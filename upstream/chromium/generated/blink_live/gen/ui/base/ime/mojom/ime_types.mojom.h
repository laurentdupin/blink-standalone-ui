...
#include "ui/base/ime/mojom/ime_types.mojom-forward.h"  // IWYU pragma: export
#include <string>
#include <vector>
 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ImeTextSpan::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
struct  StructTraits<::ui::mojom::ImeTextSpan::DataView,
  ...
  static decltype(::ui::mojom::ImeTextSpan::interim_char_selection) interim_char_selection(
      const ::ui::mojom::ImeTextSpanPtr& input) {
  ...
  static decltype(::ui::mojom::ImeTextSpan::should_hide_suggestion_menu) should_hide_suggestion_menu(
      const ::ui::mojom::ImeTextSpanPtr& input) {
