...
TextInputState::TextInputState(
    ...
    uint32_t flags_in,
    ::mojo_base::mojom::blink::BigString16Ptr value_in,
    ::gfx::mojom::blink::RangePtr selection_in,
    ::gfx::mojom::blink::RangePtr composition_in,
...
void TextInputState::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "value"), this->value,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::mojo_base::mojom::blink::BigString16Ptr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::gfx::mojom::blink::RangePtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
