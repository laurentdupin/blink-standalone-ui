...
#include "ui/base/mojom/ui_base_types.mojom-data-view.h"  // IWYU pragma: export
...
struct Serializer<::ui::mojom::ModalType, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::ui::mojom::ModalType>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::ui::mojom::ModalType, UserType> ||
                        HasInfallibleConversion(::ui::mojom::ModalType()),
                    "::ui::mojom::ModalType does not have an infallible conversion, "
