...
#include "ui/base/mojom/themes.mojom-data-view.h"  // IWYU pragma: export
...
struct Serializer<::ui::mojom::BrowserColorVariant, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::ui::mojom::BrowserColorVariant>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::ui::mojom::BrowserColorVariant, UserType> ||
                        HasInfallibleConversion(::ui::mojom::BrowserColorVariant()),
                    "::ui::mojom::BrowserColorVariant does not have an infallible conversion, "
