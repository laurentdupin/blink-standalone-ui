...
struct Serializer<::ui::mojom::DragEventSource, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::ui::mojom::DragEventSource>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::ui::mojom::DragEventSource, UserType> ||
                        HasInfallibleConversion(::ui::mojom::DragEventSource()),
                    "::ui::mojom::DragEventSource does not have an infallible conversion, "
...
struct Serializer<::ui::mojom::DragOperation, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::ui::mojom::DragOperation>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::ui::mojom::DragOperation, UserType> ||
                        HasInfallibleConversion(::ui::mojom::DragOperation()),
                    "::ui::mojom::DragOperation does not have an infallible conversion, "
                    "use an optional return type.");
      *output = Traits::FromMojom(known_value);
      return true;
    } else {
