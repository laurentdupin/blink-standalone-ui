...
HistoricalCachedPointer::HistoricalCachedPointer(
    std::vector<PointerCoordinatesPtr> pointers_in,
    ::mojo_base::mojom::TimeTicksPtr event_time_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<PointerCoordinatesPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
CachedMotionEventAndroid::CachedMotionEventAndroid(
    ...
    ::mojo_base::mojom::TimeTicksPtr latest_event_time_in,
    ::mojo_base::mojom::TimeTicksPtr down_time_ms_in,
    int32_t action_in,
    ...
    std::vector<MotionEventAndroidCachedPointerPtr> pointers_in,
    std::vector<HistoricalCachedPointerPtr> historical_events_in)
...
void CachedMotionEventAndroid::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "pointers"), this->pointers,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<MotionEventAndroidCachedPointerPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<HistoricalCachedPointerPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
