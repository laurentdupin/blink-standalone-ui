...
class  GestureData {
 public:
  ...
  GestureData(
      ...
      ::ui::mojom::GestureDeviceType device_type,
...
class  ScrollData {
 public:
  ...
  ScrollData(
      ...
      ::ui::mojom::EventMomentumPhase momentum_phase,
      ::ui::mojom::ScrollEventPhase scroll_event_phase);
...
class  Event {
 public:
  ...
  Event(
      ...
      ::ui::mojom::LatencyInfoPtr latency,
      KeyDataPtr key_data,
