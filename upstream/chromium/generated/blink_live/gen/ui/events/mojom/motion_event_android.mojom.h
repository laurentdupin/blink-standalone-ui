...
class  HistoricalCachedPointer {
 public:
  ...
  HistoricalCachedPointer(
      std::vector<PointerCoordinatesPtr> pointers,
      ::mojo_base::mojom::TimeTicksPtr event_time);
...
class  CachedMotionEventAndroid {
 public:
  ...
  CachedMotionEventAndroid(
      ...
      ::mojo_base::mojom::TimeTicksPtr latest_event_time,
      ::mojo_base::mojom::TimeTicksPtr down_time_ms,
      int32_t action,
      ...
      std::vector<MotionEventAndroidCachedPointerPtr> pointers,
      std::vector<HistoricalCachedPointerPtr> historical_events);
