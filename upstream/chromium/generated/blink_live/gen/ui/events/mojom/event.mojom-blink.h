...
class  GesturePinchData {
 public:
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        GesturePinchData::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        GesturePinchData::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
class  GestureSwipeData {
 public:
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        GestureSwipeData::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        GestureSwipeData::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
class  LocationData {
 public:
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        LocationData::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        LocationData::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
class  PointerDetails {
 public:
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        PointerDetails::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        PointerDetails::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
class  Event {
 public:
  ...
  Event(
      ...
      const std::optional<::blink::HashMap<::blink::String, ::blink::Vector<uint8_t>>>& properties);
...
Event& operator=(const Event&) = delete;
  ...
  std::optional<::blink::HashMap<::blink::String, ::blink::Vector<uint8_t>>> properties;
...
struct  StructTraits<::ui::mojom::blink::GesturePinchData::DataView,
  ...
  static bool IsNull(const ::ui::mojom::blink::GesturePinchDataPtr& input) { return !input; }
  static void SetToNull(::ui::mojom::blink::GesturePinchDataPtr* output) { output->reset(); }

  static decltype(::ui::mojom::blink::GesturePinchData::scale) scale(
      const ::ui::mojom::blink::GesturePinchDataPtr& input) {
    return input->scale;
  }

  static bool Read(::ui::mojom::blink::GesturePinchData::DataView input, ::ui::mojom::blink::GesturePinchDataPtr* output);
};
...
struct  StructTraits<::ui::mojom::blink::GestureSwipeData::DataView,
  ...
  static bool IsNull(const ::ui::mojom::blink::GestureSwipeDataPtr& input) { return !input; }
  static void SetToNull(::ui::mojom::blink::GestureSwipeDataPtr* output) { output->reset(); }

  static decltype(::ui::mojom::blink::GestureSwipeData::left) left(
      const ::ui::mojom::blink::GestureSwipeDataPtr& input) {
    return input->left;
  }

  static decltype(::ui::mojom::blink::GestureSwipeData::right) right(
      const ::ui::mojom::blink::GestureSwipeDataPtr& input) {
    return input->right;
  }

  static decltype(::ui::mojom::blink::GestureSwipeData::up) up(
      const ::ui::mojom::blink::GestureSwipeDataPtr& input) {
    return input->up;
  }

  static decltype(::ui::mojom::blink::GestureSwipeData::down) down(
      const ::ui::mojom::blink::GestureSwipeDataPtr& input) {
    return input->down;
  }

  static bool Read(::ui::mojom::blink::GestureSwipeData::DataView input, ::ui::mojom::blink::GestureSwipeDataPtr* output);
};
...
struct  StructTraits<::ui::mojom::blink::GestureData::DataView,
  ...
  static const decltype(::ui::mojom::blink::GestureData::details)& details(
      const ::ui::mojom::blink::GestureDataPtr& input) {
...
struct  StructTraits<::ui::mojom::blink::MouseData::DataView,
  ...
  static const decltype(::ui::mojom::blink::MouseData::tick_120ths)& tick_120ths(
      const ::ui::mojom::blink::MouseDataPtr& input) {
...
struct  UnionTraits<::ui::mojom::blink::GestureDataDetails::DataView,
  ...
  static bool IsNull(const ::ui::mojom::blink::GestureDataDetailsPtr& input) { return !input; }
  static void SetToNull(::ui::mojom::blink::GestureDataDetailsPtr* output) { output->reset(); }

  static ::ui::mojom::blink::GestureDataDetails::Tag GetTag(const ::ui::mojom::blink::GestureDataDetailsPtr& input) {
    return input->which();
  }

  static const ::ui::mojom::blink::GesturePinchDataPtr& pinch(const ::ui::mojom::blink::GestureDataDetailsPtr& input) {
    return input->get_pinch();
  }

  static const ::ui::mojom::blink::GestureSwipeDataPtr& swipe(const ::ui::mojom::blink::GestureDataDetailsPtr& input) {
    return input->get_swipe();
  }

  static bool Read(::ui::mojom::blink::GestureDataDetails::DataView input, ::ui::mojom::blink::GestureDataDetailsPtr* output);
};
