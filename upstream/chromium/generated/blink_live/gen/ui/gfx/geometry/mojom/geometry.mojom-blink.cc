...
bool StructTraits<::gfx::mojom::blink::Quaternion::DataView, ::gfx::mojom::blink::QuaternionPtr>::Read(
    ::gfx::mojom::blink::Quaternion::DataView input,
    ::gfx::mojom::blink::QuaternionPtr* output) {
  bool success = true;
...
bool StructTraits<::gfx::mojom::blink::QuadF::DataView, ::gfx::mojom::blink::QuadFPtr>::Read(
    ::gfx::mojom::blink::QuadF::DataView input,
    ::gfx::mojom::blink::QuadFPtr* output) {
  bool success = true;
...
// static
bool StructTraits<::gfx::mojom::blink::AxisTransform2d::DataView, ::gfx::mojom::blink::AxisTransform2dPtr>::Read(
    ::gfx::mojom::blink::AxisTransform2d::DataView input,
    ::gfx::mojom::blink::AxisTransform2dPtr* output) {
  bool success = true;
  ::gfx::mojom::blink::AxisTransform2dPtr result(::gfx::mojom::blink::AxisTransform2d::New());
