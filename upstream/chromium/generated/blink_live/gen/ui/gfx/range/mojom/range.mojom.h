...
#include "ui/gfx/range/mojom/range.mojom-forward.h"  // IWYU pragma: export
#include "ui/gfx/range/mojom/range.mojom-import-headers.h"  // IWYU pragma: export
#include <string>
#include <vector>
 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        Range::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
class  RangeF {
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        RangeF::DataView, std::vector<uint8_t>, send_validation>(input);
  }
