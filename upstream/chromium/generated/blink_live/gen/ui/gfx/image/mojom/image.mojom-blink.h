...
class BLINK_PLATFORM_EXPORT ImageSkiaRep {
 public:
  template <typename T>
  ...
  ImageSkiaRep(
      ::skia::mojom::blink::BitmapWithArbitraryBppPtr bitmap,
      float scale);

ImageSkiaRep(const ImageSkiaRep&) = delete;
ImageSkiaRep& operator=(const ImageSkiaRep&) = delete;
...
class BLINK_PLATFORM_EXPORT ImageSkia {
 public:
  template <typename T>
  ...
  explicit ImageSkia(
      ::blink::Vector<ImageSkiaRepPtr> image_reps);

ImageSkia(const ImageSkia&) = delete;
ImageSkia& operator=(const ImageSkia&) = delete;
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::gfx::mojom::blink::ImageSkiaRep::DataView,
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::gfx::mojom::blink::ImageSkia::DataView,
