...
ImageSkiaRep::ImageSkiaRep(
    ::skia::mojom::BitmapWithArbitraryBppPtr bitmap_in,
    float scale_in)
...
void ImageSkiaRep::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      ...
      "<value of type ::skia::mojom::BitmapWithArbitraryBppPtr>"
#else
      "<value>"
...
ImageSkia::ImageSkia(
    std::vector<ImageSkiaRepPtr> image_reps_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<ImageSkiaRepPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
