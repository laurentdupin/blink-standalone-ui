// ui/gfx/mojom/delegated_ink_point.mojom-shared.cc is auto generated by mojom_bindings_generator.py, do not edit
...
// static
bool DelegatedInkPoint_Data::Validate(
    const void* data,
  ...
  [[maybe_unused]] const DelegatedInkPoint_Data* object =
      static_cast<const DelegatedInkPoint_Data*>(data);
...
DelegatedInkPoint_Data::DelegatedInkPoint_Data()
