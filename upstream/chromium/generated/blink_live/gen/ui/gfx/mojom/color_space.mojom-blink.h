...
#include "ui/gfx/mojom/color_space.mojom-blink-forward.h"  // IWYU pragma: export
...
class BLINK_PLATFORM_EXPORT ColorSpace {
 public:
  template <typename T>
  ...
  ColorSpace(
      ...
      ::blink::Vector<float> custom_primary_matrix,
      ::blink::Vector<float> transfer_params);
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ColorSpace::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ColorSpace::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::gfx::mojom::blink::ColorSpace::DataView,
