...
CALayerParams::CALayerParams(
    ...
    ::gfx::mojom::blink::SizePtr pixel_size_in,
...
// static
bool StructTraits<::gfx::mojom::blink::CAContext::DataView, ::gfx::mojom::blink::CAContextPtr>::Read(
    ::gfx::mojom::blink::CAContext::DataView input,
    ::gfx::mojom::blink::CAContextPtr* output) {
  bool success = true;
  ::gfx::mojom::blink::CAContextPtr result(::gfx::mojom::blink::CAContext::New());
...
bool UnionTraits<::gfx::mojom::blink::CALayerContent::DataView, ::gfx::mojom::blink::CALayerContentPtr>::Read(
  ...
  switch (input.tag()) {
    case Tag::kCaContext: {
      ::gfx::mojom::blink::CAContextPtr result_ca_context{};
