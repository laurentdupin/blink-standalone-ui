...
bool GpuMemoryBufferPlatformHandle_Data::Validate(
  ...
  switch (object->tag) {
    ...
    case GpuMemoryBufferPlatformHandle_Tag::kDxgiHandle: {
      ...
      if (!mojo::internal::ValidatePointerNonNullable(
              object->data.f_dxgi_handle, 2, validation_context)) {
        return false;
      }
...
// static
bool DXGIHandleToken_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  [[maybe_unused]] const DXGIHandleToken_Data* object =
      static_cast<const DXGIHandleToken_Data*>(data);
...
bool DXGIHandle_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const DXGIHandle_Data* object =
      static_cast<const DXGIHandle_Data*>(data);
