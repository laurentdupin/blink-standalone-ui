...
class BLINK_PLATFORM_EXPORT GpuFenceHandle {
 public:
  template <typename T>
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::gfx::mojom::blink::GpuFenceHandle::DataView,
  ...
  static  decltype(::gfx::mojom::blink::GpuFenceHandle::native_handle)& native_handle(
