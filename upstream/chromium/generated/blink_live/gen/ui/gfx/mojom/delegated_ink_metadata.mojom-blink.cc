// ui/gfx/mojom/delegated_ink_metadata.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "ui/gfx/mojom/delegated_ink_metadata.mojom-blink-test-utils.h"
...
// static
bool StructTraits<::gfx::mojom::blink::DelegatedInkMetadata::DataView, ::gfx::mojom::blink::DelegatedInkMetadataPtr>::Read(
    ::gfx::mojom::blink::DelegatedInkMetadata::DataView input,
    ::gfx::mojom::blink::DelegatedInkMetadataPtr* output) {
  bool success = true;
  ::gfx::mojom::blink::DelegatedInkMetadataPtr result(::gfx::mojom::blink::DelegatedInkMetadata::New());
