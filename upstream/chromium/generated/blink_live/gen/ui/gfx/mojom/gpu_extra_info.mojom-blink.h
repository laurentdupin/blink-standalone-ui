...
#include "ui/gfx/mojom/gpu_extra_info.mojom-blink-forward.h"  // IWYU pragma: export
 ...
 public:
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ANGLEFeature::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ANGLEFeature::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
class  GpuExtraInfo {
 public:
  ...
  explicit GpuExtraInfo(
      ::blink::Vector<ANGLEFeaturePtr> angle_features);

GpuExtraInfo(const GpuExtraInfo&) = delete;
GpuExtraInfo& operator=(const GpuExtraInfo&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        GpuExtraInfo::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        GpuExtraInfo::DataView, ::blink::Vector<uint8_t>>(input);
  }
