...
class BLINK_PLATFORM_EXPORT DisplayColorSpaces {
 public:
  template <typename T>
  ...
  DisplayColorSpaces(
      ::blink::Vector<::gfx::ColorSpace> color_spaces,
      ::blink::Vector<::viz::mojom::blink::SharedImageFormatPtr> formats,
      const ::SkColorSpacePrimaries& primaries,
      float sdr_max_luminance_nits,
      float hdr_max_luminance_relative);

DisplayColorSpaces(const DisplayColorSpaces&) = delete;
DisplayColorSpaces& operator=(const DisplayColorSpaces&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        DisplayColorSpaces::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        DisplayColorSpaces::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::gfx::mojom::blink::DisplayColorSpaces::DataView,
  ...
  static const decltype(::gfx::mojom::blink::DisplayColorSpaces::formats)& formats(
      const ::gfx::mojom::blink::DisplayColorSpacesPtr& input) {
    return input->formats;
  }

  static const decltype(::gfx::mojom::blink::DisplayColorSpaces::primaries)& primaries(
      const ::gfx::mojom::blink::DisplayColorSpacesPtr& input) {
