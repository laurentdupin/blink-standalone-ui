...
class BLINK_PLATFORM_EXPORT PresentationFeedback {
 public:
  template <typename T>
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        PresentationFeedback::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        PresentationFeedback::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::gfx::mojom::blink::PresentationFeedback::DataView,
  ...
  static decltype(::gfx::mojom::blink::PresentationFeedback::display_trace_id) display_trace_id(
      const ::gfx::mojom::blink::PresentationFeedbackPtr& input) {
