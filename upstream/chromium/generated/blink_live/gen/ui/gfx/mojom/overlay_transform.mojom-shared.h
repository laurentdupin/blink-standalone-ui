...
#include "ui/gfx/mojom/overlay_transform.mojom-data-view.h"  // IWYU pragma: export
...
struct Serializer<::gfx::mojom::OverlayTransform, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::gfx::mojom::OverlayTransform>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::gfx::mojom::OverlayTransform, UserType> ||
                        HasInfallibleConversion(::gfx::mojom::OverlayTransform()),
                    "::gfx::mojom::OverlayTransform does not have an infallible conversion, "
