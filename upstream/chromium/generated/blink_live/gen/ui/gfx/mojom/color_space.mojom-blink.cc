// ui/gfx/mojom/color_space.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "ui/gfx/mojom/color_space.mojom-blink-test-utils.h"
...
ColorSpace::ColorSpace(
    ...
    ::blink::Vector<float> custom_primary_matrix_in,
    ::blink::Vector<float> transfer_params_in)
...
// static
bool StructTraits<::gfx::mojom::blink::ColorSpace::DataView, ::gfx::mojom::blink::ColorSpacePtr>::Read(
    ::gfx::mojom::blink::ColorSpace::DataView input,
    ::gfx::mojom::blink::ColorSpacePtr* output) {
  bool success = true;
  ::gfx::mojom::blink::ColorSpacePtr result(::gfx::mojom::blink::ColorSpace::New());
