...
class  DelegatedInkPoint {
 public:
  ...
  DelegatedInkPoint(
      ::gfx::mojom::PointFPtr point,
      ::mojo_base::mojom::TimeTicksPtr timestamp,
      int32_t pointer_id);

DelegatedInkPoint(const DelegatedInkPoint&) = delete;
DelegatedInkPoint& operator=(const DelegatedInkPoint&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        DelegatedInkPoint::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
template <>
struct  StructTraits<::gfx::mojom::DelegatedInkPoint::DataView,
                                         ::gfx::mojom::DelegatedInkPointPtr> {
  static bool IsNull(const ::gfx::mojom::DelegatedInkPointPtr& input) { return !input; }
  static void SetToNull(::gfx::mojom::DelegatedInkPointPtr* output) { output->reset(); }

  static const decltype(::gfx::mojom::DelegatedInkPoint::point)& point(
      const ::gfx::mojom::DelegatedInkPointPtr& input) {
    return input->point;
  }

  static const decltype(::gfx::mojom::DelegatedInkPoint::timestamp)& timestamp(
      const ::gfx::mojom::DelegatedInkPointPtr& input) {
    return input->timestamp;
  }

  static decltype(::gfx::mojom::DelegatedInkPoint::pointer_id) pointer_id(
      const ::gfx::mojom::DelegatedInkPointPtr& input) {
