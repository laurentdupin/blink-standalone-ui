...
bool DisplayColorSpaces_Data::Validate(
  ...
  [[maybe_unused]] const DisplayColorSpaces_Data* object =
      static_cast<const DisplayColorSpaces_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->formats, 2, validation_context)) {
    return false;
  }
...
// static
void TraceFormatTraits<::gfx::mojom::ContentColorUsage>::WriteIntoTrace(
