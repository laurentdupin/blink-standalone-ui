...
class  ScreenInfos {
 public:
  ...
  ScreenInfos(
      ::blink::Vector<::display::mojom::blink::ScreenInfoPtr> screen_infos,
      int64_t current_display_id,
      const ::gfx::Size& system_cursor_size);

ScreenInfos(const ScreenInfos&) = delete;
ScreenInfos& operator=(const ScreenInfos&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ScreenInfos::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ScreenInfos::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::display::mojom::blink::ScreenInfos::DataView,
                                         ::display::mojom::blink::ScreenInfosPtr> {
  static bool IsNull(const ::display::mojom::blink::ScreenInfosPtr& input) { return !input; }
  static void SetToNull(::display::mojom::blink::ScreenInfosPtr* output) { output->reset(); }

  static const decltype(::display::mojom::blink::ScreenInfos::screen_infos)& screen_infos(
      const ::display::mojom::blink::ScreenInfosPtr& input) {
    return input->screen_infos;
  }

  static decltype(::display::mojom::blink::ScreenInfos::current_display_id) current_display_id(
      const ::display::mojom::blink::ScreenInfosPtr& input) {
    return input->current_display_id;
  }

  static const decltype(::display::mojom::blink::ScreenInfos::system_cursor_size)& system_cursor_size(
      const ::display::mojom::blink::ScreenInfosPtr& input) {
