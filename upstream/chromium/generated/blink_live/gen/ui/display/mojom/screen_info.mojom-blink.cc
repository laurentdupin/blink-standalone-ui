...
ScreenInfo::ScreenInfo(
    ...
    ::gfx::mojom::blink::DisplayColorSpacesPtr display_color_spaces_in,
    uint32_t depth_in,
    int32_t handwriting_radius_in,
    ...
    : device_scale_factor(std::move(device_scale_factor_in)),
      ...
      handwriting_radius(std::move(handwriting_radius_in)),
...
void ScreenInfo::WriteIntoTrace(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::gfx::mojom::blink::DisplayColorSpacesPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "handwriting_radius"), this->handwriting_radius,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool StructTraits<::display::mojom::blink::ScreenInfo::DataView, ::display::mojom::blink::ScreenInfoPtr>::Read(
  ...
  ::display::mojom::blink::ScreenInfoPtr result(::display::mojom::blink::ScreenInfo::New());
      ...
      if (success)
        result->handwriting_radius = input.handwriting_radius();
      if (success)
