...
#include "ui/display/mojom/display.mojom-data-view.h"  // IWYU pragma: export
...
struct Serializer<::display::mojom::Rotation, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::display::mojom::Rotation>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::display::mojom::Rotation, UserType> ||
                        HasInfallibleConversion(::display::mojom::Rotation()),
                    "::display::mojom::Rotation does not have an infallible conversion, "
...
struct Serializer<::display::mojom::TouchSupport, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::display::mojom::TouchSupport>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::display::mojom::TouchSupport, UserType> ||
                        HasInfallibleConversion(::display::mojom::TouchSupport()),
                    "::display::mojom::TouchSupport does not have an infallible conversion, "
                    "use an optional return type.");
      *output = Traits::FromMojom(known_value);
      return true;
    } else {
...
struct Serializer<::display::mojom::AccelerometerSupport, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::display::mojom::AccelerometerSupport>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::display::mojom::AccelerometerSupport, UserType> ||
                        HasInfallibleConversion(::display::mojom::AccelerometerSupport()),
                    "::display::mojom::AccelerometerSupport does not have an infallible conversion, "
                    "use an optional return type.");
      *output = Traits::FromMojom(known_value);
      return true;
    } else {
