...
ScreenInfos::ScreenInfos(
    ::blink::Vector<::display::mojom::blink::ScreenInfoPtr> screen_infos_in,
...
void ScreenInfos::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      ...
      "<value of type ::blink::Vector<::display::mojom::blink::ScreenInfoPtr>>"
#else
      "<value>"
...
bool StructTraits<::display::mojom::blink::ScreenInfos::DataView, ::display::mojom::blink::ScreenInfosPtr>::Read(
    ::display::mojom::blink::ScreenInfos::DataView input,
    ::display::mojom::blink::ScreenInfosPtr* output) {
  bool success = true;
