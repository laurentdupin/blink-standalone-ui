...
bool Display_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->native_origin, 4, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->work_area, 5, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->maximum_cursor_size, 10, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->color_spaces, 11, validation_context)) {
    return false;
  }
