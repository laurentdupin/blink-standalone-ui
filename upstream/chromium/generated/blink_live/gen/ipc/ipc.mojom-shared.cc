...
bool Channel_SetPeerPid_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const Channel_SetPeerPid_Params_Data* object =
      static_cast<const Channel_SetPeerPid_Params_Data*>(data);
...
bool Channel_GetAssociatedInterface_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const Channel_GetAssociatedInterface_Params_Data* object =
      static_cast<const Channel_GetAssociatedInterface_Params_Data*>(data);
