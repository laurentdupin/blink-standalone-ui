...
void ChannelProxy::SetPeerPid(
  ...
  mojo::Message message(
      std::to_underlying(messages::Channel::kSetPeerPid), kFlags, estimated_payload_size);
...
void ChannelProxy::GetAssociatedInterface(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::Channel::kGetAssociatedInterface), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
