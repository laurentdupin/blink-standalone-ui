...
static_assert(sizeof(ProxyResolver_GetProxyForUrl_Params_Data) == 40,
...
static_assert(sizeof(ProxyResolverRequestClient_ResolveDns_Params_Data) == 48,
...
static_assert(sizeof(ProxyResolverFactoryRequestClient_ResolveDns_Params_Data) == 48,
              "Bad sizeof(ProxyResolverFactoryRequestClient_ResolveDns_Params_Data)");
class  SystemProxyResolver_GetProxyForUrl_Params_Data {
 public:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
 ...
 private:
  friend class mojo::internal::MessageFragment<SystemProxyResolver_GetProxyForUrl_Params_Data>;

  SystemProxyResolver_GetProxyForUrl_Params_Data();
  ~SystemProxyResolver_GetProxyForUrl_Params_Data() = delete;
};
static_assert(sizeof(SystemProxyResolver_GetProxyForUrl_Params_Data) == 16,
              "Bad sizeof(SystemProxyResolver_GetProxyForUrl_Params_Data)");
class  SystemProxyResolver_GetProxyForUrl_ResponseParams_Data {
 public:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
  ...
  mojo::internal::Pointer<internal::SystemProxyResolutionStatus_Data> status;

 private:
  friend class mojo::internal::MessageFragment<SystemProxyResolver_GetProxyForUrl_ResponseParams_Data>;

  SystemProxyResolver_GetProxyForUrl_ResponseParams_Data();
  ~SystemProxyResolver_GetProxyForUrl_ResponseParams_Data() = delete;
};
static_assert(sizeof(SystemProxyResolver_GetProxyForUrl_ResponseParams_Data) == 24,
              "Bad sizeof(SystemProxyResolver_GetProxyForUrl_ResponseParams_Data)");
...
class ProxyResolver_GetProxyForUrl_ParamsDataView {
 public:
  ...
  UserType TakeClient() {
    UserType result;
    bool ret =
        mojo::internal::Deserialize<mojo::InterfacePtrDataView<::proxy_resolver::mojom::ProxyResolverRequestClientInterfaceBase>>(
 ...
 public:
  ...
  HostResolveOperation operation() const {
    return ::mojo::internal::ToKnownEnumValueHelper(
          static_cast<::proxy_resolver::mojom::HostResolveOperation>(data_->operation));
  }
  inline void GetNetworkAnonymizationKeyDataView(
      ::network::mojom::NetworkAnonymizationKeyDataView* output);
  ...
  UserType TakeClient() {
    UserType result;
    bool ret =
        mojo::internal::Deserialize<mojo::InterfacePtrDataView<::proxy_resolver::mojom::HostResolverRequestClientInterfaceBase>>(
            &data_->client, &result, message_);
    DCHECK(ret);
    return result;
  }
...
class ProxyResolverFactory_CreateResolver_ParamsDataView {
 public:
  ...
  template <typename UserType>
  [[nodiscard]] bool ReadPacScript(UserType* output) {
  ...
  UserType TakeReceiver() {
    UserType result;
    bool ret =
        mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::proxy_resolver::mojom::ProxyResolverInterfaceBase>>(
  ...
  UserType TakeClient() {
    UserType result;
    bool ret =
        mojo::internal::Deserialize<mojo::InterfacePtrDataView<::proxy_resolver::mojom::ProxyResolverFactoryRequestClientInterfaceBase>>(
            &data_->client, &result, message_);
    DCHECK(ret);
    return result;
  }
...
class SystemProxyResolver_GetProxyForUrl_ParamsDataView {
 public:
  SystemProxyResolver_GetProxyForUrl_ParamsDataView() = default;

  SystemProxyResolver_GetProxyForUrl_ParamsDataView(
      internal::SystemProxyResolver_GetProxyForUrl_Params_Data* data,
      mojo::Message* message)
      : data_(data), message_(message) {}
 ...
 private:
  internal::SystemProxyResolver_GetProxyForUrl_Params_Data* data_ = nullptr;
  mojo::Message* message_ = nullptr;
};


class SystemProxyResolver_GetProxyForUrl_ResponseParamsDataView {
 public:
  SystemProxyResolver_GetProxyForUrl_ResponseParamsDataView() = default;

  SystemProxyResolver_GetProxyForUrl_ResponseParamsDataView(
      internal::SystemProxyResolver_GetProxyForUrl_ResponseParams_Data* data,
      mojo::Message* message)
      : data_(data), message_(message) {}
  ...
  inline void GetStatusDataView(
      SystemProxyResolutionStatusDataView* output);

  template <typename UserType>
  [[nodiscard]] bool ReadStatus(UserType* output) {
    
    auto* pointer = data_->status.Get();
    return mojo::internal::Deserialize<::proxy_resolver::mojom::SystemProxyResolutionStatusDataView>(
        pointer, output, message_);
  }
 private:
  internal::SystemProxyResolver_GetProxyForUrl_ResponseParams_Data* data_ = nullptr;
  mojo::Message* message_ = nullptr;
};
...
inline void ProxyResolver_GetProxyForUrl_ParamsDataView::GetNetworkAnonymizationKeyDataView(
    ::network::mojom::NetworkAnonymizationKeyDataView* output) {
...
inline void ProxyResolverRequestClient_ResolveDns_ParamsDataView::GetNetworkAnonymizationKeyDataView(
    ::network::mojom::NetworkAnonymizationKeyDataView* output) {
  auto pointer = &data_->network_anonymization_key;
  *output = ::network::mojom::NetworkAnonymizationKeyDataView(pointer, message_);
}
...
inline void SystemProxyResolver_GetProxyForUrl_ParamsDataView::GetUrlDataView(
    ::url::mojom::UrlDataView* output) {
  auto pointer = data_->url.Get();
  *output = ::url::mojom::UrlDataView(pointer, message_);
}
...
inline void SystemProxyResolver_GetProxyForUrl_ResponseParamsDataView::GetProxyListDataView(
    ::network::mojom::ProxyListDataView* output) {
  auto pointer = data_->proxy_list.Get();
  *output = ::network::mojom::ProxyListDataView(pointer, message_);
}
inline void SystemProxyResolver_GetProxyForUrl_ResponseParamsDataView::GetStatusDataView(
    SystemProxyResolutionStatusDataView* output) {
  auto pointer = data_->status.Get();
  *output = SystemProxyResolutionStatusDataView(pointer, message_);
}
