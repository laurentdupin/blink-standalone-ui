...
class  HostResolverRequestClientInterceptorForTesting : public HostResolverRequestClient {
  ...
  void ReportResult(int32_t error, std::vector<::network::mojom::IPAddressPtr> result) override;
};
...
class  ProxyResolverInterceptorForTesting : public ProxyResolver {
  ...
  void GetProxyForUrl(const ::GURL& url, ::network::mojom::NetworkAnonymizationKeyPtr network_anonymization_key, ::mojo::PendingRemote<ProxyResolverRequestClient> client) override;
};
...
class  ProxyResolverRequestClientInterceptorForTesting : public ProxyResolverRequestClient {
  ...
  void ResolveDns(const std::string& host, HostResolveOperation operation, ::network::mojom::NetworkAnonymizationKeyPtr network_anonymization_key, ::mojo::PendingRemote<HostResolverRequestClient> client) override;
};
...
class  SystemProxyResolverInterceptorForTesting : public SystemProxyResolver {
...
class  SystemProxyResolverAsyncWaiter {
 public:
