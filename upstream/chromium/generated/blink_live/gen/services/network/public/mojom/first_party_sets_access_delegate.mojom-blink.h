// services/network/public/mojom/first_party_sets_access_delegate.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef SERVICES_NETWORK_PUBLIC_MOJOM_FIRST_PARTY_SETS_ACCESS_DELEGATE_MOJOM_BLINK_H_
#define SERVICES_NETWORK_PUBLIC_MOJOM_FIRST_PARTY_SETS_ACCESS_DELEGATE_MOJOM_BLINK_H_
...
#include "services/network/public/mojom/first_party_sets_access_delegate.mojom-blink-forward.h"  // IWYU pragma: export
 ...
 public:
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        FirstPartySetsAccessDelegateParams::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        FirstPartySetsAccessDelegateParams::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
class  FirstPartySetsReadyEvent {
 public:
  ...
  FirstPartySetsReadyEvent(
      ::network::mojom::blink::FirstPartySetsContextConfigPtr config,
      ::network::mojom::blink::FirstPartySetsCacheFilterPtr cache_filter);
...
FirstPartySetsReadyEvent& operator=(const FirstPartySetsReadyEvent&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        FirstPartySetsReadyEvent::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        FirstPartySetsReadyEvent::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::network::mojom::blink::FirstPartySetsAccessDelegateParams::DataView,
                                         ::network::mojom::blink::FirstPartySetsAccessDelegateParamsPtr> {
  static bool IsNull(const ::network::mojom::blink::FirstPartySetsAccessDelegateParamsPtr& input) { return !input; }
  static void SetToNull(::network::mojom::blink::FirstPartySetsAccessDelegateParamsPtr* output) { output->reset(); }

  static decltype(::network::mojom::blink::FirstPartySetsAccessDelegateParams::enabled) enabled(
      const ::network::mojom::blink::FirstPartySetsAccessDelegateParamsPtr& input) {
    return input->enabled;
  }

  static bool Read(::network::mojom::blink::FirstPartySetsAccessDelegateParams::DataView input, ::network::mojom::blink::FirstPartySetsAccessDelegateParamsPtr* output);
};


template <>
struct  StructTraits<::network::mojom::blink::FirstPartySetsReadyEvent::DataView,
                                         ::network::mojom::blink::FirstPartySetsReadyEventPtr> {
  static bool IsNull(const ::network::mojom::blink::FirstPartySetsReadyEventPtr& input) { return !input; }
  static void SetToNull(::network::mojom::blink::FirstPartySetsReadyEventPtr* output) { output->reset(); }

  static const decltype(::network::mojom::blink::FirstPartySetsReadyEvent::config)& config(
      const ::network::mojom::blink::FirstPartySetsReadyEventPtr& input) {
    return input->config;
  }

  static const decltype(::network::mojom::blink::FirstPartySetsReadyEvent::cache_filter)& cache_filter(
      const ::network::mojom::blink::FirstPartySetsReadyEventPtr& input) {
    return input->cache_filter;
  }

  static bool Read(::network::mojom::blink::FirstPartySetsReadyEvent::DataView input, ::network::mojom::blink::FirstPartySetsReadyEventPtr* output);
};

}  // namespace mojo

#endif  // SERVICES_NETWORK_PUBLIC_MOJOM_FIRST_PARTY_SETS_ACCESS_DELEGATE_MOJOM_BLINK_H_