...
// with not having this data in traces there.
  ...
  virtual void OnWebBundleError(WebBundleErrorType type, const ::blink::String& message) = 0;
...
class BLINK_PLATFORM_EXPORT WebBundleHandleProxy
 ...
 public:
  ...
  void OnWebBundleError(WebBundleErrorType type, const ::blink::String& message) final;
