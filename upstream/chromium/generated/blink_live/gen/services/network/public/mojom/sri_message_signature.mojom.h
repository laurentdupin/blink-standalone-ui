 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SRIMessageSignatureComponentParameter::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SRIMessageSignatureComponentParameter::DataView, std::vector<uint8_t>>(input);
  }
...
SRIMessageSignatureComponent& operator=(const SRIMessageSignatureComponent&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SRIMessageSignatureComponent::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
SRIMessageSignature& operator=(const SRIMessageSignature&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SRIMessageSignature::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
class  SRIMessageSignatureIssue {
 public:
  ...
  SRIMessageSignatureIssue(
      ...
      const std::optional<std::string>& signature_base,
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SRIMessageSignatureIssue::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SRIMessageSignatureIssue::DataView, std::vector<uint8_t>>(input);
  }
...
SRIMessageSignatures& operator=(const SRIMessageSignatures&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SRIMessageSignatures::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
template <>
struct  StructTraits<::network::mojom::SRIMessageSignatureComponentParameter::DataView,
                                         ::network::mojom::SRIMessageSignatureComponentParameterPtr> {
  static bool IsNull(const ::network::mojom::SRIMessageSignatureComponentParameterPtr& input) { return !input; }
  static void SetToNull(::network::mojom::SRIMessageSignatureComponentParameterPtr* output) { output->reset(); }

  static decltype(::network::mojom::SRIMessageSignatureComponentParameter::type) type(
      const ::network::mojom::SRIMessageSignatureComponentParameterPtr& input) {
    return input->type;
  }

  static const decltype(::network::mojom::SRIMessageSignatureComponentParameter::value)& value(
      const ::network::mojom::SRIMessageSignatureComponentParameterPtr& input) {
    return input->value;
  }

  static bool Read(::network::mojom::SRIMessageSignatureComponentParameter::DataView input, ::network::mojom::SRIMessageSignatureComponentParameterPtr* output);
};
...
template <>
struct  StructTraits<::network::mojom::SRIMessageSignatureIssue::DataView,
                                         ::network::mojom::SRIMessageSignatureIssuePtr> {
  static bool IsNull(const ::network::mojom::SRIMessageSignatureIssuePtr& input) { return !input; }
  static void SetToNull(::network::mojom::SRIMessageSignatureIssuePtr* output) { output->reset(); }

  static decltype(::network::mojom::SRIMessageSignatureIssue::error) error(
      const ::network::mojom::SRIMessageSignatureIssuePtr& input) {
    return input->error;
  }

  static const decltype(::network::mojom::SRIMessageSignatureIssue::signature_base)& signature_base(
      const ::network::mojom::SRIMessageSignatureIssuePtr& input) {
    return input->signature_base;
  }

  static const decltype(::network::mojom::SRIMessageSignatureIssue::integrity_assertions)& integrity_assertions(
      const ::network::mojom::SRIMessageSignatureIssuePtr& input) {
    return input->integrity_assertions;
  }

  static bool Read(::network::mojom::SRIMessageSignatureIssue::DataView input, ::network::mojom::SRIMessageSignatureIssuePtr* output);
};
...
struct  StructTraits<::network::mojom::SRIMessageSignatures::DataView,
  ...
  static const decltype(::network::mojom::SRIMessageSignatures::issues)& issues(
      const ::network::mojom::SRIMessageSignaturesPtr& input) {
    return input->issues;
  }
