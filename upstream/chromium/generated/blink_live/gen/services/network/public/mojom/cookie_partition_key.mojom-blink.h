...
CookiePartitionKey& operator=(const CookiePartitionKey&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CookiePartitionKey::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CookiePartitionKey::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
class BLINK_PLATFORM_EXPORT CookiePartitionKeyCollection {
 public:
  ...
  CookiePartitionKeyCollection(
      ...
      ::blink::Vector<CookiePartitionKeyPtr> keys);
...
CookiePartitionKeyCollection& operator=(const CookiePartitionKeyCollection&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CookiePartitionKeyCollection::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CookiePartitionKeyCollection::DataView, ::blink::Vector<uint8_t>>(input);
  }
