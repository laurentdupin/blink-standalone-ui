...
#include "services/network/public/mojom/host_resolver_endpoint_result.mojom-forward.h"
...
// with not having this data in traces there.
  ...
  virtual void OnComplete(int32_t result, ::network::mojom::ResolveErrorInfoPtr resolve_error_info, ::network::mojom::AddressListPtr resolved_addresses, std::vector<::network::mojom::HostResolverEndpointResultPtr> alternative_endpoints) = 0;

  virtual void OnTextResults(const std::vector<std::string>& text_results) = 0;

  virtual void OnHostnameResults(std::vector<::network::mojom::HostPortPairPtr> hosts) = 0;
};
...
// with not having this data in traces there.
  ...
  virtual void OnAddressResult(MdnsListenClient::UpdateType update_type, DnsQueryType query_type, ::network::mojom::IPEndPointPtr endpoint) = 0;

  virtual void OnTextResult(MdnsListenClient::UpdateType update_type, DnsQueryType query_type, const std::vector<std::string>& text_records) = 0;

  virtual void OnHostnameResult(MdnsListenClient::UpdateType update_type, DnsQueryType query_type, ::network::mojom::HostPortPairPtr host) = 0;
...
// with not having this data in traces there.
  ...
  virtual void ResolveHost(HostResolverHostPtr host, ::network::mojom::NetworkAnonymizationKeyPtr network_anonymization_key, ResolveHostParametersPtr optional_parameters, ::mojo::PendingRemote<ResolveHostClient> response_client) = 0;

  using MdnsListenCallback = base::OnceCallback<void(int32_t)>;
  using MdnsListenMojoCallback = base::OnceCallback<void(int32_t)>;

  virtual void MdnsListen(::network::mojom::HostPortPairPtr host, DnsQueryType query_type, ::mojo::PendingRemote<MdnsListenClient> response_client, MdnsListenCallback callback) = 0;
};
...
class  ResolveHostClientProxy
 ...
 public:
  ...
  void OnComplete(int32_t result, ::network::mojom::ResolveErrorInfoPtr resolve_error_info, ::network::mojom::AddressListPtr resolved_addresses, std::vector<::network::mojom::HostResolverEndpointResultPtr> alternative_endpoints) final;
  
  void OnTextResults(const std::vector<std::string>& text_results) final;
  
  void OnHostnameResults(std::vector<::network::mojom::HostPortPairPtr> hosts) final;
...
class  MdnsListenClientProxy
 ...
 public:
  ...
  void OnAddressResult(MdnsListenClient::UpdateType update_type, DnsQueryType query_type, ::network::mojom::IPEndPointPtr endpoint) final;
  
  void OnTextResult(MdnsListenClient::UpdateType update_type, DnsQueryType query_type, const std::vector<std::string>& text_records) final;
  
  void OnHostnameResult(MdnsListenClient::UpdateType update_type, DnsQueryType query_type, ::network::mojom::HostPortPairPtr host) final;
...
class  HostResolverProxy
 ...
 public:
  ...
  void ResolveHost(HostResolverHostPtr host, ::network::mojom::NetworkAnonymizationKeyPtr network_anonymization_key, ResolveHostParametersPtr optional_parameters, ::mojo::PendingRemote<ResolveHostClient> response_client) final;
  
  void MdnsListen(::network::mojom::HostPortPairPtr host, DnsQueryType query_type, ::mojo::PendingRemote<MdnsListenClient> response_client, MdnsListenCallback callback) final;
...
class  HostResolverHost {
 public:
  ...
  const ::network::mojom::HostPortPairPtr& get_host_port_pair() const {
    CHECK(tag_ == Tag::kHostPortPair);
    return data_.host_port_pair;
  }
  ::network::mojom::HostPortPairPtr& get_host_port_pair() {
    CHECK(tag_ == Tag::kHostPortPair);
    return data_.host_port_pair;
  }
  void set_host_port_pair(::network::mojom::HostPortPairPtr host_port_pair);
 ...
 private:
  ...
  union Union_ {
    ...
    ::network::mojom::HostPortPairPtr host_port_pair;
  };
...
class  DnsOverHttpsServerConfig {
 public:
  ...
  DnsOverHttpsServerConfig(
      ...
      std::vector<std::vector<::network::mojom::IPAddressPtr>> endpoints);
...
class  DnsOverHttpsConfig {
 public:
  ...
  explicit DnsOverHttpsConfig(
      std::vector<DnsOverHttpsServerConfigPtr> servers);
...
class  DnsConfigOverrides {
 public:
  ...
  DnsConfigOverrides(
      std::optional<std::vector<::network::mojom::IPEndPointPtr>> nameservers,
      ...
      std::optional<std::vector<::network::mojom::IPEndPointPtr>> fallback_doh_nameservers,
      bool clear_hosts);
...
class  ResolveHostParameters {
 public:
  ...
  ResolveHostParameters(
      ...
      ::network::mojom::RequestPriority initial_priority,
...
struct  StructTraits<::network::mojom::ResolveHostParameters::DataView,
  ...
  static const decltype(::network::mojom::ResolveHostParameters::network_restrictions_id)& network_restrictions_id(
      const ::network::mojom::ResolveHostParametersPtr& input) {
...
struct  UnionTraits<::network::mojom::HostResolverHost::DataView,
  ...
  static const ::network::mojom::HostPortPairPtr& host_port_pair(const ::network::mojom::HostResolverHostPtr& input) {
