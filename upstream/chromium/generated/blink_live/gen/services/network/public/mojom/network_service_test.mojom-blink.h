...
// with not having this data in traces there.
  ...
  virtual void OpenFile(::mojo_base::mojom::blink::FilePathPtr path, OpenFileCallback callback) = 0;
  ...
  virtual void EnumerateFiles(::mojo_base::mojom::blink::FilePathPtr path, ::mojo::PendingRemote<::network::mojom::blink::HttpCacheBackendFileOperationsFactory> factory, EnumerateFilesCallback callback) = 0;
  ...
  virtual void CreateSimpleCache(::mojo::PendingRemote<::network::mojom::blink::HttpCacheBackendFileOperationsFactory> factory, ::mojo_base::mojom::blink::FilePathPtr path, bool reset, CreateSimpleCacheCallback callback) = 0;
  ...
  virtual void MakeRequestToServer(::network::mojom::blink::TransferableSocketPtr s, ::network::mojom::blink::IPEndPointPtr endpoint, MakeRequestToServerCallback callback) = 0;
  ...
  virtual bool HasRawHeadersAccess(uint32_t process_id, const ::blink::KURL& url, bool* out_result);
  ...
  virtual void HasRawHeadersAccess(uint32_t process_id, const ::blink::KURL& url, HasRawHeadersAccessCallback callback) = 0;
};
...
class  NetworkServiceTestProxy
 ...
 public:
  ...
  void OpenFile(::mojo_base::mojom::blink::FilePathPtr path, OpenFileCallback callback) final;
  
  void EnumerateFiles(::mojo_base::mojom::blink::FilePathPtr path, ::mojo::PendingRemote<::network::mojom::blink::HttpCacheBackendFileOperationsFactory> factory, EnumerateFilesCallback callback) final;
  
  void CreateSimpleCache(::mojo::PendingRemote<::network::mojom::blink::HttpCacheBackendFileOperationsFactory> factory, ::mojo_base::mojom::blink::FilePathPtr path, bool reset, CreateSimpleCacheCallback callback) final;
  
  void MakeRequestToServer(::network::mojom::blink::TransferableSocketPtr s, ::network::mojom::blink::IPEndPointPtr endpoint, MakeRequestToServerCallback callback) final;
  ...
  bool HasRawHeadersAccess(uint32_t process_id, const ::blink::KURL& url, bool* out_result) final;
  
  void HasRawHeadersAccess(uint32_t process_id, const ::blink::KURL& url, HasRawHeadersAccessCallback callback) final;
...
template <>
struct  StructTraits<::network::mojom::blink::Rule::DataView,
...
template <>
struct  StructTraits<::network::mojom::blink::SimpleCacheOpenEntryResult::DataView,
