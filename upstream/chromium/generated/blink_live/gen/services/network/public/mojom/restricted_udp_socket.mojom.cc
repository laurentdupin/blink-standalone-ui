...
RestrictedUDPSocketParams::RestrictedUDPSocketParams(
    ::network::mojom::UDPSocketOptionsPtr socket_options_in)
...
void RestrictedUDPSocketProxy::Send(
    ::mojo_base::mojom::ReadOnlyBufferPtr in_data, SendCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void RestrictedUDPSocketProxy::SendTo(
    ::mojo_base::mojom::ReadOnlyBufferPtr in_data, ::network::mojom::HostPortPairPtr in_dest_addr, ::network::mojom::DnsQueryType in_dns_query_type, SendToCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("dns_query_type"), in_dns_query_type,
                        "<value of type ::network::mojom::DnsQueryType>");
   });
#endif
...
bool RestrictedUDPSocketStubDispatch::AcceptWithResponder(
  ...
  switch (static_cast<messages::RestrictedUDPSocket>(message->header()->name)) {
    ...
    case messages::RestrictedUDPSocket::kSendTo: {
      ...
      bool success = true;
      ::mojo_base::mojom::ReadOnlyBufferPtr p_data{};
      ::network::mojom::HostPortPairPtr p_dest_addr{};
      ::network::mojom::DnsQueryType p_dns_query_type{};
...
bool RestrictedUDPSocketRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::RestrictedUDPSocket::Name_,
...
bool StructTraits<::network::mojom::RestrictedUDPSocketParams::DataView, ::network::mojom::RestrictedUDPSocketParamsPtr>::Read(
    ::network::mojom::RestrictedUDPSocketParams::DataView input,
    ::network::mojom::RestrictedUDPSocketParamsPtr* output) {
  bool success = true;
...
void RestrictedUDPSocketInterceptorForTesting::JoinGroup(::network::mojom::IPAddressPtr group_address, ::network::mojom::IPAddressPtr source_address, JoinGroupCallback callback) {
...
void RestrictedUDPSocketInterceptorForTesting::LeaveGroup(::network::mojom::IPAddressPtr group_address, ::network::mojom::IPAddressPtr source_address, LeaveGroupCallback callback) {
...
void RestrictedUDPSocketInterceptorForTesting::Send(::mojo_base::mojom::ReadOnlyBufferPtr data, SendCallback callback) {
  GetForwardingInterface()->Send(
    std::move(data)
    , std::move(callback));
}
void RestrictedUDPSocketInterceptorForTesting::SendTo(::mojo_base::mojom::ReadOnlyBufferPtr data, ::network::mojom::HostPortPairPtr dest_addr, ::network::mojom::DnsQueryType dns_query_type, SendToCallback callback) {
...
int32_t RestrictedUDPSocketAsyncWaiter::Send(
    ::mojo_base::mojom::ReadOnlyBufferPtr data) {
  int32_t async_wait_result;
...
int32_t RestrictedUDPSocketAsyncWaiter::SendTo(
    ::mojo_base::mojom::ReadOnlyBufferPtr data, ::network::mojom::HostPortPairPtr dest_addr, ::network::mojom::DnsQueryType dns_query_type) {
  int32_t async_wait_result;
