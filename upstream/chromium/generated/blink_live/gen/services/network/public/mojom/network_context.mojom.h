...
#include "services/network/public/mojom/auth.mojom-forward.h"
#include "services/network/public/mojom/cache_encryption_provider.mojom-forward.h"
#include "services/network/public/mojom/cert_verifier_service.mojom-forward.h"
#include "services/network/public/mojom/cert_verify_result.mojom-forward.h"
...
#include "services/network/public/mojom/default_credentials.mojom-forward.h"
...
#include "services/network/public/mojom/network_anonymization_key.mojom-forward.h"
...
#include "services/network/public/mojom/shared_dictionary_isolation_key.mojom-forward.h"
#include "services/network/public/mojom/shared_dictionary_usage_info.mojom-forward.h"
...
#include "services/network/public/mojom/ssl_info.mojom-forward.h"
...
// with not having this data in traces there.
  ...
  virtual void OnFallback(::network::mojom::ProxyChainPtr bad_chain, int32_t net_error) = 0;

  virtual void OnTunnelHeadersReceived(::network::mojom::ProxyChainPtr proxy_chain, uint64_t chain_index, ::network::mojom::HttpResponseHeadersPtr response_headers) = 0;
};
...
// with not having this data in traces there.
  ...
  using OnBeforeSendHeadersCallback = base::OnceCallback<void(int32_t, ::network::mojom::HttpRequestHeadersPtr)>;
  using OnBeforeSendHeadersMojoCallback = base::OnceCallback<void(int32_t, ::network::mojom::HttpRequestHeadersPtr)>;

  virtual void OnBeforeSendHeaders(::network::mojom::HttpRequestHeadersPtr headers, OnBeforeSendHeadersCallback callback) = 0;
  ...
  virtual void OnHeadersReceived(const std::string& headers, ::network::mojom::IPEndPointPtr remote_endpoint, ::network::mojom::SSLInfoPtr ssl_info, OnHeadersReceivedCallback callback) = 0;
};
...
// with not having this data in traces there.
  ...
  virtual void NotifyExternalCacheHit(const ::GURL& url, const std::string& http_method, ::network::mojom::NetworkIsolationKeyPtr key, bool include_credentials) = 0;
  ...
  virtual void ClearSharedDictionaryCacheForIsolationKey(::network::mojom::SharedDictionaryIsolationKeyPtr isolation_key, ClearSharedDictionaryCacheForIsolationKeyCallback callback) = 0;

  virtual void SetDocumentReportingEndpoints(const ::base::UnguessableToken& reporting_source, const ::url::Origin& origin, ::network::mojom::IsolationInfoPtr isolation_info, const base::flat_map<std::string, std::string>& endpoints) = 0;

  virtual void SendReportsAndRemoveSource(const ::base::UnguessableToken& reporting_source) = 0;

  virtual void QueueReport(const std::string& type, const std::string& group, const ::GURL& url, const std::optional<::base::UnguessableToken>& reporting_source, ::network::mojom::NetworkAnonymizationKeyPtr network_anonymization_key, ::mojo_base::mojom::DictionaryValuePtr body) = 0;

  virtual void QueueEnterpriseReport(const std::string& type, const std::string& group, const ::GURL& url, ::mojo_base::mojom::DictionaryValuePtr body) = 0;

  virtual void QueueSignedExchangeReport(SignedExchangeReportPtr report, ::network::mojom::NetworkAnonymizationKeyPtr network_anonymization_key) = 0;
  ...
  virtual void SetNetworkConditions(const ::base::UnguessableToken& throttling_profile_id, const ::base::UnguessableToken& throttling_client_id, std::vector<MatchedNetworkConditionsPtr> conditions) = 0;
  ...
  using CreateRestrictedUDPSocketCallback = base::OnceCallback<void(int32_t, ::network::mojom::IPEndPointPtr)>;
  using CreateRestrictedUDPSocketMojoCallback = base::OnceCallback<void(int32_t, ::network::mojom::IPEndPointPtr)>;

  virtual void CreateRestrictedUDPSocket(::network::mojom::IPEndPointPtr addr, ::network::mojom::RestrictedUDPSocketMode mode, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::network::mojom::RestrictedUDPSocketParamsPtr params, ::mojo::PendingReceiver<::network::mojom::RestrictedUDPSocket> receiver, ::mojo::PendingRemote<::network::mojom::UDPSocketListener> listener, bool allow_multicast, bool allow_source_specific_multicast, CreateRestrictedUDPSocketCallback callback) = 0;

  using CreateTCPServerSocketCallback = base::OnceCallback<void(int32_t, ::network::mojom::IPEndPointPtr)>;
  using CreateTCPServerSocketMojoCallback = base::OnceCallback<void(int32_t, ::network::mojom::IPEndPointPtr)>;

  virtual void CreateTCPServerSocket(::network::mojom::IPEndPointPtr local_addr, ::network::mojom::TCPServerSocketOptionsPtr options, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::mojo::PendingReceiver<::network::mojom::TCPServerSocket> socket, CreateTCPServerSocketCallback callback) = 0;

  using CreateTCPConnectedSocketCallback = base::OnceCallback<void(int32_t, ::network::mojom::IPEndPointPtr, ::network::mojom::IPEndPointPtr, ::mojo::ScopedDataPipeConsumerHandle, ::mojo::ScopedDataPipeProducerHandle)>;
  using CreateTCPConnectedSocketMojoCallback = base::OnceCallback<void(int32_t, ::network::mojom::IPEndPointPtr, ::network::mojom::IPEndPointPtr, ::mojo::ScopedDataPipeConsumerHandle, ::mojo::ScopedDataPipeProducerHandle)>;

  virtual void CreateTCPConnectedSocket(::network::mojom::IPEndPointPtr local_addr, ::network::mojom::AddressListPtr remote_addr_list, ::network::mojom::TCPConnectedSocketOptionsPtr tcp_connected_socket_options, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::mojo::PendingReceiver<::network::mojom::TCPConnectedSocket> socket, ::mojo::PendingRemote<::network::mojom::SocketObserver> observer, CreateTCPConnectedSocketCallback callback) = 0;

  using CreateTCPBoundSocketCallback = base::OnceCallback<void(int32_t, ::network::mojom::IPEndPointPtr)>;
  using CreateTCPBoundSocketMojoCallback = base::OnceCallback<void(int32_t, ::network::mojom::IPEndPointPtr)>;

  virtual void CreateTCPBoundSocket(::network::mojom::IPEndPointPtr local_addr, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::mojo::PendingReceiver<::network::mojom::TCPBoundSocket> socket, CreateTCPBoundSocketCallback callback) = 0;

  virtual void CreateProxyResolvingSocketFactory(::mojo::PendingReceiver<::network::mojom::ProxyResolvingSocketFactory> factory) = 0;

  virtual void LookUpProxyForURL(const ::GURL& url, ::network::mojom::NetworkAnonymizationKeyPtr network_anonymization_key, ::mojo::PendingRemote<::network::mojom::ProxyLookupClient> proxy_lookup_client) = 0;
  ...
  virtual void ResolveHost(::network::mojom::HostResolverHostPtr host, ::network::mojom::NetworkAnonymizationKeyPtr network_anonymization_key, ::network::mojom::ResolveHostParametersPtr optional_parameters, ::mojo::PendingRemote<::network::mojom::ResolveHostClient> response_client) = 0;

  virtual void CreateHostResolver(::network::mojom::DnsConfigOverridesPtr config_overrides, ::mojo::PendingReceiver<::network::mojom::HostResolver> host_resolver) = 0;

  using VerifyCertCallback = base::OnceCallback<void(int32_t, ::network::mojom::CertVerifyResultPtr, bool)>;
  using VerifyCertMojoCallback = base::OnceCallback<void(int32_t, ::network::mojom::CertVerifyResultPtr, bool)>;

  virtual void VerifyCert(::network::mojom::X509CertificatePtr certificate, ::network::mojom::HostPortPairPtr host_port, const std::string& ocsp_response, const std::string& sct_list, VerifyCertCallback callback) = 0;

  using VerifyCertForSignedExchangeCallback = base::OnceCallback<void(int32_t, ::network::mojom::CertVerifyResultPtr, bool)>;
  using VerifyCertForSignedExchangeMojoCallback = base::OnceCallback<void(int32_t, ::network::mojom::CertVerifyResultPtr, bool)>;

  virtual void VerifyCertForSignedExchange(::network::mojom::X509CertificatePtr certificate, ::network::mojom::HostPortPairPtr host_port, const std::string& ocsp_response, const std::string& sct_list, VerifyCertForSignedExchangeCallback callback) = 0;

  using Verify2QwacCertBindingCallback = base::OnceCallback<void(::network::mojom::X509CertificatePtr)>;
  using Verify2QwacCertBindingMojoCallback = base::OnceCallback<void(::network::mojom::X509CertificatePtr)>;

  virtual void Verify2QwacCertBinding(const std::string& binding, const std::string& hostname, ::network::mojom::X509CertificatePtr tls_certificate, Verify2QwacCertBindingCallback callback) = 0;
  ...
  using GetHSTSStateCallback = base::OnceCallback<void(::mojo_base::mojom::DictionaryValuePtr)>;
  using GetHSTSStateMojoCallback = base::OnceCallback<void(::mojo_base::mojom::DictionaryValuePtr)>;
  ...
  virtual void AddAuthCacheEntry(::network::mojom::AuthChallengeInfoPtr challenge, ::network::mojom::NetworkAnonymizationKeyPtr network_anonymization_key, ::network::mojom::AuthCredentialsPtr credentials, AddAuthCacheEntryCallback callback) = 0;
  ...
  virtual void VerifyCertificateForTesting(::network::mojom::X509CertificatePtr certificate, const std::string& hostname, const std::string& ocsp_response, const std::string& sct_list, VerifyCertificateForTestingCallback callback) = 0;
  ...
  using GetSharedDictionaryUsageInfoCallback = base::OnceCallback<void(std::vector<::network::mojom::SharedDictionaryUsageInfoPtr>)>;
  using GetSharedDictionaryUsageInfoMojoCallback = base::OnceCallback<void(std::vector<::network::mojom::SharedDictionaryUsageInfoPtr>)>;
  ...
  virtual void GetSharedDictionaryInfo(::network::mojom::SharedDictionaryIsolationKeyPtr isolation_key, GetSharedDictionaryInfoCallback callback) = 0;
  ...
  virtual void FlushCachedClientCertIfNeeded(::network::mojom::HostPortPairPtr host, ::network::mojom::X509CertificatePtr certificate) = 0;

  virtual void FlushMatchingCachedClientCert(::network::mojom::X509CertificatePtr certificate) = 0;
  ...
  virtual void RestrictNetworkForIds(std::vector<IdAndAllowlistedPatternsPtr> ids_to_patterns, RestrictNetworkForIdsCallback callback) = 0;

  virtual void ClearNetworkRestrictions(const std::vector<::base::UnguessableToken>& network_restrictions_ids) = 0;
  ...
  virtual void AddQuicHints(const std::vector<::url::SchemeHostPort>& origins, ::network::mojom::NetworkAnonymizationKeyPtr network_anonymization_key) = 0;
...
class  CustomProxyConnectionObserverProxy
 ...
 public:
  ...
  void OnFallback(::network::mojom::ProxyChainPtr bad_chain, int32_t net_error) final;
  
  void OnTunnelHeadersReceived(::network::mojom::ProxyChainPtr proxy_chain, uint64_t chain_index, ::network::mojom::HttpResponseHeadersPtr response_headers) final;
...
class  TrustedHeaderClientProxy
 ...
 public:
  ...
  void OnBeforeSendHeaders(::network::mojom::HttpRequestHeadersPtr headers, OnBeforeSendHeadersCallback callback) final;
  
  void OnHeadersReceived(const std::string& headers, ::network::mojom::IPEndPointPtr remote_endpoint, ::network::mojom::SSLInfoPtr ssl_info, OnHeadersReceivedCallback callback) final;
...
class  NetworkContextProxy
 ...
 public:
  ...
  void NotifyExternalCacheHit(const ::GURL& url, const std::string& http_method, ::network::mojom::NetworkIsolationKeyPtr key, bool include_credentials) final;
  ...
  void ClearSharedDictionaryCacheForIsolationKey(::network::mojom::SharedDictionaryIsolationKeyPtr isolation_key, ClearSharedDictionaryCacheForIsolationKeyCallback callback) final;
  
  void SetDocumentReportingEndpoints(const ::base::UnguessableToken& reporting_source, const ::url::Origin& origin, ::network::mojom::IsolationInfoPtr isolation_info, const base::flat_map<std::string, std::string>& endpoints) final;
  
  void SendReportsAndRemoveSource(const ::base::UnguessableToken& reporting_source) final;
  
  void QueueReport(const std::string& type, const std::string& group, const ::GURL& url, const std::optional<::base::UnguessableToken>& reporting_source, ::network::mojom::NetworkAnonymizationKeyPtr network_anonymization_key, ::mojo_base::mojom::DictionaryValuePtr body) final;
  
  void QueueEnterpriseReport(const std::string& type, const std::string& group, const ::GURL& url, ::mojo_base::mojom::DictionaryValuePtr body) final;
  
  void QueueSignedExchangeReport(SignedExchangeReportPtr report, ::network::mojom::NetworkAnonymizationKeyPtr network_anonymization_key) final;
  ...
  void SetNetworkConditions(const ::base::UnguessableToken& throttling_profile_id, const ::base::UnguessableToken& throttling_client_id, std::vector<MatchedNetworkConditionsPtr> conditions) final;
  ...
  void CreateRestrictedUDPSocket(::network::mojom::IPEndPointPtr addr, ::network::mojom::RestrictedUDPSocketMode mode, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::network::mojom::RestrictedUDPSocketParamsPtr params, ::mojo::PendingReceiver<::network::mojom::RestrictedUDPSocket> receiver, ::mojo::PendingRemote<::network::mojom::UDPSocketListener> listener, bool allow_multicast, bool allow_source_specific_multicast, CreateRestrictedUDPSocketCallback callback) final;
  
  void CreateTCPServerSocket(::network::mojom::IPEndPointPtr local_addr, ::network::mojom::TCPServerSocketOptionsPtr options, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::mojo::PendingReceiver<::network::mojom::TCPServerSocket> socket, CreateTCPServerSocketCallback callback) final;
  ...
  void CreateTCPBoundSocket(::network::mojom::IPEndPointPtr local_addr, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::mojo::PendingReceiver<::network::mojom::TCPBoundSocket> socket, CreateTCPBoundSocketCallback callback) final;
  
  void CreateProxyResolvingSocketFactory(::mojo::PendingReceiver<::network::mojom::ProxyResolvingSocketFactory> factory) final;
  
  void LookUpProxyForURL(const ::GURL& url, ::network::mojom::NetworkAnonymizationKeyPtr network_anonymization_key, ::mojo::PendingRemote<::network::mojom::ProxyLookupClient> proxy_lookup_client) final;
  ...
  void ResolveHost(::network::mojom::HostResolverHostPtr host, ::network::mojom::NetworkAnonymizationKeyPtr network_anonymization_key, ::network::mojom::ResolveHostParametersPtr optional_parameters, ::mojo::PendingRemote<::network::mojom::ResolveHostClient> response_client) final;
  
  void CreateHostResolver(::network::mojom::DnsConfigOverridesPtr config_overrides, ::mojo::PendingReceiver<::network::mojom::HostResolver> host_resolver) final;
  
  void VerifyCert(::network::mojom::X509CertificatePtr certificate, ::network::mojom::HostPortPairPtr host_port, const std::string& ocsp_response, const std::string& sct_list, VerifyCertCallback callback) final;
  
  void VerifyCertForSignedExchange(::network::mojom::X509CertificatePtr certificate, ::network::mojom::HostPortPairPtr host_port, const std::string& ocsp_response, const std::string& sct_list, VerifyCertForSignedExchangeCallback callback) final;
  
  void Verify2QwacCertBinding(const std::string& binding, const std::string& hostname, ::network::mojom::X509CertificatePtr tls_certificate, Verify2QwacCertBindingCallback callback) final;
  ...
  void AddAuthCacheEntry(::network::mojom::AuthChallengeInfoPtr challenge, ::network::mojom::NetworkAnonymizationKeyPtr network_anonymization_key, ::network::mojom::AuthCredentialsPtr credentials, AddAuthCacheEntryCallback callback) final;
  ...
  void VerifyCertificateForTesting(::network::mojom::X509CertificatePtr certificate, const std::string& hostname, const std::string& ocsp_response, const std::string& sct_list, VerifyCertificateForTestingCallback callback) final;
  ...
  void GetSharedDictionaryInfo(::network::mojom::SharedDictionaryIsolationKeyPtr isolation_key, GetSharedDictionaryInfoCallback callback) final;
  ...
  void FlushCachedClientCertIfNeeded(::network::mojom::HostPortPairPtr host, ::network::mojom::X509CertificatePtr certificate) final;
  
  void FlushMatchingCachedClientCert(::network::mojom::X509CertificatePtr certificate) final;
  
  void FlushClientCertCache() final;
  
  void RestrictNetworkForIds(std::vector<IdAndAllowlistedPatternsPtr> ids_to_patterns, RestrictNetworkForIdsCallback callback) final;
  
  void ClearNetworkRestrictions(const std::vector<::base::UnguessableToken>& network_restrictions_ids) final;
  ...
  void AddQuicHints(const std::vector<::url::SchemeHostPort>& origins, ::network::mojom::NetworkAnonymizationKeyPtr network_anonymization_key) final;
...
class  CustomProxyConfig {
 public:
  ...
  CustomProxyConfig(
      ::network::mojom::ProxyRulesPtr rules,
      bool should_override_existing_config,
      bool allow_non_idempotent_methods,
      ::network::mojom::HttpRequestHeadersPtr connect_tunnel_headers);
...
class  NetworkContextFilePaths {
 public:
  ...
  NetworkContextFilePaths(
      ::network::mojom::TransferableDirectoryPtr shared_dictionary_directory,
      ::network::mojom::TransferableDirectoryPtr http_cache_directory,
      ::network::mojom::TransferableDirectoryPtr no_vary_search_directory,
      ::network::mojom::TransferableDirectoryPtr data_directory,
      ::mojo_base::mojom::FilePathPtr unsandboxed_data_path,
      ::mojo_base::mojom::FilePathPtr cookie_database_name,
      ::mojo_base::mojom::FilePathPtr device_bound_sessions_database_name,
      ::mojo_base::mojom::FilePathPtr trust_token_database_name,
      ::mojo_base::mojom::FilePathPtr http_server_properties_file_name,
      ::mojo_base::mojom::FilePathPtr transport_security_persister_file_name,
      ::mojo_base::mojom::FilePathPtr reporting_and_nel_store_database_name,
      ::mojo_base::mojom::FilePathPtr sct_auditing_pending_reports_file_name,
...
class  NetworkContextParams {
 public:
  ...
  NetworkContextParams(
      ...
      ::mojo::PendingRemote<::network::mojom::CacheEncryptionProvider> encryption_provider,
      ...
      ::network::mojom::ProxyConfigWithAnnotationPtr initial_proxy_config,
      ...
      std::vector<::network::mojom::SchemefulSitePtr> device_bound_sessions_restricted_sites,
      int64_t bound_network,
      std::optional<int64_t> quic_idle_connection_timeout_seconds,
      bool enable_encrypted_http_cache,
      ::mojo::PendingRemote<::unexportable_keys::mojom::UnexportableKeyService> bound_sessions_unexportable_key_service,
      ::variations::mojom::VariationsHeadersPtr initial_variations_headers);
...
MatchedNetworkConditions& operator=(const MatchedNetworkConditions&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        MatchedNetworkConditions::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        MatchedNetworkConditions::DataView, std::vector<uint8_t>>(input);
  }
...
class  SharedDictionaryInfo {
 public:
  ...
  SharedDictionaryInfo(
      ...
      uint64_t size,
      ::network::mojom::SHA256HashValuePtr hash);
...
class  SignedExchangeReport {
 public:
  ...
  SignedExchangeReport(
      ...
      ::network::mojom::IPAddressPtr server_ip_address,
...
class  URLLoaderFactoryParams {
 public:
  ...
  URLLoaderFactoryParams(
      ::network::mojom::OriginatingProcessIdPtr process_id,
      ...
      ::network::mojom::IsolationInfoPtr isolation_info,
      ...
      ::network::mojom::CookieSettingOverridesPtr cookie_setting_overrides,
      ::network::mojom::CookieSettingOverridesPtr devtools_cookie_setting_overrides,
...
class  IdAndAllowlistedPatterns {
 public:
  ...
  IdAndAllowlistedPatterns(
      ...
      ::network::mojom::ConnectionAllowlistsPtr allowlists);
...
IdAndAllowlistedPatterns& operator=(const IdAndAllowlistedPatterns&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        IdAndAllowlistedPatterns::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        IdAndAllowlistedPatterns::DataView, std::vector<uint8_t>>(input);
  }
...
struct  StructTraits<::network::mojom::NetworkContextParams::DataView,
  ...
  static  decltype(::network::mojom::NetworkContextParams::encryption_provider)& encryption_provider(
       ::network::mojom::NetworkContextParamsPtr& input) {
  ...
  static const decltype(::network::mojom::NetworkContextParams::device_bound_sessions_restricted_sites)& device_bound_sessions_restricted_sites(
      const ::network::mojom::NetworkContextParamsPtr& input) {
  ...
  static decltype(::network::mojom::NetworkContextParams::enable_encrypted_http_cache) enable_encrypted_http_cache(
      const ::network::mojom::NetworkContextParamsPtr& input) {
    return input->enable_encrypted_http_cache;
  }

  static  decltype(::network::mojom::NetworkContextParams::bound_sessions_unexportable_key_service)& bound_sessions_unexportable_key_service(
       ::network::mojom::NetworkContextParamsPtr& input) {
    return input->bound_sessions_unexportable_key_service;
  }

  static const decltype(::network::mojom::NetworkContextParams::initial_variations_headers)& initial_variations_headers(
      const ::network::mojom::NetworkContextParamsPtr& input) {
...
struct  StructTraits<::network::mojom::NetworkConditions::DataView,
  ...
  static const decltype(::network::mojom::NetworkConditions::rule_id)& rule_id(
      const ::network::mojom::NetworkConditionsPtr& input) {
...
template <>
struct  StructTraits<::network::mojom::MatchedNetworkConditions::DataView,
                                         ::network::mojom::MatchedNetworkConditionsPtr> {
  static bool IsNull(const ::network::mojom::MatchedNetworkConditionsPtr& input) { return !input; }
  static void SetToNull(::network::mojom::MatchedNetworkConditionsPtr* output) { output->reset(); }

  static const decltype(::network::mojom::MatchedNetworkConditions::pattern)& pattern(
      const ::network::mojom::MatchedNetworkConditionsPtr& input) {
    return input->pattern;
  }

  static const decltype(::network::mojom::MatchedNetworkConditions::conditions)& conditions(
      const ::network::mojom::MatchedNetworkConditionsPtr& input) {
    return input->conditions;
  }

  static bool Read(::network::mojom::MatchedNetworkConditions::DataView input, ::network::mojom::MatchedNetworkConditionsPtr* output);
};
...
struct  StructTraits<::network::mojom::URLLoaderFactoryParams::DataView,
  ...
  static const decltype(::network::mojom::URLLoaderFactoryParams::process_id)& process_id(
  ...
  static decltype(::network::mojom::URLLoaderFactoryParams::is_main_frame_origin_recently_accessed) is_main_frame_origin_recently_accessed(
      const ::network::mojom::URLLoaderFactoryParamsPtr& input) {
    return input->is_main_frame_origin_recently_accessed;
  }

  static const decltype(::network::mojom::URLLoaderFactoryParams::network_restrictions_id)& network_restrictions_id(
      const ::network::mojom::URLLoaderFactoryParamsPtr& input) {
    return input->network_restrictions_id;
  }

  static decltype(::network::mojom::URLLoaderFactoryParams::prefer_factory_site_for_cookies) prefer_factory_site_for_cookies(
      const ::network::mojom::URLLoaderFactoryParamsPtr& input) {
...
template <>
struct  StructTraits<::network::mojom::IdAndAllowlistedPatterns::DataView,
                                         ::network::mojom::IdAndAllowlistedPatternsPtr> {
  static bool IsNull(const ::network::mojom::IdAndAllowlistedPatternsPtr& input) { return !input; }
  static void SetToNull(::network::mojom::IdAndAllowlistedPatternsPtr* output) { output->reset(); }

  static const decltype(::network::mojom::IdAndAllowlistedPatterns::network_restrictions_id)& network_restrictions_id(
      const ::network::mojom::IdAndAllowlistedPatternsPtr& input) {
    return input->network_restrictions_id;
  }

  static const decltype(::network::mojom::IdAndAllowlistedPatterns::allowlists)& allowlists(
      const ::network::mojom::IdAndAllowlistedPatternsPtr& input) {
    return input->allowlists;
  }

  static bool Read(::network::mojom::IdAndAllowlistedPatterns::DataView input, ::network::mojom::IdAndAllowlistedPatternsPtr* output);
};
