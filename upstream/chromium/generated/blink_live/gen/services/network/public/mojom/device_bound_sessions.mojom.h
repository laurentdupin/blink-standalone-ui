...
// with not having this data in traces there.
  ...
  using GetAllSessionsCallback = base::OnceCallback<void(std::vector<DeviceBoundSessionKeyPtr>)>;
  using GetAllSessionsMojoCallback = base::OnceCallback<void(std::vector<DeviceBoundSessionKeyPtr>)>;
  ...
  virtual void DeleteAllSessions(DeviceBoundSessionDeletionReason reason, std::optional<::base::Time> created_after_time, std::optional<::base::Time> created_before_time, ::network::mojom::ClearDataFilterPtr filter, DeleteAllSessionsCallback callback) = 0;
  ...
  using CreateBoundSessionsCallback = base::OnceCallback<void(const std::vector<DeviceBoundSessionError>&, std::vector<::network::mojom::CookieInclusionStatusPtr>)>;
  using CreateBoundSessionsMojoCallback = base::OnceCallback<void(const std::vector<DeviceBoundSessionError>&, std::vector<::network::mojom::CookieInclusionStatusPtr>)>;

  virtual void CreateBoundSessions(std::vector<DeviceBoundSessionParamsPtr> params, const std::vector<uint8_t>& wrapped_key, std::vector<::network::mojom::CanonicalCookiePtr> cookies_to_set, ::network::mojom::CookieOptionsPtr cookie_options, CreateBoundSessionsCallback callback) = 0;
};
...
// with not having this data in traces there.
  ...
  virtual void AddDeviceBoundSessionDisplays(std::vector<DeviceBoundSessionDisplayPtr> session_displays) = 0;
};
...
class  DeviceBoundSessionManagerProxy
 ...
 public:
  ...
  void DeleteAllSessions(DeviceBoundSessionDeletionReason reason, std::optional<::base::Time> created_after_time, std::optional<::base::Time> created_before_time, ::network::mojom::ClearDataFilterPtr filter, DeleteAllSessionsCallback callback) final;
  ...
  void CreateBoundSessions(std::vector<DeviceBoundSessionParamsPtr> params, const std::vector<uint8_t>& wrapped_key, std::vector<::network::mojom::CanonicalCookiePtr> cookies_to_set, ::network::mojom::CookieOptionsPtr cookie_options, CreateBoundSessionsCallback callback) final;
...
class  DeviceBoundSessionEventObserverProxy
 ...
 public:
  ...
  void AddDeviceBoundSessionDisplays(std::vector<DeviceBoundSessionDisplayPtr> session_displays) final;
...
class  DeviceBoundSessionKey {
 public:
  ...
  DeviceBoundSessionKey(
      ::network::mojom::SchemefulSitePtr site,
      const std::string& id);
...
class  DeviceBoundSessionInclusionRulesDisplay {
 public:
  ...
  DeviceBoundSessionInclusionRulesDisplay(
      const std::string& origin,
      bool include_site,
      std::vector<DeviceBoundSessionUrlRuleDisplayPtr> url_rules);
...
class  DeviceBoundSessionDisplay {
 public:
  ...
  DeviceBoundSessionDisplay(
      ...
      std::vector<DeviceBoundSessionCookieCravingDisplayPtr> cookie_cravings,
...
struct  UnionTraits<::network::mojom::DeviceBoundSessionEventTypeDetails::DataView,
  ...
  static const ::network::mojom::DeviceBoundSessionCreationDetailsPtr& creation(const ::network::mojom::DeviceBoundSessionEventTypeDetailsPtr& input) {
    return input->get_creation();
  }

  static const ::network::mojom::DeviceBoundSessionRefreshDetailsPtr& refresh(const ::network::mojom::DeviceBoundSessionEventTypeDetailsPtr& input) {
    return input->get_refresh();
  }

  static const ::network::mojom::DeviceBoundSessionTerminationDetailsPtr& termination(const ::network::mojom::DeviceBoundSessionEventTypeDetailsPtr& input) {
    return input->get_termination();
  }

  static const ::network::mojom::DeviceBoundSessionChallengeDetailsPtr& challenge(const ::network::mojom::DeviceBoundSessionEventTypeDetailsPtr& input) {
