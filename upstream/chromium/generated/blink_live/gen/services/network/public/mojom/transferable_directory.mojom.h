...
class  TransferableDirectory {
 public:
  ...
  const ::mojo_base::mojom::FilePathPtr& get_path() const {
    CHECK(tag_ == Tag::kPath);
    return data_.path;
  }
  ::mojo_base::mojom::FilePathPtr& get_path() {
    CHECK(tag_ == Tag::kPath);
    return data_.path;
  }
  void set_path(::mojo_base::mojom::FilePathPtr path);
...
struct  UnionTraits<::network::mojom::TransferableDirectory::DataView,
  ...
  static const ::mojo_base::mojom::FilePathPtr& path(const ::network::mojom::TransferableDirectoryPtr& input) {
