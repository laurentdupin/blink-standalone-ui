...
static_assert(sizeof(WebTransport_GetStats_Params_Data) == 8,
              "Bad sizeof(WebTransport_GetStats_Params_Data)");
...
static_assert(sizeof(WebTransport_GetStats_ResponseParams_Data) == 16,
              "Bad sizeof(WebTransport_GetStats_ResponseParams_Data)");
...
class  WebTransportHandshakeClient_OnBeforeConnect_Params_Data {
 public:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);

  mojo::internal::StructHeader header_;
  mojo::internal::Pointer<::network::mojom::internal::IPEndPoint_Data> server_address;

 private:
  friend class mojo::internal::MessageFragment<WebTransportHandshakeClient_OnBeforeConnect_Params_Data>;

  WebTransportHandshakeClient_OnBeforeConnect_Params_Data();
  ~WebTransportHandshakeClient_OnBeforeConnect_Params_Data() = delete;
};
static_assert(sizeof(WebTransportHandshakeClient_OnBeforeConnect_Params_Data) == 16,
              "Bad sizeof(WebTransportHandshakeClient_OnBeforeConnect_Params_Data)");
class  WebTransportHandshakeClient_OnConnectionEstablished_Params_Data {
 public:
  ...
  mojo::internal::Pointer<mojo::internal::String_Data> selected_application_protocol;
...
static_assert(sizeof(WebTransportHandshakeClient_OnConnectionEstablished_Params_Data) == 48,
...
class WebTransport_GetStats_ParamsDataView {
 public:
  ...
  WebTransport_GetStats_ParamsDataView(
      internal::WebTransport_GetStats_Params_Data* data,
      mojo::Message* message)
      : data_(data) {}
...
class WebTransport_GetStats_ResponseParamsDataView {
 public:
  ...
  WebTransport_GetStats_ResponseParamsDataView(
      internal::WebTransport_GetStats_ResponseParams_Data* data,
      mojo::Message* message)
      : data_(data), message_(message) {}
...
class WebTransportHandshakeClient_OnBeforeConnect_ParamsDataView {
 public:
  WebTransportHandshakeClient_OnBeforeConnect_ParamsDataView() = default;

  WebTransportHandshakeClient_OnBeforeConnect_ParamsDataView(
      internal::WebTransportHandshakeClient_OnBeforeConnect_Params_Data* data,
      mojo::Message* message)
      : data_(data), message_(message) {}

  bool is_null() const { return !data_; }
  inline void GetServerAddressDataView(
      ::network::mojom::IPEndPointDataView* output);

  template <typename UserType>
  [[nodiscard]] bool ReadServerAddress(UserType* output) {
    
    auto* pointer = data_->server_address.Get();
    return mojo::internal::Deserialize<::network::mojom::IPEndPointDataView>(
        pointer, output, message_);
  }
 private:
  internal::WebTransportHandshakeClient_OnBeforeConnect_Params_Data* data_ = nullptr;
  mojo::Message* message_ = nullptr;
};
...
class WebTransportHandshakeClient_OnConnectionEstablished_ParamsDataView {
 public:
  ...
  inline void GetSelectedApplicationProtocolDataView(
      mojo::StringDataView* output);

  template <typename UserType>
  [[nodiscard]] bool ReadSelectedApplicationProtocol(UserType* output) {
    
static_assert(
    mojo::internal::IsValidUserTypeForOptionalValue<
        mojo::StringDataView, UserType>(),
    "Attempting to read the optional `selected_application_protocol` field into a type which "
    "cannot represent a null value. Either wrap the destination object "
    "with std::optional, ensure that any corresponding "
    "{Struct/Union/Array/String}Traits define the necessary IsNull and "
    "SetToNull methods, or use `MaybeReadSelectedApplicationProtocol` instead "
    "of `ReadSelectedApplicationProtocol if you're fine with null values being "
    "silently ignored in this case.");
    auto* pointer = data_->selected_application_protocol.Get();
...
inline void WebTransportHandshakeClient_OnBeforeConnect_ParamsDataView::GetServerAddressDataView(
    ::network::mojom::IPEndPointDataView* output) {
  auto pointer = data_->server_address.Get();
...
inline void WebTransportHandshakeClient_OnConnectionEstablished_ParamsDataView::GetSelectedApplicationProtocolDataView(
    mojo::StringDataView* output) {
  auto pointer = data_->selected_application_protocol.Get();
