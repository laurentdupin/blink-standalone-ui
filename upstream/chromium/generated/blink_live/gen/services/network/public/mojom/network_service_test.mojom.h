...
#include "services/network/public/mojom/transferable_socket.mojom-forward.h"
...
// with not having this data in traces there.
  ...
  using ReadDataMojoCallback = base::OnceCallback<void(const std::vector<uint8_t>&, int32_t)>;
  ...
  using ReadSparseDataMojoCallback = base::OnceCallback<void(const std::vector<uint8_t>&, int32_t)>;
...
class NetworkServiceTest
 ...
 public:
  ...
  enum MethodMinVersions : uint32_t {
    ...
    kHasRawHeadersAccessMinVersion = 0,
  };
...
// with not having this data in traces there.
  ...
  struct HasRawHeadersAccess_Sym {
    NOINLINE static uint32_t IPCStableHash();
  };
#endif // !BUILDFLAG(IS_FUCHSIA)
  ...
  virtual void SimulateNetworkQualityChange(::network::mojom::EffectiveConnectionType type, SimulateNetworkQualityChangeCallback callback) = 0;
  ...
  virtual bool MockCertVerifierAddResultForCertAndHost(::network::mojom::X509CertificatePtr cert, const std::string& host_pattern, ::network::mojom::CertVerifyResultPtr verify_result, int32_t rv);
  ...
  virtual void MockCertVerifierAddResultForCertAndHost(::network::mojom::X509CertificatePtr cert, const std::string& host_pattern, ::network::mojom::CertVerifyResultPtr verify_result, int32_t rv, MockCertVerifierAddResultForCertAndHostCallback callback) = 0;
  ...
  virtual bool SetTestDohConfig(::network::mojom::SecureDnsMode secure_dns_mode, ::network::mojom::DnsOverHttpsConfigPtr doh_config);
  using SetTestDohConfigCallback = base::OnceCallback<void()>;
  using SetTestDohConfigMojoCallback = base::OnceCallback<void()>;

  virtual void SetTestDohConfig(::network::mojom::SecureDnsMode secure_dns_mode, ::network::mojom::DnsOverHttpsConfigPtr doh_config, SetTestDohConfigCallback callback) = 0;
  ...
  virtual bool GetLatestMemoryPressureLevel(::mojo_base::mojom::MemoryPressureLevel* out_memory_pressure_level);
  using GetLatestMemoryPressureLevelCallback = base::OnceCallback<void(::mojo_base::mojom::MemoryPressureLevel)>;
  using GetLatestMemoryPressureLevelMojoCallback = base::OnceCallback<void(::mojo_base::mojom::MemoryPressureLevel)>;
  ...
  using GetEnvironmentVariableValueMojoCallback = base::OnceCallback<void(const std::string&)>;
  ...
  virtual void OpenFile(::mojo_base::mojom::FilePathPtr path, OpenFileCallback callback) = 0;

  using EnumerateFilesCallback = base::OnceCallback<void(std::vector<::network::mojom::FileEnumerationEntryPtr>, bool)>;
  using EnumerateFilesMojoCallback = base::OnceCallback<void(std::vector<::network::mojom::FileEnumerationEntryPtr>, bool)>;

  virtual void EnumerateFiles(::mojo_base::mojom::FilePathPtr path, ::mojo::PendingRemote<::network::mojom::HttpCacheBackendFileOperationsFactory> factory, EnumerateFilesCallback callback) = 0;
  ...
  virtual void CreateSimpleCache(::mojo::PendingRemote<::network::mojom::HttpCacheBackendFileOperationsFactory> factory, ::mojo_base::mojom::FilePathPtr path, bool reset, CreateSimpleCacheCallback callback) = 0;
  ...
  virtual void MakeRequestToServer(::network::mojom::TransferableSocketPtr s, ::network::mojom::IPEndPointPtr endpoint, MakeRequestToServerCallback callback) = 0;

  using ResolveOwnHostnameWithSystemDnsCallback = base::OnceCallback<void(::network::mojom::AddressListPtr, int32_t, int32_t)>;
  using ResolveOwnHostnameWithSystemDnsMojoCallback = base::OnceCallback<void(::network::mojom::AddressListPtr, int32_t, int32_t)>;
  ...
  virtual bool HasRawHeadersAccess(uint32_t process_id, const ::GURL& url, bool* out_result);
  using HasRawHeadersAccessCallback = base::OnceCallback<void(bool)>;
  using HasRawHeadersAccessMojoCallback = base::OnceCallback<void(bool)>;

  virtual void HasRawHeadersAccess(uint32_t process_id, const ::GURL& url, HasRawHeadersAccessCallback callback) = 0;
};
...
class  NetworkServiceTestProxy
 ...
 public:
  ...
  void SimulateNetworkQualityChange(::network::mojom::EffectiveConnectionType type, SimulateNetworkQualityChangeCallback callback) final;
  ...
  bool MockCertVerifierAddResultForCertAndHost(::network::mojom::X509CertificatePtr cert, const std::string& host_pattern, ::network::mojom::CertVerifyResultPtr verify_result, int32_t rv) final;
  
  void MockCertVerifierAddResultForCertAndHost(::network::mojom::X509CertificatePtr cert, const std::string& host_pattern, ::network::mojom::CertVerifyResultPtr verify_result, int32_t rv, MockCertVerifierAddResultForCertAndHostCallback callback) final;
  ...
  bool SetTestDohConfig(::network::mojom::SecureDnsMode secure_dns_mode, ::network::mojom::DnsOverHttpsConfigPtr doh_config) final;
  
  void SetTestDohConfig(::network::mojom::SecureDnsMode secure_dns_mode, ::network::mojom::DnsOverHttpsConfigPtr doh_config, SetTestDohConfigCallback callback) final;
  
  void CrashOnResolveHost(const std::string& host) final;
  
  void CrashOnGetCookieList() final;
  
  bool GetLatestMemoryPressureLevel(::mojo_base::mojom::MemoryPressureLevel* out_memory_pressure_level) final;
  ...
  void OpenFile(::mojo_base::mojom::FilePathPtr path, OpenFileCallback callback) final;
  
  void EnumerateFiles(::mojo_base::mojom::FilePathPtr path, ::mojo::PendingRemote<::network::mojom::HttpCacheBackendFileOperationsFactory> factory, EnumerateFilesCallback callback) final;
  
  void CreateSimpleCache(::mojo::PendingRemote<::network::mojom::HttpCacheBackendFileOperationsFactory> factory, ::mojo_base::mojom::FilePathPtr path, bool reset, CreateSimpleCacheCallback callback) final;
  
  void MakeRequestToServer(::network::mojom::TransferableSocketPtr s, ::network::mojom::IPEndPointPtr endpoint, MakeRequestToServerCallback callback) final;
  ...
  bool HasRawHeadersAccess(uint32_t process_id, const ::GURL& url, bool* out_result) final;
  
  void HasRawHeadersAccess(uint32_t process_id, const ::GURL& url, HasRawHeadersAccessCallback callback) final;
 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        Rule::DataView, std::vector<uint8_t>, send_validation>(input);
  }
