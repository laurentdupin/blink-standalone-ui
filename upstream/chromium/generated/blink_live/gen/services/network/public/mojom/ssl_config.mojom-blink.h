...
class  SSLConfig {
 public:
  ...
  SSLConfig(
      ...
      ::blink::Vector<uint16_t> disabled_cipher_suites,
      bool tls13_cipher_prefer_aes_256,
      ::blink::Vector<::blink::String> client_cert_pooling_policy,
      SSLNamedGroupsPreset named_groups_preset,
      bool ech_enabled,
      ::blink::Vector<::blink::Vector<uint8_t>> trust_anchor_ids,
      ::blink::Vector<::blink::Vector<uint8_t>> mtc_trust_anchor_ids,
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SSLConfig::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SSLConfig::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::network::mojom::blink::SSLConfig::DataView,
  ...
  static decltype(::network::mojom::blink::SSLConfig::tls13_cipher_prefer_aes_256) tls13_cipher_prefer_aes_256(
      const ::network::mojom::blink::SSLConfigPtr& input) {
  ...
  static decltype(::network::mojom::blink::SSLConfig::named_groups_preset) named_groups_preset(
      const ::network::mojom::blink::SSLConfigPtr& input) {
    return input->named_groups_preset;
  }

  static decltype(::network::mojom::blink::SSLConfig::ech_enabled) ech_enabled(
      const ::network::mojom::blink::SSLConfigPtr& input) {
    return input->ech_enabled;
  }

  static const decltype(::network::mojom::blink::SSLConfig::trust_anchor_ids)& trust_anchor_ids(
      const ::network::mojom::blink::SSLConfigPtr& input) {
    return input->trust_anchor_ids;
  }

  static const decltype(::network::mojom::blink::SSLConfig::mtc_trust_anchor_ids)& mtc_trust_anchor_ids(
      const ::network::mojom::blink::SSLConfigPtr& input) {
    return input->mtc_trust_anchor_ids;
  }

  static decltype(::network::mojom::blink::SSLConfig::mtc_update_time_seconds) mtc_update_time_seconds(
      const ::network::mojom::blink::SSLConfigPtr& input) {
