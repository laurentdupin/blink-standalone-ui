...
template <>
struct  StructTraits<::network::mojom::blink::TransferableSocket::DataView,
                                         ::network::mojom::blink::TransferableSocketPtr> {
  static bool IsNull(const ::network::mojom::blink::TransferableSocketPtr& input) { return !input; }
  static void SetToNull(::network::mojom::blink::TransferableSocketPtr* output) { output->reset(); }

  static  decltype(::network::mojom::blink::TransferableSocket::socket)& socket(
       ::network::mojom::blink::TransferableSocketPtr& input) {
    return input->socket;
  }
