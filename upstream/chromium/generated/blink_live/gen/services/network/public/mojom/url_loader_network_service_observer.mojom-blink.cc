...
LoadInfo::LoadInfo(
    ...
    const ::blink::String& state_param_in,
...
uint32_t ClientCertificateResponder::ContinueWithCertificate_Sym::IPCStableHash() {
  ...
  static constexpr uint32_t kHash = 0x0a33248f;  // IPCStableHash for network::mojom::ClientCertificateResponder::ContinueWithCertificate
...
uint32_t ClientCertificateResponder::ContinueWithoutCertificate_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xd7a2be46;  // IPCStableHash for network::mojom::ClientCertificateResponder::ContinueWithoutCertificate
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t ClientCertificateResponder::CancelRequest_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x1ebd7b10;  // IPCStableHash for network::mojom::ClientCertificateResponder::CancelRequest
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void ClientCertificateResponderProxy::ContinueWithCertificate(
    const ::scoped_refptr<::net::X509Certificate>& in_x509_certificate, const ::blink::String& in_provider_name, const ::blink::Vector<uint16_t>& in_algorithm_preferences, ::mojo::PendingRemote<SSLPrivateKey> in_ssl_private_key) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  mojo::Message message(
      std::to_underlying(messages::ClientCertificateResponder::kContinueWithCertificate), kFlags, estimated_payload_size);
  ...
  mojo::internal::Serialize<mojo::ArrayDataView<uint16_t>>(
    in_algorithm_preferences,
    algorithm_preferences_fragment,
...
void ClientCertificateResponderProxy::ContinueWithoutCertificate(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::ClientCertificateResponder::kContinueWithoutCertificate), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void ClientCertificateResponderProxy::CancelRequest(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::ClientCertificateResponder::kCancelRequest), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool ClientCertificateResponderStubDispatch::Accept(
  ...
  switch (static_cast<messages::ClientCertificateResponder>(message->header()->name)) {
    case messages::ClientCertificateResponder::kContinueWithCertificate: {
      ...
      ::blink::String p_provider_name{};
      ::blink::Vector<uint16_t> p_algorithm_preferences{};
...
bool ClientCertificateResponderRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::blink::ClientCertificateResponder::Name_,
    kClientCertificateResponderValidationInfo);
}
...
uint32_t SSLPrivateKey::Sign_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xdbf1633b;  // IPCStableHash for network::mojom::SSLPrivateKey::Sign
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void SSLPrivateKeyProxy::Sign(
    uint16_t in_algorithm, const ::blink::Vector<uint8_t>& in_input, SignCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::SSLPrivateKey::kSign), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
class SSLPrivateKey_Sign_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      int32_t in_net_error, const ::blink::Vector<uint8_t>& in_signature);
};
...
bool SSLPrivateKey_Sign_ForwardToCallback::Accept(
  ...
  bool success = true;
  int32_t p_net_error{};
  ::blink::Vector<uint8_t> p_signature{};
...
bool SSLPrivateKeyRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::blink::SSLPrivateKey::Name_,
    kSSLPrivateKeyValidationInfo);
}
...
uint32_t AuthChallengeResponder::OnAuthCredentials_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xd5cb0275;  // IPCStableHash for network::mojom::AuthChallengeResponder::OnAuthCredentials
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void AuthChallengeResponderProxy::OnAuthCredentials(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::AuthChallengeResponder::kOnAuthCredentials), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool AuthChallengeResponderRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::blink::AuthChallengeResponder::Name_,
    kAuthChallengeResponderValidationInfo);
}
...
URLLoaderNetworkServiceObserver::IPCStableHashFunction URLLoaderNetworkServiceObserver::MessageToMethodInfo_(mojo::Message& message) {
  ...
  switch (static_cast<messages::URLLoaderNetworkServiceObserver>(message.name())) {
    ...
    case messages::URLLoaderNetworkServiceObserver::kOnLocalNetworkAccessPermissionRequired: {
      return &URLLoaderNetworkServiceObserver::OnLocalNetworkAccessPermissionRequired_Sym::IPCStableHash;
    }
    case messages::URLLoaderNetworkServiceObserver::kOnPlatformLocalNetworkPermissionRequired: {
      return &URLLoaderNetworkServiceObserver::OnPlatformLocalNetworkPermissionRequired_Sym::IPCStableHash;
    }
    ...
    case messages::URLLoaderNetworkServiceObserver::kOnAdAuctionEventRecordHeaderReceived: {
      return &URLLoaderNetworkServiceObserver::OnAdAuctionEventRecordHeaderReceived_Sym::IPCStableHash;
    }
    case messages::URLLoaderNetworkServiceObserver::kClone: {
      return &URLLoaderNetworkServiceObserver::Clone_Sym::IPCStableHash;
    }
    case messages::URLLoaderNetworkServiceObserver::kOnWebSocketConnectedToLocalNetwork: {
      return &URLLoaderNetworkServiceObserver::OnWebSocketConnectedToLocalNetwork_Sym::IPCStableHash;
    }
    case messages::URLLoaderNetworkServiceObserver::kOnUrlLoaderConnectedToLocalNetwork: {
      return &URLLoaderNetworkServiceObserver::OnUrlLoaderConnectedToLocalNetwork_Sym::IPCStableHash;
    }
  }
#endif  // !BUILDFLAG(IS_FUCHSIA)
  return nullptr;
...
const char* URLLoaderNetworkServiceObserver::MessageToMethodName_(mojo::Message& message) {
  ...
  if (!is_response) {
    switch (static_cast<messages::URLLoaderNetworkServiceObserver>(message.name())) {
      ...
      case messages::URLLoaderNetworkServiceObserver::kOnLocalNetworkAccessPermissionRequired:
            return "Receive network::mojom::URLLoaderNetworkServiceObserver::OnLocalNetworkAccessPermissionRequired";
      case messages::URLLoaderNetworkServiceObserver::kOnPlatformLocalNetworkPermissionRequired:
            return "Receive network::mojom::URLLoaderNetworkServiceObserver::OnPlatformLocalNetworkPermissionRequired";
      case messages::URLLoaderNetworkServiceObserver::kOnClearSiteData:
      ...
      case messages::URLLoaderNetworkServiceObserver::kOnAdAuctionEventRecordHeaderReceived:
            return "Receive network::mojom::URLLoaderNetworkServiceObserver::OnAdAuctionEventRecordHeaderReceived";
      case messages::URLLoaderNetworkServiceObserver::kClone:
            return "Receive network::mojom::URLLoaderNetworkServiceObserver::Clone";
      case messages::URLLoaderNetworkServiceObserver::kOnWebSocketConnectedToLocalNetwork:
            return "Receive network::mojom::URLLoaderNetworkServiceObserver::OnWebSocketConnectedToLocalNetwork";
      case messages::URLLoaderNetworkServiceObserver::kOnUrlLoaderConnectedToLocalNetwork:
            return "Receive network::mojom::URLLoaderNetworkServiceObserver::OnUrlLoaderConnectedToLocalNetwork";
    }
  } else {
    switch (static_cast<messages::URLLoaderNetworkServiceObserver>(message.name())) {
      case messages::URLLoaderNetworkServiceObserver::kOnSSLCertificateError:
      ...
      case messages::URLLoaderNetworkServiceObserver::kOnLocalNetworkAccessPermissionRequired:
            return "Receive reply network::mojom::URLLoaderNetworkServiceObserver::OnLocalNetworkAccessPermissionRequired";
      case messages::URLLoaderNetworkServiceObserver::kOnPlatformLocalNetworkPermissionRequired:
            return "Receive reply network::mojom::URLLoaderNetworkServiceObserver::OnPlatformLocalNetworkPermissionRequired";
      case messages::URLLoaderNetworkServiceObserver::kOnClearSiteData:
      ...
      case messages::URLLoaderNetworkServiceObserver::kOnAdAuctionEventRecordHeaderReceived:
            return "Receive reply network::mojom::URLLoaderNetworkServiceObserver::OnAdAuctionEventRecordHeaderReceived";
      case messages::URLLoaderNetworkServiceObserver::kClone:
            return "Receive reply network::mojom::URLLoaderNetworkServiceObserver::Clone";
      case messages::URLLoaderNetworkServiceObserver::kOnWebSocketConnectedToLocalNetwork:
            return "Receive reply network::mojom::URLLoaderNetworkServiceObserver::OnWebSocketConnectedToLocalNetwork";
      case messages::URLLoaderNetworkServiceObserver::kOnUrlLoaderConnectedToLocalNetwork:
            return "Receive reply network::mojom::URLLoaderNetworkServiceObserver::OnUrlLoaderConnectedToLocalNetwork";
    }
  }
  return "Receive unknown mojo message";
#else
...
uint32_t URLLoaderNetworkServiceObserver::OnSSLCertificateError_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x0da13f2f;  // IPCStableHash for network::mojom::URLLoaderNetworkServiceObserver::OnSSLCertificateError
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t URLLoaderNetworkServiceObserver::OnCertificateRequested_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x6992b5d9;  // IPCStableHash for network::mojom::URLLoaderNetworkServiceObserver::OnCertificateRequested
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t URLLoaderNetworkServiceObserver::OnAuthRequired_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x65dc9100;  // IPCStableHash for network::mojom::URLLoaderNetworkServiceObserver::OnAuthRequired
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t URLLoaderNetworkServiceObserver::OnLocalNetworkAccessPermissionRequired_Sym::IPCStableHash() {
  // This method's address is used for identifying the mojo method name after
  // symbolization. So each IPCStableHash should have a unique address.
  // We cannot use NO_CODE_FOLDING() here - it relies on the uniqueness of
  // __LINE__ value, which is not unique across different mojo modules.
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x53ca4916;  // IPCStableHash for network::mojom::URLLoaderNetworkServiceObserver::OnLocalNetworkAccessPermissionRequired
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t URLLoaderNetworkServiceObserver::OnPlatformLocalNetworkPermissionRequired_Sym::IPCStableHash() {
  // This method's address is used for identifying the mojo method name after
  // symbolization. So each IPCStableHash should have a unique address.
  // We cannot use NO_CODE_FOLDING() here - it relies on the uniqueness of
  // __LINE__ value, which is not unique across different mojo modules.
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x3d6957a5;  // IPCStableHash for network::mojom::URLLoaderNetworkServiceObserver::OnPlatformLocalNetworkPermissionRequired
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t URLLoaderNetworkServiceObserver::OnClearSiteData_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x4894337f;  // IPCStableHash for network::mojom::URLLoaderNetworkServiceObserver::OnClearSiteData
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t URLLoaderNetworkServiceObserver::OnLoadingStateUpdate_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xba76eccb;  // IPCStableHash for network::mojom::URLLoaderNetworkServiceObserver::OnLoadingStateUpdate
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t URLLoaderNetworkServiceObserver::OnDataUseUpdate_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x29bb842d;  // IPCStableHash for network::mojom::URLLoaderNetworkServiceObserver::OnDataUseUpdate
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t URLLoaderNetworkServiceObserver::OnSharedStorageHeaderReceived_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x67fa2679;  // IPCStableHash for network::mojom::URLLoaderNetworkServiceObserver::OnSharedStorageHeaderReceived
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t URLLoaderNetworkServiceObserver::OnAdAuctionEventRecordHeaderReceived_Sym::IPCStableHash() {
  // This method's address is used for identifying the mojo method name after
  // symbolization. So each IPCStableHash should have a unique address.
  // We cannot use NO_CODE_FOLDING() here - it relies on the uniqueness of
  // __LINE__ value, which is not unique across different mojo modules.
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x12fba543;  // IPCStableHash for network::mojom::URLLoaderNetworkServiceObserver::OnAdAuctionEventRecordHeaderReceived
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t URLLoaderNetworkServiceObserver::Clone_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x35f0b7e4;  // IPCStableHash for network::mojom::URLLoaderNetworkServiceObserver::Clone
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t URLLoaderNetworkServiceObserver::OnWebSocketConnectedToLocalNetwork_Sym::IPCStableHash() {
  // This method's address is used for identifying the mojo method name after
  // symbolization. So each IPCStableHash should have a unique address.
  // We cannot use NO_CODE_FOLDING() here - it relies on the uniqueness of
  // __LINE__ value, which is not unique across different mojo modules.
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x8174ca9a;  // IPCStableHash for network::mojom::URLLoaderNetworkServiceObserver::OnWebSocketConnectedToLocalNetwork
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t URLLoaderNetworkServiceObserver::OnUrlLoaderConnectedToLocalNetwork_Sym::IPCStableHash() {
  // This method's address is used for identifying the mojo method name after
  // symbolization. So each IPCStableHash should have a unique address.
  // We cannot use NO_CODE_FOLDING() here - it relies on the uniqueness of
  // __LINE__ value, which is not unique across different mojo modules.
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x21adea66;  // IPCStableHash for network::mojom::URLLoaderNetworkServiceObserver::OnUrlLoaderConnectedToLocalNetwork
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
class URLLoaderNetworkServiceObserver_OnLocalNetworkAccessPermissionRequired_ForwardToCallback
    : public mojo::MessageReceiver {
 public:
  URLLoaderNetworkServiceObserver_OnLocalNetworkAccessPermissionRequired_ForwardToCallback(
      URLLoaderNetworkServiceObserver::OnLocalNetworkAccessPermissionRequiredCallback callback
      ) : callback_(std::move(callback)) {
  }

  URLLoaderNetworkServiceObserver_OnLocalNetworkAccessPermissionRequired_ForwardToCallback(const URLLoaderNetworkServiceObserver_OnLocalNetworkAccessPermissionRequired_ForwardToCallback&) = delete;
  URLLoaderNetworkServiceObserver_OnLocalNetworkAccessPermissionRequired_ForwardToCallback& operator=(const URLLoaderNetworkServiceObserver_OnLocalNetworkAccessPermissionRequired_ForwardToCallback&) = delete;

  bool Accept(mojo::Message* message) override;
 private:
  URLLoaderNetworkServiceObserver::OnLocalNetworkAccessPermissionRequiredCallback callback_;
};

class URLLoaderNetworkServiceObserver_OnPlatformLocalNetworkPermissionRequired_ForwardToCallback
    : public mojo::MessageReceiver {
 public:
  URLLoaderNetworkServiceObserver_OnPlatformLocalNetworkPermissionRequired_ForwardToCallback(
      URLLoaderNetworkServiceObserver::OnPlatformLocalNetworkPermissionRequiredCallback callback
      ) : callback_(std::move(callback)) {
  }

  URLLoaderNetworkServiceObserver_OnPlatformLocalNetworkPermissionRequired_ForwardToCallback(const URLLoaderNetworkServiceObserver_OnPlatformLocalNetworkPermissionRequired_ForwardToCallback&) = delete;
  URLLoaderNetworkServiceObserver_OnPlatformLocalNetworkPermissionRequired_ForwardToCallback& operator=(const URLLoaderNetworkServiceObserver_OnPlatformLocalNetworkPermissionRequired_ForwardToCallback&) = delete;

  bool Accept(mojo::Message* message) override;
 private:
  URLLoaderNetworkServiceObserver::OnPlatformLocalNetworkPermissionRequiredCallback callback_;
};
...
void URLLoaderNetworkServiceObserverProxy::OnSSLCertificateError(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::URLLoaderNetworkServiceObserver::kOnSSLCertificateError), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void URLLoaderNetworkServiceObserverProxy::OnCertificateRequested(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::URLLoaderNetworkServiceObserver::kOnCertificateRequested), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void URLLoaderNetworkServiceObserverProxy::OnAuthRequired(
    const std::optional<::base::UnguessableToken>& in_window_id, int32_t in_request_id, const ::blink::KURL& in_url, bool in_first_auth_attempt, const ::net::AuthChallengeInfo& in_auth_info, const ::scoped_refptr<::net::HttpResponseHeaders>& in_head_headers, ::mojo::PendingRemote<AuthChallengeResponder> in_auth_challenge_responder) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::URLLoaderNetworkServiceObserver::kOnAuthRequired), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
  ...
  mojo::internal::Serialize<mojo::InterfacePtrDataView<::network::mojom::AuthChallengeResponderInterfaceBase>>(
    in_auth_challenge_responder,
    &params->auth_challenge_responder,
    &params.message());
...
void URLLoaderNetworkServiceObserverProxy::OnLocalNetworkAccessPermissionRequired(
    TransportType in_transport_type, ::network::mojom::blink::IPAddressSpace in_ip_address_space, OnLocalNetworkAccessPermissionRequiredCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "Send network::mojom::URLLoaderNetworkServiceObserver::OnLocalNetworkAccessPermissionRequired", "input_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("transport_type"), in_transport_type,
                        "<value of type TransportType>");
      perfetto::WriteIntoTracedValueWithFallback(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::URLLoaderNetworkServiceObserver::kOnLocalNetworkAccessPermissionRequired), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
      ::network::mojom::internal::URLLoaderNetworkServiceObserver_OnLocalNetworkAccessPermissionRequired_Params_Data> params(
          message);
  params.Allocate();

  
  mojo::internal::Serialize<::network::mojom::TransportType>(
    in_transport_type,
  ...
  mojo::internal::Serialize<::network::mojom::IPAddressSpace>(
    in_ip_address_space,
    &params->ip_address_space);

#if defined(ENABLE_IPC_FUZZER)
  message.set_interface_name(URLLoaderNetworkServiceObserver::Name_);
  message.set_method_name("OnLocalNetworkAccessPermissionRequired");
#endif
  std::unique_ptr<mojo::MessageReceiver> responder(
      new URLLoaderNetworkServiceObserver_OnLocalNetworkAccessPermissionRequired_ForwardToCallback(
          std::move(callback)));
  ::mojo::internal::SendMojoMessage(*receiver_, message, std::move(responder));
}

void URLLoaderNetworkServiceObserverProxy::OnPlatformLocalNetworkPermissionRequired(
    OnPlatformLocalNetworkPermissionRequiredCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "Send network::mojom::URLLoaderNetworkServiceObserver::OnPlatformLocalNetworkPermissionRequired");
#endif
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::URLLoaderNetworkServiceObserver::kOnPlatformLocalNetworkPermissionRequired), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
      ::network::mojom::internal::URLLoaderNetworkServiceObserver_OnPlatformLocalNetworkPermissionRequired_Params_Data> params(
          message);
  params.Allocate();

#if defined(ENABLE_IPC_FUZZER)
  message.set_interface_name(URLLoaderNetworkServiceObserver::Name_);
  message.set_method_name("OnPlatformLocalNetworkPermissionRequired");
#endif
  std::unique_ptr<mojo::MessageReceiver> responder(
      new URLLoaderNetworkServiceObserver_OnPlatformLocalNetworkPermissionRequired_ForwardToCallback(
          std::move(callback)));
  ::mojo::internal::SendMojoMessage(*receiver_, message, std::move(responder));
}

void URLLoaderNetworkServiceObserverProxy::OnClearSiteData(
    const ::blink::KURL& in_url, const ::blink::String& in_header_value, int32_t in_load_flags, ::network::mojom::blink::CookiePartitionKeyPtr in_cookie_partition_key, bool in_partitioned_state_allowed_only, OnClearSiteDataCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::URLLoaderNetworkServiceObserver::kOnClearSiteData), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void URLLoaderNetworkServiceObserverProxy::OnLoadingStateUpdate(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::URLLoaderNetworkServiceObserver::kOnLoadingStateUpdate), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void URLLoaderNetworkServiceObserverProxy::OnDataUseUpdate(
    int32_t in_network_traffic_annotation_id_hash, ::mojo_base::mojom::blink::ByteSizePtr in_recv_bytes, ::mojo_base::mojom::blink::ByteSizePtr in_sent_bytes) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("recv_bytes"), in_recv_bytes,
                        "<value of type ::mojo_base::mojom::blink::ByteSizePtr>");
      perfetto::WriteIntoTracedValueWithFallback(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::URLLoaderNetworkServiceObserver::kOnDataUseUpdate), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
  ...
  mojo::internal::MessageFragment<
      typename decltype(params->recv_bytes)::BaseType> recv_bytes_fragment(
          params.message());
  ...
  params->recv_bytes.Set(
      recv_bytes_fragment.is_null() ? nullptr : recv_bytes_fragment.data());

  
  MOJO_INTERNAL_CHECK_SERIALIZATION(
    mojo::internal::SendValidation::kDefault,
    !(params->recv_bytes.is_null()),
    mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
    "null recv_bytes in URLLoaderNetworkServiceObserver.OnDataUseUpdate request");
  mojo::internal::MessageFragment<
      typename decltype(params->sent_bytes)::BaseType> sent_bytes_fragment(
          params.message());
  ...
  params->sent_bytes.Set(
      sent_bytes_fragment.is_null() ? nullptr : sent_bytes_fragment.data());

  
  MOJO_INTERNAL_CHECK_SERIALIZATION(
    mojo::internal::SendValidation::kDefault,
    !(params->sent_bytes.is_null()),
    mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
    "null sent_bytes in URLLoaderNetworkServiceObserver.OnDataUseUpdate request");
...
void URLLoaderNetworkServiceObserverProxy::OnSharedStorageHeaderReceived(
    const ::scoped_refptr<const ::blink::SecurityOrigin>& in_request_origin, ::network::mojom::blink::SharedStorageBatchUpdateMethodsArgumentPtr in_methods_with_options, ::network::mojom::blink::LockNamePtr in_with_lock, OnSharedStorageHeaderReceivedCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("methods_with_options"), in_methods_with_options,
                        "<value of type ::network::mojom::blink::SharedStorageBatchUpdateMethodsArgumentPtr>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("with_lock"), in_with_lock,
                        "<value of type ::network::mojom::blink::LockNamePtr>");
   });
#endif
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::URLLoaderNetworkServiceObserver::kOnSharedStorageHeaderReceived), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
  ...
  MOJO_INTERNAL_CHECK_SERIALIZATION(
    ...
    mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
    "null methods_with_options in URLLoaderNetworkServiceObserver.OnSharedStorageHeaderReceived request");
  mojo::internal::MessageFragment<
...
void URLLoaderNetworkServiceObserverProxy::OnAdAuctionEventRecordHeaderReceived(
    ::network::mojom::blink::AdAuctionEventRecordPtr in_ad_auction_event_record, const ::scoped_refptr<const ::blink::SecurityOrigin>& in_top_frame_origin) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "Send network::mojom::URLLoaderNetworkServiceObserver::OnAdAuctionEventRecordHeaderReceived", "input_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("ad_auction_event_record"), in_ad_auction_event_record,
                        "<value of type ::network::mojom::blink::AdAuctionEventRecordPtr>");
      perfetto::WriteIntoTracedValueWithFallback(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::URLLoaderNetworkServiceObserver::kOnAdAuctionEventRecordHeaderReceived), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
      ::network::mojom::internal::URLLoaderNetworkServiceObserver_OnAdAuctionEventRecordHeaderReceived_Params_Data> params(
          message);
  params.Allocate();
  mojo::internal::MessageFragment<
      typename decltype(params->ad_auction_event_record)::BaseType> ad_auction_event_record_fragment(
          params.message());
  
  mojo::internal::Serialize<::network::mojom::AdAuctionEventRecordDataView>(
    in_ad_auction_event_record,
    ad_auction_event_record_fragment);

  params->ad_auction_event_record.Set(
      ad_auction_event_record_fragment.is_null() ? nullptr : ad_auction_event_record_fragment.data());

  
  MOJO_INTERNAL_CHECK_SERIALIZATION(
    mojo::internal::SendValidation::kDefault,
    !(params->ad_auction_event_record.is_null()),
    mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
    "null ad_auction_event_record in URLLoaderNetworkServiceObserver.OnAdAuctionEventRecordHeaderReceived request");
  mojo::internal::MessageFragment<
...
#if defined(ENABLE_IPC_FUZZER)
  message.set_interface_name(URLLoaderNetworkServiceObserver::Name_);
  message.set_method_name("OnAdAuctionEventRecordHeaderReceived");
#endif
  // This return value may be ignored as false implies the Connector has
  // encountered an error, which will be visible through other means.
  ::mojo::internal::SendMojoMessage(*receiver_, message);
...
void URLLoaderNetworkServiceObserverProxy::Clone(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::URLLoaderNetworkServiceObserver::kClone), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void URLLoaderNetworkServiceObserverProxy::OnWebSocketConnectedToLocalNetwork(
    const ::blink::KURL& in_request_url, ::network::mojom::blink::IPAddressSpace in_ip_address_space) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "Send network::mojom::URLLoaderNetworkServiceObserver::OnWebSocketConnectedToLocalNetwork", "input_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::URLLoaderNetworkServiceObserver::kOnWebSocketConnectedToLocalNetwork), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
      ::network::mojom::internal::URLLoaderNetworkServiceObserver_OnWebSocketConnectedToLocalNetwork_Params_Data> params(
          message);
  params.Allocate();
  mojo::internal::MessageFragment<
  ...
  MOJO_INTERNAL_CHECK_SERIALIZATION(
    ...
    mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
    "null request_url in URLLoaderNetworkServiceObserver.OnWebSocketConnectedToLocalNetwork request");
...
#if defined(ENABLE_IPC_FUZZER)
  message.set_interface_name(URLLoaderNetworkServiceObserver::Name_);
  message.set_method_name("OnWebSocketConnectedToLocalNetwork");
#endif
  // This return value may be ignored as false implies the Connector has
  // encountered an error, which will be visible through other means.
  ::mojo::internal::SendMojoMessage(*receiver_, message);
...
void URLLoaderNetworkServiceObserverProxy::OnUrlLoaderConnectedToLocalNetwork(
    const ::blink::KURL& in_request_url, ::network::mojom::blink::IPAddressSpace in_response_address_space, ::network::mojom::blink::IPAddressSpace in_client_address_space, ::network::mojom::blink::IPAddressSpace in_target_address_space) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "Send network::mojom::URLLoaderNetworkServiceObserver::OnUrlLoaderConnectedToLocalNetwork", "input_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("request_url"), in_request_url,
                        "<value of type const ::blink::KURL&>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("response_address_space"), in_response_address_space,
                        "<value of type ::network::mojom::blink::IPAddressSpace>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("client_address_space"), in_client_address_space,
                        "<value of type ::network::mojom::blink::IPAddressSpace>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("target_address_space"), in_target_address_space,
                        "<value of type ::network::mojom::blink::IPAddressSpace>");
   });
#endif
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::URLLoaderNetworkServiceObserver::kOnUrlLoaderConnectedToLocalNetwork), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
      ::network::mojom::internal::URLLoaderNetworkServiceObserver_OnUrlLoaderConnectedToLocalNetwork_Params_Data> params(
          message);
  params.Allocate();
  mojo::internal::MessageFragment<
      typename decltype(params->request_url)::BaseType> request_url_fragment(
  ...
  MOJO_INTERNAL_CHECK_SERIALIZATION(
    ...
    !(params->request_url.is_null()),
    mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
    "null request_url in URLLoaderNetworkServiceObserver.OnUrlLoaderConnectedToLocalNetwork request");

  
  mojo::internal::Serialize<::network::mojom::IPAddressSpace>(
    in_response_address_space,
    &params->response_address_space);

  
  mojo::internal::Serialize<::network::mojom::IPAddressSpace>(
    in_client_address_space,
    &params->client_address_space);

  
  mojo::internal::Serialize<::network::mojom::IPAddressSpace>(
    in_target_address_space,
    &params->target_address_space);

#if defined(ENABLE_IPC_FUZZER)
  message.set_interface_name(URLLoaderNetworkServiceObserver::Name_);
  message.set_method_name("OnUrlLoaderConnectedToLocalNetwork");
#endif
  // This return value may be ignored as false implies the Connector has
  // encountered an error, which will be visible through other means.
  ::mojo::internal::SendMojoMessage(*receiver_, message);
...
class URLLoaderNetworkServiceObserver_OnLocalNetworkAccessPermissionRequired_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 public:
  static URLLoaderNetworkServiceObserver::OnLocalNetworkAccessPermissionRequiredCallback CreateCallback(
      ::mojo::Message& message,
      std::unique_ptr<mojo::MessageReceiverWithStatus> responder) {
    std::unique_ptr<URLLoaderNetworkServiceObserver_OnLocalNetworkAccessPermissionRequired_ProxyToResponder> proxy(
        new URLLoaderNetworkServiceObserver_OnLocalNetworkAccessPermissionRequired_ProxyToResponder(
            message, std::move(responder)));
    return base::BindOnce(&URLLoaderNetworkServiceObserver_OnLocalNetworkAccessPermissionRequired_ProxyToResponder::Run,
                          std::move(proxy));
  }

  ~URLLoaderNetworkServiceObserver_OnLocalNetworkAccessPermissionRequired_ProxyToResponder() {
#if DCHECK_IS_ON()
    if (responder_) {
      // If we're being destroyed without being run, we want to ensure the
      // binding endpoint has been closed. This checks for that asynchronously.
 ...
 private:
  ...
  static void OnIsConnectedComplete(bool connected) {
    DCHECK(!connected)
        << "URLLoaderNetworkServiceObserver::OnLocalNetworkAccessPermissionRequiredCallback was destroyed without "
        << "first either being run or its corresponding binding being closed. "
        << "It is an error to drop response callbacks which still correspond "
        << "to an open interface pipe.";
  }
  ...
  void Run(
      LocalNetworkAccessResult in_result);
};

bool URLLoaderNetworkServiceObserver_OnLocalNetworkAccessPermissionRequired_ForwardToCallback::Accept(
    mojo::Message* message) {
  DCHECK(message->is_serialized());
  internal::URLLoaderNetworkServiceObserver_OnLocalNetworkAccessPermissionRequired_ResponseParams_Data* params =
      reinterpret_cast<
          internal::URLLoaderNetworkServiceObserver_OnLocalNetworkAccessPermissionRequired_ResponseParams_Data*>(
              message->mutable_payload());
  

  // Validation for URLLoaderNetworkServiceObserver.3
  bool success = true;
  LocalNetworkAccessResult p_result{};
  URLLoaderNetworkServiceObserver_OnLocalNetworkAccessPermissionRequired_ResponseParamsDataView input_data_view(params, message);
...
void URLLoaderNetworkServiceObserver_OnLocalNetworkAccessPermissionRequired_ProxyToResponder::Run(
    LocalNetworkAccessResult in_result) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "Send reply network::mojom::URLLoaderNetworkServiceObserver::OnLocalNetworkAccessPermissionRequired", "async_response_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("result"), in_result,
                        "<value of type LocalNetworkAccessResult>");
   });
#endif
  ...
  mojo::Message message(
      std::to_underlying(messages::URLLoaderNetworkServiceObserver::kOnLocalNetworkAccessPermissionRequired), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
      ::network::mojom::internal::URLLoaderNetworkServiceObserver_OnLocalNetworkAccessPermissionRequired_ResponseParams_Data> params(
          message);
  params.Allocate();

  
  mojo::internal::Serialize<::network::mojom::LocalNetworkAccessResult>(
    in_result,
    &params->result);
...
class URLLoaderNetworkServiceObserver_OnPlatformLocalNetworkPermissionRequired_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 public:
  static URLLoaderNetworkServiceObserver::OnPlatformLocalNetworkPermissionRequiredCallback CreateCallback(
      ::mojo::Message& message,
      std::unique_ptr<mojo::MessageReceiverWithStatus> responder) {
    std::unique_ptr<URLLoaderNetworkServiceObserver_OnPlatformLocalNetworkPermissionRequired_ProxyToResponder> proxy(
        new URLLoaderNetworkServiceObserver_OnPlatformLocalNetworkPermissionRequired_ProxyToResponder(
            message, std::move(responder)));
    return base::BindOnce(&URLLoaderNetworkServiceObserver_OnPlatformLocalNetworkPermissionRequired_ProxyToResponder::Run,
                          std::move(proxy));
  }

  ~URLLoaderNetworkServiceObserver_OnPlatformLocalNetworkPermissionRequired_ProxyToResponder() {
#if DCHECK_IS_ON()
    if (responder_) {
      // If we're being destroyed without being run, we want to ensure the
      // binding endpoint has been closed. This checks for that asynchronously.
 ...
 private:
  ...
  static void OnIsConnectedComplete(bool connected) {
    DCHECK(!connected)
        << "URLLoaderNetworkServiceObserver::OnPlatformLocalNetworkPermissionRequiredCallback was destroyed without "
        << "first either being run or its corresponding binding being closed. "
        << "It is an error to drop response callbacks which still correspond "
        << "to an open interface pipe.";
  }
...
bool URLLoaderNetworkServiceObserver_OnPlatformLocalNetworkPermissionRequired_ForwardToCallback::Accept(
    mojo::Message* message) {
  DCHECK(message->is_serialized());
  internal::URLLoaderNetworkServiceObserver_OnPlatformLocalNetworkPermissionRequired_ResponseParams_Data* params =
      reinterpret_cast<
          internal::URLLoaderNetworkServiceObserver_OnPlatformLocalNetworkPermissionRequired_ResponseParams_Data*>(
              message->mutable_payload());
  ...
  bool success = true;
  bool p_granted{};
  URLLoaderNetworkServiceObserver_OnPlatformLocalNetworkPermissionRequired_ResponseParamsDataView input_data_view(params, message);
...
void URLLoaderNetworkServiceObserver_OnPlatformLocalNetworkPermissionRequired_ProxyToResponder::Run(
    bool in_granted) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "Send reply network::mojom::URLLoaderNetworkServiceObserver::OnPlatformLocalNetworkPermissionRequired", "async_response_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
  ...
  mojo::Message message(
      std::to_underlying(messages::URLLoaderNetworkServiceObserver::kOnPlatformLocalNetworkPermissionRequired), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
      ::network::mojom::internal::URLLoaderNetworkServiceObserver_OnPlatformLocalNetworkPermissionRequired_ResponseParams_Data> params(
          message);
  params.Allocate();
...
bool URLLoaderNetworkServiceObserver_OnLoadingStateUpdate_ForwardToCallback::Accept(
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        URLLoaderNetworkServiceObserver::Name_, 6, true);
    return false;
  }
  if (!callback_.is_null()) {
    std::move(callback_).Run();
...
bool URLLoaderNetworkServiceObserver_OnSharedStorageHeaderReceived_ForwardToCallback::Accept(
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        URLLoaderNetworkServiceObserver::Name_, 8, true);
    return false;
  }
  if (!callback_.is_null()) {
    std::move(callback_).Run();
...
bool URLLoaderNetworkServiceObserverStubDispatch::Accept(
  ...
  switch (static_cast<messages::URLLoaderNetworkServiceObserver>(message->header()->name)) {
    ...
    case messages::URLLoaderNetworkServiceObserver::kOnDataUseUpdate: {
      ...
      ::mojo_base::mojom::blink::ByteSizePtr p_recv_bytes{};
      ::mojo_base::mojom::blink::ByteSizePtr p_sent_bytes{};
      ...
      if (success && !input_data_view.ReadRecvBytes(&p_recv_bytes))
        success = false;
      if (success && !input_data_view.ReadSentBytes(&p_sent_bytes))
        success = false;
      if (!success) {
        ReportValidationErrorForMessage(
            message,
    ...
    case messages::URLLoaderNetworkServiceObserver::kOnAdAuctionEventRecordHeaderReceived: {
      DCHECK(message->is_serialized());
      internal::URLLoaderNetworkServiceObserver_OnAdAuctionEventRecordHeaderReceived_Params_Data* params =
          reinterpret_cast<internal::URLLoaderNetworkServiceObserver_OnAdAuctionEventRecordHeaderReceived_Params_Data*>(
              message->mutable_payload());
      

      // Validation for URLLoaderNetworkServiceObserver.9
      bool success = true;
      ::network::mojom::blink::AdAuctionEventRecordPtr p_ad_auction_event_record{};
      ::scoped_refptr<const ::blink::SecurityOrigin> p_top_frame_origin{};
      URLLoaderNetworkServiceObserver_OnAdAuctionEventRecordHeaderReceived_ParamsDataView input_data_view(params, message);
      
      if (success && !input_data_view.ReadAdAuctionEventRecord(&p_ad_auction_event_record))
        success = false;
      ...
      // A null |impl| means no implementation was bound.
      DCHECK(impl);
      impl->OnAdAuctionEventRecordHeaderReceived(        
        std::move(p_ad_auction_event_record), 
    ...
    case messages::URLLoaderNetworkServiceObserver::kClone: {
      ...
      // Validation for URLLoaderNetworkServiceObserver.10
      bool success = true;
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            URLLoaderNetworkServiceObserver::Name_, 10, false);
        return false;
      }
      // A null |impl| means no implementation was bound.
      DCHECK(impl);
    ...
    case messages::URLLoaderNetworkServiceObserver::kOnWebSocketConnectedToLocalNetwork: {
      DCHECK(message->is_serialized());
      internal::URLLoaderNetworkServiceObserver_OnWebSocketConnectedToLocalNetwork_Params_Data* params =
          reinterpret_cast<internal::URLLoaderNetworkServiceObserver_OnWebSocketConnectedToLocalNetwork_Params_Data*>(
              message->mutable_payload());
      

      // Validation for URLLoaderNetworkServiceObserver.11
      bool success = true;
      ::blink::KURL p_request_url{};
      ::network::mojom::blink::IPAddressSpace p_ip_address_space{};
      URLLoaderNetworkServiceObserver_OnWebSocketConnectedToLocalNetwork_ParamsDataView input_data_view(params, message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            URLLoaderNetworkServiceObserver::Name_, 11, false);
        return false;
      }
      // A null |impl| means no implementation was bound.
      DCHECK(impl);
      impl->OnWebSocketConnectedToLocalNetwork(        
    ...
    case messages::URLLoaderNetworkServiceObserver::kOnUrlLoaderConnectedToLocalNetwork: {
      DCHECK(message->is_serialized());
      internal::URLLoaderNetworkServiceObserver_OnUrlLoaderConnectedToLocalNetwork_Params_Data* params =
          reinterpret_cast<internal::URLLoaderNetworkServiceObserver_OnUrlLoaderConnectedToLocalNetwork_Params_Data*>(
              message->mutable_payload());
      

      // Validation for URLLoaderNetworkServiceObserver.12
      bool success = true;
      ::blink::KURL p_request_url{};
      ::network::mojom::blink::IPAddressSpace p_response_address_space{};
      ::network::mojom::blink::IPAddressSpace p_client_address_space{};
      ::network::mojom::blink::IPAddressSpace p_target_address_space{};
      URLLoaderNetworkServiceObserver_OnUrlLoaderConnectedToLocalNetwork_ParamsDataView input_data_view(params, message);
      
      if (success && !input_data_view.ReadRequestUrl(&p_request_url))
        success = false;
      if (success && !input_data_view.ReadResponseAddressSpace(&p_response_address_space))
        success = false;
      if (success && !input_data_view.ReadClientAddressSpace(&p_client_address_space))
        success = false;
      if (success && !input_data_view.ReadTargetAddressSpace(&p_target_address_space))
        success = false;
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            URLLoaderNetworkServiceObserver::Name_, 12, false);
        return false;
      }
      // A null |impl| means no implementation was bound.
      DCHECK(impl);
      impl->OnUrlLoaderConnectedToLocalNetwork(        
        std::move(p_request_url), 
        std::move(p_response_address_space), 
        std::move(p_client_address_space), 
        std::move(p_target_address_space));
      return true;
    }
  }
  return false;
...
bool URLLoaderNetworkServiceObserverStubDispatch::AcceptWithResponder(
  ...
  switch (static_cast<messages::URLLoaderNetworkServiceObserver>(message->header()->name)) {
    ...
    case messages::URLLoaderNetworkServiceObserver::kOnLocalNetworkAccessPermissionRequired: {
      internal::URLLoaderNetworkServiceObserver_OnLocalNetworkAccessPermissionRequired_Params_Data* params =
          reinterpret_cast<
              internal::URLLoaderNetworkServiceObserver_OnLocalNetworkAccessPermissionRequired_Params_Data*>(
                  message->mutable_payload());
      ...
      ::network::mojom::blink::IPAddressSpace p_ip_address_space{};
      URLLoaderNetworkServiceObserver_OnLocalNetworkAccessPermissionRequired_ParamsDataView input_data_view(params, message);
      
      if (success && !input_data_view.ReadTransportType(&p_transport_type))
        success = false;
      if (success && !input_data_view.ReadIpAddressSpace(&p_ip_address_space))
        success = false;
      if (!success) {
      ...
      auto callback =
          URLLoaderNetworkServiceObserver_OnLocalNetworkAccessPermissionRequired_ProxyToResponder::CreateCallback(
              *message, std::move(responder));
      // A null |impl| means no implementation was bound.
      DCHECK(impl);
      impl->OnLocalNetworkAccessPermissionRequired(        
        std::move(p_transport_type), 
        std::move(p_ip_address_space), std::move(callback));
      return true;
    }
    case messages::URLLoaderNetworkServiceObserver::kOnPlatformLocalNetworkPermissionRequired: {
      internal::URLLoaderNetworkServiceObserver_OnPlatformLocalNetworkPermissionRequired_Params_Data* params =
          reinterpret_cast<
              internal::URLLoaderNetworkServiceObserver_OnPlatformLocalNetworkPermissionRequired_Params_Data*>(
                  message->mutable_payload());
      

      // Validation for URLLoaderNetworkServiceObserver.4
      bool success = true;
      URLLoaderNetworkServiceObserver_OnPlatformLocalNetworkPermissionRequired_ParamsDataView input_data_view(params, message);
      ...
      auto callback =
          URLLoaderNetworkServiceObserver_OnPlatformLocalNetworkPermissionRequired_ProxyToResponder::CreateCallback(
              *message, std::move(responder));
      // A null |impl| means no implementation was bound.
      DCHECK(impl);
      impl->OnPlatformLocalNetworkPermissionRequired(std::move(callback));
      return true;
    }
    case messages::URLLoaderNetworkServiceObserver::kOnClearSiteData: {
    ...
    case messages::URLLoaderNetworkServiceObserver::kOnSharedStorageHeaderReceived: {
      ...
      ::network::mojom::blink::SharedStorageBatchUpdateMethodsArgumentPtr p_methods_with_options{};
      ::network::mojom::blink::LockNamePtr p_with_lock{};
...
static const mojo::internal::GenericValidationInfo kURLLoaderNetworkServiceObserverValidationInfo[] = {
    ...
    { &internal::URLLoaderNetworkServiceObserver_OnAuthRequired_Params_Data::Validate,
     nullptr /* no response */},
    { &internal::URLLoaderNetworkServiceObserver_OnLocalNetworkAccessPermissionRequired_Params_Data::Validate,
     &internal::URLLoaderNetworkServiceObserver_OnLocalNetworkAccessPermissionRequired_ResponseParams_Data::Validate},
    { &internal::URLLoaderNetworkServiceObserver_OnPlatformLocalNetworkPermissionRequired_Params_Data::Validate,
     &internal::URLLoaderNetworkServiceObserver_OnPlatformLocalNetworkPermissionRequired_ResponseParams_Data::Validate},
    ...
    { &internal::URLLoaderNetworkServiceObserver_OnAdAuctionEventRecordHeaderReceived_Params_Data::Validate,
     nullptr /* no response */},
    { &internal::URLLoaderNetworkServiceObserver_Clone_Params_Data::Validate,
     nullptr /* no response */},
    { &internal::URLLoaderNetworkServiceObserver_OnWebSocketConnectedToLocalNetwork_Params_Data::Validate,
     nullptr /* no response */},
    { &internal::URLLoaderNetworkServiceObserver_OnUrlLoaderConnectedToLocalNetwork_Params_Data::Validate,
     nullptr /* no response */},
};
...
bool URLLoaderNetworkServiceObserverRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::blink::URLLoaderNetworkServiceObserver::Name_,
    kURLLoaderNetworkServiceObserverValidationInfo);
}
...
void ClientCertificateResponderInterceptorForTesting::ContinueWithCertificate(const ::scoped_refptr<::net::X509Certificate>& x509_certificate, const ::blink::String& provider_name, const ::blink::Vector<uint16_t>& algorithm_preferences, ::mojo::PendingRemote<SSLPrivateKey> ssl_private_key) {
...
void SSLPrivateKeyInterceptorForTesting::Sign(uint16_t algorithm, const ::blink::Vector<uint8_t>& input, SignCallback callback) {
...
,
             ::blink::Vector<uint8_t>* out_signature
,
             int32_t net_error,
             const ::blink::Vector<uint8_t>& signature) {*out_net_error = std::move(net_error);*out_signature = std::move(signature);
            loop->Quit();
          },
          &loop,
          out_net_error,
...
void URLLoaderNetworkServiceObserverInterceptorForTesting::OnLocalNetworkAccessPermissionRequired(TransportType transport_type, ::network::mojom::blink::IPAddressSpace ip_address_space, OnLocalNetworkAccessPermissionRequiredCallback callback) {
  GetForwardingInterface()->OnLocalNetworkAccessPermissionRequired(
    std::move(transport_type)
    , 
    std::move(ip_address_space)
    , std::move(callback));
}
void URLLoaderNetworkServiceObserverInterceptorForTesting::OnPlatformLocalNetworkPermissionRequired(OnPlatformLocalNetworkPermissionRequiredCallback callback) {
  GetForwardingInterface()->OnPlatformLocalNetworkPermissionRequired(std::move(callback));
}
void URLLoaderNetworkServiceObserverInterceptorForTesting::OnClearSiteData(const ::blink::KURL& url, const ::blink::String& header_value, int32_t load_flags, ::network::mojom::blink::CookiePartitionKeyPtr cookie_partition_key, bool partitioned_state_allowed_only, OnClearSiteDataCallback callback) {
...
void URLLoaderNetworkServiceObserverInterceptorForTesting::OnDataUseUpdate(int32_t network_traffic_annotation_id_hash, ::mojo_base::mojom::blink::ByteSizePtr recv_bytes, ::mojo_base::mojom::blink::ByteSizePtr sent_bytes) {
...
void URLLoaderNetworkServiceObserverInterceptorForTesting::OnSharedStorageHeaderReceived(const ::scoped_refptr<const ::blink::SecurityOrigin>& request_origin, ::network::mojom::blink::SharedStorageBatchUpdateMethodsArgumentPtr methods_with_options, ::network::mojom::blink::LockNamePtr with_lock, OnSharedStorageHeaderReceivedCallback callback) {
...
void URLLoaderNetworkServiceObserverInterceptorForTesting::OnAdAuctionEventRecordHeaderReceived(::network::mojom::blink::AdAuctionEventRecordPtr ad_auction_event_record, const ::scoped_refptr<const ::blink::SecurityOrigin>& top_frame_origin) {
  GetForwardingInterface()->OnAdAuctionEventRecordHeaderReceived(
    std::move(ad_auction_event_record)
    , 
...
void URLLoaderNetworkServiceObserverInterceptorForTesting::OnWebSocketConnectedToLocalNetwork(const ::blink::KURL& request_url, ::network::mojom::blink::IPAddressSpace ip_address_space) {
  GetForwardingInterface()->OnWebSocketConnectedToLocalNetwork(
    std::move(request_url)
    , 
    std::move(ip_address_space)
    );
}
void URLLoaderNetworkServiceObserverInterceptorForTesting::OnUrlLoaderConnectedToLocalNetwork(const ::blink::KURL& request_url, ::network::mojom::blink::IPAddressSpace response_address_space, ::network::mojom::blink::IPAddressSpace client_address_space, ::network::mojom::blink::IPAddressSpace target_address_space) {
  GetForwardingInterface()->OnUrlLoaderConnectedToLocalNetwork(
    std::move(request_url)
    , 
    std::move(response_address_space)
    , 
    std::move(client_address_space)
    , 
    std::move(target_address_space)
    );
}
...
void URLLoaderNetworkServiceObserverAsyncWaiter::OnLocalNetworkAccessPermissionRequired(
    TransportType transport_type, ::network::mojom::blink::IPAddressSpace ip_address_space, LocalNetworkAccessResult* out_result) {
  base::RunLoop loop;
  proxy_->OnLocalNetworkAccessPermissionRequired(
      std::move(transport_type),
      std::move(ip_address_space),
      base::BindOnce(
          [](base::RunLoop* loop,
             LocalNetworkAccessResult* out_result
,
             LocalNetworkAccessResult result) {*out_result = std::move(result);
            loop->Quit();
          },
          &loop,
          out_result));
...
LocalNetworkAccessResult URLLoaderNetworkServiceObserverAsyncWaiter::OnLocalNetworkAccessPermissionRequired(
    TransportType transport_type, ::network::mojom::blink::IPAddressSpace ip_address_space) {
  LocalNetworkAccessResult async_wait_result;
  OnLocalNetworkAccessPermissionRequired(std::move(transport_type),std::move(ip_address_space),&async_wait_result);
  return async_wait_result;
}

void URLLoaderNetworkServiceObserverAsyncWaiter::OnPlatformLocalNetworkPermissionRequired(
    bool* out_granted) {
  base::RunLoop loop;
  proxy_->OnPlatformLocalNetworkPermissionRequired(
      base::BindOnce(
          [](base::RunLoop* loop,
             bool* out_granted
,
...
bool URLLoaderNetworkServiceObserverAsyncWaiter::OnPlatformLocalNetworkPermissionRequired(
    ) {
  bool async_wait_result;
  OnPlatformLocalNetworkPermissionRequired(&async_wait_result);
  return async_wait_result;
}
