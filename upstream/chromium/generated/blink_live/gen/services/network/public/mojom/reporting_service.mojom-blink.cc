...
ReportingApiReport::ReportingApiReport(
    ...
    int32_t depth_in,
    int32_t attempts_in,
    ::mojo_base::mojom::blink::DictionaryValuePtr body_in,
...
ReportingApiEndpoint::ReportingApiEndpoint(
    ...
    const ::blink::String& group_name_in,
    ::network::mojom::blink::NetworkAnonymizationKeyPtr network_anonymization_key_in,
...
uint32_t ReportingApiObserver::OnReportAdded_Sym::IPCStableHash() {
  ...
  static constexpr uint32_t kHash = 0xe9f0f3cc;  // IPCStableHash for network::mojom::ReportingApiObserver::OnReportAdded
...
uint32_t ReportingApiObserver::OnReportUpdated_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x173fb843;  // IPCStableHash for network::mojom::ReportingApiObserver::OnReportUpdated
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t ReportingApiObserver::OnEndpointsUpdatedForOrigin_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x8c281fbb;  // IPCStableHash for network::mojom::ReportingApiObserver::OnEndpointsUpdatedForOrigin
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void ReportingApiObserverProxy::OnReportAdded(
  ...
  mojo::Message message(
      std::to_underlying(messages::ReportingApiObserver::kOnReportAdded), kFlags, estimated_payload_size);
...
void ReportingApiObserverProxy::OnReportUpdated(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::ReportingApiObserver::kOnReportUpdated), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void ReportingApiObserverProxy::OnEndpointsUpdatedForOrigin(
    ::blink::Vector<ReportingApiEndpointPtr> in_endpoints) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("endpoints"), in_endpoints,
                        "<value of type ::blink::Vector<ReportingApiEndpointPtr>>");
   });
#endif
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::ReportingApiObserver::kOnEndpointsUpdatedForOrigin), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool ReportingApiObserverStubDispatch::Accept(
  ...
  switch (static_cast<messages::ReportingApiObserver>(message->header()->name)) {
    ...
    case messages::ReportingApiObserver::kOnEndpointsUpdatedForOrigin: {
      ...
      bool success = true;
      ::blink::Vector<ReportingApiEndpointPtr> p_endpoints{};
...
bool ReportingApiObserverRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::blink::ReportingApiObserver::Name_,
    kReportingApiObserverValidationInfo);
}
...
void ReportingApiObserverInterceptorForTesting::OnEndpointsUpdatedForOrigin(::blink::Vector<ReportingApiEndpointPtr> endpoints) {
