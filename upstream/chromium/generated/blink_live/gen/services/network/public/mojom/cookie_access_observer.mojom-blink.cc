...
CookieAccessDetails::CookieAccessDetails(
    ...
    ::blink::Vector<::network::mojom::blink::CookieOrLineWithAccessResultPtr> cookie_list_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<::network::mojom::blink::CookieOrLineWithAccessResultPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
uint32_t CookieAccessObserver::OnCookiesAccessed_Sym::IPCStableHash() {
  ...
  static constexpr uint32_t kHash = 0xed61374e;  // IPCStableHash for network::mojom::CookieAccessObserver::OnCookiesAccessed
...
uint32_t CookieAccessObserver::Clone_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xee73f55a;  // IPCStableHash for network::mojom::CookieAccessObserver::Clone
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void CookieAccessObserverProxy::OnCookiesAccessed(
    ::blink::Vector<CookieAccessDetailsPtr> in_details) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("details"), in_details,
                        "<value of type ::blink::Vector<CookieAccessDetailsPtr>>");
   });
#endif
  ...
  mojo::Message message(
      std::to_underlying(messages::CookieAccessObserver::kOnCookiesAccessed), kFlags, estimated_payload_size);
...
void CookieAccessObserverProxy::Clone(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::CookieAccessObserver::kClone), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool CookieAccessObserverStubDispatch::Accept(
  ...
  switch (static_cast<messages::CookieAccessObserver>(message->header()->name)) {
    case messages::CookieAccessObserver::kOnCookiesAccessed: {
      ...
      bool success = true;
      ::blink::Vector<CookieAccessDetailsPtr> p_details{};
...
bool CookieAccessObserverRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::blink::CookieAccessObserver::Name_,
    kCookieAccessObserverValidationInfo);
}
...
void CookieAccessObserverInterceptorForTesting::OnCookiesAccessed(::blink::Vector<CookieAccessDetailsPtr> details) {
