...
class UDPSocket
 ...
 public:
  ...
  static constexpr const char* Name_ = "network.mojom.UDPSocket";
...
// with not having this data in traces there.
  ...
  using BindCallback = base::OnceCallback<void(int32_t, ::network::mojom::blink::IPEndPointPtr)>;
  using BindMojoCallback = base::OnceCallback<void(int32_t, ::network::mojom::blink::IPEndPointPtr)>;

  virtual void Bind(::network::mojom::blink::IPEndPointPtr local_addr, UDPSocketOptionsPtr socket_options, BindCallback callback) = 0;

  using ConnectCallback = base::OnceCallback<void(int32_t, ::network::mojom::blink::IPEndPointPtr)>;
  using ConnectMojoCallback = base::OnceCallback<void(int32_t, ::network::mojom::blink::IPEndPointPtr)>;

  virtual void Connect(::network::mojom::blink::IPEndPointPtr remote_addr, UDPSocketOptionsPtr socket_options, ConnectCallback callback) = 0;

  using SetBroadcastCallback = base::OnceCallback<void(int32_t)>;
  using SetBroadcastMojoCallback = base::OnceCallback<void(int32_t)>;
  ...
  virtual void JoinGroup(::network::mojom::blink::IPAddressPtr group_address, ::network::mojom::blink::IPAddressPtr source_address, JoinGroupCallback callback) = 0;

  using LeaveGroupCallback = base::OnceCallback<void(int32_t)>;
  using LeaveGroupMojoCallback = base::OnceCallback<void(int32_t)>;

  virtual void LeaveGroup(::network::mojom::blink::IPAddressPtr group_address, ::network::mojom::blink::IPAddressPtr source_address, LeaveGroupCallback callback) = 0;
  ...
  virtual void SendTo(::network::mojom::blink::IPEndPointPtr dest_addr, ::mojo_base::mojom::blink::ReadOnlyBufferPtr data, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, SendToCallback callback) = 0;

  using SendCallback = base::OnceCallback<void(int32_t)>;
  using SendMojoCallback = base::OnceCallback<void(int32_t)>;

  virtual void Send(::mojo_base::mojom::blink::ReadOnlyBufferPtr data, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, SendCallback callback) = 0;
...
class UDPSocketListener
 ...
 public:
  using IPCStableHashFunction = uint32_t(*)();
  static constexpr const char* Name_ = "network.mojom.UDPSocketListener";
  static IPCStableHashFunction MessageToMethodInfo_(mojo::Message& message);
  static const char* MessageToMethodName_(mojo::Message& message);
  static constexpr uint32_t Version_ = 0;
  static constexpr bool PassesAssociatedKinds_ = false;
...
// with not having this data in traces there.
  ...
  virtual void OnReceived(int32_t result, ::network::mojom::blink::IPEndPointPtr src_addr, ::mojo_base::mojom::blink::ReadOnlyBufferPtr data) = 0;
};
...
class  UDPSocketProxy
 ...
 public:
  ...
  void Bind(::network::mojom::blink::IPEndPointPtr local_addr, UDPSocketOptionsPtr socket_options, BindCallback callback) final;
  
  void Connect(::network::mojom::blink::IPEndPointPtr remote_addr, UDPSocketOptionsPtr socket_options, ConnectCallback callback) final;
  ...
  void JoinGroup(::network::mojom::blink::IPAddressPtr group_address, ::network::mojom::blink::IPAddressPtr source_address, JoinGroupCallback callback) final;
  
  void LeaveGroup(::network::mojom::blink::IPAddressPtr group_address, ::network::mojom::blink::IPAddressPtr source_address, LeaveGroupCallback callback) final;
  ...
  void SendTo(::network::mojom::blink::IPEndPointPtr dest_addr, ::mojo_base::mojom::blink::ReadOnlyBufferPtr data, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, SendToCallback callback) final;
  
  void Send(::mojo_base::mojom::blink::ReadOnlyBufferPtr data, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, SendCallback callback) final;
...
class  UDPSocketListenerProxy
 ...
 public:
  ...
  void OnReceived(int32_t result, ::network::mojom::blink::IPEndPointPtr src_addr, ::mojo_base::mojom::blink::ReadOnlyBufferPtr data) final;
 ...
 public:
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        UDPSocketOptions::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        UDPSocketOptions::DataView, ::blink::Vector<uint8_t>>(input);
  }
