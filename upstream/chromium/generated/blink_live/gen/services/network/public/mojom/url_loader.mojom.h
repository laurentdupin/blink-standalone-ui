...
// with not having this data in traces there.
  ...
  virtual void FollowRedirect(::network::mojom::HttpRequestHeadersUpdateParamsPtr headers_update_params, const std::optional<::GURL>& new_url) = 0;

  virtual void SetPriority(::network::mojom::RequestPriority priority, int32_t intra_priority_value) = 0;
};
...
class  URLLoaderProxy
 ...
 public:
  ...
  void FollowRedirect(::network::mojom::HttpRequestHeadersUpdateParamsPtr headers_update_params, const std::optional<::GURL>& new_url) final;
  
  void SetPriority(::network::mojom::RequestPriority priority, int32_t intra_priority_value) final;
