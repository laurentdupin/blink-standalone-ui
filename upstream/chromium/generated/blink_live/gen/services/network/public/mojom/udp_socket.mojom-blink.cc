// services/network/public/mojom/udp_socket.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void UDPSocketProxy::SendTo(
    ::network::mojom::blink::IPEndPointPtr in_dest_addr, ::mojo_base::mojom::blink::ReadOnlyBufferPtr in_data, const ::net::MutableNetworkTrafficAnnotationTag& in_traffic_annotation, SendToCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void UDPSocketProxy::Send(
    ::mojo_base::mojom::blink::ReadOnlyBufferPtr in_data, const ::net::MutableNetworkTrafficAnnotationTag& in_traffic_annotation, SendCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool UDPSocketRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::blink::UDPSocket::Name_,
...
bool UDPSocketListenerRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::blink::UDPSocketListener::Name_,
...
void UDPSocketInterceptorForTesting::JoinGroup(::network::mojom::blink::IPAddressPtr group_address, ::network::mojom::blink::IPAddressPtr source_address, JoinGroupCallback callback) {
...
void UDPSocketInterceptorForTesting::LeaveGroup(::network::mojom::blink::IPAddressPtr group_address, ::network::mojom::blink::IPAddressPtr source_address, LeaveGroupCallback callback) {
...
void UDPSocketInterceptorForTesting::SendTo(::network::mojom::blink::IPEndPointPtr dest_addr, ::mojo_base::mojom::blink::ReadOnlyBufferPtr data, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, SendToCallback callback) {
...
void UDPSocketInterceptorForTesting::Send(::mojo_base::mojom::blink::ReadOnlyBufferPtr data, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, SendCallback callback) {
...
int32_t UDPSocketAsyncWaiter::SendTo(
    ::network::mojom::blink::IPEndPointPtr dest_addr, ::mojo_base::mojom::blink::ReadOnlyBufferPtr data, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation) {
  int32_t async_wait_result;
...
int32_t UDPSocketAsyncWaiter::Send(
    ::mojo_base::mojom::blink::ReadOnlyBufferPtr data, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation) {
  int32_t async_wait_result;
...
void UDPSocketListenerInterceptorForTesting::OnReceived(int32_t result, ::network::mojom::blink::IPEndPointPtr src_addr, ::mojo_base::mojom::blink::ReadOnlyBufferPtr data) {
