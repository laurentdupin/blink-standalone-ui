...
bool WebBundleHandle_Clone_Params_Data::Validate(
  ...
  [[maybe_unused]] const WebBundleHandle_Clone_Params_Data* object =
      static_cast<const WebBundleHandle_Clone_Params_Data*>(data);
...
bool WebBundleHandle_OnWebBundleError_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const WebBundleHandle_OnWebBundleError_Params_Data* object =
      static_cast<const WebBundleHandle_OnWebBundleError_Params_Data*>(data);
