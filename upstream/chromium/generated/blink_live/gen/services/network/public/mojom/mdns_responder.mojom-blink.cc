// services/network/public/mojom/mdns_responder.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void MdnsResponderProxy::CreateNameForAddress(
    ::network::mojom::blink::IPAddressPtr in_address, CreateNameForAddressCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void MdnsResponderProxy::RemoveNameForAddress(
    ::network::mojom::blink::IPAddressPtr in_address, RemoveNameForAddressCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
class MdnsResponder_CreateNameForAddress_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      const ::blink::String& in_name, bool in_announcement_scheduled);
};
...
bool MdnsResponderStubDispatch::AcceptWithResponder(
  ...
  switch (static_cast<messages::MdnsResponder>(message->header()->name)) {
    case messages::MdnsResponder::kCreateNameForAddress: {
      ...
      // Validation for MdnsResponder.0
      bool success = true;
      ::network::mojom::blink::IPAddressPtr p_address{};
...
bool MdnsResponderRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::blink::MdnsResponder::Name_,
