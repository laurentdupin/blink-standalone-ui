...
void NetLogExporterProxy::Start(
    ::mojo_base::mojom::blink::FilePtr in_destination, ::mojo_base::mojom::blink::DictionaryValuePtr in_extra_constants, NetLogCaptureMode in_capture_mode, uint64_t in_max_file_size, StartCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool NetLogExporterStubDispatch::AcceptWithResponder(
  ...
  switch (static_cast<messages::NetLogExporter>(message->header()->name)) {
    case messages::NetLogExporter::kStart: {
      ...
      // Validation for NetLogExporter.0
      bool success = true;
      ::mojo_base::mojom::blink::FilePtr p_destination{};
...
bool NetLogExporterRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::blink::NetLogExporter::Name_,
...
bool NetLogProxySourceRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::blink::NetLogProxySource::Name_,
...
void NetLogProxySinkProxy::AddEntry(
    uint32_t in_type, ::network::mojom::blink::NetLogSourcePtr in_net_log_source, NetLogEventPhase in_phase, ::base::TimeTicks in_time, ::mojo_base::mojom::blink::DictionaryValuePtr in_params) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool NetLogProxySinkStubDispatch::Accept(
  ...
  switch (static_cast<messages::NetLogProxySink>(message->header()->name)) {
    case messages::NetLogProxySink::kAddEntry: {
      ...
      ::mojo_base::mojom::blink::DictionaryValuePtr p_params{};
...
bool NetLogProxySinkRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::blink::NetLogProxySink::Name_,
...
void NetLogExporterInterceptorForTesting::Start(::mojo_base::mojom::blink::FilePtr destination, ::mojo_base::mojom::blink::DictionaryValuePtr extra_constants, NetLogCaptureMode capture_mode, uint64_t max_file_size, StartCallback callback) {
...
void NetLogExporterAsyncWaiter::Start(
    ::mojo_base::mojom::blink::FilePtr destination, ::mojo_base::mojom::blink::DictionaryValuePtr extra_constants, NetLogCaptureMode capture_mode, uint64_t max_file_size, int32_t* out_net_error) {
  base::RunLoop loop;
  proxy_->Start(
      std::move(destination),
      std::move(extra_constants),
...
int32_t NetLogExporterAsyncWaiter::Start(
    ::mojo_base::mojom::blink::FilePtr destination, ::mojo_base::mojom::blink::DictionaryValuePtr extra_constants, NetLogCaptureMode capture_mode, uint64_t max_file_size) {
...
int32_t NetLogExporterAsyncWaiter::Stop(
    ::mojo_base::mojom::blink::DictionaryValuePtr polled_values) {
  int32_t async_wait_result;
...
void NetLogProxySinkInterceptorForTesting::AddEntry(uint32_t type, ::network::mojom::blink::NetLogSourcePtr net_log_source, NetLogEventPhase phase, ::base::TimeTicks time, ::mojo_base::mojom::blink::DictionaryValuePtr params) {
