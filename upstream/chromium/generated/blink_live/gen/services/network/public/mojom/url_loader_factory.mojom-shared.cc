// services/network/public/mojom/url_loader_factory.mojom-shared.cc is auto generated by mojom_bindings_generator.py, do not edit
...
bool URLLoaderFactory_CreateLoaderAndStart_Params_Data::Validate(
  ...
  [[maybe_unused]] const URLLoaderFactory_CreateLoaderAndStart_Params_Data* object =
      static_cast<const URLLoaderFactory_CreateLoaderAndStart_Params_Data*>(data);
...
URLLoaderFactory_CreateLoaderAndStart_Params_Data::URLLoaderFactory_CreateLoaderAndStart_Params_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool URLLoaderFactory_Clone_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const URLLoaderFactory_Clone_Params_Data* object =
      static_cast<const URLLoaderFactory_Clone_Params_Data*>(data);
...
URLLoaderFactory_Clone_Params_Data::URLLoaderFactory_Clone_Params_Data()
    : header_({sizeof(*this), 0}) {}
