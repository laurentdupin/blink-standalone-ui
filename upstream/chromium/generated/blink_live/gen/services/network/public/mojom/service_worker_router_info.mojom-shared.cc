...
NOINLINE static const char* ServiceWorkerRouterSourceTypeToStringHelper(ServiceWorkerRouterSourceType value) {
  ...
  switch(value) {
    case ServiceWorkerRouterSourceType::kNetwork:
      return "kNetwork";
    case ServiceWorkerRouterSourceType::kRaceNetworkAndFetchEvent:
      return "kRaceNetworkAndFetchEvent";
    case ServiceWorkerRouterSourceType::kFetchEvent:
      return "kFetchEvent";
    case ServiceWorkerRouterSourceType::kCache:
      return "kCache";
    case ServiceWorkerRouterSourceType::kRaceNetworkAndCache:
      return "kRaceNetworkAndCache";
    default:
      return nullptr;
  }
}
