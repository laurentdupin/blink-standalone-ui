...
ProxyConfigWithAnnotation::ProxyConfigWithAnnotation(
    ::network::mojom::ProxyConfigPtr value_in,
...
void ProxyConfigWithAnnotation::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      ...
      "<value of type ::network::mojom::ProxyConfigPtr>"
#else
      "<value>"
...
void ProxyConfigClientProxy::OnProxyConfigUpdated(
  ...
  mojo::Message message(
      std::to_underlying(messages::ProxyConfigClient::kOnProxyConfigUpdated), kFlags, estimated_payload_size);
...
void ProxyConfigClientProxy::FlushProxyConfig(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::ProxyConfigClient::kFlushProxyConfig), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool ProxyConfigClientRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::ProxyConfigClient::Name_,
...
void ProxyConfigPollerClientProxy::OnLazyProxyConfigPoll(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::ProxyConfigPollerClient::kOnLazyProxyConfigPoll), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool ProxyConfigPollerClientRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::ProxyConfigPollerClient::Name_,
...
void ProxyErrorClientProxy::OnPACScriptError(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::ProxyErrorClient::kOnPACScriptError), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void ProxyErrorClientProxy::OnRequestMaybeFailedDueToProxySettings(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::ProxyErrorClient::kOnRequestMaybeFailedDueToProxySettings), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool ProxyErrorClientRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::ProxyErrorClient::Name_,
