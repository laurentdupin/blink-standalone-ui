...
uint32_t ProxyResolvingSocket::UpgradeToTLS_Sym::IPCStableHash() {
  ...
  static constexpr uint32_t kHash = 0x3940a03d;  // IPCStableHash for network::mojom::ProxyResolvingSocket::UpgradeToTLS
...
void ProxyResolvingSocketProxy::UpgradeToTLS(
    ::network::mojom::HostPortPairPtr in_host_port_pair, const ::net::MutableNetworkTrafficAnnotationTag& in_traffic_annotation, ::mojo::PendingReceiver<::network::mojom::TLSClientSocket> in_receiver, ::mojo::PendingRemote<::network::mojom::SocketObserver> in_observer, UpgradeToTLSCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  mojo::Message message(
      std::to_underlying(messages::ProxyResolvingSocket::kUpgradeToTLS), kFlags, estimated_payload_size);
...
bool ProxyResolvingSocketRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::ProxyResolvingSocket::Name_,
    kProxyResolvingSocketValidationInfo);
}
...
uint32_t ProxyResolvingSocketFactory::CreateProxyResolvingSocket_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x12dfedd0;  // IPCStableHash for network::mojom::ProxyResolvingSocketFactory::CreateProxyResolvingSocket
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void ProxyResolvingSocketFactoryProxy::CreateProxyResolvingSocket(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::ProxyResolvingSocketFactory::kCreateProxyResolvingSocket), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
class ProxyResolvingSocketFactory_CreateProxyResolvingSocket_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      int32_t in_result, ::network::mojom::IPEndPointPtr in_local_addr, ::network::mojom::IPEndPointPtr in_peer_addr, ::mojo::ScopedDataPipeConsumerHandle in_receive_stream, ::mojo::ScopedDataPipeProducerHandle in_send_stream);
};
...
bool ProxyResolvingSocketFactoryRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::ProxyResolvingSocketFactory::Name_,
    kProxyResolvingSocketFactoryValidationInfo);
}
