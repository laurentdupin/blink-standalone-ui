...
class  RestrictedCookieManager_SetCanonicalCookie_Params_Data {
 public:
  ...
  mojo::internal::StructHeader header_;
  mojo::internal::Pointer<internal::RestrictedCanonicalCookieParams_Data> canonical_cookie_params;
  mojo::internal::Pointer<::url::mojom::internal::Url_Data> url;
  mojo::internal::Pointer<::network::mojom::internal::SiteForCookies_Data> site_for_cookies;
  mojo::internal::Pointer<::url::mojom::internal::Origin_Data> top_frame_origin;
  int32_t storage_access_api_status;
...
class RestrictedCookieManager_SetCanonicalCookie_ParamsDataView {
 public:
  ...
  bool is_null() const { return !data_; }
  inline void GetCanonicalCookieParamsDataView(
      RestrictedCanonicalCookieParamsDataView* output);

  template <typename UserType>
  [[nodiscard]] bool ReadCanonicalCookieParams(UserType* output) {
    
    auto* pointer = data_->canonical_cookie_params.Get();
    return mojo::internal::Deserialize<::network::mojom::RestrictedCanonicalCookieParamsDataView>(
        pointer, output, message_);
  }
  inline void GetUrlDataView(
      ::url::mojom::UrlDataView* output);
...
inline void RestrictedCookieManager_SetCanonicalCookie_ParamsDataView::GetCanonicalCookieParamsDataView(
    RestrictedCanonicalCookieParamsDataView* output) {
  auto pointer = data_->canonical_cookie_params.Get();
  *output = RestrictedCanonicalCookieParamsDataView(pointer, message_);
}
