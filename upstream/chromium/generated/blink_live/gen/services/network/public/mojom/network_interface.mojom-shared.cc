...
// static
bool NetworkInterface_Data::Validate(
    const void* data,
  ...
  [[maybe_unused]] const NetworkInterface_Data* object =
      static_cast<const NetworkInterface_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->friendly_name, 2, validation_context)) {
    return false;
  }
  constexpr const mojo::internal::ContainerValidateParams& friendly_name_validate_params =
      mojo::internal::GetArrayValidator<0, false, nullptr>();
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->address, 5, validation_context)) {
    return false;
  }
