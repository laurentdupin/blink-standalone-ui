...
#include "services/network/public/mojom/connection_allowlist.mojom-forward.h"
...
// with not having this data in traces there.
  ...
  virtual void OnRawRequest(const std::string& devtool_request_id, std::vector<::network::mojom::CookieWithAccessResultPtr> cookies_with_access_result, std::vector<::network::mojom::HttpRawHeaderPairPtr> headers, ::base::TimeTicks timestamp, std::vector<::network::mojom::DeviceBoundSessionWithUsagePtr> device_bound_session_usages, ::network::mojom::ClientSecurityStatePtr client_security_state, OtherPartitionInfoPtr other_partition_info, const std::optional<::base::UnguessableToken>& applied_network_conditions_id) = 0;

  virtual void OnRawResponse(const std::string& devtool_request_id, std::vector<::network::mojom::CookieAndLineWithAccessResultPtr> cookies_with_access_result, std::vector<::network::mojom::HttpRawHeaderPairPtr> headers, const std::optional<std::string>& raw_response_headers, ::network::mojom::IPAddressSpace resource_address_space, int32_t http_status_code, ::network::mojom::CookiePartitionKeyPtr cookie_partition_key) = 0;
  ...
  virtual void OnLocalNetworkRequest(const std::optional<std::string>& devtool_request_id, const ::GURL& url, bool is_warning, ::network::mojom::IPAddressSpace resource_address_space, ::network::mojom::ClientSecurityStatePtr client_security_state) = 0;

  virtual void OnCorsPreflightRequest(const ::base::UnguessableToken& devtool_request_id, ::network::mojom::HttpRequestHeadersPtr request_headers, URLRequestDevToolsInfoPtr request_info, const ::GURL& initiator_url, const std::string& initiator_devtool_request_id) = 0;
  ...
  virtual void OnCorsError(const std::optional<std::string>& devtool_request_id, const std::optional<::url::Origin>& initiator_origin, ::network::mojom::ClientSecurityStatePtr client_security_state, const ::GURL& url, ::network::mojom::CorsErrorStatusPtr status, bool is_warning) = 0;
  ...
  virtual void OnConnectionAllowlistIssue(const std::string& devtool_request_id, const ::GURL& url, ::network::mojom::ConnectionAllowlistIssue issue) = 0;
...
class  DevToolsObserverProxy
 ...
 public:
  ...
  void OnRawRequest(const std::string& devtool_request_id, std::vector<::network::mojom::CookieWithAccessResultPtr> cookies_with_access_result, std::vector<::network::mojom::HttpRawHeaderPairPtr> headers, ::base::TimeTicks timestamp, std::vector<::network::mojom::DeviceBoundSessionWithUsagePtr> device_bound_session_usages, ::network::mojom::ClientSecurityStatePtr client_security_state, OtherPartitionInfoPtr other_partition_info, const std::optional<::base::UnguessableToken>& applied_network_conditions_id) final;
  
  void OnRawResponse(const std::string& devtool_request_id, std::vector<::network::mojom::CookieAndLineWithAccessResultPtr> cookies_with_access_result, std::vector<::network::mojom::HttpRawHeaderPairPtr> headers, const std::optional<std::string>& raw_response_headers, ::network::mojom::IPAddressSpace resource_address_space, int32_t http_status_code, ::network::mojom::CookiePartitionKeyPtr cookie_partition_key) final;
  ...
  void OnLocalNetworkRequest(const std::optional<std::string>& devtool_request_id, const ::GURL& url, bool is_warning, ::network::mojom::IPAddressSpace resource_address_space, ::network::mojom::ClientSecurityStatePtr client_security_state) final;
  
  void OnCorsPreflightRequest(const ::base::UnguessableToken& devtool_request_id, ::network::mojom::HttpRequestHeadersPtr request_headers, URLRequestDevToolsInfoPtr request_info, const ::GURL& initiator_url, const std::string& initiator_devtool_request_id) final;
  ...
  void OnCorsError(const std::optional<std::string>& devtool_request_id, const std::optional<::url::Origin>& initiator_origin, ::network::mojom::ClientSecurityStatePtr client_security_state, const ::GURL& url, ::network::mojom::CorsErrorStatusPtr status, bool is_warning) final;
  ...
  void OnConnectionAllowlistIssue(const std::string& devtool_request_id, const ::GURL& url, ::network::mojom::ConnectionAllowlistIssue issue) final;
