...
// with not having this data in traces there.
  ...
  virtual void UpgradeToTLS(::network::mojom::blink::HostPortPairPtr host_port_pair, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::mojo::PendingReceiver<::network::mojom::blink::TLSClientSocket> receiver, ::mojo::PendingRemote<::network::mojom::blink::SocketObserver> observer, UpgradeToTLSCallback callback) = 0;
};
...
// with not having this data in traces there.
  ...
  using CreateProxyResolvingSocketCallback = base::OnceCallback<void(int32_t, ::network::mojom::blink::IPEndPointPtr, ::network::mojom::blink::IPEndPointPtr, ::mojo::ScopedDataPipeConsumerHandle, ::mojo::ScopedDataPipeProducerHandle)>;
  using CreateProxyResolvingSocketMojoCallback = base::OnceCallback<void(int32_t, ::network::mojom::blink::IPEndPointPtr, ::network::mojom::blink::IPEndPointPtr, ::mojo::ScopedDataPipeConsumerHandle, ::mojo::ScopedDataPipeProducerHandle)>;
...
class  ProxyResolvingSocketProxy
 ...
 public:
  ...
  void UpgradeToTLS(::network::mojom::blink::HostPortPairPtr host_port_pair, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::mojo::PendingReceiver<::network::mojom::blink::TLSClientSocket> receiver, ::mojo::PendingRemote<::network::mojom::blink::SocketObserver> observer, UpgradeToTLSCallback callback) final;
...
class  ProxyResolvingSocketFactoryProxy
 ...
 public:
  ...
  void CreateProxyResolvingSocket(const ::blink::KURL& url, ::network::mojom::blink::NetworkAnonymizationKeyPtr network_anonymization_key, ProxyResolvingSocketOptionsPtr options, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::mojo::PendingReceiver<ProxyResolvingSocket> socket, ::mojo::PendingRemote<::network::mojom::blink::SocketObserver> observer, CreateProxyResolvingSocketCallback callback) final;
 ...
 public:
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ProxyResolvingSocketOptions::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ProxyResolvingSocketOptions::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::network::mojom::blink::ProxyResolvingSocketOptions::DataView,
                                         ::network::mojom::blink::ProxyResolvingSocketOptionsPtr> {
  static bool IsNull(const ::network::mojom::blink::ProxyResolvingSocketOptionsPtr& input) { return !input; }
  static void SetToNull(::network::mojom::blink::ProxyResolvingSocketOptionsPtr* output) { output->reset(); }

  static decltype(::network::mojom::blink::ProxyResolvingSocketOptions::use_tls) use_tls(
