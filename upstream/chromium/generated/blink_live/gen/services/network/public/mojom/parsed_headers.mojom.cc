...
ParsedHeaders::ParsedHeaders()
    : content_security_policy(),
      ...
      prefetch_activation_beacon_endpoint() {}
...
ParsedHeaders::ParsedHeaders(
    ...
    ::network::mojom::ConnectionAllowlistsPtr connection_allowlists_in,
    ::network::mojom::CrossOriginEmbedderPolicyPtr cross_origin_embedder_policy_in,
    ::network::mojom::CrossOriginOpenerPolicyPtr cross_origin_opener_policy_in,
    ::network::mojom::DocumentIsolationPolicyPtr document_isolation_policy_in,
    ::network::mojom::IntegrityPolicyPtr integrity_policy_in,
    ::network::mojom::IntegrityPolicyPtr integrity_policy_report_only_in,
    ...
    std::optional<std::vector<std::string>> cookie_indices_in,
    std::optional<std::vector<std::string>> avail_language_in,
    ...
    ::network::mojom::DeclarativePerformanceObserverPolicyPtr declarative_performance_observer_policy_in,
    const std::optional<::GURL>& prefetch_activation_beacon_endpoint_in)
    : content_security_policy(std::move(content_security_policy_in)),
      ...
      declarative_performance_observer_policy(std::move(declarative_performance_observer_policy_in)),
      prefetch_activation_beacon_endpoint(std::move(prefetch_activation_beacon_endpoint_in)) {}
...
void ParsedHeaders::WriteIntoTrace(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::network::mojom::ConnectionAllowlistsPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::network::mojom::CrossOriginEmbedderPolicyPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::network::mojom::CrossOriginOpenerPolicyPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::network::mojom::IntegrityPolicyPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "declarative_performance_observer_policy"), this->declarative_performance_observer_policy,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::network::mojom::DeclarativePerformanceObserverPolicyPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "prefetch_activation_beacon_endpoint"), this->prefetch_activation_beacon_endpoint,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool StructTraits<::network::mojom::ParsedHeaders::DataView, ::network::mojom::ParsedHeadersPtr>::Read(
  ...
  ::network::mojom::ParsedHeadersPtr result(::network::mojom::ParsedHeaders::New());
      ...
      if (success && !input.ReadDeclarativePerformanceObserverPolicy(&result->declarative_performance_observer_policy))
        success = false;
      if (success && !input.ReadPrefetchActivationBeaconEndpoint(&result->prefetch_activation_beacon_endpoint))
        success = false;
