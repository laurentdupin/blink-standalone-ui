// services/network/public/mojom/encoded_body_length.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef SERVICES_NETWORK_PUBLIC_MOJOM_ENCODED_BODY_LENGTH_MOJOM_BLINK_H_
#define SERVICES_NETWORK_PUBLIC_MOJOM_ENCODED_BODY_LENGTH_MOJOM_BLINK_H_
...
#include "services/network/public/mojom/encoded_body_length.mojom-blink-forward.h"  // IWYU pragma: export
...
class BLINK_PLATFORM_EXPORT EncodedBodyLength {
 public:
  template <typename T>
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        EncodedBodyLength::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        EncodedBodyLength::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::EncodedBodyLength::DataView,
                                         ::network::mojom::blink::EncodedBodyLengthPtr> {
  static bool IsNull(const ::network::mojom::blink::EncodedBodyLengthPtr& input) { return !input; }
  static void SetToNull(::network::mojom::blink::EncodedBodyLengthPtr* output) { output->reset(); }

  static decltype(::network::mojom::blink::EncodedBodyLength::value) value(
      const ::network::mojom::blink::EncodedBodyLengthPtr& input) {
    return input->value;
  }

  static bool Read(::network::mojom::blink::EncodedBodyLength::DataView input, ::network::mojom::blink::EncodedBodyLengthPtr* output);
};

}  // namespace mojo

#endif  // SERVICES_NETWORK_PUBLIC_MOJOM_ENCODED_BODY_LENGTH_MOJOM_BLINK_H_