...
bool ProxyResolvingSocketRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::blink::ProxyResolvingSocket::Name_,
...
class ProxyResolvingSocketFactory_CreateProxyResolvingSocket_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      int32_t in_result, ::network::mojom::blink::IPEndPointPtr in_local_addr, ::network::mojom::blink::IPEndPointPtr in_peer_addr, ::mojo::ScopedDataPipeConsumerHandle in_receive_stream, ::mojo::ScopedDataPipeProducerHandle in_send_stream);
};
...
bool ProxyResolvingSocketFactoryRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::blink::ProxyResolvingSocketFactory::Name_,
