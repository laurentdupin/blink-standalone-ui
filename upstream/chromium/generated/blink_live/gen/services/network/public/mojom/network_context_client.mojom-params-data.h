...
static_assert(sizeof(NetworkContextClient_OnFileUploadRequested_Params_Data) == 48,
...
inline void NetworkContextClient_OnFileUploadRequested_ParamsDataView::GetProcessIdDataView(
    ::network::mojom::OriginatingProcessIdDataView* output) {
