...
void NetworkQualityEstimatorManagerClientProxy::OnNetworkQualityChanged(
    ::network::mojom::EffectiveConnectionType in_type, ::base::TimeDelta in_http_rtt, ::base::TimeDelta in_transport_rtt, int32_t in_downlink_bandwidth_kbps) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  mojo::Message message(
      std::to_underlying(messages::NetworkQualityEstimatorManagerClient::kOnNetworkQualityChanged), kFlags, estimated_payload_size);
...
bool NetworkQualityEstimatorManagerClientRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::NetworkQualityEstimatorManagerClient::Name_,
...
void NetworkQualityEstimatorManagerProxy::RequestNotifications(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::NetworkQualityEstimatorManager::kRequestNotifications), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool NetworkQualityEstimatorManagerRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::NetworkQualityEstimatorManager::Name_,
...
void NetworkQualityEstimatorManagerClientInterceptorForTesting::OnNetworkQualityChanged(::network::mojom::EffectiveConnectionType type, ::base::TimeDelta http_rtt, ::base::TimeDelta transport_rtt, int32_t downlink_bandwidth_kbps) {
