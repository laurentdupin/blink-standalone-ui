// services/network/public/mojom/shared_dictionary_usage_info.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef SERVICES_NETWORK_PUBLIC_MOJOM_SHARED_DICTIONARY_USAGE_INFO_MOJOM_BLINK_H_
#define SERVICES_NETWORK_PUBLIC_MOJOM_SHARED_DICTIONARY_USAGE_INFO_MOJOM_BLINK_H_
...
#include "services/network/public/mojom/shared_dictionary_usage_info.mojom-blink-forward.h"  // IWYU pragma: export
...
SharedDictionaryUsageInfo(const SharedDictionaryUsageInfo&) = delete;
SharedDictionaryUsageInfo& operator=(const SharedDictionaryUsageInfo&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SharedDictionaryUsageInfo::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SharedDictionaryUsageInfo::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::network::mojom::blink::SharedDictionaryUsageInfo::DataView,
                                         ::network::mojom::blink::SharedDictionaryUsageInfoPtr> {
  static bool IsNull(const ::network::mojom::blink::SharedDictionaryUsageInfoPtr& input) { return !input; }
  static void SetToNull(::network::mojom::blink::SharedDictionaryUsageInfoPtr* output) { output->reset(); }

  static const decltype(::network::mojom::blink::SharedDictionaryUsageInfo::isolation_key)& isolation_key(
      const ::network::mojom::blink::SharedDictionaryUsageInfoPtr& input) {
    return input->isolation_key;
  }

  static decltype(::network::mojom::blink::SharedDictionaryUsageInfo::total_size_bytes) total_size_bytes(
      const ::network::mojom::blink::SharedDictionaryUsageInfoPtr& input) {
    return input->total_size_bytes;
  }

  static bool Read(::network::mojom::blink::SharedDictionaryUsageInfo::DataView input, ::network::mojom::blink::SharedDictionaryUsageInfoPtr* output);
};

}  // namespace mojo

#endif  // SERVICES_NETWORK_PUBLIC_MOJOM_SHARED_DICTIONARY_USAGE_INFO_MOJOM_BLINK_H_