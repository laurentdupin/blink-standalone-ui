// services/network/public/mojom/hash_value.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef SERVICES_NETWORK_PUBLIC_MOJOM_HASH_VALUE_MOJOM_BLINK_H_
#define SERVICES_NETWORK_PUBLIC_MOJOM_HASH_VALUE_MOJOM_BLINK_H_
...
#include "services/network/public/mojom/hash_value.mojom-blink-forward.h"  // IWYU pragma: export
...
class BLINK_PLATFORM_EXPORT SHA256HashValue {
 public:
  template <typename T>
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::SHA256HashValue::DataView,
                                         ::network::mojom::blink::SHA256HashValuePtr> {
  static bool IsNull(const ::network::mojom::blink::SHA256HashValuePtr& input) { return !input; }
  static void SetToNull(::network::mojom::blink::SHA256HashValuePtr* output) { output->reset(); }

  static const decltype(::network::mojom::blink::SHA256HashValue::data)& data(
      const ::network::mojom::blink::SHA256HashValuePtr& input) {
    return input->data;
  }

  static bool Read(::network::mojom::blink::SHA256HashValue::DataView input, ::network::mojom::blink::SHA256HashValuePtr* output);
};

}  // namespace mojo

#endif  // SERVICES_NETWORK_PUBLIC_MOJOM_HASH_VALUE_MOJOM_BLINK_H_