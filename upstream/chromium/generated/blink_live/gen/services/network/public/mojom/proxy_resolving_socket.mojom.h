...
// with not having this data in traces there.
  ...
  virtual void UpgradeToTLS(::network::mojom::HostPortPairPtr host_port_pair, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::mojo::PendingReceiver<::network::mojom::TLSClientSocket> receiver, ::mojo::PendingRemote<::network::mojom::SocketObserver> observer, UpgradeToTLSCallback callback) = 0;
};
...
// with not having this data in traces there.
  ...
  using CreateProxyResolvingSocketCallback = base::OnceCallback<void(int32_t, ::network::mojom::IPEndPointPtr, ::network::mojom::IPEndPointPtr, ::mojo::ScopedDataPipeConsumerHandle, ::mojo::ScopedDataPipeProducerHandle)>;
  using CreateProxyResolvingSocketMojoCallback = base::OnceCallback<void(int32_t, ::network::mojom::IPEndPointPtr, ::network::mojom::IPEndPointPtr, ::mojo::ScopedDataPipeConsumerHandle, ::mojo::ScopedDataPipeProducerHandle)>;

  virtual void CreateProxyResolvingSocket(const ::GURL& url, ::network::mojom::NetworkAnonymizationKeyPtr network_anonymization_key, ProxyResolvingSocketOptionsPtr options, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::mojo::PendingReceiver<ProxyResolvingSocket> socket, ::mojo::PendingRemote<::network::mojom::SocketObserver> observer, CreateProxyResolvingSocketCallback callback) = 0;
};
...
class  ProxyResolvingSocketProxy
 ...
 public:
  ...
  void UpgradeToTLS(::network::mojom::HostPortPairPtr host_port_pair, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::mojo::PendingReceiver<::network::mojom::TLSClientSocket> receiver, ::mojo::PendingRemote<::network::mojom::SocketObserver> observer, UpgradeToTLSCallback callback) final;
...
class  ProxyResolvingSocketFactoryProxy
 ...
 public:
  ...
  void CreateProxyResolvingSocket(const ::GURL& url, ::network::mojom::NetworkAnonymizationKeyPtr network_anonymization_key, ProxyResolvingSocketOptionsPtr options, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::mojo::PendingReceiver<ProxyResolvingSocket> socket, ::mojo::PendingRemote<::network::mojom::SocketObserver> observer, CreateProxyResolvingSocketCallback callback) final;
