 ...
 public:
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        PreviousOperatorEntry::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        PreviousOperatorEntry::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
class  CTLogInfo {
 public:
  ...
  CTLogInfo(
      ::mojo_base::mojom::blink::ByteStringPtr id,
      ::mojo_base::mojom::blink::ByteStringPtr public_key,
      const ::blink::String& name,
      std::optional<::base::Time> disqualified_at,
      ::base::TimeDelta mmd,
      const ::blink::String& current_operator,
      ::blink::Vector<PreviousOperatorEntryPtr> previous_operators,
...
CTLogInfo& operator=(const CTLogInfo&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CTLogInfo::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CTLogInfo::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::network::mojom::blink::PreviousOperatorEntry::DataView,
                                         ::network::mojom::blink::PreviousOperatorEntryPtr> {
  static bool IsNull(const ::network::mojom::blink::PreviousOperatorEntryPtr& input) { return !input; }
  static void SetToNull(::network::mojom::blink::PreviousOperatorEntryPtr* output) { output->reset(); }

  static const decltype(::network::mojom::blink::PreviousOperatorEntry::name)& name(
      const ::network::mojom::blink::PreviousOperatorEntryPtr& input) {
    return input->name;
  }

  static const decltype(::network::mojom::blink::PreviousOperatorEntry::end_time)& end_time(
      const ::network::mojom::blink::PreviousOperatorEntryPtr& input) {
...
template <>
struct  StructTraits<::network::mojom::blink::CTLogInfo::DataView,
  ...
  static const decltype(::network::mojom::blink::CTLogInfo::id)& id(
  ...
  static const decltype(::network::mojom::blink::CTLogInfo::mmd)& mmd(
      const ::network::mojom::blink::CTLogInfoPtr& input) {
    return input->mmd;
  }

  static const decltype(::network::mojom::blink::CTLogInfo::current_operator)& current_operator(
      const ::network::mojom::blink::CTLogInfoPtr& input) {
    return input->current_operator;
  }

  static const decltype(::network::mojom::blink::CTLogInfo::previous_operators)& previous_operators(
      const ::network::mojom::blink::CTLogInfoPtr& input) {
    return input->previous_operators;
  }

  static decltype(::network::mojom::blink::CTLogInfo::log_type) log_type(
      const ::network::mojom::blink::CTLogInfoPtr& input) {
