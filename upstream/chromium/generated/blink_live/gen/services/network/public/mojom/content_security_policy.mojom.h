...
class  AllowCSPFromHeaderValue {
 public:
  ...
  const ::url::mojom::OriginPtr& get_origin() const {
    CHECK(tag_ == Tag::kOrigin);
    return data_.origin;
  }
  ::url::mojom::OriginPtr& get_origin() {
    CHECK(tag_ == Tag::kOrigin);
    return data_.origin;
  }
  void set_origin(::url::mojom::OriginPtr origin);
...
class  CSPSourceList {
 public:
  ...
  CSPSourceList(
      ...
      std::vector<::network::mojom::IntegrityMetadataPtr> hashes,
      std::vector<::network::mojom::IntegrityMetadataPtr> url_hashes,
      std::vector<::network::mojom::IntegrityMetadataPtr> eval_hashes,
      bool allow_self,
      bool allow_star,
      bool allow_inline,
...
struct  UnionTraits<::network::mojom::AllowCSPFromHeaderValue::DataView,
  ...
  static const ::url::mojom::OriginPtr& origin(const ::network::mojom::AllowCSPFromHeaderValuePtr& input) {
