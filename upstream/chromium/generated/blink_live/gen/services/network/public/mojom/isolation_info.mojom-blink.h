...
IsolationInfo(const IsolationInfo&) = delete;
IsolationInfo& operator=(const IsolationInfo&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        IsolationInfo::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        IsolationInfo::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::IsolationInfo::DataView,
  ...
  static decltype(::network::mojom::blink::IsolationInfo::network_isolation_partition) network_isolation_partition(
      const ::network::mojom::blink::IsolationInfoPtr& input) {
    return input->network_isolation_partition;
  }

  static decltype(::network::mojom::blink::IsolationInfo::frame_ancestor_relation) frame_ancestor_relation(
      const ::network::mojom::blink::IsolationInfoPtr& input) {
