...
// with not having this data in traces there.
  ...
  virtual void Verify(RequestParamsPtr params, ::network::mojom::NetLogSourcePtr net_log_source, ::mojo::PendingRemote<CertVerifierRequest> cert_verifier_request) = 0;

  using Verify2QwacBindingCallback = base::OnceCallback<void(::network::mojom::X509CertificatePtr)>;
  using Verify2QwacBindingMojoCallback = base::OnceCallback<void(::network::mojom::X509CertificatePtr)>;

  virtual void Verify2QwacBinding(const std::string& binding, const std::string& hostname, ::network::mojom::X509CertificatePtr tls_certificate, ::network::mojom::NetLogSourcePtr net_log_source, Verify2QwacBindingCallback callback) = 0;
...
// with not having this data in traces there.
  ...
  virtual void Complete(::network::mojom::CertVerifyResultPtr result, int32_t net_error) = 0;
};
...
class  CertVerifierServiceProxy
 ...
 public:
  ...
  void Verify(RequestParamsPtr params, ::network::mojom::NetLogSourcePtr net_log_source, ::mojo::PendingRemote<CertVerifierRequest> cert_verifier_request) final;
  
  void Verify2QwacBinding(const std::string& binding, const std::string& hostname, ::network::mojom::X509CertificatePtr tls_certificate, ::network::mojom::NetLogSourcePtr net_log_source, Verify2QwacBindingCallback callback) final;
...
class  CertVerifierRequestProxy
 ...
 public:
  ...
  void Complete(::network::mojom::CertVerifyResultPtr result, int32_t net_error) final;
...
class  RequestParams {
 public:
  ...
  RequestParams(
      ::network::mojom::X509CertificatePtr certificate,
      const std::string& hostname,
      int32_t flags,
      ::mojo_base::mojom::ByteStringPtr ocsp_response,
      ::mojo_base::mojom::ByteStringPtr sct_list);
