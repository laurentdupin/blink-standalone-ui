...
class P2PTrustedSocketManagerClient
 ...
 public:
  ...
  static constexpr const char* Name_ = "network.mojom.P2PTrustedSocketManagerClient";
...
// with not having this data in traces there.
  ...
  virtual void DumpPacket(const ::blink::Vector<uint8_t>& packet_header, uint64_t packet_length, bool incoming) = 0;
};
...
class P2PTrustedSocketManager
 ...
 public:
  using IPCStableHashFunction = uint32_t(*)();
  static constexpr const char* Name_ = "network.mojom.P2PTrustedSocketManager";
  static IPCStableHashFunction MessageToMethodInfo_(mojo::Message& message);
  static const char* MessageToMethodName_(mojo::Message& message);
  static constexpr uint32_t Version_ = 0;
  static constexpr bool PassesAssociatedKinds_ = false;
...
class  P2PTrustedSocketManagerClientProxy
 ...
 public:
  ...
  void DumpPacket(const ::blink::Vector<uint8_t>& packet_header, uint64_t packet_length, bool incoming) final;
