...
RestrictedCanonicalCookieParams::RestrictedCanonicalCookieParams(
    ...
    ::network::mojom::CookiePriority priority_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::network::mojom::CookiePriority>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
# endif // !BUILDFLAG(IS_FUCHSIA)
bool RestrictedCookieManager::GetCookiesString(const ::GURL& url, ::network::mojom::SiteForCookiesPtr site_for_cookies, const ::url::Origin& top_frame_origin, ::network::mojom::StorageAccessApiStatus storage_access_api_status, bool get_version_shared_memory, bool is_ad_tagged, bool apply_devtools_overrides, bool force_disable_third_party_cookies, uint64_t* out_version, ::mojo_base::mojom::ReadOnlySharedMemoryRegionPtr* out_version_buffer, std::string* out_cookies) {
  NOTREACHED();
}
bool RestrictedCookieManager::CookiesEnabledFor(const ::GURL& url, ::network::mojom::SiteForCookiesPtr site_for_cookies, const ::url::Origin& top_frame_origin, ::network::mojom::StorageAccessApiStatus storage_access_api_status, bool apply_devtools_overrides, bool* out_cookies_enabled) {
  NOTREACHED();
}
...
class RestrictedCookieManager_GetCookiesString_HandleSyncResponse
 ...
 public:
  RestrictedCookieManager_GetCookiesString_HandleSyncResponse(
      bool* result, uint64_t* out_version, ::mojo_base::mojom::ReadOnlySharedMemoryRegionPtr* out_version_buffer, std::string* out_cookies)
 ...
 private:
  ...
  ::mojo_base::mojom::ReadOnlySharedMemoryRegionPtr* out_version_buffer_;
...
void RestrictedCookieManagerProxy::GetAllForUrl(
    const ::GURL& in_url, ::network::mojom::SiteForCookiesPtr in_site_for_cookies, const ::url::Origin& in_top_frame_origin, ::network::mojom::StorageAccessApiStatus in_storage_access_api_status, CookieManagerGetOptionsPtr in_options, bool in_is_ad_tagged, bool in_apply_devtools_overrides, bool in_force_disable_third_party_cookies, GetAllForUrlCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("site_for_cookies"), in_site_for_cookies,
                        "<value of type ::network::mojom::SiteForCookiesPtr>");
      perfetto::WriteIntoTracedValueWithFallback(
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("storage_access_api_status"), in_storage_access_api_status,
                        "<value of type ::network::mojom::StorageAccessApiStatus>");
      perfetto::WriteIntoTracedValueWithFallback(
...
void RestrictedCookieManagerProxy::SetCanonicalCookie(
    RestrictedCanonicalCookieParamsPtr in_canonical_cookie_params, const ::GURL& in_url, ::network::mojom::SiteForCookiesPtr in_site_for_cookies, const ::url::Origin& in_top_frame_origin, ::network::mojom::StorageAccessApiStatus in_storage_access_api_status, bool in_is_ad_tagged, bool in_apply_devtools_overrides, SetCanonicalCookieCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void RestrictedCookieManagerProxy::AddChangeListener(
    const ::GURL& in_url, ::network::mojom::SiteForCookiesPtr in_site_for_cookies, const ::url::Origin& in_top_frame_origin, ::network::mojom::StorageAccessApiStatus in_storage_access_api_status, ::mojo::PendingRemote<::network::mojom::CookieChangeListener> in_listener, AddChangeListenerCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void RestrictedCookieManagerProxy::SetCookieFromString(
    const ::GURL& in_url, ::network::mojom::SiteForCookiesPtr in_site_for_cookies, const ::url::Origin& in_top_frame_origin, ::network::mojom::StorageAccessApiStatus in_storage_access_api_status, bool in_is_ad_tagged, bool in_apply_devtools_overrides, const std::string& in_cookie) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool RestrictedCookieManagerProxy::GetCookiesString(
    const ::GURL& param_url, ::network::mojom::SiteForCookiesPtr param_site_for_cookies, const ::url::Origin& param_top_frame_origin, ::network::mojom::StorageAccessApiStatus param_storage_access_api_status, bool param_get_version_shared_memory, bool param_is_ad_tagged, bool param_apply_devtools_overrides, bool param_force_disable_third_party_cookies, uint64_t* out_param_version, ::mojo_base::mojom::ReadOnlySharedMemoryRegionPtr* out_param_version_buffer, std::string* out_param_cookies) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_BEGIN1(
...
void RestrictedCookieManagerProxy::GetCookiesString(
    const ::GURL& in_url, ::network::mojom::SiteForCookiesPtr in_site_for_cookies, const ::url::Origin& in_top_frame_origin, ::network::mojom::StorageAccessApiStatus in_storage_access_api_status, bool in_get_version_shared_memory, bool in_is_ad_tagged, bool in_apply_devtools_overrides, bool in_force_disable_third_party_cookies, GetCookiesStringCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool RestrictedCookieManagerProxy::CookiesEnabledFor(
    const ::GURL& param_url, ::network::mojom::SiteForCookiesPtr param_site_for_cookies, const ::url::Origin& param_top_frame_origin, ::network::mojom::StorageAccessApiStatus param_storage_access_api_status, bool param_apply_devtools_overrides, bool* out_param_cookies_enabled) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_BEGIN1(
...
void RestrictedCookieManagerProxy::CookiesEnabledFor(
    const ::GURL& in_url, ::network::mojom::SiteForCookiesPtr in_site_for_cookies, const ::url::Origin& in_top_frame_origin, ::network::mojom::StorageAccessApiStatus in_storage_access_api_status, bool in_apply_devtools_overrides, CookiesEnabledForCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
class RestrictedCookieManager_GetAllForUrl_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      std::vector<::network::mojom::CookieWithAccessResultPtr> in_cookies);
};
...
bool RestrictedCookieManager_GetAllForUrl_ForwardToCallback::Accept(
  ...
  bool success = true;
  std::vector<::network::mojom::CookieWithAccessResultPtr> p_cookies{};
...
class RestrictedCookieManager_GetCookiesString_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      uint64_t in_version, ::mojo_base::mojom::ReadOnlySharedMemoryRegionPtr in_version_buffer, const std::string& in_cookies);
};
...
bool RestrictedCookieManager_GetCookiesString_ForwardToCallback::Accept(
  ...
  bool success = true;
  uint64_t p_version{};
  ::mojo_base::mojom::ReadOnlySharedMemoryRegionPtr p_version_buffer{};
...
bool RestrictedCookieManagerStubDispatch::Accept(
  ...
  switch (static_cast<messages::RestrictedCookieManager>(message->header()->name)) {
    ...
    case messages::RestrictedCookieManager::kSetCookieFromString: {
      ...
      bool success = true;
      ::GURL p_url{};
      ::network::mojom::SiteForCookiesPtr p_site_for_cookies{};
      ::url::Origin p_top_frame_origin{};
      ::network::mojom::StorageAccessApiStatus p_storage_access_api_status{};
      bool p_is_ad_tagged{};
...
// static
bool StructTraits<::network::mojom::RestrictedCanonicalCookieParams::DataView, ::network::mojom::RestrictedCanonicalCookieParamsPtr>::Read(
    ::network::mojom::RestrictedCanonicalCookieParams::DataView input,
    ::network::mojom::RestrictedCanonicalCookieParamsPtr* output) {
  bool success = true;
  ::network::mojom::RestrictedCanonicalCookieParamsPtr result(::network::mojom::RestrictedCanonicalCookieParams::New());
...
void RestrictedCookieManagerInterceptorForTesting::GetAllForUrl(const ::GURL& url, ::network::mojom::SiteForCookiesPtr site_for_cookies, const ::url::Origin& top_frame_origin, ::network::mojom::StorageAccessApiStatus storage_access_api_status, CookieManagerGetOptionsPtr options, bool is_ad_tagged, bool apply_devtools_overrides, bool force_disable_third_party_cookies, GetAllForUrlCallback callback) {
...
void RestrictedCookieManagerInterceptorForTesting::SetCanonicalCookie(RestrictedCanonicalCookieParamsPtr canonical_cookie_params, const ::GURL& url, ::network::mojom::SiteForCookiesPtr site_for_cookies, const ::url::Origin& top_frame_origin, ::network::mojom::StorageAccessApiStatus storage_access_api_status, bool is_ad_tagged, bool apply_devtools_overrides, SetCanonicalCookieCallback callback) {
...
void RestrictedCookieManagerInterceptorForTesting::AddChangeListener(const ::GURL& url, ::network::mojom::SiteForCookiesPtr site_for_cookies, const ::url::Origin& top_frame_origin, ::network::mojom::StorageAccessApiStatus storage_access_api_status, ::mojo::PendingRemote<::network::mojom::CookieChangeListener> listener, AddChangeListenerCallback callback) {
...
void RestrictedCookieManagerInterceptorForTesting::SetCookieFromString(const ::GURL& url, ::network::mojom::SiteForCookiesPtr site_for_cookies, const ::url::Origin& top_frame_origin, ::network::mojom::StorageAccessApiStatus storage_access_api_status, bool is_ad_tagged, bool apply_devtools_overrides, const std::string& cookie) {
...
void RestrictedCookieManagerInterceptorForTesting::GetCookiesString(const ::GURL& url, ::network::mojom::SiteForCookiesPtr site_for_cookies, const ::url::Origin& top_frame_origin, ::network::mojom::StorageAccessApiStatus storage_access_api_status, bool get_version_shared_memory, bool is_ad_tagged, bool apply_devtools_overrides, bool force_disable_third_party_cookies, GetCookiesStringCallback callback) {
...
void RestrictedCookieManagerInterceptorForTesting::CookiesEnabledFor(const ::GURL& url, ::network::mojom::SiteForCookiesPtr site_for_cookies, const ::url::Origin& top_frame_origin, ::network::mojom::StorageAccessApiStatus storage_access_api_status, bool apply_devtools_overrides, CookiesEnabledForCallback callback) {
...
void RestrictedCookieManagerAsyncWaiter::GetAllForUrl(
  ...
  proxy_->GetAllForUrl(
      ...
      base::BindOnce(
          [](base::RunLoop* loop,
             std::vector<::network::mojom::CookieWithAccessResultPtr>* out_cookies
,
             std::vector<::network::mojom::CookieWithAccessResultPtr> cookies) {*out_cookies = std::move(cookies);
            loop->Quit();
          },
          &loop,
          out_cookies));
...
std::vector<::network::mojom::CookieWithAccessResultPtr> RestrictedCookieManagerAsyncWaiter::GetAllForUrl(
    const ::GURL& url, ::network::mojom::SiteForCookiesPtr site_for_cookies, const ::url::Origin& top_frame_origin, ::network::mojom::StorageAccessApiStatus storage_access_api_status, CookieManagerGetOptionsPtr options, bool is_ad_tagged, bool apply_devtools_overrides, bool force_disable_third_party_cookies) {
  std::vector<::network::mojom::CookieWithAccessResultPtr> async_wait_result;
...
bool RestrictedCookieManagerAsyncWaiter::SetCanonicalCookie(
    RestrictedCanonicalCookieParamsPtr canonical_cookie_params, const ::GURL& url, ::network::mojom::SiteForCookiesPtr site_for_cookies, const ::url::Origin& top_frame_origin, ::network::mojom::StorageAccessApiStatus storage_access_api_status, bool is_ad_tagged, bool apply_devtools_overrides) {
...
,
             ::mojo_base::mojom::ReadOnlySharedMemoryRegionPtr* out_version_buffer
,
             std::string* out_cookies
,
             uint64_t version,
             ::mojo_base::mojom::ReadOnlySharedMemoryRegionPtr version_buffer,
...
bool RestrictedCookieManagerAsyncWaiter::CookiesEnabledFor(
    const ::GURL& url, ::network::mojom::SiteForCookiesPtr site_for_cookies, const ::url::Origin& top_frame_origin, ::network::mojom::StorageAccessApiStatus storage_access_api_status, bool apply_devtools_overrides) {
  bool async_wait_result;
