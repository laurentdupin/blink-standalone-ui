...
// with not having this data in traces there.
  ...
  virtual void CreateNameForAddress(::network::mojom::IPAddressPtr address, CreateNameForAddressCallback callback) = 0;
  ...
  virtual void RemoveNameForAddress(::network::mojom::IPAddressPtr address, RemoveNameForAddressCallback callback) = 0;
};
...
class  MdnsResponderProxy
 ...
 public:
  ...
  void CreateNameForAddress(::network::mojom::IPAddressPtr address, CreateNameForAddressCallback callback) final;
  
  void RemoveNameForAddress(::network::mojom::IPAddressPtr address, RemoveNameForAddressCallback callback) final;
