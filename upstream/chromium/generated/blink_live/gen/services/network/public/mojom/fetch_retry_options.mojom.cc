// services/network/public/mojom/fetch_retry_options.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "services/network/public/mojom/fetch_retry_options.mojom-import-headers.h"
#include "services/network/public/mojom/fetch_retry_options.mojom-test-utils.h"
...
// static
bool StructTraits<::network::mojom::FetchRetryOptions::DataView, ::network::mojom::FetchRetryOptionsPtr>::Read(
    ::network::mojom::FetchRetryOptions::DataView input,
    ::network::mojom::FetchRetryOptionsPtr* output) {
  bool success = true;
  ::network::mojom::FetchRetryOptionsPtr result(::network::mojom::FetchRetryOptions::New());
