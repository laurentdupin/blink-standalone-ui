...
class BLINK_PLATFORM_EXPORT ClearDataFilter {
 public:
  ...
  ClearDataFilter(
      ...
      ::blink::Vector<::blink::String> domains,
      ::blink::Vector<::scoped_refptr<const ::blink::SecurityOrigin>> origins);
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ClearDataFilter::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ClearDataFilter::DataView, ::blink::Vector<uint8_t>>(input);
  }
