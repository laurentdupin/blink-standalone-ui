...
#include "services/network/public/mojom/alternate_protocol_usage.mojom-blink-forward.h"
#include "services/network/public/mojom/client_security_state.mojom-blink-forward.h"
#include "services/network/public/mojom/connection_allowlist.mojom-blink-forward.h"
...
class BLINK_PLATFORM_EXPORT DevToolsObserver
 ...
 public:
  ...
  enum MethodMinVersions : uint32_t {
    ...
    kOnLocalNetworkRequestMinVersion = 0,
    ...
    kOnConnectionAllowlistIssueMinVersion = 0,
    kCloneMinVersion = 0,
  };
...
// with not having this data in traces there.
  ...
  struct OnLocalNetworkRequest_Sym {
    NOINLINE static uint32_t IPCStableHash();
  };
  ...
  struct OnConnectionAllowlistIssue_Sym {
    NOINLINE static uint32_t IPCStableHash();
  };
  struct Clone_Sym {
    NOINLINE static uint32_t IPCStableHash();
  ...
  virtual void OnRawRequest(const ::blink::String& devtool_request_id, ::blink::Vector<::network::mojom::blink::CookieWithAccessResultPtr> cookies_with_access_result, ::blink::Vector<::network::mojom::blink::HttpRawHeaderPairPtr> headers, ::base::TimeTicks timestamp, ::blink::Vector<::network::mojom::blink::DeviceBoundSessionWithUsagePtr> device_bound_session_usages, ::network::mojom::blink::ClientSecurityStatePtr client_security_state, OtherPartitionInfoPtr other_partition_info, const std::optional<::base::UnguessableToken>& applied_network_conditions_id) = 0;

  virtual void OnRawResponse(const ::blink::String& devtool_request_id, ::blink::Vector<::network::mojom::blink::CookieAndLineWithAccessResultPtr> cookies_with_access_result, ::blink::Vector<::network::mojom::blink::HttpRawHeaderPairPtr> headers, const ::blink::String& raw_response_headers, ::network::mojom::blink::IPAddressSpace resource_address_space, int32_t http_status_code, ::network::mojom::blink::CookiePartitionKeyPtr cookie_partition_key) = 0;

  virtual void OnEarlyHintsResponse(const ::blink::String& devtool_request_id, ::blink::Vector<::network::mojom::blink::HttpRawHeaderPairPtr> headers) = 0;

  virtual void OnLocalNetworkRequest(const ::blink::String& devtool_request_id, const ::blink::KURL& url, bool is_warning, ::network::mojom::blink::IPAddressSpace resource_address_space, ::network::mojom::blink::ClientSecurityStatePtr client_security_state) = 0;

  virtual void OnCorsPreflightRequest(const ::base::UnguessableToken& devtool_request_id, ::network::mojom::blink::HttpRequestHeadersPtr request_headers, URLRequestDevToolsInfoPtr request_info, const ::blink::KURL& initiator_url, const ::blink::String& initiator_devtool_request_id) = 0;
  ...
  virtual void OnTrustTokenOperationDone(const ::blink::String& devtool_request_id, ::network::mojom::blink::TrustTokenOperationResultPtr result) = 0;

  virtual void OnCorsError(const ::blink::String& devtool_request_id, const ::scoped_refptr<const ::blink::SecurityOrigin>& initiator_origin, ::network::mojom::blink::ClientSecurityStatePtr client_security_state, const ::blink::KURL& url, ::network::mojom::blink::CorsErrorStatusPtr status, bool is_warning) = 0;

  virtual void OnOrbError(const ::blink::String& devtools_request_id, const ::blink::KURL& url) = 0;

  virtual void OnSharedDictionaryError(const ::blink::String& devtool_request_id, const ::blink::KURL& url, ::network::mojom::blink::SharedDictionaryError error) = 0;

  virtual void OnSRIMessageSignatureIssue(const ::blink::String& devtool_request_id, const ::blink::KURL& url, ::blink::Vector<::network::mojom::blink::SRIMessageSignatureIssuePtr> issues) = 0;

  virtual void OnUnencodedDigestError(const ::blink::String& devtool_request_id, const ::blink::KURL& url, ::network::mojom::blink::UnencodedDigestIssue issue) = 0;

  virtual void OnConnectionAllowlistIssue(const ::blink::String& devtool_request_id, const ::blink::KURL& url, ::network::mojom::blink::ConnectionAllowlistIssue issue) = 0;
...
class BLINK_PLATFORM_EXPORT DevToolsObserverProxy
 ...
 public:
  ...
  void OnRawResponse(const ::blink::String& devtool_request_id, ::blink::Vector<::network::mojom::blink::CookieAndLineWithAccessResultPtr> cookies_with_access_result, ::blink::Vector<::network::mojom::blink::HttpRawHeaderPairPtr> headers, const ::blink::String& raw_response_headers, ::network::mojom::blink::IPAddressSpace resource_address_space, int32_t http_status_code, ::network::mojom::blink::CookiePartitionKeyPtr cookie_partition_key) final;
  
  void OnEarlyHintsResponse(const ::blink::String& devtool_request_id, ::blink::Vector<::network::mojom::blink::HttpRawHeaderPairPtr> headers) final;
  
  void OnLocalNetworkRequest(const ::blink::String& devtool_request_id, const ::blink::KURL& url, bool is_warning, ::network::mojom::blink::IPAddressSpace resource_address_space, ::network::mojom::blink::ClientSecurityStatePtr client_security_state) final;
  
  void OnCorsPreflightRequest(const ::base::UnguessableToken& devtool_request_id, ::network::mojom::blink::HttpRequestHeadersPtr request_headers, URLRequestDevToolsInfoPtr request_info, const ::blink::KURL& initiator_url, const ::blink::String& initiator_devtool_request_id) final;
  ...
  void OnTrustTokenOperationDone(const ::blink::String& devtool_request_id, ::network::mojom::blink::TrustTokenOperationResultPtr result) final;
  
  void OnCorsError(const ::blink::String& devtool_request_id, const ::scoped_refptr<const ::blink::SecurityOrigin>& initiator_origin, ::network::mojom::blink::ClientSecurityStatePtr client_security_state, const ::blink::KURL& url, ::network::mojom::blink::CorsErrorStatusPtr status, bool is_warning) final;
  
  void OnOrbError(const ::blink::String& devtools_request_id, const ::blink::KURL& url) final;
  
  void OnSharedDictionaryError(const ::blink::String& devtool_request_id, const ::blink::KURL& url, ::network::mojom::blink::SharedDictionaryError error) final;
  
  void OnSRIMessageSignatureIssue(const ::blink::String& devtool_request_id, const ::blink::KURL& url, ::blink::Vector<::network::mojom::blink::SRIMessageSignatureIssuePtr> issues) final;
  
  void OnUnencodedDigestError(const ::blink::String& devtool_request_id, const ::blink::KURL& url, ::network::mojom::blink::UnencodedDigestIssue issue) final;
  
  void OnConnectionAllowlistIssue(const ::blink::String& devtool_request_id, const ::blink::KURL& url, ::network::mojom::blink::ConnectionAllowlistIssue issue) final;
 ...
 public:
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        OtherPartitionInfo::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        OtherPartitionInfo::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
URLRequestDevToolsInfo& operator=(const URLRequestDevToolsInfo&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        URLRequestDevToolsInfo::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        URLRequestDevToolsInfo::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
class BLINK_PLATFORM_EXPORT URLResponseHeadDevToolsInfo {
 public:
  ...
  URLResponseHeadDevToolsInfo(
      ...
      const ::blink::String& alpn_negotiated_protocol,
      ::network::mojom::blink::AlternateProtocolUsage alternate_protocol_usage,
...
URLResponseHeadDevToolsInfo& operator=(const URLResponseHeadDevToolsInfo&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        URLResponseHeadDevToolsInfo::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        URLResponseHeadDevToolsInfo::DataView, ::blink::Vector<uint8_t>>(input);
  }
  ...
  ::blink::String cache_storage_cache_name;
  
  ::blink::String alpn_negotiated_protocol;
...
struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::URLRequestDevToolsInfo::DataView,
  ...
  static decltype(::network::mojom::blink::URLRequestDevToolsInfo::is_ad_related) is_ad_related(
      const ::network::mojom::blink::URLRequestDevToolsInfoPtr& input) {
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::OtherPartitionInfo::DataView,
                                         ::network::mojom::blink::OtherPartitionInfoPtr> {
  static bool IsNull(const ::network::mojom::blink::OtherPartitionInfoPtr& input) { return !input; }
  static void SetToNull(::network::mojom::blink::OtherPartitionInfoPtr* output) { output->reset(); }
