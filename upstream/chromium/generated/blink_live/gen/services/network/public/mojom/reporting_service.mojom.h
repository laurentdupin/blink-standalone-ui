...
// with not having this data in traces there.
  ...
  virtual void OnEndpointsUpdatedForOrigin(std::vector<ReportingApiEndpointPtr> endpoints) = 0;
};
...
class  ReportingApiObserverProxy
 ...
 public:
  ...
  void OnEndpointsUpdatedForOrigin(std::vector<ReportingApiEndpointPtr> endpoints) final;
...
class  ReportingApiReport {
 public:
  ...
  ReportingApiReport(
      ...
      int32_t depth,
      int32_t attempts,
      ::mojo_base::mojom::DictionaryValuePtr body,
...
class  ReportingApiEndpoint {
 public:
  ...
  ReportingApiEndpoint(
      ...
      ::network::mojom::NetworkAnonymizationKeyPtr network_anonymization_key,
