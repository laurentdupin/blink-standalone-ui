...
class  PinSet_Data {
 public:
  ...
  mojo::internal::Pointer<mojo::internal::Array_Data<mojo::internal::Pointer<::network::mojom::internal::SHA256HashValue_Data>>> static_spki_hashes;
  mojo::internal::Pointer<mojo::internal::Array_Data<mojo::internal::Pointer<::network::mojom::internal::SHA256HashValue_Data>>> bad_static_spki_hashes;
...
static_assert(sizeof(PinSet_Data) == 32,
