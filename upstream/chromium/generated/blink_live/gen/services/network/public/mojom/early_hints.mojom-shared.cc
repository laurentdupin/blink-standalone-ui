// services/network/public/mojom/early_hints.mojom-shared.cc is auto generated by mojom_bindings_generator.py, do not edit
...
bool EarlyHints_Data::Validate(
  ...
  [[maybe_unused]] const EarlyHints_Data* object =
      static_cast<const EarlyHints_Data*>(data);
...
EarlyHints_Data::EarlyHints_Data()
