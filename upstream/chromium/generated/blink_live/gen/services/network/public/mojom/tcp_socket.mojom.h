...
// with not having this data in traces there.
  ...
  using ConnectCallback = base::OnceCallback<void(int32_t, ::network::mojom::IPEndPointPtr, ::network::mojom::IPEndPointPtr, ::mojo::ScopedDataPipeConsumerHandle, ::mojo::ScopedDataPipeProducerHandle)>;
  using ConnectMojoCallback = base::OnceCallback<void(int32_t, ::network::mojom::IPEndPointPtr, ::network::mojom::IPEndPointPtr, ::mojo::ScopedDataPipeConsumerHandle, ::mojo::ScopedDataPipeProducerHandle)>;

  virtual void Connect(::network::mojom::AddressListPtr remote_addr_list, TCPConnectedSocketOptionsPtr tcp_connected_socket_options, ::mojo::PendingReceiver<TCPConnectedSocket> socket, ::mojo::PendingRemote<SocketObserver> observer, ConnectCallback callback) = 0;
};
...
// with not having this data in traces there.
  ...
  using UpgradeToTLSCallback = base::OnceCallback<void(int32_t, ::mojo::ScopedDataPipeConsumerHandle, ::mojo::ScopedDataPipeProducerHandle, ::network::mojom::SSLInfoPtr)>;
  using UpgradeToTLSMojoCallback = base::OnceCallback<void(int32_t, ::mojo::ScopedDataPipeConsumerHandle, ::mojo::ScopedDataPipeProducerHandle, ::network::mojom::SSLInfoPtr)>;

  virtual void UpgradeToTLS(::network::mojom::HostPortPairPtr host_port_pair, ::network::mojom::TLSClientSocketOptionsPtr options, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::mojo::PendingReceiver<::network::mojom::TLSClientSocket> receiver, ::mojo::PendingRemote<SocketObserver> observer, UpgradeToTLSCallback callback) = 0;
...
// with not having this data in traces there.
  ...
  using AcceptCallback = base::OnceCallback<void(int32_t, ::network::mojom::IPEndPointPtr, ::mojo::PendingRemote<TCPConnectedSocket>, ::mojo::ScopedDataPipeConsumerHandle, ::mojo::ScopedDataPipeProducerHandle)>;
  using AcceptMojoCallback = base::OnceCallback<void(int32_t, ::network::mojom::IPEndPointPtr, ::mojo::PendingRemote<TCPConnectedSocket>, ::mojo::ScopedDataPipeConsumerHandle, ::mojo::ScopedDataPipeProducerHandle)>;
...
class  TCPBoundSocketProxy
 ...
 public:
  ...
  void Connect(::network::mojom::AddressListPtr remote_addr_list, TCPConnectedSocketOptionsPtr tcp_connected_socket_options, ::mojo::PendingReceiver<TCPConnectedSocket> socket, ::mojo::PendingRemote<SocketObserver> observer, ConnectCallback callback) final;
