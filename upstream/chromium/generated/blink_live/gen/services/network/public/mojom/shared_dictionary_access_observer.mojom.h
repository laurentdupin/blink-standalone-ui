// services/network/public/mojom/shared_dictionary_access_observer.mojom.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef SERVICES_NETWORK_PUBLIC_MOJOM_SHARED_DICTIONARY_ACCESS_OBSERVER_MOJOM_H_
#define SERVICES_NETWORK_PUBLIC_MOJOM_SHARED_DICTIONARY_ACCESS_OBSERVER_MOJOM_H_
...
#include "services/network/public/mojom/shared_dictionary_access_observer.mojom-forward.h"  // IWYU pragma: export
...
class  SharedDictionaryAccessObserverStubDispatch {
 public:
...
class  SharedDictionaryAccessObserverRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
SharedDictionaryAccessDetails& operator=(const SharedDictionaryAccessDetails&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SharedDictionaryAccessDetails::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SharedDictionaryAccessDetails::DataView, std::vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::network::mojom::SharedDictionaryAccessDetails::DataView,
                                         ::network::mojom::SharedDictionaryAccessDetailsPtr> {
  static bool IsNull(const ::network::mojom::SharedDictionaryAccessDetailsPtr& input) { return !input; }
  static void SetToNull(::network::mojom::SharedDictionaryAccessDetailsPtr* output) { output->reset(); }

  static decltype(::network::mojom::SharedDictionaryAccessDetails::type) type(
      const ::network::mojom::SharedDictionaryAccessDetailsPtr& input) {
    return input->type;
  }

  static const decltype(::network::mojom::SharedDictionaryAccessDetails::url)& url(
      const ::network::mojom::SharedDictionaryAccessDetailsPtr& input) {
    return input->url;
  }

  static const decltype(::network::mojom::SharedDictionaryAccessDetails::isolation_key)& isolation_key(
      const ::network::mojom::SharedDictionaryAccessDetailsPtr& input) {
    return input->isolation_key;
  }

  static decltype(::network::mojom::SharedDictionaryAccessDetails::is_blocked) is_blocked(
      const ::network::mojom::SharedDictionaryAccessDetailsPtr& input) {
    return input->is_blocked;
  }

  static bool Read(::network::mojom::SharedDictionaryAccessDetails::DataView input, ::network::mojom::SharedDictionaryAccessDetailsPtr* output);
};

}  // namespace mojo

#endif  // SERVICES_NETWORK_PUBLIC_MOJOM_SHARED_DICTIONARY_ACCESS_OBSERVER_MOJOM_H_