...
class  CertVerifierServiceInterceptorForTesting : public CertVerifierService {
  ...
  void Verify(RequestParamsPtr params, ::network::mojom::blink::NetLogSourcePtr net_log_source, ::mojo::PendingRemote<CertVerifierRequest> cert_verifier_request) override;
  void Verify2QwacBinding(const ::blink::String& binding, const ::blink::String& hostname, ::network::mojom::blink::X509CertificatePtr tls_certificate, ::network::mojom::blink::NetLogSourcePtr net_log_source, Verify2QwacBindingCallback callback) override;
...
class  CertVerifierServiceAsyncWaiter {
 public:
  ...
  ::network::mojom::blink::X509CertificatePtr Verify2QwacBinding(const ::blink::String& binding, const ::blink::String& hostname, ::network::mojom::blink::X509CertificatePtr tls_certificate, ::network::mojom::blink::NetLogSourcePtr net_log_source);
