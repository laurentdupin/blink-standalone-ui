...
#include "services/network/public/mojom/http_cache_backend_file_operations.mojom-data-view.h"  // IWYU pragma: export
...
struct Serializer<::network::mojom::HttpCacheBackendOpenFileFlags, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::network::mojom::HttpCacheBackendOpenFileFlags>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::network::mojom::HttpCacheBackendOpenFileFlags, UserType> ||
                        HasInfallibleConversion(::network::mojom::HttpCacheBackendOpenFileFlags()),
                    "::network::mojom::HttpCacheBackendOpenFileFlags does not have an infallible conversion, "
...
struct Serializer<::network::mojom::HttpCacheBackendDeleteFileMode, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::network::mojom::HttpCacheBackendDeleteFileMode>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::network::mojom::HttpCacheBackendDeleteFileMode, UserType> ||
                        HasInfallibleConversion(::network::mojom::HttpCacheBackendDeleteFileMode()),
                    "::network::mojom::HttpCacheBackendDeleteFileMode does not have an infallible conversion, "
                    "use an optional return type.");
      *output = Traits::FromMojom(known_value);
      return true;
    } else {
