...
void SocketBrokerProxy::CreateTcpSocket(
    ::network::mojom::blink::AddressFamily in_address_family, CreateTcpSocketCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void SocketBrokerProxy::CreateUdpSocket(
    ::network::mojom::blink::AddressFamily in_address_family, CreateUdpSocketCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
