...
RequestParams::RequestParams(
    ::network::mojom::X509CertificatePtr certificate_in,
    const std::string& hostname_in,
    int32_t flags_in,
    ::mojo_base::mojom::ByteStringPtr ocsp_response_in,
    ::mojo_base::mojom::ByteStringPtr sct_list_in)
...
size_t CertVerifierConfig::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->enable_rev_checking);
  seed = mojo::internal::Hash(seed, this->require_rev_checking_local_anchors);
  return seed;
}
...
void CertVerifierServiceProxy::Verify(
    RequestParamsPtr in_params, ::network::mojom::NetLogSourcePtr in_net_log_source, ::mojo::PendingRemote<CertVerifierRequest> in_cert_verifier_request) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("net_log_source"), in_net_log_source,
                        "<value of type ::network::mojom::NetLogSourcePtr>");
      perfetto::WriteIntoTracedValueWithFallback(
...
void CertVerifierServiceProxy::Verify2QwacBinding(
    const std::string& in_binding, const std::string& in_hostname, ::network::mojom::X509CertificatePtr in_tls_certificate, ::network::mojom::NetLogSourcePtr in_net_log_source, Verify2QwacBindingCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
class CertVerifierService_Verify2QwacBinding_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::network::mojom::X509CertificatePtr in_verified_cert);
};
...
bool CertVerifierService_Verify2QwacBinding_ForwardToCallback::Accept(
  ...
  bool success = true;
  ::network::mojom::X509CertificatePtr p_verified_cert{};
...
bool CertVerifierServiceStubDispatch::Accept(
  ...
  switch (static_cast<messages::CertVerifierService>(message->header()->name)) {
    ...
    case messages::CertVerifierService::kVerify: {
      ...
      ::network::mojom::NetLogSourcePtr p_net_log_source{};
...
bool CertVerifierServiceStubDispatch::AcceptWithResponder(
  ...
  switch (static_cast<messages::CertVerifierService>(message->header()->name)) {
    ...
    case messages::CertVerifierService::kVerify2QwacBinding: {
      ...
      ::network::mojom::X509CertificatePtr p_tls_certificate{};
      ::network::mojom::NetLogSourcePtr p_net_log_source{};
...
void CertVerifierRequestProxy::Complete(
    ::network::mojom::CertVerifyResultPtr in_result, int32_t in_net_error) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool CertVerifierRequestStubDispatch::Accept(
  ...
  switch (static_cast<messages::CertVerifierRequest>(message->header()->name)) {
    case messages::CertVerifierRequest::kComplete: {
      ...
      bool success = true;
      ::network::mojom::CertVerifyResultPtr p_result{};
      int32_t p_net_error{};
...
void CertVerifierServiceInterceptorForTesting::Verify(RequestParamsPtr params, ::network::mojom::NetLogSourcePtr net_log_source, ::mojo::PendingRemote<CertVerifierRequest> cert_verifier_request) {
...
void CertVerifierServiceInterceptorForTesting::Verify2QwacBinding(const std::string& binding, const std::string& hostname, ::network::mojom::X509CertificatePtr tls_certificate, ::network::mojom::NetLogSourcePtr net_log_source, Verify2QwacBindingCallback callback) {
...
void CertVerifierServiceAsyncWaiter::Verify2QwacBinding(
  ...
  proxy_->Verify2QwacBinding(
      ...
      base::BindOnce(
          [](base::RunLoop* loop,
             ::network::mojom::X509CertificatePtr* out_verified_cert
,
             ::network::mojom::X509CertificatePtr verified_cert) {*out_verified_cert = std::move(verified_cert);
            loop->Quit();
          },
          &loop,
          out_verified_cert));
...
::network::mojom::X509CertificatePtr CertVerifierServiceAsyncWaiter::Verify2QwacBinding(
    const std::string& binding, const std::string& hostname, ::network::mojom::X509CertificatePtr tls_certificate, ::network::mojom::NetLogSourcePtr net_log_source) {
  ::network::mojom::X509CertificatePtr async_wait_result;
...
void CertVerifierRequestInterceptorForTesting::Complete(::network::mojom::CertVerifyResultPtr result, int32_t net_error) {
