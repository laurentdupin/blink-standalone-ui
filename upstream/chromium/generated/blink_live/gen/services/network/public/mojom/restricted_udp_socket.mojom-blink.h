...
// with not having this data in traces there.
  ...
  virtual void Send(::mojo_base::mojom::blink::ReadOnlyBufferPtr data, SendCallback callback) = 0;

  using SendToCallback = base::OnceCallback<void(int32_t)>;
  using SendToMojoCallback = base::OnceCallback<void(int32_t)>;

  virtual void SendTo(::mojo_base::mojom::blink::ReadOnlyBufferPtr data, ::network::mojom::blink::HostPortPairPtr dest_addr, ::network::mojom::blink::DnsQueryType dns_query_type, SendToCallback callback) = 0;
};
...
class  RestrictedUDPSocketProxy
 ...
 public:
  ...
  void Send(::mojo_base::mojom::blink::ReadOnlyBufferPtr data, SendCallback callback) final;
  
  void SendTo(::mojo_base::mojom::blink::ReadOnlyBufferPtr data, ::network::mojom::blink::HostPortPairPtr dest_addr, ::network::mojom::blink::DnsQueryType dns_query_type, SendToCallback callback) final;
...
template <>
struct  StructTraits<::network::mojom::blink::RestrictedUDPSocketParams::DataView,
