// services/network/public/mojom/websocket.mojom-shared-internal.h is auto generated by mojom_bindings_generator.py, do not edit
...
class  HttpHeader_Data {
 ...
 private:
  friend class mojo::internal::MessageFragment<HttpHeader_Data>;
...
struct HttpHeader_UnserializedMessageContext
 ...
 private:
  ...
  void Serialize(mojo::Message& message) override {
    mojo::internal::MessageFragment<HttpHeader_Data> fragment(message);
...
class  WebSocketHandshakeRequest_Data {
 ...
 private:
  friend class mojo::internal::MessageFragment<WebSocketHandshakeRequest_Data>;
...
struct WebSocketHandshakeRequest_UnserializedMessageContext
 ...
 private:
  // mojo::internal::UnserializedMessageContext:
  void Serialize(mojo::Message& message) override {
    mojo::internal::MessageFragment<WebSocketHandshakeRequest_Data> fragment(message);
    mojo::internal::Serialize<DataView>(user_data_, fragment);
  }
...
class  WebSocketHandshakeResponse_Data {
 ...
 private:
  friend class mojo::internal::MessageFragment<WebSocketHandshakeResponse_Data>;

  WebSocketHandshakeResponse_Data();
  ~WebSocketHandshakeResponse_Data() = delete;
};
static_assert(sizeof(WebSocketHandshakeResponse_Data) == 80,
...
struct WebSocketHandshakeResponse_UnserializedMessageContext
 ...
 private:
  // mojo::internal::UnserializedMessageContext:
  void Serialize(mojo::Message& message) override {
    mojo::internal::MessageFragment<WebSocketHandshakeResponse_Data> fragment(message);
    mojo::internal::Serialize<DataView>(user_data_, fragment);
  }
