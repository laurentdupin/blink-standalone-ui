...
CookiePartitionKeyCollection::CookiePartitionKeyCollection(
    ...
    ::blink::Vector<CookiePartitionKeyPtr> keys_in)
...
void CookiePartitionKeyCollection::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "keys"), this->keys,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<CookiePartitionKeyPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
bool StructTraits<::network::mojom::blink::CookiePartitionKey::DataView, ::network::mojom::blink::CookiePartitionKeyPtr>::Read(
    ::network::mojom::blink::CookiePartitionKey::DataView input,
    ::network::mojom::blink::CookiePartitionKeyPtr* output) {
  bool success = true;
...
bool StructTraits<::network::mojom::blink::CookiePartitionKeyCollection::DataView, ::network::mojom::blink::CookiePartitionKeyCollectionPtr>::Read(
    ::network::mojom::blink::CookiePartitionKeyCollection::DataView input,
    ::network::mojom::blink::CookiePartitionKeyCollectionPtr* output) {
  bool success = true;
