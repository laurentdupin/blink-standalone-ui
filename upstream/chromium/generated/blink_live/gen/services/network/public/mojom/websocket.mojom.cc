...
void WebSocketAuthenticationHandlerProxy::OnAuthRequired(
    const ::net::AuthChallengeInfo& in_info, const ::scoped_refptr<::net::HttpResponseHeaders>& in_headers, ::network::mojom::IPEndPointPtr in_remote_endpoint, OnAuthRequiredCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool WebSocketAuthenticationHandlerStubDispatch::AcceptWithResponder(
  ...
  switch (static_cast<messages::WebSocketAuthenticationHandler>(message->header()->name)) {
    case messages::WebSocketAuthenticationHandler::kOnAuthRequired: {
      ...
      ::network::mojom::IPEndPointPtr p_remote_endpoint{};
...
void WebSocketAuthenticationHandlerInterceptorForTesting::OnAuthRequired(const ::net::AuthChallengeInfo& info, const ::scoped_refptr<::net::HttpResponseHeaders>& headers, ::network::mojom::IPEndPointPtr remote_endpoint, OnAuthRequiredCallback callback) {
...
void WebSocketAuthenticationHandlerAsyncWaiter::OnAuthRequired(
    const ::net::AuthChallengeInfo& info, const ::scoped_refptr<::net::HttpResponseHeaders>& headers, ::network::mojom::IPEndPointPtr remote_endpoint, std::optional<::net::AuthCredentials>* out_credentials) {
  base::RunLoop loop;
...
std::optional<::net::AuthCredentials> WebSocketAuthenticationHandlerAsyncWaiter::OnAuthRequired(
    const ::net::AuthChallengeInfo& info, const ::scoped_refptr<::net::HttpResponseHeaders>& headers, ::network::mojom::IPEndPointPtr remote_endpoint) {
