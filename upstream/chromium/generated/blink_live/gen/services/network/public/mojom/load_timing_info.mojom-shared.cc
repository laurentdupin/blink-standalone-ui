...
bool LoadTimingInfoConnectTiming_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->domain_lookup_start, 1, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->domain_lookup_end, 2, validation_context)) {
    return false;
  }
...
bool LoadTimingInfo_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->service_worker_router_evaluation_start, 20, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->service_worker_cache_lookup_start, 21, validation_context)) {
    return false;
  }
