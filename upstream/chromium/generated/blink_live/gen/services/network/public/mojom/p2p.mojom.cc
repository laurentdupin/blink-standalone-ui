...
P2PReceivedPacket::P2PReceivedPacket(
    ::mojo_base::mojom::ReadOnlyBufferPtr data_in,
    ::network::mojom::IPEndPointPtr socket_address_in,
...
void P2PNetworkNotificationClientProxy::NetworkListChanged(
    std::vector<::network::mojom::NetworkInterfacePtr> in_networks, ::network::mojom::IPAddressPtr in_default_ipv4_local_address, ::network::mojom::IPAddressPtr in_default_ipv6_local_address) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("networks"), in_networks,
                        "<value of type std::vector<::network::mojom::NetworkInterfacePtr>>");
      perfetto::WriteIntoTracedValueWithFallback(
...
bool P2PNetworkNotificationClientStubDispatch::Accept(
  ...
  switch (static_cast<messages::P2PNetworkNotificationClient>(message->header()->name)) {
    case messages::P2PNetworkNotificationClient::kNetworkListChanged: {
      ...
      bool success = true;
      std::vector<::network::mojom::NetworkInterfacePtr> p_networks{};
      ::network::mojom::IPAddressPtr p_default_ipv4_local_address{};
      ::network::mojom::IPAddressPtr p_default_ipv6_local_address{};
...
void P2PSocketManagerProxy::GetHostAddress(
    const std::string& in_host_name, std::optional<::network::mojom::AddressFamily> in_address_family, bool in_enable_mdns, GetHostAddressCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("address_family"), in_address_family,
                        "<value of type std::optional<::network::mojom::AddressFamily>>");
      perfetto::WriteIntoTracedValueWithFallback(
...
void P2PSocketManagerProxy::CreateSocket(
    P2PSocketType in_type, ::network::mojom::IPEndPointPtr in_local_address, P2PPortRangePtr in_port_range, P2PHostAndIPEndPointPtr in_remote_address, const ::net::MutableNetworkTrafficAnnotationTag& in_traffic_annotation, const std::optional<::base::UnguessableToken>& in_devtools_token, ::mojo::PendingRemote<P2PSocketClient> in_client, ::mojo::PendingReceiver<P2PSocket> in_socket) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
class P2PSocketManager_GetHostAddress_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      std::vector<::network::mojom::IPAddressPtr> in_addresses);
};
...
bool P2PSocketManager_GetHostAddress_ForwardToCallback::Accept(
  ...
  bool success = true;
  std::vector<::network::mojom::IPAddressPtr> p_addresses{};
...
bool P2PSocketManagerStubDispatch::Accept(
  ...
  switch (static_cast<messages::P2PSocketManager>(message->header()->name)) {
    ...
    case messages::P2PSocketManager::kCreateSocket: {
      ...
      ::network::mojom::IPEndPointPtr p_local_address{};
...
bool P2PSocketManagerStubDispatch::AcceptWithResponder(
  ...
  switch (static_cast<messages::P2PSocketManager>(message->header()->name)) {
    ...
    case messages::P2PSocketManager::kGetHostAddress: {
      ...
      std::optional<::network::mojom::AddressFamily> p_address_family{};
      bool p_enable_mdns{};
...
void P2PSocketProxy::Send(
    ::mojo_base::mojom::ReadOnlyBufferPtr in_data, P2PPacketInfoPtr in_packet_info) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void P2PSocketClientProxy::SocketCreated(
    ::network::mojom::IPEndPointPtr in_local_address, ::network::mojom::IPEndPointPtr in_remote_address) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void P2PSocketClientProxy::SendBatchComplete(
    std::vector<P2PSendPacketMetricsPtr> in_send_metrics_batch) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("send_metrics_batch"), in_send_metrics_batch,
                        "<value of type std::vector<P2PSendPacketMetricsPtr>>");
   });
#endif
...
bool P2PSocketClientStubDispatch::Accept(
  ...
  switch (static_cast<messages::P2PSocketClient>(message->header()->name)) {
    case messages::P2PSocketClient::kSocketCreated: {
      ...
      bool success = true;
      ::network::mojom::IPEndPointPtr p_local_address{};
      ::network::mojom::IPEndPointPtr p_remote_address{};
    ...
    case messages::P2PSocketClient::kSendBatchComplete: {
      ...
      bool success = true;
      std::vector<P2PSendPacketMetricsPtr> p_send_metrics_batch{};
...
void P2PNetworkNotificationClientInterceptorForTesting::NetworkListChanged(std::vector<::network::mojom::NetworkInterfacePtr> networks, ::network::mojom::IPAddressPtr default_ipv4_local_address, ::network::mojom::IPAddressPtr default_ipv6_local_address) {
...
void P2PSocketManagerInterceptorForTesting::GetHostAddress(const std::string& host_name, std::optional<::network::mojom::AddressFamily> address_family, bool enable_mdns, GetHostAddressCallback callback) {
...
void P2PSocketManagerInterceptorForTesting::CreateSocket(P2PSocketType type, ::network::mojom::IPEndPointPtr local_address, P2PPortRangePtr port_range, P2PHostAndIPEndPointPtr remote_address, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, const std::optional<::base::UnguessableToken>& devtools_token, ::mojo::PendingRemote<P2PSocketClient> client, ::mojo::PendingReceiver<P2PSocket> socket) {
...
void P2PSocketManagerAsyncWaiter::GetHostAddress(
  ...
  proxy_->GetHostAddress(
      ...
      base::BindOnce(
          [](base::RunLoop* loop,
             std::vector<::network::mojom::IPAddressPtr>* out_addresses
,
             std::vector<::network::mojom::IPAddressPtr> addresses) {*out_addresses = std::move(addresses);
            loop->Quit();
          },
          &loop,
          out_addresses));
...
std::vector<::network::mojom::IPAddressPtr> P2PSocketManagerAsyncWaiter::GetHostAddress(
    const std::string& host_name, std::optional<::network::mojom::AddressFamily> address_family, bool enable_mdns) {
  std::vector<::network::mojom::IPAddressPtr> async_wait_result;
...
void P2PSocketInterceptorForTesting::Send(::mojo_base::mojom::ReadOnlyBufferPtr data, P2PPacketInfoPtr packet_info) {
...
void P2PSocketClientInterceptorForTesting::SocketCreated(::network::mojom::IPEndPointPtr local_address, ::network::mojom::IPEndPointPtr remote_address) {
...
void P2PSocketClientInterceptorForTesting::SendBatchComplete(std::vector<P2PSendPacketMetricsPtr> send_metrics_batch) {
