...
class  URLLoaderInterceptorForTesting : public URLLoader {
  ...
  void FollowRedirect(::network::mojom::HttpRequestHeadersUpdateParamsPtr headers_update_params, const std::optional<::GURL>& new_url) override;
  void SetPriority(::network::mojom::RequestPriority priority, int32_t intra_priority_value) override;
};
