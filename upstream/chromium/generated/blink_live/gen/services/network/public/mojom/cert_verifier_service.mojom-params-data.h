...
static_assert(sizeof(CertVerifierService_Verify_Params_Data) == 32,
              "Bad sizeof(CertVerifierService_Verify_Params_Data)");
class  CertVerifierService_Verify2QwacBinding_Params_Data {
 public:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
 ...
 private:
  friend class mojo::internal::MessageFragment<CertVerifierService_Verify2QwacBinding_Params_Data>;

  CertVerifierService_Verify2QwacBinding_Params_Data();
  ~CertVerifierService_Verify2QwacBinding_Params_Data() = delete;
};
static_assert(sizeof(CertVerifierService_Verify2QwacBinding_Params_Data) == 40,
              "Bad sizeof(CertVerifierService_Verify2QwacBinding_Params_Data)");
class  CertVerifierService_Verify2QwacBinding_ResponseParams_Data {
 public:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
 ...
 private:
  friend class mojo::internal::MessageFragment<CertVerifierService_Verify2QwacBinding_ResponseParams_Data>;

  CertVerifierService_Verify2QwacBinding_ResponseParams_Data();
  ~CertVerifierService_Verify2QwacBinding_ResponseParams_Data() = delete;
};
static_assert(sizeof(CertVerifierService_Verify2QwacBinding_ResponseParams_Data) == 16,
              "Bad sizeof(CertVerifierService_Verify2QwacBinding_ResponseParams_Data)");
...
static_assert(sizeof(CertVerifierServiceClient_OnCertVerifierChanged_Params_Data) == 8,
              "Bad sizeof(CertVerifierServiceClient_OnCertVerifierChanged_Params_Data)");
...
class CertVerifierService_Verify2QwacBinding_ParamsDataView {
 public:
  CertVerifierService_Verify2QwacBinding_ParamsDataView() = default;

  CertVerifierService_Verify2QwacBinding_ParamsDataView(
      internal::CertVerifierService_Verify2QwacBinding_Params_Data* data,
      mojo::Message* message)
      : data_(data), message_(message) {}
 ...
 private:
  internal::CertVerifierService_Verify2QwacBinding_Params_Data* data_ = nullptr;
  mojo::Message* message_ = nullptr;
};


class CertVerifierService_Verify2QwacBinding_ResponseParamsDataView {
 public:
  CertVerifierService_Verify2QwacBinding_ResponseParamsDataView() = default;

  CertVerifierService_Verify2QwacBinding_ResponseParamsDataView(
      internal::CertVerifierService_Verify2QwacBinding_ResponseParams_Data* data,
      mojo::Message* message)
      : data_(data), message_(message) {}
...
static_assert(
 ...
 private:
  internal::CertVerifierService_Verify2QwacBinding_ResponseParams_Data* data_ = nullptr;
  mojo::Message* message_ = nullptr;
};
...
class CertVerifierServiceClient_OnCertVerifierChanged_ParamsDataView {
 public:
  ...
  CertVerifierServiceClient_OnCertVerifierChanged_ParamsDataView(
      internal::CertVerifierServiceClient_OnCertVerifierChanged_Params_Data* data,
      mojo::Message* message)
      : data_(data) {}
...
inline void CertVerifierService_Verify_ParamsDataView::GetNetLogSourceDataView(
    ::network::mojom::NetLogSourceDataView* output) {
  auto pointer = data_->net_log_source.Get();
...
inline void CertVerifierService_Verify2QwacBinding_ParamsDataView::GetBindingDataView(
    mojo::StringDataView* output) {
  auto pointer = data_->binding.Get();
  *output = mojo::StringDataView(pointer, message_);
}
inline void CertVerifierService_Verify2QwacBinding_ParamsDataView::GetHostnameDataView(
    mojo::StringDataView* output) {
  auto pointer = data_->hostname.Get();
  *output = mojo::StringDataView(pointer, message_);
}
inline void CertVerifierService_Verify2QwacBinding_ParamsDataView::GetTlsCertificateDataView(
    ::network::mojom::X509CertificateDataView* output) {
  auto pointer = data_->tls_certificate.Get();
  *output = ::network::mojom::X509CertificateDataView(pointer, message_);
}
inline void CertVerifierService_Verify2QwacBinding_ParamsDataView::GetNetLogSourceDataView(
    ::network::mojom::NetLogSourceDataView* output) {
  auto pointer = data_->net_log_source.Get();
  *output = ::network::mojom::NetLogSourceDataView(pointer, message_);
}
...
inline void CertVerifierService_Verify2QwacBinding_ResponseParamsDataView::GetVerifiedCertDataView(
    ::network::mojom::X509CertificateDataView* output) {
  auto pointer = data_->verified_cert.Get();
  *output = ::network::mojom::X509CertificateDataView(pointer, message_);
}
