...
void AcceptCHFrameObserverProxy::OnAcceptCHFrameReceived(
  ...
  mojo::Message message(
      std::to_underlying(messages::AcceptCHFrameObserver::kOnAcceptCHFrameReceived), kFlags, estimated_payload_size);
...
void AcceptCHFrameObserverProxy::Clone(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::AcceptCHFrameObserver::kClone), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool AcceptCHFrameObserverRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::AcceptCHFrameObserver::Name_,
