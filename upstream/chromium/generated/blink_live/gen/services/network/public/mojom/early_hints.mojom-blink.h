...
EarlyHints& operator=(const EarlyHints&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        EarlyHints::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        EarlyHints::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::network::mojom::blink::EarlyHints::DataView,
                                         ::network::mojom::blink::EarlyHintsPtr> {
  static bool IsNull(const ::network::mojom::blink::EarlyHintsPtr& input) { return !input; }
  static void SetToNull(::network::mojom::blink::EarlyHintsPtr* output) { output->reset(); }

  static const decltype(::network::mojom::blink::EarlyHints::headers)& headers(
      const ::network::mojom::blink::EarlyHintsPtr& input) {
    return input->headers;
  }

  static decltype(::network::mojom::blink::EarlyHints::referrer_policy) referrer_policy(
      const ::network::mojom::blink::EarlyHintsPtr& input) {
    return input->referrer_policy;
  }

  static decltype(::network::mojom::blink::EarlyHints::ip_address_space) ip_address_space(
      const ::network::mojom::blink::EarlyHintsPtr& input) {
