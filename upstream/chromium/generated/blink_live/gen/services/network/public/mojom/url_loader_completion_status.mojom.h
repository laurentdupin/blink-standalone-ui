 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        BlockedByResponseReasonWrapper::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
class  URLLoaderCompletionStatus {
 public:
  ...
  URLLoaderCompletionStatus(
      ...
      ::network::mojom::CorsErrorStatusPtr cors_error_status,
...
URLLoaderCompletionStatus& operator=(const URLLoaderCompletionStatus&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        URLLoaderCompletionStatus::DataView, std::vector<uint8_t>, send_validation>(input);
  }
