...
// with not having this data in traces there.
  ...
  virtual bool GetNext(uint32_t num_entries, ::blink::Vector<FileEnumerationEntryPtr>* out_entries, bool* out_end, bool* out_error);
  using GetNextCallback = base::OnceCallback<void(::blink::Vector<FileEnumerationEntryPtr>, bool, bool)>;
  using GetNextMojoCallback = base::OnceCallback<void(::blink::Vector<FileEnumerationEntryPtr>, bool, bool)>;
...
// with not having this data in traces there.
  ...
  virtual bool CreateDirectory(::mojo_base::mojom::blink::FilePathPtr path, bool* out_result);
  using CreateDirectoryCallback = base::OnceCallback<void(bool)>;
  using CreateDirectoryMojoCallback = base::OnceCallback<void(bool)>;

  virtual void CreateDirectory(::mojo_base::mojom::blink::FilePathPtr path, CreateDirectoryCallback callback) = 0;

  // Sync method. This signature is used by the client side; the service side
  // should implement the signature with callback below.
  
  virtual bool PathExists(::mojo_base::mojom::blink::FilePathPtr path, bool* out_result);
  using PathExistsCallback = base::OnceCallback<void(bool)>;
  using PathExistsMojoCallback = base::OnceCallback<void(bool)>;

  virtual void PathExists(::mojo_base::mojom::blink::FilePathPtr path, PathExistsCallback callback) = 0;

  // Sync method. This signature is used by the client side; the service side
  // should implement the signature with callback below.
  
  virtual bool DirectoryExists(::mojo_base::mojom::blink::FilePathPtr path, bool* out_result);
  using DirectoryExistsCallback = base::OnceCallback<void(bool)>;
  using DirectoryExistsMojoCallback = base::OnceCallback<void(bool)>;

  virtual void DirectoryExists(::mojo_base::mojom::blink::FilePathPtr path, DirectoryExistsCallback callback) = 0;

  // Sync method. This signature is used by the client side; the service side
  // should implement the signature with callback below.
  
  virtual bool OpenFile(::mojo_base::mojom::blink::FilePathPtr path, HttpCacheBackendOpenFileFlags flags, ::mojo_base::mojom::blink::FilePtr* out_file, ::mojo_base::mojom::blink::FileError* out_error);
  using OpenFileCallback = base::OnceCallback<void(::mojo_base::mojom::blink::FilePtr, ::mojo_base::mojom::blink::FileError)>;
  using OpenFileMojoCallback = base::OnceCallback<void(::mojo_base::mojom::blink::FilePtr, ::mojo_base::mojom::blink::FileError)>;

  virtual void OpenFile(::mojo_base::mojom::blink::FilePathPtr path, HttpCacheBackendOpenFileFlags flags, OpenFileCallback callback) = 0;

  // Sync method. This signature is used by the client side; the service side
  // should implement the signature with callback below.
  
  virtual bool DeleteFile(::mojo_base::mojom::blink::FilePathPtr path, HttpCacheBackendDeleteFileMode mode, bool* out_result);
  using DeleteFileCallback = base::OnceCallback<void(bool)>;
  using DeleteFileMojoCallback = base::OnceCallback<void(bool)>;

  virtual void DeleteFile(::mojo_base::mojom::blink::FilePathPtr path, HttpCacheBackendDeleteFileMode mode, DeleteFileCallback callback) = 0;

  // Sync method. This signature is used by the client side; the service side
  // should implement the signature with callback below.
  
  virtual bool RenameFile(::mojo_base::mojom::blink::FilePathPtr from_path, ::mojo_base::mojom::blink::FilePathPtr to_path, ::mojo_base::mojom::blink::FileError* out_error);
  using RenameFileCallback = base::OnceCallback<void(::mojo_base::mojom::blink::FileError)>;
  using RenameFileMojoCallback = base::OnceCallback<void(::mojo_base::mojom::blink::FileError)>;

  virtual void RenameFile(::mojo_base::mojom::blink::FilePathPtr from_path, ::mojo_base::mojom::blink::FilePathPtr to_path, RenameFileCallback callback) = 0;

  // Sync method. This signature is used by the client side; the service side
  // should implement the signature with callback below.
  
  virtual bool GetFileInfo(::mojo_base::mojom::blink::FilePathPtr path, ::mojo_base::mojom::blink::FileInfoPtr* out_info);
  using GetFileInfoCallback = base::OnceCallback<void(::mojo_base::mojom::blink::FileInfoPtr)>;
  using GetFileInfoMojoCallback = base::OnceCallback<void(::mojo_base::mojom::blink::FileInfoPtr)>;

  virtual void GetFileInfo(::mojo_base::mojom::blink::FilePathPtr path, GetFileInfoCallback callback) = 0;

  virtual void EnumerateFiles(::mojo_base::mojom::blink::FilePathPtr path, ::mojo::PendingReceiver<FileEnumerator> receiver) = 0;

  using CleanupDirectoryCallback = base::OnceCallback<void(bool)>;
  using CleanupDirectoryMojoCallback = base::OnceCallback<void(bool)>;

  virtual void CleanupDirectory(::mojo_base::mojom::blink::FilePathPtr path, CleanupDirectoryCallback callback) = 0;
};
...
class  FileEnumeratorProxy
 ...
 public:
  ...
  bool GetNext(uint32_t num_entries, ::blink::Vector<FileEnumerationEntryPtr>* out_entries, bool* out_end, bool* out_error) final;
...
class  HttpCacheBackendFileOperationsProxy
 ...
 public:
  ...
  bool CreateDirectory(::mojo_base::mojom::blink::FilePathPtr path, bool* out_result) final;
  
  void CreateDirectory(::mojo_base::mojom::blink::FilePathPtr path, CreateDirectoryCallback callback) final;
  
  bool PathExists(::mojo_base::mojom::blink::FilePathPtr path, bool* out_result) final;
  
  void PathExists(::mojo_base::mojom::blink::FilePathPtr path, PathExistsCallback callback) final;
  
  bool DirectoryExists(::mojo_base::mojom::blink::FilePathPtr path, bool* out_result) final;
  
  void DirectoryExists(::mojo_base::mojom::blink::FilePathPtr path, DirectoryExistsCallback callback) final;
  
  bool OpenFile(::mojo_base::mojom::blink::FilePathPtr path, HttpCacheBackendOpenFileFlags flags, ::mojo_base::mojom::blink::FilePtr* out_file, ::mojo_base::mojom::blink::FileError* out_error) final;
  
  void OpenFile(::mojo_base::mojom::blink::FilePathPtr path, HttpCacheBackendOpenFileFlags flags, OpenFileCallback callback) final;
  
  bool DeleteFile(::mojo_base::mojom::blink::FilePathPtr path, HttpCacheBackendDeleteFileMode mode, bool* out_result) final;
  
  void DeleteFile(::mojo_base::mojom::blink::FilePathPtr path, HttpCacheBackendDeleteFileMode mode, DeleteFileCallback callback) final;
  
  bool RenameFile(::mojo_base::mojom::blink::FilePathPtr from_path, ::mojo_base::mojom::blink::FilePathPtr to_path, ::mojo_base::mojom::blink::FileError* out_error) final;
  
  void RenameFile(::mojo_base::mojom::blink::FilePathPtr from_path, ::mojo_base::mojom::blink::FilePathPtr to_path, RenameFileCallback callback) final;
  
  bool GetFileInfo(::mojo_base::mojom::blink::FilePathPtr path, ::mojo_base::mojom::blink::FileInfoPtr* out_info) final;
  
  void GetFileInfo(::mojo_base::mojom::blink::FilePathPtr path, GetFileInfoCallback callback) final;
  
  void EnumerateFiles(::mojo_base::mojom::blink::FilePathPtr path, ::mojo::PendingReceiver<FileEnumerator> receiver) final;
  
  void CleanupDirectory(::mojo_base::mojom::blink::FilePathPtr path, CleanupDirectoryCallback callback) final;
...
FileEnumerationEntry(const FileEnumerationEntry&) = delete;
FileEnumerationEntry& operator=(const FileEnumerationEntry&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        FileEnumerationEntry::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        FileEnumerationEntry::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::network::mojom::blink::FileEnumerationEntry::DataView,
