...
void DeviceBoundSessionManagerProxy::CreateBoundSessions(
    ::blink::Vector<DeviceBoundSessionParamsPtr> in_params, const ::blink::Vector<uint8_t>& in_wrapped_key, ::blink::Vector<::network::mojom::blink::CanonicalCookiePtr> in_cookies_to_set, ::network::mojom::blink::CookieOptionsPtr in_cookie_options, CreateBoundSessionsCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("cookies_to_set"), in_cookies_to_set,
                        "<value of type ::blink::Vector<::network::mojom::blink::CanonicalCookiePtr>>");
      perfetto::WriteIntoTracedValueWithFallback(
...
class DeviceBoundSessionManager_CreateBoundSessions_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      const ::blink::Vector<DeviceBoundSessionError>& in_session_results, ::blink::Vector<::network::mojom::blink::CookieInclusionStatusPtr> in_cookie_results);
};
...
bool DeviceBoundSessionManager_CreateBoundSessions_ForwardToCallback::Accept(
  ...
  ::blink::Vector<::network::mojom::blink::CookieInclusionStatusPtr> p_cookie_results{};
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("cookie_results"), in_cookie_results,
                        "<value of type ::blink::Vector<::network::mojom::blink::CookieInclusionStatusPtr>>");
   });
#endif
...
bool DeviceBoundSessionManagerStubDispatch::AcceptWithResponder(
  ...
  switch (static_cast<messages::DeviceBoundSessionManager>(message->header()->name)) {
    ...
    case messages::DeviceBoundSessionManager::kCreateBoundSessions: {
      ...
      ::blink::Vector<::network::mojom::blink::CanonicalCookiePtr> p_cookies_to_set{};
...
void DeviceBoundSessionManagerInterceptorForTesting::CreateBoundSessions(::blink::Vector<DeviceBoundSessionParamsPtr> params, const ::blink::Vector<uint8_t>& wrapped_key, ::blink::Vector<::network::mojom::blink::CanonicalCookiePtr> cookies_to_set, ::network::mojom::blink::CookieOptionsPtr cookie_options, CreateBoundSessionsCallback callback) {
...
,
             ::blink::Vector<::network::mojom::blink::CookieInclusionStatusPtr>* out_cookie_results
,
             const ::blink::Vector<DeviceBoundSessionError>& session_results,
             ::blink::Vector<::network::mojom::blink::CookieInclusionStatusPtr> cookie_results) {*out_session_results = std::move(session_results);*out_cookie_results = std::move(cookie_results);
            loop->Quit();
          },
          &loop,
          out_session_results,
