...
// with not having this data in traces there.
  ...
  using OnAuthRequiredMojoCallback = base::OnceCallback<void(const std::optional<::net::AuthCredentials>&)>;

  virtual void OnAuthRequired(const ::net::AuthChallengeInfo& info, const ::scoped_refptr<::net::HttpResponseHeaders>& headers, ::network::mojom::IPEndPointPtr remote_endpoint, OnAuthRequiredCallback callback) = 0;
};
...
class  WebSocketAuthenticationHandlerProxy
 ...
 public:
  ...
  void OnAuthRequired(const ::net::AuthChallengeInfo& info, const ::scoped_refptr<::net::HttpResponseHeaders>& headers, ::network::mojom::IPEndPointPtr remote_endpoint, OnAuthRequiredCallback callback) final;
 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        HttpHeader::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
WebSocketHandshakeRequest& operator=(const WebSocketHandshakeRequest&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        WebSocketHandshakeRequest::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
WebSocketHandshakeResponse& operator=(const WebSocketHandshakeResponse&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        WebSocketHandshakeResponse::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
struct  StructTraits<::network::mojom::WebSocketHandshakeResponse::DataView,
  ...
  static const decltype(::network::mojom::WebSocketHandshakeResponse::extensions)& extensions(
      const ::network::mojom::WebSocketHandshakeResponsePtr& input) {
