...
CTLogInfo::CTLogInfo(
    ::mojo_base::mojom::blink::ByteStringPtr id_in,
    ::mojo_base::mojom::blink::ByteStringPtr public_key_in,
    const ::blink::String& name_in,
    std::optional<::base::Time> disqualified_at_in,
    ::base::TimeDelta mmd_in,
    const ::blink::String& current_operator_in,
    ::blink::Vector<PreviousOperatorEntryPtr> previous_operators_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<PreviousOperatorEntryPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
