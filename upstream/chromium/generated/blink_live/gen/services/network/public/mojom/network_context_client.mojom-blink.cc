...
void NetworkContextClientProxy::OnFileUploadRequested(
    ::network::mojom::blink::OriginatingProcessIdPtr in_process_id, bool in_async, ::blink::Vector<::mojo_base::mojom::blink::FilePathPtr> in_file_paths, const ::blink::KURL& in_destination_url, OnFileUploadRequestedCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("process_id"), in_process_id,
                        "<value of type ::network::mojom::blink::OriginatingProcessIdPtr>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("async"), in_async,
                        "<value of type bool>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("file_paths"), in_file_paths,
                        "<value of type ::blink::Vector<::mojo_base::mojom::blink::FilePathPtr>>");
      perfetto::WriteIntoTracedValueWithFallback(
...
class NetworkContextClient_OnFileUploadRequested_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      int32_t in_net_error, ::blink::Vector<::mojo_base::mojom::blink::ReadOnlyFilePtr> in_files);
};
...
bool NetworkContextClient_OnFileUploadRequested_ForwardToCallback::Accept(
  ...
  bool success = true;
  int32_t p_net_error{};
  ::blink::Vector<::mojo_base::mojom::blink::ReadOnlyFilePtr> p_files{};
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("files"), in_files,
                        "<value of type ::blink::Vector<::mojo_base::mojom::blink::ReadOnlyFilePtr>>");
   });
#endif
...
bool NetworkContextClientStubDispatch::AcceptWithResponder(
  ...
  switch (static_cast<messages::NetworkContextClient>(message->header()->name)) {
    case messages::NetworkContextClient::kOnFileUploadRequested: {
      ...
      // Validation for NetworkContextClient.0
      bool success = true;
      ::network::mojom::blink::OriginatingProcessIdPtr p_process_id{};
      bool p_async{};
      ::blink::Vector<::mojo_base::mojom::blink::FilePathPtr> p_file_paths{};
...
void NetworkContextClientInterceptorForTesting::OnFileUploadRequested(::network::mojom::blink::OriginatingProcessIdPtr process_id, bool async, ::blink::Vector<::mojo_base::mojom::blink::FilePathPtr> file_paths, const ::blink::KURL& destination_url, OnFileUploadRequestedCallback callback) {
...
,
             ::blink::Vector<::mojo_base::mojom::blink::ReadOnlyFilePtr>* out_files
,
             int32_t net_error,
             ::blink::Vector<::mojo_base::mojom::blink::ReadOnlyFilePtr> files) {*out_net_error = std::move(net_error);*out_files = std::move(files);
            loop->Quit();
          },
          &loop,
          out_net_error,
