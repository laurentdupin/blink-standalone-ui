...
StructuredHeadersParameterizedItem::StructuredHeadersParameterizedItem(
    StructuredHeadersItemPtr item_in,
    std::vector<StructuredHeadersParameterPtr> parameters_in)
    : item(std::move(item_in)),
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<StructuredHeadersParameterPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
StructuredHeadersParameterizedMember::StructuredHeadersParameterizedMember(
    std::vector<StructuredHeadersParameterizedItemPtr> member_in,
...
void StructuredHeadersParameterizedMember::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "member"), this->member,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<StructuredHeadersParameterizedItemPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
StructuredHeadersDictionary::StructuredHeadersDictionary(
    std::vector<StructuredHeadersDictionaryMemberPtr> members_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<StructuredHeadersDictionaryMemberPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
void StructuredHeadersItem::set_token_value(const std::string& token_value) {
  if (tag_ == Tag::kTokenValue) {
    ...
    DestroyActive();
    tag_ = Tag::kTokenValue;
    new (&data_.token_value) std::string(
        std::move(token_value));
  }
}

void StructuredHeadersItem::set_byte_sequence_value(::mojo_base::mojom::ByteStringPtr byte_sequence_value) {
  if (tag_ == Tag::kByteSequenceValue) {
    data_.byte_sequence_value = std::move(byte_sequence_value);
  } else {
    DestroyActive();
    tag_ = Tag::kByteSequenceValue;
    new (&data_.byte_sequence_value) ::mojo_base::mojom::ByteStringPtr(
...
bool StructTraits<::network::mojom::StructuredHeadersParameter::DataView, ::network::mojom::StructuredHeadersParameterPtr>::Read(
    ::network::mojom::StructuredHeadersParameter::DataView input,
    ::network::mojom::StructuredHeadersParameterPtr* output) {
  bool success = true;
...
bool StructTraits<::network::mojom::StructuredHeadersParameterizedItem::DataView, ::network::mojom::StructuredHeadersParameterizedItemPtr>::Read(
    ::network::mojom::StructuredHeadersParameterizedItem::DataView input,
    ::network::mojom::StructuredHeadersParameterizedItemPtr* output) {
  bool success = true;
...
bool StructTraits<::network::mojom::StructuredHeadersParameterizedMember::DataView, ::network::mojom::StructuredHeadersParameterizedMemberPtr>::Read(
    ::network::mojom::StructuredHeadersParameterizedMember::DataView input,
    ::network::mojom::StructuredHeadersParameterizedMemberPtr* output) {
  bool success = true;
...
bool StructTraits<::network::mojom::StructuredHeadersDictionaryMember::DataView, ::network::mojom::StructuredHeadersDictionaryMemberPtr>::Read(
    ::network::mojom::StructuredHeadersDictionaryMember::DataView input,
    ::network::mojom::StructuredHeadersDictionaryMemberPtr* output) {
  bool success = true;
...
bool StructTraits<::network::mojom::StructuredHeadersDictionary::DataView, ::network::mojom::StructuredHeadersDictionaryPtr>::Read(
    ::network::mojom::StructuredHeadersDictionary::DataView input,
    ::network::mojom::StructuredHeadersDictionaryPtr* output) {
  bool success = true;
...
bool UnionTraits<::network::mojom::StructuredHeadersItem::DataView, ::network::mojom::StructuredHeadersItemPtr>::Read(
    ::network::mojom::StructuredHeadersItem::DataView input,
    ::network::mojom::StructuredHeadersItemPtr* output) {
  ...
  switch (input.tag()) {
    ...
    case Tag::kByteSequenceValue: {
      ::mojo_base::mojom::ByteStringPtr result_byte_sequence_value{};
