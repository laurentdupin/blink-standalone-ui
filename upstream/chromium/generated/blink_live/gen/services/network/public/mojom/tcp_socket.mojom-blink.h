...
// with not having this data in traces there.
  ...
  using ConnectMojoCallback = base::OnceCallback<void(int32_t, ::network::mojom::blink::IPEndPointPtr, ::network::mojom::blink::IPEndPointPtr, ::mojo::ScopedDataPipeConsumerHandle, ::mojo::ScopedDataPipeProducerHandle)>;

  virtual void Connect(::network::mojom::blink::AddressListPtr remote_addr_list, TCPConnectedSocketOptionsPtr tcp_connected_socket_options, ::mojo::PendingReceiver<TCPConnectedSocket> socket, ::mojo::PendingRemote<SocketObserver> observer, ConnectCallback callback) = 0;
};
...
// with not having this data in traces there.
  ...
  using UpgradeToTLSMojoCallback = base::OnceCallback<void(int32_t, ::mojo::ScopedDataPipeConsumerHandle, ::mojo::ScopedDataPipeProducerHandle, ::network::mojom::blink::SSLInfoPtr)>;

  virtual void UpgradeToTLS(::network::mojom::blink::HostPortPairPtr host_port_pair, ::network::mojom::blink::TLSClientSocketOptionsPtr options, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::mojo::PendingReceiver<::network::mojom::blink::TLSClientSocket> receiver, ::mojo::PendingRemote<SocketObserver> observer, UpgradeToTLSCallback callback) = 0;
...
// with not having this data in traces there.
  ...
  using AcceptCallback = base::OnceCallback<void(int32_t, ::network::mojom::blink::IPEndPointPtr, ::mojo::PendingRemote<TCPConnectedSocket>, ::mojo::ScopedDataPipeConsumerHandle, ::mojo::ScopedDataPipeProducerHandle)>;
  using AcceptMojoCallback = base::OnceCallback<void(int32_t, ::network::mojom::blink::IPEndPointPtr, ::mojo::PendingRemote<TCPConnectedSocket>, ::mojo::ScopedDataPipeConsumerHandle, ::mojo::ScopedDataPipeProducerHandle)>;
...
class  TCPBoundSocketProxy
 ...
 public:
  ...
  void Connect(::network::mojom::blink::AddressListPtr remote_addr_list, TCPConnectedSocketOptionsPtr tcp_connected_socket_options, ::mojo::PendingReceiver<TCPConnectedSocket> socket, ::mojo::PendingRemote<SocketObserver> observer, ConnectCallback callback) final;
 ...
 public:
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        TCPKeepAliveOptions::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        TCPKeepAliveOptions::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
class  TCPServerSocketOptions {
 public:
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        TCPServerSocketOptions::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        TCPServerSocketOptions::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
TCPConnectedSocketOptions& operator=(const TCPConnectedSocketOptions&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        TCPConnectedSocketOptions::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        TCPConnectedSocketOptions::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::network::mojom::blink::TCPKeepAliveOptions::DataView,
                                         ::network::mojom::blink::TCPKeepAliveOptionsPtr> {
  static bool IsNull(const ::network::mojom::blink::TCPKeepAliveOptionsPtr& input) { return !input; }
  static void SetToNull(::network::mojom::blink::TCPKeepAliveOptionsPtr* output) { output->reset(); }

  static decltype(::network::mojom::blink::TCPKeepAliveOptions::enable) enable(
      const ::network::mojom::blink::TCPKeepAliveOptionsPtr& input) {
    return input->enable;
  }

  static decltype(::network::mojom::blink::TCPKeepAliveOptions::delay) delay(
      const ::network::mojom::blink::TCPKeepAliveOptionsPtr& input) {
    return input->delay;
  }
...
template <>
struct  StructTraits<::network::mojom::blink::TCPConnectedSocketOptions::DataView,
...
template <>
struct  StructTraits<::network::mojom::blink::TCPServerSocketOptions::DataView,
                                         ::network::mojom::blink::TCPServerSocketOptionsPtr> {
  static bool IsNull(const ::network::mojom::blink::TCPServerSocketOptionsPtr& input) { return !input; }
  static void SetToNull(::network::mojom::blink::TCPServerSocketOptionsPtr* output) { output->reset(); }

  static decltype(::network::mojom::blink::TCPServerSocketOptions::backlog) backlog(
      const ::network::mojom::blink::TCPServerSocketOptionsPtr& input) {
    return input->backlog;
  }

  static decltype(::network::mojom::blink::TCPServerSocketOptions::ipv6_only) ipv6_only(
      const ::network::mojom::blink::TCPServerSocketOptionsPtr& input) {
