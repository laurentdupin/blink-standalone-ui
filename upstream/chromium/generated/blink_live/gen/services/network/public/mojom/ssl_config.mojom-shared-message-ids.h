// services/network/public/mojom/ssl_config.mojom-shared-message-ids.h is auto generated by mojom_bindings_generator.py, do not edit
...
enum class SSLConfigClient : uint32_t {
  kOnSSLConfigUpdated = 0,
};
