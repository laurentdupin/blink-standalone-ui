// services/network/public/mojom/unencoded_digest.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef SERVICES_NETWORK_PUBLIC_MOJOM_UNENCODED_DIGEST_MOJOM_BLINK_H_
#define SERVICES_NETWORK_PUBLIC_MOJOM_UNENCODED_DIGEST_MOJOM_BLINK_H_
...
#include "services/network/public/mojom/unencoded_digest.mojom-blink-forward.h"  // IWYU pragma: export
...
class BLINK_PLATFORM_EXPORT UnencodedDigests {
 public:
  template <typename T>
  ...
  UnencodedDigests(
      ::blink::Vector<::network::IntegrityMetadata> digests,
      ::blink::Vector<UnencodedDigestIssue> issues);
...
UnencodedDigests& operator=(const UnencodedDigests&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        UnencodedDigests::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        UnencodedDigests::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::UnencodedDigests::DataView,
                                         ::network::mojom::blink::UnencodedDigestsPtr> {
  static bool IsNull(const ::network::mojom::blink::UnencodedDigestsPtr& input) { return !input; }
  static void SetToNull(::network::mojom::blink::UnencodedDigestsPtr* output) { output->reset(); }

  static const decltype(::network::mojom::blink::UnencodedDigests::digests)& digests(
      const ::network::mojom::blink::UnencodedDigestsPtr& input) {
    return input->digests;
  }

  static const decltype(::network::mojom::blink::UnencodedDigests::issues)& issues(
      const ::network::mojom::blink::UnencodedDigestsPtr& input) {
    return input->issues;
  }

  static bool Read(::network::mojom::blink::UnencodedDigests::DataView input, ::network::mojom::blink::UnencodedDigestsPtr* output);
};

}  // namespace mojo

#endif  // SERVICES_NETWORK_PUBLIC_MOJOM_UNENCODED_DIGEST_MOJOM_BLINK_H_