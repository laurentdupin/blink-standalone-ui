...
#include "services/network/public/mojom/trust_tokens.mojom-data-view.h"  // IWYU pragma: export
...
struct Serializer<::network::mojom::TrustTokenProtocolVersion, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::network::mojom::TrustTokenProtocolVersion>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::network::mojom::TrustTokenProtocolVersion, UserType> ||
                        HasInfallibleConversion(::network::mojom::TrustTokenProtocolVersion()),
                    "::network::mojom::TrustTokenProtocolVersion does not have an infallible conversion, "
...
struct Serializer<::network::mojom::TrustTokenOperationStatus, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::network::mojom::TrustTokenOperationStatus>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::network::mojom::TrustTokenOperationStatus, UserType> ||
                        HasInfallibleConversion(::network::mojom::TrustTokenOperationStatus()),
                    "::network::mojom::TrustTokenOperationStatus does not have an infallible conversion, "
                    "use an optional return type.");
      *output = Traits::FromMojom(known_value);
      return true;
    } else {
...
struct Serializer<::network::mojom::TrustTokenOperationType, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::network::mojom::TrustTokenOperationType>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::network::mojom::TrustTokenOperationType, UserType> ||
                        HasInfallibleConversion(::network::mojom::TrustTokenOperationType()),
                    "::network::mojom::TrustTokenOperationType does not have an infallible conversion, "
                    "use an optional return type.");
      *output = Traits::FromMojom(known_value);
      return true;
    } else {
...
struct Serializer<::network::mojom::TrustTokenRefreshPolicy, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::network::mojom::TrustTokenRefreshPolicy>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::network::mojom::TrustTokenRefreshPolicy, UserType> ||
                        HasInfallibleConversion(::network::mojom::TrustTokenRefreshPolicy()),
                    "::network::mojom::TrustTokenRefreshPolicy does not have an infallible conversion, "
                    "use an optional return type.");
      *output = Traits::FromMojom(known_value);
      return true;
    } else {
...
struct Serializer<::network::mojom::TrustTokenSignRequestData, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::network::mojom::TrustTokenSignRequestData>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::network::mojom::TrustTokenSignRequestData, UserType> ||
                        HasInfallibleConversion(::network::mojom::TrustTokenSignRequestData()),
                    "::network::mojom::TrustTokenSignRequestData does not have an infallible conversion, "
                    "use an optional return type.");
      *output = Traits::FromMojom(known_value);
      return true;
    } else {
...
struct Serializer<::network::mojom::DeleteStoredTrustTokensStatus, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::network::mojom::DeleteStoredTrustTokensStatus>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::network::mojom::DeleteStoredTrustTokensStatus, UserType> ||
                        HasInfallibleConversion(::network::mojom::DeleteStoredTrustTokensStatus()),
                    "::network::mojom::DeleteStoredTrustTokensStatus does not have an infallible conversion, "
                    "use an optional return type.");
      *output = Traits::FromMojom(known_value);
      return true;
    } else {
...
struct Serializer<::network::mojom::TrustTokenKeyCommitmentResult_Os, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::network::mojom::TrustTokenKeyCommitmentResult_Os>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::network::mojom::TrustTokenKeyCommitmentResult_Os, UserType> ||
                        HasInfallibleConversion(::network::mojom::TrustTokenKeyCommitmentResult_Os()),
                    "::network::mojom::TrustTokenKeyCommitmentResult_Os does not have an infallible conversion, "
                    "use an optional return type.");
      *output = Traits::FromMojom(known_value);
      return true;
    } else {
...
struct Serializer<::network::mojom::TrustTokenKeyCommitmentResult_UnavailableLocalOperationFallback, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::network::mojom::TrustTokenKeyCommitmentResult_UnavailableLocalOperationFallback>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::network::mojom::TrustTokenKeyCommitmentResult_UnavailableLocalOperationFallback, UserType> ||
                        HasInfallibleConversion(::network::mojom::TrustTokenKeyCommitmentResult_UnavailableLocalOperationFallback()),
                    "::network::mojom::TrustTokenKeyCommitmentResult_UnavailableLocalOperationFallback does not have an infallible conversion, "
                    "use an optional return type.");
      *output = Traits::FromMojom(known_value);
      return true;
    } else {
...
struct Serializer<::network::mojom::FulfillTrustTokenIssuanceAnswer_Status, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::network::mojom::FulfillTrustTokenIssuanceAnswer_Status>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::network::mojom::FulfillTrustTokenIssuanceAnswer_Status, UserType> ||
                        HasInfallibleConversion(::network::mojom::FulfillTrustTokenIssuanceAnswer_Status()),
                    "::network::mojom::FulfillTrustTokenIssuanceAnswer_Status does not have an infallible conversion, "
                    "use an optional return type.");
      *output = Traits::FromMojom(known_value);
      return true;
    } else {
