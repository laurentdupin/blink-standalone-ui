...
SharedDictionaryIsolationKey(const SharedDictionaryIsolationKey&) = delete;
SharedDictionaryIsolationKey& operator=(const SharedDictionaryIsolationKey&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SharedDictionaryIsolationKey::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SharedDictionaryIsolationKey::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::SharedDictionaryIsolationKey::DataView,
                                         ::network::mojom::blink::SharedDictionaryIsolationKeyPtr> {
  static bool IsNull(const ::network::mojom::blink::SharedDictionaryIsolationKeyPtr& input) { return !input; }
  static void SetToNull(::network::mojom::blink::SharedDictionaryIsolationKeyPtr* output) { output->reset(); }
