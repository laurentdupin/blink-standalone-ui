// services/network/public/mojom/mutable_partial_network_traffic_annotation_tag.mojom-shared-internal.h is auto generated by mojom_bindings_generator.py, do not edit
...
class  MutablePartialNetworkTrafficAnnotationTag_Data {
 ...
 private:
  friend class mojo::internal::MessageFragment<MutablePartialNetworkTrafficAnnotationTag_Data>;
...
struct MutablePartialNetworkTrafficAnnotationTag_UnserializedMessageContext
 ...
 private:
  ...
  void Serialize(mojo::Message& message) override {
    mojo::internal::MessageFragment<MutablePartialNetworkTrafficAnnotationTag_Data> fragment(message);
