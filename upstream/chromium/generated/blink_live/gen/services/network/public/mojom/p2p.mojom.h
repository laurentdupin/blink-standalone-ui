...
// with not having this data in traces there.
  ...
  virtual void NetworkListChanged(std::vector<::network::mojom::NetworkInterfacePtr> networks, ::network::mojom::IPAddressPtr default_ipv4_local_address, ::network::mojom::IPAddressPtr default_ipv6_local_address) = 0;
};
...
// with not having this data in traces there.
  ...
  using GetHostAddressCallback = base::OnceCallback<void(std::vector<::network::mojom::IPAddressPtr>)>;
  using GetHostAddressMojoCallback = base::OnceCallback<void(std::vector<::network::mojom::IPAddressPtr>)>;

  virtual void GetHostAddress(const std::string& host_name, std::optional<::network::mojom::AddressFamily> address_family, bool enable_mdns, GetHostAddressCallback callback) = 0;

  virtual void CreateSocket(P2PSocketType type, ::network::mojom::IPEndPointPtr local_address, P2PPortRangePtr port_range, P2PHostAndIPEndPointPtr remote_address, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, const std::optional<::base::UnguessableToken>& devtools_token, ::mojo::PendingRemote<P2PSocketClient> client, ::mojo::PendingReceiver<P2PSocket> socket) = 0;
};
...
// with not having this data in traces there.
  ...
  virtual void Send(::mojo_base::mojom::ReadOnlyBufferPtr data, P2PPacketInfoPtr packet_info) = 0;
...
// with not having this data in traces there.
  ...
  virtual void SocketCreated(::network::mojom::IPEndPointPtr local_address, ::network::mojom::IPEndPointPtr remote_address) = 0;

  virtual void SendComplete(P2PSendPacketMetricsPtr send_metrics) = 0;

  virtual void SendBatchComplete(std::vector<P2PSendPacketMetricsPtr> send_metrics_batch) = 0;
...
class  P2PNetworkNotificationClientProxy
 ...
 public:
  ...
  void NetworkListChanged(std::vector<::network::mojom::NetworkInterfacePtr> networks, ::network::mojom::IPAddressPtr default_ipv4_local_address, ::network::mojom::IPAddressPtr default_ipv6_local_address) final;
...
class  P2PSocketManagerProxy
 ...
 public:
  ...
  void GetHostAddress(const std::string& host_name, std::optional<::network::mojom::AddressFamily> address_family, bool enable_mdns, GetHostAddressCallback callback) final;
...
class  P2PSocketProxy
 ...
 public:
  ...
  void Send(::mojo_base::mojom::ReadOnlyBufferPtr data, P2PPacketInfoPtr packet_info) final;
...
class  P2PSocketClientProxy
 ...
 public:
  ...
  void SocketCreated(::network::mojom::IPEndPointPtr local_address, ::network::mojom::IPEndPointPtr remote_address) final;
  
  void SendComplete(P2PSendPacketMetricsPtr send_metrics) final;
  
  void SendBatchComplete(std::vector<P2PSendPacketMetricsPtr> send_metrics_batch) final;
...
class  P2PReceivedPacket {
 public:
  ...
  P2PReceivedPacket(
      ...
      ::network::mojom::IPEndPointPtr socket_address,
