...
#include "services/network/public/mojom/cross_origin_embedder_policy.mojom-test-utils.h"
...
void CrossOriginEmbedderPolicyReporterProxy::QueueCorpViolationReport(
  ...
  mojo::Message message(
      std::to_underlying(messages::CrossOriginEmbedderPolicyReporter::kQueueCorpViolationReport), kFlags, estimated_payload_size);
...
void CrossOriginEmbedderPolicyReporterProxy::Clone(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::CrossOriginEmbedderPolicyReporter::kClone), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool CrossOriginEmbedderPolicyReporterRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::CrossOriginEmbedderPolicyReporter::Name_,
...
void CrossOriginEmbedderPolicyReporterInterceptorForTesting::QueueCorpViolationReport(const ::GURL& blocked_url, ::network::mojom::RequestDestination destination, bool report_only) {
