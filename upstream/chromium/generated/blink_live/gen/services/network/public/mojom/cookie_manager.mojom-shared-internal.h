...
class ExclusionReasons_Data;
class WarningReasons_Data;
...
struct CookieScopeSemantics_Data {
 public:
  static bool constexpr kIsExtensible = false;
...
class  CookieManagerParams_Data {
 public:
  ...
  mojo::internal::Pointer<mojo::internal::Array_Data<mojo::internal::Pointer<::url::mojom::internal::Origin_Data>>> secure_origin_cookies_allowed_origins;
...
static_assert(sizeof(CookieManagerParams_Data) == 56,
...
class  ExclusionReasons_Data {
 ...
 private:
  friend class mojo::internal::MessageFragment<ExclusionReasons_Data>;

  ExclusionReasons_Data();
  ~ExclusionReasons_Data() = delete;
};
static_assert(sizeof(ExclusionReasons_Data) == 16,
              "Bad sizeof(ExclusionReasons_Data)");
// Used by ExclusionReasons::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView>
struct ExclusionReasons_UnserializedMessageContext
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  ExclusionReasons_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
      , user_data_(std::move(input)) {}
  ~ExclusionReasons_UnserializedMessageContext() override = default;
 ...
 private:
  // mojo::internal::UnserializedMessageContext:
  void Serialize(mojo::Message& message) override {
    mojo::internal::MessageFragment<ExclusionReasons_Data> fragment(message);
    mojo::internal::Serialize<DataView>(user_data_, fragment);
  }
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag
    ExclusionReasons_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
class  WarningReasons_Data {
 public:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
 ...
 private:
  friend class mojo::internal::MessageFragment<WarningReasons_Data>;

  WarningReasons_Data();
  ~WarningReasons_Data() = delete;
};
static_assert(sizeof(WarningReasons_Data) == 16,
              "Bad sizeof(WarningReasons_Data)");
// Used by WarningReasons::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView>
struct WarningReasons_UnserializedMessageContext
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  WarningReasons_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
      , user_data_(std::move(input)) {}
  ~WarningReasons_UnserializedMessageContext() override = default;
 ...
 private:
  // mojo::internal::UnserializedMessageContext:
  void Serialize(mojo::Message& message) override {
    mojo::internal::MessageFragment<WarningReasons_Data> fragment(message);
    mojo::internal::Serialize<DataView>(user_data_, fragment);
  }
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag
    WarningReasons_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
class  CookieInclusionStatus_Data {
 public:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
  ...
  mojo::internal::StructHeader header_;
  mojo::internal::Pointer<internal::ExclusionReasons_Data> exclusion_reasons;
  mojo::internal::Pointer<internal::WarningReasons_Data> warning_reasons;
...
static_assert(sizeof(CookieInclusionStatus_Data) == 32,
