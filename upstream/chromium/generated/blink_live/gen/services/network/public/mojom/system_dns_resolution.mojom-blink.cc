...
void SystemDnsResolverProxy::Resolve(
    const ::blink::String& in_hostname, ::network::mojom::blink::AddressFamily in_addr_family, int32_t in_flags, uint64_t in_network, ResolveCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("addr_family"), in_addr_family,
                        "<value of type ::network::mojom::blink::AddressFamily>");
      perfetto::WriteIntoTracedValueWithFallback(
...
void SystemDnsResolverInterceptorForTesting::Resolve(const ::blink::String& hostname, ::network::mojom::blink::AddressFamily addr_family, int32_t flags, uint64_t network, ResolveCallback callback) {
...
void SystemDnsResolverAsyncWaiter::Resolve(
    const ::blink::String& hostname, ::network::mojom::blink::AddressFamily addr_family, int32_t flags, uint64_t network, ::network::mojom::blink::AddressListPtr* out_addr_list, int32_t* out_os_error, int32_t* out_net_error) {
  base::RunLoop loop;
  proxy_->Resolve(
      std::move(hostname),
      std::move(addr_family),
