// services/network/public/mojom/mutable_partial_network_traffic_annotation_tag.mojom.h is auto generated by mojom_bindings_generator.py, do not edit
...
#include "services/network/public/mojom/mutable_partial_network_traffic_annotation_tag.mojom-forward.h"  // IWYU pragma: export
#include <string>
#include <vector>
 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        MutablePartialNetworkTrafficAnnotationTag::DataView, std::vector<uint8_t>, send_validation>(input);
  }
