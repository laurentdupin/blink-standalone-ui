 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CookieSettingOverrides::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CookieSettingOverrides::DataView, std::vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::network::mojom::CookieSettingOverrides::DataView,
                                         ::network::mojom::CookieSettingOverridesPtr> {
  static bool IsNull(const ::network::mojom::CookieSettingOverridesPtr& input) { return !input; }
  static void SetToNull(::network::mojom::CookieSettingOverridesPtr* output) { output->reset(); }

  static decltype(::network::mojom::CookieSettingOverrides::overrides_bitmask) overrides_bitmask(
      const ::network::mojom::CookieSettingOverridesPtr& input) {
