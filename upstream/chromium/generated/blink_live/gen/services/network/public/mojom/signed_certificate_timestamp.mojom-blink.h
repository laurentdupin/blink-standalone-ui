// services/network/public/mojom/signed_certificate_timestamp.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef SERVICES_NETWORK_PUBLIC_MOJOM_SIGNED_CERTIFICATE_TIMESTAMP_MOJOM_BLINK_H_
#define SERVICES_NETWORK_PUBLIC_MOJOM_SIGNED_CERTIFICATE_TIMESTAMP_MOJOM_BLINK_H_
...
#include "services/network/public/mojom/signed_certificate_timestamp.mojom-blink-forward.h"  // IWYU pragma: export
...
class BLINK_PLATFORM_EXPORT SignedCertificateTimestamp {
 public:
  template <typename T>
  ...
  SignedCertificateTimestamp(
      ...
      const ::blink::String& log_id,
      ::base::Time timestamp,
      ::blink::Vector<uint8_t> extensions,
      const ::net::ct::DigitallySigned& signature,
      ::net::ct::SignedCertificateTimestamp::Origin origin,
      const ::blink::String& log_description);
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SignedCertificateTimestamp::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SignedCertificateTimestamp::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::SignedCertificateTimestamp::DataView,
                                         ::network::mojom::blink::SignedCertificateTimestampPtr> {
  static bool IsNull(const ::network::mojom::blink::SignedCertificateTimestampPtr& input) { return !input; }
  static void SetToNull(::network::mojom::blink::SignedCertificateTimestampPtr* output) { output->reset(); }

  static decltype(::network::mojom::blink::SignedCertificateTimestamp::version) version(
      const ::network::mojom::blink::SignedCertificateTimestampPtr& input) {
    return input->version;
  }

  static const decltype(::network::mojom::blink::SignedCertificateTimestamp::log_id)& log_id(
      const ::network::mojom::blink::SignedCertificateTimestampPtr& input) {
    return input->log_id;
  }

  static const decltype(::network::mojom::blink::SignedCertificateTimestamp::timestamp)& timestamp(
      const ::network::mojom::blink::SignedCertificateTimestampPtr& input) {
    return input->timestamp;
  }

  static const decltype(::network::mojom::blink::SignedCertificateTimestamp::extensions)& extensions(
      const ::network::mojom::blink::SignedCertificateTimestampPtr& input) {
    return input->extensions;
  }

  static const decltype(::network::mojom::blink::SignedCertificateTimestamp::signature)& signature(
      const ::network::mojom::blink::SignedCertificateTimestampPtr& input) {
    return input->signature;
  }

  static decltype(::network::mojom::blink::SignedCertificateTimestamp::origin) origin(
      const ::network::mojom::blink::SignedCertificateTimestampPtr& input) {
    return input->origin;
  }

  static const decltype(::network::mojom::blink::SignedCertificateTimestamp::log_description)& log_description(
      const ::network::mojom::blink::SignedCertificateTimestampPtr& input) {
    return input->log_description;
  }

  static bool Read(::network::mojom::blink::SignedCertificateTimestamp::DataView input, ::network::mojom::blink::SignedCertificateTimestampPtr* output);
};

}  // namespace mojo

#endif  // SERVICES_NETWORK_PUBLIC_MOJOM_SIGNED_CERTIFICATE_TIMESTAMP_MOJOM_BLINK_H_