...
void SocketBrokerProxy::CreateTcpSocket(
    ::network::mojom::AddressFamily in_address_family, CreateTcpSocketCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  mojo::Message message(
      std::to_underlying(messages::SocketBroker::kCreateTcpSocket), kFlags, estimated_payload_size);
...
void SocketBrokerProxy::CreateUdpSocket(
    ::network::mojom::AddressFamily in_address_family, CreateUdpSocketCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::SocketBroker::kCreateUdpSocket), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
class SocketBroker_CreateTcpSocket_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::network::mojom::TransferableSocketPtr in_created_socket, int32_t in_rv);
};
...
bool SocketBroker_CreateTcpSocket_ForwardToCallback::Accept(
  ...
  bool success = true;
  ::network::mojom::TransferableSocketPtr p_created_socket{};
  int32_t p_rv{};
...
bool SocketBrokerStubDispatch::AcceptWithResponder(
  ...
  switch (static_cast<messages::SocketBroker>(message->header()->name)) {
    case messages::SocketBroker::kCreateTcpSocket: {
      ...
      // Validation for SocketBroker.0
      bool success = true;
      ::network::mojom::AddressFamily p_address_family{};
...
bool SocketBrokerRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::SocketBroker::Name_,
...
void SocketBrokerInterceptorForTesting::CreateTcpSocket(::network::mojom::AddressFamily address_family, CreateTcpSocketCallback callback) {
  GetForwardingInterface()->CreateTcpSocket(
    std::move(address_family)
    , std::move(callback));
}
void SocketBrokerInterceptorForTesting::CreateUdpSocket(::network::mojom::AddressFamily address_family, CreateUdpSocketCallback callback) {
...
void SocketBrokerAsyncWaiter::CreateTcpSocket(
    ::network::mojom::AddressFamily address_family, ::network::mojom::TransferableSocketPtr* out_created_socket, int32_t* out_rv) {
  base::RunLoop loop;
  proxy_->CreateTcpSocket(
      std::move(address_family),
      base::BindOnce(
          [](base::RunLoop* loop,
             ::network::mojom::TransferableSocketPtr* out_created_socket
,
             int32_t* out_rv
,
             ::network::mojom::TransferableSocketPtr created_socket,
