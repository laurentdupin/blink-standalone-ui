// services/network/public/mojom/supports_loading_mode.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef SERVICES_NETWORK_PUBLIC_MOJOM_SUPPORTS_LOADING_MODE_MOJOM_BLINK_H_
#define SERVICES_NETWORK_PUBLIC_MOJOM_SUPPORTS_LOADING_MODE_MOJOM_BLINK_H_
...
#include "services/network/public/mojom/supports_loading_mode.mojom-blink-forward.h"  // IWYU pragma: export
...
class BLINK_PLATFORM_EXPORT SupportsLoadingMode {
 public:
  template <typename T>
  ...
  explicit SupportsLoadingMode(
      ::blink::Vector<LoadingMode> supported_modes);
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SupportsLoadingMode::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SupportsLoadingMode::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::SupportsLoadingMode::DataView,
                                         ::network::mojom::blink::SupportsLoadingModePtr> {
  static bool IsNull(const ::network::mojom::blink::SupportsLoadingModePtr& input) { return !input; }
  static void SetToNull(::network::mojom::blink::SupportsLoadingModePtr* output) { output->reset(); }

  static const decltype(::network::mojom::blink::SupportsLoadingMode::supported_modes)& supported_modes(
      const ::network::mojom::blink::SupportsLoadingModePtr& input) {
    return input->supported_modes;
  }

  static bool Read(::network::mojom::blink::SupportsLoadingMode::DataView input, ::network::mojom::blink::SupportsLoadingModePtr* output);
};

}  // namespace mojo

#endif  // SERVICES_NETWORK_PUBLIC_MOJOM_SUPPORTS_LOADING_MODE_MOJOM_BLINK_H_