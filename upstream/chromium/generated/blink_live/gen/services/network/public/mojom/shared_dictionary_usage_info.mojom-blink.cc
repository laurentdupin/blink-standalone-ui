// services/network/public/mojom/shared_dictionary_usage_info.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "services/network/public/mojom/shared_dictionary_usage_info.mojom-blink-test-utils.h"
...
// static
bool StructTraits<::network::mojom::blink::SharedDictionaryUsageInfo::DataView, ::network::mojom::blink::SharedDictionaryUsageInfoPtr>::Read(
    ::network::mojom::blink::SharedDictionaryUsageInfo::DataView input,
    ::network::mojom::blink::SharedDictionaryUsageInfoPtr* output) {
  bool success = true;
  ::network::mojom::blink::SharedDictionaryUsageInfoPtr result(::network::mojom::blink::SharedDictionaryUsageInfo::New());
