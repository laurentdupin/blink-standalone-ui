...
#include "services/network/public/mojom/web_bundle_handle.mojom-test-utils.h"
...
void WebBundleHandleProxy::Clone(
  ...
  mojo::Message message(
      std::to_underlying(messages::WebBundleHandle::kClone), kFlags, estimated_payload_size);
...
void WebBundleHandleProxy::OnWebBundleError(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::WebBundleHandle::kOnWebBundleError), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void WebBundleHandleProxy::OnWebBundleLoadFinished(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::WebBundleHandle::kOnWebBundleLoadFinished), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool WebBundleHandleRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::WebBundleHandle::Name_,
...
void WebBundleHandleInterceptorForTesting::OnWebBundleError(WebBundleErrorType type, const std::string& message) {
