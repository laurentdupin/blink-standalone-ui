...
DnsOverHttpsServerConfig::DnsOverHttpsServerConfig(
    ...
    ::blink::Vector<::blink::Vector<::network::mojom::blink::IPAddressPtr>> endpoints_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<::blink::Vector<::network::mojom::blink::IPAddressPtr>>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
DnsConfigOverrides::DnsConfigOverrides(
    std::optional<::blink::Vector<::network::mojom::blink::IPEndPointPtr>> nameservers_in,
    ...
    std::optional<::blink::Vector<::network::mojom::blink::IPEndPointPtr>> fallback_doh_nameservers_in,
    bool clear_hosts_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::optional<::blink::Vector<::network::mojom::blink::IPEndPointPtr>>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
ResolveHostParameters::ResolveHostParameters()
    : dns_query_type(DnsQueryType::UNSPECIFIED),
      initial_priority(::network::mojom::blink::RequestPriority::kLowest),
...
ResolveHostParameters::ResolveHostParameters(
    ...
    ::network::mojom::blink::RequestPriority initial_priority_in,
...
void HostResolverHost::set_host_port_pair(::network::mojom::blink::HostPortPairPtr host_port_pair) {
  if (tag_ == Tag::kHostPortPair) {
    data_.host_port_pair = std::move(host_port_pair);
  } else {
    DestroyActive();
    tag_ = Tag::kHostPortPair;
    new (&data_.host_port_pair) ::network::mojom::blink::HostPortPairPtr(
...
void ResolveHostClientProxy::OnHostnameResults(
    ::blink::Vector<::network::mojom::blink::HostPortPairPtr> in_hosts) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("hosts"), in_hosts,
                        "<value of type ::blink::Vector<::network::mojom::blink::HostPortPairPtr>>");
   });
#endif
...
bool ResolveHostClientStubDispatch::Accept(
  ...
  switch (static_cast<messages::ResolveHostClient>(message->header()->name)) {
    ...
    case messages::ResolveHostClient::kOnHostnameResults: {
      ...
      bool success = true;
      ::blink::Vector<::network::mojom::blink::HostPortPairPtr> p_hosts{};
...
void MdnsListenClientProxy::OnAddressResult(
    MdnsListenClient::UpdateType in_update_type, DnsQueryType in_query_type, ::network::mojom::blink::IPEndPointPtr in_endpoint) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void MdnsListenClientProxy::OnTextResult(
    MdnsListenClient::UpdateType in_update_type, DnsQueryType in_query_type, const ::blink::Vector<::blink::String>& in_text_records) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool UnionTraits<::network::mojom::blink::HostResolverHost::DataView, ::network::mojom::blink::HostResolverHostPtr>::Read(
  ...
  switch (input.tag()) {
    ...
    case Tag::kHostPortPair: {
      ::network::mojom::blink::HostPortPairPtr result_host_port_pair{};
...
void ResolveHostClientInterceptorForTesting::OnHostnameResults(::blink::Vector<::network::mojom::blink::HostPortPairPtr> hosts) {
...
void MdnsListenClientInterceptorForTesting::OnTextResult(MdnsListenClient::UpdateType update_type, DnsQueryType query_type, const ::blink::Vector<::blink::String>& text_records) {
...
int32_t HostResolverAsyncWaiter::MdnsListen(
    ::network::mojom::blink::HostPortPairPtr host, DnsQueryType query_type, ::mojo::PendingRemote<MdnsListenClient> response_client) {
