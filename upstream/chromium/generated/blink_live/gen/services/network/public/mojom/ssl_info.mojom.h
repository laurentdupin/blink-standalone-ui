// services/network/public/mojom/ssl_info.mojom.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef SERVICES_NETWORK_PUBLIC_MOJOM_SSL_INFO_MOJOM_H_
#define SERVICES_NETWORK_PUBLIC_MOJOM_SSL_INFO_MOJOM_H_
...
#include "services/network/public/mojom/ssl_info.mojom-forward.h"  // IWYU pragma: export
...
class  SSLInfo {
 public:
  ...
  SSLInfo(
      ...
      ::net::SSLInfo::HandshakeType handshake_type,
      std::vector<::net::SHA256HashValue> public_key_hashes,
      std::vector<::net::SignedCertificateTimestampAndStatus> signed_certificate_timestamps,
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SSLInfo::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SSLInfo::DataView, std::vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::network::mojom::SSLInfo::DataView,
                                         ::network::mojom::SSLInfoPtr> {
  static bool IsNull(const ::network::mojom::SSLInfoPtr& input) { return !input; }
  static void SetToNull(::network::mojom::SSLInfoPtr* output) { output->reset(); }

  static const decltype(::network::mojom::SSLInfo::cert)& cert(
      const ::network::mojom::SSLInfoPtr& input) {
    return input->cert;
  }

  static const decltype(::network::mojom::SSLInfo::unverified_cert)& unverified_cert(
      const ::network::mojom::SSLInfoPtr& input) {
    return input->unverified_cert;
  }

  static decltype(::network::mojom::SSLInfo::cert_status) cert_status(
      const ::network::mojom::SSLInfoPtr& input) {
    return input->cert_status;
  }

  static decltype(::network::mojom::SSLInfo::key_exchange_group) key_exchange_group(
      const ::network::mojom::SSLInfoPtr& input) {
    return input->key_exchange_group;
  }

  static decltype(::network::mojom::SSLInfo::peer_signature_algorithm) peer_signature_algorithm(
      const ::network::mojom::SSLInfoPtr& input) {
    return input->peer_signature_algorithm;
  }

  static decltype(::network::mojom::SSLInfo::connection_status) connection_status(
      const ::network::mojom::SSLInfoPtr& input) {
    return input->connection_status;
  }

  static decltype(::network::mojom::SSLInfo::is_issued_by_known_root) is_issued_by_known_root(
      const ::network::mojom::SSLInfoPtr& input) {
    return input->is_issued_by_known_root;
  }

  static decltype(::network::mojom::SSLInfo::pkp_bypassed) pkp_bypassed(
      const ::network::mojom::SSLInfoPtr& input) {
    return input->pkp_bypassed;
  }

  static decltype(::network::mojom::SSLInfo::client_cert_sent) client_cert_sent(
      const ::network::mojom::SSLInfoPtr& input) {
    return input->client_cert_sent;
  }

  static decltype(::network::mojom::SSLInfo::encrypted_client_hello) encrypted_client_hello(
      const ::network::mojom::SSLInfoPtr& input) {
    return input->encrypted_client_hello;
  }

  static decltype(::network::mojom::SSLInfo::handshake_type) handshake_type(
      const ::network::mojom::SSLInfoPtr& input) {
    return input->handshake_type;
  }

  static const decltype(::network::mojom::SSLInfo::public_key_hashes)& public_key_hashes(
      const ::network::mojom::SSLInfoPtr& input) {
    return input->public_key_hashes;
  }

  static const decltype(::network::mojom::SSLInfo::signed_certificate_timestamps)& signed_certificate_timestamps(
      const ::network::mojom::SSLInfoPtr& input) {
    return input->signed_certificate_timestamps;
  }

  static decltype(::network::mojom::SSLInfo::ct_policy_compliance) ct_policy_compliance(
      const ::network::mojom::SSLInfoPtr& input) {
    return input->ct_policy_compliance;
  }

  static decltype(::network::mojom::SSLInfo::is_fatal_cert_error) is_fatal_cert_error(
      const ::network::mojom::SSLInfoPtr& input) {
    return input->is_fatal_cert_error;
  }

  static bool Read(::network::mojom::SSLInfo::DataView input, ::network::mojom::SSLInfoPtr* output);
};

}  // namespace mojo

#endif  // SERVICES_NETWORK_PUBLIC_MOJOM_SSL_INFO_MOJOM_H_