...
HttpRequestHeadersUpdateParams::HttpRequestHeadersUpdateParams(
    std::vector<std::string> removed_headers_in,
...
// static
bool StructTraits<::network::mojom::HttpRequestHeadersUpdateParams::DataView, ::network::mojom::HttpRequestHeadersUpdateParamsPtr>::Read(
    ::network::mojom::HttpRequestHeadersUpdateParams::DataView input,
    ::network::mojom::HttpRequestHeadersUpdateParamsPtr* output) {
  bool success = true;
  ::network::mojom::HttpRequestHeadersUpdateParamsPtr result(::network::mojom::HttpRequestHeadersUpdateParams::New());
