...
void MdnsResponderProxy::CreateNameForAddress(
    ::network::mojom::IPAddressPtr in_address, CreateNameForAddressCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  mojo::Message message(
      std::to_underlying(messages::MdnsResponder::kCreateNameForAddress), kFlags, estimated_payload_size);
...
void MdnsResponderProxy::RemoveNameForAddress(
    ::network::mojom::IPAddressPtr in_address, RemoveNameForAddressCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::MdnsResponder::kRemoveNameForAddress), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool MdnsResponderStubDispatch::AcceptWithResponder(
  ...
  switch (static_cast<messages::MdnsResponder>(message->header()->name)) {
    case messages::MdnsResponder::kCreateNameForAddress: {
      ...
      // Validation for MdnsResponder.0
      bool success = true;
      ::network::mojom::IPAddressPtr p_address{};
...
void MdnsResponderInterceptorForTesting::CreateNameForAddress(::network::mojom::IPAddressPtr address, CreateNameForAddressCallback callback) {
  GetForwardingInterface()->CreateNameForAddress(
    std::move(address)
    , std::move(callback));
}
void MdnsResponderInterceptorForTesting::RemoveNameForAddress(::network::mojom::IPAddressPtr address, RemoveNameForAddressCallback callback) {
...
void MdnsResponderAsyncWaiter::CreateNameForAddress(
    ::network::mojom::IPAddressPtr address, std::string* out_name, bool* out_announcement_scheduled) {
  base::RunLoop loop;
...
void MdnsResponderAsyncWaiter::RemoveNameForAddress(
    ::network::mojom::IPAddressPtr address, bool* out_removed, bool* out_goodbye_scheduled) {
  base::RunLoop loop;
