...
class RestrictedCanonicalCookieParams_Data;
...
struct RestrictedCookiePartition_Data {
 public:
  static bool constexpr kIsExtensible = false;
...
class  RestrictedCanonicalCookieParams_Data {
 ...
 private:
  friend class mojo::internal::MessageFragment<RestrictedCanonicalCookieParams_Data>;

  RestrictedCanonicalCookieParams_Data();
  ~RestrictedCanonicalCookieParams_Data() = delete;
};
static_assert(sizeof(RestrictedCanonicalCookieParams_Data) == 80,
              "Bad sizeof(RestrictedCanonicalCookieParams_Data)");
// Used by RestrictedCanonicalCookieParams::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView>
struct RestrictedCanonicalCookieParams_UnserializedMessageContext
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  RestrictedCanonicalCookieParams_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
      , user_data_(std::move(input)) {}
  ~RestrictedCanonicalCookieParams_UnserializedMessageContext() override = default;
 ...
 private:
  // mojo::internal::UnserializedMessageContext:
  void Serialize(mojo::Message& message) override {
    mojo::internal::MessageFragment<RestrictedCanonicalCookieParams_Data> fragment(message);
    mojo::internal::Serialize<DataView>(user_data_, fragment);
  }
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag
    RestrictedCanonicalCookieParams_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
