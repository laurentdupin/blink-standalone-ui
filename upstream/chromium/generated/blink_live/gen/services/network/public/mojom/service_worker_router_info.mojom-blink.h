// services/network/public/mojom/service_worker_router_info.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef SERVICES_NETWORK_PUBLIC_MOJOM_SERVICE_WORKER_ROUTER_INFO_MOJOM_BLINK_H_
#define SERVICES_NETWORK_PUBLIC_MOJOM_SERVICE_WORKER_ROUTER_INFO_MOJOM_BLINK_H_
...
#include "services/network/public/mojom/service_worker_router_info.mojom-blink-forward.h"  // IWYU pragma: export
...
class BLINK_PLATFORM_EXPORT ServiceWorkerRouterInfo {
 public:
  template <typename T>
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ServiceWorkerRouterInfo::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ServiceWorkerRouterInfo::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::ServiceWorkerRouterInfo::DataView,
                                         ::network::mojom::blink::ServiceWorkerRouterInfoPtr> {
  static bool IsNull(const ::network::mojom::blink::ServiceWorkerRouterInfoPtr& input) { return !input; }
  static void SetToNull(::network::mojom::blink::ServiceWorkerRouterInfoPtr* output) { output->reset(); }

  static decltype(::network::mojom::blink::ServiceWorkerRouterInfo::rule_id_matched) rule_id_matched(
      const ::network::mojom::blink::ServiceWorkerRouterInfoPtr& input) {
    return input->rule_id_matched;
  }

  static decltype(::network::mojom::blink::ServiceWorkerRouterInfo::matched_source_type) matched_source_type(
      const ::network::mojom::blink::ServiceWorkerRouterInfoPtr& input) {
    return input->matched_source_type;
  }

  static decltype(::network::mojom::blink::ServiceWorkerRouterInfo::actual_source_type) actual_source_type(
      const ::network::mojom::blink::ServiceWorkerRouterInfoPtr& input) {
    return input->actual_source_type;
  }

  static decltype(::network::mojom::blink::ServiceWorkerRouterInfo::route_rule_num) route_rule_num(
      const ::network::mojom::blink::ServiceWorkerRouterInfoPtr& input) {
    return input->route_rule_num;
  }

  static const decltype(::network::mojom::blink::ServiceWorkerRouterInfo::router_evaluation_time)& router_evaluation_time(
      const ::network::mojom::blink::ServiceWorkerRouterInfoPtr& input) {
    return input->router_evaluation_time;
  }

  static const decltype(::network::mojom::blink::ServiceWorkerRouterInfo::cache_lookup_time)& cache_lookup_time(
      const ::network::mojom::blink::ServiceWorkerRouterInfoPtr& input) {
    return input->cache_lookup_time;
  }

  static decltype(::network::mojom::blink::ServiceWorkerRouterInfo::evaluation_worker_status) evaluation_worker_status(
      const ::network::mojom::blink::ServiceWorkerRouterInfoPtr& input) {
    return input->evaluation_worker_status;
  }

  static bool Read(::network::mojom::blink::ServiceWorkerRouterInfo::DataView input, ::network::mojom::blink::ServiceWorkerRouterInfoPtr* output);
};

}  // namespace mojo

#endif  // SERVICES_NETWORK_PUBLIC_MOJOM_SERVICE_WORKER_ROUTER_INFO_MOJOM_BLINK_H_