...
CTLogInfo::CTLogInfo(
    ::mojo_base::mojom::ByteStringPtr id_in,
    ::mojo_base::mojom::ByteStringPtr public_key_in,
    const std::string& name_in,
...
bool StructTraits<::network::mojom::PreviousOperatorEntry::DataView, ::network::mojom::PreviousOperatorEntryPtr>::Read(
    ::network::mojom::PreviousOperatorEntry::DataView input,
    ::network::mojom::PreviousOperatorEntryPtr* output) {
  bool success = true;
