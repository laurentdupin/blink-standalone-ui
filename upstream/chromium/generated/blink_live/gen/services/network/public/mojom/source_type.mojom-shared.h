// services/network/public/mojom/source_type.mojom-shared.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2016 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef SERVICES_NETWORK_PUBLIC_MOJOM_SOURCE_TYPE_MOJOM_SHARED_H_
#define SERVICES_NETWORK_PUBLIC_MOJOM_SOURCE_TYPE_MOJOM_SHARED_H_
...
#include "services/network/public/mojom/source_type.mojom-data-view.h"  // IWYU pragma: export
...
struct Serializer<::network::mojom::SourceType, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::network::mojom::SourceType>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::network::mojom::SourceType, UserType> ||
                        HasInfallibleConversion(::network::mojom::SourceType()),
                    "::network::mojom::SourceType does not have an infallible conversion, "
...
#endif  // SERVICES_NETWORK_PUBLIC_MOJOM_SOURCE_TYPE_MOJOM_SHARED_H_