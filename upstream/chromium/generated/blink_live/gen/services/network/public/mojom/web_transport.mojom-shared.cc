...
NOINLINE static const char* WebTransportCongestionControlToStringHelper(WebTransportCongestionControl value) {
  // Defined in a helper function to ensure that Clang generates a lookup table.
  switch(value) {
    case WebTransportCongestionControl::kDefault:
      return "kDefault";
    case WebTransportCongestionControl::kThroughput:
      return "kThroughput";
    case WebTransportCongestionControl::kLowLatency:
      return "kLowLatency";
    default:
      return nullptr;
  }
...
std::string WebTransportCongestionControlToString(WebTransportCongestionControl value) {
  const char *str = WebTransportCongestionControlToStringHelper(value);
  if (!str) {
    return base::StringPrintf("Unknown WebTransportCongestionControl value: %i", static_cast<int32_t>(value));
  }
  return str;
}

std::ostream& operator<<(std::ostream& os, WebTransportCongestionControl value) {
  return os << WebTransportCongestionControlToString(value);
}
...
bool WebTransportCertificateFingerprint_Data::Validate(
  ...
  constexpr const mojo::internal::ContainerValidateParams& algorithm_validate_params =
      mojo::internal::GetArrayValidator<0, false, nullptr>();
...
bool WebTransportStats_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const WebTransportStats_Data* object =
      static_cast<const WebTransportStats_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->min_rtt, 2, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->smoothed_rtt, 3, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->rtt_variation, 4, validation_context)) {
    return false;
  }
...
bool WebTransport_GetStats_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const WebTransport_GetStats_Params_Data* object =
      static_cast<const WebTransport_GetStats_Params_Data*>(data);
...
bool WebTransport_GetStats_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const WebTransport_GetStats_ResponseParams_Data* object =
      static_cast<const WebTransport_GetStats_ResponseParams_Data*>(data);
...
// static
bool WebTransportHandshakeClient_OnBeforeConnect_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const WebTransportHandshakeClient_OnBeforeConnect_Params_Data* object =
      static_cast<const WebTransportHandshakeClient_OnBeforeConnect_Params_Data*>(data);

  if (!mojo::internal::ValidatePointerNonNullable(
          object->server_address, 1, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateStruct(object->server_address, validation_context))
    return false;

  return true;
}

WebTransportHandshakeClient_OnBeforeConnect_Params_Data::WebTransportHandshakeClient_OnBeforeConnect_Params_Data()
    : header_({sizeof(*this), 0}) {}
...
bool WebTransportHandshakeClient_OnConnectionEstablished_Params_Data::Validate(
  ...
  constexpr const mojo::internal::ContainerValidateParams& selected_application_protocol_validate_params =
      mojo::internal::GetArrayValidator<0, false, nullptr>();
  if (!mojo::internal::ValidateContainer(object->selected_application_protocol, validation_context,
                                         &selected_application_protocol_validate_params)) {
    return false;
  }

  if (!mojo::internal::ValidatePointerNonNullable(
          object->initial_stats, 5, validation_context)) {
    return false;
  }
...
// static
void TraceFormatTraits<::network::mojom::WebTransportCongestionControl>::WriteIntoTrace(
   perfetto::TracedValue context, ::network::mojom::WebTransportCongestionControl value) {
  return std::move(context).WriteString(::network::mojom::WebTransportCongestionControlToString(value));
}
