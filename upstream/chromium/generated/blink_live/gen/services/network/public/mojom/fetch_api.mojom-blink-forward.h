...
using RequestMode = RequestMode;
using RequestDestination = RequestDestination;
using RedirectMode = RedirectMode;
using CredentialsMode = CredentialsMode;
using FetchResponseType = FetchResponseType;
using FetchResponseSource = FetchResponseSource;
