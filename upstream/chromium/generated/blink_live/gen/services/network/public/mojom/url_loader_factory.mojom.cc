...
void URLLoaderFactoryProxy::CreateLoaderAndStart(
    ::mojo::PendingReceiver<::network::mojom::URLLoader> in_loader, int32_t in_request_id, uint32_t in_options, const ::network::ResourceRequest& in_request, ::mojo::PendingRemote<::network::mojom::URLLoaderClient> in_client, const ::net::MutableNetworkTrafficAnnotationTag& in_traffic_annotation) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  mojo::Message message(
      std::to_underlying(messages::URLLoaderFactory::kCreateLoaderAndStart), kFlags, estimated_payload_size);
...
void URLLoaderFactoryProxy::Clone(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::URLLoaderFactory::kClone), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool URLLoaderFactoryRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::URLLoaderFactory::Name_,
...
void URLLoaderFactoryInterceptorForTesting::CreateLoaderAndStart(::mojo::PendingReceiver<::network::mojom::URLLoader> loader, int32_t request_id, uint32_t options, const ::network::ResourceRequest& request, ::mojo::PendingRemote<::network::mojom::URLLoaderClient> client, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation) {
