...
class NetworkDurableMessageConfig_Data;
...
static_assert(sizeof(NetworkServiceParams_Data) == 48,
...
class  NetworkDurableMessageConfig_Data {
 ...
 private:
  friend class mojo::internal::MessageFragment<NetworkDurableMessageConfig_Data>;

  NetworkDurableMessageConfig_Data();
  ~NetworkDurableMessageConfig_Data() = delete;
};
static_assert(sizeof(NetworkDurableMessageConfig_Data) == 16,
              "Bad sizeof(NetworkDurableMessageConfig_Data)");
// Used by NetworkDurableMessageConfig::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView>
struct NetworkDurableMessageConfig_UnserializedMessageContext
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  NetworkDurableMessageConfig_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
      , user_data_(std::move(input)) {}
  ~NetworkDurableMessageConfig_UnserializedMessageContext() override = default;
 ...
 private:
  // mojo::internal::UnserializedMessageContext:
  void Serialize(mojo::Message& message) override {
    mojo::internal::MessageFragment<NetworkDurableMessageConfig_Data> fragment(message);
    mojo::internal::Serialize<DataView>(user_data_, fragment);
  }
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag
    NetworkDurableMessageConfig_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
