...
static_assert(sizeof(HasRedemptionRecordResult_Data) == 16,
              "Bad sizeof(HasRedemptionRecordResult_Data)");
// Used by HasRedemptionRecordResult::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView>
struct HasRedemptionRecordResult_UnserializedMessageContext
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  HasRedemptionRecordResult_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag
    HasRedemptionRecordResult_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
class  TrustTokenVerificationKey_Data {
 public:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
...
static_assert(sizeof(ToplevelRedemptionRecord_Data) == 24,
              "Bad sizeof(ToplevelRedemptionRecord_Data)");
// Used by ToplevelRedemptionRecord::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView>
struct ToplevelRedemptionRecord_UnserializedMessageContext
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  ToplevelRedemptionRecord_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag
    ToplevelRedemptionRecord_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
