...
#include "services/network/public/mojom/address_family.mojom-data-view.h"  // IWYU pragma: export
...
struct Serializer<::network::mojom::AddressFamily, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::network::mojom::AddressFamily>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::network::mojom::AddressFamily, UserType> ||
                        HasInfallibleConversion(::network::mojom::AddressFamily()),
                    "::network::mojom::AddressFamily does not have an infallible conversion, "
