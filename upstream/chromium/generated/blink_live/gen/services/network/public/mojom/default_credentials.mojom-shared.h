...
#include "services/network/public/mojom/default_credentials.mojom-data-view.h"  // IWYU pragma: export
...
struct Serializer<::network::mojom::DefaultCredentials, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::network::mojom::DefaultCredentials>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::network::mojom::DefaultCredentials, UserType> ||
                        HasInfallibleConversion(::network::mojom::DefaultCredentials()),
                    "::network::mojom::DefaultCredentials does not have an infallible conversion, "
