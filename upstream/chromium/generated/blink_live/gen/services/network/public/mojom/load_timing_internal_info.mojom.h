// services/network/public/mojom/load_timing_internal_info.mojom.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef SERVICES_NETWORK_PUBLIC_MOJOM_LOAD_TIMING_INTERNAL_INFO_MOJOM_H_
#define SERVICES_NETWORK_PUBLIC_MOJOM_LOAD_TIMING_INTERNAL_INFO_MOJOM_H_
...
#include "services/network/public/mojom/load_timing_internal_info.mojom-forward.h"  // IWYU pragma: export
 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        DohResolutionDetails::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        DohResolutionDetails::DataView, std::vector<uint8_t>>(input);
  }
...
ResolutionDetails& operator=(const ResolutionDetails&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ResolutionDetails::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ResolutionDetails::DataView, std::vector<uint8_t>>(input);
  }
...
LoadTimingInternalInfo& operator=(const LoadTimingInternalInfo&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        LoadTimingInternalInfo::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        LoadTimingInternalInfo::DataView, std::vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::network::mojom::DohResolutionDetails::DataView,
                                         ::network::mojom::DohResolutionDetailsPtr> {
  static bool IsNull(const ::network::mojom::DohResolutionDetailsPtr& input) { return !input; }
  static void SetToNull(::network::mojom::DohResolutionDetailsPtr* output) { output->reset(); }

  static decltype(::network::mojom::DohResolutionDetails::session_source) session_source(
      const ::network::mojom::DohResolutionDetailsPtr& input) {
    return input->session_source;
  }

  static decltype(::network::mojom::DohResolutionDetails::connection_info) connection_info(
      const ::network::mojom::DohResolutionDetailsPtr& input) {
    return input->connection_info;
  }

  static bool Read(::network::mojom::DohResolutionDetails::DataView input, ::network::mojom::DohResolutionDetailsPtr* output);
};


template <>
struct  StructTraits<::network::mojom::ResolutionDetails::DataView,
                                         ::network::mojom::ResolutionDetailsPtr> {
  static bool IsNull(const ::network::mojom::ResolutionDetailsPtr& input) { return !input; }
  static void SetToNull(::network::mojom::ResolutionDetailsPtr* output) { output->reset(); }

  static decltype(::network::mojom::ResolutionDetails::source) source(
      const ::network::mojom::ResolutionDetailsPtr& input) {
    return input->source;
  }

  static const decltype(::network::mojom::ResolutionDetails::task_completion_delay)& task_completion_delay(
      const ::network::mojom::ResolutionDetailsPtr& input) {
    return input->task_completion_delay;
  }

  static decltype(::network::mojom::ResolutionDetails::secure_dns_attempted) secure_dns_attempted(
      const ::network::mojom::ResolutionDetailsPtr& input) {
    return input->secure_dns_attempted;
  }

  static const decltype(::network::mojom::ResolutionDetails::doh_details)& doh_details(
      const ::network::mojom::ResolutionDetailsPtr& input) {
    return input->doh_details;
  }

  static bool Read(::network::mojom::ResolutionDetails::DataView input, ::network::mojom::ResolutionDetailsPtr* output);
};


template <>
struct  StructTraits<::network::mojom::LoadTimingInternalInfo::DataView,
                                         ::network::mojom::LoadTimingInternalInfoPtr> {
  static bool IsNull(const ::network::mojom::LoadTimingInternalInfoPtr& input) { return !input; }
  static void SetToNull(::network::mojom::LoadTimingInternalInfoPtr* output) { output->reset(); }

  static const decltype(::network::mojom::LoadTimingInternalInfo::max_stream_limit_pending_delay)& max_stream_limit_pending_delay(
      const ::network::mojom::LoadTimingInternalInfoPtr& input) {
    return input->max_stream_limit_pending_delay;
  }

  static const decltype(::network::mojom::LoadTimingInternalInfo::create_stream_delay)& create_stream_delay(
      const ::network::mojom::LoadTimingInternalInfoPtr& input) {
    return input->create_stream_delay;
  }

  static const decltype(::network::mojom::LoadTimingInternalInfo::connected_callback_delay)& connected_callback_delay(
      const ::network::mojom::LoadTimingInternalInfoPtr& input) {
    return input->connected_callback_delay;
  }

  static decltype(::network::mojom::LoadTimingInternalInfo::accept_ch_frame_received) accept_ch_frame_received(
      const ::network::mojom::LoadTimingInternalInfoPtr& input) {
    return input->accept_ch_frame_received;
  }

  static const decltype(::network::mojom::LoadTimingInternalInfo::initialize_stream_delay)& initialize_stream_delay(
      const ::network::mojom::LoadTimingInternalInfoPtr& input) {
    return input->initialize_stream_delay;
  }

  static decltype(::network::mojom::LoadTimingInternalInfo::session_source) session_source(
      const ::network::mojom::LoadTimingInternalInfoPtr& input) {
    return input->session_source;
  }

  static decltype(::network::mojom::LoadTimingInternalInfo::advertised_alt_svc_state) advertised_alt_svc_state(
      const ::network::mojom::LoadTimingInternalInfoPtr& input) {
    return input->advertised_alt_svc_state;
  }

  static decltype(::network::mojom::LoadTimingInternalInfo::http_network_session_quic_enabled) http_network_session_quic_enabled(
      const ::network::mojom::LoadTimingInternalInfoPtr& input) {
    return input->http_network_session_quic_enabled;
  }

  static const decltype(::network::mojom::LoadTimingInternalInfo::resolution_details)& resolution_details(
      const ::network::mojom::LoadTimingInternalInfoPtr& input) {
    return input->resolution_details;
  }

  static bool Read(::network::mojom::LoadTimingInternalInfo::DataView input, ::network::mojom::LoadTimingInternalInfoPtr* output);
};

}  // namespace mojo

#endif  // SERVICES_NETWORK_PUBLIC_MOJOM_LOAD_TIMING_INTERNAL_INFO_MOJOM_H_