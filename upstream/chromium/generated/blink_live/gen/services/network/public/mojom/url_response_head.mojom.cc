...
URLResponseHead::URLResponseHead()
    : request_time(),
      ...
      device_bound_session_usage(::network::mojom::DeviceBoundSessionUsage::kUnknown),
...
URLResponseHead::URLResponseHead(
    ...
    ::network::mojom::LoadTimingInternalInfoPtr load_timing_internal_info_in,
    ...
    std::optional<::network::mojom::ServiceWorkerStatus> initial_service_worker_status_in,
    ...
    std::vector<::network::mojom::ParsedRequestCookiePtr> request_cookies_in,
    ...
    std::vector<::network::mojom::SourceType> client_side_content_decoding_types_in,
    ::network::mojom::DeviceBoundSessionUsage device_bound_session_usage_in,
    bool from_synthetic_response_in,
    bool bypass_redirect_checks_in,
    ::network::mojom::UnencodedDigestsPtr unencoded_digests_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::network::mojom::LoadTimingInternalInfoPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<::network::mojom::ParsedRequestCookiePtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::network::mojom::DeviceBoundSessionUsage>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::network::mojom::UnencodedDigestsPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
