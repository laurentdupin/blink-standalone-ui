...
void URLLoaderProxy::FollowRedirect(
    ::network::mojom::HttpRequestHeadersUpdateParamsPtr in_headers_update_params, const std::optional<::GURL>& in_new_url) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("headers_update_params"), in_headers_update_params,
                        "<value of type ::network::mojom::HttpRequestHeadersUpdateParamsPtr>");
      perfetto::WriteIntoTracedValueWithFallback(
...
void URLLoaderProxy::SetPriority(
    ::network::mojom::RequestPriority in_priority, int32_t in_intra_priority_value) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool URLLoaderStubDispatch::Accept(
  ...
  switch (static_cast<messages::URLLoader>(message->header()->name)) {
    case messages::URLLoader::kFollowRedirect: {
      ...
      bool success = true;
      ::network::mojom::HttpRequestHeadersUpdateParamsPtr p_headers_update_params{};
      std::optional<::GURL> p_new_url{};
    ...
    case messages::URLLoader::kSetPriority: {
      ...
      bool success = true;
      ::network::mojom::RequestPriority p_priority{};
...
void URLLoaderClientProxy::OnReceiveResponse(
    ::network::mojom::URLResponseHeadPtr in_head, ::mojo::ScopedDataPipeConsumerHandle in_body, std::optional<::mojo_base::BigBuffer> in_cached_metadata) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool URLLoaderClientRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::URLLoaderClient::Name_,
...
void URLLoaderInterceptorForTesting::FollowRedirect(::network::mojom::HttpRequestHeadersUpdateParamsPtr headers_update_params, const std::optional<::GURL>& new_url) {
...
void URLLoaderInterceptorForTesting::SetPriority(::network::mojom::RequestPriority priority, int32_t intra_priority_value) {
...
void URLLoaderClientInterceptorForTesting::OnReceiveResponse(::network::mojom::URLResponseHeadPtr head, ::mojo::ScopedDataPipeConsumerHandle body, std::optional<::mojo_base::BigBuffer> cached_metadata) {
