...
class BLINK_PLATFORM_EXPORT AcceptCHFrameObserverInterceptorForTesting : public AcceptCHFrameObserver {
  ...
  void OnAcceptCHFrameReceived(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, const ::blink::Vector<::network::mojom::blink::WebClientHintsType>& accept_ch_frame, OnAcceptCHFrameReceivedCallback callback) override;
...
class BLINK_PLATFORM_EXPORT AcceptCHFrameObserverAsyncWaiter {
 public:
  ...
  int32_t OnAcceptCHFrameReceived(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, const ::blink::Vector<::network::mojom::blink::WebClientHintsType>& accept_ch_frame);
