...
static_assert(sizeof(HostResolverHost_Data) == mojo::internal::kUnionDataSize,
              "Bad sizeof(HostResolverHost_Data)");
class  DnsOverHttpsServerConfig_Data {
 public:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
...
static_assert(sizeof(DnsConfigOverrides_Data) == 80,
...
static_assert(sizeof(ResolveHostParameters_Data) == 48,
