...
SharedDictionaryAccessDetails::SharedDictionaryAccessDetails(
    ...
    const ::GURL& url_in,
    ::network::mojom::SharedDictionaryIsolationKeyPtr isolation_key_in,
    bool is_blocked_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::network::mojom::SharedDictionaryIsolationKeyPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
uint32_t SharedDictionaryAccessObserver::OnSharedDictionaryAccessed_Sym::IPCStableHash() {
  ...
  static constexpr uint32_t kHash = 0x988cc7c0;  // IPCStableHash for network::mojom::SharedDictionaryAccessObserver::OnSharedDictionaryAccessed
...
uint32_t SharedDictionaryAccessObserver::Clone_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x0928f4d2;  // IPCStableHash for network::mojom::SharedDictionaryAccessObserver::Clone
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void SharedDictionaryAccessObserverProxy::OnSharedDictionaryAccessed(
  ...
  mojo::Message message(
      std::to_underlying(messages::SharedDictionaryAccessObserver::kOnSharedDictionaryAccessed), kFlags, estimated_payload_size);
...
void SharedDictionaryAccessObserverProxy::Clone(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::SharedDictionaryAccessObserver::kClone), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool SharedDictionaryAccessObserverRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::SharedDictionaryAccessObserver::Name_,
    kSharedDictionaryAccessObserverValidationInfo);
}
...
bool StructTraits<::network::mojom::SharedDictionaryAccessDetails::DataView, ::network::mojom::SharedDictionaryAccessDetailsPtr>::Read(
    ::network::mojom::SharedDictionaryAccessDetails::DataView input,
    ::network::mojom::SharedDictionaryAccessDetailsPtr* output) {
  bool success = true;
