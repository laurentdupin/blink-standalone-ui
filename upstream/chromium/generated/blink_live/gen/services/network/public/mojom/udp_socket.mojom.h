...
// with not having this data in traces there.
  ...
  using BindCallback = base::OnceCallback<void(int32_t, ::network::mojom::IPEndPointPtr)>;
  using BindMojoCallback = base::OnceCallback<void(int32_t, ::network::mojom::IPEndPointPtr)>;

  virtual void Bind(::network::mojom::IPEndPointPtr local_addr, UDPSocketOptionsPtr socket_options, BindCallback callback) = 0;

  using ConnectCallback = base::OnceCallback<void(int32_t, ::network::mojom::IPEndPointPtr)>;
  using ConnectMojoCallback = base::OnceCallback<void(int32_t, ::network::mojom::IPEndPointPtr)>;

  virtual void Connect(::network::mojom::IPEndPointPtr remote_addr, UDPSocketOptionsPtr socket_options, ConnectCallback callback) = 0;
  ...
  virtual void JoinGroup(::network::mojom::IPAddressPtr group_address, ::network::mojom::IPAddressPtr source_address, JoinGroupCallback callback) = 0;

  using LeaveGroupCallback = base::OnceCallback<void(int32_t)>;
  using LeaveGroupMojoCallback = base::OnceCallback<void(int32_t)>;

  virtual void LeaveGroup(::network::mojom::IPAddressPtr group_address, ::network::mojom::IPAddressPtr source_address, LeaveGroupCallback callback) = 0;
  ...
  virtual void SendTo(::network::mojom::IPEndPointPtr dest_addr, ::mojo_base::mojom::ReadOnlyBufferPtr data, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, SendToCallback callback) = 0;

  using SendCallback = base::OnceCallback<void(int32_t)>;
  using SendMojoCallback = base::OnceCallback<void(int32_t)>;

  virtual void Send(::mojo_base::mojom::ReadOnlyBufferPtr data, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, SendCallback callback) = 0;
...
// with not having this data in traces there.
  ...
  virtual void OnReceived(int32_t result, ::network::mojom::IPEndPointPtr src_addr, ::mojo_base::mojom::ReadOnlyBufferPtr data) = 0;
};
...
class  UDPSocketProxy
 ...
 public:
  ...
  void Bind(::network::mojom::IPEndPointPtr local_addr, UDPSocketOptionsPtr socket_options, BindCallback callback) final;
  
  void Connect(::network::mojom::IPEndPointPtr remote_addr, UDPSocketOptionsPtr socket_options, ConnectCallback callback) final;
  ...
  void JoinGroup(::network::mojom::IPAddressPtr group_address, ::network::mojom::IPAddressPtr source_address, JoinGroupCallback callback) final;
  
  void LeaveGroup(::network::mojom::IPAddressPtr group_address, ::network::mojom::IPAddressPtr source_address, LeaveGroupCallback callback) final;
  ...
  void SendTo(::network::mojom::IPEndPointPtr dest_addr, ::mojo_base::mojom::ReadOnlyBufferPtr data, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, SendToCallback callback) final;
  
  void Send(::mojo_base::mojom::ReadOnlyBufferPtr data, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, SendCallback callback) final;
...
class  UDPSocketListenerProxy
 ...
 public:
  ...
  void OnReceived(int32_t result, ::network::mojom::IPEndPointPtr src_addr, ::mojo_base::mojom::ReadOnlyBufferPtr data) final;
 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        UDPSocketOptions::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
struct  StructTraits<::network::mojom::UDPSocketOptions::DataView,
  ...
  static decltype(::network::mojom::UDPSocketOptions::ipv6_only) ipv6_only(
      const ::network::mojom::UDPSocketOptionsPtr& input) {
