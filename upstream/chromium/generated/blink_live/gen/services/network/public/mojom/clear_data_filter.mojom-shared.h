...
#include "services/network/public/mojom/clear_data_filter.mojom-data-view.h"  // IWYU pragma: export
...
struct Serializer<::network::mojom::ClearDataFilter_Type, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::network::mojom::ClearDataFilter_Type>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::network::mojom::ClearDataFilter_Type, UserType> ||
                        HasInfallibleConversion(::network::mojom::ClearDataFilter_Type()),
                    "::network::mojom::ClearDataFilter_Type does not have an infallible conversion, "
