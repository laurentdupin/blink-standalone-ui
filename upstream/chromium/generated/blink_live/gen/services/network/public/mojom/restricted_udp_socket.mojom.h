...
// with not having this data in traces there.
  ...
  virtual void Send(::mojo_base::mojom::ReadOnlyBufferPtr data, SendCallback callback) = 0;

  using SendToCallback = base::OnceCallback<void(int32_t)>;
  using SendToMojoCallback = base::OnceCallback<void(int32_t)>;

  virtual void SendTo(::mojo_base::mojom::ReadOnlyBufferPtr data, ::network::mojom::HostPortPairPtr dest_addr, ::network::mojom::DnsQueryType dns_query_type, SendToCallback callback) = 0;
};
...
class  RestrictedUDPSocketProxy
 ...
 public:
  ...
  void Send(::mojo_base::mojom::ReadOnlyBufferPtr data, SendCallback callback) final;
  
  void SendTo(::mojo_base::mojom::ReadOnlyBufferPtr data, ::network::mojom::HostPortPairPtr dest_addr, ::network::mojom::DnsQueryType dns_query_type, SendToCallback callback) final;
...
RestrictedUDPSocketParams& operator=(const RestrictedUDPSocketParams&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        RestrictedUDPSocketParams::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        RestrictedUDPSocketParams::DataView, std::vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::network::mojom::RestrictedUDPSocketParams::DataView,
                                         ::network::mojom::RestrictedUDPSocketParamsPtr> {
  static bool IsNull(const ::network::mojom::RestrictedUDPSocketParamsPtr& input) { return !input; }
  static void SetToNull(::network::mojom::RestrictedUDPSocketParamsPtr* output) { output->reset(); }
