...
uint32_t UDPSocket::Bind_Sym::IPCStableHash() {
  ...
  static constexpr uint32_t kHash = 0xb4d4a7fb;  // IPCStableHash for network::mojom::UDPSocket::Bind
...
uint32_t UDPSocket::Connect_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xf7940241;  // IPCStableHash for network::mojom::UDPSocket::Connect
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t UDPSocket::SetBroadcast_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xb9ba2d91;  // IPCStableHash for network::mojom::UDPSocket::SetBroadcast
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t UDPSocket::SetSendBufferSize_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x8fe50abd;  // IPCStableHash for network::mojom::UDPSocket::SetSendBufferSize
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t UDPSocket::SetReceiveBufferSize_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x1f9d97b0;  // IPCStableHash for network::mojom::UDPSocket::SetReceiveBufferSize
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t UDPSocket::JoinGroup_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x04844b86;  // IPCStableHash for network::mojom::UDPSocket::JoinGroup
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t UDPSocket::LeaveGroup_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xe802a7c8;  // IPCStableHash for network::mojom::UDPSocket::LeaveGroup
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t UDPSocket::ReceiveMore_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xb5709139;  // IPCStableHash for network::mojom::UDPSocket::ReceiveMore
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t UDPSocket::ReceiveMoreWithBufferSize_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xad52a5e6;  // IPCStableHash for network::mojom::UDPSocket::ReceiveMoreWithBufferSize
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t UDPSocket::SendTo_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x365d6264;  // IPCStableHash for network::mojom::UDPSocket::SendTo
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t UDPSocket::Send_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xac0252b6;  // IPCStableHash for network::mojom::UDPSocket::Send
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t UDPSocket::Close_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xe3aa1bc6;  // IPCStableHash for network::mojom::UDPSocket::Close
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void UDPSocketProxy::Bind(
    ::network::mojom::IPEndPointPtr in_local_addr, UDPSocketOptionsPtr in_socket_options, BindCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  mojo::Message message(
      std::to_underlying(messages::UDPSocket::kBind), kFlags, estimated_payload_size);
...
void UDPSocketProxy::Connect(
    ::network::mojom::IPEndPointPtr in_remote_addr, UDPSocketOptionsPtr in_socket_options, ConnectCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::UDPSocket::kConnect), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void UDPSocketProxy::SetBroadcast(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::UDPSocket::kSetBroadcast), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void UDPSocketProxy::SetSendBufferSize(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::UDPSocket::kSetSendBufferSize), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void UDPSocketProxy::SetReceiveBufferSize(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::UDPSocket::kSetReceiveBufferSize), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void UDPSocketProxy::JoinGroup(
    ::network::mojom::IPAddressPtr in_group_address, ::network::mojom::IPAddressPtr in_source_address, JoinGroupCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("group_address"), in_group_address,
                        "<value of type ::network::mojom::IPAddressPtr>");
      perfetto::WriteIntoTracedValueWithFallback(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::UDPSocket::kJoinGroup), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void UDPSocketProxy::LeaveGroup(
    ::network::mojom::IPAddressPtr in_group_address, ::network::mojom::IPAddressPtr in_source_address, LeaveGroupCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::UDPSocket::kLeaveGroup), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void UDPSocketProxy::ReceiveMore(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::UDPSocket::kReceiveMore), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void UDPSocketProxy::ReceiveMoreWithBufferSize(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::UDPSocket::kReceiveMoreWithBufferSize), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void UDPSocketProxy::SendTo(
    ::network::mojom::IPEndPointPtr in_dest_addr, ::mojo_base::mojom::ReadOnlyBufferPtr in_data, const ::net::MutableNetworkTrafficAnnotationTag& in_traffic_annotation, SendToCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("data"), in_data,
                        "<value of type ::mojo_base::mojom::ReadOnlyBufferPtr>");
      perfetto::WriteIntoTracedValueWithFallback(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::UDPSocket::kSendTo), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void UDPSocketProxy::Send(
    ::mojo_base::mojom::ReadOnlyBufferPtr in_data, const ::net::MutableNetworkTrafficAnnotationTag& in_traffic_annotation, SendCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::UDPSocket::kSend), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void UDPSocketProxy::Close(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::UDPSocket::kClose), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
class UDPSocket_Bind_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      int32_t in_result, ::network::mojom::IPEndPointPtr in_local_addr_out);
};
...
bool UDPSocket_Bind_ForwardToCallback::Accept(
  ...
  bool success = true;
  int32_t p_result{};
  ::network::mojom::IPEndPointPtr p_local_addr_out{};
...
bool UDPSocketStubDispatch::AcceptWithResponder(
  ...
  switch (static_cast<messages::UDPSocket>(message->header()->name)) {
    case messages::UDPSocket::kBind: {
      ...
      // Validation for UDPSocket.0
      bool success = true;
      ::network::mojom::IPEndPointPtr p_local_addr{};
    ...
    case messages::UDPSocket::kConnect: {
      ...
      // Validation for UDPSocket.1
      bool success = true;
      ::network::mojom::IPEndPointPtr p_remote_addr{};
      UDPSocketOptionsPtr p_socket_options{};
    ...
    case messages::UDPSocket::kJoinGroup: {
      ...
      // Validation for UDPSocket.5
      bool success = true;
      ::network::mojom::IPAddressPtr p_group_address{};
      ::network::mojom::IPAddressPtr p_source_address{};
    ...
    case messages::UDPSocket::kSendTo: {
      ...
      // Validation for UDPSocket.9
      bool success = true;
      ::network::mojom::IPEndPointPtr p_dest_addr{};
      ::mojo_base::mojom::ReadOnlyBufferPtr p_data{};
...
bool UDPSocketRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::UDPSocket::Name_,
    kUDPSocketValidationInfo);
}
...
uint32_t UDPSocketListener::OnReceived_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x7c34215f;  // IPCStableHash for network::mojom::UDPSocketListener::OnReceived
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void UDPSocketListenerProxy::OnReceived(
    int32_t in_result, ::network::mojom::IPEndPointPtr in_src_addr, ::mojo_base::mojom::ReadOnlyBufferPtr in_data) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::UDPSocketListener::kOnReceived), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool UDPSocketListenerStubDispatch::Accept(
  ...
  switch (static_cast<messages::UDPSocketListener>(message->header()->name)) {
    case messages::UDPSocketListener::kOnReceived: {
      ...
      bool success = true;
      int32_t p_result{};
      ::network::mojom::IPEndPointPtr p_src_addr{};
      ::mojo_base::mojom::ReadOnlyBufferPtr p_data{};
...
bool UDPSocketListenerRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::UDPSocketListener::Name_,
    kUDPSocketListenerValidationInfo);
}
...
void UDPSocketInterceptorForTesting::Bind(::network::mojom::IPEndPointPtr local_addr, UDPSocketOptionsPtr socket_options, BindCallback callback) {
...
void UDPSocketInterceptorForTesting::Connect(::network::mojom::IPEndPointPtr remote_addr, UDPSocketOptionsPtr socket_options, ConnectCallback callback) {
...
void UDPSocketInterceptorForTesting::JoinGroup(::network::mojom::IPAddressPtr group_address, ::network::mojom::IPAddressPtr source_address, JoinGroupCallback callback) {
...
void UDPSocketInterceptorForTesting::LeaveGroup(::network::mojom::IPAddressPtr group_address, ::network::mojom::IPAddressPtr source_address, LeaveGroupCallback callback) {
...
void UDPSocketInterceptorForTesting::SendTo(::network::mojom::IPEndPointPtr dest_addr, ::mojo_base::mojom::ReadOnlyBufferPtr data, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, SendToCallback callback) {
...
void UDPSocketInterceptorForTesting::Send(::mojo_base::mojom::ReadOnlyBufferPtr data, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, SendCallback callback) {
...
,
             int32_t result,
             ::network::mojom::IPEndPointPtr local_addr_out) {*out_result = std::move(result);*out_local_addr_out = std::move(local_addr_out);
            loop->Quit();
          },
          &loop,
          out_result,
...
int32_t UDPSocketAsyncWaiter::JoinGroup(
    ::network::mojom::IPAddressPtr group_address, ::network::mojom::IPAddressPtr source_address) {
  int32_t async_wait_result;
...
int32_t UDPSocketAsyncWaiter::SendTo(
    ::network::mojom::IPEndPointPtr dest_addr, ::mojo_base::mojom::ReadOnlyBufferPtr data, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation) {
  int32_t async_wait_result;
...
int32_t UDPSocketAsyncWaiter::Send(
    ::mojo_base::mojom::ReadOnlyBufferPtr data, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation) {
  int32_t async_wait_result;
...
void UDPSocketListenerInterceptorForTesting::OnReceived(int32_t result, ::network::mojom::IPEndPointPtr src_addr, ::mojo_base::mojom::ReadOnlyBufferPtr data) {
