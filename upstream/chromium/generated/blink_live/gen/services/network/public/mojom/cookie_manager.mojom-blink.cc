...
CookieManagerParams::CookieManagerParams(
    ...
    ::blink::Vector<::scoped_refptr<const ::blink::SecurityOrigin>> secure_origin_cookies_allowed_origins_in,
...
size_t CookieInclusionStatus::Hash(size_t seed) const {
  ...
  seed = mojo::internal::WTFHash(seed, this->exemption_reason);
  return seed;
}
...
size_t CookieAccessResult::Hash(size_t seed) const {
  ...
  seed = mojo::internal::WTFHash(seed, this->scope_semantics);
...
void CookieManagerProxy::SetCanonicalCookie(
    CanonicalCookiePtr in_cookie, const ::blink::KURL& in_source_url, CookieOptionsPtr in_cookie_options, SetCanonicalCookieCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
class CookieManager_GetAllCookies_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::blink::Vector<CanonicalCookiePtr> in_cookies);
};
...
bool CookieManager_GetAllCookies_ForwardToCallback::Accept(
  ...
  bool success = true;
  ::blink::Vector<CanonicalCookiePtr> p_cookies{};
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("cookies"), in_cookies,
                        "<value of type ::blink::Vector<CanonicalCookiePtr>>");
   });
#endif
...
class CookieManager_GetAllCookiesWithAccessSemantics_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::blink::Vector<CanonicalCookiePtr> in_cookies, const ::blink::Vector<CookieAccessSemantics>& in_access_semantics_list);
};
...
bool UnionTraits<::network::mojom::blink::CookieOrLine::DataView, ::network::mojom::blink::CookieOrLinePtr>::Read(
  ...
  switch (input.tag()) {
    case Tag::kCookie: {
      ::network::mojom::blink::CanonicalCookiePtr result_cookie{};
...
void CookieManagerInterceptorForTesting::SetCanonicalCookie(CanonicalCookiePtr cookie, const ::blink::KURL& source_url, CookieOptionsPtr cookie_options, SetCanonicalCookieCallback callback) {
...
void CookieManagerAsyncWaiter::GetAllCookies(
    ::blink::Vector<CanonicalCookiePtr>* out_cookies) {
  base::RunLoop loop;
  proxy_->GetAllCookies(
      base::BindOnce(
          [](base::RunLoop* loop,
             ::blink::Vector<CanonicalCookiePtr>* out_cookies
,
             ::blink::Vector<CanonicalCookiePtr> cookies) {*out_cookies = std::move(cookies);
            loop->Quit();
          },
          &loop,
          out_cookies));
...
::blink::Vector<CanonicalCookiePtr> CookieManagerAsyncWaiter::GetAllCookies(
    ) {
  ::blink::Vector<CanonicalCookiePtr> async_wait_result;
  GetAllCookies(&async_wait_result);
  return async_wait_result;
}

void CookieManagerAsyncWaiter::GetAllCookiesWithAccessSemantics(
    ::blink::Vector<CanonicalCookiePtr>* out_cookies, ::blink::Vector<CookieAccessSemantics>* out_access_semantics_list) {
  base::RunLoop loop;
...
,
             ::blink::Vector<CanonicalCookiePtr> cookies,
...
void CookieManagerAsyncWaiter::SetCanonicalCookie(
    CanonicalCookiePtr cookie, const ::blink::KURL& source_url, CookieOptionsPtr cookie_options, CookieAccessResultPtr* out_access_result) {
  base::RunLoop loop;
...
CookieAccessResultPtr CookieManagerAsyncWaiter::SetCanonicalCookie(
    CanonicalCookiePtr cookie, const ::blink::KURL& source_url, CookieOptionsPtr cookie_options) {
