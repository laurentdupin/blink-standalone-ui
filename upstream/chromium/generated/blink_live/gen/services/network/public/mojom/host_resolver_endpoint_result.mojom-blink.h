...
class  HostResolverEndpointResult {
 public:
  ...
  HostResolverEndpointResult(
      ::blink::Vector<::network::mojom::blink::IPEndPointPtr> ip_endpoints,
...
HostResolverEndpointResult& operator=(const HostResolverEndpointResult&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        HostResolverEndpointResult::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        HostResolverEndpointResult::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::network::mojom::blink::HostResolverEndpointResult::DataView,
                                         ::network::mojom::blink::HostResolverEndpointResultPtr> {
  static bool IsNull(const ::network::mojom::blink::HostResolverEndpointResultPtr& input) { return !input; }
  static void SetToNull(::network::mojom::blink::HostResolverEndpointResultPtr* output) { output->reset(); }
