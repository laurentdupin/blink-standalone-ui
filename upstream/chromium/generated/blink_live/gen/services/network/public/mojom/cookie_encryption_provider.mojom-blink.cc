// services/network/public/mojom/cookie_encryption_provider.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "services/network/public/mojom/cookie_encryption_provider.mojom-blink-test-utils.h"
...
uint32_t CookieEncryptionProvider::GetEncryptor_Sym::IPCStableHash() {
  ...
  static constexpr uint32_t kHash = 0x090a75d1;  // IPCStableHash for network::mojom::CookieEncryptionProvider::GetEncryptor
...
void CookieEncryptionProviderProxy::GetEncryptor(
  ...
  mojo::Message message(
      std::to_underlying(messages::CookieEncryptionProvider::kGetEncryptor), kFlags, estimated_payload_size);
...
bool CookieEncryptionProviderRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::blink::CookieEncryptionProvider::Name_,
    kCookieEncryptionProviderValidationInfo);
}
...
::os_crypt_async::mojom::blink::EncryptorPtr CookieEncryptionProviderAsyncWaiter::GetEncryptor(
    ) {
