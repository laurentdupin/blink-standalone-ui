// services/network/public/mojom/permissions_policy/permissions_policy_feature.mojom-shared.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "services/network/public/mojom/permissions_policy/permissions_policy_feature.mojom-params-data.h"
namespace network {
namespace mojom {
...
NOINLINE static const char* PermissionsPolicyFeatureToStringHelper(PermissionsPolicyFeature value) {
  ...
  switch(value) {
    ...
    case PermissionsPolicyFeature::kAutofill:
      return "kAutofill";
    ...
    case PermissionsPolicyFeature::kDeferredFetchMinimal:
      return "kDeferredFetchMinimal";
    case PermissionsPolicyFeature::kClientHintUAHighEntropyValues:
      return "kClientHintUAHighEntropyValues";
    case PermissionsPolicyFeature::kSummarizer:
      return "kSummarizer";
    case PermissionsPolicyFeature::kWriter:
      return "kWriter";
    case PermissionsPolicyFeature::kRewriter:
      return "kRewriter";
    case PermissionsPolicyFeature::kTranslator:
      return "kTranslator";
    case PermissionsPolicyFeature::kLanguageDetector:
      return "kLanguageDetector";
    case PermissionsPolicyFeature::kDeviceAttributes:
      return "kDeviceAttributes";
    case PermissionsPolicyFeature::kLocalNetworkAccess:
      return "kLocalNetworkAccess";
    case PermissionsPolicyFeature::kRecordAdAuctionEvents:
      return "kRecordAdAuctionEvents";
    case PermissionsPolicyFeature::kOnDeviceSpeechRecognition:
      return "kOnDeviceSpeechRecognition";
    case PermissionsPolicyFeature::kLanguageModel:
      return "kLanguageModel";
    case PermissionsPolicyFeature::kAriaNotify:
      return "kAriaNotify";
    case PermissionsPolicyFeature::kDigitalCredentialsCreate:
      return "kDigitalCredentialsCreate";
    case PermissionsPolicyFeature::kMulticastInDirectSockets:
      return "kMulticastInDirectSockets";
    case PermissionsPolicyFeature::kManualText:
      return "kManualText";
    case PermissionsPolicyFeature::kLocalNetwork:
      return "kLocalNetwork";
    case PermissionsPolicyFeature::kLoopbackNetwork:
      return "kLoopbackNetwork";
    case PermissionsPolicyFeature::kTools:
      return "kTools";
    case PermissionsPolicyFeature::kWebNN:
      return "kWebNN";
    default:
      return nullptr;
  }
...
// static
void TraceFormatTraits<::network::mojom::PermissionsPolicyFeature>::WriteIntoTrace(
   perfetto::TracedValue context, ::network::mojom::PermissionsPolicyFeature value) {
  return std::move(context).WriteString(::network::mojom::PermissionsPolicyFeatureToString(value));
}
