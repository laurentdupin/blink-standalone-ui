...
#include "services/network/public/mojom/cross_origin_opener_policy.mojom-forward.h"  // IWYU pragma: export
 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CrossOriginOpenerPolicy::DataView, std::vector<uint8_t>, send_validation>(input);
  }
