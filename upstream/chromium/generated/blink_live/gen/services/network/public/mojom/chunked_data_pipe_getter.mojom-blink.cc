// services/network/public/mojom/chunked_data_pipe_getter.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
uint32_t ChunkedDataPipeGetter::GetSize_Sym::IPCStableHash() {
  ...
  static constexpr uint32_t kHash = 0x32b47b21;  // IPCStableHash for network::mojom::ChunkedDataPipeGetter::GetSize
...
uint32_t ChunkedDataPipeGetter::StartReading_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x485e7b28;  // IPCStableHash for network::mojom::ChunkedDataPipeGetter::StartReading
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void ChunkedDataPipeGetterProxy::GetSize(
  ...
  mojo::Message message(
      std::to_underlying(messages::ChunkedDataPipeGetter::kGetSize), kFlags, estimated_payload_size);
...
void ChunkedDataPipeGetterProxy::StartReading(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::ChunkedDataPipeGetter::kStartReading), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
static const mojo::internal::GenericValidationInfo kChunkedDataPipeGetterValidationInfo[] = {
...
bool ChunkedDataPipeGetterRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::blink::ChunkedDataPipeGetter::Name_,
    kChunkedDataPipeGetterValidationInfo);
}
