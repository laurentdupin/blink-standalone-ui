// services/network/public/mojom/network_quality_estimator_manager.mojom-test-utils.h is auto generated by mojom_bindings_generator.py, do not edit
...
class  NetworkQualityEstimatorManagerClientInterceptorForTesting : public NetworkQualityEstimatorManagerClient {
  ...
  void OnNetworkQualityChanged(::network::mojom::EffectiveConnectionType type, ::base::TimeDelta http_rtt, ::base::TimeDelta transport_rtt, int32_t downlink_bandwidth_kbps) override;
};
