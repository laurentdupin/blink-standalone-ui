...
class  URLLoader_FollowRedirect_Params_Data {
 public:
  ...
  mojo::internal::Pointer<::network::mojom::internal::HttpRequestHeadersUpdateParams_Data> headers_update_params;
...
static_assert(sizeof(URLLoader_FollowRedirect_Params_Data) == 24,
...
class URLLoader_FollowRedirect_ParamsDataView {
 public:
  ...
  inline void GetHeadersUpdateParamsDataView(
      ::network::mojom::HttpRequestHeadersUpdateParamsDataView* output);

  template <typename UserType>
  [[nodiscard]] bool ReadHeadersUpdateParams(UserType* output) {
    
    auto* pointer = data_->headers_update_params.Get();
    return mojo::internal::Deserialize<::network::mojom::HttpRequestHeadersUpdateParamsDataView>(
...
inline void URLLoader_FollowRedirect_ParamsDataView::GetHeadersUpdateParamsDataView(
    ::network::mojom::HttpRequestHeadersUpdateParamsDataView* output) {
  auto pointer = data_->headers_update_params.Get();
  *output = ::network::mojom::HttpRequestHeadersUpdateParamsDataView(pointer, message_);
}
