...
class  ParsedHeaders {
 public:
  ...
  ParsedHeaders(
      ...
      ::network::mojom::ConnectionAllowlistsPtr connection_allowlists,
      ::network::mojom::CrossOriginEmbedderPolicyPtr cross_origin_embedder_policy,
      ::network::mojom::CrossOriginOpenerPolicyPtr cross_origin_opener_policy,
      ::network::mojom::DocumentIsolationPolicyPtr document_isolation_policy,
      ::network::mojom::IntegrityPolicyPtr integrity_policy,
      ::network::mojom::IntegrityPolicyPtr integrity_policy_report_only,
      ...
      ::network::mojom::DeclarativePerformanceObserverPolicyPtr declarative_performance_observer_policy,
      const std::optional<::GURL>& prefetch_activation_beacon_endpoint);
...
ParsedHeaders& operator=(const ParsedHeaders&) = delete;
  ...
  std::optional<::GURL> prefetch_activation_beacon_endpoint;
...
struct  StructTraits<::network::mojom::ParsedHeaders::DataView,
  ...
  static const decltype(::network::mojom::ParsedHeaders::declarative_performance_observer_policy)& declarative_performance_observer_policy(
      const ::network::mojom::ParsedHeadersPtr& input) {
    return input->declarative_performance_observer_policy;
  }

  static const decltype(::network::mojom::ParsedHeaders::prefetch_activation_beacon_endpoint)& prefetch_activation_beacon_endpoint(
      const ::network::mojom::ParsedHeadersPtr& input) {
