...
NOINLINE static const char* CrossOriginEmbedderPolicyValueToStringHelper(CrossOriginEmbedderPolicyValue value) {
...
bool CrossOriginEmbedderPolicy_Data::Validate(
  ...
  [[maybe_unused]] const CrossOriginEmbedderPolicy_Data* object =
      static_cast<const CrossOriginEmbedderPolicy_Data*>(data);
...
bool CrossOriginEmbedderPolicyReporter_QueueCorpViolationReport_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const CrossOriginEmbedderPolicyReporter_QueueCorpViolationReport_Params_Data* object =
      static_cast<const CrossOriginEmbedderPolicyReporter_QueueCorpViolationReport_Params_Data*>(data);
...
bool CrossOriginEmbedderPolicyReporter_Clone_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const CrossOriginEmbedderPolicyReporter_Clone_Params_Data* object =
      static_cast<const CrossOriginEmbedderPolicyReporter_Clone_Params_Data*>(data);
