...
RequestParams::RequestParams(
    ...
    int32_t flags_in,
    ::mojo_base::mojom::blink::ByteStringPtr ocsp_response_in,
    ::mojo_base::mojom::blink::ByteStringPtr sct_list_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::mojo_base::mojom::blink::ByteStringPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
void URLLoaderFactoryConnectorProxy::CreateURLLoaderFactory(
  ...
  mojo::Message message(
      std::to_underlying(messages::URLLoaderFactoryConnector::kCreateURLLoaderFactory), kFlags, estimated_payload_size);
...
bool URLLoaderFactoryConnectorRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::cert_verifier::mojom::blink::URLLoaderFactoryConnector::Name_,
...
void CertVerifierServiceProxy::EnableNetworkAccess(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::CertVerifierService::kEnableNetworkAccess), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void CertVerifierServiceProxy::Verify(
    RequestParamsPtr in_params, ::network::mojom::blink::NetLogSourcePtr in_net_log_source, ::mojo::PendingRemote<CertVerifierRequest> in_cert_verifier_request) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("net_log_source"), in_net_log_source,
                        "<value of type ::network::mojom::blink::NetLogSourcePtr>");
      perfetto::WriteIntoTracedValueWithFallback(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::CertVerifierService::kVerify), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void CertVerifierServiceProxy::Verify2QwacBinding(
    const ::blink::String& in_binding, const ::blink::String& in_hostname, ::network::mojom::blink::X509CertificatePtr in_tls_certificate, ::network::mojom::blink::NetLogSourcePtr in_net_log_source, Verify2QwacBindingCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::CertVerifierService::kVerify2QwacBinding), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void CertVerifierServiceProxy::SetConfig(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::CertVerifierService::kSetConfig), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
class CertVerifierService_Verify2QwacBinding_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::network::mojom::blink::X509CertificatePtr in_verified_cert);
};
...
bool CertVerifierService_Verify2QwacBinding_ForwardToCallback::Accept(
  ...
  bool success = true;
  ::network::mojom::blink::X509CertificatePtr p_verified_cert{};
...
bool CertVerifierServiceStubDispatch::Accept(
  ...
  switch (static_cast<messages::CertVerifierService>(message->header()->name)) {
    ...
    case messages::CertVerifierService::kVerify: {
      ...
      ::network::mojom::blink::NetLogSourcePtr p_net_log_source{};
...
bool CertVerifierServiceStubDispatch::AcceptWithResponder(
  ...
  switch (static_cast<messages::CertVerifierService>(message->header()->name)) {
    ...
    case messages::CertVerifierService::kVerify2QwacBinding: {
      ...
      // Validation for CertVerifierService.2
      bool success = true;
      ::blink::String p_binding{};
      ::blink::String p_hostname{};
      ::network::mojom::blink::X509CertificatePtr p_tls_certificate{};
      ::network::mojom::blink::NetLogSourcePtr p_net_log_source{};
...
bool CertVerifierServiceRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::cert_verifier::mojom::blink::CertVerifierService::Name_,
...
void CertVerifierServiceClientProxy::OnCertVerifierChanged(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::CertVerifierServiceClient::kOnCertVerifierChanged), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool CertVerifierServiceClientRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::cert_verifier::mojom::blink::CertVerifierServiceClient::Name_,
...
void CertVerifierRequestProxy::Complete(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::CertVerifierRequest::kComplete), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool CertVerifierRequestRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::cert_verifier::mojom::blink::CertVerifierRequest::Name_,
...
void CertVerifierServiceInterceptorForTesting::EnableNetworkAccess(::mojo::PendingRemote<::network::mojom::blink::URLLoaderFactory> url_loader_factory, ::mojo::PendingRemote<URLLoaderFactoryConnector> reconnector) {
...
void CertVerifierServiceInterceptorForTesting::Verify(RequestParamsPtr params, ::network::mojom::blink::NetLogSourcePtr net_log_source, ::mojo::PendingRemote<CertVerifierRequest> cert_verifier_request) {
...
void CertVerifierServiceInterceptorForTesting::Verify2QwacBinding(const ::blink::String& binding, const ::blink::String& hostname, ::network::mojom::blink::X509CertificatePtr tls_certificate, ::network::mojom::blink::NetLogSourcePtr net_log_source, Verify2QwacBindingCallback callback) {
...
void CertVerifierServiceAsyncWaiter::Verify2QwacBinding(
    const ::blink::String& binding, const ::blink::String& hostname, ::network::mojom::blink::X509CertificatePtr tls_certificate, ::network::mojom::blink::NetLogSourcePtr net_log_source, ::network::mojom::blink::X509CertificatePtr* out_verified_cert) {
  base::RunLoop loop;
  proxy_->Verify2QwacBinding(
      ...
      base::BindOnce(
          [](base::RunLoop* loop,
             ::network::mojom::blink::X509CertificatePtr* out_verified_cert
,
             ::network::mojom::blink::X509CertificatePtr verified_cert) {*out_verified_cert = std::move(verified_cert);
            loop->Quit();
          },
          &loop,
          out_verified_cert));
...
::network::mojom::blink::X509CertificatePtr CertVerifierServiceAsyncWaiter::Verify2QwacBinding(
    const ::blink::String& binding, const ::blink::String& hostname, ::network::mojom::blink::X509CertificatePtr tls_certificate, ::network::mojom::blink::NetLogSourcePtr net_log_source) {
  ::network::mojom::blink::X509CertificatePtr async_wait_result;
