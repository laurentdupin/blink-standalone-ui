...
URLResponseHead::URLResponseHead()
    : request_time(),
      ...
      did_send_available_dictionary(false),
      did_use_shared_dictionary(false),
      load_with_storage_access(false),
      client_side_content_decoding_types(),
      device_bound_session_usage(::network::mojom::blink::DeviceBoundSessionUsage::kUnknown),
      from_synthetic_response(false),
...
URLResponseHead::URLResponseHead(
    ...
    ::network::mojom::blink::LoadTimingInternalInfoPtr load_timing_internal_info_in,
    ...
    ::blink::Vector<::blink::KURL> url_list_via_service_worker_in,
    ...
    ::blink::Vector<::network::mojom::blink::ParsedRequestCookiePtr> request_cookies_in,
    ::blink::Vector<::blink::String> cors_exposed_header_names_in,
    ...
    bool did_send_available_dictionary_in,
    bool did_use_shared_dictionary_in,
    bool load_with_storage_access_in,
    ::blink::Vector<::network::mojom::blink::SourceType> client_side_content_decoding_types_in,
    ::network::mojom::blink::DeviceBoundSessionUsage device_bound_session_usage_in,
    bool from_synthetic_response_in,
    bool bypass_redirect_checks_in,
    ::network::mojom::blink::UnencodedDigestsPtr unencoded_digests_in,
    bool did_use_server_http_auth_in)
    : request_time(std::move(request_time_in)),
      ...
      load_timing_internal_info(std::move(load_timing_internal_info_in)),
      ...
      did_send_available_dictionary(std::move(did_send_available_dictionary_in)),
      ...
      client_side_content_decoding_types(std::move(client_side_content_decoding_types_in)),
      device_bound_session_usage(std::move(device_bound_session_usage_in)),
      from_synthetic_response(std::move(from_synthetic_response_in)),
      bypass_redirect_checks(std::move(bypass_redirect_checks_in)),
      unencoded_digests(std::move(unencoded_digests_in)),
      did_use_server_http_auth(std::move(did_use_server_http_auth_in)) {}
...
void URLResponseHead::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "load_timing_internal_info"), this->load_timing_internal_info,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::network::mojom::blink::LoadTimingInternalInfoPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<::network::mojom::blink::ParsedRequestCookiePtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "did_send_available_dictionary"), this->did_send_available_dictionary,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type bool>"
#else
      "<value>"
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "client_side_content_decoding_types"), this->client_side_content_decoding_types,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "device_bound_session_usage"), this->device_bound_session_usage,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::network::mojom::blink::DeviceBoundSessionUsage>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "from_synthetic_response"), this->from_synthetic_response,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type bool>"
#else
      "<value>"
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "unencoded_digests"), this->unencoded_digests,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::network::mojom::blink::UnencodedDigestsPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "did_use_server_http_auth"), this->did_use_server_http_auth,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type bool>"
#else
      "<value>"
...
bool StructTraits<::network::mojom::blink::URLResponseHead::DataView, ::network::mojom::blink::URLResponseHeadPtr>::Read(
  ...
  ::network::mojom::blink::URLResponseHeadPtr result(::network::mojom::blink::URLResponseHead::New());
      ...
      if (success && !input.ReadLoadTiming(&result->load_timing))
        success = false;
      if (success && !input.ReadLoadTimingInternalInfo(&result->load_timing_internal_info))
        success = false;
      if (success)
      ...
      if (success)
        result->did_send_available_dictionary = input.did_send_available_dictionary();
      if (success)
      ...
      if (success && !input.ReadClientSideContentDecodingTypes(&result->client_side_content_decoding_types))
        success = false;
      if (success && !input.ReadDeviceBoundSessionUsage(&result->device_bound_session_usage))
        success = false;
      if (success)
        result->from_synthetic_response = input.from_synthetic_response();
      if (success)
        result->bypass_redirect_checks = input.bypass_redirect_checks();
      if (success && !input.ReadUnencodedDigests(&result->unencoded_digests))
        success = false;
      if (success)
        result->did_use_server_http_auth = input.did_use_server_http_auth();
