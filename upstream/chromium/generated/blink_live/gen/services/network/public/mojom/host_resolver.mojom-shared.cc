...
bool ResolveHostClient_OnComplete_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->resolved_addresses, 3, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->alternative_endpoints, 4, validation_context)) {
    return false;
  }
  constexpr const mojo::internal::ContainerValidateParams& alternative_endpoints_validate_params =
      mojo::internal::GetArrayValidator<0, false, nullptr>();
  if (!mojo::internal::ValidateContainer(object->alternative_endpoints, validation_context,
