...
// static
bool HttpRequestHeaderKeyValuePair_Data::Validate(
    const void* data,
  ...
  [[maybe_unused]] const HttpRequestHeaderKeyValuePair_Data* object =
      static_cast<const HttpRequestHeaderKeyValuePair_Data*>(data);
...
// static
bool HttpRequestHeaders_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const HttpRequestHeaders_Data* object =
      static_cast<const HttpRequestHeaders_Data*>(data);
...
// static
bool HttpRequestHeadersUpdateParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const HttpRequestHeadersUpdateParams_Data* object =
      static_cast<const HttpRequestHeadersUpdateParams_Data*>(data);
...
HttpRequestHeadersUpdateParams_Data::HttpRequestHeadersUpdateParams_Data()
    : header_({sizeof(*this), 0}) {}
