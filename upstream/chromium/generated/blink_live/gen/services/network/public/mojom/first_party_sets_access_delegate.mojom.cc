...
FirstPartySetsReadyEvent::FirstPartySetsReadyEvent(
    ::network::mojom::FirstPartySetsContextConfigPtr config_in,
    ::network::mojom::FirstPartySetsCacheFilterPtr cache_filter_in)
...
void FirstPartySetsReadyEvent::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "config"), this->config,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::network::mojom::FirstPartySetsContextConfigPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::network::mojom::FirstPartySetsCacheFilterPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
