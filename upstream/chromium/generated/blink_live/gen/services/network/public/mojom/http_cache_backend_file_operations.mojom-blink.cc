...
uint32_t FileEnumerator::GetNext_Sym::IPCStableHash() {
  ...
  static constexpr uint32_t kHash = 0x423a1027;  // IPCStableHash for network::mojom::FileEnumerator::GetNext
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
# endif // !BUILDFLAG(IS_FUCHSIA)
bool FileEnumerator::GetNext(uint32_t num_entries, ::blink::Vector<FileEnumerationEntryPtr>* out_entries, bool* out_end, bool* out_error) {
  NOTREACHED();
}
class FileEnumerator_GetNext_HandleSyncResponse
 ...
 public:
  FileEnumerator_GetNext_HandleSyncResponse(
      bool* result, ::blink::Vector<FileEnumerationEntryPtr>* out_entries, bool* out_end, bool* out_error)
 ...
 private:
  bool* result_;
  ::blink::Vector<FileEnumerationEntryPtr>* out_entries_;
  bool* out_end_;
  bool* out_error_;};
...
bool FileEnumeratorProxy::GetNext(
    uint32_t param_num_entries, ::blink::Vector<FileEnumerationEntryPtr>* out_param_entries, bool* out_param_end, bool* out_param_error) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_BEGIN1(
  ...
  mojo::Message message(
      std::to_underlying(messages::FileEnumerator::kGetNext), kFlags, estimated_payload_size);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_END1(
    "mojom", "Call network::mojom::FileEnumerator::GetNext (sync)", "sync_response_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("entries"), out_param_entries,
                        "<value of type ::blink::Vector<FileEnumerationEntryPtr>>");
      perfetto::WriteIntoTracedValueWithFallback(
...
class FileEnumerator_GetNext_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::blink::Vector<FileEnumerationEntryPtr> in_entries, bool in_end, bool in_error);
};
...
bool FileEnumerator_GetNext_ForwardToCallback::Accept(
  ...
  bool success = true;
  ::blink::Vector<FileEnumerationEntryPtr> p_entries{};
  bool p_end{};
  bool p_error{};
...
bool FileEnumeratorRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::blink::FileEnumerator::Name_,
    kFileEnumeratorValidationInfo);
}
...
uint32_t HttpCacheBackendFileOperations::CreateDirectory_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x493bac39;  // IPCStableHash for network::mojom::HttpCacheBackendFileOperations::CreateDirectory
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t HttpCacheBackendFileOperations::PathExists_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x12fc0586;  // IPCStableHash for network::mojom::HttpCacheBackendFileOperations::PathExists
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t HttpCacheBackendFileOperations::DirectoryExists_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xd99604d1;  // IPCStableHash for network::mojom::HttpCacheBackendFileOperations::DirectoryExists
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t HttpCacheBackendFileOperations::OpenFile_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xc8e5ca5e;  // IPCStableHash for network::mojom::HttpCacheBackendFileOperations::OpenFile
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t HttpCacheBackendFileOperations::DeleteFile_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x50744223;  // IPCStableHash for network::mojom::HttpCacheBackendFileOperations::DeleteFile
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t HttpCacheBackendFileOperations::RenameFile_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x6957028f;  // IPCStableHash for network::mojom::HttpCacheBackendFileOperations::RenameFile
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t HttpCacheBackendFileOperations::GetFileInfo_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xf6b94dde;  // IPCStableHash for network::mojom::HttpCacheBackendFileOperations::GetFileInfo
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t HttpCacheBackendFileOperations::EnumerateFiles_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xbda1689b;  // IPCStableHash for network::mojom::HttpCacheBackendFileOperations::EnumerateFiles
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t HttpCacheBackendFileOperations::CleanupDirectory_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x21f115c0;  // IPCStableHash for network::mojom::HttpCacheBackendFileOperations::CleanupDirectory
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
# endif // !BUILDFLAG(IS_FUCHSIA)
bool HttpCacheBackendFileOperations::CreateDirectory(::mojo_base::mojom::blink::FilePathPtr path, bool* out_result) {
  NOTREACHED();
}
bool HttpCacheBackendFileOperations::PathExists(::mojo_base::mojom::blink::FilePathPtr path, bool* out_result) {
  NOTREACHED();
}
bool HttpCacheBackendFileOperations::DirectoryExists(::mojo_base::mojom::blink::FilePathPtr path, bool* out_result) {
  NOTREACHED();
}
bool HttpCacheBackendFileOperations::OpenFile(::mojo_base::mojom::blink::FilePathPtr path, HttpCacheBackendOpenFileFlags flags, ::mojo_base::mojom::blink::FilePtr* out_file, ::mojo_base::mojom::blink::FileError* out_error) {
  NOTREACHED();
}
bool HttpCacheBackendFileOperations::DeleteFile(::mojo_base::mojom::blink::FilePathPtr path, HttpCacheBackendDeleteFileMode mode, bool* out_result) {
  NOTREACHED();
}
bool HttpCacheBackendFileOperations::RenameFile(::mojo_base::mojom::blink::FilePathPtr from_path, ::mojo_base::mojom::blink::FilePathPtr to_path, ::mojo_base::mojom::blink::FileError* out_error) {
  NOTREACHED();
}
bool HttpCacheBackendFileOperations::GetFileInfo(::mojo_base::mojom::blink::FilePathPtr path, ::mojo_base::mojom::blink::FileInfoPtr* out_info) {
  NOTREACHED();
}
...
class HttpCacheBackendFileOperations_OpenFile_HandleSyncResponse
 ...
 public:
  HttpCacheBackendFileOperations_OpenFile_HandleSyncResponse(
      bool* result, ::mojo_base::mojom::blink::FilePtr* out_file, ::mojo_base::mojom::blink::FileError* out_error)
 ...
 private:
  bool* result_;
  ::mojo_base::mojom::blink::FilePtr* out_file_;
  ::mojo_base::mojom::blink::FileError* out_error_;};
...
class HttpCacheBackendFileOperations_RenameFile_HandleSyncResponse
 ...
 public:
  HttpCacheBackendFileOperations_RenameFile_HandleSyncResponse(
      bool* result, ::mojo_base::mojom::blink::FileError* out_error)
...
class HttpCacheBackendFileOperations_GetFileInfo_HandleSyncResponse
 ...
 public:
  HttpCacheBackendFileOperations_GetFileInfo_HandleSyncResponse(
      bool* result, ::mojo_base::mojom::blink::FileInfoPtr* out_info)
 ...
 private:
  bool* result_;
  ::mojo_base::mojom::blink::FileInfoPtr* out_info_;};
...
bool HttpCacheBackendFileOperationsProxy::CreateDirectory(
    ::mojo_base::mojom::blink::FilePathPtr param_path, bool* out_param_result) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_BEGIN1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::HttpCacheBackendFileOperations::kCreateDirectory), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_END1(
    "mojom", "Call network::mojom::HttpCacheBackendFileOperations::CreateDirectory (sync)", "sync_response_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
...
void HttpCacheBackendFileOperationsProxy::CreateDirectory(
    ::mojo_base::mojom::blink::FilePathPtr in_path, CreateDirectoryCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool HttpCacheBackendFileOperationsProxy::PathExists(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::HttpCacheBackendFileOperations::kPathExists), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_END1(
    "mojom", "Call network::mojom::HttpCacheBackendFileOperations::PathExists (sync)", "sync_response_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("result"), out_param_result,
...
void HttpCacheBackendFileOperationsProxy::PathExists(
    ::mojo_base::mojom::blink::FilePathPtr in_path, PathExistsCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool HttpCacheBackendFileOperationsProxy::DirectoryExists(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::HttpCacheBackendFileOperations::kDirectoryExists), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_END1(
    "mojom", "Call network::mojom::HttpCacheBackendFileOperations::DirectoryExists (sync)", "sync_response_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("result"), out_param_result,
...
void HttpCacheBackendFileOperationsProxy::DirectoryExists(
    ::mojo_base::mojom::blink::FilePathPtr in_path, DirectoryExistsCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool HttpCacheBackendFileOperationsProxy::OpenFile(
    ::mojo_base::mojom::blink::FilePathPtr param_path, HttpCacheBackendOpenFileFlags param_flags, ::mojo_base::mojom::blink::FilePtr* out_param_file, ::mojo_base::mojom::blink::FileError* out_param_error) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_BEGIN1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::HttpCacheBackendFileOperations::kOpenFile), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_END1(
    "mojom", "Call network::mojom::HttpCacheBackendFileOperations::OpenFile (sync)", "sync_response_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("error"), out_param_error,
                        "<value of type ::mojo_base::mojom::blink::FileError>");
   });
#endif
  return result;
}
...
void HttpCacheBackendFileOperationsProxy::OpenFile(
    ::mojo_base::mojom::blink::FilePathPtr in_path, HttpCacheBackendOpenFileFlags in_flags, OpenFileCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool HttpCacheBackendFileOperationsProxy::DeleteFile(
    ::mojo_base::mojom::blink::FilePathPtr param_path, HttpCacheBackendDeleteFileMode param_mode, bool* out_param_result) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_BEGIN1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::HttpCacheBackendFileOperations::kDeleteFile), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_END1(
    "mojom", "Call network::mojom::HttpCacheBackendFileOperations::DeleteFile (sync)", "sync_response_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("result"), out_param_result,
...
void HttpCacheBackendFileOperationsProxy::DeleteFile(
    ::mojo_base::mojom::blink::FilePathPtr in_path, HttpCacheBackendDeleteFileMode in_mode, DeleteFileCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool HttpCacheBackendFileOperationsProxy::RenameFile(
    ::mojo_base::mojom::blink::FilePathPtr param_from_path, ::mojo_base::mojom::blink::FilePathPtr param_to_path, ::mojo_base::mojom::blink::FileError* out_param_error) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_BEGIN1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::HttpCacheBackendFileOperations::kRenameFile), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_END1(
    "mojom", "Call network::mojom::HttpCacheBackendFileOperations::RenameFile (sync)", "sync_response_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("error"), out_param_error,
...
void HttpCacheBackendFileOperationsProxy::RenameFile(
    ::mojo_base::mojom::blink::FilePathPtr in_from_path, ::mojo_base::mojom::blink::FilePathPtr in_to_path, RenameFileCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool HttpCacheBackendFileOperationsProxy::GetFileInfo(
    ::mojo_base::mojom::blink::FilePathPtr param_path, ::mojo_base::mojom::blink::FileInfoPtr* out_param_info) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_BEGIN1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::HttpCacheBackendFileOperations::kGetFileInfo), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_END1(
    "mojom", "Call network::mojom::HttpCacheBackendFileOperations::GetFileInfo (sync)", "sync_response_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("info"), out_param_info,
                        "<value of type ::mojo_base::mojom::blink::FileInfoPtr>");
   });
#endif
  return result;
}
...
void HttpCacheBackendFileOperationsProxy::GetFileInfo(
    ::mojo_base::mojom::blink::FilePathPtr in_path, GetFileInfoCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void HttpCacheBackendFileOperationsProxy::EnumerateFiles(
    ::mojo_base::mojom::blink::FilePathPtr in_path, ::mojo::PendingReceiver<FileEnumerator> in_receiver) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::HttpCacheBackendFileOperations::kEnumerateFiles), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void HttpCacheBackendFileOperationsProxy::CleanupDirectory(
    ::mojo_base::mojom::blink::FilePathPtr in_path, CleanupDirectoryCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::HttpCacheBackendFileOperations::kCleanupDirectory), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
class HttpCacheBackendFileOperations_OpenFile_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::mojo_base::mojom::blink::FilePtr in_file, ::mojo_base::mojom::blink::FileError in_error);
};
...
bool HttpCacheBackendFileOperations_OpenFile_ForwardToCallback::Accept(
  ...
  ::mojo_base::mojom::blink::FileError p_error{};
...
class HttpCacheBackendFileOperations_RenameFile_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::mojo_base::mojom::blink::FileError in_error);
};
...
class HttpCacheBackendFileOperations_GetFileInfo_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::mojo_base::mojom::blink::FileInfoPtr in_info);
};
...
bool HttpCacheBackendFileOperations_GetFileInfo_ForwardToCallback::Accept(
  ...
  bool success = true;
  ::mojo_base::mojom::blink::FileInfoPtr p_info{};
...
bool HttpCacheBackendFileOperationsStubDispatch::AcceptWithResponder(
  ...
  switch (static_cast<messages::HttpCacheBackendFileOperations>(message->header()->name)) {
    ...
    case messages::HttpCacheBackendFileOperations::kRenameFile: {
      ...
      // Validation for HttpCacheBackendFileOperations.5
      bool success = true;
      ::mojo_base::mojom::blink::FilePathPtr p_from_path{};
      ::mojo_base::mojom::blink::FilePathPtr p_to_path{};
...
bool HttpCacheBackendFileOperationsRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::blink::HttpCacheBackendFileOperations::Name_,
    kHttpCacheBackendFileOperationsValidationInfo);
}
...
uint32_t HttpCacheBackendFileOperationsFactory::Create_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xa797145b;  // IPCStableHash for network::mojom::HttpCacheBackendFileOperationsFactory::Create
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void HttpCacheBackendFileOperationsFactoryProxy::Create(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::HttpCacheBackendFileOperationsFactory::kCreate), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool HttpCacheBackendFileOperationsFactoryRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::blink::HttpCacheBackendFileOperationsFactory::Name_,
    kHttpCacheBackendFileOperationsFactoryValidationInfo);
}
...
bool StructTraits<::network::mojom::blink::FileEnumerationEntry::DataView, ::network::mojom::blink::FileEnumerationEntryPtr>::Read(
  ...
  bool success = true;
  ::network::mojom::blink::FileEnumerationEntryPtr result(::network::mojom::blink::FileEnumerationEntry::New());
...
void FileEnumeratorInterceptorForTesting::GetNext(uint32_t num_entries, GetNextCallback callback) {
  GetForwardingInterface()->GetNext(
    std::move(num_entries)
    , std::move(callback));
}
...
void FileEnumeratorAsyncWaiter::GetNext(
  ...
  proxy_->GetNext(
      ...
      base::BindOnce(
          [](base::RunLoop* loop,
             ::blink::Vector<FileEnumerationEntryPtr>* out_entries
,
             bool* out_end
,
             bool* out_error
...
void HttpCacheBackendFileOperationsInterceptorForTesting::CreateDirectory(::mojo_base::mojom::blink::FilePathPtr path, CreateDirectoryCallback callback) {
  GetForwardingInterface()->CreateDirectory(
    std::move(path)
    , std::move(callback));
}
void HttpCacheBackendFileOperationsInterceptorForTesting::PathExists(::mojo_base::mojom::blink::FilePathPtr path, PathExistsCallback callback) {
  GetForwardingInterface()->PathExists(
    std::move(path)
    , std::move(callback));
}
void HttpCacheBackendFileOperationsInterceptorForTesting::DirectoryExists(::mojo_base::mojom::blink::FilePathPtr path, DirectoryExistsCallback callback) {
  GetForwardingInterface()->DirectoryExists(
    std::move(path)
    , std::move(callback));
}
void HttpCacheBackendFileOperationsInterceptorForTesting::OpenFile(::mojo_base::mojom::blink::FilePathPtr path, HttpCacheBackendOpenFileFlags flags, OpenFileCallback callback) {
...
void HttpCacheBackendFileOperationsInterceptorForTesting::DeleteFile(::mojo_base::mojom::blink::FilePathPtr path, HttpCacheBackendDeleteFileMode mode, DeleteFileCallback callback) {
...
void HttpCacheBackendFileOperationsInterceptorForTesting::RenameFile(::mojo_base::mojom::blink::FilePathPtr from_path, ::mojo_base::mojom::blink::FilePathPtr to_path, RenameFileCallback callback) {
...
void HttpCacheBackendFileOperationsInterceptorForTesting::GetFileInfo(::mojo_base::mojom::blink::FilePathPtr path, GetFileInfoCallback callback) {
  GetForwardingInterface()->GetFileInfo(
    std::move(path)
    , std::move(callback));
}
void HttpCacheBackendFileOperationsInterceptorForTesting::EnumerateFiles(::mojo_base::mojom::blink::FilePathPtr path, ::mojo::PendingReceiver<FileEnumerator> receiver) {
...
void HttpCacheBackendFileOperationsInterceptorForTesting::CleanupDirectory(::mojo_base::mojom::blink::FilePathPtr path, CleanupDirectoryCallback callback) {
  GetForwardingInterface()->CleanupDirectory(
    std::move(path)
    , std::move(callback));
}
...
void HttpCacheBackendFileOperationsAsyncWaiter::OpenFile(
  ...
  proxy_->OpenFile(
      ...
      base::BindOnce(
          [](base::RunLoop* loop,
             ::mojo_base::mojom::blink::FilePtr* out_file
,
             ::mojo_base::mojom::blink::FileError* out_error
,
             ::mojo_base::mojom::blink::FilePtr file,
             ::mojo_base::mojom::blink::FileError error) {*out_file = std::move(file);*out_error = std::move(error);
            loop->Quit();
          },
          &loop,
          out_file,
...
bool HttpCacheBackendFileOperationsAsyncWaiter::DeleteFile(
    ::mojo_base::mojom::blink::FilePathPtr path, HttpCacheBackendDeleteFileMode mode) {
  bool async_wait_result;
  ...
  proxy_->RenameFile(
      ...
      base::BindOnce(
          [](base::RunLoop* loop,
             ::mojo_base::mojom::blink::FileError* out_error
,
             ::mojo_base::mojom::blink::FileError error) {*out_error = std::move(error);
            loop->Quit();
          },
          &loop,
          out_error));
...
::mojo_base::mojom::blink::FileError HttpCacheBackendFileOperationsAsyncWaiter::RenameFile(
    ::mojo_base::mojom::blink::FilePathPtr from_path, ::mojo_base::mojom::blink::FilePathPtr to_path) {
  ::mojo_base::mojom::blink::FileError async_wait_result;
...
void HttpCacheBackendFileOperationsAsyncWaiter::GetFileInfo(
  ...
  proxy_->GetFileInfo(
      ...
      base::BindOnce(
          [](base::RunLoop* loop,
             ::mojo_base::mojom::blink::FileInfoPtr* out_info
,
             ::mojo_base::mojom::blink::FileInfoPtr info) {*out_info = std::move(info);
            loop->Quit();
          },
          &loop,
          out_info));
...
::mojo_base::mojom::blink::FileInfoPtr HttpCacheBackendFileOperationsAsyncWaiter::GetFileInfo(
    ::mojo_base::mojom::blink::FilePathPtr path) {
  ::mojo_base::mojom::blink::FileInfoPtr async_wait_result;
