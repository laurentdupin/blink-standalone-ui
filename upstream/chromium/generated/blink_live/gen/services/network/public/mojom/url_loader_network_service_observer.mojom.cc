...
bool ClientCertificateResponderRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::ClientCertificateResponder::Name_,
...
bool SSLPrivateKeyRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::SSLPrivateKey::Name_,
...
bool AuthChallengeResponderRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::AuthChallengeResponder::Name_,
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("ssl_info"), in_ssl_info,
                        "<value of type const ::net::SSLInfo&>");
      perfetto::WriteIntoTracedValueWithFallback(
...
void URLLoaderNetworkServiceObserverProxy::OnLocalNetworkAccessPermissionRequired(
    TransportType in_transport_type, ::network::mojom::IPAddressSpace in_ip_address_space, OnLocalNetworkAccessPermissionRequiredCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void URLLoaderNetworkServiceObserverProxy::OnClearSiteData(
    const ::GURL& in_url, const std::string& in_header_value, int32_t in_load_flags, ::network::mojom::CookiePartitionKeyPtr in_cookie_partition_key, bool in_partitioned_state_allowed_only, OnClearSiteDataCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void URLLoaderNetworkServiceObserverProxy::OnDataUseUpdate(
    int32_t in_network_traffic_annotation_id_hash, ::mojo_base::mojom::ByteSizePtr in_recv_bytes, ::mojo_base::mojom::ByteSizePtr in_sent_bytes) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("recv_bytes"), in_recv_bytes,
                        "<value of type ::mojo_base::mojom::ByteSizePtr>");
      perfetto::WriteIntoTracedValueWithFallback(
...
void URLLoaderNetworkServiceObserverProxy::OnSharedStorageHeaderReceived(
    const ::url::Origin& in_request_origin, ::network::mojom::SharedStorageBatchUpdateMethodsArgumentPtr in_methods_with_options, ::network::mojom::LockNamePtr in_with_lock, OnSharedStorageHeaderReceivedCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("methods_with_options"), in_methods_with_options,
                        "<value of type ::network::mojom::SharedStorageBatchUpdateMethodsArgumentPtr>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("with_lock"), in_with_lock,
                        "<value of type ::network::mojom::LockNamePtr>");
   });
#endif
...
void URLLoaderNetworkServiceObserverProxy::OnAdAuctionEventRecordHeaderReceived(
    ::network::mojom::AdAuctionEventRecordPtr in_ad_auction_event_record, const std::optional<::url::Origin>& in_top_frame_origin) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("ad_auction_event_record"), in_ad_auction_event_record,
                        "<value of type ::network::mojom::AdAuctionEventRecordPtr>");
      perfetto::WriteIntoTracedValueWithFallback(
...
void URLLoaderNetworkServiceObserverProxy::OnWebSocketConnectedToLocalNetwork(
    const ::GURL& in_request_url, ::network::mojom::IPAddressSpace in_ip_address_space) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void URLLoaderNetworkServiceObserverProxy::OnUrlLoaderConnectedToLocalNetwork(
    const ::GURL& in_request_url, ::network::mojom::IPAddressSpace in_response_address_space, ::network::mojom::IPAddressSpace in_client_address_space, ::network::mojom::IPAddressSpace in_target_address_space) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool URLLoaderNetworkServiceObserverStubDispatch::Accept(
  ...
  switch (static_cast<messages::URLLoaderNetworkServiceObserver>(message->header()->name)) {
    ...
    case messages::URLLoaderNetworkServiceObserver::kOnDataUseUpdate: {
      ...
      ::mojo_base::mojom::ByteSizePtr p_recv_bytes{};
      ::mojo_base::mojom::ByteSizePtr p_sent_bytes{};
    ...
    case messages::URLLoaderNetworkServiceObserver::kOnAdAuctionEventRecordHeaderReceived: {
      ...
      bool success = true;
      ::network::mojom::AdAuctionEventRecordPtr p_ad_auction_event_record{};
      std::optional<::url::Origin> p_top_frame_origin{};
    ...
    case messages::URLLoaderNetworkServiceObserver::kOnUrlLoaderConnectedToLocalNetwork: {
      ...
      bool success = true;
      ::GURL p_request_url{};
      ::network::mojom::IPAddressSpace p_response_address_space{};
      ::network::mojom::IPAddressSpace p_client_address_space{};
      ::network::mojom::IPAddressSpace p_target_address_space{};
...
bool URLLoaderNetworkServiceObserverStubDispatch::AcceptWithResponder(
  ...
  switch (static_cast<messages::URLLoaderNetworkServiceObserver>(message->header()->name)) {
    ...
    case messages::URLLoaderNetworkServiceObserver::kOnSharedStorageHeaderReceived: {
      ...
      ::network::mojom::SharedStorageBatchUpdateMethodsArgumentPtr p_methods_with_options{};
      ::network::mojom::LockNamePtr p_with_lock{};
...
bool URLLoaderNetworkServiceObserverRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::URLLoaderNetworkServiceObserver::Name_,
...
void URLLoaderNetworkServiceObserverInterceptorForTesting::OnLocalNetworkAccessPermissionRequired(TransportType transport_type, ::network::mojom::IPAddressSpace ip_address_space, OnLocalNetworkAccessPermissionRequiredCallback callback) {
...
void URLLoaderNetworkServiceObserverInterceptorForTesting::OnClearSiteData(const ::GURL& url, const std::string& header_value, int32_t load_flags, ::network::mojom::CookiePartitionKeyPtr cookie_partition_key, bool partitioned_state_allowed_only, OnClearSiteDataCallback callback) {
...
void URLLoaderNetworkServiceObserverInterceptorForTesting::OnDataUseUpdate(int32_t network_traffic_annotation_id_hash, ::mojo_base::mojom::ByteSizePtr recv_bytes, ::mojo_base::mojom::ByteSizePtr sent_bytes) {
...
void URLLoaderNetworkServiceObserverInterceptorForTesting::OnSharedStorageHeaderReceived(const ::url::Origin& request_origin, ::network::mojom::SharedStorageBatchUpdateMethodsArgumentPtr methods_with_options, ::network::mojom::LockNamePtr with_lock, OnSharedStorageHeaderReceivedCallback callback) {
...
void URLLoaderNetworkServiceObserverInterceptorForTesting::OnAdAuctionEventRecordHeaderReceived(::network::mojom::AdAuctionEventRecordPtr ad_auction_event_record, const std::optional<::url::Origin>& top_frame_origin) {
...
void URLLoaderNetworkServiceObserverInterceptorForTesting::OnWebSocketConnectedToLocalNetwork(const ::GURL& request_url, ::network::mojom::IPAddressSpace ip_address_space) {
...
void URLLoaderNetworkServiceObserverInterceptorForTesting::OnUrlLoaderConnectedToLocalNetwork(const ::GURL& request_url, ::network::mojom::IPAddressSpace response_address_space, ::network::mojom::IPAddressSpace client_address_space, ::network::mojom::IPAddressSpace target_address_space) {
...
LocalNetworkAccessResult URLLoaderNetworkServiceObserverAsyncWaiter::OnLocalNetworkAccessPermissionRequired(
    TransportType transport_type, ::network::mojom::IPAddressSpace ip_address_space) {
