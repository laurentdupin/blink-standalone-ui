...
CIDR::CIDR(
    ::network::mojom::blink::IPAddressPtr ip_in,
    ::network::mojom::blink::IPAddressPtr mask_in)
    : ip(std::move(ip_in)),
...
CertWithConstraints::CertWithConstraints(
    ::blink::Vector<uint8_t> certificate_in,
    ::blink::Vector<::blink::String> permitted_dns_names_in,
    ::blink::Vector<CIDRPtr> permitted_cidrs_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<CIDRPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
AdditionalCertificates::AdditionalCertificates(
    ::blink::Vector<::blink::Vector<uint8_t>> all_certificates_in,
    ::blink::Vector<::blink::Vector<uint8_t>> trust_anchors_in,
    ::blink::Vector<::blink::Vector<uint8_t>> trust_anchors_with_enforced_constraints_in,
    ::blink::Vector<CertWithConstraintsPtr> trust_anchors_with_additional_constraints_in,
    ::blink::Vector<CertWithConstraintsPtr> trust_anchors_and_leafs_in,
    ::blink::Vector<CertWithConstraintsPtr> trust_leafs_in,
    ::blink::Vector<::blink::Vector<uint8_t>> distrusted_spkis_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<CertWithConstraintsPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
void CertVerifierServiceUpdaterProxy::UpdateAdditionalCertificates(
  ...
  mojo::Message message(
      std::to_underlying(messages::CertVerifierServiceUpdater::kUpdateAdditionalCertificates), kFlags, estimated_payload_size);
...
void CertVerifierServiceUpdaterProxy::WaitUntilNextUpdateForTesting(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::CertVerifierServiceUpdater::kWaitUntilNextUpdateForTesting), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool CertVerifierServiceUpdaterRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::cert_verifier::mojom::blink::CertVerifierServiceUpdater::Name_,
...
bool StructTraits<::cert_verifier::mojom::blink::CIDR::DataView, ::cert_verifier::mojom::blink::CIDRPtr>::Read(
    ::cert_verifier::mojom::blink::CIDR::DataView input,
    ::cert_verifier::mojom::blink::CIDRPtr* output) {
  bool success = true;
...
bool StructTraits<::cert_verifier::mojom::blink::CertWithConstraints::DataView, ::cert_verifier::mojom::blink::CertWithConstraintsPtr>::Read(
    ::cert_verifier::mojom::blink::CertWithConstraints::DataView input,
    ::cert_verifier::mojom::blink::CertWithConstraintsPtr* output) {
  bool success = true;
