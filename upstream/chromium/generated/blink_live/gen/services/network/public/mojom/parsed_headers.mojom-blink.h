...
#include "services/network/public/mojom/parsed_headers.mojom-blink-forward.h"  // IWYU pragma: export
...
#include "services/network/public/mojom/supports_loading_mode.mojom-blink-forward.h"
...
class  ParsedHeaders {
 public:
  ...
  ParsedHeaders(
      ::blink::Vector<::network::mojom::blink::ContentSecurityPolicyPtr> content_security_policy,
      ::network::mojom::blink::AllowCSPFromHeaderValuePtr allow_csp_from,
      ::network::mojom::blink::ConnectionAllowlistsPtr connection_allowlists,
      ::network::mojom::blink::CrossOriginEmbedderPolicyPtr cross_origin_embedder_policy,
      ::network::mojom::blink::CrossOriginOpenerPolicyPtr cross_origin_opener_policy,
      ::network::mojom::blink::DocumentIsolationPolicyPtr document_isolation_policy,
      ::network::mojom::blink::IntegrityPolicyPtr integrity_policy,
      ::network::mojom::blink::IntegrityPolicyPtr integrity_policy_report_only,
      OriginAgentClusterValue origin_agent_cluster,
      std::optional<::blink::Vector<::network::mojom::blink::WebClientHintsType>> accept_ch,
      std::optional<::blink::Vector<::network::mojom::blink::WebClientHintsType>> critical_ch,
      bool client_hints_ignored_due_to_clear_site_data_header,
      ::network::mojom::blink::XFrameOptionsValue xfo,
      ::blink::Vector<::network::mojom::blink::LinkHeaderPtr> link_headers,
      ::network::mojom::blink::TimingAllowOriginPtr timing_allow_origin,
      ::blink::Vector<::network::mojom::blink::LoadingMode> supports_loading_mode,
      const std::optional<::blink::HashMap<::blink::String, ::blink::String>>& reporting_endpoints,
      std::optional<::blink::Vector<::blink::String>> cookie_indices,
      std::optional<::blink::Vector<::blink::String>> avail_language,
      std::optional<::blink::Vector<::blink::String>> content_language,
      ...
      ::network::mojom::blink::DeclarativePerformanceObserverPolicyPtr declarative_performance_observer_policy,
      const std::optional<::blink::KURL>& prefetch_activation_beacon_endpoint);
...
ParsedHeaders& operator=(const ParsedHeaders&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ParsedHeaders::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ParsedHeaders::DataView, ::blink::Vector<uint8_t>>(input);
  }
  ...
  std::optional<::blink::HashMap<::blink::String, ::blink::String>> reporting_endpoints;
  ...
  std::optional<::blink::KURL> prefetch_activation_beacon_endpoint;
...
ParsedHeadersPtr ParsedHeaders::Clone() const {
  return New(
      ...
      mojo::Clone(declarative_performance_observer_policy),
      mojo::Clone(prefetch_activation_beacon_endpoint)
  );
}
...
bool ParsedHeaders::Equals(const T& other_struct) const {
  ...
  if (!mojo::Equals(this->allow_cross_origin_event_reporting, other_struct.allow_cross_origin_event_reporting))
    return false;
  if (!mojo::Equals(this->declarative_performance_observer_policy, other_struct.declarative_performance_observer_policy))
    return false;
  if (!mojo::Equals(this->prefetch_activation_beacon_endpoint, other_struct.prefetch_activation_beacon_endpoint))
    return false;
  return true;
}
...
bool operator<(const T& lhs, const T& rhs) {
  ...
  if (rhs.allow_cross_origin_event_reporting < lhs.allow_cross_origin_event_reporting)
    return false;
  if (lhs.declarative_performance_observer_policy < rhs.declarative_performance_observer_policy)
    return true;
  if (rhs.declarative_performance_observer_policy < lhs.declarative_performance_observer_policy)
    return false;
  if (lhs.prefetch_activation_beacon_endpoint < rhs.prefetch_activation_beacon_endpoint)
    return true;
  if (rhs.prefetch_activation_beacon_endpoint < lhs.prefetch_activation_beacon_endpoint)
    return false;
  return false;
}
...
template <>
struct  StructTraits<::network::mojom::blink::ParsedHeaders::DataView,
  ...
  static const decltype(::network::mojom::blink::ParsedHeaders::connection_allowlists)& connection_allowlists(
      const ::network::mojom::blink::ParsedHeadersPtr& input) {
  ...
  static const decltype(::network::mojom::blink::ParsedHeaders::document_isolation_policy)& document_isolation_policy(
      const ::network::mojom::blink::ParsedHeadersPtr& input) {
    return input->document_isolation_policy;
  }

  static const decltype(::network::mojom::blink::ParsedHeaders::integrity_policy)& integrity_policy(
      const ::network::mojom::blink::ParsedHeadersPtr& input) {
    return input->integrity_policy;
  }

  static const decltype(::network::mojom::blink::ParsedHeaders::integrity_policy_report_only)& integrity_policy_report_only(
      const ::network::mojom::blink::ParsedHeadersPtr& input) {
  ...
  static decltype(::network::mojom::blink::ParsedHeaders::client_hints_ignored_due_to_clear_site_data_header) client_hints_ignored_due_to_clear_site_data_header(
      const ::network::mojom::blink::ParsedHeadersPtr& input) {
  ...
  static const decltype(::network::mojom::blink::ParsedHeaders::supports_loading_mode)& supports_loading_mode(
      const ::network::mojom::blink::ParsedHeadersPtr& input) {
  ...
  static const decltype(::network::mojom::blink::ParsedHeaders::cookie_indices)& cookie_indices(
      const ::network::mojom::blink::ParsedHeadersPtr& input) {
    return input->cookie_indices;
  }

  static const decltype(::network::mojom::blink::ParsedHeaders::avail_language)& avail_language(
      const ::network::mojom::blink::ParsedHeadersPtr& input) {
  ...
  static const decltype(::network::mojom::blink::ParsedHeaders::no_vary_search_with_parse_error)& no_vary_search_with_parse_error(
      const ::network::mojom::blink::ParsedHeadersPtr& input) {
    return input->no_vary_search_with_parse_error;
  }

  static decltype(::network::mojom::blink::ParsedHeaders::observe_browsing_topics) observe_browsing_topics(
      const ::network::mojom::blink::ParsedHeadersPtr& input) {
    return input->observe_browsing_topics;
  }

  static decltype(::network::mojom::blink::ParsedHeaders::allow_cross_origin_event_reporting) allow_cross_origin_event_reporting(
      const ::network::mojom::blink::ParsedHeadersPtr& input) {
    return input->allow_cross_origin_event_reporting;
  }

  static const decltype(::network::mojom::blink::ParsedHeaders::declarative_performance_observer_policy)& declarative_performance_observer_policy(
      const ::network::mojom::blink::ParsedHeadersPtr& input) {
    return input->declarative_performance_observer_policy;
  }

  static const decltype(::network::mojom::blink::ParsedHeaders::prefetch_activation_beacon_endpoint)& prefetch_activation_beacon_endpoint(
      const ::network::mojom::blink::ParsedHeadersPtr& input) {
    return input->prefetch_activation_beacon_endpoint;
  }
