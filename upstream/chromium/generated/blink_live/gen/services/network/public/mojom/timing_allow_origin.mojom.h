...
#include "services/network/public/mojom/timing_allow_origin.mojom-forward.h"  // IWYU pragma: export
#include <string>
#include <vector>
...
class  TimingAllowOrigin {
 public:
  ...
  std::vector<std::string>& get_serialized_origins() {
    CHECK(tag_ == Tag::kSerializedOrigins);
    return data_.serialized_origins;
  }
  void set_serialized_origins(std::vector<std::string> serialized_origins);
