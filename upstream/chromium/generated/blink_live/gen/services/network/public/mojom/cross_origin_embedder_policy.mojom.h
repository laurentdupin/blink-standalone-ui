...
class CrossOriginEmbedderPolicyReporter
 ...
 public:
  ...
  static constexpr const char* Name_ = "network.mojom.CrossOriginEmbedderPolicyReporter";
 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CrossOriginEmbedderPolicy::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CrossOriginEmbedderPolicy::DataView, std::vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::network::mojom::CrossOriginEmbedderPolicy::DataView,
                                         ::network::mojom::CrossOriginEmbedderPolicyPtr> {
  static bool IsNull(const ::network::mojom::CrossOriginEmbedderPolicyPtr& input) { return !input; }
  static void SetToNull(::network::mojom::CrossOriginEmbedderPolicyPtr* output) { output->reset(); }

  static decltype(::network::mojom::CrossOriginEmbedderPolicy::value) value(
