...
// static
bool NetworkServiceTest_HasRawHeadersAccess_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const NetworkServiceTest_HasRawHeadersAccess_Params_Data* object =
      static_cast<const NetworkServiceTest_HasRawHeadersAccess_Params_Data*>(data);
...
NetworkServiceTest_HasRawHeadersAccess_Params_Data::NetworkServiceTest_HasRawHeadersAccess_Params_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool NetworkServiceTest_HasRawHeadersAccess_ResponseParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const NetworkServiceTest_HasRawHeadersAccess_ResponseParams_Data* object =
      static_cast<const NetworkServiceTest_HasRawHeadersAccess_ResponseParams_Data*>(data);

  return true;
}

NetworkServiceTest_HasRawHeadersAccess_ResponseParams_Data::NetworkServiceTest_HasRawHeadersAccess_ResponseParams_Data()
    : header_({sizeof(*this), 0}) {}
