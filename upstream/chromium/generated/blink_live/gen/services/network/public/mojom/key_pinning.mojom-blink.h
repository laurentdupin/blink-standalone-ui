...
template <>
struct  StructTraits<::network::mojom::blink::PinSet::DataView,
...
template <>
struct  StructTraits<::network::mojom::blink::PinSetInfo::DataView,
...
template <>
struct  StructTraits<::network::mojom::blink::PinList::DataView,
