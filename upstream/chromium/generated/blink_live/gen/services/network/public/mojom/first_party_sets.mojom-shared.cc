...
bool GlobalFirstPartySets_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->public_config, 2, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateStruct(object->public_config, validation_context))
    return false;

  if (!mojo::internal::ValidatePointerNonNullable(
          object->manual_config, 3, validation_context)) {
    return false;
  }
