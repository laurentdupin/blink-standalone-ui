...
void NetworkChangeManagerClientProxy::OnInitialConnectionType(
  ...
  mojo::Message message(
      std::to_underlying(messages::NetworkChangeManagerClient::kOnInitialConnectionType), kFlags, estimated_payload_size);
...
void NetworkChangeManagerClientProxy::OnNetworkChanged(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::NetworkChangeManagerClient::kOnNetworkChanged), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool NetworkChangeManagerClientRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::blink::NetworkChangeManagerClient::Name_,
...
void NetworkChangeManagerProxy::RequestNotifications(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::NetworkChangeManager::kRequestNotifications), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool NetworkChangeManagerRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::blink::NetworkChangeManager::Name_,
