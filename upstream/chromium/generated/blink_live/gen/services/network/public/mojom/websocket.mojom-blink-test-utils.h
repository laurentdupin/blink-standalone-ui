...
class BLINK_PLATFORM_EXPORT WebSocketAuthenticationHandlerInterceptorForTesting : public WebSocketAuthenticationHandler {
  ...
  void OnAuthRequired(const ::net::AuthChallengeInfo& info, const ::scoped_refptr<::net::HttpResponseHeaders>& headers, ::network::mojom::blink::IPEndPointPtr remote_endpoint, OnAuthRequiredCallback callback) override;
};
class BLINK_PLATFORM_EXPORT WebSocketAuthenticationHandlerAsyncWaiter {
 public:
  ...
  std::optional<::net::AuthCredentials> OnAuthRequired(const ::net::AuthChallengeInfo& info, const ::scoped_refptr<::net::HttpResponseHeaders>& headers, ::network::mojom::blink::IPEndPointPtr remote_endpoint);
