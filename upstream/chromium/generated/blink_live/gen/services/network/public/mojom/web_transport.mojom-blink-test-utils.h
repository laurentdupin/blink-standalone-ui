...
class BLINK_PLATFORM_EXPORT WebTransportHandshakeClientInterceptorForTesting : public WebTransportHandshakeClient {
  ...
  void OnBeforeConnect(::network::mojom::blink::IPEndPointPtr server_address) override;
  void OnConnectionEstablished(::mojo::PendingRemote<WebTransport> transport, ::mojo::PendingReceiver<WebTransportClient> client, const ::scoped_refptr<::net::HttpResponseHeaders>& response_headers, const ::blink::String& selected_application_protocol, WebTransportStatsPtr initial_stats) override;
