// services/network/public/mojom/connection_endpoint_metadata.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef SERVICES_NETWORK_PUBLIC_MOJOM_CONNECTION_ENDPOINT_METADATA_MOJOM_BLINK_H_
#define SERVICES_NETWORK_PUBLIC_MOJOM_CONNECTION_ENDPOINT_METADATA_MOJOM_BLINK_H_
...
#include "services/network/public/mojom/connection_endpoint_metadata.mojom-blink-forward.h"  // IWYU pragma: export
...
class  ConnectionEndpointMetadata {
 public:
  ...
  ConnectionEndpointMetadata(
      ::blink::Vector<::blink::String> supported_protocol_alpns,
      ::blink::Vector<uint8_t> ech_config_list,
      const ::blink::String& target_name,
      ::blink::Vector<::blink::Vector<uint8_t>> trust_anchor_ids);
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ConnectionEndpointMetadata::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ConnectionEndpointMetadata::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::network::mojom::blink::ConnectionEndpointMetadata::DataView,
                                         ::network::mojom::blink::ConnectionEndpointMetadataPtr> {
  static bool IsNull(const ::network::mojom::blink::ConnectionEndpointMetadataPtr& input) { return !input; }
  static void SetToNull(::network::mojom::blink::ConnectionEndpointMetadataPtr* output) { output->reset(); }

  static const decltype(::network::mojom::blink::ConnectionEndpointMetadata::supported_protocol_alpns)& supported_protocol_alpns(
      const ::network::mojom::blink::ConnectionEndpointMetadataPtr& input) {
    return input->supported_protocol_alpns;
  }

  static const decltype(::network::mojom::blink::ConnectionEndpointMetadata::ech_config_list)& ech_config_list(
      const ::network::mojom::blink::ConnectionEndpointMetadataPtr& input) {
    return input->ech_config_list;
  }

  static const decltype(::network::mojom::blink::ConnectionEndpointMetadata::target_name)& target_name(
      const ::network::mojom::blink::ConnectionEndpointMetadataPtr& input) {
    return input->target_name;
  }

  static const decltype(::network::mojom::blink::ConnectionEndpointMetadata::trust_anchor_ids)& trust_anchor_ids(
      const ::network::mojom::blink::ConnectionEndpointMetadataPtr& input) {
    return input->trust_anchor_ids;
  }

  static bool Read(::network::mojom::blink::ConnectionEndpointMetadata::DataView input, ::network::mojom::blink::ConnectionEndpointMetadataPtr* output);
};

}  // namespace mojo

#endif  // SERVICES_NETWORK_PUBLIC_MOJOM_CONNECTION_ENDPOINT_METADATA_MOJOM_BLINK_H_