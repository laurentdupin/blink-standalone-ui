 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        HttpRequestHeaderKeyValuePair::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
HttpRequestHeaders& operator=(const HttpRequestHeaders&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        HttpRequestHeaders::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
class  HttpRequestHeadersUpdateParams {
 public:
  template <typename T>
...
HttpRequestHeadersUpdateParams& operator=(const HttpRequestHeadersUpdateParams&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        HttpRequestHeadersUpdateParams::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        HttpRequestHeadersUpdateParams::DataView, std::vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::network::mojom::HttpRequestHeadersUpdateParams::DataView,
                                         ::network::mojom::HttpRequestHeadersUpdateParamsPtr> {
  static bool IsNull(const ::network::mojom::HttpRequestHeadersUpdateParamsPtr& input) { return !input; }
  static void SetToNull(::network::mojom::HttpRequestHeadersUpdateParamsPtr* output) { output->reset(); }

  static const decltype(::network::mojom::HttpRequestHeadersUpdateParams::removed_headers)& removed_headers(
      const ::network::mojom::HttpRequestHeadersUpdateParamsPtr& input) {
    return input->removed_headers;
  }

  static const decltype(::network::mojom::HttpRequestHeadersUpdateParams::modified_headers)& modified_headers(
      const ::network::mojom::HttpRequestHeadersUpdateParamsPtr& input) {
    return input->modified_headers;
  }

  static const decltype(::network::mojom::HttpRequestHeadersUpdateParams::modified_cors_exempt_headers)& modified_cors_exempt_headers(
      const ::network::mojom::HttpRequestHeadersUpdateParamsPtr& input) {
    return input->modified_cors_exempt_headers;
  }

  static bool Read(::network::mojom::HttpRequestHeadersUpdateParams::DataView input, ::network::mojom::HttpRequestHeadersUpdateParamsPtr* output);
};
