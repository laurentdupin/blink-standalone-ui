...
CSPSourceList::CSPSourceList(
    ::blink::Vector<CSPSourcePtr> sources_in,
    ::blink::Vector<::blink::String> nonces_in,
    ::blink::Vector<::network::mojom::blink::IntegrityMetadataPtr> hashes_in,
    ::blink::Vector<::network::mojom::blink::IntegrityMetadataPtr> url_hashes_in,
    ::blink::Vector<::network::mojom::blink::IntegrityMetadataPtr> eval_hashes_in,
    bool allow_self_in,
    bool allow_star_in,
    ...
    std::optional<::network::mojom::blink::IntegrityAlgorithm> report_hash_algorithm_in)
...
void CSPSourceList::WriteIntoTrace(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<CSPSourcePtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "hashes"), this->hashes,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<::network::mojom::blink::IntegrityMetadataPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::optional<::network::mojom::blink::IntegrityAlgorithm>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
CSPTrustedTypes::CSPTrustedTypes(
    ::blink::Vector<::blink::String> list_in,
    bool allow_any_in,
...
ContentSecurityPolicy::ContentSecurityPolicy(
    ...
    const ::blink::HashMap<CSPDirectiveName, ::blink::String>& raw_directives_in,
    ::blink::HashMap<CSPDirectiveName, CSPSourceListPtr> directives_in,
    ...
    ::blink::Vector<::blink::String> report_endpoints_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type const ::blink::HashMap<CSPDirectiveName, ::blink::String>&>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::HashMap<CSPDirectiveName, CSPSourceListPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
CSPViolation::CSPViolation(
    const ::blink::String& directive_in,
    const ::blink::String& effective_directive_in,
    const ::blink::String& console_message_in,
    ::url::mojom::blink::UrlPtr blocked_url_in,
    ::blink::Vector<::blink::String> report_endpoints_in,
    bool use_reporting_api_in,
    const ::blink::String& header_in,
    ContentSecurityPolicyType type_in,
...
AllowCSPFromHeaderValue::NewAllowStar(
    bool value) {
  return AllowCSPFromHeaderValuePtr(
      std::in_place,
      std::in_place_index<static_cast<size_t>(Tag::kAllowStar)>,
      std::move(value));
}

AllowCSPFromHeaderValuePtr
AllowCSPFromHeaderValue::NewOrigin(
    ::url::mojom::blink::OriginPtr value) {
  return AllowCSPFromHeaderValuePtr(
      std::in_place,
      std::in_place_index<static_cast<size_t>(Tag::kOrigin)>,
      std::move(value));
}

AllowCSPFromHeaderValuePtr
AllowCSPFromHeaderValue::NewErrorMessage(
...
AllowCSPFromHeaderValue::AllowCSPFromHeaderValue(
    ...
    bool value)
    : tag_(Tag::kAllowStar),
      data_(std::in_place_index<static_cast<size_t>(Tag::kAllowStar)>,
            std::move(value)) {}
...
AllowCSPFromHeaderValue::AllowCSPFromHeaderValue(
    ...
    ::url::mojom::blink::OriginPtr value)
    : tag_(Tag::kOrigin),
      data_(std::in_place_index<static_cast<size_t>(Tag::kOrigin)>,
            std::move(value)) {}
...
void AllowCSPFromHeaderValue::set_origin(::url::mojom::blink::OriginPtr origin) {
  if (tag_ == Tag::kOrigin) {
    data_.origin = std::move(origin);
  } else {
    DestroyActive();
    tag_ = Tag::kOrigin;
    new (&data_.origin) ::url::mojom::blink::OriginPtr(
        std::move(origin));
  }
}

void AllowCSPFromHeaderValue::set_error_message(const ::blink::String& error_message) {
...
AllowCSPFromHeaderValue::Union_::Union_(
    std::in_place_index_t<static_cast<size_t>(Tag::kAllowStar)>,
    bool value)
    : allow_star(std::move(value)) {}
...
void AllowCSPFromHeaderValue::DestroyActive() {
  switch (tag_) {
    ...
    case Tag::kAllowStar:
      std::destroy_at(&data_.allow_star);
      break;
    case Tag::kOrigin:
      std::destroy_at(&data_.origin);
      break;
...
bool UnionTraits<::network::mojom::blink::AllowCSPFromHeaderValue::DataView, ::network::mojom::blink::AllowCSPFromHeaderValuePtr>::Read(
  ...
  switch (input.tag()) {
    ...
    case Tag::kOrigin: {
      ::url::mojom::blink::OriginPtr result_origin{};
