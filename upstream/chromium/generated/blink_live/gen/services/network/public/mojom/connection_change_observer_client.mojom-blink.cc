// services/network/public/mojom/connection_change_observer_client.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "services/network/public/mojom/connection_change_observer_client.mojom-blink-import-headers.h"
#include "services/network/public/mojom/connection_change_observer_client.mojom-blink-test-utils.h"
...
EstablishedConnectionInfo::EstablishedConnectionInfo(
    ::network::mojom::blink::NextProto connection_info_in,
...
void EstablishedConnectionInfo::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      ...
      "<value of type ::network::mojom::blink::NextProto>"
#else
      "<value>"
...
ConnectionKeepAliveConfig::ConnectionKeepAliveConfig(
    ...
    const ::blink::String& quic_connection_options_in)
...
size_t ConnectionKeepAliveConfig::Hash(size_t seed) const {
  seed = mojo::internal::WTFHash(seed, this->idle_timeout_in_seconds);
  seed = mojo::internal::WTFHash(seed, this->ping_interval_in_seconds);
  seed = mojo::internal::WTFHash(seed, this->enable_connection_keep_alive);
  seed = mojo::internal::WTFHash(seed, this->quic_connection_options);
  return seed;
}
...
bool ConnectionChangeObserverClientRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::blink::ConnectionChangeObserverClient::Name_,
...
// static
bool StructTraits<::network::mojom::blink::EstablishedConnectionInfo::DataView, ::network::mojom::blink::EstablishedConnectionInfoPtr>::Read(
    ::network::mojom::blink::EstablishedConnectionInfo::DataView input,
    ::network::mojom::blink::EstablishedConnectionInfoPtr* output) {
  bool success = true;
  ::network::mojom::blink::EstablishedConnectionInfoPtr result(::network::mojom::blink::EstablishedConnectionInfo::New());
...
// static
bool StructTraits<::network::mojom::blink::ConnectionKeepAliveConfig::DataView, ::network::mojom::blink::ConnectionKeepAliveConfigPtr>::Read(
    ::network::mojom::blink::ConnectionKeepAliveConfig::DataView input,
    ::network::mojom::blink::ConnectionKeepAliveConfigPtr* output) {
  bool success = true;
  ::network::mojom::blink::ConnectionKeepAliveConfigPtr result(::network::mojom::blink::ConnectionKeepAliveConfig::New());
