...
class  WebSocketAuthenticationHandlerInterceptorForTesting : public WebSocketAuthenticationHandler {
  ...
  void OnAuthRequired(const ::net::AuthChallengeInfo& info, const ::scoped_refptr<::net::HttpResponseHeaders>& headers, ::network::mojom::IPEndPointPtr remote_endpoint, OnAuthRequiredCallback callback) override;
};
class  WebSocketAuthenticationHandlerAsyncWaiter {
 public:
  ...
  std::optional<::net::AuthCredentials> OnAuthRequired(const ::net::AuthChallengeInfo& info, const ::scoped_refptr<::net::HttpResponseHeaders>& headers, ::network::mojom::IPEndPointPtr remote_endpoint);
