...
RestrictedCanonicalCookieParams::RestrictedCanonicalCookieParams()
    : name(),
      value(),
      domain(),
      path(),
...
RestrictedCanonicalCookieParams::RestrictedCanonicalCookieParams(
    ...
    ::base::Time expires_in,
    ::base::Time last_access_in,
    bool secure_in,
    bool http_only_in,
    ::network::mojom::blink::CookieSameSite same_site_in,
    ::network::mojom::blink::CookiePriority priority_in,
    RestrictedCookiePartition partitioned_in)
    : name(std::move(name_in)),
      ...
      partitioned(std::move(partitioned_in)) {}

RestrictedCanonicalCookieParams::~RestrictedCanonicalCookieParams() = default;

void RestrictedCanonicalCookieParams::WriteIntoTrace(
    perfetto::TracedValue traced_context) const {
  [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::network::mojom::blink::CookiePriority>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type RestrictedCookiePartition>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
bool RestrictedCanonicalCookieParams::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  return Data_::Validate(data, validation_context);
}
...
# endif // !BUILDFLAG(IS_FUCHSIA)
bool RestrictedCookieManager::GetCookiesString(const ::blink::KURL& url, ::network::mojom::blink::SiteForCookiesPtr site_for_cookies, const ::scoped_refptr<const ::blink::SecurityOrigin>& top_frame_origin, ::network::mojom::blink::StorageAccessApiStatus storage_access_api_status, bool get_version_shared_memory, bool is_ad_tagged, bool apply_devtools_overrides, bool force_disable_third_party_cookies, uint64_t* out_version, ::mojo_base::mojom::blink::ReadOnlySharedMemoryRegionPtr* out_version_buffer, ::blink::String* out_cookies) {
  NOTREACHED();
}
bool RestrictedCookieManager::CookiesEnabledFor(const ::blink::KURL& url, ::network::mojom::blink::SiteForCookiesPtr site_for_cookies, const ::scoped_refptr<const ::blink::SecurityOrigin>& top_frame_origin, ::network::mojom::blink::StorageAccessApiStatus storage_access_api_status, bool apply_devtools_overrides, bool* out_cookies_enabled) {
  NOTREACHED();
}
...
class RestrictedCookieManager_GetCookiesString_HandleSyncResponse
 ...
 public:
  RestrictedCookieManager_GetCookiesString_HandleSyncResponse(
      bool* result, uint64_t* out_version, ::mojo_base::mojom::blink::ReadOnlySharedMemoryRegionPtr* out_version_buffer, ::blink::String* out_cookies)
 ...
 private:
  ...
  ::mojo_base::mojom::blink::ReadOnlySharedMemoryRegionPtr* out_version_buffer_;
  ::blink::String* out_cookies_;};
...
void RestrictedCookieManagerProxy::GetAllForUrl(
    const ::blink::KURL& in_url, ::network::mojom::blink::SiteForCookiesPtr in_site_for_cookies, const ::scoped_refptr<const ::blink::SecurityOrigin>& in_top_frame_origin, ::network::mojom::blink::StorageAccessApiStatus in_storage_access_api_status, CookieManagerGetOptionsPtr in_options, bool in_is_ad_tagged, bool in_apply_devtools_overrides, bool in_force_disable_third_party_cookies, GetAllForUrlCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("storage_access_api_status"), in_storage_access_api_status,
                        "<value of type ::network::mojom::blink::StorageAccessApiStatus>");
      perfetto::WriteIntoTracedValueWithFallback(
  ...
  mojo::Message message(
      std::to_underlying(messages::RestrictedCookieManager::kGetAllForUrl), kFlags, estimated_payload_size);
...
void RestrictedCookieManagerProxy::SetCanonicalCookie(
    RestrictedCanonicalCookieParamsPtr in_canonical_cookie_params, const ::blink::KURL& in_url, ::network::mojom::blink::SiteForCookiesPtr in_site_for_cookies, const ::scoped_refptr<const ::blink::SecurityOrigin>& in_top_frame_origin, ::network::mojom::blink::StorageAccessApiStatus in_storage_access_api_status, bool in_is_ad_tagged, bool in_apply_devtools_overrides, SetCanonicalCookieCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("canonical_cookie_params"), in_canonical_cookie_params,
                        "<value of type RestrictedCanonicalCookieParamsPtr>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("url"), in_url,
                        "<value of type const ::blink::KURL&>");
      perfetto::WriteIntoTracedValueWithFallback(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::RestrictedCookieManager::kSetCanonicalCookie), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
      ::network::mojom::internal::RestrictedCookieManager_SetCanonicalCookie_Params_Data> params(
          message);
  params.Allocate();
  mojo::internal::MessageFragment<
      typename decltype(params->canonical_cookie_params)::BaseType> canonical_cookie_params_fragment(
          params.message());
  
  mojo::internal::Serialize<::network::mojom::RestrictedCanonicalCookieParamsDataView>(
    in_canonical_cookie_params,
    canonical_cookie_params_fragment);

  params->canonical_cookie_params.Set(
      canonical_cookie_params_fragment.is_null() ? nullptr : canonical_cookie_params_fragment.data());

  
  MOJO_INTERNAL_CHECK_SERIALIZATION(
    mojo::internal::SendValidation::kDefault,
    !(params->canonical_cookie_params.is_null()),
    mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
    "null canonical_cookie_params in RestrictedCookieManager.SetCanonicalCookie request");
  mojo::internal::MessageFragment<
      typename decltype(params->url)::BaseType> url_fragment(
          params.message());
...
void RestrictedCookieManagerProxy::AddChangeListener(
    const ::blink::KURL& in_url, ::network::mojom::blink::SiteForCookiesPtr in_site_for_cookies, const ::scoped_refptr<const ::blink::SecurityOrigin>& in_top_frame_origin, ::network::mojom::blink::StorageAccessApiStatus in_storage_access_api_status, ::mojo::PendingRemote<::network::mojom::blink::CookieChangeListener> in_listener, AddChangeListenerCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::RestrictedCookieManager::kAddChangeListener), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void RestrictedCookieManagerProxy::SetCookieFromString(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::RestrictedCookieManager::kSetCookieFromString), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool RestrictedCookieManagerProxy::GetCookiesString(
    const ::blink::KURL& param_url, ::network::mojom::blink::SiteForCookiesPtr param_site_for_cookies, const ::scoped_refptr<const ::blink::SecurityOrigin>& param_top_frame_origin, ::network::mojom::blink::StorageAccessApiStatus param_storage_access_api_status, bool param_get_version_shared_memory, bool param_is_ad_tagged, bool param_apply_devtools_overrides, bool param_force_disable_third_party_cookies, uint64_t* out_param_version, ::mojo_base::mojom::blink::ReadOnlySharedMemoryRegionPtr* out_param_version_buffer, ::blink::String* out_param_cookies) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_BEGIN1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::RestrictedCookieManager::kGetCookiesString), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_END1(
    "mojom", "Call network::mojom::RestrictedCookieManager::GetCookiesString (sync)", "sync_response_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("version_buffer"), out_param_version_buffer,
                        "<value of type ::mojo_base::mojom::blink::ReadOnlySharedMemoryRegionPtr>");
      perfetto::WriteIntoTracedValueWithFallback(
...
void RestrictedCookieManagerProxy::GetCookiesString(
    const ::blink::KURL& in_url, ::network::mojom::blink::SiteForCookiesPtr in_site_for_cookies, const ::scoped_refptr<const ::blink::SecurityOrigin>& in_top_frame_origin, ::network::mojom::blink::StorageAccessApiStatus in_storage_access_api_status, bool in_get_version_shared_memory, bool in_is_ad_tagged, bool in_apply_devtools_overrides, bool in_force_disable_third_party_cookies, GetCookiesStringCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool RestrictedCookieManagerProxy::CookiesEnabledFor(
    const ::blink::KURL& param_url, ::network::mojom::blink::SiteForCookiesPtr param_site_for_cookies, const ::scoped_refptr<const ::blink::SecurityOrigin>& param_top_frame_origin, ::network::mojom::blink::StorageAccessApiStatus param_storage_access_api_status, bool param_apply_devtools_overrides, bool* out_param_cookies_enabled) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_BEGIN1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::RestrictedCookieManager::kCookiesEnabledFor), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_END1(
    "mojom", "Call network::mojom::RestrictedCookieManager::CookiesEnabledFor (sync)", "sync_response_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
...
void RestrictedCookieManagerProxy::CookiesEnabledFor(
    const ::blink::KURL& in_url, ::network::mojom::blink::SiteForCookiesPtr in_site_for_cookies, const ::scoped_refptr<const ::blink::SecurityOrigin>& in_top_frame_origin, ::network::mojom::blink::StorageAccessApiStatus in_storage_access_api_status, bool in_apply_devtools_overrides, CookiesEnabledForCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
class RestrictedCookieManager_GetAllForUrl_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::blink::Vector<::network::mojom::blink::CookieWithAccessResultPtr> in_cookies);
};
...
bool RestrictedCookieManager_GetAllForUrl_ForwardToCallback::Accept(
  ...
  bool success = true;
  ::blink::Vector<::network::mojom::blink::CookieWithAccessResultPtr> p_cookies{};
...
class RestrictedCookieManager_GetCookiesString_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      uint64_t in_version, ::mojo_base::mojom::blink::ReadOnlySharedMemoryRegionPtr in_version_buffer, const ::blink::String& in_cookies);
};
...
bool RestrictedCookieManager_GetCookiesString_ForwardToCallback::Accept(
  ...
  bool success = true;
  uint64_t p_version{};
  ::mojo_base::mojom::blink::ReadOnlySharedMemoryRegionPtr p_version_buffer{};
  ::blink::String p_cookies{};
  ...
  switch (static_cast<messages::RestrictedCookieManager>(message->header()->name)) {
    ...
    case messages::RestrictedCookieManager::kSetCookieFromString: {
      ...
      internal::RestrictedCookieManager_SetCookieFromString_Params_Data* params =
          reinterpret_cast<internal::RestrictedCookieManager_SetCookieFromString_Params_Data*>(
              message->mutable_payload());
      ...
      bool success = true;
      ::blink::KURL p_url{};
      ::network::mojom::blink::SiteForCookiesPtr p_site_for_cookies{};
      ::scoped_refptr<const ::blink::SecurityOrigin> p_top_frame_origin{};
      ::network::mojom::blink::StorageAccessApiStatus p_storage_access_api_status{};
      bool p_is_ad_tagged{};
      bool p_apply_devtools_overrides{};
      ::blink::String p_cookie{};
...
bool RestrictedCookieManagerStubDispatch::AcceptWithResponder(
  ...
  switch (static_cast<messages::RestrictedCookieManager>(message->header()->name)) {
    ...
    case messages::RestrictedCookieManager::kSetCanonicalCookie: {
      ...
      // Validation for RestrictedCookieManager.1
      bool success = true;
      RestrictedCanonicalCookieParamsPtr p_canonical_cookie_params{};
      ::blink::KURL p_url{};
      ::network::mojom::blink::SiteForCookiesPtr p_site_for_cookies{};
      ::scoped_refptr<const ::blink::SecurityOrigin> p_top_frame_origin{};
      ::network::mojom::blink::StorageAccessApiStatus p_storage_access_api_status{};
      ...
      if (success && !input_data_view.ReadCanonicalCookieParams(&p_canonical_cookie_params))
        success = false;
      if (success && !input_data_view.ReadUrl(&p_url))
        success = false;
      if (success && !input_data_view.ReadSiteForCookies(&p_site_for_cookies))
      ...
      impl->SetCanonicalCookie(        
        std::move(p_canonical_cookie_params), 
        std::move(p_url), 
        std::move(p_site_for_cookies), 
        std::move(p_top_frame_origin), 
        std::move(p_storage_access_api_status), 
...
bool RestrictedCookieManagerRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::blink::RestrictedCookieManager::Name_,
...
// static
bool StructTraits<::network::mojom::blink::RestrictedCanonicalCookieParams::DataView, ::network::mojom::blink::RestrictedCanonicalCookieParamsPtr>::Read(
    ::network::mojom::blink::RestrictedCanonicalCookieParams::DataView input,
    ::network::mojom::blink::RestrictedCanonicalCookieParamsPtr* output) {
  bool success = true;
  ::network::mojom::blink::RestrictedCanonicalCookieParamsPtr result(::network::mojom::blink::RestrictedCanonicalCookieParams::New());
      ...
      if (success && !input.ReadPriority(&result->priority))
        success = false;
      if (success && !input.ReadPartitioned(&result->partitioned))
        success = false;
  *output = std::move(result);
  return success;
}
...
void RestrictedCookieManagerInterceptorForTesting::GetAllForUrl(const ::blink::KURL& url, ::network::mojom::blink::SiteForCookiesPtr site_for_cookies, const ::scoped_refptr<const ::blink::SecurityOrigin>& top_frame_origin, ::network::mojom::blink::StorageAccessApiStatus storage_access_api_status, CookieManagerGetOptionsPtr options, bool is_ad_tagged, bool apply_devtools_overrides, bool force_disable_third_party_cookies, GetAllForUrlCallback callback) {
...
void RestrictedCookieManagerInterceptorForTesting::SetCanonicalCookie(RestrictedCanonicalCookieParamsPtr canonical_cookie_params, const ::blink::KURL& url, ::network::mojom::blink::SiteForCookiesPtr site_for_cookies, const ::scoped_refptr<const ::blink::SecurityOrigin>& top_frame_origin, ::network::mojom::blink::StorageAccessApiStatus storage_access_api_status, bool is_ad_tagged, bool apply_devtools_overrides, SetCanonicalCookieCallback callback) {
  GetForwardingInterface()->SetCanonicalCookie(
    std::move(canonical_cookie_params)
    , 
    std::move(url)
    , 
    std::move(site_for_cookies)
...
void RestrictedCookieManagerInterceptorForTesting::AddChangeListener(const ::blink::KURL& url, ::network::mojom::blink::SiteForCookiesPtr site_for_cookies, const ::scoped_refptr<const ::blink::SecurityOrigin>& top_frame_origin, ::network::mojom::blink::StorageAccessApiStatus storage_access_api_status, ::mojo::PendingRemote<::network::mojom::blink::CookieChangeListener> listener, AddChangeListenerCallback callback) {
...
void RestrictedCookieManagerInterceptorForTesting::SetCookieFromString(const ::blink::KURL& url, ::network::mojom::blink::SiteForCookiesPtr site_for_cookies, const ::scoped_refptr<const ::blink::SecurityOrigin>& top_frame_origin, ::network::mojom::blink::StorageAccessApiStatus storage_access_api_status, bool is_ad_tagged, bool apply_devtools_overrides, const ::blink::String& cookie) {
...
void RestrictedCookieManagerInterceptorForTesting::GetCookiesString(const ::blink::KURL& url, ::network::mojom::blink::SiteForCookiesPtr site_for_cookies, const ::scoped_refptr<const ::blink::SecurityOrigin>& top_frame_origin, ::network::mojom::blink::StorageAccessApiStatus storage_access_api_status, bool get_version_shared_memory, bool is_ad_tagged, bool apply_devtools_overrides, bool force_disable_third_party_cookies, GetCookiesStringCallback callback) {
...
void RestrictedCookieManagerInterceptorForTesting::CookiesEnabledFor(const ::blink::KURL& url, ::network::mojom::blink::SiteForCookiesPtr site_for_cookies, const ::scoped_refptr<const ::blink::SecurityOrigin>& top_frame_origin, ::network::mojom::blink::StorageAccessApiStatus storage_access_api_status, bool apply_devtools_overrides, CookiesEnabledForCallback callback) {
...
void RestrictedCookieManagerAsyncWaiter::GetAllForUrl(
  ...
  proxy_->GetAllForUrl(
      ...
      base::BindOnce(
          [](base::RunLoop* loop,
             ::blink::Vector<::network::mojom::blink::CookieWithAccessResultPtr>* out_cookies
,
             ::blink::Vector<::network::mojom::blink::CookieWithAccessResultPtr> cookies) {*out_cookies = std::move(cookies);
            loop->Quit();
          },
          &loop,
          out_cookies));
...
::blink::Vector<::network::mojom::blink::CookieWithAccessResultPtr> RestrictedCookieManagerAsyncWaiter::GetAllForUrl(
    const ::blink::KURL& url, ::network::mojom::blink::SiteForCookiesPtr site_for_cookies, const ::scoped_refptr<const ::blink::SecurityOrigin>& top_frame_origin, ::network::mojom::blink::StorageAccessApiStatus storage_access_api_status, CookieManagerGetOptionsPtr options, bool is_ad_tagged, bool apply_devtools_overrides, bool force_disable_third_party_cookies) {
  ::blink::Vector<::network::mojom::blink::CookieWithAccessResultPtr> async_wait_result;
...
bool RestrictedCookieManagerAsyncWaiter::SetCanonicalCookie(
  ...
  SetCanonicalCookie(std::move(canonical_cookie_params),std::move(url),std::move(site_for_cookies),std::move(top_frame_origin),std::move(storage_access_api_status),std::move(is_ad_tagged),std::move(apply_devtools_overrides),&async_wait_result);
  return async_wait_result;
}
...
,
             ::mojo_base::mojom::blink::ReadOnlySharedMemoryRegionPtr* out_version_buffer
,
             ::blink::String* out_cookies
,
             uint64_t version,
             ::mojo_base::mojom::blink::ReadOnlySharedMemoryRegionPtr version_buffer,
             const ::blink::String& cookies) {*out_version = std::move(version);*out_version_buffer = std::move(version_buffer);*out_cookies = std::move(cookies);
            loop->Quit();
          },
          &loop,
          out_version,
...
bool RestrictedCookieManagerAsyncWaiter::CookiesEnabledFor(
    const ::blink::KURL& url, ::network::mojom::blink::SiteForCookiesPtr site_for_cookies, const ::scoped_refptr<const ::blink::SecurityOrigin>& top_frame_origin, ::network::mojom::blink::StorageAccessApiStatus storage_access_api_status, bool apply_devtools_overrides) {
  bool async_wait_result;
