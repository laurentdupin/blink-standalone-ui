 ...
 public:
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ParsedRequestCookie::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ParsedRequestCookie::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::ParsedRequestCookie::DataView,
                                         ::network::mojom::blink::ParsedRequestCookiePtr> {
  static bool IsNull(const ::network::mojom::blink::ParsedRequestCookiePtr& input) { return !input; }
  static void SetToNull(::network::mojom::blink::ParsedRequestCookiePtr* output) { output->reset(); }

  static const decltype(::network::mojom::blink::ParsedRequestCookie::name)& name(
      const ::network::mojom::blink::ParsedRequestCookiePtr& input) {
    return input->name;
  }

  static const decltype(::network::mojom::blink::ParsedRequestCookie::value)& value(
      const ::network::mojom::blink::ParsedRequestCookiePtr& input) {
    return input->value;
  }
