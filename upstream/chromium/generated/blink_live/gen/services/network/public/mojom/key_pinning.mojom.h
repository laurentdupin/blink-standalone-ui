 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        PinSetInfo::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
class  PinSet {
 public:
  ...
  PinSet(
      ...
      std::vector<::network::mojom::SHA256HashValuePtr> static_spki_hashes,
      std::vector<::network::mojom::SHA256HashValuePtr> bad_static_spki_hashes);
...
PinSet& operator=(const PinSet&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        PinSet::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
PinList& operator=(const PinList&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        PinList::DataView, std::vector<uint8_t>, send_validation>(input);
  }
