...
bool NetworkQualityEstimatorManagerClient_OnNetworkQualityChanged_Params_Data::Validate(
  ...
  [[maybe_unused]] const NetworkQualityEstimatorManagerClient_OnNetworkQualityChanged_Params_Data* object =
      static_cast<const NetworkQualityEstimatorManagerClient_OnNetworkQualityChanged_Params_Data*>(data);
...
bool NetworkQualityEstimatorManager_RequestNotifications_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const NetworkQualityEstimatorManager_RequestNotifications_Params_Data* object =
      static_cast<const NetworkQualityEstimatorManager_RequestNotifications_Params_Data*>(data);
