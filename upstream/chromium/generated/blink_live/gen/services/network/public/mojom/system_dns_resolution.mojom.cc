// services/network/public/mojom/system_dns_resolution.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "services/network/public/mojom/system_dns_resolution.mojom-test-utils.h"
...
void SystemDnsResolverProxy::Resolve(
    const std::optional<std::string>& in_hostname, ::network::mojom::AddressFamily in_addr_family, int32_t in_flags, uint64_t in_network, ResolveCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("addr_family"), in_addr_family,
                        "<value of type ::network::mojom::AddressFamily>");
      perfetto::WriteIntoTracedValueWithFallback(
  ...
  mojo::Message message(
      std::to_underlying(messages::SystemDnsResolver::kResolve), kFlags, estimated_payload_size);
...
bool SystemDnsResolverStubDispatch::AcceptWithResponder(
  ...
  switch (static_cast<messages::SystemDnsResolver>(message->header()->name)) {
    case messages::SystemDnsResolver::kResolve: {
      ...
      ::network::mojom::AddressFamily p_addr_family{};
      int32_t p_flags{};
      uint64_t p_network{};
...
bool SystemDnsResolverRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::SystemDnsResolver::Name_,
...
void SystemDnsResolverInterceptorForTesting::Resolve(const std::optional<std::string>& hostname, ::network::mojom::AddressFamily addr_family, int32_t flags, uint64_t network, ResolveCallback callback) {
...
void SystemDnsResolverAsyncWaiter::Resolve(
    const std::optional<std::string>& hostname, ::network::mojom::AddressFamily addr_family, int32_t flags, uint64_t network, ::network::mojom::AddressListPtr* out_addr_list, int32_t* out_os_error, int32_t* out_net_error) {
  base::RunLoop loop;
  proxy_->Resolve(
      std::move(hostname),
      std::move(addr_family),
