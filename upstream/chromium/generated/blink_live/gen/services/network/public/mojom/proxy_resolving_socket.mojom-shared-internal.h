// services/network/public/mojom/proxy_resolving_socket.mojom-shared-internal.h is auto generated by mojom_bindings_generator.py, do not edit
...
class  ProxyResolvingSocketOptions_Data {
 ...
 private:
  friend class mojo::internal::MessageFragment<ProxyResolvingSocketOptions_Data>;
...
struct ProxyResolvingSocketOptions_UnserializedMessageContext
 ...
 private:
  ...
  void Serialize(mojo::Message& message) override {
    mojo::internal::MessageFragment<ProxyResolvingSocketOptions_Data> fragment(message);
