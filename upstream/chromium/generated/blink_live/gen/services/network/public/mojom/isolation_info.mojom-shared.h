...
#include "services/network/public/mojom/isolation_info.mojom-data-view.h"  // IWYU pragma: export
...
struct Serializer<::network::mojom::IsolationInfoRequestType, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::network::mojom::IsolationInfoRequestType>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::network::mojom::IsolationInfoRequestType, UserType> ||
                        HasInfallibleConversion(::network::mojom::IsolationInfoRequestType()),
                    "::network::mojom::IsolationInfoRequestType does not have an infallible conversion, "
...
struct Serializer<::network::mojom::IsolationInfoFrameAncestorRelation, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::network::mojom::IsolationInfoFrameAncestorRelation>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::network::mojom::IsolationInfoFrameAncestorRelation, UserType> ||
                        HasInfallibleConversion(::network::mojom::IsolationInfoFrameAncestorRelation()),
                    "::network::mojom::IsolationInfoFrameAncestorRelation does not have an infallible conversion, "
                    "use an optional return type.");
      *output = Traits::FromMojom(known_value);
      return true;
    } else {
