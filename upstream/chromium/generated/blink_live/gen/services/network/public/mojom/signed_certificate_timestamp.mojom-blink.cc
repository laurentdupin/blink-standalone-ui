// services/network/public/mojom/signed_certificate_timestamp.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "services/network/public/mojom/signed_certificate_timestamp.mojom-blink-test-utils.h"
...
// static
bool StructTraits<::network::mojom::blink::SignedCertificateTimestamp::DataView, ::network::mojom::blink::SignedCertificateTimestampPtr>::Read(
    ::network::mojom::blink::SignedCertificateTimestamp::DataView input,
    ::network::mojom::blink::SignedCertificateTimestampPtr* output) {
  bool success = true;
  ::network::mojom::blink::SignedCertificateTimestampPtr result(::network::mojom::blink::SignedCertificateTimestamp::New());
