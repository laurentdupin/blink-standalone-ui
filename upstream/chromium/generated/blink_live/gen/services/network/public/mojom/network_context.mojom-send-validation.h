...
struct SendValidationSerializer<::network::mojom::NetworkContextParamsDataView, MaybeConstUserType, send_validation> {
  ...
  static void Serialize(
    ...
    fragment.Allocate();
      ...
      mojo::internal::Serialize<::variations::mojom::VariationsHeadersDataView, send_validation>(
...
struct SendValidationSerializer<::network::mojom::URLLoaderFactoryParamsDataView, MaybeConstUserType, send_validation> {
  ...
  static void Serialize(
    ...
    fragment.Allocate();
      ...
      mojo::internal::Serialize<::network::mojom::OriginatingProcessIdDataView, send_validation>(
        in_process_id,
        process_id_fragment,
        true);
...
template <typename MaybeConstUserType, mojo::internal::SendValidation send_validation>
struct SendValidationSerializer<::network::mojom::IdAndAllowlistedPatternsDataView, MaybeConstUserType, send_validation> {
  using UserType = typename std::remove_const<MaybeConstUserType>::type;
