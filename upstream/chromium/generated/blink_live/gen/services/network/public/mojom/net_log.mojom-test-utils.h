...
class  NetLogExporterInterceptorForTesting : public NetLogExporter {
  ...
  void Start(::mojo_base::mojom::FilePtr destination, ::mojo_base::mojom::DictionaryValuePtr extra_constants, NetLogCaptureMode capture_mode, uint64_t max_file_size, StartCallback callback) override;
  void Stop(::mojo_base::mojom::DictionaryValuePtr polled_values, StopCallback callback) override;
};
class  NetLogExporterAsyncWaiter {
 public:
  ...
  int32_t Start(::mojo_base::mojom::FilePtr destination, ::mojo_base::mojom::DictionaryValuePtr extra_constants, NetLogCaptureMode capture_mode, uint64_t max_file_size);
  void Stop(
      ::mojo_base::mojom::DictionaryValuePtr polled_values, int32_t* out_net_error);
  int32_t Stop(::mojo_base::mojom::DictionaryValuePtr polled_values);
...
class  NetLogProxySinkInterceptorForTesting : public NetLogProxySink {
  ...
  void AddEntry(uint32_t type, ::network::mojom::NetLogSourcePtr net_log_source, NetLogEventPhase phase, ::base::TimeTicks time, ::mojo_base::mojom::DictionaryValuePtr params) override;
};
