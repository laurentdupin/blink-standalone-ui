// services/network/public/mojom/http_raw_headers.mojom-shared.cc is auto generated by mojom_bindings_generator.py, do not edit
...
// static
bool HttpRawHeaderPair_Data::Validate(
    const void* data,
  ...
  [[maybe_unused]] const HttpRawHeaderPair_Data* object =
      static_cast<const HttpRawHeaderPair_Data*>(data);
...
HttpRawHeaderPair_Data::HttpRawHeaderPair_Data()
