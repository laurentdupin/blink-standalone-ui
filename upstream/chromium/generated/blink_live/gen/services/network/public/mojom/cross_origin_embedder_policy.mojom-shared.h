...
#include "services/network/public/mojom/cross_origin_embedder_policy.mojom-data-view.h"  // IWYU pragma: export
...
struct Serializer<::network::mojom::CrossOriginEmbedderPolicyValue, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::network::mojom::CrossOriginEmbedderPolicyValue>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::network::mojom::CrossOriginEmbedderPolicyValue, UserType> ||
                        HasInfallibleConversion(::network::mojom::CrossOriginEmbedderPolicyValue()),
                    "::network::mojom::CrossOriginEmbedderPolicyValue does not have an infallible conversion, "
