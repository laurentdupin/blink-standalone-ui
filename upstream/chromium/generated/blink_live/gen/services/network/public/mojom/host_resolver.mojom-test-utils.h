...
class  ResolveHostClientInterceptorForTesting : public ResolveHostClient {
  ...
  void OnComplete(int32_t result, ::network::mojom::ResolveErrorInfoPtr resolve_error_info, ::network::mojom::AddressListPtr resolved_addresses, std::vector<::network::mojom::HostResolverEndpointResultPtr> alternative_endpoints) override;
  void OnTextResults(const std::vector<std::string>& text_results) override;
  void OnHostnameResults(std::vector<::network::mojom::HostPortPairPtr> hosts) override;
};
...
class  MdnsListenClientInterceptorForTesting : public MdnsListenClient {
  ...
  void OnAddressResult(MdnsListenClient::UpdateType update_type, DnsQueryType query_type, ::network::mojom::IPEndPointPtr endpoint) override;
  void OnTextResult(MdnsListenClient::UpdateType update_type, DnsQueryType query_type, const std::vector<std::string>& text_records) override;
  void OnHostnameResult(MdnsListenClient::UpdateType update_type, DnsQueryType query_type, ::network::mojom::HostPortPairPtr host) override;
...
class  HostResolverInterceptorForTesting : public HostResolver {
  ...
  void ResolveHost(HostResolverHostPtr host, ::network::mojom::NetworkAnonymizationKeyPtr network_anonymization_key, ResolveHostParametersPtr optional_parameters, ::mojo::PendingRemote<ResolveHostClient> response_client) override;
  void MdnsListen(::network::mojom::HostPortPairPtr host, DnsQueryType query_type, ::mojo::PendingRemote<MdnsListenClient> response_client, MdnsListenCallback callback) override;
};
class  HostResolverAsyncWaiter {
 public:
  ...
  int32_t MdnsListen(::network::mojom::HostPortPairPtr host, DnsQueryType query_type, ::mojo::PendingRemote<MdnsListenClient> response_client);
