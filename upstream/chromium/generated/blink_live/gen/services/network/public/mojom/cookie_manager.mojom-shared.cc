...
NOINLINE static const char* CookieExemptionReasonToStringHelper(CookieExemptionReason value) {
  ...
  switch(value) {
    ...
    case CookieExemptionReason::kScheme:
      return "kScheme";
    case CookieExemptionReason::kSameSiteNoneCookiesInSandbox:
      return "kSameSiteNoneCookiesInSandbox";
    default:
      return nullptr;
  }
}
...
NOINLINE static const char* CookieScopeSemanticsToStringHelper(CookieScopeSemantics value) {
  // Defined in a helper function to ensure that Clang generates a lookup table.
  switch(value) {
    case CookieScopeSemantics::UNKNOWN:
      return "UNKNOWN";
    case CookieScopeSemantics::NONLEGACY:
      return "NONLEGACY";
    case CookieScopeSemantics::LEGACY:
      return "LEGACY";
    default:
      return nullptr;
  }
...
std::string CookieScopeSemanticsToString(CookieScopeSemantics value) {
  const char *str = CookieScopeSemanticsToStringHelper(value);
  if (!str) {
    return base::StringPrintf("Unknown CookieScopeSemantics value: %i", static_cast<int32_t>(value));
  }
  return str;
}

std::ostream& operator<<(std::ostream& os, CookieScopeSemantics value) {
  return os << CookieScopeSemanticsToString(value);
}
...
bool CookieOrLine_Data::Validate(
  ...
  switch (object->tag) {
    ...
    case CookieOrLine_Tag::kCookieString: {
      ...
      constexpr const mojo::internal::ContainerValidateParams& cookie_string_validate_params =
...
bool CookieManagerParams_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->content_settings, 2, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->secure_origin_cookies_allowed_origins, 4, validation_context)) {
    return false;
  }
  constexpr const mojo::internal::ContainerValidateParams& secure_origin_cookies_allowed_origins_validate_params =
      mojo::internal::GetArrayValidator<0, false, nullptr>();
  if (!mojo::internal::ValidateContainer(object->secure_origin_cookies_allowed_origins, validation_context,
                                         &secure_origin_cookies_allowed_origins_validate_params)) {
    return false;
  }

  if (!mojo::internal::ValidatePointerNonNullable(
          object->matching_scheme_cookies_allowed_schemes, 5, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->third_party_cookies_allowed_schemes, 6, validation_context)) {
    return false;
  }
...
bool CanonicalCookie_Data::Validate(
  ...
  if (!::network::mojom::internal::CookieSourceType_Data
...
// static
bool ExclusionReasons_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const ExclusionReasons_Data* object =
      static_cast<const ExclusionReasons_Data*>(data);

  return true;
}

ExclusionReasons_Data::ExclusionReasons_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool WarningReasons_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const WarningReasons_Data* object =
      static_cast<const WarningReasons_Data*>(data);

  return true;
}

WarningReasons_Data::WarningReasons_Data()
    : header_({sizeof(*this), 0}) {}
...
bool CookieInclusionStatus_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->exclusion_reasons, 1, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateStruct(object->exclusion_reasons, validation_context))
    return false;

  if (!mojo::internal::ValidatePointerNonNullable(
          object->warning_reasons, 2, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateStruct(object->warning_reasons, validation_context))
    return false;


  if (!::network::mojom::internal::CookieExemptionReason_Data
        ::Validate(object->exemption_reason, validation_context))
    return false;
...
bool CookieAccessResult_Data::Validate(
  ...
  if (!::network::mojom::internal::CookieScopeSemantics_Data
        ::Validate(object->scope_semantics, validation_context))
    return false;
...
bool CookieDeletionFilter_Data::Validate(
  ...
  constexpr const mojo::internal::ContainerValidateParams& cookie_name_validate_params =
      mojo::internal::GetArrayValidator<0, false, nullptr>();
...
bool CookieManager_SetContentSettings_Params_Data::Validate(
  ...
  if (!::content_settings::mojom::internal::ContentSettingsType_Data
        ::Validate(object->content_settings_type, validation_context))
    return false;
...
// static
void TraceFormatTraits<::network::mojom::CookieScopeSemantics>::WriteIntoTrace(
   perfetto::TracedValue context, ::network::mojom::CookieScopeSemantics value) {
  return std::move(context).WriteString(::network::mojom::CookieScopeSemanticsToString(value));
}
