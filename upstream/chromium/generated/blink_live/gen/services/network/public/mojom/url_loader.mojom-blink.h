...
class URLLoader
 ...
 public:
  ...
  static constexpr const char* Name_ = "network.mojom.URLLoader";
...
// with not having this data in traces there.
  ...
  virtual void FollowRedirect(::network::mojom::blink::HttpRequestHeadersUpdateParamsPtr headers_update_params, const std::optional<::blink::KURL>& new_url) = 0;

  virtual void SetPriority(::network::mojom::blink::RequestPriority priority, int32_t intra_priority_value) = 0;
};
...
class URLLoaderClient
 ...
 public:
  using IPCStableHashFunction = uint32_t(*)();
  static constexpr const char* Name_ = "network.mojom.URLLoaderClient";
  static IPCStableHashFunction MessageToMethodInfo_(mojo::Message& message);
  static const char* MessageToMethodName_(mojo::Message& message);
  static constexpr uint32_t Version_ = 0;
  static constexpr bool PassesAssociatedKinds_ = false;
...
// with not having this data in traces there.
  ...
  virtual void OnReceiveRedirect(const ::net::RedirectInfo& redirect_info, ::network::mojom::blink::URLResponseHeadPtr head) = 0;

  using OnUploadProgressCallback = base::OnceCallback<void()>;
  using OnUploadProgressMojoCallback = base::OnceCallback<void()>;
...
class  URLLoaderProxy
 ...
 public:
  ...
  void FollowRedirect(::network::mojom::blink::HttpRequestHeadersUpdateParamsPtr headers_update_params, const std::optional<::blink::KURL>& new_url) final;
  
  void SetPriority(::network::mojom::blink::RequestPriority priority, int32_t intra_priority_value) final;
...
class  URLLoaderClientProxy
 ...
 public:
  ...
  void OnReceiveRedirect(const ::net::RedirectInfo& redirect_info, ::network::mojom::blink::URLResponseHeadPtr head) final;
...
template <>
struct  StructTraits<::network::mojom::blink::URLLoaderClientEndpoints::DataView,
