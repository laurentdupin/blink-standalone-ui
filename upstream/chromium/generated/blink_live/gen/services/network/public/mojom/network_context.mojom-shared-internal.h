...
class MatchedNetworkConditions_Data;
...
class IdAndAllowlistedPatterns_Data;
...
static_assert(sizeof(CertVerifierServiceRemoteParams_Data) == 24,
...
class  NetworkContextFilePaths_Data {
 public:
  ...
  ::network::mojom::internal::TransferableDirectory_Data no_vary_search_directory;
...
static_assert(sizeof(NetworkContextFilePaths_Data) == 144,
...
class  NetworkContextParams_Data {
 public:
  ...
  uint8_t quic_idle_connection_timeout_seconds_$flag : 1;
  uint8_t enable_encrypted_http_cache : 1;
  uint8_t pad23_[1];
  ...
  mojo::internal::Interface_Data encryption_provider;
  ...
  mojo::internal::Pointer<mojo::internal::Array_Data<mojo::internal::Pointer<::network::mojom::internal::SchemefulSite_Data>>> device_bound_sessions_restricted_sites;
  int64_t bound_network;
  int64_t quic_idle_connection_timeout_seconds_$value;
  mojo::internal::Interface_Data bound_sessions_unexportable_key_service;
  mojo::internal::Pointer<::variations::mojom::internal::VariationsHeaders_Data> initial_variations_headers;
...
class  NetworkConditions_Data {
 public:
  ...
  double packet_loss;
  mojo::internal::Pointer<::mojo_base::mojom::internal::UnguessableToken_Data> rule_id;
...
static_assert(sizeof(NetworkConditions_Data) == 56,
...
class  MatchedNetworkConditions_Data {
 public:
  ...
  mojo::internal::StructHeader header_;
  mojo::internal::Pointer<mojo::internal::String_Data> pattern;
  mojo::internal::Pointer<internal::NetworkConditions_Data> conditions;

 private:
  friend class mojo::internal::MessageFragment<MatchedNetworkConditions_Data>;

  MatchedNetworkConditions_Data();
  ~MatchedNetworkConditions_Data() = delete;
};
static_assert(sizeof(MatchedNetworkConditions_Data) == 24,
              "Bad sizeof(MatchedNetworkConditions_Data)");
// Used by MatchedNetworkConditions::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView>
struct MatchedNetworkConditions_UnserializedMessageContext
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  MatchedNetworkConditions_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
      , user_data_(std::move(input)) {}
  ~MatchedNetworkConditions_UnserializedMessageContext() override = default;
 ...
 private:
  // mojo::internal::UnserializedMessageContext:
  void Serialize(mojo::Message& message) override {
    mojo::internal::MessageFragment<MatchedNetworkConditions_Data> fragment(message);
    mojo::internal::Serialize<DataView>(user_data_, fragment);
  }
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag
    MatchedNetworkConditions_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
class  SharedDictionaryInfo_Data {
 public:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
...
static_assert(sizeof(SharedDictionaryInfo_Data) == 88,
...
struct SharedDictionaryInfo_UnserializedMessageContext
 ...
 public:
  ...
  SharedDictionaryInfo_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
...
class  URLLoaderFactoryParams_Data {
 public:
  ...
  uint8_t ignore_factory_reset : 1;
  uint8_t is_main_frame_origin_recently_accessed : 1;
  uint8_t prefer_factory_site_for_cookies : 1;
  uint8_t pad12_[2];
  ...
  mojo::internal::Interface_Data dip_reporter;
  ...
  mojo::internal::Interface_Data device_bound_session_observer;
...
static_assert(sizeof(URLLoaderFactoryParams_Data) == 184,
...
class  IdAndAllowlistedPatterns_Data {
 public:
  ...
  mojo::internal::StructHeader header_;
  mojo::internal::Pointer<::mojo_base::mojom::internal::UnguessableToken_Data> network_restrictions_id;
  mojo::internal::Pointer<::network::mojom::internal::ConnectionAllowlists_Data> allowlists;

 private:
  friend class mojo::internal::MessageFragment<IdAndAllowlistedPatterns_Data>;

  IdAndAllowlistedPatterns_Data();
  ~IdAndAllowlistedPatterns_Data() = delete;
};
static_assert(sizeof(IdAndAllowlistedPatterns_Data) == 24,
              "Bad sizeof(IdAndAllowlistedPatterns_Data)");
// Used by IdAndAllowlistedPatterns::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView>
struct IdAndAllowlistedPatterns_UnserializedMessageContext
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  IdAndAllowlistedPatterns_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
      , user_data_(std::move(input)) {}
  ~IdAndAllowlistedPatterns_UnserializedMessageContext() override = default;
 ...
 private:
  // mojo::internal::UnserializedMessageContext:
  void Serialize(mojo::Message& message) override {
    mojo::internal::MessageFragment<IdAndAllowlistedPatterns_Data> fragment(message);
    mojo::internal::Serialize<DataView>(user_data_, fragment);
  }
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag
    IdAndAllowlistedPatterns_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
