...
EnabledClientHints::EnabledClientHints(
    ...
    ::blink::Vector<::network::mojom::blink::WebClientHintsType> not_allowed_hints_in)
...
TrustedUrlRequestParams::TrustedUrlRequestParams(
    ::network::mojom::blink::IsolationInfoPtr isolation_info_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::network::mojom::blink::IsolationInfoPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
URLRequest::URLRequest(
    ...
    ::network::mojom::blink::HttpRequestHeadersPtr headers_in,
    ::network::mojom::blink::HttpRequestHeadersPtr cors_exempt_headers_in,
    ...
    std::optional<::blink::Vector<::network::mojom::blink::SourceType>> devtools_accepted_stream_types_in,
    ...
    ::network::mojom::blink::StorageAccessApiStatus storage_access_api_status_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type const std::optional<::blink::Vector<::network::mojom::blink::SourceType>>&>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
