...
void WebTransportHandshakeClientProxy::OnBeforeConnect(
    ::network::mojom::blink::IPEndPointPtr in_server_address) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void WebTransportHandshakeClientProxy::OnConnectionEstablished(
    ::mojo::PendingRemote<WebTransport> in_transport, ::mojo::PendingReceiver<WebTransportClient> in_client, const ::scoped_refptr<::net::HttpResponseHeaders>& in_response_headers, const ::blink::String& in_selected_application_protocol, WebTransportStatsPtr in_initial_stats) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool WebTransportHandshakeClientStubDispatch::Accept(
  ...
  switch (static_cast<messages::WebTransportHandshakeClient>(message->header()->name)) {
    case messages::WebTransportHandshakeClient::kOnBeforeConnect: {
      ...
      bool success = true;
      ::network::mojom::blink::IPEndPointPtr p_server_address{};
