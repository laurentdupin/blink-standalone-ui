...
bool ProxyResolvingSocketOptions_Data::Validate(
  ...
  [[maybe_unused]] const ProxyResolvingSocketOptions_Data* object =
      static_cast<const ProxyResolvingSocketOptions_Data*>(data);
...
bool ProxyResolvingSocket_UpgradeToTLS_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const ProxyResolvingSocket_UpgradeToTLS_Params_Data* object =
      static_cast<const ProxyResolvingSocket_UpgradeToTLS_Params_Data*>(data);
