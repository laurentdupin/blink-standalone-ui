// services/network/public/mojom/ssl_info.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "services/network/public/mojom/ssl_info.mojom-test-utils.h"
...
SSLInfo::SSLInfo(
    ...
    ::net::SSLInfo::HandshakeType handshake_type_in,
    std::vector<::net::SHA256HashValue> public_key_hashes_in,
    std::vector<::net::SignedCertificateTimestampAndStatus> signed_certificate_timestamps_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::net::SSLInfo::HandshakeType>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
// static
bool StructTraits<::network::mojom::SSLInfo::DataView, ::network::mojom::SSLInfoPtr>::Read(
    ::network::mojom::SSLInfo::DataView input,
    ::network::mojom::SSLInfoPtr* output) {
  bool success = true;
  ::network::mojom::SSLInfoPtr result(::network::mojom::SSLInfo::New());
