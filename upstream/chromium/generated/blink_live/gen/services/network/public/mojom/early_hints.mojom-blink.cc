...
EarlyHints::EarlyHints(
    ::network::mojom::blink::ParsedHeadersPtr headers_in,
...
void EarlyHints::WriteIntoTrace(
...
bool StructTraits<::network::mojom::blink::EarlyHints::DataView, ::network::mojom::blink::EarlyHintsPtr>::Read(
    ::network::mojom::blink::EarlyHints::DataView input,
    ::network::mojom::blink::EarlyHintsPtr* output) {
  bool success = true;
