...
CSPSourceList::CSPSourceList(
    ...
    std::vector<::network::mojom::IntegrityMetadataPtr> hashes_in,
    std::vector<::network::mojom::IntegrityMetadataPtr> url_hashes_in,
    std::vector<::network::mojom::IntegrityMetadataPtr> eval_hashes_in,
    bool allow_self_in,
    bool allow_star_in,
...
void CSPSourceList::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "hashes"), this->hashes,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<::network::mojom::IntegrityMetadataPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
CSPViolation::CSPViolation(
    ...
    ::url::mojom::UrlPtr blocked_url_in,
    std::vector<std::string> report_endpoints_in,
    bool use_reporting_api_in,
...
void AllowCSPFromHeaderValue::set_origin(::url::mojom::OriginPtr origin) {
  if (tag_ == Tag::kOrigin) {
    data_.origin = std::move(origin);
  } else {
    DestroyActive();
    tag_ = Tag::kOrigin;
    new (&data_.origin) ::url::mojom::OriginPtr(
        std::move(origin));
  }
}
...
bool UnionTraits<::network::mojom::AllowCSPFromHeaderValue::DataView, ::network::mojom::AllowCSPFromHeaderValuePtr>::Read(
  ...
  switch (input.tag()) {
    ...
    case Tag::kOrigin: {
      ::url::mojom::OriginPtr result_origin{};
