...
uint32_t TCPBoundSocket::Listen_Sym::IPCStableHash() {
  ...
  static constexpr uint32_t kHash = 0xd4cc5f6e;  // IPCStableHash for network::mojom::TCPBoundSocket::Listen
...
uint32_t TCPBoundSocket::Connect_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x5381c2c9;  // IPCStableHash for network::mojom::TCPBoundSocket::Connect
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void TCPBoundSocketProxy::Listen(
  ...
  mojo::Message message(
      std::to_underlying(messages::TCPBoundSocket::kListen), kFlags, estimated_payload_size);
...
void TCPBoundSocketProxy::Connect(
    ::network::mojom::AddressListPtr in_remote_addr_list, TCPConnectedSocketOptionsPtr in_tcp_connected_socket_options, ::mojo::PendingReceiver<TCPConnectedSocket> in_socket, ::mojo::PendingRemote<SocketObserver> in_observer, ConnectCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::TCPBoundSocket::kConnect), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
class TCPBoundSocket_Connect_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      int32_t in_net_error, ::network::mojom::IPEndPointPtr in_local_addr, ::network::mojom::IPEndPointPtr in_peer_addr, ::mojo::ScopedDataPipeConsumerHandle in_receive_stream, ::mojo::ScopedDataPipeProducerHandle in_send_stream);
};
...
bool TCPBoundSocket_Connect_ForwardToCallback::Accept(
  ...
  ::network::mojom::IPEndPointPtr p_peer_addr{};
...
bool TCPBoundSocketStubDispatch::AcceptWithResponder(
  ...
  switch (static_cast<messages::TCPBoundSocket>(message->header()->name)) {
    ...
    case messages::TCPBoundSocket::kConnect: {
      ...
      // Validation for TCPBoundSocket.1
      bool success = true;
      ::network::mojom::AddressListPtr p_remote_addr_list{};
...
bool TCPBoundSocketRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::TCPBoundSocket::Name_,
    kTCPBoundSocketValidationInfo);
}
...
uint32_t TCPConnectedSocket::UpgradeToTLS_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x0658d61c;  // IPCStableHash for network::mojom::TCPConnectedSocket::UpgradeToTLS
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t TCPConnectedSocket::SetSendBufferSize_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x73e0021c;  // IPCStableHash for network::mojom::TCPConnectedSocket::SetSendBufferSize
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t TCPConnectedSocket::SetReceiveBufferSize_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xa9bdd631;  // IPCStableHash for network::mojom::TCPConnectedSocket::SetReceiveBufferSize
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t TCPConnectedSocket::SetNoDelay_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xbf8c7304;  // IPCStableHash for network::mojom::TCPConnectedSocket::SetNoDelay
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t TCPConnectedSocket::SetKeepAlive_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x5907eb20;  // IPCStableHash for network::mojom::TCPConnectedSocket::SetKeepAlive
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void TCPConnectedSocketProxy::UpgradeToTLS(
    ::network::mojom::HostPortPairPtr in_host_port_pair, ::network::mojom::TLSClientSocketOptionsPtr in_options, const ::net::MutableNetworkTrafficAnnotationTag& in_traffic_annotation, ::mojo::PendingReceiver<::network::mojom::TLSClientSocket> in_receiver, ::mojo::PendingRemote<SocketObserver> in_observer, UpgradeToTLSCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::TCPConnectedSocket::kUpgradeToTLS), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void TCPConnectedSocketProxy::SetSendBufferSize(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::TCPConnectedSocket::kSetSendBufferSize), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void TCPConnectedSocketProxy::SetReceiveBufferSize(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::TCPConnectedSocket::kSetReceiveBufferSize), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void TCPConnectedSocketProxy::SetNoDelay(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::TCPConnectedSocket::kSetNoDelay), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void TCPConnectedSocketProxy::SetKeepAlive(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::TCPConnectedSocket::kSetKeepAlive), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
class TCPConnectedSocket_UpgradeToTLS_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      int32_t in_net_error, ::mojo::ScopedDataPipeConsumerHandle in_receive_stream, ::mojo::ScopedDataPipeProducerHandle in_send_stream, ::network::mojom::SSLInfoPtr in_ssl_info);
};
...
bool TCPConnectedSocket_UpgradeToTLS_ForwardToCallback::Accept(
  ...
  ::mojo::ScopedDataPipeConsumerHandle p_receive_stream{};
  ::mojo::ScopedDataPipeProducerHandle p_send_stream{};
  ::network::mojom::SSLInfoPtr p_ssl_info{};
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("ssl_info"), in_ssl_info,
                        "<value of type ::network::mojom::SSLInfoPtr>");
   });
#endif
...
bool TCPConnectedSocketStubDispatch::AcceptWithResponder(
  ...
  switch (static_cast<messages::TCPConnectedSocket>(message->header()->name)) {
    case messages::TCPConnectedSocket::kUpgradeToTLS: {
      ...
      // Validation for TCPConnectedSocket.0
      bool success = true;
      ::network::mojom::HostPortPairPtr p_host_port_pair{};
...
bool TCPConnectedSocketRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::TCPConnectedSocket::Name_,
    kTCPConnectedSocketValidationInfo);
}
...
uint32_t SocketObserver::OnReadError_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x7f43a0d7;  // IPCStableHash for network::mojom::SocketObserver::OnReadError
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t SocketObserver::OnWriteError_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x8004a6bf;  // IPCStableHash for network::mojom::SocketObserver::OnWriteError
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void SocketObserverProxy::OnReadError(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::SocketObserver::kOnReadError), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void SocketObserverProxy::OnWriteError(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::SocketObserver::kOnWriteError), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool SocketObserverRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::SocketObserver::Name_,
    kSocketObserverValidationInfo);
}
...
uint32_t TCPServerSocket::Accept_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xd2815b9b;  // IPCStableHash for network::mojom::TCPServerSocket::Accept
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void TCPServerSocketProxy::Accept(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::TCPServerSocket::kAccept), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
class TCPServerSocket_Accept_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      int32_t in_net_error, ::network::mojom::IPEndPointPtr in_remote_addr, ::mojo::PendingRemote<TCPConnectedSocket> in_connected_socket, ::mojo::ScopedDataPipeConsumerHandle in_send_stream, ::mojo::ScopedDataPipeProducerHandle in_receive_stream);
};
...
bool TCPServerSocketRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::TCPServerSocket::Name_,
    kTCPServerSocketValidationInfo);
}
...
void TCPBoundSocketInterceptorForTesting::Connect(::network::mojom::AddressListPtr remote_addr_list, TCPConnectedSocketOptionsPtr tcp_connected_socket_options, ::mojo::PendingReceiver<TCPConnectedSocket> socket, ::mojo::PendingRemote<SocketObserver> observer, ConnectCallback callback) {
...
void TCPBoundSocketAsyncWaiter::Connect(
    ::network::mojom::AddressListPtr remote_addr_list, TCPConnectedSocketOptionsPtr tcp_connected_socket_options, ::mojo::PendingReceiver<TCPConnectedSocket> socket, ::mojo::PendingRemote<SocketObserver> observer, int32_t* out_net_error, ::network::mojom::IPEndPointPtr* out_local_addr, ::network::mojom::IPEndPointPtr* out_peer_addr, ::mojo::ScopedDataPipeConsumerHandle* out_receive_stream, ::mojo::ScopedDataPipeProducerHandle* out_send_stream) {
  base::RunLoop loop;
  proxy_->Connect(
      std::move(remote_addr_list),
      std::move(tcp_connected_socket_options),
      ...
      base::BindOnce(
          [](base::RunLoop* loop,
             int32_t* out_net_error
,
             ::network::mojom::IPEndPointPtr* out_local_addr
,
             ::network::mojom::IPEndPointPtr* out_peer_addr
,
...
,
             int32_t net_error,
             ::network::mojom::IPEndPointPtr local_addr,
             ::network::mojom::IPEndPointPtr peer_addr,
...
void TCPConnectedSocketInterceptorForTesting::UpgradeToTLS(::network::mojom::HostPortPairPtr host_port_pair, ::network::mojom::TLSClientSocketOptionsPtr options, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::mojo::PendingReceiver<::network::mojom::TLSClientSocket> receiver, ::mojo::PendingRemote<SocketObserver> observer, UpgradeToTLSCallback callback) {
...
void TCPConnectedSocketAsyncWaiter::UpgradeToTLS(
    ::network::mojom::HostPortPairPtr host_port_pair, ::network::mojom::TLSClientSocketOptionsPtr options, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation, ::mojo::PendingReceiver<::network::mojom::TLSClientSocket> receiver, ::mojo::PendingRemote<SocketObserver> observer, int32_t* out_net_error, ::mojo::ScopedDataPipeConsumerHandle* out_receive_stream, ::mojo::ScopedDataPipeProducerHandle* out_send_stream, ::network::mojom::SSLInfoPtr* out_ssl_info) {
  base::RunLoop loop;
  proxy_->UpgradeToTLS(
      std::move(host_port_pair),
      std::move(options),
...
,
             ::mojo::ScopedDataPipeProducerHandle* out_send_stream
,
             ::network::mojom::SSLInfoPtr* out_ssl_info
,
             int32_t net_error,
             ::mojo::ScopedDataPipeConsumerHandle receive_stream,
             ::mojo::ScopedDataPipeProducerHandle send_stream,
             ::network::mojom::SSLInfoPtr ssl_info) {*out_net_error = std::move(net_error);*out_receive_stream = std::move(receive_stream);*out_send_stream = std::move(send_stream);*out_ssl_info = std::move(ssl_info);
            loop->Quit();
          },
          &loop,
          out_net_error,
...
void TCPServerSocketAsyncWaiter::Accept(
    ::mojo::PendingRemote<SocketObserver> observer, int32_t* out_net_error, ::network::mojom::IPEndPointPtr* out_remote_addr, ::mojo::PendingRemote<TCPConnectedSocket>* out_connected_socket, ::mojo::ScopedDataPipeConsumerHandle* out_send_stream, ::mojo::ScopedDataPipeProducerHandle* out_receive_stream) {
  base::RunLoop loop;
  proxy_->Accept(
      std::move(observer),
      base::BindOnce(
          [](base::RunLoop* loop,
             int32_t* out_net_error
,
             ::network::mojom::IPEndPointPtr* out_remote_addr
,
...
,
             int32_t net_error,
             ::network::mojom::IPEndPointPtr remote_addr,
