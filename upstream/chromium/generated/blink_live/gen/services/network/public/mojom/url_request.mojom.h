...
#include "services/network/public/mojom/url_request.mojom-forward.h"  // IWYU pragma: export
 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SocketTag::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SocketTag::DataView, std::vector<uint8_t>>(input);
  }
...
class  EnabledClientHints {
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        EnabledClientHints::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        EnabledClientHints::DataView, std::vector<uint8_t>>(input);
  }
...
class  URLRequest {
 public:
  ...
  URLRequest(
      ...
      const ::GURL& url,
      ::network::mojom::SiteForCookiesPtr site_for_cookies,
      ...
      const ::GURL& referrer,
      ::network::mojom::URLRequestReferrerPolicy referrer_policy,
      ::network::mojom::HttpRequestHeadersPtr headers,
      ::network::mojom::HttpRequestHeadersPtr cors_exempt_headers,
      int32_t load_flags,
      ...
      std::optional<std::vector<::network::mojom::SourceType>> devtools_accepted_stream_types,
      ...
      ::network::mojom::FetchRetryOptionsPtr fetch_retry_options);
...
template <>
struct  StructTraits<::network::mojom::EnabledClientHints::DataView,
                                         ::network::mojom::EnabledClientHintsPtr> {
  static bool IsNull(const ::network::mojom::EnabledClientHintsPtr& input) { return !input; }
  static void SetToNull(::network::mojom::EnabledClientHintsPtr* output) { output->reset(); }

  static const decltype(::network::mojom::EnabledClientHints::origin)& origin(
      const ::network::mojom::EnabledClientHintsPtr& input) {
    return input->origin;
  }

  static decltype(::network::mojom::EnabledClientHints::is_outermost_main_frame) is_outermost_main_frame(
      const ::network::mojom::EnabledClientHintsPtr& input) {
    return input->is_outermost_main_frame;
  }

  static const decltype(::network::mojom::EnabledClientHints::hints)& hints(
      const ::network::mojom::EnabledClientHintsPtr& input) {
    return input->hints;
  }

  static const decltype(::network::mojom::EnabledClientHints::not_allowed_hints)& not_allowed_hints(
      const ::network::mojom::EnabledClientHintsPtr& input) {
    return input->not_allowed_hints;
  }

  static bool Read(::network::mojom::EnabledClientHints::DataView input, ::network::mojom::EnabledClientHintsPtr* output);
};
...
struct  StructTraits<::network::mojom::TrustedUrlRequestParams::DataView,
  ...
  static decltype(::network::mojom::TrustedUrlRequestParams::allow_cookies_from_browser) allow_cookies_from_browser(
      const ::network::mojom::TrustedUrlRequestParamsPtr& input) {
    return input->allow_cookies_from_browser;
  }

  static decltype(::network::mojom::TrustedUrlRequestParams::include_request_cookies_with_response) include_request_cookies_with_response(
      const ::network::mojom::TrustedUrlRequestParamsPtr& input) {
    return input->include_request_cookies_with_response;
  }

  static const decltype(::network::mojom::TrustedUrlRequestParams::enabled_client_hints)& enabled_client_hints(
      const ::network::mojom::TrustedUrlRequestParamsPtr& input) {
  ...
  static  decltype(::network::mojom::TrustedUrlRequestParams::trust_token_observer)& trust_token_observer(
       ::network::mojom::TrustedUrlRequestParamsPtr& input) {
  ...
  static  decltype(::network::mojom::TrustedUrlRequestParams::device_bound_session_observer)& device_bound_session_observer(
       ::network::mojom::TrustedUrlRequestParamsPtr& input) {
  ...
  static  decltype(::network::mojom::TrustedUrlRequestParams::shared_dictionary_observer)& shared_dictionary_observer(
       ::network::mojom::TrustedUrlRequestParamsPtr& input) {
    return input->shared_dictionary_observer;
  }

  static  decltype(::network::mojom::TrustedUrlRequestParams::response_body_stream)& response_body_stream(
       ::network::mojom::TrustedUrlRequestParamsPtr& input) {
    return input->response_body_stream;
  }

  static const decltype(::network::mojom::TrustedUrlRequestParams::expected_response_headers_for_synthetic_response)& expected_response_headers_for_synthetic_response(
      const ::network::mojom::TrustedUrlRequestParamsPtr& input) {
    return input->expected_response_headers_for_synthetic_response;
  }

  static decltype(::network::mojom::TrustedUrlRequestParams::is_ad_auction_trusted_signals_request) is_ad_auction_trusted_signals_request(
      const ::network::mojom::TrustedUrlRequestParamsPtr& input) {
...
struct  StructTraits<::network::mojom::URLRequest::DataView,
  ...
  static decltype(::network::mojom::URLRequest::priority_incremental) priority_incremental(
      const ::network::mojom::URLRequestPtr& input) {
  ...
  static const decltype(::network::mojom::URLRequest::expected_public_keys)& expected_public_keys(
      const ::network::mojom::URLRequestPtr& input) {
  ...
  static decltype(::network::mojom::URLRequest::browsing_topics) browsing_topics(
      const ::network::mojom::URLRequestPtr& input) {
    return input->browsing_topics;
  }

  static decltype(::network::mojom::URLRequest::ad_auction_headers) ad_auction_headers(
      const ::network::mojom::URLRequestPtr& input) {
    return input->ad_auction_headers;
  }

  static decltype(::network::mojom::URLRequest::shared_storage_writable_eligible) shared_storage_writable_eligible(
      const ::network::mojom::URLRequestPtr& input) {
  ...
  static decltype(::network::mojom::URLRequest::is_reload_navigation) is_reload_navigation(
      const ::network::mojom::URLRequestPtr& input) {
  ...
  static decltype(::network::mojom::URLRequest::is_fetch_later_api) is_fetch_later_api(
      const ::network::mojom::URLRequestPtr& input) {
  ...
  static decltype(::network::mojom::URLRequest::storage_access_api_status) storage_access_api_status(
      const ::network::mojom::URLRequestPtr& input) {
    return input->storage_access_api_status;
  }

  static decltype(::network::mojom::URLRequest::attribution_reporting_support) attribution_reporting_support(
      const ::network::mojom::URLRequestPtr& input) {
    return input->attribution_reporting_support;
  }

  static decltype(::network::mojom::URLRequest::attribution_reporting_eligibility) attribution_reporting_eligibility(
      const ::network::mojom::URLRequestPtr& input) {
    return input->attribution_reporting_eligibility;
  }

  static const decltype(::network::mojom::URLRequest::attribution_reporting_src_token)& attribution_reporting_src_token(
      const ::network::mojom::URLRequestPtr& input) {
    return input->attribution_reporting_src_token;
  }

  static const decltype(::network::mojom::URLRequest::keepalive_token)& keepalive_token(
      const ::network::mojom::URLRequestPtr& input) {
    return input->keepalive_token;
  }

  static decltype(::network::mojom::URLRequest::is_ad_tagged) is_ad_tagged(
      const ::network::mojom::URLRequestPtr& input) {
    return input->is_ad_tagged;
  }

  static decltype(::network::mojom::URLRequest::shared_dictionary_writer_enabled) shared_dictionary_writer_enabled(
      const ::network::mojom::URLRequestPtr& input) {
    return input->shared_dictionary_writer_enabled;
  }

  static decltype(::network::mojom::URLRequest::client_side_content_decoding_enabled) client_side_content_decoding_enabled(
      const ::network::mojom::URLRequestPtr& input) {
    return input->client_side_content_decoding_enabled;
  }

  static const decltype(::network::mojom::URLRequest::socket_tag)& socket_tag(
      const ::network::mojom::URLRequestPtr& input) {
    return input->socket_tag;
  }

  static decltype(::network::mojom::URLRequest::allows_device_bound_sessions) allows_device_bound_sessions(
      const ::network::mojom::URLRequestPtr& input) {
    return input->allows_device_bound_sessions;
  }

  static const decltype(::network::mojom::URLRequest::permissions_policy)& permissions_policy(
      const ::network::mojom::URLRequestPtr& input) {
    return input->permissions_policy;
  }

  static const decltype(::network::mojom::URLRequest::fetch_retry_options)& fetch_retry_options(
      const ::network::mojom::URLRequestPtr& input) {
...
template <>
struct  StructTraits<::network::mojom::SocketTag::DataView,
                                         ::network::mojom::SocketTagPtr> {
  static bool IsNull(const ::network::mojom::SocketTagPtr& input) { return !input; }
  static void SetToNull(::network::mojom::SocketTagPtr* output) { output->reset(); }

  static bool Read(::network::mojom::SocketTag::DataView input, ::network::mojom::SocketTagPtr* output);
};
