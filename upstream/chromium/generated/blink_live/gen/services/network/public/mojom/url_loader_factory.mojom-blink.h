// services/network/public/mojom/url_loader_factory.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit
...
#include "services/network/public/mojom/url_loader_factory.mojom-blink-forward.h"  // IWYU pragma: export
...
class URLLoaderFactory
 ...
 public:
  ...
  static constexpr const char* Name_ = "network.mojom.URLLoaderFactory";
...
// with not having this data in traces there.
  ...
  virtual void CreateLoaderAndStart(::mojo::PendingReceiver<::network::mojom::blink::URLLoader> loader, int32_t request_id, uint32_t options, const ::network::ResourceRequest& request, ::mojo::PendingRemote<::network::mojom::blink::URLLoaderClient> client, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation) = 0;
  ...
  virtual void CreateLoaderAndStart(::mojo::PendingReceiver<::network::mojom::blink::URLLoader> loader, int32_t request_id, uint32_t options, ::network::ResourceRequest& request, ::mojo::PendingRemote<::network::mojom::blink::URLLoaderClient> client, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation) {
    CreateLoaderAndStart(std::move(loader), std::move(request_id), std::move(options), const_cast<const ::network::ResourceRequest&>(request), std::move(client), std::move(traffic_annotation));
  }
...
class  URLLoaderFactoryProxy
 ...
 public:
  ...
  void CreateLoaderAndStart(::mojo::PendingReceiver<::network::mojom::blink::URLLoader> loader, int32_t request_id, uint32_t options, const ::network::ResourceRequest& request, ::mojo::PendingRemote<::network::mojom::blink::URLLoaderClient> client, const ::net::MutableNetworkTrafficAnnotationTag& traffic_annotation) final;
