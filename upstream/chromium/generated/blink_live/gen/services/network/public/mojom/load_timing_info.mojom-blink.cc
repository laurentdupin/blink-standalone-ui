...
LoadTimingInfoConnectTiming::LoadTimingInfoConnectTiming(
    ::base::TimeTicks domain_lookup_start_in,
    ::base::TimeTicks domain_lookup_end_in,
...
LoadTimingInfo::LoadTimingInfo(
    ...
    LoadTimingInfoConnectTimingPtr connect_timing_in,
    ...
    ::base::TimeTicks service_worker_router_evaluation_start_in,
    ::base::TimeTicks service_worker_cache_lookup_start_in)
...
void LoadTimingInfo::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "service_worker_router_evaluation_start"), this->service_worker_router_evaluation_start,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::base::TimeTicks>"
#else
      "<value>"
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "service_worker_cache_lookup_start"), this->service_worker_cache_lookup_start,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::base::TimeTicks>"
#else
      "<value>"
...
bool StructTraits<::network::mojom::blink::LoadTimingInfoConnectTiming::DataView, ::network::mojom::blink::LoadTimingInfoConnectTimingPtr>::Read(
    ::network::mojom::blink::LoadTimingInfoConnectTiming::DataView input,
    ::network::mojom::blink::LoadTimingInfoConnectTimingPtr* output) {
  bool success = true;
...
bool StructTraits<::network::mojom::blink::LoadTimingInfo::DataView, ::network::mojom::blink::LoadTimingInfoPtr>::Read(
    ::network::mojom::blink::LoadTimingInfo::DataView input,
    ::network::mojom::blink::LoadTimingInfoPtr* output) {
  bool success = true;
