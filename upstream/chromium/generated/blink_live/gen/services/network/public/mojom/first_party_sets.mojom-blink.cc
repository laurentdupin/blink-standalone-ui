...
FirstPartySetEntry::FirstPartySetEntry(
    ::network::mojom::blink::SchemefulSitePtr primary_in,
...
FirstPartySetsContextConfig::FirstPartySetsContextConfig(
    ::blink::HashMap<::network::mojom::blink::SchemefulSitePtr, FirstPartySetEntryOverridePtr> customizations_in,
    ::blink::HashMap<::network::mojom::blink::SchemefulSitePtr, ::network::mojom::blink::SchemefulSitePtr> aliases_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::HashMap<::network::mojom::blink::SchemefulSitePtr, FirstPartySetEntryOverridePtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::HashMap<::network::mojom::blink::SchemefulSitePtr, ::network::mojom::blink::SchemefulSitePtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
FirstPartySetsCacheFilter::FirstPartySetsCacheFilter(
    ::blink::HashMap<::network::mojom::blink::SchemefulSitePtr, int64_t> filter_in,
...
void FirstPartySetsCacheFilter::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "filter"), this->filter,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::HashMap<::network::mojom::blink::SchemefulSitePtr, int64_t>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
GlobalFirstPartySets::GlobalFirstPartySets(
    ::mojo_base::mojom::blink::VersionPtr public_sets_version_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::mojo_base::mojom::blink::VersionPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
