...
class  WebTransportHandshakeClientInterceptorForTesting : public WebTransportHandshakeClient {
  ...
  void OnBeforeConnect(::network::mojom::IPEndPointPtr server_address) override;
  void OnConnectionEstablished(::mojo::PendingRemote<WebTransport> transport, ::mojo::PendingReceiver<WebTransportClient> client, const ::scoped_refptr<::net::HttpResponseHeaders>& response_headers, const std::optional<std::string>& selected_application_protocol, WebTransportStatsPtr initial_stats) override;
