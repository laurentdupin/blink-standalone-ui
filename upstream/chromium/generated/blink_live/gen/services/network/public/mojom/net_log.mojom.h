...
// with not having this data in traces there.
  ...
  virtual void Start(::mojo_base::mojom::FilePtr destination, ::mojo_base::mojom::DictionaryValuePtr extra_constants, NetLogCaptureMode capture_mode, uint64_t max_file_size, StartCallback callback) = 0;

  using StopCallback = base::OnceCallback<void(int32_t)>;
  using StopMojoCallback = base::OnceCallback<void(int32_t)>;

  virtual void Stop(::mojo_base::mojom::DictionaryValuePtr polled_values, StopCallback callback) = 0;
};
...
// with not having this data in traces there.
  ...
  virtual void AddEntry(uint32_t type, ::network::mojom::NetLogSourcePtr net_log_source, NetLogEventPhase phase, ::base::TimeTicks time, ::mojo_base::mojom::DictionaryValuePtr params) = 0;
};
...
class  NetLogExporterProxy
 ...
 public:
  ...
  void Start(::mojo_base::mojom::FilePtr destination, ::mojo_base::mojom::DictionaryValuePtr extra_constants, NetLogCaptureMode capture_mode, uint64_t max_file_size, StartCallback callback) final;
  
  void Stop(::mojo_base::mojom::DictionaryValuePtr polled_values, StopCallback callback) final;
...
class  NetLogProxySinkProxy
 ...
 public:
  ...
  void AddEntry(uint32_t type, ::network::mojom::NetLogSourcePtr net_log_source, NetLogEventPhase phase, ::base::TimeTicks time, ::mojo_base::mojom::DictionaryValuePtr params) final;
