...
void CrossOriginOpenerPolicyReporterProxy::QueueAccessReport(
  ...
  mojo::Message message(
      std::to_underlying(messages::CrossOriginOpenerPolicyReporter::kQueueAccessReport), kFlags, estimated_payload_size);
...
bool CrossOriginOpenerPolicyReporterRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::CrossOriginOpenerPolicyReporter::Name_,
