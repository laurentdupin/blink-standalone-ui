...
CookieAccessDetails::CookieAccessDetails(
    ...
    ::network::mojom::CookieSettingOverridesPtr cookie_setting_overrides_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::network::mojom::CookieSettingOverridesPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
void CookieAccessObserverProxy::OnCookiesAccessed(
    std::vector<CookieAccessDetailsPtr> in_details) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool CookieAccessObserverRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::CookieAccessObserver::Name_,
