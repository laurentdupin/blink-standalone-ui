...
struct  StructTraits<::network::mojom::ConnectionAllowlist::DataView,
  ...
  static decltype(::network::mojom::ConnectionAllowlist::redirect_behavior) redirect_behavior(
      const ::network::mojom::ConnectionAllowlistPtr& input) {
    return input->redirect_behavior;
  }

  static decltype(::network::mojom::ConnectionAllowlist::webrtc_behavior) webrtc_behavior(
      const ::network::mojom::ConnectionAllowlistPtr& input) {
...
struct  StructTraits<::network::mojom::ConnectionAllowlists::DataView,
  ...
  static const decltype(::network::mojom::ConnectionAllowlists::response_url)& response_url(
  ...
  static const decltype(::network::mojom::ConnectionAllowlists::reporting_source)& reporting_source(
      const ::network::mojom::ConnectionAllowlistsPtr& input) {
