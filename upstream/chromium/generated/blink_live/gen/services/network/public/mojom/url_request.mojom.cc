...
EnabledClientHints::EnabledClientHints(
    ...
    std::vector<::network::mojom::WebClientHintsType> hints_in,
    std::vector<::network::mojom::WebClientHintsType> not_allowed_hints_in)
    : origin(std::move(origin_in)),
      is_outermost_main_frame(std::move(is_outermost_main_frame_in)),
      hints(std::move(hints_in)),
      not_allowed_hints(std::move(not_allowed_hints_in)) {}
...
void EnabledClientHints::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "not_allowed_hints"), this->not_allowed_hints,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type const std::vector<::network::mojom::WebClientHintsType>&>"
#else
      "<value>"
...
TrustedUrlRequestParams::TrustedUrlRequestParams(
    ::network::mojom::IsolationInfoPtr isolation_info_in,
    ...
    ::mojo::ScopedDataPipeProducerHandle response_body_stream_in,
    const ::scoped_refptr<::net::HttpResponseHeaders>& expected_response_headers_for_synthetic_response_in,
    bool is_ad_auction_trusted_signals_request_in)
    : isolation_info(std::move(isolation_info_in)),
      ...
      response_body_stream(std::move(response_body_stream_in)),
      expected_response_headers_for_synthetic_response(std::move(expected_response_headers_for_synthetic_response_in)),
      is_ad_auction_trusted_signals_request(std::move(is_ad_auction_trusted_signals_request_in)) {}
...
void TrustedUrlRequestParams::WriteIntoTrace(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::network::mojom::IsolationInfoPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "response_body_stream"), this->response_body_stream,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "expected_response_headers_for_synthetic_response"), this->expected_response_headers_for_synthetic_response,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "is_ad_auction_trusted_signals_request"), this->is_ad_auction_trusted_signals_request,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type bool>"
#else
      "<value>"
...
URLRequest::URLRequest()
    : method(),
      ...
      socket_tag(),
      allows_device_bound_sessions(true),
      permissions_policy(),
      fetch_retry_options() {}
...
URLRequest::URLRequest(
    ...
    const ::GURL& url_in,
    ::network::mojom::SiteForCookiesPtr site_for_cookies_in,
    ...
    ::network::mojom::HttpRequestHeadersPtr headers_in,
    ::network::mojom::HttpRequestHeadersPtr cors_exempt_headers_in,
    ...
    std::vector<std::vector<uint8_t>> expected_public_keys_in,
    ...
    std::optional<std::vector<::network::mojom::SourceType>> devtools_accepted_stream_types_in,
    ...
    ::network::mojom::StorageAccessApiStatus storage_access_api_status_in,
    ...
    bool allows_device_bound_sessions_in,
    std::optional<::network::PermissionsPolicy> permissions_policy_in,
    ::network::mojom::FetchRetryOptionsPtr fetch_retry_options_in)
    : method(std::move(method_in)),
      ...
      is_reload_navigation(std::move(is_reload_navigation_in)),
      ...
      allows_device_bound_sessions(std::move(allows_device_bound_sessions_in)),
...
void URLRequest::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "is_reload_navigation"), this->is_reload_navigation,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type bool>"
#else
      "<value>"
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type const std::optional<std::vector<::network::mojom::SourceType>>&>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "allows_device_bound_sessions"), this->allows_device_bound_sessions,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type bool>"
#else
      "<value>"
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::network::mojom::FetchRetryOptionsPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
// static
bool StructTraits<::network::mojom::EnabledClientHints::DataView, ::network::mojom::EnabledClientHintsPtr>::Read(
    ::network::mojom::EnabledClientHints::DataView input,
    ::network::mojom::EnabledClientHintsPtr* output) {
  bool success = true;
  ::network::mojom::EnabledClientHintsPtr result(::network::mojom::EnabledClientHints::New());
      ...
      if (success && !input.ReadHints(&result->hints))
        success = false;
      if (success && !input.ReadNotAllowedHints(&result->not_allowed_hints))
        success = false;
...
bool StructTraits<::network::mojom::TrustedUrlRequestParams::DataView, ::network::mojom::TrustedUrlRequestParamsPtr>::Read(
  ...
  ::network::mojom::TrustedUrlRequestParamsPtr result(::network::mojom::TrustedUrlRequestParams::New());
      ...
      if (success)
        result->response_body_stream = input.TakeResponseBodyStream();
      if (success && !input.ReadExpectedResponseHeadersForSyntheticResponse(&result->expected_response_headers_for_synthetic_response))
        success = false;
      if (success)
        result->is_ad_auction_trusted_signals_request = input.is_ad_auction_trusted_signals_request();
  *output = std::move(result);
  return success;
}
...
bool StructTraits<::network::mojom::URLRequest::DataView, ::network::mojom::URLRequestPtr>::Read(
  ...
  ::network::mojom::URLRequestPtr result(::network::mojom::URLRequest::New());
      ...
      if (success)
        result->is_reload_navigation = input.is_reload_navigation();
      if (success)
      ...
      if (success && !input.ReadSocketTag(&result->socket_tag))
        success = false;
      if (success)
        result->allows_device_bound_sessions = input.allows_device_bound_sessions();
...
bool StructTraits<::network::mojom::SocketTag::DataView, ::network::mojom::SocketTagPtr>::Read(
    ::network::mojom::SocketTag::DataView input,
    ::network::mojom::SocketTagPtr* output) {
  bool success = true;
