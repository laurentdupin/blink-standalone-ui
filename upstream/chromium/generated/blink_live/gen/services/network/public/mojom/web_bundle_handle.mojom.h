// services/network/public/mojom/web_bundle_handle.mojom.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef SERVICES_NETWORK_PUBLIC_MOJOM_WEB_BUNDLE_HANDLE_MOJOM_H_
#define SERVICES_NETWORK_PUBLIC_MOJOM_WEB_BUNDLE_HANDLE_MOJOM_H_
...
#include "services/network/public/mojom/web_bundle_handle.mojom-forward.h"  // IWYU pragma: export
#include <string>
#include <vector>
...
// with not having this data in traces there.
  ...
  virtual void OnWebBundleError(WebBundleErrorType type, const std::string& message) = 0;
...
class  WebBundleHandleProxy
 ...
 public:
  ...
  void OnWebBundleError(WebBundleErrorType type, const std::string& message) final;
...
class  WebBundleHandleStubDispatch {
 public:
...
class  WebBundleHandleRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
#endif  // SERVICES_NETWORK_PUBLIC_MOJOM_WEB_BUNDLE_HANDLE_MOJOM_H_