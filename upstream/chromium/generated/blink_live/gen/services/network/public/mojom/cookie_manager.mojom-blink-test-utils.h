...
class BLINK_PLATFORM_EXPORT CookieManagerInterceptorForTesting : public CookieManager {
  ...
  void SetCanonicalCookie(CanonicalCookiePtr cookie, const ::blink::KURL& source_url, CookieOptionsPtr cookie_options, SetCanonicalCookieCallback callback) override;
...
class BLINK_PLATFORM_EXPORT CookieManagerAsyncWaiter {
 public:
  ...
  ::blink::Vector<CanonicalCookiePtr> GetAllCookies();
  ...
  CookieAccessResultPtr SetCanonicalCookie(CanonicalCookiePtr cookie, const ::blink::KURL& source_url, CookieOptionsPtr cookie_options);
