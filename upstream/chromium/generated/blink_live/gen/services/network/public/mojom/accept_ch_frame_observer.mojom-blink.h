...
// with not having this data in traces there.
  ...
  using OnAcceptCHFrameReceivedMojoCallback = base::OnceCallback<void(int32_t)>;

  virtual void OnAcceptCHFrameReceived(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, const ::blink::Vector<::network::mojom::blink::WebClientHintsType>& accept_ch_frame, OnAcceptCHFrameReceivedCallback callback) = 0;
...
class BLINK_PLATFORM_EXPORT AcceptCHFrameObserverProxy
 ...
 public:
  ...
  void OnAcceptCHFrameReceived(const ::scoped_refptr<const ::blink::SecurityOrigin>& origin, const ::blink::Vector<::network::mojom::blink::WebClientHintsType>& accept_ch_frame, OnAcceptCHFrameReceivedCallback callback) final;
