...
void URLLoaderProxy::FollowRedirect(
    ::network::mojom::blink::HttpRequestHeadersUpdateParamsPtr in_headers_update_params, const std::optional<::blink::KURL>& in_new_url) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("headers_update_params"), in_headers_update_params,
                        "<value of type ::network::mojom::blink::HttpRequestHeadersUpdateParamsPtr>");
      perfetto::WriteIntoTracedValueWithFallback(
...
void URLLoaderProxy::SetPriority(
    ::network::mojom::blink::RequestPriority in_priority, int32_t in_intra_priority_value) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool URLLoaderStubDispatch::Accept(
  ...
  switch (static_cast<messages::URLLoader>(message->header()->name)) {
    case messages::URLLoader::kFollowRedirect: {
      ...
      bool success = true;
      ::network::mojom::blink::HttpRequestHeadersUpdateParamsPtr p_headers_update_params{};
    ...
    case messages::URLLoader::kSetPriority: {
      ...
      bool success = true;
      ::network::mojom::blink::RequestPriority p_priority{};
...
void URLLoaderClientProxy::OnReceiveRedirect(
    const ::net::RedirectInfo& in_redirect_info, ::network::mojom::blink::URLResponseHeadPtr in_head) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void URLLoaderInterceptorForTesting::FollowRedirect(::network::mojom::blink::HttpRequestHeadersUpdateParamsPtr headers_update_params, const std::optional<::blink::KURL>& new_url) {
...
void URLLoaderInterceptorForTesting::SetPriority(::network::mojom::blink::RequestPriority priority, int32_t intra_priority_value) {
...
void URLLoaderClientInterceptorForTesting::OnReceiveRedirect(const ::net::RedirectInfo& redirect_info, ::network::mojom::blink::URLResponseHeadPtr head) {
