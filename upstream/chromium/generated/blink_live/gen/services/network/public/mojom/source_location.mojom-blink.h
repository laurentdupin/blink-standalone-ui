// services/network/public/mojom/source_location.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef SERVICES_NETWORK_PUBLIC_MOJOM_SOURCE_LOCATION_MOJOM_BLINK_H_
#define SERVICES_NETWORK_PUBLIC_MOJOM_SOURCE_LOCATION_MOJOM_BLINK_H_
...
#include "services/network/public/mojom/source_location.mojom-blink-forward.h"  // IWYU pragma: export
...
class BLINK_PLATFORM_EXPORT SourceLocation {
 public:
  template <typename T>
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SourceLocation::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SourceLocation::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::network::mojom::blink::SourceLocation::DataView,
                                         ::network::mojom::blink::SourceLocationPtr> {
  static bool IsNull(const ::network::mojom::blink::SourceLocationPtr& input) { return !input; }
  static void SetToNull(::network::mojom::blink::SourceLocationPtr* output) { output->reset(); }

  static const decltype(::network::mojom::blink::SourceLocation::url)& url(
      const ::network::mojom::blink::SourceLocationPtr& input) {
    return input->url;
  }

  static decltype(::network::mojom::blink::SourceLocation::line) line(
      const ::network::mojom::blink::SourceLocationPtr& input) {
    return input->line;
  }

  static decltype(::network::mojom::blink::SourceLocation::column) column(
      const ::network::mojom::blink::SourceLocationPtr& input) {
    return input->column;
  }

  static bool Read(::network::mojom::blink::SourceLocation::DataView input, ::network::mojom::blink::SourceLocationPtr* output);
};

}  // namespace mojo

#endif  // SERVICES_NETWORK_PUBLIC_MOJOM_SOURCE_LOCATION_MOJOM_BLINK_H_