...
class  ResolveHostClient_OnComplete_Params_Data {
 public:
  ...
  mojo::internal::Pointer<mojo::internal::Array_Data<mojo::internal::Pointer<::network::mojom::internal::HostResolverEndpointResult_Data>>> alternative_endpoints;
...
class ResolveHostClient_OnComplete_ParamsDataView {
 public:
  ...
  inline void GetAlternativeEndpointsDataView(
      mojo::ArrayDataView<::network::mojom::HostResolverEndpointResultDataView>* output);

  template <typename UserType>
  [[nodiscard]] bool ReadAlternativeEndpoints(UserType* output) {
    
    auto* pointer = data_->alternative_endpoints.Get();
...
inline void ResolveHostClient_OnComplete_ParamsDataView::GetAlternativeEndpointsDataView(
    mojo::ArrayDataView<::network::mojom::HostResolverEndpointResultDataView>* output) {
  auto pointer = data_->alternative_endpoints.Get();
