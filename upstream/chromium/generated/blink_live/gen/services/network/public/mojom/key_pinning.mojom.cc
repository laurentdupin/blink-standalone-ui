...
PinSet::PinSet(
    ...
    std::vector<::network::mojom::SHA256HashValuePtr> static_spki_hashes_in,
    std::vector<::network::mojom::SHA256HashValuePtr> bad_static_spki_hashes_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<::network::mojom::SHA256HashValuePtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
PinSetInfo::PinSetInfo(
    ...
    const std::string& pinset_name_in,
...
PinList::PinList(
    std::vector<PinSetPtr> pinsets_in,
    std::vector<PinSetInfoPtr> host_pins_in)
...
bool StructTraits<::network::mojom::PinSet::DataView, ::network::mojom::PinSetPtr>::Read(
    ::network::mojom::PinSet::DataView input,
    ::network::mojom::PinSetPtr* output) {
  bool success = true;
...
bool StructTraits<::network::mojom::PinSetInfo::DataView, ::network::mojom::PinSetInfoPtr>::Read(
    ::network::mojom::PinSetInfo::DataView input,
    ::network::mojom::PinSetInfoPtr* output) {
  bool success = true;
...
bool StructTraits<::network::mojom::PinList::DataView, ::network::mojom::PinListPtr>::Read(
    ::network::mojom::PinList::DataView input,
    ::network::mojom::PinListPtr* output) {
  bool success = true;
