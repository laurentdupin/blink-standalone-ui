...
class  AddressList {
 public:
  ...
  AddressList(
      std::vector<::network::mojom::IPEndPointPtr> addresses,
...
AddressList& operator=(const AddressList&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        AddressList::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
struct  StructTraits<::network::mojom::AddressList::DataView,
  ...
  static const decltype(::network::mojom::AddressList::dns_aliases)& dns_aliases(
      const ::network::mojom::AddressListPtr& input) {
