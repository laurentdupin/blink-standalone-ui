// services/network/public/mojom/mutable_partial_network_traffic_annotation_tag.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "services/network/public/mojom/mutable_partial_network_traffic_annotation_tag.mojom-test-utils.h"
...
size_t MutablePartialNetworkTrafficAnnotationTag::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->unique_id_hash_code);
  seed = mojo::internal::Hash(seed, this->completing_id_hash_code);
  return seed;
}

void MutablePartialNetworkTrafficAnnotationTag::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "completing_id_hash_code"), this->completing_id_hash_code,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type uint32_t>"
#else
      "<value>"
