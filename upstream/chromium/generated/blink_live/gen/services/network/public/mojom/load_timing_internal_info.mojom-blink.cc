// services/network/public/mojom/load_timing_internal_info.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "services/network/public/mojom/load_timing_internal_info.mojom-blink-test-utils.h"
...
size_t DohResolutionDetails::Hash(size_t seed) const {
  seed = mojo::internal::WTFHash(seed, this->session_source);
  seed = mojo::internal::WTFHash(seed, this->connection_info);
  return seed;
}
...
// static
bool StructTraits<::network::mojom::blink::DohResolutionDetails::DataView, ::network::mojom::blink::DohResolutionDetailsPtr>::Read(
    ::network::mojom::blink::DohResolutionDetails::DataView input,
    ::network::mojom::blink::DohResolutionDetailsPtr* output) {
  bool success = true;
  ::network::mojom::blink::DohResolutionDetailsPtr result(::network::mojom::blink::DohResolutionDetails::New());
...
// static
bool StructTraits<::network::mojom::blink::ResolutionDetails::DataView, ::network::mojom::blink::ResolutionDetailsPtr>::Read(
    ::network::mojom::blink::ResolutionDetails::DataView input,
    ::network::mojom::blink::ResolutionDetailsPtr* output) {
  bool success = true;
  ::network::mojom::blink::ResolutionDetailsPtr result(::network::mojom::blink::ResolutionDetails::New());
...
// static
bool StructTraits<::network::mojom::blink::LoadTimingInternalInfo::DataView, ::network::mojom::blink::LoadTimingInternalInfoPtr>::Read(
    ::network::mojom::blink::LoadTimingInternalInfo::DataView input,
    ::network::mojom::blink::LoadTimingInternalInfoPtr* output) {
  bool success = true;
  ::network::mojom::blink::LoadTimingInternalInfoPtr result(::network::mojom::blink::LoadTimingInternalInfo::New());
