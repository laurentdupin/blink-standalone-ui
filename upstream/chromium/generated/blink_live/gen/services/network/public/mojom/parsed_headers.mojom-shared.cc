...
bool ParsedHeaders_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->connection_allowlists, 3, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->cross_origin_embedder_policy, 4, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->cross_origin_opener_policy, 5, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->document_isolation_policy, 6, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->integrity_policy, 7, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->integrity_policy_report_only, 8, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->link_headers, 14, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->supports_loading_mode, 16, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidateStruct(object->declarative_performance_observer_policy, validation_context))
    return false;

  if (!mojo::internal::ValidateStruct(object->prefetch_activation_beacon_endpoint, validation_context))
    return false;
