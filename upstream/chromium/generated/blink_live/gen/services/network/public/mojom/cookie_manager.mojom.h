...
// with not having this data in traces there.
  ...
  using GetAllCookiesCallback = base::OnceCallback<void(std::vector<CanonicalCookiePtr>)>;
  using GetAllCookiesMojoCallback = base::OnceCallback<void(std::vector<CanonicalCookiePtr>)>;

  virtual void GetAllCookies(GetAllCookiesCallback callback) = 0;

  using GetAllCookiesWithAccessSemanticsCallback = base::OnceCallback<void(std::vector<CanonicalCookiePtr>, const std::vector<CookieAccessSemantics>&)>;
  using GetAllCookiesWithAccessSemanticsMojoCallback = base::OnceCallback<void(std::vector<CanonicalCookiePtr>, const std::vector<CookieAccessSemantics>&)>;

  virtual void GetAllCookiesWithAccessSemantics(GetAllCookiesWithAccessSemanticsCallback callback) = 0;

  using GetCookieListCallback = base::OnceCallback<void(std::vector<CookieWithAccessResultPtr>, std::vector<CookieWithAccessResultPtr>)>;
  using GetCookieListMojoCallback = base::OnceCallback<void(std::vector<CookieWithAccessResultPtr>, std::vector<CookieWithAccessResultPtr>)>;

  virtual void GetCookieList(const ::GURL& url, CookieOptionsPtr cookie_options, ::network::mojom::CookiePartitionKeyCollectionPtr cookie_partition_key_collection, GetCookieListCallback callback) = 0;
  ...
  virtual void SetCanonicalCookie(CanonicalCookiePtr cookie, const ::GURL& source_url, CookieOptionsPtr cookie_options, SetCanonicalCookieCallback callback) = 0;
  ...
  virtual void SetContentSettings(::content_settings::mojom::ContentSettingsType content_settings_type, std::vector<::content_settings::mojom::ContentSettingPatternSourcePtr> settings, SetContentSettingsCallback callback) = 0;
...
class  CookieManagerProxy
 ...
 public:
  ...
  void GetCookieList(const ::GURL& url, CookieOptionsPtr cookie_options, ::network::mojom::CookiePartitionKeyCollectionPtr cookie_partition_key_collection, GetCookieListCallback callback) final;
  
  void SetCanonicalCookie(CanonicalCookiePtr cookie, const ::GURL& source_url, CookieOptionsPtr cookie_options, SetCanonicalCookieCallback callback) final;
  ...
  void SetContentSettings(::content_settings::mojom::ContentSettingsType content_settings_type, std::vector<::content_settings::mojom::ContentSettingPatternSourcePtr> settings, SetContentSettingsCallback callback) final;
 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CookieSameSiteContextMetadata::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
class  ExclusionReasons {
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ExclusionReasons::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ExclusionReasons::DataView, std::vector<uint8_t>>(input);
  }
...
class  WarningReasons {
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        WarningReasons::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        WarningReasons::DataView, std::vector<uint8_t>>(input);
  }
...
class  CookieManagerParams {
 public:
  ...
  CookieManagerParams(
      ...
      base::flat_map<::content_settings::mojom::ContentSettingsType, std::vector<::content_settings::mojom::ContentSettingPatternSourcePtr>> content_settings,
      std::vector<std::string> secure_origin_cookies_allowed_schemes,
      std::vector<::url::Origin> secure_origin_cookies_allowed_origins,
...
CookieManagerParams& operator=(const CookieManagerParams&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CookieManagerParams::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
CookieSameSiteContext& operator=(const CookieSameSiteContext&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CookieSameSiteContext::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
CookieOptions& operator=(const CookieOptions&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CookieOptions::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
class  CanonicalCookie {
 public:
  ...
  CanonicalCookie(
      ...
      ::network::mojom::CookiePartitionKeyPtr partition_key,
      int32_t source_port,
...
CanonicalCookie& operator=(const CanonicalCookie&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CanonicalCookie::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
CookieInclusionStatus& operator=(const CookieInclusionStatus&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CookieInclusionStatus::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
CookieAndLineWithAccessResult& operator=(const CookieAndLineWithAccessResult&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CookieAndLineWithAccessResult::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
CookieOrLineWithAccessResult& operator=(const CookieOrLineWithAccessResult&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CookieOrLineWithAccessResult::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
CookieAccessResult& operator=(const CookieAccessResult&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CookieAccessResult::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
CookieWithAccessResult& operator=(const CookieWithAccessResult&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CookieWithAccessResult::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
CookieChangeInfo& operator=(const CookieChangeInfo&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CookieChangeInfo::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
class  CookieDeletionFilter {
 public:
  ...
  CookieDeletionFilter(
      ...
      ::network::mojom::CookiePartitionKeyCollectionPtr cookie_partition_key_collection,
...
CookieDeletionFilter& operator=(const CookieDeletionFilter&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CookieDeletionFilter::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
struct  StructTraits<::network::mojom::CookieManagerParams::DataView,
  ...
  static const decltype(::network::mojom::CookieManagerParams::content_settings)& content_settings(
      const ::network::mojom::CookieManagerParamsPtr& input) {
  ...
  static const decltype(::network::mojom::CookieManagerParams::secure_origin_cookies_allowed_origins)& secure_origin_cookies_allowed_origins(
      const ::network::mojom::CookieManagerParamsPtr& input) {
...
struct  StructTraits<::network::mojom::CanonicalCookie::DataView,
  ...
  static decltype(::network::mojom::CanonicalCookie::source_type) source_type(
      const ::network::mojom::CanonicalCookiePtr& input) {
...
template <>
struct  StructTraits<::network::mojom::ExclusionReasons::DataView,
                                         ::network::mojom::ExclusionReasonsPtr> {
  static bool IsNull(const ::network::mojom::ExclusionReasonsPtr& input) { return !input; }
  static void SetToNull(::network::mojom::ExclusionReasonsPtr* output) { output->reset(); }

  static decltype(::network::mojom::ExclusionReasons::exclusions_bitmask) exclusions_bitmask(
      const ::network::mojom::ExclusionReasonsPtr& input) {
    return input->exclusions_bitmask;
  }

  static bool Read(::network::mojom::ExclusionReasons::DataView input, ::network::mojom::ExclusionReasonsPtr* output);
};


template <>
struct  StructTraits<::network::mojom::WarningReasons::DataView,
                                         ::network::mojom::WarningReasonsPtr> {
  static bool IsNull(const ::network::mojom::WarningReasonsPtr& input) { return !input; }
  static void SetToNull(::network::mojom::WarningReasonsPtr* output) { output->reset(); }

  static decltype(::network::mojom::WarningReasons::warnings_bitmask) warnings_bitmask(
      const ::network::mojom::WarningReasonsPtr& input) {
    return input->warnings_bitmask;
  }

  static bool Read(::network::mojom::WarningReasons::DataView input, ::network::mojom::WarningReasonsPtr* output);
};
...
struct  StructTraits<::network::mojom::CookieInclusionStatus::DataView,
  ...
  static const decltype(::network::mojom::CookieInclusionStatus::exclusion_reasons)& exclusion_reasons(
      const ::network::mojom::CookieInclusionStatusPtr& input) {
    return input->exclusion_reasons;
  }

  static const decltype(::network::mojom::CookieInclusionStatus::warning_reasons)& warning_reasons(
      const ::network::mojom::CookieInclusionStatusPtr& input) {
    return input->warning_reasons;
  }

  static decltype(::network::mojom::CookieInclusionStatus::exemption_reason) exemption_reason(
      const ::network::mojom::CookieInclusionStatusPtr& input) {
...
struct  StructTraits<::network::mojom::CookieAccessResult::DataView,
  ...
  static decltype(::network::mojom::CookieAccessResult::scope_semantics) scope_semantics(
      const ::network::mojom::CookieAccessResultPtr& input) {
...
struct  UnionTraits<::network::mojom::CookieOrLine::DataView,
  ...
  static const ::network::mojom::CanonicalCookiePtr& cookie(const ::network::mojom::CookieOrLinePtr& input) {
