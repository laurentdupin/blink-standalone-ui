// services/network/public/mojom/data_pipe_getter.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "services/network/public/mojom/data_pipe_getter.mojom-blink-test-utils.h"
...
uint32_t DataPipeGetter::Read_Sym::IPCStableHash() {
  ...
  static constexpr uint32_t kHash = 0xd367e802;  // IPCStableHash for network::mojom::DataPipeGetter::Read
...
uint32_t DataPipeGetter::Clone_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x88fc5c68;  // IPCStableHash for network::mojom::DataPipeGetter::Clone
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void DataPipeGetterProxy::Read(
  ...
  mojo::Message message(
      std::to_underlying(messages::DataPipeGetter::kRead), kFlags, estimated_payload_size);
...
void DataPipeGetterProxy::Clone(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DataPipeGetter::kClone), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool DataPipeGetterRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::network::mojom::blink::DataPipeGetter::Name_,
    kDataPipeGetterValidationInfo);
}
