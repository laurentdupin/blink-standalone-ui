// services/device/public/mojom/time_zone_monitor.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef SERVICES_DEVICE_PUBLIC_MOJOM_TIME_ZONE_MONITOR_MOJOM_BLINK_H_
#define SERVICES_DEVICE_PUBLIC_MOJOM_TIME_ZONE_MONITOR_MOJOM_BLINK_H_
...
#include "services/device/public/mojom/time_zone_monitor.mojom-blink-forward.h"  // IWYU pragma: export
...
class BLINK_PLATFORM_EXPORT TimeZoneMonitor
    : public TimeZoneMonitorInterfaceBase {
 public:
  using IPCStableHashFunction = uint32_t(*)();
  static constexpr const char* Name_ = "device.mojom.TimeZoneMonitor";
...
class BLINK_PLATFORM_EXPORT TimeZoneMonitorClient
    : public TimeZoneMonitorClientInterfaceBase {
 public:
  using IPCStableHashFunction = uint32_t(*)();
  static constexpr const char* Name_ = "device.mojom.TimeZoneMonitorClient";
  static IPCStableHashFunction MessageToMethodInfo_(mojo::Message& message);
  static const char* MessageToMethodName_(mojo::Message& message);
  static constexpr uint32_t Version_ = 0;
  static constexpr bool PassesAssociatedKinds_ = false;
...
// with not having this data in traces there.
  ...
  virtual void OnTimeZoneChange(const ::blink::String& tz_info) = 0;
};



class BLINK_PLATFORM_EXPORT TimeZoneMonitorProxy
...
class BLINK_PLATFORM_EXPORT TimeZoneMonitorClientProxy
 ...
 public:
  ...
  void OnTimeZoneChange(const ::blink::String& tz_info) final;

 private:
  mojo::MessageReceiverWithResponder* receiver_;
};
class BLINK_PLATFORM_EXPORT TimeZoneMonitorStubDispatch {
 public:
...
class BLINK_PLATFORM_EXPORT TimeZoneMonitorClientStubDispatch {
 public:
...
class BLINK_PLATFORM_EXPORT TimeZoneMonitorRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class BLINK_PLATFORM_EXPORT TimeZoneMonitorClientRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
#endif  // SERVICES_DEVICE_PUBLIC_MOJOM_TIME_ZONE_MONITOR_MOJOM_BLINK_H_