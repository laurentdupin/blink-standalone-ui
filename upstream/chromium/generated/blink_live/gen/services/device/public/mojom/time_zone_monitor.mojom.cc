// services/device/public/mojom/time_zone_monitor.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void TimeZoneMonitorProxy::AddClient(
  ...
  mojo::Message message(
      std::to_underlying(messages::TimeZoneMonitor::kAddClient), kFlags, estimated_payload_size);
...
bool TimeZoneMonitorRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::device::mojom::TimeZoneMonitor::Name_,
...
void TimeZoneMonitorClientProxy::OnTimeZoneChange(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::TimeZoneMonitorClient::kOnTimeZoneChange), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool TimeZoneMonitorClientRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::device::mojom::TimeZoneMonitorClient::Name_,
