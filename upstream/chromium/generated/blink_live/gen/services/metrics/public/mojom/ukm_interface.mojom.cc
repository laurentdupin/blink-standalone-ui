...
uint32_t SingularUkmInterface::Submit_Sym::IPCStableHash() {
  ...
  static constexpr uint32_t kHash = 0xac350fbe;  // IPCStableHash for ukm::mojom::SingularUkmInterface::Submit
...
void SingularUkmInterfaceProxy::Submit(
  ...
  mojo::Message message(
      std::to_underlying(messages::SingularUkmInterface::kSubmit), kFlags, estimated_payload_size);
...
bool SingularUkmInterfaceRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::ukm::mojom::SingularUkmInterface::Name_,
    kSingularUkmInterfaceValidationInfo);
}
...
uint32_t UkmRecorderClientInterface::SetParameters_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x1d4074d0;  // IPCStableHash for ukm::mojom::UkmRecorderClientInterface::SetParameters
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void UkmRecorderClientInterfaceProxy::SetParameters(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::UkmRecorderClientInterface::kSetParameters), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool UkmRecorderClientInterfaceRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::ukm::mojom::UkmRecorderClientInterface::Name_,
    kUkmRecorderClientInterfaceValidationInfo);
}
...
uint32_t UkmRecorderInterface::AddEntry_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x0ecd5886;  // IPCStableHash for ukm::mojom::UkmRecorderInterface::AddEntry
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t UkmRecorderInterface::UpdateSourceURL_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x7bfd1998;  // IPCStableHash for ukm::mojom::UkmRecorderInterface::UpdateSourceURL
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void UkmRecorderInterfaceProxy::AddEntry(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::UkmRecorderInterface::kAddEntry), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void UkmRecorderInterfaceProxy::UpdateSourceURL(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::UkmRecorderInterface::kUpdateSourceURL), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool UkmRecorderInterfaceRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    ...
    kUkmRecorderInterfaceValidationInfo);
}
...
uint32_t UkmRecorderFactory::CreateUkmRecorder_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xdddbe304;  // IPCStableHash for ukm::mojom::UkmRecorderFactory::CreateUkmRecorder
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void UkmRecorderFactoryProxy::CreateUkmRecorder(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::UkmRecorderFactory::kCreateUkmRecorder), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool UkmRecorderFactoryRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    ...
    kUkmRecorderFactoryValidationInfo);
}
