...
static_assert(sizeof(MediaMetadata_Data) == 48,
...
static_assert(sizeof(MediaImageBitmap_Data) == 32,
...
static_assert(sizeof(MediaPosition_Data) == 48,
              "Bad sizeof(MediaPosition_Data)");
...
struct MediaPosition_UnserializedMessageContext
 ...
 public:
  ...
  MediaPosition_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
...
static_assert(sizeof(RemotePlaybackMetadata_Data) == 40,
              "Bad sizeof(RemotePlaybackMetadata_Data)");
...
struct RemotePlaybackMetadata_UnserializedMessageContext
 ...
 public:
  ...
  RemotePlaybackMetadata_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
...
class  MediaSessionInfo_Data {
 public:
  ...
  uint8_t can_enter_browser_initiated_autopip : 1;
  uint8_t pad10_[2];
...
static_assert(sizeof(MediaSessionInfo_Data) == 64,
