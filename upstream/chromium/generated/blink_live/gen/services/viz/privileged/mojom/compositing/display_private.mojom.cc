...
namespace viz::mojom {
FrameRateVelocityPoint::FrameRateVelocityPoint()
    : frame_per_second(),
      dp_per_second() {}

FrameRateVelocityPoint::FrameRateVelocityPoint(
    float frame_per_second_in,
    float dp_per_second_in)
    : frame_per_second(std::move(frame_per_second_in)),
      dp_per_second(std::move(dp_per_second_in)) {}

FrameRateVelocityPoint::~FrameRateVelocityPoint() = default;
size_t FrameRateVelocityPoint::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->frame_per_second);
  seed = mojo::internal::Hash(seed, this->dp_per_second);
  return seed;
}

void FrameRateVelocityPoint::WriteIntoTrace(
    perfetto::TracedValue traced_context) const {
  [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "frame_per_second"), this->frame_per_second,
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "dp_per_second"), this->dp_per_second,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type float>"
#else
      "<value>"
...
bool FrameRateVelocityPoint::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  return Data_::Validate(data, validation_context);
}
AdaptiveRefreshRateInfo::AdaptiveRefreshRateInfo()
    : has_support(),
      suggested_high(),
      velocity_mapping(),
      device_scale_factor() {}
...
AdaptiveRefreshRateInfo::AdaptiveRefreshRateInfo(
    bool has_support_in,
    float suggested_high_in,
    std::vector<FrameRateVelocityPointPtr> velocity_mapping_in,
    float device_scale_factor_in)
    : has_support(std::move(has_support_in)),
      suggested_high(std::move(suggested_high_in)),
      velocity_mapping(std::move(velocity_mapping_in)),
      device_scale_factor(std::move(device_scale_factor_in)) {}

AdaptiveRefreshRateInfo::~AdaptiveRefreshRateInfo() = default;

void AdaptiveRefreshRateInfo::WriteIntoTrace(
    perfetto::TracedValue traced_context) const {
  [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "suggested_high"), this->suggested_high,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type float>"
#else
      "<value>"
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "velocity_mapping"), this->velocity_mapping,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<FrameRateVelocityPointPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
bool AdaptiveRefreshRateInfo::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  return Data_::Validate(data, validation_context);
}
...
uint32_t DisplayPrivate::DisableSwapUntilResize_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xcdf2cca6;  // IPCStableHash for viz::mojom::DisplayPrivate::DisableSwapUntilResize
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void DisplayPrivateProxy::SetDisplayVisible(
  ...
  mojo::Message message(
      std::to_underlying(messages::DisplayPrivate::kSetDisplayVisible), kFlags, estimated_payload_size);
...
bool DisplayPrivateProxy::DisableSwapUntilResize(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DisplayPrivate::kDisableSwapUntilResize), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
      ::viz::mojom::internal::DisplayPrivate_DisableSwapUntilResize_Params_Data> params(
          message);
  params.Allocate();
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_END0("mojom", "Call viz::mojom::DisplayPrivate::DisableSwapUntilResize (sync)");
#endif
  return result;
}
...
void DisplayPrivateProxy::Resize(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DisplayPrivate::kResize), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void DisplayPrivateProxy::SetDisplayColorMatrix(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DisplayPrivate::kSetDisplayColorMatrix), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void DisplayPrivateProxy::SetDisplayColorSpaces(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DisplayPrivate::kSetDisplayColorSpaces), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void DisplayPrivateProxy::SetOutputIsSecure(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DisplayPrivate::kSetOutputIsSecure), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void DisplayPrivateProxy::SetDisplayVSyncParameters(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DisplayPrivate::kSetDisplayVSyncParameters), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void DisplayPrivateProxy::ForceImmediateDrawAndSwapIfPossible(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DisplayPrivate::kForceImmediateDrawAndSwapIfPossible), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void DisplayPrivateProxy::AddVSyncParameterObserver(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DisplayPrivate::kAddVSyncParameterObserver), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void DisplayPrivateProxy::SetDelegatedInkPointRenderer(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DisplayPrivate::kSetDelegatedInkPointRenderer), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void DisplayPrivateProxy::SetStandaloneBeginFrameObserver(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DisplayPrivate::kSetStandaloneBeginFrameObserver), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void DisplayPrivateProxy::SetMaxVSyncAndVrr(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DisplayPrivate::kSetMaxVSyncAndVrr), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void DisplayPrivate_DisableSwapUntilResize_ProxyToResponder::Run(
  ...
  mojo::Message message(
      std::to_underlying(messages::DisplayPrivate::kDisableSwapUntilResize), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
      ::viz::mojom::internal::DisplayPrivate_DisableSwapUntilResize_ResponseParams_Data> params(
          message);
  params.Allocate();
...
uint32_t DisplayClient::CreateLayeredWindowUpdater_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xc8ab4d84;  // IPCStableHash for viz::mojom::DisplayClient::CreateLayeredWindowUpdater
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t DisplayClient::AddChildWindowToBrowser_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x7c8c97fc;  // IPCStableHash for viz::mojom::DisplayClient::AddChildWindowToBrowser
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void DisplayClientProxy::CreateLayeredWindowUpdater(
    ::mojo::PendingReceiver<::viz::mojom::LayeredWindowUpdater> in_receiver) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "Send viz::mojom::DisplayClient::CreateLayeredWindowUpdater", "input_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("receiver"), in_receiver,
                        "<value of type ::mojo::PendingReceiver<::viz::mojom::LayeredWindowUpdater>>");
   });
#endif
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DisplayClient::kCreateLayeredWindowUpdater), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
      ::viz::mojom::internal::DisplayClient_CreateLayeredWindowUpdater_Params_Data> params(
          message);
  params.Allocate();
...
void DisplayClientProxy::AddChildWindowToBrowser(
    ::gpu::SurfaceHandle in_child_window) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "Send viz::mojom::DisplayClient::AddChildWindowToBrowser", "input_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("child_window"), in_child_window,
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DisplayClient::kAddChildWindowToBrowser), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
      ::viz::mojom::internal::DisplayClient_AddChildWindowToBrowser_Params_Data> params(
          message);
  params.Allocate();
  mojo::internal::MessageFragment<
      typename decltype(params->child_window)::BaseType> child_window_fragment(
          params.message());
  
  mojo::internal::Serialize<::gpu::mojom::SurfaceHandleDataView>(
    in_child_window,
    child_window_fragment);

  params->child_window.Set(
      child_window_fragment.is_null() ? nullptr : child_window_fragment.data());

  
  MOJO_INTERNAL_CHECK_SERIALIZATION(
    mojo::internal::SendValidation::kDefault,
    !(params->child_window.is_null()),
    mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
  ...
  switch (static_cast<messages::DisplayClient>(message->header()->name)) {
    ...
    case messages::DisplayClient::kAddChildWindowToBrowser: {
      ...
      internal::DisplayClient_AddChildWindowToBrowser_Params_Data* params =
          reinterpret_cast<internal::DisplayClient_AddChildWindowToBrowser_Params_Data*>(
              message->mutable_payload());
      ...
      // A null |impl| means no implementation was bound.
      DCHECK(impl);
      impl->AddChildWindowToBrowser(        
        std::move(p_child_window));
      return true;
    }
  }
  return false;
...
static const mojo::internal::GenericValidationInfo kDisplayClientValidationInfo[] = {
    { &internal::DisplayClient_CreateLayeredWindowUpdater_Params_Data::Validate,
     nullptr /* no response */},
    { &internal::DisplayClient_AddChildWindowToBrowser_Params_Data::Validate,
     nullptr /* no response */},
};
...
// static
bool StructTraits<::viz::mojom::FrameRateVelocityPoint::DataView, ::viz::mojom::FrameRateVelocityPointPtr>::Read(
    ::viz::mojom::FrameRateVelocityPoint::DataView input,
    ::viz::mojom::FrameRateVelocityPointPtr* output) {
  bool success = true;
  ::viz::mojom::FrameRateVelocityPointPtr result(::viz::mojom::FrameRateVelocityPoint::New());
  
      if (success)
        result->frame_per_second = input.frame_per_second();
      if (success)
        result->dp_per_second = input.dp_per_second();
...
// static
bool StructTraits<::viz::mojom::AdaptiveRefreshRateInfo::DataView, ::viz::mojom::AdaptiveRefreshRateInfoPtr>::Read(
    ::viz::mojom::AdaptiveRefreshRateInfo::DataView input,
    ::viz::mojom::AdaptiveRefreshRateInfoPtr* output) {
  bool success = true;
  ::viz::mojom::AdaptiveRefreshRateInfoPtr result(::viz::mojom::AdaptiveRefreshRateInfo::New());
  
      if (success)
        result->has_support = input.has_support();
      if (success)
        result->suggested_high = input.suggested_high();
      if (success && !input.ReadVelocityMapping(&result->velocity_mapping))
        success = false;
      if (success)
...
void DisplayClientInterceptorForTesting::CreateLayeredWindowUpdater(::mojo::PendingReceiver<::viz::mojom::LayeredWindowUpdater> receiver) {
  GetForwardingInterface()->CreateLayeredWindowUpdater(
    std::move(receiver)
    );
}
void DisplayClientInterceptorForTesting::AddChildWindowToBrowser(::gpu::SurfaceHandle child_window) {
  GetForwardingInterface()->AddChildWindowToBrowser(
    std::move(child_window)
    );
}
