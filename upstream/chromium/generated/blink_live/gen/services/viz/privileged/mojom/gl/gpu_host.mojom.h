...
#include "ui/gfx/mojom/gpu_extra_info.mojom-forward.h"
...
// with not having this data in traces there.
  ...
  virtual void DidLoseContext(::viz::mojom::ContextLostReason reason, const ::GURL& active_url) = 0;
  ...
  virtual void GetIsolationKey(int32_t client_id, ::blink::mojom::WebGPUExecutionContextTokenPtr wgpu_context_token, GetIsolationKeyCallback callback) = 0;
...
class  GpuHostProxy
 ...
 public:
  ...
  void DidLoseContext(::viz::mojom::ContextLostReason reason, const ::GURL& active_url) final;
  ...
  void GetIsolationKey(int32_t client_id, ::blink::mojom::WebGPUExecutionContextTokenPtr wgpu_context_token, GetIsolationKeyCallback callback) final;
