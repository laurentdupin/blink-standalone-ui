...
RootCompositorFrameSinkParams::RootCompositorFrameSinkParams()
    : frame_sink_id(),
      ...
      enable_video_conference_matcher(false),
...
RootCompositorFrameSinkParams::RootCompositorFrameSinkParams(
    ...
    bool enable_video_conference_matcher_in,
    ...
    : frame_sink_id(std::move(frame_sink_id_in)),
      ...
      enable_video_conference_matcher(std::move(enable_video_conference_matcher_in)),
...
void RootCompositorFrameSinkParams::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "enable_video_conference_matcher"), this->enable_video_conference_matcher,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type bool>"
#else
      "<value>"
...
void FrameSinkManagerProxy::RegisterFrameSinkId(
  ...
  mojo::Message message(
      std::to_underlying(messages::FrameSinkManager::kRegisterFrameSinkId), kFlags, estimated_payload_size);
...
void FrameSinkManagerProxy::InvalidateFrameSinkId(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameSinkManager::kInvalidateFrameSinkId), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameSinkManagerProxy::SetFrameSinkDebugLabel(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameSinkManager::kSetFrameSinkDebugLabel), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameSinkManagerProxy::CreateRootCompositorFrameSink(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameSinkManager::kCreateRootCompositorFrameSink), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameSinkManagerProxy::CreateFrameSinkBundle(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameSinkManager::kCreateFrameSinkBundle), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameSinkManagerProxy::CreateCompositorFrameSink(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameSinkManager::kCreateCompositorFrameSink), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool FrameSinkManagerProxy::DestroyCompositorFrameSink(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameSinkManager::kDestroyCompositorFrameSink), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
  ...
  ::mojo::internal::SendMojoMessage(*receiver_, message, std::move(responder));
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_END0("mojom", "Call viz::mojom::FrameSinkManager::DestroyCompositorFrameSink (sync)");
#endif
  return result;
}
...
void FrameSinkManagerProxy::RegisterFrameSinkHierarchy(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameSinkManager::kRegisterFrameSinkHierarchy), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameSinkManagerProxy::UnregisterFrameSinkHierarchy(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameSinkManager::kUnregisterFrameSinkHierarchy), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameSinkManagerProxy::AddVideoDetectorObserver(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameSinkManager::kAddVideoDetectorObserver), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameSinkManagerProxy::EvictSurfaces(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameSinkManager::kEvictSurfaces), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameSinkManagerProxy::Throttle(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameSinkManager::kThrottle), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameSinkManagerProxy::StartThrottlingAllFrameSinks(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameSinkManager::kStartThrottlingAllFrameSinks), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameSinkManagerProxy::StopThrottlingAllFrameSinks(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameSinkManager::kStopThrottlingAllFrameSinks), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameSinkManagerProxy::RequestCopyOfOutput(
    const ::viz::SurfaceId& in_surface_id, ::std::unique_ptr<::viz::CopyOutputRequest> in_request, bool in_capture_exact_surface_id, ::base::TimeDelta in_timeout) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameSinkManager::kRequestCopyOfOutput), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
  ...
  MOJO_INTERNAL_CHECK_SERIALIZATION(
    ...
    mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
    "null timeout in FrameSinkManager.RequestCopyOfOutput request");
...
void FrameSinkManagerProxy::UpdateDebugRendererSettings(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameSinkManager::kUpdateDebugRendererSettings), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameSinkManagerProxy::ClearUnclaimedViewTransitionResources(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameSinkManager::kClearUnclaimedViewTransitionResources), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameSinkManagerProxy::CreateMetricsRecorderForTest(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameSinkManager::kCreateMetricsRecorderForTest), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameSinkManagerProxy::EnableFrameSinkManagerTestApi(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameSinkManager::kEnableFrameSinkManagerTestApi), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
FrameSinkManagerClient::IPCStableHashFunction FrameSinkManagerClient::MessageToMethodInfo_(mojo::Message& message) {
  ...
  switch (static_cast<messages::FrameSinkManagerClient>(message.name())) {
    ...
    case messages::FrameSinkManagerClient::kOnViewTransitionResourcesCaptured: {
      return &FrameSinkManagerClient::OnViewTransitionResourcesCaptured_Sym::IPCStableHash;
    }
  }
#endif  // !BUILDFLAG(IS_FUCHSIA)
  return nullptr;
...
const char* FrameSinkManagerClient::MessageToMethodName_(mojo::Message& message) {
  ...
  if (!is_response) {
    switch (static_cast<messages::FrameSinkManagerClient>(message.name())) {
      ...
      case messages::FrameSinkManagerClient::kOnViewTransitionResourcesCaptured:
            return "Receive viz::mojom::FrameSinkManagerClient::OnViewTransitionResourcesCaptured";
    }
  } else {
    switch (static_cast<messages::FrameSinkManagerClient>(message.name())) {
      case messages::FrameSinkManagerClient::kOnFirstSurfaceActivation:
      ...
      case messages::FrameSinkManagerClient::kOnViewTransitionResourcesCaptured:
            return "Receive reply viz::mojom::FrameSinkManagerClient::OnViewTransitionResourcesCaptured";
    }
  }
  return "Receive unknown mojo message";
#else
...
uint32_t FrameSinkManagerClient::OnViewTransitionResourcesCaptured_Sym::IPCStableHash() {
  // This method's address is used for identifying the mojo method name after
  // symbolization. So each IPCStableHash should have a unique address.
  // We cannot use NO_CODE_FOLDING() here - it relies on the uniqueness of
  // __LINE__ value, which is not unique across different mojo modules.
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xb50a3427;  // IPCStableHash for viz::mojom::FrameSinkManagerClient::OnViewTransitionResourcesCaptured
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void FrameSinkManagerClientProxy::OnFirstSurfaceActivation(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameSinkManagerClient::kOnFirstSurfaceActivation), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameSinkManagerClientProxy::OnAggregatedHitTestRegionListUpdated(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameSinkManagerClient::kOnAggregatedHitTestRegionListUpdated), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameSinkManagerClientProxy::OnFrameTokenChanged(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameSinkManagerClient::kOnFrameTokenChanged), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameSinkManagerClientProxy::OnScreenshotCaptured(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameSinkManagerClient::kOnScreenshotCaptured), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameSinkManagerClientProxy::OnVizTouchStateAvailable(
    ::mojo_base::mojom::ReadOnlySharedMemoryRegionPtr in_region) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameSinkManagerClient::kOnVizTouchStateAvailable), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameSinkManagerClientProxy::OnViewTransitionResourcesCaptured(
    const ::blink::ViewTransitionToken& in_transition_token) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "Send viz::mojom::FrameSinkManagerClient::OnViewTransitionResourcesCaptured", "input_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("transition_token"), in_transition_token,
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameSinkManagerClient::kOnViewTransitionResourcesCaptured), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
      ::viz::mojom::internal::FrameSinkManagerClient_OnViewTransitionResourcesCaptured_Params_Data> params(
          message);
  params.Allocate();
  mojo::internal::MessageFragment<
      typename decltype(params->transition_token)::BaseType> transition_token_fragment(
  ...
  MOJO_INTERNAL_CHECK_SERIALIZATION(
    ...
    !(params->transition_token.is_null()),
    mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
    "null transition_token in FrameSinkManagerClient.OnViewTransitionResourcesCaptured request");

#if defined(ENABLE_IPC_FUZZER)
  message.set_interface_name(FrameSinkManagerClient::Name_);
  message.set_method_name("OnViewTransitionResourcesCaptured");
#endif
  // This return value may be ignored as false implies the Connector has
  // encountered an error, which will be visible through other means.
  ::mojo::internal::SendMojoMessage(*receiver_, message);
...
bool FrameSinkManagerClientStubDispatch::Accept(
  ...
  switch (static_cast<messages::FrameSinkManagerClient>(message->header()->name)) {
    ...
    case messages::FrameSinkManagerClient::kOnVizTouchStateAvailable: {
      ...
      bool success = true;
      ::mojo_base::mojom::ReadOnlySharedMemoryRegionPtr p_region{};
    ...
    case messages::FrameSinkManagerClient::kOnViewTransitionResourcesCaptured: {
      DCHECK(message->is_serialized());
      internal::FrameSinkManagerClient_OnViewTransitionResourcesCaptured_Params_Data* params =
          reinterpret_cast<internal::FrameSinkManagerClient_OnViewTransitionResourcesCaptured_Params_Data*>(
              message->mutable_payload());
      

      // Validation for FrameSinkManagerClient.5
      bool success = true;
      ::blink::ViewTransitionToken p_transition_token{};
      FrameSinkManagerClient_OnViewTransitionResourcesCaptured_ParamsDataView input_data_view(params, message);
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            FrameSinkManagerClient::Name_, 5, false);
        return false;
      }
      // A null |impl| means no implementation was bound.
      DCHECK(impl);
      impl->OnViewTransitionResourcesCaptured(        
        std::move(p_transition_token));
      return true;
    }
  }
...
static const mojo::internal::GenericValidationInfo kFrameSinkManagerClientValidationInfo[] = {
    ...
    { &internal::FrameSinkManagerClient_OnVizTouchStateAvailable_Params_Data::Validate,
     nullptr /* no response */},
    { &internal::FrameSinkManagerClient_OnViewTransitionResourcesCaptured_Params_Data::Validate,
     nullptr /* no response */},
};
...
bool StructTraits<::viz::mojom::RootCompositorFrameSinkParams::DataView, ::viz::mojom::RootCompositorFrameSinkParamsPtr>::Read(
  ...
  ::viz::mojom::RootCompositorFrameSinkParamsPtr result(::viz::mojom::RootCompositorFrameSinkParams::New());
      ...
      if (success)
        result->enable_video_conference_matcher = input.enable_video_conference_matcher();
      if (success) {
...
void FrameSinkManagerInterceptorForTesting::RequestCopyOfOutput(const ::viz::SurfaceId& surface_id, ::std::unique_ptr<::viz::CopyOutputRequest> request, bool capture_exact_surface_id, ::base::TimeDelta timeout) {
...
void FrameSinkManagerClientInterceptorForTesting::OnVizTouchStateAvailable(::mojo_base::mojom::ReadOnlySharedMemoryRegionPtr region) {
  GetForwardingInterface()->OnVizTouchStateAvailable(
    std::move(region)
    );
}
void FrameSinkManagerClientInterceptorForTesting::OnViewTransitionResourcesCaptured(const ::blink::ViewTransitionToken& transition_token) {
  GetForwardingInterface()->OnViewTransitionResourcesCaptured(
    std::move(transition_token)
    );
}
