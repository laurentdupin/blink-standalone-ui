...
static_assert(sizeof(GpuHost_DidUpdateOverlayInfo_Params_Data) == 16,
              "Bad sizeof(GpuHost_DidUpdateOverlayInfo_Params_Data)");
...
static_assert(sizeof(GpuHost_DidUpdateDXGIInfo_Params_Data) == 16,
              "Bad sizeof(GpuHost_DidUpdateDXGIInfo_Params_Data)");
...
static_assert(sizeof(GpuHost_GetIsolationKey_Params_Data) == 32,
              "Bad sizeof(GpuHost_GetIsolationKey_Params_Data)");
...
static_assert(sizeof(GpuHost_GetIsolationKey_ResponseParams_Data) == 16,
              "Bad sizeof(GpuHost_GetIsolationKey_ResponseParams_Data)");
...
static_assert(sizeof(GpuHost_StoreBlobToDisk_Params_Data) == 40,
              "Bad sizeof(GpuHost_StoreBlobToDisk_Params_Data)");
...
static_assert(sizeof(GpuHost_ClearGrShaderDiskCache_Params_Data) == 8,
              "Bad sizeof(GpuHost_ClearGrShaderDiskCache_Params_Data)");
...
class GpuHost_DidUpdateOverlayInfo_ParamsDataView {
 public:
  ...
  GpuHost_DidUpdateOverlayInfo_ParamsDataView(
      internal::GpuHost_DidUpdateOverlayInfo_Params_Data* data,
      mojo::Message* message)
      : data_(data), message_(message) {}

  bool is_null() const { return !data_; }
  inline void GetOverlayInfoDataView(
      ::gpu::mojom::OverlayInfoDataView* output);
...
class GpuHost_DidUpdateDXGIInfo_ParamsDataView {
 public:
  ...
  GpuHost_DidUpdateDXGIInfo_ParamsDataView(
      internal::GpuHost_DidUpdateDXGIInfo_Params_Data* data,
      mojo::Message* message)
      : data_(data), message_(message) {}

  bool is_null() const { return !data_; }
  inline void GetDxgiInfoDataView(
      ::gfx::mojom::DXGIInfoDataView* output);

  template <typename UserType>
  [[nodiscard]] bool ReadDxgiInfo(UserType* output) {
    
    auto* pointer = data_->dxgi_info.Get();
    return mojo::internal::Deserialize<::gfx::mojom::DXGIInfoDataView>(
        pointer, output, message_);
  }
 private:
...
class GpuHost_GetIsolationKey_ParamsDataView {
 public:
  ...
  GpuHost_GetIsolationKey_ParamsDataView(
      internal::GpuHost_GetIsolationKey_Params_Data* data,
      mojo::Message* message)
      : data_(data), message_(message) {}
  ...
  inline void GetWgpuContextTokenDataView(
      ::blink::mojom::WebGPUExecutionContextTokenDataView* output);

  template <typename UserType>
  [[nodiscard]] bool ReadWgpuContextToken(UserType* output) {
    
    auto* pointer = !data_->wgpu_context_token.is_null() ? &data_->wgpu_context_token : nullptr;
    return mojo::internal::Deserialize<::blink::mojom::WebGPUExecutionContextTokenDataView>(
        pointer, output, message_);
  }
 private:
...
class GpuHost_GetIsolationKey_ResponseParamsDataView {
 public:
  ...
  GpuHost_GetIsolationKey_ResponseParamsDataView(
      internal::GpuHost_GetIsolationKey_ResponseParams_Data* data,
      mojo::Message* message)
      : data_(data), message_(message) {}
...
class GpuHost_StoreBlobToDisk_ParamsDataView {
 public:
  ...
  GpuHost_StoreBlobToDisk_ParamsDataView(
      internal::GpuHost_StoreBlobToDisk_Params_Data* data,
      mojo::Message* message)
      : data_(data), message_(message) {}
...
class GpuHost_ClearGrShaderDiskCache_ParamsDataView {
 public:
  ...
  GpuHost_ClearGrShaderDiskCache_ParamsDataView(
      internal::GpuHost_ClearGrShaderDiskCache_Params_Data* data,
      mojo::Message* message)
      : data_(data) {}
...
inline void GpuHost_DidUpdateOverlayInfo_ParamsDataView::GetOverlayInfoDataView(
    ::gpu::mojom::OverlayInfoDataView* output) {
  auto pointer = data_->overlay_info.Get();
...
inline void GpuHost_DidUpdateDXGIInfo_ParamsDataView::GetDxgiInfoDataView(
    ::gfx::mojom::DXGIInfoDataView* output) {
  auto pointer = data_->dxgi_info.Get();
