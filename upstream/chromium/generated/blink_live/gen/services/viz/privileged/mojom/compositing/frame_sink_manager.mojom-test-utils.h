...
class  FrameSinkManagerInterceptorForTesting : public FrameSinkManager {
  ...
  void RequestCopyOfOutput(const ::viz::SurfaceId& surface_id, ::std::unique_ptr<::viz::CopyOutputRequest> request, bool capture_exact_surface_id, ::base::TimeDelta timeout) override;
...
class  FrameSinkManagerClientInterceptorForTesting : public FrameSinkManagerClient {
  ...
  void OnVizTouchStateAvailable(::mojo_base::mojom::ReadOnlySharedMemoryRegionPtr region) override;
  void OnViewTransitionResourcesCaptured(const ::blink::ViewTransitionToken& transition_token) override;
};
