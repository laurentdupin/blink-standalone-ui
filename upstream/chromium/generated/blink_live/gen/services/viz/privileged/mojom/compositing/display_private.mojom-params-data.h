...
static_assert(sizeof(DisplayPrivate_SetMaxVSyncAndVrr_Params_Data) == 24,
              "Bad sizeof(DisplayPrivate_SetMaxVSyncAndVrr_Params_Data)");
...
static_assert(sizeof(DisplayClient_AddChildWindowToBrowser_Params_Data) == 16,
              "Bad sizeof(DisplayClient_AddChildWindowToBrowser_Params_Data)");
...
class DisplayPrivate_SetMaxVSyncAndVrr_ParamsDataView {
 public:
  ...
  DisplayPrivate_SetMaxVSyncAndVrr_ParamsDataView(
      internal::DisplayPrivate_SetMaxVSyncAndVrr_Params_Data* data,
      mojo::Message* message)
      : data_(data), message_(message) {}

  bool is_null() const { return !data_; }
  inline void GetMaxVsyncIntervalDataView(
      ::mojo_base::mojom::TimeDeltaDataView* output);

  template <typename UserType>
  [[nodiscard]] bool ReadMaxVsyncInterval(UserType* output) {
...
static_assert(
  ...
  template <typename UserType>
  [[nodiscard]] bool ReadVrrState(UserType* output) const {
...
class DisplayClient_CreateLayeredWindowUpdater_ParamsDataView {
 public:
  ...
  UserType TakeReceiver() {
    UserType result;
    bool ret =
        mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::viz::mojom::LayeredWindowUpdaterInterfaceBase>>(
            &data_->receiver, &result, message_);
    DCHECK(ret);
    return result;
  }
...
class DisplayClient_AddChildWindowToBrowser_ParamsDataView {
 public:
  ...
  DisplayClient_AddChildWindowToBrowser_ParamsDataView(
      internal::DisplayClient_AddChildWindowToBrowser_Params_Data* data,
      mojo::Message* message)
      : data_(data), message_(message) {}

  bool is_null() const { return !data_; }
  inline void GetChildWindowDataView(
      ::gpu::mojom::SurfaceHandleDataView* output);

  template <typename UserType>
  [[nodiscard]] bool ReadChildWindow(UserType* output) {
...
inline void DisplayPrivate_SetMaxVSyncAndVrr_ParamsDataView::GetMaxVsyncIntervalDataView(
    ::mojo_base::mojom::TimeDeltaDataView* output) {
  auto pointer = data_->max_vsync_interval.Get();
  *output = ::mojo_base::mojom::TimeDeltaDataView(pointer, message_);
}
...
inline void DisplayClient_AddChildWindowToBrowser_ParamsDataView::GetChildWindowDataView(
    ::gpu::mojom::SurfaceHandleDataView* output) {
  auto pointer = data_->child_window.Get();
