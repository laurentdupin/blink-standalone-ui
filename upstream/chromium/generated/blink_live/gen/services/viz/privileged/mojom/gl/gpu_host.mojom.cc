...
uint32_t GpuHost::DidInitialize_Sym::IPCStableHash() {
  ...
  static constexpr uint32_t kHash = 0x0f7cc3bc;  // IPCStableHash for viz::mojom::GpuHost::DidInitialize
...
uint32_t GpuHost::DidFailInitialize_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x52bafb05;  // IPCStableHash for viz::mojom::GpuHost::DidFailInitialize
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t GpuHost::DidCreateContextSuccessfully_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x19a02850;  // IPCStableHash for viz::mojom::GpuHost::DidCreateContextSuccessfully
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t GpuHost::DidCreateOffscreenContext_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x5b2d3e47;  // IPCStableHash for viz::mojom::GpuHost::DidCreateOffscreenContext
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t GpuHost::DidDestroyOffscreenContext_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xcfbb8089;  // IPCStableHash for viz::mojom::GpuHost::DidDestroyOffscreenContext
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t GpuHost::DidDestroyChannel_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x394e61e9;  // IPCStableHash for viz::mojom::GpuHost::DidDestroyChannel
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t GpuHost::DidDestroyAllChannels_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x6dadf171;  // IPCStableHash for viz::mojom::GpuHost::DidDestroyAllChannels
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t GpuHost::DidLoseContext_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x5516989f;  // IPCStableHash for viz::mojom::GpuHost::DidLoseContext
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t GpuHost::DidUpdateGPUInfo_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x7df99141;  // IPCStableHash for viz::mojom::GpuHost::DidUpdateGPUInfo
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t GpuHost::DidUpdateOverlayInfo_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x7d214b4d;  // IPCStableHash for viz::mojom::GpuHost::DidUpdateOverlayInfo
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t GpuHost::DidUpdateDXGIInfo_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xaf6c10eb;  // IPCStableHash for viz::mojom::GpuHost::DidUpdateDXGIInfo
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t GpuHost::DisableGpuCompositing_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x008f38cf;  // IPCStableHash for viz::mojom::GpuHost::DisableGpuCompositing
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t GpuHost::GetIsolationKey_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x185e54f5;  // IPCStableHash for viz::mojom::GpuHost::GetIsolationKey
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t GpuHost::StoreBlobToDisk_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x49ffb63a;  // IPCStableHash for viz::mojom::GpuHost::StoreBlobToDisk
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t GpuHost::ClearGrShaderDiskCache_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x5c7c7af6;  // IPCStableHash for viz::mojom::GpuHost::ClearGrShaderDiskCache
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void GpuHostProxy::DidInitialize(
  ...
  mojo::Message message(
      std::to_underlying(messages::GpuHost::kDidInitialize), kFlags, estimated_payload_size);
  ...
  mojo::internal::Serialize<::gpu::mojom::GpuInfoDataView>(
    in_gpu_info_for_hardware_gpu,
    gpu_info_for_hardware_gpu_fragment);
  ...
  mojo::internal::Serialize<::gpu::mojom::GpuFeatureInfoDataView>(
    in_gpu_feature_info_for_hardware_gpu,
    gpu_feature_info_for_hardware_gpu_fragment);
...
void GpuHostProxy::DidFailInitialize(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::GpuHost::kDidFailInitialize), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void GpuHostProxy::DidCreateContextSuccessfully(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::GpuHost::kDidCreateContextSuccessfully), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void GpuHostProxy::DidCreateOffscreenContext(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::GpuHost::kDidCreateOffscreenContext), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void GpuHostProxy::DidDestroyOffscreenContext(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::GpuHost::kDidDestroyOffscreenContext), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void GpuHostProxy::DidDestroyChannel(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::GpuHost::kDidDestroyChannel), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void GpuHostProxy::DidDestroyAllChannels(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::GpuHost::kDidDestroyAllChannels), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void GpuHostProxy::DidLoseContext(
    ::viz::mojom::ContextLostReason in_reason, const ::GURL& in_active_url) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("reason"), in_reason,
                        "<value of type ::viz::mojom::ContextLostReason>");
      perfetto::WriteIntoTracedValueWithFallback(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::GpuHost::kDidLoseContext), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void GpuHostProxy::DidUpdateGPUInfo(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::GpuHost::kDidUpdateGPUInfo), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void GpuHostProxy::DidUpdateOverlayInfo(
    const ::gpu::OverlayInfo& in_overlay_info) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "Send viz::mojom::GpuHost::DidUpdateOverlayInfo", "input_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::GpuHost::kDidUpdateOverlayInfo), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
      ::viz::mojom::internal::GpuHost_DidUpdateOverlayInfo_Params_Data> params(
          message);
  params.Allocate();
  mojo::internal::MessageFragment<
  ...
  MOJO_INTERNAL_CHECK_SERIALIZATION(
    ...
    mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
    "null overlay_info in GpuHost.DidUpdateOverlayInfo request");
...
void GpuHostProxy::DidUpdateDXGIInfo(
    ::gfx::mojom::DXGIInfoPtr in_dxgi_info) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "Send viz::mojom::GpuHost::DidUpdateDXGIInfo", "input_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::GpuHost::kDidUpdateDXGIInfo), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
      ::viz::mojom::internal::GpuHost_DidUpdateDXGIInfo_Params_Data> params(
          message);
  params.Allocate();
  mojo::internal::MessageFragment<
  ...
  MOJO_INTERNAL_CHECK_SERIALIZATION(
    ...
    mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
    "null dxgi_info in GpuHost.DidUpdateDXGIInfo request");
...
void GpuHostProxy::DisableGpuCompositing(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::GpuHost::kDisableGpuCompositing), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void GpuHostProxy::GetIsolationKey(
    int32_t in_client_id, ::blink::mojom::WebGPUExecutionContextTokenPtr in_wgpu_context_token, GetIsolationKeyCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("wgpu_context_token"), in_wgpu_context_token,
                        "<value of type ::blink::mojom::WebGPUExecutionContextTokenPtr>");
   });
#endif
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::GpuHost::kGetIsolationKey), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
  ...
  mojo::internal::Serialize<::blink::mojom::WebGPUExecutionContextTokenDataView>(
    in_wgpu_context_token,
    wgpu_context_token_fragment,
    true);
...
void GpuHostProxy::StoreBlobToDisk(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::GpuHost::kStoreBlobToDisk), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void GpuHostProxy::ClearGrShaderDiskCache(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::GpuHost::kClearGrShaderDiskCache), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool GpuHostStubDispatch::Accept(
  ...
  switch (static_cast<messages::GpuHost>(message->header()->name)) {
    ...
    case messages::GpuHost::kDidLoseContext: {
      ...
      bool success = true;
      ::viz::mojom::ContextLostReason p_reason{};
      ::GURL p_active_url{};
    ...
    case messages::GpuHost::kDidUpdateOverlayInfo: {
      ...
      internal::GpuHost_DidUpdateOverlayInfo_Params_Data* params =
          reinterpret_cast<internal::GpuHost_DidUpdateOverlayInfo_Params_Data*>(
              message->mutable_payload());
    ...
    case messages::GpuHost::kDidUpdateDXGIInfo: {
      ...
      internal::GpuHost_DidUpdateDXGIInfo_Params_Data* params =
          reinterpret_cast<internal::GpuHost_DidUpdateDXGIInfo_Params_Data*>(
              message->mutable_payload());
...
bool GpuHostStubDispatch::AcceptWithResponder(
  ...
  switch (static_cast<messages::GpuHost>(message->header()->name)) {
    ...
    case messages::GpuHost::kGetIsolationKey: {
      ...
      bool success = true;
      int32_t p_client_id{};
      ::blink::mojom::WebGPUExecutionContextTokenPtr p_wgpu_context_token{};
...
static const mojo::internal::GenericValidationInfo kGpuHostValidationInfo[] = {
    ...
    { &internal::GpuHost_DidUpdateGPUInfo_Params_Data::Validate,
     nullptr /* no response */},
    { &internal::GpuHost_DidUpdateOverlayInfo_Params_Data::Validate,
     nullptr /* no response */},
    { &internal::GpuHost_DidUpdateDXGIInfo_Params_Data::Validate,
     nullptr /* no response */},
...
bool GpuHostRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::viz::mojom::GpuHost::Name_,
    kGpuHostValidationInfo);
}
...
void GpuHostInterceptorForTesting::DidLoseContext(::viz::mojom::ContextLostReason reason, const ::GURL& active_url) {
...
void GpuHostInterceptorForTesting::GetIsolationKey(int32_t client_id, ::blink::mojom::WebGPUExecutionContextTokenPtr wgpu_context_token, GetIsolationKeyCallback callback) {
...
void GpuHostAsyncWaiter::GetIsolationKey(
    int32_t client_id, ::blink::mojom::WebGPUExecutionContextTokenPtr wgpu_context_token, std::string* out_isolation_key) {
  base::RunLoop loop;
...
std::string GpuHostAsyncWaiter::GetIsolationKey(
    int32_t client_id, ::blink::mojom::WebGPUExecutionContextTokenPtr wgpu_context_token) {
