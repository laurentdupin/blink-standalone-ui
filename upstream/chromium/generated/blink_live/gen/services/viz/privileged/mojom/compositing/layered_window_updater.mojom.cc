...
uint32_t LayeredWindowUpdater::OnAllocatedSharedMemory_Sym::IPCStableHash() {
  ...
  static constexpr uint32_t kHash = 0xf190d4b2;  // IPCStableHash for viz::mojom::LayeredWindowUpdater::OnAllocatedSharedMemory
...
uint32_t LayeredWindowUpdater::Draw_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x2cf5ee6e;  // IPCStableHash for viz::mojom::LayeredWindowUpdater::Draw
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void LayeredWindowUpdaterProxy::OnAllocatedSharedMemory(
  ...
  mojo::Message message(
      std::to_underlying(messages::LayeredWindowUpdater::kOnAllocatedSharedMemory), kFlags, estimated_payload_size);
...
void LayeredWindowUpdaterProxy::Draw(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::LayeredWindowUpdater::kDraw), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool LayeredWindowUpdaterRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::viz::mojom::LayeredWindowUpdater::Name_,
    kLayeredWindowUpdaterValidationInfo);
}
