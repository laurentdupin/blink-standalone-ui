...
class  GpuServiceInterceptorForTesting : public GpuService {
  ...
  void EstablishGpuChannel(int32_t client_id, uint64_t client_tracing_id, bool is_gpu_host, bool enable_extra_handles_validation, ::mojo::ScopedMessagePipeHandle channel_handle, EstablishGpuChannelCallback callback) override;
