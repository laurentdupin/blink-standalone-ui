...
// static
bool FrameSinkManagerClient_OnVizTouchStateAvailable_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const FrameSinkManagerClient_OnVizTouchStateAvailable_Params_Data* object =
      static_cast<const FrameSinkManagerClient_OnVizTouchStateAvailable_Params_Data*>(data);
...
FrameSinkManagerClient_OnVizTouchStateAvailable_Params_Data::FrameSinkManagerClient_OnVizTouchStateAvailable_Params_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool FrameSinkManagerClient_OnViewTransitionResourcesCaptured_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const FrameSinkManagerClient_OnViewTransitionResourcesCaptured_Params_Data* object =
      static_cast<const FrameSinkManagerClient_OnViewTransitionResourcesCaptured_Params_Data*>(data);
...
FrameSinkManagerClient_OnViewTransitionResourcesCaptured_Params_Data::FrameSinkManagerClient_OnViewTransitionResourcesCaptured_Params_Data()
    : header_({sizeof(*this), 0}) {}
