...
void FrameSinksMetricsRecorderProxy::StartFrameCounting(
  ...
  mojo::Message message(
      std::to_underlying(messages::FrameSinksMetricsRecorder::kStartFrameCounting), kFlags, estimated_payload_size);
...
void FrameSinksMetricsRecorderProxy::StopFrameCounting(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameSinksMetricsRecorder::kStopFrameCounting), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameSinksMetricsRecorderProxy::StartOverdrawTracking(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameSinksMetricsRecorder::kStartOverdrawTracking), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameSinksMetricsRecorderProxy::StopOverdrawTracking(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameSinksMetricsRecorder::kStopOverdrawTracking), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
