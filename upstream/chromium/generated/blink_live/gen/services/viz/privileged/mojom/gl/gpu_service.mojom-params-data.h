...
static_assert(sizeof(GpuService_EstablishGpuChannel_Params_Data) == 32,
...
static_assert(sizeof(GpuService_RegisterDCOMPSurfaceHandle_Params_Data) == 16,
              "Bad sizeof(GpuService_RegisterDCOMPSurfaceHandle_Params_Data)");
...
static_assert(sizeof(GpuService_RegisterDCOMPSurfaceHandle_ResponseParams_Data) == 16,
              "Bad sizeof(GpuService_RegisterDCOMPSurfaceHandle_ResponseParams_Data)");
...
static_assert(sizeof(GpuService_UnregisterDCOMPSurfaceHandle_Params_Data) == 16,
              "Bad sizeof(GpuService_UnregisterDCOMPSurfaceHandle_Params_Data)");
...
static_assert(sizeof(GpuService_RequestDXGIInfo_Params_Data) == 8,
              "Bad sizeof(GpuService_RequestDXGIInfo_Params_Data)");
...
static_assert(sizeof(GpuService_RequestDXGIInfo_ResponseParams_Data) == 16,
              "Bad sizeof(GpuService_RequestDXGIInfo_ResponseParams_Data)");
...
class GpuService_RegisterDCOMPSurfaceHandle_ParamsDataView {
 public:
  ...
  GpuService_RegisterDCOMPSurfaceHandle_ParamsDataView(
      internal::GpuService_RegisterDCOMPSurfaceHandle_Params_Data* data,
      mojo::Message* message)
      : data_(data), message_(message) {}
  ...
  mojo::PlatformHandle TakeSurfaceHandle() {
    ...
    bool ret =
        mojo::internal::Deserialize<mojo::PlatformHandle>(
            &data_->surface_handle, &result, message_);
    DCHECK(ret);
    return result;
  }
 private:
...
class GpuService_RegisterDCOMPSurfaceHandle_ResponseParamsDataView {
 public:
  ...
  GpuService_RegisterDCOMPSurfaceHandle_ResponseParamsDataView(
      internal::GpuService_RegisterDCOMPSurfaceHandle_ResponseParams_Data* data,
      mojo::Message* message)
      : data_(data), message_(message) {}
...
class GpuService_UnregisterDCOMPSurfaceHandle_ParamsDataView {
 public:
  ...
  GpuService_UnregisterDCOMPSurfaceHandle_ParamsDataView(
      internal::GpuService_UnregisterDCOMPSurfaceHandle_Params_Data* data,
      mojo::Message* message)
      : data_(data), message_(message) {}
...
class GpuService_RequestDXGIInfo_ParamsDataView {
 public:
  ...
  GpuService_RequestDXGIInfo_ParamsDataView(
      internal::GpuService_RequestDXGIInfo_Params_Data* data,
      mojo::Message* message)
      : data_(data) {}
...
class GpuService_RequestDXGIInfo_ResponseParamsDataView {
 public:
  ...
  GpuService_RequestDXGIInfo_ResponseParamsDataView(
      internal::GpuService_RequestDXGIInfo_ResponseParams_Data* data,
      mojo::Message* message)
      : data_(data), message_(message) {}
...
inline void GpuService_RegisterDCOMPSurfaceHandle_ResponseParamsDataView::GetTokenDataView(
    ::mojo_base::mojom::UnguessableTokenDataView* output) {
  auto pointer = data_->token.Get();
...
inline void GpuService_UnregisterDCOMPSurfaceHandle_ParamsDataView::GetTokenDataView(
    ::mojo_base::mojom::UnguessableTokenDataView* output) {
  auto pointer = data_->token.Get();
  *output = ::mojo_base::mojom::UnguessableTokenDataView(pointer, message_);
}
...
inline void GpuService_RequestDXGIInfo_ResponseParamsDataView::GetDxgiInfoDataView(
    ::gfx::mojom::DXGIInfoDataView* output) {
  auto pointer = data_->dxgi_info.Get();
