...
class FrameSinkManager
 ...
 public:
  ...
  static constexpr const char* Name_ = "viz.mojom.FrameSinkManager";
...
// with not having this data in traces there.
  ...
  using InvalidateFrameSinkIdCallback = base::OnceCallback<void()>;
  using InvalidateFrameSinkIdMojoCallback = base::OnceCallback<void()>;

  virtual void InvalidateFrameSinkId(const ::viz::FrameSinkId& frame_sink_id, InvalidateFrameSinkIdCallback callback) = 0;
  ...
  using DestroyCompositorFrameSinkMojoCallback = base::OnceCallback<void()>;
  ...
  virtual void RequestCopyOfOutput(const ::viz::SurfaceId& surface_id, ::std::unique_ptr<::viz::CopyOutputRequest> request, bool capture_exact_surface_id, ::base::TimeDelta timeout) = 0;
...
class FrameSinkManagerClient
 ...
 public:
  using IPCStableHashFunction = uint32_t(*)();
  static constexpr const char* Name_ = "viz.mojom.FrameSinkManagerClient";
  static IPCStableHashFunction MessageToMethodInfo_(mojo::Message& message);
  static const char* MessageToMethodName_(mojo::Message& message);
  static constexpr uint32_t Version_ = 0;
  ...
  enum MethodMinVersions : uint32_t {
    ...
    kOnVizTouchStateAvailableMinVersion = 0,
    kOnViewTransitionResourcesCapturedMinVersion = 0,
  };
...
// with not having this data in traces there.
  ...
  struct OnVizTouchStateAvailable_Sym {
    NOINLINE static uint32_t IPCStableHash();
  };
  struct OnViewTransitionResourcesCaptured_Sym {
    NOINLINE static uint32_t IPCStableHash();
  };
#endif // !BUILDFLAG(IS_FUCHSIA)
  ...
  virtual void OnVizTouchStateAvailable(::mojo_base::mojom::ReadOnlySharedMemoryRegionPtr region) = 0;

  virtual void OnViewTransitionResourcesCaptured(const ::blink::ViewTransitionToken& transition_token) = 0;
};
...
class  FrameSinkManagerProxy
 ...
 public:
  ...
  void InvalidateFrameSinkId(const ::viz::FrameSinkId& frame_sink_id, InvalidateFrameSinkIdCallback callback) final;
  ...
  void RequestCopyOfOutput(const ::viz::SurfaceId& surface_id, ::std::unique_ptr<::viz::CopyOutputRequest> request, bool capture_exact_surface_id, ::base::TimeDelta timeout) final;
...
class  FrameSinkManagerClientProxy
 ...
 public:
  ...
  void OnVizTouchStateAvailable(::mojo_base::mojom::ReadOnlySharedMemoryRegionPtr region) final;
  
  void OnViewTransitionResourcesCaptured(const ::blink::ViewTransitionToken& transition_token) final;
...
class  RootCompositorFrameSinkParams {
 public:
  ...
  RootCompositorFrameSinkParams(
      ...
      ::mojo::PendingAssociatedRemote<::viz::mojom::ExternalBeginFrameControllerClient> external_begin_frame_controller_client);
...
RootCompositorFrameSinkParamsPtr RootCompositorFrameSinkParams::Clone() const {
  return New(
      ...
      mojo::Clone(enable_video_conference_matcher),
...
bool RootCompositorFrameSinkParams::Equals(const T& other_struct) const {
  ...
  if (!mojo::Equals(this->disable_frame_rate_limit, other_struct.disable_frame_rate_limit))
    return false;
  if (!mojo::Equals(this->enable_video_conference_matcher, other_struct.enable_video_conference_matcher))
    return false;
...
bool operator<(const T& lhs, const T& rhs) {
  ...
  if (rhs.disable_frame_rate_limit < lhs.disable_frame_rate_limit)
    return false;
  if (lhs.enable_video_conference_matcher < rhs.enable_video_conference_matcher)
    return true;
  if (rhs.enable_video_conference_matcher < lhs.enable_video_conference_matcher)
    return false;
  ...
  if (rhs.external_begin_frame_controller < lhs.external_begin_frame_controller)
    return false;
  if (lhs.external_begin_frame_controller_client < rhs.external_begin_frame_controller_client)
    return true;
  if (rhs.external_begin_frame_controller_client < lhs.external_begin_frame_controller_client)
    return false;
  return false;
}
...
struct  StructTraits<::viz::mojom::RootCompositorFrameSinkParams::DataView,
  ...
  static decltype(::viz::mojom::RootCompositorFrameSinkParams::enable_video_conference_matcher) enable_video_conference_matcher(
      const ::viz::mojom::RootCompositorFrameSinkParamsPtr& input) {
    return input->enable_video_conference_matcher;
  }
