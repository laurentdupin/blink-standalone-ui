// services/viz/privileged/mojom/compositing/begin_frame_observer.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "services/viz/privileged/mojom/compositing/begin_frame_observer.mojom-blink.h"
#include <math.h>
#include <stdint.h>
#include <utility>
...
#include "services/viz/privileged/mojom/compositing/begin_frame_observer.mojom-blink-import-headers.h"
#include "services/viz/privileged/mojom/compositing/begin_frame_observer.mojom-blink-test-utils.h"
...
uint32_t BeginFrameObserver::OnStandaloneBeginFrame_Sym::IPCStableHash() {
  ...
  static constexpr uint32_t kHash = 0x8465978b;  // IPCStableHash for viz::mojom::BeginFrameObserver::OnStandaloneBeginFrame
...
void BeginFrameObserverProxy::OnStandaloneBeginFrame(
  ...
  mojo::Message message(
      std::to_underlying(messages::BeginFrameObserver::kOnStandaloneBeginFrame), kFlags, estimated_payload_size);
...
bool BeginFrameObserverRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::viz::mojom::blink::BeginFrameObserver::Name_,
    kBeginFrameObserverValidationInfo);
}
...
void BeginFrameObserverInterceptorForTesting::OnStandaloneBeginFrame(const ::viz::BeginFrameArgs& args) {
  GetForwardingInterface()->OnStandaloneBeginFrame(
    std::move(args)
    );
}
