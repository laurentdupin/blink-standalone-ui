...
NOINLINE static const char* BufferFormatPreferenceToStringHelper(BufferFormatPreference value) {
  ...
  switch(value) {
    case BufferFormatPreference::kDefault:
      return "kDefault";
    case BufferFormatPreference::kPreferMappableSharedImage:
      return "kPreferMappableSharedImage";
    case BufferFormatPreference::kPreferSharedImageWithNativeHandle:
      return "kPreferSharedImageWithNativeHandle";
    default:
      return nullptr;
  }
}
...
// static
bool FrameSinkVideoConsumer_OnNewCaptureVersion_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const FrameSinkVideoConsumer_OnNewCaptureVersion_Params_Data* object =
      static_cast<const FrameSinkVideoConsumer_OnNewCaptureVersion_Params_Data*>(data);
...
FrameSinkVideoConsumer_OnNewCaptureVersion_Params_Data::FrameSinkVideoConsumer_OnNewCaptureVersion_Params_Data()
    : header_({sizeof(*this), 0}) {}
...
// static
bool FrameSinkVideoCapturer_SetAnimationFpsLockIn_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const FrameSinkVideoCapturer_SetAnimationFpsLockIn_Params_Data* object =
      static_cast<const FrameSinkVideoCapturer_SetAnimationFpsLockIn_Params_Data*>(data);

  return true;
}

FrameSinkVideoCapturer_SetAnimationFpsLockIn_Params_Data::FrameSinkVideoCapturer_SetAnimationFpsLockIn_Params_Data()
    : header_({sizeof(*this), 0}) {}
