...
// static
bool GpuServiceCreationParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const GpuServiceCreationParams_Data* object =
      static_cast<const GpuServiceCreationParams_Data*>(data);
...
bool VizMain_CreateGpuService_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->gpu_logging, 3, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateHandleOrInterface(object->gpu_logging,
                                                 validation_context)) {
    return false;
  }

  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->discardable_memory_manager, 4, validation_context)) {
    return false;
  }
...
// static
bool VizMain_SetRenderParams_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const VizMain_SetRenderParams_Params_Data* object =
      static_cast<const VizMain_SetRenderParams_Params_Data*>(data);
...
// static
bool VizMain_CreateInfoCollectionGpuService_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->info_collection_gpu_service, 1, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateHandleOrInterface(object->info_collection_gpu_service,
                                                 validation_context)) {
    return false;
  }
