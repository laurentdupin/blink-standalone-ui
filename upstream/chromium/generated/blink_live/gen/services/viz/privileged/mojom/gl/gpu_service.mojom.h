...
#include "components/persistent_cache/mojom/persistent_cache.mojom-forward.h"
...
class GpuService
 ...
 public:
  ...
  enum MethodMinVersions : uint32_t {
    ...
    kSetChannelPersistentCachePendingBackendMinVersion = 0,
...
// with not having this data in traces there.
  ...
  struct SetChannelPersistentCachePendingBackend_Sym {
    NOINLINE static uint32_t IPCStableHash();
  };
  ...
  virtual bool EstablishGpuChannel(int32_t client_id, uint64_t client_tracing_id, bool is_gpu_host, bool enable_extra_handles_validation, ::mojo::ScopedMessagePipeHandle channel_handle, bool* out_success, ::gpu::GPUInfo* out_gpu_info, ::gpu::GpuFeatureInfo* out_gpu_feature_info, ::gpu::SharedImageCapabilities* out_shared_image_capabilities);
  using EstablishGpuChannelCallback = base::OnceCallback<void(bool, const ::gpu::GPUInfo&, const ::gpu::GpuFeatureInfo&, const ::gpu::SharedImageCapabilities&)>;
  using EstablishGpuChannelMojoCallback = base::OnceCallback<void(bool, const ::gpu::GPUInfo&, const ::gpu::GpuFeatureInfo&, const ::gpu::SharedImageCapabilities&)>;

  virtual void EstablishGpuChannel(int32_t client_id, uint64_t client_tracing_id, bool is_gpu_host, bool enable_extra_handles_validation, ::mojo::ScopedMessagePipeHandle channel_handle, EstablishGpuChannelCallback callback) = 0;
  ...
  virtual void SetChannelPersistentCachePendingBackend(int32_t client_id, const ::gpu::GpuDiskCacheHandle& cache_handle, ::persistent_cache::PendingBackend pending_backend) = 0;
  ...
  using RegisterDCOMPSurfaceHandleMojoCallback = base::OnceCallback<void(const std::optional<::base::UnguessableToken>&)>;
  ...
  using RequestDXGIInfoMojoCallback = base::OnceCallback<void(::gfx::mojom::DXGIInfoPtr)>;
...
class  GpuServiceProxy
 ...
 public:
  ...
  bool EstablishGpuChannel(int32_t client_id, uint64_t client_tracing_id, bool is_gpu_host, bool enable_extra_handles_validation, ::mojo::ScopedMessagePipeHandle channel_handle, bool* out_success, ::gpu::GPUInfo* out_gpu_info, ::gpu::GpuFeatureInfo* out_gpu_feature_info, ::gpu::SharedImageCapabilities* out_shared_image_capabilities) final;
  
  void EstablishGpuChannel(int32_t client_id, uint64_t client_tracing_id, bool is_gpu_host, bool enable_extra_handles_validation, ::mojo::ScopedMessagePipeHandle channel_handle, EstablishGpuChannelCallback callback) final;
  ...
  void SetChannelPersistentCachePendingBackend(int32_t client_id, const ::gpu::GpuDiskCacheHandle& cache_handle, ::persistent_cache::PendingBackend pending_backend) final;
