...
// with not having this data in traces there.
  ...
  virtual void ProvideFeedback(::media::mojom::VideoCaptureFeedbackPtr feedback) = 0;
};
...
// with not having this data in traces there.
  ...
  virtual void OnFrameCaptured(::media::mojom::VideoBufferHandlePtr data, ::media::mojom::VideoFrameInfoPtr info, ::gfx::mojom::RectPtr content_rect, ::mojo::PendingRemote<FrameSinkVideoConsumerFrameCallbacks> callbacks) = 0;

  virtual void OnNewCaptureVersion(::media::mojom::CaptureVersionPtr capture_version) = 0;
...
// with not having this data in traces there.
  ...
  virtual void SetFormat(::media::mojom::VideoPixelFormat format) = 0;

  virtual void SetMinCapturePeriod(::mojo_base::mojom::TimeDeltaPtr min_period) = 0;

  virtual void SetMinSizeChangePeriod(::mojo_base::mojom::TimeDeltaPtr min_period) = 0;

  virtual void SetResolutionConstraints(::gfx::mojom::SizePtr min_size, ::gfx::mojom::SizePtr max_size, bool use_fixed_aspect_ratio) = 0;
  ...
  virtual void ChangeTarget(VideoCaptureTargetPtr target, uint32_t sub_capture_version) = 0;
...
// with not having this data in traces there.
  ...
  virtual void SetImageAndBounds(::skia::mojom::BitmapN32Ptr image, ::gfx::mojom::RectFPtr bounds) = 0;

  virtual void SetBounds(::gfx::mojom::RectFPtr bounds) = 0;

  virtual void OnCapturedMouseEvent(::gfx::mojom::PointPtr coordinates) = 0;
};
...
class  FrameSinkVideoConsumerFrameCallbacksProxy
 ...
 public:
  ...
  void ProvideFeedback(::media::mojom::VideoCaptureFeedbackPtr feedback) final;
...
class  FrameSinkVideoConsumerProxy
 ...
 public:
  ...
  void OnFrameCaptured(::media::mojom::VideoBufferHandlePtr data, ::media::mojom::VideoFrameInfoPtr info, ::gfx::mojom::RectPtr content_rect, ::mojo::PendingRemote<FrameSinkVideoConsumerFrameCallbacks> callbacks) final;
  
  void OnNewCaptureVersion(::media::mojom::CaptureVersionPtr capture_version) final;
...
class  FrameSinkVideoCapturerProxy
 ...
 public:
  ...
  void SetFormat(::media::mojom::VideoPixelFormat format) final;
  
  void SetMinCapturePeriod(::mojo_base::mojom::TimeDeltaPtr min_period) final;
  
  void SetMinSizeChangePeriod(::mojo_base::mojom::TimeDeltaPtr min_period) final;
  
  void SetResolutionConstraints(::gfx::mojom::SizePtr min_size, ::gfx::mojom::SizePtr max_size, bool use_fixed_aspect_ratio) final;
  ...
  void ChangeTarget(VideoCaptureTargetPtr target, uint32_t sub_capture_version) final;
...
class  FrameSinkVideoCaptureOverlayProxy
 ...
 public:
  ...
  void SetImageAndBounds(::skia::mojom::BitmapN32Ptr image, ::gfx::mojom::RectFPtr bounds) final;
  
  void SetBounds(::gfx::mojom::RectFPtr bounds) final;
  
  void OnCapturedMouseEvent(::gfx::mojom::PointPtr coordinates) final;
...
class  VideoCaptureSubTarget {
 public:
  ...
  const ::viz::mojom::SubtreeCaptureIdPtr& get_subtree_capture_id() const {
    CHECK(tag_ == Tag::kSubtreeCaptureId);
    return data_.subtree_capture_id;
  }
  ::viz::mojom::SubtreeCaptureIdPtr& get_subtree_capture_id() {
    CHECK(tag_ == Tag::kSubtreeCaptureId);
    return data_.subtree_capture_id;
  }
  void set_subtree_capture_id(::viz::mojom::SubtreeCaptureIdPtr subtree_capture_id);

  bool is_region_capture_crop_id() const { return tag_ == Tag::kRegionCaptureCropId; }
  const ::mojo_base::mojom::TokenPtr& get_region_capture_crop_id() const {
    CHECK(tag_ == Tag::kRegionCaptureCropId);
    return data_.region_capture_crop_id;
  }
  ::mojo_base::mojom::TokenPtr& get_region_capture_crop_id() {
    CHECK(tag_ == Tag::kRegionCaptureCropId);
    return data_.region_capture_crop_id;
  }
  void set_region_capture_crop_id(::mojo_base::mojom::TokenPtr region_capture_crop_id);
 ...
 private:
  ...
  union Union_ {
    ...
    ::viz::mojom::SubtreeCaptureIdPtr subtree_capture_id;
    ::mojo_base::mojom::TokenPtr region_capture_crop_id;
  };
...
class  VideoCaptureTarget {
 public:
  ...
  VideoCaptureTarget(
      ::viz::mojom::FrameSinkIdPtr frame_sink_id,
      VideoCaptureSubTargetPtr sub_target);

VideoCaptureTarget(const VideoCaptureTarget&) = delete;
VideoCaptureTarget& operator=(const VideoCaptureTarget&) = delete;
...
struct  UnionTraits<::viz::mojom::VideoCaptureSubTarget::DataView,
  ...
  static const ::viz::mojom::SubtreeCaptureIdPtr& subtree_capture_id(const ::viz::mojom::VideoCaptureSubTargetPtr& input) {
    return input->get_subtree_capture_id();
  }

  static const ::mojo_base::mojom::TokenPtr& region_capture_crop_id(const ::viz::mojom::VideoCaptureSubTargetPtr& input) {
