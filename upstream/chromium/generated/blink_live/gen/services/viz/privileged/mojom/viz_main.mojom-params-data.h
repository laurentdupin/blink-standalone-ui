...
class  VizMain_CreateGpuService_Params_Data {
 public:
  ...
  mojo::internal::Interface_Data gpu_logging;
...
static_assert(sizeof(VizMain_CreateGpuService_Params_Data) == 56,
...
static_assert(sizeof(VizMain_SetRenderParams_Params_Data) == 24,
              "Bad sizeof(VizMain_SetRenderParams_Params_Data)");
...
static_assert(sizeof(VizMain_CreateInfoCollectionGpuService_Params_Data) == 16,
              "Bad sizeof(VizMain_CreateInfoCollectionGpuService_Params_Data)");
...
class VizMain_CreateGpuService_ParamsDataView {
 public:
  ...
  template <typename UserType>
  UserType TakeGpuLogging() {
    UserType result;
    bool ret =
        mojo::internal::Deserialize<mojo::InterfacePtrDataView<::viz::mojom::GpuLoggingInterfaceBase>>(
            &data_->gpu_logging, &result, message_);
    DCHECK(ret);
    return result;
  }
  template <typename UserType>
  ...
  inline void GetUseShaderCacheShmCountDataView(
      ::mojo_base::mojom::UnsafeSharedMemoryRegionDataView* output);

  template <typename UserType>
  [[nodiscard]] bool ReadUseShaderCacheShmCount(UserType* output) {
...
static_assert(
  ...
  inline void GetParamsDataView(
      GpuServiceCreationParamsDataView* output);

  template <typename UserType>
  [[nodiscard]] bool ReadParams(UserType* output) {
    
    auto* pointer = data_->params.Get();
    return mojo::internal::Deserialize<::viz::mojom::GpuServiceCreationParamsDataView>(
        pointer, output, message_);
  }
 private:
...
class VizMain_SetRenderParams_ParamsDataView {
 public:
  ...
  VizMain_SetRenderParams_ParamsDataView(
      internal::VizMain_SetRenderParams_Params_Data* data,
      mojo::Message* message)
      : data_(data) {}
...
class VizMain_CreateInfoCollectionGpuService_ParamsDataView {
 public:
  ...
  VizMain_CreateInfoCollectionGpuService_ParamsDataView(
      internal::VizMain_CreateInfoCollectionGpuService_Params_Data* data,
      mojo::Message* message)
      : data_(data), message_(message) {}

  bool is_null() const { return !data_; }
  template <typename UserType>
  UserType TakeInfoCollectionGpuService() {
    UserType result;
    bool ret =
        mojo::internal::Deserialize<mojo::InterfaceRequestDataView<::viz::mojom::InfoCollectionGpuServiceInterfaceBase>>(
...
inline void VizMain_CreateGpuService_ParamsDataView::GetUseShaderCacheShmCountDataView(
    ::mojo_base::mojom::UnsafeSharedMemoryRegionDataView* output) {
  auto pointer = data_->use_shader_cache_shm_count.Get();
  *output = ::mojo_base::mojom::UnsafeSharedMemoryRegionDataView(pointer, message_);
}
inline void VizMain_CreateGpuService_ParamsDataView::GetParamsDataView(
    GpuServiceCreationParamsDataView* output) {
  auto pointer = data_->params.Get();
