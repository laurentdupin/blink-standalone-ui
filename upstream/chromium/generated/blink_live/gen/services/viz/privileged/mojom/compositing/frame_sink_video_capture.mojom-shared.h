...
#include "services/viz/privileged/mojom/compositing/frame_sink_video_capture.mojom-data-view.h"  // IWYU pragma: export
...
struct Serializer<::viz::mojom::BufferFormatPreference, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::viz::mojom::BufferFormatPreference>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::viz::mojom::BufferFormatPreference, UserType> ||
                        HasInfallibleConversion(::viz::mojom::BufferFormatPreference()),
                    "::viz::mojom::BufferFormatPreference does not have an infallible conversion, "
