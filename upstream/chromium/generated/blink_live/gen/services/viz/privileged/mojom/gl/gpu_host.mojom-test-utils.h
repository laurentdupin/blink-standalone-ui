...
class  GpuHostInterceptorForTesting : public GpuHost {
  ...
  void DidLoseContext(::viz::mojom::ContextLostReason reason, const ::GURL& active_url) override;
  ...
  void GetIsolationKey(int32_t client_id, ::blink::mojom::WebGPUExecutionContextTokenPtr wgpu_context_token, GetIsolationKeyCallback callback) override;
...
class  GpuHostAsyncWaiter {
 public:
  ...
  ~GpuHostAsyncWaiter();
  void GetIsolationKey(
      int32_t client_id, ::blink::mojom::WebGPUExecutionContextTokenPtr wgpu_context_token, std::string* out_isolation_key);
  std::string GetIsolationKey(int32_t client_id, ::blink::mojom::WebGPUExecutionContextTokenPtr wgpu_context_token);
