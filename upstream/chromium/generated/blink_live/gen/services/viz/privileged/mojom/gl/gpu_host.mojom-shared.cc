...
// static
bool GpuHost_DidUpdateOverlayInfo_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const GpuHost_DidUpdateOverlayInfo_Params_Data* object =
      static_cast<const GpuHost_DidUpdateOverlayInfo_Params_Data*>(data);
...
// static
bool GpuHost_DidUpdateDXGIInfo_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const GpuHost_DidUpdateDXGIInfo_Params_Data* object =
      static_cast<const GpuHost_DidUpdateDXGIInfo_Params_Data*>(data);
