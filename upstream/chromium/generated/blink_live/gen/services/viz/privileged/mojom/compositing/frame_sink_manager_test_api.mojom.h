...
class FrameSinkManagerTestApi
 ...
 public:
  ...
  static constexpr const char* Name_ = "viz.mojom.FrameSinkManagerTestApi";
...
// with not having this data in traces there.
  ...
  using HasUnclaimedViewTransitionResourcesMojoCallback = base::OnceCallback<void(bool)>;
  ...
  using SetSameDocNavigationScreenshotSizeMojoCallback = base::OnceCallback<void()>;
  ...
  using GetForceEnableZoomStateMojoCallback = base::OnceCallback<void(bool)>;
  ...
  using WaitForSurfaceAnimationManagerMojoCallback = base::OnceCallback<void()>;
