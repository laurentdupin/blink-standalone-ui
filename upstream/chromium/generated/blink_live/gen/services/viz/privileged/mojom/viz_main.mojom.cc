...
uint32_t VizMain::CreateInfoCollectionGpuService_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xee9b7bd2;  // IPCStableHash for viz::mojom::VizMain::CreateInfoCollectionGpuService
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void VizMainProxy::CreateFrameSinkManager(
  ...
  mojo::Message message(
      std::to_underlying(messages::VizMain::kCreateFrameSinkManager), kFlags, estimated_payload_size);
...
void VizMainProxy::CreateGpuService(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::VizMain::kCreateGpuService), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void VizMainProxy::SetRenderParams(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::VizMain::kSetRenderParams), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void VizMainProxy::CreateInfoCollectionGpuService(
    ::mojo::PendingReceiver<::viz::mojom::InfoCollectionGpuService> in_info_collection_gpu_service) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "Send viz::mojom::VizMain::CreateInfoCollectionGpuService", "input_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("info_collection_gpu_service"), in_info_collection_gpu_service,
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::VizMain::kCreateInfoCollectionGpuService), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
      ::viz::mojom::internal::VizMain_CreateInfoCollectionGpuService_Params_Data> params(
          message);
  params.Allocate();

  
  mojo::internal::Serialize<mojo::InterfaceRequestDataView<::viz::mojom::InfoCollectionGpuServiceInterfaceBase>>(
    in_info_collection_gpu_service,
    &params->info_collection_gpu_service,
    &params.message());

  
  MOJO_INTERNAL_CHECK_SERIALIZATION(
    mojo::internal::SendValidation::kDefault,
    !(!mojo::internal::IsHandleOrInterfaceValid(params->info_collection_gpu_service)),
    mojo::internal::VALIDATION_ERROR_UNEXPECTED_INVALID_HANDLE,
    "invalid info_collection_gpu_service in VizMain.CreateInfoCollectionGpuService request");
  ...
  switch (static_cast<messages::VizMain>(message->header()->name)) {
    ...
    case messages::VizMain::kCreateInfoCollectionGpuService: {
      ...
      internal::VizMain_CreateInfoCollectionGpuService_Params_Data* params =
          reinterpret_cast<internal::VizMain_CreateInfoCollectionGpuService_Params_Data*>(
              message->mutable_payload());
      ...
      if (success) {
        p_info_collection_gpu_service =
            input_data_view.TakeInfoCollectionGpuService<decltype(p_info_collection_gpu_service)>();
      }
      if (!success) {
        ReportValidationErrorForMessage(
            message,
      ...
      // A null |impl| means no implementation was bound.
      DCHECK(impl);
      impl->CreateInfoCollectionGpuService(        
        std::move(p_info_collection_gpu_service));
      return true;
    }
  }
  return false;
...
static const mojo::internal::GenericValidationInfo kVizMainValidationInfo[] = {
    ...
    { &internal::VizMain_SetRenderParams_Params_Data::Validate,
     nullptr /* no response */},
    { &internal::VizMain_CreateInfoCollectionGpuService_Params_Data::Validate,
     nullptr /* no response */},
};
...
void VizMainInterceptorForTesting::CreateInfoCollectionGpuService(::mojo::PendingReceiver<::viz::mojom::InfoCollectionGpuService> info_collection_gpu_service) {
  GetForwardingInterface()->CreateInfoCollectionGpuService(
    std::move(info_collection_gpu_service)
    );
}
