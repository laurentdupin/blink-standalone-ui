...
#include "services/viz/public/mojom/compositing/compositing_mode_watcher.mojom-test-utils.h"
...
uint32_t CompositingModeWatcher::CompositingModeFallbackToSoftware_Sym::IPCStableHash() {
  ...
  static constexpr uint32_t kHash = 0xbcac840e;  // IPCStableHash for viz::mojom::CompositingModeWatcher::CompositingModeFallbackToSoftware
...
void CompositingModeWatcherProxy::CompositingModeFallbackToSoftware(
  ...
  mojo::Message message(
      std::to_underlying(messages::CompositingModeWatcher::kCompositingModeFallbackToSoftware), kFlags, estimated_payload_size);
...
bool CompositingModeWatcherRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::viz::mojom::CompositingModeWatcher::Name_,
    kCompositingModeWatcherValidationInfo);
}
...
uint32_t CompositingModeReporter::AddCompositingModeWatcher_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x6eeed3ac;  // IPCStableHash for viz::mojom::CompositingModeReporter::AddCompositingModeWatcher
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void CompositingModeReporterProxy::AddCompositingModeWatcher(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::CompositingModeReporter::kAddCompositingModeWatcher), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool CompositingModeReporterRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::viz::mojom::CompositingModeReporter::Name_,
    kCompositingModeReporterValidationInfo);
}
...
void CompositingModeReporterInterceptorForTesting::AddCompositingModeWatcher(::mojo::PendingRemote<CompositingModeWatcher> watcher) {
  GetForwardingInterface()->AddCompositingModeWatcher(
    std::move(watcher)
    );
}
