...
#include "services/viz/public/mojom/compositing/compositor_frame_metadata.mojom-forward.h"  // IWYU pragma: export
...
class  CompositorFrameMetadata {
 public:
  ...
  CompositorFrameMetadata(
      ...
      bool is_software,
      std::vector<::viz::mojom::OffsetTagDefinitionPtr> offset_tag_definitions,
      std::vector<::viz::OffsetTagValue> offset_tag_values,
      ::viz::mojom::FrameIntervalInputsPtr frame_interval_inputs,
...
CompositorFrameMetadata& operator=(const CompositorFrameMetadata&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CompositorFrameMetadata::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
struct  StructTraits<::viz::mojom::CompositorFrameMetadata::DataView,
  ...
  static const decltype(::viz::mojom::CompositorFrameMetadata::visible_viewport_size)& visible_viewport_size(
      const ::viz::mojom::CompositorFrameMetadataPtr& input) {
  ...
  static decltype(::viz::mojom::CompositorFrameMetadata::may_throttle_if_undrawn_frames) may_throttle_if_undrawn_frames(
      const ::viz::mojom::CompositorFrameMetadataPtr& input) {
    return input->may_throttle_if_undrawn_frames;
  }

  static decltype(::viz::mojom::CompositorFrameMetadata::is_handling_interaction) is_handling_interaction(
      const ::viz::mojom::CompositorFrameMetadataPtr& input) {
    return input->is_handling_interaction;
  }

  static decltype(::viz::mojom::CompositorFrameMetadata::is_handling_animation) is_handling_animation(
      const ::viz::mojom::CompositorFrameMetadataPtr& input) {
    return input->is_handling_animation;
  }

  static const decltype(::viz::mojom::CompositorFrameMetadata::root_background_color)& root_background_color(
      const ::viz::mojom::CompositorFrameMetadataPtr& input) {
  ...
  static decltype(::viz::mojom::CompositorFrameMetadata::is_mobile_optimized) is_mobile_optimized(
      const ::viz::mojom::CompositorFrameMetadataPtr& input) {
  ...
  static const decltype(::viz::mojom::CompositorFrameMetadata::transition_directives)& transition_directives(
      const ::viz::mojom::CompositorFrameMetadataPtr& input) {
    return input->transition_directives;
  }

  static const decltype(::viz::mojom::CompositorFrameMetadata::capture_bounds)& capture_bounds(
      const ::viz::mojom::CompositorFrameMetadataPtr& input) {
    return input->capture_bounds;
  }

  static decltype(::viz::mojom::CompositorFrameMetadata::has_shared_element_resources) has_shared_element_resources(
      const ::viz::mojom::CompositorFrameMetadataPtr& input) {
    return input->has_shared_element_resources;
  }

  static const decltype(::viz::mojom::CompositorFrameMetadata::screenshot_destination)& screenshot_destination(
      const ::viz::mojom::CompositorFrameMetadataPtr& input) {
    return input->screenshot_destination;
  }

  static decltype(::viz::mojom::CompositorFrameMetadata::is_software) is_software(
      const ::viz::mojom::CompositorFrameMetadataPtr& input) {
    return input->is_software;
  }

  static const decltype(::viz::mojom::CompositorFrameMetadata::offset_tag_definitions)& offset_tag_definitions(
      const ::viz::mojom::CompositorFrameMetadataPtr& input) {
    return input->offset_tag_definitions;
  }

  static const decltype(::viz::mojom::CompositorFrameMetadata::offset_tag_values)& offset_tag_values(
      const ::viz::mojom::CompositorFrameMetadataPtr& input) {
    return input->offset_tag_values;
  }

  static const decltype(::viz::mojom::CompositorFrameMetadata::frame_interval_inputs)& frame_interval_inputs(
      const ::viz::mojom::CompositorFrameMetadataPtr& input) {
    return input->frame_interval_inputs;
  }

  static const decltype(::viz::mojom::CompositorFrameMetadata::trees_in_viz_timing)& trees_in_viz_timing(
      const ::viz::mojom::CompositorFrameMetadataPtr& input) {
    return input->trees_in_viz_timing;
  }

  static const decltype(::viz::mojom::CompositorFrameMetadata::tracked_element_rects)& tracked_element_rects(
      const ::viz::mojom::CompositorFrameMetadataPtr& input) {
