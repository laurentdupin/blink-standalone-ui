 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SubtreeCaptureId::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SubtreeCaptureId::DataView, std::vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::viz::mojom::SubtreeCaptureId::DataView,
                                         ::viz::mojom::SubtreeCaptureIdPtr> {
  static bool IsNull(const ::viz::mojom::SubtreeCaptureIdPtr& input) { return !input; }
  static void SetToNull(::viz::mojom::SubtreeCaptureIdPtr* output) { output->reset(); }

  static const decltype(::viz::mojom::SubtreeCaptureId::subtree_id)& subtree_id(
      const ::viz::mojom::SubtreeCaptureIdPtr& input) {
