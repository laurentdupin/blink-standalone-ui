// services/viz/public/mojom/compositing/filter_operation.mojom-shared-internal.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2016 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef SERVICES_VIZ_PUBLIC_MOJOM_COMPOSITING_FILTER_OPERATION_MOJOM_SHARED_INTERNAL_H_
#define SERVICES_VIZ_PUBLIC_MOJOM_COMPOSITING_FILTER_OPERATION_MOJOM_SHARED_INTERNAL_H_
...
class  FilterOperation_Data {
 public:
  ...
  int32_t type;
  float amount;
  mojo::internal::Pointer<::gfx::mojom::internal::Point_Data> offset;
  mojo::internal::Pointer<::skia::mojom::internal::SkColor4f_Data> drop_shadow_color;
 ...
 private:
  friend class mojo::internal::MessageFragment<FilterOperation_Data>;
...
struct FilterOperation_UnserializedMessageContext
 ...
 private:
  ...
  void Serialize(mojo::Message& message) override {
    mojo::internal::MessageFragment<FilterOperation_Data> fragment(message);
...
#endif  // SERVICES_VIZ_PUBLIC_MOJOM_COMPOSITING_FILTER_OPERATION_MOJOM_SHARED_INTERNAL_H_