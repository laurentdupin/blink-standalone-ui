// services/viz/public/mojom/compositing/shared_image_format.mojom.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef SERVICES_VIZ_PUBLIC_MOJOM_COMPOSITING_SHARED_IMAGE_FORMAT_MOJOM_H_
#define SERVICES_VIZ_PUBLIC_MOJOM_COMPOSITING_SHARED_IMAGE_FORMAT_MOJOM_H_
...
#include "services/viz/public/mojom/compositing/shared_image_format.mojom-forward.h"  // IWYU pragma: export
 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        MultiplanarFormat::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        MultiplanarFormat::DataView, std::vector<uint8_t>>(input);
  }
...
class  SharedImageFormat {
 public:
  ...
  ::viz::mojom::SingleplanarFormat get_singleplanar_format() const {
    CHECK(tag_ == Tag::kSingleplanarFormat);
    return data_.singleplanar_format;
  }
  void set_singleplanar_format(::viz::mojom::SingleplanarFormat singleplanar_format);
...
template <>
struct  StructTraits<::viz::mojom::MultiplanarFormat::DataView,
                                         ::viz::mojom::MultiplanarFormatPtr> {
  static bool IsNull(const ::viz::mojom::MultiplanarFormatPtr& input) { return !input; }
  static void SetToNull(::viz::mojom::MultiplanarFormatPtr* output) { output->reset(); }

  static decltype(::viz::mojom::MultiplanarFormat::plane_config) plane_config(
      const ::viz::mojom::MultiplanarFormatPtr& input) {
    return input->plane_config;
  }

  static decltype(::viz::mojom::MultiplanarFormat::subsampling) subsampling(
      const ::viz::mojom::MultiplanarFormatPtr& input) {
    return input->subsampling;
  }

  static decltype(::viz::mojom::MultiplanarFormat::channel_format) channel_format(
      const ::viz::mojom::MultiplanarFormatPtr& input) {
    return input->channel_format;
  }

  static bool Read(::viz::mojom::MultiplanarFormat::DataView input, ::viz::mojom::MultiplanarFormatPtr* output);
};


template <>
struct  UnionTraits<::viz::mojom::SharedImageFormat::DataView,
                                        ::viz::mojom::SharedImageFormatPtr> {
  static bool IsNull(const ::viz::mojom::SharedImageFormatPtr& input) { return !input; }
  static void SetToNull(::viz::mojom::SharedImageFormatPtr* output) { output->reset(); }

  static ::viz::mojom::SharedImageFormat::Tag GetTag(const ::viz::mojom::SharedImageFormatPtr& input) {
    return input->which();
  }

  static  ::viz::mojom::SingleplanarFormat singleplanar_format(const ::viz::mojom::SharedImageFormatPtr& input) {
    return input->get_singleplanar_format();
  }

  static const ::viz::mojom::MultiplanarFormatPtr& multiplanar_format(const ::viz::mojom::SharedImageFormatPtr& input) {
    return input->get_multiplanar_format();
  }

  static bool Read(::viz::mojom::SharedImageFormat::DataView input, ::viz::mojom::SharedImageFormatPtr* output);
};

}  // namespace mojo

#endif  // SERVICES_VIZ_PUBLIC_MOJOM_COMPOSITING_SHARED_IMAGE_FORMAT_MOJOM_H_