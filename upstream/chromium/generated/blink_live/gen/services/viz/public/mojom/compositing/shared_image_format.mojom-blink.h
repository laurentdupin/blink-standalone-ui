...
class BLINK_PLATFORM_EXPORT MultiplanarFormat {
 public:
  template <typename T>
...
class BLINK_PLATFORM_EXPORT SharedImageFormat {
 public:
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::MultiplanarFormat::DataView,
...
template <>
struct BLINK_PLATFORM_EXPORT UnionTraits<::viz::mojom::blink::SharedImageFormat::DataView,
