...
bool HitTestRegion_Data::Validate(
  ...
  [[maybe_unused]] const HitTestRegion_Data* object =
      static_cast<const HitTestRegion_Data*>(data);
...
bool HitTestRegionList_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const HitTestRegionList_Data* object =
      static_cast<const HitTestRegionList_Data*>(data);
