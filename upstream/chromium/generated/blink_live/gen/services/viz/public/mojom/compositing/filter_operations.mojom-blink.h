...
#include "services/viz/public/mojom/compositing/filter_operations.mojom-blink-forward.h"  // IWYU pragma: export
...
class BLINK_PLATFORM_EXPORT FilterOperations {
 public:
  ...
  explicit FilterOperations(
      ::blink::Vector<::cc::FilterOperation> operations);
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        FilterOperations::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        FilterOperations::DataView, ::blink::Vector<uint8_t>>(input);
  }
