// services/viz/public/mojom/hit_test/hit_test_region_list.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
HitTestRegionList::HitTestRegionList(
    ...
    const ::gfx::Transform& transform_in,
    ::blink::Vector<::viz::HitTestRegion> regions_in)
    : flags(std::move(flags_in)),
      async_hit_test_reasons(std::move(async_hit_test_reasons_in)),
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type const ::blink::Vector<::viz::HitTestRegion>&>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
