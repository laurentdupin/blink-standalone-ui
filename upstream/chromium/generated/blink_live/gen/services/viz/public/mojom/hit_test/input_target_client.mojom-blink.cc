// services/viz/public/mojom/hit_test/input_target_client.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
bool InputTargetClientRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::viz::mojom::blink::InputTargetClient::Name_,
