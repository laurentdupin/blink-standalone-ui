...
#include "services/viz/public/mojom/compositing/copy_output_request.mojom-test-utils.h"
...
CopyOutputRequest::CopyOutputRequest(
    ...
    ::viz::mojom::CopyOutputResultDestination result_destination_in,
    ...
    std::optional<::viz::BlitRequest> blit_request_in,
...
void CopyOutputRequest::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      ...
      "<value of type ::viz::mojom::CopyOutputResultFormat>"
#else
      "<value>"
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::viz::mojom::CopyOutputResultDestination>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::optional<::viz::BlitRequest>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
void CopyOutputResultSenderProxy::SendResult(
  ...
  mojo::Message message(
      std::to_underlying(messages::CopyOutputResultSender::kSendResult), kFlags, estimated_payload_size);
...
bool CopyOutputResultSenderRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::viz::mojom::CopyOutputResultSender::Name_,
