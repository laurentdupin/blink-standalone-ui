// services/viz/public/mojom/compositing/selection.mojom-shared.cc is auto generated by mojom_bindings_generator.py, do not edit
...
bool Selection_Data::Validate(
  ...
  [[maybe_unused]] const Selection_Data* object =
      static_cast<const Selection_Data*>(data);
