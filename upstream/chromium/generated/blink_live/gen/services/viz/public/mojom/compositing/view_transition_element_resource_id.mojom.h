// services/viz/public/mojom/compositing/view_transition_element_resource_id.mojom.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef SERVICES_VIZ_PUBLIC_MOJOM_COMPOSITING_VIEW_TRANSITION_ELEMENT_RESOURCE_ID_MOJOM_H_
#define SERVICES_VIZ_PUBLIC_MOJOM_COMPOSITING_VIEW_TRANSITION_ELEMENT_RESOURCE_ID_MOJOM_H_
...
#include "services/viz/public/mojom/compositing/view_transition_element_resource_id.mojom-forward.h"  // IWYU pragma: export
 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ViewTransitionElementResourceId::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ViewTransitionElementResourceId::DataView, std::vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::viz::mojom::ViewTransitionElementResourceId::DataView,
                                         ::viz::mojom::ViewTransitionElementResourceIdPtr> {
  static bool IsNull(const ::viz::mojom::ViewTransitionElementResourceIdPtr& input) { return !input; }
  static void SetToNull(::viz::mojom::ViewTransitionElementResourceIdPtr* output) { output->reset(); }

  static const decltype(::viz::mojom::ViewTransitionElementResourceId::transition_token)& transition_token(
      const ::viz::mojom::ViewTransitionElementResourceIdPtr& input) {
    return input->transition_token;
  }

  static decltype(::viz::mojom::ViewTransitionElementResourceId::local_id) local_id(
      const ::viz::mojom::ViewTransitionElementResourceIdPtr& input) {
    return input->local_id;
  }

  static decltype(::viz::mojom::ViewTransitionElementResourceId::for_scope_snapshot) for_scope_snapshot(
      const ::viz::mojom::ViewTransitionElementResourceIdPtr& input) {
    return input->for_scope_snapshot;
  }

  static bool Read(::viz::mojom::ViewTransitionElementResourceId::DataView input, ::viz::mojom::ViewTransitionElementResourceIdPtr* output);
};

}  // namespace mojo

#endif  // SERVICES_VIZ_PUBLIC_MOJOM_COMPOSITING_VIEW_TRANSITION_ELEMENT_RESOURCE_ID_MOJOM_H_