 ...
 public:
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CubicBezierTimingFunction::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CubicBezierTimingFunction::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
class BLINK_PLATFORM_EXPORT StepsTimingFunction {
 public:
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        StepsTimingFunction::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        StepsTimingFunction::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
class BLINK_PLATFORM_EXPORT LinearEasingPoint {
 public:
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        LinearEasingPoint::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        LinearEasingPoint::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
class BLINK_PLATFORM_EXPORT TimingFunction {
 public:
  ...
  const CubicBezierTimingFunctionPtr& get_cubic_bezier() const {
    CHECK(tag_ == Tag::kCubicBezier);
    return data_.cubic_bezier;
  }
  CubicBezierTimingFunctionPtr& get_cubic_bezier() {
    CHECK(tag_ == Tag::kCubicBezier);
    return data_.cubic_bezier;
  }
  ...
  const StepsTimingFunctionPtr& get_steps() const {
    CHECK(tag_ == Tag::kSteps);
    return data_.steps;
  }
  StepsTimingFunctionPtr& get_steps() {
    CHECK(tag_ == Tag::kSteps);
    return data_.steps;
  }
  ...
  const ::blink::Vector<LinearEasingPointPtr>& get_linear() const {
    CHECK(tag_ == Tag::kLinear);
    return data_.linear;
  }
  ::blink::Vector<LinearEasingPointPtr>& get_linear() {
    CHECK(tag_ == Tag::kLinear);
    return data_.linear;
  }
  void set_linear(::blink::Vector<LinearEasingPointPtr> linear);
 ...
 private:
  ...
  union Union_ {
    ...
    ::blink::Vector<LinearEasingPointPtr> linear;
  };
...
class BLINK_PLATFORM_EXPORT TransformOperation {
 public:
  ...
  static TransformOperationPtr NewIdentity(
      bool value);
  // Construct an instance holding |perspective_depth|.
  static TransformOperationPtr NewPerspectiveDepth(
      float value);
  // Construct an instance holding |skew|.
  static TransformOperationPtr NewSkew(
      const ::gfx::Vector2dF& value);
  // Construct an instance holding |scale|.
  static TransformOperationPtr NewScale(
      const ::gfx::Vector3dF& value);
  // Construct an instance holding |translate|.
  static TransformOperationPtr NewTranslate(
      const ::gfx::Vector3dF& value);
  // Construct an instance holding |rotate|.
  static TransformOperationPtr NewRotate(
      AxisAnglePtr value);
  // Construct an instance holding |matrix|.
  static TransformOperationPtr NewMatrix(
  ...
  const ::gfx::Vector2dF& get_skew() const {
    CHECK(tag_ == Tag::kSkew);
    return data_.skew;
  }
  ::gfx::Vector2dF& get_skew() {
    CHECK(tag_ == Tag::kSkew);
    return data_.skew;
  }
  ...
  const ::gfx::Vector3dF& get_scale() const {
    CHECK(tag_ == Tag::kScale);
    return data_.scale;
  }
  ::gfx::Vector3dF& get_scale() {
    CHECK(tag_ == Tag::kScale);
    return data_.scale;
  }
  ...
  const ::gfx::Vector3dF& get_translate() const {
    CHECK(tag_ == Tag::kTranslate);
    return data_.translate;
  }
  ::gfx::Vector3dF& get_translate() {
    CHECK(tag_ == Tag::kTranslate);
    return data_.translate;
  }
  ...
  const AxisAnglePtr& get_rotate() const {
    CHECK(tag_ == Tag::kRotate);
    return data_.rotate;
  }
  AxisAnglePtr& get_rotate() {
    CHECK(tag_ == Tag::kRotate);
    return data_.rotate;
  }
  ...
  const ::gfx::Transform& get_matrix() const {
    CHECK(tag_ == Tag::kMatrix);
    return data_.matrix;
  }
  ::gfx::Transform& get_matrix() {
    CHECK(tag_ == Tag::kMatrix);
    return data_.matrix;
  }
...
class BLINK_PLATFORM_EXPORT AnimationKeyframeValue {
 public:
  ...
  static AnimationKeyframeValuePtr NewScalar(
      float value);
  // Construct an instance holding |color|.
  static AnimationKeyframeValuePtr NewColor(
      ::SkColor value);
  // Construct an instance holding |size|.
  static AnimationKeyframeValuePtr NewSize(
      const ::gfx::SizeF& value);
  // Construct an instance holding |rect|.
  static AnimationKeyframeValuePtr NewRect(
      const ::gfx::Rect& value);
  // Construct an instance holding |transform|.
  static AnimationKeyframeValuePtr NewTransform(
  ...
  const ::gfx::SizeF& get_size() const {
  ...
  const ::blink::Vector<TransformOperationPtr>& get_transform() const {
    CHECK(tag_ == Tag::kTransform);
    return data_.transform;
  }
  ::blink::Vector<TransformOperationPtr>& get_transform() {
    CHECK(tag_ == Tag::kTransform);
    return data_.transform;
  }
  void set_transform(::blink::Vector<TransformOperationPtr> transform);
 ...
 private:
  ...
  union Union_ {
    ...
    ::gfx::SizeF size;
    ::gfx::Rect rect;
    ::blink::Vector<TransformOperationPtr> transform;
  };
...
class BLINK_PLATFORM_EXPORT AxisAngle {
 public:
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        AxisAngle::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        AxisAngle::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
AnimationKeyframe& operator=(const AnimationKeyframe&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        AnimationKeyframe::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        AnimationKeyframe::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
class BLINK_PLATFORM_EXPORT AnimationKeyframeModel {
 public:
  ...
  AnimationKeyframeModel(
      ...
      TimingFunctionPtr timing_function,
      ::blink::Vector<AnimationKeyframePtr> keyframes,
...
AnimationKeyframeModel& operator=(const AnimationKeyframeModel&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        AnimationKeyframeModel::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        AnimationKeyframeModel::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
class BLINK_PLATFORM_EXPORT Animation {
 public:
  ...
  Animation(
      int32_t id,
      ::cc::ElementId element_id,
      ::blink::Vector<AnimationKeyframeModelPtr> keyframe_models);
...
Animation& operator=(const Animation&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        Animation::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        Animation::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
class BLINK_PLATFORM_EXPORT AnimationTimeline {
 public:
  ...
  AnimationTimeline(
      int32_t id,
      ::blink::Vector<AnimationPtr> new_animations,
      ::blink::Vector<int32_t> removed_animations);
...
AnimationTimeline& operator=(const AnimationTimeline&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        AnimationTimeline::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        AnimationTimeline::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
bool AnimationKeyframeModel::Equals(const T& other_struct) const {
  ...
  if (!mojo::Equals(this->start_delay, other_struct.start_delay))
    return false;
  if (!mojo::Equals(this->hold_time, other_struct.hold_time))
    return false;
  return true;
}
...
bool operator<(const T& lhs, const T& rhs) {
  ...
  if (lhs.hold_time < rhs.hold_time)
    return true;
  if (rhs.hold_time < lhs.hold_time)
    return false;
  return false;
}
template <typename StructPtrType>
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::CubicBezierTimingFunction::DataView,
                                         ::viz::mojom::blink::CubicBezierTimingFunctionPtr> {
  static bool IsNull(const ::viz::mojom::blink::CubicBezierTimingFunctionPtr& input) { return !input; }
  static void SetToNull(::viz::mojom::blink::CubicBezierTimingFunctionPtr* output) { output->reset(); }

  static decltype(::viz::mojom::blink::CubicBezierTimingFunction::x1) x1(
      const ::viz::mojom::blink::CubicBezierTimingFunctionPtr& input) {
    return input->x1;
  }

  static decltype(::viz::mojom::blink::CubicBezierTimingFunction::y1) y1(
      const ::viz::mojom::blink::CubicBezierTimingFunctionPtr& input) {
    return input->y1;
  }

  static decltype(::viz::mojom::blink::CubicBezierTimingFunction::x2) x2(
      const ::viz::mojom::blink::CubicBezierTimingFunctionPtr& input) {
    return input->x2;
  }

  static decltype(::viz::mojom::blink::CubicBezierTimingFunction::y2) y2(
      const ::viz::mojom::blink::CubicBezierTimingFunctionPtr& input) {
    return input->y2;
  }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::StepsTimingFunction::DataView,
                                         ::viz::mojom::blink::StepsTimingFunctionPtr> {
  static bool IsNull(const ::viz::mojom::blink::StepsTimingFunctionPtr& input) { return !input; }
  static void SetToNull(::viz::mojom::blink::StepsTimingFunctionPtr* output) { output->reset(); }

  static decltype(::viz::mojom::blink::StepsTimingFunction::num_steps) num_steps(
      const ::viz::mojom::blink::StepsTimingFunctionPtr& input) {
    return input->num_steps;
  }

  static decltype(::viz::mojom::blink::StepsTimingFunction::step_position) step_position(
      const ::viz::mojom::blink::StepsTimingFunctionPtr& input) {
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::LinearEasingPoint::DataView,
                                         ::viz::mojom::blink::LinearEasingPointPtr> {
  static bool IsNull(const ::viz::mojom::blink::LinearEasingPointPtr& input) { return !input; }
  static void SetToNull(::viz::mojom::blink::LinearEasingPointPtr* output) { output->reset(); }

  static decltype(::viz::mojom::blink::LinearEasingPoint::in) in(
      const ::viz::mojom::blink::LinearEasingPointPtr& input) {
    return input->in;
  }

  static decltype(::viz::mojom::blink::LinearEasingPoint::out) out(
      const ::viz::mojom::blink::LinearEasingPointPtr& input) {
    return input->out;
  }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::AxisAngle::DataView,
                                         ::viz::mojom::blink::AxisAnglePtr> {
  static bool IsNull(const ::viz::mojom::blink::AxisAnglePtr& input) { return !input; }
  static void SetToNull(::viz::mojom::blink::AxisAnglePtr* output) { output->reset(); }

  static const decltype(::viz::mojom::blink::AxisAngle::axis)& axis(
      const ::viz::mojom::blink::AxisAnglePtr& input) {
    return input->axis;
  }

  static decltype(::viz::mojom::blink::AxisAngle::angle) angle(
      const ::viz::mojom::blink::AxisAnglePtr& input) {
    return input->angle;
  }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::AnimationKeyframe::DataView,
                                         ::viz::mojom::blink::AnimationKeyframePtr> {
  static bool IsNull(const ::viz::mojom::blink::AnimationKeyframePtr& input) { return !input; }
  static void SetToNull(::viz::mojom::blink::AnimationKeyframePtr* output) { output->reset(); }

  static const decltype(::viz::mojom::blink::AnimationKeyframe::value)& value(
      const ::viz::mojom::blink::AnimationKeyframePtr& input) {
    return input->value;
  }

  static const decltype(::viz::mojom::blink::AnimationKeyframe::start_time)& start_time(
      const ::viz::mojom::blink::AnimationKeyframePtr& input) {
    return input->start_time;
  }

  static const decltype(::viz::mojom::blink::AnimationKeyframe::timing_function)& timing_function(
      const ::viz::mojom::blink::AnimationKeyframePtr& input) {
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::AnimationKeyframeModel::DataView,
                                         ::viz::mojom::blink::AnimationKeyframeModelPtr> {
  static bool IsNull(const ::viz::mojom::blink::AnimationKeyframeModelPtr& input) { return !input; }
  static void SetToNull(::viz::mojom::blink::AnimationKeyframeModelPtr* output) { output->reset(); }

  static decltype(::viz::mojom::blink::AnimationKeyframeModel::id) id(
      const ::viz::mojom::blink::AnimationKeyframeModelPtr& input) {
    return input->id;
  }

  static decltype(::viz::mojom::blink::AnimationKeyframeModel::group_id) group_id(
      const ::viz::mojom::blink::AnimationKeyframeModelPtr& input) {
  ...
  static const decltype(::viz::mojom::blink::AnimationKeyframeModel::element_id)& element_id(
      const ::viz::mojom::blink::AnimationKeyframeModelPtr& input) {
  ...
  static const decltype(::viz::mojom::blink::AnimationKeyframeModel::keyframes)& keyframes(
      const ::viz::mojom::blink::AnimationKeyframeModelPtr& input) {
    return input->keyframes;
  }

  static decltype(::viz::mojom::blink::AnimationKeyframeModel::scaled_duration) scaled_duration(
      const ::viz::mojom::blink::AnimationKeyframeModelPtr& input) {
    return input->scaled_duration;
  }

  static decltype(::viz::mojom::blink::AnimationKeyframeModel::direction) direction(
      const ::viz::mojom::blink::AnimationKeyframeModelPtr& input) {
    return input->direction;
  }

  static decltype(::viz::mojom::blink::AnimationKeyframeModel::fill_mode) fill_mode(
      const ::viz::mojom::blink::AnimationKeyframeModelPtr& input) {
    return input->fill_mode;
  }

  static decltype(::viz::mojom::blink::AnimationKeyframeModel::playback_rate) playback_rate(
      const ::viz::mojom::blink::AnimationKeyframeModelPtr& input) {
    return input->playback_rate;
  }

  static decltype(::viz::mojom::blink::AnimationKeyframeModel::iterations) iterations(
      const ::viz::mojom::blink::AnimationKeyframeModelPtr& input) {
    return input->iterations;
  }

  static decltype(::viz::mojom::blink::AnimationKeyframeModel::iteration_start) iteration_start(
      const ::viz::mojom::blink::AnimationKeyframeModelPtr& input) {
    return input->iteration_start;
  }

  static const decltype(::viz::mojom::blink::AnimationKeyframeModel::start_delay)& start_delay(
      const ::viz::mojom::blink::AnimationKeyframeModelPtr& input) {
    return input->start_delay;
  }

  static const decltype(::viz::mojom::blink::AnimationKeyframeModel::hold_time)& hold_time(
      const ::viz::mojom::blink::AnimationKeyframeModelPtr& input) {
    return input->hold_time;
  }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::Animation::DataView,
                                         ::viz::mojom::blink::AnimationPtr> {
  static bool IsNull(const ::viz::mojom::blink::AnimationPtr& input) { return !input; }
  static void SetToNull(::viz::mojom::blink::AnimationPtr* output) { output->reset(); }

  static decltype(::viz::mojom::blink::Animation::id) id(
      const ::viz::mojom::blink::AnimationPtr& input) {
    return input->id;
  }

  static const decltype(::viz::mojom::blink::Animation::element_id)& element_id(
      const ::viz::mojom::blink::AnimationPtr& input) {
    return input->element_id;
  }

  static const decltype(::viz::mojom::blink::Animation::keyframe_models)& keyframe_models(
      const ::viz::mojom::blink::AnimationPtr& input) {
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::AnimationTimeline::DataView,
                                         ::viz::mojom::blink::AnimationTimelinePtr> {
  static bool IsNull(const ::viz::mojom::blink::AnimationTimelinePtr& input) { return !input; }
  static void SetToNull(::viz::mojom::blink::AnimationTimelinePtr* output) { output->reset(); }

  static decltype(::viz::mojom::blink::AnimationTimeline::id) id(
      const ::viz::mojom::blink::AnimationTimelinePtr& input) {
    return input->id;
  }

  static const decltype(::viz::mojom::blink::AnimationTimeline::new_animations)& new_animations(
      const ::viz::mojom::blink::AnimationTimelinePtr& input) {
...
template <>
struct BLINK_PLATFORM_EXPORT UnionTraits<::viz::mojom::blink::TimingFunction::DataView,
                                        ::viz::mojom::blink::TimingFunctionPtr> {
  static bool IsNull(const ::viz::mojom::blink::TimingFunctionPtr& input) { return !input; }
  static void SetToNull(::viz::mojom::blink::TimingFunctionPtr* output) { output->reset(); }
  ...
  static const ::blink::Vector<::viz::mojom::blink::LinearEasingPointPtr>& linear(const ::viz::mojom::blink::TimingFunctionPtr& input) {
...
template <>
struct BLINK_PLATFORM_EXPORT UnionTraits<::viz::mojom::blink::TransformOperation::DataView,
                                        ::viz::mojom::blink::TransformOperationPtr> {
  static bool IsNull(const ::viz::mojom::blink::TransformOperationPtr& input) { return !input; }
  static void SetToNull(::viz::mojom::blink::TransformOperationPtr* output) { output->reset(); }
...
template <>
struct BLINK_PLATFORM_EXPORT UnionTraits<::viz::mojom::blink::AnimationKeyframeValue::DataView,
                                        ::viz::mojom::blink::AnimationKeyframeValuePtr> {
  static bool IsNull(const ::viz::mojom::blink::AnimationKeyframeValuePtr& input) { return !input; }
  static void SetToNull(::viz::mojom::blink::AnimationKeyframeValuePtr* output) { output->reset(); }
  ...
  static const ::blink::Vector<::viz::mojom::blink::TransformOperationPtr>& transform(const ::viz::mojom::blink::AnimationKeyframeValuePtr& input) {
