...
class BLINK_PLATFORM_EXPORT CompositorFrame {
 public:
  ...
  CompositorFrame(
      ...
      ::blink::Vector<::viz::TransferableResource> resources,
      ::blink::Vector<::std::unique_ptr<::viz::CompositorRenderPass>> passes);
...
struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::CompositorFrame::DataView,
  ...
  static  decltype(::viz::mojom::blink::CompositorFrame::resources)& resources(
