// services/viz/public/mojom/compositing/transferable_resource.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "services/viz/public/mojom/compositing/transferable_resource.mojom-blink-test-utils.h"
...
// static
bool StructTraits<::viz::mojom::blink::MetadataOverride::DataView, ::viz::mojom::blink::MetadataOverridePtr>::Read(
    ::viz::mojom::blink::MetadataOverride::DataView input,
    ::viz::mojom::blink::MetadataOverridePtr* output) {
  bool success = true;
  ::viz::mojom::blink::MetadataOverridePtr result(::viz::mojom::blink::MetadataOverride::New());
