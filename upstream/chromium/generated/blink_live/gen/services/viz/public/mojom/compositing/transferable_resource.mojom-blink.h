...
#include "services/viz/public/mojom/compositing/transferable_resource.mojom-blink-forward.h"  // IWYU pragma: export
...
class BLINK_PLATFORM_EXPORT MetadataOverride {
 public:
  template <typename T>
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        MetadataOverride::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        MetadataOverride::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::MetadataOverride::DataView,
                                         ::viz::mojom::blink::MetadataOverridePtr> {
  static bool IsNull(const ::viz::mojom::blink::MetadataOverridePtr& input) { return !input; }
  static void SetToNull(::viz::mojom::blink::MetadataOverridePtr* output) { output->reset(); }

  static decltype(::viz::mojom::blink::MetadataOverride::is_overlay_candidate) is_overlay_candidate(
      const ::viz::mojom::blink::MetadataOverridePtr& input) {
    return input->is_overlay_candidate;
  }

  static const decltype(::viz::mojom::blink::MetadataOverride::color_space)& color_space(
      const ::viz::mojom::blink::MetadataOverridePtr& input) {
    return input->color_space;
  }

  static decltype(::viz::mojom::blink::MetadataOverride::origin) origin(
      const ::viz::mojom::blink::MetadataOverridePtr& input) {
    return input->origin;
  }

  static decltype(::viz::mojom::blink::MetadataOverride::alpha_type) alpha_type(
      const ::viz::mojom::blink::MetadataOverridePtr& input) {
    return input->alpha_type;
  }

  static bool Read(::viz::mojom::blink::MetadataOverride::DataView input, ::viz::mojom::blink::MetadataOverridePtr* output);
};


template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::TransferableResource::DataView,
  ...
  static const decltype(::viz::mojom::blink::TransferableResource::id)& id(
      const ::viz::mojom::blink::TransferableResourcePtr& input) {
    return input->id;
  }

  static  decltype(::viz::mojom::blink::TransferableResource::shared_image)& shared_image(
       ::viz::mojom::blink::TransferableResourcePtr& input) {
    return input->shared_image;
  }

  static const decltype(::viz::mojom::blink::TransferableResource::sync_token)& sync_token(
      const ::viz::mojom::blink::TransferableResourcePtr& input) {
    return input->sync_token;
  }

  static decltype(::viz::mojom::blink::TransferableResource::synchronization_type) synchronization_type(
      const ::viz::mojom::blink::TransferableResourcePtr& input) {
    return input->synchronization_type;
  }

  static decltype(::viz::mojom::blink::TransferableResource::is_low_latency_rendering) is_low_latency_rendering(
      const ::viz::mojom::blink::TransferableResourcePtr& input) {
  ...
  static decltype(::viz::mojom::blink::TransferableResource::resource_source) resource_source(
      const ::viz::mojom::blink::TransferableResourcePtr& input) {
    return input->resource_source;
  }

  static const decltype(::viz::mojom::blink::TransferableResource::metadata_override)& metadata_override(
      const ::viz::mojom::blink::TransferableResourcePtr& input) {
