...
class BLINK_PLATFORM_EXPORT FrameSinkBundleInterceptorForTesting : public FrameSinkBundle {
  ...
  void Submit(::blink::Vector<BundledFrameSubmissionPtr> submissions) override;
};
...
class BLINK_PLATFORM_EXPORT FrameSinkBundleClientInterceptorForTesting : public FrameSinkBundleClient {
  ...
  void FlushNotifications(::blink::Vector<BundledReturnedResourcesPtr> acks, ::blink::Vector<BeginFrameInfoPtr> begin_frames, ::blink::Vector<BundledReturnedResourcesPtr> reclaimed_resources) override;
