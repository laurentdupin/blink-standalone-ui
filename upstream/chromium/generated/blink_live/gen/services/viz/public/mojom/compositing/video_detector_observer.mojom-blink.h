// services/viz/public/mojom/compositing/video_detector_observer.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef SERVICES_VIZ_PUBLIC_MOJOM_COMPOSITING_VIDEO_DETECTOR_OBSERVER_MOJOM_BLINK_H_
#define SERVICES_VIZ_PUBLIC_MOJOM_COMPOSITING_VIDEO_DETECTOR_OBSERVER_MOJOM_BLINK_H_
...
#include "services/viz/public/mojom/compositing/video_detector_observer.mojom-blink-forward.h"  // IWYU pragma: export
...
class BLINK_PLATFORM_EXPORT VideoDetectorObserver
    : public VideoDetectorObserverInterfaceBase {
 public:
  using IPCStableHashFunction = uint32_t(*)();
  static constexpr const char* Name_ = "viz.mojom.VideoDetectorObserver";
...
class BLINK_PLATFORM_EXPORT VideoDetectorObserverProxy
...
class BLINK_PLATFORM_EXPORT VideoDetectorObserverStubDispatch {
 public:
...
class BLINK_PLATFORM_EXPORT VideoDetectorObserverRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
#endif  // SERVICES_VIZ_PUBLIC_MOJOM_COMPOSITING_VIDEO_DETECTOR_OBSERVER_MOJOM_BLINK_H_