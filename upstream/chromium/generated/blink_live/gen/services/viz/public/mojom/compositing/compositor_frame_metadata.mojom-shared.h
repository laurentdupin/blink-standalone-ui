...
#include "services/viz/public/mojom/compositing/compositor_frame_metadata.mojom-data-view.h"  // IWYU pragma: export
...
inline void CompositorFrameMetadataDataView::GetTrackedElementRectsDataView(
