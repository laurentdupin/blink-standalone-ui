...
class  FrameSinkBundleClientInterceptorForTesting : public FrameSinkBundleClient {
  ...
  void FlushNotifications(std::vector<BundledReturnedResourcesPtr> acks, std::vector<BeginFrameInfoPtr> begin_frames, std::vector<BundledReturnedResourcesPtr> reclaimed_resources) override;
