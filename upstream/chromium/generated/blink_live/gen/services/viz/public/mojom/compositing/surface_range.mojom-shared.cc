// services/viz/public/mojom/compositing/surface_range.mojom-shared.cc is auto generated by mojom_bindings_generator.py, do not edit
...
// static
bool SurfaceRange_Data::Validate(
    const void* data,
  ...
  [[maybe_unused]] const SurfaceRange_Data* object =
      static_cast<const SurfaceRange_Data*>(data);
...
SurfaceRange_Data::SurfaceRange_Data()
