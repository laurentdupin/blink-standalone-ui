...
// with not having this data in traces there.
  ...
  virtual void OnTilingsReadyForCleanup(int32_t layer_id, const std::vector<float>& tiling_scales_to_clean_up) = 0;
};
...
class  LayerContextClientProxy
 ...
 public:
  ...
  void OnTilingsReadyForCleanup(int32_t layer_id, const std::vector<float>& tiling_scales_to_clean_up) final;
...
class  TransferableUIResourceRequest {
 public:
  template <typename T>
...
class  LayerTreeUpdate {
 public:
  ...
  LayerTreeUpdate(
      ...
      std::vector<TransferableUIResourceRequestPtr> ui_resource_requests,
      ...
      ::viz::mojom::ScrollTreeUpdatePtr scroll_tree_update,
      ...
      std::optional<std::vector<::viz::SurfaceRange>> surface_ranges,
      std::optional<std::vector<::viz::mojom::ViewTransitionRequestPtr>> view_transition_requests,
...
template <>
struct  StructTraits<::viz::mojom::TransferableUIResourceRequest::DataView,
                                         ::viz::mojom::TransferableUIResourceRequestPtr> {
  static bool IsNull(const ::viz::mojom::TransferableUIResourceRequestPtr& input) { return !input; }
  static void SetToNull(::viz::mojom::TransferableUIResourceRequestPtr* output) { output->reset(); }

  static decltype(::viz::mojom::TransferableUIResourceRequest::type) type(
      const ::viz::mojom::TransferableUIResourceRequestPtr& input) {
    return input->type;
  }

  static const decltype(::viz::mojom::TransferableUIResourceRequest::uid)& uid(
      const ::viz::mojom::TransferableUIResourceRequestPtr& input) {
    return input->uid;
  }

  static  decltype(::viz::mojom::TransferableUIResourceRequest::transferable_resource)& transferable_resource(
       ::viz::mojom::TransferableUIResourceRequestPtr& input) {
    return input->transferable_resource;
  }

  static decltype(::viz::mojom::TransferableUIResourceRequest::opaque) opaque(
      const ::viz::mojom::TransferableUIResourceRequestPtr& input) {
    return input->opaque;
  }

  static bool Read(::viz::mojom::TransferableUIResourceRequest::DataView input, ::viz::mojom::TransferableUIResourceRequestPtr* output);
};
...
struct  StructTraits<::viz::mojom::LayerTreeUpdate::DataView,
  ...
  static const decltype(::viz::mojom::LayerTreeUpdate::begin_frame_args)& begin_frame_args(
  ...
  static decltype(::viz::mojom::LayerTreeUpdate::primary_main_frame_item_sequence_number) primary_main_frame_item_sequence_number(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->primary_main_frame_item_sequence_number;
  }

  static const decltype(::viz::mojom::LayerTreeUpdate::selection)& selection(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->selection;
  }

  static decltype(::viz::mojom::LayerTreeUpdate::page_scale_factor) page_scale_factor(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->page_scale_factor;
  }

  static decltype(::viz::mojom::LayerTreeUpdate::min_page_scale_factor) min_page_scale_factor(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->min_page_scale_factor;
  }

  static decltype(::viz::mojom::LayerTreeUpdate::max_page_scale_factor) max_page_scale_factor(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->max_page_scale_factor;
  }

  static decltype(::viz::mojom::LayerTreeUpdate::external_page_scale_factor) external_page_scale_factor(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
  ...
  static const decltype(::viz::mojom::LayerTreeUpdate::display_color_spaces)& display_color_spaces(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
  ...
  static const decltype(::viz::mojom::LayerTreeUpdate::current_local_surface_id)& current_local_surface_id(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->current_local_surface_id;
  }

  static decltype(::viz::mojom::LayerTreeUpdate::next_frame_token) next_frame_token(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->next_frame_token;
  }

  static decltype(::viz::mojom::LayerTreeUpdate::send_frame_token_to_embedder) send_frame_token_to_embedder(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
  ...
  static const decltype(::viz::mojom::LayerTreeUpdate::inner_viewport_container_bounds_delta)& inner_viewport_container_bounds_delta(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->inner_viewport_container_bounds_delta;
  }

  static const decltype(::viz::mojom::LayerTreeUpdate::outer_viewport_container_bounds_delta)& outer_viewport_container_bounds_delta(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->outer_viewport_container_bounds_delta;
  }

  static const decltype(::viz::mojom::LayerTreeUpdate::viewport_damage_rect)& viewport_damage_rect(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->viewport_damage_rect;
  }

  static const decltype(::viz::mojom::LayerTreeUpdate::root_layer_damage_rect)& root_layer_damage_rect(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->root_layer_damage_rect;
  }

  static decltype(::viz::mojom::LayerTreeUpdate::full_tree_damaged) full_tree_damaged(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->full_tree_damaged;
  }

  static const decltype(::viz::mojom::LayerTreeUpdate::debug_state)& debug_state(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->debug_state;
  }

  static decltype(::viz::mojom::LayerTreeUpdate::display_transform_hint) display_transform_hint(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->display_transform_hint;
  }

  static decltype(::viz::mojom::LayerTreeUpdate::max_safe_area_inset_bottom) max_safe_area_inset_bottom(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->max_safe_area_inset_bottom;
  }

  static const decltype(::viz::mojom::LayerTreeUpdate::browser_controls_params)& browser_controls_params(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->browser_controls_params;
  }

  static const decltype(::viz::mojom::LayerTreeUpdate::browser_controls_offset_tag_modifications)& browser_controls_offset_tag_modifications(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->browser_controls_offset_tag_modifications;
  }

  static decltype(::viz::mojom::LayerTreeUpdate::top_controls_shown_ratio) top_controls_shown_ratio(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->top_controls_shown_ratio;
  }

  static decltype(::viz::mojom::LayerTreeUpdate::bottom_controls_shown_ratio) bottom_controls_shown_ratio(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->bottom_controls_shown_ratio;
  }

  static  decltype(::viz::mojom::LayerTreeUpdate::ui_resource_requests)& ui_resource_requests(
       ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->ui_resource_requests;
  }

  static  decltype(::viz::mojom::LayerTreeUpdate::layers)& layers(
       ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->layers;
  }
  ...
  static const decltype(::viz::mojom::LayerTreeUpdate::scroll_tree_update)& scroll_tree_update(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
  ...
  static  decltype(::viz::mojom::LayerTreeUpdate::effect_nodes)& effect_nodes(
       ::viz::mojom::LayerTreeUpdatePtr& input) {
  ...
  static  decltype(::viz::mojom::LayerTreeUpdate::tilings)& tilings(
       ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->tilings;
  }

  static const decltype(::viz::mojom::LayerTreeUpdate::surface_ranges)& surface_ranges(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->surface_ranges;
  }

  static const decltype(::viz::mojom::LayerTreeUpdate::view_transition_requests)& view_transition_requests(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
  ...
  static decltype(::viz::mojom::LayerTreeUpdate::frame_has_damage) frame_has_damage(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->frame_has_damage;
  }

  static decltype(::viz::mojom::LayerTreeUpdate::is_handling_interaction) is_handling_interaction(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->is_handling_interaction;
  }

  static const decltype(::viz::mojom::LayerTreeUpdate::delegated_ink_metadata)& delegated_ink_metadata(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->delegated_ink_metadata;
  }

  static const decltype(::viz::mojom::LayerTreeUpdate::screenshot_destination)& screenshot_destination(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->screenshot_destination;
  }

  static decltype(::viz::mojom::LayerTreeUpdate::may_throttle_if_undrawn_frames) may_throttle_if_undrawn_frames(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->may_throttle_if_undrawn_frames;
  }

  static decltype(::viz::mojom::LayerTreeUpdate::is_viewport_mobile_optimized) is_viewport_mobile_optimized(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->is_viewport_mobile_optimized;
  }

  static decltype(::viz::mojom::LayerTreeUpdate::is_animating_hud_contents) is_animating_hud_contents(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->is_animating_hud_contents;
  }

  static decltype(::viz::mojom::LayerTreeUpdate::is_flush) is_flush(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->is_flush;
  }

  static const decltype(::viz::mojom::LayerTreeUpdate::latency_info)& latency_info(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
    return input->latency_info;
  }

  static const decltype(::viz::mojom::LayerTreeUpdate::tracked_element_rects)& tracked_element_rects(
      const ::viz::mojom::LayerTreeUpdatePtr& input) {
