...
struct  StructTraits<::viz::mojom::CopyOutputResult::DataView,
  ...
  static decltype(::viz::mojom::CopyOutputResult::destination) destination(
      const ::viz::mojom::CopyOutputResultPtr& input) {
  ...
  static const decltype(::viz::mojom::CopyOutputResult::tracked_element_rects)& tracked_element_rects(
      const ::viz::mojom::CopyOutputResultPtr& input) {
    return input->tracked_element_rects;
  }

  static decltype(::viz::mojom::CopyOutputResult::error) error(
      const ::viz::mojom::CopyOutputResultPtr& input) {
    return input->error;
  }
