...
TileDisplayLayerExtra::TileDisplayLayerExtra(
    ...
    std::vector<float> proposed_tiling_scales_for_deletion_in)
...
TransformTreeUpdate::TransformTreeUpdate(
    ...
    const base::flat_map<::cc::ElementId, ::gfx::Vector2dF>& drawn_elastic_overscroll_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::gfx::MaskFilterInfo>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
// static
bool StructTraits<::viz::mojom::LayerGeneralProperties::DataView, ::viz::mojom::LayerGeneralPropertiesPtr>::Read(
    ::viz::mojom::LayerGeneralProperties::DataView input,
    ::viz::mojom::LayerGeneralPropertiesPtr* output) {
  bool success = true;
  ::viz::mojom::LayerGeneralPropertiesPtr result(::viz::mojom::LayerGeneralProperties::New());
