...
CompositorRenderPass::CompositorRenderPass(
    ...
    const std::optional<::viz::ViewTransitionElementResourceId>& view_transition_element_resource_id_in,
    ...
    ::blink::Vector<::std::unique_ptr<::viz::CopyOutputRequest>> copy_requests_in,
    ::blink::Vector<::viz::mojom::blink::DrawQuadPtr> quad_list_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<::viz::mojom::blink::DrawQuadPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
