// services/viz/public/mojom/compositing/view_transition_request.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "services/viz/public/mojom/compositing/view_transition_request.mojom-blink-test-utils.h"
...
ViewTransitionRequest::ViewTransitionRequest(
    ::viz::mojom::blink::CompositorFrameTransitionDirectiveType type_in,
    const ::blink::ViewTransitionToken& transition_token_in,
    bool maybe_cross_frame_sink_in,
    uint32_t sequence_id_in,
    ::blink::Vector<::viz::ViewTransitionElementResourceId> capture_resource_ids_in)
...
void ViewTransitionRequest::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      ...
      "<value of type ::viz::mojom::blink::CompositorFrameTransitionDirectiveType>"
#else
      "<value>"
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type const ::blink::Vector<::viz::ViewTransitionElementResourceId>&>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
// static
bool StructTraits<::viz::mojom::blink::ViewTransitionRequest::DataView, ::viz::mojom::blink::ViewTransitionRequestPtr>::Read(
    ::viz::mojom::blink::ViewTransitionRequest::DataView input,
    ::viz::mojom::blink::ViewTransitionRequestPtr* output) {
  bool success = true;
  ::viz::mojom::blink::ViewTransitionRequestPtr result(::viz::mojom::blink::ViewTransitionRequest::New());
