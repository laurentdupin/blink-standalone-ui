 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ContentFrameIntervalInfo::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ContentFrameIntervalInfo::DataView, std::vector<uint8_t>>(input);
  }
...
class  FrameIntervalInputs {
 public:
  ...
  FrameIntervalInputs(
      ...
      std::vector<ContentFrameIntervalInfoPtr> content_interval_info,
...
FrameIntervalInputs& operator=(const FrameIntervalInputs&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        FrameIntervalInputs::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        FrameIntervalInputs::DataView, std::vector<uint8_t>>(input);
  }
...
FrameIntervalInputsPtr FrameIntervalInputs::Clone() const {
  return New(
      ...
      mojo::Clone(has_user_input),
      mojo::Clone(has_input),
      mojo::Clone(major_scroll_speed_in_pixels_per_second),
...
bool FrameIntervalInputs::Equals(const T& other_struct) const {
  if (!mojo::Equals(this->frame_time, other_struct.frame_time))
    return false;
  if (!mojo::Equals(this->has_user_input, other_struct.has_user_input))
    return false;
  if (!mojo::Equals(this->has_input, other_struct.has_input))
    return false;
  if (!mojo::Equals(this->major_scroll_speed_in_pixels_per_second, other_struct.major_scroll_speed_in_pixels_per_second))
    return false;
...
bool operator<(const T& lhs, const T& rhs) {
  ...
  if (rhs.frame_time < lhs.frame_time)
    return false;
  if (lhs.has_user_input < rhs.has_user_input)
    return true;
  if (rhs.has_user_input < lhs.has_user_input)
    return false;
  if (lhs.has_input < rhs.has_input)
    return true;
  if (rhs.has_input < lhs.has_input)
    return false;
  if (lhs.major_scroll_speed_in_pixels_per_second < rhs.major_scroll_speed_in_pixels_per_second)
    return true;
  if (rhs.major_scroll_speed_in_pixels_per_second < lhs.major_scroll_speed_in_pixels_per_second)
    return false;
...
template <>
struct  StructTraits<::viz::mojom::ContentFrameIntervalInfo::DataView,
                                         ::viz::mojom::ContentFrameIntervalInfoPtr> {
  static bool IsNull(const ::viz::mojom::ContentFrameIntervalInfoPtr& input) { return !input; }
  static void SetToNull(::viz::mojom::ContentFrameIntervalInfoPtr* output) { output->reset(); }

  static decltype(::viz::mojom::ContentFrameIntervalInfo::type) type(
      const ::viz::mojom::ContentFrameIntervalInfoPtr& input) {
    return input->type;
  }

  static const decltype(::viz::mojom::ContentFrameIntervalInfo::frame_interval)& frame_interval(
      const ::viz::mojom::ContentFrameIntervalInfoPtr& input) {
    return input->frame_interval;
  }

  static decltype(::viz::mojom::ContentFrameIntervalInfo::duplicate_count) duplicate_count(
      const ::viz::mojom::ContentFrameIntervalInfoPtr& input) {
...
template <>
struct  StructTraits<::viz::mojom::FrameIntervalInputs::DataView,
                                         ::viz::mojom::FrameIntervalInputsPtr> {
  static bool IsNull(const ::viz::mojom::FrameIntervalInputsPtr& input) { return !input; }
  static void SetToNull(::viz::mojom::FrameIntervalInputsPtr* output) { output->reset(); }

  static const decltype(::viz::mojom::FrameIntervalInputs::frame_time)& frame_time(
      const ::viz::mojom::FrameIntervalInputsPtr& input) {
    return input->frame_time;
  }

  static decltype(::viz::mojom::FrameIntervalInputs::has_user_input) has_user_input(
      const ::viz::mojom::FrameIntervalInputsPtr& input) {
    return input->has_user_input;
  }

  static decltype(::viz::mojom::FrameIntervalInputs::has_input) has_input(
      const ::viz::mojom::FrameIntervalInputsPtr& input) {
    return input->has_input;
  }

  static decltype(::viz::mojom::FrameIntervalInputs::major_scroll_speed_in_pixels_per_second) major_scroll_speed_in_pixels_per_second(
      const ::viz::mojom::FrameIntervalInputsPtr& input) {
    return input->major_scroll_speed_in_pixels_per_second;
  }

  static const decltype(::viz::mojom::FrameIntervalInputs::content_interval_info)& content_interval_info(
      const ::viz::mojom::FrameIntervalInputsPtr& input) {
