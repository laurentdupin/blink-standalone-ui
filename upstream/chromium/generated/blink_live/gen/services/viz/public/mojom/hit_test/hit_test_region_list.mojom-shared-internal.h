// services/viz/public/mojom/hit_test/hit_test_region_list.mojom-shared-internal.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2016 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef SERVICES_VIZ_PUBLIC_MOJOM_HIT_TEST_HIT_TEST_REGION_LIST_MOJOM_SHARED_INTERNAL_H_
#define SERVICES_VIZ_PUBLIC_MOJOM_HIT_TEST_HIT_TEST_REGION_LIST_MOJOM_SHARED_INTERNAL_H_
...
class  HitTestRegion_Data {
 ...
 private:
  friend class mojo::internal::MessageFragment<HitTestRegion_Data>;
...
struct HitTestRegion_UnserializedMessageContext
 ...
 private:
  ...
  void Serialize(mojo::Message& message) override {
    mojo::internal::MessageFragment<HitTestRegion_Data> fragment(message);
...
class  HitTestRegionList_Data {
 ...
 private:
  friend class mojo::internal::MessageFragment<HitTestRegionList_Data>;
...
struct HitTestRegionList_UnserializedMessageContext
 ...
 private:
  // mojo::internal::UnserializedMessageContext:
  void Serialize(mojo::Message& message) override {
    mojo::internal::MessageFragment<HitTestRegionList_Data> fragment(message);
    mojo::internal::Serialize<DataView>(user_data_, fragment);
  }
...
#endif  // SERVICES_VIZ_PUBLIC_MOJOM_HIT_TEST_HIT_TEST_REGION_LIST_MOJOM_SHARED_INTERNAL_H_