...
FilterOperation::FilterOperation(
    ...
    std::optional<::blink::Vector<float>> matrix_in,
    int32_t zoom_inset_in,
    ::skia::mojom::blink::TileMode blur_tile_mode_in,
    std::optional<::blink::Vector<::gfx::Rect>> shape_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::skia::mojom::blink::TileMode>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
