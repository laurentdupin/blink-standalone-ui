...
class  AggregatedHitTestRegion {
 public:
  ...
  AggregatedHitTestRegion(
      ::viz::mojom::blink::FrameSinkIdPtr frame_sink_id,
      uint32_t flags,
...
AggregatedHitTestRegion& operator=(const AggregatedHitTestRegion&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        AggregatedHitTestRegion::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        AggregatedHitTestRegion::DataView, ::blink::Vector<uint8_t>>(input);
  }
