...
BeginFrameArgs::BeginFrameArgs(
    ...
    std::optional<::base::TimeDelta> unthrottled_interval_in)
    : frame_time(std::move(frame_time_in)),
      ...
      unthrottled_interval(std::move(unthrottled_interval_in)) {}
...
void BeginFrameArgs::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "unthrottled_interval"), this->unthrottled_interval,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
// static
bool StructTraits<::viz::mojom::blink::BeginFrameId::DataView, ::viz::mojom::blink::BeginFrameIdPtr>::Read(
    ::viz::mojom::blink::BeginFrameId::DataView input,
    ::viz::mojom::blink::BeginFrameIdPtr* output) {
  bool success = true;
  ::viz::mojom::blink::BeginFrameIdPtr result(::viz::mojom::blink::BeginFrameId::New());
...
bool StructTraits<::viz::mojom::blink::BeginFrameArgs::DataView, ::viz::mojom::blink::BeginFrameArgsPtr>::Read(
  ...
  ::viz::mojom::blink::BeginFrameArgsPtr result(::viz::mojom::blink::BeginFrameArgs::New());
      ...
      if (success && !input.ReadUnthrottledInterval(&result->unthrottled_interval))
        success = false;
  *output = std::move(result);
  return success;
}
