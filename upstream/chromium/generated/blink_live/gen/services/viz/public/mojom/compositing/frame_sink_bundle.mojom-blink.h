...
// with not having this data in traces there.
  ...
  virtual void Submit(::blink::Vector<BundledFrameSubmissionPtr> submissions) = 0;
};
...
// with not having this data in traces there.
  ...
  virtual void FlushNotifications(::blink::Vector<BundledReturnedResourcesPtr> acks, ::blink::Vector<BeginFrameInfoPtr> begin_frames, ::blink::Vector<BundledReturnedResourcesPtr> reclaimed_resources) = 0;
...
class BLINK_PLATFORM_EXPORT FrameSinkBundleProxy
 ...
 public:
  ...
  void Submit(::blink::Vector<BundledFrameSubmissionPtr> submissions) final;
...
class BLINK_PLATFORM_EXPORT FrameSinkBundleClientProxy
 ...
 public:
  ...
  void FlushNotifications(::blink::Vector<BundledReturnedResourcesPtr> acks, ::blink::Vector<BeginFrameInfoPtr> begin_frames, ::blink::Vector<BundledReturnedResourcesPtr> reclaimed_resources) final;
...
class BLINK_PLATFORM_EXPORT BundledReturnedResources {
 public:
  ...
  BundledReturnedResources(
      uint32_t sink_id,
      ::blink::Vector<::viz::ReturnedResource> resources);
...
class BLINK_PLATFORM_EXPORT BeginFrameInfo {
 public:
  ...
  BeginFrameInfo(
      ...
      const ::blink::HashMap<uint32_t, ::viz::FrameTimingDetails>& details,
      ::blink::Vector<::viz::ReturnedResource> resources);
...
BeginFrameInfo& operator=(const BeginFrameInfo&) = delete;
  ...
  ::blink::HashMap<uint32_t, ::viz::FrameTimingDetails> details;
...
struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::BeginFrameInfo::DataView,
  ...
  static  decltype(::viz::mojom::blink::BeginFrameInfo::resources)& resources(
       ::viz::mojom::blink::BeginFrameInfoPtr& input) {
    return input->resources;
  }
