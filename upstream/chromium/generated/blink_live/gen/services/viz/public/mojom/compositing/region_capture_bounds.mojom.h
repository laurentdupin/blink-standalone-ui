 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CropIdBoundsPair::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        CropIdBoundsPair::DataView, std::vector<uint8_t>>(input);
  }
...
RegionCaptureBounds& operator=(const RegionCaptureBounds&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        RegionCaptureBounds::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        RegionCaptureBounds::DataView, std::vector<uint8_t>>(input);
  }
...
struct  StructTraits<::viz::mojom::CropIdBoundsPair::DataView,
  ...
  static bool IsNull(const ::viz::mojom::CropIdBoundsPairPtr& input) { return !input; }
  static void SetToNull(::viz::mojom::CropIdBoundsPairPtr* output) { output->reset(); }

  static const decltype(::viz::mojom::CropIdBoundsPair::crop_id)& crop_id(
      const ::viz::mojom::CropIdBoundsPairPtr& input) {
    return input->crop_id;
  }

  static const decltype(::viz::mojom::CropIdBoundsPair::bounds)& bounds(
      const ::viz::mojom::CropIdBoundsPairPtr& input) {
    return input->bounds;
  }
...
struct  StructTraits<::viz::mojom::RegionCaptureBounds::DataView,
  ...
  static bool IsNull(const ::viz::mojom::RegionCaptureBoundsPtr& input) { return !input; }
  static void SetToNull(::viz::mojom::RegionCaptureBoundsPtr* output) { output->reset(); }

  static const decltype(::viz::mojom::RegionCaptureBounds::bounds)& bounds(
      const ::viz::mojom::RegionCaptureBoundsPtr& input) {
    return input->bounds;
  }
