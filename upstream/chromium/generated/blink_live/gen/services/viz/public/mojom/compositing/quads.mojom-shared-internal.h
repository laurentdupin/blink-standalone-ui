...
static_assert(sizeof(RoundedDisplayMasksInfo_Data) == 24,
              "Bad sizeof(RoundedDisplayMasksInfo_Data)");
// Used by RoundedDisplayMasksInfo::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView>
struct RoundedDisplayMasksInfo_UnserializedMessageContext
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  RoundedDisplayMasksInfo_UnserializedMessageContext(
...
const mojo::internal::UnserializedMessageContext::Tag
    RoundedDisplayMasksInfo_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
class  DebugBorderQuadState_Data {
 public:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
...
static_assert(sizeof(CompositorRenderPassQuadState_Data) == 64,
...
class  SurfaceQuadState_Data {
 public:
  ...
  uint8_t override_child_filter_quality_$flag : 1;
  uint8_t pad5_[3];
  int32_t override_child_filter_quality_$value;
  mojo::internal::Pointer<::cc::mojom::internal::DynamicRangeLimit_Data> override_child_dynamic_range_limit;
...
static_assert(sizeof(SurfaceQuadState_Data) == 40,
...
class  TextureQuadState_Data {
 public:
  ...
  uint8_t is_normalized_coords : 1;
  uint8_t pad8_[3];
...
static_assert(sizeof(TextureQuadState_Data) == 72,
