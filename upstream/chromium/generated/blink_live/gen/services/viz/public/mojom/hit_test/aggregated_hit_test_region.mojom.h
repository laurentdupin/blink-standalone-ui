// services/viz/public/mojom/hit_test/aggregated_hit_test_region.mojom.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef SERVICES_VIZ_PUBLIC_MOJOM_HIT_TEST_AGGREGATED_HIT_TEST_REGION_MOJOM_H_
#define SERVICES_VIZ_PUBLIC_MOJOM_HIT_TEST_AGGREGATED_HIT_TEST_REGION_MOJOM_H_
...
#include "services/viz/public/mojom/hit_test/aggregated_hit_test_region.mojom-forward.h"  // IWYU pragma: export
...
class  AggregatedHitTestRegion {
 public:
  ...
  AggregatedHitTestRegion(
      ...
      ::gfx::mojom::RectPtr rect,
      uint32_t child_count,
      ::gfx::mojom::TransformPtr transform);

AggregatedHitTestRegion(const AggregatedHitTestRegion&) = delete;
AggregatedHitTestRegion& operator=(const AggregatedHitTestRegion&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        AggregatedHitTestRegion::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
struct  StructTraits<::viz::mojom::AggregatedHitTestRegion::DataView,
  ...
  static decltype(::viz::mojom::AggregatedHitTestRegion::async_hit_test_reasons) async_hit_test_reasons(
      const ::viz::mojom::AggregatedHitTestRegionPtr& input) {
...
#endif  // SERVICES_VIZ_PUBLIC_MOJOM_HIT_TEST_AGGREGATED_HIT_TEST_REGION_MOJOM_H_