...
class  CompositorRenderPass {
 public:
  ...
  CompositorRenderPass(
      ...
      const std::optional<::viz::ViewTransitionElementResourceId>& view_transition_element_resource_id,
...
struct  StructTraits<::viz::mojom::CompositorRenderPass::DataView,
  ...
  static const decltype(::viz::mojom::CompositorRenderPass::subtree_capture_id)& subtree_capture_id(
      const ::viz::mojom::CompositorRenderPassPtr& input) {
    return input->subtree_capture_id;
  }

  static const decltype(::viz::mojom::CompositorRenderPass::subtree_size)& subtree_size(
      const ::viz::mojom::CompositorRenderPassPtr& input) {
  ...
  static decltype(::viz::mojom::CompositorRenderPass::has_per_quad_damage) has_per_quad_damage(
      const ::viz::mojom::CompositorRenderPassPtr& input) {
