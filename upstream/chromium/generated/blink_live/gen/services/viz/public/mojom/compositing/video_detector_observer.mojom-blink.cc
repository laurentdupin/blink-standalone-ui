// services/viz/public/mojom/compositing/video_detector_observer.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "services/viz/public/mojom/compositing/video_detector_observer.mojom-blink-test-utils.h"
...
uint32_t VideoDetectorObserver::OnVideoActivityStarted_Sym::IPCStableHash() {
  ...
  static constexpr uint32_t kHash = 0xd9bca91b;  // IPCStableHash for viz::mojom::VideoDetectorObserver::OnVideoActivityStarted
...
uint32_t VideoDetectorObserver::OnVideoActivityEnded_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x0172304c;  // IPCStableHash for viz::mojom::VideoDetectorObserver::OnVideoActivityEnded
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void VideoDetectorObserverProxy::OnVideoActivityStarted(
  ...
  mojo::Message message(
      std::to_underlying(messages::VideoDetectorObserver::kOnVideoActivityStarted), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
      ::viz::mojom::internal::VideoDetectorObserver_OnVideoActivityStarted_Params_Data> params(
          message);
  params.Allocate();
...
void VideoDetectorObserverProxy::OnVideoActivityEnded(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::VideoDetectorObserver::kOnVideoActivityEnded), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
      ::viz::mojom::internal::VideoDetectorObserver_OnVideoActivityEnded_Params_Data> params(
          message);
  params.Allocate();
...
bool VideoDetectorObserverRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::viz::mojom::blink::VideoDetectorObserver::Name_,
    kVideoDetectorObserverValidationInfo);
}
