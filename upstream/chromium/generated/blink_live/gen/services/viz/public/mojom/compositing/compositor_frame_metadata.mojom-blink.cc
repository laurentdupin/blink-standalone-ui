...
#include "services/viz/public/mojom/compositing/compositor_frame_metadata.mojom-blink-test-utils.h"
...
CompositorFrameMetadata::CompositorFrameMetadata(
    ...
    ::blink::Vector<::viz::SurfaceRange> referenced_surfaces_in,
    const ::viz::FrameDeadline& deadline_in,
    ::blink::Vector<::viz::SurfaceId> activation_dependencies_in,
    const ::viz::BeginFrameAck& begin_frame_ack_in,
    uint32_t frame_token_in,
    bool send_frame_token_to_embedder_in,
    std::optional<float> top_controls_visible_height_in,
    ...
    ::blink::Vector<::viz::CompositorFrameTransitionDirective> transition_directives_in,
    ...
    bool is_software_in,
    ::blink::Vector<::viz::mojom::blink::OffsetTagDefinitionPtr> offset_tag_definitions_in,
    ::blink::Vector<::viz::OffsetTagValue> offset_tag_values_in,
    ::viz::mojom::blink::FrameIntervalInputsPtr frame_interval_inputs_in,
    ::viz::TreesInVizTiming trees_in_viz_timing_in,
    ...
    : device_scale_factor(std::move(device_scale_factor_in)),
      ...
      trees_in_viz_timing(std::move(trees_in_viz_timing_in)),
...
void CompositorFrameMetadata::WriteIntoTrace(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type const ::blink::Vector<::viz::SurfaceRange>&>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type const ::blink::Vector<::viz::SurfaceId>&>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<::viz::CompositorFrameTransitionDirective>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<::viz::mojom::blink::OffsetTagDefinitionPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type const ::blink::Vector<::viz::OffsetTagValue>&>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::viz::mojom::blink::FrameIntervalInputsPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "trees_in_viz_timing"), this->trees_in_viz_timing,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::viz::TreesInVizTiming>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
bool StructTraits<::viz::mojom::blink::CompositorFrameMetadata::DataView, ::viz::mojom::blink::CompositorFrameMetadataPtr>::Read(
  ...
  ::viz::mojom::blink::CompositorFrameMetadataPtr result(::viz::mojom::blink::CompositorFrameMetadata::New());
      ...
      if (success && !input.ReadFrameIntervalInputs(&result->frame_interval_inputs))
        success = false;
      if (success && !input.ReadTreesInVizTiming(&result->trees_in_viz_timing))
        success = false;
