// services/viz/public/mojom/compositing/frame_sink_id.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef SERVICES_VIZ_PUBLIC_MOJOM_COMPOSITING_FRAME_SINK_ID_MOJOM_BLINK_H_
#define SERVICES_VIZ_PUBLIC_MOJOM_COMPOSITING_FRAME_SINK_ID_MOJOM_BLINK_H_
...
#include "services/viz/public/mojom/compositing/frame_sink_id.mojom-blink-forward.h"  // IWYU pragma: export
...
class BLINK_PLATFORM_EXPORT FrameSinkId {
 public:
  template <typename T>
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        FrameSinkId::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        FrameSinkId::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::FrameSinkId::DataView,
                                         ::viz::mojom::blink::FrameSinkIdPtr> {
  static bool IsNull(const ::viz::mojom::blink::FrameSinkIdPtr& input) { return !input; }
  static void SetToNull(::viz::mojom::blink::FrameSinkIdPtr* output) { output->reset(); }

  static decltype(::viz::mojom::blink::FrameSinkId::client_id) client_id(
      const ::viz::mojom::blink::FrameSinkIdPtr& input) {
    return input->client_id;
  }

  static decltype(::viz::mojom::blink::FrameSinkId::sink_id) sink_id(
      const ::viz::mojom::blink::FrameSinkIdPtr& input) {
    return input->sink_id;
  }

  static bool Read(::viz::mojom::blink::FrameSinkId::DataView input, ::viz::mojom::blink::FrameSinkIdPtr* output);
};

}  // namespace mojo

#endif  // SERVICES_VIZ_PUBLIC_MOJOM_COMPOSITING_FRAME_SINK_ID_MOJOM_BLINK_H_