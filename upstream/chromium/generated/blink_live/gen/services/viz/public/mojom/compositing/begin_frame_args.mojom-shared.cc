...
// static
bool BeginFrameId_Data::Validate(
    const void* data,
  ...
  [[maybe_unused]] const BeginFrameId_Data* object =
      static_cast<const BeginFrameId_Data*>(data);

  return true;
}

BeginFrameId_Data::BeginFrameId_Data()
...
bool BeginFrameArgs_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const BeginFrameArgs_Data* object =
      static_cast<const BeginFrameArgs_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->frame_id, 4, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->dispatch_time, 7, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->client_arrival_time, 8, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidateStruct(object->unthrottled_interval, validation_context))
    return false;
...
bool BeginFrameAck_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const BeginFrameAck_Data* object =
      static_cast<const BeginFrameAck_Data*>(data);
...
// static
void TraceFormatTraits<::viz::mojom::BeginFrameArgsType>::WriteIntoTrace(
