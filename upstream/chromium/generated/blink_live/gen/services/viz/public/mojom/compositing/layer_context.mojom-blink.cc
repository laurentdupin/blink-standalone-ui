...
LayerTreeUpdate::LayerTreeUpdate(
    ...
    bool is_flush_in,
    ::blink::Vector<::ui::LatencyInfo> latency_info_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type const ::blink::Vector<::ui::LatencyInfo>&>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
void LayerContextClientProxy::OnTilingsReadyForCleanup(
    int32_t in_layer_id, const ::blink::Vector<float>& in_tiling_scales_to_clean_up) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool LayerContextClientStubDispatch::Accept(
  ...
  switch (static_cast<messages::LayerContextClient>(message->header()->name)) {
    ...
    case messages::LayerContextClient::kOnTilingsReadyForCleanup: {
      ...
      bool success = true;
      int32_t p_layer_id{};
      ::blink::Vector<float> p_tiling_scales_to_clean_up{};
...
void LayerContextClientInterceptorForTesting::OnTilingsReadyForCleanup(int32_t layer_id, const ::blink::Vector<float>& tiling_scales_to_clean_up) {
