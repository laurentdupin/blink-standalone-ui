...
class BLINK_PLATFORM_EXPORT TileDisplayLayerExtra {
 public:
  ...
  TileDisplayLayerExtra(
      ...
      ::blink::Vector<float> proposed_tiling_scales_for_deletion);
...
class BLINK_PLATFORM_EXPORT LayerGeneralProperties {
 public:
  template <typename T>
...
class BLINK_PLATFORM_EXPORT AnchorPositionScrollData {
 public:
  ...
  AnchorPositionScrollData(
      ::blink::Vector<::cc::ElementId> adjustment_container_ids,
...
class BLINK_PLATFORM_EXPORT TransformTreeUpdate {
 public:
  ...
  TransformTreeUpdate(
      ...
      const ::blink::HashMap<::cc::ElementId, ::gfx::Vector2dF>& drawn_elastic_overscroll);
...
TransformTreeUpdate& operator=(const TransformTreeUpdate&) = delete;
  ...
  ::blink::HashMap<::cc::ElementId, ::gfx::Vector2dF> drawn_elastic_overscroll;
...
class BLINK_PLATFORM_EXPORT EffectNode {
 public:
  ...
  EffectNode(
      ...
      ::blink::Vector<::std::unique_ptr<::viz::CopyOutputRequest>> copy_output_requests);
...
class BLINK_PLATFORM_EXPORT ScrollTreeUpdate {
 public:
  ...
  ScrollTreeUpdate(
      const ::blink::HashMap<::cc::ElementId, ::scoped_refptr<::cc::SyncedScrollOffset>>& synced_scroll_offsets,
      const ::blink::HashMap<::cc::ElementId, ::gfx::Rect>& scrolling_contents_cull_rects,
      const ::blink::HashMap<::cc::ElementId, ::gfx::Vector2dF>& elastic_overscroll);
  ...
  ::blink::HashMap<::cc::ElementId, ::scoped_refptr<::cc::SyncedScrollOffset>> synced_scroll_offsets;
  
  ::blink::HashMap<::cc::ElementId, ::gfx::Rect> scrolling_contents_cull_rects;
  
  ::blink::HashMap<::cc::ElementId, ::gfx::Vector2dF> elastic_overscroll;
...
struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::TextureLayerExtra::DataView,
  ...
  static decltype(::viz::mojom::blink::TextureLayerExtra::update_transferable_resource) update_transferable_resource(
      const ::viz::mojom::blink::TextureLayerExtraPtr& input) {
    return input->update_transferable_resource;
  }

  static  decltype(::viz::mojom::blink::TextureLayerExtra::transferable_resource)& transferable_resource(
       ::viz::mojom::blink::TextureLayerExtraPtr& input) {
...
struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::TileDisplayLayerExtra::DataView,
  ...
  static const decltype(::viz::mojom::blink::TileDisplayLayerExtra::recorded_bounds)& recorded_bounds(
      const ::viz::mojom::blink::TileDisplayLayerExtraPtr& input) {
    return input->recorded_bounds;
  }

  static const decltype(::viz::mojom::blink::TileDisplayLayerExtra::proposed_tiling_scales_for_deletion)& proposed_tiling_scales_for_deletion(
      const ::viz::mojom::blink::TileDisplayLayerExtraPtr& input) {
...
struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::NinePatchThumbScrollbarLayerExtra::DataView,
  ...
  static decltype(::viz::mojom::blink::NinePatchThumbScrollbarLayerExtra::minimum_thumb_length) minimum_thumb_length(
      const ::viz::mojom::blink::NinePatchThumbScrollbarLayerExtraPtr& input) {
...
struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::PaintedScrollbarLayerExtra::DataView,
  ...
  static decltype(::viz::mojom::blink::PaintedScrollbarLayerExtra::minimum_thumb_length) minimum_thumb_length(
      const ::viz::mojom::blink::PaintedScrollbarLayerExtraPtr& input) {
    return input->minimum_thumb_length;
  }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::LayerGeneralProperties::DataView,
                                         ::viz::mojom::blink::LayerGeneralPropertiesPtr> {
  static bool IsNull(const ::viz::mojom::blink::LayerGeneralPropertiesPtr& input) { return !input; }
  static void SetToNull(::viz::mojom::blink::LayerGeneralPropertiesPtr* output) { output->reset(); }

  static const decltype(::viz::mojom::blink::LayerGeneralProperties::bounds)& bounds(
      const ::viz::mojom::blink::LayerGeneralPropertiesPtr& input) {
    return input->bounds;
  }

  static decltype(::viz::mojom::blink::LayerGeneralProperties::contents_opaque) contents_opaque(
      const ::viz::mojom::blink::LayerGeneralPropertiesPtr& input) {
    return input->contents_opaque;
  }

  static decltype(::viz::mojom::blink::LayerGeneralProperties::contents_opaque_for_text) contents_opaque_for_text(
      const ::viz::mojom::blink::LayerGeneralPropertiesPtr& input) {
    return input->contents_opaque_for_text;
  }

  static decltype(::viz::mojom::blink::LayerGeneralProperties::is_drawable) is_drawable(
      const ::viz::mojom::blink::LayerGeneralPropertiesPtr& input) {
    return input->is_drawable;
  }

  static decltype(::viz::mojom::blink::LayerGeneralProperties::layer_property_changed_not_from_property_trees) layer_property_changed_not_from_property_trees(
      const ::viz::mojom::blink::LayerGeneralPropertiesPtr& input) {
    return input->layer_property_changed_not_from_property_trees;
  }

  static decltype(::viz::mojom::blink::LayerGeneralProperties::layer_property_changed_from_property_trees) layer_property_changed_from_property_trees(
      const ::viz::mojom::blink::LayerGeneralPropertiesPtr& input) {
    return input->layer_property_changed_from_property_trees;
  }

  static decltype(::viz::mojom::blink::LayerGeneralProperties::hit_test_opaqueness) hit_test_opaqueness(
      const ::viz::mojom::blink::LayerGeneralPropertiesPtr& input) {
    return input->hit_test_opaqueness;
  }

  static const decltype(::viz::mojom::blink::LayerGeneralProperties::background_color)& background_color(
      const ::viz::mojom::blink::LayerGeneralPropertiesPtr& input) {
    return input->background_color;
  }

  static const decltype(::viz::mojom::blink::LayerGeneralProperties::safe_opaque_background_color)& safe_opaque_background_color(
      const ::viz::mojom::blink::LayerGeneralPropertiesPtr& input) {
    return input->safe_opaque_background_color;
  }

  static const decltype(::viz::mojom::blink::LayerGeneralProperties::element_id)& element_id(
      const ::viz::mojom::blink::LayerGeneralPropertiesPtr& input) {
    return input->element_id;
  }

  static const decltype(::viz::mojom::blink::LayerGeneralProperties::update_rect)& update_rect(
      const ::viz::mojom::blink::LayerGeneralPropertiesPtr& input) {
    return input->update_rect;
  }

  static const decltype(::viz::mojom::blink::LayerGeneralProperties::offset_to_transform_parent)& offset_to_transform_parent(
      const ::viz::mojom::blink::LayerGeneralPropertiesPtr& input) {
    return input->offset_to_transform_parent;
  }

  static decltype(::viz::mojom::blink::LayerGeneralProperties::should_check_backface_visibility) should_check_backface_visibility(
      const ::viz::mojom::blink::LayerGeneralPropertiesPtr& input) {
    return input->should_check_backface_visibility;
  }

  static const decltype(::viz::mojom::blink::LayerGeneralProperties::rare_properties)& rare_properties(
      const ::viz::mojom::blink::LayerGeneralPropertiesPtr& input) {
    return input->rare_properties;
  }

  static  decltype(::viz::mojom::blink::LayerGeneralProperties::layer_extra)& layer_extra(
       ::viz::mojom::blink::LayerGeneralPropertiesPtr& input) {
    return input->layer_extra;
  }

  static bool Read(::viz::mojom::blink::LayerGeneralProperties::DataView input, ::viz::mojom::blink::LayerGeneralPropertiesPtr* output);
};
...
struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::Layer::DataView,
  ...
  static  decltype(::viz::mojom::blink::Layer::general_properties)& general_properties(
       ::viz::mojom::blink::LayerPtr& input) {
...
struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::StickyPositionNodeData::DataView,
  ...
  static decltype(::viz::mojom::blink::StickyPositionNodeData::x_scroll_ancestor) x_scroll_ancestor(
      const ::viz::mojom::blink::StickyPositionNodeDataPtr& input) {
    return input->x_scroll_ancestor;
  }

  static decltype(::viz::mojom::blink::StickyPositionNodeData::y_scroll_ancestor) y_scroll_ancestor(
      const ::viz::mojom::blink::StickyPositionNodeDataPtr& input) {
...
struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::TransformTreeUpdate::DataView,
  ...
  static const decltype(::viz::mojom::blink::TransformTreeUpdate::drawn_elastic_overscroll)& drawn_elastic_overscroll(
      const ::viz::mojom::blink::TransformTreeUpdatePtr& input) {
...
struct BLINK_PLATFORM_EXPORT StructTraits<::viz::mojom::blink::EffectNode::DataView,
  ...
  static decltype(::viz::mojom::blink::EffectNode::effect_changed) effect_changed(
      const ::viz::mojom::blink::EffectNodePtr& input) {
  ...
  static decltype(::viz::mojom::blink::EffectNode::only_draws_visible_content) only_draws_visible_content(
      const ::viz::mojom::blink::EffectNodePtr& input) {
...
struct BLINK_PLATFORM_EXPORT UnionTraits<::viz::mojom::blink::LayerExtra::DataView,
  ...
  static  ::viz::mojom::blink::TextureLayerExtraPtr& texture_layer_extra( ::viz::mojom::blink::LayerExtraPtr& input) {
