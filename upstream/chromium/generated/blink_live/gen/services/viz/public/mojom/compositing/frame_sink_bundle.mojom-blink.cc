...
BundledReturnedResources::BundledReturnedResources(
    uint32_t sink_id_in,
    ::blink::Vector<::viz::ReturnedResource> resources_in)
    : sink_id(std::move(sink_id_in)),
...
BeginFrameInfo::BeginFrameInfo(
    ...
    const ::blink::HashMap<uint32_t, ::viz::FrameTimingDetails>& details_in,
    ::blink::Vector<::viz::ReturnedResource> resources_in)
    : sink_id(std::move(sink_id_in)),
...
void FrameSinkBundleProxy::Submit(
    ::blink::Vector<BundledFrameSubmissionPtr> in_submissions) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("submissions"), in_submissions,
                        "<value of type ::blink::Vector<BundledFrameSubmissionPtr>>");
   });
#endif
...
bool FrameSinkBundleStubDispatch::Accept(
  ...
  switch (static_cast<messages::FrameSinkBundle>(message->header()->name)) {
    ...
    case messages::FrameSinkBundle::kSubmit: {
      ...
      bool success = true;
      ::blink::Vector<BundledFrameSubmissionPtr> p_submissions{};
...
bool FrameSinkBundleRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::viz::mojom::blink::FrameSinkBundle::Name_,
...
void FrameSinkBundleClientProxy::FlushNotifications(
    ::blink::Vector<BundledReturnedResourcesPtr> in_acks, ::blink::Vector<BeginFrameInfoPtr> in_begin_frames, ::blink::Vector<BundledReturnedResourcesPtr> in_reclaimed_resources) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("acks"), in_acks,
                        "<value of type ::blink::Vector<BundledReturnedResourcesPtr>>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("begin_frames"), in_begin_frames,
                        "<value of type ::blink::Vector<BeginFrameInfoPtr>>");
      perfetto::WriteIntoTracedValueWithFallback(
...
bool FrameSinkBundleClientStubDispatch::Accept(
  ...
  switch (static_cast<messages::FrameSinkBundleClient>(message->header()->name)) {
    case messages::FrameSinkBundleClient::kFlushNotifications: {
      ...
      bool success = true;
      ::blink::Vector<BundledReturnedResourcesPtr> p_acks{};
      ::blink::Vector<BeginFrameInfoPtr> p_begin_frames{};
      ::blink::Vector<BundledReturnedResourcesPtr> p_reclaimed_resources{};
...
bool FrameSinkBundleClientRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::viz::mojom::blink::FrameSinkBundleClient::Name_,
...
void FrameSinkBundleInterceptorForTesting::Submit(::blink::Vector<BundledFrameSubmissionPtr> submissions) {
...
void FrameSinkBundleClientInterceptorForTesting::FlushNotifications(::blink::Vector<BundledReturnedResourcesPtr> acks, ::blink::Vector<BeginFrameInfoPtr> begin_frames, ::blink::Vector<BundledReturnedResourcesPtr> reclaimed_resources) {
