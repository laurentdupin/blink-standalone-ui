...
#include "services/viz/public/mojom/compositing/compositor_frame.mojom-forward.h"  // IWYU pragma: export
...
struct  StructTraits<::viz::mojom::CompositorFrame::DataView,
  ...
  static  decltype(::viz::mojom::CompositorFrame::resources)& resources(
