...
class  CompositorFrameMetadata_Data {
 public:
  ...
  uint8_t is_handling_animation : 1;
  ...
  float top_controls_visible_height_$value;
  ...
  mojo::internal::Pointer<mojo::internal::Array_Data<mojo::internal::Pointer<::viz::mojom::internal::CompositorFrameTransitionDirective_Data>>> transition_directives;
  ...
  mojo::internal::Pointer<::viz::mojom::internal::TreesInVizTiming_Data> trees_in_viz_timing;
...
static_assert(sizeof(CompositorFrameMetadata_Data) == 184,
