// services/viz/public/mojom/compositing/trees_in_viz_timing.mojom.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef SERVICES_VIZ_PUBLIC_MOJOM_COMPOSITING_TREES_IN_VIZ_TIMING_MOJOM_H_
#define SERVICES_VIZ_PUBLIC_MOJOM_COMPOSITING_TREES_IN_VIZ_TIMING_MOJOM_H_
...
#include "services/viz/public/mojom/compositing/trees_in_viz_timing.mojom-forward.h"  // IWYU pragma: export
 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        TreesInVizTiming::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        TreesInVizTiming::DataView, std::vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::viz::mojom::TreesInVizTiming::DataView,
                                         ::viz::mojom::TreesInVizTimingPtr> {
  static bool IsNull(const ::viz::mojom::TreesInVizTimingPtr& input) { return !input; }
  static void SetToNull(::viz::mojom::TreesInVizTimingPtr* output) { output->reset(); }

  static const decltype(::viz::mojom::TreesInVizTiming::start_update_display_tree)& start_update_display_tree(
      const ::viz::mojom::TreesInVizTimingPtr& input) {
    return input->start_update_display_tree;
  }

  static const decltype(::viz::mojom::TreesInVizTiming::start_prepare_to_draw)& start_prepare_to_draw(
      const ::viz::mojom::TreesInVizTimingPtr& input) {
    return input->start_prepare_to_draw;
  }

  static const decltype(::viz::mojom::TreesInVizTiming::start_draw_layers)& start_draw_layers(
      const ::viz::mojom::TreesInVizTimingPtr& input) {
    return input->start_draw_layers;
  }

  static const decltype(::viz::mojom::TreesInVizTiming::submit_compositor_frame)& submit_compositor_frame(
      const ::viz::mojom::TreesInVizTimingPtr& input) {
    return input->submit_compositor_frame;
  }

  static bool Read(::viz::mojom::TreesInVizTiming::DataView input, ::viz::mojom::TreesInVizTimingPtr* output);
};

}  // namespace mojo

#endif  // SERVICES_VIZ_PUBLIC_MOJOM_COMPOSITING_TREES_IN_VIZ_TIMING_MOJOM_H_