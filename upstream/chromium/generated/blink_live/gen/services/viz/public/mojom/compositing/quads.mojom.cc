...
SurfaceQuadState::SurfaceQuadState(
    ...
    bool allow_merge_in,
    std::optional<::cc::PaintFlags::FilterQuality> override_child_filter_quality_in,
    const std::optional<::cc::PaintFlags::DynamicRangeLimitMixture>& override_child_dynamic_range_limit_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::optional<::cc::PaintFlags::FilterQuality>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type const std::optional<::cc::PaintFlags::DynamicRangeLimitMixture>&>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
TextureQuadState::TextureQuadState(
    ...
    : resource_id(std::move(resource_id_in)),
      ...
      is_normalized_coords(std::move(is_normalized_coords_in)),
...
void TextureQuadState::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "is_normalized_coords"), this->is_normalized_coords,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type bool>"
#else
      "<value>"
...
SharedElementQuadState::SharedElementQuadState(
    const ::viz::ViewTransitionElementResourceId& element_resource_id_in)
...
bool StructTraits<::viz::mojom::RoundedDisplayMasksInfo::DataView, ::viz::mojom::RoundedDisplayMasksInfoPtr>::Read(
  ...
  bool success = true;
  ::viz::mojom::RoundedDisplayMasksInfoPtr result(::viz::mojom::RoundedDisplayMasksInfo::New());
...
bool StructTraits<::viz::mojom::TextureQuadState::DataView, ::viz::mojom::TextureQuadStatePtr>::Read(
  ...
  ::viz::mojom::TextureQuadStatePtr result(::viz::mojom::TextureQuadState::New());
      ...
      if (success)
        result->is_normalized_coords = input.is_normalized_coords();
...
bool StructTraits<::viz::mojom::SharedElementQuadState::DataView, ::viz::mojom::SharedElementQuadStatePtr>::Read(
  ...
  bool success = true;
  ::viz::mojom::SharedElementQuadStatePtr result(::viz::mojom::SharedElementQuadState::New());
...
bool UnionTraits<::viz::mojom::DrawQuadState::DataView, ::viz::mojom::DrawQuadStatePtr>::Read(
  ...
  switch (input.tag()) {
    ...
    case Tag::kSharedElementQuadState: {
      ::viz::mojom::SharedElementQuadStatePtr result_shared_element_quad_state{};
