...
#include "cc/mojom/missing_tile_reason.mojom-forward.h"
#include <string>
#include <vector>
...
class  TileContents {
 public:
  ...
  ::cc::mojom::MissingTileReason get_missing_reason() const {
    CHECK(tag_ == Tag::kMissingReason);
    return data_.missing_reason;
  }
  void set_missing_reason(::cc::mojom::MissingTileReason missing_reason);
...
struct  StructTraits<::viz::mojom::TileResource::DataView,
  ...
  static bool IsNull(const ::viz::mojom::TileResourcePtr& input) { return !input; }
  static void SetToNull(::viz::mojom::TileResourcePtr* output) { output->reset(); }

  static  decltype(::viz::mojom::TileResource::resource)& resource(
       ::viz::mojom::TileResourcePtr& input) {
    return input->resource;
  }

  static decltype(::viz::mojom::TileResource::is_checkered) is_checkered(
      const ::viz::mojom::TileResourcePtr& input) {
...
struct  StructTraits<::viz::mojom::Tile::DataView,
                                         ::viz::mojom::TilePtr> {
  static bool IsNull(const ::viz::mojom::TilePtr& input) { return !input; }
  static void SetToNull(::viz::mojom::TilePtr* output) { output->reset(); }

  static decltype(::viz::mojom::Tile::column_index) column_index(
      const ::viz::mojom::TilePtr& input) {
    return input->column_index;
  }

  static decltype(::viz::mojom::Tile::row_index) row_index(
      const ::viz::mojom::TilePtr& input) {
    return input->row_index;
  }

  static decltype(::viz::mojom::Tile::update_damage) update_damage(
      const ::viz::mojom::TilePtr& input) {
    return input->update_damage;
  }

  static  decltype(::viz::mojom::Tile::contents)& contents(
       ::viz::mojom::TilePtr& input) {
...
struct  StructTraits<::viz::mojom::Tiling::DataView,
                                         ::viz::mojom::TilingPtr> {
  static bool IsNull(const ::viz::mojom::TilingPtr& input) { return !input; }
  static void SetToNull(::viz::mojom::TilingPtr* output) { output->reset(); }

  static decltype(::viz::mojom::Tiling::layer_id) layer_id(
      const ::viz::mojom::TilingPtr& input) {
    return input->layer_id;
  }

  static const decltype(::viz::mojom::Tiling::raster_translation)& raster_translation(
      const ::viz::mojom::TilingPtr& input) {
    return input->raster_translation;
  }

  static const decltype(::viz::mojom::Tiling::raster_scale)& raster_scale(
      const ::viz::mojom::TilingPtr& input) {
    return input->raster_scale;
  }

  static const decltype(::viz::mojom::Tiling::tile_size)& tile_size(
      const ::viz::mojom::TilingPtr& input) {
    return input->tile_size;
  }

  static const decltype(::viz::mojom::Tiling::tiling_rect)& tiling_rect(
      const ::viz::mojom::TilingPtr& input) {
    return input->tiling_rect;
  }

  static  decltype(::viz::mojom::Tiling::tiles)& tiles(
       ::viz::mojom::TilingPtr& input) {
    return input->tiles;
  }

  static decltype(::viz::mojom::Tiling::scale_key) scale_key(
      const ::viz::mojom::TilingPtr& input) {
    return input->scale_key;
  }

  static decltype(::viz::mojom::Tiling::is_deleted) is_deleted(
      const ::viz::mojom::TilingPtr& input) {
...
struct  UnionTraits<::viz::mojom::TileContents::DataView,
  ...
  static bool IsNull(const ::viz::mojom::TileContentsPtr& input) { return !input; }
  static void SetToNull(::viz::mojom::TileContentsPtr* output) { output->reset(); }

  static ::viz::mojom::TileContents::Tag GetTag(const ::viz::mojom::TileContentsPtr& input) {
    return input->which();
  }

  static  ::cc::mojom::MissingTileReason missing_reason(const ::viz::mojom::TileContentsPtr& input) {
    return input->get_missing_reason();
  }

  static  ::viz::mojom::TileResourcePtr& resource( ::viz::mojom::TileContentsPtr& input) {
