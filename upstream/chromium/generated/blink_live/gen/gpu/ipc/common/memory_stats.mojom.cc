...
size_t VideoMemoryProcessStats::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->video_memory_bytes);
  seed = mojo::internal::Hash(seed, this->has_duplicates);
  return seed;
}
...
VideoMemoryUsageStats::VideoMemoryUsageStats(
    base::flat_map<int32_t, VideoMemoryProcessStatsPtr> process_map_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type base::flat_map<int32_t, VideoMemoryProcessStatsPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
