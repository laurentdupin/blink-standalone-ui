...
class BLINK_PLATFORM_EXPORT GpuPreferences {
 public:
  template <typename T>
  ...
  GpuPreferences(
      ...
      ::blink::Vector<uint32_t> ignored_gpu_blocklist_entries,
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::gpu::mojom::blink::GpuPreferences::DataView,
  ...
  static const decltype(::gpu::mojom::blink::GpuPreferences::ignored_gpu_blocklist_entries)& ignored_gpu_blocklist_entries(
      const ::gpu::mojom::blink::GpuPreferencesPtr& input) {
