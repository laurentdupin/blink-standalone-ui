...
size_t SharedImageCapabilities::Hash(size_t seed) const {
  ...
  seed = mojo::internal::WTFHash(seed, this->supports_ycbcr_nv12_sampling);
  seed = mojo::internal::WTFHash(seed, this->supports_ycbcr_p010_sampling);
  ...
  seed = mojo::internal::WTFHash(seed, this->disable_one_component_textures);
...
bool StructTraits<::gpu::mojom::blink::SharedImageCapabilities::DataView, ::gpu::mojom::blink::SharedImageCapabilitiesPtr>::Read(
    ::gpu::mojom::blink::SharedImageCapabilities::DataView input,
    ::gpu::mojom::blink::SharedImageCapabilitiesPtr* output) {
  bool success = true;
