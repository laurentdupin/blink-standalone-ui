...
GpuDevice& operator=(const GpuDevice&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        GpuDevice::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
class  VideoDecodeAcceleratorSupportedProfile {
 public:
  ...
  VideoDecodeAcceleratorSupportedProfile(
      ...
      ::gfx::mojom::SizePtr max_resolution,
      ::gfx::mojom::SizePtr min_resolution,
      bool encrypted_only);
...
VideoDecodeAcceleratorSupportedProfile& operator=(const VideoDecodeAcceleratorSupportedProfile&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VideoDecodeAcceleratorSupportedProfile::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
class  VideoDecodeAcceleratorCapabilities {
 public:
  ...
  VideoDecodeAcceleratorCapabilities(
      std::vector<VideoDecodeAcceleratorSupportedProfilePtr> supported_profiles,
      uint32_t flags);
...
VideoDecodeAcceleratorCapabilities& operator=(const VideoDecodeAcceleratorCapabilities&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VideoDecodeAcceleratorCapabilities::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
VideoEncodeAcceleratorSupportedProfile& operator=(const VideoEncodeAcceleratorSupportedProfile&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VideoEncodeAcceleratorSupportedProfile::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
class  GpuInfo {
 public:
  ...
  GpuInfo(
      ::mojo_base::mojom::TimeDeltaPtr initialization_time,
      bool optimus,
      bool amd_switchable,
      GpuDevicePtr gpu,
      std::vector<GpuDevicePtr> secondary_gpus,
      std::vector<GpuDevicePtr> npus,
      ...
      std::vector<VideoDecodeAcceleratorSupportedProfilePtr> video_decode_accelerator_supported_profiles,
      std::vector<VideoEncodeAcceleratorSupportedProfilePtr> video_encode_accelerator_supported_profiles,
      bool jpeg_decode_accelerator_supported,
      bool subpixel_font_rendering,
      uint32_t visibility_callback_call_count,
      bool hardware_supports_vulkan,
      ::gpu::mojom::VulkanInfoPtr vulkan_info);
...
GpuInfo& operator=(const GpuInfo&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        GpuInfo::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
struct  StructTraits<::gpu::mojom::GpuDevice::DataView,
  ...
  static decltype(::gpu::mojom::GpuDevice::sub_sys_id) sub_sys_id(
      const ::gpu::mojom::GpuDevicePtr& input) {
    return input->sub_sys_id;
  }

  static decltype(::gpu::mojom::GpuDevice::revision) revision(
      const ::gpu::mojom::GpuDevicePtr& input) {
  ...
  static const decltype(::gpu::mojom::GpuDevice::luid)& luid(
      const ::gpu::mojom::GpuDevicePtr& input) {
    return input->luid;
  }

  static decltype(::gpu::mojom::GpuDevice::gpu_preference) gpu_preference(
      const ::gpu::mojom::GpuDevicePtr& input) {
...
template <>
struct  StructTraits<::gpu::mojom::OverlayInfo::DataView,
                                         ::gpu::mojom::OverlayInfoPtr> {
  static bool IsNull(const ::gpu::mojom::OverlayInfoPtr& input) { return !input; }
  static void SetToNull(::gpu::mojom::OverlayInfoPtr* output) { output->reset(); }

  static decltype(::gpu::mojom::OverlayInfo::direct_composition) direct_composition(
      const ::gpu::mojom::OverlayInfoPtr& input) {
    return input->direct_composition;
  }

  static decltype(::gpu::mojom::OverlayInfo::supports_overlays) supports_overlays(
      const ::gpu::mojom::OverlayInfoPtr& input) {
    return input->supports_overlays;
  }

  static decltype(::gpu::mojom::OverlayInfo::yuy2_overlay_support) yuy2_overlay_support(
      const ::gpu::mojom::OverlayInfoPtr& input) {
    return input->yuy2_overlay_support;
  }

  static decltype(::gpu::mojom::OverlayInfo::nv12_overlay_support) nv12_overlay_support(
      const ::gpu::mojom::OverlayInfoPtr& input) {
    return input->nv12_overlay_support;
  }

  static decltype(::gpu::mojom::OverlayInfo::bgra8_overlay_support) bgra8_overlay_support(
      const ::gpu::mojom::OverlayInfoPtr& input) {
    return input->bgra8_overlay_support;
  }

  static decltype(::gpu::mojom::OverlayInfo::rgb10a2_overlay_support) rgb10a2_overlay_support(
      const ::gpu::mojom::OverlayInfoPtr& input) {
    return input->rgb10a2_overlay_support;
  }

  static decltype(::gpu::mojom::OverlayInfo::p010_overlay_support) p010_overlay_support(
      const ::gpu::mojom::OverlayInfoPtr& input) {
...
struct  StructTraits<::gpu::mojom::GpuInfo::DataView,
  ...
  static const decltype(::gpu::mojom::GpuInfo::npus)& npus(
      const ::gpu::mojom::GpuInfoPtr& input) {
    return input->npus;
  }
  ...
  static const decltype(::gpu::mojom::GpuInfo::display_type)& display_type(
      const ::gpu::mojom::GpuInfoPtr& input) {
    return input->display_type;
  }

  static decltype(::gpu::mojom::GpuInfo::skia_backend_type) skia_backend_type(
      const ::gpu::mojom::GpuInfoPtr& input) {
  ...
  static const decltype(::gpu::mojom::GpuInfo::gl_implementation_parts)& gl_implementation_parts(
      const ::gpu::mojom::GpuInfoPtr& input) {
  ...
  static decltype(::gpu::mojom::GpuInfo::directml_feature_level) directml_feature_level(
      const ::gpu::mojom::GpuInfoPtr& input) {
    return input->directml_feature_level;
  }

  static decltype(::gpu::mojom::GpuInfo::d3d12_feature_level) d3d12_feature_level(
      const ::gpu::mojom::GpuInfoPtr& input) {
    return input->d3d12_feature_level;
  }

  static decltype(::gpu::mojom::GpuInfo::vulkan_version) vulkan_version(
      const ::gpu::mojom::GpuInfoPtr& input) {
    return input->vulkan_version;
  }

  static const decltype(::gpu::mojom::GpuInfo::overlay_info)& overlay_info(
      const ::gpu::mojom::GpuInfoPtr& input) {
    return input->overlay_info;
  }

  static decltype(::gpu::mojom::GpuInfo::shared_image_d3d) shared_image_d3d(
      const ::gpu::mojom::GpuInfoPtr& input) {
  ...
  static decltype(::gpu::mojom::GpuInfo::subpixel_font_rendering) subpixel_font_rendering(
      const ::gpu::mojom::GpuInfoPtr& input) {
    return input->subpixel_font_rendering;
  }

  static decltype(::gpu::mojom::GpuInfo::visibility_callback_call_count) visibility_callback_call_count(
      const ::gpu::mojom::GpuInfoPtr& input) {
    return input->visibility_callback_call_count;
  }

  static decltype(::gpu::mojom::GpuInfo::hardware_supports_vulkan) hardware_supports_vulkan(
      const ::gpu::mojom::GpuInfoPtr& input) {
    return input->hardware_supports_vulkan;
  }

  static const decltype(::gpu::mojom::GpuInfo::vulkan_info)& vulkan_info(
      const ::gpu::mojom::GpuInfoPtr& input) {
