 ...
 public:
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VideoMemoryProcessStats::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VideoMemoryProcessStats::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
class  VideoMemoryUsageStats {
 public:
  ...
  VideoMemoryUsageStats(
      ::blink::HashMap<int32_t, VideoMemoryProcessStatsPtr> process_map,
...
VideoMemoryUsageStats& operator=(const VideoMemoryUsageStats&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VideoMemoryUsageStats::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VideoMemoryUsageStats::DataView, ::blink::Vector<uint8_t>>(input);
  }
