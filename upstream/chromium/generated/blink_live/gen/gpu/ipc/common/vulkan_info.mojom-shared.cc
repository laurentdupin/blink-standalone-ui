...
bool VulkanPhysicalDeviceInfo_Data::Validate(
  ...
  [[maybe_unused]] const VulkanPhysicalDeviceInfo_Data* object =
      static_cast<const VulkanPhysicalDeviceInfo_Data*>(data);
...
bool VulkanInfo_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const VulkanInfo_Data* object =
      static_cast<const VulkanInfo_Data*>(data);
