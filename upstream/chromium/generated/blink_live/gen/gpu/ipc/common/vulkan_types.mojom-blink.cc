...
VkExtensionProperties::VkExtensionProperties(
    const ::blink::String& extensionName_in,
...
VkLayerProperties::VkLayerProperties(
    const ::blink::String& layerName_in,
    uint32_t specVersion_in,
...
VkPhysicalDeviceLimits::VkPhysicalDeviceLimits(
    ...
    ::blink::Vector<uint32_t> maxComputeWorkGroupCount_in,
    uint32_t maxComputeWorkGroupInvocations_in,
    ::blink::Vector<uint32_t> maxComputeWorkGroupSize_in,
    ...
    ::blink::Vector<uint32_t> maxViewportDimensions_in,
    ::blink::Vector<float> viewportBoundsRange_in,
    ...
    ::blink::Vector<float> pointSizeRange_in,
    ::blink::Vector<float> lineWidthRange_in,
...
VkPhysicalDeviceProperties::VkPhysicalDeviceProperties(
    ...
    const ::blink::String& deviceName_in,
    ::blink::Vector<uint8_t> pipelineCacheUUID_in,
