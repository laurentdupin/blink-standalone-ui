...
#include "gpu/ipc/common/vulkan_types.mojom-data-view.h"  // IWYU pragma: export
...
struct Serializer<::gpu::mojom::VkPhysicalDeviceType, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::gpu::mojom::VkPhysicalDeviceType>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::gpu::mojom::VkPhysicalDeviceType, UserType> ||
                        HasInfallibleConversion(::gpu::mojom::VkPhysicalDeviceType()),
                    "::gpu::mojom::VkPhysicalDeviceType does not have an infallible conversion, "
...
template <>
struct  TraceFormatTraits<::gpu::mojom::VkPhysicalDeviceType> {
