...
class  VkExtensionProperties {
 public:
  ...
  VkExtensionProperties(
      const ::blink::String& extensionName,
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VkExtensionProperties::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VkExtensionProperties::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
class  VkLayerProperties {
 public:
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VkLayerProperties::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VkLayerProperties::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
class  VkExtent3D {
 public:
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VkExtent3D::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VkExtent3D::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
class  VkPhysicalDeviceLimits {
 public:
  ...
  VkPhysicalDeviceLimits(
      ...
      ::blink::Vector<uint32_t> maxComputeWorkGroupCount,
      uint32_t maxComputeWorkGroupInvocations,
      ::blink::Vector<uint32_t> maxComputeWorkGroupSize,
      ...
      ::blink::Vector<uint32_t> maxViewportDimensions,
      ::blink::Vector<float> viewportBoundsRange,
      ...
      ::blink::Vector<float> pointSizeRange,
      ::blink::Vector<float> lineWidthRange,
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VkPhysicalDeviceLimits::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VkPhysicalDeviceLimits::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
class  VkPhysicalDeviceSparseProperties {
 public:
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VkPhysicalDeviceSparseProperties::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VkPhysicalDeviceSparseProperties::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
class  VkPhysicalDeviceProperties {
 public:
  ...
  VkPhysicalDeviceProperties(
      ...
      const ::blink::String& deviceName,
      ::blink::Vector<uint8_t> pipelineCacheUUID,
      VkPhysicalDeviceLimitsPtr limits,
      VkPhysicalDeviceSparsePropertiesPtr sparseProperties);

VkPhysicalDeviceProperties(const VkPhysicalDeviceProperties&) = delete;
VkPhysicalDeviceProperties& operator=(const VkPhysicalDeviceProperties&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VkPhysicalDeviceProperties::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VkPhysicalDeviceProperties::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
class  VkPhysicalDeviceFeatures {
 public:
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VkPhysicalDeviceFeatures::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VkPhysicalDeviceFeatures::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
class  VkQueueFamilyProperties {
 public:
  ...
  VkQueueFamilyProperties(
      ...
      VkExtent3DPtr minImageTransferGranularity);

VkQueueFamilyProperties(const VkQueueFamilyProperties&) = delete;
VkQueueFamilyProperties& operator=(const VkQueueFamilyProperties&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VkQueueFamilyProperties::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VkQueueFamilyProperties::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
struct  StructTraits<::gpu::mojom::blink::VkExtensionProperties::DataView,
  ...
  static bool IsNull(const ::gpu::mojom::blink::VkExtensionPropertiesPtr& input) { return !input; }
  static void SetToNull(::gpu::mojom::blink::VkExtensionPropertiesPtr* output) { output->reset(); }

  static const decltype(::gpu::mojom::blink::VkExtensionProperties::extensionName)& extensionName(
      const ::gpu::mojom::blink::VkExtensionPropertiesPtr& input) {
    return input->extensionName;
  }

  static decltype(::gpu::mojom::blink::VkExtensionProperties::specVersion) specVersion(
      const ::gpu::mojom::blink::VkExtensionPropertiesPtr& input) {
    return input->specVersion;
  }

  static bool Read(::gpu::mojom::blink::VkExtensionProperties::DataView input, ::gpu::mojom::blink::VkExtensionPropertiesPtr* output);
};
...
struct  StructTraits<::gpu::mojom::blink::VkLayerProperties::DataView,
  ...
  static bool IsNull(const ::gpu::mojom::blink::VkLayerPropertiesPtr& input) { return !input; }
  static void SetToNull(::gpu::mojom::blink::VkLayerPropertiesPtr* output) { output->reset(); }

  static const decltype(::gpu::mojom::blink::VkLayerProperties::layerName)& layerName(
      const ::gpu::mojom::blink::VkLayerPropertiesPtr& input) {
    return input->layerName;
  }

  static decltype(::gpu::mojom::blink::VkLayerProperties::specVersion) specVersion(
      const ::gpu::mojom::blink::VkLayerPropertiesPtr& input) {
    return input->specVersion;
  }

  static decltype(::gpu::mojom::blink::VkLayerProperties::implementationVersion) implementationVersion(
      const ::gpu::mojom::blink::VkLayerPropertiesPtr& input) {
    return input->implementationVersion;
  }

  static const decltype(::gpu::mojom::blink::VkLayerProperties::description)& description(
      const ::gpu::mojom::blink::VkLayerPropertiesPtr& input) {
    return input->description;
  }

  static bool Read(::gpu::mojom::blink::VkLayerProperties::DataView input, ::gpu::mojom::blink::VkLayerPropertiesPtr* output);
};
...
struct  StructTraits<::gpu::mojom::blink::VkPhysicalDeviceLimits::DataView,
  ...
  static bool IsNull(const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) { return !input; }
  static void SetToNull(::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr* output) { output->reset(); }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxImageDimension1D) maxImageDimension1D(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxImageDimension1D;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxImageDimension2D) maxImageDimension2D(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxImageDimension2D;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxImageDimension3D) maxImageDimension3D(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxImageDimension3D;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxImageDimensionCube) maxImageDimensionCube(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxImageDimensionCube;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxImageArrayLayers) maxImageArrayLayers(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxImageArrayLayers;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxTexelBufferElements) maxTexelBufferElements(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxTexelBufferElements;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxUniformBufferRange) maxUniformBufferRange(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxUniformBufferRange;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxStorageBufferRange) maxStorageBufferRange(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxStorageBufferRange;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxPushConstantsSize) maxPushConstantsSize(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxPushConstantsSize;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxMemoryAllocationCount) maxMemoryAllocationCount(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxMemoryAllocationCount;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxSamplerAllocationCount) maxSamplerAllocationCount(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxSamplerAllocationCount;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::bufferImageGranularity) bufferImageGranularity(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->bufferImageGranularity;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::sparseAddressSpaceSize) sparseAddressSpaceSize(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->sparseAddressSpaceSize;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxBoundDescriptorSets) maxBoundDescriptorSets(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxBoundDescriptorSets;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxPerStageDescriptorSamplers) maxPerStageDescriptorSamplers(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxPerStageDescriptorSamplers;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxPerStageDescriptorUniformBuffers) maxPerStageDescriptorUniformBuffers(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxPerStageDescriptorUniformBuffers;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxPerStageDescriptorStorageBuffers) maxPerStageDescriptorStorageBuffers(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxPerStageDescriptorStorageBuffers;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxPerStageDescriptorSampledImages) maxPerStageDescriptorSampledImages(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxPerStageDescriptorSampledImages;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxPerStageDescriptorStorageImages) maxPerStageDescriptorStorageImages(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxPerStageDescriptorStorageImages;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxPerStageDescriptorInputAttachments) maxPerStageDescriptorInputAttachments(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxPerStageDescriptorInputAttachments;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxPerStageResources) maxPerStageResources(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxPerStageResources;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxDescriptorSetSamplers) maxDescriptorSetSamplers(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxDescriptorSetSamplers;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxDescriptorSetUniformBuffers) maxDescriptorSetUniformBuffers(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxDescriptorSetUniformBuffers;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxDescriptorSetUniformBuffersDynamic) maxDescriptorSetUniformBuffersDynamic(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxDescriptorSetUniformBuffersDynamic;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxDescriptorSetStorageBuffers) maxDescriptorSetStorageBuffers(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxDescriptorSetStorageBuffers;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxDescriptorSetStorageBuffersDynamic) maxDescriptorSetStorageBuffersDynamic(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxDescriptorSetStorageBuffersDynamic;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxDescriptorSetSampledImages) maxDescriptorSetSampledImages(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxDescriptorSetSampledImages;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxDescriptorSetStorageImages) maxDescriptorSetStorageImages(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxDescriptorSetStorageImages;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxDescriptorSetInputAttachments) maxDescriptorSetInputAttachments(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxDescriptorSetInputAttachments;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxVertexInputAttributes) maxVertexInputAttributes(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxVertexInputAttributes;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxVertexInputBindings) maxVertexInputBindings(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxVertexInputBindings;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxVertexInputAttributeOffset) maxVertexInputAttributeOffset(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxVertexInputAttributeOffset;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxVertexInputBindingStride) maxVertexInputBindingStride(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxVertexInputBindingStride;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxVertexOutputComponents) maxVertexOutputComponents(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxVertexOutputComponents;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxTessellationGenerationLevel) maxTessellationGenerationLevel(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxTessellationGenerationLevel;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxTessellationPatchSize) maxTessellationPatchSize(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxTessellationPatchSize;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxTessellationControlPerVertexInputComponents) maxTessellationControlPerVertexInputComponents(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxTessellationControlPerVertexInputComponents;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxTessellationControlPerVertexOutputComponents) maxTessellationControlPerVertexOutputComponents(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxTessellationControlPerVertexOutputComponents;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxTessellationControlPerPatchOutputComponents) maxTessellationControlPerPatchOutputComponents(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxTessellationControlPerPatchOutputComponents;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxTessellationControlTotalOutputComponents) maxTessellationControlTotalOutputComponents(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxTessellationControlTotalOutputComponents;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxTessellationEvaluationInputComponents) maxTessellationEvaluationInputComponents(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxTessellationEvaluationInputComponents;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxTessellationEvaluationOutputComponents) maxTessellationEvaluationOutputComponents(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxTessellationEvaluationOutputComponents;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxGeometryShaderInvocations) maxGeometryShaderInvocations(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxGeometryShaderInvocations;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxGeometryInputComponents) maxGeometryInputComponents(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxGeometryInputComponents;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxGeometryOutputComponents) maxGeometryOutputComponents(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxGeometryOutputComponents;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxGeometryOutputVertices) maxGeometryOutputVertices(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxGeometryOutputVertices;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxGeometryTotalOutputComponents) maxGeometryTotalOutputComponents(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxGeometryTotalOutputComponents;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxFragmentInputComponents) maxFragmentInputComponents(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxFragmentInputComponents;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxFragmentOutputAttachments) maxFragmentOutputAttachments(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxFragmentOutputAttachments;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxFragmentDualSrcAttachments) maxFragmentDualSrcAttachments(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxFragmentDualSrcAttachments;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxFragmentCombinedOutputResources) maxFragmentCombinedOutputResources(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxFragmentCombinedOutputResources;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxComputeSharedMemorySize) maxComputeSharedMemorySize(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxComputeSharedMemorySize;
  }

  static const decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxComputeWorkGroupCount)& maxComputeWorkGroupCount(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxComputeWorkGroupCount;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxComputeWorkGroupInvocations) maxComputeWorkGroupInvocations(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxComputeWorkGroupInvocations;
  }

  static const decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxComputeWorkGroupSize)& maxComputeWorkGroupSize(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxComputeWorkGroupSize;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::subPixelPrecisionBits) subPixelPrecisionBits(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->subPixelPrecisionBits;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::subTexelPrecisionBits) subTexelPrecisionBits(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->subTexelPrecisionBits;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::mipmapPrecisionBits) mipmapPrecisionBits(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->mipmapPrecisionBits;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxDrawIndexedIndexValue) maxDrawIndexedIndexValue(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxDrawIndexedIndexValue;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxDrawIndirectCount) maxDrawIndirectCount(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxDrawIndirectCount;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxSamplerLodBias) maxSamplerLodBias(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxSamplerLodBias;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxSamplerAnisotropy) maxSamplerAnisotropy(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxSamplerAnisotropy;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxViewports) maxViewports(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxViewports;
  }

  static const decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxViewportDimensions)& maxViewportDimensions(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxViewportDimensions;
  }

  static const decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::viewportBoundsRange)& viewportBoundsRange(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->viewportBoundsRange;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::viewportSubPixelBits) viewportSubPixelBits(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->viewportSubPixelBits;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::minMemoryMapAlignment) minMemoryMapAlignment(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->minMemoryMapAlignment;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::minTexelBufferOffsetAlignment) minTexelBufferOffsetAlignment(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->minTexelBufferOffsetAlignment;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::minUniformBufferOffsetAlignment) minUniformBufferOffsetAlignment(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->minUniformBufferOffsetAlignment;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::minStorageBufferOffsetAlignment) minStorageBufferOffsetAlignment(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->minStorageBufferOffsetAlignment;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::minTexelOffset) minTexelOffset(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->minTexelOffset;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxTexelOffset) maxTexelOffset(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxTexelOffset;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::minTexelGatherOffset) minTexelGatherOffset(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->minTexelGatherOffset;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxTexelGatherOffset) maxTexelGatherOffset(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxTexelGatherOffset;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::minInterpolationOffset) minInterpolationOffset(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->minInterpolationOffset;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxInterpolationOffset) maxInterpolationOffset(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxInterpolationOffset;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::subPixelInterpolationOffsetBits) subPixelInterpolationOffsetBits(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->subPixelInterpolationOffsetBits;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxFramebufferWidth) maxFramebufferWidth(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxFramebufferWidth;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxFramebufferHeight) maxFramebufferHeight(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxFramebufferHeight;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxFramebufferLayers) maxFramebufferLayers(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxFramebufferLayers;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::framebufferColorSampleCounts) framebufferColorSampleCounts(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->framebufferColorSampleCounts;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::framebufferDepthSampleCounts) framebufferDepthSampleCounts(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->framebufferDepthSampleCounts;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::framebufferStencilSampleCounts) framebufferStencilSampleCounts(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->framebufferStencilSampleCounts;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::framebufferNoAttachmentsSampleCounts) framebufferNoAttachmentsSampleCounts(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->framebufferNoAttachmentsSampleCounts;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxColorAttachments) maxColorAttachments(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxColorAttachments;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::sampledImageColorSampleCounts) sampledImageColorSampleCounts(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->sampledImageColorSampleCounts;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::sampledImageIntegerSampleCounts) sampledImageIntegerSampleCounts(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->sampledImageIntegerSampleCounts;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::sampledImageDepthSampleCounts) sampledImageDepthSampleCounts(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->sampledImageDepthSampleCounts;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::sampledImageStencilSampleCounts) sampledImageStencilSampleCounts(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->sampledImageStencilSampleCounts;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::storageImageSampleCounts) storageImageSampleCounts(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->storageImageSampleCounts;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxSampleMaskWords) maxSampleMaskWords(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxSampleMaskWords;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::timestampComputeAndGraphics) timestampComputeAndGraphics(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->timestampComputeAndGraphics;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::timestampPeriod) timestampPeriod(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->timestampPeriod;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxClipDistances) maxClipDistances(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxClipDistances;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxCullDistances) maxCullDistances(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxCullDistances;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::maxCombinedClipAndCullDistances) maxCombinedClipAndCullDistances(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->maxCombinedClipAndCullDistances;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::discreteQueuePriorities) discreteQueuePriorities(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->discreteQueuePriorities;
  }

  static const decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::pointSizeRange)& pointSizeRange(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->pointSizeRange;
  }

  static const decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::lineWidthRange)& lineWidthRange(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->lineWidthRange;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::pointSizeGranularity) pointSizeGranularity(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->pointSizeGranularity;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::lineWidthGranularity) lineWidthGranularity(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->lineWidthGranularity;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::strictLines) strictLines(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->strictLines;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::standardSampleLocations) standardSampleLocations(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->standardSampleLocations;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::optimalBufferCopyOffsetAlignment) optimalBufferCopyOffsetAlignment(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->optimalBufferCopyOffsetAlignment;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::optimalBufferCopyRowPitchAlignment) optimalBufferCopyRowPitchAlignment(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->optimalBufferCopyRowPitchAlignment;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceLimits::nonCoherentAtomSize) nonCoherentAtomSize(
      const ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr& input) {
    return input->nonCoherentAtomSize;
  }

  static bool Read(::gpu::mojom::blink::VkPhysicalDeviceLimits::DataView input, ::gpu::mojom::blink::VkPhysicalDeviceLimitsPtr* output);
};
...
struct  StructTraits<::gpu::mojom::blink::VkPhysicalDeviceSparseProperties::DataView,
  ...
  static bool IsNull(const ::gpu::mojom::blink::VkPhysicalDeviceSparsePropertiesPtr& input) { return !input; }
  static void SetToNull(::gpu::mojom::blink::VkPhysicalDeviceSparsePropertiesPtr* output) { output->reset(); }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceSparseProperties::residencyStandard2DBlockShape) residencyStandard2DBlockShape(
      const ::gpu::mojom::blink::VkPhysicalDeviceSparsePropertiesPtr& input) {
    return input->residencyStandard2DBlockShape;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceSparseProperties::residencyStandard2DMultisampleBlockShape) residencyStandard2DMultisampleBlockShape(
      const ::gpu::mojom::blink::VkPhysicalDeviceSparsePropertiesPtr& input) {
    return input->residencyStandard2DMultisampleBlockShape;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceSparseProperties::residencyStandard3DBlockShape) residencyStandard3DBlockShape(
      const ::gpu::mojom::blink::VkPhysicalDeviceSparsePropertiesPtr& input) {
    return input->residencyStandard3DBlockShape;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceSparseProperties::residencyAlignedMipSize) residencyAlignedMipSize(
      const ::gpu::mojom::blink::VkPhysicalDeviceSparsePropertiesPtr& input) {
    return input->residencyAlignedMipSize;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceSparseProperties::residencyNonResidentStrict) residencyNonResidentStrict(
      const ::gpu::mojom::blink::VkPhysicalDeviceSparsePropertiesPtr& input) {
    return input->residencyNonResidentStrict;
  }

  static bool Read(::gpu::mojom::blink::VkPhysicalDeviceSparseProperties::DataView input, ::gpu::mojom::blink::VkPhysicalDeviceSparsePropertiesPtr* output);
};
...
struct  StructTraits<::gpu::mojom::blink::VkPhysicalDeviceProperties::DataView,
  ...
  static bool IsNull(const ::gpu::mojom::blink::VkPhysicalDevicePropertiesPtr& input) { return !input; }
  static void SetToNull(::gpu::mojom::blink::VkPhysicalDevicePropertiesPtr* output) { output->reset(); }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceProperties::apiVersion) apiVersion(
      const ::gpu::mojom::blink::VkPhysicalDevicePropertiesPtr& input) {
    return input->apiVersion;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceProperties::driverVersion) driverVersion(
      const ::gpu::mojom::blink::VkPhysicalDevicePropertiesPtr& input) {
    return input->driverVersion;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceProperties::vendorID) vendorID(
      const ::gpu::mojom::blink::VkPhysicalDevicePropertiesPtr& input) {
    return input->vendorID;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceProperties::deviceID) deviceID(
      const ::gpu::mojom::blink::VkPhysicalDevicePropertiesPtr& input) {
    return input->deviceID;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceProperties::deviceType) deviceType(
      const ::gpu::mojom::blink::VkPhysicalDevicePropertiesPtr& input) {
    return input->deviceType;
  }

  static const decltype(::gpu::mojom::blink::VkPhysicalDeviceProperties::deviceName)& deviceName(
      const ::gpu::mojom::blink::VkPhysicalDevicePropertiesPtr& input) {
    return input->deviceName;
  }

  static const decltype(::gpu::mojom::blink::VkPhysicalDeviceProperties::pipelineCacheUUID)& pipelineCacheUUID(
      const ::gpu::mojom::blink::VkPhysicalDevicePropertiesPtr& input) {
    return input->pipelineCacheUUID;
  }

  static const decltype(::gpu::mojom::blink::VkPhysicalDeviceProperties::limits)& limits(
      const ::gpu::mojom::blink::VkPhysicalDevicePropertiesPtr& input) {
    return input->limits;
  }

  static const decltype(::gpu::mojom::blink::VkPhysicalDeviceProperties::sparseProperties)& sparseProperties(
      const ::gpu::mojom::blink::VkPhysicalDevicePropertiesPtr& input) {
    return input->sparseProperties;
  }

  static bool Read(::gpu::mojom::blink::VkPhysicalDeviceProperties::DataView input, ::gpu::mojom::blink::VkPhysicalDevicePropertiesPtr* output);
};
...
struct  StructTraits<::gpu::mojom::blink::VkPhysicalDeviceFeatures::DataView,
  ...
  static bool IsNull(const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) { return !input; }
  static void SetToNull(::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr* output) { output->reset(); }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::robustBufferAccess) robustBufferAccess(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->robustBufferAccess;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::fullDrawIndexUint32) fullDrawIndexUint32(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->fullDrawIndexUint32;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::imageCubeArray) imageCubeArray(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->imageCubeArray;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::independentBlend) independentBlend(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->independentBlend;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::geometryShader) geometryShader(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->geometryShader;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::tessellationShader) tessellationShader(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->tessellationShader;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::sampleRateShading) sampleRateShading(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->sampleRateShading;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::dualSrcBlend) dualSrcBlend(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->dualSrcBlend;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::logicOp) logicOp(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->logicOp;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::multiDrawIndirect) multiDrawIndirect(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->multiDrawIndirect;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::drawIndirectFirstInstance) drawIndirectFirstInstance(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->drawIndirectFirstInstance;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::depthClamp) depthClamp(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->depthClamp;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::depthBiasClamp) depthBiasClamp(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->depthBiasClamp;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::fillModeNonSolid) fillModeNonSolid(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->fillModeNonSolid;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::depthBounds) depthBounds(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->depthBounds;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::wideLines) wideLines(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->wideLines;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::largePoints) largePoints(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->largePoints;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::alphaToOne) alphaToOne(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->alphaToOne;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::multiViewport) multiViewport(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->multiViewport;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::samplerAnisotropy) samplerAnisotropy(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->samplerAnisotropy;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::textureCompressionETC2) textureCompressionETC2(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->textureCompressionETC2;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::textureCompressionASTC_LDR) textureCompressionASTC_LDR(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->textureCompressionASTC_LDR;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::textureCompressionBC) textureCompressionBC(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->textureCompressionBC;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::occlusionQueryPrecise) occlusionQueryPrecise(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->occlusionQueryPrecise;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::pipelineStatisticsQuery) pipelineStatisticsQuery(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->pipelineStatisticsQuery;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::vertexPipelineStoresAndAtomics) vertexPipelineStoresAndAtomics(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->vertexPipelineStoresAndAtomics;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::fragmentStoresAndAtomics) fragmentStoresAndAtomics(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->fragmentStoresAndAtomics;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::shaderTessellationAndGeometryPointSize) shaderTessellationAndGeometryPointSize(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->shaderTessellationAndGeometryPointSize;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::shaderImageGatherExtended) shaderImageGatherExtended(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->shaderImageGatherExtended;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::shaderStorageImageExtendedFormats) shaderStorageImageExtendedFormats(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->shaderStorageImageExtendedFormats;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::shaderStorageImageMultisample) shaderStorageImageMultisample(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->shaderStorageImageMultisample;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::shaderStorageImageReadWithoutFormat) shaderStorageImageReadWithoutFormat(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->shaderStorageImageReadWithoutFormat;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::shaderStorageImageWriteWithoutFormat) shaderStorageImageWriteWithoutFormat(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->shaderStorageImageWriteWithoutFormat;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::shaderUniformBufferArrayDynamicIndexing) shaderUniformBufferArrayDynamicIndexing(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->shaderUniformBufferArrayDynamicIndexing;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::shaderSampledImageArrayDynamicIndexing) shaderSampledImageArrayDynamicIndexing(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->shaderSampledImageArrayDynamicIndexing;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::shaderStorageBufferArrayDynamicIndexing) shaderStorageBufferArrayDynamicIndexing(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->shaderStorageBufferArrayDynamicIndexing;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::shaderStorageImageArrayDynamicIndexing) shaderStorageImageArrayDynamicIndexing(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->shaderStorageImageArrayDynamicIndexing;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::shaderClipDistance) shaderClipDistance(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->shaderClipDistance;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::shaderCullDistance) shaderCullDistance(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->shaderCullDistance;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::shaderFloat64) shaderFloat64(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->shaderFloat64;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::shaderInt64) shaderInt64(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->shaderInt64;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::shaderInt16) shaderInt16(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->shaderInt16;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::shaderResourceResidency) shaderResourceResidency(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->shaderResourceResidency;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::shaderResourceMinLod) shaderResourceMinLod(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->shaderResourceMinLod;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::sparseBinding) sparseBinding(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->sparseBinding;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::sparseResidencyBuffer) sparseResidencyBuffer(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->sparseResidencyBuffer;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::sparseResidencyImage2D) sparseResidencyImage2D(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->sparseResidencyImage2D;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::sparseResidencyImage3D) sparseResidencyImage3D(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->sparseResidencyImage3D;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::sparseResidency2Samples) sparseResidency2Samples(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->sparseResidency2Samples;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::sparseResidency4Samples) sparseResidency4Samples(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->sparseResidency4Samples;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::sparseResidency8Samples) sparseResidency8Samples(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->sparseResidency8Samples;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::sparseResidency16Samples) sparseResidency16Samples(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->sparseResidency16Samples;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::sparseResidencyAliased) sparseResidencyAliased(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->sparseResidencyAliased;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::variableMultisampleRate) variableMultisampleRate(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->variableMultisampleRate;
  }

  static decltype(::gpu::mojom::blink::VkPhysicalDeviceFeatures::inheritedQueries) inheritedQueries(
      const ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr& input) {
    return input->inheritedQueries;
  }

  static bool Read(::gpu::mojom::blink::VkPhysicalDeviceFeatures::DataView input, ::gpu::mojom::blink::VkPhysicalDeviceFeaturesPtr* output);
};
...
struct  StructTraits<::gpu::mojom::blink::VkExtent3D::DataView,
  ...
  static bool IsNull(const ::gpu::mojom::blink::VkExtent3DPtr& input) { return !input; }
  static void SetToNull(::gpu::mojom::blink::VkExtent3DPtr* output) { output->reset(); }

  static decltype(::gpu::mojom::blink::VkExtent3D::width) width(
      const ::gpu::mojom::blink::VkExtent3DPtr& input) {
    return input->width;
  }

  static decltype(::gpu::mojom::blink::VkExtent3D::height) height(
      const ::gpu::mojom::blink::VkExtent3DPtr& input) {
    return input->height;
  }

  static decltype(::gpu::mojom::blink::VkExtent3D::depth) depth(
      const ::gpu::mojom::blink::VkExtent3DPtr& input) {
    return input->depth;
  }

  static bool Read(::gpu::mojom::blink::VkExtent3D::DataView input, ::gpu::mojom::blink::VkExtent3DPtr* output);
};
...
struct  StructTraits<::gpu::mojom::blink::VkQueueFamilyProperties::DataView,
  ...
  static bool IsNull(const ::gpu::mojom::blink::VkQueueFamilyPropertiesPtr& input) { return !input; }
  static void SetToNull(::gpu::mojom::blink::VkQueueFamilyPropertiesPtr* output) { output->reset(); }

  static decltype(::gpu::mojom::blink::VkQueueFamilyProperties::queueFlags) queueFlags(
      const ::gpu::mojom::blink::VkQueueFamilyPropertiesPtr& input) {
    return input->queueFlags;
  }

  static decltype(::gpu::mojom::blink::VkQueueFamilyProperties::queueCount) queueCount(
      const ::gpu::mojom::blink::VkQueueFamilyPropertiesPtr& input) {
    return input->queueCount;
  }

  static decltype(::gpu::mojom::blink::VkQueueFamilyProperties::timestampValidBits) timestampValidBits(
      const ::gpu::mojom::blink::VkQueueFamilyPropertiesPtr& input) {
    return input->timestampValidBits;
  }

  static const decltype(::gpu::mojom::blink::VkQueueFamilyProperties::minImageTransferGranularity)& minImageTransferGranularity(
      const ::gpu::mojom::blink::VkQueueFamilyPropertiesPtr& input) {
    return input->minImageTransferGranularity;
  }

  static bool Read(::gpu::mojom::blink::VkQueueFamilyProperties::DataView input, ::gpu::mojom::blink::VkQueueFamilyPropertiesPtr* output);
};
