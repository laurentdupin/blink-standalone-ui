// gpu/ipc/common/capabilities.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "gpu/ipc/common/capabilities.mojom-test-utils.h"
...
Capabilities::Capabilities(
    ...
    const base::flat_map<uint32_t, std::vector<uint64_t>>& drm_formats_and_modifiers_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type const base::flat_map<uint32_t, std::vector<uint64_t>>&>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
size_t ShaderPrecision::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->min_range);
  seed = mojo::internal::Hash(seed, this->max_range);
  seed = mojo::internal::Hash(seed, this->precision);
  return seed;
}
...
size_t PerStagePrecisions::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->low_int);
  seed = mojo::internal::Hash(seed, this->medium_int);
  seed = mojo::internal::Hash(seed, this->high_int);
  seed = mojo::internal::Hash(seed, this->low_float);
  seed = mojo::internal::Hash(seed, this->medium_float);
  seed = mojo::internal::Hash(seed, this->high_float);
  return seed;
}
...
// static
bool StructTraits<::gpu::mojom::Capabilities::DataView, ::gpu::mojom::CapabilitiesPtr>::Read(
    ::gpu::mojom::Capabilities::DataView input,
    ::gpu::mojom::CapabilitiesPtr* output) {
  bool success = true;
  ::gpu::mojom::CapabilitiesPtr result(::gpu::mojom::Capabilities::New());
...
// static
bool StructTraits<::gpu::mojom::ShaderPrecision::DataView, ::gpu::mojom::ShaderPrecisionPtr>::Read(
    ::gpu::mojom::ShaderPrecision::DataView input,
    ::gpu::mojom::ShaderPrecisionPtr* output) {
  bool success = true;
  ::gpu::mojom::ShaderPrecisionPtr result(::gpu::mojom::ShaderPrecision::New());
...
// static
bool StructTraits<::gpu::mojom::PerStagePrecisions::DataView, ::gpu::mojom::PerStagePrecisionsPtr>::Read(
    ::gpu::mojom::PerStagePrecisions::DataView input,
    ::gpu::mojom::PerStagePrecisionsPtr* output) {
  bool success = true;
  ::gpu::mojom::PerStagePrecisionsPtr result(::gpu::mojom::PerStagePrecisions::New());
...
// static
bool StructTraits<::gpu::mojom::GLCapabilities::DataView, ::gpu::mojom::GLCapabilitiesPtr>::Read(
    ::gpu::mojom::GLCapabilities::DataView input,
    ::gpu::mojom::GLCapabilitiesPtr* output) {
  bool success = true;
  ::gpu::mojom::GLCapabilitiesPtr result(::gpu::mojom::GLCapabilities::New());
