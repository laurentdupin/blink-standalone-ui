 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VideoMemoryProcessStats::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
class  VideoMemoryUsageStats {
 public:
  ...
  VideoMemoryUsageStats(
      base::flat_map<int32_t, VideoMemoryProcessStatsPtr> process_map,
...
VideoMemoryUsageStats& operator=(const VideoMemoryUsageStats&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VideoMemoryUsageStats::DataView, std::vector<uint8_t>, send_validation>(input);
  }
