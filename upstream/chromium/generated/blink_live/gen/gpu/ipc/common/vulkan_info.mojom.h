...
class  VulkanPhysicalDeviceInfo {
 public:
  ...
  VulkanPhysicalDeviceInfo(
      ::gpu::mojom::VkPhysicalDevicePropertiesPtr properties,
      std::vector<::gpu::mojom::VkExtensionPropertiesPtr> extensions,
      ::gpu::mojom::VkPhysicalDeviceFeaturesPtr features,
      bool feature_sampler_ycbcr_conversion,
      bool feature_protected_memory,
      std::vector<::gpu::mojom::VkQueueFamilyPropertiesPtr> queue_families);
...
class  VulkanInfo {
 public:
  ...
  VulkanInfo(
      ...
      std::vector<::gpu::mojom::VkExtensionPropertiesPtr> instance_extensions,
      std::vector<std::string> enabled_instance_extensions,
      std::vector<::gpu::mojom::VkLayerPropertiesPtr> instance_layers,
      std::vector<VulkanPhysicalDeviceInfoPtr> physical_devices);
