...
class  SharedImageCapabilities {
 public:
  ...
  SharedImageCapabilities(
      ...
      bool supports_ycbcr_nv12_sampling,
      bool supports_ycbcr_p010_sampling,
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SharedImageCapabilities::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SharedImageCapabilities::DataView, std::vector<uint8_t>>(input);
  }
...
SharedImageCapabilitiesPtr SharedImageCapabilities::Clone() const {
  return New(
      ...
      mojo::Clone(supports_scanout_shared_images_for_software_video_frames),
      mojo::Clone(supports_luminance_shared_images),
      mojo::Clone(supports_r16_shared_images),
      mojo::Clone(supports_ycbcr_nv12_sampling),
      mojo::Clone(supports_ycbcr_p010_sampling),
...
bool SharedImageCapabilities::Equals(const T& other_struct) const {
  ...
  if (!mojo::Equals(this->supports_r16_shared_images, other_struct.supports_r16_shared_images))
    return false;
  if (!mojo::Equals(this->supports_ycbcr_nv12_sampling, other_struct.supports_ycbcr_nv12_sampling))
    return false;
  if (!mojo::Equals(this->supports_ycbcr_p010_sampling, other_struct.supports_ycbcr_p010_sampling))
    return false;
...
bool operator<(const T& lhs, const T& rhs) {
  ...
  if (rhs.supports_r16_shared_images < lhs.supports_r16_shared_images)
    return false;
  if (lhs.supports_ycbcr_nv12_sampling < rhs.supports_ycbcr_nv12_sampling)
    return true;
  if (rhs.supports_ycbcr_nv12_sampling < lhs.supports_ycbcr_nv12_sampling)
    return false;
  if (lhs.supports_ycbcr_p010_sampling < rhs.supports_ycbcr_p010_sampling)
    return true;
  if (rhs.supports_ycbcr_p010_sampling < lhs.supports_ycbcr_p010_sampling)
    return false;
...
template <>
struct  StructTraits<::gpu::mojom::SharedImageCapabilities::DataView,
                                         ::gpu::mojom::SharedImageCapabilitiesPtr> {
  static bool IsNull(const ::gpu::mojom::SharedImageCapabilitiesPtr& input) { return !input; }
  static void SetToNull(::gpu::mojom::SharedImageCapabilitiesPtr* output) { output->reset(); }
  ...
  static decltype(::gpu::mojom::SharedImageCapabilities::supports_scanout_shared_images_for_software_video_frames) supports_scanout_shared_images_for_software_video_frames(
      const ::gpu::mojom::SharedImageCapabilitiesPtr& input) {
  ...
  static decltype(::gpu::mojom::SharedImageCapabilities::supports_ycbcr_nv12_sampling) supports_ycbcr_nv12_sampling(
      const ::gpu::mojom::SharedImageCapabilitiesPtr& input) {
    return input->supports_ycbcr_nv12_sampling;
  }

  static decltype(::gpu::mojom::SharedImageCapabilities::supports_ycbcr_p010_sampling) supports_ycbcr_p010_sampling(
      const ::gpu::mojom::SharedImageCapabilitiesPtr& input) {
    return input->supports_ycbcr_p010_sampling;
  }

  static decltype(::gpu::mojom::SharedImageCapabilities::is_r16f_supported) is_r16f_supported(
      const ::gpu::mojom::SharedImageCapabilitiesPtr& input) {
  ...
  static decltype(::gpu::mojom::SharedImageCapabilities::disable_one_component_textures) disable_one_component_textures(
      const ::gpu::mojom::SharedImageCapabilitiesPtr& input) {
