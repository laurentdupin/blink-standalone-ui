...
size_t VkExtensionProperties::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->extensionName);
  seed = mojo::internal::Hash(seed, this->specVersion);
  return seed;
}
...
size_t VkLayerProperties::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->layerName);
  seed = mojo::internal::Hash(seed, this->specVersion);
  seed = mojo::internal::Hash(seed, this->implementationVersion);
...
size_t VkPhysicalDeviceSparseProperties::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->residencyStandard2DBlockShape);
  seed = mojo::internal::Hash(seed, this->residencyStandard2DMultisampleBlockShape);
  seed = mojo::internal::Hash(seed, this->residencyStandard3DBlockShape);
  seed = mojo::internal::Hash(seed, this->residencyAlignedMipSize);
  seed = mojo::internal::Hash(seed, this->residencyNonResidentStrict);
  return seed;
}
...
size_t VkPhysicalDeviceFeatures::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->robustBufferAccess);
  seed = mojo::internal::Hash(seed, this->fullDrawIndexUint32);
  seed = mojo::internal::Hash(seed, this->imageCubeArray);
  seed = mojo::internal::Hash(seed, this->independentBlend);
  seed = mojo::internal::Hash(seed, this->geometryShader);
  seed = mojo::internal::Hash(seed, this->tessellationShader);
  seed = mojo::internal::Hash(seed, this->sampleRateShading);
  seed = mojo::internal::Hash(seed, this->dualSrcBlend);
  seed = mojo::internal::Hash(seed, this->logicOp);
  seed = mojo::internal::Hash(seed, this->multiDrawIndirect);
  seed = mojo::internal::Hash(seed, this->drawIndirectFirstInstance);
  seed = mojo::internal::Hash(seed, this->depthClamp);
  seed = mojo::internal::Hash(seed, this->depthBiasClamp);
  seed = mojo::internal::Hash(seed, this->fillModeNonSolid);
  seed = mojo::internal::Hash(seed, this->depthBounds);
  seed = mojo::internal::Hash(seed, this->wideLines);
  seed = mojo::internal::Hash(seed, this->largePoints);
  seed = mojo::internal::Hash(seed, this->alphaToOne);
  seed = mojo::internal::Hash(seed, this->multiViewport);
  seed = mojo::internal::Hash(seed, this->samplerAnisotropy);
  seed = mojo::internal::Hash(seed, this->textureCompressionETC2);
  seed = mojo::internal::Hash(seed, this->textureCompressionASTC_LDR);
  seed = mojo::internal::Hash(seed, this->textureCompressionBC);
  seed = mojo::internal::Hash(seed, this->occlusionQueryPrecise);
  seed = mojo::internal::Hash(seed, this->pipelineStatisticsQuery);
  seed = mojo::internal::Hash(seed, this->vertexPipelineStoresAndAtomics);
  seed = mojo::internal::Hash(seed, this->fragmentStoresAndAtomics);
  seed = mojo::internal::Hash(seed, this->shaderTessellationAndGeometryPointSize);
  seed = mojo::internal::Hash(seed, this->shaderImageGatherExtended);
  seed = mojo::internal::Hash(seed, this->shaderStorageImageExtendedFormats);
  seed = mojo::internal::Hash(seed, this->shaderStorageImageMultisample);
  seed = mojo::internal::Hash(seed, this->shaderStorageImageReadWithoutFormat);
  seed = mojo::internal::Hash(seed, this->shaderStorageImageWriteWithoutFormat);
  seed = mojo::internal::Hash(seed, this->shaderUniformBufferArrayDynamicIndexing);
  seed = mojo::internal::Hash(seed, this->shaderSampledImageArrayDynamicIndexing);
  seed = mojo::internal::Hash(seed, this->shaderStorageBufferArrayDynamicIndexing);
  seed = mojo::internal::Hash(seed, this->shaderStorageImageArrayDynamicIndexing);
  seed = mojo::internal::Hash(seed, this->shaderClipDistance);
  seed = mojo::internal::Hash(seed, this->shaderCullDistance);
  seed = mojo::internal::Hash(seed, this->shaderFloat64);
  seed = mojo::internal::Hash(seed, this->shaderInt64);
  seed = mojo::internal::Hash(seed, this->shaderInt16);
  seed = mojo::internal::Hash(seed, this->shaderResourceResidency);
  seed = mojo::internal::Hash(seed, this->shaderResourceMinLod);
  seed = mojo::internal::Hash(seed, this->sparseBinding);
  seed = mojo::internal::Hash(seed, this->sparseResidencyBuffer);
  seed = mojo::internal::Hash(seed, this->sparseResidencyImage2D);
  seed = mojo::internal::Hash(seed, this->sparseResidencyImage3D);
  seed = mojo::internal::Hash(seed, this->sparseResidency2Samples);
  seed = mojo::internal::Hash(seed, this->sparseResidency4Samples);
  seed = mojo::internal::Hash(seed, this->sparseResidency8Samples);
  seed = mojo::internal::Hash(seed, this->sparseResidency16Samples);
  seed = mojo::internal::Hash(seed, this->sparseResidencyAliased);
  seed = mojo::internal::Hash(seed, this->variableMultisampleRate);
  seed = mojo::internal::Hash(seed, this->inheritedQueries);
  return seed;
}
...
size_t VkExtent3D::Hash(size_t seed) const {
  ...
  seed = mojo::internal::Hash(seed, this->depth);
  return seed;
}
...
size_t VkQueueFamilyProperties::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->queueFlags);
  seed = mojo::internal::Hash(seed, this->queueCount);
  seed = mojo::internal::Hash(seed, this->timestampValidBits);
  seed = mojo::internal::Hash(seed, this->minImageTransferGranularity);
  return seed;
}
