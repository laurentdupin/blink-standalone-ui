...
DevicePerfInfoPtr DevicePerfInfo::Clone() const {
  return New(
      ...
      mojo::Clone(system_commit_limit_mb),
      mojo::Clone(d3d11_feature_level),
      mojo::Clone(has_discrete_gpu)
  );
}
...
template <>
struct  StructTraits<::gpu::mojom::DevicePerfInfo::DataView,
  ...
  static decltype(::gpu::mojom::DevicePerfInfo::system_commit_limit_mb) system_commit_limit_mb(
      const ::gpu::mojom::DevicePerfInfoPtr& input) {
    return input->system_commit_limit_mb;
  }

  static decltype(::gpu::mojom::DevicePerfInfo::d3d11_feature_level) d3d11_feature_level(
      const ::gpu::mojom::DevicePerfInfoPtr& input) {
    return input->d3d11_feature_level;
  }

  static decltype(::gpu::mojom::DevicePerfInfo::has_discrete_gpu) has_discrete_gpu(
      const ::gpu::mojom::DevicePerfInfoPtr& input) {
