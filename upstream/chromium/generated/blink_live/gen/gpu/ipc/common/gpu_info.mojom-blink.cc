...
GpuDevice::GpuDevice(
    ...
    uint32_t sub_sys_id_in,
    uint32_t revision_in,
    bool active_in,
    const ::blink::String& vendor_string_in,
    const ::blink::String& device_string_in,
    const ::blink::String& driver_vendor_in,
    const ::blink::String& driver_version_in,
    ::gpu::mojom::blink::LuidPtr luid_in,
...
size_t GpuDevice::Hash(size_t seed) const {
  ...
  seed = mojo::internal::WTFHash(seed, this->sub_sys_id);
  seed = mojo::internal::WTFHash(seed, this->revision);
  ...
  seed = mojo::internal::WTFHash(seed, this->luid);
...
void GpuDevice::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "luid"), this->luid,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::gpu::mojom::blink::LuidPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
VideoDecodeAcceleratorSupportedProfile::VideoDecodeAcceleratorSupportedProfile(
    ...
    ::gfx::mojom::blink::SizePtr max_resolution_in,
    ::gfx::mojom::blink::SizePtr min_resolution_in,
...
size_t VideoDecodeAcceleratorSupportedProfile::Hash(size_t seed) const {
  seed = mojo::internal::WTFHash(seed, this->profile);
  seed = mojo::internal::WTFHash(seed, this->max_resolution);
  seed = mojo::internal::WTFHash(seed, this->min_resolution);
  seed = mojo::internal::WTFHash(seed, this->encrypted_only);
  return seed;
}
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::gfx::mojom::blink::SizePtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
VideoDecodeAcceleratorCapabilities::VideoDecodeAcceleratorCapabilities(
    ::blink::Vector<VideoDecodeAcceleratorSupportedProfilePtr> supported_profiles_in,
    uint32_t flags_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<VideoDecodeAcceleratorSupportedProfilePtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
size_t VideoEncodeAcceleratorSupportedProfile::Hash(size_t seed) const {
  seed = mojo::internal::WTFHash(seed, this->profile);
  seed = mojo::internal::WTFHash(seed, this->min_resolution);
  seed = mojo::internal::WTFHash(seed, this->max_resolution);
  seed = mojo::internal::WTFHash(seed, this->max_framerate_numerator);
  seed = mojo::internal::WTFHash(seed, this->max_framerate_denominator);
  return seed;
}
...
OverlayInfo::OverlayInfo(
    ...
    OverlaySupport yuy2_overlay_support_in,
    OverlaySupport nv12_overlay_support_in,
    OverlaySupport bgra8_overlay_support_in,
    OverlaySupport rgb10a2_overlay_support_in,
    OverlaySupport p010_overlay_support_in)
...
void OverlayInfo::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "direct_composition"), this->direct_composition,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type bool>"
#else
      "<value>"
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "supports_overlays"), this->supports_overlays,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type bool>"
#else
      "<value>"
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "yuy2_overlay_support"), this->yuy2_overlay_support,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "nv12_overlay_support"), this->nv12_overlay_support,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type OverlaySupport>"
#else
      "<value>"
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "bgra8_overlay_support"), this->bgra8_overlay_support,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type OverlaySupport>"
#else
      "<value>"
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "rgb10a2_overlay_support"), this->rgb10a2_overlay_support,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type OverlaySupport>"
#else
      "<value>"
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "p010_overlay_support"), this->p010_overlay_support,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type OverlaySupport>"
#else
      "<value>"
...
GpuInfo::GpuInfo(
    ::mojo_base::mojom::blink::TimeDeltaPtr initialization_time_in,
    bool optimus_in,
    bool amd_switchable_in,
    GpuDevicePtr gpu_in,
    ::blink::Vector<GpuDevicePtr> secondary_gpus_in,
    ::blink::Vector<GpuDevicePtr> npus_in,
    const ::blink::String& pixel_shader_version_in,
    const ::blink::String& vertex_shader_version_in,
    const ::blink::String& max_msaa_samples_in,
    const ::blink::String& machine_model_name_in,
    const ::blink::String& machine_model_version_in,
    const ::blink::String& display_type_in,
    SkiaBackendType skia_backend_type_in,
    const ::blink::String& gl_version_in,
    const ::blink::String& gl_vendor_in,
    const ::blink::String& gl_renderer_in,
    const ::blink::String& gl_extensions_in,
    const ::blink::String& gl_ws_vendor_in,
    const ::blink::String& gl_ws_version_in,
    const ::blink::String& gl_ws_extensions_in,
    uint32_t gl_reset_notification_strategy_in,
    ::gl::mojom::blink::GLImplementationPartsPtr gl_implementation_parts_in,
    const ::blink::String& direct_rendering_version_in,
    bool sandboxed_in,
    bool in_process_gpu_in,
    bool passthrough_cmd_decoder_in,
    bool can_support_threaded_texture_mailbox_in,
    uint32_t directml_feature_level_in,
    uint32_t d3d12_feature_level_in,
    uint32_t vulkan_version_in,
    OverlayInfoPtr overlay_info_in,
    bool shared_image_d3d_in,
    ::blink::Vector<VideoDecodeAcceleratorSupportedProfilePtr> video_decode_accelerator_supported_profiles_in,
    ::blink::Vector<VideoEncodeAcceleratorSupportedProfilePtr> video_encode_accelerator_supported_profiles_in,
    bool jpeg_decode_accelerator_supported_in,
    bool subpixel_font_rendering_in,
    uint32_t visibility_callback_call_count_in,
    bool hardware_supports_vulkan_in,
...
void GpuInfo::WriteIntoTrace(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<GpuDevicePtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "directml_feature_level"), this->directml_feature_level,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type uint32_t>"
#else
      "<value>"
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "d3d12_feature_level"), this->d3d12_feature_level,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type uint32_t>"
#else
      "<value>"
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "vulkan_version"), this->vulkan_version,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type uint32_t>"
#else
      "<value>"
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "overlay_info"), this->overlay_info,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<VideoEncodeAcceleratorSupportedProfilePtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "hardware_supports_vulkan"), this->hardware_supports_vulkan,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type bool>"
#else
      "<value>"
...
bool StructTraits<::gpu::mojom::blink::OverlayInfo::DataView, ::gpu::mojom::blink::OverlayInfoPtr>::Read(
    ::gpu::mojom::blink::OverlayInfo::DataView input,
    ::gpu::mojom::blink::OverlayInfoPtr* output) {
  bool success = true;
