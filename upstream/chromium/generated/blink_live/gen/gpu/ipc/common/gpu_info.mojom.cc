...
size_t GpuDevice::Hash(size_t seed) const {
  ...
  seed = mojo::internal::Hash(seed, this->sub_sys_id);
  seed = mojo::internal::Hash(seed, this->revision);
  seed = mojo::internal::Hash(seed, this->active);
  seed = mojo::internal::Hash(seed, this->vendor_string);
  seed = mojo::internal::Hash(seed, this->device_string);
  seed = mojo::internal::Hash(seed, this->driver_vendor);
  seed = mojo::internal::Hash(seed, this->driver_version);
  seed = mojo::internal::Hash(seed, this->luid);
...
void GpuDevice::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "luid"), this->luid,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::gpu::mojom::LuidPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
VideoDecodeAcceleratorSupportedProfile::VideoDecodeAcceleratorSupportedProfile(
    ...
    ::gfx::mojom::SizePtr max_resolution_in,
    ::gfx::mojom::SizePtr min_resolution_in,
...
size_t VideoDecodeAcceleratorSupportedProfile::Hash(size_t seed) const {
  ...
  seed = mojo::internal::Hash(seed, this->max_resolution);
  seed = mojo::internal::Hash(seed, this->min_resolution);
  seed = mojo::internal::Hash(seed, this->encrypted_only);
  return seed;
}
...
VideoDecodeAcceleratorCapabilities::VideoDecodeAcceleratorCapabilities(
    std::vector<VideoDecodeAcceleratorSupportedProfilePtr> supported_profiles_in,
    uint32_t flags_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<VideoDecodeAcceleratorSupportedProfilePtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
size_t VideoEncodeAcceleratorSupportedProfile::Hash(size_t seed) const {
  ...
  seed = mojo::internal::Hash(seed, this->min_resolution);
  seed = mojo::internal::Hash(seed, this->max_resolution);
  seed = mojo::internal::Hash(seed, this->max_framerate_numerator);
  seed = mojo::internal::Hash(seed, this->max_framerate_denominator);
  return seed;
}
...
size_t OverlayInfo::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->direct_composition);
  seed = mojo::internal::Hash(seed, this->supports_overlays);
  seed = mojo::internal::Hash(seed, this->yuy2_overlay_support);
  seed = mojo::internal::Hash(seed, this->nv12_overlay_support);
  seed = mojo::internal::Hash(seed, this->bgra8_overlay_support);
  seed = mojo::internal::Hash(seed, this->rgb10a2_overlay_support);
  seed = mojo::internal::Hash(seed, this->p010_overlay_support);
  return seed;
}
...
GpuInfo::GpuInfo(
    ::mojo_base::mojom::TimeDeltaPtr initialization_time_in,
    bool optimus_in,
    bool amd_switchable_in,
    GpuDevicePtr gpu_in,
    std::vector<GpuDevicePtr> secondary_gpus_in,
    std::vector<GpuDevicePtr> npus_in,
    ...
    std::vector<VideoDecodeAcceleratorSupportedProfilePtr> video_decode_accelerator_supported_profiles_in,
    std::vector<VideoEncodeAcceleratorSupportedProfilePtr> video_encode_accelerator_supported_profiles_in,
    ...
    ::gpu::mojom::VulkanInfoPtr vulkan_info_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<GpuDevicePtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<VideoEncodeAcceleratorSupportedProfilePtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::gpu::mojom::VulkanInfoPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
bool StructTraits<::gpu::mojom::OverlayInfo::DataView, ::gpu::mojom::OverlayInfoPtr>::Read(
    ::gpu::mojom::OverlayInfo::DataView input,
    ::gpu::mojom::OverlayInfoPtr* output) {
  bool success = true;
