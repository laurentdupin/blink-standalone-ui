...
NOINLINE static const char* Direct3DFeatureLevelToStringHelper(Direct3DFeatureLevel value) {
  ...
  switch(value) {
    case Direct3DFeatureLevel::k1_0_Generic:
      return "k1_0_Generic";
...
bool DevicePerfInfo_Data::Validate(
  ...
  if (!::gpu::mojom::internal::Direct3DFeatureLevel_Data
        ::Validate(object->d3d11_feature_level, validation_context))
    return false;


  if (!::gpu::mojom::internal::HasDiscreteGpu_Data
        ::Validate(object->has_discrete_gpu, validation_context))
    return false;
