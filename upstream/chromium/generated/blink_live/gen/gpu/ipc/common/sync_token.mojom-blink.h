...
class BLINK_PLATFORM_EXPORT SyncToken {
 public:
  ...
  SyncToken(
      bool verified_flush,
      ::gpu::mojom::blink::CommandBufferNamespace namespace_id,
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SyncToken::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SyncToken::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::gpu::mojom::blink::SyncToken::DataView,
