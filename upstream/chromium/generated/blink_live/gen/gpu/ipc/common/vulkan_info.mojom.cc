...
VulkanPhysicalDeviceInfo::VulkanPhysicalDeviceInfo(
    ::gpu::mojom::VkPhysicalDevicePropertiesPtr properties_in,
    std::vector<::gpu::mojom::VkExtensionPropertiesPtr> extensions_in,
    ::gpu::mojom::VkPhysicalDeviceFeaturesPtr features_in,
    bool feature_sampler_ycbcr_conversion_in,
    bool feature_protected_memory_in,
    std::vector<::gpu::mojom::VkQueueFamilyPropertiesPtr> queue_families_in)
...
void VulkanPhysicalDeviceInfo::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      ...
      "<value of type ::gpu::mojom::VkPhysicalDevicePropertiesPtr>"
#else
      "<value>"
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<::gpu::mojom::VkExtensionPropertiesPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::gpu::mojom::VkPhysicalDeviceFeaturesPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<::gpu::mojom::VkQueueFamilyPropertiesPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
VulkanInfo::VulkanInfo(
    ...
    std::vector<::gpu::mojom::VkExtensionPropertiesPtr> instance_extensions_in,
    std::vector<std::string> enabled_instance_extensions_in,
    std::vector<::gpu::mojom::VkLayerPropertiesPtr> instance_layers_in,
    std::vector<VulkanPhysicalDeviceInfoPtr> physical_devices_in)
...
void VulkanInfo::WriteIntoTrace(
    perfetto::TracedValue traced_context) const {
  [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<::gpu::mojom::VkLayerPropertiesPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<VulkanPhysicalDeviceInfoPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
