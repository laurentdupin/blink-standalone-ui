...
#pragma pack(push, 1)
class GPU_EXPORT GpuPreferences_Data {
 public:
  ...
  mojo::internal::Pointer<mojo::internal::Array_Data<uint32_t>> ignored_gpu_blocklist_entries;
...
static_assert(sizeof(GpuPreferences_Data) == 80,
