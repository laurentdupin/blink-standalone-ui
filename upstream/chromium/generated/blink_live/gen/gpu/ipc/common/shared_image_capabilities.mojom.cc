...
SharedImageCapabilities::SharedImageCapabilities(
    ...
    bool supports_scanout_shared_images_for_software_video_frames_in,
    bool supports_luminance_shared_images_in,
    bool supports_r16_shared_images_in,
    bool supports_ycbcr_nv12_sampling_in,
    bool supports_ycbcr_p010_sampling_in,
    ...
    : supports_scanout_shared_images(std::move(supports_scanout_shared_images_in)),
      ...
      supports_ycbcr_nv12_sampling(std::move(supports_ycbcr_nv12_sampling_in)),
      supports_ycbcr_p010_sampling(std::move(supports_ycbcr_p010_sampling_in)),
...
size_t SharedImageCapabilities::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->supports_scanout_shared_images);
  seed = mojo::internal::Hash(seed, this->supports_scanout_shared_images_for_software_video_frames);
  seed = mojo::internal::Hash(seed, this->supports_luminance_shared_images);
  seed = mojo::internal::Hash(seed, this->supports_r16_shared_images);
  seed = mojo::internal::Hash(seed, this->supports_ycbcr_nv12_sampling);
  seed = mojo::internal::Hash(seed, this->supports_ycbcr_p010_sampling);
  seed = mojo::internal::Hash(seed, this->is_r16f_supported);
  seed = mojo::internal::Hash(seed, this->disable_r8_shared_images);
  seed = mojo::internal::Hash(seed, this->disable_webgpu_shared_images);
  seed = mojo::internal::Hash(seed, this->disable_one_component_textures);
  seed = mojo::internal::Hash(seed, this->shared_image_d3d);
  seed = mojo::internal::Hash(seed, this->shared_image_swap_chain);
  return seed;
}
...
void SharedImageCapabilities::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "supports_scanout_shared_images_for_software_video_frames"), this->supports_scanout_shared_images_for_software_video_frames,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type bool>"
#else
      "<value>"
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "supports_ycbcr_nv12_sampling"), this->supports_ycbcr_nv12_sampling,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type bool>"
#else
      "<value>"
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "supports_ycbcr_p010_sampling"), this->supports_ycbcr_p010_sampling,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type bool>"
#else
      "<value>"
...
bool StructTraits<::gpu::mojom::SharedImageCapabilities::DataView, ::gpu::mojom::SharedImageCapabilitiesPtr>::Read(
  ...
  ::gpu::mojom::SharedImageCapabilitiesPtr result(::gpu::mojom::SharedImageCapabilities::New());
      ...
      if (success)
        result->supports_ycbcr_nv12_sampling = input.supports_ycbcr_nv12_sampling();
      if (success)
        result->supports_ycbcr_p010_sampling = input.supports_ycbcr_p010_sampling();
      if (success)
