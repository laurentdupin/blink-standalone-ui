...
NOINLINE static const char* VideoCodecProfileToStringHelper(VideoCodecProfile value) {
  ...
  switch(value) {
    ...
    case VideoCodecProfile::DOLBYVISION_PROFILE10:
      return "DOLBYVISION_PROFILE10";
    case VideoCodecProfile::DOLBYVISION_PROFILE20:
      return "DOLBYVISION_PROFILE20";
    default:
      return nullptr;
  }
}
...
bool GpuDevice_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->vendor_string, 6, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->device_string, 7, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->driver_vendor, 8, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->driver_version, 9, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->luid, 10, validation_context)) {
    return false;
  }
...
// static
bool OverlayInfo_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const OverlayInfo_Data* object =
      static_cast<const OverlayInfo_Data*>(data);


  if (!::gpu::mojom::internal::OverlaySupport_Data
        ::Validate(object->yuy2_overlay_support, validation_context))
    return false;


  if (!::gpu::mojom::internal::OverlaySupport_Data
        ::Validate(object->nv12_overlay_support, validation_context))
    return false;


  if (!::gpu::mojom::internal::OverlaySupport_Data
        ::Validate(object->bgra8_overlay_support, validation_context))
    return false;


  if (!::gpu::mojom::internal::OverlaySupport_Data
        ::Validate(object->rgb10a2_overlay_support, validation_context))
    return false;


  if (!::gpu::mojom::internal::OverlaySupport_Data
        ::Validate(object->p010_overlay_support, validation_context))
    return false;
...
bool GpuInfo_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->overlay_info, 31, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->video_decode_accelerator_supported_profiles, 33, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->video_encode_accelerator_supported_profiles, 34, validation_context)) {
    return false;
  }
...
// static
void TraceFormatTraits<::gpu::mojom::OverlaySupport>::WriteIntoTrace(
   perfetto::TracedValue context, ::gpu::mojom::OverlaySupport value) {
