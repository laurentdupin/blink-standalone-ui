...
#include "gpu/ipc/common/gpu_disk_cache_type.mojom-data-view.h"  // IWYU pragma: export
...
struct Serializer<::gpu::mojom::GpuDiskCacheType, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::gpu::mojom::GpuDiskCacheType>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::gpu::mojom::GpuDiskCacheType, UserType> ||
                        HasInfallibleConversion(::gpu::mojom::GpuDiskCacheType()),
                    "::gpu::mojom::GpuDiskCacheType does not have an infallible conversion, "
...
template <>
struct  TraceFormatTraits<::gpu::mojom::GpuDiskCacheType> {
