...
size_t VulkanYCbCrInfo::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->image_format);
  seed = mojo::internal::Hash(seed, this->external_format);
  seed = mojo::internal::Hash(seed, this->suggested_ycbcr_model);
  seed = mojo::internal::Hash(seed, this->suggested_ycbcr_range);
  seed = mojo::internal::Hash(seed, this->suggested_xchroma_offset);
  seed = mojo::internal::Hash(seed, this->suggested_ychroma_offset);
  seed = mojo::internal::Hash(seed, this->format_features);
  return seed;
}
...
bool StructTraits<::gpu::mojom::VulkanYCbCrInfo::DataView, ::gpu::mojom::VulkanYCbCrInfoPtr>::Read(
    ::gpu::mojom::VulkanYCbCrInfo::DataView input,
    ::gpu::mojom::VulkanYCbCrInfoPtr* output) {
  bool success = true;
