...
size_t PatternParts::Hash(size_t seed) const {
  ...
  seed = mojo::internal::Hash(seed, this->is_scheme_wildcard);
  seed = mojo::internal::Hash(seed, this->host);
  seed = mojo::internal::Hash(seed, this->has_domain_wildcard);
  ...
  seed = mojo::internal::Hash(seed, this->is_path_wildcard);
  return seed;
}
...
size_t ContentSettingsPattern::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->parts);
  seed = mojo::internal::Hash(seed, this->is_valid);
  return seed;
}
...
RuleMetaData::RuleMetaData(
    ...
    bool autorevocation_bypassed_by_user_in)
    : last_modified(std::move(last_modified_in)),
      ...
      autorevocation_bypassed_by_user(std::move(autorevocation_bypassed_by_user_in)) {}
...
void RuleMetaData::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "session_model"), this->session_model,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::content_settings::mojom::SessionModel>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "tpcd_metadata_rule_source"), this->tpcd_metadata_rule_source,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::content_settings::mojom::TpcdMetadataRuleSource>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "tpcd_metadata_cohort"), this->tpcd_metadata_cohort,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::content_settings::mojom::TpcdMetadataCohort>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "decided_by_related_website_sets"), this->decided_by_related_website_sets,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type bool>"
#else
      "<value>"
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "autorevocation_bypassed_by_user"), this->autorevocation_bypassed_by_user,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type bool>"
#else
      "<value>"
...
void ContentSettingPatternSource::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "source"), this->source,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::content_settings::mojom::ProviderType>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
RendererContentSettingRules::RendererContentSettingRules(
    std::vector<ContentSettingPatternSourcePtr> mixed_content_rules_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<ContentSettingPatternSourcePtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
bool StructTraits<::content_settings::mojom::RuleMetaData::DataView, ::content_settings::mojom::RuleMetaDataPtr>::Read(
  ...
  bool success = true;
  ::content_settings::mojom::RuleMetaDataPtr result(::content_settings::mojom::RuleMetaData::New());
      ...
      if (success)
        result->autorevocation_bypassed_by_user = input.autorevocation_bypassed_by_user();
  *output = std::move(result);
  return success;
}
