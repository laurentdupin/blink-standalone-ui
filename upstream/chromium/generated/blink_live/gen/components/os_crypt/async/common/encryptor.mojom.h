...
class  Key {
 public:
  ...
  Key(
      ...
      ::mojo_base::mojom::UnsafeSharedMemoryRegionPtr key);
...
class  Encryptor {
 public:
  ...
  Encryptor(
      ...
      base::flat_map<std::string, KeyPtr> key_entries);
...
template <>
struct  StructTraits<::os_crypt_async::mojom::Key::DataView,
                                         ::os_crypt_async::mojom::KeyPtr> {
  static bool IsNull(const ::os_crypt_async::mojom::KeyPtr& input) { return !input; }
  static void SetToNull(::os_crypt_async::mojom::KeyPtr* output) { output->reset(); }

  static decltype(::os_crypt_async::mojom::Key::algorithm) algorithm(
      const ::os_crypt_async::mojom::KeyPtr& input) {
    return input->algorithm;
  }

  static  decltype(::os_crypt_async::mojom::Key::key)& key(
       ::os_crypt_async::mojom::KeyPtr& input) {
    return input->key;
  }
...
template <>
struct  StructTraits<::os_crypt_async::mojom::Encryptor::DataView,
                                         ::os_crypt_async::mojom::EncryptorPtr> {
  static bool IsNull(const ::os_crypt_async::mojom::EncryptorPtr& input) { return !input; }
  static void SetToNull(::os_crypt_async::mojom::EncryptorPtr* output) { output->reset(); }
  ...
  static  decltype(::os_crypt_async::mojom::Encryptor::key_entries)& key_entries(
       ::os_crypt_async::mojom::EncryptorPtr& input) {
