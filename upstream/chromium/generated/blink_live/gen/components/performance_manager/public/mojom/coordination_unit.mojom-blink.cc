...
void DocumentCoordinationUnitProxy::SetNetworkAlmostIdle(
  ...
  mojo::Message message(
      std::to_underlying(messages::DocumentCoordinationUnit::kSetNetworkAlmostIdle), kFlags, estimated_payload_size);
...
void DocumentCoordinationUnitProxy::SetLifecycleState(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DocumentCoordinationUnit::kSetLifecycleState), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void DocumentCoordinationUnitProxy::SetHasNonEmptyBeforeUnload(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DocumentCoordinationUnit::kSetHasNonEmptyBeforeUnload), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void DocumentCoordinationUnitProxy::SetHadFormInteraction(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DocumentCoordinationUnit::kSetHadFormInteraction), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void DocumentCoordinationUnitProxy::SetHadUserEdits(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DocumentCoordinationUnit::kSetHadUserEdits), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void DocumentCoordinationUnitProxy::OnStartedUsingWebRTC(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DocumentCoordinationUnit::kOnStartedUsingWebRTC), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void DocumentCoordinationUnitProxy::OnStoppedUsingWebRTC(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DocumentCoordinationUnit::kOnStoppedUsingWebRTC), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void DocumentCoordinationUnitProxy::SetIsAdFrame(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DocumentCoordinationUnit::kSetIsAdFrame), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void DocumentCoordinationUnitProxy::OnNonPersistentNotificationCreated(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DocumentCoordinationUnit::kOnNonPersistentNotificationCreated), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void DocumentCoordinationUnitProxy::OnFirstContentfulPaint(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DocumentCoordinationUnit::kOnFirstContentfulPaint), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void DocumentCoordinationUnitProxy::OnWebMemoryMeasurementRequested(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DocumentCoordinationUnit::kOnWebMemoryMeasurementRequested), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void DocumentCoordinationUnitProxy::OnFreezingOriginTrialOptOut(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DocumentCoordinationUnit::kOnFreezingOriginTrialOptOut), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void ProcessCoordinationUnitProxy::SetMainThreadTaskLoadIsLow(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::ProcessCoordinationUnit::kSetMainThreadTaskLoadIsLow), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void ProcessCoordinationUnitProxy::OnV8ContextCreated(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::ProcessCoordinationUnit::kOnV8ContextCreated), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void ProcessCoordinationUnitProxy::OnV8ContextDetached(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::ProcessCoordinationUnit::kOnV8ContextDetached), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void ProcessCoordinationUnitProxy::OnV8ContextDestroyed(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::ProcessCoordinationUnit::kOnV8ContextDestroyed), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void ProcessCoordinationUnitProxy::OnRemoteIframeAttached(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::ProcessCoordinationUnit::kOnRemoteIframeAttached), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void ProcessCoordinationUnitProxy::OnRemoteIframeDetached(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::ProcessCoordinationUnit::kOnRemoteIframeDetached), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void ChildProcessCoordinationUnitProxy::InitializeChildProcessCoordination(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "Send performance_manager::mojom::ChildProcessCoordinationUnit::InitializeChildProcessCoordination");
#endif
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::ChildProcessCoordinationUnit::kInitializeChildProcessCoordination), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool ChildProcessCoordinationUnitStubDispatch::AcceptWithResponder(
  ...
  switch (static_cast<messages::ChildProcessCoordinationUnit>(message->header()->name)) {
    case messages::ChildProcessCoordinationUnit::kInitializeChildProcessCoordination: {
      ...
      // A null |impl| means no implementation was bound.
      DCHECK(impl);
      impl->InitializeChildProcessCoordination(std::move(callback));
      return true;
    }
  }
  return false;
...
static const mojo::internal::GenericValidationInfo kChildProcessCoordinationUnitValidationInfo[] = {
...
void ChildProcessCoordinationUnitInterceptorForTesting::InitializeChildProcessCoordination(InitializeChildProcessCoordinationCallback callback) {
  GetForwardingInterface()->InitializeChildProcessCoordination(std::move(callback));
}
...
void ChildProcessCoordinationUnitAsyncWaiter::InitializeChildProcessCoordination(
    ::base::ReadOnlySharedMemoryRegion* out_global_region, ::base::ReadOnlySharedMemoryRegion* out_process_region) {
  base::RunLoop loop;
