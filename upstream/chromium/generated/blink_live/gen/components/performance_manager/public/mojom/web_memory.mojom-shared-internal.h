...
class COMPONENT_EXPORT(PERFORMANCE_MANAGER_PUBLIC_MOJOM_SHARED) WebMemoryBreakdownEntry_Data {
 public:
  ...
  mojo::internal::StructHeader header_;
  mojo::internal::Pointer<::mojo_base::mojom::internal::ByteSize_Data> memory;
  mojo::internal::Pointer<::mojo_base::mojom::internal::ByteSize_Data> canvas_memory;
...
class COMPONENT_EXPORT(PERFORMANCE_MANAGER_PUBLIC_MOJOM_SHARED) WebMemoryMeasurement_Data {
 public:
  ...
  mojo::internal::Pointer<::mojo_base::mojom::internal::ByteSize_Data> detached_memory;
  mojo::internal::Pointer<::mojo_base::mojom::internal::ByteSize_Data> shared_memory;
  mojo::internal::Pointer<::mojo_base::mojom::internal::ByteSize_Data> blink_memory;
