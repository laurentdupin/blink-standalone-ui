// components/performance_manager/public/mojom/v8_contexts.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "components/performance_manager/public/mojom/v8_contexts.mojom-blink-import-headers.h"
#include "components/performance_manager/public/mojom/v8_contexts.mojom-blink-test-utils.h"
...
// static
bool StructTraits<::performance_manager::mojom::blink::IframeAttributionData::DataView, ::performance_manager::mojom::blink::IframeAttributionDataPtr>::Read(
    ::performance_manager::mojom::blink::IframeAttributionData::DataView input,
    ::performance_manager::mojom::blink::IframeAttributionDataPtr* output) {
  bool success = true;
  ::performance_manager::mojom::blink::IframeAttributionDataPtr result(::performance_manager::mojom::blink::IframeAttributionData::New());
...
// static
bool StructTraits<::performance_manager::mojom::blink::V8ContextDescription::DataView, ::performance_manager::mojom::blink::V8ContextDescriptionPtr>::Read(
    ::performance_manager::mojom::blink::V8ContextDescription::DataView input,
    ::performance_manager::mojom::blink::V8ContextDescriptionPtr* output) {
  bool success = true;
  ::performance_manager::mojom::blink::V8ContextDescriptionPtr result(::performance_manager::mojom::blink::V8ContextDescription::New());
