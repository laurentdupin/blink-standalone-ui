...
#include "components/performance_manager/public/mojom/coordination_unit.mojom-data-view.h"  // IWYU pragma: export
...
struct Serializer<::performance_manager::mojom::CoordinationUnitType, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::performance_manager::mojom::CoordinationUnitType>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::performance_manager::mojom::CoordinationUnitType, UserType> ||
                        HasInfallibleConversion(::performance_manager::mojom::CoordinationUnitType()),
                    "::performance_manager::mojom::CoordinationUnitType does not have an infallible conversion, "
