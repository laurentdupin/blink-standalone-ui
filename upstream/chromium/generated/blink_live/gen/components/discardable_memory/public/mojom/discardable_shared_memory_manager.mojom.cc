...
uint32_t DiscardableSharedMemoryManager::AllocateLockedDiscardableSharedMemory_Sym::IPCStableHash() {
  ...
  static constexpr uint32_t kHash = 0x58c34b71;  // IPCStableHash for discardable_memory::mojom::DiscardableSharedMemoryManager::AllocateLockedDiscardableSharedMemory
...
uint32_t DiscardableSharedMemoryManager::DeletedDiscardableSharedMemory_Sym::IPCStableHash() {
  ...
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xdee373e2;  // IPCStableHash for discardable_memory::mojom::DiscardableSharedMemoryManager::DeletedDiscardableSharedMemory
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void DiscardableSharedMemoryManagerProxy::AllocateLockedDiscardableSharedMemory(
  ...
  mojo::Message message(
      std::to_underlying(messages::DiscardableSharedMemoryManager::kAllocateLockedDiscardableSharedMemory), kFlags, estimated_payload_size);
...
void DiscardableSharedMemoryManagerProxy::DeletedDiscardableSharedMemory(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DiscardableSharedMemoryManager::kDeletedDiscardableSharedMemory), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
class DiscardableSharedMemoryManager_AllocateLockedDiscardableSharedMemory_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::mojo_base::mojom::UnsafeSharedMemoryRegionPtr in_region);
};
...
bool DiscardableSharedMemoryManager_AllocateLockedDiscardableSharedMemory_ForwardToCallback::Accept(
  ...
  bool success = true;
  ::mojo_base::mojom::UnsafeSharedMemoryRegionPtr p_region{};
...
bool DiscardableSharedMemoryManagerRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    ...
    kDiscardableSharedMemoryManagerValidationInfo);
}
...
void DiscardableSharedMemoryManagerAsyncWaiter::AllocateLockedDiscardableSharedMemory(
    uint32_t size, int32_t id, ::mojo_base::mojom::UnsafeSharedMemoryRegionPtr* out_region) {
  base::RunLoop loop;
  proxy_->AllocateLockedDiscardableSharedMemory(
      ...
      base::BindOnce(
          [](base::RunLoop* loop,
             ::mojo_base::mojom::UnsafeSharedMemoryRegionPtr* out_region
,
             ::mojo_base::mojom::UnsafeSharedMemoryRegionPtr region) {*out_region = std::move(region);
            loop->Quit();
          },
          &loop,
          out_region));
...
::mojo_base::mojom::UnsafeSharedMemoryRegionPtr DiscardableSharedMemoryManagerAsyncWaiter::AllocateLockedDiscardableSharedMemory(
    uint32_t size, int32_t id) {
  ::mojo_base::mojom::UnsafeSharedMemoryRegionPtr async_wait_result;
