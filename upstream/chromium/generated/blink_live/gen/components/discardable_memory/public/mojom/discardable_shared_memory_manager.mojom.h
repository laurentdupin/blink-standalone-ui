...
// with not having this data in traces there.
  ...
  using AllocateLockedDiscardableSharedMemoryCallback = base::OnceCallback<void(::mojo_base::mojom::UnsafeSharedMemoryRegionPtr)>;
  using AllocateLockedDiscardableSharedMemoryMojoCallback = base::OnceCallback<void(::mojo_base::mojom::UnsafeSharedMemoryRegionPtr)>;
