// components/viz/service/debugger/mojom/viz_debugger.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "components/viz/service/debugger/mojom/viz_debugger.mojom-test-utils.h"
...
void VizDebugOutputProxy::LogFrame(
    ::mojo_base::mojom::ValuePtr in_frameData) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool VizDebugOutputStubDispatch::Accept(
  ...
  switch (static_cast<messages::VizDebugOutput>(message->header()->name)) {
    case messages::VizDebugOutput::kLogFrame: {
      ...
      bool success = true;
      ::mojo_base::mojom::ValuePtr p_frameData{};
...
bool VizDebugOutputRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::viz::mojom::VizDebugOutput::Name_,
...
void VizDebugOutputInterceptorForTesting::LogFrame(::mojo_base::mojom::ValuePtr frameData) {
