...
AggregationKeys::AggregationKeys(
    base::flat_map<std::string, ::mojo_base::mojom::Uint128Ptr> keys_in)
...
void AggregationKeys::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "keys"), this->keys,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type base::flat_map<std::string, ::mojo_base::mojom::Uint128Ptr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
AggregatableTriggerData::AggregatableTriggerData(
    ::mojo_base::mojom::Uint128Ptr key_piece_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::mojo_base::mojom::Uint128Ptr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
DestinationSet::DestinationSet(
    std::vector<::network::mojom::SchemefulSitePtr> destinations_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<::network::mojom::SchemefulSitePtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
size_t AggregatableDebugReportingContribution::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->key_piece);
...
AggregatableDebugReportingConfig::AggregatableDebugReportingConfig(
    ::mojo_base::mojom::Uint128Ptr key_piece_in,
    base::flat_map<::attribution_reporting::mojom::DebugDataType, AggregatableDebugReportingContributionPtr> debug_data_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type base::flat_map<::attribution_reporting::mojom::DebugDataType, AggregatableDebugReportingContributionPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
AggregatableValues::AggregatableValues(
    base::flat_map<std::string, AggregatableValuesValuePtr> values_in,
    FilterPairPtr filters_in)
...
void AggregatableValues::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "values"), this->values,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type base::flat_map<std::string, AggregatableValuesValuePtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
TriggerRegistration::TriggerRegistration(
    ...
    FilterPairPtr filters_in,
    std::vector<AggregatableTriggerDataPtr> aggregatable_trigger_data_in,
    std::vector<AggregatableValuesPtr> aggregatable_values_in,
    std::optional<uint64_t> debug_key_in,
    std::vector<AggregatableDedupKeyPtr> aggregatable_dedup_keys_in,
    bool debug_reporting_in,
    SuitableOriginPtr aggregation_coordinator_origin_in,
    ...
    std::vector<AggregatableNamedBudgetCandidatePtr> aggregatable_named_budget_candidates_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<AggregatableTriggerDataPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<AggregatableValuesPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<AggregatableDedupKeyPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<AggregatableNamedBudgetCandidatePtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
OsRegistration::OsRegistration(
    std::vector<OsRegistrationItemPtr> items_in)
...
void OsRegistration::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "items"), this->items,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<OsRegistrationItemPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
