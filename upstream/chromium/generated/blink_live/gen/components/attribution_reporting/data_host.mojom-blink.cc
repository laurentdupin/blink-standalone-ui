...
void DataHostProxy::SourceDataAvailable(
    ::attribution_reporting::mojom::blink::SuitableOriginPtr in_reporting_origin, ::attribution_reporting::mojom::blink::SourceRegistrationPtr in_data, bool in_was_fetched_via_service_worker) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("reporting_origin"), in_reporting_origin,
                        "<value of type ::attribution_reporting::mojom::blink::SuitableOriginPtr>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("data"), in_data,
                        "<value of type ::attribution_reporting::mojom::blink::SourceRegistrationPtr>");
      perfetto::WriteIntoTracedValueWithFallback(
...
void DataHostProxy::TriggerDataAvailable(
    ::attribution_reporting::mojom::blink::SuitableOriginPtr in_reporting_origin, ::attribution_reporting::mojom::blink::TriggerRegistrationPtr in_data, bool in_was_fetched_via_service_worker) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("data"), in_data,
                        "<value of type ::attribution_reporting::mojom::blink::TriggerRegistrationPtr>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("was_fetched_via_service_worker"), in_was_fetched_via_service_worker,
                        "<value of type bool>");
   });
...
void DataHostProxy::OsSourceDataAvailable(
    ::attribution_reporting::mojom::blink::OsRegistrationPtr in_registration, bool in_was_fetched_via_service_worker) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("registration"), in_registration,
                        "<value of type ::attribution_reporting::mojom::blink::OsRegistrationPtr>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("was_fetched_via_service_worker"), in_was_fetched_via_service_worker,
                        "<value of type bool>");
   });
...
void DataHostProxy::ReportRegistrationHeaderError(
    ::attribution_reporting::mojom::blink::SuitableOriginPtr in_reporting_origin, ::attribution_reporting::mojom::blink::RegistrationHeaderErrorPtr in_error) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("error"), in_error,
                        "<value of type ::attribution_reporting::mojom::blink::RegistrationHeaderErrorPtr>");
   });
#endif
...
bool DataHostStubDispatch::Accept(
  ...
  switch (static_cast<messages::DataHost>(message->header()->name)) {
    case messages::DataHost::kSourceDataAvailable: {
      ...
      bool success = true;
      ::attribution_reporting::mojom::blink::SuitableOriginPtr p_reporting_origin{};
      ::attribution_reporting::mojom::blink::SourceRegistrationPtr p_data{};
    ...
    case messages::DataHost::kTriggerDataAvailable: {
      ...
      bool success = true;
      ::attribution_reporting::mojom::blink::SuitableOriginPtr p_reporting_origin{};
      ::attribution_reporting::mojom::blink::TriggerRegistrationPtr p_data{};
      bool p_was_fetched_via_service_worker{};
    ...
    case messages::DataHost::kOsSourceDataAvailable: {
      ...
      bool success = true;
      ::attribution_reporting::mojom::blink::OsRegistrationPtr p_registration{};
      bool p_was_fetched_via_service_worker{};
    ...
    case messages::DataHost::kReportRegistrationHeaderError: {
      ...
      bool success = true;
      ::attribution_reporting::mojom::blink::SuitableOriginPtr p_reporting_origin{};
      ::attribution_reporting::mojom::blink::RegistrationHeaderErrorPtr p_error{};
...
void DataHostInterceptorForTesting::SourceDataAvailable(::attribution_reporting::mojom::blink::SuitableOriginPtr reporting_origin, ::attribution_reporting::mojom::blink::SourceRegistrationPtr data, bool was_fetched_via_service_worker) {
...
void DataHostInterceptorForTesting::TriggerDataAvailable(::attribution_reporting::mojom::blink::SuitableOriginPtr reporting_origin, ::attribution_reporting::mojom::blink::TriggerRegistrationPtr data, bool was_fetched_via_service_worker) {
...
void DataHostInterceptorForTesting::OsSourceDataAvailable(::attribution_reporting::mojom::blink::OsRegistrationPtr registration, bool was_fetched_via_service_worker) {
...
void DataHostInterceptorForTesting::OsTriggerDataAvailable(::attribution_reporting::mojom::blink::OsRegistrationPtr registration, bool was_fetched_via_service_worker) {
...
void DataHostInterceptorForTesting::ReportRegistrationHeaderError(::attribution_reporting::mojom::blink::SuitableOriginPtr reporting_origin, ::attribution_reporting::mojom::blink::RegistrationHeaderErrorPtr error) {
