...
// with not having this data in traces there.
  ...
  virtual void SourceDataAvailable(::attribution_reporting::mojom::SuitableOriginPtr reporting_origin, ::attribution_reporting::mojom::SourceRegistrationPtr data, bool was_fetched_via_service_worker) = 0;

  virtual void TriggerDataAvailable(::attribution_reporting::mojom::SuitableOriginPtr reporting_origin, ::attribution_reporting::mojom::TriggerRegistrationPtr data, bool was_fetched_via_service_worker) = 0;

  virtual void OsSourceDataAvailable(::attribution_reporting::mojom::OsRegistrationPtr registration, bool was_fetched_via_service_worker) = 0;

  virtual void OsTriggerDataAvailable(::attribution_reporting::mojom::OsRegistrationPtr registration, bool was_fetched_via_service_worker) = 0;

  virtual void ReportRegistrationHeaderError(::attribution_reporting::mojom::SuitableOriginPtr reporting_origin, ::attribution_reporting::mojom::RegistrationHeaderErrorPtr error) = 0;
};
...
class  DataHostProxy
 ...
 public:
  ...
  void SourceDataAvailable(::attribution_reporting::mojom::SuitableOriginPtr reporting_origin, ::attribution_reporting::mojom::SourceRegistrationPtr data, bool was_fetched_via_service_worker) final;
  
  void TriggerDataAvailable(::attribution_reporting::mojom::SuitableOriginPtr reporting_origin, ::attribution_reporting::mojom::TriggerRegistrationPtr data, bool was_fetched_via_service_worker) final;
  
  void OsSourceDataAvailable(::attribution_reporting::mojom::OsRegistrationPtr registration, bool was_fetched_via_service_worker) final;
  
  void OsTriggerDataAvailable(::attribution_reporting::mojom::OsRegistrationPtr registration, bool was_fetched_via_service_worker) final;
  
  void ReportRegistrationHeaderError(::attribution_reporting::mojom::SuitableOriginPtr reporting_origin, ::attribution_reporting::mojom::RegistrationHeaderErrorPtr error) final;
