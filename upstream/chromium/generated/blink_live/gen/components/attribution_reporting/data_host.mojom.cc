// components/attribution_reporting/data_host.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
void DataHostProxy::SourceDataAvailable(
    ::attribution_reporting::mojom::SuitableOriginPtr in_reporting_origin, ::attribution_reporting::mojom::SourceRegistrationPtr in_data, bool in_was_fetched_via_service_worker) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("reporting_origin"), in_reporting_origin,
                        "<value of type ::attribution_reporting::mojom::SuitableOriginPtr>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("data"), in_data,
                        "<value of type ::attribution_reporting::mojom::SourceRegistrationPtr>");
      perfetto::WriteIntoTracedValueWithFallback(
  ...
  mojo::Message message(
      std::to_underlying(messages::DataHost::kSourceDataAvailable), kFlags, estimated_payload_size);
...
void DataHostProxy::TriggerDataAvailable(
    ::attribution_reporting::mojom::SuitableOriginPtr in_reporting_origin, ::attribution_reporting::mojom::TriggerRegistrationPtr in_data, bool in_was_fetched_via_service_worker) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("data"), in_data,
                        "<value of type ::attribution_reporting::mojom::TriggerRegistrationPtr>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("was_fetched_via_service_worker"), in_was_fetched_via_service_worker,
                        "<value of type bool>");
   });
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DataHost::kTriggerDataAvailable), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void DataHostProxy::OsSourceDataAvailable(
    ::attribution_reporting::mojom::OsRegistrationPtr in_registration, bool in_was_fetched_via_service_worker) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("registration"), in_registration,
                        "<value of type ::attribution_reporting::mojom::OsRegistrationPtr>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("was_fetched_via_service_worker"), in_was_fetched_via_service_worker,
                        "<value of type bool>");
   });
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DataHost::kOsSourceDataAvailable), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void DataHostProxy::OsTriggerDataAvailable(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DataHost::kOsTriggerDataAvailable), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void DataHostProxy::ReportRegistrationHeaderError(
    ::attribution_reporting::mojom::SuitableOriginPtr in_reporting_origin, ::attribution_reporting::mojom::RegistrationHeaderErrorPtr in_error) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("error"), in_error,
                        "<value of type ::attribution_reporting::mojom::RegistrationHeaderErrorPtr>");
   });
#endif
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DataHost::kReportRegistrationHeaderError), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool DataHostStubDispatch::Accept(
  ...
  switch (static_cast<messages::DataHost>(message->header()->name)) {
    case messages::DataHost::kSourceDataAvailable: {
      ...
      bool success = true;
      ::attribution_reporting::mojom::SuitableOriginPtr p_reporting_origin{};
      ::attribution_reporting::mojom::SourceRegistrationPtr p_data{};
    ...
    case messages::DataHost::kTriggerDataAvailable: {
      ...
      bool success = true;
      ::attribution_reporting::mojom::SuitableOriginPtr p_reporting_origin{};
      ::attribution_reporting::mojom::TriggerRegistrationPtr p_data{};
      bool p_was_fetched_via_service_worker{};
    ...
    case messages::DataHost::kOsSourceDataAvailable: {
      ...
      bool success = true;
      ::attribution_reporting::mojom::OsRegistrationPtr p_registration{};
      bool p_was_fetched_via_service_worker{};
    ...
    case messages::DataHost::kReportRegistrationHeaderError: {
      ...
      bool success = true;
      ::attribution_reporting::mojom::SuitableOriginPtr p_reporting_origin{};
      ::attribution_reporting::mojom::RegistrationHeaderErrorPtr p_error{};
...
bool DataHostRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::attribution_reporting::mojom::DataHost::Name_,
...
void DataHostInterceptorForTesting::SourceDataAvailable(::attribution_reporting::mojom::SuitableOriginPtr reporting_origin, ::attribution_reporting::mojom::SourceRegistrationPtr data, bool was_fetched_via_service_worker) {
...
void DataHostInterceptorForTesting::TriggerDataAvailable(::attribution_reporting::mojom::SuitableOriginPtr reporting_origin, ::attribution_reporting::mojom::TriggerRegistrationPtr data, bool was_fetched_via_service_worker) {
...
void DataHostInterceptorForTesting::OsSourceDataAvailable(::attribution_reporting::mojom::OsRegistrationPtr registration, bool was_fetched_via_service_worker) {
...
void DataHostInterceptorForTesting::OsTriggerDataAvailable(::attribution_reporting::mojom::OsRegistrationPtr registration, bool was_fetched_via_service_worker) {
...
void DataHostInterceptorForTesting::ReportRegistrationHeaderError(::attribution_reporting::mojom::SuitableOriginPtr reporting_origin, ::attribution_reporting::mojom::RegistrationHeaderErrorPtr error) {
