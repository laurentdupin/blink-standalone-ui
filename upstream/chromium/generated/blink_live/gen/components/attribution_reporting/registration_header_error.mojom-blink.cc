...
size_t RegistrationHeaderError::Hash(size_t seed) const {
  ...
  seed = mojo::internal::WTFHash(seed, this->error_details);
  return seed;
}
...
size_t RegistrationHeaderErrorDetails::Hash(size_t seed) const {
  ...
  switch (tag_) {
    ...
    case Tag::kSourceError:
      return mojo::internal::WTFHash(seed, data_.source_error);
    case Tag::kTriggerError:
      return mojo::internal::WTFHash(seed, data_.trigger_error);
    case Tag::kOsSourceError:
      return mojo::internal::WTFHash(seed, data_.os_source_error);
    case Tag::kOsTriggerError:
      return mojo::internal::WTFHash(seed, data_.os_trigger_error);
    default:
      NOTREACHED();
  }
}
