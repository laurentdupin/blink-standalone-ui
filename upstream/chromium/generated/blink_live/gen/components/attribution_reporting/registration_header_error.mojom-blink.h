// components/attribution_reporting/registration_header_error.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef COMPONENTS_ATTRIBUTION_REPORTING_REGISTRATION_HEADER_ERROR_MOJOM_BLINK_H_
#define COMPONENTS_ATTRIBUTION_REPORTING_REGISTRATION_HEADER_ERROR_MOJOM_BLINK_H_
...
#include "components/attribution_reporting/registration_header_error.mojom-blink-forward.h"  // IWYU pragma: export
#include "components/attribution_reporting/os_registration_error.mojom-blink-forward.h"
#include "components/attribution_reporting/source_registration_error.mojom-blink-forward.h"
#include "components/attribution_reporting/trigger_registration_error.mojom-blink-forward.h"
...
class BLINK_PLATFORM_EXPORT RegistrationHeaderErrorDetails {
 public:
  ...
  ::attribution_reporting::mojom::blink::SourceRegistrationError get_source_error() const {
    CHECK(tag_ == Tag::kSourceError);
    return data_.source_error;
  }
  void set_source_error(::attribution_reporting::mojom::blink::SourceRegistrationError source_error);

  bool is_trigger_error() const { return tag_ == Tag::kTriggerError; }
  ::attribution_reporting::mojom::blink::TriggerRegistrationError get_trigger_error() const {
    CHECK(tag_ == Tag::kTriggerError);
    return data_.trigger_error;
  }
  void set_trigger_error(::attribution_reporting::mojom::blink::TriggerRegistrationError trigger_error);

  bool is_os_source_error() const { return tag_ == Tag::kOsSourceError; }
  ::attribution_reporting::mojom::blink::OsRegistrationError get_os_source_error() const {
    CHECK(tag_ == Tag::kOsSourceError);
    return data_.os_source_error;
  }
  void set_os_source_error(::attribution_reporting::mojom::blink::OsRegistrationError os_source_error);

  bool is_os_trigger_error() const { return tag_ == Tag::kOsTriggerError; }
  ::attribution_reporting::mojom::blink::OsRegistrationError get_os_trigger_error() const {
    CHECK(tag_ == Tag::kOsTriggerError);
    return data_.os_trigger_error;
  }
  void set_os_trigger_error(::attribution_reporting::mojom::blink::OsRegistrationError os_trigger_error);
 ...
 private:
  ...
  union Union_ {
    ...
    ::attribution_reporting::mojom::blink::SourceRegistrationError source_error;
    ::attribution_reporting::mojom::blink::TriggerRegistrationError trigger_error;
    ::attribution_reporting::mojom::blink::OsRegistrationError os_source_error;
    ::attribution_reporting::mojom::blink::OsRegistrationError os_trigger_error;
  };
...
class BLINK_PLATFORM_EXPORT RegistrationHeaderError {
 public:
  template <typename T>
  ...
  RegistrationHeaderError(
      ...
      RegistrationHeaderErrorDetailsPtr error_details);

RegistrationHeaderError(const RegistrationHeaderError&) = delete;
RegistrationHeaderError& operator=(const RegistrationHeaderError&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        RegistrationHeaderError::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        RegistrationHeaderError::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::attribution_reporting::mojom::blink::RegistrationHeaderError::DataView,
                                         ::attribution_reporting::mojom::blink::RegistrationHeaderErrorPtr> {
  static bool IsNull(const ::attribution_reporting::mojom::blink::RegistrationHeaderErrorPtr& input) { return !input; }
  static void SetToNull(::attribution_reporting::mojom::blink::RegistrationHeaderErrorPtr* output) { output->reset(); }

  static const decltype(::attribution_reporting::mojom::blink::RegistrationHeaderError::header_value)& header_value(
      const ::attribution_reporting::mojom::blink::RegistrationHeaderErrorPtr& input) {
    return input->header_value;
  }

  static const decltype(::attribution_reporting::mojom::blink::RegistrationHeaderError::error_details)& error_details(
      const ::attribution_reporting::mojom::blink::RegistrationHeaderErrorPtr& input) {
    return input->error_details;
  }

  static bool Read(::attribution_reporting::mojom::blink::RegistrationHeaderError::DataView input, ::attribution_reporting::mojom::blink::RegistrationHeaderErrorPtr* output);
};


template <>
struct BLINK_PLATFORM_EXPORT UnionTraits<::attribution_reporting::mojom::blink::RegistrationHeaderErrorDetails::DataView,
                                        ::attribution_reporting::mojom::blink::RegistrationHeaderErrorDetailsPtr> {
  static bool IsNull(const ::attribution_reporting::mojom::blink::RegistrationHeaderErrorDetailsPtr& input) { return !input; }
  static void SetToNull(::attribution_reporting::mojom::blink::RegistrationHeaderErrorDetailsPtr* output) { output->reset(); }

  static ::attribution_reporting::mojom::blink::RegistrationHeaderErrorDetails::Tag GetTag(const ::attribution_reporting::mojom::blink::RegistrationHeaderErrorDetailsPtr& input) {
    return input->which();
  }

  static  ::attribution_reporting::mojom::blink::SourceRegistrationError source_error(const ::attribution_reporting::mojom::blink::RegistrationHeaderErrorDetailsPtr& input) {
    return input->get_source_error();
  }

  static  ::attribution_reporting::mojom::blink::TriggerRegistrationError trigger_error(const ::attribution_reporting::mojom::blink::RegistrationHeaderErrorDetailsPtr& input) {
    return input->get_trigger_error();
  }

  static  ::attribution_reporting::mojom::blink::OsRegistrationError os_source_error(const ::attribution_reporting::mojom::blink::RegistrationHeaderErrorDetailsPtr& input) {
    return input->get_os_source_error();
  }

  static  ::attribution_reporting::mojom::blink::OsRegistrationError os_trigger_error(const ::attribution_reporting::mojom::blink::RegistrationHeaderErrorDetailsPtr& input) {
    return input->get_os_trigger_error();
  }

  static bool Read(::attribution_reporting::mojom::blink::RegistrationHeaderErrorDetails::DataView input, ::attribution_reporting::mojom::blink::RegistrationHeaderErrorDetailsPtr* output);
};

}  // namespace mojo

#endif  // COMPONENTS_ATTRIBUTION_REPORTING_REGISTRATION_HEADER_ERROR_MOJOM_BLINK_H_