...
#include "components/attribution_reporting/source_registration_error.mojom-data-view.h"  // IWYU pragma: export
...
struct Serializer<::attribution_reporting::mojom::SourceRegistrationError, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::attribution_reporting::mojom::SourceRegistrationError>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::attribution_reporting::mojom::SourceRegistrationError, UserType> ||
                        HasInfallibleConversion(::attribution_reporting::mojom::SourceRegistrationError()),
                    "::attribution_reporting::mojom::SourceRegistrationError does not have an infallible conversion, "
