...
// static
bool TriggerDataSet_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const TriggerDataSet_Data* object =
      static_cast<const TriggerDataSet_Data*>(data);

  if (!mojo::internal::ValidatePointerNonNullable(
          object->trigger_data, 1, validation_context)) {
    return false;
  }
  constexpr const mojo::internal::ContainerValidateParams& trigger_data_validate_params =
      mojo::internal::GetArrayValidator<0, false, nullptr>();
  if (!mojo::internal::ValidateContainer(object->trigger_data, validation_context,
...
TriggerDataSet_Data::TriggerDataSet_Data()
    : header_({sizeof(*this), 0}) {}
...
bool SourceRegistration_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->trigger_data, 4, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateStruct(object->trigger_data, validation_context))
    return false;

  if (!mojo::internal::ValidatePointerNonNullable(
          object->event_report_windows, 5, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->aggregatable_report_window, 7, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->aggregatable_debug_reporting_config, 16, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->aggregatable_named_budget_defs, 19, validation_context)) {
    return false;
  }
