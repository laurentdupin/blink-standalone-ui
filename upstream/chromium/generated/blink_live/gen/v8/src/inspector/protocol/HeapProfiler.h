...
public:
    ~SamplingHeapProfileNode() override;  // Defined below
    ...
    void setSelfSize(double value);  // Defined below
    ...
    void setChildren(std::unique_ptr<protocol::Array<protocol::HeapProfiler::SamplingHeapProfileNode>> value);  // Defined below
    ...
    public:
        ...
        SamplingHeapProfileNodeBuilder<STATE | CallFrameSet>& setCallFrame(std::unique_ptr<protocol::Runtime::CallFrame> value);  // Defined below

        SamplingHeapProfileNodeBuilder<STATE | SelfSizeSet>& setSelfSize(double value);  // Defined below

        SamplingHeapProfileNodeBuilder<STATE | IdSet>& setId(int value);  // Defined below

        SamplingHeapProfileNodeBuilder<STATE | ChildrenSet>& setChildren(std::unique_ptr<protocol::Array<protocol::HeapProfiler::SamplingHeapProfileNode>> value);  // Defined below
...
private:
    ...
    SamplingHeapProfileNode();  // Defined below
...
public:
    ~SamplingHeapProfileSample() override;  // Defined below
    ...
    void setOrdinal(double value);  // Defined below
    ...
    public:
        ...
        SamplingHeapProfileSampleBuilder<STATE | SizeSet>& setSize(double value);  // Defined below

        SamplingHeapProfileSampleBuilder<STATE | NodeIdSet>& setNodeId(int value);  // Defined below

        SamplingHeapProfileSampleBuilder<STATE | OrdinalSet>& setOrdinal(double value);  // Defined below
...
private:
    ...
    SamplingHeapProfileSample();  // Defined below
...
public:
    ~SamplingHeapProfile() override;  // Defined below

    protocol::HeapProfiler::SamplingHeapProfileNode* getHead() { return m_head.get(); }
    void setHead(std::unique_ptr<protocol::HeapProfiler::SamplingHeapProfileNode> value);  // Defined below

    protocol::Array<protocol::HeapProfiler::SamplingHeapProfileSample>* getSamples() { return m_samples.get(); }
    void setSamples(std::unique_ptr<protocol::Array<protocol::HeapProfiler::SamplingHeapProfileSample>> value);  // Defined below
    ...
    public:
        ...
        SamplingHeapProfileBuilder<STATE | HeadSet>& setHead(std::unique_ptr<protocol::HeapProfiler::SamplingHeapProfileNode> value);  // Defined below

        SamplingHeapProfileBuilder<STATE | SamplesSet>& setSamples(std::unique_ptr<protocol::Array<protocol::HeapProfiler::SamplingHeapProfileSample>> value);  // Defined below
...
private:
    ...
    SamplingHeapProfile();  // Defined below
...
inline SamplingHeapProfileNode::~SamplingHeapProfileNode() = default;
inline void SamplingHeapProfileNode::setCallFrame(std::unique_ptr<protocol::Runtime::CallFrame> value) { m_callFrame = std::move(value); }
inline void SamplingHeapProfileNode::setSelfSize(double value) { m_selfSize = value; }
inline void SamplingHeapProfileNode::setId(int value) { m_id = value; }
inline void SamplingHeapProfileNode::setChildren(std::unique_ptr<protocol::Array<protocol::HeapProfiler::SamplingHeapProfileNode>> value) { m_children = std::move(value); }

template<int STATE>
inline SamplingHeapProfileNode::SamplingHeapProfileNodeBuilder<STATE | SamplingHeapProfileNode::SamplingHeapProfileNodeBuilder<STATE>::CallFrameSet>&
SamplingHeapProfileNode::SamplingHeapProfileNodeBuilder<STATE>::setCallFrame(std::unique_ptr<protocol::Runtime::CallFrame> value) {
...
template<int STATE>
inline SamplingHeapProfileNode::SamplingHeapProfileNodeBuilder<STATE | SamplingHeapProfileNode::SamplingHeapProfileNodeBuilder<STATE>::SelfSizeSet>&
SamplingHeapProfileNode::SamplingHeapProfileNodeBuilder<STATE>::setSelfSize(double value) {
...
template<int STATE>
inline SamplingHeapProfileNode::SamplingHeapProfileNodeBuilder<STATE | SamplingHeapProfileNode::SamplingHeapProfileNodeBuilder<STATE>::IdSet>&
SamplingHeapProfileNode::SamplingHeapProfileNodeBuilder<STATE>::setId(int value) {
  static_assert(!(STATE & IdSet), "property id should not be set yet");
  m_result->setId(value);
  return castState<IdSet>();
}
template<int STATE>
inline SamplingHeapProfileNode::SamplingHeapProfileNodeBuilder<STATE | SamplingHeapProfileNode::SamplingHeapProfileNodeBuilder<STATE>::ChildrenSet>&
SamplingHeapProfileNode::SamplingHeapProfileNodeBuilder<STATE>::setChildren(std::unique_ptr<protocol::Array<protocol::HeapProfiler::SamplingHeapProfileNode>> value) {
...
inline SamplingHeapProfileNode::SamplingHeapProfileNode() {
  m_selfSize = 0;
  m_id = 0;
}
inline SamplingHeapProfileSample::~SamplingHeapProfileSample() = default;
inline void SamplingHeapProfileSample::setSize(double value) { m_size = value; }
inline void SamplingHeapProfileSample::setNodeId(int value) { m_nodeId = value; }
inline void SamplingHeapProfileSample::setOrdinal(double value) { m_ordinal = value; }

template<int STATE>
inline SamplingHeapProfileSample::SamplingHeapProfileSampleBuilder<STATE | SamplingHeapProfileSample::SamplingHeapProfileSampleBuilder<STATE>::SizeSet>&
SamplingHeapProfileSample::SamplingHeapProfileSampleBuilder<STATE>::setSize(double value) {
  static_assert(!(STATE & SizeSet), "property size should not be set yet");
  m_result->setSize(value);
  return castState<SizeSet>();
}
template<int STATE>
inline SamplingHeapProfileSample::SamplingHeapProfileSampleBuilder<STATE | SamplingHeapProfileSample::SamplingHeapProfileSampleBuilder<STATE>::NodeIdSet>&
SamplingHeapProfileSample::SamplingHeapProfileSampleBuilder<STATE>::setNodeId(int value) {
  static_assert(!(STATE & NodeIdSet), "property nodeId should not be set yet");
  m_result->setNodeId(value);
  return castState<NodeIdSet>();
}
template<int STATE>
inline SamplingHeapProfileSample::SamplingHeapProfileSampleBuilder<STATE | SamplingHeapProfileSample::SamplingHeapProfileSampleBuilder<STATE>::OrdinalSet>&
SamplingHeapProfileSample::SamplingHeapProfileSampleBuilder<STATE>::setOrdinal(double value) {
...
inline SamplingHeapProfileSample::SamplingHeapProfileSample() {
  m_size = 0;
  m_nodeId = 0;
  m_ordinal = 0;
}
inline SamplingHeapProfile::~SamplingHeapProfile() = default;
inline void SamplingHeapProfile::setHead(std::unique_ptr<protocol::HeapProfiler::SamplingHeapProfileNode> value) { m_head = std::move(value); }
inline void SamplingHeapProfile::setSamples(std::unique_ptr<protocol::Array<protocol::HeapProfiler::SamplingHeapProfileSample>> value) { m_samples = std::move(value); }

template<int STATE>
inline SamplingHeapProfile::SamplingHeapProfileBuilder<STATE | SamplingHeapProfile::SamplingHeapProfileBuilder<STATE>::HeadSet>&
SamplingHeapProfile::SamplingHeapProfileBuilder<STATE>::setHead(std::unique_ptr<protocol::HeapProfiler::SamplingHeapProfileNode> value) {
  static_assert(!(STATE & HeadSet), "property head should not be set yet");
  m_result->setHead(std::move(value));
  return castState<HeadSet>();
}
template<int STATE>
inline SamplingHeapProfile::SamplingHeapProfileBuilder<STATE | SamplingHeapProfile::SamplingHeapProfileBuilder<STATE>::SamplesSet>&
SamplingHeapProfile::SamplingHeapProfileBuilder<STATE>::setSamples(std::unique_ptr<protocol::Array<protocol::HeapProfiler::SamplingHeapProfileSample>> value) {
...
inline SamplingHeapProfile::SamplingHeapProfile() {
}
...
public:
    ...
    virtual DispatchResponse startSampling(std::optional<double> in_samplingInterval, std::optional<double> in_stackDepth, std::optional<bool> in_includeObjectsCollectedByMajorGC, std::optional<bool> in_includeObjectsCollectedByMinorGC) = 0;
