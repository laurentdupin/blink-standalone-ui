...
TNode<JSArgumentsObject> NewJSStrictArgumentsObject_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArray> p_elements) {
  ...
  if (block0.is_used()) {
    ...
    tmp2 = LoadFixedArrayBaseLengthIntptr_0(state_, TNode<FixedArrayBase>{p_elements});
    ...
    tmp7 = AllocateFromNew_0(state_, TNode<IntPtrT>{tmp6}, TNode<Map>{tmp0}, TNode<BoolT>{tmp4}, TNode<BoolT>{tmp5});
...
TorqueStructParameterMapIterator_0 NewParameterMapIterator_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<IntPtrT> p_formalParameterCount, TNode<IntPtrT> p_mappedCount) {
  ...
  if (block0.is_used()) {
    ...
    tmp3 = FromConstexpr_intptr_constexpr_intptr_0(state_, CastIfEnumClass<intptr_t>(Context::Field::MIN_CONTEXT_SLOTS));
  ...
  if (block3.is_used()) {
    ...
    tmp7 = ca_.UncheckedCast<Uint32T>(CodeStubAssembler(state_).DecodeWord32<base::BitField<VariableAllocationInfo, 7, 2, uint32_t>>(ca_.UncheckedCast<Word32T>(tmp2)));
    tmp8 = FromConstexpr_VariableAllocationInfo_constexpr_CONTEXT_0(state_, VariableAllocationInfo::CONTEXT);
    tmp9 = CodeStubAssembler(state_).Word32Equal(TNode<Uint32T>{tmp7}, TNode<Uint32T>{tmp8});
    ca_.Branch(tmp9, &block4, std::vector<compiler::Node*>{}, &block5, std::vector<compiler::Node*>{phi_bb3_4});
  }
  ...
  if (block4.is_used()) {
    ...
    tmp11 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{phi_bb3_4}, TNode<IntPtrT>{tmp10});
  ...
  if (block5.is_used()) {
    ...
    tmp12 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{phi_bb5_4}, TNode<IntPtrT>{p_formalParameterCount});
    tmp13 = CodeStubAssembler(state_).IntPtrSub(TNode<IntPtrT>{tmp12}, TNode<IntPtrT>{p_mappedCount});
    ca_.Goto(&block6);
  }
...
TNode<JSArray> NewAllArguments_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<RawPtrT> p_frame, TNode<IntPtrT> p_argumentCount) {
  ...
  if (block0.is_used()) {
    ...
    std::tie(tmp1, tmp2, tmp3, tmp4) = CodeStubAssembler(state_).GetFrameArguments(TNode<RawPtrT>{p_frame}, TNode<IntPtrT>{p_argumentCount}).Flatten();
    tmp5 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    tmp6 = NewFixedArray_ArgumentsIterator_0(state_, TNode<IntPtrT>{p_argumentCount}, TorqueStructArgumentsIterator_0{TorqueStructArguments{TNode<RawPtrT>{tmp1}, TNode<RawPtrT>{tmp2}, TNode<IntPtrT>{tmp3}, TNode<IntPtrT>{tmp4}}, TNode<IntPtrT>{tmp5}});
    tmp7 = NewJSArray_0(state_, TNode<Context>{p_context}, TNode<Map>{tmp0}, TNode<FixedArrayBase>{tmp6});
    ca_.Goto(&block2);
  }
...
TNode<FixedArray> NewRestArgumentsElements_0(compiler::CodeAssemblerState* state_, TNode<RawPtrT> p_frame, TNode<IntPtrT> p_formalParameterCount, TNode<IntPtrT> p_argumentCount) {
  ...
  if (block4.is_used()) {
    ...
    std::tie(tmp3, tmp4, tmp5, tmp6) = CodeStubAssembler(state_).GetFrameArguments(TNode<RawPtrT>{p_frame}, TNode<IntPtrT>{p_argumentCount}).Flatten();
    tmp7 = NewFixedArray_ArgumentsIterator_0(state_, TNode<IntPtrT>{phi_bb4_3}, TorqueStructArgumentsIterator_0{TorqueStructArguments{TNode<RawPtrT>{tmp3}, TNode<RawPtrT>{tmp4}, TNode<IntPtrT>{tmp5}, TNode<IntPtrT>{tmp6}}, TNode<IntPtrT>{p_formalParameterCount}});
    ca_.Goto(&block6);
  }
...
TNode<FixedArray> NewStrictArgumentsElements_0(compiler::CodeAssemblerState* state_, TNode<RawPtrT> p_frame, TNode<IntPtrT> p_argumentCount) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    std::tie(tmp0, tmp1, tmp2, tmp3) = CodeStubAssembler(state_).GetFrameArguments(TNode<RawPtrT>{p_frame}, TNode<IntPtrT>{p_argumentCount}).Flatten();
    tmp4 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    tmp5 = NewFixedArray_ArgumentsIterator_0(state_, TNode<IntPtrT>{p_argumentCount}, TorqueStructArgumentsIterator_0{TorqueStructArguments{TNode<RawPtrT>{tmp0}, TNode<RawPtrT>{tmp1}, TNode<IntPtrT>{tmp2}, TNode<IntPtrT>{tmp3}}, TNode<IntPtrT>{tmp4}});
    ca_.Goto(&block2);
  }
...
TNode<FixedArray> NewSloppyArgumentsElements_0(compiler::CodeAssemblerState* state_, TNode<RawPtrT> p_frame, TNode<IntPtrT> p_formalParameterCount, TNode<IntPtrT> p_argumentCount) {
  ...
  if (block0.is_used()) {
    ...
    std::tie(tmp0, tmp1, tmp2, tmp3) = CodeStubAssembler(state_).GetFrameArguments(TNode<RawPtrT>{p_frame}, TNode<IntPtrT>{p_argumentCount}).Flatten();
    tmp4 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    tmp5 = CodeStubAssembler(state_).WordEqual(TNode<IntPtrT>{p_formalParameterCount}, TNode<IntPtrT>{tmp4});
  ...
  if (block2.is_used()) {
    ...
    tmp7 = NewFixedArray_ArgumentsIterator_0(state_, TNode<IntPtrT>{p_argumentCount}, TorqueStructArgumentsIterator_0{TorqueStructArguments{TNode<RawPtrT>{tmp0}, TNode<RawPtrT>{tmp1}, TNode<IntPtrT>{tmp2}, TNode<IntPtrT>{tmp3}}, TNode<IntPtrT>{tmp6}});
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    tmp8 = CodeStubAssembler(state_).IntPtrMin(TNode<IntPtrT>{p_formalParameterCount}, TNode<IntPtrT>{p_argumentCount});
    std::tie(tmp9, tmp10, tmp11, tmp12, tmp13, tmp14) = NewParameterValueIterator_0(state_, TNode<IntPtrT>{tmp8}, TorqueStructArguments{TNode<RawPtrT>{tmp0}, TNode<RawPtrT>{tmp1}, TNode<IntPtrT>{tmp2}, TNode<IntPtrT>{tmp3}}).Flatten();
    tmp15 = NewFixedArray_ParameterValueIterator_0(state_, TNode<IntPtrT>{p_argumentCount}, TorqueStructParameterValueIterator_0{TNode<IntPtrT>{tmp9}, TorqueStructArguments{TNode<RawPtrT>{tmp10}, TNode<RawPtrT>{tmp11}, TNode<IntPtrT>{tmp12}, TNode<IntPtrT>{tmp13}}, TNode<IntPtrT>{tmp14}});
...
TNode<JSArgumentsObject> NewSloppyArguments_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructFrameWithArgumentsInfo_0 p_info, TNode<JSFunction> p_callee) {
  ...
  if (block3.is_used()) {
    ...
    tmp9 = Convert_int32_intptr_0(state_, TNode<IntPtrT>{tmp6});
    tmp10 = CodeStubAssembler(state_).Unsigned(TNode<Int32T>{tmp9});
    tmp11 = NewSloppyArgumentsElements_ParameterMapIterator_0(state_, TNode<Uint32T>{tmp10}, TNode<Context>{p_context}, TNode<FixedArray>{tmp2}, TorqueStructParameterMapIterator_0{TNode<IntPtrT>{tmp7}, TNode<IntPtrT>{tmp8}});
    tmp12 = Convert_Smi_intptr_0(state_, TNode<IntPtrT>{tmp0});
    tmp13 = NewJSFastAliasedArgumentsObject_0(state_, TNode<Context>{p_context}, TNode<FixedArrayBase>{tmp11}, TNode<Smi>{tmp12}, TNode<JSFunction>{p_callee});
...
TNode<JSArray> NewRestArgumentsFromArguments_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArguments p_arguments, TNode<IntPtrT> p_start) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = CodeStubAssembler(state_).IntPtrLessThanOrEqual(TNode<IntPtrT>{p_start}, TNode<IntPtrT>{p_arguments.length});
    ca_.Branch(tmp0, &block2, std::vector<compiler::Node*>{}, &block3, std::vector<compiler::Node*>{});
  }
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    {
      ...
      pos_stack.push_back({"src/objects/arguments.tq", 285});
      CodeStubAssembler(state_).FailAssert("Torque assert 'start <= arguments.length' failed", pos_stack);
    }
  }
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    tmp1 = GetFastPackedElementsJSArrayMap_0(state_, TNode<Context>{p_context});
    tmp2 = CodeStubAssembler(state_).IntPtrSub(TNode<IntPtrT>{p_arguments.length}, TNode<IntPtrT>{p_start});
    tmp3 = NewFixedArray_ArgumentsIterator_0(state_, TNode<IntPtrT>{tmp2}, TorqueStructArgumentsIterator_0{TorqueStructArguments{TNode<RawPtrT>{p_arguments.frame}, TNode<RawPtrT>{p_arguments.base}, TNode<IntPtrT>{p_arguments.length}, TNode<IntPtrT>{p_arguments.actual_count}}, TNode<IntPtrT>{p_start}});
    tmp4 = NewJSArray_0(state_, TNode<Context>{p_context}, TNode<Map>{tmp1}, TNode<FixedArrayBase>{tmp3});
    ca_.Goto(&block4);
  }
...
TorqueStructReference_Object_0 AccessSloppyArgumentsCommon_0(compiler::CodeAssemblerState* state_, TNode<JSObject> p_receiver, TNode<Object> p_keyObject, compiler::CodeAssemblerLabel* label_Bailout) {
  ...
  if (block5.is_used()) {
    ...
    tmp7 = CodeStubAssembler(state_).LoadReference<Uint32T>(CodeStubAssembler::Reference{tmp4, tmp6});
    tmp8 = OutOfBounds_Smi_uint32_0(state_, TNode<Smi>{tmp0}, TNode<Uint32T>{tmp7});
  ...
  if (block15.is_used()) {
    ...
    tmp20 = CodeStubAssembler(state_).LoadReference<Union<Smi, TheHole>>(CodeStubAssembler::Reference{tmp18, tmp19});
  ...
  if (block34.is_used()) {
    ...
    tmp41 = CodeStubAssembler(state_).LoadReference<Uint32T>(CodeStubAssembler::Reference{ca_.UncheckedCast<FixedArray>(tmp37), tmp40});
    tmp42 = OutOfBounds_Smi_uint32_0(state_, TNode<Smi>{tmp0}, TNode<Uint32T>{tmp41});
    ca_.Branch(tmp42, &block35, std::vector<compiler::Node*>{}, &block36, std::vector<compiler::Node*>{});
  }
  ...
  if (block36.is_used()) {
    ...
    ca_.Branch(tmp49, &block43, std::vector<compiler::Node*>{}, &block44, std::vector<compiler::Node*>{});
  }
  ...
  if (block38.is_used()) {
    ...
    ca_.Branch(tmp63, &block51, std::vector<compiler::Node*>{}, &block52, std::vector<compiler::Node*>{});
  }
  ...
  if (block2.is_used()) {
    ...
    ca_.Goto(&block55, phi_bb2_2, phi_bb2_3);
  }
...
TNode<JSAny> SloppyArgumentsLoad_0(compiler::CodeAssemblerState* state_, TNode<JSObject> p_receiver, TNode<Object> p_keyObject, compiler::CodeAssemblerLabel* label_Bailout) {
  ...
  if (block3.is_used()) {
    ...
    compiler::CodeAssemblerLabel label5(&ca_);
    tmp4 = Cast_JSAny_0(state_, TNode<Object>{tmp3}, &label5);
    ca_.Goto(&block11);
    if (label5.is_used()) {
      ca_.Bind(&label5);
      ca_.Goto(&block12);
  ...
  if (block8.is_used()) {
    ...
    ca_.Branch(phi_bb8_6, &block6, std::vector<compiler::Node*>{}, &block7, std::vector<compiler::Node*>{});
  }
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    tmp8 = TORQUE_CAST(TNode<Object>{tmp3});
    ca_.Goto(&block13);
  }
...
TNode<Union<Smi, TheHole>> LoadSloppyArgumentsElementsMappedEntries_0(compiler::CodeAssemblerState* state_, TNode<SloppyArgumentsElements> p_o, TNode<IntPtrT> p_i) {
  ...
  if (block6.is_used()) {
    ...
    tmp10 = CodeStubAssembler(state_).LoadReference<Union<Smi, TheHole>>(CodeStubAssembler::Reference{tmp8, tmp9});
    ca_.Goto(&block10);
  }
  ...
  if (block7.is_used()) {
    ...
    ca_.Bind(&block10);
  return TNode<Union<Smi, TheHole>>{tmp10};
}
...
void StoreSloppyArgumentsElementsMappedEntries_0(compiler::CodeAssemblerState* state_, TNode<SloppyArgumentsElements> p_o, TNode<IntPtrT> p_i, TNode<Union<Smi, TheHole>> p_v) {
  ...
  if (block6.is_used()) {
    ...
    tmp7 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp1}, TNode<IntPtrT>{tmp6});
    std::tie(tmp8, tmp9) = NewReference_Smi_OR_TheHole_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp0}, TNode<IntPtrT>{tmp7}).Flatten();
    CodeStubAssembler(state_).StoreReference<Union<Smi, TheHole>>(CodeStubAssembler::Reference{tmp8, tmp9}, p_v);
    ca_.Goto(&block10);
  }
...
TNode<JSArgumentsObject> DownCastForTorqueClass_JSArgumentsObject_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block7.is_used()) {
    ...
    tmp6 = FromConstexpr_uint32_constexpr_uint32_0(state_, CastIfEnumClass<uint32_t>(static_cast<InstanceType>(2123)));
...
TNode<SloppyArgumentsElements> DownCastForTorqueClass_SloppyArgumentsElements_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block7.is_used()) {
    ...
    tmp4 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    tmp5 = CodeStubAssembler(state_).LoadReference<Uint16T>(CodeStubAssembler::Reference{tmp1, tmp4});
    tmp6 = FromConstexpr_uint32_constexpr_uint32_0(state_, CastIfEnumClass<uint32_t>(static_cast<InstanceType>(220)));
    tmp7 = CodeStubAssembler(state_).Word32NotEqual(TNode<Uint32T>{tmp5}, TNode<Uint32T>{tmp6});
    ca_.Branch(tmp7, &block11, std::vector<compiler::Node*>{}, &block12, std::vector<compiler::Node*>{});
  }
...
TNode<AliasedArgumentsEntry> DownCastForTorqueClass_AliasedArgumentsEntry_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block7.is_used()) {
    ...
    tmp4 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    tmp5 = CodeStubAssembler(state_).LoadReference<Uint16T>(CodeStubAssembler::Reference{tmp1, tmp4});
    tmp6 = FromConstexpr_uint32_constexpr_uint32_0(state_, CastIfEnumClass<uint32_t>(static_cast<InstanceType>(142)));
    tmp7 = CodeStubAssembler(state_).Word32NotEqual(TNode<Uint32T>{tmp5}, TNode<Uint32T>{tmp6});
    ca_.Branch(tmp7, &block11, std::vector<compiler::Node*>{}, &block12, std::vector<compiler::Node*>{});
  }
...
TNode<FixedArray> NewFixedArray_ParameterValueIterator_0(compiler::CodeAssemblerState* state_, TNode<IntPtrT> p_length, TorqueStructParameterValueIterator_0 p_it) {
  ...
  if (block5.is_used()) {
    ...
    InitializeFieldsFromIterator_Object_ParameterValueIterator_0(state_, TorqueStructSlice_Object_MutableReference_Object_0{TNode<Union<HeapObject, TaggedIndex>>{tmp14}, TNode<IntPtrT>{tmp17}, TNode<IntPtrT>{tmp9}, TorqueStructUnsafe_0{}}, TorqueStructParameterValueIterator_0{TNode<IntPtrT>{p_it.mapped_count}, TorqueStructArguments{TNode<RawPtrT>{p_it.arguments.frame}, TNode<RawPtrT>{p_it.arguments.base}, TNode<IntPtrT>{p_it.arguments.length}, TNode<IntPtrT>{p_it.arguments.actual_count}}, TNode<IntPtrT>{p_it.current}});
    tmp18 = TORQUE_CAST(TNode<HeapObject>{tmp14});
    ca_.Goto(&block1, tmp18);
  }

  TNode<FixedArray> phi_bb1_7;
  if (block1.is_used()) {
    ca_.Bind(&block1, &phi_bb1_7);
    ca_.Goto(&block6, phi_bb1_7);
  }

  TNode<FixedArray> phi_bb6_7;
...
TNode<SloppyArgumentsElements> NewSloppyArgumentsElements_ParameterMapIterator_0(compiler::CodeAssemblerState* state_, TNode<Uint32T> p_length, TNode<Context> p_context, TNode<FixedArray> p_arguments, TorqueStructParameterMapIterator_0 p_it) {
  ...
  TNode<IntPtrT> tmp10;
  TNode<IntPtrT> tmp11;
  TNode<SloppyArgumentsElements> tmp12;
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = CodeStubAssembler(state_).GetClassMapConstant<SloppyArgumentsElements>();
    tmp1 = Convert_intptr_uint32_0(state_, TNode<Uint32T>{p_length});
    tmp2 = FromConstexpr_intptr_constexpr_int31_0(state_, 16);
    tmp3 = AddIndexedFieldSizeToObjectSize_0(state_, TNode<IntPtrT>{tmp2}, TNode<IntPtrT>{tmp1}, CastIfEnumClass<int32_t>(kTaggedSize));
    tmp4 = FromConstexpr_bool_constexpr_bool_0(state_, false);
    tmp5 = FromConstexpr_bool_constexpr_bool_0(state_, false);
    tmp6 = AllocateFromNew_0(state_, TNode<IntPtrT>{tmp3}, TNode<Map>{tmp0}, TNode<BoolT>{tmp4}, TNode<BoolT>{tmp5});
    ...
    CodeStubAssembler(state_).StoreReference<Uint32T>(CodeStubAssembler::Reference{tmp6, tmp8}, p_length);
    tmp9 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    CodeStubAssembler(state_).StoreReference<Context>(CodeStubAssembler::Reference{tmp6, tmp9}, p_context);
...
TNode<BoolT> OutOfBounds_Smi_uint32_0(compiler::CodeAssemblerState* state_, TNode<Smi> p_index, TNode<Uint32T> p_length) {
  ...
  if (block0.is_used()) {
    ...
    tmp2 = Convert_intptr_uint32_0(state_, TNode<Uint32T>{p_length});
...
void InitializeFieldsFromIterator_Smi_OR_TheHole_ParameterMapIterator_0(compiler::CodeAssemblerState* state_, TorqueStructSlice_Smi_OR_TheHole_MutableReference_Smi_OR_TheHole_0 p_target, TorqueStructParameterMapIterator_0 p_originIterator) {
  ...
  if (block17.is_used()) {
    ...
    CodeStubAssembler(state_).StoreReference<Union<Smi, TheHole>>(CodeStubAssembler::Reference{tmp4, tmp5}, tmp11);
