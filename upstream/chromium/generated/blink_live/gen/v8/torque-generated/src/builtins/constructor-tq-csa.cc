...
TF_BUILTIN(FastNewFunctionContextEval, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = ConstructorBuiltinsAssembler(state_).FastNewFunctionContext(TNode<ScopeInfo>{parameter1}, TNode<Uint32T>{parameter2}, TNode<Context>{parameter0}, ScopeType::EVAL_SCOPE, CastIfEnumClass<ContextMode>(ContextMode::kNoContextCells));
...
TF_BUILTIN(FastNewFunctionContextFunction, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = ConstructorBuiltinsAssembler(state_).FastNewFunctionContext(TNode<ScopeInfo>{parameter1}, TNode<Uint32T>{parameter2}, TNode<Context>{parameter0}, ScopeType::FUNCTION_SCOPE, CastIfEnumClass<ContextMode>(ContextMode::kNoContextCells));
    CodeStubAssembler(state_).Return(tmp0);
  }
}
...
TF_BUILTIN(FastNewFunctionContextFunctionWithCells, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = ConstructorBuiltinsAssembler(state_).FastNewFunctionContext(TNode<ScopeInfo>{parameter1}, TNode<Uint32T>{parameter2}, TNode<Context>{parameter0}, ScopeType::FUNCTION_SCOPE, CastIfEnumClass<ContextMode>(ContextMode::kHasContextCells));
    CodeStubAssembler(state_).Return(tmp0);
  }
}
...
TF_BUILTIN(CreateShallowArrayLiteral, CodeStubAssembler) {
  ...
  if (block3.is_used()) {
    ...
    tmp2 = ConstructorBuiltinsAssembler(state_).CreateShallowArrayLiteral(TNode<FeedbackVector>{tmp0}, TNode<TaggedIndex>{parameter2}, TNode<Context>{parameter0}, CastIfEnumClass<AllocationSiteMode>(AllocationSiteMode::TRACK_ALLOCATION_SITE), &label3);
    ca_.Goto(&block5);
    if (label3.is_used()) {
      ca_.Bind(&label3);
      ca_.Goto(&block6);
...
TF_BUILTIN(ObjectConstructor, CodeStubAssembler) {
  ...
  TNode<BoolT> phi_bb5_9;
  if (block5.is_used()) {
    ca_.Bind(&block5, &phi_bb5_9);
    ca_.Branch(phi_bb5_9, &block1, std::vector<compiler::Node*>{}, &block2, std::vector<compiler::Node*>{});
  }
  ...
  if (block11.is_used()) {
    ...
    ca_.Branch(phi_bb11_10, &block12, std::vector<compiler::Node*>{}, &block13, std::vector<compiler::Node*>{});
  }
  ...
  if (block14.is_used()) {
    ...
    ca_.Branch(phi_bb14_10, &block7, std::vector<compiler::Node*>{}, &block8, std::vector<compiler::Node*>{});
  }
...
TF_BUILTIN(NumberConstructor, CodeStubAssembler) {
  ...
  if (block1.is_used()) {
    ...
    tmp5 = CodeStubAssembler(state_).ToNumber(TNode<Context>{parameter0}, TNode<JSAny>{tmp4}, CastIfEnumClass<CodeStubAssembler::BigIntHandling>(CodeStubAssembler::BigIntHandling::kConvertToNumber));
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    arguments.PopAndReturn(phi_bb2_8);
  }
