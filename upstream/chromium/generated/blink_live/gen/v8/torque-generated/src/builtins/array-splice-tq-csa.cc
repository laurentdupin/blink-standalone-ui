...
// https://crsrc.org/c/v8/src/builtins/array-splice.tq?l=12&c=1
...
// https://crsrc.org/c/v8/src/builtins/array-splice.tq?l=20&c=1
...
// https://crsrc.org/c/v8/src/builtins/array-splice.tq?l=126&c=1
TNode<Int32T> TransitionElementsKindForInsertionIfNeeded_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSArray> p_a, TNode<Int32T> p_originalElementsKind, TorqueStructArguments p_args, IntegerLiteral p_argsStart) {
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    {
      ...
      pos_stack.push_back({"src/builtins/array-splice.tq", 129});
...
// https://crsrc.org/c/v8/src/builtins/array-splice.tq?l=160&c=1
...
// https://crsrc.org/c/v8/src/builtins/array-splice.tq?l=212&c=1
...
// https://crsrc.org/c/v8/src/builtins/array-splice.tq?l=245&c=1
void HandleForwardCase_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<Number> p_itemCount, TNode<Number> p_actualStart, TNode<Number> p_actualDeleteCount) {
  ...
  if (block6.is_used()) {
    ...
    tmp9 = FromConstexpr_LanguageModeSmi_constexpr_LanguageMode_0(state_, CastIfEnumClass<LanguageMode>(LanguageMode::kStrict));
  ...
  if (block8.is_used()) {
    ...
    tmp18 = FromConstexpr_LanguageModeSmi_constexpr_LanguageMode_0(state_, CastIfEnumClass<LanguageMode>(LanguageMode::kStrict));
...
// https://crsrc.org/c/v8/src/builtins/array-splice.tq?l=293&c=1
void HandleBackwardCase_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<Number> p_itemCount, TNode<Number> p_actualStart, TNode<Number> p_actualDeleteCount) {
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6, &phi_bb6_6);
    tmp13 = FromConstexpr_LanguageModeSmi_constexpr_LanguageMode_0(state_, CastIfEnumClass<LanguageMode>(LanguageMode::kStrict));
...
// https://crsrc.org/c/v8/src/builtins/array-splice.tq?l=330&c=1
...
TF_BUILTIN(ArrayPrototypeSplice, CodeStubAssembler) {
  ...
  if (block11.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{parameter0}, CastIfEnumClass<MessageTemplate>(MessageTemplate::kInvalidArrayLength), TNode<Object>{tmp30});
  }
...
// https://crsrc.org/c/v8/src/builtins/array-splice.tq?l=137&c=40
...
// https://crsrc.org/c/v8/src/builtins/array-splice.tq?l=153&c=47
...
// https://crsrc.org/c/v8/src/builtins/array-splice.tq?l=200&c=5
void FastSplice_FixedArray_JSAny_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArguments p_args, TNode<JSArray> p_a, TNode<Smi> p_length, TNode<Smi> p_newLength, TNode<Smi> p_actualStart, TNode<Smi> p_insertCount, TNode<Smi> p_actualDeleteCount) {
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    tmp12 = Convert_intptr_Smi_0(state_, TNode<Smi>{p_newLength});
    tmp13 = LoadFixedArrayBaseLengthIntptr_0(state_, TNode<FixedArrayBase>{tmp3});
  ...
  if (block10.is_used()) {
    ...
    tmp22 = CodeStubAssembler(state_).LoadReference<Uint32T>(CodeStubAssembler::Reference{tmp3, tmp21});
    tmp23 = FromConstexpr_uint32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    tmp24 = CodeStubAssembler(state_).Uint32GreaterThan(TNode<Uint32T>{tmp22}, TNode<Uint32T>{tmp23});
...
// https://crsrc.org/c/v8/src/builtins/array-splice.tq?l=204&c=5
...
// https://crsrc.org/c/v8/src/builtins/array-splice.tq?l=95&c=7
...
// https://crsrc.org/c/v8/src/builtins/array-splice.tq?l=97&c=7
...
// https://crsrc.org/c/v8/src/builtins/array-splice.tq?l=110&c=11
...
// https://crsrc.org/c/v8/src/builtins/array-splice.tq?l=89&c=22
TNode<Union<FixedArray, FixedDoubleArray>> UnsafeCast_FixedDoubleArray_OR_EmptyFixedArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o) {
  ...
  TNode<Union<FixedArray, FixedDoubleArray>> tmp1;
  if (block2.is_used()) {
    ca_.Bind(&block2);
    tmp1 = TORQUE_CAST(TNode<Object>{p_o});
    ca_.Goto(&block4);
    ...
    ca_.Bind(&block4);
  return TNode<Union<FixedArray, FixedDoubleArray>>{tmp1};
}
