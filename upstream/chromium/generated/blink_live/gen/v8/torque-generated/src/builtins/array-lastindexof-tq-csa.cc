...
TNode<JSAny> LoadWithHoleCheck_FixedDoubleArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArrayBase> p_elements, TNode<Smi> p_index, compiler::CodeAssemblerLabel* label_IfHole) {
  ...
  if (block17.is_used()) {
    ca_.Bind(&block17);
    tmp16 = CodeStubAssembler(state_).AllocateHeapNumberWithValue(TNode<Float64T>{tmp14});
...
TNode<Number> GetFromIndex_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Number> p_length, TorqueStructArguments p_arguments) {
  ...
  if (block3.is_used()) {
    ...
    tmp6 = ToInteger_Inline_0(state_, TNode<Context>{p_context}, TNode<JSAny>{tmp5});
...
TNode<JSAny> TryFastArrayLastIndexOf_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_receiver, TNode<JSAny> p_searchElement, TNode<Number> p_from, compiler::CodeAssemblerLabel* label_Slow) {
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    tmp12 = FastArrayLastIndexOf_FixedArray_0(state_, TNode<Context>{p_context}, TNode<JSArray>{tmp0}, TNode<Smi>{tmp6}, TNode<JSAny>{p_searchElement});
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    {
      ...
      pos_stack.push_back({"src/builtins/array-lastindexof.tq", 100});
  ...
  if (block11.is_used()) {
    ca_.Bind(&block11);
    tmp14 = FastArrayLastIndexOf_FixedDoubleArray_0(state_, TNode<Context>{p_context}, TNode<JSArray>{tmp0}, TNode<Smi>{tmp6}, TNode<JSAny>{p_searchElement});
...
TF_BUILTIN(ArrayPrototypeLastIndexOf, CodeStubAssembler) {
  ...
  if (block2.is_used()) {
    ...
    tmp8 = TryFastArrayLastIndexOf_0(state_, TNode<Context>{parameter0}, TNode<JSReceiver>{tmp0}, TNode<JSAny>{tmp7}, TNode<Number>{tmp5}, &label9);
    ca_.Goto(&block5);
    if (label9.is_used()) {
      ca_.Bind(&label9);
      ca_.Goto(&block6);
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    tmp10 = GenericArrayLastIndexOf_0(state_, TNode<Context>{parameter0}, TNode<JSReceiver>{tmp0}, TNode<JSAny>{tmp7}, TNode<Number>{tmp5});
...
TNode<Smi> FastArrayLastIndexOf_FixedArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSArray> p_array, TNode<Smi> p_from, TNode<JSAny> p_searchElement) {
  ...
  if (block0.is_used()) {
    ...
    tmp2 = LoadFixedArrayBaseLengthIntptr_0(state_, TNode<FixedArrayBase>{tmp1});
  ...
  if (block2.is_used()) {
    ...
    tmp6 = CodeStubAssembler(state_).SmiSub(TNode<Smi>{tmp3}, TNode<Smi>{tmp5});
  ...
  if (block6.is_used()) {
    ...
    tmp8 = CodeStubAssembler(state_).SmiGreaterThanOrEqual(TNode<Smi>{phi_bb6_6}, TNode<Smi>{tmp7});
  ...
  if (block4.is_used()) {
    ...
    tmp9 = LoadWithHoleCheck_FixedArray_0(state_, TNode<Context>{p_context}, TNode<FixedArrayBase>{tmp1}, TNode<Smi>{phi_bb4_6}, &label10);
    ca_.Goto(&block9, phi_bb4_6, phi_bb4_6);
    if (label10.is_used()) {
      ca_.Bind(&label10);
      ca_.Goto(&block10, phi_bb4_6, phi_bb4_6);
    }
  }
  ...
  if (block9.is_used()) {
    ...
    tmp11 = CodeStubAssembler(state_).StrictEqual(TNode<JSAny>{p_searchElement}, TNode<JSAny>{tmp9});
    tmp12 = True_0(state_);
    tmp13 = CodeStubAssembler(state_).TaggedEqual(TNode<Union<Context, FixedArrayBase, FunctionTemplateInfo, Hole, JSReceiver, Map, Oddball, String, Symbol, WasmFuncRef, WasmNull, WeakCell>>{tmp11}, TNode<Union<Context, FixedArrayBase, FunctionTemplateInfo, Hole, JSReceiver, Map, Oddball, String, Symbol, WasmFuncRef, WasmNull, WeakCell>>{tmp12});
    ca_.Branch(tmp13, &block11, std::vector<compiler::Node*>{phi_bb9_6}, &block12, std::vector<compiler::Node*>{phi_bb9_6});
  }
  ...
  if (block11.is_used()) {
    ...
    tmp14 = Is_FastJSArray_JSArray_0(state_, TNode<Context>{p_context}, TNode<JSArray>{p_array});
    ca_.Branch(tmp14, &block13, std::vector<compiler::Node*>{phi_bb11_6}, &block14, std::vector<compiler::Node*>{phi_bb11_6});
  }
  ...
  if (block14.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/array-lastindexof.tq", 54});
  ...
  if (block13.is_used()) {
    ...
    ca_.Goto(&block1, phi_bb13_6);
  }

  TNode<Smi> phi_bb12_6;
  if (block12.is_used()) {
    ca_.Bind(&block12, &phi_bb12_6);
    ca_.Goto(&block7, phi_bb12_6);
  }
  ...
  if (block7.is_used()) {
    ...
    tmp16 = CodeStubAssembler(state_).SmiSub(TNode<Smi>{phi_bb7_6}, TNode<Smi>{tmp15});
  ...
  if (block5.is_used()) {
    ...
    tmp17 = Is_FastJSArray_JSArray_0(state_, TNode<Context>{p_context}, TNode<JSArray>{p_array});
    ca_.Branch(tmp17, &block15, std::vector<compiler::Node*>{phi_bb5_6}, &block16, std::vector<compiler::Node*>{phi_bb5_6});
  }
  ...
  if (block16.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/array-lastindexof.tq", 62});
      CodeStubAssembler(state_).FailAssert("Torque assert 'Is<FastJSArray>(array)' failed", pos_stack);
    }
  }
  ...
  if (block15.is_used()) {
    ...
    tmp18 = FromConstexpr_Smi_constexpr_IntegerLiteral_0(state_, IntegerLiteral(true, 0x1ull));
...
TNode<Smi> FastArrayLastIndexOf_FixedDoubleArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSArray> p_array, TNode<Smi> p_from, TNode<JSAny> p_searchElement) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4, &phi_bb4_6);
    compiler::CodeAssemblerLabel label10(&ca_);
    tmp9 = LoadWithHoleCheck_FixedDoubleArray_0(state_, TNode<Context>{p_context}, TNode<FixedArrayBase>{tmp1}, TNode<Smi>{phi_bb4_6}, &label10);
    ca_.Goto(&block9, phi_bb4_6, phi_bb4_6);
    if (label10.is_used()) {
      ca_.Bind(&label10);
      ca_.Goto(&block10, phi_bb4_6, phi_bb4_6);
