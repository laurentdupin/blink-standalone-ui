...
TF_BUILTIN(ArrayForEachLoopEagerDeoptContinuation, CodeStubAssembler) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-foreach.tq:12:59");
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-foreach.tq:13:57");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-foreach.tq:14:52");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-foreach.tq:15:55");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block15.is_used()) {
    ...
    tmp10 = ca_.CallBuiltin<JSAny>(Builtin::kArrayForEachLoopContinuation, parameter0, tmp0, tmp2, parameter3, tmp8, tmp0, tmp4, tmp6, tmp9);
...
TF_BUILTIN(ArrayForEachLoopLazyDeoptContinuation, CodeStubAssembler) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-foreach.tq:28:59");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-foreach.tq:29:57");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-foreach.tq:30:52");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-foreach.tq:31:55");
    CodeStubAssembler(state_).Unreachable();
  }
...
TF_BUILTIN(ArrayForEachLoopContinuation, CodeStubAssembler) {
  ...
  USE(parameter6);
  TNode<Number> parameter7 = UncheckedParameter<Number>(Descriptor::kLen);
  USE(parameter7);
  TNode<JSAny> parameter8 = UncheckedParameter<JSAny>(Descriptor::kTo);
  USE(parameter8);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
// https://crsrc.org/c/v8/src/builtins/array-foreach.tq?l=68&c=1
TNode<JSAny> FastArrayForEach_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<Union<JSBoundFunction, JSFunction, JSObject, JSProxy, JSWrappedFunction>> p_callbackfn, TNode<JSAny> p_thisArg, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_0) {
  ...
  if (block14.is_used()) {
    ...
    tmp26 = CodeStubAssembler(state_).SmiAdd(TNode<Smi>{phi_bb14_5}, TNode<Smi>{tmp25});
    ca_.Goto(&block13, tmp26, tmp17);
  }
...
TF_BUILTIN(ArrayForEach, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = RequireObjectCoercible_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, "Array.prototype.forEach");
  ...
  if (block5.is_used()) {
    ...
    tmp12 = FastArrayForEach_0(state_, TNode<Context>{parameter0}, TNode<JSReceiver>{tmp1}, TNode<Number>{tmp2}, TNode<Union<JSBoundFunction, JSFunction, JSObject, JSProxy, JSWrappedFunction>>{tmp7}, TNode<JSAny>{tmp10}, &label13, &tmp14);
    ca_.Goto(&block9);
    if (label13.is_used()) {
      ca_.Bind(&label13);
      ca_.Goto(&block10);
  ...
  if (block10.is_used()) {
    ...
    tmp17 = ca_.CallBuiltin<JSAny>(Builtin::kArrayForEachLoopContinuation, parameter0, tmp1, tmp7, tmp10, tmp15, tmp1, tmp14.value(), tmp2, tmp16);
