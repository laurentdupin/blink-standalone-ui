...
// https://crsrc.org/c/v8/src/builtins/array-to-reversed.tq?l=7&c=1
TNode<JSArray> FastPackedDoubleArrayToReversed_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedDoubleArray> p_elements, TNode<Smi> p_length) {
  ...
  if (block0.is_used()) {
    ...
    tmp1 = CodeStubAssembler(state_).AllocateFixedArray(CastIfEnumClass<ElementsKind>(ElementsKind::PACKED_DOUBLE_ELEMENTS), TNode<IntPtrT>{tmp0});
  ...
  if (block13.is_used()) {
    ...
    std::tie(tmp19, tmp20, tmp21) = LoadFloat64OrUndefinedOrHole_0(state_, TorqueStructReference_float64_or_undefined_or_hole_0{TNode<Union<HeapObject, TaggedIndex>>{tmp17}, TNode<IntPtrT>{tmp18}, TorqueStructUnsafe_0{}}).Flatten();
  ...
  if (block19.is_used()) {
    ...
    ca_.Branch(tmp20, &block20, std::vector<compiler::Node*>{phi_bb19_4}, &block21, std::vector<compiler::Node*>{phi_bb19_4});
  }

  TNode<Smi> phi_bb20_4;
  if (block20.is_used()) {
    ca_.Bind(&block20, &phi_bb20_4);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-to-reversed.tq:27:22");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block21.is_used()) {
    ...
    CodeStubAssembler(state_).StoreFixedDoubleArrayElement(TNode<FixedDoubleArray>{tmp2}, TNode<Smi>{phi_bb21_4}, TNode<Float64T>{tmp21});
    tmp22 = FromConstexpr_Smi_constexpr_int31_0(state_, 1);
    tmp23 = CodeStubAssembler(state_).SmiAdd(TNode<Smi>{phi_bb21_4}, TNode<Smi>{tmp22});
  ...
  if (block3.is_used()) {
    ...
    tmp24 = CodeStubAssembler(state_).LoadNativeContext(TNode<Context>{p_context});
    tmp25 = CodeStubAssembler(state_).LoadJSArrayElementsMap(CastIfEnumClass<ElementsKind>(ElementsKind::PACKED_DOUBLE_ELEMENTS), TNode<NativeContext>{tmp24});
    tmp26 = NewJSArray_0(state_, TNode<Context>{p_context}, TNode<Map>{tmp25}, TNode<FixedArrayBase>{tmp2});
    ca_.Goto(&block22);
  }

    ca_.Bind(&block22);
  return TNode<JSArray>{tmp26};
}

// https://crsrc.org/c/v8/src/builtins/array-to-reversed.tq?l=81&c=1
TNode<JSArray> TryFastArrayToReversed_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSAny> p_receiver, compiler::CodeAssemblerLabel* label_Slow) {
  ...
  if (block7.is_used()) {
    ...
    tmp16 = FastArrayToReversed_FixedArray_0(state_, TNode<Context>{p_context}, CastIfEnumClass<ElementsKind>(ElementsKind::PACKED_SMI_ELEMENTS), TNode<FixedArray>{tmp14}, TNode<Smi>{tmp15}, false);
  ...
  if (block10.is_used()) {
    ...
    tmp23 = FastArrayToReversed_FixedArray_0(state_, TNode<Context>{p_context}, CastIfEnumClass<ElementsKind>(ElementsKind::PACKED_ELEMENTS), TNode<FixedArray>{tmp21}, TNode<Smi>{tmp22}, false);
  ...
  if (block20.is_used()) {
    ...
    tmp45 = FastArrayToReversed_FixedArray_0(state_, TNode<Context>{p_context}, CastIfEnumClass<ElementsKind>(ElementsKind::PACKED_ELEMENTS), TNode<FixedArray>{tmp43}, TNode<Smi>{tmp44}, false);
  ...
  if (block26.is_used()) {
    ...
    tmp52 = FastArrayToReversed_FixedDoubleArray_0(state_, TNode<Context>{p_context}, CastIfEnumClass<ElementsKind>(ElementsKind::PACKED_ELEMENTS), TNode<FixedDoubleArray>{tmp50}, TNode<Smi>{tmp51}, true);
...
// https://crsrc.org/c/v8/src/builtins/array-to-reversed.tq?l=89&c=12
...
// https://crsrc.org/c/v8/src/builtins/array-to-reversed.tq?l=109&c=14
TNode<JSArray> FastArrayToReversed_FixedDoubleArray_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, ElementsKind p_kind, TNode<FixedDoubleArray> p_elements, TNode<Smi> p_length, bool p_initializeArray) {
  ...
  TNode<Smi> tmp10;
  TNode<Smi> tmp11;
  TNode<Union<HeapNumber, Smi, Undefined>> tmp12;
  TNode<Smi> tmp13;
  TNode<Smi> tmp14;
  if (block6.is_used()) {
    ca_.Bind(&block6, &phi_bb6_4);
...
// https://crsrc.org/c/v8/src/builtins/array-to-reversed.tq?l=52&c=12
