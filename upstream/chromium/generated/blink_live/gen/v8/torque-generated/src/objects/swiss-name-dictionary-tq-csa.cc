...
// https://crsrc.org/c/v8/src/objects/swiss-name-dictionary.tq?l=7&c=1
...
TNode<IntPtrT> SwissNameDictionaryCapacityFor_0(compiler::CodeAssemblerState* state_, TNode<IntPtrT> p_atLeastSpaceFor) {
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    tmp7 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x4ull));
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    tmp8 = FromConstexpr_bool_constexpr_bool_0(state_, (CodeStubAssembler(state_).ConstexprInt32Equal(swiss_table::Group::kWidth, (FromConstexpr_constexpr_int32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x10ull))))));
  ...
  if (block10.is_used()) {
    ca_.Bind(&block10);
    tmp9 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x4ull));
    tmp10 = CodeStubAssembler(state_).WordEqual(TNode<IntPtrT>{p_atLeastSpaceFor}, TNode<IntPtrT>{tmp9});
  ...
  if (block14.is_used()) {
    ca_.Bind(&block14);
    {
      ...
      pos_stack.push_back({"src/objects/swiss-name-dictionary.tq", 70});
      CodeStubAssembler(state_).FailAssert("Torque assert 'atLeastSpaceFor == 4' failed", pos_stack);
    }
  }
  ...
  if (block13.is_used()) {
    ca_.Bind(&block13);
    tmp11 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x4ull));
  ...
  if (block11.is_used()) {
    ca_.Bind(&block11);
    tmp12 = FromConstexpr_bool_constexpr_bool_0(state_, (CodeStubAssembler(state_).ConstexprInt32Equal(swiss_table::Group::kWidth, (FromConstexpr_constexpr_int32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x8ull))))));
  ...
  if (block15.is_used()) {
    ca_.Bind(&block15);
    tmp13 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x4ull));
    tmp14 = CodeStubAssembler(state_).WordEqual(TNode<IntPtrT>{p_atLeastSpaceFor}, TNode<IntPtrT>{tmp13});
  ...
  if (block18.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/objects/swiss-name-dictionary.tq", 73});
      CodeStubAssembler(state_).FailAssert("Torque assert 'atLeastSpaceFor == 4' failed", pos_stack);
    }
  }
  ...
  if (block17.is_used()) {
    ca_.Bind(&block17);
    tmp15 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x8ull));
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    tmp16 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x7ull));
    tmp17 = CodeStubAssembler(state_).IntPtrDiv(TNode<IntPtrT>{p_atLeastSpaceFor}, TNode<IntPtrT>{tmp16});
    tmp18 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{p_atLeastSpaceFor}, TNode<IntPtrT>{tmp17});
    tmp19 = CodeStubAssembler(state_).IntPtrRoundUpToPowerOfTwo32(TNode<IntPtrT>{tmp18});
...
TNode<IntPtrT> SwissNameDictionaryMaxUsableCapacity_0(compiler::CodeAssemblerState* state_, TNode<IntPtrT> p_capacity) {
  ...
  if (block0.is_used()) {
    ...
    tmp1 = CodeStubAssembler(state_).WordEqual(TNode<IntPtrT>{p_capacity}, TNode<IntPtrT>{tmp0});
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    tmp3 = FromConstexpr_intptr_constexpr_int32_0(state_, SwissNameDictionary::kInitialCapacity);
    tmp4 = CodeStubAssembler(state_).IntPtrGreaterThanOrEqual(TNode<IntPtrT>{p_capacity}, TNode<IntPtrT>{tmp3});
  ...
  if (block3.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/objects/swiss-name-dictionary.tq", 85});
      CodeStubAssembler(state_).FailAssert("Torque assert 'capacity == 0 || capacity >= kSwissNameDictionaryInitialCapacity' failed", pos_stack);
    }
  }
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    tmp5 = FromConstexpr_bool_constexpr_bool_0(state_, (CodeStubAssembler(state_).ConstexprInt32Equal(swiss_table::Group::kWidth, (FromConstexpr_constexpr_int32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x8ull))))));
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    tmp6 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x4ull));
    tmp7 = CodeStubAssembler(state_).WordEqual(TNode<IntPtrT>{p_capacity}, TNode<IntPtrT>{tmp6});
  ...
  if (block11.is_used()) {
    ...
    ca_.Branch(phi_bb11_2, &block7, std::vector<compiler::Node*>{}, &block8, std::vector<compiler::Node*>{});
  }

  TNode<IntPtrT> tmp9;
  if (block7.is_used()) {
    ca_.Bind(&block7);
    tmp9 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x3ull));
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    tmp10 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x8ull));
    tmp11 = CodeStubAssembler(state_).IntPtrDiv(TNode<IntPtrT>{p_capacity}, TNode<IntPtrT>{tmp10});
    tmp12 = CodeStubAssembler(state_).IntPtrSub(TNode<IntPtrT>{p_capacity}, TNode<IntPtrT>{tmp11});
...
TNode<IntPtrT> SwissNameDictionarySizeFor_0(compiler::CodeAssemblerState* state_, TNode<IntPtrT> p_capacity) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, (CodeStubAssembler(state_).ConstexprInt31Add((CodeStubAssembler(state_).ConstexprInt31Mul((FromConstexpr_constexpr_int31_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x2ull))), kTaggedSize)), (FromConstexpr_constexpr_int31_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x2ull))))));
    ...
    tmp4 = FromConstexpr_intptr_constexpr_int32_0(state_, (CodeStubAssembler(state_).ConstexprInt32Add((CodeStubAssembler(state_).ConstexprInt32Add(HeapObject::kHeaderSize, (FromConstexpr_constexpr_int32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x8ull))))), CastIfEnumClass<int32_t>(kTaggedSize))));
...
TNode<IntPtrT> SwissNameDictionaryMetaTableSizePerEntryFor_0(compiler::CodeAssemblerState* state_, TNode<IntPtrT> p_capacity) {
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    tmp5 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x2ull));
...
// https://crsrc.org/c/v8/src/objects/swiss-name-dictionary.tq?l=145&c=1
TorqueStructProbeSequence_0 Probe_0(compiler::CodeAssemblerState* state_, TNode<Uint32T> p_hash, TNode<Uint32T> p_mask) {
  ...
  if (block0.is_used()) {
    ...
    tmp1 = CodeStubAssembler(state_).Uint32Add(TNode<Uint32T>{p_mask}, TNode<Uint32T>{tmp0});
    tmp2 = CodeStubAssembler(state_).Word32And(TNode<Uint32T>{tmp1}, TNode<Uint32T>{p_mask});
  ...
  if (block3.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/objects/swiss-name-dictionary.tq", 147});
      CodeStubAssembler(state_).FailAssert("Torque assert '((mask + 1) & mask) == 0' failed", pos_stack);
    }
  }
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    tmp5 = H1_0(state_, TNode<Uint32T>{p_hash});
    tmp6 = CodeStubAssembler(state_).Word32And(TNode<Uint32T>{tmp5}, TNode<Uint32T>{p_mask});
    tmp7 = FromConstexpr_uint32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    ca_.Goto(&block4);
  }

    ca_.Bind(&block4);
  return TorqueStructProbeSequence_0{TNode<Uint32T>{p_mask}, TNode<Uint32T>{tmp6}, TNode<Uint32T>{tmp7}};
}
...
// https://crsrc.org/c/v8/src/objects/swiss-name-dictionary.tq?l=12&c=3
void StoreSwissNameDictionaryDataTable_0(compiler::CodeAssemblerState* state_, TNode<SwissNameDictionary> p_o, TNode<IntPtrT> p_i, TNode<Union<BigInt, Boolean, HeapNumber, JSReceiver, Null, Smi, String, Symbol, TheHole, Undefined>> p_v) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block6(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
TNode<SwissNameDictionary> DownCastForTorqueClass_SwissNameDictionary_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block7.is_used()) {
    ...
    tmp6 = FromConstexpr_uint32_constexpr_uint32_0(state_, CastIfEnumClass<uint32_t>(static_cast<InstanceType>(280)));
...
// https://crsrc.org/c/v8/src/objects/swiss-name-dictionary.tq?l=281&c=3
void FindEntry_GroupSse2Loader_0(compiler::CodeAssemblerState* state_, TNode<SwissNameDictionary> p_table, TNode<Name> p_key, compiler::CodeAssemblerLabel* label_Found, compiler::TypedCodeAssemblerVariable<IntPtrT>* label_Found_parameter_0, compiler::CodeAssemblerLabel* label_NotFound) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = CodeStubAssembler(state_).LoadNameHashAssumeComputed(TNode<Name>{p_key});
  ...
  if (block8.is_used()) {
    ...
    tmp37 = CodeStubAssembler(state_).TaggedEqual(TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{p_key}, TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp36});
  ...
  if (block4.is_used()) {
    ...
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/objects/swiss-name-dictionary.tq:185:3");
    CodeStubAssembler(state_).Unreachable();
  }
}

// https://crsrc.org/c/v8/src/objects/swiss-name-dictionary.tq?l=289&c=3
void FindEntry_GroupPortableLoader_0(compiler::CodeAssemblerState* state_, TNode<SwissNameDictionary> p_table, TNode<Name> p_key, compiler::CodeAssemblerLabel* label_Found, compiler::TypedCodeAssemblerVariable<IntPtrT>* label_Found_parameter_0, compiler::CodeAssemblerLabel* label_NotFound) {
  ...
  if (block10.is_used()) {
    ca_.Bind(&block10, &phi_bb10_8, &phi_bb10_9, &phi_bb10_11);
    tmp32 = FromConstexpr_uint64_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
  ...
  if (block8.is_used()) {
    ...
    tmp44 = CodeStubAssembler(state_).TaggedEqual(TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{p_key}, TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp43});
  ...
  if (block9.is_used()) {
    ...
    tmp47 = FromConstexpr_uint64_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x6ull));
    ...
    tmp52 = FromConstexpr_uint64_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
...
// https://crsrc.org/c/v8/src/objects/swiss-name-dictionary.tq?l=304&c=3
void Add_GroupSse2Loader_0(compiler::CodeAssemblerState* state_, TNode<SwissNameDictionary> p_table, TNode<Name> p_key, TNode<Object> p_value, TNode<Uint8T> p_propertyDetails, compiler::CodeAssemblerLabel* label_Bailout) {
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    tmp10 = CodeStubAssembler(state_).LoadNameHashAssumeComputed(TNode<Name>{p_key});
...
// https://crsrc.org/c/v8/src/objects/swiss-name-dictionary.tq?l=312&c=3
...
TNode<Int32T> FindFirstEmpty_GroupSse2Loader_0(compiler::CodeAssemblerState* state_, TNode<SwissNameDictionary> p_table, TNode<IntPtrT> p_capacity, TNode<Uint32T> p_hash) {
  ...
  if (block3.is_used()) {
    ...
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/objects/swiss-name-dictionary.tq:210:3");
    CodeStubAssembler(state_).Unreachable();
  }
...
TNode<Int32T> FindFirstEmpty_GroupPortableLoader_0(compiler::CodeAssemblerState* state_, TNode<SwissNameDictionary> p_table, TNode<IntPtrT> p_capacity, TNode<Uint32T> p_hash) {
  ...
  if (block2.is_used()) {
    ...
    tmp19 = FromConstexpr_uint64_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x6ull));
    ...
    tmp24 = FromConstexpr_uint64_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
