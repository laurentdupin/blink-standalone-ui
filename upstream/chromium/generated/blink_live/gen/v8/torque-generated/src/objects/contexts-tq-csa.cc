...
TNode<Context> AllocateSyntheticFunctionContext_1(compiler::CodeAssemblerState* state_, TNode<NativeContext> p_nativeContext, TNode<IntPtrT> p_slots) {
  ...
  if (block0.is_used()) {
    ...
    CodeStubAssembler(state_).StaticAssert(TNode<BoolT>{tmp1}, "static_assert(slots >= ContextSlot::MIN_CONTEXT_SLOTS) at https://crsrc.org/c/v8/src/objects/contexts.tq?l=73&c=3");
...
TNode<IntPtrT> ITERATOR_ZIP_KEYED_HELPER_MAP_INDEX_0(compiler::CodeAssemblerState* state_) {
  ...
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ...
    ca_.Bind(&block0);
  TNode<IntPtrT> tmp0;
    tmp0 = FromConstexpr_ContextSlot_constexpr_ITERATOR_ZIP_KEYED_HELPER_MAP_INDEX_0(state_, Context::Field::ITERATOR_ZIP_KEYED_HELPER_MAP_INDEX);
  TNode<IntPtrT> tmp1;
    tmp1 = (TNode<IntPtrT>{tmp0});
  return TNode<IntPtrT>{tmp1};}
...
TNode<Object> LoadContextElementNoCellImpl_0(compiler::CodeAssemblerState* state_, TNode<Context> p_c, TNode<IntPtrT> p_i) {
  ...
  if (block6.is_used()) {
    ...
    tmp11 = Cast_TheHole_0(state_, TNode<Object>{tmp10}, &label12);
    ca_.Goto(&block15);
    if (label12.is_used()) {
      ca_.Bind(&label12);
      ca_.Goto(&block16);
  ...
  if (block15.is_used()) {
    ...
    ca_.Goto(&block12, tmp14);
  }

  TNode<BoolT> phi_bb12_5;
  if (block12.is_used()) {
    ca_.Bind(&block12, &phi_bb12_5);
    ca_.Branch(phi_bb12_5, &block17, std::vector<compiler::Node*>{}, &block18, std::vector<compiler::Node*>{});
  }
  ...
  if (block18.is_used()) {
    ...
    tmp16 = CodeStubAssembler(state_).TaggedToHeapObject(TNode<Object>{tmp10}, &label17);
    ca_.Goto(&block24);
    if (label17.is_used()) {
      ca_.Bind(&label17);
      ca_.Goto(&block25);
  ...
  if (block24.is_used()) {
    ...
    tmp18 = Cast_ContextCell_0(state_, TNode<HeapObject>{tmp16}, &label19);
    ca_.Goto(&block26);
    if (label19.is_used()) {
      ca_.Bind(&label19);
      ca_.Goto(&block27);
  ...
  if (block20.is_used()) {
    ...
    tmp22 = CodeStubAssembler(state_).Word32BinaryNot(TNode<BoolT>{phi_bb20_6});
    ca_.Goto(&block19, tmp22);
  }

  TNode<BoolT> phi_bb19_4;
  if (block19.is_used()) {
    ca_.Bind(&block19, &phi_bb19_4);
    ca_.Branch(phi_bb19_4, &block10, std::vector<compiler::Node*>{}, &block11, std::vector<compiler::Node*>{});
  }
  ...
  if (block11.is_used()) {
    ca_.Bind(&block11);
    {
      ...
      pos_stack.push_back({"src/objects/contexts.tq", 284});
      CodeStubAssembler(state_).FailAssert("Torque assert 'Is<TheHole>(val) || !Is<ContextCell>(val)' failed", pos_stack);
    }
  }
...
void StoreContextElementNoCellImpl_0(compiler::CodeAssemblerState* state_, TNode<Context> p_c, TNode<IntPtrT> p_i, TNode<Object> p_o) {
  ...
  if (block18.is_used()) {
    ...
    tmp19 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{p_i});
  ...
  if (block24.is_used()) {
    ca_.Bind(&block24);
    tmp22 = TimesSizeOf_Object_0(state_, TNode<IntPtrT>{p_i});
    ...
    tmp27 = CodeStubAssembler(state_).TaggedToHeapObject(TNode<Object>{tmp26}, &label28);
    ca_.Goto(&block32);
    if (label28.is_used()) {
      ca_.Bind(&label28);
      ca_.Goto(&block33);
  ...
  TNode<ContextCell> tmp29;
  if (block32.is_used()) {
    ca_.Bind(&block32);
    compiler::CodeAssemblerLabel label30(&ca_);
    tmp29 = Cast_ContextCell_0(state_, TNode<HeapObject>{tmp27}, &label30);
    ca_.Goto(&block34);
    if (label30.is_used()) {
      ca_.Bind(&label30);
      ca_.Goto(&block35);
  ...
  if (block28.is_used()) {
    ...
    tmp33 = CodeStubAssembler(state_).Word32BinaryNot(TNode<BoolT>{phi_bb28_6});
    ca_.Goto(&block19, tmp33);
  }

  TNode<BoolT> phi_bb19_4;
  if (block19.is_used()) {
    ca_.Bind(&block19, &phi_bb19_4);
    ca_.Branch(phi_bb19_4, &block2, std::vector<compiler::Node*>{}, &block3, std::vector<compiler::Node*>{});
  }
  ...
  if (block3.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/objects/contexts.tq", 289});
      CodeStubAssembler(state_).FailAssert("Torque assert 'Is<TheHole>(c.elements[i]) || !Is<ContextCell>(c.elements[i])' failed", pos_stack);
    }
  }
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    std::tie(tmp34, tmp35, tmp36) = FieldSliceContextElements_0(state_, TNode<Context>{p_c}).Flatten();
    tmp37 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{p_i});
    tmp38 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp36});
  ...
  if (block40.is_used()) {
    ca_.Bind(&block40);
    tmp40 = TimesSizeOf_Object_0(state_, TNode<IntPtrT>{p_i});
    tmp41 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp35}, TNode<IntPtrT>{tmp40});
    std::tie(tmp42, tmp43) = NewReference_Object_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp34}, TNode<IntPtrT>{tmp41}).Flatten();
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp42, tmp43}, p_o);
    ca_.Goto(&block44);
  }
...
TF_BUILTIN(LoadFromContextCell, CodeStubAssembler) {
  ...
  if (block4.is_used()) {
    ...
    ca_.Branch(phi_bb4_7, &block2, std::vector<compiler::Node*>{}, &block3, std::vector<compiler::Node*>{});
  }
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    tmp6 = TORQUE_CAST(TNode<Object>{parameter1});
    tmp7 = CodeStubAssembler(state_).SmiUntag(TNode<Smi>{parameter2});
    tmp8 = LoadContextElementImpl_0(state_, TNode<Context>{tmp6}, TNode<IntPtrT>{tmp7});
...
TF_BUILTIN(StoreContextElementBaseline, CodeStubAssembler) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, IntPtrT> block12(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Context> block19(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Context> block20(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, IntPtrT> block13(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
  ...
  if (block4.is_used()) {
    ...
    ca_.Branch(phi_bb4_8, &block2, std::vector<compiler::Node*>{}, &block3, std::vector<compiler::Node*>{});
  }
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    tmp6 = TORQUE_CAST(TNode<Object>{parameter0});
    tmp7 = CodeStubAssembler(state_).TaggedIndexToIntPtr(TNode<TaggedIndex>{parameter3});
    ca_.Goto(&block14, tmp6, tmp7);
  }
  ...
  if (block14.is_used()) {
    ...
    tmp9 = CodeStubAssembler(state_).IntPtrGreaterThan(TNode<IntPtrT>{phi_bb14_5}, TNode<IntPtrT>{tmp8});
    ca_.Branch(tmp9, &block12, std::vector<compiler::Node*>{phi_bb14_4, phi_bb14_5}, &block13, std::vector<compiler::Node*>{phi_bb14_4, phi_bb14_5});
  }

  TNode<Context> phi_bb12_4;
  ...
  if (block12.is_used()) {
    ...
    tmp11 = CodeStubAssembler(state_).IntPtrSub(TNode<IntPtrT>{phi_bb12_5}, TNode<IntPtrT>{tmp10});
    std::tie(tmp12, tmp13, tmp14) = FieldSliceContextElements_0(state_, TNode<Context>{phi_bb12_4}).Flatten();
    tmp15 = PREVIOUS_INDEX_0(state_);
    ...
    ca_.Branch(tmp18, &block19, std::vector<compiler::Node*>{phi_bb12_4, phi_bb12_4}, &block20, std::vector<compiler::Node*>{phi_bb12_4, phi_bb12_4});
  }

  TNode<Context> phi_bb19_4;
  TNode<Context> phi_bb19_6;
  TNode<IntPtrT> tmp19;
  TNode<IntPtrT> tmp20;
  ...
  if (block19.is_used()) {
    ...
    tmp24 = UnsafeCast_Context_0(state_, TNode<Context>{phi_bb19_4}, TNode<Object>{tmp23});
    ca_.Goto(&block14, tmp24, tmp11);
  }

  TNode<Context> phi_bb20_4;
  TNode<Context> phi_bb20_6;
  if (block20.is_used()) {
    ca_.Bind(&block20, &phi_bb20_4, &phi_bb20_6);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/torque-internal.tq:113:45");
    CodeStubAssembler(state_).Unreachable();
  }

  TNode<Context> phi_bb13_4;
  TNode<IntPtrT> phi_bb13_5;
  TNode<IntPtrT> tmp25;
  TNode<Undefined> tmp26;
  if (block13.is_used()) {
    ca_.Bind(&block13, &phi_bb13_4, &phi_bb13_5);
    tmp25 = CodeStubAssembler(state_).SmiUntag(TNode<Smi>{parameter2});
    StoreScriptContextElementImpl_0(state_, TNode<Context>{phi_bb13_4}, TNode<IntPtrT>{tmp25}, TNode<Object>{parameter1});
...
TF_BUILTIN(DetachContextCell, CodeStubAssembler) {
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    tmp6 = TORQUE_CAST(TNode<Object>{parameter0});
    std::tie(tmp7, tmp8, tmp9) = FieldSliceContextElements_0(state_, TNode<Context>{tmp6}).Flatten();
    tmp10 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{parameter2});
  ...
  if (block18.is_used()) {
    ca_.Bind(&block18);
    tmp13 = TimesSizeOf_Object_0(state_, TNode<IntPtrT>{parameter2});
    tmp14 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp8}, TNode<IntPtrT>{tmp13});
    std::tie(tmp15, tmp16) = NewReference_Object_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp7}, TNode<IntPtrT>{tmp14}).Flatten();
    tmp17 = CodeStubAssembler(state_).LoadReference<Object>(CodeStubAssembler::Reference{tmp15, tmp16});
    compiler::CodeAssemblerLabel label19(&ca_);
    tmp18 = CodeStubAssembler(state_).TaggedToHeapObject(TNode<Object>{tmp17}, &label19);
    ca_.Goto(&block23);
    if (label19.is_used()) {
      ca_.Bind(&label19);
      ca_.Goto(&block24);
  ...
  if (block23.is_used()) {
    ...
    tmp20 = Cast_ContextCell_0(state_, TNode<HeapObject>{tmp18}, &label21);
    ca_.Goto(&block25);
    if (label21.is_used()) {
      ca_.Bind(&label21);
      ca_.Goto(&block26);
  ...
  if (block25.is_used()) {
    ca_.Bind(&block25);
    tmp22 = CodeStubAssembler(state_).IsUndefinedContextCell(TNode<Object>{tmp20});
    ca_.Branch(tmp22, &block27, std::vector<compiler::Node*>{}, &block28, std::vector<compiler::Node*>{});
  }

  if (block13.is_used()) {
    ca_.Bind(&block13);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/objects/contexts.tq:325:59");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block27.is_used()) {
    ca_.Bind(&block27);
    std::tie(tmp23, tmp24, tmp25) = FieldSliceContextElements_0(state_, TNode<Context>{tmp6}).Flatten();
    tmp26 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{parameter2});
    ...
    ca_.Branch(tmp28, &block33, std::vector<compiler::Node*>{}, &block34, std::vector<compiler::Node*>{});
  }
  ...
  if (block33.is_used()) {
    ca_.Bind(&block33);
    tmp29 = TimesSizeOf_Object_0(state_, TNode<IntPtrT>{parameter2});
    tmp30 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp24}, TNode<IntPtrT>{tmp29});
    std::tie(tmp31, tmp32) = NewReference_Object_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp23}, TNode<IntPtrT>{tmp30}).Flatten();
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp31, tmp32}, parameter1);
  ...
  if (block28.is_used()) {
    ca_.Bind(&block28);
    NotifyContextCellStateWillChange_0(state_, TNode<ContextCell>{tmp20});
    tmp34 = FromConstexpr_intptr_constexpr_int31_0(state_, 4);
    tmp35 = kZero_0(state_);
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp20, tmp34}, tmp35);
    std::tie(tmp36, tmp37, tmp38) = FieldSliceContextElements_0(state_, TNode<Context>{tmp6}).Flatten();
    tmp39 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{parameter2});
    ...
    ca_.Branch(tmp41, &block41, std::vector<compiler::Node*>{}, &block42, std::vector<compiler::Node*>{});
  }
  ...
  TNode<IntPtrT> tmp46;
  TNode<Int32T> tmp47;
  TNode<Undefined> tmp48;
  if (block41.is_used()) {
    ca_.Bind(&block41);
    tmp42 = TimesSizeOf_Object_0(state_, TNode<IntPtrT>{parameter2});
    tmp43 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp37}, TNode<IntPtrT>{tmp42});
    std::tie(tmp44, tmp45) = NewReference_Object_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp36}, TNode<IntPtrT>{tmp43}).Flatten();
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp44, tmp45}, parameter1);
    tmp46 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
    tmp47 = FromConstexpr_int32_constexpr_int32_0(state_, ContextCell::kDetached);
    CodeStubAssembler(state_).StoreReference<Int32T>(CodeStubAssembler::Reference{tmp20, tmp46}, tmp47);
...
void StoreScriptContextElementImpl_0(compiler::CodeAssemblerState* state_, TNode<Context> p_c, TNode<IntPtrT> p_index, TNode<Object> p_newValue) {
  ...
  compiler::CodeAssemblerParameterizedLabel<> block167(&ca_, compiler::CodeAssemblerLabel::kDeferred);
  ...
  if (block64.is_used()) {
    ca_.Bind(&block64);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/objects/contexts.tq:390:54");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block96.is_used()) {
    ca_.Bind(&block96);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/objects/contexts.tq:400:64");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block103.is_used()) {
    ca_.Bind(&block103);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/objects/contexts.tq:401:62");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block149.is_used()) {
    ca_.Bind(&block149);
    tmp180 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
    tmp181 = CodeStubAssembler(state_).LoadReference<Int32T>(CodeStubAssembler::Reference{tmp71, tmp180});
    tmp182 = FromConstexpr_int32_constexpr_int32_0(state_, ContextCell::kFloat64);
    tmp183 = CodeStubAssembler(state_).Word32Equal(TNode<Int32T>{tmp181}, TNode<Int32T>{tmp182});
    ca_.Branch(tmp183, &block166, std::vector<compiler::Node*>{}, &block167, std::vector<compiler::Node*>{});
  }
  ...
  if (block167.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/objects/contexts.tq", 462});
      CodeStubAssembler(state_).FailAssert("Torque assert 'cell.state == kContextCellFloat64' failed", pos_stack);
    }
  }
  ...
  if (block166.is_used()) {
    ...
    tmp184 = Cast_Smi_0(state_, TNode<Object>{p_newValue}, &label185);
    ca_.Goto(&block170);
    if (label185.is_used()) {
      ca_.Bind(&label185);
      ca_.Goto(&block171);
  ...
  TNode<HeapNumber> tmp186;
  if (block171.is_used()) {
    ca_.Bind(&block171);
    compiler::CodeAssemblerLabel label187(&ca_);
    tmp186 = Cast_HeapNumber_0(state_, TNode<HeapObject>{ca_.UncheckedCast<HeapObject>(p_newValue)}, &label187);
    ca_.Goto(&block174);
    if (label187.is_used()) {
      ca_.Bind(&label187);
      ca_.Goto(&block175);
  ...
  if (block170.is_used()) {
    ...
    tmp189 = CodeStubAssembler(state_).SmiToFloat64(TNode<Smi>{tmp184});
    tmp190 = CodeStubAssembler(state_).Float64SilenceNaN(TNode<Float64T>{tmp189});
    CodeStubAssembler(state_).StoreReference<Float64T>(CodeStubAssembler::Reference{tmp71, tmp188}, tmp190);
    ca_.Goto(&block168);
  }
  ...
  if (block175.is_used()) {
    ca_.Bind(&block175);
    NotifyContextCellStateWillChange_0(state_, TNode<ContextCell>{tmp71});
    std::tie(tmp191, tmp192, tmp193) = FieldSliceContextElements_0(state_, TNode<Context>{p_c}).Flatten();
    tmp194 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{p_index});
    tmp195 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp193});
    tmp196 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT>{tmp194}, TNode<UintPtrT>{tmp195});
    ca_.Branch(tmp196, &block180, std::vector<compiler::Node*>{}, &block181, std::vector<compiler::Node*>{});
  }
  ...
  if (block174.is_used()) {
    ca_.Bind(&block174);
    tmp197 = FromConstexpr_intptr_constexpr_int31_0(state_, 16);
    tmp198 = FromConstexpr_intptr_constexpr_int31_0(state_, 4);
    tmp199 = CodeStubAssembler(state_).LoadReference<Float64T>(CodeStubAssembler::Reference{tmp186, tmp198});
    tmp200 = CodeStubAssembler(state_).Float64SilenceNaN(TNode<Float64T>{tmp199});
    CodeStubAssembler(state_).StoreReference<Float64T>(CodeStubAssembler::Reference{tmp71, tmp197}, tmp200);
    ca_.Goto(&block172);
  }
  ...
  if (block180.is_used()) {
    ca_.Bind(&block180);
    tmp201 = TimesSizeOf_Object_0(state_, TNode<IntPtrT>{p_index});
    tmp202 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp192}, TNode<IntPtrT>{tmp201});
    std::tie(tmp203, tmp204) = NewReference_Object_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp191}, TNode<IntPtrT>{tmp202}).Flatten();
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp203, tmp204}, p_newValue);
    tmp205 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
    tmp206 = FromConstexpr_int32_constexpr_int32_0(state_, ContextCell::kDetached);
    CodeStubAssembler(state_).StoreReference<Int32T>(CodeStubAssembler::Reference{tmp71, tmp205}, tmp206);
    ca_.Goto(&block172);
  }
...
TNode<Object> LoadContextElementImpl_0(compiler::CodeAssemblerState* state_, TNode<Context> p_c, TNode<IntPtrT> p_i) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Object> block33(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
  ...
  if (block15.is_used()) {
    ca_.Bind(&block15);
    tmp15 = HasContextCells_0(state_, TNode<Context>{p_c});
  ...
  if (block18.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/objects/contexts.tq", 481});
      CodeStubAssembler(state_).FailAssert("Torque assert 'HasContextCells(c)' failed", pos_stack);
    }
  }
  ...
  if (block17.is_used()) {
    ca_.Bind(&block17);
    tmp16 = FromConstexpr_bool_constexpr_bool_0(state_, (CodeStubAssembler(state_).ConstexprInt32Equal(ContextCell::kConst, (FromConstexpr_constexpr_int32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull))))));
  ...
  if (block20.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/objects/contexts.tq", 482});
      CodeStubAssembler(state_).FailAssert("Torque assert 'kContextCellConst == 0' failed", pos_stack);
    }
  }
  ...
  if (block19.is_used()) {
    ca_.Bind(&block19);
    tmp17 = FromConstexpr_bool_constexpr_bool_0(state_, (CodeStubAssembler(state_).ConstexprInt32Equal(ContextCell::kSmi, (FromConstexpr_constexpr_int32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull))))));
  ...
  if (block22.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/objects/contexts.tq", 483});
      CodeStubAssembler(state_).FailAssert("Torque assert 'kContextCellSmi == 1' failed", pos_stack);
    }
  }
  ...
  if (block21.is_used()) {
    ...
    tmp19 = CodeStubAssembler(state_).LoadReference<Int32T>(CodeStubAssembler::Reference{tmp13, tmp18});
    tmp20 = FromConstexpr_int32_constexpr_int32_0(state_, ContextCell::kSmi);
    tmp21 = CodeStubAssembler(state_).Int32LessThanOrEqual(TNode<Int32T>{tmp19}, TNode<Int32T>{tmp20});
  ...
  if (block23.is_used()) {
    ...
    tmp23 = CodeStubAssembler(state_).LoadReference<Object>(CodeStubAssembler::Reference{tmp13, tmp22});
  ...
  if (block24.is_used()) {
    ...
    tmp25 = CodeStubAssembler(state_).LoadReference<Int32T>(CodeStubAssembler::Reference{tmp13, tmp24});
    tmp26 = FromConstexpr_int32_constexpr_int32_0(state_, ContextCell::kInt32);
    tmp27 = CodeStubAssembler(state_).Word32Equal(TNode<Int32T>{tmp25}, TNode<Int32T>{tmp26});
  ...
  if (block26.is_used()) {
    ca_.Bind(&block26);
    tmp28 = CodeStubAssembler(state_).LoadContextCellInt32Value(TNode<ContextCell>{tmp13});
    tmp29 = Convert_intptr_int32_0(state_, TNode<Int32T>{tmp28});
    tmp30 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp29});
    tmp31 = FromConstexpr_uintptr_constexpr_uintptr_0(state_, kSmiMaxValue);
    tmp32 = CodeStubAssembler(state_).UintPtrLessThanOrEqual(TNode<UintPtrT>{tmp30}, TNode<UintPtrT>{tmp31});
    ca_.Branch(tmp32, &block29, std::vector<compiler::Node*>{}, &block30, std::vector<compiler::Node*>{});
  }

  TNode<Smi> tmp33;
  if (block29.is_used()) {
    ca_.Bind(&block29);
    tmp33 = Convert_Smi_intptr_0(state_, TNode<IntPtrT>{tmp29});
  ...
  if (block30.is_used()) {
    ca_.Bind(&block30);
    tmp34 = CodeStubAssembler(state_).LoadContextCellInt32Value(TNode<ContextCell>{tmp13});
    tmp35 = CodeStubAssembler(state_).ChangeInt32ToFloat64(TNode<Int32T>{tmp34});
  ...
  if (block27.is_used()) {
    ...
    tmp38 = CodeStubAssembler(state_).LoadReference<Int32T>(CodeStubAssembler::Reference{tmp13, tmp37});
    tmp39 = FromConstexpr_int32_constexpr_int32_0(state_, ContextCell::kFloat64);
    tmp40 = CodeStubAssembler(state_).Word32Equal(TNode<Int32T>{tmp38}, TNode<Int32T>{tmp39});
    ca_.Branch(tmp40, &block31, std::vector<compiler::Node*>{}, &block32, std::vector<compiler::Node*>{});
  }
  ...
  if (block32.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/objects/contexts.tq", 493});
      CodeStubAssembler(state_).FailAssert("Torque assert 'cell.state == kContextCellFloat64' failed", pos_stack);
    }
  }
  ...
  TNode<HeapNumber> tmp43;
  if (block31.is_used()) {
    ca_.Bind(&block31);
    tmp41 = FromConstexpr_intptr_constexpr_int31_0(state_, 16);
    tmp42 = CodeStubAssembler(state_).LoadReference<Float64T>(CodeStubAssembler::Reference{tmp13, tmp41});
    tmp43 = CodeStubAssembler(state_).AllocateHeapNumberWithValue(TNode<Float64T>{tmp42});
  ...
  if (block1.is_used()) {
    ...
    ca_.Goto(&block33, phi_bb1_2);
  }

  TNode<Object> phi_bb33_2;
    ca_.Bind(&block33, &phi_bb33_2);
  return TNode<Object>{phi_bb33_2};
}
...
TNode<Context> DownCastForTorqueClass_Context_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block7.is_used()) {
    ...
    tmp6 = FromConstexpr_uint32_constexpr_uint32_0(state_, CastIfEnumClass<uint32_t>(static_cast<InstanceType>(221)));
...
TNode<ScriptContextTable> DownCastForTorqueClass_ScriptContextTable_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block7.is_used()) {
    ...
    tmp4 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    tmp5 = CodeStubAssembler(state_).LoadReference<Uint16T>(CodeStubAssembler::Reference{tmp1, tmp4});
    tmp6 = FromConstexpr_uint32_constexpr_uint32_0(state_, CastIfEnumClass<uint32_t>(static_cast<InstanceType>(277)));
    tmp7 = CodeStubAssembler(state_).Word32NotEqual(TNode<Uint32T>{tmp5}, TNode<Uint32T>{tmp6});
    ca_.Branch(tmp7, &block11, std::vector<compiler::Node*>{}, &block12, std::vector<compiler::Node*>{});
  }
...
TNode<ContextCell> DownCastForTorqueClass_ContextCell_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block0.is_used()) {
    ...
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 0);
    tmp1 = CodeStubAssembler(state_).LoadReference<Map>(CodeStubAssembler::Reference{p_o, tmp0});
    if (((CodeStubAssembler(state_).ConstexprInt31Equal(static_cast<InstanceType>(257), static_cast<InstanceType>(257))))) {
      ca_.Goto(&block3);
    } else {
      ca_.Goto(&block4);
    }
  ...
  if (block7.is_used()) {
    ...
    tmp4 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    tmp5 = CodeStubAssembler(state_).LoadReference<Uint16T>(CodeStubAssembler::Reference{tmp1, tmp4});
    tmp6 = FromConstexpr_uint32_constexpr_uint32_0(state_, CastIfEnumClass<uint32_t>(static_cast<InstanceType>(257)));
    tmp7 = CodeStubAssembler(state_).Word32NotEqual(TNode<Uint32T>{tmp5}, TNode<Uint32T>{tmp6});
    ca_.Branch(tmp7, &block11, std::vector<compiler::Node*>{}, &block12, std::vector<compiler::Node*>{});
  }
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    tmp8 = FromConstexpr_int32_constexpr_int32_0(state_, (CodeStubAssembler(state_).ConstexprUint32Sub(static_cast<InstanceType>(257), static_cast<InstanceType>(257))));
    tmp9 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    tmp10 = CodeStubAssembler(state_).LoadReference<Uint16T>(CodeStubAssembler::Reference{tmp1, tmp9});
    tmp11 = Convert_uint16_InstanceType_0(state_, TNode<Uint16T>{tmp10});
    tmp12 = Convert_int32_uint16_0(state_, TNode<Uint16T>{tmp11});
    tmp13 = FromConstexpr_InstanceType_constexpr_InstanceType_0(state_, static_cast<InstanceType>(257));
    tmp14 = Convert_uint16_InstanceType_0(state_, TNode<Uint16T>{tmp13});
    tmp15 = Convert_int32_uint16_0(state_, TNode<Uint16T>{tmp14});
    tmp16 = CodeStubAssembler(state_).Int32Sub(TNode<Int32T>{tmp12}, TNode<Int32T>{tmp15});
    tmp17 = CodeStubAssembler(state_).Unsigned(TNode<Int32T>{tmp16});
...
TNode<Context> DownCastForTorqueClass_BlockContext_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block7.is_used()) {
    ...
    tmp4 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    tmp5 = CodeStubAssembler(state_).LoadReference<Uint16T>(CodeStubAssembler::Reference{tmp1, tmp4});
    tmp6 = FromConstexpr_uint32_constexpr_uint32_0(state_, CastIfEnumClass<uint32_t>(static_cast<InstanceType>(222)));
    tmp7 = CodeStubAssembler(state_).Word32NotEqual(TNode<Uint32T>{tmp5}, TNode<Uint32T>{tmp6});
    ca_.Branch(tmp7, &block11, std::vector<compiler::Node*>{}, &block12, std::vector<compiler::Node*>{});
  }
...
TNode<Context> DownCastForTorqueClass_CatchContext_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block7.is_used()) {
    ...
    tmp4 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    tmp5 = CodeStubAssembler(state_).LoadReference<Uint16T>(CodeStubAssembler::Reference{tmp1, tmp4});
    tmp6 = FromConstexpr_uint32_constexpr_uint32_0(state_, CastIfEnumClass<uint32_t>(static_cast<InstanceType>(223)));
    tmp7 = CodeStubAssembler(state_).Word32NotEqual(TNode<Uint32T>{tmp5}, TNode<Uint32T>{tmp6});
    ca_.Branch(tmp7, &block11, std::vector<compiler::Node*>{}, &block12, std::vector<compiler::Node*>{});
  }
...
TNode<Context> DownCastForTorqueClass_DebugEvaluateContext_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block7.is_used()) {
    ...
    tmp4 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    tmp5 = CodeStubAssembler(state_).LoadReference<Uint16T>(CodeStubAssembler::Reference{tmp1, tmp4});
    tmp6 = FromConstexpr_uint32_constexpr_uint32_0(state_, CastIfEnumClass<uint32_t>(static_cast<InstanceType>(224)));
    tmp7 = CodeStubAssembler(state_).Word32NotEqual(TNode<Uint32T>{tmp5}, TNode<Uint32T>{tmp6});
    ca_.Branch(tmp7, &block11, std::vector<compiler::Node*>{}, &block12, std::vector<compiler::Node*>{});
  }
...
TNode<Context> DownCastForTorqueClass_EvalContext_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block7.is_used()) {
    ...
    tmp4 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    tmp5 = CodeStubAssembler(state_).LoadReference<Uint16T>(CodeStubAssembler::Reference{tmp1, tmp4});
    tmp6 = FromConstexpr_uint32_constexpr_uint32_0(state_, CastIfEnumClass<uint32_t>(static_cast<InstanceType>(225)));
    tmp7 = CodeStubAssembler(state_).Word32NotEqual(TNode<Uint32T>{tmp5}, TNode<Uint32T>{tmp6});
    ca_.Branch(tmp7, &block11, std::vector<compiler::Node*>{}, &block12, std::vector<compiler::Node*>{});
  }
...
TNode<Context> DownCastForTorqueClass_ModuleContext_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block7.is_used()) {
    ...
    tmp4 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    tmp5 = CodeStubAssembler(state_).LoadReference<Uint16T>(CodeStubAssembler::Reference{tmp1, tmp4});
    tmp6 = FromConstexpr_uint32_constexpr_uint32_0(state_, CastIfEnumClass<uint32_t>(static_cast<InstanceType>(227)));
    tmp7 = CodeStubAssembler(state_).Word32NotEqual(TNode<Uint32T>{tmp5}, TNode<Uint32T>{tmp6});
    ca_.Branch(tmp7, &block11, std::vector<compiler::Node*>{}, &block12, std::vector<compiler::Node*>{});
  }
...
TNode<Context> DownCastForTorqueClass_ScriptContext_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block7.is_used()) {
    ...
    tmp4 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    tmp5 = CodeStubAssembler(state_).LoadReference<Uint16T>(CodeStubAssembler::Reference{tmp1, tmp4});
    tmp6 = FromConstexpr_uint32_constexpr_uint32_0(state_, CastIfEnumClass<uint32_t>(static_cast<InstanceType>(229)));
    tmp7 = CodeStubAssembler(state_).Word32NotEqual(TNode<Uint32T>{tmp5}, TNode<Uint32T>{tmp6});
    ca_.Branch(tmp7, &block11, std::vector<compiler::Node*>{}, &block12, std::vector<compiler::Node*>{});
  }
...
TNode<Context> DownCastForTorqueClass_WithContext_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block7.is_used()) {
    ...
    tmp4 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    tmp5 = CodeStubAssembler(state_).LoadReference<Uint16T>(CodeStubAssembler::Reference{tmp1, tmp4});
    tmp6 = FromConstexpr_uint32_constexpr_uint32_0(state_, CastIfEnumClass<uint32_t>(static_cast<InstanceType>(230)));
    tmp7 = CodeStubAssembler(state_).Word32NotEqual(TNode<Uint32T>{tmp5}, TNode<Uint32T>{tmp6});
    ca_.Branch(tmp7, &block11, std::vector<compiler::Node*>{}, &block12, std::vector<compiler::Node*>{});
  }
...
TNode<Context> DownCastForTorqueClass_FunctionContext_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block7.is_used()) {
    ...
    tmp4 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    tmp5 = CodeStubAssembler(state_).LoadReference<Uint16T>(CodeStubAssembler::Reference{tmp1, tmp4});
    tmp6 = FromConstexpr_uint32_constexpr_uint32_0(state_, CastIfEnumClass<uint32_t>(static_cast<InstanceType>(226)));
    tmp7 = CodeStubAssembler(state_).Word32NotEqual(TNode<Uint32T>{tmp5}, TNode<Uint32T>{tmp6});
    ca_.Branch(tmp7, &block11, std::vector<compiler::Node*>{}, &block12, std::vector<compiler::Node*>{});
  }
...
TNode<NativeContext> DownCastForTorqueClass_NativeContext_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block7.is_used()) {
    ...
    tmp4 = FromConstexpr_intptr_constexpr_int31_0(state_, 8);
    tmp5 = CodeStubAssembler(state_).LoadReference<Uint16T>(CodeStubAssembler::Reference{tmp1, tmp4});
    tmp6 = FromConstexpr_uint32_constexpr_uint32_0(state_, CastIfEnumClass<uint32_t>(static_cast<InstanceType>(228)));
    tmp7 = CodeStubAssembler(state_).Word32NotEqual(TNode<Uint32T>{tmp5}, TNode<Uint32T>{tmp6});
    ca_.Branch(tmp7, &block11, std::vector<compiler::Node*>{}, &block12, std::vector<compiler::Node*>{});
  }
...
TNode<Context> UnsafeCast_Context_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = Is_Context_Object_0(state_, TNode<Context>{p_context}, TNode<Object>{p_o});
...
TorqueStructReference_JSReceiver_0 ReferenceCast_JSReceiver_Object_0(compiler::CodeAssemblerState* state_, TorqueStructReference_Object_0 p_ref) {
  ...
  if (block9.is_used()) {
    ...
    tmp5 = Cast_JSReceiver_0(state_, TNode<HeapObject>{tmp3}, &label6);
    ca_.Goto(&block11);
    if (label6.is_used()) {
      ca_.Bind(&label6);
      ca_.Goto(&block12);
  ...
  if (block5.is_used()) {
    ...
    ca_.Branch(phi_bb5_8, &block3, std::vector<compiler::Node*>{}, &block4, std::vector<compiler::Node*>{});
  }
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    tmp9 = TORQUE_CAST(TNode<Object>{tmp2});
    ca_.Goto(&block13);
  }
...
TorqueStructReference_JSAny_0 ReferenceCast_JSAny_Object_0(compiler::CodeAssemblerState* state_, TorqueStructReference_Object_0 p_ref) {
  ...
  if (block0.is_used()) {
    ...
    compiler::CodeAssemblerLabel label4(&ca_);
    tmp3 = Cast_JSAny_0(state_, TNode<Object>{tmp2}, &label4);
    ca_.Goto(&block8);
    if (label4.is_used()) {
      ca_.Bind(&label4);
      ca_.Goto(&block9);
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    tmp7 = TORQUE_CAST(TNode<Object>{tmp2});
    ca_.Goto(&block10);
  }
...
TorqueStructReference_JSPromise_0 ReferenceCast_JSPromise_Object_0(compiler::CodeAssemblerState* state_, TorqueStructReference_Object_0 p_ref) {
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    compiler::CodeAssemblerLabel label6(&ca_);
    tmp5 = Cast_JSPromise_0(state_, TNode<HeapObject>{tmp3}, &label6);
    ca_.Goto(&block11);
    if (label6.is_used()) {
      ca_.Bind(&label6);
      ca_.Goto(&block12);
...
TorqueStructReference_Number_0 ReferenceCast_Number_Object_0(compiler::CodeAssemblerState* state_, TorqueStructReference_Object_0 p_ref) {
  ...
  if (block0.is_used()) {
    ...
    compiler::CodeAssemblerLabel label4(&ca_);
    tmp3 = Cast_Number_0(state_, TNode<Object>{tmp2}, &label4);
    ca_.Goto(&block8);
    if (label4.is_used()) {
      ca_.Bind(&label4);
      ca_.Goto(&block9);
...
TorqueStructReference_FixedArray_OR_Undefined_0 NativeContextSlot_FixedArray_OR_Undefined_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<IntPtrT> p_index) {
  ...
  if (block0.is_used()) {
    ...
    std::tie(tmp1, tmp2) = ContextSlot_NativeContext_NativeContext_FixedArray_OR_Undefined_0(state_, TNode<NativeContext>{tmp0}, TNode<IntPtrT>{p_index}).Flatten();
    ca_.Goto(&block2);
  }

    ca_.Bind(&block2);
  return TorqueStructReference_FixedArray_OR_Undefined_0{TNode<Union<HeapObject, TaggedIndex>>{tmp1}, TNode<IntPtrT>{tmp2}, TorqueStructUnsafe_0{}};
}
...
TorqueStructReference_Boolean_0 ReferenceCast_Boolean_Object_0(compiler::CodeAssemblerState* state_, TorqueStructReference_Object_0 p_ref) {
  ...
  if (block0.is_used()) {
    ...
    compiler::CodeAssemblerLabel label4(&ca_);
    tmp3 = Cast_Boolean_0(state_, TNode<Object>{tmp2}, &label4);
    ca_.Goto(&block8);
    if (label4.is_used()) {
      ca_.Bind(&label4);
      ca_.Goto(&block9);
...
TorqueStructReference_PromiseCapability_0 ReferenceCast_PromiseCapability_Object_0(compiler::CodeAssemblerState* state_, TorqueStructReference_Object_0 p_ref) {
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    compiler::CodeAssemblerLabel label6(&ca_);
    tmp5 = Cast_PromiseCapability_0(state_, TNode<HeapObject>{tmp3}, &label6);
    ca_.Goto(&block11);
    if (label6.is_used()) {
      ca_.Bind(&label6);
      ca_.Goto(&block12);
...
TorqueStructReference_FixedArray_0 ReferenceCast_FixedArray_Object_0(compiler::CodeAssemblerState* state_, TorqueStructReference_Object_0 p_ref) {
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    compiler::CodeAssemblerLabel label6(&ca_);
    tmp5 = Cast_FixedArray_0(state_, TNode<HeapObject>{tmp3}, &label6);
    ca_.Goto(&block11);
    if (label6.is_used()) {
      ca_.Bind(&label6);
      ca_.Goto(&block12);
...
TorqueStructReference_Callable_0 ReferenceCast_Callable_Object_0(compiler::CodeAssemblerState* state_, TorqueStructReference_Object_0 p_ref) {
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    compiler::CodeAssemblerLabel label6(&ca_);
    tmp5 = Cast_Callable_0(state_, TNode<HeapObject>{tmp3}, &label6);
    ca_.Goto(&block11);
    if (label6.is_used()) {
      ca_.Bind(&label6);
      ca_.Goto(&block12);
...
TorqueStructReference_Constructor_0 ReferenceCast_Constructor_Object_0(compiler::CodeAssemblerState* state_, TorqueStructReference_Object_0 p_ref) {
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    compiler::CodeAssemblerLabel label6(&ca_);
    tmp5 = Cast_Constructor_0(state_, TNode<HeapObject>{tmp3}, &label6);
    ca_.Goto(&block11);
    if (label6.is_used()) {
      ca_.Bind(&label6);
      ca_.Goto(&block12);
...
TorqueStructReference_Undefined_OR_JSFunction_OR_CallableApiObject_OR_CallableJSProxy_OR_JSWrappedFunction_OR_JSBoundFunction_0 NativeContextSlot_Undefined_OR_JSFunction_OR_CallableApiObject_OR_CallableJSProxy_OR_JSWrappedFunction_OR_JSBoundFunction_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<IntPtrT> p_index) {
  ...
  if (block0.is_used()) {
    ...
    ca_.Bind(&block2);
  return TorqueStructReference_Undefined_OR_JSFunction_OR_CallableApiObject_OR_CallableJSProxy_OR_JSWrappedFunction_OR_JSBoundFunction_0{TNode<Union<HeapObject, TaggedIndex>>{tmp1}, TNode<IntPtrT>{tmp2}, TorqueStructUnsafe_0{}};
}
...
TorqueStructReference_Null_OR_JSProxy_0 ReferenceCast_Null_OR_JSProxy_Object_0(compiler::CodeAssemblerState* state_, TorqueStructReference_Object_0 p_ref) {
  ...
  TNode<Union<JSProxy, Null>> tmp5;
  if (block9.is_used()) {
    ca_.Bind(&block9);
    compiler::CodeAssemblerLabel label6(&ca_);
    tmp5 = Cast_Null_OR_JSProxy_0(state_, TNode<HeapObject>{tmp3}, &label6);
    ca_.Goto(&block11);
    if (label6.is_used()) {
      ca_.Bind(&label6);
      ca_.Goto(&block12);
...
TorqueStructReference_Map_0 ReferenceCast_Map_Object_0(compiler::CodeAssemblerState* state_, TorqueStructReference_Object_0 p_ref) {
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    compiler::CodeAssemblerLabel label6(&ca_);
    tmp5 = Cast_Map_0(state_, TNode<HeapObject>{tmp3}, &label6);
    ca_.Goto(&block11);
    if (label6.is_used()) {
      ca_.Bind(&label6);
      ca_.Goto(&block12);
...
TorqueStructReference_ScopeInfo_0 ReferenceCast_ScopeInfo_Object_0(compiler::CodeAssemblerState* state_, TorqueStructReference_Object_0 p_ref) {
  ...
  TNode<ScopeInfo> tmp5;
  if (block9.is_used()) {
    ca_.Bind(&block9);
    compiler::CodeAssemblerLabel label6(&ca_);
    tmp5 = Cast_ScopeInfo_0(state_, TNode<HeapObject>{tmp3}, &label6);
    ca_.Goto(&block11);
    if (label6.is_used()) {
      ca_.Bind(&label6);
      ca_.Goto(&block12);
...
TorqueStructReference_Undefined_OR_JSFunction_0 ReferenceCast_Undefined_OR_JSFunction_Object_0(compiler::CodeAssemblerState* state_, TorqueStructReference_Object_0 p_ref) {
  ...
  TNode<Union<JSFunction, Undefined>> tmp5;
  if (block9.is_used()) {
    ca_.Bind(&block9);
    compiler::CodeAssemblerLabel label6(&ca_);
    tmp5 = Cast_Undefined_OR_JSFunction_0(state_, TNode<HeapObject>{tmp3}, &label6);
    ca_.Goto(&block11);
    if (label6.is_used()) {
      ca_.Bind(&label6);
      ca_.Goto(&block12);
  ...
  TNode<Union<JSFunction, Undefined>> tmp9;
  if (block3.is_used()) {
    ca_.Bind(&block3);
    tmp9 = TORQUE_CAST(TNode<Object>{tmp2});
    ca_.Goto(&block13);
...
TorqueStructReference_JSFunction_0 ReferenceCast_JSFunction_Object_0(compiler::CodeAssemblerState* state_, TorqueStructReference_Object_0 p_ref) {
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    compiler::CodeAssemblerLabel label6(&ca_);
    tmp5 = Cast_JSFunction_0(state_, TNode<HeapObject>{tmp3}, &label6);
    ca_.Goto(&block11);
    if (label6.is_used()) {
      ca_.Bind(&label6);
      ca_.Goto(&block12);
...
TorqueStructReference_FixedArray_OR_Undefined_0 ContextSlot_NativeContext_NativeContext_FixedArray_OR_Undefined_0(compiler::CodeAssemblerState* state_, TNode<NativeContext> p_context, TNode<IntPtrT> p_index) {
  ...
  if (block6.is_used()) {
    ...
    tmp7 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp1}, TNode<IntPtrT>{tmp6});
    std::tie(tmp8, tmp9) = NewReference_Object_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp0}, TNode<IntPtrT>{tmp7}).Flatten();
    std::tie(tmp10, tmp11) = ReferenceCast_FixedArray_OR_Undefined_Object_0(state_, TorqueStructReference_Object_0{TNode<Union<HeapObject, TaggedIndex>>{tmp8}, TNode<IntPtrT>{tmp9}, TorqueStructUnsafe_0{}}).Flatten();
    ca_.Goto(&block10);
  }
  ...
  if (block7.is_used()) {
    ...
    ca_.Bind(&block10);
  return TorqueStructReference_FixedArray_OR_Undefined_0{TNode<Union<HeapObject, TaggedIndex>>{tmp10}, TNode<IntPtrT>{tmp11}, TorqueStructUnsafe_0{}};
}
...
TorqueStructReference_JSObject_0 ReferenceCast_JSObject_Object_0(compiler::CodeAssemblerState* state_, TorqueStructReference_Object_0 p_ref) {
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    compiler::CodeAssemblerLabel label6(&ca_);
    tmp5 = Cast_JSObject_0(state_, TNode<HeapObject>{tmp3}, &label6);
    ca_.Goto(&block11);
    if (label6.is_used()) {
      ca_.Bind(&label6);
      ca_.Goto(&block12);
...
TorqueStructReference_Cell_0 ReferenceCast_Cell_Object_0(compiler::CodeAssemblerState* state_, TorqueStructReference_Object_0 p_ref) {
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    compiler::CodeAssemblerLabel label6(&ca_);
    tmp5 = Cast_Cell_0(state_, TNode<HeapObject>{tmp3}, &label6);
    ca_.Goto(&block11);
    if (label6.is_used()) {
      ca_.Bind(&label6);
      ca_.Goto(&block12);
...
TorqueStructReference_Undefined_OR_JSFunction_OR_CallableApiObject_OR_CallableJSProxy_OR_JSWrappedFunction_OR_JSBoundFunction_0 ContextSlot_NativeContext_NativeContext_Undefined_OR_JSFunction_OR_CallableApiObject_OR_CallableJSProxy_OR_JSWrappedFunction_OR_JSBoundFunction_0(compiler::CodeAssemblerState* state_, TNode<NativeContext> p_context, TNode<IntPtrT> p_index) {
  ...
  if (block6.is_used()) {
    ...
    tmp7 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp1}, TNode<IntPtrT>{tmp6});
    std::tie(tmp8, tmp9) = NewReference_Object_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp0}, TNode<IntPtrT>{tmp7}).Flatten();
    std::tie(tmp10, tmp11) = ReferenceCast_Undefined_OR_JSFunction_OR_CallableApiObject_OR_CallableJSProxy_OR_JSWrappedFunction_OR_JSBoundFunction_Object_0(state_, TorqueStructReference_Object_0{TNode<Union<HeapObject, TaggedIndex>>{tmp8}, TNode<IntPtrT>{tmp9}, TorqueStructUnsafe_0{}}).Flatten();
    ca_.Goto(&block10);
  }
  ...
  if (block7.is_used()) {
    ...
    ca_.Bind(&block10);
  return TorqueStructReference_Undefined_OR_JSFunction_OR_CallableApiObject_OR_CallableJSProxy_OR_JSWrappedFunction_OR_JSBoundFunction_0{TNode<Union<HeapObject, TaggedIndex>>{tmp10}, TNode<IntPtrT>{tmp11}, TorqueStructUnsafe_0{}};
}
...
TorqueStructReference_FixedArray_OR_Undefined_0 ReferenceCast_FixedArray_OR_Undefined_Object_0(compiler::CodeAssemblerState* state_, TorqueStructReference_Object_0 p_ref) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    std::tie(tmp0, tmp1) = NewReference_FixedArray_OR_Undefined_0(state_, TNode<Union<HeapObject, TaggedIndex>>{p_ref.object}, TNode<IntPtrT>{p_ref.offset}).Flatten();
  ...
  TNode<Union<FixedArray, Undefined>> tmp5;
  if (block9.is_used()) {
    ca_.Bind(&block9);
    compiler::CodeAssemblerLabel label6(&ca_);
    tmp5 = Cast_FixedArray_OR_Undefined_0(state_, TNode<HeapObject>{tmp3}, &label6);
    ca_.Goto(&block11);
    if (label6.is_used()) {
      ca_.Bind(&label6);
      ca_.Goto(&block12);
  ...
  TNode<Union<FixedArray, Undefined>> tmp9;
  if (block3.is_used()) {
    ca_.Bind(&block3);
    tmp9 = TORQUE_CAST(TNode<Object>{tmp2});
    ca_.Goto(&block13);
...
TorqueStructReference_RegExpMatchInfo_0 ReferenceCast_RegExpMatchInfo_Object_0(compiler::CodeAssemblerState* state_, TorqueStructReference_Object_0 p_ref) {
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    compiler::CodeAssemblerLabel label6(&ca_);
    tmp5 = Cast_RegExpMatchInfo_0(state_, TNode<HeapObject>{tmp3}, &label6);
    ca_.Goto(&block11);
    if (label6.is_used()) {
      ca_.Bind(&label6);
      ca_.Goto(&block12);
...
TorqueStructReference_FixedDoubleArray_0 ReferenceCast_FixedDoubleArray_Object_0(compiler::CodeAssemblerState* state_, TorqueStructReference_Object_0 p_ref) {
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    compiler::CodeAssemblerLabel label6(&ca_);
    tmp5 = Cast_FixedDoubleArray_0(state_, TNode<HeapObject>{tmp3}, &label6);
    ca_.Goto(&block11);
    if (label6.is_used()) {
      ca_.Bind(&label6);
      ca_.Goto(&block12);
...
TorqueStructReference_Undefined_OR_JSFunction_OR_CallableApiObject_OR_CallableJSProxy_OR_JSWrappedFunction_OR_JSBoundFunction_0 ReferenceCast_Undefined_OR_JSFunction_OR_CallableApiObject_OR_CallableJSProxy_OR_JSWrappedFunction_OR_JSBoundFunction_Object_0(compiler::CodeAssemblerState* state_, TorqueStructReference_Object_0 p_ref) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    std::tie(tmp0, tmp1) = NewReference_Undefined_OR_JSFunction_OR_CallableApiObject_OR_CallableJSProxy_OR_JSWrappedFunction_OR_JSBoundFunction_0(state_, TNode<Union<HeapObject, TaggedIndex>>{p_ref.object}, TNode<IntPtrT>{p_ref.offset}).Flatten();
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    compiler::CodeAssemblerLabel label6(&ca_);
    tmp5 = Cast_Undefined_OR_JSFunction_OR_CallableApiObject_OR_CallableJSProxy_OR_JSWrappedFunction_OR_JSBoundFunction_0(state_, TNode<HeapObject>{tmp3}, &label6);
    ca_.Goto(&block11);
    if (label6.is_used()) {
      ca_.Bind(&label6);
      ca_.Goto(&block12);
  ...
  TNode<Union<JSBoundFunction, JSFunction, JSObject, JSProxy, JSWrappedFunction, Undefined>> tmp9;
  if (block3.is_used()) {
    ca_.Bind(&block3);
    tmp9 = TORQUE_CAST(TNode<Object>{tmp2});
    ca_.Goto(&block13);
