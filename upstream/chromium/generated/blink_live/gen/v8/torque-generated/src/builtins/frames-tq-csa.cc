...
// https://crsrc.org/c/v8/src/builtins/frames.tq?l=11&c=1
...
// https://crsrc.org/c/v8/src/builtins/frames.tq?l=21&c=1
TNode<Smi> Cast_FrameType_0(compiler::CodeAssemblerState* state_, TNode<Object> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    tmp1 = CodeStubAssembler(state_).BitcastTaggedToWordForTagAndSmiBits(TNode<MaybeObject>{p_o});
    tmp2 = Convert_int32_intptr_0(state_, TNode<IntPtrT>{tmp1});
    tmp3 = FromConstexpr_Smi_constexpr_int31_0(state_, StackFrame::NUMBER_OF_TYPES);
    tmp4 = CodeStubAssembler(state_).SmiShl(TNode<Smi>{tmp3}, kSmiTagSize);
    tmp5 = Convert_int32_Smi_0(state_, TNode<Smi>{tmp4});
    tmp6 = CodeStubAssembler(state_).Int32LessThan(TNode<Int32T>{tmp2}, TNode<Int32T>{tmp5});
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    {
      ...
      pos_stack.push_back({"src/builtins/frames.tq", 24});
      CodeStubAssembler(state_).FailAssert("Torque assert 'Convert<int32>(BitcastTaggedToWordForTagAndSmiBits(o)) < Convert<int32>(kFrameTypeCount << kSmiTagSize)' failed", pos_stack);
    }
  }
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    tmp7 = TORQUE_CAST(TNode<Object>{p_o});
    ca_.Goto(&block7);
  }
...
// https://crsrc.org/c/v8/src/builtins/frames.tq?l=41&c=1
...
// https://crsrc.org/c/v8/src/builtins/frames.tq?l=44&c=1
...
// https://crsrc.org/c/v8/src/builtins/frames.tq?l=47&c=1
...
// https://crsrc.org/c/v8/src/builtins/frames.tq?l=53&c=1
TNode<JSFunction> LoadFunctionFromFrame_0(compiler::CodeAssemblerState* state_, TNode<RawPtrT> p_f) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = LoadObjectFromFrame_0(state_, TNode<RawPtrT>{p_f}, CastIfEnumClass<int32_t>(StandardFrameConstants::kFunctionOffset));
...
// https://crsrc.org/c/v8/src/builtins/frames.tq?l=63&c=1
TNode<RawPtrT> LoadCallerFromFrame_0(compiler::CodeAssemblerState* state_, TNode<RawPtrT> p_f) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = LoadPointerFromFrame_0(state_, TNode<RawPtrT>{p_f}, CastIfEnumClass<int32_t>(StandardFrameConstants::kCallerFPOffset));
...
// https://crsrc.org/c/v8/src/builtins/frames.tq?l=73&c=1
TNode<IntPtrT> LoadArgCFromFrame_0(compiler::CodeAssemblerState* state_, TNode<RawPtrT> p_f) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = LoadIntptrFromFrame_0(state_, TNode<RawPtrT>{p_f}, CastIfEnumClass<int32_t>(StandardFrameConstants::kArgCOffset));
    tmp1 = FromConstexpr_intptr_constexpr_int31_0(state_, kJSArgcReceiverSlots);
...
// https://crsrc.org/c/v8/src/builtins/frames.tq?l=79&c=1
...
// https://crsrc.org/c/v8/src/builtins/frames.tq?l=97&c=1
TNode<Union<Context, Smi>> LoadContextOrFrameTypeFromFrame_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<RawPtrT> p_f) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = LoadObjectFromFrame_0(state_, TNode<RawPtrT>{p_f}, CastIfEnumClass<int32_t>(StandardFrameConstants::kContextOrFrameTypeOffset));
...
// https://crsrc.org/c/v8/src/builtins/frames.tq?l=103&c=1
TNode<BoolT> FrameTypeEquals_0(compiler::CodeAssemblerState* state_, TNode<Smi> p_f1, TNode<Smi> p_f2) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = CodeStubAssembler(state_).TaggedEqual(TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{p_f1}, TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{p_f2});
    ca_.Goto(&block2);
  }
...
// https://crsrc.org/c/v8/src/builtins/frames.tq?l=109&c=1
...
// https://crsrc.org/c/v8/src/builtins/frames.tq?l=99&c=10
TNode<Union<Context, Smi>> UnsafeCast_ContextOrFrameType_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = Is_ContextOrFrameType_Object_0(state_, TNode<Context>{p_context}, TNode<Object>{p_o});
...
// https://crsrc.org/c/v8/src/builtins/frames.tq?l=112&c=7
