...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=12&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=16&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=20&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=24&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=28&c=1
TNode<Int8T> FromConstexpr_int8_constexpr_IntegerLiteral_0(compiler::CodeAssemblerState* state_, IntegerLiteral p_i) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FromConstexpr_int8_constexpr_int31_0(state_, CastIfEnumClass<int31_t>((CodeStubAssembler(state_).ConstexprIntegerLiteralToInt8(p_i))));
    ca_.Goto(&block2);
  }
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=32&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=36&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=40&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=44&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=48&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=52&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=59&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=64&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=67&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=70&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=82&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=88&c=1
TNode<Smi> FromConstexpr_PositiveSmi_constexpr_int31_0(compiler::CodeAssemblerState* state_, int31_t p_i) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FromConstexpr_bool_constexpr_bool_0(state_, (CodeStubAssembler(state_).ConstexprInt31GreaterThanEqual(p_i, (FromConstexpr_constexpr_int31_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull))))));
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    {
      ...
      pos_stack.push_back({"src/builtins/convert.tq", 89});
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    tmp1 = ca_.SmiConstant(CastToUnderlyingTypeIfEnum(p_i));
    ca_.Goto(&block4);
  }
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=92&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=95&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=98&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=101&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=104&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=107&c=1
TNode<Uint8T> FromConstexpr_uint8_constexpr_int31_0(compiler::CodeAssemblerState* state_, int31_t p_i) {
  ...
  if (block0.is_used()) {
    ...
    CodeStubAssembler(state_).StaticAssert(TNode<BoolT>{tmp2}, "static_assert(i <= 255) at https://crsrc.org/c/v8/src/builtins/convert.tq?l=109&c=3");
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=112&c=1
TNode<Int8T> FromConstexpr_int8_constexpr_int31_0(compiler::CodeAssemblerState* state_, int31_t p_i) {
  ...
  if (block4.is_used()) {
    ...
    CodeStubAssembler(state_).StaticAssert(TNode<BoolT>{phi_bb4_2}, "static_assert(-128 <= i && i <= 127) at https://crsrc.org/c/v8/src/builtins/convert.tq?l=114&c=3");
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=117&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=120&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=123&c=1
TNode<Uint8T> FromConstexpr_uint8_constexpr_uint8_0(compiler::CodeAssemblerState* state_, uint8_t p_i) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FromConstexpr_uint32_constexpr_uint32_0(state_, CastIfEnumClass<uint32_t>(p_i));
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=130&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=133&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=136&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=139&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=142&c=1
TNode<Float64T> FromConstexpr_float64_constexpr_int31_0(compiler::CodeAssemblerState* state_, int31_t p_i) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = CodeStubAssembler(state_).Float64Constant(CastIfEnumClass<int32_t>(p_i));
    ca_.Goto(&block2);
  }
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=145&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=148&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=151&c=1
TNode<Float32T> FromConstexpr_float32_constexpr_float32_0(compiler::CodeAssemblerState* state_, float p_i) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = CodeStubAssembler(state_).Float32Constant(p_i);
    ca_.Goto(&block2);
  }
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=154&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=157&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=160&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=163&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=167&c=1
TNode<Smi> FromConstexpr_LanguageModeSmi_constexpr_LanguageMode_0(compiler::CodeAssemblerState* state_, LanguageMode p_c) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = CodeStubAssembler(state_).SmiConstant(CastIfEnumClass<bool>(p_c));
    tmp1 = (TNode<Smi>{tmp0});
    ca_.Goto(&block2);
  }
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=171&c=1
TNode<Int32T> FromConstexpr_PromiseState_constexpr_PromiseState_0(compiler::CodeAssemblerState* state_, Promise::PromiseState p_c) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = CodeStubAssembler(state_).Int32Constant(CastIfEnumClass<int31_t>(p_c));
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=175&c=1
TNode<Uint16T> FromConstexpr_InstanceType_constexpr_InstanceType_0(compiler::CodeAssemblerState* state_, InstanceType p_c) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = CodeStubAssembler(state_).Uint16Constant(CastIfEnumClass<uint16_t>(p_c));
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=180&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=185&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=190&c=1
TNode<Uint8T> FromConstexpr_PrivateSymbolKind_constexpr_PrivateSymbolKind_0(compiler::CodeAssemblerState* state_, PrivateSymbolKind p_c) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block0.is_used()) {
    ...
    ca_.Bind(&block2);
  return TNode<Uint8T>{tmp2};
}

// https://crsrc.org/c/v8/src/builtins/convert.tq?l=203&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=206&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=209&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=215&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=221&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=224&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=227&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=230&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=233&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=236&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=245&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=248&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=251&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=254&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=257&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=260&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=263&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=266&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=269&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=272&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=275&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=278&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=281&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=292&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=295&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=301&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=304&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=307&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=310&c=1
TNode<IntPtrT> Convert_intptr_uintptr_0(compiler::CodeAssemblerState* state_, TNode<UintPtrT> p_ui) {
  ...
  if (block3.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/convert.tq", 312});
      CodeStubAssembler(state_).FailAssert("Torque assert 'i >= 0' failed", pos_stack);
    }
  }
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=315&c=1
TNode<Smi> Convert_PositiveSmi_intptr_0(compiler::CodeAssemblerState* state_, TNode<IntPtrT> p_i) {
  ...
  if (block3.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/convert.tq", 316});
      CodeStubAssembler(state_).FailAssert("Torque assert 'IsValidPositiveSmi(i)' failed", pos_stack);
    }
  }
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=319&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=325&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=333&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=336&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=339&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=342&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=345&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=348&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=351&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=354&c=1
TorqueStructfloat64_or_undefined_or_hole_0 Convert_float64_or_undefined_or_hole_float64_0(compiler::CodeAssemblerState* state_, TNode<Float64T> p_f) {
  ...
  if (block0.is_used()) {
    ...
    ca_.Bind(&block2);
  return TorqueStructfloat64_or_undefined_or_hole_0{TNode<BoolT>{tmp0}, TNode<BoolT>{tmp1}, TNode<Float64T>{p_f}};
}

// https://crsrc.org/c/v8/src/builtins/convert.tq?l=367&c=1
TorqueStructfloat64_or_undefined_or_hole_0 Convert_float64_or_undefined_or_hole_Number_0(compiler::CodeAssemblerState* state_, TNode<Number> p_n) {
  ...
  if (block0.is_used()) {
    ...
    std::tie(tmp1, tmp2, tmp3) = Convert_float64_or_undefined_or_hole_float64_0(state_, TNode<Float64T>{tmp0}).Flatten();
    ca_.Goto(&block2);
  }

    ca_.Bind(&block2);
  return TorqueStructfloat64_or_undefined_or_hole_0{TNode<BoolT>{tmp1}, TNode<BoolT>{tmp2}, TNode<Float64T>{tmp3}};
}

// https://crsrc.org/c/v8/src/builtins/convert.tq?l=371&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=374&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=377&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=381&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=384&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=387&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=390&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=393&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=396&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=399&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=402&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=405&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=411&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=414&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=417&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=420&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=424&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=429&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=433&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=437&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=441&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=444&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=447&c=1
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=255&c=17
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=258&c=17
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=261&c=17
...
// https://crsrc.org/c/v8/src/builtins/convert.tq?l=270&c=17
