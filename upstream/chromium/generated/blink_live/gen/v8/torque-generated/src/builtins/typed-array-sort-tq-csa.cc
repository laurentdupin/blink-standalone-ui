...
// https://crsrc.org/c/v8/src/builtins/typed-array-sort.tq?l=8&c=1
...
// https://crsrc.org/c/v8/src/builtins/typed-array-sort.tq?l=12&c=1
TNode<Number> CallCompare_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSTypedArray> p_array, TNode<Union<JSBoundFunction, JSFunction, JSObject, JSProxy, JSWrappedFunction>> p_comparefn, TNode<JSAny> p_a, TNode<JSAny> p_b) {
  compiler::CodeAssembler ca_(state_);
  ...
  if (block0.is_used()) {
    ...
    tmp1 = CodeStubAssembler(state_).Call(TNode<Context>{p_context}, TNode<JSAny>{p_comparefn}, TNode<JSAny>{tmp0}, TNode<JSAny>{p_a}, TNode<JSAny>{p_b});
    tmp2 = CodeStubAssembler(state_).ToNumber_Inline(TNode<Context>{p_context}, TNode<JSAny>{tmp1});
...
// https://crsrc.org/c/v8/src/builtins/typed-array-sort.tq?l=27&c=1
void TypedArrayMerge_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSTypedArray> p_array, TNode<Union<JSBoundFunction, JSFunction, JSObject, JSProxy, JSWrappedFunction>> p_comparefn, TNode<FixedArray> p_source, TNode<UintPtrT> p_from, TNode<UintPtrT> p_middle, TNode<UintPtrT> p_to, TNode<FixedArray> p_target) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<UintPtrT, UintPtrT, UintPtrT> block67(&ca_, compiler::CodeAssemblerLabel::kDeferred);
  compiler::CodeAssemblerParameterizedLabel<UintPtrT, UintPtrT, UintPtrT> block66(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<UintPtrT, UintPtrT, UintPtrT, UintPtrT, UintPtrT> block72(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<UintPtrT, UintPtrT, UintPtrT, UintPtrT, UintPtrT> block73(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<UintPtrT, UintPtrT, UintPtrT, UintPtrT, UintPtrT, UintPtrT> block80(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<UintPtrT, UintPtrT, UintPtrT, UintPtrT, UintPtrT, UintPtrT> block81(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block24.is_used()) {
    ...
    std::tie(tmp26, tmp27) = NewReference_Object_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp15}, TNode<IntPtrT>{tmp25}).Flatten();
  ...
  if (block35.is_used()) {
    ...
    std::tie(tmp39, tmp40) = NewReference_Object_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp30}, TNode<IntPtrT>{tmp38}).Flatten();
  ...
  if (block43.is_used()) {
    ...
    tmp56 = CallCompare_0(state_, TNode<Context>{p_context}, TNode<JSTypedArray>{p_array}, TNode<Union<JSBoundFunction, JSFunction, JSObject, JSProxy, JSWrappedFunction>>{p_comparefn}, TNode<JSAny>{tmp42}, TNode<JSAny>{tmp55});
  ...
  if (block54.is_used()) {
    ...
    std::tie(tmp68, tmp69) = NewReference_Object_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp59}, TNode<IntPtrT>{tmp67}).Flatten();
  ...
  if (block62.is_used()) {
    ...
    std::tie(tmp81, tmp82) = NewReference_Object_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp72}, TNode<IntPtrT>{tmp80}).Flatten();
  ...
  if (block29.is_used()) {
    ...
    tmp85 = CodeStubAssembler(state_).WordEqual(TNode<UintPtrT>{phi_bb29_8}, TNode<UintPtrT>{p_middle});
    ca_.Branch(tmp85, &block66, std::vector<compiler::Node*>{phi_bb29_8, phi_bb29_9, phi_bb29_10}, &block67, std::vector<compiler::Node*>{phi_bb29_8, phi_bb29_9, phi_bb29_10});
  }

  TNode<UintPtrT> phi_bb67_8;
  TNode<UintPtrT> phi_bb67_9;
  TNode<UintPtrT> phi_bb67_10;
  if (block67.is_used()) {
    ca_.Bind(&block67, &phi_bb67_8, &phi_bb67_9, &phi_bb67_10);
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/typed-array-sort.tq", 53});
      CodeStubAssembler(state_).FailAssert("Torque assert 'left == middle' failed", pos_stack);
    }
  }

  TNode<UintPtrT> phi_bb66_8;
  TNode<UintPtrT> phi_bb66_9;
  TNode<UintPtrT> phi_bb66_10;
  ...
  TNode<BoolT> tmp92;
  if (block66.is_used()) {
    ca_.Bind(&block66, &phi_bb66_8, &phi_bb66_9, &phi_bb66_10);
    std::tie(tmp86, tmp87, tmp88) = FieldSliceFixedArrayObjects_0(state_, TNode<FixedArray>{p_target}).Flatten();
    tmp89 = Convert_intptr_uintptr_0(state_, TNode<UintPtrT>{phi_bb66_10});
    ...
    ca_.Branch(tmp92, &block72, std::vector<compiler::Node*>{phi_bb66_8, phi_bb66_9, phi_bb66_10, phi_bb66_10, phi_bb66_10}, &block73, std::vector<compiler::Node*>{phi_bb66_8, phi_bb66_9, phi_bb66_10, phi_bb66_10, phi_bb66_10});
  }

  TNode<UintPtrT> phi_bb72_8;
  TNode<UintPtrT> phi_bb72_9;
  TNode<UintPtrT> phi_bb72_10;
  TNode<UintPtrT> phi_bb72_15;
  TNode<UintPtrT> phi_bb72_16;
  TNode<IntPtrT> tmp93;
  TNode<IntPtrT> tmp94;
  ...
  TNode<BoolT> tmp105;
  if (block72.is_used()) {
    ca_.Bind(&block72, &phi_bb72_8, &phi_bb72_9, &phi_bb72_10, &phi_bb72_15, &phi_bb72_16);
    tmp93 = TimesSizeOf_Object_0(state_, TNode<IntPtrT>{tmp89});
    tmp94 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp87}, TNode<IntPtrT>{tmp93});
    std::tie(tmp95, tmp96) = NewReference_Object_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp86}, TNode<IntPtrT>{tmp94}).Flatten();
    std::tie(tmp97, tmp98, tmp99) = FieldSliceFixedArrayObjects_0(state_, TNode<FixedArray>{p_source}).Flatten();
    tmp100 = FromConstexpr_uintptr_constexpr_int31_0(state_, 1);
    tmp101 = CodeStubAssembler(state_).UintPtrAdd(TNode<UintPtrT>{phi_bb72_9}, TNode<UintPtrT>{tmp100});
    tmp102 = Convert_intptr_uintptr_0(state_, TNode<UintPtrT>{phi_bb72_9});
    tmp103 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp102});
    tmp104 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp99});
    tmp105 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT>{tmp103}, TNode<UintPtrT>{tmp104});
    ca_.Branch(tmp105, &block80, std::vector<compiler::Node*>{phi_bb72_8, phi_bb72_10, phi_bb72_15, phi_bb72_16, phi_bb72_9, phi_bb72_9}, &block81, std::vector<compiler::Node*>{phi_bb72_8, phi_bb72_10, phi_bb72_15, phi_bb72_16, phi_bb72_9, phi_bb72_9});
  }

  TNode<UintPtrT> phi_bb73_8;
  TNode<UintPtrT> phi_bb73_9;
  TNode<UintPtrT> phi_bb73_10;
  TNode<UintPtrT> phi_bb73_15;
  TNode<UintPtrT> phi_bb73_16;
  if (block73.is_used()) {
    ca_.Bind(&block73, &phi_bb73_8, &phi_bb73_9, &phi_bb73_10, &phi_bb73_15, &phi_bb73_16);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/torque-internal.tq:117:62");
    CodeStubAssembler(state_).Unreachable();
  }

  TNode<UintPtrT> phi_bb80_8;
  TNode<UintPtrT> phi_bb80_10;
  TNode<UintPtrT> phi_bb80_15;
  TNode<UintPtrT> phi_bb80_16;
  TNode<UintPtrT> phi_bb80_23;
  TNode<UintPtrT> phi_bb80_24;
  ...
  TNode<Object> tmp110;
  if (block80.is_used()) {
    ca_.Bind(&block80, &phi_bb80_8, &phi_bb80_10, &phi_bb80_15, &phi_bb80_16, &phi_bb80_23, &phi_bb80_24);
    tmp106 = TimesSizeOf_Object_0(state_, TNode<IntPtrT>{tmp102});
    tmp107 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp98}, TNode<IntPtrT>{tmp106});
    std::tie(tmp108, tmp109) = NewReference_Object_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp97}, TNode<IntPtrT>{tmp107}).Flatten();
    tmp110 = CodeStubAssembler(state_).LoadReference<Object>(CodeStubAssembler::Reference{tmp108, tmp109});
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp95, tmp96}, tmp110);
    ca_.Goto(&block30, phi_bb80_8, tmp101, phi_bb80_10);
  }

  TNode<UintPtrT> phi_bb81_8;
  TNode<UintPtrT> phi_bb81_10;
  TNode<UintPtrT> phi_bb81_15;
  TNode<UintPtrT> phi_bb81_16;
  TNode<UintPtrT> phi_bb81_23;
  TNode<UintPtrT> phi_bb81_24;
  if (block81.is_used()) {
    ca_.Bind(&block81, &phi_bb81_8, &phi_bb81_10, &phi_bb81_15, &phi_bb81_16, &phi_bb81_23, &phi_bb81_24);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/torque-internal.tq:117:62");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block11.is_used()) {
    ...
    tmp112 = CodeStubAssembler(state_).UintPtrAdd(TNode<UintPtrT>{phi_bb11_10}, TNode<UintPtrT>{tmp111});
    ca_.Goto(&block4, phi_bb11_8, phi_bb11_9, tmp112);
  }
...
TF_BUILTIN(TypedArrayMergeSort, CodeStubAssembler) {
  ...
  USE(parameter5);
  TNode<Union<JSBoundFunction, JSFunction, JSObject, JSProxy, JSWrappedFunction>> parameter6 = UncheckedParameter<Union<JSBoundFunction, JSFunction, JSObject, JSProxy, JSWrappedFunction>>(Descriptor::kComparefn);
  USE(parameter6);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block2.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/typed-array-sort.tq", 62});
      CodeStubAssembler(state_).FailAssert("Torque assert 'to - from > 1' failed", pos_stack);
    }
  }
  ...
  if (block1.is_used()) {
    ca_.Bind(&block1);
    tmp3 = CodeStubAssembler(state_).UintPtrSub(TNode<UintPtrT>{parameter3}, TNode<UintPtrT>{parameter2});
    tmp4 = FromConstexpr_uintptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull));
    tmp5 = CodeStubAssembler(state_).WordShr(TNode<UintPtrT>{tmp3}, TNode<UintPtrT>{tmp4});
    tmp6 = CodeStubAssembler(state_).UintPtrAdd(TNode<UintPtrT>{parameter2}, TNode<UintPtrT>{tmp5});
    tmp7 = CodeStubAssembler(state_).UintPtrSub(TNode<UintPtrT>{tmp6}, TNode<UintPtrT>{parameter2});
    tmp8 = FromConstexpr_uintptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull));
    tmp9 = CodeStubAssembler(state_).UintPtrGreaterThan(TNode<UintPtrT>{tmp7}, TNode<UintPtrT>{tmp8});
    ca_.Branch(tmp9, &block3, std::vector<compiler::Node*>{}, &block4, std::vector<compiler::Node*>{});
  }

  TNode<JSAny> tmp10;
  if (block3.is_used()) {
    ca_.Bind(&block3);
    tmp10 = ca_.CallBuiltin<JSAny>(Builtin::kTypedArrayMergeSort, parameter0, parameter4, parameter2, tmp6, parameter1, parameter5, parameter6);
    ca_.Goto(&block4);
  }
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    tmp11 = CodeStubAssembler(state_).UintPtrSub(TNode<UintPtrT>{parameter3}, TNode<UintPtrT>{tmp6});
    tmp12 = FromConstexpr_uintptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull));
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    tmp14 = ca_.CallBuiltin<JSAny>(Builtin::kTypedArrayMergeSort, parameter0, parameter4, tmp6, parameter3, parameter1, parameter5, parameter6);
    ca_.Goto(&block6);
  }
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    TypedArrayMerge_0(state_, TNode<Context>{parameter0}, TNode<JSTypedArray>{parameter5}, TNode<Union<JSBoundFunction, JSFunction, JSObject, JSProxy, JSWrappedFunction>>{parameter6}, TNode<FixedArray>{parameter1}, TNode<UintPtrT>{parameter2}, TNode<UintPtrT>{tmp6}, TNode<UintPtrT>{parameter3}, TNode<FixedArray>{parameter4});
    tmp15 = Undefined_0(state_);
    CodeStubAssembler(state_).Return(tmp15);
  }
}

// https://crsrc.org/c/v8/src/builtins/typed-array-sort.tq?l=81&c=1
TNode<JSTypedArray> TypedArraySortCommon_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSTypedArray> p_array, TNode<UintPtrT> p_len, TNode<Union<JSBoundFunction, JSFunction, JSObject, JSProxy, JSWrappedFunction, Undefined>> p_comparefnArg, bool p_isSort) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssembler::SourcePositionScope pos_scope(&ca_);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<UintPtrT> block50(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<UintPtrT> block48(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<UintPtrT, UintPtrT, UintPtrT, UintPtrT> block56(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<UintPtrT, UintPtrT, UintPtrT, UintPtrT> block57(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<UintPtrT, UintPtrT, UintPtrT> block62(&ca_, compiler::CodeAssemblerLabel::kDeferred);
  compiler::CodeAssemblerParameterizedLabel<UintPtrT, UintPtrT, UintPtrT> block61(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<UintPtrT> block49(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<JSTypedArray> block1(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<JSTypedArray> block63(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{p_context}, CastIfEnumClass<MessageTemplate>(MessageTemplate::kTypedArrayTooLargeToSort));
  }
  ...
  if (block11.is_used()) {
    ca_.Bind(&block11);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/typed-array-sort.tq:101:46");
    CodeStubAssembler(state_).Unreachable();
  }
...
tmp19 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallInterfaceDescriptorFor(ExampleBuiltinForTorqueFunctionPointerType(1)), tmp10, TNode<Object>(), p_array, phi_bb12_10));
  ...
  if (block29.is_used()) {
    ...
    std::tie(tmp40, tmp41) = NewReference_Object_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp31}, TNode<IntPtrT>{tmp39}).Flatten();
  ...
  if (block13.is_used()) {
    ...
    tmp45 = ca_.CallBuiltin<JSAny>(Builtin::kTypedArrayMergeSort, p_context, tmp16, tmp44, p_len, tmp14, p_array, tmp7);
    if ((p_isSort)) {
      ca_.Goto(&block33);
    } else {
      ca_.Goto(&block34);
  ...
  if (block33.is_used()) {
    ...
    tmp46 = CodeStubAssembler(state_).LoadJSTypedArrayLengthAndValidate(TNode<JSTypedArray>{p_array}, CastIfEnumClass<TypedArrayAccessMode>(TypedArrayAccessMode::kRead), &label47);
    ca_.Goto(&block38);
    if (label47.is_used()) {
      ca_.Bind(&label47);
      ca_.Goto(&block39);
  ...
  if (block34.is_used()) {
    ...
    tmp50 = CodeStubAssembler(state_).LoadJSTypedArrayLengthAndValidate(TNode<JSTypedArray>{p_array}, CastIfEnumClass<TypedArrayAccessMode>(TypedArrayAccessMode::kRead), &label51);
    ca_.Goto(&block46);
    if (label51.is_used()) {
      ca_.Bind(&label51);
      ca_.Goto(&block47);
  ...
  if (block47.is_used()) {
    ca_.Bind(&block47);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/typed-array-sort.tq:141:68");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block46.is_used()) {
    ca_.Bind(&block46);
    tmp52 = CodeStubAssembler(state_).WordEqual(TNode<UintPtrT>{p_len}, TNode<UintPtrT>{tmp50});
  ...
  if (block43.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/typed-array-sort.tq", 139});
      CodeStubAssembler(state_).FailAssert("Torque assert 'writebackLen == LoadJSTypedArrayLengthAndValidate(array, access) otherwise unreachable' failed", pos_stack);
    }
  }
  ...
  if (block50.is_used()) {
    ...
    tmp54 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT>{phi_bb50_11}, TNode<UintPtrT>{phi_bb35_10});
    ca_.Branch(tmp54, &block48, std::vector<compiler::Node*>{phi_bb50_11}, &block49, std::vector<compiler::Node*>{phi_bb50_11});
  }
  ...
  if (block48.is_used()) {
    ...
    std::tie(tmp55, tmp56, tmp57) = FieldSliceFixedArrayObjects_0(state_, TNode<FixedArray>{tmp14}).Flatten();
    tmp58 = Convert_intptr_uintptr_0(state_, TNode<UintPtrT>{phi_bb48_11});
    ...
    ca_.Branch(tmp61, &block56, std::vector<compiler::Node*>{phi_bb48_11, phi_bb48_11, phi_bb48_11, phi_bb48_11}, &block57, std::vector<compiler::Node*>{phi_bb48_11, phi_bb48_11, phi_bb48_11, phi_bb48_11});
  }

  TNode<UintPtrT> phi_bb56_11;
  TNode<UintPtrT> phi_bb56_17;
  TNode<UintPtrT> phi_bb56_22;
  TNode<UintPtrT> phi_bb56_23;
  TNode<IntPtrT> tmp62;
  TNode<IntPtrT> tmp63;
  ...
  TNode<BoolT> tmp70;
  if (block56.is_used()) {
    ca_.Bind(&block56, &phi_bb56_11, &phi_bb56_17, &phi_bb56_22, &phi_bb56_23);
    ...
    std::tie(tmp64, tmp65) = NewReference_Object_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp55}, TNode<IntPtrT>{tmp63}).Flatten();
    tmp66 = CodeStubAssembler(state_).LoadReference<Object>(CodeStubAssembler::Reference{tmp64, tmp65});
    tmp67 = UnsafeCast_Numeric_0(state_, TNode<Context>{p_context}, TNode<Object>{tmp66});
tmp68 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallInterfaceDescriptorFor(ExampleBuiltinForTorqueFunctionPointerType(2)), tmp11, p_context, p_array, phi_bb56_17, tmp67));
    tmp69 = kStoreSucceded_0(state_);
    tmp70 = CodeStubAssembler(state_).SmiEqual(TNode<Smi>{tmp68}, TNode<Smi>{tmp69});
    ca_.Branch(tmp70, &block61, std::vector<compiler::Node*>{phi_bb56_11, phi_bb56_17, phi_bb56_17}, &block62, std::vector<compiler::Node*>{phi_bb56_11, phi_bb56_17, phi_bb56_17});
  }

  TNode<UintPtrT> phi_bb57_11;
  TNode<UintPtrT> phi_bb57_17;
  TNode<UintPtrT> phi_bb57_22;
  TNode<UintPtrT> phi_bb57_23;
  if (block57.is_used()) {
    ca_.Bind(&block57, &phi_bb57_11, &phi_bb57_17, &phi_bb57_22, &phi_bb57_23);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/torque-internal.tq:117:62");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  TNode<UintPtrT> phi_bb62_17;
  TNode<UintPtrT> phi_bb62_21;
  if (block62.is_used()) {
    ca_.Bind(&block62, &phi_bb62_11, &phi_bb62_17, &phi_bb62_21);
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/typed-array.tq", 107});
      CodeStubAssembler(state_).FailAssert("Torque assert 'result == kStoreSucceded' failed", pos_stack);
    }
  }

  TNode<UintPtrT> phi_bb61_11;
  TNode<UintPtrT> phi_bb61_17;
  TNode<UintPtrT> phi_bb61_21;
  TNode<UintPtrT> tmp71;
  TNode<UintPtrT> tmp72;
  if (block61.is_used()) {
    ca_.Bind(&block61, &phi_bb61_11, &phi_bb61_17, &phi_bb61_21);
    tmp71 = FromConstexpr_uintptr_constexpr_int31_0(state_, 1);
    tmp72 = CodeStubAssembler(state_).UintPtrAdd(TNode<UintPtrT>{phi_bb61_11}, TNode<UintPtrT>{tmp71});
    ca_.Goto(&block50, tmp72);
  }

  TNode<UintPtrT> phi_bb49_11;
  if (block49.is_used()) {
  ...
  if (block1.is_used()) {
    ...
    ca_.Goto(&block63, phi_bb1_4);
  }

  TNode<JSTypedArray> phi_bb63_4;
    ca_.Bind(&block63, &phi_bb63_4);
  return TNode<JSTypedArray>{phi_bb63_4};
}
...
TF_BUILTIN(TypedArrayPrototypeSort, CodeStubAssembler) {
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    tmp4 = TypedArrayBuiltinsAssembler(state_).ValidateTypedArrayAndGetLength(TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, kBuiltinNameSort_0(state_), CastIfEnumClass<TypedArrayAccessMode>(TypedArrayAccessMode::kWrite));
    tmp5 = UnsafeCast_JSTypedArray_0(state_, TNode<Context>{parameter0}, TNode<Object>{parameter1});
    tmp6 = TypedArraySortCommon_0(state_, TNode<Context>{parameter0}, TNode<JSTypedArray>{tmp5}, TNode<UintPtrT>{tmp4}, TNode<Union<JSBoundFunction, JSFunction, JSObject, JSProxy, JSWrappedFunction, Undefined>>{tmp2}, true);
    arguments.PopAndReturn(tmp6);
  }
}

// https://crsrc.org/c/v8/src/builtins/typed-array-sort.tq?l=147&c=28
TNode<Numeric> UnsafeCast_Numeric_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = Is_Numeric_Object_0(state_, TNode<Context>{p_context}, TNode<Object>{p_o});
