...
TorqueStructTypedArrayAccessor_0 GetTypedArrayAccessor_0(compiler::CodeAssemblerState* state_, TNode<Int32T> p_elementsKindParam) {
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    tmp1 = FromConstexpr_int32_constexpr_int32_0(state_, CastIfEnumClass<int32_t>(kFirstRabGsabFixedTypedArrayElementsKind_0(state_)));
    tmp2 = CodeStubAssembler(state_).Int32Sub(TNode<Int32T>{p_elementsKindParam}, TNode<Int32T>{tmp1});
    tmp3 = FromConstexpr_int32_constexpr_int32_0(state_, CastIfEnumClass<int32_t>(kFirstFixedTypedArrayElementsKind_0(state_)));
  ...
  if (block3.is_used()) {
    ...
    tmp6 = CodeStubAssembler(state_).IsElementsKindGreaterThan(TNode<Int32T>{phi_bb3_1}, CastIfEnumClass<ElementsKind>(ElementsKind::UINT32_ELEMENTS));
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/typed-array.tq:183:3");
...
TNode<JSTypedArray> EnsureValid_0(compiler::CodeAssemblerState* state_, TNode<JSTypedArray> p_array, TypedArrayAccessMode p_mode, compiler::CodeAssemblerLabel* label_Fail) {
  ...
  if (block0.is_used()) {
    ...
    CodeStubAssembler(state_).IsJSArrayBufferViewValid(TNode<JSArrayBufferView>{p_array}, p_mode, &label0, &label1);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block5);
    }
...
TorqueStructValidJSTypedArrayAndLength_0 EnsureValidAndReadLength_0(compiler::CodeAssemblerState* state_, TNode<JSTypedArray> p_array, TypedArrayAccessMode p_mode, compiler::CodeAssemblerLabel* label_Fail) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    compiler::CodeAssemblerLabel label1(&ca_);
    tmp0 = CodeStubAssembler(state_).LoadJSTypedArrayLengthAndValidate(TNode<JSTypedArray>{p_array}, p_mode, &label1);
    ca_.Goto(&block3);
    if (label1.is_used()) {
      ca_.Bind(&label1);
      ca_.Goto(&block4);
  ...
  if (block3.is_used()) {
    ...
    ca_.Bind(&block5);
  return TorqueStructValidJSTypedArrayAndLength_0{TNode<JSTypedArray>{tmp2}, TNode<UintPtrT>{tmp0}};
}
...
ElementsKind KindForArrayType_Uint8Elements_0(compiler::CodeAssemblerState* state_) {
  ...
  if (block0.is_used()) {
    ...
    ca_.Bind(&block2);
  return CastIfEnumClass<ElementsKind>(ElementsKind::UINT8_ELEMENTS);
}
...
ElementsKind KindForArrayType_Int8Elements_0(compiler::CodeAssemblerState* state_) {
  ...
  if (block0.is_used()) {
    ...
    ca_.Bind(&block2);
  return CastIfEnumClass<ElementsKind>(ElementsKind::INT8_ELEMENTS);
}
...
ElementsKind KindForArrayType_Uint16Elements_0(compiler::CodeAssemblerState* state_) {
  ...
  if (block0.is_used()) {
    ...
    ca_.Bind(&block2);
  return CastIfEnumClass<ElementsKind>(ElementsKind::UINT16_ELEMENTS);
}
...
ElementsKind KindForArrayType_Int16Elements_0(compiler::CodeAssemblerState* state_) {
  ...
  if (block0.is_used()) {
    ...
    ca_.Bind(&block2);
  return CastIfEnumClass<ElementsKind>(ElementsKind::INT16_ELEMENTS);
}
...
ElementsKind KindForArrayType_Uint32Elements_0(compiler::CodeAssemblerState* state_) {
  ...
  if (block0.is_used()) {
    ...
    ca_.Bind(&block2);
  return CastIfEnumClass<ElementsKind>(ElementsKind::UINT32_ELEMENTS);
}
...
ElementsKind KindForArrayType_Int32Elements_0(compiler::CodeAssemblerState* state_) {
  ...
  if (block0.is_used()) {
    ...
    ca_.Bind(&block2);
  return CastIfEnumClass<ElementsKind>(ElementsKind::INT32_ELEMENTS);
}
...
ElementsKind KindForArrayType_Float16Elements_0(compiler::CodeAssemblerState* state_) {
  ...
  if (block0.is_used()) {
    ...
    ca_.Bind(&block2);
  return CastIfEnumClass<ElementsKind>(ElementsKind::FLOAT16_ELEMENTS);
}
...
ElementsKind KindForArrayType_Float32Elements_0(compiler::CodeAssemblerState* state_) {
  ...
  if (block0.is_used()) {
    ...
    ca_.Bind(&block2);
  return CastIfEnumClass<ElementsKind>(ElementsKind::FLOAT32_ELEMENTS);
}
...
ElementsKind KindForArrayType_Float64Elements_0(compiler::CodeAssemblerState* state_) {
  ...
  if (block0.is_used()) {
    ...
    ca_.Bind(&block2);
  return CastIfEnumClass<ElementsKind>(ElementsKind::FLOAT64_ELEMENTS);
}
...
ElementsKind KindForArrayType_Uint8ClampedElements_0(compiler::CodeAssemblerState* state_) {
  ...
  if (block0.is_used()) {
    ...
    ca_.Bind(&block2);
  return CastIfEnumClass<ElementsKind>(ElementsKind::UINT8_CLAMPED_ELEMENTS);
}
...
ElementsKind KindForArrayType_BigUint64Elements_0(compiler::CodeAssemblerState* state_) {
  ...
  if (block0.is_used()) {
    ...
    ca_.Bind(&block2);
  return CastIfEnumClass<ElementsKind>(ElementsKind::BIGUINT64_ELEMENTS);
}
...
ElementsKind KindForArrayType_BigInt64Elements_0(compiler::CodeAssemblerState* state_) {
  ...
  if (block0.is_used()) {
    ...
    ca_.Bind(&block2);
  return CastIfEnumClass<ElementsKind>(ElementsKind::BIGINT64_ELEMENTS);
}
...
TF_BUILTIN(StoreTypedElementNumeric_Int32Elements_0, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp1 = CodeStubAssembler(state_).LoadReference<JSArrayBuffer>(CodeStubAssembler::Reference{parameter1, tmp0});
    tmp2 = UnsafeCast_JSArrayBuffer_0(state_, TNode<Context>{parameter0}, TNode<Object>{tmp1});
    tmp3 = IsImmutableArrayBuffer_0(state_, TNode<JSArrayBuffer>{tmp2});
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    {
      ...
      pos_stack.push_back({"src/builtins/typed-array.tq", 317});
      CodeStubAssembler(state_).FailAssert("Torque assert '!(IsImmutableArrayBuffer(UnsafeCast<JSArrayBuffer>(typedArray.buffer)))' failed", pos_stack);
    }
  }
...
TF_BUILTIN(StoreTypedElementJSAny_Int32Elements_0, CodeStubAssembler) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    tmp1 = kStoreFailureArrayDetachedOrImmutableOrOutOfBounds_0(state_);
    CodeStubAssembler(state_).Return(tmp1);
  }
...
TNode<JSArrayBuffer> UnsafeCast_JSArrayBuffer_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = Is_JSArrayBuffer_Object_0(state_, TNode<Context>{p_context}, TNode<Object>{p_o});
