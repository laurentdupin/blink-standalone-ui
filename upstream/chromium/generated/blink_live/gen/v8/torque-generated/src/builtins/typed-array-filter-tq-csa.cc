...
// https://crsrc.org/c/v8/src/builtins/typed-array-filter.tq?l=6&c=1
...
TF_BUILTIN(TypedArrayPrototypeFilter, CodeStubAssembler) {
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{parameter0}, CastIfEnumClass<MessageTemplate>(MessageTemplate::kNotTypedArray), kBuiltinNameFilter_0(state_));
  }
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{parameter0}, CastIfEnumClass<MessageTemplate>(MessageTemplate::kTypedArrayValidateErrorOperation), kBuiltinNameFilter_0(state_));
  }
  ...
  if (block13.is_used()) {
    ...
    tmp21 = CodeStubAssembler(state_).LoadJSTypedArrayLengthAndValidate(TNode<JSTypedArray>{tmp16}, CastIfEnumClass<TypedArrayAccessMode>(TypedArrayAccessMode::kRead), &label22);
...
tmp25 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallInterfaceDescriptorFor(ExampleBuiltinForTorqueFunctionPointerType(1)), tmp18, TNode<Object>(), tmp24, phi_bb25_17));
  ...
  if (block41.is_used()) {
    ...
    tmp43 = TheHole_0(state_);
    tmp44 = ExtractFixedArray_0(state_, TNode<FixedArray>{phi_bb41_11}, TNode<IntPtrT>{tmp42}, TNode<IntPtrT>{phi_bb41_13}, TNode<IntPtrT>{tmp36}, TNode<Hole>{tmp43});
    ca_.Goto(&block35, tmp44, tmp36, phi_bb41_13, phi_bb41_17);
  }
  ...
  if (block35.is_used()) {
    ...
    std::tie(tmp45, tmp46, tmp47) = FieldSliceFixedArrayObjects_0(state_, TNode<FixedArray>{phi_bb35_11}).Flatten();
    tmp48 = FromConstexpr_intptr_constexpr_int31_0(state_, 1);
    tmp49 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{phi_bb35_13}, TNode<IntPtrT>{tmp48});
    tmp50 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{phi_bb35_13});
    ...
    ca_.Branch(tmp52, &block47, std::vector<compiler::Node*>{phi_bb35_11, phi_bb35_12, phi_bb35_17, phi_bb35_11, phi_bb35_13, phi_bb35_13, phi_bb35_13, phi_bb35_13}, &block48, std::vector<compiler::Node*>{phi_bb35_11, phi_bb35_12, phi_bb35_17, phi_bb35_11, phi_bb35_13, phi_bb35_13, phi_bb35_13, phi_bb35_13});
  }
  ...
  if (block47.is_used()) {
    ...
    tmp53 = TimesSizeOf_Object_0(state_, TNode<IntPtrT>{phi_bb47_32});
    tmp54 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp46}, TNode<IntPtrT>{tmp53});
    std::tie(tmp55, tmp56) = NewReference_Object_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp45}, TNode<IntPtrT>{tmp54}).Flatten();
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp55, tmp56}, phi_bb17_18);
    ca_.Goto(&block29, phi_bb47_11, phi_bb47_12, tmp49, phi_bb47_17);
  }
  ...
  if (block29.is_used()) {
    ...
    tmp57 = FromConstexpr_uintptr_constexpr_int31_0(state_, 1);
    tmp58 = CodeStubAssembler(state_).UintPtrAdd(TNode<UintPtrT>{phi_bb29_17}, TNode<UintPtrT>{tmp57});
    ca_.Goto(&block15, phi_bb29_11, phi_bb29_12, phi_bb29_13, phi_bb17_15, tmp58);
  }
  ...
  if (block14.is_used()) {
    ...
    tmp59 = CodeStubAssembler(state_).Unsigned(TNode<IntPtrT>{phi_bb14_13});
    tmp60 = TypedArraySpeciesCreateByLength_0(state_, TNode<Context>{parameter0}, kBuiltinNameFilter_0(state_), TNode<JSTypedArray>{tmp0}, TNode<UintPtrT>{tmp59}, CastIfEnumClass<TypedArrayAccessMode>(TypedArrayAccessMode::kWrite));
    tmp61 = CodeStubAssembler(state_).Unsigned(TNode<IntPtrT>{phi_bb14_13});
    tmp62 = Convert_Number_uintptr_0(state_, TNode<UintPtrT>{tmp61});
    tmp63 = CodeStubAssembler(state_).LoadNativeContext(TNode<Context>{parameter0});
    tmp64 = CodeStubAssembler(state_).LoadJSArrayElementsMap(CastIfEnumClass<ElementsKind>(ElementsKind::PACKED_ELEMENTS), TNode<NativeContext>{tmp63});
    tmp65 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    tmp66 = CodeStubAssembler(state_).IntPtrGreaterThanOrEqual(TNode<IntPtrT>{phi_bb14_13}, TNode<IntPtrT>{tmp65});
    ca_.Branch(tmp66, &block53, std::vector<compiler::Node*>{phi_bb14_11, phi_bb14_12, phi_bb14_13, phi_bb14_15, phi_bb14_13, phi_bb14_13}, &block54, std::vector<compiler::Node*>{phi_bb14_11, phi_bb14_12, phi_bb14_13, phi_bb14_15, phi_bb14_13, phi_bb14_13});
  }
  ...
  if (block53.is_used()) {
    ...
    tmp68 = CodeStubAssembler(state_).IntPtrGreaterThanOrEqual(TNode<IntPtrT>{phi_bb53_26}, TNode<IntPtrT>{tmp67});
    ca_.Branch(tmp68, &block55, std::vector<compiler::Node*>{phi_bb53_11, phi_bb53_12, phi_bb53_13, phi_bb53_15, phi_bb53_25, phi_bb53_26}, &block56, std::vector<compiler::Node*>{phi_bb53_11, phi_bb53_12, phi_bb53_13, phi_bb53_15, phi_bb53_25, phi_bb53_26});
  }
  ...
  if (block55.is_used()) {
    ...
    tmp69 = CodeStubAssembler(state_).IntPtrGreaterThanOrEqual(TNode<IntPtrT>{phi_bb55_26}, TNode<IntPtrT>{phi_bb55_13});
    ca_.Branch(tmp69, &block57, std::vector<compiler::Node*>{phi_bb55_11, phi_bb55_12, phi_bb55_13, phi_bb55_15, phi_bb55_25, phi_bb55_26}, &block58, std::vector<compiler::Node*>{phi_bb55_11, phi_bb55_12, phi_bb55_13, phi_bb55_15, phi_bb55_25, phi_bb55_26});
  }
  ...
  if (block57.is_used()) {
    ...
    tmp71 = TheHole_0(state_);
    tmp72 = ExtractFixedArray_0(state_, TNode<FixedArray>{phi_bb57_11}, TNode<IntPtrT>{tmp70}, TNode<IntPtrT>{phi_bb57_13}, TNode<IntPtrT>{phi_bb57_26}, TNode<Hole>{tmp71});
    tmp73 = Convert_Smi_intptr_0(state_, TNode<IntPtrT>{phi_bb57_13});
    tmp74 = CodeStubAssembler(state_).AllocateJSArray(TNode<Map>{tmp64}, TNode<FixedArrayBase>{tmp72}, TNode<Smi>{tmp73});
    CodeStubAssembler(state_).CallRuntime(Runtime::kTypedArrayCopyElements, parameter0, tmp60, tmp74, tmp62);
