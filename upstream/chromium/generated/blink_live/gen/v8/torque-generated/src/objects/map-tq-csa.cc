...
TNode<Map> Cast_Map_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_obj, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block0.is_used()) {
    ...
    tmp0 = DownCastForTorqueClass_Map_0(state_, TNode<HeapObject>{p_obj}, &label1);
    ca_.Goto(&block3);
    if (label1.is_used()) {
      ca_.Bind(&label1);
      ca_.Goto(&block4);
...
TNode<PrototypeSharedClosureInfo> LoadMapPrototypeSharedClosureInfo_0(compiler::CodeAssemblerState* state_, TNode<Map> p_m, compiler::CodeAssemblerLabel* label_HasNoPrototypeSharedClosureInfo) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    compiler::CodeAssemblerLabel label1(&ca_);
    tmp0 = Method_Map_PrototypeSharedClosureInfo_0(state_, TNode<Map>{p_m}, &label1);
    ca_.Goto(&block3);
    if (label1.is_used()) {
      ca_.Bind(&label1);
      ca_.Goto(&block4);
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    ca_.Goto(label_HasNoPrototypeSharedClosureInfo);
  }
...
TNode<BoolT> IsSimpleObjectMap_0(compiler::CodeAssemblerState* state_, TNode<Map> p_map) {
  ...
  if (block0.is_used()) {
    ...
    tmp1 = CodeStubAssembler(state_).LoadReference<Uint16T>(CodeStubAssembler::Reference{p_map, tmp0});
    tmp2 = CodeStubAssembler(state_).IsSpecialReceiverInstanceType(TNode<Uint16T>{tmp1});
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    tmp4 = FromConstexpr_intptr_constexpr_int31_0(state_, 10);
    tmp5 = CodeStubAssembler(state_).LoadReference<Uint8T>(CodeStubAssembler::Reference{p_map, tmp4});
    tmp6 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32<base::BitField<bool, 2, 1, uint8_t>>(ca_.UncheckedCast<Word32T>(tmp5)));
    tmp7 = CodeStubAssembler(state_).Word32BinaryNot(TNode<BoolT>{tmp6});
    tmp8 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32<base::BitField<bool, 5, 1, uint8_t>>(ca_.UncheckedCast<Word32T>(tmp5)));
    tmp9 = CodeStubAssembler(state_).Word32BinaryNot(TNode<BoolT>{tmp8});
    tmp10 = CodeStubAssembler(state_).Word32And(TNode<BoolT>{tmp7}, TNode<BoolT>{tmp9});
...
TNode<Union<Map, WeakArrayList>> LoadMapDependentCode_0(compiler::CodeAssemblerState* state_, TNode<Map> p_o) {
  ...
  TNode<IntPtrT> tmp0;
  TNode<Union<Map, WeakArrayList>> tmp1;
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 28);
    tmp1 = CodeStubAssembler(state_).LoadReference<Union<Map, WeakArrayList>>(CodeStubAssembler::Reference{p_o, tmp0});
    ca_.Goto(&block2);
  }

    ca_.Bind(&block2);
  return TNode<Union<Map, WeakArrayList>>{tmp1};
}
...
void StoreMapDependentCode_0(compiler::CodeAssemblerState* state_, TNode<Map> p_o, TNode<Union<Map, WeakArrayList>> p_v) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 28);
    CodeStubAssembler(state_).StoreReference<Union<Map, WeakArrayList>>(CodeStubAssembler::Reference{p_o, tmp0}, p_v);
    ca_.Goto(&block2);
  }
...
TNode<Union<Map, PrototypeInfo, PrototypeSharedClosureInfo, Smi, TransitionArray, Weak<HeapObject>>> LoadMapTransitionsOrPrototypeInfo_0(compiler::CodeAssemblerState* state_, TNode<Map> p_o) {
  ...
  TNode<IntPtrT> tmp0;
  TNode<Union<Map, PrototypeInfo, PrototypeSharedClosureInfo, Smi, TransitionArray, Weak<HeapObject>>> tmp1;
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 36);
    tmp1 = CodeStubAssembler(state_).LoadReference<Union<Map, PrototypeInfo, PrototypeSharedClosureInfo, Smi, TransitionArray, Weak<HeapObject>>>(CodeStubAssembler::Reference{p_o, tmp0});
    ca_.Goto(&block2);
  }

    ca_.Bind(&block2);
  return TNode<Union<Map, PrototypeInfo, PrototypeSharedClosureInfo, Smi, TransitionArray, Weak<HeapObject>>>{tmp1};
}
...
void StoreMapTransitionsOrPrototypeInfo_0(compiler::CodeAssemblerState* state_, TNode<Map> p_o, TNode<Union<Map, PrototypeInfo, PrototypeSharedClosureInfo, Smi, TransitionArray, Weak<HeapObject>>> p_v) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 36);
    CodeStubAssembler(state_).StoreReference<Union<Map, PrototypeInfo, PrototypeSharedClosureInfo, Smi, TransitionArray, Weak<HeapObject>>>(CodeStubAssembler::Reference{p_o, tmp0}, p_v);
    ca_.Goto(&block2);
  }
...
TNode<PrototypeInfo> Method_Map_PrototypeInfo_0(compiler::CodeAssemblerState* state_, TNode<Map> p_this, compiler::CodeAssemblerLabel* label_HasNoPrototypeInfo) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 36);
    tmp1 = CodeStubAssembler(state_).LoadReference<Union<Map, PrototypeInfo, PrototypeSharedClosureInfo, Smi, TransitionArray, Weak<HeapObject>>>(CodeStubAssembler::Reference{p_this, tmp0});
    compiler::CodeAssemblerLabel label3(&ca_);
    tmp2 = Cast_Weak_Map_0(state_, TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp1}, &label3);
    ca_.Goto(&block5);
    if (label3.is_used()) {
      ca_.Bind(&label3);
      ca_.Goto(&block6);
  ...
  if (block6.is_used()) {
    ...
    tmp4 = Cast_Smi_0(state_, TNode<Object>{ca_.UncheckedCast<Union<Map, PrototypeInfo, PrototypeSharedClosureInfo, Smi, TransitionArray>>(tmp1)}, &label5);
    ca_.Goto(&block9);
    if (label5.is_used()) {
      ca_.Bind(&label5);
      ca_.Goto(&block10);
  ...
  if (block10.is_used()) {
    ...
    tmp6 = Cast_PrototypeInfo_0(state_, TNode<HeapObject>{ca_.UncheckedCast<Union<Map, PrototypeInfo, PrototypeSharedClosureInfo, TransitionArray>>(tmp1)}, &label7);
    ca_.Goto(&block13);
    if (label7.is_used()) {
      ca_.Bind(&label7);
      ca_.Goto(&block14);
...
TNode<PrototypeSharedClosureInfo> Method_Map_PrototypeSharedClosureInfo_0(compiler::CodeAssemblerState* state_, TNode<Map> p_this, compiler::CodeAssemblerLabel* label_HasNoPrototypeSharedClosureInfo) {
  ...
  if (block0.is_used()) {
    ...
    tmp1 = CodeStubAssembler(state_).LoadReference<Union<Map, PrototypeInfo, PrototypeSharedClosureInfo, Smi, TransitionArray, Weak<HeapObject>>>(CodeStubAssembler::Reference{p_this, tmp0});
    compiler::CodeAssemblerLabel label3(&ca_);
    tmp2 = Cast_WeakHeapObject_0(state_, TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp1}, &label3);
    ca_.Goto(&block8);
    if (label3.is_used()) {
      ca_.Bind(&label3);
      ca_.Goto(&block9);
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    compiler::CodeAssemblerLabel label5(&ca_);
    tmp4 = CodeStubAssembler(state_).TaggedToHeapObject(TNode<Object>{ca_.UncheckedCast<Object>(tmp1)}, &label5);
    ca_.Goto(&block11);
    if (label5.is_used()) {
      ca_.Bind(&label5);
      ca_.Goto(&block12);
  ...
  TNode<PrototypeSharedClosureInfo> tmp6;
  if (block11.is_used()) {
    ca_.Bind(&block11);
    compiler::CodeAssemblerLabel label7(&ca_);
    tmp6 = Cast_PrototypeSharedClosureInfo_0(state_, TNode<HeapObject>{tmp4}, &label7);
    ca_.Goto(&block13);
    if (label7.is_used()) {
      ca_.Bind(&label7);
      ca_.Goto(&block14);
  ...
  if (block4.is_used()) {
    ...
    ca_.Bind(&block15);
  return TNode<PrototypeSharedClosureInfo>{tmp6};
}
...
TNode<BoolT> Method_Map_IsUndetectable_0(compiler::CodeAssemblerState* state_, TNode<Map> p_this) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 10);
    tmp1 = CodeStubAssembler(state_).LoadReference<Uint8T>(CodeStubAssembler::Reference{p_this, tmp0});
    tmp2 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32<base::BitField<bool, 4, 1, uint8_t>>(ca_.UncheckedCast<Word32T>(tmp1)));
    ca_.Goto(&block2);
  }
...
TorqueStructSlice_uint8_MutableReference_uint8_0 FieldSliceJSInterceptorMapExtendedPadding_0(compiler::CodeAssemblerState* state_, TNode<JSInterceptorMap> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = Convert_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x3ull));
    tmp1 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x29ull));
...
TNode<Uint8T> LoadJSInterceptorMapExtendedPadding_0(compiler::CodeAssemblerState* state_, TNode<JSInterceptorMap> p_o, TNode<IntPtrT> p_i) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    std::tie(tmp0, tmp1, tmp2) = FieldSliceJSInterceptorMapExtendedPadding_0(state_, TNode<JSInterceptorMap>{p_o}).Flatten();
...
TNode<InterceptorInfo> LoadJSInterceptorMapNamedInterceptor_0(compiler::CodeAssemblerState* state_, TNode<JSInterceptorMap> p_o) {
  ...
  TNode<IntPtrT> tmp0;
  TNode<InterceptorInfo> tmp1;
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 44);
    tmp1 = CodeStubAssembler(state_).LoadReference<InterceptorInfo>(CodeStubAssembler::Reference{p_o, tmp0});
    ca_.Goto(&block2);
  }

    ca_.Bind(&block2);
  return TNode<InterceptorInfo>{tmp1};
}
...
void StoreJSInterceptorMapNamedInterceptor_0(compiler::CodeAssemblerState* state_, TNode<JSInterceptorMap> p_o, TNode<InterceptorInfo> p_v) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 44);
    CodeStubAssembler(state_).StoreReference<InterceptorInfo>(CodeStubAssembler::Reference{p_o, tmp0}, p_v);
    ca_.Goto(&block2);
  }
...
TNode<Map> DownCastForTorqueClass_Map_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    if ((CodeStubAssembler(state_).ClassHasMapConstant<Map>())) {
      ca_.Goto(&block6);
    } else {
      ca_.Goto(&block7);
    }
  ...
  if (block7.is_used()) {
    ...
    tmp6 = FromConstexpr_uint32_constexpr_uint32_0(state_, CastIfEnumClass<uint32_t>(static_cast<InstanceType>(268)));
...
TNode<PrototypeSharedClosureInfo> Cast_PrototypeSharedClosureInfo_1(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Union<HeapObject, Smi, Weak<HeapObject>>> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    compiler::CodeAssemblerLabel label3(&ca_);
    tmp2 = Cast_PrototypeSharedClosureInfo_2(state_, TNode<Context>{p_context}, TNode<Object>{ca_.UncheckedCast<Object>(p_o)}, &label3);
    ca_.Goto(&block7);
    if (label3.is_used()) {
      ca_.Bind(&label3);
      ca_.Goto(&block8);
