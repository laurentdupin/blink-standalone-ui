...
TF_BUILTIN(ArraySomeLoopEagerDeoptContinuation, CodeStubAssembler) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-some.tq:16:59");
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-some.tq:17:57");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-some.tq:18:52");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-some.tq:19:55");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block15.is_used()) {
    ...
    tmp10 = ca_.CallBuiltin<JSAny>(Builtin::kArraySomeLoopContinuation, parameter0, tmp0, tmp2, parameter3, tmp8, tmp0, tmp4, tmp6, tmp9);
...
TF_BUILTIN(ArraySomeLoopLazyDeoptContinuation, CodeStubAssembler) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-some.tq:32:59");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-some.tq:33:57");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-some.tq:34:50");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-some.tq:35:55");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block18.is_used()) {
    ...
    tmp14 = ca_.CallBuiltin<JSAny>(Builtin::kArraySomeLoopContinuation, parameter0, tmp0, tmp2, parameter3, tmp12, tmp0, tmp11, tmp6, tmp13);
...
TF_BUILTIN(ArraySomeLoopContinuation, CodeStubAssembler) {
  ...
  if (block5.is_used()) {
    ...
    ca_.Branch(tmp6, &block7, std::vector<compiler::Node*>{phi_bb5_9}, &block8, std::vector<compiler::Node*>{phi_bb5_9});
  }
...
TF_BUILTIN(ArraySome, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = RequireObjectCoercible_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, "Array.prototype.some");
  ...
  if (block5.is_used()) {
    ...
    tmp11 = FastArraySome_0(state_, TNode<Context>{parameter0}, TNode<JSReceiver>{tmp1}, TNode<Number>{tmp2}, TNode<Union<JSBoundFunction, JSFunction, JSObject, JSProxy, JSWrappedFunction>>{tmp7}, TNode<JSAny>{tmp10}, &label12, &tmp13);
    ca_.Goto(&block9);
    if (label12.is_used()) {
      ca_.Bind(&label12);
      ca_.Goto(&block10);
  ...
  if (block10.is_used()) {
    ...
    tmp16 = ca_.CallBuiltin<JSAny>(Builtin::kArraySomeLoopContinuation, parameter0, tmp1, tmp7, tmp10, tmp14, tmp1, tmp13.value(), tmp2, tmp15);
