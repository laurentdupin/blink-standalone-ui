...
TF_BUILTIN(SetPrototypeDifference, CodeStubAssembler) {
  ...
  if (block3.is_used()) {
    ...
    tmp10 = CodeStubAssembler(state_).CloneFixedArray(TNode<FixedArrayBase>{tmp9}, CastIfEnumClass<CodeStubAssembler::ExtractFixedArrayFlag>(CodeStubAssembler::ExtractFixedArrayFlag::kFixedArrays));
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/set-difference.tq:27:17");
  ...
  if (block42.is_used()) {
    ...
    tmp43 = CollectionsBuiltinsAssembler(state_).TableHasKey(TNode<Context>{parameter0}, TNode<OrderedHashSet>{tmp11}, TNode<JSAny>{tmp39});
  ...
  if (block44.is_used()) {
    ...
    tmp44 = CollectionsBuiltinsAssembler(state_).DeleteFromSetTable(TNode<Context>{parameter0}, TNode<OrderedHashSet>{tmp11}, TNode<JSAny>{tmp39}, &label45);
  ...
  if (block49.is_used()) {
    ...
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/set-difference.tq:77:29");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block59.is_used()) {
    ...
    tmp59 = CollectionsBuiltinsAssembler(state_).DeleteFromSetTable(TNode<Context>{parameter0}, TNode<OrderedHashSet>{tmp11}, TNode<JSAny>{tmp54}, &label60);
  ...
  if (block68.is_used()) {
    ...
    tmp69 = CollectionsBuiltinsAssembler(state_).TableHasKey(TNode<Context>{parameter0}, TNode<OrderedHashSet>{tmp11}, TNode<JSAny>{tmp68});
  ...
  if (block70.is_used()) {
    ...
    tmp70 = CollectionsBuiltinsAssembler(state_).DeleteFromSetTable(TNode<Context>{parameter0}, TNode<OrderedHashSet>{tmp11}, TNode<JSAny>{tmp68}, &label71);
  ...
  if (block75.is_used()) {
    ...
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/set-difference.tq:141:25");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block13.is_used()) {
    ...
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/set-difference.tq:155:3");
    CodeStubAssembler(state_).Unreachable();
  }
...
// https://crsrc.org/c/v8/src/builtins/set-difference.tq?l=15&c=13
...
// https://crsrc.org/c/v8/src/builtins/set-difference.tq?l=36&c=7
...
TNode<Smi> FastDifference_OrderedHashSet_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructStableJSSetBackingTableWitness_0 p_collectionToIterate, TNode<OrderedHashSet> p_tableToLookup, TNode<OrderedHashSet> p_resultSetData) {
  ...
  if (block17.is_used()) {
    ...
    tmp22 = CollectionsBuiltinsAssembler(state_).TableHasKey(TNode<Context>{p_context}, TNode<OrderedHashSet>{p_tableToLookup}, TNode<JSAny>{tmp19});
  ...
  if (block19.is_used()) {
    ...
    tmp23 = CollectionsBuiltinsAssembler(state_).DeleteFromSetTable(TNode<Context>{p_context}, TNode<OrderedHashSet>{p_resultSetData}, TNode<JSAny>{tmp19}, &label24);
  ...
  if (block14.is_used()) {
    ...
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/set-difference.tq:187:3");
    CodeStubAssembler(state_).Unreachable();
  }
...
// https://crsrc.org/c/v8/src/builtins/set-difference.tq?l=52&c=7
...
TNode<Smi> FastDifference_OrderedHashMap_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructStableJSSetBackingTableWitness_0 p_collectionToIterate, TNode<OrderedHashMap> p_tableToLookup, TNode<OrderedHashSet> p_resultSetData) {
  ...
  if (block17.is_used()) {
    ca_.Bind(&block17, &phi_bb17_8, &phi_bb17_9, &phi_bb17_10, &phi_bb17_14);
    tmp22 = CollectionsBuiltinsAssembler(state_).TableHasKey(TNode<Context>{p_context}, TNode<OrderedHashMap>{p_tableToLookup}, TNode<JSAny>{tmp19});
    ca_.Branch(tmp22, &block19, std::vector<compiler::Node*>{phi_bb17_10}, &block20, std::vector<compiler::Node*>{phi_bb17_10});
  }
