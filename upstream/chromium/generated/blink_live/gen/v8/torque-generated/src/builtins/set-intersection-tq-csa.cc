...
TF_BUILTIN(SetPrototypeIntersection, CodeStubAssembler) {
  ...
  if (block35.is_used()) {
    ...
    tmp43 = CollectionsBuiltinsAssembler(state_).TableHasKey(TNode<Context>{parameter0}, TNode<OrderedHashSet>{tmp9}, TNode<JSAny>{tmp39});
  ...
  if (block64.is_used()) {
    ...
    tmp75 = CollectionsBuiltinsAssembler(state_).TableHasKey(TNode<Context>{parameter0}, TNode<OrderedHashSet>{tmp74}, TNode<JSAny>{tmp67});
  ...
  if (block8.is_used()) {
    ...
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/set-intersection.tq:160:3");
    CodeStubAssembler(state_).Unreachable();
  }
...
// https://crsrc.org/c/v8/src/builtins/set-intersection.tq?l=41&c=27
TNode<OrderedHashSet> FastIntersect_StableJSSetBackingTableWitness_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructStableJSSetBackingTableWitness_0 p_collectionToIterate, TorqueStructStableJSSetBackingTableWitness_0 p_tableToLookup, TNode<String> p_methodName, TNode<OrderedHashSet> p_resultSetData) {
  ...
  if (block9.is_used()) {
    ...
    tmp9 = CollectionsBuiltinsAssembler(state_).TableHasKey(TNode<Context>{p_context}, TNode<OrderedHashSet>{p_tableToLookup.unstable}, TNode<JSAny>{tmp6});
  ...
  if (block6.is_used()) {
    ...
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/set-intersection.tq:186:3");
    CodeStubAssembler(state_).Unreachable();
  }
...
// https://crsrc.org/c/v8/src/builtins/set-intersection.tq?l=59&c=27
TNode<OrderedHashSet> FastIntersect_StableJSMapBackingTableWitness_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructStableJSSetBackingTableWitness_0 p_collectionToIterate, TorqueStructStableJSMapBackingTableWitness_0 p_tableToLookup, TNode<String> p_methodName, TNode<OrderedHashSet> p_resultSetData) {
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9, &phi_bb9_7, &phi_bb9_11, &phi_bb9_12, &phi_bb9_16);
    tmp9 = CollectionsBuiltinsAssembler(state_).TableHasKey(TNode<Context>{p_context}, TNode<OrderedHashMap>{p_tableToLookup.unstable}, TNode<JSAny>{tmp6});
    ca_.Branch(tmp9, &block11, std::vector<compiler::Node*>{phi_bb9_7}, &block12, std::vector<compiler::Node*>{phi_bb9_7});
  }
