...
TF_BUILTIN(WebAssemblyStringCast, CodeStubAssembler) {
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    Trap_0(state_, TNode<Context>{parameter0}, CastIfEnumClass<MessageTemplate>(MessageTemplate::kWasmTrapIllegalCast));
  }
...
TF_BUILTIN(WebAssemblyStringFromWtf16Array, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp2 = TORQUE_CAST(CodeStubAssembler(state_).CallRuntime(Runtime::kWasmCastToSpecialPrimitiveArray, parameter0, parameter1, tmp0, tmp1)); 
    tmp3 = CodeStubAssembler(state_).ToNumber_Inline(TNode<Context>{parameter0}, TNode<JSAny>{parameter2});
    tmp4 = NumberToUint32_0(state_, TNode<Number>{tmp3});
    tmp5 = CodeStubAssembler(state_).ToNumber_Inline(TNode<Context>{parameter0}, TNode<JSAny>{parameter3});
    tmp6 = NumberToUint32_0(state_, TNode<Number>{tmp5});
    tmp7 = ca_.CallBuiltin<String>(Builtin::kWasmStringNewWtf16Array, TNode<Object>(), tmp2, tmp4, tmp6);
    CodeStubAssembler(state_).Return(tmp7);
  }
}

TF_BUILTIN(WebAssemblyStringFromWtf16ArrayShared, CodeStubAssembler) {
  compiler::CodeAssemblerState* state_ = state();  compiler::CodeAssembler ca_(state());
  TNode<NativeContext> parameter0 = UncheckedParameter<NativeContext>(Descriptor::kContext);
  USE(parameter0);
  TNode<JSAny> parameter1 = UncheckedParameter<JSAny>(Descriptor::kArrayArg);
  ...
  if (block0.is_used()) {
    ...
    tmp5 = CodeStubAssembler(state_).ToNumber_Inline(TNode<Context>{parameter0}, TNode<JSAny>{parameter3});
    tmp6 = NumberToUint32_0(state_, TNode<Number>{tmp5});
    tmp7 = ca_.CallBuiltin<String>(Builtin::kWasmStringNewWtf16ArrayShared, TNode<Object>(), tmp2, tmp4, tmp6);
    CodeStubAssembler(state_).Return(tmp7);
  }
}
...
TF_BUILTIN(WebAssemblyStringFromUtf8Array, CodeStubAssembler) {
  ...
  TNode<Smi> tmp7;
  TNode<Smi> tmp8;
  TNode<Union<String, WasmNull>> tmp9;
  TNode<BoolT> tmp10;
  if (block0.is_used()) {
    ca_.Bind(&block0);
    ...
    tmp5 = CodeStubAssembler(state_).ToNumber_Inline(TNode<Context>{parameter0}, TNode<JSAny>{parameter3});
    tmp6 = NumberToUint32_0(state_, TNode<Number>{tmp5});
    tmp7 = CodeStubAssembler(state_).SmiConstant(unibrow::Utf8Variant::kLossyUtf8);
    tmp8 = SmiConstant_0(state_, IntegerLiteral(false, 0x0ull));
    tmp9 = ca_.CallBuiltin<Union<String, WasmNull>>(Builtin::kWasmStringNewWtf8Array, TNode<Object>(), tmp4, tmp6, tmp2, tmp7, tmp8);
    tmp10 = Is_String_String_OR_WasmNull_0(state_, TNode<Context>{parameter0}, TNode<Union<String, WasmNull>>{tmp9});
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    {
      ...
      pos_stack.push_back({"src/builtins/wasm-strings.tq", 62});
      CodeStubAssembler(state_).FailAssert("Torque assert 'Is<String>(result)' failed", pos_stack);
    }
  }
  ...
  if (block1.is_used()) {
    ca_.Bind(&block1);
    tmp11 = TORQUE_CAST(TNode<Union<String, WasmNull>>{tmp9});
    CodeStubAssembler(state_).Return(tmp11);
  }
}

TF_BUILTIN(WebAssemblyStringFromUtf8ArrayShared, CodeStubAssembler) {
  compiler::CodeAssemblerState* state_ = state();  compiler::CodeAssembler ca_(state());
  TNode<NativeContext> parameter0 = UncheckedParameter<NativeContext>(Descriptor::kContext);
  USE(parameter0);
  TNode<JSAny> parameter1 = UncheckedParameter<JSAny>(Descriptor::kArrayArg);
  ...
  if (block2.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/wasm-strings.tq", 75});
      CodeStubAssembler(state_).FailAssert("Torque assert 'Is<String>(result)' failed", pos_stack);
    }
  }
...
TNode<JSAny> WebAssemblyStringIntoUtf8ArrayImpl_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSAny> p_stringArg, TNode<JSAny> p_arrayArg, TNode<JSAny> p_startArg, TNode<Smi> p_shared) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    compiler::CodeAssemblerLabel label1(&ca_);
    tmp0 = Cast_String_1(state_, TNode<Context>{p_context}, TNode<Object>{p_stringArg}, &label1);
    ca_.Goto(&block6);
    if (label1.is_used()) {
      ca_.Bind(&label1);
      ca_.Goto(&block7);
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    Trap_0(state_, TNode<Context>{p_context}, CastIfEnumClass<MessageTemplate>(MessageTemplate::kWasmTrapIllegalCast));
  }
  ...
  if (block6.is_used()) {
    ...
    tmp3 = TORQUE_CAST(CodeStubAssembler(state_).CallRuntime(Runtime::kWasmCastToSpecialPrimitiveArray, p_context, p_arrayArg, tmp2, p_shared)); 
    tmp4 = CodeStubAssembler(state_).ToNumber_Inline(TNode<Context>{p_context}, TNode<JSAny>{p_startArg});
    ...
    tmp8 = TORQUE_CAST(CodeStubAssembler(state_).CallRuntime(Runtime::kWasmStringEncodeWtf8Array, p_context, tmp6, tmp0, tmp3, tmp7)); 
    ca_.Goto(&block8);
  }
...
TF_BUILTIN(WebAssemblyStringIntoUtf8Array, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp1 = WebAssemblyStringIntoUtf8ArrayImpl_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, TNode<JSAny>{parameter2}, TNode<JSAny>{parameter3}, TNode<Smi>{tmp0});
    CodeStubAssembler(state_).Return(tmp1);
  }
}

TF_BUILTIN(WebAssemblyStringIntoUtf8ArrayShared, CodeStubAssembler) {
  compiler::CodeAssemblerState* state_ = state();  compiler::CodeAssembler ca_(state());
  TNode<NativeContext> parameter0 = UncheckedParameter<NativeContext>(Descriptor::kContext);
  USE(parameter0);
  TNode<JSAny> parameter1 = UncheckedParameter<JSAny>(Descriptor::kStringArg);
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = SmiConstant_0(state_, IntegerLiteral(false, 0x1ull));
    tmp1 = WebAssemblyStringIntoUtf8ArrayImpl_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, TNode<JSAny>{parameter2}, TNode<JSAny>{parameter3}, TNode<Smi>{tmp0});
    CodeStubAssembler(state_).Return(tmp1);
  }
}
...
TF_BUILTIN(WebAssemblyStringToUtf8Array, CodeStubAssembler) {
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    tmp2 = SmiConstant_0(state_, IntegerLiteral(false, 0x0ull));
    tmp3 = TORQUE_CAST(CodeStubAssembler(state_).CallRuntime(Runtime::kWasmStringToUtf8Array, parameter0, tmp0, tmp2)); 
    CodeStubAssembler(state_).Return(tmp3);
  }
}

TF_BUILTIN(WebAssemblyStringToUtf8ArrayShared, CodeStubAssembler) {
  compiler::CodeAssemblerState* state_ = state();  compiler::CodeAssembler ca_(state());
  TNode<NativeContext> parameter0 = UncheckedParameter<NativeContext>(Descriptor::kContext);
  USE(parameter0);
  TNode<JSAny> parameter1 = UncheckedParameter<JSAny>(Descriptor::kStringArg);
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    tmp2 = SmiConstant_0(state_, IntegerLiteral(false, 0x1ull));
    tmp3 = TORQUE_CAST(CodeStubAssembler(state_).CallRuntime(Runtime::kWasmStringToUtf8Array, parameter0, tmp0, tmp2)); 
    CodeStubAssembler(state_).Return(tmp3);
  }
}
...
TF_BUILTIN(WebAssemblyStringToWtf16Array, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = SmiConstant_0(state_, IntegerLiteral(false, 0x0ull));
    tmp1 = WebAssemblyStringToWtf16ArrayImpl_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, TNode<JSAny>{parameter2}, TNode<JSAny>{parameter3}, TNode<Smi>{tmp0});
    CodeStubAssembler(state_).Return(tmp1);
  }
}

TF_BUILTIN(WebAssemblyStringToWtf16ArrayShared, CodeStubAssembler) {
  compiler::CodeAssemblerState* state_ = state();  compiler::CodeAssembler ca_(state());
  TNode<NativeContext> parameter0 = UncheckedParameter<NativeContext>(Descriptor::kContext);
  USE(parameter0);
  TNode<JSAny> parameter1 = UncheckedParameter<JSAny>(Descriptor::kStringArg);
...
TF_BUILTIN(WebAssemblyStringFromCharCodeShared, CodeStubAssembler) {
  compiler::CodeAssemblerState* state_ = state();  compiler::CodeAssembler ca_(state());
  TNode<NativeContext> parameter0 = UncheckedParameter<NativeContext>(Descriptor::kContext);
  USE(parameter0);
  TNode<JSAny> parameter1 = UncheckedParameter<JSAny>(Descriptor::kCodeArg);
  ...
  if (block0.is_used()) {
    ...
    tmp5 = SmiConstant_0(state_, IntegerLiteral(false, 0x1ull));
    tmp6 = TORQUE_CAST(CodeStubAssembler(state_).CallRuntime(Runtime::kWasmStringFromCodePoint, parameter0, tmp4, tmp5)); 
...
TF_BUILTIN(WebAssemblyStringFromCodePoint, CodeStubAssembler) {
  ...
  if (block2.is_used()) {
    ...
    tmp7 = TORQUE_CAST(CodeStubAssembler(state_).CallRuntime(Runtime::kWasmStringFromCodePoint, parameter0, tmp0, tmp6)); 
    CodeStubAssembler(state_).Return(tmp7);
  }
}

TF_BUILTIN(WebAssemblyStringFromCodePointShared, CodeStubAssembler) {
  compiler::CodeAssemblerState* state_ = state();  compiler::CodeAssembler ca_(state());
  TNode<NativeContext> parameter0 = UncheckedParameter<NativeContext>(Descriptor::kContext);
  USE(parameter0);
  TNode<JSAny> parameter1 = UncheckedParameter<JSAny>(Descriptor::kCodeArg);
  ...
  if (block0.is_used()) {
    ...
    tmp0 = CodeStubAssembler(state_).ToNumber_Inline(TNode<Context>{parameter0}, TNode<JSAny>{parameter1});
    tmp1 = SmiConstant_0(state_, IntegerLiteral(false, 0x1ull));
    tmp2 = TORQUE_CAST(CodeStubAssembler(state_).CallRuntime(Runtime::kWasmStringFromCodePoint, parameter0, tmp0, tmp1)); 
...
TF_BUILTIN(WebAssemblyStringCodePointAt, CodeStubAssembler) {
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    Trap_0(state_, TNode<Context>{parameter0}, CastIfEnumClass<MessageTemplate>(MessageTemplate::kWasmTrapStringOffsetOutOfBounds));
  }
  ...
  if (block10.is_used()) {
    ...
    tmp11 = StringBuiltinsAssembler(state_).LoadSurrogatePairAt(TNode<String>{tmp0}, TNode<IntPtrT>{tmp8}, TNode<IntPtrT>{tmp10}, CastIfEnumClass<UnicodeEncoding>(UnicodeEncoding::UTF32));
...
TF_BUILTIN(WebAssemblyStringEquals, CodeStubAssembler) {
  ...
  if (block21.is_used()) {
    ca_.Bind(&block21);
    tmp15 = CodeStubAssembler(state_).TaggedEqual(TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{parameter1}, TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{parameter2});
...
TF_BUILTIN(WebAssemblyConfigureAllPrototypes, CodeStubAssembler) {
  compiler::CodeAssemblerState* state_ = state();  compiler::CodeAssembler ca_(state());
  TNode<NativeContext> parameter0 = UncheckedParameter<NativeContext>(Descriptor::kContext);
  USE(parameter0);
  TNode<JSAny> parameter1 = UncheckedParameter<JSAny>(Descriptor::kPrototypes);
  USE(parameter1);
  TNode<JSAny> parameter2 = UncheckedParameter<JSAny>(Descriptor::kFunctions);
  USE(parameter2);
  TNode<JSAny> parameter3 = UncheckedParameter<JSAny>(Descriptor::kData);
  USE(parameter3);
  TNode<JSAny> parameter4 = UncheckedParameter<JSAny>(Descriptor::kConstructors);
  USE(parameter4);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = TORQUE_CAST(CodeStubAssembler(state_).CallRuntime(Runtime::kWasmConfigureAllPrototypes, parameter0, parameter1, parameter2, parameter3, parameter4)); 
    CodeStubAssembler(state_).Return(tmp0);
  }
}
