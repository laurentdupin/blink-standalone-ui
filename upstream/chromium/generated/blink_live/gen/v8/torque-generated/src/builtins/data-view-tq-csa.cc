...
TNode<String> MakeDataViewGetterNameString_0(compiler::CodeAssemblerState* state_, ElementsKind p_kind) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    if (((CodeStubAssembler(state_).ElementsKindEqual(p_kind, CastIfEnumClass<ElementsKind>(ElementsKind::UINT8_ELEMENTS))))) {
      ca_.Goto(&block2);
    } else {
      ca_.Goto(&block3);
    }
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    if (((CodeStubAssembler(state_).ElementsKindEqual(p_kind, CastIfEnumClass<ElementsKind>(ElementsKind::INT8_ELEMENTS))))) {
      ca_.Goto(&block5);
    } else {
      ca_.Goto(&block6);
    }
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    if (((CodeStubAssembler(state_).ElementsKindEqual(p_kind, CastIfEnumClass<ElementsKind>(ElementsKind::UINT16_ELEMENTS))))) {
      ca_.Goto(&block8);
    } else {
      ca_.Goto(&block9);
    }
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    if (((CodeStubAssembler(state_).ElementsKindEqual(p_kind, CastIfEnumClass<ElementsKind>(ElementsKind::INT16_ELEMENTS))))) {
      ca_.Goto(&block11);
    } else {
      ca_.Goto(&block12);
    }
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    if (((CodeStubAssembler(state_).ElementsKindEqual(p_kind, CastIfEnumClass<ElementsKind>(ElementsKind::UINT32_ELEMENTS))))) {
      ca_.Goto(&block14);
    } else {
      ca_.Goto(&block15);
    }
  ...
  if (block15.is_used()) {
    ca_.Bind(&block15);
    if (((CodeStubAssembler(state_).ElementsKindEqual(p_kind, CastIfEnumClass<ElementsKind>(ElementsKind::INT32_ELEMENTS))))) {
      ca_.Goto(&block17);
    } else {
      ca_.Goto(&block18);
    }
  ...
  if (block18.is_used()) {
    ca_.Bind(&block18);
    if (((CodeStubAssembler(state_).ElementsKindEqual(p_kind, CastIfEnumClass<ElementsKind>(ElementsKind::FLOAT16_ELEMENTS))))) {
      ca_.Goto(&block20);
    } else {
      ca_.Goto(&block21);
    }
  ...
  if (block21.is_used()) {
    ca_.Bind(&block21);
    if (((CodeStubAssembler(state_).ElementsKindEqual(p_kind, CastIfEnumClass<ElementsKind>(ElementsKind::FLOAT32_ELEMENTS))))) {
      ca_.Goto(&block23);
    } else {
      ca_.Goto(&block24);
    }
  ...
  if (block24.is_used()) {
    ca_.Bind(&block24);
    if (((CodeStubAssembler(state_).ElementsKindEqual(p_kind, CastIfEnumClass<ElementsKind>(ElementsKind::FLOAT64_ELEMENTS))))) {
      ca_.Goto(&block26);
    } else {
      ca_.Goto(&block27);
    }
  ...
  if (block27.is_used()) {
    ca_.Bind(&block27);
    if (((CodeStubAssembler(state_).ElementsKindEqual(p_kind, CastIfEnumClass<ElementsKind>(ElementsKind::BIGINT64_ELEMENTS))))) {
      ca_.Goto(&block29);
    } else {
      ca_.Goto(&block30);
    }
  ...
  if (block30.is_used()) {
    ca_.Bind(&block30);
    if (((CodeStubAssembler(state_).ElementsKindEqual(p_kind, CastIfEnumClass<ElementsKind>(ElementsKind::BIGUINT64_ELEMENTS))))) {
      ca_.Goto(&block32);
    } else {
      ca_.Goto(&block33);
    }
  ...
  if (block33.is_used()) {
    ca_.Bind(&block33);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/data-view.tq:38:5");
...
TNode<String> MakeDataViewSetterNameString_0(compiler::CodeAssemblerState* state_, ElementsKind p_kind) {
  ...
  if (block33.is_used()) {
    ca_.Bind(&block33);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/data-view.tq:66:5");
    CodeStubAssembler(state_).Unreachable();
  }
...
TNode<JSDataViewOrRabGsabDataView> ValidateDataView_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSAny> p_o, TNode<String> p_method) {
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{p_context}, CastIfEnumClass<MessageTemplate>(MessageTemplate::kIncompatibleMethodReceiver), TNode<Object>{p_method}, TNode<Object>{p_o});
  }
...
TF_BUILTIN(DataViewPrototypeGetByteLength, CodeStubAssembler) {
  ...
  if (block1.is_used()) {
    ...
    tmp5 = CodeStubAssembler(state_).LoadVariableLengthJSArrayBufferViewByteLength(TNode<JSArrayBufferView>{tmp1}, TNode<JSArrayBuffer>{tmp4}, CastIfEnumClass<TypedArrayAccessMode>(TypedArrayAccessMode::kRead), &label6);
    ca_.Goto(&block6);
    if (label6.is_used()) {
      ca_.Bind(&label6);
      ca_.Goto(&block7);
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{parameter0}, CastIfEnumClass<MessageTemplate>(MessageTemplate::kTypedArrayValidateErrorOperation), kBuiltinNameByteLength_0(state_));
  }
...
TF_BUILTIN(DataViewPrototypeGetByteOffset, CodeStubAssembler) {
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{parameter0}, CastIfEnumClass<MessageTemplate>(MessageTemplate::kTypedArrayValidateErrorOperation), kBuiltinNameByteOffset_0(state_));
  }
...
TNode<Number> LoadDataView32_0(compiler::CodeAssemblerState* state_, TNode<JSArrayBuffer> p_buffer, TNode<UintPtrT> p_offset, TNode<BoolT> p_requestedLittleEndian, ElementsKind p_kind) {
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/data-view.tq:214:5");
    CodeStubAssembler(state_).Unreachable();
  }
...
TNode<Numeric> DataViewGet_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSAny> p_receiver, TNode<JSAny> p_requestIndex, TNode<JSAny> p_requestedLittleEndian, ElementsKind p_kind) {
  ...
  if (block10.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{p_context}, CastIfEnumClass<MessageTemplate>(MessageTemplate::kTypedArrayValidateErrorOperation), TNode<Object>{tmp9});
  }
  ...
  if (block12.is_used()) {
    ...
    tmp16 = CodeStubAssembler(state_).LoadVariableLengthJSArrayBufferViewByteLength(TNode<JSArrayBufferView>{tmp1}, TNode<JSArrayBuffer>{tmp15}, CastIfEnumClass<TypedArrayAccessMode>(TypedArrayAccessMode::kRead), &label17);
    ca_.Goto(&block17);
    if (label17.is_used()) {
      ca_.Bind(&label17);
      ca_.Goto(&block18);
  ...
  if (block18.is_used()) {
    ca_.Bind(&block18);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/data-view.tq:451:21");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block52.is_used()) {
    ca_.Bind(&block52);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/data-view.tq:490:7");
    CodeStubAssembler(state_).Unreachable();
  }

  if (block3.is_used()) {
    ca_.Bind(&block3);
    CodeStubAssembler(state_).ThrowRangeError(TNode<Context>{p_context}, CastIfEnumClass<MessageTemplate>(MessageTemplate::kInvalidDataViewAccessorOffset));
  }
...
TF_BUILTIN(DataViewPrototypeGetUint8, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp3 = DataViewGet_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, TNode<JSAny>{tmp1}, TNode<JSAny>{tmp2}, CastIfEnumClass<ElementsKind>(ElementsKind::UINT8_ELEMENTS));
    arguments.PopAndReturn(tmp3);
  }
}
...
TF_BUILTIN(DataViewPrototypeGetInt8, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp1 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments{TNode<RawPtrT>{torque_arguments.frame}, TNode<RawPtrT>{torque_arguments.base}, TNode<IntPtrT>{torque_arguments.length}, TNode<IntPtrT>{torque_arguments.actual_count}}, TNode<IntPtrT>{tmp0});
    tmp2 = Undefined_0(state_);
    tmp3 = DataViewGet_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, TNode<JSAny>{tmp1}, TNode<JSAny>{tmp2}, CastIfEnumClass<ElementsKind>(ElementsKind::INT8_ELEMENTS));
    arguments.PopAndReturn(tmp3);
  }
}
...
TF_BUILTIN(DataViewPrototypeGetUint16, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp4 = DataViewGet_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, TNode<JSAny>{tmp1}, TNode<JSAny>{tmp3}, CastIfEnumClass<ElementsKind>(ElementsKind::UINT16_ELEMENTS));
...
TF_BUILTIN(DataViewPrototypeGetInt16, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp2 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull));
    tmp3 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments{TNode<RawPtrT>{torque_arguments.frame}, TNode<RawPtrT>{torque_arguments.base}, TNode<IntPtrT>{torque_arguments.length}, TNode<IntPtrT>{torque_arguments.actual_count}}, TNode<IntPtrT>{tmp2});
    tmp4 = DataViewGet_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, TNode<JSAny>{tmp1}, TNode<JSAny>{tmp3}, CastIfEnumClass<ElementsKind>(ElementsKind::INT16_ELEMENTS));
    arguments.PopAndReturn(tmp4);
  }
}
...
TF_BUILTIN(DataViewPrototypeGetUint32, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp2 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull));
    tmp3 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments{TNode<RawPtrT>{torque_arguments.frame}, TNode<RawPtrT>{torque_arguments.base}, TNode<IntPtrT>{torque_arguments.length}, TNode<IntPtrT>{torque_arguments.actual_count}}, TNode<IntPtrT>{tmp2});
    tmp4 = DataViewGet_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, TNode<JSAny>{tmp1}, TNode<JSAny>{tmp3}, CastIfEnumClass<ElementsKind>(ElementsKind::UINT32_ELEMENTS));
    arguments.PopAndReturn(tmp4);
  }
}
...
TF_BUILTIN(DataViewPrototypeGetInt32, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp2 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull));
    tmp3 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments{TNode<RawPtrT>{torque_arguments.frame}, TNode<RawPtrT>{torque_arguments.base}, TNode<IntPtrT>{torque_arguments.length}, TNode<IntPtrT>{torque_arguments.actual_count}}, TNode<IntPtrT>{tmp2});
    tmp4 = DataViewGet_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, TNode<JSAny>{tmp1}, TNode<JSAny>{tmp3}, CastIfEnumClass<ElementsKind>(ElementsKind::INT32_ELEMENTS));
    arguments.PopAndReturn(tmp4);
  }
}
...
TF_BUILTIN(DataViewPrototypeGetFloat16, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp2 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull));
    tmp3 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments{TNode<RawPtrT>{torque_arguments.frame}, TNode<RawPtrT>{torque_arguments.base}, TNode<IntPtrT>{torque_arguments.length}, TNode<IntPtrT>{torque_arguments.actual_count}}, TNode<IntPtrT>{tmp2});
    tmp4 = DataViewGet_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, TNode<JSAny>{tmp1}, TNode<JSAny>{tmp3}, CastIfEnumClass<ElementsKind>(ElementsKind::FLOAT16_ELEMENTS));
    arguments.PopAndReturn(tmp4);
  }
}
...
TF_BUILTIN(DataViewPrototypeGetFloat32, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp2 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull));
    tmp3 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments{TNode<RawPtrT>{torque_arguments.frame}, TNode<RawPtrT>{torque_arguments.base}, TNode<IntPtrT>{torque_arguments.length}, TNode<IntPtrT>{torque_arguments.actual_count}}, TNode<IntPtrT>{tmp2});
    tmp4 = DataViewGet_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, TNode<JSAny>{tmp1}, TNode<JSAny>{tmp3}, CastIfEnumClass<ElementsKind>(ElementsKind::FLOAT32_ELEMENTS));
    arguments.PopAndReturn(tmp4);
  }
}
...
TF_BUILTIN(DataViewPrototypeGetFloat64, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp2 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull));
    tmp3 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments{TNode<RawPtrT>{torque_arguments.frame}, TNode<RawPtrT>{torque_arguments.base}, TNode<IntPtrT>{torque_arguments.length}, TNode<IntPtrT>{torque_arguments.actual_count}}, TNode<IntPtrT>{tmp2});
    tmp4 = DataViewGet_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, TNode<JSAny>{tmp1}, TNode<JSAny>{tmp3}, CastIfEnumClass<ElementsKind>(ElementsKind::FLOAT64_ELEMENTS));
    arguments.PopAndReturn(tmp4);
  }
}
...
TF_BUILTIN(DataViewPrototypeGetBigUint64, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp2 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull));
    tmp3 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments{TNode<RawPtrT>{torque_arguments.frame}, TNode<RawPtrT>{torque_arguments.base}, TNode<IntPtrT>{torque_arguments.length}, TNode<IntPtrT>{torque_arguments.actual_count}}, TNode<IntPtrT>{tmp2});
    tmp4 = DataViewGet_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, TNode<JSAny>{tmp1}, TNode<JSAny>{tmp3}, CastIfEnumClass<ElementsKind>(ElementsKind::BIGUINT64_ELEMENTS));
    arguments.PopAndReturn(tmp4);
  }
}
...
TF_BUILTIN(DataViewPrototypeGetBigInt64, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp2 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull));
    tmp3 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments{TNode<RawPtrT>{torque_arguments.frame}, TNode<RawPtrT>{torque_arguments.base}, TNode<IntPtrT>{torque_arguments.length}, TNode<IntPtrT>{torque_arguments.actual_count}}, TNode<IntPtrT>{tmp2});
    tmp4 = DataViewGet_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, TNode<JSAny>{tmp1}, TNode<JSAny>{tmp3}, CastIfEnumClass<ElementsKind>(ElementsKind::BIGINT64_ELEMENTS));
    arguments.PopAndReturn(tmp4);
  }
}
...
TNode<JSAny> DataViewSet_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSAny> p_receiver, TNode<JSAny> p_requestIndex, TNode<JSAny> p_value, TNode<JSAny> p_requestedLittleEndian, ElementsKind p_kind) {
  ...
  compiler::CodeAssemblerParameterizedLabel<> block8(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block9(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Numeric> block10(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block15(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block0.is_used()) {
    ...
    tmp2 = FromConstexpr_intptr_constexpr_int31_0(state_, 16);
    tmp3 = CodeStubAssembler(state_).LoadReference<JSArrayBuffer>(CodeStubAssembler::Reference{tmp1, tmp2});
    tmp4 = IsImmutableArrayBuffer_0(state_, TNode<JSArrayBuffer>{tmp3});
  ...
  if (block2.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{p_context}, CastIfEnumClass<MessageTemplate>(MessageTemplate::kTypedArrayImmutableBufferErrorOperation), TNode<Object>{tmp5});
  }
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    compiler::CodeAssemblerLabel label7(&ca_);
    tmp6 = ToIndex_0(state_, TNode<Context>{p_context}, TNode<JSAny>{p_requestIndex}, &label7);
    ca_.Goto(&block6);
    if (label7.is_used()) {
      ca_.Bind(&label7);
      ca_.Goto(&block7);
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    if ((((CodeStubAssembler(state_).ElementsKindEqual(p_kind, CastIfEnumClass<ElementsKind>(ElementsKind::BIGUINT64_ELEMENTS))) || (CodeStubAssembler(state_).ElementsKindEqual(p_kind, CastIfEnumClass<ElementsKind>(ElementsKind::BIGINT64_ELEMENTS)))))) {
      ca_.Goto(&block8);
    } else {
      ca_.Goto(&block9);
    }
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    tmp8 = CodeStubAssembler(state_).ToBigInt(TNode<Context>{p_context}, TNode<JSAny>{p_value});
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    tmp9 = CodeStubAssembler(state_).ToNumber(TNode<Context>{p_context}, TNode<JSAny>{p_value});
    ca_.Goto(&block10, tmp9);
  }

  TNode<Numeric> phi_bb10_7;
  TNode<BoolT> tmp10;
  TNode<IntPtrT> tmp11;
  TNode<JSArrayBuffer> tmp12;
  if (block10.is_used()) {
    ca_.Bind(&block10, &phi_bb10_7);
    tmp10 = ToBoolean_0(state_, TNode<JSAny>{p_requestedLittleEndian});
    tmp11 = FromConstexpr_intptr_constexpr_int31_0(state_, 16);
    tmp12 = CodeStubAssembler(state_).LoadReference<JSArrayBuffer>(CodeStubAssembler::Reference{tmp1, tmp11});
    compiler::CodeAssemblerLabel label13(&ca_);
    compiler::CodeAssemblerLabel label14(&ca_);
    CodeStubAssembler(state_).IsJSArrayBufferViewDetachedOrOutOfBounds(TNode<JSArrayBufferView>{tmp1}, &label13, &label14);
    if (label13.is_used()) {
      ca_.Bind(&label13);
      ca_.Goto(&block15);
    }
  ...
  if (block15.is_used()) {
    ca_.Bind(&block15);
    tmp15 = MakeDataViewSetterNameString_0(state_, p_kind);
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{p_context}, CastIfEnumClass<MessageTemplate>(MessageTemplate::kTypedArrayValidateErrorOperation), TNode<Object>{tmp15});
  }
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    tmp16 = CodeStubAssembler(state_).LoadJSArrayBufferViewByteOffset(TNode<JSArrayBufferView>{tmp1});
    tmp17 = FromConstexpr_intptr_constexpr_int31_0(state_, 20);
    tmp18 = CodeStubAssembler(state_).LoadReference<Uint32T>(CodeStubAssembler::Reference{tmp1, tmp17});
    tmp19 = ca_.UncheckedCast<BoolT>(CodeStubAssembler(state_).DecodeWord32<base::BitField<bool, 0, 1, uint32_t>>(ca_.UncheckedCast<Word32T>(tmp18)));
  ...
  if (block17.is_used()) {
    ...
    tmp20 = CodeStubAssembler(state_).LoadVariableLengthJSArrayBufferViewByteLength(TNode<JSArrayBufferView>{tmp1}, TNode<JSArrayBuffer>{tmp12}, CastIfEnumClass<TypedArrayAccessMode>(TypedArrayAccessMode::kRead), &label21);
    ca_.Goto(&block22);
    if (label21.is_used()) {
      ca_.Bind(&label21);
      ca_.Goto(&block23);
  ...
  if (block23.is_used()) {
    ca_.Bind(&block23);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/data-view.tq:783:21");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block19.is_used()) {
    ...
    CheckIntegerIndexAdditionOverflow_0(state_, TNode<UintPtrT>{tmp6}, TNode<UintPtrT>{tmp23}, TNode<UintPtrT>{phi_bb19_11}, &label24);
    ca_.Goto(&block24);
    if (label24.is_used()) {
      ca_.Bind(&label24);
      ca_.Goto(&block25);
  ...
  if (block24.is_used()) {
    ca_.Bind(&block24);
    tmp25 = CodeStubAssembler(state_).UintPtrAdd(TNode<UintPtrT>{tmp6}, TNode<UintPtrT>{tmp16});
    if ((((CodeStubAssembler(state_).ElementsKindEqual(p_kind, CastIfEnumClass<ElementsKind>(ElementsKind::BIGUINT64_ELEMENTS))) || (CodeStubAssembler(state_).ElementsKindEqual(p_kind, CastIfEnumClass<ElementsKind>(ElementsKind::BIGINT64_ELEMENTS)))))) {
      ca_.Goto(&block26);
    } else {
      ca_.Goto(&block27);
  ...
  if (block26.is_used()) {
    ca_.Bind(&block26);
    tmp26 = TORQUE_CAST(TNode<Numeric>{phi_bb10_7});
    StoreDataViewBigInt_0(state_, TNode<JSArrayBuffer>{tmp12}, TNode<UintPtrT>{tmp25}, TNode<BigInt>{tmp26}, TNode<BoolT>{tmp10});
    ca_.Goto(&block28);
  }
  ...
  if (block27.is_used()) {
    ca_.Bind(&block27);
    tmp27 = TORQUE_CAST(TNode<Numeric>{phi_bb10_7});
    tmp28 = CodeStubAssembler(state_).ChangeNumberToFloat64(TNode<Number>{tmp27});
    if ((((CodeStubAssembler(state_).ElementsKindEqual(p_kind, CastIfEnumClass<ElementsKind>(ElementsKind::UINT8_ELEMENTS))) || (CodeStubAssembler(state_).ElementsKindEqual(p_kind, CastIfEnumClass<ElementsKind>(ElementsKind::INT8_ELEMENTS)))))) {
      ca_.Goto(&block29);
    } else {
      ca_.Goto(&block30);
    }
  ...
  if (block29.is_used()) {
    ...
    StoreDataView8_0(state_, TNode<JSArrayBuffer>{tmp12}, TNode<UintPtrT>{tmp25}, TNode<Uint32T>{tmp29});
    ca_.Goto(&block31);
  }

  if (block30.is_used()) {
    ca_.Bind(&block30);
    if ((((CodeStubAssembler(state_).ElementsKindEqual(p_kind, CastIfEnumClass<ElementsKind>(ElementsKind::UINT16_ELEMENTS))) || (CodeStubAssembler(state_).ElementsKindEqual(p_kind, CastIfEnumClass<ElementsKind>(ElementsKind::INT16_ELEMENTS)))))) {
      ca_.Goto(&block32);
    } else {
      ca_.Goto(&block33);
    }
  ...
  if (block32.is_used()) {
    ...
    StoreDataView16_0(state_, TNode<JSArrayBuffer>{tmp12}, TNode<UintPtrT>{tmp25}, TNode<Uint32T>{tmp30}, TNode<BoolT>{tmp10});
    ca_.Goto(&block34);
  }
  ...
  if (block35.is_used()) {
    ...
    StoreDataView16_0(state_, TNode<JSArrayBuffer>{tmp12}, TNode<UintPtrT>{tmp25}, TNode<Uint32T>{tmp32}, TNode<BoolT>{tmp10});
    ca_.Goto(&block37);
  }

  if (block36.is_used()) {
    ca_.Bind(&block36);
    if ((((CodeStubAssembler(state_).ElementsKindEqual(p_kind, CastIfEnumClass<ElementsKind>(ElementsKind::UINT32_ELEMENTS))) || (CodeStubAssembler(state_).ElementsKindEqual(p_kind, CastIfEnumClass<ElementsKind>(ElementsKind::INT32_ELEMENTS)))))) {
      ca_.Goto(&block38);
    } else {
      ca_.Goto(&block39);
    }
  ...
  if (block38.is_used()) {
    ...
    StoreDataView32_0(state_, TNode<JSArrayBuffer>{tmp12}, TNode<UintPtrT>{tmp25}, TNode<Uint32T>{tmp33}, TNode<BoolT>{tmp10});
    ca_.Goto(&block40);
  }
  ...
  if (block41.is_used()) {
    ...
    StoreDataView32_0(state_, TNode<JSArrayBuffer>{tmp12}, TNode<UintPtrT>{tmp25}, TNode<Uint32T>{tmp35}, TNode<BoolT>{tmp10});
    ca_.Goto(&block43);
  }
  ...
  if (block44.is_used()) {
    ...
    StoreDataView64_0(state_, TNode<JSArrayBuffer>{tmp12}, TNode<UintPtrT>{tmp25}, TNode<Uint32T>{tmp36}, TNode<Uint32T>{tmp37}, TNode<BoolT>{tmp10});
    ca_.Goto(&block46);
  }
...
TF_BUILTIN(DataViewPrototypeSetUint8, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp5 = DataViewSet_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, TNode<JSAny>{tmp1}, TNode<JSAny>{tmp3}, TNode<JSAny>{tmp4}, CastIfEnumClass<ElementsKind>(ElementsKind::UINT8_ELEMENTS));
    arguments.PopAndReturn(tmp5);
  }
}
...
TF_BUILTIN(DataViewPrototypeSetInt8, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp3 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments{TNode<RawPtrT>{torque_arguments.frame}, TNode<RawPtrT>{torque_arguments.base}, TNode<IntPtrT>{torque_arguments.length}, TNode<IntPtrT>{torque_arguments.actual_count}}, TNode<IntPtrT>{tmp2});
    tmp4 = Undefined_0(state_);
    tmp5 = DataViewSet_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, TNode<JSAny>{tmp1}, TNode<JSAny>{tmp3}, TNode<JSAny>{tmp4}, CastIfEnumClass<ElementsKind>(ElementsKind::INT8_ELEMENTS));
    arguments.PopAndReturn(tmp5);
  }
}
...
TF_BUILTIN(DataViewPrototypeSetUint16, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp6 = DataViewSet_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, TNode<JSAny>{tmp1}, TNode<JSAny>{tmp3}, TNode<JSAny>{tmp5}, CastIfEnumClass<ElementsKind>(ElementsKind::UINT16_ELEMENTS));
...
TF_BUILTIN(DataViewPrototypeSetInt16, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp4 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x2ull));
    tmp5 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments{TNode<RawPtrT>{torque_arguments.frame}, TNode<RawPtrT>{torque_arguments.base}, TNode<IntPtrT>{torque_arguments.length}, TNode<IntPtrT>{torque_arguments.actual_count}}, TNode<IntPtrT>{tmp4});
    tmp6 = DataViewSet_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, TNode<JSAny>{tmp1}, TNode<JSAny>{tmp3}, TNode<JSAny>{tmp5}, CastIfEnumClass<ElementsKind>(ElementsKind::INT16_ELEMENTS));
    arguments.PopAndReturn(tmp6);
  }
}
...
TF_BUILTIN(DataViewPrototypeSetUint32, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp4 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x2ull));
    tmp5 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments{TNode<RawPtrT>{torque_arguments.frame}, TNode<RawPtrT>{torque_arguments.base}, TNode<IntPtrT>{torque_arguments.length}, TNode<IntPtrT>{torque_arguments.actual_count}}, TNode<IntPtrT>{tmp4});
    tmp6 = DataViewSet_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, TNode<JSAny>{tmp1}, TNode<JSAny>{tmp3}, TNode<JSAny>{tmp5}, CastIfEnumClass<ElementsKind>(ElementsKind::UINT32_ELEMENTS));
    arguments.PopAndReturn(tmp6);
  }
}
...
TF_BUILTIN(DataViewPrototypeSetInt32, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp4 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x2ull));
    tmp5 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments{TNode<RawPtrT>{torque_arguments.frame}, TNode<RawPtrT>{torque_arguments.base}, TNode<IntPtrT>{torque_arguments.length}, TNode<IntPtrT>{torque_arguments.actual_count}}, TNode<IntPtrT>{tmp4});
    tmp6 = DataViewSet_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, TNode<JSAny>{tmp1}, TNode<JSAny>{tmp3}, TNode<JSAny>{tmp5}, CastIfEnumClass<ElementsKind>(ElementsKind::INT32_ELEMENTS));
    arguments.PopAndReturn(tmp6);
  }
}
...
TF_BUILTIN(DataViewPrototypeSetFloat16, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp4 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x2ull));
    tmp5 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments{TNode<RawPtrT>{torque_arguments.frame}, TNode<RawPtrT>{torque_arguments.base}, TNode<IntPtrT>{torque_arguments.length}, TNode<IntPtrT>{torque_arguments.actual_count}}, TNode<IntPtrT>{tmp4});
    tmp6 = DataViewSet_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, TNode<JSAny>{tmp1}, TNode<JSAny>{tmp3}, TNode<JSAny>{tmp5}, CastIfEnumClass<ElementsKind>(ElementsKind::FLOAT16_ELEMENTS));
    arguments.PopAndReturn(tmp6);
  }
}
...
TF_BUILTIN(DataViewPrototypeSetFloat32, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp4 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x2ull));
    tmp5 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments{TNode<RawPtrT>{torque_arguments.frame}, TNode<RawPtrT>{torque_arguments.base}, TNode<IntPtrT>{torque_arguments.length}, TNode<IntPtrT>{torque_arguments.actual_count}}, TNode<IntPtrT>{tmp4});
    tmp6 = DataViewSet_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, TNode<JSAny>{tmp1}, TNode<JSAny>{tmp3}, TNode<JSAny>{tmp5}, CastIfEnumClass<ElementsKind>(ElementsKind::FLOAT32_ELEMENTS));
    arguments.PopAndReturn(tmp6);
  }
}
...
TF_BUILTIN(DataViewPrototypeSetFloat64, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp4 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x2ull));
    tmp5 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments{TNode<RawPtrT>{torque_arguments.frame}, TNode<RawPtrT>{torque_arguments.base}, TNode<IntPtrT>{torque_arguments.length}, TNode<IntPtrT>{torque_arguments.actual_count}}, TNode<IntPtrT>{tmp4});
    tmp6 = DataViewSet_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, TNode<JSAny>{tmp1}, TNode<JSAny>{tmp3}, TNode<JSAny>{tmp5}, CastIfEnumClass<ElementsKind>(ElementsKind::FLOAT64_ELEMENTS));
    arguments.PopAndReturn(tmp6);
  }
}
...
TF_BUILTIN(DataViewPrototypeSetBigUint64, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp4 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x2ull));
    tmp5 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments{TNode<RawPtrT>{torque_arguments.frame}, TNode<RawPtrT>{torque_arguments.base}, TNode<IntPtrT>{torque_arguments.length}, TNode<IntPtrT>{torque_arguments.actual_count}}, TNode<IntPtrT>{tmp4});
    tmp6 = DataViewSet_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, TNode<JSAny>{tmp1}, TNode<JSAny>{tmp3}, TNode<JSAny>{tmp5}, CastIfEnumClass<ElementsKind>(ElementsKind::BIGUINT64_ELEMENTS));
    arguments.PopAndReturn(tmp6);
  }
}
...
TF_BUILTIN(DataViewPrototypeSetBigInt64, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp4 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x2ull));
    tmp5 = CodeStubAssembler(state_).GetArgumentValue(TorqueStructArguments{TNode<RawPtrT>{torque_arguments.frame}, TNode<RawPtrT>{torque_arguments.base}, TNode<IntPtrT>{torque_arguments.length}, TNode<IntPtrT>{torque_arguments.actual_count}}, TNode<IntPtrT>{tmp4});
    tmp6 = DataViewSet_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, TNode<JSAny>{tmp1}, TNode<JSAny>{tmp3}, TNode<JSAny>{tmp5}, CastIfEnumClass<ElementsKind>(ElementsKind::BIGINT64_ELEMENTS));
    arguments.PopAndReturn(tmp6);
  }
}
...
TNode<JSDataView> UnsafeCast_JSDataView_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = Is_JSDataView_Object_0(state_, TNode<Context>{p_context}, TNode<Object>{p_o});
...
TNode<JSRabGsabDataView> UnsafeCast_JSRabGsabDataView_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = Is_JSRabGsabDataView_Object_0(state_, TNode<Context>{p_context}, TNode<Object>{p_o});
    ca_.Branch(tmp0, &block2, std::vector<compiler::Node*>{}, &block3, std::vector<compiler::Node*>{});
  }
  ...
  if (block2.is_used()) {
    ...
    ca_.Bind(&block4);
  return TNode<JSRabGsabDataView>{tmp1};
}
