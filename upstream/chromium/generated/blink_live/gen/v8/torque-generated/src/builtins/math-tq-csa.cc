...
TNode<Number> FastMathHypot_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArguments p_arguments, compiler::CodeAssemblerLabel* label_Slow) {
  ...
  if (block21.is_used()) {
    ca_.Bind(&block21);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/math.tq:461:3");
...
TF_BUILTIN(MathHypot, CodeStubAssembler) {
  ...
  compiler::CodeAssemblerParameterizedLabel<BoolT, Float64T> block31(&ca_, compiler::CodeAssemblerLabel::kDeferred);
  compiler::CodeAssemblerParameterizedLabel<BoolT, Float64T> block30(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<BoolT, Float64T, Float64T, Float64T, IntPtrT, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block41(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<BoolT, Float64T, Float64T, Float64T, IntPtrT, IntPtrT, IntPtrT> block46(&ca_, compiler::CodeAssemblerLabel::kDeferred);
  compiler::CodeAssemblerParameterizedLabel<BoolT, Float64T, Float64T, Float64T, IntPtrT, IntPtrT, IntPtrT> block45(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<BoolT, Float64T, Float64T, Float64T, IntPtrT, IntPtrT, IntPtrT> block48(&ca_, compiler::CodeAssemblerLabel::kDeferred);
  compiler::CodeAssemblerParameterizedLabel<BoolT, Float64T, Float64T, Float64T, IntPtrT, IntPtrT, IntPtrT> block47(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block16.is_used()) {
    ...
    std::tie(tmp23, tmp24, tmp25) = Convert_float64_or_undefined_or_hole_float64_0(state_, TNode<Float64T>{tmp12}).Flatten();
    ...
    tmp26 = CodeStubAssembler(state_).Float64GreaterThan(TNode<Float64T>{tmp12}, TNode<Float64T>{phi_bb16_9});
    ca_.Branch(tmp26, &block20, std::vector<compiler::Node*>{phi_bb16_8, phi_bb16_9, phi_bb16_10}, &block21, std::vector<compiler::Node*>{phi_bb16_8, phi_bb16_9, phi_bb16_10});
  }
  ...
  if (block11.is_used()) {
    ...
    tmp28 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{phi_bb11_10}, TNode<IntPtrT>{tmp27});
    ca_.Goto(&block7, phi_bb11_8, phi_bb11_9, tmp28);
  }
  ...
  if (block6.is_used()) {
    ...
    tmp30 = CodeStubAssembler(state_).Float64Equal(TNode<Float64T>{phi_bb6_9}, TNode<Float64T>{tmp29});
    ca_.Branch(tmp30, &block22, std::vector<compiler::Node*>{phi_bb6_8, phi_bb6_9}, &block23, std::vector<compiler::Node*>{phi_bb6_8, phi_bb6_9});
  }
  ...
  if (block26.is_used()) {
    ...
    tmp34 = CodeStubAssembler(state_).Float64Equal(TNode<Float64T>{phi_bb26_9}, TNode<Float64T>{tmp33});
    ca_.Branch(tmp34, &block28, std::vector<compiler::Node*>{phi_bb26_8, phi_bb26_9}, &block29, std::vector<compiler::Node*>{phi_bb26_8, phi_bb26_9});
  }
  ...
  if (block29.is_used()) {
    ...
    tmp37 = CodeStubAssembler(state_).Float64GreaterThan(TNode<Float64T>{phi_bb29_9}, TNode<Float64T>{tmp36});
    ca_.Branch(tmp37, &block30, std::vector<compiler::Node*>{phi_bb29_8, phi_bb29_9}, &block31, std::vector<compiler::Node*>{phi_bb29_8, phi_bb29_9});
  }

  TNode<BoolT> phi_bb31_8;
  TNode<Float64T> phi_bb31_9;
  if (block31.is_used()) {
    ca_.Bind(&block31, &phi_bb31_8, &phi_bb31_9);
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/math.tq", 494});
  ...
  TNode<IntPtrT> tmp40;
  if (block30.is_used()) {
    ca_.Bind(&block30, &phi_bb30_8, &phi_bb30_9);
    ...
    ca_.Goto(&block34, phi_bb30_8, phi_bb30_9, tmp38, tmp39, tmp40);
  }
  ...
  if (block34.is_used()) {
    ...
    tmp41 = CodeStubAssembler(state_).IntPtrLessThan(TNode<IntPtrT>{phi_bb34_12}, TNode<IntPtrT>{torque_arguments.length});
    ca_.Branch(tmp41, &block32, std::vector<compiler::Node*>{phi_bb34_8, phi_bb34_9, phi_bb34_10, phi_bb34_11, phi_bb34_12}, &block33, std::vector<compiler::Node*>{phi_bb34_8, phi_bb34_9, phi_bb34_10, phi_bb34_11, phi_bb34_12});
  }
  ...
  if (block32.is_used()) {
    ...
    std::tie(tmp42, tmp43, tmp44) = FieldSliceFixedDoubleArrayValues_0(state_, TNode<FixedDoubleArray>{tmp2}).Flatten();
    tmp45 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{phi_bb32_12});
    ...
    ca_.Branch(tmp47, &block40, std::vector<compiler::Node*>{phi_bb32_8, phi_bb32_9, phi_bb32_10, phi_bb32_11, phi_bb32_12, phi_bb32_12, phi_bb32_12, phi_bb32_12, phi_bb32_12}, &block41, std::vector<compiler::Node*>{phi_bb32_8, phi_bb32_9, phi_bb32_10, phi_bb32_11, phi_bb32_12, phi_bb32_12, phi_bb32_12, phi_bb32_12, phi_bb32_12});
  }

  TNode<BoolT> phi_bb40_8;
  TNode<Float64T> phi_bb40_9;
  TNode<Float64T> phi_bb40_10;
  TNode<Float64T> phi_bb40_11;
  ...
  TNode<BoolT> tmp55;
  if (block40.is_used()) {
    ca_.Bind(&block40, &phi_bb40_8, &phi_bb40_9, &phi_bb40_10, &phi_bb40_11, &phi_bb40_12, &phi_bb40_17, &phi_bb40_18, &phi_bb40_22, &phi_bb40_23);
    tmp48 = TimesSizeOf_float64_or_undefined_or_hole_0(state_, TNode<IntPtrT>{phi_bb40_23});
    tmp49 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp43}, TNode<IntPtrT>{tmp48});
    std::tie(tmp50, tmp51) = NewReference_float64_or_undefined_or_hole_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp42}, TNode<IntPtrT>{tmp49}).Flatten();
    std::tie(tmp52, tmp53, tmp54) = LoadFloat64OrUndefinedOrHole_0(state_, TorqueStructReference_float64_or_undefined_or_hole_0{TNode<Union<HeapObject, TaggedIndex>>{tmp50}, TNode<IntPtrT>{tmp51}, TorqueStructUnsafe_0{}}).Flatten();
    tmp55 = CodeStubAssembler(state_).Word32BinaryNot(TNode<BoolT>{tmp52});
    ca_.Branch(tmp55, &block45, std::vector<compiler::Node*>{phi_bb40_8, phi_bb40_9, phi_bb40_10, phi_bb40_11, phi_bb40_12, phi_bb40_17, phi_bb40_18}, &block46, std::vector<compiler::Node*>{phi_bb40_8, phi_bb40_9, phi_bb40_10, phi_bb40_11, phi_bb40_12, phi_bb40_17, phi_bb40_18});
  }

  TNode<BoolT> phi_bb41_8;
  TNode<Float64T> phi_bb41_9;
  TNode<Float64T> phi_bb41_10;
  TNode<Float64T> phi_bb41_11;
  ...
  if (block41.is_used()) {
    ca_.Bind(&block41, &phi_bb41_8, &phi_bb41_9, &phi_bb41_10, &phi_bb41_11, &phi_bb41_12, &phi_bb41_17, &phi_bb41_18, &phi_bb41_22, &phi_bb41_23);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/torque-internal.tq:113:45");
    CodeStubAssembler(state_).Unreachable();
  }

  TNode<BoolT> phi_bb46_8;
  TNode<Float64T> phi_bb46_9;
  TNode<Float64T> phi_bb46_10;
  TNode<Float64T> phi_bb46_11;
  TNode<IntPtrT> phi_bb46_12;
  TNode<IntPtrT> phi_bb46_17;
  TNode<IntPtrT> phi_bb46_18;
  if (block46.is_used()) {
    ca_.Bind(&block46, &phi_bb46_8, &phi_bb46_9, &phi_bb46_10, &phi_bb46_11, &phi_bb46_12, &phi_bb46_17, &phi_bb46_18);
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
  ...
  TNode<Float64T> phi_bb45_9;
  TNode<Float64T> phi_bb45_10;
  TNode<Float64T> phi_bb45_11;
  TNode<IntPtrT> phi_bb45_12;
  TNode<IntPtrT> phi_bb45_17;
  TNode<IntPtrT> phi_bb45_18;
  TNode<BoolT> tmp56;
  if (block45.is_used()) {
    ca_.Bind(&block45, &phi_bb45_8, &phi_bb45_9, &phi_bb45_10, &phi_bb45_11, &phi_bb45_12, &phi_bb45_17, &phi_bb45_18);
    tmp56 = CodeStubAssembler(state_).Word32BinaryNot(TNode<BoolT>{tmp53});
    ca_.Branch(tmp56, &block47, std::vector<compiler::Node*>{phi_bb45_8, phi_bb45_9, phi_bb45_10, phi_bb45_11, phi_bb45_12, phi_bb45_17, phi_bb45_18}, &block48, std::vector<compiler::Node*>{phi_bb45_8, phi_bb45_9, phi_bb45_10, phi_bb45_11, phi_bb45_12, phi_bb45_17, phi_bb45_18});
  }

  TNode<BoolT> phi_bb48_8;
  TNode<Float64T> phi_bb48_9;
  TNode<Float64T> phi_bb48_10;
  TNode<Float64T> phi_bb48_11;
  TNode<IntPtrT> phi_bb48_12;
  TNode<IntPtrT> phi_bb48_17;
  TNode<IntPtrT> phi_bb48_18;
  if (block48.is_used()) {
    ca_.Bind(&block48, &phi_bb48_8, &phi_bb48_9, &phi_bb48_10, &phi_bb48_11, &phi_bb48_12, &phi_bb48_17, &phi_bb48_18);
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
  ...
  TNode<Float64T> phi_bb47_9;
  TNode<Float64T> phi_bb47_10;
  TNode<Float64T> phi_bb47_11;
  ...
  TNode<IntPtrT> tmp64;
  if (block47.is_used()) {
    ca_.Bind(&block47, &phi_bb47_8, &phi_bb47_9, &phi_bb47_10, &phi_bb47_11, &phi_bb47_12, &phi_bb47_17, &phi_bb47_18);
    tmp57 = CodeStubAssembler(state_).Float64Div(TNode<Float64T>{tmp54}, TNode<Float64T>{phi_bb47_9});
    tmp58 = CodeStubAssembler(state_).Float64Mul(TNode<Float64T>{tmp57}, TNode<Float64T>{tmp57});
    tmp59 = CodeStubAssembler(state_).Float64Sub(TNode<Float64T>{tmp58}, TNode<Float64T>{phi_bb47_11});
    tmp60 = CodeStubAssembler(state_).Float64Add(TNode<Float64T>{phi_bb47_10}, TNode<Float64T>{tmp59});
    tmp61 = CodeStubAssembler(state_).Float64Sub(TNode<Float64T>{tmp60}, TNode<Float64T>{phi_bb47_10});
    tmp62 = CodeStubAssembler(state_).Float64Sub(TNode<Float64T>{tmp61}, TNode<Float64T>{tmp59});
    tmp63 = FromConstexpr_intptr_constexpr_int31_0(state_, 1);
    tmp64 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{phi_bb47_12}, TNode<IntPtrT>{tmp63});
    ca_.Goto(&block34, phi_bb47_8, phi_bb47_9, tmp60, tmp62, tmp64);
  }

  TNode<BoolT> phi_bb33_8;
  TNode<Float64T> phi_bb33_9;
  TNode<Float64T> phi_bb33_10;
  TNode<Float64T> phi_bb33_11;
  TNode<IntPtrT> phi_bb33_12;
  TNode<Float64T> tmp65;
  TNode<Float64T> tmp66;
  TNode<Number> tmp67;
  if (block33.is_used()) {
    ca_.Bind(&block33, &phi_bb33_8, &phi_bb33_9, &phi_bb33_10, &phi_bb33_11, &phi_bb33_12);
    tmp65 = CodeStubAssembler(state_).Float64Sqrt(TNode<Float64T>{phi_bb33_10});
    tmp66 = CodeStubAssembler(state_).Float64Mul(TNode<Float64T>{tmp65}, TNode<Float64T>{phi_bb33_9});
    tmp67 = Convert_Number_float64_0(state_, TNode<Float64T>{tmp66});
...
TF_BUILTIN(MathRandom, CodeStubAssembler) {
  ...
  if (block7.is_used()) {
    ...
    std::tie(tmp27, tmp28, tmp29) = LoadFloat64OrUndefinedOrHole_0(state_, TorqueStructReference_float64_or_undefined_or_hole_0{TNode<Union<HeapObject, TaggedIndex>>{tmp25}, TNode<IntPtrT>{tmp26}, TorqueStructUnsafe_0{}}).Flatten();
    tmp30 = CodeStubAssembler(state_).Word32BinaryNot(TNode<BoolT>{tmp27});
    ca_.Branch(tmp30, &block12, std::vector<compiler::Node*>{}, &block13, std::vector<compiler::Node*>{});
  }
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    tmp31 = CodeStubAssembler(state_).Word32BinaryNot(TNode<BoolT>{tmp28});
    ca_.Branch(tmp31, &block14, std::vector<compiler::Node*>{}, &block15, std::vector<compiler::Node*>{});
  }
  ...
  if (block14.is_used()) {
    ca_.Bind(&block14);
    tmp32 = CodeStubAssembler(state_).AllocateHeapNumberWithValue(TNode<Float64T>{tmp29});
