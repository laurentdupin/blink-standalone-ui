...
// https://crsrc.org/c/v8/src/builtins/promise-any.tq?l=9&c=1
...
// https://crsrc.org/c/v8/src/builtins/promise-any.tq?l=32&c=1
TNode<Context> CreatePromiseAnyRejectElementContext_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<PromiseCapability> p_capability, TNode<NativeContext> p_nativeContext) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FromConstexpr_intptr_constexpr_intptr_0(state_, CastIfEnumClass<intptr_t>(PromiseBuiltins::PromiseAnyRejectElementContextSlots::kPromiseAnyRejectElementLength));
...
// https://crsrc.org/c/v8/src/builtins/promise-any.tq?l=59&c=1
TNode<JSFunction> CreatePromiseAnyRejectElementFunction_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Context> p_rejectElementContext, TNode<Smi> p_index, TNode<NativeContext> p_nativeContext) {
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    {
      ...
      pos_stack.push_back({"src/builtins/promise-any.tq", 63});
  ...
  if (block5.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/promise-any.tq", 64});
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    tmp4 = CodeStubAssembler(state_).AllocateRootFunctionWithContext(RootIndex::kPromiseAnyRejectElementClosureSharedFun, TNode<Context>{p_rejectElementContext}, TNode<NativeContext>{p_nativeContext});
    tmp5 = FromConstexpr_bool_constexpr_bool_0(state_, (CodeStubAssembler(state_).ConstexprInt31Equal(PropertyArray::kNoHashSentinel, (FromConstexpr_constexpr_int31_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull))))));
  ...
  if (block7.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/promise-any.tq", 68});
  ...
  if (block6.is_used()) {
    ...
    CodeStubAssembler(state_).StoreReference<Union<FixedArrayBase, PropertyArray, Smi, SwissNameDictionary>>(CodeStubAssembler::Reference{tmp4, tmp6}, p_index);
    ca_.Goto(&block8);
  }
...
TF_BUILTIN(PromiseAnyRejectElementClosure, CodeStubAssembler) {
  ...
  if (block2.is_used()) {
    ...
    tmp4 = FromConstexpr_intptr_constexpr_intptr_0(state_, CastIfEnumClass<intptr_t>(PromiseBuiltins::PromiseAnyRejectElementContextSlots::kPromiseAnyRejectElementLength));
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    tmp13 = CodeStubAssembler(state_).ChangeUint32ToWord(TNode<Uint32T>{tmp11});
    tmp14 = FromConstexpr_uintptr_constexpr_uintptr_0(state_, kSmiMaxValue);
  ...
  if (block11.is_used()) {
    ca_.Bind(&block11);
    tmp16 = CodeStubAssembler(state_).ChangeUint32ToWord(TNode<Uint32T>{tmp11});
    ...
    tmp19 = CodeStubAssembler(state_).IntPtrSub(TNode<IntPtrT>{tmp17}, TNode<IntPtrT>{tmp18});
    tmp20 = kPromiseAnyRejectElementErrorsSlot_0(state_);
    std::tie(tmp21, tmp22) = ContextSlot_PromiseAnyRejectElementContext_PromiseAnyRejectElementContext_FixedArray_0(state_, TNode<Context>{tmp7}, TNode<IntPtrT>{tmp20}).Flatten();
    tmp23 = CodeStubAssembler(state_).LoadReference<FixedArray>(CodeStubAssembler::Reference{tmp21, tmp22});
    tmp24 = kPromiseAnyRejectElementRemainingSlot_0(state_);
    std::tie(tmp25, tmp26) = ContextSlot_PromiseAnyRejectElementContext_PromiseAnyRejectElementContext_Smi_0(state_, TNode<Context>{tmp7}, TNode<IntPtrT>{tmp24}).Flatten();
    tmp27 = CodeStubAssembler(state_).LoadReference<Smi>(CodeStubAssembler::Reference{tmp25, tmp26});
    tmp28 = CodeStubAssembler(state_).SmiUntag(TNode<Smi>{tmp27});
    ...
    tmp32 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp19}, TNode<IntPtrT>{tmp31});
    tmp33 = CodeStubAssembler(state_).IntPtrMax(TNode<IntPtrT>{tmp30}, TNode<IntPtrT>{tmp32});
    tmp34 = LoadFixedArrayBaseLengthIntptr_0(state_, TNode<FixedArrayBase>{tmp23});
    tmp35 = CodeStubAssembler(state_).IntPtrGreaterThan(TNode<IntPtrT>{tmp33}, TNode<IntPtrT>{tmp34});
    ca_.Branch(tmp35, &block13, std::vector<compiler::Node*>{}, &block14, std::vector<compiler::Node*>{tmp23});
  }

  TNode<IntPtrT> tmp36;
  TNode<PromiseHole> tmp37;
  TNode<IntPtrT> tmp38;
  TNode<FixedArray> tmp39;
  if (block13.is_used()) {
    ca_.Bind(&block13);
    tmp36 = LoadFixedArrayBaseLengthIntptr_0(state_, TNode<FixedArrayBase>{tmp23});
    tmp37 = PromiseHole_0(state_);
    tmp38 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    tmp39 = ExtractFixedArray_0(state_, TNode<FixedArray>{tmp23}, TNode<IntPtrT>{tmp38}, TNode<IntPtrT>{tmp36}, TNode<IntPtrT>{tmp33}, TNode<Hole>{tmp37});
    CodeStubAssembler(state_).StoreReference<FixedArray>(CodeStubAssembler::Reference{tmp21, tmp22}, tmp39);
    ca_.Goto(&block14, tmp39);
  }
  ...
  if (block14.is_used()) {
    ...
    std::tie(tmp40, tmp41, tmp42) = FieldSliceFixedArrayObjects_0(state_, TNode<FixedArray>{phi_bb14_10}).Flatten();
    tmp43 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp19});
    ...
    ca_.Branch(tmp45, &block19, std::vector<compiler::Node*>{}, &block20, std::vector<compiler::Node*>{});
  }
  ...
  if (block19.is_used()) {
    ca_.Bind(&block19);
    tmp46 = TimesSizeOf_Object_0(state_, TNode<IntPtrT>{tmp19});
    tmp47 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp41}, TNode<IntPtrT>{tmp46});
    std::tie(tmp48, tmp49) = NewReference_Object_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp40}, TNode<IntPtrT>{tmp47}).Flatten();
    CodeStubAssembler(state_).StoreReference<Object>(CodeStubAssembler::Reference{tmp48, tmp49}, parameter3);
    tmp50 = FromConstexpr_Smi_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull));
    tmp51 = CodeStubAssembler(state_).SmiSub(TNode<Smi>{tmp27}, TNode<Smi>{tmp50});
    tmp52 = kPromiseAnyRejectElementRemainingSlot_0(state_);
    std::tie(tmp53, tmp54) = ContextSlot_PromiseAnyRejectElementContext_PromiseAnyRejectElementContext_Smi_0(state_, TNode<Context>{tmp7}, TNode<IntPtrT>{tmp52}).Flatten();
    CodeStubAssembler(state_).StoreReference<Smi>(CodeStubAssembler::Reference{tmp53, tmp54}, tmp51);
    tmp55 = FromConstexpr_Smi_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    tmp56 = CodeStubAssembler(state_).SmiEqual(TNode<Smi>{tmp51}, TNode<Smi>{tmp55});
    ca_.Branch(tmp56, &block23, std::vector<compiler::Node*>{}, &block24, std::vector<compiler::Node*>{});
  }
  ...
  TNode<IntPtrT> tmp63;
  TNode<JSAny> tmp64;
  TNode<Union<JSBoundFunction, JSFunction, JSObject, JSProxy, JSWrappedFunction>> tmp65;
  TNode<Undefined> tmp66;
  TNode<JSAny> tmp67;
  if (block23.is_used()) {
    ca_.Bind(&block23);
    tmp57 = ConstructAggregateError_0(state_, TNode<Context>{tmp7}, TNode<FixedArray>{phi_bb14_10});
    tmp58 = kEmptyFixedArray_0(state_);
    CodeStubAssembler(state_).StoreReference<FixedArray>(CodeStubAssembler::Reference{tmp21, tmp22}, tmp58);
    tmp59 = kPromiseAnyRejectElementCapabilitySlot_0(state_);
    std::tie(tmp60, tmp61) = ContextSlot_PromiseAnyRejectElementContext_PromiseAnyRejectElementContext_PromiseCapability_0(state_, TNode<Context>{tmp7}, TNode<IntPtrT>{tmp59}).Flatten();
    tmp62 = CodeStubAssembler(state_).LoadReference<PromiseCapability>(CodeStubAssembler::Reference{tmp60, tmp61});
    tmp63 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
    tmp64 = CodeStubAssembler(state_).LoadReference<JSAny>(CodeStubAssembler::Reference{tmp62, tmp63});
    tmp65 = UnsafeCast_Callable_0(state_, TNode<Context>{tmp7}, TNode<Object>{tmp64});
    tmp66 = Undefined_0(state_);
    tmp67 = CodeStubAssembler(state_).Call(TNode<Context>{tmp7}, TNode<JSAny>{tmp65}, TNode<JSAny>{tmp66}, TNode<JSAny>{tmp57});
    ca_.Goto(&block24);
  }

  TNode<Undefined> tmp68;
  if (block24.is_used()) {
    ca_.Bind(&block24);
...
// https://crsrc.org/c/v8/src/builtins/promise-any.tq?l=173&c=1
TNode<JSAny> PerformPromiseAny_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<NativeContext> p_nativeContext, TorqueStructIteratorRecord p_iteratorRecord, TNode<JSReceiver> p_constructor, TNode<PromiseCapability> p_resultCapability, TNode<JSAny> p_promiseResolveFunction, compiler::CodeAssemblerLabel* label_Reject, compiler::TypedCodeAssemblerVariable<JSAny>* label_Reject_parameter_0) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Smi, JSAny, Union<JSMessageObject, TheHole>> block13(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<Smi, JSAny, Union<JSMessageObject, TheHole>> block6(&ca_, compiler::CodeAssemblerLabel::kDeferred);
  ...
  TNode<Union<JSMessageObject, TheHole>> tmp12;
  if (block11.is_used()) {
  ...
  TNode<Union<JSMessageObject, TheHole>> phi_bb13_12;
  if (block13.is_used()) {
  ...
  if (block20.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowRangeError(TNode<Context>{p_context}, CastIfEnumClass<MessageTemplate>(MessageTemplate::kTooManyElementsInPromiseCombinator), TNode<Object>{tmp30});
    }
  ...
  TNode<Union<JSMessageObject, TheHole>> tmp103;
  if (block45.is_used()) {
    ca_.Bind(&block45);
  ...
  TNode<Union<JSMessageObject, TheHole>> phi_bb6_10;
  if (block6.is_used()) {
  ...
  if (block49.is_used()) {
    ...
    tmp132 = kEmptyFixedArray_0(state_);
    CodeStubAssembler(state_).StoreReference<FixedArray>(CodeStubAssembler::Reference{tmp129, tmp130}, tmp132);
    tmp133 = LoadFixedArrayBaseLengthIntptr_0(state_, TNode<FixedArrayBase>{tmp131});
    ...
    tmp137 = CodeStubAssembler(state_).WordEqual(TNode<IntPtrT>{tmp133}, TNode<IntPtrT>{tmp136});
    ca_.Branch(tmp137, &block51, std::vector<compiler::Node*>{phi_bb49_8}, &block52, std::vector<compiler::Node*>{phi_bb49_8});
  }
  ...
  if (block52.is_used()) {
    ca_.Bind(&block52, &phi_bb52_8);
    {
      ...
      CodeStubAssembler(state_).FailAssert("Torque assert 'errors.length_intptr == Convert<intptr>(index - 1)' failed", pos_stack);
    }
  }
  ...
  if (block51.is_used()) {
    ...
    tmp138 = ConstructAggregateError_0(state_, TNode<Context>{p_context}, TNode<FixedArray>{tmp131});
    ca_.Goto(&block1, tmp138);
  }
...
TF_BUILTIN(PromiseAny, CodeStubAssembler) {
  ...
  compiler::CodeAssemblerParameterizedLabel<JSAny, Union<JSMessageObject, TheHole>> block10(&ca_, compiler::CodeAssemblerLabel::kDeferred);
  compiler::CodeAssemblerParameterizedLabel<JSAny> block8(&ca_, compiler::CodeAssemblerLabel::kDeferred);
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{parameter0}, CastIfEnumClass<MessageTemplate>(MessageTemplate::kCalledOnNonObject), "Promise.any");
  }
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    tmp3 = False_0(state_);
    tmp4 = ca_.CallBuiltin<PromiseCapability>(Builtin::kNewPromiseCapability, parameter0, tmp1, tmp3);
  ...
  if (block6.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/promise-any.tq", 352});
  ...
  TNode<JSAny> tmp11;
      TNode<JSAny> tmp13;
  TNode<JSAny> tmp14;
    compiler::TypedCodeAssemblerVariable<JSAny> tmp16(&ca_);
      TNode<JSAny> tmp18;
  if (block5.is_used()) {
    ca_.Bind(&block5);
    ...
    std::tie(tmp10, tmp11) = IteratorBuiltinsAssembler(state_).GetIterator(TNode<Context>{parameter0}, TNode<JSAny>{parameter2}).Flatten();
    }
    ...
    tmp14 = PerformPromiseAny_0(state_, TNode<Context>{parameter0}, TNode<NativeContext>{tmp0}, TorqueStructIteratorRecord{TNode<JSReceiver>{tmp10}, TNode<JSAny>{tmp11}}, TNode<JSReceiver>{tmp6}, TNode<PromiseCapability>{tmp4}, TNode<JSAny>{tmp7}, &label15, &tmp16);
    }
  ...
  TNode<Union<JSMessageObject, TheHole>> phi_bb10_8;
  if (block10.is_used()) {
    ca_.Bind(&block10, &phi_bb10_7, &phi_bb10_8);
    ca_.Goto(&block8, phi_bb10_7);
  }

  TNode<JSAny> phi_bb8_7;
  TNode<PromiseHole> tmp22;
  TNode<BoolT> tmp23;
  if (block8.is_used()) {
    ca_.Bind(&block8, &phi_bb8_7);
    tmp22 = PromiseHole_0(state_);
    tmp23 = CodeStubAssembler(state_).TaggedNotEqual(TNode<Object>{phi_bb8_7}, TNode<Union<Context, FixedArrayBase, FunctionTemplateInfo, Hole, JSReceiver, Map, Oddball, String, Symbol, WasmFuncRef, WasmNull, WeakCell>>{tmp22});
  ...
  if (block17.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/promise-any.tq", 389});
      CodeStubAssembler(state_).FailAssert("Torque assert 'e != PromiseHole' failed", pos_stack);
    }
  }

  TNode<IntPtrT> tmp24;
  TNode<JSAny> tmp25;
  TNode<Union<JSBoundFunction, JSFunction, JSObject, JSProxy, JSWrappedFunction>> tmp26;
  TNode<Undefined> tmp27;
  TNode<JSAny> tmp28;
  TNode<JSAny> tmp29;
  TNode<IntPtrT> tmp30;
  TNode<Union<JSReceiver, Undefined>> tmp31;
  if (block16.is_used()) {
    ca_.Bind(&block16);
    tmp24 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
    tmp25 = CodeStubAssembler(state_).LoadReference<JSAny>(CodeStubAssembler::Reference{tmp4, tmp24});
    ...
    tmp29 = CodeStubAssembler(state_).Call(TNode<Context>{parameter0}, TNode<JSAny>{tmp26}, TNode<JSAny>{tmp27}, TNode<JSAny>{tmp28});
    tmp30 = FromConstexpr_intptr_constexpr_int31_0(state_, 4);
    tmp31 = CodeStubAssembler(state_).LoadReference<Union<JSReceiver, Undefined>>(CodeStubAssembler::Reference{tmp4, tmp30});
    CodeStubAssembler(state_).Return(tmp31);
  }
}

// https://crsrc.org/c/v8/src/builtins/promise-any.tq?l=397&c=1
TNode<JSObject> ConstructAggregateError_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArray> p_errors) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = CodeStubAssembler(state_).SmiConstant(CastIfEnumClass<MessageTemplate>(MessageTemplate::kAllPromisesRejected));
    ...
    tmp4 = CodeStubAssembler(state_).SmiConstant(CastIfEnumClass<int31_t>(PropertyAttributes::DONT_ENUM));
...
// https://crsrc.org/c/v8/src/builtins/promise-any.tq?l=39&c=3
void InitContextSlot_PromiseAnyRejectElementContext_PromiseAnyRejectElementContext_Smi_constexpr_IntegerLiteral_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<IntPtrT> p_index, IntegerLiteral p_value) {
  ...
  if (block8.is_used()) {
    ...
    tmp13 = CodeStubAssembler(state_).TaggedEqual(TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp11}, TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp12});
  ...
  if (block16.is_used()) {
    ...
    std::tie(tmp22, tmp23) = NewReference_Object_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp14}, TNode<IntPtrT>{tmp21}).Flatten();
...
// https://crsrc.org/c/v8/src/builtins/promise-any.tq?l=44&c=3
...
// https://crsrc.org/c/v8/src/builtins/promise-any.tq?l=49&c=3
...
// https://crsrc.org/c/v8/src/builtins/promise-any.tq?l=109&c=31
...
// https://crsrc.org/c/v8/src/builtins/promise-any.tq?l=117&c=33
...
// https://crsrc.org/c/v8/src/builtins/promise-any.tq?l=162&c=25
...
// https://crsrc.org/c/v8/src/builtins/promise-any.tq?l=194&c=36
...
// https://crsrc.org/c/v8/src/builtins/promise-any.tq?l=291&c=30
...
// https://crsrc.org/c/v8/src/builtins/promise-any.tq?l=352&c=10
