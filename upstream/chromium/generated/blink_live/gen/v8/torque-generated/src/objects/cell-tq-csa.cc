...
TNode<Cell> Cast_Cell_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_obj, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block0.is_used()) {
    ...
    tmp0 = DownCastForTorqueClass_Cell_0(state_, TNode<HeapObject>{p_obj}, &label1);
    ca_.Goto(&block3);
    if (label1.is_used()) {
      ca_.Bind(&label1);
      ca_.Goto(&block4);
...
TNode<Object> LoadCellValue_0(compiler::CodeAssemblerState* state_, TNode<Cell> p_cell) {
  ...
  TNode<IntPtrT> tmp0;
  TNode<Union<HeapObject, Smi, Weak<HeapObject>>> tmp1;
  TNode<BoolT> tmp2;
  TNode<BoolT> tmp3;
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 4);
    tmp1 = CodeStubAssembler(state_).LoadReference<Union<HeapObject, Smi, Weak<HeapObject>>>(CodeStubAssembler::Reference{p_cell, tmp0});
    tmp2 = CodeStubAssembler(state_).IsWeakOrCleared(TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp1});
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    {
      ...
      pos_stack.push_back({"src/objects/cell.tq", 14});
      CodeStubAssembler(state_).FailAssert("Torque assert '!IsWeakOrCleared(value)' failed", pos_stack);
    }
  }

  TNode<Weak<HeapObject>> tmp4;
  if (block2.is_used()) {
    ca_.Bind(&block2);
    compiler::CodeAssemblerLabel label5(&ca_);
    tmp4 = Cast_WeakHeapObject_0(state_, TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp1}, &label5);
    ca_.Goto(&block13);
    if (label5.is_used()) {
      ca_.Bind(&label5);
      ca_.Goto(&block14);
  ...
  if (block14.is_used()) {
    ...
    tmp6 = Cast_Object_0(state_, TNode<Object>{ca_.UncheckedCast<Object>(tmp1)}, &label7);
    ca_.Goto(&block15);
    if (label7.is_used()) {
      ca_.Bind(&label7);
      ca_.Goto(&block16);
  ...
  if (block7.is_used()) {
    ...
    ca_.Branch(phi_bb7_6, &block5, std::vector<compiler::Node*>{}, &block6, std::vector<compiler::Node*>{});
  }
  ...
  if (block6.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/cast.tq", 969});
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    tmp10 = TORQUE_CAST(TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp1});
    ca_.Goto(&block17);
  }
...
void StoreCellValue_0(compiler::CodeAssemblerState* state_, TNode<Cell> p_cell, TNode<Object> p_value) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 4);
    CodeStubAssembler(state_).StoreReference<Union<HeapObject, Smi, Weak<HeapObject>>>(CodeStubAssembler::Reference{p_cell, tmp0}, p_value);
    ca_.Goto(&block2);
  }
...
TNode<Union<HeapObject, Smi, Weak<HeapObject>>> LoadCellMaybeValue_0(compiler::CodeAssemblerState* state_, TNode<Cell> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 4);
    tmp1 = CodeStubAssembler(state_).LoadReference<Union<HeapObject, Smi, Weak<HeapObject>>>(CodeStubAssembler::Reference{p_o, tmp0});
    ca_.Goto(&block2);
  }

    ca_.Bind(&block2);
  return TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp1};
}
...
void StoreCellMaybeValue_0(compiler::CodeAssemblerState* state_, TNode<Cell> p_o, TNode<Union<HeapObject, Smi, Weak<HeapObject>>> p_v) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FromConstexpr_intptr_constexpr_int31_0(state_, 4);
    CodeStubAssembler(state_).StoreReference<Union<HeapObject, Smi, Weak<HeapObject>>>(CodeStubAssembler::Reference{p_o, tmp0}, p_v);
    ca_.Goto(&block2);
  }
...
TNode<Cell> DownCastForTorqueClass_Cell_0(compiler::CodeAssemblerState* state_, TNode<HeapObject> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    if ((CodeStubAssembler(state_).ClassHasMapConstant<Cell>())) {
      ca_.Goto(&block6);
    } else {
      ca_.Goto(&block7);
    }
  ...
  if (block7.is_used()) {
    ...
    tmp6 = FromConstexpr_uint32_constexpr_uint32_0(state_, CastIfEnumClass<uint32_t>(static_cast<InstanceType>(255)));
...
TNode<Object> UnsafeCast_Object_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Union<HeapObject, Smi, Weak<HeapObject>>> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = Is_Object_0(state_, TNode<Context>{p_context}, TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{p_o});
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    tmp1 = TORQUE_CAST(TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{p_o});
    ca_.Goto(&block4);
  }
