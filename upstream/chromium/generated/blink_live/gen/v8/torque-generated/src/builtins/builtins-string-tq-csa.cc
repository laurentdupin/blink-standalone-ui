...
TNode<String> ToStringImpl_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSAny> p_o) {
  ...
  compiler::CodeAssemblerParameterizedLabel<JSAny, JSAny> block24(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<JSAny, JSAny> block23(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block8.is_used()) {
    ...
    tmp3 = Cast_String_0(state_, TNode<HeapObject>{ca_.UncheckedCast<Union<BigInt, Boolean, JSReceiver, Null, String, Symbol, Undefined>>(phi_bb8_3)}, &label4);
  ...
  if (block12.is_used()) {
    ...
    tmp6 = Cast_Oddball_0(state_, TNode<HeapObject>{ca_.UncheckedCast<Union<BigInt, Boolean, JSReceiver, Null, Symbol, Undefined>>(phi_bb12_3)}, &label7);
  ...
  if (block16.is_used()) {
    ...
    tmp8 = Cast_JSReceiver_0(state_, TNode<HeapObject>{ca_.UncheckedCast<Union<BigInt, JSReceiver, Symbol>>(phi_bb16_3)}, &label9);
  ...
  if (block20.is_used()) {
    ...
    tmp12 = Cast_Symbol_0(state_, TNode<HeapObject>{ca_.UncheckedCast<Union<BigInt, Symbol>>(phi_bb20_3)}, &label13);
  ...
  if (block23.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{p_context}, CastIfEnumClass<MessageTemplate>(MessageTemplate::kSymbolToString));
  }

  TNode<JSAny> phi_bb3_2;
  if (block3.is_used()) {
    ca_.Bind(&block3, &phi_bb3_2);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/builtins-string.tq:42:3");
...
TF_BUILTIN(ToString, CodeStubAssembler) {
  ...
  USE(parameter0);
  TNode<JSAny> parameter1 = UncheckedParameter<JSAny>(Descriptor::kO);
  USE(parameter1);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = ToStringImpl_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1});
    CodeStubAssembler(state_).Return(tmp0);
  }
}

TF_BUILTIN(ToStringConvertSymbol, CodeStubAssembler) {
  compiler::CodeAssemblerState* state_ = state();  compiler::CodeAssembler ca_(state());
  TNode<Context> parameter0 = UncheckedParameter<Context>(Descriptor::kContext);
  USE(parameter0);
  TNode<JSAny> parameter1 = UncheckedParameter<JSAny>(Descriptor::kO);
  ...
  if (block0.is_used()) {
    ...
    tmp0 = Cast_Symbol_1(state_, TNode<Context>{parameter0}, TNode<Object>{parameter1}, &label1);
    ca_.Goto(&block3);
    if (label1.is_used()) {
      ca_.Bind(&label1);
      ca_.Goto(&block4);
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    tmp2 = ToStringImpl_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{ca_.UncheckedCast<Union<BigInt, Boolean, HeapNumber, JSReceiver, Null, Smi, String, Undefined>>(parameter1)});
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    tmp3 = TORQUE_CAST(CodeStubAssembler(state_).CallRuntime(Runtime::kSymbolDescriptiveString, parameter0, tmp0)); 
...
TNode<String> ToString_Inline_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSAny> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = ToStringImpl_0(state_, TNode<Context>{p_context}, TNode<JSAny>{p_o});
    ca_.Goto(&block2);
  }
...
TF_BUILTIN(StringPrototypeToString, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = CodeStubAssembler(state_).ToThisValue(TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, CastIfEnumClass<PrimitiveType>(PrimitiveType::kString), "String.prototype.toString");
    CodeStubAssembler(state_).Return(tmp0);
  }
}
...
TF_BUILTIN(StringPrototypeValueOf, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = CodeStubAssembler(state_).ToThisValue(TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, CastIfEnumClass<PrimitiveType>(PrimitiveType::kString), "String.prototype.valueOf");
    CodeStubAssembler(state_).Return(tmp0);
  }
}
...
TF_BUILTIN(StringToList, CodeStubAssembler) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Smi, IntPtrT> block5(&ca_, compiler::CodeAssemblerLabel::kDeferred);
  compiler::CodeAssemblerParameterizedLabel<Smi, IntPtrT> block4(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Smi, IntPtrT> block7(&ca_, compiler::CodeAssemblerLabel::kDeferred);
  ...
  if (block0.is_used()) {
    ...
    tmp2 = CodeStubAssembler(state_).LoadJSArrayElementsMap(CastIfEnumClass<ElementsKind>(ElementsKind::PACKED_ELEMENTS), TNode<NativeContext>{tmp1});
    tmp3 = CodeStubAssembler(state_).SmiTag(TNode<IntPtrT>{tmp0});
    tmp4 = CodeStubAssembler(state_).AllocateJSArray(CastIfEnumClass<ElementsKind>(ElementsKind::PACKED_ELEMENTS), TNode<Map>{tmp2}, TNode<IntPtrT>{tmp0}, TNode<Smi>{tmp3});
  ...
  if (block1.is_used()) {
    ...
    tmp11 = StringBuiltinsAssembler(state_).LoadSurrogatePairAt(TNode<String>{parameter1}, TNode<IntPtrT>{tmp0}, TNode<IntPtrT>{phi_bb1_8}, CastIfEnumClass<UnicodeEncoding>(UnicodeEncoding::UTF16));
  ...
  if (block2.is_used()) {
    ...
    tmp18 = CodeStubAssembler(state_).SmiGreaterThanOrEqual(TNode<Smi>{phi_bb2_7}, TNode<Smi>{tmp17});
    ca_.Branch(tmp18, &block4, std::vector<compiler::Node*>{phi_bb2_7, phi_bb2_8}, &block5, std::vector<compiler::Node*>{phi_bb2_7, phi_bb2_8});
  }
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5, &phi_bb5_7, &phi_bb5_8);
    {
      ...
      pos_stack.push_back({"src/builtins/builtins-string.tq", 120});
      CodeStubAssembler(state_).FailAssert("Torque assert 'arrayLength >= 0' failed", pos_stack);
    }
  }
  ...
  if (block4.is_used()) {
    ...
    tmp19 = CodeStubAssembler(state_).SmiTag(TNode<IntPtrT>{tmp0});
    tmp20 = CodeStubAssembler(state_).SmiGreaterThanOrEqual(TNode<Smi>{tmp19}, TNode<Smi>{phi_bb4_7});
    ca_.Branch(tmp20, &block6, std::vector<compiler::Node*>{phi_bb4_7, phi_bb4_8}, &block7, std::vector<compiler::Node*>{phi_bb4_7, phi_bb4_8});
  }
  ...
  if (block7.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/builtins-string.tq", 121});
      CodeStubAssembler(state_).FailAssert("Torque assert 'SmiTag(stringLength) >= arrayLength' failed", pos_stack);
    }
  }
  ...
  if (block6.is_used()) {
    ...
    CodeStubAssembler(state_).StoreReference<Number>(CodeStubAssembler::Reference{tmp4, tmp21}, phi_bb6_7);
...
void GenerateStringAt_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSAny> p_receiver, TNode<JSAny> p_position, const char* p_methodName, compiler::CodeAssemblerLabel* label_IfInBounds, compiler::TypedCodeAssemblerVariable<String>* label_IfInBounds_parameter_0, compiler::TypedCodeAssemblerVariable<UintPtrT>* label_IfInBounds_parameter_1, compiler::TypedCodeAssemblerVariable<UintPtrT>* label_IfInBounds_parameter_2, compiler::CodeAssemblerLabel* label_IfOutOfBounds) {
  ...
  if (block0.is_used()) {
    ...
    tmp2 = ToInteger_Inline_0(state_, TNode<Context>{p_context}, TNode<JSAny>{p_position});
    compiler::CodeAssemblerLabel label4(&ca_);
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    tmp6 = LoadStringLengthAsUintPtr_0(state_, TNode<String>{tmp1});
    tmp7 = Convert_intptr_Smi_0(state_, TNode<Smi>{tmp3});
    tmp8 = CodeStubAssembler(state_).Unsigned(TNode<IntPtrT>{tmp7});
    StaticAssertStringLengthFitsSmi_0(state_);
    tmp9 = CodeStubAssembler(state_).UintPtrGreaterThanOrEqual(TNode<UintPtrT>{tmp8}, TNode<UintPtrT>{tmp6});
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    *label_IfInBounds_parameter_2 = tmp6;
    *label_IfInBounds_parameter_1 = tmp8;
  ...
  if (block10.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/builtins-string.tq", 152});
...
TF_BUILTIN(StringPrototypeCharAt, CodeStubAssembler) {
  ...
  TNode<JSAny> parameter1 = UncheckedParameter<JSAny>(Descriptor::kReceiver);
  USE(parameter1);
  TNode<JSAny> parameter2 = UncheckedParameter<JSAny>(Descriptor::kPosition);
  USE(parameter2);
  compiler::CodeAssemblerParameterizedLabel<> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block5(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block6(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block0.is_used()) {
    ...
    compiler::CodeAssemblerLabel label4(&ca_);
    GenerateStringAt_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, TNode<JSAny>{parameter2}, "String.prototype.charAt", &label0, &tmp1, &tmp2, &tmp3, &label4);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block5);
    }
...
TF_BUILTIN(StringPrototypeCharCodeAt, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    compiler::CodeAssemblerLabel label0(&ca_);
    compiler::CodeAssemblerLabel label4(&ca_);
    GenerateStringAt_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, TNode<JSAny>{parameter2}, "String.prototype.charCodeAt", &label0, &tmp1, &tmp2, &tmp3, &label4);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block5);
    }
...
TF_BUILTIN(StringPrototypeCodePointAt, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    compiler::CodeAssemblerLabel label0(&ca_);
    compiler::CodeAssemblerLabel label4(&ca_);
    GenerateStringAt_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, TNode<JSAny>{parameter2}, "String.prototype.codePointAt", &label0, &tmp1, &tmp2, &tmp3, &label4);
    if (label0.is_used()) {
      ca_.Bind(&label0);
      ca_.Goto(&block5);
    }
  ...
  if (block5.is_used()) {
    ...
    tmp7 = StringBuiltinsAssembler(state_).LoadSurrogatePairAt(TNode<String>{tmp1.value()}, TNode<IntPtrT>{tmp5}, TNode<IntPtrT>{tmp6}, CastIfEnumClass<UnicodeEncoding>(UnicodeEncoding::UTF32));
...
TF_BUILTIN(StringPrototypeConcat, CodeStubAssembler) {
  ...
  if (block1.is_used()) {
    ...
    tmp6 = CodeStubAssembler(state_).ToString_Inline(TNode<Context>{parameter0}, TNode<JSAny>{tmp5});
...
TF_BUILTIN(StringConstructor, CodeStubAssembler) {
  ...
  if (block5.is_used()) {
    ...
    tmp13 = CodeStubAssembler(state_).ToString_Inline(TNode<Context>{parameter0}, TNode<JSAny>{tmp12});
  ...
  if (block3.is_used()) {
    ...
    tmp15 = CodeStubAssembler(state_).TaggedEqual(TNode<Object>{parameter2}, TNode<Union<Context, FixedArrayBase, FunctionTemplateInfo, Hole, JSReceiver, Map, Oddball, String, Symbol, WasmFuncRef, WasmNull, WeakCell>>{tmp14});
  ...
  if (block11.is_used()) {
    ...
    tmp16 = CodeStubAssembler(state_).TaggedNotEqual(TNode<Union<Context, FixedArrayBase, FunctionTemplateInfo, Hole, JSReceiver, Map, Oddball, String, Symbol, WasmFuncRef, WasmNull, WeakCell>>{parameter3}, TNode<Object>{parameter2});
  ...
  if (block13.is_used()) {
    ...
    tmp21 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
    CodeStubAssembler(state_).StoreReference<JSAny>(CodeStubAssembler::Reference{tmp20, tmp21}, phi_bb13_9);
...
TF_BUILTIN(StringCreateLazyDeoptContinuation, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp2 = UnsafeCast_Map_0(state_, TNode<Context>{parameter0}, TNode<Object>{tmp1});
    tmp3 = AllocateFastOrSlowJSObjectFromMap_0(state_, TNode<Context>{parameter0}, TNode<Map>{tmp2});
    tmp4 = UnsafeCast_JSPrimitiveWrapper_0(state_, TNode<Context>{parameter0}, TNode<Object>{tmp3});
    tmp5 = FromConstexpr_intptr_constexpr_int31_0(state_, 12);
    tmp6 = UnsafeCast_String_0(state_, TNode<Context>{parameter0}, TNode<Object>{parameter1});
    CodeStubAssembler(state_).StoreReference<JSAny>(CodeStubAssembler::Reference{tmp4, tmp5}, tmp6);
    CodeStubAssembler(state_).Return(tmp4);
  }
}
...
TF_BUILTIN(StringAddConvertLeft, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = ToPrimitiveDefault_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1});
    tmp1 = ToStringImpl_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{tmp0});
...
TF_BUILTIN(StringAddConvertRight, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = ToPrimitiveDefault_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter2});
    tmp1 = ToStringImpl_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{tmp0});
...
TNode<Map> UnsafeCast_Map_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = Is_Map_Object_0(state_, TNode<Context>{p_context}, TNode<Object>{p_o});
