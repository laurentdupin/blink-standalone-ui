...
TNode<BigInt> AllocateEmptyBigInt_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Uint32T> p_sign, TNode<IntPtrT> p_length) {
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    CodeStubAssembler(state_).ThrowRangeError(TNode<Context>{p_context}, CastIfEnumClass<MessageTemplate>(MessageTemplate::kBigIntTooBig));
  }
...
TNode<IntPtrT> BigIntCompareAbsolute_0(compiler::CodeAssemblerState* state_, TNode<BigInt> p_x, TNode<BigInt> p_y) {
  ...
  if (block6.is_used()) {
    ...
    tmp8 = CodeStubAssembler(state_).IntPtrGreaterThanOrEqual(TNode<IntPtrT>{phi_bb6_5}, TNode<IntPtrT>{tmp7});
  ...
  if (block4.is_used()) {
    ...
    tmp9 = CodeStubAssembler(state_).LoadBigIntDigit(TNode<BigInt>{p_x}, TNode<IntPtrT>{phi_bb4_5});
    tmp10 = CodeStubAssembler(state_).LoadBigIntDigit(TNode<BigInt>{p_y}, TNode<IntPtrT>{phi_bb4_5});
    tmp11 = CodeStubAssembler(state_).WordNotEqual(TNode<UintPtrT>{tmp9}, TNode<UintPtrT>{tmp10});
    ca_.Branch(tmp11, &block8, std::vector<compiler::Node*>{phi_bb4_5}, &block9, std::vector<compiler::Node*>{phi_bb4_5});
  }
  ...
  if (block8.is_used()) {
    ...
    ca_.Branch(tmp12, &block10, std::vector<compiler::Node*>{phi_bb8_5}, &block11, std::vector<compiler::Node*>{phi_bb8_5});
  }
  ...
  if (block10.is_used()) {
    ...
    ca_.Goto(&block12, phi_bb10_5, tmp13);
  }
  ...
  if (block11.is_used()) {
    ...
    ca_.Goto(&block12, phi_bb11_5, tmp14);
  }
  ...
  if (block9.is_used()) {
    ...
    tmp16 = CodeStubAssembler(state_).IntPtrSub(TNode<IntPtrT>{phi_bb9_5}, TNode<IntPtrT>{tmp15});
...
TNode<BigInt> MutableBigIntAbsoluteSub_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<BigInt> p_x, TNode<BigInt> p_y, TNode<Uint32T> p_resultSign) {
  ...
  if (block0.is_used()) {
    ...
    tmp3 = BigIntCompareAbsolute_0(state_, TNode<BigInt>{p_x}, TNode<BigInt>{p_y});
    tmp4 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    tmp5 = CodeStubAssembler(state_).IntPtrGreaterThanOrEqual(TNode<IntPtrT>{tmp3}, TNode<IntPtrT>{tmp4});
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    {
      ...
      pos_stack.push_back({"src/builtins/builtins-bigint.tq", 125});
      CodeStubAssembler(state_).FailAssert("Torque assert 'BigIntCompareAbsolute(x, y) >= 0' failed", pos_stack);
    }
  }
  ...
  if (block4.is_used()) {
    ...
    tmp9 = CodeStubAssembler(state_).WordEqual(TNode<IntPtrT>{tmp1}, TNode<IntPtrT>{tmp8});
  ...
  if (block7.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/builtins-bigint.tq", 127});
      CodeStubAssembler(state_).FailAssert("Torque assert 'ylength == 0' failed", pos_stack);
    }
  }
  ...
  if (block5.is_used()) {
    ...
    tmp11 = CodeStubAssembler(state_).WordEqual(TNode<IntPtrT>{tmp1}, TNode<IntPtrT>{tmp10});
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    tmp12 = CodeStubAssembler(state_).Word32Equal(TNode<Uint32T>{p_resultSign}, TNode<Uint32T>{tmp2});
    ca_.Branch(tmp12, &block10, std::vector<compiler::Node*>{}, &block11, std::vector<compiler::Node*>{});
  }

  if (block10.is_used()) {
    ca_.Bind(&block10);
    ca_.Goto(&block12, p_x);
  }

  TNode<BigInt> tmp13;
  if (block11.is_used()) {
    ca_.Bind(&block11);
    tmp13 = ca_.CallBuiltin<BigInt>(Builtin::kBigIntUnaryMinus, p_context, p_x);
    ca_.Goto(&block12, tmp13);
  }

  TNode<BigInt> phi_bb12_7;
  if (block12.is_used()) {
    ca_.Bind(&block12, &phi_bb12_7);
    ca_.Goto(&block1, phi_bb12_7);
  }
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    tmp14 = AllocateEmptyBigInt_0(state_, TNode<Context>{p_context}, TNode<Uint32T>{p_resultSign}, TNode<IntPtrT>{tmp0});
    BigIntBuiltinsAssembler(state_).CppAbsoluteSubAndCanonicalize(TNode<BigInt>{tmp14}, TNode<BigInt>{p_x}, TNode<BigInt>{p_y});
    tmp15 = Convert_BigInt_MutableBigInt_0(state_, TNode<BigInt>{tmp14});
...
TNode<BigInt> MutableBigIntAbsoluteAdd_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<BigInt> p_xBigint, TNode<BigInt> p_yBigint, TNode<Uint32T> p_resultSign, compiler::CodeAssemblerLabel* label_BigIntTooBig) {
  ...
  compiler::CodeAssemblerParameterizedLabel<BigInt> block13(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block10(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<BigInt> block17(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
  ...
  if (block8.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/builtins-bigint.tq", 159});
      CodeStubAssembler(state_).FailAssert("Torque assert 'ylength == 0' failed", pos_stack);
    }
  }
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    tmp7 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    tmp8 = CodeStubAssembler(state_).WordEqual(TNode<IntPtrT>{phi_bb4_5}, TNode<IntPtrT>{tmp7});
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    tmp9 = BigIntBuiltinsAssembler(state_).ReadBigIntSign(TNode<BigInt>{phi_bb4_6});
    tmp10 = CodeStubAssembler(state_).Word32Equal(TNode<Uint32T>{p_resultSign}, TNode<Uint32T>{tmp9});
    ca_.Branch(tmp10, &block11, std::vector<compiler::Node*>{}, &block12, std::vector<compiler::Node*>{});
  }

  if (block11.is_used()) {
    ca_.Bind(&block11);
    ca_.Goto(&block13, phi_bb4_6);
  }

  TNode<BigInt> tmp11;
  if (block12.is_used()) {
    ca_.Bind(&block12);
    tmp11 = ca_.CallBuiltin<BigInt>(Builtin::kBigIntUnaryMinus, p_context, phi_bb4_6);
    ca_.Goto(&block13, tmp11);
  }

  TNode<BigInt> phi_bb13_8;
  if (block13.is_used()) {
    ca_.Bind(&block13, &phi_bb13_8);
    ca_.Goto(&block2, phi_bb13_8);
  }
  ...
  if (block10.is_used()) {
    ...
    tmp13 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{phi_bb4_4}, TNode<IntPtrT>{tmp12});
    compiler::CodeAssemblerLabel label15(&ca_);
    tmp14 = AllocateEmptyBigIntNoThrow_0(state_, TNode<Context>{p_context}, TNode<Uint32T>{p_resultSign}, TNode<IntPtrT>{tmp13}, &label15);
    ca_.Goto(&block15);
    if (label15.is_used()) {
      ca_.Bind(&label15);
      ca_.Goto(&block16);
  ...
  if (block15.is_used()) {
    ca_.Bind(&block15);
    BigIntBuiltinsAssembler(state_).CppAbsoluteAddAndCanonicalize(TNode<BigInt>{tmp14}, TNode<BigInt>{phi_bb4_6}, TNode<BigInt>{phi_bb4_7});
    tmp16 = Convert_BigInt_MutableBigInt_0(state_, TNode<BigInt>{tmp14});
  ...
  if (block2.is_used()) {
    ...
    ca_.Goto(&block17, phi_bb2_4);
  }

  TNode<BigInt> phi_bb17_4;
    ca_.Bind(&block17, &phi_bb17_4);
  return TNode<BigInt>{phi_bb17_4};
}
...
TNode<BigInt> BigIntAddImpl_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<BigInt> p_x, TNode<BigInt> p_y, compiler::CodeAssemblerLabel* label_BigIntTooBig) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    tmp5 = BigIntCompareAbsolute_0(state_, TNode<BigInt>{p_x}, TNode<BigInt>{p_y});
    tmp6 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    tmp7 = CodeStubAssembler(state_).IntPtrGreaterThanOrEqual(TNode<IntPtrT>{tmp5}, TNode<IntPtrT>{tmp6});
...
TF_BUILTIN(BigIntAdd, CodeStubAssembler) {
  ...
  if (block10.is_used()) {
    ca_.Bind(&block10);
    CodeStubAssembler(state_).ThrowRangeError(TNode<Context>{parameter0}, CastIfEnumClass<MessageTemplate>(MessageTemplate::kBigIntTooBig));
  }
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{parameter0}, CastIfEnumClass<MessageTemplate>(MessageTemplate::kBigIntMixedTypes));
  }
}
...
TNode<BigInt> BigIntMultiplyImpl_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<BigInt> p_x, TNode<BigInt> p_y, compiler::CodeAssemblerLabel* label_BigIntTooBig, compiler::CodeAssemblerLabel* label_TerminationRequested) {
  ...
  compiler::CodeAssemblerParameterizedLabel<BigInt> block20(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
    ca_.Goto(&block0);
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    tmp14 = CodeStubAssembler(state_).IntPtrLessThan(TNode<IntPtrT>{tmp0}, TNode<IntPtrT>{tmp1});
  ...
  if (block14.is_used()) {
    ca_.Bind(&block14);
    tmp15 = BigIntBuiltinsAssembler(state_).CppAbsoluteMulAndCanonicalize(TNode<BigInt>{tmp12}, TNode<BigInt>{p_y}, TNode<BigInt>{p_x});
  ...
  if (block15.is_used()) {
    ca_.Bind(&block15);
    tmp16 = BigIntBuiltinsAssembler(state_).CppAbsoluteMulAndCanonicalize(TNode<BigInt>{tmp12}, TNode<BigInt>{p_x}, TNode<BigInt>{p_y});
    ca_.Goto(&block16, tmp16);
  }

  TNode<Int32T> phi_bb16_9;
  TNode<Int32T> tmp17;
  TNode<BoolT> tmp18;
  if (block16.is_used()) {
    ca_.Bind(&block16, &phi_bb16_9);
    tmp17 = FromConstexpr_int32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull));
    tmp18 = CodeStubAssembler(state_).Word32Equal(TNode<Int32T>{phi_bb16_9}, TNode<Int32T>{tmp17});
  ...
  if (block19.is_used()) {
    ca_.Bind(&block19);
    tmp19 = Convert_BigInt_MutableBigInt_0(state_, TNode<BigInt>{tmp12});
  ...
  if (block3.is_used()) {
    ...
    ca_.Goto(&block20, phi_bb3_3);
  }

  TNode<BigInt> phi_bb20_3;
    ca_.Bind(&block20, &phi_bb20_3);
  return TNode<BigInt>{phi_bb20_3};
}
...
TNode<BigInt> BigIntDivideImpl_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<BigInt> p_x, TNode<BigInt> p_y, compiler::CodeAssemblerLabel* label_BigIntDivZero, compiler::CodeAssemblerLabel* label_TerminationRequested) {
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    tmp4 = BigIntCompareAbsolute_0(state_, TNode<BigInt>{p_x}, TNode<BigInt>{p_y});
    tmp5 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
  ...
  if (block26.is_used()) {
    ca_.Bind(&block26);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/builtins-bigint.tq:352:17");
...
TF_BUILTIN(BigIntDivide, CodeStubAssembler) {
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    CodeStubAssembler(state_).ThrowRangeError(TNode<Context>{parameter0}, CastIfEnumClass<MessageTemplate>(MessageTemplate::kBigIntDivZero));
  }
...
TNode<BigInt> BigIntModulusImpl_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<BigInt> p_x, TNode<BigInt> p_y, compiler::CodeAssemblerLabel* label_BigIntDivZero, compiler::CodeAssemblerLabel* label_TerminationRequested) {
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/builtins-bigint.tq:414:17");
    CodeStubAssembler(state_).Unreachable();
  }
...
TNode<BigInt> BigIntBitwiseAndImpl_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<BigInt> p_x, TNode<BigInt> p_y, compiler::CodeAssemblerLabel* label_BigIntTooBig) {
  ...
  if (block20.is_used()) {
    ca_.Bind(&block20);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/builtins-bigint.tq:475:19");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block42.is_used()) {
    ca_.Bind(&block42);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/builtins-bigint.tq:486:19");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block46.is_used()) {
    ca_.Bind(&block46);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/builtins-bigint.tq:491:19");
    CodeStubAssembler(state_).Unreachable();
  }
...
TNode<BigInt> BigIntBitwiseOrImpl_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<BigInt> p_x, TNode<BigInt> p_y) {
  ...
  if (block19.is_used()) {
    ca_.Bind(&block19);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/builtins-bigint.tq:542:19");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block29.is_used()) {
    ca_.Bind(&block29);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/builtins-bigint.tq:547:19");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block39.is_used()) {
    ca_.Bind(&block39);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/builtins-bigint.tq:552:19");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block43.is_used()) {
    ca_.Bind(&block43);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/builtins-bigint.tq:557:19");
    CodeStubAssembler(state_).Unreachable();
  }
...
TNode<BigInt> BigIntBitwiseXorImpl_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<BigInt> p_x, TNode<BigInt> p_y, compiler::CodeAssemblerLabel* label_BigIntTooBig) {
  ...
  if (block20.is_used()) {
    ca_.Bind(&block20);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/builtins-bigint.tq:601:19");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block34.is_used()) {
    ca_.Bind(&block34);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/builtins-bigint.tq:607:19");
    CodeStubAssembler(state_).Unreachable();
  }
...
TNode<BigInt> MutableBigIntLeftShiftByAbsolute_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<BigInt> p_x, TNode<BigInt> p_y, compiler::CodeAssemblerLabel* label_BigIntTooBig) {
  ...
  if (block8.is_used()) {
    ...
    tmp8 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    tmp9 = CodeStubAssembler(state_).LoadBigIntDigit(TNode<BigInt>{p_y}, TNode<IntPtrT>{tmp8});
    tmp10 = FromConstexpr_uintptr_constexpr_uintptr_0(state_, BigInt::kMaxBits);
...
TNode<BigInt> MutableBigIntRightShiftByAbsolute_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<BigInt> p_x, TNode<BigInt> p_y) {
  ...
  if (block7.is_used()) {
    ...
    tmp12 = FromConstexpr_uintptr_constexpr_uintptr_0(state_, BigInt::kMaxBits);
  ...
  if (block15.is_used()) {
    ca_.Bind(&block15);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/builtins-bigint.tq:735:17");
    CodeStubAssembler(state_).Unreachable();
  }
...
TNode<IntPtrT> BigIntCompare_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<BigInt> p_x, TNode<BigInt> p_y) {
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    tmp7 = BigIntCompareAbsolute_0(state_, TNode<BigInt>{p_x}, TNode<BigInt>{p_y});
    tmp8 = kPositiveSign_0(state_);
