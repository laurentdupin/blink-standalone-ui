...
// https://crsrc.org/c/v8/src/builtins/number.tq?l=7&c=1
...
// https://crsrc.org/c/v8/src/builtins/number.tq?l=56&c=1
TNode<Number> ThisNumberValue_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSAny> p_receiver, const char* p_method) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = CodeStubAssembler(state_).ToThisValue(TNode<Context>{p_context}, TNode<JSAny>{p_receiver}, CastIfEnumClass<PrimitiveType>(PrimitiveType::kNumber), p_method);
...
// https://crsrc.org/c/v8/src/builtins/number.tq?l=63&c=1
TNode<Uint8T> ToCharCode_0(compiler::CodeAssemblerState* state_, TNode<Uint32T> p_input) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Uint8T> block6(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FromConstexpr_uint32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x24ull));
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    {
      ...
      pos_stack.push_back({"src/builtins/number.tq", 64});
      CodeStubAssembler(state_).FailAssert("Torque assert 'input < 36' failed", pos_stack);
    }
  }
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    tmp2 = FromConstexpr_uint32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0xaull));
    tmp3 = CodeStubAssembler(state_).Uint32LessThan(TNode<Uint32T>{p_input}, TNode<Uint32T>{tmp2});
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    tmp4 = FromConstexpr_uint32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x30ull));
    tmp5 = CodeStubAssembler(state_).Uint32Add(TNode<Uint32T>{p_input}, TNode<Uint32T>{tmp4});
    tmp6 = ca_.UncheckedCast<Uint8T>(TNode<Uint32T>{tmp5});
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    tmp7 = FromConstexpr_uint32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0xaull));
    tmp8 = CodeStubAssembler(state_).Uint32Sub(TNode<Uint32T>{p_input}, TNode<Uint32T>{tmp7});
    tmp9 = FromConstexpr_uint32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x61ull));
    tmp10 = CodeStubAssembler(state_).Uint32Add(TNode<Uint32T>{tmp8}, TNode<Uint32T>{tmp9});
    tmp11 = ca_.UncheckedCast<Uint8T>(TNode<Uint32T>{tmp10});
    ca_.Goto(&block6, tmp11);
  }

  TNode<Uint8T> phi_bb6_1;
  if (block6.is_used()) {
    ...
    ca_.Bind(&block8);
  return TNode<Uint8T>{phi_bb6_1};
}

// https://crsrc.org/c/v8/src/builtins/number.tq?l=70&c=1
TNode<String> IntToDecimalStringImpl_0(compiler::CodeAssemblerState* state_, TNode<Int32T> p_x, TNode<RawPtrT> p_log10OffsetsTable, bool p_isPositive) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Uint32T, IntPtrT> block14(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block18(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<> block19(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Uint32T, IntPtrT> block15(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Uint32T, IntPtrT> block20(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Uint32T, IntPtrT> block21(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block0.is_used()) {
    ...
    tmp1 = CodeStubAssembler(state_).Int32GreaterThanOrEqual(TNode<Int32T>{p_x}, TNode<Int32T>{tmp0});
    tmp2 = FromConstexpr_bool_constexpr_bool_0(state_, p_isPositive);
    tmp3 = CodeStubAssembler(state_).Word32Equal(TNode<BoolT>{tmp2}, TNode<BoolT>{tmp1});
  ...
  if (block3.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/number.tq", 73});
      CodeStubAssembler(state_).FailAssert("Torque assert 'isPositive == (x >= 0)' failed", pos_stack);
    }
  }
  ...
  if (block2.is_used()) {
    ca_.Bind(&block2);
    tmp4 = FromConstexpr_bool_constexpr_bool_0(state_, p_isPositive);
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    tmp5 = CodeStubAssembler(state_).Unsigned(TNode<Int32T>{p_x});
  ...
  if (block5.is_used()) {
    ...
    tmp7 = CodeStubAssembler(state_).Int32Sub(TNode<Int32T>{tmp6}, TNode<Int32T>{p_x});
    tmp8 = CodeStubAssembler(state_).Unsigned(TNode<Int32T>{tmp7});
    ca_.Goto(&block6, tmp8);
  }

  TNode<Uint32T> phi_bb6_2;
  TNode<Int32T> tmp9;
  TNode<Int32T> tmp10;
  TNode<Int32T> tmp11;
  TNode<Int32T> tmp12;
  ...
  if (block6.is_used()) {
    ...
    tmp9 = CodeStubAssembler(state_).Signed(TNode<Uint32T>{phi_bb6_2});
    tmp10 = FromConstexpr_int32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull));
    tmp11 = CodeStubAssembler(state_).Word32Or(TNode<Int32T>{tmp9}, TNode<Int32T>{tmp10});
    tmp12 = CodeStubAssembler(state_).Word32Clz(TNode<Int32T>{tmp11});
    tmp13 = FromConstexpr_int32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1full));
    tmp14 = CodeStubAssembler(state_).Int32Sub(TNode<Int32T>{tmp13}, TNode<Int32T>{tmp12});
    tmp15 = Convert_intptr_int32_0(state_, TNode<Int32T>{tmp14});
    tmp16 = CodeStubAssembler(state_).LoadUint64Ptr(TNode<RawPtrT>{p_log10OffsetsTable}, TNode<IntPtrT>{tmp15});
    tmp17 = Convert_uint64_uint32_0(state_, TNode<Uint32T>{phi_bb6_2});
    tmp18 = CodeStubAssembler(state_).Uint64Add(TNode<Uint64T>{tmp17}, TNode<Uint64T>{tmp16});
    tmp19 = FromConstexpr_uint64_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x20ull));
    tmp20 = CodeStubAssembler(state_).Word64Shr(TNode<Uint64T>{tmp18}, TNode<Uint64T>{tmp19});
    tmp21 = Convert_uint32_uint64_0(state_, TNode<Uint64T>{tmp20});
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    tmp22 = FromConstexpr_uint32_constexpr_int31_0(state_, 1);
    tmp23 = CodeStubAssembler(state_).Uint32Add(TNode<Uint32T>{tmp21}, TNode<Uint32T>{tmp22});
  ...
  TNode<SeqOneByteString> tmp24;
  if (block10.is_used()) {
    ca_.Bind(&block10, &phi_bb10_6);
    tmp24 = AllocateNonEmptySeqOneByteString_0(state_, TNode<Uint32T>{phi_bb10_6});
    if ((p_isPositive)) {
      ca_.Goto(&block11);
    } else {
      ca_.Goto(&block12);
  ...
  if (block11.is_used()) {
    ...
    tmp26 = MakeArrayIndexHash_0(state_, TNode<Uint32T>{phi_bb6_2}, TNode<Uint32T>{phi_bb10_6});
    CodeStubAssembler(state_).StoreReference<Uint32T>(CodeStubAssembler::Reference{tmp24, tmp25}, tmp26);
    ca_.Goto(&block13);
  }
  ...
  if (block13.is_used()) {
    ca_.Bind(&block13);
    tmp27 = CodeStubAssembler(state_).Signed(TNode<Uint32T>{phi_bb10_6});
    tmp28 = Convert_intptr_int32_0(state_, TNode<Int32T>{tmp27});
    tmp29 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull));
    tmp30 = CodeStubAssembler(state_).IntPtrSub(TNode<IntPtrT>{tmp28}, TNode<IntPtrT>{tmp29});
    std::tie(tmp31, tmp32, tmp33) = FieldSliceSeqOneByteStringChars_0(state_, TNode<SeqOneByteString>{tmp24}).Flatten();
    ca_.Goto(&block16, phi_bb6_2, tmp30);
  }
  ...
  if (block16.is_used()) {
    ...
    ca_.Branch(tmp34, &block14, std::vector<compiler::Node*>{phi_bb16_2, phi_bb16_9}, &block15, std::vector<compiler::Node*>{phi_bb16_2, phi_bb16_9});
  }
  ...
  TNode<BoolT> tmp56;
  if (block14.is_used()) {
    ca_.Bind(&block14, &phi_bb14_2, &phi_bb14_9);
    tmp35 = FromConstexpr_uint64_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0xcccccccdull));
    tmp36 = Convert_uint64_uint32_0(state_, TNode<Uint32T>{phi_bb14_2});
    tmp37 = CodeStubAssembler(state_).Uint64Mul(TNode<Uint64T>{tmp36}, TNode<Uint64T>{tmp35});
    tmp38 = FromConstexpr_uint64_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x23ull));
    tmp39 = CodeStubAssembler(state_).Word64Shr(TNode<Uint64T>{tmp37}, TNode<Uint64T>{tmp38});
    tmp40 = Convert_uint32_uint64_0(state_, TNode<Uint64T>{tmp39});
    tmp41 = FromConstexpr_uint32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0xaull));
    tmp42 = CodeStubAssembler(state_).Uint32Mul(TNode<Uint32T>{tmp40}, TNode<Uint32T>{tmp41});
    tmp43 = CodeStubAssembler(state_).Uint32Sub(TNode<Uint32T>{phi_bb14_2}, TNode<Uint32T>{tmp42});
    tmp44 = FromConstexpr_uint32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x30ull));
    tmp45 = CodeStubAssembler(state_).Word32Or(TNode<Uint32T>{tmp43}, TNode<Uint32T>{tmp44});
    tmp46 = ca_.UncheckedCast<Uint8T>(TNode<Uint32T>{tmp45});
    tmp47 = TimesSizeOf_char8_0(state_, TNode<IntPtrT>{phi_bb14_9});
    tmp48 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp32}, TNode<IntPtrT>{tmp47});
    std::tie(tmp49, tmp50) = NewReference_char8_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp31}, TNode<IntPtrT>{tmp48}).Flatten();
    std::tie(tmp51, tmp52) = UnsafeConstCast_char8_0(state_, TorqueStructReference_char8_0{TNode<Union<HeapObject, TaggedIndex>>{tmp49}, TNode<IntPtrT>{tmp50}, TorqueStructUnsafe_0{}}).Flatten();
    CodeStubAssembler(state_).StoreReference<Uint8T>(CodeStubAssembler::Reference{tmp51, tmp52}, tmp46);
    tmp53 = FromConstexpr_intptr_constexpr_int31_0(state_, 1);
    tmp54 = CodeStubAssembler(state_).IntPtrSub(TNode<IntPtrT>{phi_bb14_9}, TNode<IntPtrT>{tmp53});
    tmp55 = FromConstexpr_uint32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    tmp56 = CodeStubAssembler(state_).Word32Equal(TNode<Uint32T>{tmp40}, TNode<Uint32T>{tmp55});
    ca_.Branch(tmp56, &block18, std::vector<compiler::Node*>{}, &block19, std::vector<compiler::Node*>{});
  }

  if (block18.is_used()) {
    ca_.Bind(&block18);
    ca_.Goto(&block15, tmp40, tmp54);
  }

  if (block19.is_used()) {
    ca_.Bind(&block19);
    ca_.Goto(&block16, tmp40, tmp54);
  }

  TNode<Uint32T> phi_bb15_2;
  TNode<IntPtrT> phi_bb15_9;
  if (block15.is_used()) {
    ca_.Bind(&block15, &phi_bb15_2, &phi_bb15_9);
    if (((CodeStubAssembler(state_).ConstexprBoolNot(p_isPositive)))) {
      ca_.Goto(&block20, phi_bb15_2, phi_bb15_9);
    } else {
      ca_.Goto(&block21, phi_bb15_2, phi_bb15_9);
    }
  }

  TNode<Uint32T> phi_bb20_2;
  ...
  TNode<Uint8T> tmp64;
  if (block20.is_used()) {
    ca_.Bind(&block20, &phi_bb20_2, &phi_bb20_9);
    tmp57 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    tmp58 = TimesSizeOf_char8_0(state_, TNode<IntPtrT>{tmp57});
    tmp59 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp32}, TNode<IntPtrT>{tmp58});
    std::tie(tmp60, tmp61) = NewReference_char8_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp31}, TNode<IntPtrT>{tmp59}).Flatten();
    std::tie(tmp62, tmp63) = UnsafeConstCast_char8_0(state_, TorqueStructReference_char8_0{TNode<Union<HeapObject, TaggedIndex>>{tmp60}, TNode<IntPtrT>{tmp61}, TorqueStructUnsafe_0{}}).Flatten();
    tmp64 = FromConstexpr_char8_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x2dull));
    CodeStubAssembler(state_).StoreReference<Uint8T>(CodeStubAssembler::Reference{tmp62, tmp63}, tmp64);
    ca_.Goto(&block22, phi_bb20_2, phi_bb20_9);
  }

  TNode<Uint32T> phi_bb21_2;
  TNode<IntPtrT> phi_bb21_9;
  if (block21.is_used()) {
    ca_.Bind(&block21, &phi_bb21_2, &phi_bb21_9);
    ca_.Goto(&block22, phi_bb21_2, phi_bb21_9);
  }
...
// https://crsrc.org/c/v8/src/builtins/number.tq?l=126&c=1
TNode<String> IntToString_0(compiler::CodeAssemblerState* state_, TNode<Int32T> p_x, TNode<Uint32T> p_radix) {
  ...
  compiler::CodeAssemblerParameterizedLabel<Uint32T, Int32T> block22(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Uint32T, Int32T> block20(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Uint32T, Int32T> block21(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Uint32T, Int32T> block24(&ca_, compiler::CodeAssemblerLabel::kDeferred);
  compiler::CodeAssemblerParameterizedLabel<Uint32T, Int32T> block23(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Uint32T, Uint32T, Int32T, IntPtrT> block27(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Uint32T, Uint32T, Int32T, IntPtrT> block25(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Uint32T, Int32T, IntPtrT, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block32(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Uint32T, Int32T, IntPtrT, IntPtrT, IntPtrT, IntPtrT, IntPtrT> block33(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Uint32T, Uint32T, Int32T, IntPtrT> block26(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Uint32T, Uint32T, Int32T, IntPtrT> block36(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Uint32T, Uint32T, Int32T, IntPtrT> block40(&ca_, compiler::CodeAssemblerLabel::kDeferred);
  compiler::CodeAssemblerParameterizedLabel<Uint32T, Uint32T, Int32T, IntPtrT> block39(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Uint32T, Uint32T, Int32T, IntPtrT> block46(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Uint32T, Uint32T, Int32T, IntPtrT> block47(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Uint32T, Uint32T, Int32T, IntPtrT> block37(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Uint32T, Uint32T, Int32T, IntPtrT> block51(&ca_, compiler::CodeAssemblerLabel::kDeferred);
  compiler::CodeAssemblerParameterizedLabel<Uint32T, Uint32T, Int32T, IntPtrT> block50(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Uint32T, Uint32T, Int32T, IntPtrT> block52(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<Uint32T, Uint32T, Int32T, IntPtrT> block58(&ca_, compiler::CodeAssemblerLabel::kDeferred);
  compiler::CodeAssemblerParameterizedLabel<Uint32T, Uint32T, Int32T, IntPtrT> block57(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Uint32T, Uint32T, Int32T, IntPtrT> block56(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Uint32T, Uint32T, Int32T, IntPtrT> block53(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  compiler::CodeAssemblerParameterizedLabel<Uint32T, Uint32T, Int32T, IntPtrT> block38(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<String> block1(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block2.is_used()) {
    ...
    tmp1 = CodeStubAssembler(state_).Word32NotEqual(TNode<Uint32T>{p_radix}, TNode<Uint32T>{tmp0});
  ...
  if (block6.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/number.tq", 128});
      CodeStubAssembler(state_).FailAssert("Torque assert 'radix != 10' failed", pos_stack);
    }
  }
  ...
  if (block4.is_used()) {
    ...
    tmp3 = CodeStubAssembler(state_).Int32LessThan(TNode<Int32T>{p_x}, TNode<Int32T>{tmp2});
  ...
  if (block7.is_used()) {
    ca_.Bind(&block7);
    tmp5 = CodeStubAssembler(state_).Unsigned(TNode<Int32T>{p_x});
    tmp6 = CodeStubAssembler(state_).Uint32LessThan(TNode<Uint32T>{tmp5}, TNode<Uint32T>{p_radix});
  ...
  if (block10.is_used()) {
    ...
    tmp8 = CodeStubAssembler(state_).Word32Equal(TNode<Uint32T>{tmp5}, TNode<Uint32T>{tmp7});
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    tmp9 = CodeStubAssembler(state_).ZeroStringConstant();
  ...
  if (block13.is_used()) {
    ca_.Bind(&block13);
    tmp10 = ToCharCode_0(state_, TNode<Uint32T>{tmp5});
    tmp11 = CodeStubAssembler(state_).StringFromSingleCharCode(TNode<Uint8T>{tmp10});
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    ca_.Branch(tmp3, &block14, std::vector<compiler::Node*>{}, &block15, std::vector<compiler::Node*>{});
  }
  ...
  if (block15.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/number.tq", 142});
  ...
  if (block14.is_used()) {
    ...
    tmp13 = CodeStubAssembler(state_).Int32Sub(TNode<Int32T>{tmp12}, TNode<Int32T>{p_x});
    tmp14 = CodeStubAssembler(state_).Unsigned(TNode<Int32T>{tmp13});
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    tmp15 = Convert_int32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull));
  ...
  if (block17.is_used()) {
    ca_.Bind(&block17);
    tmp16 = Convert_int32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
  ...
  if (block18.is_used()) {
    ...
    ca_.Goto(&block22, phi_bb9_3, phi_bb18_5);
  }
  ...
  if (block22.is_used()) {
    ...
    tmp17 = FromConstexpr_uint32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    tmp18 = CodeStubAssembler(state_).Uint32GreaterThan(TNode<Uint32T>{phi_bb22_4}, TNode<Uint32T>{tmp17});
    ca_.Branch(tmp18, &block20, std::vector<compiler::Node*>{phi_bb22_4, phi_bb22_5}, &block21, std::vector<compiler::Node*>{phi_bb22_4, phi_bb22_5});
  }
  ...
  if (block20.is_used()) {
    ...
    tmp19 = CodeStubAssembler(state_).Uint32Div(TNode<Uint32T>{phi_bb20_4}, TNode<Uint32T>{p_radix});
    tmp20 = FromConstexpr_int32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull));
    tmp21 = CodeStubAssembler(state_).Int32Add(TNode<Int32T>{phi_bb20_5}, TNode<Int32T>{tmp20});
    ca_.Goto(&block22, tmp19, tmp21);
  }
  ...
  if (block21.is_used()) {
    ...
    tmp22 = FromConstexpr_int32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    tmp23 = CodeStubAssembler(state_).Int32GreaterThan(TNode<Int32T>{phi_bb21_5}, TNode<Int32T>{tmp22});
    ca_.Branch(tmp23, &block23, std::vector<compiler::Node*>{phi_bb21_4, phi_bb21_5}, &block24, std::vector<compiler::Node*>{phi_bb21_4, phi_bb21_5});
  }
  ...
  if (block24.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/number.tq", 153});
  ...
  if (block23.is_used()) {
    ...
    tmp24 = CodeStubAssembler(state_).Unsigned(TNode<Int32T>{phi_bb23_5});
    tmp25 = AllocateNonEmptySeqOneByteString_0(state_, TNode<Uint32T>{tmp24});
    tmp26 = Convert_intptr_int32_0(state_, TNode<Int32T>{phi_bb23_5});
    tmp27 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull));
    tmp28 = CodeStubAssembler(state_).IntPtrSub(TNode<IntPtrT>{tmp26}, TNode<IntPtrT>{tmp27});
    ca_.Goto(&block27, phi_bb9_3, phi_bb23_4, phi_bb23_5, tmp28);
  }

  TNode<Uint32T> phi_bb27_3;
  ...
  if (block27.is_used()) {
    ...
    tmp29 = FromConstexpr_uint32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    tmp30 = CodeStubAssembler(state_).Uint32GreaterThan(TNode<Uint32T>{phi_bb27_3}, TNode<Uint32T>{tmp29});
    ca_.Branch(tmp30, &block25, std::vector<compiler::Node*>{phi_bb27_3, phi_bb27_4, phi_bb27_5, phi_bb27_7}, &block26, std::vector<compiler::Node*>{phi_bb27_3, phi_bb27_4, phi_bb27_5, phi_bb27_7});
  }

  TNode<Uint32T> phi_bb25_3;
  ...
  if (block25.is_used()) {
    ...
    tmp31 = CodeStubAssembler(state_).Uint32Mod(TNode<Uint32T>{phi_bb25_3}, TNode<Uint32T>{p_radix});
    tmp32 = CodeStubAssembler(state_).Uint32Div(TNode<Uint32T>{phi_bb25_3}, TNode<Uint32T>{p_radix});
    std::tie(tmp33, tmp34, tmp35) = FieldSliceSeqOneByteStringChars_0(state_, TNode<SeqOneByteString>{tmp25}).Flatten();
    tmp36 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{phi_bb25_7});
    ...
    ca_.Branch(tmp38, &block32, std::vector<compiler::Node*>{phi_bb25_4, phi_bb25_5, phi_bb25_7, phi_bb25_7, phi_bb25_7, phi_bb25_7, phi_bb25_7}, &block33, std::vector<compiler::Node*>{phi_bb25_4, phi_bb25_5, phi_bb25_7, phi_bb25_7, phi_bb25_7, phi_bb25_7, phi_bb25_7});
  }
  ...
  if (block32.is_used()) {
    ...
    tmp39 = TimesSizeOf_char8_0(state_, TNode<IntPtrT>{phi_bb32_19});
    tmp40 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp34}, TNode<IntPtrT>{tmp39});
    std::tie(tmp41, tmp42) = NewReference_char8_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp33}, TNode<IntPtrT>{tmp40}).Flatten();
    std::tie(tmp43, tmp44) = UnsafeConstCast_char8_0(state_, TorqueStructReference_char8_0{TNode<Union<HeapObject, TaggedIndex>>{tmp41}, TNode<IntPtrT>{tmp42}, TorqueStructUnsafe_0{}}).Flatten();
    tmp45 = ToCharCode_0(state_, TNode<Uint32T>{tmp31});
    CodeStubAssembler(state_).StoreReference<Uint8T>(CodeStubAssembler::Reference{tmp43, tmp44}, tmp45);
    tmp46 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x1ull));
    tmp47 = CodeStubAssembler(state_).IntPtrSub(TNode<IntPtrT>{phi_bb32_7}, TNode<IntPtrT>{tmp46});
    ca_.Goto(&block27, tmp32, phi_bb32_4, phi_bb32_5, tmp47);
  }
  ...
  if (block26.is_used()) {
    ...
    ca_.Branch(tmp3, &block36, std::vector<compiler::Node*>{phi_bb26_3, phi_bb26_4, phi_bb26_5, phi_bb26_7}, &block37, std::vector<compiler::Node*>{phi_bb26_3, phi_bb26_4, phi_bb26_5, phi_bb26_7});
  }

  TNode<Uint32T> phi_bb36_3;
  ...
  if (block36.is_used()) {
    ...
    tmp49 = CodeStubAssembler(state_).WordEqual(TNode<IntPtrT>{phi_bb36_7}, TNode<IntPtrT>{tmp48});
    ca_.Branch(tmp49, &block39, std::vector<compiler::Node*>{phi_bb36_3, phi_bb36_4, phi_bb36_5, phi_bb36_7}, &block40, std::vector<compiler::Node*>{phi_bb36_3, phi_bb36_4, phi_bb36_5, phi_bb36_7});
  }

  TNode<Uint32T> phi_bb40_3;
  ...
  if (block39.is_used()) {
    ...
    std::tie(tmp50, tmp51, tmp52) = FieldSliceSeqOneByteStringChars_0(state_, TNode<SeqOneByteString>{tmp25}).Flatten();
    tmp53 = FromConstexpr_uintptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x0ull));
    tmp54 = Convert_intptr_uintptr_0(state_, TNode<UintPtrT>{tmp53});
    tmp55 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp54});
    tmp56 = Convert_uintptr_intptr_0(state_, TNode<IntPtrT>{tmp52});
    tmp57 = CodeStubAssembler(state_).UintPtrLessThan(TNode<UintPtrT>{tmp55}, TNode<UintPtrT>{tmp56});
    ca_.Branch(tmp57, &block46, std::vector<compiler::Node*>{phi_bb39_3, phi_bb39_4, phi_bb39_5, phi_bb39_7}, &block47, std::vector<compiler::Node*>{phi_bb39_3, phi_bb39_4, phi_bb39_5, phi_bb39_7});
  }

  TNode<Uint32T> phi_bb46_3;
  ...
  if (block46.is_used()) {
    ...
    tmp58 = TimesSizeOf_char8_0(state_, TNode<IntPtrT>{tmp54});
    tmp59 = CodeStubAssembler(state_).IntPtrAdd(TNode<IntPtrT>{tmp51}, TNode<IntPtrT>{tmp58});
    std::tie(tmp60, tmp61) = NewReference_char8_0(state_, TNode<Union<HeapObject, TaggedIndex>>{tmp50}, TNode<IntPtrT>{tmp59}).Flatten();
    std::tie(tmp62, tmp63) = UnsafeConstCast_char8_0(state_, TorqueStructReference_char8_0{TNode<Union<HeapObject, TaggedIndex>>{tmp60}, TNode<IntPtrT>{tmp61}, TorqueStructUnsafe_0{}}).Flatten();
    tmp64 = FromConstexpr_char8_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0x2dull));
    CodeStubAssembler(state_).StoreReference<Uint8T>(CodeStubAssembler::Reference{tmp62, tmp63}, tmp64);
    ca_.Goto(&block38, phi_bb46_3, phi_bb46_4, phi_bb46_5, phi_bb46_7);
  }

  TNode<Uint32T> phi_bb47_3;
  ...
  if (block37.is_used()) {
    ...
    tmp65 = FromConstexpr_intptr_constexpr_IntegerLiteral_0(state_, IntegerLiteral(true, 0x1ull));
    tmp66 = CodeStubAssembler(state_).WordEqual(TNode<IntPtrT>{phi_bb37_7}, TNode<IntPtrT>{tmp65});
    ca_.Branch(tmp66, &block50, std::vector<compiler::Node*>{phi_bb37_3, phi_bb37_4, phi_bb37_5, phi_bb37_7}, &block51, std::vector<compiler::Node*>{phi_bb37_3, phi_bb37_4, phi_bb37_5, phi_bb37_7});
  }

  TNode<Uint32T> phi_bb51_3;
  ...
  if (block50.is_used()) {
    ...
    if (((CodeStubAssembler(state_).ConstexprBoolNot((CodeStubAssembler(state_).Is64()))))) {
      ca_.Goto(&block52, phi_bb50_3, phi_bb50_4, phi_bb50_5, phi_bb50_7);
    } else {
      ca_.Goto(&block53, phi_bb50_3, phi_bb50_4, phi_bb50_5, phi_bb50_7);
    }
  }

  TNode<Uint32T> phi_bb52_3;
  ...
  if (block52.is_used()) {
    ...
    tmp67 = FromConstexpr_uint32_constexpr_IntegerLiteral_0(state_, IntegerLiteral(false, 0xaull));
    tmp68 = CodeStubAssembler(state_).Word32Equal(TNode<Uint32T>{p_radix}, TNode<Uint32T>{tmp67});
    ca_.Branch(tmp68, &block55, std::vector<compiler::Node*>{phi_bb52_3, phi_bb52_4, phi_bb52_5, phi_bb52_7}, &block56, std::vector<compiler::Node*>{phi_bb52_3, phi_bb52_4, phi_bb52_5, phi_bb52_7});
  }
  ...
  if (block55.is_used()) {
    ...
    tmp70 = CodeStubAssembler(state_).LoadReference<Uint32T>(CodeStubAssembler::Reference{tmp25, tmp69});
    tmp71 = kNameEmptyHashField_0(state_);
    tmp72 = CodeStubAssembler(state_).Word32Equal(TNode<Uint32T>{tmp70}, TNode<Uint32T>{tmp71});
    ca_.Branch(tmp72, &block57, std::vector<compiler::Node*>{phi_bb55_3, phi_bb55_4, phi_bb55_5, phi_bb55_7}, &block58, std::vector<compiler::Node*>{phi_bb55_3, phi_bb55_4, phi_bb55_5, phi_bb55_7});
  }

  TNode<Uint32T> phi_bb58_3;
  ...
  TNode<Uint32T> tmp76;
  if (block57.is_used()) {
    ca_.Bind(&block57, &phi_bb57_3, &phi_bb57_4, &phi_bb57_5, &phi_bb57_7);
    tmp73 = FromConstexpr_intptr_constexpr_int31_0(state_, 4);
    tmp74 = CodeStubAssembler(state_).Unsigned(TNode<Int32T>{p_x});
    tmp75 = CodeStubAssembler(state_).Unsigned(TNode<Int32T>{phi_bb57_5});
    tmp76 = MakeArrayIndexHash_0(state_, TNode<Uint32T>{tmp74}, TNode<Uint32T>{tmp75});
    CodeStubAssembler(state_).StoreReference<Uint32T>(CodeStubAssembler::Reference{tmp25, tmp73}, tmp76);
    ca_.Goto(&block56, phi_bb57_3, phi_bb57_4, phi_bb57_5, phi_bb57_7);
  }

  TNode<Uint32T> phi_bb56_3;
  TNode<Uint32T> phi_bb56_4;
  TNode<Int32T> phi_bb56_5;
  TNode<IntPtrT> phi_bb56_7;
  if (block56.is_used()) {
    ca_.Bind(&block56, &phi_bb56_3, &phi_bb56_4, &phi_bb56_5, &phi_bb56_7);
    ca_.Goto(&block54, phi_bb56_3, phi_bb56_4, phi_bb56_5, phi_bb56_7);
  }

  TNode<Uint32T> phi_bb53_3;
  ...
  if (block54.is_used()) {
    ...
    ca_.Goto(&block38, phi_bb54_3, phi_bb54_4, phi_bb54_5, phi_bb54_7);
  }

  TNode<Uint32T> phi_bb38_3;
...
TF_BUILTIN(NumberPrototypeToString, CodeStubAssembler) {
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5);
    CodeStubAssembler(state_).ThrowRangeError(TNode<Context>{parameter0}, CastIfEnumClass<MessageTemplate>(MessageTemplate::kToRadixFormatRange));
  }
...
TF_BUILTIN(NumberPrototypeValueOf, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = CodeStubAssembler(state_).ToThisValue(TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, CastIfEnumClass<PrimitiveType>(PrimitiveType::kNumber), "Number.prototype.valueOf");
...
TF_BUILTIN(NumberParseFloat, CodeStubAssembler) {
  ...
  if (block19.is_used()) {
    ca_.Bind(&block19);
    tmp18 = DecodeArrayIndexFromHashField_0(state_, TNode<Uint32T>{tmp12});
...
TF_BUILTIN(ParseInt, CodeStubAssembler) {
  ...
  if (block9.is_used()) {
    ...
    tmp3 = CodeStubAssembler(state_).TaggedEqual(TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{parameter2}, TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp2});
    tmp4 = CodeStubAssembler(state_).Word32BinaryNot(TNode<BoolT>{tmp3});
  ...
  if (block12.is_used()) {
    ...
    tmp7 = CodeStubAssembler(state_).TaggedEqual(TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{parameter2}, TNode<Union<HeapObject, Smi, Weak<HeapObject>>>{tmp6});
  ...
  if (block34.is_used()) {
    ca_.Bind(&block34);
    tmp35 = DecodeArrayIndexFromHashField_0(state_, TNode<Uint32T>{tmp28});
...
// https://crsrc.org/c/v8/src/builtins/number.tq?l=386&c=1
...
TF_BUILTIN(Add, CodeStubAssembler) {
  ...
  if (block10.is_used()) {
    ...
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/number.tq:496:3");
    CodeStubAssembler(state_).Unreachable();
  }
...
// https://crsrc.org/c/v8/src/builtins/number.tq?l=500&c=1
void UnaryOp1_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSAny> p_value, compiler::CodeAssemblerLabel* label_Number, compiler::TypedCodeAssemblerVariable<Number>* label_Number_parameter_0, compiler::CodeAssemblerLabel* label_BigInt, compiler::TypedCodeAssemblerVariable<BigInt>* label_BigInt_parameter_0) {
  ...
  if (block4.is_used()) {
    ...
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/number.tq:516:3");
    CodeStubAssembler(state_).Unreachable();
  }
}

// https://crsrc.org/c/v8/src/builtins/number.tq?l=520&c=1
void UnaryOp2_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSAny> p_value, compiler::CodeAssemblerLabel* label_Smi, compiler::TypedCodeAssemblerVariable<Smi>* label_Smi_parameter_0, compiler::CodeAssemblerLabel* label_HeapNumber, compiler::TypedCodeAssemblerVariable<HeapNumber>* label_HeapNumber_parameter_0, compiler::CodeAssemblerLabel* label_BigInt, compiler::TypedCodeAssemblerVariable<BigInt>* label_BigInt_parameter_0) {
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5, &phi_bb5_2);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/number.tq:539:3");
    CodeStubAssembler(state_).Unreachable();
  }
}

// https://crsrc.org/c/v8/src/builtins/number.tq?l=543&c=1
void BinaryOp1_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSAny> p_leftVal, TNode<JSAny> p_rightVal, compiler::CodeAssemblerLabel* label_Number, compiler::TypedCodeAssemblerVariable<Number>* label_Number_parameter_0, compiler::TypedCodeAssemblerVariable<Number>* label_Number_parameter_1, compiler::CodeAssemblerLabel* label_AtLeastOneBigInt, compiler::TypedCodeAssemblerVariable<Numeric>* label_AtLeastOneBigInt_parameter_0, compiler::TypedCodeAssemblerVariable<Numeric>* label_AtLeastOneBigInt_parameter_1) {
  ...
  if (block4.is_used()) {
    ...
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/number.tq:582:3");
    CodeStubAssembler(state_).Unreachable();
  }
...
// https://crsrc.org/c/v8/src/builtins/number.tq?l=586&c=1
void BinaryOp2_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSAny> p_leftVal, TNode<JSAny> p_rightVal, compiler::CodeAssemblerLabel* label_Smis, compiler::TypedCodeAssemblerVariable<Smi>* label_Smis_parameter_0, compiler::TypedCodeAssemblerVariable<Smi>* label_Smis_parameter_1, compiler::CodeAssemblerLabel* label_Float64s, compiler::TypedCodeAssemblerVariable<Float64T>* label_Float64s_parameter_0, compiler::TypedCodeAssemblerVariable<Float64T>* label_Float64s_parameter_1, compiler::CodeAssemblerLabel* label_AtLeastOneBigInt, compiler::TypedCodeAssemblerVariable<Numeric>* label_AtLeastOneBigInt_parameter_0, compiler::TypedCodeAssemblerVariable<Numeric>* label_AtLeastOneBigInt_parameter_1) {
  ...
  if (block5.is_used()) {
    ca_.Bind(&block5, &phi_bb5_3, &phi_bb5_4);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/number.tq:644:3");
    CodeStubAssembler(state_).Unreachable();
  }
...
// https://crsrc.org/c/v8/src/builtins/number.tq?l=681&c=1
...
TF_BUILTIN(Exponentiate, CodeStubAssembler) {
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    CodeStubAssembler(state_).TailCallRuntime(Runtime::kBigIntExponentiate, parameter0, tmp4.value(), tmp5.value());
  }
}
...
TF_BUILTIN(BitwiseNot, CodeStubAssembler) {
  ...
  if (block5.is_used()) {
    ...
    tmp6 = CodeStubAssembler(state_).BitwiseOp(TNode<Int32T>{tmp4}, TNode<Int32T>{tmp5}, CastIfEnumClass<Operation>(Operation::kBitwiseXor));
    CodeStubAssembler(state_).Return(tmp6);
  }
...
TF_BUILTIN(ShiftLeft, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = BinaryOpAssembler(state_).Generate_BitwiseBinaryOp(CastIfEnumClass<Operation>(Operation::kShiftLeft), TNode<JSAny>{parameter1}, TNode<JSAny>{parameter2}, TNode<Context>{parameter0});
    CodeStubAssembler(state_).Return(tmp0);
  }
}
...
TF_BUILTIN(ShiftRight, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = BinaryOpAssembler(state_).Generate_BitwiseBinaryOp(CastIfEnumClass<Operation>(Operation::kShiftRight), TNode<JSAny>{parameter1}, TNode<JSAny>{parameter2}, TNode<Context>{parameter0});
    CodeStubAssembler(state_).Return(tmp0);
  }
}
...
TF_BUILTIN(ShiftRightLogical, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = BinaryOpAssembler(state_).Generate_BitwiseBinaryOp(CastIfEnumClass<Operation>(Operation::kShiftRightLogical), TNode<JSAny>{parameter1}, TNode<JSAny>{parameter2}, TNode<Context>{parameter0});
    CodeStubAssembler(state_).Return(tmp0);
  }
}
...
TF_BUILTIN(BitwiseAnd, CodeStubAssembler) {
  ...
  if (block5.is_used()) {
    ...
    tmp8 = CodeStubAssembler(state_).BitwiseOp(TNode<Int32T>{tmp6}, TNode<Int32T>{tmp7}, CastIfEnumClass<Operation>(Operation::kBitwiseAnd));
    CodeStubAssembler(state_).Return(tmp8);
  }
...
TF_BUILTIN(BitwiseOr, CodeStubAssembler) {
  ...
  if (block5.is_used()) {
    ...
    tmp6 = CodeStubAssembler(state_).TruncateNumberToWord32(TNode<Number>{tmp1.value()});
    tmp7 = CodeStubAssembler(state_).TruncateNumberToWord32(TNode<Number>{tmp2.value()});
    tmp8 = CodeStubAssembler(state_).BitwiseOp(TNode<Int32T>{tmp6}, TNode<Int32T>{tmp7}, CastIfEnumClass<Operation>(Operation::kBitwiseOr));
    CodeStubAssembler(state_).Return(tmp8);
  }
...
TF_BUILTIN(BitwiseXor, CodeStubAssembler) {
  ...
  if (block5.is_used()) {
    ...
    tmp6 = CodeStubAssembler(state_).TruncateNumberToWord32(TNode<Number>{tmp1.value()});
    tmp7 = CodeStubAssembler(state_).TruncateNumberToWord32(TNode<Number>{tmp2.value()});
    tmp8 = CodeStubAssembler(state_).BitwiseOp(TNode<Int32T>{tmp6}, TNode<Int32T>{tmp7}, CastIfEnumClass<Operation>(Operation::kBitwiseXor));
    CodeStubAssembler(state_).Return(tmp8);
  }
...
TF_BUILTIN(LessThan, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = CodeStubAssembler(state_).RelationalComparison(CastIfEnumClass<Operation>(Operation::kLessThan), TNode<JSAny>{parameter1}, TNode<JSAny>{parameter2}, TNode<Context>{parameter0});
    CodeStubAssembler(state_).Return(tmp0);
  }
}
...
TF_BUILTIN(LessThanOrEqual, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = CodeStubAssembler(state_).RelationalComparison(CastIfEnumClass<Operation>(Operation::kLessThanOrEqual), TNode<JSAny>{parameter1}, TNode<JSAny>{parameter2}, TNode<Context>{parameter0});
    CodeStubAssembler(state_).Return(tmp0);
  }
}
...
TF_BUILTIN(GreaterThan, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = CodeStubAssembler(state_).RelationalComparison(CastIfEnumClass<Operation>(Operation::kGreaterThan), TNode<JSAny>{parameter1}, TNode<JSAny>{parameter2}, TNode<Context>{parameter0});
    CodeStubAssembler(state_).Return(tmp0);
  }
}
...
TF_BUILTIN(GreaterThanOrEqual, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = CodeStubAssembler(state_).RelationalComparison(CastIfEnumClass<Operation>(Operation::kGreaterThanOrEqual), TNode<JSAny>{parameter1}, TNode<JSAny>{parameter2}, TNode<Context>{parameter0});
    CodeStubAssembler(state_).Return(tmp0);
  }
}
...
// https://crsrc.org/c/v8/src/builtins/number.tq?l=94&c=6
...
// https://crsrc.org/c/v8/src/builtins/number.tq?l=148&c=36
...
// https://crsrc.org/c/v8/src/builtins/number.tq?l=751&c=21
