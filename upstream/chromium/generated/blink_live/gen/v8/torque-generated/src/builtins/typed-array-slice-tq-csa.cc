...
// https://crsrc.org/c/v8/src/builtins/typed-array-slice.tq?l=8&c=1
...
// https://crsrc.org/c/v8/src/builtins/typed-array-slice.tq?l=13&c=1
void FastCopy_0(compiler::CodeAssemblerState* state_, TNode<JSTypedArray> p_src, TNode<JSTypedArray> p_dest, TNode<UintPtrT> p_k, TNode<UintPtrT> p_count, compiler::CodeAssemblerLabel* label_IfSlow) {
  ...
  if (block17.is_used()) {
    ca_.Bind(&block17);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/typed-array-slice.tq:38:17");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block18.is_used()) {
    ca_.Bind(&block18);
    tmp17 = CodeStubAssembler(state_).WordShl(TNode<UintPtrT>{p_k}, TNode<UintPtrT>{tmp2});
    tmp18 = CodeStubAssembler(state_).LoadJSTypedArrayDataPtr(TNode<JSTypedArray>{p_src});
    tmp19 = Convert_intptr_uintptr_0(state_, TNode<UintPtrT>{tmp17});
    tmp20 = CodeStubAssembler(state_).RawPtrAdd(TNode<RawPtrT>{tmp18}, TNode<IntPtrT>{tmp19});
    compiler::CodeAssemblerLabel label22(&ca_);
    tmp21 = CodeStubAssembler(state_).LoadJSTypedArrayLengthAndValidate(TNode<JSTypedArray>{p_src}, CastIfEnumClass<TypedArrayAccessMode>(TypedArrayAccessMode::kRead), &label22);
    ca_.Goto(&block21);
    if (label22.is_used()) {
      ca_.Bind(&label22);
      ca_.Goto(&block22);
  ...
  if (block22.is_used()) {
    ca_.Bind(&block22);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/typed-array-slice.tq:44:19");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block21.is_used()) {
    ca_.Bind(&block21);
    std::tie(tmp23, tmp24) = TypedArrayBuiltinsAssembler(state_).GetTypedArrayElementsInfo(TNode<JSTypedArray>{p_src}).Flatten();
    tmp25 = CodeStubAssembler(state_).ArrayBufferMaxByteLength();
    tmp26 = CodeStubAssembler(state_).WordShr(TNode<UintPtrT>{tmp25}, TNode<UintPtrT>{tmp23});
    tmp27 = CodeStubAssembler(state_).UintPtrGreaterThan(TNode<UintPtrT>{tmp21}, TNode<UintPtrT>{tmp26});
    ca_.Branch(tmp27, &block26, std::vector<compiler::Node*>{}, &block27, std::vector<compiler::Node*>{});
  }

  if (block26.is_used()) {
    ca_.Bind(&block26);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/typed-array-slice.tq:46:30");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block27.is_used()) {
    ca_.Bind(&block27);
    tmp28 = CodeStubAssembler(state_).WordShl(TNode<UintPtrT>{tmp21}, TNode<UintPtrT>{tmp23});
    compiler::CodeAssemblerLabel label30(&ca_);
    tmp29 = CodeStubAssembler(state_).LoadJSTypedArrayLengthAndValidate(TNode<JSTypedArray>{p_dest}, CastIfEnumClass<TypedArrayAccessMode>(TypedArrayAccessMode::kRead), &label30);
    ca_.Goto(&block30);
    if (label30.is_used()) {
      ca_.Bind(&label30);
      ca_.Goto(&block31);
  ...
  if (block31.is_used()) {
    ca_.Bind(&block31);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/typed-array-slice.tq:50:19");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block30.is_used()) {
    ca_.Bind(&block30);
    std::tie(tmp31, tmp32) = TypedArrayBuiltinsAssembler(state_).GetTypedArrayElementsInfo(TNode<JSTypedArray>{p_dest}).Flatten();
    tmp33 = CodeStubAssembler(state_).ArrayBufferMaxByteLength();
    tmp34 = CodeStubAssembler(state_).WordShr(TNode<UintPtrT>{tmp33}, TNode<UintPtrT>{tmp31});
    tmp35 = CodeStubAssembler(state_).UintPtrGreaterThan(TNode<UintPtrT>{tmp29}, TNode<UintPtrT>{tmp34});
    ca_.Branch(tmp35, &block35, std::vector<compiler::Node*>{}, &block36, std::vector<compiler::Node*>{});
  }

  if (block35.is_used()) {
    ca_.Bind(&block35);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/typed-array-slice.tq:52:31");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block36.is_used()) {
    ca_.Bind(&block36);
    tmp36 = CodeStubAssembler(state_).WordShl(TNode<UintPtrT>{tmp29}, TNode<UintPtrT>{tmp31});
    tmp37 = CodeStubAssembler(state_).UintPtrLessThanOrEqual(TNode<UintPtrT>{tmp13}, TNode<UintPtrT>{tmp36});
    ca_.Branch(tmp37, &block37, std::vector<compiler::Node*>{}, &block38, std::vector<compiler::Node*>{});
  }
  ...
  if (block38.is_used()) {
    ca_.Bind(&block38);
    {
      ...
      pos_stack.push_back({"src/builtins/typed-array-slice.tq", 54});
  ...
  if (block37.is_used()) {
    ca_.Bind(&block37);
    tmp38 = CodeStubAssembler(state_).UintPtrSub(TNode<UintPtrT>{tmp28}, TNode<UintPtrT>{tmp17});
    tmp39 = CodeStubAssembler(state_).UintPtrLessThanOrEqual(TNode<UintPtrT>{tmp13}, TNode<UintPtrT>{tmp38});
  ...
  if (block40.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/typed-array-slice.tq", 55});
  ...
  if (block39.is_used()) {
    ...
    tmp41 = CodeStubAssembler(state_).LoadReference<JSArrayBuffer>(CodeStubAssembler::Reference{p_src, tmp40});
    tmp42 = IsSharedArrayBuffer_0(state_, TNode<JSArrayBuffer>{tmp41});
    ca_.Branch(tmp42, &block41, std::vector<compiler::Node*>{}, &block42, std::vector<compiler::Node*>{});
  }

  TNode<RawPtrT> tmp43;
  if (block41.is_used()) {
    ca_.Bind(&block41);
    tmp43 = CodeStubAssembler(state_).LoadJSTypedArrayDataPtr(TNode<JSTypedArray>{p_dest});
    TypedArrayBuiltinsAssembler(state_).CallCRelaxedMemmove(TNode<RawPtrT>{tmp43}, TNode<RawPtrT>{tmp20}, TNode<UintPtrT>{tmp13});
    ca_.Goto(&block43);
  }
  ...
  if (block42.is_used()) {
    ca_.Bind(&block42);
    tmp44 = CodeStubAssembler(state_).LoadJSTypedArrayDataPtr(TNode<JSTypedArray>{p_dest});
    TypedArrayBuiltinsAssembler(state_).CallCMemmove(TNode<RawPtrT>{tmp44}, TNode<RawPtrT>{tmp20}, TNode<UintPtrT>{tmp13});
    ca_.Goto(&block43);
  }
...
// https://crsrc.org/c/v8/src/builtins/typed-array-slice.tq?l=66&c=1
...
TF_BUILTIN(TypedArrayPrototypeSlice, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = TypedArrayBuiltinsAssembler(state_).ValidateTypedArrayAndGetLength(TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, kBuiltinNameSlice_0(state_), CastIfEnumClass<TypedArrayAccessMode>(TypedArrayAccessMode::kRead));
  ...
  if (block7.is_used()) {
    ...
    tmp18 = TypedArraySpeciesCreateByLength_0(state_, TNode<Context>{parameter0}, kBuiltinNameSlice_0(state_), TNode<JSTypedArray>{tmp1}, TNode<UintPtrT>{tmp17}, CastIfEnumClass<TypedArrayAccessMode>(TypedArrayAccessMode::kWrite));
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    compiler::CodeAssemblerLabel label22(&ca_);
    tmp21 = CodeStubAssembler(state_).LoadJSTypedArrayLengthAndValidate(TNode<JSTypedArray>{tmp1}, CastIfEnumClass<TypedArrayAccessMode>(TypedArrayAccessMode::kRead), &label22);
    ca_.Goto(&block15);
    if (label22.is_used()) {
      ca_.Bind(&label22);
      ca_.Goto(&block16);
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{parameter0}, CastIfEnumClass<MessageTemplate>(MessageTemplate::kTypedArrayValidateErrorOperation), kBuiltinNameSlice_0(state_));
  }
