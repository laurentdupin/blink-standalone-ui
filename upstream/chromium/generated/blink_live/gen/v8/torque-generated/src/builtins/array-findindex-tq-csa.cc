...
TF_BUILTIN(ArrayFindIndexLoopEagerDeoptContinuation, CodeStubAssembler) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-findindex.tq:16:59");
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-findindex.tq:17:57");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-findindex.tq:18:52");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-findindex.tq:19:55");
    CodeStubAssembler(state_).Unreachable();
  }
...
TF_BUILTIN(ArrayFindIndexLoopLazyDeoptContinuation, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-findindex.tq:31:3");
    CodeStubAssembler(state_).Unreachable();
  }
}
...
TF_BUILTIN(ArrayFindIndexLoopAfterCallbackLazyDeoptContinuation, CodeStubAssembler) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-findindex.tq:45:59");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block8.is_used()) {
    ca_.Bind(&block8);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-findindex.tq:46:57");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-findindex.tq:47:52");
    CodeStubAssembler(state_).Unreachable();
  }
  ...
  if (block16.is_used()) {
    ca_.Bind(&block16);
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/array-findindex.tq:48:55");
    CodeStubAssembler(state_).Unreachable();
  }
...
TF_BUILTIN(ArrayFindIndexLoopContinuation, CodeStubAssembler) {
  ...
  if (block2.is_used()) {
    ...
    tmp6 = Convert_Smi_constexpr_IntegerLiteral_0(state_, IntegerLiteral(true, 0x1ull));
    CodeStubAssembler(state_).Return(tmp6);
  }
}

// https://crsrc.org/c/v8/src/builtins/array-findindex.tq?l=90&c=1
TNode<Number> FastArrayFindIndex_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<Union<JSBoundFunction, JSFunction, JSObject, JSProxy, JSWrappedFunction>> p_callbackfn, TNode<JSAny> p_thisArg, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_0) {
  ...
  TNode<JSAny> tmp20;
  if (block29.is_used()) {
    ca_.Bind(&block29, &phi_bb29_5, &phi_bb29_15, &phi_bb29_18, &phi_bb29_19, &phi_bb29_22);
    compiler::CodeAssemblerLabel label21(&ca_);
    tmp20 = LoadElementNoHole_FixedDoubleArray_0(state_, TNode<Context>{p_context}, TNode<JSArray>{tmp17}, TNode<Smi>{phi_bb29_22}, &label21);
    ca_.Goto(&block32, phi_bb29_5, phi_bb29_15, phi_bb29_18, phi_bb29_19, phi_bb29_22, phi_bb29_22);
    if (label21.is_used()) {
      ca_.Bind(&label21);
      ca_.Goto(&block33, phi_bb29_5, phi_bb29_15, phi_bb29_18, phi_bb29_19, phi_bb29_22, phi_bb29_22);
    }
  }
  ...
  if (block33.is_used()) {
    ca_.Bind(&block33, &phi_bb33_5, &phi_bb33_15, &phi_bb33_18, &phi_bb33_19, &phi_bb33_22, &phi_bb33_24);
    ca_.Goto(&block27, phi_bb33_5, phi_bb33_15, phi_bb33_18);
  }
  ...
  if (block32.is_used()) {
    ca_.Bind(&block32, &phi_bb32_5, &phi_bb32_15, &phi_bb32_18, &phi_bb32_19, &phi_bb32_22, &phi_bb32_24);
    ca_.Goto(&block28, phi_bb32_5, phi_bb32_15, phi_bb32_18, phi_bb32_19, phi_bb32_22, tmp20);
  }
  ...
  TNode<JSAny> tmp22;
  if (block30.is_used()) {
    ca_.Bind(&block30, &phi_bb30_5, &phi_bb30_15, &phi_bb30_18, &phi_bb30_19, &phi_bb30_22);
    compiler::CodeAssemblerLabel label23(&ca_);
    tmp22 = LoadElementNoHole_FixedArray_0(state_, TNode<Context>{p_context}, TNode<JSArray>{tmp17}, TNode<Smi>{phi_bb30_22}, &label23);
    ca_.Goto(&block34, phi_bb30_5, phi_bb30_15, phi_bb30_18, phi_bb30_19, phi_bb30_22, phi_bb30_22);
    if (label23.is_used()) {
      ca_.Bind(&label23);
      ca_.Goto(&block35, phi_bb30_5, phi_bb30_15, phi_bb30_18, phi_bb30_19, phi_bb30_22, phi_bb30_22);
    }
  }
  ...
  if (block35.is_used()) {
    ca_.Bind(&block35, &phi_bb35_5, &phi_bb35_15, &phi_bb35_18, &phi_bb35_19, &phi_bb35_22, &phi_bb35_24);
    ca_.Goto(&block27, phi_bb35_5, phi_bb35_15, phi_bb35_18);
  }
  ...
  if (block34.is_used()) {
    ca_.Bind(&block34, &phi_bb34_5, &phi_bb34_15, &phi_bb34_18, &phi_bb34_19, &phi_bb34_22, &phi_bb34_24);
    ca_.Goto(&block28, phi_bb34_5, phi_bb34_15, phi_bb34_18, phi_bb34_19, phi_bb34_22, tmp22);
  }
  ...
  if (block28.is_used()) {
    ca_.Bind(&block28, &phi_bb28_5, &phi_bb28_15, &phi_bb28_18, &phi_bb28_19, &phi_bb28_22, &phi_bb28_23);
    ca_.Goto(&block25, phi_bb28_5, phi_bb28_15, phi_bb28_18, phi_bb28_23);
  }
  ...
  if (block27.is_used()) {
    ca_.Bind(&block27, &phi_bb27_5, &phi_bb27_15, &phi_bb27_18);
    tmp24 = Undefined_0(state_);
    ca_.Goto(&block25, phi_bb27_5, phi_bb27_15, phi_bb27_18, tmp24);
  }
  ...
  TNode<BoolT> tmp26;
  if (block25.is_used()) {
    ca_.Bind(&block25, &phi_bb25_5, &phi_bb25_15, &phi_bb25_18, &phi_bb25_19);
    tmp25 = CodeStubAssembler(state_).Call(TNode<Context>{p_context}, TNode<JSAny>{p_callbackfn}, TNode<JSAny>{p_thisArg}, TNode<JSAny>{phi_bb25_19}, TNode<JSAny>{phi_bb25_5}, TNode<JSAny>{tmp17});
    tmp26 = ToBoolean_0(state_, TNode<JSAny>{tmp25});
    ca_.Branch(tmp26, &block37, std::vector<compiler::Node*>{phi_bb25_5}, &block38, std::vector<compiler::Node*>{phi_bb25_5});
  }
  ...
  if (block38.is_used()) {
    ...
    tmp28 = CodeStubAssembler(state_).SmiAdd(TNode<Smi>{phi_bb38_5}, TNode<Smi>{tmp27});
    ca_.Goto(&block13, tmp28, tmp17);
  }
  ...
  if (block12.is_used()) {
    ...
    tmp29 = FromConstexpr_Number_constexpr_IntegerLiteral_0(state_, IntegerLiteral(true, 0x1ull));
...
TF_BUILTIN(ArrayPrototypeFindIndex, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = RequireObjectCoercible_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{parameter1}, "Array.prototype.findIndex");
  ...
  if (block5.is_used()) {
    ...
    tmp11 = FastArrayFindIndex_0(state_, TNode<Context>{parameter0}, TNode<JSReceiver>{tmp1}, TNode<Number>{tmp2}, TNode<Union<JSBoundFunction, JSFunction, JSObject, JSProxy, JSWrappedFunction>>{tmp7}, TNode<JSAny>{tmp10}, &label12, &tmp13);
    ca_.Goto(&block9);
    if (label12.is_used()) {
      ca_.Bind(&label12);
      ca_.Goto(&block10);
...
// https://crsrc.org/c/v8/src/builtins/array-findindex.tq?l=87&c=10
TNode<Smi> Convert_Smi_constexpr_IntegerLiteral_0(compiler::CodeAssemblerState* state_, IntegerLiteral p_i) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = FromConstexpr_Smi_constexpr_IntegerLiteral_0(state_, p_i);
    ca_.Goto(&block2);
  }
