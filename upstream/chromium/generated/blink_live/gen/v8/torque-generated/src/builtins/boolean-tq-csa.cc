...
// https://crsrc.org/c/v8/src/builtins/boolean.tq?l=6&c=1
TNode<Boolean> ThisBooleanValue_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSAny> p_receiver, const char* p_method) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = CodeStubAssembler(state_).ToThisValue(TNode<Context>{p_context}, TNode<JSAny>{p_receiver}, CastIfEnumClass<PrimitiveType>(PrimitiveType::kBoolean), p_method);
...
// https://crsrc.org/c/v8/src/builtins/boolean.tq?l=9&c=10
TNode<Boolean> UnsafeCast_Boolean_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = Is_Boolean_Object_0(state_, TNode<Context>{p_context}, TNode<Object>{p_o});
...
// https://crsrc.org/c/v8/src/builtins/boolean.tq?l=22&c=37
TNode<JSReceiver> UnsafeCast_JSReceiver_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = Is_JSReceiver_Object_0(state_, TNode<Context>{p_context}, TNode<Object>{p_o});
    ca_.Branch(tmp0, &block2, std::vector<compiler::Node*>{}, &block3, std::vector<compiler::Node*>{});
  }
...
// https://crsrc.org/c/v8/src/builtins/boolean.tq?l=25&c=7
TNode<JSPrimitiveWrapper> UnsafeCast_JSPrimitiveWrapper_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    tmp0 = Is_JSPrimitiveWrapper_Object_0(state_, TNode<Context>{p_context}, TNode<Object>{p_o});
    ca_.Branch(tmp0, &block2, std::vector<compiler::Node*>{}, &block3, std::vector<compiler::Node*>{});
  }
