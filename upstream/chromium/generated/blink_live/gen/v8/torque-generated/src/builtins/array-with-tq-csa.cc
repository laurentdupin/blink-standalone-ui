...
// https://crsrc.org/c/v8/src/builtins/array-with.tq?l=6&c=1
TNode<JSArray> TryFastPackedArrayWith_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_receiver, TNode<Number> p_len, TNode<Number> p_actualIndex, TNode<JSAny> p_value, compiler::CodeAssemblerLabel* label_Slow) {
  ...
  if (block10.is_used()) {
    ...
    tmp11 = ca_.CallBuiltin<JSArray>(Builtin::kExtractFastJSArray, p_context, tmp0, tmp10, tmp6);
    tmp12 = ca_.CallBuiltin<Object>(Builtin::kFastCreateDataProperty, p_context, tmp11, p_actualIndex, p_value);
    ca_.Goto(&block11);
  }
...
TF_BUILTIN(GenericArrayWith, CodeStubAssembler) {
  ...
  if (block6.is_used()) {
    ...
    tmp5 = ca_.CallBuiltin<Object>(Builtin::kFastCreateDataProperty, parameter0, tmp0, phi_bb6_6, phi_bb6_7);
...
TF_BUILTIN(ArrayPrototypeWith, CodeStubAssembler) {
  ...
  if (block9.is_used()) {
    ca_.Bind(&block9);
    tmp8 = ca_.CallBuiltin<JSArray>(Builtin::kGenericArrayWith, parameter0, tmp0, tmp1, tmp3, parameter3);
  ...
  if (block2.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowRangeError(TNode<Context>{parameter0}, CastIfEnumClass<MessageTemplate>(MessageTemplate::kInvalid), TNode<Object>{tmp9}, TNode<Object>{parameter2});
  }
}
