...
TF_BUILTIN(SuppressedErrorConstructor, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp8 = CodeStubAssembler(state_).SmiConstant(CastIfEnumClass<int31_t>(PropertyAttributes::DONT_ENUM));
    ...
    tmp10 = CodeStubAssembler(state_).SmiConstant(CastIfEnumClass<int31_t>(PropertyAttributes::DONT_ENUM));
