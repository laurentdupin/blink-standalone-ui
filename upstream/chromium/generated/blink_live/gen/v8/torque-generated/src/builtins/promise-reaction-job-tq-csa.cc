...
TNode<JSAny> RejectPromiseReactionJob_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Union<JSPromise, PromiseCapability, Undefined>> p_promiseOrCapability, TNode<JSAny> p_reason, PromiseReaction::Type p_reactionType) {
  ...
  if (block0.is_used()) {
    ca_.Bind(&block0);
    if (((CodeStubAssembler(state_).ConstexprInt31Equal(CastIfEnumClass<int31_t>(p_reactionType), CastIfEnumClass<int31_t>(PromiseReaction::kReject))))) {
      ca_.Goto(&block2);
    } else {
      ca_.Goto(&block3);
    }
  ...
  if (block3.is_used()) {
    ca_.Bind(&block3);
    tmp12 = FromConstexpr_bool_constexpr_bool_0(state_, (CodeStubAssembler(state_).ConstexprInt31Equal(CastIfEnumClass<int31_t>(p_reactionType), CastIfEnumClass<int31_t>(PromiseReaction::kFulfill))));
    CodeStubAssembler(state_).StaticAssert(TNode<BoolT>{tmp12}, "static_assert(reactionType == kPromiseReactionFulfill) at https://crsrc.org/c/v8/src/builtins/promise-reaction-job.tq?l=32&c=5");
...
TNode<JSAny> PromiseReactionJob_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSAny> p_argument, TNode<Union<JSBoundFunction, JSFunction, JSObject, JSProxy, JSWrappedFunction, Undefined>> p_handler, TNode<Union<JSPromise, PromiseCapability, Undefined>> p_promiseOrCapability, PromiseReaction::Type p_reactionType) {
  ...
  if (block6.is_used()) {
    ca_.Bind(&block6);
    tmp3 = FromConstexpr_bool_constexpr_bool_0(state_, (CodeStubAssembler(state_).ConstexprInt31Equal(CastIfEnumClass<int31_t>(p_reactionType), CastIfEnumClass<int31_t>(PromiseReaction::kReject))));
    CodeStubAssembler(state_).StaticAssert(TNode<BoolT>{tmp3}, "static_assert(reactionType == kPromiseReactionReject) at https://crsrc.org/c/v8/src/builtins/promise-reaction-job.tq?l=79&c=7");
