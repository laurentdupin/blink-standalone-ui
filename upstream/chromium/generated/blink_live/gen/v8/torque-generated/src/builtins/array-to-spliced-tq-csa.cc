...
// https://crsrc.org/c/v8/src/builtins/array-to-spliced.tq?l=8&c=1
TNode<JSArray> CopyFastPackedArrayForToSpliced_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, ElementsKind p_kind, TNode<JSArray> p_array, TNode<Smi> p_newLenSmi, TNode<Smi> p_actualStartSmi, TNode<Smi> p_insertCountSmi, TNode<Smi> p_actualDeleteCountSmi) {
  ...
  if (block4.is_used()) {
    ca_.Bind(&block4);
    if (((CodeStubAssembler(state_).ElementsKindEqual(p_kind, CastIfEnumClass<ElementsKind>(ElementsKind::PACKED_DOUBLE_ELEMENTS))))) {
      ca_.Goto(&block6);
    } else {
      ca_.Goto(&block7);
    }
  ...
  if (block12.is_used()) {
    ca_.Bind(&block12);
    {
      ...
      pos_stack.push_back({"src/builtins/array-to-spliced.tq", 42});
...
// https://crsrc.org/c/v8/src/builtins/array-to-spliced.tq?l=50&c=1
TNode<JSArray> TryFastArrayToSpliced_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArguments p_args, TNode<JSReceiver> p_o, TNode<Number> p_originalLenNumber, TNode<Number> p_newLenNumber, TNode<Number> p_actualStartNumber, TNode<Smi> p_insertCount, TNode<Number> p_actualDeleteCountNumber, compiler::CodeAssemblerLabel* label_Slow) {
  ...
  if (block17.is_used()) {
    ca_.Bind(&block17);
    tmp19 = CopyFastPackedArrayForToSpliced_0(state_, TNode<Context>{p_context}, CastIfEnumClass<ElementsKind>(ElementsKind::PACKED_SMI_ELEMENTS), TNode<JSArray>{tmp6}, TNode<Smi>{tmp0}, TNode<Smi>{tmp2}, TNode<Smi>{p_insertCount}, TNode<Smi>{tmp4});
  ...
  if (block20.is_used()) {
    ca_.Bind(&block20);
    tmp22 = CopyFastPackedArrayForToSpliced_0(state_, TNode<Context>{p_context}, CastIfEnumClass<ElementsKind>(ElementsKind::PACKED_ELEMENTS), TNode<JSArray>{tmp6}, TNode<Smi>{tmp0}, TNode<Smi>{tmp2}, TNode<Smi>{p_insertCount}, TNode<Smi>{tmp4});
  ...
  if (block24.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/array-to-spliced.tq", 84});
  ...
  if (block23.is_used()) {
    ca_.Bind(&block23);
    tmp25 = CopyFastPackedArrayForToSpliced_0(state_, TNode<Context>{p_context}, CastIfEnumClass<ElementsKind>(ElementsKind::PACKED_DOUBLE_ELEMENTS), TNode<JSArray>{tmp6}, TNode<Smi>{tmp0}, TNode<Smi>{tmp2}, TNode<Smi>{p_insertCount}, TNode<Smi>{tmp4});
  ...
  if (block26.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/array-to-spliced.tq", 97});
...
// https://crsrc.org/c/v8/src/builtins/array-to-spliced.tq?l=109&c=1
TNode<JSArray> GenericArrayToSpliced_0(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArguments p_args, TNode<JSReceiver> p_o, TNode<Number> p_newLen, TNode<Number> p_actualStart, TNode<Number> p_actualDeleteCount) {
  ...
  if (block2.is_used()) {
    ...
    tmp4 = CodeStubAssembler(state_).GetProperty(TNode<Context>{p_context}, TNode<JSAny>{p_o}, TNode<JSAny>{phi_bb2_10});
  ...
  if (block11.is_used()) {
    ...
    tmp19 = CodeStubAssembler(state_).GetProperty(TNode<Context>{p_context}, TNode<JSAny>{p_o}, TNode<JSAny>{phi_bb11_11});
...
TF_BUILTIN(ArrayPrototypeToSpliced, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    tmp6 = ToInteger_Inline_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{tmp1});
  ...
  if (block9.is_used()) {
    ...
    tmp24 = ToInteger_Inline_0(state_, TNode<Context>{parameter0}, TNode<JSAny>{tmp3});
...
// https://crsrc.org/c/v8/src/builtins/array-to-spliced.tq?l=99&c=5
void InsertArgumentsIntoFastPackedArray_FixedArray_JSAny_0(compiler::CodeAssemblerState* state_, TNode<JSArray> p_dst, TNode<Smi> p_dstStart, TorqueStructArguments p_args, IntegerLiteral p_argsStart, TNode<Smi> p_insertCount) {
  ...
  if (block5.is_used()) {
    ...
    {
      auto pos_stack = ca_.GetMacroSourcePositionStack();
      pos_stack.push_back({"src/builtins/array-splice.tq", 67});
...
// https://crsrc.org/c/v8/src/builtins/array-to-spliced.tq?l=102&c=5
