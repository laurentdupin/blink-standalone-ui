...
TF_BUILTIN(SetPrototypeIsSupersetOf, CodeStubAssembler) {
  ...
  if (block23.is_used()) {
    ...
    tmp30 = CollectionsBuiltinsAssembler(state_).TableHasKey(TNode<Context>{parameter0}, TNode<OrderedHashSet>{tmp9}, TNode<JSAny>{tmp27});
  ...
  if (block39.is_used()) {
    ...
    tmp47 = CollectionsBuiltinsAssembler(state_).TableHasKey(TNode<Context>{parameter0}, TNode<OrderedHashSet>{tmp9}, TNode<JSAny>{tmp43});
  ...
  if (block56.is_used()) {
    ...
    tmp64 = CollectionsBuiltinsAssembler(state_).TableHasKey(TNode<Context>{parameter0}, TNode<OrderedHashSet>{tmp63}, TNode<JSAny>{tmp56});
  ...
  if (block10.is_used()) {
    ...
    CodeStubAssembler(state_).PrintErr("halting because of unreachable code at src/builtins/set-is-superset-of.tq:103:3");
    CodeStubAssembler(state_).Unreachable();
  }
