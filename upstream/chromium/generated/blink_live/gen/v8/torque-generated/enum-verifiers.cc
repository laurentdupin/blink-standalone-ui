...
namespace  {
class EnumVerifier {
  // ArrayFromAsyncLabels (https://crsrc.org/c/v8/src/builtins/array-from-async.tq?l=7&c=1)
  ...
  // ArrayFromAsyncIterableResolveContextSlots (https://crsrc.org/c/v8/src/builtins/array-from-async.tq?l=63&c=1)
  ...
  // ArrayFromAsyncArrayLikeResolveContextSlots (https://crsrc.org/c/v8/src/builtins/array-from-async.tq?l=483&c=1)
  ...
  // UpdateFeedbackMode (https://crsrc.org/c/v8/src/builtins/base.tq?l=323&c=1)
  ...
  // CallFeedbackContent (https://crsrc.org/c/v8/src/builtins/base.tq?l=331&c=1)
  ...
  // UnicodeEncoding (https://crsrc.org/c/v8/src/builtins/base.tq?l=333&c=1)
  ...
  // PromiseState (https://crsrc.org/c/v8/src/builtins/base.tq?l=336&c=1)
  ...
  // ElementsKind (https://crsrc.org/c/v8/src/builtins/base.tq?l=354&c=1)
  ...
  // AllocationFlag (https://crsrc.org/c/v8/src/builtins/base.tq?l=401&c=1)
  ...
  // SlackTrackingMode (https://crsrc.org/c/v8/src/builtins/base.tq?l=408&c=1)
  ...
  // ExtractFixedArrayFlag (https://crsrc.org/c/v8/src/builtins/base.tq?l=415&c=1)
  ...
  // MessageTemplate (https://crsrc.org/c/v8/src/builtins/base.tq?l=429&c=1)
  void VerifyEnum_MessageTemplate(MessageTemplate x) {
    switch(x) {
      ...
      case MessageTemplate::kTypedArrayDetachedErrorOperation: break;
      case MessageTemplate::kTypedArrayValidateErrorOperation: break;
      case MessageTemplate::kTypedArrayValidateWriteErrorOperation: break;
      ...
      case MessageTemplate::kTypedArrayImmutableBufferErrorOperation: break;
      ...
      case MessageTemplate::kWasmTrapNullFunc: break;
      ...
      case MessageTemplate::kWasmTrapResume: break;
      case MessageTemplate::kWasmTrapSuspend: break;
      case MessageTemplate::kWasmTrapSwitch: break;
      ...
      case MessageTemplate::kInvalidIteratorZipMode: break;
      case MessageTemplate::kIteratorZipStrictMismatch: break;
      default: break;
    }
  }

  // PropertyAttributes (https://crsrc.org/c/v8/src/builtins/base.tq?l=540&c=1)
  ...
  // PrimitiveType (https://crsrc.org/c/v8/src/builtins/base.tq?l=587&c=1)
  ...
  // LanguageMode (https://crsrc.org/c/v8/src/builtins/base.tq?l=669&c=1)
  ...
  // BigIntHandling (https://crsrc.org/c/v8/src/builtins/base.tq?l=791&c=1)
  ...
  // HashFieldType (https://crsrc.org/c/v8/src/builtins/base.tq?l=2234&c=1)
  ...
  // TypedArrayAccessMode (https://crsrc.org/c/v8/src/builtins/base.tq?l=2257&c=1)
  void VerifyEnum_TypedArrayAccessMode(TypedArrayAccessMode x) {
    switch(x) {
      case TypedArrayAccessMode::kRead: break;
      case TypedArrayAccessMode::kWrite: break;
    }
  }

  // AllocationSiteMode (https://crsrc.org/c/v8/src/builtins/constructor.tq?l=22&c=1)
  ...
  // OrdinaryToPrimitiveHint (https://crsrc.org/c/v8/src/builtins/conversion.tq?l=9&c=1)
  ...
  // ForInFeedback (https://crsrc.org/c/v8/src/builtins/internal.tq?l=44&c=1)
  ...
  // Operation (https://crsrc.org/c/v8/src/builtins/number.tq?l=7&c=1)
  ...
  // PromiseResolvingFunctionContextSlot (https://crsrc.org/c/v8/src/builtins/promise-abstract-operations.tq?l=285&c=1)
  ...
  // FunctionContextSlot (https://crsrc.org/c/v8/src/builtins/promise-abstract-operations.tq?l=294&c=1)
  ...
  // PromiseAllResolveElementContextSlots (https://crsrc.org/c/v8/src/builtins/promise-all-element-closure.tq?l=69&c=1)
  ...
  // PromiseAnyRejectElementContextSlots (https://crsrc.org/c/v8/src/builtins/promise-any.tq?l=9&c=1)
  ...
  // PromiseValueThunkOrReasonContextSlot (https://crsrc.org/c/v8/src/builtins/promise-finally.tq?l=11&c=1)
  ...
  // PromiseFinallyContextSlot (https://crsrc.org/c/v8/src/builtins/promise-finally.tq?l=18&c=1)
  ...
  // ProxyRevokeFunctionContextSlot (https://crsrc.org/c/v8/src/builtins/proxy.tq?l=28&c=1)
  ...
  // Flag (https://crsrc.org/c/v8/src/builtins/regexp.tq?l=180&c=1)
  ...
  // TrimMode (https://crsrc.org/c/v8/src/builtins/string-trim.tq?l=9&c=1)
  ...
  // ContextMode (https://crsrc.org/c/v8/src/objects/contexts.tq?l=33&c=1)
  ...
  // ContextSlot (https://crsrc.org/c/v8/src/objects/contexts.tq?l=127&c=1)
  void VerifyEnum_ContextSlot(Context::Field x) {
    switch(x) {
      ...
      case Context::Field::ITERATOR_CONCAT_HELPER_MAP_INDEX: break;
      case Context::Field::ITERATOR_ZIP_HELPER_MAP_INDEX: break;
      case Context::Field::ITERATOR_ZIP_KEYED_HELPER_MAP_INDEX: break;
  ...
  // DisposableStackState (https://crsrc.org/c/v8/src/objects/js-disposable-stack.tq?l=5&c=1)
  ...
  // DisposeMethodCallType (https://crsrc.org/c/v8/src/objects/js-disposable-stack.tq?l=6&c=1)
  ...
  // DisposeMethodHint (https://crsrc.org/c/v8/src/objects/js-disposable-stack.tq?l=10&c=1)
  ...
  // DisposableStackResourcesType (https://crsrc.org/c/v8/src/objects/js-disposable-stack.tq?l=11&c=1)
  ...
  // JSIteratorHelperState (https://crsrc.org/c/v8/src/objects/js-iterator-helpers.tq?l=7&c=1)
  void VerifyEnum_JSIteratorHelperState(JSIteratorHelperState x) {
    switch(x) {
      case JSIteratorHelperState::kSuspendedStart: break;
      case JSIteratorHelperState::kSuspendedYield: break;
      case JSIteratorHelperState::kExecuting: break;
      case JSIteratorHelperState::kCompleted: break;
    }
  }

  // JSIteratorZipHelperMode (https://crsrc.org/c/v8/src/objects/js-iterator-helpers.tq?l=61&c=1)
  void VerifyEnum_JSIteratorZipHelperMode(JSIteratorZipHelperMode x) {
    switch(x) {
      case JSIteratorZipHelperMode::kShortest: break;
      case JSIteratorZipHelperMode::kLongest: break;
      case JSIteratorZipHelperMode::kStrict: break;
    }
  }

  // ExtendedMapKind (https://crsrc.org/c/v8/src/objects/map.tq?l=100&c=1)
  void VerifyEnum_ExtendedMapKind(ExtendedMapKind x) {
    switch(x) {
      case ExtendedMapKind::kJSInterceptorMap: break;
      default: break;
    }
  }

  // PrivateSymbolKind (https://crsrc.org/c/v8/src/objects/name.tq?l=21&c=1)
  void VerifyEnum_PrivateSymbolKind(PrivateSymbolKind x) {
    switch(x) {
      case PrivateSymbolKind::kPublic: break;
      case PrivateSymbolKind::kInternal: break;
      case PrivateSymbolKind::kFieldName: break;
      case PrivateSymbolKind::kBrand: break;
    }
  }

  // ScopeType (https://crsrc.org/c/v8/src/objects/scope-info.tq?l=8&c=1)
  ...
  // VariableAllocationInfo (https://crsrc.org/c/v8/src/objects/scope-info.tq?l=27&c=1)
  ...
  // VariableMode (https://crsrc.org/c/v8/src/objects/scope-info.tq?l=34&c=1)
  ...
  // InitializationFlag (https://crsrc.org/c/v8/src/objects/scope-info.tq?l=50&c=1)
  ...
  // IsStaticFlag (https://crsrc.org/c/v8/src/objects/scope-info.tq?l=55&c=1)
  ...
  // MaybeAssignedFlag (https://crsrc.org/c/v8/src/objects/scope-info.tq?l=57&c=1)
  ...
  // StringRepresentationTag (https://crsrc.org/c/v8/src/objects/string.tq?l=54&c=1)
  ...
  // AbortReason (https://crsrc.org/c/v8/src/objects/turboshaft-types.tq?l=7&c=1)
  ...
  // AddressType (https://crsrc.org/c/v8/src/wasm/wasm-objects.tq?l=22&c=1)
