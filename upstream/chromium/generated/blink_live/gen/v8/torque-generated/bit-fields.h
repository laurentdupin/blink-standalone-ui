...
namespace v8 {
namespace internal {
// https://crsrc.org/c/v8/src/objects/api-callbacks.tq?l=5&c=1
...
// https://crsrc.org/c/v8/src/objects/api-callbacks.tq?l=39&c=1
...
// https://crsrc.org/c/v8/src/objects/call-site-info.tq?l=5&c=1
#define DEFINE_TORQUE_GENERATED_CALL_SITE_INFO_FLAGS() \
  ...
  using IsDeferredBaselineFrameBit = base::BitField<bool, 8, 1, uint32_t>; \
  enum Flag: uint32_t { \
    kNone = 0, \
    ...
    kIsDeferredBaselineFrame = uint32_t{1} << 8, \
  }; \
  using Flags = base::Flags<Flag>; \
  static constexpr int kFlagCount = 9; \

// https://crsrc.org/c/v8/src/objects/debug-objects.tq?l=19&c=1
...
// https://crsrc.org/c/v8/src/objects/debug-objects.tq?l=28&c=1
...
// https://crsrc.org/c/v8/src/objects/debug-objects.tq?l=71&c=1
...
// https://crsrc.org/c/v8/src/objects/descriptor-array.tq?l=22&c=1
#define DEFINE_TORQUE_GENERATED_DESCRIPTOR_ARRAY_FLAGS() \
  using FastIterableBits = base::BitField<DescriptorArray::FastIterableState, 0, 2, uint32_t>; \

// https://crsrc.org/c/v8/src/objects/feedback-vector.tq?l=7&c=1
#define DEFINE_TORQUE_GENERATED_FEEDBACK_VECTOR_FLAGS() \
  using TieringInProgressBit = base::BitField<bool, 0, 1, uint16_t>; \
  using OsrTieringInProgressBit = base::BitField<bool, 1, 1, uint16_t>; \
  using InterruptBudgetResetByIcChangeBit = base::BitField<bool, 2, 1, uint16_t>; \
  using AllYourBitsAreBelongToJgruberBits = base::BitField<uint32_t, 3, 13, uint16_t>; \

// https://crsrc.org/c/v8/src/objects/feedback-vector.tq?l=14&c=1
...
// https://crsrc.org/c/v8/src/objects/js-array-buffer.tq?l=5&c=1
#define DEFINE_TORQUE_GENERATED_JS_ARRAY_BUFFER_FLAGS() \
  ...
  using IsImmutableBit = base::BitField<bool, 6, 1, uint32_t>; \
  enum Flag: uint32_t { \
    kNone = 0, \
    ...
    kIsImmutable = uint32_t{1} << 6, \
  }; \
  using Flags = base::Flags<Flag>; \
  static constexpr int kFlagCount = 7; \

// https://crsrc.org/c/v8/src/objects/js-array-buffer.tq?l=67&c=1
...
// https://crsrc.org/c/v8/src/objects/js-disposable-stack.tq?l=16&c=1
#define DEFINE_TORQUE_GENERATED_DISPOSABLE_STACK_STATUS() \
  using StateBit = base::BitField<DisposableStackState, 0, 1, uint32_t>; \
  using NeedsAwaitBit = base::BitField<bool, 1, 1, uint32_t>; \
  using HasAwaitedBit = base::BitField<bool, 2, 1, uint32_t>; \
  using SuppressedErrorCreatedBit = base::BitField<bool, 3, 1, uint32_t>; \
  using LengthBits = base::BitField<int32_t, 4, 27, uint32_t>; \

// https://crsrc.org/c/v8/src/objects/js-promise.tq?l=5&c=1
#define DEFINE_TORQUE_GENERATED_JS_PROMISE_FLAGS() \
  ...
  using AsyncTaskIdBits = base::BitField<uint32_t, 4, 27, uint32_t>; \

// https://crsrc.org/c/v8/src/objects/js-regexp-string-iterator.tq?l=5&c=1
...
// https://crsrc.org/c/v8/src/objects/js-regexp.tq?l=5&c=1
...
// https://crsrc.org/c/v8/src/objects/js-regexp.tq?l=33&c=1
#define DEFINE_TORQUE_GENERATED_IR_REG_EXP_DATA_BIT_FIELD() \
  using CanBeZeroLengthBit = base::BitField<bool, 0, 1, uint32_t>; \
  using IsLinearExecutableBit = base::BitField<bool, 1, 1, uint32_t>; \
  enum Flag: uint32_t { \
    kNone = 0, \
    kCanBeZeroLength = uint32_t{1} << 0, \
    kIsLinearExecutable = uint32_t{1} << 1, \
  }; \
  using Flags = base::Flags<Flag>; \
  static constexpr int kFlagCount = 2; \

// https://crsrc.org/c/v8/src/objects/js-weak-refs.tq?l=5&c=1
...
// https://crsrc.org/c/v8/src/objects/map.tq?l=5&c=1
#define DEFINE_TORQUE_GENERATED_MAP_BIT_FIELDS1() \
  ...
  using IsExtendedMapBit = base::BitField<bool, 7, 1, uint8_t>; \
  enum Flag: uint8_t { \
    kNone = 0, \
    ...
    kIsExtendedMap = uint8_t{1} << 7, \
  }; \
  using Flags = base::Flags<Flag>; \
  static constexpr int kFlagCount = 8; \

// https://crsrc.org/c/v8/src/objects/map.tq?l=16&c=1
...
// https://crsrc.org/c/v8/src/objects/map.tq?l=22&c=1
...
// https://crsrc.org/c/v8/src/objects/map.tq?l=102&c=1
#define DEFINE_TORQUE_GENERATED_EXTENDED_MAP_BIT_FIELDS() \
  using MapKindBits = base::BitField<ExtendedMapKind, 0, 3, uint8_t>; \
  using MapSizeInWordsBits = base::BitField<uint8_t, 3, 5, uint8_t>; \

// https://crsrc.org/c/v8/src/objects/name.tq?l=11&c=1
...
// https://crsrc.org/c/v8/src/objects/name.tq?l=28&c=1
#define DEFINE_TORQUE_GENERATED_SYMBOL_FLAGS() \
  using PrivateSymbolKindBits = base::BitField<PrivateSymbolKind, 0, 2, uint32_t>; \
  using IsWellKnownSymbolBit = base::BitField<bool, 2, 1, uint32_t>; \
  using IsInPublicSymbolTableBit = base::BitField<bool, 3, 1, uint32_t>; \
  using IsInterestingSymbolBit = base::BitField<bool, 4, 1, uint32_t>; \

// https://crsrc.org/c/v8/src/objects/property-descriptor-object.tq?l=7&c=1
...
// https://crsrc.org/c/v8/src/objects/prototype-info.tq?l=5&c=1
...
// https://crsrc.org/c/v8/src/objects/scope-info.tq?l=60&c=1
#define DEFINE_TORQUE_GENERATED_SCOPE_FLAGS() \
  ...
  using AllocatesArgumentsBit = base::BitField<bool, 11, 1, uint32_t>; \
  ...
  using SomeContextHasExtensionBit = base::BitField<bool, 27, 1, uint32_t>; \
  using IsHiddenBit = base::BitField<bool, 28, 1, uint32_t>; \
  using IsWrappedFunctionBit = base::BitField<bool, 29, 1, uint32_t>; \
  using HasContextCellsBit = base::BitField<bool, 30, 1, uint32_t>; \
  using IsHoistedInContextBit = base::BitField<bool, 31, 1, uint32_t>; \

// https://crsrc.org/c/v8/src/objects/scope-info.tq?l=104&c=1
#define DEFINE_TORQUE_GENERATED_VARIABLE_PROPERTIES() \
  ...
  using IsParameterBit = base::BitField<bool, 6, 1, uint32_t>; \
  using ParameterNumberOrPositionBits = base::BitField<uint32_t, 7, 16, uint32_t>; \
  using IsStaticFlagBit = base::BitField<IsStaticFlag, 23, 1, uint32_t>; \

// https://crsrc.org/c/v8/src/objects/script.tq?l=8&c=1
...
// https://crsrc.org/c/v8/src/objects/shared-function-info.tq?l=25&c=1
#define DEFINE_TORQUE_GENERATED_SHARED_FUNCTION_INFO_FLAGS() \
  ...
  using IsHoistedInContextBit = base::BitField<bool, 30, 1, uint32_t>; \
  using LiveEditedBit = base::BitField<bool, 31, 1, uint32_t>; \

// https://crsrc.org/c/v8/src/objects/shared-function-info.tq?l=50&c=1
#define DEFINE_TORQUE_GENERATED_SHARED_FUNCTION_INFO_FLAGS2() \
  ...
  using CachedTieringDecisionBits = base::BitField<CachedTieringDecision, 4, 3, uint8_t>; \
  using FunctionContextIndependentCompiledBit = base::BitField<bool, 7, 1, uint8_t>; \

// https://crsrc.org/c/v8/src/objects/source-text-module.tq?l=7&c=1
...
// https://crsrc.org/c/v8/src/objects/source-text-module.tq?l=52&c=1
#define DEFINE_TORQUE_GENERATED_MODULE_REQUEST_FLAGS() \
  using PhaseBits = base::BitField<ModuleImportPhase, 0, 2, uint32_t>; \
  using PositionBits = base::BitField<uint32_t, 2, 29, uint32_t>; \

// https://crsrc.org/c/v8/src/objects/string.tq?l=62&c=1
...
// https://crsrc.org/c/v8/src/objects/templates.tq?l=5&c=1
#define DEFINE_TORQUE_GENERATED_TEMPLATE_INFO_FLAGS() \
  using IsCacheableBit = base::BitField<bool, 0, 1, uint32_t>; \
  using ShouldPromoteToReadOnlyBit = base::BitField<bool, 1, 1, uint32_t>; \
  using SerialNumberBits = base::BitField<uint32_t, 2, 29, uint32_t>; \

// https://crsrc.org/c/v8/src/objects/templates.tq?l=39&c=1
...
// https://crsrc.org/c/v8/src/objects/templates.tq?l=110&c=1
...
// https://crsrc.org/c/v8/src/objects/turbofan-types.tq?l=19&c=1
...
// https://crsrc.org/c/v8/src/objects/turbofan-types.tq?l=54&c=1
#define DEFINE_TORQUE_GENERATED_TURBOFAN_TYPE_HIGH_BITS() \
  ...
  using TypedArrayBit = base::BitField<bool, 3, 1, uint32_t>; \
  enum Flag: uint32_t { \
    kNone = 0, \
    kMachine = uint32_t{1} << 0, \
    kHole = uint32_t{1} << 1, \
    kStringWrapper = uint32_t{1} << 2, \
    kTypedArray = uint32_t{1} << 3, \
  }; \
  using Flags = base::Flags<Flag>; \
  static constexpr int kFlagCount = 4; \

// https://crsrc.org/c/v8/src/objects/turboshaft-types.tq?l=11&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=960&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1004&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1008&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1043&c=1
...
// https://crsrc.org/c/v8/test/torque/test-torque.tq?l=1049&c=1
...
// https://crsrc.org/c/v8/src/objects/js-date-time-format.tq?l=10&c=1
#define DEFINE_TORQUE_GENERATED_JS_DATE_TIME_FORMAT_FLAGS() \
  ...
  using HasToLocaleStringTimeZoneBit = base::BitField<bool, 9, 1, uint32_t>; \
  using ExplicitComponentsInOptionsBits = base::BitField<int32_t, 10, 11, uint32_t>; \

// https://crsrc.org/c/v8/src/objects/js-display-names.tq?l=12&c=1
...
// https://crsrc.org/c/v8/src/objects/js-duration-format.tq?l=15&c=1
...
// https://crsrc.org/c/v8/src/objects/js-duration-format.tq?l=29&c=1
...
// https://crsrc.org/c/v8/src/objects/js-list-format.tq?l=9&c=1
...
// https://crsrc.org/c/v8/src/objects/js-plural-rules.tq?l=8&c=1
...
// https://crsrc.org/c/v8/src/objects/js-relative-time-format.tq?l=9&c=1
...
// https://crsrc.org/c/v8/src/objects/js-segment-iterator.tq?l=7&c=1
...
// https://crsrc.org/c/v8/src/objects/js-segmenter.tq?l=9&c=1
#define DEFINE_TORQUE_GENERATED_JS_SEGMENTER_FLAGS() \
  using GranularityBits = base::BitField<JSSegmenter::Granularity, 0, 2, uint32_t>; \

// https://crsrc.org/c/v8/src/objects/js-segments.tq?l=7&c=1
