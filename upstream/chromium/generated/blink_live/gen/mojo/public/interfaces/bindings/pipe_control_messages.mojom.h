 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        DisconnectReason::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
class COMPONENT_EXPORT(MOJO_MOJOM_BINDINGS) RunOrClosePipeInput {
 public:
  ...
  const PeerAssociatedEndpointClosedEventPtr& get_peer_associated_endpoint_closed_event() const {
    CHECK(tag_ == Tag::kPeerAssociatedEndpointClosedEvent);
    return data_.peer_associated_endpoint_closed_event;
  }
  PeerAssociatedEndpointClosedEventPtr& get_peer_associated_endpoint_closed_event() {
    CHECK(tag_ == Tag::kPeerAssociatedEndpointClosedEvent);
    return data_.peer_associated_endpoint_closed_event;
  }
  ...
  const PauseUntilFlushCompletesPtr& get_pause_until_flush_completes() const {
    CHECK(tag_ == Tag::kPauseUntilFlushCompletes);
    return data_.pause_until_flush_completes;
  }
  PauseUntilFlushCompletesPtr& get_pause_until_flush_completes() {
    CHECK(tag_ == Tag::kPauseUntilFlushCompletes);
    return data_.pause_until_flush_completes;
  }
  void set_pause_until_flush_completes(PauseUntilFlushCompletesPtr pause_until_flush_completes);

  bool is_flush_async() const { return tag_ == Tag::kFlushAsync; }
  const FlushAsyncPtr& get_flush_async() const {
    CHECK(tag_ == Tag::kFlushAsync);
    return data_.flush_async;
  }
  FlushAsyncPtr& get_flush_async() {
    CHECK(tag_ == Tag::kFlushAsync);
    return data_.flush_async;
  }
  void set_flush_async(FlushAsyncPtr flush_async);
...
PeerAssociatedEndpointClosedEvent& operator=(const PeerAssociatedEndpointClosedEvent&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        PeerAssociatedEndpointClosedEvent::DataView, std::vector<uint8_t>, send_validation>(input);
  }
