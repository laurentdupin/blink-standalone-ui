// mojo/public/mojom/base/byte_count.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef MOJO_PUBLIC_MOJOM_BASE_BYTE_COUNT_MOJOM_BLINK_H_
#define MOJO_PUBLIC_MOJOM_BASE_BYTE_COUNT_MOJOM_BLINK_H_
...
#include "mojo/public/mojom/base/byte_count.mojom-blink-forward.h"  // IWYU pragma: export
...
class COMPONENT_EXPORT(MOJO_BASE_MOJOM_BLINK) ByteCount {
 public:
  template <typename T>
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ByteCount::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ByteCount::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct COMPONENT_EXPORT(MOJO_BASE_MOJOM_BLINK) StructTraits<::mojo_base::mojom::blink::ByteCount::DataView,
                                         ::mojo_base::mojom::blink::ByteCountPtr> {
  static bool IsNull(const ::mojo_base::mojom::blink::ByteCountPtr& input) { return !input; }
  static void SetToNull(::mojo_base::mojom::blink::ByteCountPtr* output) { output->reset(); }

  static decltype(::mojo_base::mojom::blink::ByteCount::count) count(
      const ::mojo_base::mojom::blink::ByteCountPtr& input) {
    return input->count;
  }

  static bool Read(::mojo_base::mojom::blink::ByteCount::DataView input, ::mojo_base::mojom::blink::ByteCountPtr* output);
};

}  // namespace mojo

#endif  // MOJO_PUBLIC_MOJOM_BASE_BYTE_COUNT_MOJOM_BLINK_H_