...
#include "mojo/public/mojom/base/text_direction.mojom-data-view.h"  // IWYU pragma: export
...
struct Serializer<::mojo_base::mojom::TextDirection, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::mojo_base::mojom::TextDirection>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::mojo_base::mojom::TextDirection, UserType> ||
                        HasInfallibleConversion(::mojo_base::mojom::TextDirection()),
                    "::mojo_base::mojom::TextDirection does not have an infallible conversion, "
