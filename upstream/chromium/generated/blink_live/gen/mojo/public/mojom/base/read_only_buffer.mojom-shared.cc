// mojo/public/mojom/base/read_only_buffer.mojom-shared.cc is auto generated by mojom_bindings_generator.py, do not edit
...
// static
bool ReadOnlyBuffer_Data::Validate(
    const void* data,
  ...
  [[maybe_unused]] const ReadOnlyBuffer_Data* object =
      static_cast<const ReadOnlyBuffer_Data*>(data);
...
ReadOnlyBuffer_Data::ReadOnlyBuffer_Data()
