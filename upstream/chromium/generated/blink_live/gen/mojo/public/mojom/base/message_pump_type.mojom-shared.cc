...
NOINLINE static const char* MessagePumpTypeToStringHelper(MessagePumpType value) {
...
std::string MessagePumpTypeToString(MessagePumpType value) {
  const char *str = MessagePumpTypeToStringHelper(value);
  if (!str) {
...
// static
void TraceFormatTraits<::mojo_base::mojom::MessagePumpType>::WriteIntoTrace(
