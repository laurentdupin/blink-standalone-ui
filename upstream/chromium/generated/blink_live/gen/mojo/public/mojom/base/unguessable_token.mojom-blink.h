// mojo/public/mojom/base/unguessable_token.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit
...
#include "mojo/public/mojom/base/unguessable_token.mojom-features.h"  // IWYU pragma: export
#include "mojo/public/mojom/base/unguessable_token.mojom-shared.h"  // IWYU pragma: export
#include "mojo/public/mojom/base/unguessable_token.mojom-blink-forward.h"  // IWYU pragma: export
...
class BLINK_PLATFORM_EXPORT UnguessableToken {
 public:
  template <typename T>
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        UnguessableToken::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        UnguessableToken::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::mojo_base::mojom::blink::UnguessableToken::DataView,
