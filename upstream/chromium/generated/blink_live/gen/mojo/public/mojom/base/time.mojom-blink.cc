...
size_t Time::Hash(size_t seed) const {
  seed = mojo::internal::WTFHash(seed, this->internal_value);
  return seed;
}
...
// static
bool StructTraits<::mojo_base::mojom::blink::JSTime::DataView, ::mojo_base::mojom::blink::JSTimePtr>::Read(
    ::mojo_base::mojom::blink::JSTime::DataView input,
    ::mojo_base::mojom::blink::JSTimePtr* output) {
  bool success = true;
  ::mojo_base::mojom::blink::JSTimePtr result(::mojo_base::mojom::blink::JSTime::New());
