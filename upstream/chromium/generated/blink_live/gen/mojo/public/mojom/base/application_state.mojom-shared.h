...
#include "mojo/public/mojom/base/application_state.mojom-data-view.h"  // IWYU pragma: export
...
struct Serializer<::mojo_base::mojom::ApplicationState, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::mojo_base::mojom::ApplicationState>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::mojo_base::mojom::ApplicationState, UserType> ||
                        HasInfallibleConversion(::mojo_base::mojom::ApplicationState()),
                    "::mojo_base::mojom::ApplicationState does not have an infallible conversion, "
...
template <>
struct  TraceFormatTraits<::mojo_base::mojom::ApplicationState> {
