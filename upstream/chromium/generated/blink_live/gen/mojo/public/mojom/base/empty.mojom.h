// mojo/public/mojom/base/empty.mojom.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef MOJO_PUBLIC_MOJOM_BASE_EMPTY_MOJOM_H_
#define MOJO_PUBLIC_MOJOM_BASE_EMPTY_MOJOM_H_
...
#include "mojo/public/mojom/base/empty.mojom-forward.h"  // IWYU pragma: export
#include <string>
#include <vector>
...
class COMPONENT_EXPORT(MOJO_BASE_MOJOM) Empty {
 public:
  template <typename T>
...
template <>
struct COMPONENT_EXPORT(MOJO_BASE_MOJOM) StructTraits<::mojo_base::mojom::Empty::DataView,
                                         ::mojo_base::mojom::EmptyPtr> {
  static bool IsNull(const ::mojo_base::mojom::EmptyPtr& input) { return !input; }
  static void SetToNull(::mojo_base::mojom::EmptyPtr* output) { output->reset(); }

  static bool Read(::mojo_base::mojom::Empty::DataView input, ::mojo_base::mojom::EmptyPtr* output);
};

}  // namespace mojo

#endif  // MOJO_PUBLIC_MOJOM_BASE_EMPTY_MOJOM_H_