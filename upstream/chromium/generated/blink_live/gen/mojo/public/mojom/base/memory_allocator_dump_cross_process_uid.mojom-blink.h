...
#include "mojo/public/mojom/base/memory_allocator_dump_cross_process_uid.mojom-blink-forward.h"  // IWYU pragma: export
 ...
 public:
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        MemoryAllocatorDumpCrossProcessUid::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        MemoryAllocatorDumpCrossProcessUid::DataView, ::blink::Vector<uint8_t>>(input);
  }
