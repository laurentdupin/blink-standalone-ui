...
#include "mojo/public/mojom/base/big_buffer.mojom-blink-forward.h"  // IWYU pragma: export
...
struct COMPONENT_EXPORT(MOJO_BASE_MOJOM_BLINK) UnionTraits<::mojo_base::mojom::blink::BigBuffer::DataView,
  ...
  static const ::blink::Vector<uint8_t>& bytes(const ::mojo_base::mojom::blink::BigBufferPtr& input) {
