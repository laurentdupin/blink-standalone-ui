 ...
 public:
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SchemeHostPort::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SchemeHostPort::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::url::mojom::blink::SchemeHostPort::DataView,
                                         ::url::mojom::blink::SchemeHostPortPtr> {
  static bool IsNull(const ::url::mojom::blink::SchemeHostPortPtr& input) { return !input; }
  static void SetToNull(::url::mojom::blink::SchemeHostPortPtr* output) { output->reset(); }

  static const decltype(::url::mojom::blink::SchemeHostPort::scheme)& scheme(
      const ::url::mojom::blink::SchemeHostPortPtr& input) {
    return input->scheme;
  }

  static const decltype(::url::mojom::blink::SchemeHostPort::host)& host(
      const ::url::mojom::blink::SchemeHostPortPtr& input) {
    return input->host;
  }

  static decltype(::url::mojom::blink::SchemeHostPort::port) port(
      const ::url::mojom::blink::SchemeHostPortPtr& input) {
    return input->port;
  }
