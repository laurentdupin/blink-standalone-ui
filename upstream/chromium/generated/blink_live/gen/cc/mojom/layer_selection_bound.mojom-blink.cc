// cc/mojom/layer_selection_bound.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
// static
bool StructTraits<::cc::mojom::blink::LayerSelectionBound::DataView, ::cc::mojom::blink::LayerSelectionBoundPtr>::Read(
    ::cc::mojom::blink::LayerSelectionBound::DataView input,
    ::cc::mojom::blink::LayerSelectionBoundPtr* output) {
  bool success = true;
  ::cc::mojom::blink::LayerSelectionBoundPtr result(::cc::mojom::blink::LayerSelectionBound::New());
...
// static
bool StructTraits<::cc::mojom::blink::LayerSelection::DataView, ::cc::mojom::blink::LayerSelectionPtr>::Read(
    ::cc::mojom::blink::LayerSelection::DataView input,
    ::cc::mojom::blink::LayerSelectionPtr* output) {
  bool success = true;
  ::cc::mojom::blink::LayerSelectionPtr result(::cc::mojom::blink::LayerSelection::New());
