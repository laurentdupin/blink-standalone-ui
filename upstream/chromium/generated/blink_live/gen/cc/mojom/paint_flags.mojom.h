// cc/mojom/paint_flags.mojom.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef CC_MOJOM_PAINT_FLAGS_MOJOM_H_
#define CC_MOJOM_PAINT_FLAGS_MOJOM_H_
...
#include "cc/mojom/paint_flags.mojom-forward.h"  // IWYU pragma: export
#include <string>
#include <vector>
 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        DynamicRangeLimit::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        DynamicRangeLimit::DataView, std::vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::cc::mojom::DynamicRangeLimit::DataView,
                                         ::cc::mojom::DynamicRangeLimitPtr> {
  static bool IsNull(const ::cc::mojom::DynamicRangeLimitPtr& input) { return !input; }
  static void SetToNull(::cc::mojom::DynamicRangeLimitPtr* output) { output->reset(); }

  static decltype(::cc::mojom::DynamicRangeLimit::standard_mix) standard_mix(
      const ::cc::mojom::DynamicRangeLimitPtr& input) {
    return input->standard_mix;
  }

  static decltype(::cc::mojom::DynamicRangeLimit::constrained_high_mix) constrained_high_mix(
      const ::cc::mojom::DynamicRangeLimitPtr& input) {
    return input->constrained_high_mix;
  }

  static bool Read(::cc::mojom::DynamicRangeLimit::DataView input, ::cc::mojom::DynamicRangeLimitPtr* output);
};

}  // namespace mojo

#endif  // CC_MOJOM_PAINT_FLAGS_MOJOM_H_