...
void RenderFrameMetadataObserverProxy::ReportAllFrameSubmissionsForTesting(
  ...
  mojo::Message message(
      std::to_underlying(messages::RenderFrameMetadataObserver::kReportAllFrameSubmissionsForTesting), kFlags, estimated_payload_size);
...
bool RenderFrameMetadataObserverRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::cc::mojom::blink::RenderFrameMetadataObserver::Name_,
...
void RenderFrameMetadataObserverClientProxy::OnRenderFrameMetadataChanged(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::RenderFrameMetadataObserverClient::kOnRenderFrameMetadataChanged), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void RenderFrameMetadataObserverClientProxy::OnFrameSubmissionForTesting(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::RenderFrameMetadataObserverClient::kOnFrameSubmissionForTesting), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool RenderFrameMetadataObserverClientRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::cc::mojom::blink::RenderFrameMetadataObserverClient::Name_,
