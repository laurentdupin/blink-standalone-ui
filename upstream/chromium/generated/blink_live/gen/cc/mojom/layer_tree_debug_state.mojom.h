// cc/mojom/layer_tree_debug_state.mojom.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef CC_MOJOM_LAYER_TREE_DEBUG_STATE_MOJOM_H_
#define CC_MOJOM_LAYER_TREE_DEBUG_STATE_MOJOM_H_
...
#include "cc/mojom/layer_tree_debug_state.mojom-forward.h"  // IWYU pragma: export
#include <string>
#include <vector>
 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        LayerTreeDebugState::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        LayerTreeDebugState::DataView, std::vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::cc::mojom::LayerTreeDebugState::DataView,
                                         ::cc::mojom::LayerTreeDebugStatePtr> {
  static bool IsNull(const ::cc::mojom::LayerTreeDebugStatePtr& input) { return !input; }
  static void SetToNull(::cc::mojom::LayerTreeDebugStatePtr* output) { output->reset(); }

  static decltype(::cc::mojom::LayerTreeDebugState::debugger_paused) debugger_paused(
      const ::cc::mojom::LayerTreeDebugStatePtr& input) {
    return input->debugger_paused;
  }

  static decltype(::cc::mojom::LayerTreeDebugState::show_fps_counter) show_fps_counter(
      const ::cc::mojom::LayerTreeDebugStatePtr& input) {
    return input->show_fps_counter;
  }

  static decltype(::cc::mojom::LayerTreeDebugState::show_render_pass_borders) show_render_pass_borders(
      const ::cc::mojom::LayerTreeDebugStatePtr& input) {
    return input->show_render_pass_borders;
  }

  static decltype(::cc::mojom::LayerTreeDebugState::show_surface_borders) show_surface_borders(
      const ::cc::mojom::LayerTreeDebugStatePtr& input) {
    return input->show_surface_borders;
  }

  static decltype(::cc::mojom::LayerTreeDebugState::show_layer_borders) show_layer_borders(
      const ::cc::mojom::LayerTreeDebugStatePtr& input) {
    return input->show_layer_borders;
  }

  static decltype(::cc::mojom::LayerTreeDebugState::show_layout_shift_regions) show_layout_shift_regions(
      const ::cc::mojom::LayerTreeDebugStatePtr& input) {
    return input->show_layout_shift_regions;
  }

  static decltype(::cc::mojom::LayerTreeDebugState::show_paint_rects) show_paint_rects(
      const ::cc::mojom::LayerTreeDebugStatePtr& input) {
    return input->show_paint_rects;
  }

  static decltype(::cc::mojom::LayerTreeDebugState::show_contentful_paint_rects) show_contentful_paint_rects(
      const ::cc::mojom::LayerTreeDebugStatePtr& input) {
    return input->show_contentful_paint_rects;
  }

  static decltype(::cc::mojom::LayerTreeDebugState::show_property_changed_rects) show_property_changed_rects(
      const ::cc::mojom::LayerTreeDebugStatePtr& input) {
    return input->show_property_changed_rects;
  }

  static decltype(::cc::mojom::LayerTreeDebugState::show_surface_damage_rects) show_surface_damage_rects(
      const ::cc::mojom::LayerTreeDebugStatePtr& input) {
    return input->show_surface_damage_rects;
  }

  static decltype(::cc::mojom::LayerTreeDebugState::show_screen_space_rects) show_screen_space_rects(
      const ::cc::mojom::LayerTreeDebugStatePtr& input) {
    return input->show_screen_space_rects;
  }

  static decltype(::cc::mojom::LayerTreeDebugState::show_touch_event_handler_rects) show_touch_event_handler_rects(
      const ::cc::mojom::LayerTreeDebugStatePtr& input) {
    return input->show_touch_event_handler_rects;
  }

  static decltype(::cc::mojom::LayerTreeDebugState::show_wheel_event_handler_rects) show_wheel_event_handler_rects(
      const ::cc::mojom::LayerTreeDebugStatePtr& input) {
    return input->show_wheel_event_handler_rects;
  }

  static decltype(::cc::mojom::LayerTreeDebugState::show_scroll_event_handler_rects) show_scroll_event_handler_rects(
      const ::cc::mojom::LayerTreeDebugStatePtr& input) {
    return input->show_scroll_event_handler_rects;
  }

  static decltype(::cc::mojom::LayerTreeDebugState::show_main_thread_scroll_hit_test_rects) show_main_thread_scroll_hit_test_rects(
      const ::cc::mojom::LayerTreeDebugStatePtr& input) {
    return input->show_main_thread_scroll_hit_test_rects;
  }

  static decltype(::cc::mojom::LayerTreeDebugState::show_main_thread_scroll_repaint_rects) show_main_thread_scroll_repaint_rects(
      const ::cc::mojom::LayerTreeDebugStatePtr& input) {
    return input->show_main_thread_scroll_repaint_rects;
  }

  static decltype(::cc::mojom::LayerTreeDebugState::show_raster_inducing_scroll_rects) show_raster_inducing_scroll_rects(
      const ::cc::mojom::LayerTreeDebugStatePtr& input) {
    return input->show_raster_inducing_scroll_rects;
  }

  static decltype(::cc::mojom::LayerTreeDebugState::show_layer_animation_bounds_rects) show_layer_animation_bounds_rects(
      const ::cc::mojom::LayerTreeDebugStatePtr& input) {
    return input->show_layer_animation_bounds_rects;
  }

  static decltype(::cc::mojom::LayerTreeDebugState::slow_down_raster_scale_factor) slow_down_raster_scale_factor(
      const ::cc::mojom::LayerTreeDebugStatePtr& input) {
    return input->slow_down_raster_scale_factor;
  }

  static decltype(::cc::mojom::LayerTreeDebugState::rasterize_only_visible_content) rasterize_only_visible_content(
      const ::cc::mojom::LayerTreeDebugStatePtr& input) {
    return input->rasterize_only_visible_content;
  }

  static decltype(::cc::mojom::LayerTreeDebugState::record_rendering_stats) record_rendering_stats(
      const ::cc::mojom::LayerTreeDebugStatePtr& input) {
    return input->record_rendering_stats;
  }

  static bool Read(::cc::mojom::LayerTreeDebugState::DataView input, ::cc::mojom::LayerTreeDebugStatePtr* output);
};

}  // namespace mojo

#endif  // CC_MOJOM_LAYER_TREE_DEBUG_STATE_MOJOM_H_