...
bool BitmapN32_Data::Validate(
  ...
  [[maybe_unused]] const BitmapN32_Data* object =
      static_cast<const BitmapN32_Data*>(data);
...
bool BitmapWithArbitraryBpp_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const BitmapWithArbitraryBpp_Data* object =
      static_cast<const BitmapWithArbitraryBpp_Data*>(data);
...
bool BitmapMappedFromTrustedProcess_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const BitmapMappedFromTrustedProcess_Data* object =
      static_cast<const BitmapMappedFromTrustedProcess_Data*>(data);
...
bool InlineBitmap_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const InlineBitmap_Data* object =
      static_cast<const InlineBitmap_Data*>(data);
