...
class BLINK_PLATFORM_EXPORT SkColor {
 public:
  template <typename T>
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SkColor::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SkColor::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::skia::mojom::blink::SkColor::DataView,
                                         ::skia::mojom::blink::SkColorPtr> {
  static bool IsNull(const ::skia::mojom::blink::SkColorPtr& input) { return !input; }
  static void SetToNull(::skia::mojom::blink::SkColorPtr* output) { output->reset(); }

  static decltype(::skia::mojom::blink::SkColor::value) value(
      const ::skia::mojom::blink::SkColorPtr& input) {
    return input->value;
  }
