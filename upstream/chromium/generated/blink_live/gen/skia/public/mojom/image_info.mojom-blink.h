...
#include "skia/public/mojom/image_info.mojom-blink-forward.h"  // IWYU pragma: export
...
class BLINK_PLATFORM_EXPORT ImageInfo {
 public:
  template <typename T>
  ...
  ImageInfo(
      ...
      uint32_t width,
      uint32_t height,
      std::optional<::blink::Vector<float>> color_transfer_function,
      std::optional<::blink::Vector<float>> color_to_xyz_matrix);
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ImageInfo::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ImageInfo::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
class BLINK_PLATFORM_EXPORT BitmapN32ImageInfo {
 public:
  template <typename T>
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        BitmapN32ImageInfo::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        BitmapN32ImageInfo::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::skia::mojom::blink::ImageInfo::DataView,
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::skia::mojom::blink::BitmapN32ImageInfo::DataView,
                                         ::skia::mojom::blink::BitmapN32ImageInfoPtr> {
  static bool IsNull(const ::skia::mojom::blink::BitmapN32ImageInfoPtr& input) { return !input; }
  static void SetToNull(::skia::mojom::blink::BitmapN32ImageInfoPtr* output) { output->reset(); }

  static decltype(::skia::mojom::blink::BitmapN32ImageInfo::alpha_type) alpha_type(
      const ::skia::mojom::blink::BitmapN32ImageInfoPtr& input) {
    return input->alpha_type;
  }

  static decltype(::skia::mojom::blink::BitmapN32ImageInfo::width) width(
      const ::skia::mojom::blink::BitmapN32ImageInfoPtr& input) {
    return input->width;
  }

  static decltype(::skia::mojom::blink::BitmapN32ImageInfo::height) height(
      const ::skia::mojom::blink::BitmapN32ImageInfoPtr& input) {
    return input->height;
  }

  static const decltype(::skia::mojom::blink::BitmapN32ImageInfo::color_transfer_function)& color_transfer_function(
      const ::skia::mojom::blink::BitmapN32ImageInfoPtr& input) {
    return input->color_transfer_function;
  }

  static const decltype(::skia::mojom::blink::BitmapN32ImageInfo::color_to_xyz_matrix)& color_to_xyz_matrix(
      const ::skia::mojom::blink::BitmapN32ImageInfoPtr& input) {
    return input->color_to_xyz_matrix;
  }

  static bool Read(::skia::mojom::blink::BitmapN32ImageInfo::DataView input, ::skia::mojom::blink::BitmapN32ImageInfoPtr* output);
};
