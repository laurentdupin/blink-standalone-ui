...
#include "skia/public/mojom/tile_mode.mojom-data-view.h"  // IWYU pragma: export
...
struct Serializer<::skia::mojom::TileMode, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::skia::mojom::TileMode>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::skia::mojom::TileMode, UserType> ||
                        HasInfallibleConversion(::skia::mojom::TileMode()),
                    "::skia::mojom::TileMode does not have an infallible conversion, "
