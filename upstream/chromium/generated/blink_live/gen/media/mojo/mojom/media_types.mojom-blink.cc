...
OverlayInfo::OverlayInfo(
    const std::optional<::base::UnguessableToken>& routing_token_in,
    bool is_fullscreen_in,
    bool is_persistent_video_in)
    : routing_token(std::move(routing_token_in)),
      is_fullscreen(std::move(is_fullscreen_in)),
      is_persistent_video(std::move(is_persistent_video_in)) {}

OverlayInfo::~OverlayInfo() = default;

void OverlayInfo::WriteIntoTrace(
    perfetto::TracedValue traced_context) const {
  [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "is_persistent_video"), this->is_persistent_video,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type bool>"
#else
      "<value>"
...
size_t VideoAspectRatio::Hash(size_t seed) const {
...
VideoColorSpace::VideoColorSpace(
    ...
    ::gfx::mojom::blink::ColorSpaceRangeID range_in)
...
void VideoColorSpace::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "range"), this->range,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::gfx::mojom::blink::ColorSpaceRangeID>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
VideoDecoderConfig::VideoDecoderConfig(
    ...
    VideoAspectRatioPtr aspect_ratio_in,
    ::blink::Vector<uint8_t> extra_data_in,
    EncryptionScheme encryption_scheme_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type VideoAspectRatioPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
DecryptConfig::DecryptConfig(
    ...
    ::blink::Vector<SubsampleEntryPtr> subsamples_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<SubsampleEntryPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
DecoderBufferSideData::DecoderBufferSideData(
    ::blink::Vector<uint32_t> spatial_layers_in,
    ::blink::Vector<uint8_t> alpha_data_in,
    const ::gfx::HDRMetadata& hdr_metadata_in,
...
AudioBuffer::AudioBuffer(
    SampleFormat sample_format_in,
    ::media::mojom::blink::ChannelLayout channel_layout_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::media::mojom::blink::ChannelLayout>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
size_t CaptureVersion::Hash(size_t seed) const {
  seed = mojo::internal::WTFHash(seed, this->source);
  seed = mojo::internal::WTFHash(seed, this->sub_capture);
  return seed;
}
...
VideoFrameMetadata::VideoFrameMetadata(
    ...
    std::optional<int32_t> capture_counter_in,
    ...
    CaptureVersionPtr capture_version_in,
    bool copy_required_in,
    bool end_of_stream_in,
    std::optional<::base::TimeDelta> frame_duration_in,
    std::optional<double> frame_rate_in,
    ...
    std::optional<double> device_scale_factor_in,
    std::optional<double> page_scale_factor_in,
    std::optional<double> root_scroll_offset_x_in,
    std::optional<double> root_scroll_offset_y_in,
    std::optional<double> top_controls_visible_height_in,
    ...
    std::optional<double> rtp_timestamp_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type CaptureVersionPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
SharedMemoryVideoFrameData::SharedMemoryVideoFrameData(
    ...
    ::blink::Vector<uint32_t> strides_in,
    ::blink::Vector<uint32_t> offsets_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::gpu::mojom::blink::ExportedSharedImagePtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
StatusData::StatusData(
    const ::blink::String& group_in,
    uint16_t code_in,
    const ::blink::String& message_in,
    ::base::ListValue frames_in,
...
void DecoderBufferSideDataNextConfig::set_next_audio_config(AudioDecoderConfigPtr next_audio_config) {
  if (tag_ == Tag::kNextAudioConfig) {
    data_.next_audio_config = std::move(next_audio_config);
  } else {
    DestroyActive();
    tag_ = Tag::kNextAudioConfig;
    new (&data_.next_audio_config) AudioDecoderConfigPtr(
        std::move(next_audio_config));
  }
}

void DecoderBufferSideDataNextConfig::set_next_video_config(VideoDecoderConfigPtr next_video_config) {
  if (tag_ == Tag::kNextVideoConfig) {
    data_.next_video_config = std::move(next_video_config);
  } else {
    DestroyActive();
    tag_ = Tag::kNextVideoConfig;
    new (&data_.next_video_config) VideoDecoderConfigPtr(
...
// static
bool StructTraits<::media::mojom::blink::OverlayInfo::DataView, ::media::mojom::blink::OverlayInfoPtr>::Read(
    ::media::mojom::blink::OverlayInfo::DataView input,
    ::media::mojom::blink::OverlayInfoPtr* output) {
  bool success = true;
  ::media::mojom::blink::OverlayInfoPtr result(::media::mojom::blink::OverlayInfo::New());
  
      if (success && !input.ReadRoutingToken(&result->routing_token))
        success = false;
      if (success)
        result->is_fullscreen = input.is_fullscreen();
      if (success)
        result->is_persistent_video = input.is_persistent_video();
  *output = std::move(result);
  return success;
}
...
// static
bool StructTraits<::media::mojom::blink::VideoAspectRatio::DataView, ::media::mojom::blink::VideoAspectRatioPtr>::Read(
    ::media::mojom::blink::VideoAspectRatio::DataView input,
    ::media::mojom::blink::VideoAspectRatioPtr* output) {
  bool success = true;
  ::media::mojom::blink::VideoAspectRatioPtr result(::media::mojom::blink::VideoAspectRatio::New());
...
// static
bool StructTraits<::media::mojom::blink::DecoderBufferSideData::DataView, ::media::mojom::blink::DecoderBufferSideDataPtr>::Read(
    ::media::mojom::blink::DecoderBufferSideData::DataView input,
    ::media::mojom::blink::DecoderBufferSideDataPtr* output) {
  bool success = true;
  ::media::mojom::blink::DecoderBufferSideDataPtr result(::media::mojom::blink::DecoderBufferSideData::New());
...
// static
bool StructTraits<::media::mojom::blink::DataDecoderBuffer::DataView, ::media::mojom::blink::DataDecoderBufferPtr>::Read(
    ::media::mojom::blink::DataDecoderBuffer::DataView input,
    ::media::mojom::blink::DataDecoderBufferPtr* output) {
  bool success = true;
  ::media::mojom::blink::DataDecoderBufferPtr result(::media::mojom::blink::DataDecoderBuffer::New());
...
// static
bool StructTraits<::media::mojom::blink::EosDecoderBuffer::DataView, ::media::mojom::blink::EosDecoderBufferPtr>::Read(
    ::media::mojom::blink::EosDecoderBuffer::DataView input,
    ::media::mojom::blink::EosDecoderBufferPtr* output) {
  bool success = true;
  ::media::mojom::blink::EosDecoderBufferPtr result(::media::mojom::blink::EosDecoderBuffer::New());
...
// static
bool StructTraits<::media::mojom::blink::CaptureVersion::DataView, ::media::mojom::blink::CaptureVersionPtr>::Read(
    ::media::mojom::blink::CaptureVersion::DataView input,
    ::media::mojom::blink::CaptureVersionPtr* output) {
  bool success = true;
  ::media::mojom::blink::CaptureVersionPtr result(::media::mojom::blink::CaptureVersion::New());
...
bool StructTraits<::media::mojom::blink::SharedMemoryVideoFrameData::DataView, ::media::mojom::blink::SharedMemoryVideoFrameDataPtr>::Read(
    ::media::mojom::blink::SharedMemoryVideoFrameData::DataView input,
    ::media::mojom::blink::SharedMemoryVideoFrameDataPtr* output) {
  bool success = true;
...
// static
bool StructTraits<::media::mojom::blink::SharedImageVideoFrameData::DataView, ::media::mojom::blink::SharedImageVideoFrameDataPtr>::Read(
    ::media::mojom::blink::SharedImageVideoFrameData::DataView input,
    ::media::mojom::blink::SharedImageVideoFrameDataPtr* output) {
  bool success = true;
  ::media::mojom::blink::SharedImageVideoFrameDataPtr result(::media::mojom::blink::SharedImageVideoFrameData::New());
      ...
      if (success && !input.ReadSyncToken(&result->sync_token))
        success = false;
      if (success)
        result->is_mappable = input.is_mappable();
  *output = std::move(result);
  return success;
}
...
// static
bool StructTraits<::media::mojom::blink::OpaqueVideoFrameData::DataView, ::media::mojom::blink::OpaqueVideoFrameDataPtr>::Read(
    ::media::mojom::blink::OpaqueVideoFrameData::DataView input,
    ::media::mojom::blink::OpaqueVideoFrameDataPtr* output) {
  bool success = true;
  ::media::mojom::blink::OpaqueVideoFrameDataPtr result(::media::mojom::blink::OpaqueVideoFrameData::New());
...
// static
bool StructTraits<::media::mojom::blink::AutoPipInfo::DataView, ::media::mojom::blink::AutoPipInfoPtr>::Read(
    ::media::mojom::blink::AutoPipInfo::DataView input,
    ::media::mojom::blink::AutoPipInfoPtr* output) {
  bool success = true;
  ::media::mojom::blink::AutoPipInfoPtr result(::media::mojom::blink::AutoPipInfo::New());
...
// static
bool UnionTraits<::media::mojom::blink::DecoderBufferSideDataNextConfig::DataView, ::media::mojom::blink::DecoderBufferSideDataNextConfigPtr>::Read(
    ::media::mojom::blink::DecoderBufferSideDataNextConfig::DataView input,
    ::media::mojom::blink::DecoderBufferSideDataNextConfigPtr* output) {
  using UnionType = ::media::mojom::blink::DecoderBufferSideDataNextConfig;
  using Tag = UnionType::Tag;

  switch (input.tag()) {
    case Tag::kNextAudioConfig: {
      ::media::mojom::blink::AudioDecoderConfigPtr result_next_audio_config{};
    ...
    case Tag::kNextVideoConfig: {
      ::media::mojom::blink::VideoDecoderConfigPtr result_next_video_config{};
...
// static
bool UnionTraits<::media::mojom::blink::DecoderBuffer::DataView, ::media::mojom::blink::DecoderBufferPtr>::Read(
    ::media::mojom::blink::DecoderBuffer::DataView input,
    ::media::mojom::blink::DecoderBufferPtr* output) {
  using UnionType = ::media::mojom::blink::DecoderBuffer;
  using Tag = UnionType::Tag;

  switch (input.tag()) {
    case Tag::kEos: {
      ::media::mojom::blink::EosDecoderBufferPtr result_eos{};
    ...
    case Tag::kData: {
      ::media::mojom::blink::DataDecoderBufferPtr result_data{};
...
bool UnionTraits<::media::mojom::blink::VideoFrameData::DataView, ::media::mojom::blink::VideoFrameDataPtr>::Read(
  ...
  switch (input.tag()) {
    ...
    case Tag::kSharedImageData: {
      ::media::mojom::blink::SharedImageVideoFrameDataPtr result_shared_image_data{};
    ...
    case Tag::kOpaqueData: {
      ::media::mojom::blink::OpaqueVideoFrameDataPtr result_opaque_data{};
