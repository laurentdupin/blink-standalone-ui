// media/mojo/mojom/channel_layout.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "media/mojo/mojom/channel_layout.mojom-blink-import-headers.h"
#include "media/mojo/mojom/channel_layout.mojom-blink-test-utils.h"
...
size_t ChannelLayoutConfig::Hash(size_t seed) const {
  ...
  switch (tag_) {
    ...
    case Tag::kPredefinedLayout:
      return mojo::internal::WTFHash(seed, data_.predefined_layout);
    case Tag::kDiscreteChannels:
      return mojo::internal::WTFHash(seed, data_.discrete_channels);
    default:
      NOTREACHED();
  }
}
...
// static
bool UnionTraits<::media::mojom::blink::ChannelLayoutConfig::DataView, ::media::mojom::blink::ChannelLayoutConfigPtr>::Read(
    ::media::mojom::blink::ChannelLayoutConfig::DataView input,
    ::media::mojom::blink::ChannelLayoutConfigPtr* output) {
  using UnionType = ::media::mojom::blink::ChannelLayoutConfig;
  using Tag = UnionType::Tag;

  switch (input.tag()) {
    case Tag::kPredefinedLayout: {
      ::media::mojom::blink::ChannelLayout result_predefined_layout;
