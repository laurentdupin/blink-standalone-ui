...
class  MediaPlayerObserverInterceptorForTesting : public MediaPlayerObserver {
  ...
  void OnMediaMetadataChanged(bool has_audio, bool has_video, ::media::mojom::blink::MediaContentType content_type) override;
  void OnMediaPositionStateChanged(::media_session::mojom::blink::MediaPositionPtr media_position) override;
  void OnMediaEffectivelyFullscreenChanged(::media::mojom::blink::FullscreenVideoStatus status) override;
