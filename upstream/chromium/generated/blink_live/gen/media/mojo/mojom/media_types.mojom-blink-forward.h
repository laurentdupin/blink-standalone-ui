...
using DemuxerType = DemuxerType;
using CreateCdmStatus = CreateCdmStatus;
using AutoPipReason = AutoPipReason;
...
using CaptureVersionPtr = mojo::InlinedStructPtr<CaptureVersion>;
...
class AutoPipInfo;
using AutoPipInfoPtr = mojo::StructPtr<AutoPipInfo>;
