...
bool MediaPlayer_RequestMediaRemoting_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const MediaPlayer_RequestMediaRemoting_Params_Data* object =
      static_cast<const MediaPlayer_RequestMediaRemoting_Params_Data*>(data);
...
bool MediaPlayer_RequestVisibility_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const MediaPlayer_RequestVisibility_Params_Data* object =
      static_cast<const MediaPlayer_RequestVisibility_Params_Data*>(data);
...
// static
bool MediaPlayer_RecordAutoPictureInPictureInfo_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const MediaPlayer_RecordAutoPictureInPictureInfo_Params_Data* object =
      static_cast<const MediaPlayer_RecordAutoPictureInPictureInfo_Params_Data*>(data);

  if (!mojo::internal::ValidatePointerNonNullable(
          object->auto_picture_in_picture_info, 1, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateStruct(object->auto_picture_in_picture_info, validation_context))
    return false;

  return true;
}

MediaPlayer_RecordAutoPictureInPictureInfo_Params_Data::MediaPlayer_RecordAutoPictureInPictureInfo_Params_Data()
    : header_({sizeof(*this), 0}) {}
...
bool MediaPlayerObserver_OnAudioOutputSinkChanged_Params_Data::Validate(
  ...
  constexpr const mojo::internal::ContainerValidateParams& hashed_device_id_validate_params =
      mojo::internal::GetArrayValidator<0, false, nullptr>();
...
bool MediaPlayerObserver_OnRemotePlaybackMetadataChange_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->remote_playback_metadata, 1, validation_context)) {
    return false;
  }
