...
#include "media/mojo/mojom/media_player.mojom-blink-forward.h"  // IWYU pragma: export
...
// with not having this data in traces there.
  ...
  virtual void RequestPlay(bool triggered_by_user) = 0;
  ...
  virtual void SetAudioSinkId(const ::blink::String& sink_id) = 0;
...
// with not having this data in traces there.
  ...
  virtual void OnMediaMetadataChanged(bool has_audio, bool has_video, ::media::mojom::blink::MediaContentType content_type) = 0;

  virtual void OnMediaPositionStateChanged(::media_session::mojom::blink::MediaPositionPtr media_position) = 0;

  virtual void OnMediaEffectivelyFullscreenChanged(::media::mojom::blink::FullscreenVideoStatus status) = 0;

  virtual void OnMediaSizeChanged(const ::gfx::Size& size) = 0;

  virtual void OnPictureInPictureAvailabilityChanged(bool available) = 0;

  virtual void OnAudioOutputSinkChanged(const ::blink::String& hashed_device_id) = 0;

  virtual void OnUseAudioServiceChanged(bool uses_audio_service) = 0;

  virtual void OnAudioOutputSinkChangingDisabled() = 0;

  virtual void OnRemotePlaybackMetadataChange(::media_session::mojom::blink::RemotePlaybackMetadataPtr remote_playback_metadata) = 0;
...
class  MediaPlayerProxy
 ...
 public:
  ...
  void RequestPlay(bool triggered_by_user) final;
  ...
  void SetAudioSinkId(const ::blink::String& sink_id) final;
...
class  MediaPlayerObserverProxy
 ...
 public:
  ...
  void OnMediaMetadataChanged(bool has_audio, bool has_video, ::media::mojom::blink::MediaContentType content_type) final;
  
  void OnMediaPositionStateChanged(::media_session::mojom::blink::MediaPositionPtr media_position) final;
  
  void OnMediaEffectivelyFullscreenChanged(::media::mojom::blink::FullscreenVideoStatus status) final;
  
  void OnMediaSizeChanged(const ::gfx::Size& size) final;
  
  void OnPictureInPictureAvailabilityChanged(bool available) final;
  
  void OnAudioOutputSinkChanged(const ::blink::String& hashed_device_id) final;
  
  void OnUseAudioServiceChanged(bool uses_audio_service) final;
  
  void OnAudioOutputSinkChangingDisabled() final;
  
  void OnRemotePlaybackMetadataChange(::media_session::mojom::blink::RemotePlaybackMetadataPtr remote_playback_metadata) final;
