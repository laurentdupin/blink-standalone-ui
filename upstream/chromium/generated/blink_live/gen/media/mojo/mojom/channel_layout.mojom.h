// media/mojo/mojom/channel_layout.mojom.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef MEDIA_MOJO_MOJOM_CHANNEL_LAYOUT_MOJOM_H_
#define MEDIA_MOJO_MOJOM_CHANNEL_LAYOUT_MOJOM_H_
...
#include "media/mojo/mojom/channel_layout.mojom-forward.h"  // IWYU pragma: export
#include <string>
#include <vector>
...
template <>
struct  UnionTraits<::media::mojom::ChannelLayoutConfig::DataView,
                                        ::media::mojom::ChannelLayoutConfigPtr> {
  static bool IsNull(const ::media::mojom::ChannelLayoutConfigPtr& input) { return !input; }
  static void SetToNull(::media::mojom::ChannelLayoutConfigPtr* output) { output->reset(); }

  static ::media::mojom::ChannelLayoutConfig::Tag GetTag(const ::media::mojom::ChannelLayoutConfigPtr& input) {
    return input->which();
  }

  static  ::media::mojom::ChannelLayout predefined_layout(const ::media::mojom::ChannelLayoutConfigPtr& input) {
    return input->get_predefined_layout();
  }

  static  uint32_t discrete_channels(const ::media::mojom::ChannelLayoutConfigPtr& input) {
    return input->get_discrete_channels();
  }

  static bool Read(::media::mojom::ChannelLayoutConfig::DataView input, ::media::mojom::ChannelLayoutConfigPtr* output);
};

}  // namespace mojo

#endif  // MEDIA_MOJO_MOJOM_CHANNEL_LAYOUT_MOJOM_H_