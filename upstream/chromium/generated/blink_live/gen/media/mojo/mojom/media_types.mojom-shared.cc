...
NOINLINE static const char* InputStreamErrorCodeToStringHelper(InputStreamErrorCode value) {
  ...
  switch(value) {
    ...
    case InputStreamErrorCode::kDeviceInUse:
      return "kDeviceInUse";
    case InputStreamErrorCode::kSocketError:
      return "kSocketError";
    default:
      return nullptr;
  }
...
bool VideoFrameData_Data::Validate(
  ...
  switch (object->tag) {
    ...
    case VideoFrameData_Tag::kSharedImageData: {
      ...
      if (!mojo::internal::ValidatePointerNonNullable(
              object->data.f_shared_image_data, 3, validation_context)) {
        return false;
      }
    ...
    case VideoFrameData_Tag::kOpaqueData: {
      ...
      if (!mojo::internal::ValidatePointerNonNullable(
              object->data.f_opaque_data, 4, validation_context)) {
        return false;
      }
...
bool AudioDecoderConfig_Data::Validate(
  ...
  if (!mojo::internal::ValidateInlinedUnionNonNullable(
          object->channel_layout_config, 3, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateInlinedUnion(object->channel_layout_config, validation_context))
    return false;
  ...
  if (!mojo::internal::ValidateInlinedUnionNonNullable(
          object->target_output_channel_layout, 10, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateInlinedUnion(object->target_output_channel_layout, validation_context))
    return false;
...
bool VideoDecoderConfig_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->hdr_metadata, 13, validation_context)) {
    return false;
  }
...
bool DecoderBufferSideData_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->hdr_metadata, 3, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateStruct(object->hdr_metadata, validation_context))
    return false;
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->front_discard, 5, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->back_discard, 6, validation_context)) {
    return false;
  }
...
bool VideoFrame_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->hdr_metadata, 9, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateStruct(object->hdr_metadata, validation_context))
    return false;
...
// static
void TraceFormatTraits<::media::mojom::CdmEvent>::WriteIntoTrace(
   perfetto::TracedValue context, ::media::mojom::CdmEvent value) {
