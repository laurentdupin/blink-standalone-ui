...
static_assert(sizeof(OverlayInfo_Data) == 24,
...
class  AudioDecoderConfig_Data {
 public:
  ...
  ::media::mojom::internal::ChannelLayoutConfig_Data channel_layout_config;
  ...
  int32_t codec_delay;
  int32_t profile;
  ::media::mojom::internal::ChannelLayoutConfig_Data target_output_channel_layout;
...
static_assert(sizeof(AudioDecoderConfig_Data) == 88,
...
static_assert(sizeof(DecoderBufferSideData_Data) == 56,
...
class  CaptureVersion_Data {
 ...
 private:
  friend class mojo::internal::MessageFragment<CaptureVersion_Data>;

  CaptureVersion_Data();
  ~CaptureVersion_Data() = delete;
};
static_assert(sizeof(CaptureVersion_Data) == 16,
              "Bad sizeof(CaptureVersion_Data)");
// Used by CaptureVersion::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView>
struct CaptureVersion_UnserializedMessageContext
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  CaptureVersion_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
      , user_data_(std::move(input)) {}
  ~CaptureVersion_UnserializedMessageContext() override = default;
 ...
 private:
  // mojo::internal::UnserializedMessageContext:
  void Serialize(mojo::Message& message) override {
    mojo::internal::MessageFragment<CaptureVersion_Data> fragment(message);
    mojo::internal::Serialize<DataView>(user_data_, fragment);
  }
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag
    CaptureVersion_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
class  VideoFrameMetadata_Data {
 public:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
  ...
  uint8_t capture_counter_$flag : 1;
  uint8_t copy_required : 1;
  uint8_t end_of_stream : 1;
  uint8_t frame_rate_$flag : 1;
  ...
  uint8_t device_scale_factor_$flag : 1;
  uint8_t page_scale_factor_$flag : 1;
  uint8_t root_scroll_offset_x_$flag : 1;
  uint8_t root_scroll_offset_y_$flag : 1;
  uint8_t top_controls_visible_height_$flag : 1;
  uint8_t rtp_timestamp_$flag : 1;
  uint8_t frame_sequence_$flag : 1;
  uint8_t source_id_$flag : 1;
  uint8_t pad21_[1];
  int32_t capture_counter_$value;
  ...
  mojo::internal::Pointer<internal::CaptureVersion_Data> capture_version;
  mojo::internal::Pointer<::mojo_base::mojom::internal::TimeDelta_Data> frame_duration;
  double frame_rate_$value;
  ...
  double device_scale_factor_$value;
  double page_scale_factor_$value;
  double root_scroll_offset_x_$value;
  double root_scroll_offset_y_$value;
  double top_controls_visible_height_$value;
...
static_assert(sizeof(VideoFrameMetadata_Data) == 216,
