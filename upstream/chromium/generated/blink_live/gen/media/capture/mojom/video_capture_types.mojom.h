...
#include "media/capture/mojom/video_capture_types.mojom-forward.h"  // IWYU pragma: export
 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VideoCaptureControlSupport::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
class  VideoCaptureFormat {
 public:
  ...
  VideoCaptureFormat(
      ::gfx::mojom::SizePtr frame_size,
      float frame_rate,
      VideoCapturePixelFormat pixel_format);

VideoCaptureFormat(const VideoCaptureFormat&) = delete;
VideoCaptureFormat& operator=(const VideoCaptureFormat&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VideoCaptureFormat::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
class  VideoCaptureParams {
 public:
  ...
  VideoCaptureParams(
      ...
      CaptureSourceRequestType request_type);
...
VideoCaptureParams& operator=(const VideoCaptureParams&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VideoCaptureParams::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
class  VideoCaptureFeedback {
 public:
  ...
  VideoCaptureFeedback(
      ...
      std::optional<std::vector<::gfx::mojom::SizePtr>> DEPRECATED_mapped_sizes,
      std::optional<int32_t> frame_id);

VideoCaptureFeedback(const VideoCaptureFeedback&) = delete;
VideoCaptureFeedback& operator=(const VideoCaptureFeedback&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VideoCaptureFeedback::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
class  PlaneStrides {
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        PlaneStrides::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
class  VideoCaptureDeviceDescriptor {
 public:
  ...
  VideoCaptureDeviceDescriptor(
      ...
      VideoCaptureControlSupportPtr control_support,
      VideoCaptureTransportType transport_type,
      std::optional<CameraAvailability> availability);

VideoCaptureDeviceDescriptor(const VideoCaptureDeviceDescriptor&) = delete;
VideoCaptureDeviceDescriptor& operator=(const VideoCaptureDeviceDescriptor&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VideoCaptureDeviceDescriptor::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
class  VideoCaptureDeviceInfo {
 public:
  ...
  VideoCaptureDeviceInfo(
      ...
      std::vector<VideoCaptureFormatPtr> supported_formats);

VideoCaptureDeviceInfo(const VideoCaptureDeviceInfo&) = delete;
VideoCaptureDeviceInfo& operator=(const VideoCaptureDeviceInfo&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        VideoCaptureDeviceInfo::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
VideoCaptureParamsPtr VideoCaptureParams::Clone() const {
  return New(
      ...
      mojo::Clone(capture_version_source),
...
bool VideoCaptureParams::Equals(const T& other_struct) const {
  ...
  if (!mojo::Equals(this->is_high_dpi_enabled, other_struct.is_high_dpi_enabled))
    return false;
  if (!mojo::Equals(this->capture_version_source, other_struct.capture_version_source))
    return false;
...
bool operator<(const T& lhs, const T& rhs) {
  ...
  if (rhs.is_high_dpi_enabled < lhs.is_high_dpi_enabled)
    return false;
  if (lhs.capture_version_source < rhs.capture_version_source)
    return true;
  if (rhs.capture_version_source < lhs.capture_version_source)
    return false;
...
struct  StructTraits<::media::mojom::VideoCaptureParams::DataView,
  ...
  static decltype(::media::mojom::VideoCaptureParams::capture_version_source) capture_version_source(
      const ::media::mojom::VideoCaptureParamsPtr& input) {
    return input->capture_version_source;
  }

  static decltype(::media::mojom::VideoCaptureParams::request_type) request_type(
      const ::media::mojom::VideoCaptureParamsPtr& input) {
