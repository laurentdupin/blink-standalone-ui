...
#include "media/capture/mojom/video_capture_buffer.mojom-test-utils.h"
...
VideoFrameInfo::VideoFrameInfo(
    ...
    ::media::mojom::VideoFrameMetadataPtr metadata_in,
    ::media::mojom::VideoCapturePixelFormat pixel_format_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::media::mojom::VideoFrameMetadataPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::media::mojom::VideoCapturePixelFormat>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
void VideoBufferHandle::set_unsafe_shmem_region(::mojo_base::mojom::UnsafeSharedMemoryRegionPtr unsafe_shmem_region) {
  if (tag_ == Tag::kUnsafeShmemRegion) {
    data_.unsafe_shmem_region = std::move(unsafe_shmem_region);
  } else {
    DestroyActive();
    tag_ = Tag::kUnsafeShmemRegion;
    new (&data_.unsafe_shmem_region) ::mojo_base::mojom::UnsafeSharedMemoryRegionPtr(
        std::move(unsafe_shmem_region));
  }
}

void VideoBufferHandle::set_read_only_shmem_region(::mojo_base::mojom::ReadOnlySharedMemoryRegionPtr read_only_shmem_region) {
  if (tag_ == Tag::kReadOnlyShmemRegion) {
    data_.read_only_shmem_region = std::move(read_only_shmem_region);
  } else {
    DestroyActive();
    tag_ = Tag::kReadOnlyShmemRegion;
    new (&data_.read_only_shmem_region) ::mojo_base::mojom::ReadOnlySharedMemoryRegionPtr(
...
void VideoBufferHandle::set_gpu_memory_buffer_handle(::gfx::mojom::GpuMemoryBufferHandlePtr gpu_memory_buffer_handle) {
  if (tag_ == Tag::kGpuMemoryBufferHandle) {
    data_.gpu_memory_buffer_handle = std::move(gpu_memory_buffer_handle);
  } else {
    DestroyActive();
    tag_ = Tag::kGpuMemoryBufferHandle;
    new (&data_.gpu_memory_buffer_handle) ::gfx::mojom::GpuMemoryBufferHandlePtr(
...
// static
bool StructTraits<::media::mojom::SharedImageBufferHandleSet::DataView, ::media::mojom::SharedImageBufferHandleSetPtr>::Read(
    ::media::mojom::SharedImageBufferHandleSet::DataView input,
    ::media::mojom::SharedImageBufferHandleSetPtr* output) {
  bool success = true;
  ::media::mojom::SharedImageBufferHandleSetPtr result(::media::mojom::SharedImageBufferHandleSet::New());
...
bool UnionTraits<::media::mojom::VideoBufferHandle::DataView, ::media::mojom::VideoBufferHandlePtr>::Read(
  ...
  switch (input.tag()) {
    case Tag::kUnsafeShmemRegion: {
      ::mojo_base::mojom::UnsafeSharedMemoryRegionPtr result_unsafe_shmem_region{};
    ...
    case Tag::kReadOnlyShmemRegion: {
      ::mojo_base::mojom::ReadOnlySharedMemoryRegionPtr result_read_only_shmem_region{};
    ...
    case Tag::kSharedImageHandle: {
      ::media::mojom::SharedImageBufferHandleSetPtr result_shared_image_handle{};
    ...
    case Tag::kGpuMemoryBufferHandle: {
      ::gfx::mojom::GpuMemoryBufferHandlePtr result_gpu_memory_buffer_handle{};
