...
NOINLINE static const char* CaptureSourceRequestTypeToStringHelper(CaptureSourceRequestType value) {
  // Defined in a helper function to ensure that Clang generates a lookup table.
  switch(value) {
    case CaptureSourceRequestType::kUnknown:
      return "kUnknown";
    case CaptureSourceRequestType::kGetUserMedia:
      return "kGetUserMedia";
    case CaptureSourceRequestType::kGetDisplayMedia:
...
std::string CaptureSourceRequestTypeToString(CaptureSourceRequestType value) {
  const char *str = CaptureSourceRequestTypeToStringHelper(value);
  if (!str) {
    return base::StringPrintf("Unknown CaptureSourceRequestType value: %i", static_cast<int32_t>(value));
  }
  return str;
}

std::ostream& operator<<(std::ostream& os, CaptureSourceRequestType value) {
  return os << CaptureSourceRequestTypeToString(value);
}
...
bool VideoCaptureParams_Data::Validate(
  ...
  if (!::media::mojom::internal::CaptureSourceRequestType_Data
...
// static
void TraceFormatTraits<::media::mojom::CaptureSourceRequestType>::WriteIntoTrace(
   perfetto::TracedValue context, ::media::mojom::CaptureSourceRequestType value) {
  return std::move(context).WriteString(::media::mojom::CaptureSourceRequestTypeToString(value));
}
