...
const char* V8Mapper::GetHumanReadableName() const {
  return "V8Mapper";
}
...
base::expected<ScriptValue, ScriptValue> V8Mapper::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const ScriptValue& arg1_element, uint64_t arg2_index) {
