...
class MODULES_EXPORT V8RTCIceGatheringState final : public bindings::EnumerationBase {
  
  public:
enum class Enum : enum_int_t {
kNew, kGathering, kComplete
};
static constexpr size_t kEnumSize = 3;

static V8RTCIceGatheringState Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8RTCIceGatheringState> Create(const String& value);

explicit constexpr  V8RTCIceGatheringState(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8RTCIceGatheringState& lhs, V8RTCIceGatheringState::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8RTCIceGatheringState::Enum lhs, const V8RTCIceGatheringState& rhs) {
