...
const WrapperTypeInfo V8SVGNumberList::wrapper_type_info_{
    ...
    "SVGNumberList",
    nullptr,
    V8SVGNumberList::kThisTag,
    V8SVGNumberList::kMaxSubclassTag,
...
v8::Intercepted V8SVGNumberList::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
SVGNumberListTearOff* blink_receiver = V8SVGNumberList::ToWrappableUnsafe(isolate, v8_receiver);
...
v8::Intercepted V8SVGNumberList::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
...
v8::Intercepted V8SVGNumberList::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
...
v8::Intercepted V8SVGNumberList::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
...
return V8SVGNumberList::IndexedPropertySetterCallback(
    index,
...
v8::Intercepted V8SVGNumberList::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
void V8SVGNumberList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGNumberList", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGNumberList", kOperationTable);
}
