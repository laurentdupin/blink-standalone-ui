...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_DOM_STRING_LIST_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_DOM_STRING_LIST_H_
...
class CORE_EXPORT V8DOMStringList final : public bindings::V8InterfaceBridge<V8DOMStringList, DOMStringList> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(370);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class DOMStringList;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_DOM_STRING_LIST_H_
