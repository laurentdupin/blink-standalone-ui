...
v8::Local<v8::Value> V8UnionAudioTrackOrTextTrackOrVideoTrack::DirectToV8(ScriptState* script_state, AudioTrack* value) {
  return ToV8Traits<AudioTrack>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionAudioTrackOrTextTrackOrVideoTrack::DirectToV8(ScriptState* script_state, TextTrack* value) {
  return ToV8Traits<TextTrack>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionAudioTrackOrTextTrackOrVideoTrack::DirectToV8(ScriptState* script_state, VideoTrack* value) {
  return ToV8Traits<VideoTrack>::ToV8(script_state, value);
}
