...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SMART_CARD_RESOURCE_MANAGER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SMART_CARD_RESOURCE_MANAGER_H_
...
class MODULES_EXPORT V8SmartCardResourceManager final : public bindings::V8InterfaceBridge<V8SmartCardResourceManager, SmartCardResourceManager> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1463);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SmartCardResourceManager;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SMART_CARD_RESOURCE_MANAGER_H_
