...
class MODULES_EXPORT V8PaymentComplete final : public bindings::EnumerationBase {
  
  public:
enum class Enum : enum_int_t {
kFail, kSuccess, kUnknown
};
static constexpr size_t kEnumSize = 3;

static V8PaymentComplete Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8PaymentComplete> Create(const String& value);

explicit constexpr  V8PaymentComplete(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8PaymentComplete& lhs, V8PaymentComplete::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8PaymentComplete::Enum lhs, const V8PaymentComplete& rhs) {
