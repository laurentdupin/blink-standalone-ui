...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DEVICE_MOTION_EVENT_ACCELERATION_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DEVICE_MOTION_EVENT_ACCELERATION_H_
...
class MODULES_EXPORT V8DeviceMotionEventAcceleration final : public bindings::V8InterfaceBridge<V8DeviceMotionEventAcceleration, DeviceMotionEventAcceleration> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1139);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class DeviceMotionEventAcceleration;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DEVICE_MOTION_EVENT_ACCELERATION_H_
