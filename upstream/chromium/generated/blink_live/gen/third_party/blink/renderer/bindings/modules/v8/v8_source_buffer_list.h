...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SOURCE_BUFFER_LIST_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SOURCE_BUFFER_LIST_H_
...
class MODULES_EXPORT V8SourceBufferList final : public bindings::V8InterfaceBridge<V8SourceBufferList, SourceBufferList> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(790);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SOURCE_BUFFER_LIST_H_
