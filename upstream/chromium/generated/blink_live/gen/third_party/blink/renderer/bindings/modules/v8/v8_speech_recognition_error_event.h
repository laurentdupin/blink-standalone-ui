...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SPEECH_RECOGNITION_ERROR_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SPEECH_RECOGNITION_ERROR_EVENT_H_
...
class MODULES_EXPORT V8SpeechRecognitionErrorEvent final : public bindings::V8InterfaceBridge<V8SpeechRecognitionErrorEvent, SpeechRecognitionErrorEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(461);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SpeechRecognitionErrorEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SPEECH_RECOGNITION_ERROR_EVENT_H_
