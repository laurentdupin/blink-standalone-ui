...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_MASK_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_MASK_ELEMENT_H_
...
class CORE_EXPORT V8SVGMaskElement final : public bindings::V8InterfaceBridge<V8SVGMaskElement, SVGMaskElement> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGMaskElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_MASK_ELEMENT_H_
