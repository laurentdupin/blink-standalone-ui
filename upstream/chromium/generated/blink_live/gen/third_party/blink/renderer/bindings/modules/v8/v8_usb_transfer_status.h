...
class MODULES_EXPORT V8USBTransferStatus final : public bindings::EnumerationBase {
...
static V8USBTransferStatus Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8USBTransferStatus> Create(const String& value);

explicit constexpr  V8USBTransferStatus(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8USBTransferStatus& lhs, V8USBTransferStatus::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8USBTransferStatus::Enum lhs, const V8USBTransferStatus& rhs) {
