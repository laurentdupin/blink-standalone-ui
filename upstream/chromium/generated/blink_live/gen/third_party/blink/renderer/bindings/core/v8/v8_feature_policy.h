...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_FEATURE_POLICY_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_FEATURE_POLICY_H_
...
class CORE_EXPORT V8FeaturePolicy final : public bindings::V8InterfaceBridge<V8FeaturePolicy, DOMFeaturePolicy> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(938);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class DOMFeaturePolicy;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_FEATURE_POLICY_H_
