...
const char* V8MutationCallback::GetHumanReadableName() const {
  return "V8MutationCallback";
}

v8::Maybe<void> V8MutationCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<MutationRecord>>& arg1_mutations, MutationObserver* arg2_observer) {
...
void V8MutationCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<MutationRecord>>& arg1_mutations, MutationObserver* arg2_observer) {
  v8::Isolate* isolate = GetIsolate();
...
base::expected<void, ScriptValue> V8MutationCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<MutationRecord>>& arg1_mutations, MutationObserver* arg2_observer) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_mutations, arg2_observer);
