...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_IIR_FILTER_NODE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_IIR_FILTER_NODE_H_
...
class MODULES_EXPORT V8IIRFilterNode final : public bindings::V8InterfaceBridge<V8IIRFilterNode, IIRFilterNode> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(518);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class IIRFilterNode;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_IIR_FILTER_NODE_H_
