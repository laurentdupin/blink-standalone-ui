...
v8::Local<v8::Value> V8UnionReadableByteStreamControllerOrReadableStreamDefaultController::DirectToV8(ScriptState* script_state, ReadableByteStreamController* value) {
  return ToV8Traits<ReadableByteStreamController>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionReadableByteStreamControllerOrReadableStreamDefaultController::DirectToV8(ScriptState* script_state, ReadableStreamDefaultController* value) {
  return ToV8Traits<ReadableStreamDefaultController>::ToV8(script_state, value);
}
