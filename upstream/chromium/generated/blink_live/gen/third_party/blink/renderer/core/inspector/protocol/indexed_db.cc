...
public:
    ...
    void clearObjectStore(crdtp::Dispatchable& dispatchable);
    void deleteDatabase(crdtp::Dispatchable& dispatchable);
    void deleteObjectStoreEntries(crdtp::Dispatchable& dispatchable);
    void disable(crdtp::Dispatchable& dispatchable);
    void enable(crdtp::Dispatchable& dispatchable);
    void requestData(crdtp::Dispatchable& dispatchable);
    void getMetadata(crdtp::Dispatchable& dispatchable);
    void requestDatabase(crdtp::Dispatchable& dispatchable);
    void requestDatabaseNames(crdtp::Dispatchable& dispatchable);
 protected:
    Backend* m_backend;
};
...
public:
    ClearObjectStoreCallbackImpl(std::unique_ptr<DomainDispatcher::WeakPtr> backendImpl, crdtp::Dispatchable& dispatchable)
        : DomainDispatcher::Callback(std::move(backendImpl), dispatchable, crdtp::SpanFrom("IndexedDB.clearObjectStore")) { }
...
void DomainDispatcherImpl::clearObjectStore(crdtp::Dispatchable& dispatchable)
{
    ...
    m_backend->clearObjectStore(std::move(params.securityOrigin), std::move(params.storageKey), std::move(params.storageBucket), params.databaseName, params.objectStoreName, std::make_unique<ClearObjectStoreCallbackImpl>(weakPtr(), dispatchable));
}

class DeleteDatabaseCallbackImpl : public Backend::DeleteDatabaseCallback, public DomainDispatcher::Callback {
public:
    DeleteDatabaseCallbackImpl(std::unique_ptr<DomainDispatcher::WeakPtr> backendImpl, crdtp::Dispatchable& dispatchable)
        : DomainDispatcher::Callback(std::move(backendImpl), dispatchable, crdtp::SpanFrom("IndexedDB.deleteDatabase")) { }
...
void DomainDispatcherImpl::deleteDatabase(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
    ...
    m_backend->deleteDatabase(std::move(params.securityOrigin), std::move(params.storageKey), std::move(params.storageBucket), params.databaseName, std::make_unique<DeleteDatabaseCallbackImpl>(weakPtr(), dispatchable));
}
...
public:
    DeleteObjectStoreEntriesCallbackImpl(std::unique_ptr<DomainDispatcher::WeakPtr> backendImpl, crdtp::Dispatchable& dispatchable)
        : DomainDispatcher::Callback(std::move(backendImpl), dispatchable, crdtp::SpanFrom("IndexedDB.deleteObjectStoreEntries")) { }
...
void DomainDispatcherImpl::deleteObjectStoreEntries(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
    ...
    m_backend->deleteObjectStoreEntries(std::move(params.securityOrigin), std::move(params.storageKey), std::move(params.storageBucket), params.databaseName, params.objectStoreName, std::move(params.keyRange), std::make_unique<DeleteObjectStoreEntriesCallbackImpl>(weakPtr(), dispatchable));
}
...
public:
    RequestDataCallbackImpl(std::unique_ptr<DomainDispatcher::WeakPtr> backendImpl, crdtp::Dispatchable& dispatchable)
        : DomainDispatcher::Callback(std::move(backendImpl), dispatchable, crdtp::SpanFrom("IndexedDB.requestData")) { }
...
void DomainDispatcherImpl::requestData(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
    ...
    m_backend->requestData(std::move(params.securityOrigin), std::move(params.storageKey), std::move(params.storageBucket), params.databaseName, params.objectStoreName, std::move(params.indexName), params.skipCount, params.pageSize, std::move(params.keyRange), std::make_unique<RequestDataCallbackImpl>(weakPtr(), dispatchable));
}

class GetMetadataCallbackImpl : public Backend::GetMetadataCallback, public DomainDispatcher::Callback {
public:
    GetMetadataCallbackImpl(std::unique_ptr<DomainDispatcher::WeakPtr> backendImpl, crdtp::Dispatchable& dispatchable)
        : DomainDispatcher::Callback(std::move(backendImpl), dispatchable, crdtp::SpanFrom("IndexedDB.getMetadata")) { }
...
void DomainDispatcherImpl::getMetadata(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
    ...
    m_backend->getMetadata(std::move(params.securityOrigin), std::move(params.storageKey), std::move(params.storageBucket), params.databaseName, params.objectStoreName, std::make_unique<GetMetadataCallbackImpl>(weakPtr(), dispatchable));
}

class RequestDatabaseCallbackImpl : public Backend::RequestDatabaseCallback, public DomainDispatcher::Callback {
public:
    RequestDatabaseCallbackImpl(std::unique_ptr<DomainDispatcher::WeakPtr> backendImpl, crdtp::Dispatchable& dispatchable)
        : DomainDispatcher::Callback(std::move(backendImpl), dispatchable, crdtp::SpanFrom("IndexedDB.requestDatabase")) { }
...
void DomainDispatcherImpl::requestDatabase(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
    ...
    m_backend->requestDatabase(std::move(params.securityOrigin), std::move(params.storageKey), std::move(params.storageBucket), params.databaseName, std::make_unique<RequestDatabaseCallbackImpl>(weakPtr(), dispatchable));
}

class RequestDatabaseNamesCallbackImpl : public Backend::RequestDatabaseNamesCallback, public DomainDispatcher::Callback {
public:
    RequestDatabaseNamesCallbackImpl(std::unique_ptr<DomainDispatcher::WeakPtr> backendImpl, crdtp::Dispatchable& dispatchable)
        : DomainDispatcher::Callback(std::move(backendImpl), dispatchable, crdtp::SpanFrom("IndexedDB.requestDatabaseNames")) { }
...
void DomainDispatcherImpl::requestDatabaseNames(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
    ...
    m_backend->requestDatabaseNames(std::move(params.securityOrigin), std::move(params.storageKey), std::move(params.storageBucket), std::make_unique<RequestDatabaseNamesCallbackImpl>(weakPtr(), dispatchable));
}
