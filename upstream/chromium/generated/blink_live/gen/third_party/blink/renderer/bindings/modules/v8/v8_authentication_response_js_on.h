...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_AUTHENTICATION_RESPONSE_JS_ON_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_AUTHENTICATION_RESPONSE_JS_ON_H_
...
class MODULES_EXPORT AuthenticationResponseJSON : public bindings::DictionaryBase {
  
  public:
static AuthenticationResponseJSON* Create() {
  return MakeGarbageCollected<AuthenticationResponseJSON>();
}
static AuthenticationResponseJSON* Create(v8::Isolate* isolate) {
  return MakeGarbageCollected<AuthenticationResponseJSON>(isolate);
}
static AuthenticationResponseJSON* Create(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state);

explicit  AuthenticationResponseJSON();
explicit  AuthenticationResponseJSON(v8::Isolate* isolate);
...
AuthenticatorAssertionResponseJSON* response() const {
  return member_response_.Get();
}
void setResponse(AuthenticatorAssertionResponseJSON* value) {
...
Member<AuthenticatorAssertionResponseJSON> member_response_;
String member_type_;
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_AUTHENTICATION_RESPONSE_JS_ON_H_
