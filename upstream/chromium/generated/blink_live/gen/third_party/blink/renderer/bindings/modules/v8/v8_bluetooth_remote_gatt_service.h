...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BLUETOOTH_REMOTE_GATT_SERVICE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BLUETOOTH_REMOTE_GATT_SERVICE_H_
...
class MODULES_EXPORT V8BluetoothRemoteGATTService final : public bindings::V8InterfaceBridge<V8BluetoothRemoteGATTService, BluetoothRemoteGATTService> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1094);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class BluetoothRemoteGATTService;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BLUETOOTH_REMOTE_GATT_SERVICE_H_
