...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_AUDIO_PARAM_MAP_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_AUDIO_PARAM_MAP_H_
...
template <>
class MODULES_EXPORT SyncIterator<AudioParamMap> final : public bindings::SyncIteratorBase {
  DEFINE_WRAPPERTYPEINFO();

  public:
using IDLKeyType = IDLString;
using IDLValueType = AudioParam;
using KeyType = String;
using ValueType = AudioParam*;

explicit  SyncIterator<AudioParamMap>(IterationSourceBase* source, Kind kind) : bindings::SyncIteratorBase(source, kind) {
...
class MODULES_EXPORT V8SyncIteratorAudioParamMap final : public bindings::V8InterfaceBridge<V8SyncIteratorAudioParamMap, SyncIterator<AudioParamMap>> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SyncIterator<AudioParamMap>;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_AUDIO_PARAM_MAP_H_
