...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_FUNCTION_DESCRIPTORS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_FUNCTION_DESCRIPTORS_H_
...
class CORE_EXPORT V8CSSFunctionDescriptors final : public bindings::V8InterfaceBridge<V8CSSFunctionDescriptors, CSSFunctionDescriptors> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(310);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSFunctionDescriptors;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_FUNCTION_DESCRIPTORS_H_
