...
static_assert(std::derived_from<CSSRotate, CSSTransformComponent>);
...
const WrapperTypeInfo V8CSSRotate::wrapper_type_info_{
    ...
    V8CSSRotate::kThisTag,
    V8CSSRotate::kMaxSubclassTag,
...
CSSRotate* blink_receiver = V8CSSRotate::ToWrappableUnsafe(isolate, v8_receiver);
...
static_assert(bindings::IsReturnTypeCompatible<CSSRotate, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
v8::Local<v8::Object> v8_receiver = info.This();
...
interface_function_template->SetInterfaceName(V8String(isolate, "CSSRotate"));
...
void V8CSSRotate::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "CSSRotate", kAttributeTable);
}
