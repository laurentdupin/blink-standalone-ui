...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_EQUIRECT_LAYER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_EQUIRECT_LAYER_H_
...
class MODULES_EXPORT V8XREquirectLayer final : public bindings::V8InterfaceBridge<V8XREquirectLayer, XREquirectLayer> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(822);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XREquirectLayer;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_EQUIRECT_LAYER_H_
