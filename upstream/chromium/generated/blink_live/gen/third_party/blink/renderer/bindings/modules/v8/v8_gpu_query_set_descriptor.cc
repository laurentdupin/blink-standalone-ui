...
if (!v8_value->IsObject()) {
  const char* const class_like_name = "GPUQuerySetDescriptor";
...
return dictionary;
 ...
 GPUQuerySetDescriptor::GPUQuerySetDescriptor(v8::Isolate* isolate) : GPUObjectDescriptorBase(isolate) {
...
if (!bindings::GetDictionaryMemberFromV8Object<IDLUnsignedLongEnforceRange, is_required>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), fallback_presence_var, member_count_, class_like_name, exception_state)) {
  return;
}
dictionary_from_v8_context.SetCurrentPropertyName("type");
if (!bindings::GetDictionaryMemberFromV8Object<V8GPUQueryType, is_required>(isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate), fallback_presence_var, member_type_, class_like_name, exception_state)) {
  return;
}
}
