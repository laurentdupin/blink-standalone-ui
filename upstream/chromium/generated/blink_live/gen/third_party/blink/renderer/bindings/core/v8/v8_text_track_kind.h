...
kSubtitles, kCaptions, kDescriptions, kChapters, kMetadata
};
...
explicit constexpr  V8TextTrackKind(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
