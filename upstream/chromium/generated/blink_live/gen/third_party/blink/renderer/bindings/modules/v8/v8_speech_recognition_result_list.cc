...
bool V8SpeechRecognitionResultList::IsExposed(ExecutionContext* execution_context) {
  return false;
}
...
const WrapperTypeInfo V8SpeechRecognitionResultList::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SpeechRecognitionResultList::InstallInterfaceTemplate,
    V8SpeechRecognitionResultList::InstallContextDependentProperties,
    "SpeechRecognitionResultList",
    nullptr,
    V8SpeechRecognitionResultList::kThisTag,
    V8SpeechRecognitionResultList::kMaxSubclassTag,
...
const WrapperTypeInfo& SpeechRecognitionResultList::wrapper_type_info_ =
    V8SpeechRecognitionResultList::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, SpeechRecognitionResultList>::value,
    "SpeechRecognitionResultList inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

v8::Intercepted V8SpeechRecognitionResultList::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
SpeechRecognitionResultList* blink_receiver = V8SpeechRecognitionResultList::ToWrappableUnsafe(isolate, v8_receiver);
...
static_assert(bindings::IsReturnTypeCompatible<SpeechRecognitionResult, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
return v8::Intercepted::kYes;
}

v8::Intercepted V8SpeechRecognitionResultList::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SpeechRecognitionResultList_IndexedPropertySetter");
...
v8::Intercepted V8SpeechRecognitionResultList::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SpeechRecognitionResultList_IndexedPropertyDeleter");
...
v8::Intercepted V8SpeechRecognitionResultList::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SpeechRecognitionResultList_IndexedPropertyDefiner");
...
v8::Intercepted V8SpeechRecognitionResultList::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SpeechRecognitionResultList_IndexedPropertyDescriptor");
...
void V8SpeechRecognitionResultList::IndexedPropertyEnumeratorCallback(const v8::PropertyCallbackInfo<v8::Array>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SpeechRecognitionResultList_IndexedPropertyEnumerator");
...
namespace v8_speech_recognition_result_list {
...
BLINK_BINDINGS_TRACE_EVENT("SpeechRecognitionResultList.length.get");
...
BLINK_BINDINGS_TRACE_EVENT("SpeechRecognitionResultList.item");
...
using namespace v8_speech_recognition_result_list;

}  // namespace 

void V8SpeechRecognitionResultList::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SpeechRecognitionResultList::GetWrapperTypeInfo();
...
instance_template->SetHandler(
    v8::IndexedPropertyHandlerConfiguration(
        ...
        nullptr,  // query
        V8SpeechRecognitionResultList::IndexedPropertyDeleterCallback,
        V8SpeechRecognitionResultList::IndexedPropertyEnumeratorCallback,
...
void V8SpeechRecognitionResultList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SpeechRecognitionResultList", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "SpeechRecognitionResultList", kOperationTable);
}
