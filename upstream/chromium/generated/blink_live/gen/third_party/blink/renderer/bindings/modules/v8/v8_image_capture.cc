...
const WrapperTypeInfo V8ImageCapture::wrapper_type_info_{
    ...
    "ImageCapture",
    nullptr,
    V8ImageCapture::kThisTag,
    V8ImageCapture::kMaxSubclassTag,
...
static_assert(bindings::IsReturnTypeCompatible<ImageCapture, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
static_assert(bindings::IsReturnTypeCompatible<IDLPromise<PhotoCapabilities>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
static_assert(bindings::IsReturnTypeCompatible<IDLPromise<PhotoSettings>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value);
}
...
interface_function_template->SetInterfaceName(V8String(isolate, "ImageCapture"));
...
void V8ImageCapture::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "ImageCapture", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "ImageCapture", kOperationTable);
}
