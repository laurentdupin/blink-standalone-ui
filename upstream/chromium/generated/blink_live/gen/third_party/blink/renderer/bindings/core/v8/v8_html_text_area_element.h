...
class CORE_EXPORT V8HTMLTextAreaElement final : public bindings::V8InterfaceBridge<V8HTMLTextAreaElement, HTMLTextAreaElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(668);
