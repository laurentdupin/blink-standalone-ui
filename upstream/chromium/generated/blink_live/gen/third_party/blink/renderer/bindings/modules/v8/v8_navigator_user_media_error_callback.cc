...
const char* V8NavigatorUserMediaErrorCallback::GetHumanReadableName() const {
  return "V8NavigatorUserMediaErrorCallback";
}

v8::Maybe<void> V8NavigatorUserMediaErrorCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const V8UnionDOMExceptionOrOverconstrainedError* arg1_error) {
  const char* const class_like_name = "NavigatorUserMediaErrorCallback";
...
v8::Local<v8::Value> v8_arg1_error;
ScriptState* script_state = CallbackRelevantScriptState();
v8_arg1_error = ToV8Traits<V8UnionDOMExceptionOrOverconstrainedError>::ToV8(script_state, arg1_error);
argv[0] = v8_arg1_error;
...
v8::Maybe<void> V8NavigatorUserMediaErrorCallback::Construct(const V8UnionDOMExceptionOrOverconstrainedError* arg1_error) {
  const char* const class_like_name = "NavigatorUserMediaErrorCallback";
...
void V8NavigatorUserMediaErrorCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const V8UnionDOMExceptionOrOverconstrainedError* arg1_error) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = Invoke(arg0_receiver, arg1_error);
}

base::expected<void, ScriptValue> V8NavigatorUserMediaErrorCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const V8UnionDOMExceptionOrOverconstrainedError* arg1_error) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_error);
