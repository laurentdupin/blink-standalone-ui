...
class CORE_EXPORT V8DOMMatrixReadOnly final : public bindings::V8InterfaceBridge<V8DOMMatrixReadOnly, DOMMatrixReadOnly> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(881);
  static constexpr v8::CppHeapPointerTag kMaxSubclassTag =
      static_cast<v8::CppHeapPointerTag>(882);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class DOMMatrixReadOnly;
};
