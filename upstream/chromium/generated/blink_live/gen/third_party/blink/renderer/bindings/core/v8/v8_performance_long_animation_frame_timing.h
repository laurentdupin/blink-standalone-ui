...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1001);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PerformanceLongAnimationFrameTiming;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PERFORMANCE_LONG_ANIMATION_FRAME_TIMING_H_
