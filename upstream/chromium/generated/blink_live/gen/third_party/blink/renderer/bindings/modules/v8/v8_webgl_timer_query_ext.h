...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_TIMER_QUERY_EXT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_TIMER_QUERY_EXT_H_
...
class MODULES_EXPORT V8WebGLTimerQueryEXT final : public bindings::V8InterfaceBridge<V8WebGLTimerQueryEXT, WebGLTimerQueryEXT> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1355);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_TIMER_QUERY_EXT_H_
