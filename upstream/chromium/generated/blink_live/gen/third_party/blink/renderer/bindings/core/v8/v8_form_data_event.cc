...
bool V8FormDataEvent::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<FormDataEvent, Event>);
...
const WrapperTypeInfo V8FormDataEvent::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8FormDataEvent::InstallInterfaceTemplate,
    nullptr,
    "FormDataEvent",
    V8Event::GetWrapperTypeInfo(),
    V8FormDataEvent::kThisTag,
    V8FormDataEvent::kMaxSubclassTag,
...
const WrapperTypeInfo& FormDataEvent::wrapper_type_info_ =
    V8FormDataEvent::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, FormDataEvent>::value,
    "FormDataEvent inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_form_data_event {
...
BLINK_BINDINGS_TRACE_EVENT("FormDataEvent.formData.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
FormDataEvent* blink_receiver = V8FormDataEvent::ToWrappableUnsafe(isolate, v8_receiver);
auto&& return_value = blink_receiver->formData();
static_assert(bindings::IsReturnTypeCompatible<FormData, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
BLINK_BINDINGS_TRACE_EVENT("FormDataEvent.isTrusted.get");
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_FormDataEvent_constructor");
BLINK_BINDINGS_TRACE_EVENT("FormDataEvent.constructor");
...
auto&& arg2_event_init_dict = NativeValueTraits<FormDataEventInit>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& return_value = FormDataEvent::Create(arg1_type, arg2_event_init_dict);
static_assert(bindings::IsReturnTypeCompatible<FormDataEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8FormDataEvent::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_form_data_event;

}  // namespace 

void V8FormDataEvent::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8FormDataEvent::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "FormDataEvent"));
...
void V8FormDataEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "FormDataEvent", kAttributeTable);
}
