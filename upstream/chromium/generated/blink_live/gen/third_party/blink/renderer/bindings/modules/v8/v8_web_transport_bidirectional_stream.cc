...
bool V8WebTransportBidirectionalStream::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8WebTransportBidirectionalStream::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8WebTransportBidirectionalStream::InstallInterfaceTemplate,
    nullptr,
    "WebTransportBidirectionalStream",
    nullptr,
    V8WebTransportBidirectionalStream::kThisTag,
    V8WebTransportBidirectionalStream::kMaxSubclassTag,
...
const WrapperTypeInfo& BidirectionalStream::wrapper_type_info_ =
    V8WebTransportBidirectionalStream::wrapper_type_info_;
...
namespace v8_web_transport_bidirectional_stream {
...
BLINK_BINDINGS_TRACE_EVENT("WebTransportBidirectionalStream.readable.get");
...
BLINK_BINDINGS_TRACE_EVENT("WebTransportBidirectionalStream.writable.get");
...
using namespace v8_web_transport_bidirectional_stream;

}  // namespace 

void V8WebTransportBidirectionalStream::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8WebTransportBidirectionalStream::GetWrapperTypeInfo();
...
void V8WebTransportBidirectionalStream::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "WebTransportBidirectionalStream", kAttributeTable);
}
