...
const char* V8MediaSessionActionHandler::GetHumanReadableName() const {
  return "V8MediaSessionActionHandler";
}

v8::Maybe<void> V8MediaSessionActionHandler::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const MediaSessionActionDetails* arg1_details) {
  const char* const class_like_name = "MediaSessionActionHandler";
...
v8::Local<v8::Value> v8_arg1_details;
ScriptState* script_state = CallbackRelevantScriptState();
v8_arg1_details = ToV8Traits<MediaSessionActionDetails>::ToV8(script_state, arg1_details);
argv[0] = v8_arg1_details;
...
v8::Maybe<void> V8MediaSessionActionHandler::Construct(const MediaSessionActionDetails* arg1_details) {
  const char* const class_like_name = "MediaSessionActionHandler";
...
void V8MediaSessionActionHandler::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const MediaSessionActionDetails* arg1_details) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = Invoke(arg0_receiver, arg1_details);
}

base::expected<void, ScriptValue> V8MediaSessionActionHandler::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const MediaSessionActionDetails* arg1_details) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_details);
