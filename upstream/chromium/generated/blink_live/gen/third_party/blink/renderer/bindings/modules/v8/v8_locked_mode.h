...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_LOCKED_MODE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_LOCKED_MODE_H_
...
class MODULES_EXPORT V8LockedMode final : public bindings::V8InterfaceBridge<V8LockedMode, LockedMode> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1186);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class LockedMode;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_LOCKED_MODE_H_
