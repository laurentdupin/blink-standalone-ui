...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_TRANSLATE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_TRANSLATE_H_
...
class CORE_EXPORT V8CSSTranslate final : public bindings::V8InterfaceBridge<V8CSSTranslate, CSSTranslate> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(343);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSTranslate;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_TRANSLATE_H_
