...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_POINT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_POINT_H_
...
class CORE_EXPORT V8SVGPoint final : public bindings::V8InterfaceBridge<V8SVGPoint, SVGPointTearOff> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(980);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGPointTearOff;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_POINT_H_
