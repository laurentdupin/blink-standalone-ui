...
class CORE_EXPORT V8CSPViolationReportBody final : public bindings::V8InterfaceBridge<V8CSPViolationReportBody, CSPViolationReportBody> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(865);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSPViolationReportBody;
};
