...
class CORE_EXPORT GetRootNodeOptions : public bindings::InputDictionaryBase {
  
  public:
static GetRootNodeOptions* Create() {
  return MakeGarbageCollected<GetRootNodeOptions>();
}
static GetRootNodeOptions* Create(v8::Isolate* isolate) {
  return MakeGarbageCollected<GetRootNodeOptions>(isolate);
}
static GetRootNodeOptions* Create(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state);

explicit  GetRootNodeOptions();
explicit  GetRootNodeOptions(v8::Isolate* isolate);
