...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_LAUNCH_PARAMS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_LAUNCH_PARAMS_H_
...
class MODULES_EXPORT V8LaunchParams final : public bindings::V8InterfaceBridge<V8LaunchParams, LaunchParams> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1184);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class LaunchParams;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_LAUNCH_PARAMS_H_
