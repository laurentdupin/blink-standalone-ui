...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_COLOR_BUFFER_HALF_FLOAT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_COLOR_BUFFER_HALF_FLOAT_H_
...
class MODULES_EXPORT V8EXTColorBufferHalfFloat final : public bindings::V8InterfaceBridge<V8EXTColorBufferHalfFloat, EXTColorBufferHalfFloat> {
...
class Constant final {
  ...
  public:
static constexpr uint32_t kRgba16FExt = 0x881A;
static constexpr uint32_t kRgb16FExt = 0x881B;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1295);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_COLOR_BUFFER_HALF_FLOAT_H_
