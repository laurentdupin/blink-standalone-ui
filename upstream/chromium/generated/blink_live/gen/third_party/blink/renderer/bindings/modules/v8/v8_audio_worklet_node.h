...
class MODULES_EXPORT V8AudioWorkletNode final : public bindings::V8InterfaceBridge<V8AudioWorkletNode, AudioWorkletNode> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(510);
