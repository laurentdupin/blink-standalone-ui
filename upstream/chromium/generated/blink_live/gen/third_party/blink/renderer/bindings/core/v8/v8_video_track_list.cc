...
bool V8VideoTrackList::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow() && RuntimeEnabledFeatures::AudioVideoTracksEnabled();
}

static_assert(std::derived_from<VideoTrackList, EventTarget>);
...
const WrapperTypeInfo V8VideoTrackList::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8VideoTrackList::InstallInterfaceTemplate,
    nullptr,
    "VideoTrackList",
    V8EventTarget::GetWrapperTypeInfo(),
    V8VideoTrackList::kThisTag,
    V8VideoTrackList::kMaxSubclassTag,
...
const WrapperTypeInfo& VideoTrackList::wrapper_type_info_ =
    V8VideoTrackList::wrapper_type_info_;
...
v8::Intercepted V8VideoTrackList::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
static_assert(bindings::IsReturnTypeCompatible<VideoTrack, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
return v8::Intercepted::kYes;
}

v8::Intercepted V8VideoTrackList::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_VideoTrackList_IndexedPropertySetter");
...
v8::Intercepted V8VideoTrackList::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_VideoTrackList_IndexedPropertyDeleter");
...
v8::Intercepted V8VideoTrackList::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_VideoTrackList_IndexedPropertyDefiner");
...
v8::Intercepted V8VideoTrackList::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_VideoTrackList_IndexedPropertyDescriptor");
...
BLINK_BINDINGS_TRACE_EVENT("VideoTrackList.length.get");
...
BLINK_BINDINGS_TRACE_EVENT("VideoTrackList.selectedIndex.get");
...
BLINK_BINDINGS_TRACE_EVENT("VideoTrackList.onchange.get");
...
BLINK_BINDINGS_TRACE_EVENT("VideoTrackList.onchange.set");
...
BLINK_BINDINGS_TRACE_EVENT("VideoTrackList.onaddtrack.get");
...
BLINK_BINDINGS_TRACE_EVENT("VideoTrackList.onaddtrack.set");
...
BLINK_BINDINGS_TRACE_EVENT("VideoTrackList.onremovetrack.get");
...
BLINK_BINDINGS_TRACE_EVENT("VideoTrackList.onremovetrack.set");
...
BLINK_BINDINGS_TRACE_EVENT("VideoTrackList.getTrackById");
...
static_assert(bindings::IsReturnTypeCompatible<IDLNullable<VideoTrack>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
}
...
using namespace v8_video_track_list;

}  // namespace 

void V8VideoTrackList::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8VideoTrackList::GetWrapperTypeInfo();
...
instance_template->SetHandler(
    v8::IndexedPropertyHandlerConfiguration(
        ...
        nullptr,  // query
        V8VideoTrackList::IndexedPropertyDeleterCallback,
        V8VideoTrackList::IndexedPropertyEnumeratorCallback,
...
void V8VideoTrackList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "VideoTrackList", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "VideoTrackList", kOperationTable);
}
