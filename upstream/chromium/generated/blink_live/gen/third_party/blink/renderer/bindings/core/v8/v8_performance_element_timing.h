...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PERFORMANCE_ELEMENT_TIMING_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PERFORMANCE_ELEMENT_TIMING_H_
...
class CORE_EXPORT V8PerformanceElementTiming final : public bindings::V8InterfaceBridge<V8PerformanceElementTiming, PerformanceElementTiming> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(999);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PerformanceElementTiming;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PERFORMANCE_ELEMENT_TIMING_H_
