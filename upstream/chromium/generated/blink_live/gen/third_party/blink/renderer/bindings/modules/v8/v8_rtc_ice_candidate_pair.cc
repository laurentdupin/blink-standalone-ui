...
void RTCIceCandidatePair::Trace(Visitor* visitor) const {
  visitor->Trace(member_local_);
visitor->Trace(member_remote_);
bindings::DictionaryBase::Trace(visitor);
}

void RTCIceCandidatePair::FillTemplateProperties(Vector<std::string_view>& properties) const {
...
if (!bindings::GetDictionaryMemberFromV8Object<RTCIceCandidate, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), has_local_, member_local_, class_like_name, exception_state)) {
  return;
}
dictionary_from_v8_context.SetCurrentPropertyName("remote");
if (!bindings::GetDictionaryMemberFromV8Object<RTCIceCandidate, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate), has_remote_, member_remote_, class_like_name, exception_state)) {
  return;
}
}
