...
const char* V8VideoFrameRequestCallback::GetHumanReadableName() const {
  return "V8VideoFrameRequestCallback";
}

v8::Maybe<void> V8VideoFrameRequestCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, double arg1_time, const VideoFrameCallbackMetadata* arg2_metadata) {
...
void V8VideoFrameRequestCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, double arg1_time, const VideoFrameCallbackMetadata* arg2_metadata) {
  v8::Isolate* isolate = GetIsolate();
...
base::expected<void, ScriptValue> V8VideoFrameRequestCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, double arg1_time, const VideoFrameCallbackMetadata* arg2_metadata) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_time, arg2_metadata);
