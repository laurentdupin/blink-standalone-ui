...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_VISUAL_VIEWPORT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_VISUAL_VIEWPORT_H_
...
class CORE_EXPORT V8VisualViewport final : public bindings::V8InterfaceBridge<V8VisualViewport, DOMVisualViewport> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(803);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class DOMVisualViewport;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_VISUAL_VIEWPORT_H_
