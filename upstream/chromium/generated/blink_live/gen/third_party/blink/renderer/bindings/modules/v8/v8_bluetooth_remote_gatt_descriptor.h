...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BLUETOOTH_REMOTE_GATT_DESCRIPTOR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BLUETOOTH_REMOTE_GATT_DESCRIPTOR_H_
...
class MODULES_EXPORT V8BluetoothRemoteGATTDescriptor final : public bindings::V8InterfaceBridge<V8BluetoothRemoteGATTDescriptor, BluetoothRemoteGATTDescriptor> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1092);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BLUETOOTH_REMOTE_GATT_DESCRIPTOR_H_
