...
class MODULES_EXPORT V8TextDecoder final : public bindings::V8InterfaceBridge<V8TextDecoder, TextDecoder> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1141);
