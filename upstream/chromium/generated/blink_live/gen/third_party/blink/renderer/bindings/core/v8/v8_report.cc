...
bool V8Report::IsExposed(ExecutionContext* execution_context) {
  return false;
}
...
const WrapperTypeInfo V8Report::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8Report::InstallInterfaceTemplate,
    V8Report::InstallContextDependentProperties,
    "Report",
    nullptr,
    V8Report::kThisTag,
    V8Report::kMaxSubclassTag,
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Report_type_Getter");
BLINK_BINDINGS_TRACE_EVENT("Report.type.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Report_url_Getter");
BLINK_BINDINGS_TRACE_EVENT("Report.url.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Report_body_Getter");
BLINK_BINDINGS_TRACE_EVENT("Report.body.get");
...
static_assert(bindings::IsReturnTypeCompatible<IDLNullable<ReportBody>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
}


void ToJSONOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Report_toJSON");
BLINK_BINDINGS_TRACE_EVENT("Report.toJSON");
...
using namespace v8_report;

}  // namespace 

void V8Report::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8Report::GetWrapperTypeInfo();
...
void V8Report::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "Report", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "Report", kOperationTable);
}
...
void V8Report::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object, v8::Local<v8::Object> prototype_object, v8::Local<v8::Object> interface_object, v8::Local<v8::Template> interface_template, FeatureSelector feature_selector) {
  using bindings::IDLMemberInstaller;
