...
bool V8PeriodicSyncEvent::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsServiceWorkerGlobalScope() && RuntimeEnabledFeatures::PeriodicBackgroundSyncEnabled();
}

static_assert(std::derived_from<PeriodicSyncEvent, ExtendableEvent>);
...
const WrapperTypeInfo V8PeriodicSyncEvent::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8PeriodicSyncEvent::InstallInterfaceTemplate,
    nullptr,
    "PeriodicSyncEvent",
    V8ExtendableEvent::GetWrapperTypeInfo(),
    V8PeriodicSyncEvent::kThisTag,
    V8PeriodicSyncEvent::kMaxSubclassTag,
...
const WrapperTypeInfo& PeriodicSyncEvent::wrapper_type_info_ =
    V8PeriodicSyncEvent::wrapper_type_info_;
...
namespace v8_periodic_sync_event {


void TagAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_PeriodicSyncEvent_tag_Getter");
BLINK_BINDINGS_TRACE_EVENT("PeriodicSyncEvent.tag.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_PeriodicSyncEvent_isTrusted_Getter");
BLINK_BINDINGS_TRACE_EVENT("PeriodicSyncEvent.isTrusted.get");
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_PeriodicSyncEvent_constructor");
BLINK_BINDINGS_TRACE_EVENT("PeriodicSyncEvent.constructor");
...
auto&& arg2_init = NativeValueTraits<PeriodicSyncEventInit>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& return_value = PeriodicSyncEvent::Create(arg1_type, arg2_init);
static_assert(bindings::IsReturnTypeCompatible<PeriodicSyncEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8PeriodicSyncEvent::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_periodic_sync_event;

}  // namespace 

void V8PeriodicSyncEvent::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8PeriodicSyncEvent::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "PeriodicSyncEvent"));
...
void V8PeriodicSyncEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "PeriodicSyncEvent", kAttributeTable);
}
