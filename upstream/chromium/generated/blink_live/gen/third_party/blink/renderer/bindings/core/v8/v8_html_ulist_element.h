...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_ULIST_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_ULIST_ELEMENT_H_
...
class CORE_EXPORT V8HTMLUListElement final : public bindings::V8InterfaceBridge<V8HTMLUListElement, HTMLUListElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(672);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class HTMLUListElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_ULIST_ELEMENT_H_
