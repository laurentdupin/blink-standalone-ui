...
bool V8CloseEvent::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow() || execution_context->IsWorkerGlobalScope();
}

static_assert(std::derived_from<CloseEvent, Event>);
...
const WrapperTypeInfo V8CloseEvent::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8CloseEvent::InstallInterfaceTemplate,
    nullptr,
    "CloseEvent",
    V8Event::GetWrapperTypeInfo(),
    V8CloseEvent::kThisTag,
    V8CloseEvent::kMaxSubclassTag,
...
const WrapperTypeInfo& CloseEvent::wrapper_type_info_ =
    V8CloseEvent::wrapper_type_info_;
...
namespace v8_close_event {


void WasCleanAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CloseEvent_wasClean_Getter");
BLINK_BINDINGS_TRACE_EVENT("CloseEvent.wasClean.get");
...
BLINK_BINDINGS_TRACE_EVENT("CloseEvent.code.get");
...
BLINK_BINDINGS_TRACE_EVENT("CloseEvent.reason.get");
...
BLINK_BINDINGS_TRACE_EVENT("CloseEvent.isTrusted.get");
...
BLINK_BINDINGS_TRACE_EVENT("CloseEvent.constructor");
...
decltype(NativeValueTraits<CloseEventInit>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg2_event_init_dict;
if (info[1]->IsUndefined()) {
  arg2_event_init_dict = CloseEventInit::Create();
} else {
  arg2_event_init_dict = NativeValueTraits<CloseEventInit>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
}
auto&& return_value = CloseEvent::Create(arg1_type, arg2_event_init_dict);
static_assert(bindings::IsReturnTypeCompatible<CloseEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8CloseEvent::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_close_event;

}  // namespace 

void V8CloseEvent::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8CloseEvent::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "CloseEvent"));
...
void V8CloseEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
  using bindings::IDLMemberInstaller;

{
  
static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
{"wasClean", WasCleanAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "CloseEvent", kAttributeTable);
}
