...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_STARTING_STYLE_RULE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_STARTING_STYLE_RULE_H_
...
class CORE_EXPORT V8CSSStartingStyleRule final : public bindings::V8InterfaceBridge<V8CSSStartingStyleRule, CSSStartingStyleRule> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(295);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSStartingStyleRule;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_STARTING_STYLE_RULE_H_
