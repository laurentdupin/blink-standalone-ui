...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SCREEN_DETAILED_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SCREEN_DETAILED_H_
...
class MODULES_EXPORT V8ScreenDetailed final : public bindings::V8InterfaceBridge<V8ScreenDetailed, ScreenDetailed> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(770);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class ScreenDetailed;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SCREEN_DETAILED_H_
