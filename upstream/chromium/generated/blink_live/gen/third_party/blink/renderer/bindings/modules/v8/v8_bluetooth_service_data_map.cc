...
bool V8BluetoothServiceDataMap::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8BluetoothServiceDataMap::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8BluetoothServiceDataMap::InstallInterfaceTemplate,
    V8BluetoothServiceDataMap::InstallContextDependentProperties,
    "BluetoothServiceDataMap",
    nullptr,
    V8BluetoothServiceDataMap::kThisTag,
    V8BluetoothServiceDataMap::kMaxSubclassTag,
...
const WrapperTypeInfo& BluetoothServiceDataMap::wrapper_type_info_ =
    V8BluetoothServiceDataMap::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, BluetoothServiceDataMap>::value,
    "BluetoothServiceDataMap inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_bluetooth_service_data_map {
...
BLINK_BINDINGS_TRACE_EVENT("BluetoothServiceDataMap.size.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
BluetoothServiceDataMap* blink_receiver = V8BluetoothServiceDataMap::ToWrappableUnsafe(isolate, v8_receiver);
...
void EntriesOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_BluetoothServiceDataMap_entries");
BLINK_BINDINGS_TRACE_EVENT("BluetoothServiceDataMap.entries");
...
static_assert(bindings::IsReturnTypeCompatible<SyncIterator<BluetoothServiceDataMap>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
BLINK_BINDINGS_TRACE_EVENT("BluetoothServiceDataMap.forEach");
...
BLINK_BINDINGS_TRACE_EVENT("BluetoothServiceDataMap.get");
...
BLINK_BINDINGS_TRACE_EVENT("BluetoothServiceDataMap.has");
...
BLINK_BINDINGS_TRACE_EVENT("BluetoothServiceDataMap.keys");
...
BLINK_BINDINGS_TRACE_EVENT("BluetoothServiceDataMap.values");
...
using namespace v8_bluetooth_service_data_map;

}  // namespace 

void V8BluetoothServiceDataMap::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8BluetoothServiceDataMap::GetWrapperTypeInfo();
...
void V8BluetoothServiceDataMap::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "BluetoothServiceDataMap", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "BluetoothServiceDataMap", kOperationTable);
}
...
void V8BluetoothServiceDataMap::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object, v8::Local<v8::Object> prototype_object, v8::Local<v8::Object> interface_object, v8::Local<v8::Template> interface_template, FeatureSelector feature_selector) {
  using bindings::IDLMemberInstaller;
