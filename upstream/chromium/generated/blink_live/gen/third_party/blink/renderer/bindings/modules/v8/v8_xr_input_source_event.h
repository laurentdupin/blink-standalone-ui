...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_INPUT_SOURCE_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_INPUT_SOURCE_EVENT_H_
...
class MODULES_EXPORT V8XRInputSourceEvent final : public bindings::V8InterfaceBridge<V8XRInputSourceEvent, XRInputSourceEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(489);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XRInputSourceEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_INPUT_SOURCE_EVENT_H_
