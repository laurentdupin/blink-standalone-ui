...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TEXT_UPDATE_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TEXT_UPDATE_EVENT_H_
...
class CORE_EXPORT V8TextUpdateEvent final : public bindings::V8InterfaceBridge<V8TextUpdateEvent, TextUpdateEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(469);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class TextUpdateEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TEXT_UPDATE_EVENT_H_
