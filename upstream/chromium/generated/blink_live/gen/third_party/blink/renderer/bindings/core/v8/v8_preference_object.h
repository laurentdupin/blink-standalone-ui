...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PREFERENCE_OBJECT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PREFERENCE_OBJECT_H_
...
class CORE_EXPORT V8PreferenceObject final : public bindings::V8InterfaceBridge<V8PreferenceObject, PreferenceObject> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(755);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PreferenceObject;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PREFERENCE_OBJECT_H_
