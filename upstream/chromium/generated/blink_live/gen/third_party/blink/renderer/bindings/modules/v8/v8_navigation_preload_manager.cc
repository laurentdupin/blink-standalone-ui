...
bool V8NavigationPreloadManager::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8NavigationPreloadManager::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8NavigationPreloadManager::InstallInterfaceTemplate,
    nullptr,
    "NavigationPreloadManager",
    nullptr,
    V8NavigationPreloadManager::kThisTag,
    V8NavigationPreloadManager::kMaxSubclassTag,
...
const WrapperTypeInfo& NavigationPreloadManager::wrapper_type_info_ =
    V8NavigationPreloadManager::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, NavigationPreloadManager>::value,
    "NavigationPreloadManager inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_navigation_preload_manager {
...
BLINK_BINDINGS_TRACE_EVENT("NavigationPreloadManager.disable");
// Promise returning function: Convert a TypeError to a reject promise.
ExceptionToRejectPromiseScope reject_promise_scope(info);

v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
if (!V8NavigationPreloadManager::HasInstance(isolate, v8_receiver)) {
...
BLINK_BINDINGS_TRACE_EVENT("NavigationPreloadManager.enable");
// Promise returning function: Convert a TypeError to a reject promise.
ExceptionToRejectPromiseScope reject_promise_scope(info);
...
BLINK_BINDINGS_TRACE_EVENT("NavigationPreloadManager.getState");
// Promise returning function: Convert a TypeError to a reject promise.
ExceptionToRejectPromiseScope reject_promise_scope(info);
...
static_assert(bindings::IsReturnTypeCompatible<IDLPromise<NavigationPreloadState>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value);
}

void SetHeaderValueOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_NavigationPreloadManager_setHeaderValue");
BLINK_BINDINGS_TRACE_EVENT("NavigationPreloadManager.setHeaderValue");
// Promise returning function: Convert a TypeError to a reject promise.
ExceptionToRejectPromiseScope reject_promise_scope(info);
...
const char* const class_like_name = "NavigationPreloadManager";
const char* const property_name = "setHeaderValue";
...
auto&& return_value = blink_receiver->setHeaderValue(script_state, arg1_value, exception_state);
static_assert(bindings::IsReturnTypeCompatible<IDLPromise<IDLUndefined>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
using namespace v8_navigation_preload_manager;

}  // namespace 

void V8NavigationPreloadManager::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8NavigationPreloadManager::GetWrapperTypeInfo();
...
void V8NavigationPreloadManager::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"disable", DisableOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kDoNotCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
...
{"getState", GetStateOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kDoNotCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
{"setHeaderValue", SetHeaderValueOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kDoNotCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
};
v8::Local<v8::Signature> signature = v8::Local<v8::Signature>::Cast(interface_template);
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "NavigationPreloadManager", kOperationTable);
}
