...
kRequired, kOptional, kNotAllowed
};
...
explicit constexpr  V8MediaKeysRequirement(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
