...
class InternalSettingsGenerated : public ScriptWrappable,
 ...
 public:
  ...
  void setInspectorHighlightAds(bool InspectorHighlightAds);
  ...
  void setAcceptLanguages(const String& acceptLanguages);
  ...
  void setAllowUnrestrictedWindowFocus(bool allowUnrestrictedWindowFocus);
  ...
  void setIgnorePermissionForDeviceChangedEvent(bool ignorePermissionForDeviceChangedEvent);
  void setImagesEnabled(bool imagesEnabled);
  void setImmersiveModeEnabled(bool immersiveModeEnabled);
  void setImmersiveVideoPlaybackEnabled(bool immersiveVideoPlaybackEnabled);
  ...
  void setIsInitialProfile(bool isInitialProfile);
  ...
  void setMiddleClickPasteAllowed(bool middleClickPasteAllowed);
  ...
  void setPasswordEchoEnabledPhysical(bool passwordEchoEnabledPhysical);
  void setPasswordEchoEnabledTouch(bool passwordEchoEnabledTouch);
  ...
  void setScaleAllFontsIfNoMetaTextScaleTag(bool scaleAllFontsIfNoMetaTextScaleTag);
  ...
  void setTextSizeAdjustEnabled(bool textSizeAdjustEnabled);
