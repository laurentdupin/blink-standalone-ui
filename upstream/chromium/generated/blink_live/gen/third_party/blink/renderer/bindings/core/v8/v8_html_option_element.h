...
class CORE_EXPORT V8HTMLOptionElement final : public bindings::V8InterfaceBridge<V8HTMLOptionElement, HTMLOptionElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(646);
