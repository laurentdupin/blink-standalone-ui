...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_LANGUAGE_DETECTOR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_LANGUAGE_DETECTOR_H_
...
class MODULES_EXPORT V8LanguageDetector final : public bindings::V8InterfaceBridge<V8LanguageDetector, LanguageDetector> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1075);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class LanguageDetector;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_LANGUAGE_DETECTOR_H_
