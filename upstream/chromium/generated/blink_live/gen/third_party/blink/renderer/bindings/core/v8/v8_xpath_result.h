...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_XPATH_RESULT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_XPATH_RESULT_H_
...
class CORE_EXPORT V8XPathResult final : public bindings::V8InterfaceBridge<V8XPathResult, XPathResult> {
...
class Constant final {
  ...
  public:
static constexpr uint16_t kAnyType = 0;
static constexpr uint16_t kNumberType = 1;
static constexpr uint16_t kStringType = 2;
static constexpr uint16_t kBooleanType = 3;
static constexpr uint16_t kUnorderedNodeIteratorType = 4;
static constexpr uint16_t kOrderedNodeIteratorType = 5;
static constexpr uint16_t kUnorderedNodeSnapshotType = 6;
static constexpr uint16_t kOrderedNodeSnapshotType = 7;
static constexpr uint16_t kAnyUnorderedNodeType = 8;
static constexpr uint16_t kFirstOrderedNodeType = 9;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1048);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XPathResult;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_XPATH_RESULT_H_
