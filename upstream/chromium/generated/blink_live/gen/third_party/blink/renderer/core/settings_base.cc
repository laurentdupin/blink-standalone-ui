...
void SettingsBase::SetInspectorHighlightAds(bool inspector_highlight_ads) {
  if (inspector_highlight_ads_ == inspector_highlight_ads)
    return;
  inspector_highlight_ads_ = inspector_highlight_ads;
  Invalidate(SettingsDelegate::ChangeType::kHighlightAds);
}
...
void SettingsBase::SetAllowUnrestrictedWindowFocus(bool allow_unrestricted_window_focus) {
  if (allow_unrestricted_window_focus_ == allow_unrestricted_window_focus)
    return;
  allow_unrestricted_window_focus_ = allow_unrestricted_window_focus;
}
...
void SettingsBase::SetIgnorePermissionForDeviceChangedEvent(bool ignore_permission_for_device_changed_event) {
  if (ignore_permission_for_device_changed_event_ == ignore_permission_for_device_changed_event)
    return;
  ignore_permission_for_device_changed_event_ = ignore_permission_for_device_changed_event;
}
...
void SettingsBase::SetImmersiveVideoPlaybackEnabled(bool immersive_video_playback_enabled) {
  if (immersive_video_playback_enabled_ == immersive_video_playback_enabled)
    return;
  immersive_video_playback_enabled_ = immersive_video_playback_enabled;
}
...
void SettingsBase::SetIsInitialProfile(bool is_initial_profile) {
  if (is_initial_profile_ == is_initial_profile)
    return;
...
void SettingsBase::SetMiddleClickPasteAllowed(bool middle_click_paste_allowed) {
  if (middle_click_paste_allowed_ == middle_click_paste_allowed)
    return;
  middle_click_paste_allowed_ = middle_click_paste_allowed;
}
...
void SettingsBase::SetPasswordEchoEnabledPhysical(bool password_echo_enabled_physical) {
  if (password_echo_enabled_physical_ == password_echo_enabled_physical)
    return;
  password_echo_enabled_physical_ = password_echo_enabled_physical;
}

void SettingsBase::SetPasswordEchoEnabledTouch(bool password_echo_enabled_touch) {
  if (password_echo_enabled_touch_ == password_echo_enabled_touch)
    return;
  password_echo_enabled_touch_ = password_echo_enabled_touch;
}
...
void SettingsBase::SetRootScrollbarThemeColor(std::optional<SkColor> root_scrollbar_theme_color) {
  if (root_scrollbar_theme_color_ == root_scrollbar_theme_color)
    return;
  root_scrollbar_theme_color_ = root_scrollbar_theme_color;
  Invalidate(SettingsDelegate::ChangeType::kPaint);
}
...
void SettingsBase::SetScaleAllFontsIfNoMetaTextScaleTag(bool scale_all_fonts_if_no_meta_text_scale_tag) {
  if (scale_all_fonts_if_no_meta_text_scale_tag_ == scale_all_fonts_if_no_meta_text_scale_tag)
    return;
  scale_all_fonts_if_no_meta_text_scale_tag_ = scale_all_fonts_if_no_meta_text_scale_tag;
}
...
void SettingsBase::SetTextSizeAdjustEnabled(bool text_size_adjust_enabled) {
  if (text_size_adjust_enabled_ == text_size_adjust_enabled)
    return;
  text_size_adjust_enabled_ = text_size_adjust_enabled;
  Invalidate(SettingsDelegate::ChangeType::kStyle);
}
...
void SettingsBase::SetTextTrackBackgroundColor(const String& text_track_background_color) {
  ...
  Invalidate(SettingsDelegate::ChangeType::kTextTrackStyle);
}
...
void SettingsBase::SetFromStrings(const String& name, const String& value) {
  ...
  if (name == "InspectorHighlightAds") {
    SetInspectorHighlightAds(FromString<bool>()(value));
    return;
  }
  ...
  if (name == "acceptLanguages") {
    SetAcceptLanguages(FromString<String>()(value));
    return;
  }
  ...
  if (name == "allowUnrestrictedWindowFocus") {
    SetAllowUnrestrictedWindowFocus(FromString<bool>()(value));
    return;
  }
  ...
  if (name == "ignorePermissionForDeviceChangedEvent") {
    SetIgnorePermissionForDeviceChangedEvent(FromString<bool>()(value));
    return;
  }
  ...
  if (name == "immersiveVideoPlaybackEnabled") {
    SetImmersiveVideoPlaybackEnabled(FromString<bool>()(value));
    return;
  }
  ...
  if (name == "isInitialProfile") {
    SetIsInitialProfile(FromString<bool>()(value));
    return;
  }
  ...
  if (name == "middleClickPasteAllowed") {
    SetMiddleClickPasteAllowed(FromString<bool>()(value));
    return;
  }
  ...
  if (name == "passwordEchoEnabledPhysical") {
    SetPasswordEchoEnabledPhysical(FromString<bool>()(value));
    return;
  }
  if (name == "passwordEchoEnabledTouch") {
    SetPasswordEchoEnabledTouch(FromString<bool>()(value));
    return;
  }
  ...
  if (name == "rootScrollbarThemeColor") {
    SetRootScrollbarThemeColor(FromString<std::optional<SkColor>>()(value));
    return;
  }
  ...
  if (name == "scaleAllFontsIfNoMetaTextScaleTag") {
    SetScaleAllFontsIfNoMetaTextScaleTag(FromString<bool>()(value));
    return;
  }
  ...
  if (name == "textSizeAdjustEnabled") {
    SetTextSizeAdjustEnabled(FromString<bool>()(value));
    return;
  }
