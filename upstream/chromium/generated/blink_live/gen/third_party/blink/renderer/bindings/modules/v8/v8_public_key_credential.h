...
class MODULES_EXPORT V8PublicKeyCredential final : public bindings::V8InterfaceBridge<V8PublicKeyCredential, PublicKeyCredential> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PublicKeyCredential;
};
