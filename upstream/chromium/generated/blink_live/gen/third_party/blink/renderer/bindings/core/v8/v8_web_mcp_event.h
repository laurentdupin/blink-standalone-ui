...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_WEB_MCP_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_WEB_MCP_EVENT_H_
...
class CORE_EXPORT V8WebMCPEvent final : public bindings::V8InterfaceBridge<V8WebMCPEvent, WebMCPEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(487);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class WebMCPEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_WEB_MCP_EVENT_H_
