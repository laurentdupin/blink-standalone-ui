...
static_assert(std::derived_from<PictureInPictureWindow, EventTarget>);
...
const WrapperTypeInfo V8PictureInPictureWindow::wrapper_type_info_{
    ...
    V8PictureInPictureWindow::kThisTag,
    V8PictureInPictureWindow::kMaxSubclassTag,
...
PictureInPictureWindow* blink_receiver = V8PictureInPictureWindow::ToWrappableUnsafe(isolate, v8_receiver);
...
void V8PictureInPictureWindow::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "PictureInPictureWindow", kAttributeTable);
}
