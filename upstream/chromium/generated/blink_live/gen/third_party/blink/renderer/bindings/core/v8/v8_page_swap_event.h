...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PAGE_SWAP_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PAGE_SWAP_EVENT_H_
...
class CORE_EXPORT V8PageSwapEvent final : public bindings::V8InterfaceBridge<V8PageSwapEvent, PageSwapEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(438);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PageSwapEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PAGE_SWAP_EVENT_H_
