...
bool V8SVGFEMorphologyElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<SVGFEMorphologyElement, SVGElement>);
...
const WrapperTypeInfo V8SVGFEMorphologyElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SVGFEMorphologyElement::InstallInterfaceTemplate,
    nullptr,
    "SVGFEMorphologyElement",
    V8SVGElement::GetWrapperTypeInfo(),
    V8SVGFEMorphologyElement::kThisTag,
    V8SVGFEMorphologyElement::kMaxSubclassTag,
...
const WrapperTypeInfo& SVGFEMorphologyElement::wrapper_type_info_ =
    V8SVGFEMorphologyElement::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, SVGFEMorphologyElement>::value,
    "SVGFEMorphologyElement inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_svg_fe_morphology_element {
...
SVGFEMorphologyElement* blink_receiver = V8SVGFEMorphologyElement::ToWrappableUnsafe(isolate, v8_receiver);
...
using namespace v8_svg_fe_morphology_element;

}  // namespace 

void V8SVGFEMorphologyElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SVGFEMorphologyElement::GetWrapperTypeInfo();
...
void V8SVGFEMorphologyElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"radiusX", RadiusXAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
{"radiusY", RadiusYAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGFEMorphologyElement", kAttributeTable);
}
...
{"SVG_MORPHOLOGY_OPERATOR_UNKNOWN", V8SVGFEMorphologyElement::Constant::kSVGMorphologyOperatorUnknown},
{"SVG_MORPHOLOGY_OPERATOR_ERODE", V8SVGFEMorphologyElement::Constant::kSVGMorphologyOperatorErode},
{"SVG_MORPHOLOGY_OPERATOR_DILATE", V8SVGFEMorphologyElement::Constant::kSVGMorphologyOperatorDilate},
};
