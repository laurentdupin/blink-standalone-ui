...
bool V8CSSKeyframeRule::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<CSSKeyframeRule, CSSRule>);
...
const WrapperTypeInfo V8CSSKeyframeRule::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8CSSKeyframeRule::InstallInterfaceTemplate,
    nullptr,
    "CSSKeyframeRule",
    V8CSSRule::GetWrapperTypeInfo(),
    V8CSSKeyframeRule::kThisTag,
    V8CSSKeyframeRule::kMaxSubclassTag,
...
const WrapperTypeInfo& CSSKeyframeRule::wrapper_type_info_ =
    V8CSSKeyframeRule::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, CSSKeyframeRule>::value,
    "CSSKeyframeRule inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_css_keyframe_rule {


void KeyTextAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSKeyframeRule_keyText_Getter");
BLINK_BINDINGS_TRACE_EVENT("CSSKeyframeRule.keyText.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
CSSKeyframeRule* blink_receiver = V8CSSKeyframeRule::ToWrappableUnsafe(isolate, v8_receiver);
auto&& return_value = blink_receiver->keyText();
...
void KeyTextAttributeSetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSKeyframeRule_keyText_Setter");
BLINK_BINDINGS_TRACE_EVENT("CSSKeyframeRule.keyText.set");
...
blink_receiver->setKeyText(execution_context, arg1_value, exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
BLINK_BINDINGS_TRACE_EVENT("CSSKeyframeRule.style.get");
...
BLINK_BINDINGS_TRACE_EVENT("CSSKeyframeRule.style.set");
...
using namespace v8_css_keyframe_rule;

}  // namespace 

void V8CSSKeyframeRule::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8CSSKeyframeRule::GetWrapperTypeInfo();
...
void V8CSSKeyframeRule::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
  using bindings::IDLMemberInstaller;

{
  
static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
{"keyText", KeyTextAttributeGetCallback, KeyTextAttributeSetCallback, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "CSSKeyframeRule", kAttributeTable);
}
