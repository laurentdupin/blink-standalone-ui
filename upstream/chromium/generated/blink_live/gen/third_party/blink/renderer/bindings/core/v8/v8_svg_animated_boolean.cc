...
const WrapperTypeInfo V8SVGAnimatedBoolean::wrapper_type_info_{
    ...
    "SVGAnimatedBoolean",
    nullptr,
    V8SVGAnimatedBoolean::kThisTag,
    V8SVGAnimatedBoolean::kMaxSubclassTag,
...
void V8SVGAnimatedBoolean::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGAnimatedBoolean", kAttributeTable);
}
