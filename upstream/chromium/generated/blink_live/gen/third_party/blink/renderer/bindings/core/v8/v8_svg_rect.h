...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_RECT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_RECT_H_
...
class CORE_EXPORT V8SVGRect final : public bindings::V8InterfaceBridge<V8SVGRect, SVGRectTearOff> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(983);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGRectTearOff;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_RECT_H_
