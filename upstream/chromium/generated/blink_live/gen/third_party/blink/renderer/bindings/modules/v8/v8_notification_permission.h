...
class MODULES_EXPORT V8NotificationPermission final : public bindings::EnumerationBase {
  
  public:
enum class Enum : enum_int_t {
kDefault, kDenied, kGranted
};
static constexpr size_t kEnumSize = 3;

static V8NotificationPermission Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8NotificationPermission> Create(const String& value);

explicit constexpr  V8NotificationPermission(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
V8NotificationPermission& operator=(const V8NotificationPermission&) = default;
...
inline bool operator==(const V8NotificationPermission& lhs, V8NotificationPermission::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8NotificationPermission::Enum lhs, const V8NotificationPermission& rhs) {
