...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_BLUETOOTH_MANUFACTURER_DATA_MAP_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_BLUETOOTH_MANUFACTURER_DATA_MAP_H_
...
template <>
class MODULES_EXPORT SyncIterator<BluetoothManufacturerDataMap> final : public bindings::SyncIteratorBase {
  DEFINE_WRAPPERTYPEINFO();

  public:
using IDLKeyType = IDLUnsignedShort;
using IDLValueType = NotShared<DOMDataView>;
using KeyType = uint16_t;
using ValueType = NotShared<DOMDataView>;

explicit  SyncIterator<BluetoothManufacturerDataMap>(IterationSourceBase* source, Kind kind) : bindings::SyncIteratorBase(source, kind) {
...
class MODULES_EXPORT V8SyncIteratorBluetoothManufacturerDataMap final : public bindings::V8InterfaceBridge<V8SyncIteratorBluetoothManufacturerDataMap, SyncIterator<BluetoothManufacturerDataMap>> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1495);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SyncIterator<BluetoothManufacturerDataMap>;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_BLUETOOTH_MANUFACTURER_DATA_MAP_H_
