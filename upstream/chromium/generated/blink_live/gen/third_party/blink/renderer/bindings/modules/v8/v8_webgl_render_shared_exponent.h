...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_RENDER_SHARED_EXPONENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_RENDER_SHARED_EXPONENT_H_
...
class MODULES_EXPORT V8WebGLRenderSharedExponent final : public bindings::V8InterfaceBridge<V8WebGLRenderSharedExponent, WebGLRenderSharedExponent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1361);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class WebGLRenderSharedExponent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_RENDER_SHARED_EXPONENT_H_
