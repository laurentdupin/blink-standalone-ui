...
bool V8WebGLVertexArrayObjectOES::IsExposed(ExecutionContext* execution_context) {
  return false;
}

static_assert(std::derived_from<WebGLVertexArrayObjectOES, WebGLObject>);
...
const WrapperTypeInfo V8WebGLVertexArrayObjectOES::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8WebGLVertexArrayObjectOES::InstallInterfaceTemplate,
    V8WebGLVertexArrayObjectOES::InstallContextDependentProperties,
    "WebGLVertexArrayObjectOES",
    V8WebGLObject::GetWrapperTypeInfo(),
    V8WebGLVertexArrayObjectOES::kThisTag,
    V8WebGLVertexArrayObjectOES::kMaxSubclassTag,
...
const WrapperTypeInfo& WebGLVertexArrayObjectOES::wrapper_type_info_ =
    V8WebGLVertexArrayObjectOES::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, WebGLVertexArrayObjectOES>::value,
    "WebGLVertexArrayObjectOES inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_webgl_vertex_array_object_oes {



}  // namespace v8_webgl_vertex_array_object_oes

using namespace v8_webgl_vertex_array_object_oes;

}  // namespace 

void V8WebGLVertexArrayObjectOES::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8WebGLVertexArrayObjectOES::GetWrapperTypeInfo();
