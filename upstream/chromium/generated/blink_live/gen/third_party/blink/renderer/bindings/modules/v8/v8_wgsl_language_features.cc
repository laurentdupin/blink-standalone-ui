...
bool V8WGSLLanguageFeatures::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8WGSLLanguageFeatures::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8WGSLLanguageFeatures::InstallInterfaceTemplate,
    V8WGSLLanguageFeatures::InstallContextDependentProperties,
    "WGSLLanguageFeatures",
    nullptr,
    V8WGSLLanguageFeatures::kThisTag,
    V8WGSLLanguageFeatures::kMaxSubclassTag,
...
const WrapperTypeInfo& WGSLLanguageFeatures::wrapper_type_info_ =
    V8WGSLLanguageFeatures::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, WGSLLanguageFeatures>::value,
    "WGSLLanguageFeatures inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_wgsl_language_features {


void SizeAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_WGSLLanguageFeatures_size_Getter");
BLINK_BINDINGS_TRACE_EVENT("WGSLLanguageFeatures.size.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
WGSLLanguageFeatures* blink_receiver = V8WGSLLanguageFeatures::ToWrappableUnsafe(isolate, v8_receiver);
...
void EntriesOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_WGSLLanguageFeatures_entries");
BLINK_BINDINGS_TRACE_EVENT("WGSLLanguageFeatures.entries");
...
static_assert(bindings::IsReturnTypeCompatible<SyncIterator<WGSLLanguageFeatures>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
}

void ForEachOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_WGSLLanguageFeatures_forEach");
BLINK_BINDINGS_TRACE_EVENT("WGSLLanguageFeatures.forEach");
...
void HasOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_WGSLLanguageFeatures_has");
BLINK_BINDINGS_TRACE_EVENT("WGSLLanguageFeatures.has");
...
void KeysOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_WGSLLanguageFeatures_keys");
BLINK_BINDINGS_TRACE_EVENT("WGSLLanguageFeatures.keys");
...
void ValuesOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_WGSLLanguageFeatures_values");
BLINK_BINDINGS_TRACE_EVENT("WGSLLanguageFeatures.values");
...
using namespace v8_wgsl_language_features;

}  // namespace 

void V8WGSLLanguageFeatures::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8WGSLLanguageFeatures::GetWrapperTypeInfo();
...
void V8WGSLLanguageFeatures::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "WGSLLanguageFeatures", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "WGSLLanguageFeatures", kOperationTable);
}
...
void V8WGSLLanguageFeatures::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object, v8::Local<v8::Object> prototype_object, v8::Local<v8::Object> interface_object, v8::Local<v8::Template> interface_template, FeatureSelector feature_selector) {
  using bindings::IDLMemberInstaller;
