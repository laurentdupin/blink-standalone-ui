...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_FUNCTION_DECLARATIONS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_FUNCTION_DECLARATIONS_H_
...
class CSSFunctionDeclarationsRule;
class ExecutionContext;
struct WrapperTypeInfo;

class CORE_EXPORT V8CSSFunctionDeclarations final : public bindings::V8InterfaceBridge<V8CSSFunctionDeclarations, CSSFunctionDeclarationsRule> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(282);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSFunctionDeclarationsRule;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_FUNCTION_DECLARATIONS_H_
