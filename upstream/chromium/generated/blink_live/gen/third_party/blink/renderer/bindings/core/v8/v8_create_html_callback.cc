...
const char* V8CreateHTMLCallback::GetHumanReadableName() const {
  return "V8CreateHTMLCallback";
}

v8::Maybe<String> V8CreateHTMLCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const String& arg1_input, const HeapVector<ScriptValue>& arg2_args) {
  const char* const class_like_name = "CreateHTMLCallback";
...
v8::Maybe<String> V8CreateHTMLCallback::Construct(const String& arg1_input, const HeapVector<ScriptValue>& arg2_args) {
  const char* const class_like_name = "CreateHTMLCallback";
...
base::expected<String, ScriptValue> V8CreateHTMLCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const String& arg1_input, const HeapVector<ScriptValue>& arg2_args) {
