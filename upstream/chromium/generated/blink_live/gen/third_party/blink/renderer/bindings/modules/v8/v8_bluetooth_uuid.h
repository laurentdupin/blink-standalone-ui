...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BLUETOOTH_UUID_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BLUETOOTH_UUID_H_
...
class MODULES_EXPORT V8BluetoothUUID final : public bindings::V8InterfaceBridge<V8BluetoothUUID, BluetoothUUID> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1096);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class BluetoothUUID;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BLUETOOTH_UUID_H_
