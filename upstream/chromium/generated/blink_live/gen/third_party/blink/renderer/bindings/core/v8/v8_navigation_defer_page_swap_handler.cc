...
const char* V8NavigationDeferPageSwapHandler::GetHumanReadableName() const {
  return "V8NavigationDeferPageSwapHandler";
}

v8::Maybe<ScriptPromise<IDLAny>> V8NavigationDeferPageSwapHandler::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, NavigationDeferPageSwapController* arg1_controller) {
  const char* const class_like_name = "NavigationDeferPageSwapHandler";
...
v8_arg1_controller = ToV8Traits<NavigationDeferPageSwapController>::ToV8(script_state, arg1_controller);
...
v8::Maybe<ScriptPromise<IDLAny>> V8NavigationDeferPageSwapHandler::Construct(NavigationDeferPageSwapController* arg1_controller) {
  const char* const class_like_name = "NavigationDeferPageSwapHandler";
...
base::expected<ScriptPromise<IDLAny>, ScriptValue> V8NavigationDeferPageSwapHandler::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, NavigationDeferPageSwapController* arg1_controller) {
