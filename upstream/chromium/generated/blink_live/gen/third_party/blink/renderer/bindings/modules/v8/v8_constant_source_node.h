...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CONSTANT_SOURCE_NODE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CONSTANT_SOURCE_NODE_H_
...
class MODULES_EXPORT V8ConstantSourceNode final : public bindings::V8InterfaceBridge<V8ConstantSourceNode, ConstantSourceNode> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(508);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CONSTANT_SOURCE_NODE_H_
