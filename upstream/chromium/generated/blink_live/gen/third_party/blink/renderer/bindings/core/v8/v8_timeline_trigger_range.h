...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TIMELINE_TRIGGER_RANGE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TIMELINE_TRIGGER_RANGE_H_
...
class CORE_EXPORT V8TimelineTriggerRange final : public bindings::V8InterfaceBridge<V8TimelineTriggerRange, TimelineTriggerRange> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(268);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class TimelineTriggerRange;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TIMELINE_TRIGGER_RANGE_H_
