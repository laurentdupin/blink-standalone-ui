...
base::expected<String, ScriptValue> V8CreateURLCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const String& arg1_input, const HeapVector<ScriptValue>& arg2_args) {
