...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_MIDI_INPUT_MAP_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_MIDI_INPUT_MAP_H_
...
template <>
class MODULES_EXPORT SyncIterator<MIDIInputMap> final : public bindings::SyncIteratorBase {
  DEFINE_WRAPPERTYPEINFO();

  public:
using IDLKeyType = IDLString;
using IDLValueType = MIDIInput;
using KeyType = String;
using ValueType = MIDIInput*;

explicit  SyncIterator<MIDIInputMap>(IterationSourceBase* source, Kind kind) : bindings::SyncIteratorBase(source, kind) {
...
class MODULES_EXPORT V8SyncIteratorMIDIInputMap final : public bindings::V8InterfaceBridge<V8SyncIteratorMIDIInputMap, SyncIterator<MIDIInputMap>> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1503);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SyncIterator<MIDIInputMap>;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_MIDI_INPUT_MAP_H_
