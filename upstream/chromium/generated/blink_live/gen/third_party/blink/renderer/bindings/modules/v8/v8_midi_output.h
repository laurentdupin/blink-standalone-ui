...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MIDI_OUTPUT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MIDI_OUTPUT_H_
...
class MODULES_EXPORT V8MIDIOutput final : public bindings::V8InterfaceBridge<V8MIDIOutput, MIDIOutput> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class MIDIOutput;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MIDI_OUTPUT_H_
