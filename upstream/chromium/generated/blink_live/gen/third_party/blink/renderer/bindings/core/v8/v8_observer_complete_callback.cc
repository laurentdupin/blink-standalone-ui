...
const char* V8ObserverCompleteCallback::GetHumanReadableName() const {
  return "V8ObserverCompleteCallback";
}

v8::Maybe<void> V8ObserverCompleteCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
  const char* const class_like_name = "ObserverCompleteCallback";
...
v8::Maybe<void> V8ObserverCompleteCallback::Construct() {
  const char* const class_like_name = "ObserverCompleteCallback";
...
void V8ObserverCompleteCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
  v8::Isolate* isolate = GetIsolate();
...
base::expected<void, ScriptValue> V8ObserverCompleteCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
