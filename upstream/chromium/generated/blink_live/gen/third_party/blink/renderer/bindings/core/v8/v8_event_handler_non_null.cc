...
const char* V8EventHandlerNonNull::GetHumanReadableName() const {
...
bindings::CallbackInvokeHelper<CallbackFunctionBase, bindings::CallbackInvokeHelperMode::kLegacyTreatNonObjectAsNull, bindings::CallbackReturnTypeIsPromise::kNo> helper(
...
base::expected<ScriptValue, ScriptValue> V8EventHandlerNonNull::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<ScriptValue>& arg1_args) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_args);
...
v8::Maybe<ScriptValue> V8EventHandlerNonNull::InvokeWithoutRunnabilityCheck(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<ScriptValue>& arg1_args) {
  const char* const class_like_name = "EventHandlerNonNull";
const char* const property_name = "invoke";
ScriptState* callback_relevant_script_state =
    CallbackRelevantScriptStateOrThrowException(
