...
return dictionary;
 ...
 RTCRemoteInboundRtpStreamStats::RTCRemoteInboundRtpStreamStats(v8::Isolate* isolate) : RTCReceivedRtpStreamStats(isolate) {
...
void RTCRemoteInboundRtpStreamStats::FillTemplateProperties(Vector<std::string_view>& properties) const {
...
if (hasPacketsWithBleachedEct1Marking()) {
  values[2] = ToV8Traits<IDLUnsignedLongLong>::ToV8(script_state, member_packets_with_bleached_ect_1_marking_);
...
if (!bindings::GetDictionaryMemberFromV8Object<IDLDouble, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), has_fraction_lost_, member_fraction_lost_, class_like_name, exception_state)) {
  return;
}
dictionary_from_v8_context.SetCurrentPropertyName("localId");
if (!bindings::GetDictionaryMemberFromV8Object<IDLString, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate), has_local_id_, member_local_id_, class_like_name, exception_state)) {
  return;
}
dictionary_from_v8_context.SetCurrentPropertyName("packetsWithBleachedEct1Marking");
if (!bindings::GetDictionaryMemberFromV8Object<IDLUnsignedLongLong, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[2].Get(isolate), has_packets_with_bleached_ect_1_marking_, member_packets_with_bleached_ect_1_marking_, class_like_name, exception_state)) {
  return;
}
