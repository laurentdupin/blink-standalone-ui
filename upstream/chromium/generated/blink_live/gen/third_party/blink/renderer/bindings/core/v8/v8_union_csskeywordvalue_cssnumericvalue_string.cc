...
v8::Local<v8::Value> V8UnionCSSKeywordValueOrCSSNumericValueOrString::DirectToV8(ScriptState* script_state, CSSKeywordValue* value) {
  return ToV8Traits<CSSKeywordValue>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionCSSKeywordValueOrCSSNumericValueOrString::DirectToV8(ScriptState* script_state, CSSNumericValue* value) {
  return ToV8Traits<CSSNumericValue>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionCSSKeywordValueOrCSSNumericValueOrString::DirectToV8(ScriptState* script_state, const String& value) {
