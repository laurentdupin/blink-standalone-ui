...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_ELEMENT_INDEX_UINT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_ELEMENT_INDEX_UINT_H_
...
class MODULES_EXPORT V8OESElementIndexUint final : public bindings::V8InterfaceBridge<V8OESElementIndexUint, OESElementIndexUint> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1314);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class OESElementIndexUint;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_ELEMENT_INDEX_UINT_H_
