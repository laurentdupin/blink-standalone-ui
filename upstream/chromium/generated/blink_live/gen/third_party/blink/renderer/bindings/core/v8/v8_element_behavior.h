...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_ELEMENT_BEHAVIOR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_ELEMENT_BEHAVIOR_H_
...
class CORE_EXPORT V8ElementBehavior final : public bindings::V8InterfaceBridge<V8ElementBehavior, ElementBehavior> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(900);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class ElementBehavior;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_ELEMENT_BEHAVIOR_H_
