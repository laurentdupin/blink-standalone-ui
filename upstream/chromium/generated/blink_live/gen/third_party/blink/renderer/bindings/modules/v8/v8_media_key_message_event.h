...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MEDIA_KEY_MESSAGE_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MEDIA_KEY_MESSAGE_EVENT_H_
...
class MODULES_EXPORT V8MediaKeyMessageEvent final : public bindings::V8InterfaceBridge<V8MediaKeyMessageEvent, MediaKeyMessageEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(426);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class MediaKeyMessageEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MEDIA_KEY_MESSAGE_EVENT_H_
