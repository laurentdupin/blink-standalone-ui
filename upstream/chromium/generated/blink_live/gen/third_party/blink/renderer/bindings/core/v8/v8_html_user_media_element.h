...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_USER_MEDIA_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_USER_MEDIA_ELEMENT_H_
...
class CORE_EXPORT V8HTMLUserMediaElement final : public bindings::V8InterfaceBridge<V8HTMLUserMediaElement, HTMLUserMediaElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(674);
...
static InstallContextDependentPropertiesFuncType install_context_dependent_props_func_;
  ...
  friend class HTMLUserMediaElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_USER_MEDIA_ELEMENT_H_
