...
SummarizerCreateOptions* SummarizerCreateOptions::Create(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state) {
  SummarizerCreateOptions* dictionary = MakeGarbageCollected<SummarizerCreateOptions>(isolate);
if (v8_value->IsNullOrUndefined()) {
  return dictionary;
}
if (!v8_value->IsObject()) {
  const char* const class_like_name = "SummarizerCreateOptions";
...
return dictionary;
 ...
 SummarizerCreateOptions::SummarizerCreateOptions() {
  
}

 SummarizerCreateOptions::SummarizerCreateOptions(v8::Isolate* isolate) : SummarizerCreateCoreOptions(isolate) {
...
String SummarizerCreateOptions::getSharedContextOr(const String& fallback_value) const {
  if (!hasSharedContext()) {
...
String SummarizerCreateOptions::getSharedContextOr(String&& fallback_value) const {
  if (!hasSharedContext()) {
...
void SummarizerCreateOptions::setSharedContext(const String& value) {
  member_shared_context_ = value;
has_shared_context_ = true;
}

void SummarizerCreateOptions::setSharedContext(String&& value) {
...
void SummarizerCreateOptions::Trace(Visitor* visitor) const {
  visitor->Trace(member_monitor_);
visitor->Trace(member_signal_);
SummarizerCreateCoreOptions::Trace(visitor);
}

void SummarizerCreateOptions::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state) {
  TryRethrowScope rethrow_scope(isolate, exception_state);
SummarizerCreateCoreOptions::FillMembersFromV8Object(isolate, v8_dictionary, exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
const base::span<const v8::Eternal<v8::Name>> SummarizerCreateOptions::GetV8OwnMemberNames(v8::Isolate* isolate) {
