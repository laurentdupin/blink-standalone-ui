...
kActive, kRemoved, kPersisted
};
static constexpr size_t kEnumSize = 3;

static V8ReplaceState Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8ReplaceState> Create(const String& value);

explicit constexpr  V8ReplaceState(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
