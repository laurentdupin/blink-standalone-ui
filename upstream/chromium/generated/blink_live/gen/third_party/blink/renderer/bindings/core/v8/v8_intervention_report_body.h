...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_INTERVENTION_REPORT_BODY_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_INTERVENTION_REPORT_BODY_H_
...
class CORE_EXPORT V8InterventionReportBody final : public bindings::V8InterfaceBridge<V8InterventionReportBody, InterventionReportBody> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(870);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class InterventionReportBody;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_INTERVENTION_REPORT_BODY_H_
