...
bool V8AudioScheduledSourceNode::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<AudioScheduledSourceNode, AudioNode>);
...
const WrapperTypeInfo V8AudioScheduledSourceNode::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8AudioScheduledSourceNode::InstallInterfaceTemplate,
    nullptr,
    "AudioScheduledSourceNode",
    V8AudioNode::GetWrapperTypeInfo(),
    V8AudioScheduledSourceNode::kThisTag,
    V8AudioScheduledSourceNode::kMaxSubclassTag,
...
const WrapperTypeInfo& AudioScheduledSourceNode::wrapper_type_info_ =
    V8AudioScheduledSourceNode::wrapper_type_info_;
...
namespace v8_audio_scheduled_source_node {
...
BLINK_BINDINGS_TRACE_EVENT("AudioScheduledSourceNode.onended.get");
...
BLINK_BINDINGS_TRACE_EVENT("AudioScheduledSourceNode.onended.set");
...
BLINK_BINDINGS_TRACE_EVENT("AudioScheduledSourceNode.start");
...
auto&& arg1_when = NativeValueTraits<IDLDouble>::ArgumentValue(isolate, 0, info[0], exception_state);
...
BLINK_BINDINGS_TRACE_EVENT("AudioScheduledSourceNode.stop");
...
blink_receiver->stop(arg1_when, exception_state);
} while (false);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
using namespace v8_audio_scheduled_source_node;

}  // namespace 

void V8AudioScheduledSourceNode::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8AudioScheduledSourceNode::GetWrapperTypeInfo();
...
void V8AudioScheduledSourceNode::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "AudioScheduledSourceNode", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "AudioScheduledSourceNode", kOperationTable);
}
