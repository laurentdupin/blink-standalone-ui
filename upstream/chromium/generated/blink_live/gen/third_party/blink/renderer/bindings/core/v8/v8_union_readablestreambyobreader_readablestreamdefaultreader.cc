...
v8::Local<v8::Value> V8UnionReadableStreamBYOBReaderOrReadableStreamDefaultReader::DirectToV8(ScriptState* script_state, ReadableStreamBYOBReader* value) {
  return ToV8Traits<ReadableStreamBYOBReader>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionReadableStreamBYOBReaderOrReadableStreamDefaultReader::DirectToV8(ScriptState* script_state, ReadableStreamDefaultReader* value) {
  return ToV8Traits<ReadableStreamDefaultReader>::ToV8(script_state, value);
}

void V8UnionReadableStreamBYOBReaderOrReadableStreamDefaultReader::Trace(Visitor* visitor) const {
  visitor->Trace(member_readable_stream_byob_reader_);
visitor->Trace(member_readable_stream_default_reader_);
