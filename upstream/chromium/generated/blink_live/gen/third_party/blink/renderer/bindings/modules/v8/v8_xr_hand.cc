...
bool V8XRHand::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8XRHand::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8XRHand::InstallInterfaceTemplate,
    V8XRHand::InstallContextDependentProperties,
    "XRHand",
    nullptr,
    V8XRHand::kThisTag,
    V8XRHand::kMaxSubclassTag,
...
const WrapperTypeInfo& XRHand::wrapper_type_info_ =
    V8XRHand::wrapper_type_info_;
...
namespace v8_xr_hand {


void SizeAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRHand_size_Getter");
BLINK_BINDINGS_TRACE_EVENT("XRHand.size.get");
...
void GetOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRHand_get");
BLINK_BINDINGS_TRACE_EVENT("XRHand.get");
...
auto&& return_value = blink_receiver->get(arg1_key);
static_assert(bindings::IsReturnTypeCompatible<XRJointSpace, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
}

void EntriesOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRHand_entries");
BLINK_BINDINGS_TRACE_EVENT("XRHand.entries");
...
static_assert(bindings::IsReturnTypeCompatible<SyncIterator<XRHand>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
}

void ForEachOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRHand_forEach");
BLINK_BINDINGS_TRACE_EVENT("XRHand.forEach");
...
void KeysOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRHand_keys");
BLINK_BINDINGS_TRACE_EVENT("XRHand.keys");
...
void ValuesOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRHand_values");
BLINK_BINDINGS_TRACE_EVENT("XRHand.values");
...
using namespace v8_xr_hand;

}  // namespace 

void V8XRHand::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8XRHand::GetWrapperTypeInfo();
...
void V8XRHand::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "XRHand", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "XRHand", kOperationTable);
}
...
void V8XRHand::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object, v8::Local<v8::Object> prototype_object, v8::Local<v8::Object> interface_object, v8::Local<v8::Template> interface_template, FeatureSelector feature_selector) {
  using bindings::IDLMemberInstaller;
