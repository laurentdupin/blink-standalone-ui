...
bool V8ExtendableMessageEvent::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsServiceWorkerGlobalScope();
}

static_assert(std::derived_from<ExtendableMessageEvent, ExtendableEvent>);
...
const WrapperTypeInfo V8ExtendableMessageEvent::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8ExtendableMessageEvent::InstallInterfaceTemplate,
    nullptr,
    "ExtendableMessageEvent",
    V8ExtendableEvent::GetWrapperTypeInfo(),
    V8ExtendableMessageEvent::kThisTag,
    V8ExtendableMessageEvent::kMaxSubclassTag,
...
const WrapperTypeInfo& ExtendableMessageEvent::wrapper_type_info_ =
    V8ExtendableMessageEvent::wrapper_type_info_;
...
namespace v8_extendable_message_event {
...
BLINK_BINDINGS_TRACE_EVENT("ExtendableMessageEvent.data.get");
...
BLINK_BINDINGS_TRACE_EVENT("ExtendableMessageEvent.origin.get");
...
BLINK_BINDINGS_TRACE_EVENT("ExtendableMessageEvent.lastEventId.get");
...
BLINK_BINDINGS_TRACE_EVENT("ExtendableMessageEvent.source.get");
...
static_assert(bindings::IsReturnTypeCompatible<IDLNullable<V8UnionClientOrMessagePortOrServiceWorker>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Value> v8_return_value = ToV8Traits<IDLNullable<V8UnionClientOrMessagePortOrServiceWorker>>::ToV8(script_state, return_value);
...
BLINK_BINDINGS_TRACE_EVENT("ExtendableMessageEvent.ports.get");
...
static_assert(bindings::IsReturnTypeCompatible<IDLArray<MessagePort>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
BLINK_BINDINGS_TRACE_EVENT("ExtendableMessageEvent.isTrusted.get");
...
BLINK_BINDINGS_TRACE_EVENT("ExtendableMessageEvent.constructor");
...
decltype(NativeValueTraits<ExtendableMessageEventInit>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg2_event_init_dict;
if (info[1]->IsUndefined()) {
  arg2_event_init_dict = ExtendableMessageEventInit::Create();
} else {
  arg2_event_init_dict = NativeValueTraits<ExtendableMessageEventInit>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
}
auto&& return_value = ExtendableMessageEvent::Create(arg1_type, arg2_event_init_dict);
static_assert(bindings::IsReturnTypeCompatible<ExtendableMessageEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8ExtendableMessageEvent::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_extendable_message_event;

}  // namespace 

void V8ExtendableMessageEvent::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8ExtendableMessageEvent::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "ExtendableMessageEvent"));
...
void V8ExtendableMessageEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "ExtendableMessageEvent", kAttributeTable);
}
