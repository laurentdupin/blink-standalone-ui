...
bool V8TimelineTriggerRangeList::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8TimelineTriggerRangeList::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8TimelineTriggerRangeList::InstallInterfaceTemplate,
    nullptr,
    "TimelineTriggerRangeList",
    nullptr,
    V8TimelineTriggerRangeList::kThisTag,
    V8TimelineTriggerRangeList::kMaxSubclassTag,
...
const WrapperTypeInfo& TimelineTriggerRangeList::wrapper_type_info_ =
    V8TimelineTriggerRangeList::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, TimelineTriggerRangeList>::value,
    "TimelineTriggerRangeList inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

v8::Intercepted V8TimelineTriggerRangeList::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TimelineTriggerRangeList_IndexedPropertyGetter");
...
TimelineTriggerRangeList* blink_receiver = V8TimelineTriggerRangeList::ToWrappableUnsafe(isolate, v8_receiver);
...
static_assert(bindings::IsReturnTypeCompatible<TimelineTriggerRange, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
return v8::Intercepted::kYes;
}

v8::Intercepted V8TimelineTriggerRangeList::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TimelineTriggerRangeList_IndexedPropertySetter");
...
v8::Intercepted V8TimelineTriggerRangeList::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TimelineTriggerRangeList_IndexedPropertyDeleter");
...
v8::Intercepted V8TimelineTriggerRangeList::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TimelineTriggerRangeList_IndexedPropertyDefiner");
...
v8::Intercepted V8TimelineTriggerRangeList::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TimelineTriggerRangeList_IndexedPropertyDescriptor");
...
auto intercepted =
    V8TimelineTriggerRangeList::IndexedPropertyGetterCallback(index, info);
...
void V8TimelineTriggerRangeList::IndexedPropertyEnumeratorCallback(const v8::PropertyCallbackInfo<v8::Array>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TimelineTriggerRangeList_IndexedPropertyEnumerator");
...
namespace v8_timeline_trigger_range_list {


void LengthAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TimelineTriggerRangeList_length_Getter");
BLINK_BINDINGS_TRACE_EVENT("TimelineTriggerRangeList.length.get");
...
void ItemOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TimelineTriggerRangeList_item");
BLINK_BINDINGS_TRACE_EVENT("TimelineTriggerRangeList.item");
...
using namespace v8_timeline_trigger_range_list;

}  // namespace 

void V8TimelineTriggerRangeList::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8TimelineTriggerRangeList::GetWrapperTypeInfo();
...
instance_template->SetHandler(
    v8::IndexedPropertyHandlerConfiguration(
        V8TimelineTriggerRangeList::IndexedPropertyGetterCallback,
        V8TimelineTriggerRangeList::IndexedPropertySetterCallback,
        nullptr,  // query
        V8TimelineTriggerRangeList::IndexedPropertyDeleterCallback,
        V8TimelineTriggerRangeList::IndexedPropertyEnumeratorCallback,
        V8TimelineTriggerRangeList::IndexedPropertyDefinerCallback,
        V8TimelineTriggerRangeList::IndexedPropertyDescriptorCallback,
        nullptr,  // index_of
        v8::Local<v8::Value>(),
...
void V8TimelineTriggerRangeList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "TimelineTriggerRangeList", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "TimelineTriggerRangeList", kOperationTable);
}
