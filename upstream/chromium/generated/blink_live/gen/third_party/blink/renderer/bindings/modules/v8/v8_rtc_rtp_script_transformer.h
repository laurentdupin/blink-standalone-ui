...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_RTP_SCRIPT_TRANSFORMER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_RTP_SCRIPT_TRANSFORMER_H_
...
class MODULES_EXPORT V8RTCRtpScriptTransformer final : public bindings::V8InterfaceBridge<V8RTCRtpScriptTransformer, RTCRtpScriptTransformer> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1222);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class RTCRtpScriptTransformer;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_RTP_SCRIPT_TRANSFORMER_H_
