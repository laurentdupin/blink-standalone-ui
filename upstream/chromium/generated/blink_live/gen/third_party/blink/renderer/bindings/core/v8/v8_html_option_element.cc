...
static_assert(std::derived_from<HTMLOptionElement, HTMLElement>);
...
bindings::PerformAttributeSetCEReactionsReflectTypeBoolean(info, html_names::kSelectedAttr);
}
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLOptionElement::GetWrapperTypeInfo(), ElementType::kHTMLOptionElement);
}
...
void V8HTMLOptionElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLOptionElement", kAttributeTable);
}
