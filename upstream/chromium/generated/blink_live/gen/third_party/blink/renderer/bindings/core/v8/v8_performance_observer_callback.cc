...
const char* V8PerformanceObserverCallback::GetHumanReadableName() const {
  return "V8PerformanceObserverCallback";
}

v8::Maybe<void> V8PerformanceObserverCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, PerformanceObserverEntryList* arg1_entries, PerformanceObserver* arg2_observer, const PerformanceObserverCallbackOptions* arg3_options) {
...
v8::Maybe<void> V8PerformanceObserverCallback::Construct(PerformanceObserverEntryList* arg1_entries, PerformanceObserver* arg2_observer, const PerformanceObserverCallbackOptions* arg3_options) {
  const char* const class_like_name = "PerformanceObserverCallback";
...
void V8PerformanceObserverCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, PerformanceObserverEntryList* arg1_entries, PerformanceObserver* arg2_observer, const PerformanceObserverCallbackOptions* arg3_options) {
  v8::Isolate* isolate = GetIsolate();
...
base::expected<void, ScriptValue> V8PerformanceObserverCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, PerformanceObserverEntryList* arg1_entries, PerformanceObserver* arg2_observer, const PerformanceObserverCallbackOptions* arg3_options) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_entries, arg2_observer, arg3_options);
