...
bool V8CSSKeyframesRule::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<CSSKeyframesRule, CSSRule>);
...
const WrapperTypeInfo V8CSSKeyframesRule::wrapper_type_info_{
    ...
    V8CSSKeyframesRule::kThisTag,
    V8CSSKeyframesRule::kMaxSubclassTag,
...
const WrapperTypeInfo& CSSKeyframesRule::wrapper_type_info_ =
    V8CSSKeyframesRule::wrapper_type_info_;
...
v8::Intercepted V8CSSKeyframesRule::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
static_assert(bindings::IsReturnTypeCompatible<CSSKeyframeRule, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
return v8::Intercepted::kYes;
}

v8::Intercepted V8CSSKeyframesRule::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
...
v8::Intercepted V8CSSKeyframesRule::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
...
v8::Intercepted V8CSSKeyframesRule::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
...
v8::Intercepted V8CSSKeyframesRule::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSKeyframesRule_length_Getter");
BLINK_BINDINGS_TRACE_EVENT("CSSKeyframesRule.length.get");
...
blink_receiver->deleteRule(execution_context, arg1_select);
...
auto&& return_value = blink_receiver->findRule(execution_context, arg1_select);
static_assert(bindings::IsReturnTypeCompatible<IDLNullable<CSSKeyframeRule>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
}
...
instance_template->SetHandler(
    v8::IndexedPropertyHandlerConfiguration(
        ...
        nullptr,  // query
        V8CSSKeyframesRule::IndexedPropertyDeleterCallback,
        V8CSSKeyframesRule::IndexedPropertyEnumeratorCallback,
...
void V8CSSKeyframesRule::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "CSSKeyframesRule", kAttributeTable);
}
...
{"appendRule", AppendRuleOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
...
void V8CSSKeyframesRule::InstallContextIndependentProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
  using bindings::IDLMemberInstaller;

if (RuntimeEnabledFeatures::CSSKeyframesRuleLengthEnabled()) {
