...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SHARED_STORAGE_MODIFIER_METHOD_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SHARED_STORAGE_MODIFIER_METHOD_H_
...
class MODULES_EXPORT V8SharedStorageModifierMethod final : public bindings::V8InterfaceBridge<V8SharedStorageModifierMethod, SharedStorageModifierMethod> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1254);
  static constexpr v8::CppHeapPointerTag kMaxSubclassTag =
      static_cast<v8::CppHeapPointerTag>(1258);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SharedStorageModifierMethod;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SHARED_STORAGE_MODIFIER_METHOD_H_
