...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_VIRTUAL_KEYBOARD_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_VIRTUAL_KEYBOARD_H_
...
class MODULES_EXPORT V8VirtualKeyboard final : public bindings::V8InterfaceBridge<V8VirtualKeyboard, VirtualKeyboard> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(802);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_VIRTUAL_KEYBOARD_H_
