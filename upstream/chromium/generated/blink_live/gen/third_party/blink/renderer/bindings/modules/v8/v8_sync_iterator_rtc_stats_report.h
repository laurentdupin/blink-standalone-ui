...
template <>
class MODULES_EXPORT SyncIterator<RTCStatsReport> final : public bindings::SyncIteratorBase {
...
using ValueType = ScriptObject;

explicit  SyncIterator<RTCStatsReport>(IterationSourceBase* source, Kind kind) : bindings::SyncIteratorBase(source, kind) {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1499);
