...
static_assert(std::derived_from<SVGImageElement, SVGGraphicsElement>);
...
const WrapperTypeInfo& SVGImageElement::wrapper_type_info_ =
    V8SVGImageElement::wrapper_type_info_;
...
bindings::PerformAttributeSetCEReactionsReflectTypeString(info, svg_names::kDecodingAttr);
}
...
bindings::PerformAttributeSetCEReactionsReflectTypeStringOrNull(info, svg_names::kCrossoriginAttr);
}
...
void V8SVGImageElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGImageElement", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGImageElement", kOperationTable);
}
