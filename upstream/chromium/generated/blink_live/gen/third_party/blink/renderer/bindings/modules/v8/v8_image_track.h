...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_IMAGE_TRACK_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_IMAGE_TRACK_H_
...
class MODULES_EXPORT V8ImageTrack final : public bindings::V8InterfaceBridge<V8ImageTrack, ImageTrack> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1286);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class ImageTrack;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_IMAGE_TRACK_H_
