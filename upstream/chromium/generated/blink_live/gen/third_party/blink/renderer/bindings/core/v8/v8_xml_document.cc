...
bool V8XMLDocument::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<XMLDocument, Document>);
...
const WrapperTypeInfo V8XMLDocument::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8XMLDocument::InstallInterfaceTemplate,
    nullptr,
    "XMLDocument",
    V8Document::GetWrapperTypeInfo(),
    V8XMLDocument::kThisTag,
    V8XMLDocument::kMaxSubclassTag,
...
const WrapperTypeInfo& XMLDocument::wrapper_type_info_ =
    V8XMLDocument::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, XMLDocument>::value,
    "XMLDocument inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_xml_document {
...
BLINK_BINDINGS_TRACE_EVENT("XMLDocument.location.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
XMLDocument* blink_receiver = V8XMLDocument::ToWrappableUnsafe(isolate, v8_receiver);
...
BLINK_BINDINGS_TRACE_EVENT("XMLDocument.location.set");
...
using namespace v8_xml_document;

}  // namespace 

void V8XMLDocument::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8XMLDocument::GetWrapperTypeInfo();
...
void V8XMLDocument::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "XMLDocument", kAttributeTable);
}
