...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_GEOLOCATION_COORDINATES_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_GEOLOCATION_COORDINATES_H_
...
class CORE_EXPORT V8GeolocationCoordinates final : public bindings::V8InterfaceBridge<V8GeolocationCoordinates, GeolocationCoordinates> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(878);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class GeolocationCoordinates;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_GEOLOCATION_COORDINATES_H_
