...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_CANVAS_CONTEXT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_CANVAS_CONTEXT_H_
...
class MODULES_EXPORT V8GPUCanvasContext final : public bindings::V8InterfaceBridge<V8GPUCanvasContext, GPUCanvasContext> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1374);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class GPUCanvasContext;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_CANVAS_CONTEXT_H_
