...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PROCESSING_INSTRUCTION_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PROCESSING_INSTRUCTION_H_
...
class CORE_EXPORT V8ProcessingInstruction final : public bindings::V8InterfaceBridge<V8ProcessingInstruction, ProcessingInstruction> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(584);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PROCESSING_INSTRUCTION_H_
