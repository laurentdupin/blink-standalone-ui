...
v8::Local<v8::Value> V8UnionURLPatternInitOrUSVString::DirectToV8(ScriptState* script_state, URLPatternInit* value) {
  return ToV8Traits<URLPatternInit>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionURLPatternInitOrUSVString::DirectToV8(ScriptState* script_state, const String& value) {
