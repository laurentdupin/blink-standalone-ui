...
class CORE_EXPORT V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVString final : public bindings::UnionBase {
  
  public:
// The type of the content value of this IDL union.
enum class ContentType {
kArrayBuffer, kArrayBufferView, kBlob, kUSVString
};

static V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVString* Create(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state);

explicit  V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVString(DOMArrayBuffer* value) : content_type_(ContentType::kArrayBuffer), member_array_buffer_(value) {
  DCHECK(value);
}
explicit  V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVString(NotShared<DOMArrayBufferView> value) : content_type_(ContentType::kArrayBufferView), member_array_buffer_view_(value) {
  DCHECK(value);
}
explicit  V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVString(Blob* value) : content_type_(ContentType::kBlob), member_blob_(value) {
  DCHECK(value);
}
...
using Ret = bindings::OptimizedReturnProxy<V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVString>;
...
static constexpr const char* UnionNameInIDL() {
  return "(ArrayBuffer or ArrayBufferView or Blob or USVString)";
}
