...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_MATH_RANDOM_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_MATH_RANDOM_H_
...
class CORE_EXPORT V8CSSMathRandom final : public bindings::V8InterfaceBridge<V8CSSMathRandom, CSSMathRandom> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(329);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSMathRandom;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_MATH_RANDOM_H_
