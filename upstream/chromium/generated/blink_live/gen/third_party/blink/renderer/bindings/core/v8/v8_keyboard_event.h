...
class CORE_EXPORT V8KeyboardEvent final : public bindings::V8InterfaceBridge<V8KeyboardEvent, KeyboardEvent> {
...
class Constant final {
  ...
  public:
static constexpr uint32_t kDOMKeyLocationStandard = 0x00;
static constexpr uint32_t kDOMKeyLocationLeft = 0x01;
static constexpr uint32_t kDOMKeyLocationRight = 0x02;
static constexpr uint32_t kDOMKeyLocationNumpad = 0x03;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(477);
