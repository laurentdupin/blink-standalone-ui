...
bool V8WebGLContextEvent::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow() || execution_context->IsWorkerGlobalScope();
}

static_assert(std::derived_from<WebGLContextEvent, Event>);
...
const WrapperTypeInfo V8WebGLContextEvent::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8WebGLContextEvent::InstallInterfaceTemplate,
    nullptr,
    "WebGLContextEvent",
    V8Event::GetWrapperTypeInfo(),
    V8WebGLContextEvent::kThisTag,
    V8WebGLContextEvent::kMaxSubclassTag,
...
const WrapperTypeInfo& WebGLContextEvent::wrapper_type_info_ =
    V8WebGLContextEvent::wrapper_type_info_;
...
namespace v8_webgl_context_event {


void StatusMessageAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_WebGLContextEvent_statusMessage_Getter");
BLINK_BINDINGS_TRACE_EVENT("WebGLContextEvent.statusMessage.get");
...
BLINK_BINDINGS_TRACE_EVENT("WebGLContextEvent.isTrusted.get");
...
BLINK_BINDINGS_TRACE_EVENT("WebGLContextEvent.constructor");
...
decltype(NativeValueTraits<WebGLContextEventInit>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg2_event_init;
if (info[1]->IsUndefined()) {
  arg2_event_init = WebGLContextEventInit::Create();
} else {
  arg2_event_init = NativeValueTraits<WebGLContextEventInit>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
}
auto&& return_value = WebGLContextEvent::Create(arg1_type, arg2_event_init);
static_assert(bindings::IsReturnTypeCompatible<WebGLContextEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8WebGLContextEvent::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_webgl_context_event;

}  // namespace 

void V8WebGLContextEvent::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8WebGLContextEvent::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "WebGLContextEvent"));
...
void V8WebGLContextEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
  using bindings::IDLMemberInstaller;

{
  
static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
{"statusMessage", StatusMessageAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "WebGLContextEvent", kAttributeTable);
}
