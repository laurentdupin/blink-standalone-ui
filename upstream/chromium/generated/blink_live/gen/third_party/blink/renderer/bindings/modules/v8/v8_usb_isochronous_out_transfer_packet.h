...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_USB_ISOCHRONOUS_OUT_TRANSFER_PACKET_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_USB_ISOCHRONOUS_OUT_TRANSFER_PACKET_H_
...
class MODULES_EXPORT V8USBIsochronousOutTransferPacket final : public bindings::V8InterfaceBridge<V8USBIsochronousOutTransferPacket, USBIsochronousOutTransferPacket> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1418);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class USBIsochronousOutTransferPacket;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_USB_ISOCHRONOUS_OUT_TRANSFER_PACKET_H_
