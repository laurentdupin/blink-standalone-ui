...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_UNIT_VALUE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_UNIT_VALUE_H_
...
class CORE_EXPORT V8CSSUnitValue final : public bindings::V8InterfaceBridge<V8CSSUnitValue, CSSUnitValue> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(331);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSUnitValue;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_UNIT_VALUE_H_
