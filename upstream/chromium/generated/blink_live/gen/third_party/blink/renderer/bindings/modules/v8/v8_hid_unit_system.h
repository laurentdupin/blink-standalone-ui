...
kNone, kSiLinear, kSiRotation, kEnglishLinear, kEnglishRotation, kVendorDefined, kReserved
};
...
explicit constexpr  V8HIDUnitSystem(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
