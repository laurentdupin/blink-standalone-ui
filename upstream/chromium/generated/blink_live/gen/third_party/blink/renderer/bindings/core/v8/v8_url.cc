...
bool V8URL::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8URL::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8URL::InstallInterfaceTemplate,
    V8URL::InstallContextDependentProperties,
    "URL",
    nullptr,
    V8URL::kThisTag,
    V8URL::kMaxSubclassTag,
...
const WrapperTypeInfo& DOMURL::wrapper_type_info_ =
    V8URL::wrapper_type_info_;
