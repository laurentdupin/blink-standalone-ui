...
bool V8SVGTextElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<SVGTextElement, SVGTextPositioningElement>);
...
const WrapperTypeInfo V8SVGTextElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SVGTextElement::InstallInterfaceTemplate,
    nullptr,
    "SVGTextElement",
    V8SVGTextPositioningElement::GetWrapperTypeInfo(),
    V8SVGTextElement::kThisTag,
    V8SVGTextElement::kMaxSubclassTag,
...
const WrapperTypeInfo& SVGTextElement::wrapper_type_info_ =
    V8SVGTextElement::wrapper_type_info_;
...
namespace v8_svg_text_element {



}  // namespace v8_svg_text_element

using namespace v8_svg_text_element;

}  // namespace 

void V8SVGTextElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SVGTextElement::GetWrapperTypeInfo();
