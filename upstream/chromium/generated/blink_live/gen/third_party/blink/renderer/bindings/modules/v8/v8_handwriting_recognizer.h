...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_HANDWRITING_RECOGNIZER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_HANDWRITING_RECOGNIZER_H_
...
class MODULES_EXPORT V8HandwritingRecognizer final : public bindings::V8InterfaceBridge<V8HandwritingRecognizer, HandwritingRecognizer> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1172);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class HandwritingRecognizer;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_HANDWRITING_RECOGNIZER_H_
