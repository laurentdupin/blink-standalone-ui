...
bool V8SVGFEMergeElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<SVGFEMergeElement, SVGElement>);
...
const WrapperTypeInfo V8SVGFEMergeElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SVGFEMergeElement::InstallInterfaceTemplate,
    nullptr,
    "SVGFEMergeElement",
    V8SVGElement::GetWrapperTypeInfo(),
    V8SVGFEMergeElement::kThisTag,
    V8SVGFEMergeElement::kMaxSubclassTag,
...
const WrapperTypeInfo& SVGFEMergeElement::wrapper_type_info_ =
    V8SVGFEMergeElement::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, SVGFEMergeElement>::value,
    "SVGFEMergeElement inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_svg_fe_merge_element {
...
BLINK_BINDINGS_TRACE_EVENT("SVGFEMergeElement.x.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
SVGFEMergeElement* blink_receiver = V8SVGFEMergeElement::ToWrappableUnsafe(isolate, v8_receiver);
...
BLINK_BINDINGS_TRACE_EVENT("SVGFEMergeElement.y.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFEMergeElement.width.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFEMergeElement.height.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFEMergeElement.result.get");
...
using namespace v8_svg_fe_merge_element;

}  // namespace 

void V8SVGFEMergeElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SVGFEMergeElement::GetWrapperTypeInfo();
...
void V8SVGFEMergeElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGFEMergeElement", kAttributeTable);
}
