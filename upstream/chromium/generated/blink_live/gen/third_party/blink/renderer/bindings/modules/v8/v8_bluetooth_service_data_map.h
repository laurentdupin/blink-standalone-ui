...
class MODULES_EXPORT V8BluetoothServiceDataMap final : public bindings::V8InterfaceBridge<V8BluetoothServiceDataMap, BluetoothServiceDataMap> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1095);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class BluetoothServiceDataMap;
};
