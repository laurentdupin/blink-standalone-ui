...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_TEMPLATE_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_TEMPLATE_ELEMENT_H_
...
class CORE_EXPORT V8HTMLTemplateElement final : public bindings::V8InterfaceBridge<V8HTMLTemplateElement, HTMLTemplateElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(667);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class HTMLTemplateElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_TEMPLATE_ELEMENT_H_
