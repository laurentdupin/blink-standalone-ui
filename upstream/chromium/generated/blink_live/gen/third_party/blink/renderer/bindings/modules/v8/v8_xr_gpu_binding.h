...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_GPU_BINDING_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_GPU_BINDING_H_
...
class MODULES_EXPORT V8XRGPUBinding final : public bindings::V8InterfaceBridge<V8XRGPUBinding, XRGPUBinding> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1429);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XRGPUBinding;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_GPU_BINDING_H_
