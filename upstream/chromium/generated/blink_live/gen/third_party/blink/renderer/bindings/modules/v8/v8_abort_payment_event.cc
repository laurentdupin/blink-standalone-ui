...
bool V8AbortPaymentEvent::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsServiceWorkerGlobalScope() && RuntimeEnabledFeatures::PaymentAppEnabled();
}

static_assert(std::derived_from<AbortPaymentEvent, ExtendableEvent>);
...
const WrapperTypeInfo V8AbortPaymentEvent::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8AbortPaymentEvent::InstallInterfaceTemplate,
    nullptr,
    "AbortPaymentEvent",
    V8ExtendableEvent::GetWrapperTypeInfo(),
    V8AbortPaymentEvent::kThisTag,
    V8AbortPaymentEvent::kMaxSubclassTag,
...
const WrapperTypeInfo& AbortPaymentEvent::wrapper_type_info_ =
    V8AbortPaymentEvent::wrapper_type_info_;
...
namespace v8_abort_payment_event {
...
BLINK_BINDINGS_TRACE_EVENT("AbortPaymentEvent.isTrusted.get");
...
BLINK_BINDINGS_TRACE_EVENT("AbortPaymentEvent.constructor");
...
auto&& arg2_event_init_dict = NativeValueTraits<ExtendableEventInit>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& return_value = AbortPaymentEvent::Create(arg1_type, arg2_event_init_dict);
static_assert(bindings::IsReturnTypeCompatible<AbortPaymentEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8AbortPaymentEvent::GetWrapperTypeInfo(), v8_receiver);
...
BLINK_BINDINGS_TRACE_EVENT("AbortPaymentEvent.respondWith");
...
ExceptionState exception_state(isolate);
auto&& arg1_payment_aborted_response = NativeValueTraits<IDLPromise<IDLBoolean>>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
blink_receiver->respondWith(script_state, arg1_payment_aborted_response, exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
using namespace v8_abort_payment_event;

}  // namespace 

void V8AbortPaymentEvent::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8AbortPaymentEvent::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "AbortPaymentEvent"));
...
void V8AbortPaymentEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "AbortPaymentEvent", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "AbortPaymentEvent", kOperationTable);
}
