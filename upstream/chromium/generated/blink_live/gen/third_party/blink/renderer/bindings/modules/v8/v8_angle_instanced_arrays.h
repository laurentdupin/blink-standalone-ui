...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ANGLE_INSTANCED_ARRAYS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ANGLE_INSTANCED_ARRAYS_H_
...
class MODULES_EXPORT V8ANGLEInstancedArrays final : public bindings::V8InterfaceBridge<V8ANGLEInstancedArrays, ANGLEInstancedArrays> {
...
class Constant final {
  ...
  public:
static constexpr uint32_t kVertexAttribArrayDivisorAngle = 0x88FE;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1291);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class ANGLEInstancedArrays;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ANGLE_INSTANCED_ARRAYS_H_
