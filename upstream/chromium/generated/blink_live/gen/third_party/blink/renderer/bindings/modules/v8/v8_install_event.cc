...
bool V8InstallEvent::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsServiceWorkerGlobalScope();
}

static_assert(std::derived_from<InstallEvent, ExtendableEvent>);
...
const WrapperTypeInfo V8InstallEvent::wrapper_type_info_{
    ...
    V8InstallEvent::kThisTag,
    V8InstallEvent::kMaxSubclassTag,
...
const WrapperTypeInfo& InstallEvent::wrapper_type_info_ =
    V8InstallEvent::wrapper_type_info_;
...
static_assert(bindings::IsReturnTypeCompatible<InstallEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
interface_function_template->SetInterfaceName(V8String(isolate, "InstallEvent"));
...
void V8InstallEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "InstallEvent", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "InstallEvent", kOperationTable);
}
