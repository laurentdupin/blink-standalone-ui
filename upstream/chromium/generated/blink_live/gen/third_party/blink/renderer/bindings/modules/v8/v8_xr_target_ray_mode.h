...
class MODULES_EXPORT V8XRTargetRayMode final : public bindings::EnumerationBase {
  
  public:
enum class Enum : enum_int_t {
kGaze, kTrackedPointer, kScreen
};
static constexpr size_t kEnumSize = 3;

static V8XRTargetRayMode Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8XRTargetRayMode> Create(const String& value);

explicit constexpr  V8XRTargetRayMode(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8XRTargetRayMode& lhs, V8XRTargetRayMode::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8XRTargetRayMode::Enum lhs, const V8XRTargetRayMode& rhs) {
