...
const char* V8MojoWatchCallback::GetHumanReadableName() const {
  return "V8MojoWatchCallback";
}

v8::Maybe<void> V8MojoWatchCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, uint32_t arg1_result) {
  const char* const class_like_name = "MojoWatchCallback";
...
v8::Local<v8::Value> v8_arg1_result;
ScriptState* script_state = CallbackRelevantScriptState();
v8_arg1_result = ToV8Traits<IDLUnsignedLong>::ToV8(script_state, arg1_result);
argv[0] = v8_arg1_result;
...
v8::Maybe<void> V8MojoWatchCallback::Construct(uint32_t arg1_result) {
  const char* const class_like_name = "MojoWatchCallback";
...
void V8MojoWatchCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, uint32_t arg1_result) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = Invoke(arg0_receiver, arg1_result);
}

base::expected<void, ScriptValue> V8MojoWatchCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, uint32_t arg1_result) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_result);
