...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MEDIA_SOURCE_HANDLE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MEDIA_SOURCE_HANDLE_H_
...
class MODULES_EXPORT V8MediaSourceHandle final : public bindings::V8InterfaceBridge<V8MediaSourceHandle, MediaSourceHandleImpl> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1193);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class MediaSourceHandleImpl;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MEDIA_SOURCE_HANDLE_H_
