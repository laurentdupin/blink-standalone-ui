...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_INTEREST_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_INTEREST_EVENT_H_
...
class CORE_EXPORT V8InterestEvent final : public bindings::V8InterfaceBridge<V8InterestEvent, InterestEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(422);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class InterestEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_INTEREST_EVENT_H_
