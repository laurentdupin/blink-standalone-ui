...
bool V8HTMLTitleElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<HTMLTitleElement, HTMLElement>);
...
const WrapperTypeInfo V8HTMLTitleElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8HTMLTitleElement::InstallInterfaceTemplate,
    nullptr,
    "HTMLTitleElement",
    V8HTMLElement::GetWrapperTypeInfo(),
    V8HTMLTitleElement::kThisTag,
    V8HTMLTitleElement::kMaxSubclassTag,
...
const WrapperTypeInfo& HTMLTitleElement::wrapper_type_info_ =
    V8HTMLTitleElement::wrapper_type_info_;
...
namespace v8_html_title_element {
...
BLINK_BINDINGS_TRACE_EVENT("HTMLTitleElement.text.get");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLTitleElement.text.set");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLTitleElement.constructor");
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLTitleElement::GetWrapperTypeInfo(), ElementType::kHTMLTitleElement);
}


}  // namespace v8_html_title_element

using namespace v8_html_title_element;

}  // namespace 

void V8HTMLTitleElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8HTMLTitleElement::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "HTMLTitleElement"));
...
void V8HTMLTitleElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLTitleElement", kAttributeTable);
}
