...
const char* V8NotificationPermissionCallback::GetHumanReadableName() const {
  return "V8NotificationPermissionCallback";
}

v8::Maybe<void> V8NotificationPermissionCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, V8NotificationPermission arg1_permission) {
  const char* const class_like_name = "NotificationPermissionCallback";
...
v8::Local<v8::Value> v8_arg1_permission;
ScriptState* script_state = CallbackRelevantScriptState();
v8_arg1_permission = ToV8Traits<V8NotificationPermission>::ToV8(script_state, arg1_permission);
argv[0] = v8_arg1_permission;
...
v8::Maybe<void> V8NotificationPermissionCallback::Construct(V8NotificationPermission arg1_permission) {
  const char* const class_like_name = "NotificationPermissionCallback";
...
void V8NotificationPermissionCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, V8NotificationPermission arg1_permission) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = Invoke(arg0_receiver, arg1_permission);
}

base::expected<void, ScriptValue> V8NotificationPermissionCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, V8NotificationPermission arg1_permission) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_permission);
