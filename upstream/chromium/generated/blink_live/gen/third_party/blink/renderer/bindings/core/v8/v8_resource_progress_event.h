...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_RESOURCE_PROGRESS_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_RESOURCE_PROGRESS_EVENT_H_
...
class CORE_EXPORT V8ResourceProgressEvent final : public bindings::V8InterfaceBridge<V8ResourceProgressEvent, ResourceProgressEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(447);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class ResourceProgressEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_RESOURCE_PROGRESS_EVENT_H_
