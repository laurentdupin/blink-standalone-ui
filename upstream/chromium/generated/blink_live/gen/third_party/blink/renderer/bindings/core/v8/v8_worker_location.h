...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_WORKER_LOCATION_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_WORKER_LOCATION_H_
...
class CORE_EXPORT V8WorkerLocation final : public bindings::V8InterfaceBridge<V8WorkerLocation, WorkerLocation> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1034);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class WorkerLocation;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_WORKER_LOCATION_H_
