...
const char* V8DecodeErrorCallback::GetHumanReadableName() const {
  return "V8DecodeErrorCallback";
}

v8::Maybe<void> V8DecodeErrorCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, DOMException* arg1_error) {
  const char* const class_like_name = "DecodeErrorCallback";
...
v8::Maybe<void> V8DecodeErrorCallback::Construct(DOMException* arg1_error) {
  const char* const class_like_name = "DecodeErrorCallback";
...
void V8DecodeErrorCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, DOMException* arg1_error) {
  v8::Isolate* isolate = GetIsolate();
...
base::expected<void, ScriptValue> V8DecodeErrorCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, DOMException* arg1_error) {
