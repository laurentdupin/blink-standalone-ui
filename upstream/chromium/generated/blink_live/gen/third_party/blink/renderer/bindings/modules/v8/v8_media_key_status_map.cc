...
bool V8MediaKeyStatusMap::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8MediaKeyStatusMap::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8MediaKeyStatusMap::InstallInterfaceTemplate,
    V8MediaKeyStatusMap::InstallContextDependentProperties,
    "MediaKeyStatusMap",
    nullptr,
    V8MediaKeyStatusMap::kThisTag,
    V8MediaKeyStatusMap::kMaxSubclassTag,
...
const WrapperTypeInfo& MediaKeyStatusMap::wrapper_type_info_ =
    V8MediaKeyStatusMap::wrapper_type_info_;
...
namespace v8_media_key_status_map {
...
BLINK_BINDINGS_TRACE_EVENT("MediaKeyStatusMap.size.get");
...
BLINK_BINDINGS_TRACE_EVENT("MediaKeyStatusMap.get");
...
auto&& return_value = blink_receiver->get(script_state, arg1_key_id);
static_assert(bindings::IsReturnTypeCompatible<V8UnionMediaKeyStatusOrUndefined, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Value> v8_return_value = ToV8Traits<V8UnionMediaKeyStatusOrUndefined>::ToV8(script_state, return_value);
...
BLINK_BINDINGS_TRACE_EVENT("MediaKeyStatusMap.has");
...
auto&& return_value = blink_receiver->has(arg1_key_id);
...
void EntriesOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaKeyStatusMap_entries");
BLINK_BINDINGS_TRACE_EVENT("MediaKeyStatusMap.entries");
...
static_assert(bindings::IsReturnTypeCompatible<SyncIterator<MediaKeyStatusMap>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
BLINK_BINDINGS_TRACE_EVENT("MediaKeyStatusMap.forEach");
...
BLINK_BINDINGS_TRACE_EVENT("MediaKeyStatusMap.keys");
...
BLINK_BINDINGS_TRACE_EVENT("MediaKeyStatusMap.values");
...
using namespace v8_media_key_status_map;

}  // namespace 

void V8MediaKeyStatusMap::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8MediaKeyStatusMap::GetWrapperTypeInfo();
...
void V8MediaKeyStatusMap::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "MediaKeyStatusMap", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "MediaKeyStatusMap", kOperationTable);
}
...
void V8MediaKeyStatusMap::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object, v8::Local<v8::Object> prototype_object, v8::Local<v8::Object> interface_object, v8::Local<v8::Template> interface_template, FeatureSelector feature_selector) {
  using bindings::IDLMemberInstaller;
