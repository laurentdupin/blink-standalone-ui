...
bool V8HTMLDataElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<HTMLDataElement, HTMLElement>);
...
const WrapperTypeInfo V8HTMLDataElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8HTMLDataElement::InstallInterfaceTemplate,
    nullptr,
    "HTMLDataElement",
    V8HTMLElement::GetWrapperTypeInfo(),
    V8HTMLDataElement::kThisTag,
    V8HTMLDataElement::kMaxSubclassTag,
...
const WrapperTypeInfo& HTMLDataElement::wrapper_type_info_ =
    V8HTMLDataElement::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, HTMLDataElement>::value,
    "HTMLDataElement inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_html_data_element {
...
BLINK_BINDINGS_TRACE_EVENT("HTMLDataElement.value.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
HTMLDataElement* blink_receiver = V8HTMLDataElement::ToWrappableUnsafe(isolate, v8_receiver);
...
BLINK_BINDINGS_TRACE_EVENT("HTMLDataElement.value.set");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLDataElement.constructor");
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLDataElement::GetWrapperTypeInfo(), ElementType::kHTMLDataElement);
}


}  // namespace v8_html_data_element

using namespace v8_html_data_element;

}  // namespace 

void V8HTMLDataElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8HTMLDataElement::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "HTMLDataElement"));
...
void V8HTMLDataElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLDataElement", kAttributeTable);
}
