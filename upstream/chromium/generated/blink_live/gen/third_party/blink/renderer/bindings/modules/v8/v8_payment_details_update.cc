...
return dictionary;
 ...
 PaymentDetailsUpdate::PaymentDetailsUpdate(v8::Isolate* isolate) : PaymentDetailsBase(isolate) {
...
void PaymentDetailsUpdate::FillTemplateProperties(Vector<std::string_view>& properties) const {
...
if (!bindings::GetDictionaryMemberFromV8Object<IDLObject, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate), has_payment_method_errors_, member_payment_method_errors_, class_like_name, exception_state)) {
  return;
}
dictionary_from_v8_context.SetCurrentPropertyName("shippingAddressErrors");
if (!bindings::GetDictionaryMemberFromV8Object<AddressErrors, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[2].Get(isolate), has_shipping_address_errors_, member_shipping_address_errors_, class_like_name, exception_state)) {
  return;
}
