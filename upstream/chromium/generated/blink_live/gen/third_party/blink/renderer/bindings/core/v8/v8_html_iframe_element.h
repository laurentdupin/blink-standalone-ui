...
class CORE_EXPORT V8HTMLIFrameElement final : public bindings::V8InterfaceBridge<V8HTMLIFrameElement, HTMLIFrameElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(622);
