...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_STORAGE_BUCKET_MANAGER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_STORAGE_BUCKET_MANAGER_H_
...
class MODULES_EXPORT V8StorageBucketManager final : public bindings::V8InterfaceBridge<V8StorageBucketManager, StorageBucketManager> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1100);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class StorageBucketManager;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_STORAGE_BUCKET_MANAGER_H_
