...
class MODULES_EXPORT V8PaymentShippingType final : public bindings::EnumerationBase {
  
  public:
enum class Enum : enum_int_t {
kShipping, kDelivery, kPickup
};
static constexpr size_t kEnumSize = 3;

static V8PaymentShippingType Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8PaymentShippingType> Create(const String& value);

explicit constexpr  V8PaymentShippingType(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8PaymentShippingType& lhs, V8PaymentShippingType::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8PaymentShippingType::Enum lhs, const V8PaymentShippingType& rhs) {
