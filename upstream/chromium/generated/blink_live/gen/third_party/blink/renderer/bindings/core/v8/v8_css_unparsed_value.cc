...
static_assert(std::derived_from<CSSUnparsedValue, CSSStyleValue>);
...
const WrapperTypeInfo& CSSUnparsedValue::wrapper_type_info_ =
    V8CSSUnparsedValue::wrapper_type_info_;
...
static_assert(bindings::IsReturnTypeCompatible<V8UnionCSSVariableReferenceValueOrString, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
v8::Intercepted V8CSSUnparsedValue::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
...
CSSUnparsedValue* blink_receiver = V8CSSUnparsedValue::ToWrappableUnsafe(isolate, v8_receiver);
ExceptionState exception_state(isolate);
auto&& blink_property_value = NativeValueTraits<V8UnionCSSVariableReferenceValueOrString>::ArgumentValue(isolate, 1, v8_property_value, exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return v8::Intercepted::kYes;
}
...
v8::Intercepted V8CSSUnparsedValue::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
...
static_assert(bindings::IsReturnTypeCompatible<CSSUnparsedValue, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
instance_template->SetHandler(
    v8::IndexedPropertyHandlerConfiguration(
        ...
        nullptr,  // query
        V8CSSUnparsedValue::IndexedPropertyDeleterCallback,
        V8CSSUnparsedValue::IndexedPropertyEnumeratorCallback,
...
void V8CSSUnparsedValue::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "CSSUnparsedValue", kAttributeTable);
}
