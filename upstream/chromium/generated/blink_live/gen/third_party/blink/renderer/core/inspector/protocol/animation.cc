...
public:
    ...
    void getCurrentTime(crdtp::Dispatchable& dispatchable);
    void getPlaybackRate(crdtp::Dispatchable& dispatchable);
    void releaseAnimations(crdtp::Dispatchable& dispatchable);
    void resolveAnimation(crdtp::Dispatchable& dispatchable);
    void seekAnimations(crdtp::Dispatchable& dispatchable);
    void setPaused(crdtp::Dispatchable& dispatchable);
    void setPlaybackRate(crdtp::Dispatchable& dispatchable);
    void setTiming(crdtp::Dispatchable& dispatchable);
 protected:
    Backend* m_backend;
};
...
void DomainDispatcherImpl::getCurrentTime(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
...
void DomainDispatcherImpl::getPlaybackRate(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    // Declare output parameters.
...
void DomainDispatcherImpl::releaseAnimations(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
...
void DomainDispatcherImpl::resolveAnimation(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
...
void DomainDispatcherImpl::seekAnimations(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
...
void DomainDispatcherImpl::setPaused(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
...
void DomainDispatcherImpl::setPlaybackRate(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
...
void DomainDispatcherImpl::setTiming(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
