...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_SUBGROUP_MATRIX_CONFIG_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_SUBGROUP_MATRIX_CONFIG_H_
...
class MODULES_EXPORT V8GPUSubgroupMatrixConfig final : public bindings::V8InterfaceBridge<V8GPUSubgroupMatrixConfig, GPUSubgroupMatrixConfig> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1397);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class GPUSubgroupMatrixConfig;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_SUBGROUP_MATRIX_CONFIG_H_
