...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PAYMENT_REQUEST_UPDATE_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PAYMENT_REQUEST_UPDATE_EVENT_H_
...
class MODULES_EXPORT V8PaymentRequestUpdateEvent final : public bindings::V8InterfaceBridge<V8PaymentRequestUpdateEvent, PaymentRequestUpdateEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(440);
  static constexpr v8::CppHeapPointerTag kMaxSubclassTag =
      static_cast<v8::CppHeapPointerTag>(441);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PaymentRequestUpdateEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PAYMENT_REQUEST_UPDATE_EVENT_H_
