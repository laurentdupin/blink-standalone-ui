...
bool V8LayoutShift::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<LayoutShift, PerformanceEntry>);
...
const WrapperTypeInfo V8LayoutShift::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8LayoutShift::InstallInterfaceTemplate,
    nullptr,
    "LayoutShift",
    V8PerformanceEntry::GetWrapperTypeInfo(),
    V8LayoutShift::kThisTag,
    V8LayoutShift::kMaxSubclassTag,
...
const WrapperTypeInfo& LayoutShift::wrapper_type_info_ =
    V8LayoutShift::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, LayoutShift>::value,
    "LayoutShift inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_layout_shift {
...
BLINK_BINDINGS_TRACE_EVENT("LayoutShift.value.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
LayoutShift* blink_receiver = V8LayoutShift::ToWrappableUnsafe(isolate, v8_receiver);
...
void HadRecentInputAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_LayoutShift_hadRecentInput_Getter");
BLINK_BINDINGS_TRACE_EVENT("LayoutShift.hadRecentInput.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
LayoutShift* blink_receiver = V8LayoutShift::ToWrappableUnsafe(isolate, v8_receiver);
auto&& return_value = blink_receiver->hadRecentInput();
...
void LastInputTimeAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_LayoutShift_lastInputTime_Getter");
BLINK_BINDINGS_TRACE_EVENT("LayoutShift.lastInputTime.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
LayoutShift* blink_receiver = V8LayoutShift::ToWrappableUnsafe(isolate, v8_receiver);
auto&& return_value = blink_receiver->lastInputTime();
static_assert(bindings::IsReturnTypeCompatible<IDLDouble, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, bindings::V8ReturnValue::PrimitiveType<double>());
}
...
void SourcesAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_LayoutShift_sources_Getter");
BLINK_BINDINGS_TRACE_EVENT("LayoutShift.sources.get");
...
LayoutShift* blink_receiver = V8LayoutShift::ToWrappableUnsafe(isolate, v8_receiver);
auto&& return_value = blink_receiver->sources();
static_assert(bindings::IsReturnTypeCompatible<IDLArray<LayoutShiftAttribution>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Value> v8_return_value = ToV8Traits<IDLArray<LayoutShiftAttribution>>::ToV8(script_state, return_value);
...
using namespace v8_layout_shift;

}  // namespace 

void V8LayoutShift::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8LayoutShift::GetWrapperTypeInfo();
...
void V8LayoutShift::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"hadRecentInput", HadRecentInputAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
{"lastInputTime", LastInputTimeAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
{"sources", SourcesAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
};
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "LayoutShift", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "LayoutShift", kOperationTable);
}
