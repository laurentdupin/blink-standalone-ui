...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_ANIMATED_STRING_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_ANIMATED_STRING_H_
...
class CORE_EXPORT V8SVGAnimatedString final : public bindings::V8InterfaceBridge<V8SVGAnimatedString, SVGAnimatedString> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(973);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGAnimatedString;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_ANIMATED_STRING_H_
