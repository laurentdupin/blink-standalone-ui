...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_BYTE_LENGTH_QUEUING_STRATEGY_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_BYTE_LENGTH_QUEUING_STRATEGY_H_
...
class CORE_EXPORT V8ByteLengthQueuingStrategy final : public bindings::V8InterfaceBridge<V8ByteLengthQueuingStrategy, ByteLengthQueuingStrategy> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(947);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class ByteLengthQueuingStrategy;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_BYTE_LENGTH_QUEUING_STRATEGY_H_
