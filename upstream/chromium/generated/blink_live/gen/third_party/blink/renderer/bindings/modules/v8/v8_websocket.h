...
class MODULES_EXPORT V8WebSocket final : public bindings::V8InterfaceBridge<V8WebSocket, DOMWebSocket> {
...
static constexpr uint16_t kClosing = 2;
static constexpr uint16_t kClosed = 3;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(806);
