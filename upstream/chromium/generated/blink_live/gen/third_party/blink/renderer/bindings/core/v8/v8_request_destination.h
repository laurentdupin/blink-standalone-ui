...
k, kAudio, kAudioworklet, kDocument, kEmbed, kFont, kFrame, kIFrame, kImage, kJson, kManifest, kObject, kPaintworklet, kReport, kScript, kServiceworker, kSharedworker, kStyle, kTrack, kVideo, kWorker, kXslt, kFencedframe, kDictionary, kSpeculationrules, kSharedstorageworklet, kWebbundle
};
static constexpr size_t kEnumSize = 27;
