...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_SWITCH_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_SWITCH_ELEMENT_H_
...
class CORE_EXPORT V8SVGSwitchElement final : public bindings::V8InterfaceBridge<V8SVGSwitchElement, SVGSwitchElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(729);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGSwitchElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_SWITCH_ELEMENT_H_
