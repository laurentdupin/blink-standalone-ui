...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CLIPBOARD_CHANGE_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CLIPBOARD_CHANGE_EVENT_H_
...
class MODULES_EXPORT V8ClipboardChangeEvent final : public bindings::V8InterfaceBridge<V8ClipboardChangeEvent, ClipboardChangeEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(385);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class ClipboardChangeEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CLIPBOARD_CHANGE_EVENT_H_
