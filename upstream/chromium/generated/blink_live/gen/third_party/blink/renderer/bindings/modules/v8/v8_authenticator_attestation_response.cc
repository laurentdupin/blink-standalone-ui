...
static_assert(std::derived_from<AuthenticatorAttestationResponse, AuthenticatorResponse>);
...
// [Measure], [MeasureAs]
UseCounter::Count(current_execution_context, WebFeature::kV8AuthenticatorAttestationResponse_GetPublicKey_Method);
...
void V8AuthenticatorAttestationResponse::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "AuthenticatorAttestationResponse", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "AuthenticatorAttestationResponse", kOperationTable);
}
