...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PROTECTED_AUDIENCE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PROTECTED_AUDIENCE_H_
...
class MODULES_EXPORT V8ProtectedAudience final : public bindings::V8InterfaceBridge<V8ProtectedAudience, ProtectedAudience> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1070);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class ProtectedAudience;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PROTECTED_AUDIENCE_H_
