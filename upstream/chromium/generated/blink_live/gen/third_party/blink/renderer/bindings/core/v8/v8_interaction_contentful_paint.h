...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_INTERACTION_CONTENTFUL_PAINT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_INTERACTION_CONTENTFUL_PAINT_H_
...
class CORE_EXPORT V8InteractionContentfulPaint final : public bindings::V8InterfaceBridge<V8InteractionContentfulPaint, InteractionContentfulPaint> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(995);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class InteractionContentfulPaint;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_INTERACTION_CONTENTFUL_PAINT_H_
