...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SUMMARIZER_CREATE_OPTIONS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SUMMARIZER_CREATE_OPTIONS_H_
...
class MODULES_EXPORT SummarizerCreateOptions : public SummarizerCreateCoreOptions {
  
  public:
static SummarizerCreateOptions* Create() {
  return MakeGarbageCollected<SummarizerCreateOptions>();
}
static SummarizerCreateOptions* Create(v8::Isolate* isolate) {
  return MakeGarbageCollected<SummarizerCreateOptions>(isolate);
}
static SummarizerCreateOptions* Create(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state);

explicit  SummarizerCreateOptions();
explicit  SummarizerCreateOptions(v8::Isolate* isolate);
...
void Trace(Visitor* visitor) const override;
  ...
  protected:
static constexpr size_t kBasePropertyCount = SummarizerCreateCoreOptions::kTotalPropertyCount;
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SUMMARIZER_CREATE_OPTIONS_H_
