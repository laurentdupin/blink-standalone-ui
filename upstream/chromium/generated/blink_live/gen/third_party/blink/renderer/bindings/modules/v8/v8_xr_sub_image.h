...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_SUB_IMAGE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_SUB_IMAGE_H_
...
class MODULES_EXPORT V8XRSubImage final : public bindings::V8InterfaceBridge<V8XRSubImage, XRSubImage> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1447);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XRSubImage;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_SUB_IMAGE_H_
