...
class CORE_EXPORT V8HTMLFieldSetElement final : public bindings::V8InterfaceBridge<V8HTMLFieldSetElement, HTMLFieldSetElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(612);
