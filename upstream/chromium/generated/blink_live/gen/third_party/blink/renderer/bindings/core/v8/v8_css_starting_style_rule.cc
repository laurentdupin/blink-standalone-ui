...
static_assert(std::derived_from<CSSStartingStyleRule, CSSGroupingRule>);
...
const WrapperTypeInfo V8CSSStartingStyleRule::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8CSSStartingStyleRule::InstallInterfaceTemplate,
    nullptr,
    "CSSStartingStyleRule",
    V8CSSGroupingRule::GetWrapperTypeInfo(),
    V8CSSStartingStyleRule::kThisTag,
    V8CSSStartingStyleRule::kMaxSubclassTag,
...
const WrapperTypeInfo& CSSStartingStyleRule::wrapper_type_info_ =
    V8CSSStartingStyleRule::wrapper_type_info_;
...
namespace v8_css_starting_style_rule {



}  // namespace v8_css_starting_style_rule

using namespace v8_css_starting_style_rule;

}  // namespace 

void V8CSSStartingStyleRule::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8CSSStartingStyleRule::GetWrapperTypeInfo();
