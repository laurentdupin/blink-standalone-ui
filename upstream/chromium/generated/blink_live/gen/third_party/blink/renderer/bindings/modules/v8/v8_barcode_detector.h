...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BARCODE_DETECTOR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BARCODE_DETECTOR_H_
...
class MODULES_EXPORT V8BarcodeDetector final : public bindings::V8InterfaceBridge<V8BarcodeDetector, BarcodeDetector> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1249);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class BarcodeDetector;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BARCODE_DETECTOR_H_
