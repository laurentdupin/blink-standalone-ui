...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_KEYBOARD_LAYOUT_MAP_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_KEYBOARD_LAYOUT_MAP_H_
...
template <>
class MODULES_EXPORT SyncIterator<KeyboardLayoutMap> final : public bindings::SyncIteratorBase {
...
explicit  SyncIterator<KeyboardLayoutMap>(IterationSourceBase* source, Kind kind) : bindings::SyncIteratorBase(source, kind) {
...
class MODULES_EXPORT V8SyncIteratorKeyboardLayoutMap final : public bindings::V8InterfaceBridge<V8SyncIteratorKeyboardLayoutMap, SyncIterator<KeyboardLayoutMap>> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1498);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SyncIterator<KeyboardLayoutMap>;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_KEYBOARD_LAYOUT_MAP_H_
