...
return dictionary;
 ...
 ElementRegistrationOptions::ElementRegistrationOptions(v8::Isolate* isolate) : member_prototype_(isolate, v8::Null(isolate)) {
...
void ElementRegistrationOptions::Trace(Visitor* visitor) const {
  visitor->Trace(member_prototype_);
bindings::DictionaryBase::Trace(visitor);
}

void ElementRegistrationOptions::FillTemplateProperties(Vector<std::string_view>& properties) const {
...
dictionary_from_v8_context.SetCurrentPropertyName("extends");
constexpr bool is_optional = false;
v8::Local<v8::Context> current_context = isolate->GetCurrentContext();
const auto& v8_own_member_names = GetV8OwnMemberNames(isolate);
bool fallback_presence_var;
if (!bindings::GetDictionaryMemberFromV8Object<IDLNullable<IDLString>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), fallback_presence_var, member_extends_, class_like_name, exception_state)) {
  return;
}
dictionary_from_v8_context.SetCurrentPropertyName("prototype");
if (!bindings::GetDictionaryMemberFromV8Object<IDLNullable<IDLObject>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate), fallback_presence_var, member_prototype_, class_like_name, exception_state)) {
  return;
}
}
