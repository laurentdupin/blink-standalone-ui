...
v8::Local<v8::Value> V8UnionClientOrMessagePortOrServiceWorker::DirectToV8(ScriptState* script_state, ServiceWorkerClient* value) {
  return ToV8Traits<ServiceWorkerClient>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionClientOrMessagePortOrServiceWorker::DirectToV8(ScriptState* script_state, MessagePort* value) {
  return ToV8Traits<MessagePort>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionClientOrMessagePortOrServiceWorker::DirectToV8(ScriptState* script_state, ServiceWorker* value) {
  return ToV8Traits<ServiceWorker>::ToV8(script_state, value);
}
