...
v8::Local<v8::Value> V8UnionMediaSourceHandleOrMediaStream::DirectToV8(ScriptState* script_state, MediaSourceHandleImpl* value) {
  return ToV8Traits<MediaSourceHandleImpl>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionMediaSourceHandleOrMediaStream::DirectToV8(ScriptState* script_state, MediaStream* value) {
  return ToV8Traits<MediaStream>::ToV8(script_state, value);
}
