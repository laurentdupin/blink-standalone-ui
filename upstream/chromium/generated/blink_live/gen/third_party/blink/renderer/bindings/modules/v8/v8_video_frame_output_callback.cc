...
const char* V8VideoFrameOutputCallback::GetHumanReadableName() const {
  return "V8VideoFrameOutputCallback";
}

v8::Maybe<void> V8VideoFrameOutputCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, VideoFrame* arg1_output) {
  const char* const class_like_name = "VideoFrameOutputCallback";
...
v8_arg1_output = ToV8Traits<VideoFrame>::ToV8(script_state, arg1_output);
...
v8::Maybe<void> V8VideoFrameOutputCallback::Construct(VideoFrame* arg1_output) {
  const char* const class_like_name = "VideoFrameOutputCallback";
...
void V8VideoFrameOutputCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, VideoFrame* arg1_output) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = Invoke(arg0_receiver, arg1_output);
}

base::expected<void, ScriptValue> V8VideoFrameOutputCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, VideoFrame* arg1_output) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_output);
