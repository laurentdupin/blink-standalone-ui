...
bool V8PaymentMethodChangeEvent::IsExposed(ExecutionContext* execution_context) {
  
const bool is_in_secure_context = execution_context->IsSecureContext();
return is_in_secure_context && execution_context->IsWindow() && RuntimeEnabledFeatures::PaymentMethodChangeEventEnabled();
}

static_assert(std::derived_from<PaymentMethodChangeEvent, PaymentRequestUpdateEvent>);
...
const WrapperTypeInfo V8PaymentMethodChangeEvent::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8PaymentMethodChangeEvent::InstallInterfaceTemplate,
    nullptr,
    "PaymentMethodChangeEvent",
    V8PaymentRequestUpdateEvent::GetWrapperTypeInfo(),
    V8PaymentMethodChangeEvent::kThisTag,
    V8PaymentMethodChangeEvent::kMaxSubclassTag,
...
const WrapperTypeInfo& PaymentMethodChangeEvent::wrapper_type_info_ =
    V8PaymentMethodChangeEvent::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, PaymentMethodChangeEvent>::value,
    "PaymentMethodChangeEvent inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_payment_method_change_event {
...
BLINK_BINDINGS_TRACE_EVENT("PaymentMethodChangeEvent.methodName.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
PaymentMethodChangeEvent* blink_receiver = V8PaymentMethodChangeEvent::ToWrappableUnsafe(isolate, v8_receiver);
...
void MethodDetailsAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_PaymentMethodChangeEvent_methodDetails_Getter");
BLINK_BINDINGS_TRACE_EVENT("PaymentMethodChangeEvent.methodDetails.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
PaymentMethodChangeEvent* blink_receiver = V8PaymentMethodChangeEvent::ToWrappableUnsafe(isolate, v8_receiver);
auto&& return_value = blink_receiver->methodDetails();
...
BLINK_BINDINGS_TRACE_EVENT("PaymentMethodChangeEvent.isTrusted.get");
...
BLINK_BINDINGS_TRACE_EVENT("PaymentMethodChangeEvent.constructor");
...
decltype(NativeValueTraits<PaymentMethodChangeEventInit>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg2_event_init_dict;
if (info[1]->IsUndefined()) {
  arg2_event_init_dict = PaymentMethodChangeEventInit::Create(isolate);
} else {
  arg2_event_init_dict = NativeValueTraits<PaymentMethodChangeEventInit>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
}
auto&& return_value = PaymentMethodChangeEvent::Create(script_state, arg1_type, arg2_event_init_dict);
static_assert(bindings::IsReturnTypeCompatible<PaymentMethodChangeEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8PaymentMethodChangeEvent::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_payment_method_change_event;

}  // namespace 

void V8PaymentMethodChangeEvent::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8PaymentMethodChangeEvent::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "PaymentMethodChangeEvent"));
...
void V8PaymentMethodChangeEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
  using bindings::IDLMemberInstaller;

{
  
static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
{"methodName", MethodNameAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
{"methodDetails", MethodDetailsAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "PaymentMethodChangeEvent", kAttributeTable);
}
