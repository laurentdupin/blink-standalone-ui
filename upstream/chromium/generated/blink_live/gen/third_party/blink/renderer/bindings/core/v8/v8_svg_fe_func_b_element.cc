...
bool V8SVGFEFuncBElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<SVGFEFuncBElement, SVGComponentTransferFunctionElement>);
...
const WrapperTypeInfo V8SVGFEFuncBElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SVGFEFuncBElement::InstallInterfaceTemplate,
    nullptr,
    "SVGFEFuncBElement",
    V8SVGComponentTransferFunctionElement::GetWrapperTypeInfo(),
    V8SVGFEFuncBElement::kThisTag,
    V8SVGFEFuncBElement::kMaxSubclassTag,
...
const WrapperTypeInfo& SVGFEFuncBElement::wrapper_type_info_ =
    V8SVGFEFuncBElement::wrapper_type_info_;
...
namespace v8_svg_fe_func_b_element {



}  // namespace v8_svg_fe_func_b_element

using namespace v8_svg_fe_func_b_element;

}  // namespace 

void V8SVGFEFuncBElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SVGFEFuncBElement::GetWrapperTypeInfo();
