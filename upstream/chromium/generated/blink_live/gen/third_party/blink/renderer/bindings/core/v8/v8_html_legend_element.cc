...
static_assert(std::derived_from<HTMLLegendElement, HTMLElement>);
...
const WrapperTypeInfo& HTMLLegendElement::wrapper_type_info_ =
    V8HTMLLegendElement::wrapper_type_info_;
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLLegendElement::GetWrapperTypeInfo(), ElementType::kHTMLLegendElement);
}
...
void V8HTMLLegendElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLLegendElement", kAttributeTable);
}
