...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_SELECTED_CONTENT_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_SELECTED_CONTENT_ELEMENT_H_
...
class CORE_EXPORT V8HTMLSelectedContentElement final : public bindings::V8InterfaceBridge<V8HTMLSelectedContentElement, HTMLSelectedContentElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(656);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class HTMLSelectedContentElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_SELECTED_CONTENT_ELEMENT_H_
