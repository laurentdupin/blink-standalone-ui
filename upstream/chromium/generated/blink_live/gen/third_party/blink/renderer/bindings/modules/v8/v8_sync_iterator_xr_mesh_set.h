...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_XR_MESH_SET_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_XR_MESH_SET_H_
...
template <>
class MODULES_EXPORT SyncIterator<XRMeshSet> final : public bindings::SyncIteratorBase {
  DEFINE_WRAPPERTYPEINFO();

  public:
using IDLKeyType = void;
using IDLValueType = XRMesh;
using KeyType = void;
using ValueType = XRMesh*;

explicit  SyncIterator<XRMeshSet>(IterationSourceBase* source, Kind kind) : bindings::SyncIteratorBase(source, kind) {
...
class MODULES_EXPORT V8SyncIteratorXRMeshSet final : public bindings::V8InterfaceBridge<V8SyncIteratorXRMeshSet, SyncIterator<XRMeshSet>> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1507);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SyncIterator<XRMeshSet>;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_XR_MESH_SET_H_
