...
class MODULES_EXPORT V8XRReferenceSpace final : public bindings::V8InterfaceBridge<V8XRReferenceSpace, XRReferenceSpace> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(830);
