...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_COLOR_PAGE_POPUP_CONTROLLER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_COLOR_PAGE_POPUP_CONTROLLER_H_
...
class ColorPagePopupController;
class ExecutionContext;
struct WrapperTypeInfo;

class CORE_EXPORT V8ColorPagePopupController final : public bindings::V8InterfaceBridge<V8ColorPagePopupController, ColorPagePopupController> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(937);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class ColorPagePopupController;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_COLOR_PAGE_POPUP_CONTROLLER_H_
