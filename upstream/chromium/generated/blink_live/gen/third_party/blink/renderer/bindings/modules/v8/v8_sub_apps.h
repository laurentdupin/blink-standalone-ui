...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SUB_APPS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SUB_APPS_H_
...
class MODULES_EXPORT V8SubApps final : public bindings::V8InterfaceBridge<V8SubApps, SubApps> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1271);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SubApps;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SUB_APPS_H_
