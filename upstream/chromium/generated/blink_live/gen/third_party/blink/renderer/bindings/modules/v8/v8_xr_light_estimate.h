...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_LIGHT_ESTIMATE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_LIGHT_ESTIMATE_H_
...
class MODULES_EXPORT V8XRLightEstimate final : public bindings::V8InterfaceBridge<V8XRLightEstimate, XRLightEstimate> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1436);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XRLightEstimate;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_LIGHT_ESTIMATE_H_
