...
static_assert(std::derived_from<TaskPriorityChangeEvent, Event>);
...
const WrapperTypeInfo V8TaskPriorityChangeEvent::wrapper_type_info_{
    ...
    V8TaskPriorityChangeEvent::kThisTag,
    V8TaskPriorityChangeEvent::kMaxSubclassTag,
...
static_assert(bindings::IsReturnTypeCompatible<TaskPriorityChangeEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
interface_function_template->SetInterfaceName(V8String(isolate, "TaskPriorityChangeEvent"));
...
void V8TaskPriorityChangeEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "TaskPriorityChangeEvent", kAttributeTable);
}
