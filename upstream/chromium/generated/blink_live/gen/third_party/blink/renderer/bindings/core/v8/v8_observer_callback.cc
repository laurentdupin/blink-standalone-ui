...
const char* V8ObserverCallback::GetHumanReadableName() const {
  return "V8ObserverCallback";
}

v8::Maybe<void> V8ObserverCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const ScriptValue& arg1_value) {
  const char* const class_like_name = "ObserverCallback";
...
v8::Maybe<void> V8ObserverCallback::Construct(const ScriptValue& arg1_value) {
  const char* const class_like_name = "ObserverCallback";
...
void V8ObserverCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const ScriptValue& arg1_value) {
  v8::Isolate* isolate = GetIsolate();
...
base::expected<void, ScriptValue> V8ObserverCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const ScriptValue& arg1_value) {
