...
class MODULES_EXPORT V8RTCPeerConnection final : public bindings::V8InterfaceBridge<V8RTCPeerConnection, RTCPeerConnection> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(765);
