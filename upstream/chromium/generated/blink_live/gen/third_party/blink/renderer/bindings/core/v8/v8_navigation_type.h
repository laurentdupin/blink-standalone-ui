...
kReload, kPush, kReplace, kTraverse
};
static constexpr size_t kEnumSize = 4;

static V8NavigationType Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8NavigationType> Create(const String& value);

explicit constexpr  V8NavigationType(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8NavigationType& lhs, V8NavigationType::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8NavigationType::Enum lhs, const V8NavigationType& rhs) {
