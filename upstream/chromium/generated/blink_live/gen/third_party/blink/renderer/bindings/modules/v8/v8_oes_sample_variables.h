...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_SAMPLE_VARIABLES_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_SAMPLE_VARIABLES_H_
...
class MODULES_EXPORT V8OESSampleVariables final : public bindings::V8InterfaceBridge<V8OESSampleVariables, OESSampleVariables> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1316);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class OESSampleVariables;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_SAMPLE_VARIABLES_H_
