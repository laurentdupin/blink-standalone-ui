...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_VISIBILITY_MASK_CHANGE_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_VISIBILITY_MASK_CHANGE_EVENT_H_
...
class XRVisibilityMaskChangeEvent;
struct WrapperTypeInfo;

class MODULES_EXPORT V8XRVisibilityMaskChangeEvent final : public bindings::V8InterfaceBridge<V8XRVisibilityMaskChangeEvent, XRVisibilityMaskChangeEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(494);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XRVisibilityMaskChangeEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_VISIBILITY_MASK_CHANGE_EVENT_H_
