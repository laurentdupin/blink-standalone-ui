...
base::expected<Vector<String>, ScriptValue> V8TestSequenceCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const Vector<int32_t>& arg1_numbers) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_numbers);
