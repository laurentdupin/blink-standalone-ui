...
bool V8KeyboardLayoutMap::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8KeyboardLayoutMap::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8KeyboardLayoutMap::InstallInterfaceTemplate,
    V8KeyboardLayoutMap::InstallContextDependentProperties,
    "KeyboardLayoutMap",
    nullptr,
    V8KeyboardLayoutMap::kThisTag,
    V8KeyboardLayoutMap::kMaxSubclassTag,
...
const WrapperTypeInfo& KeyboardLayoutMap::wrapper_type_info_ =
    V8KeyboardLayoutMap::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, KeyboardLayoutMap>::value,
    "KeyboardLayoutMap inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_keyboard_layout_map {
...
BLINK_BINDINGS_TRACE_EVENT("KeyboardLayoutMap.size.get");
...
void EntriesOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_KeyboardLayoutMap_entries");
BLINK_BINDINGS_TRACE_EVENT("KeyboardLayoutMap.entries");
...
static_assert(bindings::IsReturnTypeCompatible<SyncIterator<KeyboardLayoutMap>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
BLINK_BINDINGS_TRACE_EVENT("KeyboardLayoutMap.forEach");
...
BLINK_BINDINGS_TRACE_EVENT("KeyboardLayoutMap.get");
...
BLINK_BINDINGS_TRACE_EVENT("KeyboardLayoutMap.has");
...
BLINK_BINDINGS_TRACE_EVENT("KeyboardLayoutMap.keys");
...
BLINK_BINDINGS_TRACE_EVENT("KeyboardLayoutMap.values");
...
using namespace v8_keyboard_layout_map;

}  // namespace 

void V8KeyboardLayoutMap::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8KeyboardLayoutMap::GetWrapperTypeInfo();
...
void V8KeyboardLayoutMap::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "KeyboardLayoutMap", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "KeyboardLayoutMap", kOperationTable);
}
...
void V8KeyboardLayoutMap::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object, v8::Local<v8::Object> prototype_object, v8::Local<v8::Object> interface_object, v8::Local<v8::Template> interface_template, FeatureSelector feature_selector) {
  using bindings::IDLMemberInstaller;
