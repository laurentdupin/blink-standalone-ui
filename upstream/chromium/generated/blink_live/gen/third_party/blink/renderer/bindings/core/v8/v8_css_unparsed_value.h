...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_UNPARSED_VALUE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_UNPARSED_VALUE_H_
...
class CORE_EXPORT V8CSSUnparsedValue final : public bindings::V8InterfaceBridge<V8CSSUnparsedValue, CSSUnparsedValue> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(334);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSUnparsedValue;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_UNPARSED_VALUE_H_
