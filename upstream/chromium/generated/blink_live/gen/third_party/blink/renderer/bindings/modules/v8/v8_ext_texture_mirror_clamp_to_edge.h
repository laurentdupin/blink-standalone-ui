...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_TEXTURE_MIRROR_CLAMP_TO_EDGE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_TEXTURE_MIRROR_CLAMP_TO_EDGE_H_
...
class MODULES_EXPORT V8EXTTextureMirrorClampToEdge final : public bindings::V8InterfaceBridge<V8EXTTextureMirrorClampToEdge, EXTTextureMirrorClampToEdge> {
...
class Constant final {
  ...
  public:
static constexpr uint32_t kMirrorClampToEdgeExt = 0x8743;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1309);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class EXTTextureMirrorClampToEdge;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_TEXTURE_MIRROR_CLAMP_TO_EDGE_H_
