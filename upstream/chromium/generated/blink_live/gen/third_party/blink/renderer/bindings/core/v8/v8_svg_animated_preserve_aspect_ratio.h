...
class CORE_EXPORT V8SVGAnimatedPreserveAspectRatio final : public bindings::V8InterfaceBridge<V8SVGAnimatedPreserveAspectRatio, SVGAnimatedPreserveAspectRatio> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(971);
