...
void AddressErrors::FillTemplateProperties(Vector<std::string_view>& properties) const {
...
if (!bindings::GetDictionaryMemberFromV8Object<IDLString, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), has_address_line_, member_address_line_, class_like_name, exception_state)) {
  return;
}
