...
bool V8LargestContentfulPaint::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<LargestContentfulPaint, PerformanceEntry>);
...
const WrapperTypeInfo V8LargestContentfulPaint::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8LargestContentfulPaint::InstallInterfaceTemplate,
    nullptr,
    "LargestContentfulPaint",
    V8PerformanceEntry::GetWrapperTypeInfo(),
    V8LargestContentfulPaint::kThisTag,
    V8LargestContentfulPaint::kMaxSubclassTag,
...
const WrapperTypeInfo& LargestContentfulPaint::wrapper_type_info_ =
    V8LargestContentfulPaint::wrapper_type_info_;
...
namespace v8_largest_contentful_paint {
...
BLINK_BINDINGS_TRACE_EVENT("LargestContentfulPaint.renderTime.get");
...
BLINK_BINDINGS_TRACE_EVENT("LargestContentfulPaint.loadTime.get");
...
BLINK_BINDINGS_TRACE_EVENT("LargestContentfulPaint.size.get");
...
BLINK_BINDINGS_TRACE_EVENT("LargestContentfulPaint.id.get");
...
BLINK_BINDINGS_TRACE_EVENT("LargestContentfulPaint.url.get");
...
BLINK_BINDINGS_TRACE_EVENT("LargestContentfulPaint.element.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_LargestContentfulPaint_paintTime_Getter");
BLINK_BINDINGS_TRACE_EVENT("LargestContentfulPaint.paintTime.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_LargestContentfulPaint_presentationTime_Getter");
BLINK_BINDINGS_TRACE_EVENT("LargestContentfulPaint.presentationTime.get");
...
using namespace v8_largest_contentful_paint;

}  // namespace 

void V8LargestContentfulPaint::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8LargestContentfulPaint::GetWrapperTypeInfo();
...
void V8LargestContentfulPaint::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "LargestContentfulPaint", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "LargestContentfulPaint", kOperationTable);
}
...
void V8LargestContentfulPaint::InstallContextIndependentProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
  using bindings::IDLMemberInstaller;
