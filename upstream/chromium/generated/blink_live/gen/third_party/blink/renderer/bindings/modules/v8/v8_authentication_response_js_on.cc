...
AuthenticationResponseJSON* AuthenticationResponseJSON::Create(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state) {
  AuthenticationResponseJSON* dictionary = MakeGarbageCollected<AuthenticationResponseJSON>(isolate);
if (!v8_value->IsObject()) {
  const char* const class_like_name = "AuthenticationResponseJSON";
...
return dictionary;
 ...
 AuthenticationResponseJSON::AuthenticationResponseJSON(v8::Isolate* isolate) {
  
}



String AuthenticationResponseJSON::getAuthenticatorAttachmentOr(const String& fallback_value) const {
...
String AuthenticationResponseJSON::getAuthenticatorAttachmentOr(String&& fallback_value) const {
  if (!hasAuthenticatorAttachment()) {
...
void AuthenticationResponseJSON::setAuthenticatorAttachment(const String& value) {
  member_authenticator_attachment_ = value;
has_authenticator_attachment_ = true;
}

void AuthenticationResponseJSON::setAuthenticatorAttachment(String&& value) {
...
void AuthenticationResponseJSON::setId(const String& value) {
  member_id_ = value;
}

void AuthenticationResponseJSON::setId(String&& value) {
...
void AuthenticationResponseJSON::setRawId(const String& value) {
  member_raw_id_ = value;
}

void AuthenticationResponseJSON::setRawId(String&& value) {
...
void AuthenticationResponseJSON::setType(const String& value) {
  member_type_ = value;
}

void AuthenticationResponseJSON::setType(String&& value) {
  member_type_ = std::move(value);
}



void AuthenticationResponseJSON::Trace(Visitor* visitor) const {
  visitor->Trace(member_client_extension_results_);
visitor->Trace(member_response_);
bindings::DictionaryBase::Trace(visitor);
}

void AuthenticationResponseJSON::FillTemplateProperties(Vector<std::string_view>& properties) const {
  static_assert(std::size(kOwnPropertyNames) == kOwnPropertyCount);
properties.append_range(kOwnPropertyNames);
DCHECK_EQ(properties.size(), kTotalPropertyCount);
}

void AuthenticationResponseJSON::FillValuesImpl(ScriptState* script_state, base::span<v8::MaybeLocal<v8::Value>> values) const {
...
if (hasResponse()) {
  values[4] = ToV8Traits<AuthenticatorAssertionResponseJSON>::ToV8(script_state, member_response_.Get());
...
const void* AuthenticationResponseJSON::TemplateKey() const {
  static const void *s_key = &s_key;
return s_key;
}

v8::Local<v8::Object> AuthenticationResponseJSON::FillValues(ScriptState* script_state, v8::Local<v8::DictionaryTemplate> dict_template) const {
  v8::MaybeLocal<v8::Value> values[kTotalPropertyCount];
FillValuesImpl(script_state, values);
return dict_template->NewInstance(script_state->GetContext(), values);
}

void AuthenticationResponseJSON::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state) {
...
if (!bindings::GetDictionaryMemberFromV8Object<AuthenticatorAssertionResponseJSON, is_required>(isolate, current_context, v8_dictionary, v8_own_member_names[4].Get(isolate), fallback_presence_var, member_response_, class_like_name, exception_state)) {
  return;
}
...
const base::span<const v8::Eternal<v8::Name>> AuthenticationResponseJSON::GetV8OwnMemberNames(v8::Isolate* isolate) {
