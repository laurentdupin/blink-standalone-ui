...
bool V8CSSRuleList::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8CSSRuleList::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8CSSRuleList::InstallInterfaceTemplate,
    nullptr,
    "CSSRuleList",
    nullptr,
    V8CSSRuleList::kThisTag,
    V8CSSRuleList::kMaxSubclassTag,
...
const WrapperTypeInfo& CSSRuleList::wrapper_type_info_ =
    V8CSSRuleList::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, CSSRuleList>::value,
    "CSSRuleList inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

v8::Intercepted V8CSSRuleList::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSRuleList_IndexedPropertyGetter");
...
CSSRuleList* blink_receiver = V8CSSRuleList::ToWrappableUnsafe(isolate, v8_receiver);
...
v8::Intercepted V8CSSRuleList::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSRuleList_IndexedPropertySetter");
...
v8::Intercepted V8CSSRuleList::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSRuleList_IndexedPropertyDeleter");
...
v8::Intercepted V8CSSRuleList::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSRuleList_IndexedPropertyDefiner");
...
v8::Intercepted V8CSSRuleList::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSRuleList_IndexedPropertyDescriptor");
...
auto intercepted =
    V8CSSRuleList::IndexedPropertyGetterCallback(index, info);
...
void V8CSSRuleList::IndexedPropertyEnumeratorCallback(const v8::PropertyCallbackInfo<v8::Array>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSRuleList_IndexedPropertyEnumerator");
...
namespace v8_css_rule_list {


void LengthAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSRuleList_length_Getter");
BLINK_BINDINGS_TRACE_EVENT("CSSRuleList.length.get");
...
void ItemOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSRuleList_item");
BLINK_BINDINGS_TRACE_EVENT("CSSRuleList.item");
...
// [Measure], [MeasureAs]
UseCounter::Count(current_execution_context, WebFeature::kV8CSSRuleList_Item_Method);
...
using namespace v8_css_rule_list;

}  // namespace 

void V8CSSRuleList::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8CSSRuleList::GetWrapperTypeInfo();
...
instance_template->SetHandler(
    v8::IndexedPropertyHandlerConfiguration(
        V8CSSRuleList::IndexedPropertyGetterCallback,
        V8CSSRuleList::IndexedPropertySetterCallback,
        nullptr,  // query
        V8CSSRuleList::IndexedPropertyDeleterCallback,
        V8CSSRuleList::IndexedPropertyEnumeratorCallback,
        V8CSSRuleList::IndexedPropertyDefinerCallback,
        V8CSSRuleList::IndexedPropertyDescriptorCallback,
        nullptr,  // index_of
        v8::Local<v8::Value>(),
...
void V8CSSRuleList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "CSSRuleList", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "CSSRuleList", kOperationTable);
}
