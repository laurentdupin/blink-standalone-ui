...
bool V8WebSocketStream::IsExposed(ExecutionContext* execution_context) {
  
return (execution_context->IsWindow() || execution_context->IsWorkerGlobalScope()) && RuntimeEnabledFeatures::WebSocketStreamEnabled();
}
...
const WrapperTypeInfo V8WebSocketStream::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8WebSocketStream::InstallInterfaceTemplate,
    nullptr,
    "WebSocketStream",
    nullptr,
    V8WebSocketStream::kThisTag,
    V8WebSocketStream::kMaxSubclassTag,
...
const WrapperTypeInfo& WebSocketStream::wrapper_type_info_ =
    V8WebSocketStream::wrapper_type_info_;
...
BLINK_BINDINGS_TRACE_EVENT("WebSocketStream.url.get");
...
v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
if (!V8WebSocketStream::HasInstance(isolate, v8_receiver)) {
  V8ThrowException::ThrowTypeError(isolate, "Illegal invocation");
return;
}

RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_WebSocketStream_opened_Getter");
BLINK_BINDINGS_TRACE_EVENT("WebSocketStream.opened.get");
...
static_assert(bindings::IsReturnTypeCompatible<IDLPromise<WebSocketOpenInfo>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
BLINK_BINDINGS_TRACE_EVENT("WebSocketStream.closed.get");
...
static_assert(bindings::IsReturnTypeCompatible<IDLPromise<WebSocketCloseInfo>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value);
}
...
BLINK_BINDINGS_TRACE_EVENT("WebSocketStream.constructor");
...
decltype(NativeValueTraits<WebSocketStreamOptions>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg2_options;
if (info[1]->IsUndefined()) {
  arg2_options = WebSocketStreamOptions::Create();
} else {
  arg2_options = NativeValueTraits<WebSocketStreamOptions>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
}
auto&& return_value = WebSocketStream::Create(script_state, arg1_url, arg2_options, exception_state);
static_assert(bindings::IsReturnTypeCompatible<WebSocketStream, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8WebSocketStream::GetWrapperTypeInfo(), v8_receiver);
...
if (info[0]->IsUndefined()) {
  arg1_close_info = WebSocketCloseInfo::Create();
} else {
  arg1_close_info = NativeValueTraits<WebSocketCloseInfo>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
}
blink_receiver->close(arg1_close_info, exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
using namespace v8_websocket_stream;

}  // namespace 

void V8WebSocketStream::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8WebSocketStream::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "WebSocketStream"));
...
void V8WebSocketStream::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "WebSocketStream", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "WebSocketStream", kOperationTable);
}
