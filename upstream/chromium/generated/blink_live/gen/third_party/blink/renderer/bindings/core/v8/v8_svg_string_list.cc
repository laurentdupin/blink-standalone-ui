...
bool V8SVGStringList::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8SVGStringList::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SVGStringList::InstallInterfaceTemplate,
    nullptr,
    "SVGStringList",
    nullptr,
    V8SVGStringList::kThisTag,
    V8SVGStringList::kMaxSubclassTag,
...
const WrapperTypeInfo& SVGStringListTearOff::wrapper_type_info_ =
    V8SVGStringList::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, SVGStringListTearOff>::value,
    "SVGStringListTearOff inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

v8::Intercepted V8SVGStringList::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
SVGStringListTearOff* blink_receiver = V8SVGStringList::ToWrappableUnsafe(isolate, v8_receiver);
...
v8::Intercepted V8SVGStringList::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SVGStringListTearOff_IndexedPropertySetter");
...
v8::Intercepted V8SVGStringList::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SVGStringListTearOff_IndexedPropertyDeleter");
...
v8::Intercepted V8SVGStringList::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SVGStringListTearOff_IndexedPropertyDefiner");
...
return V8SVGStringList::IndexedPropertySetterCallback(
    index,
...
v8::Intercepted V8SVGStringList::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SVGStringListTearOff_IndexedPropertyDescriptor");
...
void V8SVGStringList::IndexedPropertyEnumeratorCallback(const v8::PropertyCallbackInfo<v8::Array>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SVGStringListTearOff_IndexedPropertyEnumerator");
...
BLINK_BINDINGS_TRACE_EVENT("SVGStringList.length.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGStringList.numberOfItems.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGStringList.appendItem");
...
SVGStringListTearOff* blink_receiver = V8SVGStringList::ToWrappableUnsafe(isolate, v8_receiver);
ExceptionState exception_state(isolate);
auto&& arg1_new_item = NativeValueTraits<IDLString>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
BLINK_BINDINGS_TRACE_EVENT("SVGStringList.clear");
...
BLINK_BINDINGS_TRACE_EVENT("SVGStringList.getItem");
...
BLINK_BINDINGS_TRACE_EVENT("SVGStringList.initialize");
...
BLINK_BINDINGS_TRACE_EVENT("SVGStringList.insertItemBefore");
...
SVGStringListTearOff* blink_receiver = V8SVGStringList::ToWrappableUnsafe(isolate, v8_receiver);
ExceptionState exception_state(isolate);
auto&& arg1_item = NativeValueTraits<IDLString>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
auto&& return_value = blink_receiver->insertItemBefore(arg1_item, arg2_index, exception_state);
static_assert(bindings::IsReturnTypeCompatible<IDLString, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
BLINK_BINDINGS_TRACE_EVENT("SVGStringList.removeItem");
...
BLINK_BINDINGS_TRACE_EVENT("SVGStringList.replaceItem");
...
using namespace v8_svg_string_list;

}  // namespace 

void V8SVGStringList::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SVGStringList::GetWrapperTypeInfo();
...
instance_template->SetHandler(
    v8::IndexedPropertyHandlerConfiguration(
        ...
        nullptr,  // query
        V8SVGStringList::IndexedPropertyDeleterCallback,
        V8SVGStringList::IndexedPropertyEnumeratorCallback,
...
void V8SVGStringList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGStringList", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGStringList", kOperationTable);
}
