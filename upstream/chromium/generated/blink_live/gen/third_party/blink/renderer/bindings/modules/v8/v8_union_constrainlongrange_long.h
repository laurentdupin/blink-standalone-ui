...
using Ret = bindings::OptimizedReturnProxy<V8UnionConstrainLongRangeOrLong>;
v8::Local<v8::Value> ToV8(ScriptState* script_state) const;

static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, ConstrainLongRange* value);
static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, int32_t value);
