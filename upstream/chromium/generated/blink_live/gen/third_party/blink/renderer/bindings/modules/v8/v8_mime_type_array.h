...
class MODULES_EXPORT V8MimeTypeArray final : public bindings::V8InterfaceBridge<V8MimeTypeArray, DOMMimeTypeArray> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1232);
