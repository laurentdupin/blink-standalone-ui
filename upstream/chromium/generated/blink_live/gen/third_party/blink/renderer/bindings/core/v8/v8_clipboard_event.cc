...
static_assert(std::derived_from<ClipboardEvent, Event>);
...
const WrapperTypeInfo V8ClipboardEvent::wrapper_type_info_{
    ...
    V8ClipboardEvent::kThisTag,
    V8ClipboardEvent::kMaxSubclassTag,
...
ClipboardEvent* blink_receiver = V8ClipboardEvent::ToWrappableUnsafe(isolate, v8_receiver);
...
static_assert(bindings::IsReturnTypeCompatible<ClipboardEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
interface_function_template->SetInterfaceName(V8String(isolate, "ClipboardEvent"));
...
void V8ClipboardEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "ClipboardEvent", kAttributeTable);
}
