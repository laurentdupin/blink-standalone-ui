...
using Ret = bindings::OptimizedReturnProxy<V8UnionCompositeOperationOrAutoOrCompositeOperationOrAutoSequence>;
v8::Local<v8::Value> ToV8(ScriptState* script_state) const;

static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, V8CompositeOperationOrAuto value);
static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, const Vector<V8CompositeOperationOrAuto>& value);
