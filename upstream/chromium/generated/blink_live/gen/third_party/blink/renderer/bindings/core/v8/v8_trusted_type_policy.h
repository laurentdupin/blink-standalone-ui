...
class CORE_EXPORT V8TrustedTypePolicy final : public bindings::V8InterfaceBridge<V8TrustedTypePolicy, TrustedTypePolicy> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1024);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class TrustedTypePolicy;
};
