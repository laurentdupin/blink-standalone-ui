...
class MODULES_EXPORT V8AnalyserNode final : public bindings::V8InterfaceBridge<V8AnalyserNode, AnalyserNode> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(504);
