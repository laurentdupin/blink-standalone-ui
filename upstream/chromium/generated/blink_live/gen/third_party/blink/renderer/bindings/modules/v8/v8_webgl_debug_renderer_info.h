...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_DEBUG_RENDERER_INFO_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_DEBUG_RENDERER_INFO_H_
...
class MODULES_EXPORT V8WebGLDebugRendererInfo final : public bindings::V8InterfaceBridge<V8WebGLDebugRendererInfo, WebGLDebugRendererInfo> {
...
class Constant final {
  ...
  public:
static constexpr uint32_t kUnmaskedVendorWebgl = 0x9245;
static constexpr uint32_t kUnmaskedRendererWebgl = 0x9246;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1337);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class WebGLDebugRendererInfo;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_DEBUG_RENDERER_INFO_H_
