...
bool V8CSSTransformValue::IsExposed(ExecutionContext* execution_context) {
...
static_assert(std::derived_from<CSSTransformValue, CSSStyleValue>);
...
const WrapperTypeInfo V8CSSTransformValue::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8CSSTransformValue::InstallInterfaceTemplate,
    nullptr,
    "CSSTransformValue",
    V8CSSStyleValue::GetWrapperTypeInfo(),
    V8CSSTransformValue::kThisTag,
    V8CSSTransformValue::kMaxSubclassTag,
...
const WrapperTypeInfo& CSSTransformValue::wrapper_type_info_ =
    V8CSSTransformValue::wrapper_type_info_;
...
v8::Intercepted V8CSSTransformValue::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
static_assert(bindings::IsReturnTypeCompatible<CSSTransformComponent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
return v8::Intercepted::kYes;
}

v8::Intercepted V8CSSTransformValue::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSTransformValue_IndexedPropertySetter");
...
auto&& blink_property_value = NativeValueTraits<CSSTransformComponent>::ArgumentValue(isolate, 1, v8_property_value, exception_state);
...
v8::Intercepted V8CSSTransformValue::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSTransformValue_IndexedPropertyDeleter");
...
v8::Intercepted V8CSSTransformValue::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSTransformValue_IndexedPropertyDefiner");
...
return V8CSSTransformValue::IndexedPropertySetterCallback(
    index,
...
v8::Intercepted V8CSSTransformValue::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSTransformValue_IndexedPropertyDescriptor");
...
namespace v8_css_transform_value {
...
BLINK_BINDINGS_TRACE_EVENT("CSSTransformValue.length.get");
...
BLINK_BINDINGS_TRACE_EVENT("CSSTransformValue.is2D.get");
...
BLINK_BINDINGS_TRACE_EVENT("CSSTransformValue.constructor");
...
ExceptionState exception_state(isolate);
auto&& arg1_transforms = NativeValueTraits<IDLSequence<CSSTransformComponent>>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& return_value = CSSTransformValue::Create(std::move(arg1_transforms), exception_state);
static_assert(bindings::IsReturnTypeCompatible<CSSTransformValue, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8CSSTransformValue::GetWrapperTypeInfo(), v8_receiver);
...
BLINK_BINDINGS_TRACE_EVENT("CSSTransformValue.toMatrix");
...
using namespace v8_css_transform_value;

}  // namespace 

void V8CSSTransformValue::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8CSSTransformValue::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "CSSTransformValue"));
...
instance_template->SetHandler(
    v8::IndexedPropertyHandlerConfiguration(
        ...
        nullptr,  // query
        V8CSSTransformValue::IndexedPropertyDeleterCallback,
        V8CSSTransformValue::IndexedPropertyEnumeratorCallback,
...
void V8CSSTransformValue::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "CSSTransformValue", kAttributeTable);
}
...
{"toMatrix", ToMatrixOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
};
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "CSSTransformValue", kOperationTable);
}
