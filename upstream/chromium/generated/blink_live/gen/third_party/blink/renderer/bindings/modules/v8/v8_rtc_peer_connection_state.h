...
class MODULES_EXPORT V8RTCPeerConnectionState final : public bindings::EnumerationBase {
  
  public:
enum class Enum : enum_int_t {
kNew, kConnecting, kConnected, kDisconnected, kFailed, kClosed
};
static constexpr size_t kEnumSize = 6;

static V8RTCPeerConnectionState Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8RTCPeerConnectionState> Create(const String& value);

explicit constexpr  V8RTCPeerConnectionState(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
V8RTCPeerConnectionState& operator=(const V8RTCPeerConnectionState&) = default;
...
inline bool operator==(const V8RTCPeerConnectionState& lhs, V8RTCPeerConnectionState::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8RTCPeerConnectionState::Enum lhs, const V8RTCPeerConnectionState& rhs) {
