...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_FEDERATED_CREDENTIAL_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_FEDERATED_CREDENTIAL_H_
...
class MODULES_EXPORT V8FederatedCredential final : public bindings::V8InterfaceBridge<V8FederatedCredential, FederatedCredential> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1124);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class FederatedCredential;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_FEDERATED_CREDENTIAL_H_
