...
kTopLevel, kNested, kAuxiliary, kNone
};
...
explicit constexpr  V8ContextFrameType(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
