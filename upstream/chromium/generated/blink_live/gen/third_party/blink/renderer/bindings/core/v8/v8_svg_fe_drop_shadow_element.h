...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_DROP_SHADOW_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_DROP_SHADOW_ELEMENT_H_
...
class CORE_EXPORT V8SVGFEDropShadowElement final : public bindings::V8InterfaceBridge<V8SVGFEDropShadowElement, SVGFEDropShadowElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(697);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGFEDropShadowElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_DROP_SHADOW_ELEMENT_H_
