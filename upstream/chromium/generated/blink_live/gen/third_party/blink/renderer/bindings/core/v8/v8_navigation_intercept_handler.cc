...
const char* V8NavigationInterceptHandler::GetHumanReadableName() const {
  return "V8NavigationInterceptHandler";
}

v8::Maybe<ScriptPromise<IDLUndefined>> V8NavigationInterceptHandler::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
  const char* const class_like_name = "NavigationInterceptHandler";
...
v8::Maybe<ScriptPromise<IDLUndefined>> V8NavigationInterceptHandler::Construct() {
  const char* const class_like_name = "NavigationInterceptHandler";
...
base::expected<ScriptPromise<IDLUndefined>, ScriptValue> V8NavigationInterceptHandler::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver);
