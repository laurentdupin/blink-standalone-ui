...
bool V8HTMLUListElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<HTMLUListElement, HTMLElement>);
...
const WrapperTypeInfo V8HTMLUListElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8HTMLUListElement::InstallInterfaceTemplate,
    nullptr,
    "HTMLUListElement",
    V8HTMLElement::GetWrapperTypeInfo(),
    V8HTMLUListElement::kThisTag,
    V8HTMLUListElement::kMaxSubclassTag,
...
const WrapperTypeInfo& HTMLUListElement::wrapper_type_info_ =
    V8HTMLUListElement::wrapper_type_info_;
...
namespace v8_html_ulist_element {
...
BLINK_BINDINGS_TRACE_EVENT("HTMLUListElement.compact.get");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLUListElement.compact.set");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLUListElement.type.get");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLUListElement.type.set");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLUListElement.constructor");
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLUListElement::GetWrapperTypeInfo(), ElementType::kHTMLUListElement);
}


}  // namespace v8_html_ulist_element

using namespace v8_html_ulist_element;

}  // namespace 

void V8HTMLUListElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8HTMLUListElement::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "HTMLUListElement"));
...
void V8HTMLUListElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLUListElement", kAttributeTable);
}
