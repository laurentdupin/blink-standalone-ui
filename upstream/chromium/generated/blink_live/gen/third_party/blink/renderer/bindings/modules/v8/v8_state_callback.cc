...
const char* V8StateCallback::GetHumanReadableName() const {
  return "V8StateCallback";
}

v8::Maybe<ScriptValue> V8StateCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
  const char* const class_like_name = "StateCallback";
...
v8::Maybe<ScriptValue> V8StateCallback::Construct() {
  const char* const class_like_name = "StateCallback";
...
base::expected<ScriptValue, ScriptValue> V8StateCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
