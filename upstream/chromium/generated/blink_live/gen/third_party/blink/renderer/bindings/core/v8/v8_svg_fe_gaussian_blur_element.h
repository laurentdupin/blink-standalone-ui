...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_GAUSSIAN_BLUR_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_GAUSSIAN_BLUR_ELEMENT_H_
...
class CORE_EXPORT V8SVGFEGaussianBlurElement final : public bindings::V8InterfaceBridge<V8SVGFEGaussianBlurElement, SVGFEGaussianBlurElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(699);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGFEGaussianBlurElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_GAUSSIAN_BLUR_ELEMENT_H_
