...
if (!bindings::GetDictionaryMemberFromV8Object<IDLNullable<CustomElementRegistry>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), has_custom_element_registry_, member_custom_element_registry_, class_like_name, exception_state)) {
  return;
}
}
