...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_STATIC_RANGE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_STATIC_RANGE_H_
...
class CORE_EXPORT V8StaticRange final : public bindings::V8InterfaceBridge<V8StaticRange, StaticRange> {
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_STATIC_RANGE_H_
