...
class MODULES_EXPORT V8SpeechRecognitionResult final : public bindings::V8InterfaceBridge<V8SpeechRecognitionResult, SpeechRecognitionResult> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1265);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SpeechRecognitionResult;
};
