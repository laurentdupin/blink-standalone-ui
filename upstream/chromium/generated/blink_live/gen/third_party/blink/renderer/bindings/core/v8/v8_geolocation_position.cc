...
bool V8GeolocationPosition::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8GeolocationPosition::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8GeolocationPosition::InstallInterfaceTemplate,
    nullptr,
    "GeolocationPosition",
    nullptr,
    V8GeolocationPosition::kThisTag,
    V8GeolocationPosition::kMaxSubclassTag,
...
const WrapperTypeInfo& Geoposition::wrapper_type_info_ =
    V8GeolocationPosition::wrapper_type_info_;
...
namespace v8_geolocation_position {
...
BLINK_BINDINGS_TRACE_EVENT("GeolocationPosition.coords.get");
...
static_assert(bindings::IsReturnTypeCompatible<GeolocationCoordinates, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
BLINK_BINDINGS_TRACE_EVENT("GeolocationPosition.timestamp.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Geoposition_accuracyMode_Getter");
BLINK_BINDINGS_TRACE_EVENT("GeolocationPosition.accuracyMode.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
Geoposition* blink_receiver = V8GeolocationPosition::ToWrappableUnsafe(isolate, v8_receiver);
auto&& return_value = blink_receiver->accuracyMode();
static_assert(bindings::IsReturnTypeCompatible<V8AccuracyMode, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, isolate, bindings::V8ReturnValue::kNonNullable);
}


void ToJSONOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Geoposition_toJSON");
BLINK_BINDINGS_TRACE_EVENT("GeolocationPosition.toJSON");
...
using namespace v8_geolocation_position;

}  // namespace 

void V8GeolocationPosition::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8GeolocationPosition::GetWrapperTypeInfo();
...
void V8GeolocationPosition::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"coords", CoordsAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
{"timestamp", TimestampAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
};
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "GeolocationPosition", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "GeolocationPosition", kOperationTable);
}
...
void V8GeolocationPosition::InstallContextIndependentProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
  using bindings::IDLMemberInstaller;

if (RuntimeEnabledFeatures::ApproximateGeolocationWebVisibleAPIEnabled()) {
  
static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
{"accuracyMode", AccuracyModeAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
};
v8::Local<v8::Signature> signature = v8::Local<v8::Signature>::Cast(interface_template);
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "GeolocationPosition", kAttributeTable);
}
