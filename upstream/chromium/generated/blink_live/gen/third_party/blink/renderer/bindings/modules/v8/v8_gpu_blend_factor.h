...
kZero, kOne, kSrc, kOneMinusSrc, kSrcAlpha, kOneMinusSrcAlpha, kDst, kOneMinusDst, kDstAlpha, kOneMinusDstAlpha, kSrcAlphaSaturated, kConstant, kOneMinusConstant, kSrc1, kOneMinusSrc1, kSrc1Alpha, kOneMinusSrc1Alpha
};
...
explicit constexpr  V8GPUBlendFactor(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
