...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_RIGID_TRANSFORM_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_RIGID_TRANSFORM_H_
...
class MODULES_EXPORT V8XRRigidTransform final : public bindings::V8InterfaceBridge<V8XRRigidTransform, XRRigidTransform> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XRRigidTransform;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_RIGID_TRANSFORM_H_
