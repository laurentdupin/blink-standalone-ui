...
bool V8XRPlaneSet::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8XRPlaneSet::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8XRPlaneSet::InstallInterfaceTemplate,
    V8XRPlaneSet::InstallContextDependentProperties,
    "XRPlaneSet",
    nullptr,
    V8XRPlaneSet::kThisTag,
    V8XRPlaneSet::kMaxSubclassTag,
...
const WrapperTypeInfo& XRPlaneSet::wrapper_type_info_ =
    V8XRPlaneSet::wrapper_type_info_;
...
BLINK_BINDINGS_TRACE_EVENT("XRPlaneSet.size.get");
...
static_assert(bindings::IsReturnTypeCompatible<SyncIterator<XRPlaneSet>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
ScriptState* script_state = receiver_script_state;
ExceptionState exception_state(isolate);
auto&& arg1_value = NativeValueTraits<XRPlane>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
void ValuesOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRPlaneSet_values");
BLINK_BINDINGS_TRACE_EVENT("XRPlaneSet.values");
...
using namespace v8_xr_plane_set;

}  // namespace 

void V8XRPlaneSet::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8XRPlaneSet::GetWrapperTypeInfo();
...
void V8XRPlaneSet::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "XRPlaneSet", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "XRPlaneSet", kOperationTable);
}
...
void V8XRPlaneSet::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object, v8::Local<v8::Object> prototype_object, v8::Local<v8::Object> interface_object, v8::Local<v8::Template> interface_template, FeatureSelector feature_selector) {
  using bindings::IDLMemberInstaller;
