...
#if DCHECK_IS_ON() || defined(FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION)
...
std::ostream& operator<<(std::ostream& o, const EBlockEllipsis v) {
  switch (v) {
   case EBlockEllipsis::kEllipsis:
    o << "ellipsis";
    break;
...
std::ostream& operator<<(std::ostream& o, const ECaretShape v) {
  switch (v) {
...
std::ostream& operator<<(std::ostream& o, const EColumnWrap v) {
  switch (v) {
   case EColumnWrap::kAuto:
    o << "auto";
    break;
...
std::ostream& operator<<(std::ostream& o, const EContinue v) {
  switch (v) {
...
std::ostream& operator<<(std::ostream& o, const EFrameSizing v) {
  switch (v) {
   ...
   case EFrameSizing::kContentBlockSize:
    o << "content-block-size";
    break;
   case EFrameSizing::kContentInlineSize:
    o << "content-inline-size";
    break;
  }
  return o;
}

std::ostream& operator<<(std::ostream& o, const EGridLanesPack v) {
  switch (v) {
   case EGridLanesPack::kNormal:
    o << "normal";
    break;
...
std::ostream& operator<<(std::ostream& o, const EImageRendering v) {
  switch (v) {
   ...
   case EImageRendering::kPixelated:
    o << "pixelated";
    break;
   case EImageRendering::kCrispEdges:
    o << "crisp-edges";
    break;
...
std::ostream& operator<<(std::ostream& o, const EInternalOverscrollArea v) {
  switch (v) {
   case EInternalOverscrollArea::kNone:
    o << "none";
    break;
...
std::ostream& operator<<(std::ostream& o, const EInternalOverscrollPosition v) {
  switch (v) {
   case EInternalOverscrollPosition::kNone:
    o << "none";
    break;
...
std::ostream& operator<<(std::ostream& o, const EPageMarginSafety v) {
  switch (v) {
   case EPageMarginSafety::kNone:
    o << "none";
    break;
...
std::ostream& operator<<(std::ostream& o, const ERubyOverhang v) {
  switch (v) {
   case ERubyOverhang::kAuto:
    o << "auto";
    break;
...
std::ostream& operator<<(std::ostream& o, const ERuleOverlap v) {
  switch (v) {
   case ERuleOverlap::kRowOverColumn:
    o << "row-over-column";
    break;
   case ERuleOverlap::kColumnOverRow:
    o << "column-over-row";
    break;
  }
  return o;
...
std::ostream& operator<<(std::ostream& o, const EScrollInitialTarget v) {
  switch (v) {
...
std::ostream& operator<<(std::ostream& o, const EScrollTargetGroup v) {
  switch (v) {
   case EScrollTargetGroup::kNone:
    o << "none";
    break;
...
std::ostream& operator<<(std::ostream& o, const ETextTransform v) {
  if (v == ETextTransform::kNone) {
    return o << "none";
  }
  if ((v & ETextTransform::kCapitalize) == ETextTransform::kCapitalize) {
    o << "capitalize ";
  }
  if ((v & ETextTransform::kUppercase) == ETextTransform::kUppercase) {
    o << "uppercase ";
  }
  if ((v & ETextTransform::kLowercase) == ETextTransform::kLowercase) {
    o << "lowercase ";
  }
  if ((v & ETextTransform::kFullWidth) == ETextTransform::kFullWidth) {
    o << "full-width ";
  }
  if ((v & ETextTransform::kFullSizeKana) == ETextTransform::kFullSizeKana) {
    o << "full-size-kana ";
  }
  if ((v & ETextTransform::kMathAuto) == ETextTransform::kMathAuto) {
    o << "math-auto ";
  }
  return o;
}
...
std::ostream& operator<<(std::ostream& o, const EViewTransitionScope v) {
  switch (v) {
   case EViewTransitionScope::kNone:
    o << "none";
    break;
...
std::ostream& operator<<(std::ostream& o, const HangingPunctuation v) {
  if (v == HangingPunctuation::kNone) {
    return o << "none";
  }
  if ((v & HangingPunctuation::kFirst) == HangingPunctuation::kFirst) {
    o << "first ";
  }
  if ((v & HangingPunctuation::kLast) == HangingPunctuation::kLast) {
    o << "last ";
  }
  if ((v & HangingPunctuation::kAllowEnd) == HangingPunctuation::kAllowEnd) {
    o << "allow-end ";
  }
  return o;
}
...
std::ostream& operator<<(std::ostream& o, const RuleBreak v) {
  switch (v) {
   case RuleBreak::kNone:
    o << "none";
    break;
...
std::ostream& operator<<(std::ostream& o, const RuleVisibilityItems v) {
  switch (v) {
...
std::ostream& operator<<(std::ostream& o, const TextDecorationSkipSpaces v) {
  if (v == TextDecorationSkipSpaces::kNone) {
    return o << "none";
  }
  if ((v & TextDecorationSkipSpaces::kStart) == TextDecorationSkipSpaces::kStart) {
    o << "start ";
  }
  if ((v & TextDecorationSkipSpaces::kEnd) == TextDecorationSkipSpaces::kEnd) {
    o << "end ";
  }
  if ((v & TextDecorationSkipSpaces::kAll) == TextDecorationSkipSpaces::kAll) {
    o << "all ";
  }
  return o;
}
