...
bool V8SVGSwitchElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<SVGSwitchElement, SVGGraphicsElement>);
...
const WrapperTypeInfo V8SVGSwitchElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SVGSwitchElement::InstallInterfaceTemplate,
    nullptr,
    "SVGSwitchElement",
    V8SVGGraphicsElement::GetWrapperTypeInfo(),
    V8SVGSwitchElement::kThisTag,
    V8SVGSwitchElement::kMaxSubclassTag,
...
const WrapperTypeInfo& SVGSwitchElement::wrapper_type_info_ =
    V8SVGSwitchElement::wrapper_type_info_;
...
namespace v8_svg_switch_element {



}  // namespace v8_svg_switch_element

using namespace v8_svg_switch_element;

}  // namespace 

void V8SVGSwitchElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SVGSwitchElement::GetWrapperTypeInfo();
