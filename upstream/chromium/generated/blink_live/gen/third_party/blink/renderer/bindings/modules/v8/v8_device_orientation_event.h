...
class MODULES_EXPORT V8DeviceOrientationEvent final : public bindings::V8InterfaceBridge<V8DeviceOrientationEvent, DeviceOrientationEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(393);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class DeviceOrientationEvent;
};
