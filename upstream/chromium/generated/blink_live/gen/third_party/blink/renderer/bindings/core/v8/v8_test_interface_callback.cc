...
const char* V8TestInterfaceCallback::GetHumanReadableName() const {
  return "V8TestInterfaceCallback";
}

v8::Maybe<void> V8TestInterfaceCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, HTMLDivElement* arg1_div_element) {
  const char* const class_like_name = "TestInterfaceCallback";
...
v8::Maybe<void> V8TestInterfaceCallback::Construct(HTMLDivElement* arg1_div_element) {
  const char* const class_like_name = "TestInterfaceCallback";
...
void V8TestInterfaceCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, HTMLDivElement* arg1_div_element) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = Invoke(arg0_receiver, arg1_div_element);
}

base::expected<void, ScriptValue> V8TestInterfaceCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, HTMLDivElement* arg1_div_element) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_div_element);
