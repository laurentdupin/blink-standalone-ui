...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MESH_2D_VERTEX_BUFFER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MESH_2D_VERTEX_BUFFER_H_
...
class MODULES_EXPORT V8Mesh2DVertexBuffer final : public bindings::V8InterfaceBridge<V8Mesh2DVertexBuffer, Mesh2DVertexBuffer> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1109);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class Mesh2DVertexBuffer;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MESH_2D_VERTEX_BUFFER_H_
