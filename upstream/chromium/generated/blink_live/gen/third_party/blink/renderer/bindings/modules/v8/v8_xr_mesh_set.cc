...
bool V8XRMeshSet::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8XRMeshSet::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8XRMeshSet::InstallInterfaceTemplate,
    V8XRMeshSet::InstallContextDependentProperties,
    "XRMeshSet",
    nullptr,
    V8XRMeshSet::kThisTag,
    V8XRMeshSet::kMaxSubclassTag,
...
const WrapperTypeInfo& XRMeshSet::wrapper_type_info_ =
    V8XRMeshSet::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, XRMeshSet>::value,
    "XRMeshSet inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_xr_mesh_set {


void SizeAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRMeshSet_size_Getter");
BLINK_BINDINGS_TRACE_EVENT("XRMeshSet.size.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
XRMeshSet* blink_receiver = V8XRMeshSet::ToWrappableUnsafe(isolate, v8_receiver);
...
void EntriesOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRMeshSet_entries");
BLINK_BINDINGS_TRACE_EVENT("XRMeshSet.entries");
...
static_assert(bindings::IsReturnTypeCompatible<SyncIterator<XRMeshSet>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
}

void ForEachOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRMeshSet_forEach");
BLINK_BINDINGS_TRACE_EVENT("XRMeshSet.forEach");
...
void HasOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRMeshSet_has");
BLINK_BINDINGS_TRACE_EVENT("XRMeshSet.has");
...
ScriptState* script_state = receiver_script_state;
ExceptionState exception_state(isolate);
auto&& arg1_value = NativeValueTraits<XRMesh>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
void KeysOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRMeshSet_keys");
BLINK_BINDINGS_TRACE_EVENT("XRMeshSet.keys");
...
void ValuesOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRMeshSet_values");
BLINK_BINDINGS_TRACE_EVENT("XRMeshSet.values");
...
using namespace v8_xr_mesh_set;

}  // namespace 

void V8XRMeshSet::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8XRMeshSet::GetWrapperTypeInfo();
...
void V8XRMeshSet::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "XRMeshSet", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "XRMeshSet", kOperationTable);
}
...
void V8XRMeshSet::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object, v8::Local<v8::Object> prototype_object, v8::Local<v8::Object> interface_object, v8::Local<v8::Template> interface_template, FeatureSelector feature_selector) {
  using bindings::IDLMemberInstaller;
