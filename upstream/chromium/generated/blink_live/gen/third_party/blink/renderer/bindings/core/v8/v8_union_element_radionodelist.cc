...
v8::Local<v8::Value> V8UnionElementOrRadioNodeList::DirectToV8(ScriptState* script_state, Element* value) {
  return ToV8Traits<Element>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionElementOrRadioNodeList::DirectToV8(ScriptState* script_state, RadioNodeList* value) {
  return ToV8Traits<RadioNodeList>::ToV8(script_state, value);
}
