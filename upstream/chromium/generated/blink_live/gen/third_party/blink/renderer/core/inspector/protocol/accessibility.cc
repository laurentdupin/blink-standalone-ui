...
const char Url[] = "url";
const char ActiveFullscreenElement[] = "activeFullscreenElement";
const char ActiveModalDialog[] = "activeModalDialog";
const char ActiveAriaModalDialog[] = "activeAriaModalDialog";
const char AriaHiddenElement[] = "ariaHiddenElement";
const char AriaHiddenSubtree[] = "ariaHiddenSubtree";
const char EmptyAlt[] = "emptyAlt";
const char EmptyText[] = "emptyText";
const char InertElement[] = "inertElement";
const char InertSubtree[] = "inertSubtree";
const char LabelContainer[] = "labelContainer";
const char LabelFor[] = "labelFor";
const char NotRendered[] = "notRendered";
const char NotVisible[] = "notVisible";
const char PresentationalRole[] = "presentationalRole";
const char ProbablyPresentational[] = "probablyPresentational";
const char InactiveCarouselTabContent[] = "inactiveCarouselTabContent";
const char Uninteresting[] = "uninteresting";
} // namespace AXPropertyNameEnum
...
public:
    ...
    void getPartialAXTree(crdtp::Dispatchable& dispatchable);
    void getFullAXTree(crdtp::Dispatchable& dispatchable);
    void getRootAXNode(crdtp::Dispatchable& dispatchable);
    void getAXNodeAndAncestors(crdtp::Dispatchable& dispatchable);
    void getChildAXNodes(crdtp::Dispatchable& dispatchable);
    void queryAXTree(crdtp::Dispatchable& dispatchable);
 protected:
    Backend* m_backend;
};
...
struct getPartialAXTreeParams : public crdtp::DeserializableProtocolObject<getPartialAXTreeParams> {
    ...
    std::optional<bool> fetchRelatives;
...
void DomainDispatcherImpl::getPartialAXTree(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
...
void DomainDispatcherImpl::getFullAXTree(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
...
void DomainDispatcherImpl::getRootAXNode(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
...
void DomainDispatcherImpl::getAXNodeAndAncestors(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
...
void DomainDispatcherImpl::getChildAXNodes(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
...
public:
    QueryAXTreeCallbackImpl(std::unique_ptr<DomainDispatcher::WeakPtr> backendImpl, crdtp::Dispatchable& dispatchable)
        : DomainDispatcher::Callback(std::move(backendImpl), dispatchable, crdtp::SpanFrom("Accessibility.queryAXTree")) { }
...
void DomainDispatcherImpl::queryAXTree(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
    ...
    m_backend->queryAXTree(std::move(params.nodeId), std::move(params.backendNodeId), std::move(params.objectId), std::move(params.accessibleName), std::move(params.role), std::make_unique<QueryAXTreeCallbackImpl>(weakPtr(), dispatchable));
}
