...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_DISPLACEMENT_MAP_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_DISPLACEMENT_MAP_ELEMENT_H_
...
class CORE_EXPORT V8SVGFEDisplacementMapElement final : public bindings::V8InterfaceBridge<V8SVGFEDisplacementMapElement, SVGFEDisplacementMapElement> {
...
class Constant final {
  ...
  public:
static constexpr uint16_t kSVGChannelUnknown = 0;
static constexpr uint16_t kSVGChannelR = 1;
static constexpr uint16_t kSVGChannelG = 2;
static constexpr uint16_t kSVGChannelB = 3;
static constexpr uint16_t kSVGChannelA = 4;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(695);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGFEDisplacementMapElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_DISPLACEMENT_MAP_ELEMENT_H_
