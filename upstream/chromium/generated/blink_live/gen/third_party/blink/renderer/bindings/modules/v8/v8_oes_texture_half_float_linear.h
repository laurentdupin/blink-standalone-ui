...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_TEXTURE_HALF_FLOAT_LINEAR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_TEXTURE_HALF_FLOAT_LINEAR_H_
...
class MODULES_EXPORT V8OESTextureHalfFloatLinear final : public bindings::V8InterfaceBridge<V8OESTextureHalfFloatLinear, OESTextureHalfFloatLinear> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1322);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class OESTextureHalfFloatLinear;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_TEXTURE_HALF_FLOAT_LINEAR_H_
