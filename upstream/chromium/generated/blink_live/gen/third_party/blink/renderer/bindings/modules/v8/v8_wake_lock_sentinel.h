...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WAKE_LOCK_SENTINEL_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WAKE_LOCK_SENTINEL_H_
...
class MODULES_EXPORT V8WakeLockSentinel final : public bindings::V8InterfaceBridge<V8WakeLockSentinel, WakeLockSentinel> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(804);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WAKE_LOCK_SENTINEL_H_
