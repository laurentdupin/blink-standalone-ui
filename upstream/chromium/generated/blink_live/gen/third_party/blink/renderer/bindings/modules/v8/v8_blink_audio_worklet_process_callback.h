...
[[nodiscard]] base::expected<ScriptValue, ScriptValue> InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const ScriptValue& arg1_inputs, const ScriptValue& arg2_outputs, const ScriptValue& arg3_param_values);
