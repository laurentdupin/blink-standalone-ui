...
using Ret = bindings::OptimizedReturnProxy<V8UnionDoubleOrDoubleOrStringOrTimelineRangeOffsetOrNullSequenceOrStringOrTimelineRangeOffsetOrNull>;
...
static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, const HeapVector<Member<V8UnionDoubleOrStringOrTimelineRangeOffset>>& value);
