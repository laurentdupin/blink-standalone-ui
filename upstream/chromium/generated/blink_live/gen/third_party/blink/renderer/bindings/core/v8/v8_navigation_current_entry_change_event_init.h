...
const std::optional<V8NavigationType>& navigationType() const {
  return member_navigation_type_;
}
void setNavigationType(const std::optional<V8NavigationType>& value) {
...
std::optional<V8NavigationType> member_navigation_type_;
