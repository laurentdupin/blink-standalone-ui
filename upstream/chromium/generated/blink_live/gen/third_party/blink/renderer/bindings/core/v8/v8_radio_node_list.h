...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_RADIO_NODE_LIST_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_RADIO_NODE_LIST_H_
...
class CORE_EXPORT V8RadioNodeList final : public bindings::V8InterfaceBridge<V8RadioNodeList, RadioNodeList> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class RadioNodeList;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_RADIO_NODE_LIST_H_
