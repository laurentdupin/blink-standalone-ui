...
class CORE_EXPORT V8SVGFECompositeElement final : public bindings::V8InterfaceBridge<V8SVGFECompositeElement, SVGFECompositeElement> {
...
class Constant final {
  ...
  public:
static constexpr uint16_t kSVGFecompositeOperatorUnknown = 0;
static constexpr uint16_t kSVGFecompositeOperatorOver = 1;
static constexpr uint16_t kSVGFecompositeOperatorIn = 2;
static constexpr uint16_t kSVGFecompositeOperatorOut = 3;
static constexpr uint16_t kSVGFecompositeOperatorAtop = 4;
static constexpr uint16_t kSVGFecompositeOperatorXor = 5;
static constexpr uint16_t kSVGFecompositeOperatorArithmetic = 6;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(692);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGFECompositeElement;
};
