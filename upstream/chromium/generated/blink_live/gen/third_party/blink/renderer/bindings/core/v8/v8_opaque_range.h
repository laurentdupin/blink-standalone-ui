...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_OPAQUE_RANGE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_OPAQUE_RANGE_H_
...
class CORE_EXPORT V8OpaqueRange final : public bindings::V8InterfaceBridge<V8OpaqueRange, OpaqueRange> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class OpaqueRange;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_OPAQUE_RANGE_H_
