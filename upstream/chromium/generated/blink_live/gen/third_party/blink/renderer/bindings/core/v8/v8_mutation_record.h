...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_MUTATION_RECORD_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_MUTATION_RECORD_H_
...
class CORE_EXPORT V8MutationRecord final : public bindings::V8InterfaceBridge<V8MutationRecord, MutationRecord> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(834);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class MutationRecord;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_MUTATION_RECORD_H_
