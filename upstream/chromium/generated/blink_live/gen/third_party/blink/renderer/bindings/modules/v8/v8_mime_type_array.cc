...
bool V8MimeTypeArray::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8MimeTypeArray::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8MimeTypeArray::InstallInterfaceTemplate,
    nullptr,
    "MimeTypeArray",
    nullptr,
    V8MimeTypeArray::kThisTag,
    V8MimeTypeArray::kMaxSubclassTag,
...
const WrapperTypeInfo& DOMMimeTypeArray::wrapper_type_info_ =
    V8MimeTypeArray::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, DOMMimeTypeArray>::value,
    "DOMMimeTypeArray inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

v8::Intercepted V8MimeTypeArray::NamedPropertyGetterCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
DOMMimeTypeArray* blink_receiver = V8MimeTypeArray::ToWrappableUnsafe(isolate, v8_receiver);
...
v8::Intercepted V8MimeTypeArray::NamedPropertySetterCallback(v8::Local<v8::Name> v8_property_name, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMMimeTypeArray_NamedPropertySetter");
...
v8::Intercepted V8MimeTypeArray::NamedPropertyDeleterCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMMimeTypeArray_NamedPropertyDeleter");
...
v8::Intercepted V8MimeTypeArray::NamedPropertyDefinerCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMMimeTypeArray_NamedPropertyDefiner");
...
v8::Intercepted V8MimeTypeArray::NamedPropertyDescriptorCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMMimeTypeArray_NamedPropertyDescriptor");
...
//  only argument value."
auto intercepted =
    V8MimeTypeArray::NamedPropertyGetterCallback(v8_property_name, info);
// "Return OrdinaryGetOwnProperty(O, P)."
...
v8::Intercepted V8MimeTypeArray::NamedPropertyQueryCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Integer>& info) {
...
void V8MimeTypeArray::NamedPropertyEnumeratorCallback(const v8::PropertyCallbackInfo<v8::Array>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMMimeTypeArray_NamedPropertyEnumerator");
...
v8::Intercepted V8MimeTypeArray::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
v8::Intercepted V8MimeTypeArray::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMMimeTypeArray_IndexedPropertySetter");
...
v8::Intercepted V8MimeTypeArray::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMMimeTypeArray_IndexedPropertyDeleter");
...
v8::Intercepted V8MimeTypeArray::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMMimeTypeArray_IndexedPropertyDefiner");
...
v8::Intercepted V8MimeTypeArray::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMMimeTypeArray_IndexedPropertyDescriptor");
...
void V8MimeTypeArray::IndexedPropertyEnumeratorCallback(const v8::PropertyCallbackInfo<v8::Array>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMMimeTypeArray_IndexedPropertyEnumerator");
...
BLINK_BINDINGS_TRACE_EVENT("MimeTypeArray.length.get");
...
BLINK_BINDINGS_TRACE_EVENT("MimeTypeArray.item");
...
BLINK_BINDINGS_TRACE_EVENT("MimeTypeArray.namedItem");
...
using namespace v8_mime_type_array;

}  // namespace 

void V8MimeTypeArray::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8MimeTypeArray::GetWrapperTypeInfo();
...
instance_template->SetHandler(
    v8::NamedPropertyHandlerConfiguration(
        V8MimeTypeArray::NamedPropertyGetterCallback,
        V8MimeTypeArray::NamedPropertySetterCallback,
        V8MimeTypeArray::NamedPropertyQueryCallback,
        V8MimeTypeArray::NamedPropertyDeleterCallback,
        V8MimeTypeArray::NamedPropertyEnumeratorCallback,
        V8MimeTypeArray::NamedPropertyDefinerCallback,
        V8MimeTypeArray::NamedPropertyDescriptorCallback,
        v8::Local<v8::Value>(),
...
instance_template->SetHandler(
    v8::IndexedPropertyHandlerConfiguration(
        ...
        nullptr,  // query
        V8MimeTypeArray::IndexedPropertyDeleterCallback,
        V8MimeTypeArray::IndexedPropertyEnumeratorCallback,
...
void V8MimeTypeArray::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "MimeTypeArray", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "MimeTypeArray", kOperationTable);
}
