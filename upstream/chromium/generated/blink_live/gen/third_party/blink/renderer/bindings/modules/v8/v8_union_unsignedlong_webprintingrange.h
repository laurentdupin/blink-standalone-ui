...
using Ret = bindings::OptimizedReturnProxy<V8UnionUnsignedLongOrWebPrintingRange>;
v8::Local<v8::Value> ToV8(ScriptState* script_state) const;

static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, uint32_t value);
static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, WebPrintingRange* value);
