...
const char* V8FunctionStringCallback::GetHumanReadableName() const {
  return "V8FunctionStringCallback";
}

v8::Maybe<void> V8FunctionStringCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const String& arg1_data) {
  const char* const class_like_name = "FunctionStringCallback";
...
v8_arg1_data = ToV8Traits<IDLString>::ToV8(script_state, arg1_data);
argv[0] = v8_arg1_data;
...
v8::Maybe<void> V8FunctionStringCallback::Construct(const String& arg1_data) {
  const char* const class_like_name = "FunctionStringCallback";
...
void V8FunctionStringCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const String& arg1_data) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = Invoke(arg0_receiver, arg1_data);
}

base::expected<void, ScriptValue> V8FunctionStringCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const String& arg1_data) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_data);
