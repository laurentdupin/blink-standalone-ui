...
class MODULES_EXPORT SerialPortInfo : public bindings::DictionaryBase {
  ...
  public:
static SerialPortInfo* Create() {
  return MakeGarbageCollected<SerialPortInfo>();
}
static SerialPortInfo* Create(v8::Isolate* isolate) {
  return MakeGarbageCollected<SerialPortInfo>(isolate);
}
