...
v8::Local<v8::Value> V8UnionArrayBufferAllowSharedOrArrayBufferViewAllowShared::DirectToV8(ScriptState* script_state, DOMArrayBufferBase* value) {
  return ToV8Traits<DOMArrayBufferBase>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionArrayBufferAllowSharedOrArrayBufferViewAllowShared::DirectToV8(ScriptState* script_state, MaybeShared<DOMArrayBufferView> value) {
  return ToV8Traits<MaybeShared<DOMArrayBufferView>>::ToV8(script_state, value);
}
