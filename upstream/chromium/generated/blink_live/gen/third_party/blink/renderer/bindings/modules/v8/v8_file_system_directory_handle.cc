...
static_assert(std::derived_from<FileSystemDirectoryHandle, FileSystemHandle>);
...
static_assert(bindings::IsReturnTypeCompatible<IDLPromise<FileSystemFileHandle>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
bindings::V8SetReturnValue(info, return_value);
...
static_assert(bindings::IsReturnTypeCompatible<IDLPromise<IDLNullable<IDLSequence<IDLUSVString>>>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
bindings::V8SetReturnValue(info, return_value);
...
static_assert(bindings::IsReturnTypeCompatible<AsyncIterator<FileSystemDirectoryHandle>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
void V8FileSystemDirectoryHandle::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "FileSystemDirectoryHandle", kOperationTable);
}
