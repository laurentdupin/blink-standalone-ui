...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_SCTP_TRANSPORT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_SCTP_TRANSPORT_H_
...
class MODULES_EXPORT V8RTCSctpTransport final : public bindings::V8InterfaceBridge<V8RTCSctpTransport, RTCSctpTransport> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(766);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class RTCSctpTransport;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_SCTP_TRANSPORT_H_
