...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WAVE_SHAPER_NODE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WAVE_SHAPER_NODE_H_
...
class MODULES_EXPORT V8WaveShaperNode final : public bindings::V8InterfaceBridge<V8WaveShaperNode, WaveShaperNode> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(525);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class WaveShaperNode;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WAVE_SHAPER_NODE_H_
