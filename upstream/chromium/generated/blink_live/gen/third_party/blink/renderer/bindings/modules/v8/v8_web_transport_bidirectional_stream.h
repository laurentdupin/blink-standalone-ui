...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEB_TRANSPORT_BIDIRECTIONAL_STREAM_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEB_TRANSPORT_BIDIRECTIONAL_STREAM_H_
...
class MODULES_EXPORT V8WebTransportBidirectionalStream final : public bindings::V8InterfaceBridge<V8WebTransportBidirectionalStream, BidirectionalStream> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1407);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class BidirectionalStream;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEB_TRANSPORT_BIDIRECTIONAL_STREAM_H_
