...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SCREEN_DETAILS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SCREEN_DETAILS_H_
...
class MODULES_EXPORT V8ScreenDetails final : public bindings::V8InterfaceBridge<V8ScreenDetails, ScreenDetails> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(771);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class ScreenDetails;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SCREEN_DETAILS_H_
