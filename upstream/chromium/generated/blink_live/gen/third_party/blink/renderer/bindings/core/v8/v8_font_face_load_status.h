...
kUnloaded, kLoading, kLoaded, kError
};
...
explicit constexpr  V8FontFaceLoadStatus(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
