...
static_assert(std::derived_from<HTMLFormElement, HTMLElement>);
...
auto&& return_value = blink_receiver->AnonymousNamedGetter(script_state, blink_property_name);
static_assert(bindings::IsReturnTypeCompatible<V8UnionElementOrRadioNodeList, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (!return_value) {
...
v8::Intercepted V8HTMLFormElement::NamedPropertySetterCallback(v8::Local<v8::Name> v8_property_name, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
...
v8::Intercepted V8HTMLFormElement::NamedPropertyDefinerCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
...
v8::Intercepted V8HTMLFormElement::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
...
v8::Intercepted V8HTMLFormElement::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
...
bindings::PerformAttributeSetCEReactionsReflectTypeString(info, html_names::kAcceptCharsetAttr);
}
...
bindings::PerformAttributeSetCEReactionsReflectTypeString(info, html_names::kAutocompleteAttr);
}
...
bindings::PerformAttributeSetCEReactionsReflectTypeBoolean(info, html_names::kNovalidateAttr);
}
...
static_assert(bindings::IsReturnTypeCompatible<HTMLFormControlsCollection, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
}
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLFormElement::GetWrapperTypeInfo(), ElementType::kHTMLFormElement);
}
...
void V8HTMLFormElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLFormElement", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLFormElement", kOperationTable);
}
