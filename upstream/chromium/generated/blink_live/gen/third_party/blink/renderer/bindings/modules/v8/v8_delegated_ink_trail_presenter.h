...
class MODULES_EXPORT V8DelegatedInkTrailPresenter final : public bindings::V8InterfaceBridge<V8DelegatedInkTrailPresenter, DelegatedInkTrailPresenter> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1137);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class DelegatedInkTrailPresenter;
};
