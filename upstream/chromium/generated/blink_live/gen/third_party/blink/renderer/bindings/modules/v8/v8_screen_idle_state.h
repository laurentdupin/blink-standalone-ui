...
class MODULES_EXPORT V8ScreenIdleState final : public bindings::EnumerationBase {
...
static V8ScreenIdleState Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8ScreenIdleState> Create(const String& value);

explicit constexpr  V8ScreenIdleState(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8ScreenIdleState& lhs, V8ScreenIdleState::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8ScreenIdleState::Enum lhs, const V8ScreenIdleState& rhs) {
