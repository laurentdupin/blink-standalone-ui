...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_NESTED_DECLARATIONS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_NESTED_DECLARATIONS_H_
...
class CORE_EXPORT V8CSSNestedDeclarations final : public bindings::V8InterfaceBridge<V8CSSNestedDeclarations, CSSNestedDeclarationsRule> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(302);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSNestedDeclarationsRule;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_NESTED_DECLARATIONS_H_
