...
class MODULES_EXPORT V8BackgroundFetchResult final : public bindings::EnumerationBase {
...
static V8BackgroundFetchResult Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8BackgroundFetchResult> Create(const String& value);

explicit constexpr  V8BackgroundFetchResult(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8BackgroundFetchResult& lhs, V8BackgroundFetchResult::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8BackgroundFetchResult::Enum lhs, const V8BackgroundFetchResult& rhs) {
