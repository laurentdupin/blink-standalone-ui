...
class MODULES_EXPORT V8XRReferenceSpaceType final : public bindings::EnumerationBase {
  
  public:
enum class Enum : enum_int_t {
kBoundedFloor, kLocal, kLocalFloor, kUnbounded, kViewer
};
static constexpr size_t kEnumSize = 5;

static V8XRReferenceSpaceType Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8XRReferenceSpaceType> Create(const String& value);

explicit constexpr  V8XRReferenceSpaceType(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8XRReferenceSpaceType& lhs, V8XRReferenceSpaceType::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8XRReferenceSpaceType::Enum lhs, const V8XRReferenceSpaceType& rhs) {
