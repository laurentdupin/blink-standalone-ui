...
bool V8NodeList::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8NodeList::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8NodeList::InstallInterfaceTemplate,
    nullptr,
    "NodeList",
    nullptr,
    V8NodeList::kThisTag,
    V8NodeList::kMaxSubclassTag,
...
const WrapperTypeInfo& NodeList::wrapper_type_info_ =
    V8NodeList::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, NodeList>::value,
    "NodeList inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

v8::Intercepted V8NodeList::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
NodeList* blink_receiver = V8NodeList::ToWrappableUnsafe(isolate, v8_receiver);
...
v8::Intercepted V8NodeList::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_NodeList_IndexedPropertySetter");
...
v8::Intercepted V8NodeList::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_NodeList_IndexedPropertyDeleter");
...
v8::Intercepted V8NodeList::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_NodeList_IndexedPropertyDefiner");
...
v8::Intercepted V8NodeList::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_NodeList_IndexedPropertyDescriptor");
...
void V8NodeList::IndexedPropertyEnumeratorCallback(const v8::PropertyCallbackInfo<v8::Array>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_NodeList_IndexedPropertyEnumerator");
...
uint32_t V8NodeList::IndexedPropertyIndexOfCallback(v8::Local<v8::Value> needle, uint32_t start_index, uint32_t end_index, uint32_t* out_length, const v8::PropertyCallbackInfo<void>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_NodeList_IndexedPropertyIndexOf");
...
auto&& blink_needle = V8Node::ToWrappable(isolate, needle);
...
//    otherwise. See v8::IndexedPropertyIndexOfCallback.
          ...
          for (uint32_t index = start_index; index < end_index; index++) {
            auto&& item = blink_receiver->item(index);
...
BLINK_BINDINGS_TRACE_EVENT("NodeList.length.get");
...
BLINK_BINDINGS_TRACE_EVENT("NodeList.item");
...
using namespace v8_node_list;

}  // namespace 

void V8NodeList::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8NodeList::GetWrapperTypeInfo();
...
instance_template->SetHandler(
    v8::IndexedPropertyHandlerConfiguration(
        ...
        nullptr,  // query
        V8NodeList::IndexedPropertyDeleterCallback,
        V8NodeList::IndexedPropertyEnumeratorCallback,
        V8NodeList::IndexedPropertyDefinerCallback,
        V8NodeList::IndexedPropertyDescriptorCallback,
        V8NodeList::IndexedPropertyIndexOfCallback,
        v8::Local<v8::Value>(),
...
void V8NodeList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "NodeList", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "NodeList", kOperationTable);
}
