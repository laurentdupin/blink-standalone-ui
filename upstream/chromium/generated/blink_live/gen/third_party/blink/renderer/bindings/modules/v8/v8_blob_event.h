...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BLOB_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BLOB_EVENT_H_
...
class MODULES_EXPORT V8BlobEvent final : public bindings::V8InterfaceBridge<V8BlobEvent, BlobEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(380);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class BlobEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BLOB_EVENT_H_
