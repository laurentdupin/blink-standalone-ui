...
V8UnionHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrImageDataOrOffscreenCanvasOrVideoFrame* V8UnionHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrImageDataOrOffscreenCanvasOrVideoFrame::Create(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state) {
...
return MakeGarbageCollected<V8UnionHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrImageDataOrOffscreenCanvasOrVideoFrame>(blink_value);
}
...
V8UnionHTMLCanvasElementOrOffscreenCanvas* V8UnionHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrImageDataOrOffscreenCanvasOrVideoFrame::GetAsV8UnionHTMLCanvasElementOrOffscreenCanvas() const {
...
void V8UnionHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrImageDataOrOffscreenCanvasOrVideoFrame::Set(const V8UnionHTMLCanvasElementOrOffscreenCanvas* value) {
...
V8UnionHTMLVideoElementOrVideoFrame* V8UnionHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrImageDataOrOffscreenCanvasOrVideoFrame::GetAsV8UnionHTMLVideoElementOrVideoFrame() const {
  switch (content_type_) {
...
void V8UnionHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrImageDataOrOffscreenCanvasOrVideoFrame::Set(const V8UnionHTMLVideoElementOrVideoFrame* value) {
  switch (value->GetContentType()) {
