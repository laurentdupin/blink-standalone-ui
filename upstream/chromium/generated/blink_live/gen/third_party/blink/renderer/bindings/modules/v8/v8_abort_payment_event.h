...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ABORT_PAYMENT_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ABORT_PAYMENT_EVENT_H_
...
class MODULES_EXPORT V8AbortPaymentEvent final : public bindings::V8InterfaceBridge<V8AbortPaymentEvent, AbortPaymentEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(398);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class AbortPaymentEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ABORT_PAYMENT_EVENT_H_
