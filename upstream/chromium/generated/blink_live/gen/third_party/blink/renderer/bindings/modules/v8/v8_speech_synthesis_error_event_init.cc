...
return dictionary;
 ...
 SpeechSynthesisErrorEventInit::SpeechSynthesisErrorEventInit(v8::Isolate* isolate) : SpeechSynthesisEventInit(isolate) {
...
if (!bindings::GetDictionaryMemberFromV8Object<V8SpeechSynthesisErrorCode, is_required>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), fallback_presence_var, member_error_, class_like_name, exception_state)) {
  return;
}
}
