...
const char* V8UkmEntryAddedCallback::GetHumanReadableName() const {
...
base::expected<void, ScriptValue> V8UkmEntryAddedCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
