...
WriterCreateOptions* WriterCreateOptions::Create(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state) {
  WriterCreateOptions* dictionary = MakeGarbageCollected<WriterCreateOptions>(isolate);
if (v8_value->IsNullOrUndefined()) {
  return dictionary;
}
if (!v8_value->IsObject()) {
  const char* const class_like_name = "WriterCreateOptions";
...
return dictionary;
 ...
 WriterCreateOptions::WriterCreateOptions() {
  
}

 WriterCreateOptions::WriterCreateOptions(v8::Isolate* isolate) : WriterCreateCoreOptions(isolate) {
...
String WriterCreateOptions::getSharedContextOr(const String& fallback_value) const {
  if (!hasSharedContext()) {
...
String WriterCreateOptions::getSharedContextOr(String&& fallback_value) const {
  if (!hasSharedContext()) {
...
void WriterCreateOptions::setSharedContext(const String& value) {
  member_shared_context_ = value;
has_shared_context_ = true;
}

void WriterCreateOptions::setSharedContext(String&& value) {
...
void WriterCreateOptions::Trace(Visitor* visitor) const {
  visitor->Trace(member_monitor_);
visitor->Trace(member_signal_);
WriterCreateCoreOptions::Trace(visitor);
}

void WriterCreateOptions::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state) {
  TryRethrowScope rethrow_scope(isolate, exception_state);
WriterCreateCoreOptions::FillMembersFromV8Object(isolate, v8_dictionary, exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
const base::span<const v8::Eternal<v8::Name>> WriterCreateOptions::GetV8OwnMemberNames(v8::Isolate* isolate) {
