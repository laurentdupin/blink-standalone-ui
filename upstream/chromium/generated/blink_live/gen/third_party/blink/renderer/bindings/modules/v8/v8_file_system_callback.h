...
explicit  V8FileSystemCallback(v8::Local<v8::Object> callback_object) : CallbackInterfaceBase(callback_object) {
...
[[nodiscard]] v8::Maybe<void> handleEvent(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, DOMFileSystem* arg1_file_system);
...
void InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, DOMFileSystem* arg1_file_system);
