...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_PEER_CONNECTION_ICE_ERROR_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_PEER_CONNECTION_ICE_ERROR_EVENT_H_
...
class MODULES_EXPORT V8RTCPeerConnectionIceErrorEvent final : public bindings::V8InterfaceBridge<V8RTCPeerConnectionIceErrorEvent, RTCPeerConnectionIceErrorEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(452);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class RTCPeerConnectionIceErrorEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_PEER_CONNECTION_ICE_ERROR_EVENT_H_
