...
class CORE_EXPORT V8CSSNumericBaseType final : public bindings::EnumerationBase {
  
  public:
enum class Enum : enum_int_t {
kLength, kAngle, kTime, kFrequency, kResolution, kFlex, kPercent
};
static constexpr size_t kEnumSize = 7;

static V8CSSNumericBaseType Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8CSSNumericBaseType> Create(const String& value);

explicit constexpr  V8CSSNumericBaseType(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8CSSNumericBaseType& lhs, V8CSSNumericBaseType::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8CSSNumericBaseType::Enum lhs, const V8CSSNumericBaseType& rhs) {
