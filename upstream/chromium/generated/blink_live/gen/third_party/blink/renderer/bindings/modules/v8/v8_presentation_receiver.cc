...
bool V8PresentationReceiver::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8PresentationReceiver::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8PresentationReceiver::InstallInterfaceTemplate,
    nullptr,
    "PresentationReceiver",
    nullptr,
    V8PresentationReceiver::kThisTag,
    V8PresentationReceiver::kMaxSubclassTag,
...
const WrapperTypeInfo& PresentationReceiver::wrapper_type_info_ =
    V8PresentationReceiver::wrapper_type_info_;
...
namespace v8_presentation_receiver {


void ConnectionListAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  // Promise returning function: Convert a TypeError to a reject promise.
ExceptionToRejectPromiseScope reject_promise_scope(info);
v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
if (!V8PresentationReceiver::HasInstance(isolate, v8_receiver)) {
...
BLINK_BINDINGS_TRACE_EVENT("PresentationReceiver.connectionList.get");
...
auto&& return_value = blink_receiver->connectionList(script_state);
static_assert(bindings::IsReturnTypeCompatible<IDLPromise<PresentationConnectionList>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
using namespace v8_presentation_receiver;

}  // namespace 

void V8PresentationReceiver::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8PresentationReceiver::GetWrapperTypeInfo();
