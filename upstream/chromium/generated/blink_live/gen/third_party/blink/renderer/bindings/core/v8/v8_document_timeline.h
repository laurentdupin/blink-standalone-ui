...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_DOCUMENT_TIMELINE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_DOCUMENT_TIMELINE_H_
...
class CORE_EXPORT V8DocumentTimeline final : public bindings::V8InterfaceBridge<V8DocumentTimeline, DocumentTimeline> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(262);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class DocumentTimeline;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_DOCUMENT_TIMELINE_H_
