...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SYNC_ITERATOR_HIGHLIGHT_REGISTRY_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SYNC_ITERATOR_HIGHLIGHT_REGISTRY_H_
...
template <>
class CORE_EXPORT SyncIterator<HighlightRegistry> final : public bindings::SyncIteratorBase {
  DEFINE_WRAPPERTYPEINFO();

  public:
using IDLKeyType = IDLString;
using IDLValueType = Highlight;
using KeyType = String;
using ValueType = Highlight*;

explicit  SyncIterator<HighlightRegistry>(IterationSourceBase* source, Kind kind) : bindings::SyncIteratorBase(source, kind) {
...
class CORE_EXPORT V8SyncIteratorHighlightRegistry final : public bindings::V8InterfaceBridge<V8SyncIteratorHighlightRegistry, SyncIterator<HighlightRegistry>> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1489);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SyncIterator<HighlightRegistry>;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SYNC_ITERATOR_HIGHLIGHT_REGISTRY_H_
