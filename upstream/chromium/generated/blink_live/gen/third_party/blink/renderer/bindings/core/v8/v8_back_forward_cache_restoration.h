...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_BACK_FORWARD_CACHE_RESTORATION_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_BACK_FORWARD_CACHE_RESTORATION_H_
...
class BackForwardCacheRestoration;
class ExecutionContext;
struct WrapperTypeInfo;

class CORE_EXPORT V8BackForwardCacheRestoration final : public bindings::V8InterfaceBridge<V8BackForwardCacheRestoration, BackForwardCacheRestoration> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(994);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class BackForwardCacheRestoration;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_BACK_FORWARD_CACHE_RESTORATION_H_
