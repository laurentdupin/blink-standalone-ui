...
bool V8Clients::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8Clients::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8Clients::InstallInterfaceTemplate,
    nullptr,
    "Clients",
    nullptr,
    V8Clients::kThisTag,
    V8Clients::kMaxSubclassTag,
...
const WrapperTypeInfo& ServiceWorkerClients::wrapper_type_info_ =
    V8Clients::wrapper_type_info_;
...
namespace v8_clients {

void ClaimOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_ServiceWorkerClients_claim");
BLINK_BINDINGS_TRACE_EVENT("Clients.claim");
// Promise returning function: Convert a TypeError to a reject promise.
ExceptionToRejectPromiseScope reject_promise_scope(info);

v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
if (!V8Clients::HasInstance(isolate, v8_receiver)) {
...
BLINK_BINDINGS_TRACE_EVENT("Clients.get");
// Promise returning function: Convert a TypeError to a reject promise.
ExceptionToRejectPromiseScope reject_promise_scope(info);
...
const char* const class_like_name = "Clients";
...
auto&& return_value = blink_receiver->get(script_state, arg1_id);
static_assert(bindings::IsReturnTypeCompatible<IDLPromise<ServiceWorkerClient>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value);
}
...
BLINK_BINDINGS_TRACE_EVENT("Clients.matchAll");
// Promise returning function: Convert a TypeError to a reject promise.
ExceptionToRejectPromiseScope reject_promise_scope(info);
...
if (info[0]->IsUndefined()) {
  arg1_options = ClientQueryOptions::Create();
} else {
  const v8::ExceptionContext exception_context_type = v8::ExceptionContext::kOperation;
const char* const class_like_name = "Clients";
const char* const property_name = "matchAll";
ExceptionState exception_state(isolate, ExceptionContext(exception_context_type, class_like_name, property_name));
arg1_options = NativeValueTraits<ClientQueryOptions>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
}
auto&& return_value = blink_receiver->matchAll(script_state, arg1_options);
static_assert(bindings::IsReturnTypeCompatible<IDLPromise<IDLSequence<ServiceWorkerClient>>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value);
}
...
BLINK_BINDINGS_TRACE_EVENT("Clients.openWindow");
// Promise returning function: Convert a TypeError to a reject promise.
ExceptionToRejectPromiseScope reject_promise_scope(info);
...
using namespace v8_clients;

}  // namespace 

void V8Clients::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8Clients::GetWrapperTypeInfo();
...
void V8Clients::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"claim", ClaimOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kDoNotCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "Clients", kOperationTable);
}
