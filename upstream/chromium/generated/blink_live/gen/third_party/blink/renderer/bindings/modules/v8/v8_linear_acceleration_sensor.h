...
class MODULES_EXPORT V8LinearAccelerationSensor final : public bindings::V8InterfaceBridge<V8LinearAccelerationSensor, LinearAccelerationSensor> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class LinearAccelerationSensor;
};
