...
const char* V8ViewTransitionCallback::GetHumanReadableName() const {
  return "V8ViewTransitionCallback";
}

v8::Maybe<ScriptPromise<IDLUndefined>> V8ViewTransitionCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
  const char* const class_like_name = "ViewTransitionCallback";
...
v8::Maybe<ScriptPromise<IDLUndefined>> V8ViewTransitionCallback::Construct() {
  const char* const class_like_name = "ViewTransitionCallback";
...
base::expected<ScriptPromise<IDLUndefined>, ScriptValue> V8ViewTransitionCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
