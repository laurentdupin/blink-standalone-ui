...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PROOFREADER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PROOFREADER_H_
...
class MODULES_EXPORT V8Proofreader final : public bindings::V8InterfaceBridge<V8Proofreader, Proofreader> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1077);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class Proofreader;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PROOFREADER_H_
