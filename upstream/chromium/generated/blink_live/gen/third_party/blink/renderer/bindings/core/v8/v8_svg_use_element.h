...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_USE_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_USE_ELEMENT_H_
...
class CORE_EXPORT V8SVGUseElement final : public bindings::V8InterfaceBridge<V8SVGUseElement, SVGUseElement> {
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_USE_ELEMENT_H_
