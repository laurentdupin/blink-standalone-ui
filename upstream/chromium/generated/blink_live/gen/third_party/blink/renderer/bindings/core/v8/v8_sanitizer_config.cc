...
HeapVector<Member<V8UnionSanitizerProcessingInstructionOrString>> SanitizerConfig::getProcessingInstructionsOr(const HeapVector<Member<V8UnionSanitizerProcessingInstructionOrString>>& fallback_value) const {
  if (!hasProcessingInstructions()) {
  return fallback_value;
}
return member_processing_instructions_;
}

HeapVector<Member<V8UnionSanitizerProcessingInstructionOrString>> SanitizerConfig::getProcessingInstructionsOr(HeapVector<Member<V8UnionSanitizerProcessingInstructionOrString>>&& fallback_value) const {
  if (!hasProcessingInstructions()) {
  return std::move(fallback_value);
}
return member_processing_instructions_;
...
void SanitizerConfig::setProcessingInstructions(const HeapVector<Member<V8UnionSanitizerProcessingInstructionOrString>>& value) {
  member_processing_instructions_ = value;
has_processing_instructions_ = true;
}

void SanitizerConfig::setProcessingInstructions(HeapVector<Member<V8UnionSanitizerProcessingInstructionOrString>>&& value) {
  member_processing_instructions_ = std::move(value);
has_processing_instructions_ = true;
}
...
HeapVector<Member<V8UnionSanitizerProcessingInstructionOrString>> SanitizerConfig::getRemoveProcessingInstructionsOr(const HeapVector<Member<V8UnionSanitizerProcessingInstructionOrString>>& fallback_value) const {
  if (!hasRemoveProcessingInstructions()) {
  return fallback_value;
}
return member_remove_processing_instructions_;
}

HeapVector<Member<V8UnionSanitizerProcessingInstructionOrString>> SanitizerConfig::getRemoveProcessingInstructionsOr(HeapVector<Member<V8UnionSanitizerProcessingInstructionOrString>>&& fallback_value) const {
  if (!hasRemoveProcessingInstructions()) {
  return std::move(fallback_value);
}
return member_remove_processing_instructions_;
...
void SanitizerConfig::setRemoveProcessingInstructions(const HeapVector<Member<V8UnionSanitizerProcessingInstructionOrString>>& value) {
  member_remove_processing_instructions_ = value;
has_remove_processing_instructions_ = true;
}

void SanitizerConfig::setRemoveProcessingInstructions(HeapVector<Member<V8UnionSanitizerProcessingInstructionOrString>>&& value) {
  member_remove_processing_instructions_ = std::move(value);
has_remove_processing_instructions_ = true;
}
...
if (hasProcessingInstructions()) {
  values[4] = ToV8Traits<IDLSequence<V8UnionSanitizerProcessingInstructionOrString>>::ToV8(script_state, member_processing_instructions_);
DCHECK(!values[4].IsEmpty());
}
if (hasRemoveAttributes()) {
  values[5] = ToV8Traits<IDLSequence<V8UnionSanitizerAttributeNamespaceOrString>>::ToV8(script_state, member_remove_attributes_);
DCHECK(!values[5].IsEmpty());
}
if (hasRemoveElements()) {
  values[6] = ToV8Traits<IDLSequence<V8UnionSanitizerElementNamespaceOrString>>::ToV8(script_state, member_remove_elements_);
DCHECK(!values[6].IsEmpty());
}
if (hasRemoveProcessingInstructions()) {
  values[7] = ToV8Traits<IDLSequence<V8UnionSanitizerProcessingInstructionOrString>>::ToV8(script_state, member_remove_processing_instructions_);
DCHECK(!values[7].IsEmpty());
}
if (hasReplaceWithChildrenElements()) {
  values[8] = ToV8Traits<IDLSequence<V8UnionSanitizerElementNamespaceOrString>>::ToV8(script_state, member_replace_with_children_elements_);
...
dictionary_from_v8_context.SetCurrentPropertyName("processingInstructions");
if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<V8UnionSanitizerProcessingInstructionOrString>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[4].Get(isolate), has_processing_instructions_, member_processing_instructions_, class_like_name, exception_state)) {
  return;
}
dictionary_from_v8_context.SetCurrentPropertyName("removeAttributes");
if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<V8UnionSanitizerAttributeNamespaceOrString>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[5].Get(isolate), has_remove_attributes_, member_remove_attributes_, class_like_name, exception_state)) {
  return;
}
dictionary_from_v8_context.SetCurrentPropertyName("removeElements");
if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<V8UnionSanitizerElementNamespaceOrString>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[6].Get(isolate), has_remove_elements_, member_remove_elements_, class_like_name, exception_state)) {
  return;
}
dictionary_from_v8_context.SetCurrentPropertyName("removeProcessingInstructions");
if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<V8UnionSanitizerProcessingInstructionOrString>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[7].Get(isolate), has_remove_processing_instructions_, member_remove_processing_instructions_, class_like_name, exception_state)) {
  return;
}
dictionary_from_v8_context.SetCurrentPropertyName("replaceWithChildrenElements");
if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<V8UnionSanitizerElementNamespaceOrString>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[8].Get(isolate), has_replace_with_children_elements_, member_replace_with_children_elements_, class_like_name, exception_state)) {
  return;
}
}
