...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MIDI_OUTPUT_MAP_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MIDI_OUTPUT_MAP_H_
...
class MODULES_EXPORT V8MIDIOutputMap final : public bindings::V8InterfaceBridge<V8MIDIOutputMap, MIDIOutputMap> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1404);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class MIDIOutputMap;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MIDI_OUTPUT_MAP_H_
