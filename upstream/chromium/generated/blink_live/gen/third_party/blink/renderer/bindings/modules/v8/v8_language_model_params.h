...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_LANGUAGE_MODEL_PARAMS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_LANGUAGE_MODEL_PARAMS_H_
...
class MODULES_EXPORT V8LanguageModelParams final : public bindings::V8InterfaceBridge<V8LanguageModelParams, LanguageModelParams> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1074);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class LanguageModelParams;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_LANGUAGE_MODEL_PARAMS_H_
