...
bool V8KHRParallelShaderCompile::IsExposed(ExecutionContext* execution_context) {
  return false;
}
...
const WrapperTypeInfo V8KHRParallelShaderCompile::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8KHRParallelShaderCompile::InstallInterfaceTemplate,
    V8KHRParallelShaderCompile::InstallContextDependentProperties,
    "KHRParallelShaderCompile",
    nullptr,
    V8KHRParallelShaderCompile::kThisTag,
    V8KHRParallelShaderCompile::kMaxSubclassTag,
...
const WrapperTypeInfo& KHRParallelShaderCompile::wrapper_type_info_ =
    V8KHRParallelShaderCompile::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, KHRParallelShaderCompile>::value,
    "KHRParallelShaderCompile inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_khr_parallel_shader_compile {



}  // namespace v8_khr_parallel_shader_compile

using namespace v8_khr_parallel_shader_compile;

}  // namespace 

void V8KHRParallelShaderCompile::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8KHRParallelShaderCompile::GetWrapperTypeInfo();
...
void V8KHRParallelShaderCompile::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"COMPLETION_STATUS_KHR", V8KHRParallelShaderCompile::Constant::kCompletionStatusKhr},
};
