...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MEDIA_STREAM_TRACK_VIDEO_STATS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MEDIA_STREAM_TRACK_VIDEO_STATS_H_
...
class MODULES_EXPORT V8MediaStreamTrackVideoStats final : public bindings::V8InterfaceBridge<V8MediaStreamTrackVideoStats, MediaStreamTrackVideoStats> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1201);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class MediaStreamTrackVideoStats;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MEDIA_STREAM_TRACK_VIDEO_STATS_H_
