...
bool V8XRSpace::IsExposed(ExecutionContext* execution_context) {
  
const bool is_in_secure_context = execution_context->IsSecureContext();
return is_in_secure_context && execution_context->IsWindow() && RuntimeEnabledFeatures::WebXREnabled();
}

static_assert(std::derived_from<XRSpace, EventTarget>);
...
const WrapperTypeInfo V8XRSpace::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8XRSpace::InstallInterfaceTemplate,
    nullptr,
    "XRSpace",
    V8EventTarget::GetWrapperTypeInfo(),
    V8XRSpace::kThisTag,
    V8XRSpace::kMaxSubclassTag,
...
const WrapperTypeInfo& XRSpace::wrapper_type_info_ =
    V8XRSpace::wrapper_type_info_;
...
namespace v8_xr_space {



}  // namespace v8_xr_space

using namespace v8_xr_space;

}  // namespace 

void V8XRSpace::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8XRSpace::GetWrapperTypeInfo();
