...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_DOM_OVERLAY_STATE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_DOM_OVERLAY_STATE_H_
...
class MODULES_EXPORT V8XRDOMOverlayState final : public bindings::V8InterfaceBridge<V8XRDOMOverlayState, XRDOMOverlayState> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1427);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XRDOMOverlayState;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_DOM_OVERLAY_STATE_H_
