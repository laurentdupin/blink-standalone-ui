...
public:
    ...
    void setInstrumentationBreakpoint(crdtp::Dispatchable& dispatchable);
    void removeInstrumentationBreakpoint(crdtp::Dispatchable& dispatchable);
...
void DomainDispatcherImpl::setInstrumentationBreakpoint(crdtp::Dispatchable& dispatchable)
{
...
void DomainDispatcherImpl::removeInstrumentationBreakpoint(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
