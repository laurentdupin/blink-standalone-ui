...
MediaStreamConstraints* MediaStreamConstraints::Create(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state) {
  MediaStreamConstraints* dictionary = MakeGarbageCollected<MediaStreamConstraints>(isolate);
if (v8_value->IsNullOrUndefined()) {
  return dictionary;
}
if (!v8_value->IsObject()) {
  const char* const class_like_name = "MediaStreamConstraints";
...
return dictionary;
 ...
 MediaStreamConstraints::MediaStreamConstraints() : member_audio_(MakeGarbageCollected<V8UnionBooleanOrMediaTrackConstraints>(false)), member_video_(MakeGarbageCollected<V8UnionBooleanOrMediaTrackConstraints>(false)) {
  
}

 MediaStreamConstraints::MediaStreamConstraints(v8::Isolate* isolate) : member_audio_(MakeGarbageCollected<V8UnionBooleanOrMediaTrackConstraints>(false)), member_video_(MakeGarbageCollected<V8UnionBooleanOrMediaTrackConstraints>(false)) {
...
void MediaStreamConstraints::Trace(Visitor* visitor) const {
...
void MediaStreamConstraints::FillMembersFromV8Object(v8::Isolate* isolate, v8::Local<v8::Object> v8_dictionary, ExceptionState& exception_state) {
...
const base::span<const v8::Eternal<v8::Name>> MediaStreamConstraints::GetV8OwnMemberNames(v8::Isolate* isolate) {
