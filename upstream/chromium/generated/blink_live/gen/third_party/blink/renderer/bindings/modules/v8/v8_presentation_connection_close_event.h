...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PRESENTATION_CONNECTION_CLOSE_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PRESENTATION_CONNECTION_CLOSE_EVENT_H_
...
class MODULES_EXPORT V8PresentationConnectionCloseEvent final : public bindings::V8InterfaceBridge<V8PresentationConnectionCloseEvent, PresentationConnectionCloseEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(445);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PresentationConnectionCloseEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PRESENTATION_CONNECTION_CLOSE_EVENT_H_
