...
bool V8RTCDTMFToneChangeEvent::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<RTCDTMFToneChangeEvent, Event>);
...
const WrapperTypeInfo V8RTCDTMFToneChangeEvent::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8RTCDTMFToneChangeEvent::InstallInterfaceTemplate,
    nullptr,
    "RTCDTMFToneChangeEvent",
    V8Event::GetWrapperTypeInfo(),
    V8RTCDTMFToneChangeEvent::kThisTag,
    V8RTCDTMFToneChangeEvent::kMaxSubclassTag,
...
const WrapperTypeInfo& RTCDTMFToneChangeEvent::wrapper_type_info_ =
    V8RTCDTMFToneChangeEvent::wrapper_type_info_;
...
namespace v8_rtc_dtmf_tone_change_event {


void ToneAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_RTCDTMFToneChangeEvent_tone_Getter");
BLINK_BINDINGS_TRACE_EVENT("RTCDTMFToneChangeEvent.tone.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_RTCDTMFToneChangeEvent_isTrusted_Getter");
BLINK_BINDINGS_TRACE_EVENT("RTCDTMFToneChangeEvent.isTrusted.get");
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_RTCDTMFToneChangeEvent_constructor");
BLINK_BINDINGS_TRACE_EVENT("RTCDTMFToneChangeEvent.constructor");
...
auto&& arg2_event_init_dict = NativeValueTraits<RTCDTMFToneChangeEventInit>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& return_value = RTCDTMFToneChangeEvent::Create(arg1_type, arg2_event_init_dict);
static_assert(bindings::IsReturnTypeCompatible<RTCDTMFToneChangeEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8RTCDTMFToneChangeEvent::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_rtc_dtmf_tone_change_event;

}  // namespace 

void V8RTCDTMFToneChangeEvent::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8RTCDTMFToneChangeEvent::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "RTCDTMFToneChangeEvent"));
...
void V8RTCDTMFToneChangeEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "RTCDTMFToneChangeEvent", kAttributeTable);
}
