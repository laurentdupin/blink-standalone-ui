...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TRANSFORM_STREAM_DEFAULT_CONTROLLER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TRANSFORM_STREAM_DEFAULT_CONTROLLER_H_
...
class CORE_EXPORT V8TransformStreamDefaultController final : public bindings::V8InterfaceBridge<V8TransformStreamDefaultController, TransformStreamDefaultController> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(956);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TRANSFORM_STREAM_DEFAULT_CONTROLLER_H_
