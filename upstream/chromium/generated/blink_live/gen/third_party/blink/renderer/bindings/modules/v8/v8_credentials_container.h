...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CREDENTIALS_CONTAINER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CREDENTIALS_CONTAINER_H_
...
class MODULES_EXPORT V8CredentialsContainer final : public bindings::V8InterfaceBridge<V8CredentialsContainer, CredentialsContainer> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1129);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CredentialsContainer;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CREDENTIALS_CONTAINER_H_
