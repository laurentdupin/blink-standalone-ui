...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_FILE_SYSTEM_OBSERVER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_FILE_SYSTEM_OBSERVER_H_
...
class MODULES_EXPORT V8FileSystemObserver final : public bindings::V8InterfaceBridge<V8FileSystemObserver, FileSystemObserver> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1152);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class FileSystemObserver;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_FILE_SYSTEM_OBSERVER_H_
