...
public:
    ...
    void clear(crdtp::Dispatchable& dispatchable);
    void disable(crdtp::Dispatchable& dispatchable);
    void enable(crdtp::Dispatchable& dispatchable);
    void getDOMStorageItems(crdtp::Dispatchable& dispatchable);
    void removeDOMStorageItem(crdtp::Dispatchable& dispatchable);
    void setDOMStorageItem(crdtp::Dispatchable& dispatchable);
 protected:
    Backend* m_backend;
};
...
void DomainDispatcherImpl::clear(crdtp::Dispatchable& dispatchable)
{
...
void DomainDispatcherImpl::getDOMStorageItems(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
...
void DomainDispatcherImpl::removeDOMStorageItem(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
...
void DomainDispatcherImpl::setDOMStorageItem(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
