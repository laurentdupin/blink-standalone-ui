...
v8::Local<v8::Value> V8UnionCompositeOperationOrAutoOrCompositeOperationOrAutoSequence::DirectToV8(ScriptState* script_state, V8CompositeOperationOrAuto value) {
  return ToV8Traits<V8CompositeOperationOrAuto>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionCompositeOperationOrAutoOrCompositeOperationOrAutoSequence::DirectToV8(ScriptState* script_state, const Vector<V8CompositeOperationOrAuto>& value) {
  return ToV8Traits<IDLSequence<V8CompositeOperationOrAuto>>::ToV8(script_state, value);
}
