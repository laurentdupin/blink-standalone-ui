...
public:
    ...
    void getDOMCounters(crdtp::Dispatchable& dispatchable);
    void forciblyPurgeJavaScriptMemory(crdtp::Dispatchable& dispatchable);
    void startSampling(crdtp::Dispatchable& dispatchable);
    void stopSampling(crdtp::Dispatchable& dispatchable);
    void getAllTimeSamplingProfile(crdtp::Dispatchable& dispatchable);
    void getSamplingProfile(crdtp::Dispatchable& dispatchable);
 protected:
    Backend* m_backend;
};
...
void DomainDispatcherImpl::getDOMCounters(crdtp::Dispatchable& dispatchable)
{
...
void DomainDispatcherImpl::forciblyPurgeJavaScriptMemory(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
...
struct startSamplingParams : public crdtp::DeserializableProtocolObject<startSamplingParams> {
    std::optional<int> samplingInterval;
    std::optional<bool> suppressRandomness;
...
void DomainDispatcherImpl::startSampling(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
...
void DomainDispatcherImpl::stopSampling(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
...
void DomainDispatcherImpl::getAllTimeSamplingProfile(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    // Declare output parameters.
...
void DomainDispatcherImpl::getSamplingProfile(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    // Declare output parameters.
    std::unique_ptr<protocol::Memory::SamplingProfile> out_profile;
