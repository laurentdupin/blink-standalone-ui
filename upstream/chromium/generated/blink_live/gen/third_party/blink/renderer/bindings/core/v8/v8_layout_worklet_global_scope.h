...
class CORE_EXPORT V8LayoutWorkletGlobalScope final : public bindings::V8InterfaceBridge<V8LayoutWorkletGlobalScope, LayoutWorkletGlobalScope> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1041);
...
static InstallContextIndependentPropertiesFuncType install_context_independent_props_func_;
  ...
  friend class LayoutWorkletGlobalScope;
};
