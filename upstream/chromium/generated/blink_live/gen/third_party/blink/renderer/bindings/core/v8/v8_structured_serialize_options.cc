...
void StructuredSerializeOptions::setTransfer(const HeapVector<ScriptObject>& value) {
  member_transfer_ = value;
}

void StructuredSerializeOptions::setTransfer(HeapVector<ScriptObject>&& value) {
...
if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<IDLObject>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), fallback_presence_var, member_transfer_, class_like_name, exception_state)) {
  return;
}
}
