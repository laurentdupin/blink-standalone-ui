...
static_assert(std::derived_from<HTMLAnchorElement, HTMLElement>);
...
const WrapperTypeInfo& HTMLAnchorElement::wrapper_type_info_ =
    V8HTMLAnchorElement::wrapper_type_info_;
...
bindings::PerformAttributeSetCEReactionsReflectTypeString(info, html_names::kHreftranslateAttr);
}
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLAnchorElement_interestForElement_Getter");
BLINK_BINDINGS_TRACE_EVENT("HTMLAnchorElement.interestForElement.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLAnchorElement_interestForElement_Setter");
BLINK_BINDINGS_TRACE_EVENT("HTMLAnchorElement.interestForElement.set");
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLAnchorElement::GetWrapperTypeInfo(), ElementType::kHTMLAnchorElement);
}
...
void V8HTMLAnchorElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLAnchorElement", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLAnchorElement", kOperationTable);
}
...
void V8HTMLAnchorElement::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object, v8::Local<v8::Object> prototype_object, v8::Local<v8::Object> interface_object, v8::Local<v8::Template> interface_template, FeatureSelector feature_selector) {
  using bindings::IDLMemberInstaller;
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_object, prototype_object, interface_object, signature, "HTMLAnchorElement", kAttributeTable);
}
