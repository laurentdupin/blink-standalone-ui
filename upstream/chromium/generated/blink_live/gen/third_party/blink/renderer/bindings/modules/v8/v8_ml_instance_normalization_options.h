...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ML_INSTANCE_NORMALIZATION_OPTIONS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ML_INSTANCE_NORMALIZATION_OPTIONS_H_
...
class MODULES_EXPORT MLInstanceNormalizationOptions : public MLOperatorOptions {
  
  public:
static MLInstanceNormalizationOptions* Create() {
  return MakeGarbageCollected<MLInstanceNormalizationOptions>();
}
static MLInstanceNormalizationOptions* Create(v8::Isolate* isolate) {
  return MakeGarbageCollected<MLInstanceNormalizationOptions>(isolate);
}
static MLInstanceNormalizationOptions* Create(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state);

explicit  MLInstanceNormalizationOptions();
explicit  MLInstanceNormalizationOptions(v8::Isolate* isolate);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ML_INSTANCE_NORMALIZATION_OPTIONS_H_
