...
bool V8MIDIOutputMap::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8MIDIOutputMap::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8MIDIOutputMap::InstallInterfaceTemplate,
    V8MIDIOutputMap::InstallContextDependentProperties,
    "MIDIOutputMap",
    nullptr,
    V8MIDIOutputMap::kThisTag,
    V8MIDIOutputMap::kMaxSubclassTag,
...
const WrapperTypeInfo& MIDIOutputMap::wrapper_type_info_ =
    V8MIDIOutputMap::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, MIDIOutputMap>::value,
    "MIDIOutputMap inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_midi_output_map {
...
BLINK_BINDINGS_TRACE_EVENT("MIDIOutputMap.size.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
MIDIOutputMap* blink_receiver = V8MIDIOutputMap::ToWrappableUnsafe(isolate, v8_receiver);
...
void EntriesOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MIDIOutputMap_entries");
BLINK_BINDINGS_TRACE_EVENT("MIDIOutputMap.entries");
...
static_assert(bindings::IsReturnTypeCompatible<SyncIterator<MIDIOutputMap>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
BLINK_BINDINGS_TRACE_EVENT("MIDIOutputMap.forEach");
...
BLINK_BINDINGS_TRACE_EVENT("MIDIOutputMap.get");
...
BLINK_BINDINGS_TRACE_EVENT("MIDIOutputMap.has");
...
BLINK_BINDINGS_TRACE_EVENT("MIDIOutputMap.keys");
...
BLINK_BINDINGS_TRACE_EVENT("MIDIOutputMap.values");
...
using namespace v8_midi_output_map;

}  // namespace 

void V8MIDIOutputMap::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8MIDIOutputMap::GetWrapperTypeInfo();
...
void V8MIDIOutputMap::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "MIDIOutputMap", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "MIDIOutputMap", kOperationTable);
}
...
void V8MIDIOutputMap::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object, v8::Local<v8::Object> prototype_object, v8::Local<v8::Object> interface_object, v8::Local<v8::Template> interface_template, FeatureSelector feature_selector) {
  using bindings::IDLMemberInstaller;
