...
bool V8HTMLMapElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<HTMLMapElement, HTMLElement>);
...
const WrapperTypeInfo V8HTMLMapElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8HTMLMapElement::InstallInterfaceTemplate,
    nullptr,
    "HTMLMapElement",
    V8HTMLElement::GetWrapperTypeInfo(),
    V8HTMLMapElement::kThisTag,
    V8HTMLMapElement::kMaxSubclassTag,
...
const WrapperTypeInfo& HTMLMapElement::wrapper_type_info_ =
    V8HTMLMapElement::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, HTMLMapElement>::value,
    "HTMLMapElement inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_html_map_element {
...
BLINK_BINDINGS_TRACE_EVENT("HTMLMapElement.name.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
HTMLMapElement* blink_receiver = V8HTMLMapElement::ToWrappableUnsafe(isolate, v8_receiver);
...
BLINK_BINDINGS_TRACE_EVENT("HTMLMapElement.name.set");

bindings::PerformAttributeSetCEReactionsReflectTypeString(info, html_names::kNameAttr);
}


void AreasAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLMapElement_areas_Getter");
BLINK_BINDINGS_TRACE_EVENT("HTMLMapElement.areas.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
HTMLMapElement* blink_receiver = V8HTMLMapElement::ToWrappableUnsafe(isolate, v8_receiver);
auto&& return_value = blink_receiver->areas();
...
BLINK_BINDINGS_TRACE_EVENT("HTMLMapElement.constructor");
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLMapElement::GetWrapperTypeInfo(), ElementType::kHTMLMapElement);
}


}  // namespace v8_html_map_element

using namespace v8_html_map_element;

}  // namespace 

void V8HTMLMapElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8HTMLMapElement::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "HTMLMapElement"));
...
void V8HTMLMapElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"areas", AreasAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
};
v8::Local<v8::Signature> signature = v8::Local<v8::Signature>::Cast(interface_template);
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLMapElement", kAttributeTable);
}
