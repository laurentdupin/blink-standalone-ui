...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GAMEPAD_RAW_INPUT_CHANGE_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GAMEPAD_RAW_INPUT_CHANGE_EVENT_H_
...
class GamepadRawInputChangeEvent;
struct WrapperTypeInfo;

class MODULES_EXPORT V8GamepadRawInputChangeEvent final : public bindings::V8InterfaceBridge<V8GamepadRawInputChangeEvent, GamepadRawInputChangeEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(417);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class GamepadRawInputChangeEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GAMEPAD_RAW_INPUT_CHANGE_EVENT_H_
