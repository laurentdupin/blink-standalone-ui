...
const char* V8FileWriterCallback::GetHumanReadableName() const {
  return "V8FileWriterCallback";
}

v8::Maybe<void> V8FileWriterCallback::handleEvent(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, FileWriter* arg1_file_writer) {
  const char* const class_like_name = "FileWriterCallback";
...
v8::Local<v8::Value> v8_arg1_file_writer;
ScriptState* script_state = CallbackRelevantScriptState();
v8_arg1_file_writer = ToV8Traits<FileWriter>::ToV8(script_state, arg1_file_writer);
argv[0] = v8_arg1_file_writer;
...
void V8FileWriterCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, FileWriter* arg1_file_writer) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = handleEvent(arg0_receiver, arg1_file_writer);
}
