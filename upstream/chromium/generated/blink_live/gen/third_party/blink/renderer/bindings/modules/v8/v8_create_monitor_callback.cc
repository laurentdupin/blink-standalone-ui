...
v8::Maybe<void> V8CreateMonitorCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, CreateMonitor* arg1_monitor) {
  const char* const class_like_name = "CreateMonitorCallback";
...
v8::Local<v8::Value> v8_arg1_monitor;
ScriptState* script_state = CallbackRelevantScriptState();
v8_arg1_monitor = ToV8Traits<CreateMonitor>::ToV8(script_state, arg1_monitor);
argv[0] = v8_arg1_monitor;
...
v8::Maybe<void> V8CreateMonitorCallback::Construct(CreateMonitor* arg1_monitor) {
  const char* const class_like_name = "CreateMonitorCallback";
...
void V8CreateMonitorCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, CreateMonitor* arg1_monitor) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = Invoke(arg0_receiver, arg1_monitor);
}

base::expected<void, ScriptValue> V8CreateMonitorCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, CreateMonitor* arg1_monitor) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_monitor);
