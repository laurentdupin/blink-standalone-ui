...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_VIEW_TIMELINE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_VIEW_TIMELINE_H_
...
class CORE_EXPORT V8ViewTimeline final : public bindings::V8InterfaceBridge<V8ViewTimeline, ViewTimeline> {
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_VIEW_TIMELINE_H_
