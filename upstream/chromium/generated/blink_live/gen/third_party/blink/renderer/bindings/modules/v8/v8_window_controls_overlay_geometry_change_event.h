...
class MODULES_EXPORT V8WindowControlsOverlayGeometryChangeEvent final : public bindings::V8InterfaceBridge<V8WindowControlsOverlayGeometryChangeEvent, WindowControlsOverlayGeometryChangeEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(488);
