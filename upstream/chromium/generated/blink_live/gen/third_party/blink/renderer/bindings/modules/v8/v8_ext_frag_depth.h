...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_FRAG_DEPTH_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_FRAG_DEPTH_H_
...
class MODULES_EXPORT V8EXTFragDepth final : public bindings::V8InterfaceBridge<V8EXTFragDepth, EXTFragDepth> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1301);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class EXTFragDepth;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_FRAG_DEPTH_H_
