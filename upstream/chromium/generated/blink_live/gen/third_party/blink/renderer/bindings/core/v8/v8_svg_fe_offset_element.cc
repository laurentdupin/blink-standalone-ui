...
bool V8SVGFEOffsetElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<SVGFEOffsetElement, SVGElement>);
...
const WrapperTypeInfo V8SVGFEOffsetElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SVGFEOffsetElement::InstallInterfaceTemplate,
    nullptr,
    "SVGFEOffsetElement",
    V8SVGElement::GetWrapperTypeInfo(),
    V8SVGFEOffsetElement::kThisTag,
    V8SVGFEOffsetElement::kMaxSubclassTag,
...
const WrapperTypeInfo& SVGFEOffsetElement::wrapper_type_info_ =
    V8SVGFEOffsetElement::wrapper_type_info_;
...
namespace v8_svg_fe_offset_element {
...
BLINK_BINDINGS_TRACE_EVENT("SVGFEOffsetElement.in1.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFEOffsetElement.dx.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFEOffsetElement.dy.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFEOffsetElement.x.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFEOffsetElement.y.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFEOffsetElement.width.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFEOffsetElement.height.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFEOffsetElement.result.get");
...
using namespace v8_svg_fe_offset_element;

}  // namespace 

void V8SVGFEOffsetElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SVGFEOffsetElement::GetWrapperTypeInfo();
...
void V8SVGFEOffsetElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGFEOffsetElement", kAttributeTable);
}
