...
bool V8CSSPageRule::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<CSSPageRule, CSSGroupingRule>);
...
const WrapperTypeInfo V8CSSPageRule::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8CSSPageRule::InstallInterfaceTemplate,
    nullptr,
    "CSSPageRule",
    V8CSSGroupingRule::GetWrapperTypeInfo(),
    V8CSSPageRule::kThisTag,
    V8CSSPageRule::kMaxSubclassTag,
...
const WrapperTypeInfo& CSSPageRule::wrapper_type_info_ =
    V8CSSPageRule::wrapper_type_info_;
...
BLINK_BINDINGS_TRACE_EVENT("CSSPageRule.selectorText.get");
...
BLINK_BINDINGS_TRACE_EVENT("CSSPageRule.selectorText.set");
...
BLINK_BINDINGS_TRACE_EVENT("CSSPageRule.style.get");
...
BLINK_BINDINGS_TRACE_EVENT("CSSPageRule.style.set");
...
using namespace v8_css_page_rule;

}  // namespace 

void V8CSSPageRule::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8CSSPageRule::GetWrapperTypeInfo();
...
void V8CSSPageRule::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "CSSPageRule", kAttributeTable);
}
