...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_FRAGMENT_DIRECTIVE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_FRAGMENT_DIRECTIVE_H_
...
class CORE_EXPORT V8FragmentDirective final : public bindings::V8InterfaceBridge<V8FragmentDirective, FragmentDirective> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(852);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_FRAGMENT_DIRECTIVE_H_
