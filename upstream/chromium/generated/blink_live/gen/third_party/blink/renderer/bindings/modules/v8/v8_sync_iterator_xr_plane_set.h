...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_XR_PLANE_SET_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_XR_PLANE_SET_H_
...
template <>
class MODULES_EXPORT SyncIterator<XRPlaneSet> final : public bindings::SyncIteratorBase {
  DEFINE_WRAPPERTYPEINFO();

  public:
using IDLKeyType = void;
using IDLValueType = XRPlane;
using KeyType = void;
using ValueType = XRPlane*;

explicit  SyncIterator<XRPlaneSet>(IterationSourceBase* source, Kind kind) : bindings::SyncIteratorBase(source, kind) {
...
class MODULES_EXPORT V8SyncIteratorXRPlaneSet final : public bindings::V8InterfaceBridge<V8SyncIteratorXRPlaneSet, SyncIterator<XRPlaneSet>> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1508);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SyncIterator<XRPlaneSet>;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_XR_PLANE_SET_H_
