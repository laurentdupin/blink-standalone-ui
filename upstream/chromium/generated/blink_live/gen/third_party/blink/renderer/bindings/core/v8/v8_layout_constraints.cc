...
bool V8LayoutConstraints::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8LayoutConstraints::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8LayoutConstraints::InstallInterfaceTemplate,
    nullptr,
    "LayoutConstraints",
    nullptr,
    V8LayoutConstraints::kThisTag,
    V8LayoutConstraints::kMaxSubclassTag,
...
const WrapperTypeInfo& CustomLayoutConstraints::wrapper_type_info_ =
    V8LayoutConstraints::wrapper_type_info_;
...
namespace v8_layout_constraints {


void FixedInlineSizeAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CustomLayoutConstraints_fixedInlineSize_Getter");
BLINK_BINDINGS_TRACE_EVENT("LayoutConstraints.fixedInlineSize.get");
...
void FixedBlockSizeAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CustomLayoutConstraints_fixedBlockSize_Getter");
BLINK_BINDINGS_TRACE_EVENT("LayoutConstraints.fixedBlockSize.get");
...
BLINK_BINDINGS_TRACE_EVENT("LayoutConstraints.data.get");
...
using namespace v8_layout_constraints;

}  // namespace 

void V8LayoutConstraints::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8LayoutConstraints::GetWrapperTypeInfo();
...
void V8LayoutConstraints::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
  using bindings::IDLMemberInstaller;

{
  
static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
{"fixedInlineSize", FixedInlineSizeAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
{"fixedBlockSize", FixedBlockSizeAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
{"data", DataAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
};
v8::Local<v8::Signature> signature = v8::Local<v8::Signature>::Cast(interface_template);
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "LayoutConstraints", kAttributeTable);
}
