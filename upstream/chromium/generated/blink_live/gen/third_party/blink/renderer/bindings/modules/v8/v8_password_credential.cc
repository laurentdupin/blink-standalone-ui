...
static_assert(std::derived_from<PasswordCredential, Credential>);
...
const WrapperTypeInfo& PasswordCredential::wrapper_type_info_ =
    V8PasswordCredential::wrapper_type_info_;
...
static_assert(bindings::IsReturnTypeCompatible<PasswordCredential, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
v8::Local<v8::Object> v8_receiver = info.This();
...
void V8PasswordCredential::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "PasswordCredential", kAttributeTable);
}
