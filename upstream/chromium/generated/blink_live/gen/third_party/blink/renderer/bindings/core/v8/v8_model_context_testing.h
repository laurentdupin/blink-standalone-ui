...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_MODEL_CONTEXT_TESTING_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_MODEL_CONTEXT_TESTING_H_
...
class CORE_EXPORT V8ModelContextTesting final : public bindings::V8InterfaceBridge<V8ModelContextTesting, ModelContextTesting> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(573);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class ModelContextTesting;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_MODEL_CONTEXT_TESTING_H_
