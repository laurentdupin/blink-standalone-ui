...
bool V8AudioParamMap::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8AudioParamMap::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8AudioParamMap::InstallInterfaceTemplate,
    V8AudioParamMap::InstallContextDependentProperties,
    "AudioParamMap",
    nullptr,
    V8AudioParamMap::kThisTag,
    V8AudioParamMap::kMaxSubclassTag,
...
const WrapperTypeInfo& AudioParamMap::wrapper_type_info_ =
    V8AudioParamMap::wrapper_type_info_;
...
BLINK_BINDINGS_TRACE_EVENT("AudioParamMap.size.get");
...
void EntriesOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_AudioParamMap_entries");
BLINK_BINDINGS_TRACE_EVENT("AudioParamMap.entries");
...
static_assert(bindings::IsReturnTypeCompatible<SyncIterator<AudioParamMap>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
BLINK_BINDINGS_TRACE_EVENT("AudioParamMap.forEach");
...
BLINK_BINDINGS_TRACE_EVENT("AudioParamMap.get");
...
BLINK_BINDINGS_TRACE_EVENT("AudioParamMap.has");
...
BLINK_BINDINGS_TRACE_EVENT("AudioParamMap.keys");
...
BLINK_BINDINGS_TRACE_EVENT("AudioParamMap.values");
...
using namespace v8_audio_param_map;

}  // namespace 

void V8AudioParamMap::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8AudioParamMap::GetWrapperTypeInfo();
...
void V8AudioParamMap::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "AudioParamMap", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "AudioParamMap", kOperationTable);
}
...
void V8AudioParamMap::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object, v8::Local<v8::Object> prototype_object, v8::Local<v8::Object> interface_object, v8::Local<v8::Template> interface_template, FeatureSelector feature_selector) {
  using bindings::IDLMemberInstaller;
