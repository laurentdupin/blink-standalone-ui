...
class MODULES_EXPORT V8GPUPrimitiveTopology final : public bindings::EnumerationBase {
...
static V8GPUPrimitiveTopology Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8GPUPrimitiveTopology> Create(const String& value);

explicit constexpr  V8GPUPrimitiveTopology(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8GPUPrimitiveTopology& lhs, V8GPUPrimitiveTopology::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8GPUPrimitiveTopology::Enum lhs, const V8GPUPrimitiveTopology& rhs) {
