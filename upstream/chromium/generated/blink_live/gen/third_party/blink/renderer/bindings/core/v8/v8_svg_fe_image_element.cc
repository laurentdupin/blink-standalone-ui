...
bool V8SVGFEImageElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<SVGFEImageElement, SVGElement>);
...
const WrapperTypeInfo V8SVGFEImageElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SVGFEImageElement::InstallInterfaceTemplate,
    nullptr,
    "SVGFEImageElement",
    V8SVGElement::GetWrapperTypeInfo(),
    V8SVGFEImageElement::kThisTag,
    V8SVGFEImageElement::kMaxSubclassTag,
...
const WrapperTypeInfo& SVGFEImageElement::wrapper_type_info_ =
    V8SVGFEImageElement::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, SVGFEImageElement>::value,
    "SVGFEImageElement inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_svg_fe_image_element {
...
BLINK_BINDINGS_TRACE_EVENT("SVGFEImageElement.preserveAspectRatio.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
SVGFEImageElement* blink_receiver = V8SVGFEImageElement::ToWrappableUnsafe(isolate, v8_receiver);
...
BLINK_BINDINGS_TRACE_EVENT("SVGFEImageElement.x.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFEImageElement.y.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFEImageElement.width.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFEImageElement.height.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFEImageElement.result.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFEImageElement.href.get");
v8::Isolate* isolate = info.GetIsolate();
...
using namespace v8_svg_fe_image_element;

}  // namespace 

void V8SVGFEImageElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SVGFEImageElement::GetWrapperTypeInfo();
...
void V8SVGFEImageElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGFEImageElement", kAttributeTable);
}
