...
static_assert(std::derived_from<SpeechSynthesisErrorEvent, SpeechSynthesisEvent>);
...
const WrapperTypeInfo& SpeechSynthesisErrorEvent::wrapper_type_info_ =
    V8SpeechSynthesisErrorEvent::wrapper_type_info_;
...
static_assert(bindings::IsReturnTypeCompatible<V8SpeechSynthesisErrorCode, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
static_assert(bindings::IsReturnTypeCompatible<SpeechSynthesisErrorEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
void V8SpeechSynthesisErrorEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SpeechSynthesisErrorEvent", kAttributeTable);
}
