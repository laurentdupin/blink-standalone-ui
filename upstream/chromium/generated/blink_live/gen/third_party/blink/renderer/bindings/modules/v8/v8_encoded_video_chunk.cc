...
bool V8EncodedVideoChunk::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8EncodedVideoChunk::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8EncodedVideoChunk::InstallInterfaceTemplate,
    nullptr,
    "EncodedVideoChunk",
    nullptr,
    V8EncodedVideoChunk::kThisTag,
    V8EncodedVideoChunk::kMaxSubclassTag,
...
const WrapperTypeInfo& EncodedVideoChunk::wrapper_type_info_ =
    V8EncodedVideoChunk::wrapper_type_info_;
...
namespace v8_encoded_video_chunk {
...
BLINK_BINDINGS_TRACE_EVENT("EncodedVideoChunk.type.get");
...
static_assert(bindings::IsReturnTypeCompatible<V8EncodedVideoChunkType, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
BLINK_BINDINGS_TRACE_EVENT("EncodedVideoChunk.timestamp.get");
...
BLINK_BINDINGS_TRACE_EVENT("EncodedVideoChunk.duration.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_EncodedVideoChunk_byteLength_Getter");
BLINK_BINDINGS_TRACE_EVENT("EncodedVideoChunk.byteLength.get");
...
BLINK_BINDINGS_TRACE_EVENT("EncodedVideoChunk.constructor");
...
auto&& arg1_init = NativeValueTraits<EncodedVideoChunkInit>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& return_value = EncodedVideoChunk::Create(script_state, arg1_init, exception_state);
static_assert(bindings::IsReturnTypeCompatible<EncodedVideoChunk, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8EncodedVideoChunk::GetWrapperTypeInfo(), v8_receiver);
bindings::V8SetReturnValue(info, v8_wrapper);
}

void CopyToOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_EncodedVideoChunk_copyTo");
BLINK_BINDINGS_TRACE_EVENT("EncodedVideoChunk.copyTo");
...
using namespace v8_encoded_video_chunk;

}  // namespace 

void V8EncodedVideoChunk::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8EncodedVideoChunk::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "EncodedVideoChunk"));
...
void V8EncodedVideoChunk::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "EncodedVideoChunk", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "EncodedVideoChunk", kOperationTable);
}
