...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CONTACT_ADDRESS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CONTACT_ADDRESS_H_
...
class MODULES_EXPORT V8ContactAddress final : public bindings::V8InterfaceBridge<V8ContactAddress, ContactAddress> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class ContactAddress;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CONTACT_ADDRESS_H_
