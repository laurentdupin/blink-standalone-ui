...
template <>
class MODULES_EXPORT SyncIterator<XRAnchorSet> final : public bindings::SyncIteratorBase {
...
explicit  SyncIterator<XRAnchorSet>(IterationSourceBase* source, Kind kind) : bindings::SyncIteratorBase(source, kind) {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1505);
