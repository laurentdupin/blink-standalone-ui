...
public:
    ...
    void deleteCache(crdtp::Dispatchable& dispatchable);
    void deleteEntry(crdtp::Dispatchable& dispatchable);
    void requestCacheNames(crdtp::Dispatchable& dispatchable);
    void requestCachedResponse(crdtp::Dispatchable& dispatchable);
    void requestEntries(crdtp::Dispatchable& dispatchable);
 protected:
    Backend* m_backend;
};
...
public:
    DeleteCacheCallbackImpl(std::unique_ptr<DomainDispatcher::WeakPtr> backendImpl, crdtp::Dispatchable& dispatchable)
        : DomainDispatcher::Callback(std::move(backendImpl), dispatchable, crdtp::SpanFrom("CacheStorage.deleteCache")) { }
...
void DomainDispatcherImpl::deleteCache(crdtp::Dispatchable& dispatchable)
{
    ...
    m_backend->deleteCache(params.cacheId, std::make_unique<DeleteCacheCallbackImpl>(weakPtr(), dispatchable));
}

class DeleteEntryCallbackImpl : public Backend::DeleteEntryCallback, public DomainDispatcher::Callback {
public:
    DeleteEntryCallbackImpl(std::unique_ptr<DomainDispatcher::WeakPtr> backendImpl, crdtp::Dispatchable& dispatchable)
        : DomainDispatcher::Callback(std::move(backendImpl), dispatchable, crdtp::SpanFrom("CacheStorage.deleteEntry")) { }
...
void DomainDispatcherImpl::deleteEntry(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
    ...
    m_backend->deleteEntry(params.cacheId, params.request, std::make_unique<DeleteEntryCallbackImpl>(weakPtr(), dispatchable));
}

class RequestCacheNamesCallbackImpl : public Backend::RequestCacheNamesCallback, public DomainDispatcher::Callback {
public:
    RequestCacheNamesCallbackImpl(std::unique_ptr<DomainDispatcher::WeakPtr> backendImpl, crdtp::Dispatchable& dispatchable)
        : DomainDispatcher::Callback(std::move(backendImpl), dispatchable, crdtp::SpanFrom("CacheStorage.requestCacheNames")) { }
...
void DomainDispatcherImpl::requestCacheNames(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
    ...
    m_backend->requestCacheNames(std::move(params.securityOrigin), std::move(params.storageKey), std::move(params.storageBucket), std::make_unique<RequestCacheNamesCallbackImpl>(weakPtr(), dispatchable));
}

class RequestCachedResponseCallbackImpl : public Backend::RequestCachedResponseCallback, public DomainDispatcher::Callback {
public:
    RequestCachedResponseCallbackImpl(std::unique_ptr<DomainDispatcher::WeakPtr> backendImpl, crdtp::Dispatchable& dispatchable)
        : DomainDispatcher::Callback(std::move(backendImpl), dispatchable, crdtp::SpanFrom("CacheStorage.requestCachedResponse")) { }
...
void DomainDispatcherImpl::requestCachedResponse(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
    ...
    m_backend->requestCachedResponse(params.cacheId, params.requestURL, std::move(params.requestHeaders), std::make_unique<RequestCachedResponseCallbackImpl>(weakPtr(), dispatchable));
}

class RequestEntriesCallbackImpl : public Backend::RequestEntriesCallback, public DomainDispatcher::Callback {
public:
    RequestEntriesCallbackImpl(std::unique_ptr<DomainDispatcher::WeakPtr> backendImpl, crdtp::Dispatchable& dispatchable)
        : DomainDispatcher::Callback(std::move(backendImpl), dispatchable, crdtp::SpanFrom("CacheStorage.requestEntries")) { }
...
void DomainDispatcherImpl::requestEntries(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
    ...
    m_backend->requestEntries(params.cacheId, std::move(params.skipCount), std::move(params.pageSize), std::move(params.pathFilter), std::make_unique<RequestEntriesCallbackImpl>(weakPtr(), dispatchable));
}
