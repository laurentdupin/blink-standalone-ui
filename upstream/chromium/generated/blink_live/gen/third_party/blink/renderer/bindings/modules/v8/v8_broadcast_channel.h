...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BROADCAST_CHANNEL_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BROADCAST_CHANNEL_H_
...
class MODULES_EXPORT V8BroadcastChannel final : public bindings::V8InterfaceBridge<V8BroadcastChannel, BroadcastChannel> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(535);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BROADCAST_CHANNEL_H_
