...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BACKGROUND_FETCH_RECORD_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BACKGROUND_FETCH_RECORD_H_
...
class MODULES_EXPORT V8BackgroundFetchRecord final : public bindings::V8InterfaceBridge<V8BackgroundFetchRecord, BackgroundFetchRecord> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1086);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class BackgroundFetchRecord;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BACKGROUND_FETCH_RECORD_H_
