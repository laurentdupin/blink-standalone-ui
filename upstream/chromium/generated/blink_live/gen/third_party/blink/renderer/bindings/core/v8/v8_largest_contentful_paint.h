...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_LARGEST_CONTENTFUL_PAINT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_LARGEST_CONTENTFUL_PAINT_H_
...
class CORE_EXPORT V8LargestContentfulPaint final : public bindings::V8InterfaceBridge<V8LargestContentfulPaint, LargestContentfulPaint> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(996);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_LARGEST_CONTENTFUL_PAINT_H_
