...
bool V8AudioEncoder::IsExposed(ExecutionContext* execution_context) {
  
const bool is_in_secure_context = execution_context->IsSecureContext();
return is_in_secure_context && (execution_context->IsWindow() || execution_context->IsDedicatedWorkerGlobalScope());
}

static_assert(std::derived_from<AudioEncoder, EventTarget>);
...
const WrapperTypeInfo V8AudioEncoder::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8AudioEncoder::InstallInterfaceTemplate,
    nullptr,
    "AudioEncoder",
    V8EventTarget::GetWrapperTypeInfo(),
    V8AudioEncoder::kThisTag,
    V8AudioEncoder::kMaxSubclassTag,
...
const WrapperTypeInfo& AudioEncoder::wrapper_type_info_ =
    V8AudioEncoder::wrapper_type_info_;
...
namespace v8_audio_encoder {


void EncodeQueueSizeAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_AudioEncoder_encodeQueueSize_Getter");
BLINK_BINDINGS_TRACE_EVENT("AudioEncoder.encodeQueueSize.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_AudioEncoder_ondequeue_Getter");
BLINK_BINDINGS_TRACE_EVENT("AudioEncoder.ondequeue.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_AudioEncoder_ondequeue_Setter");
BLINK_BINDINGS_TRACE_EVENT("AudioEncoder.ondequeue.set");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_AudioEncoder_state_Getter");
BLINK_BINDINGS_TRACE_EVENT("AudioEncoder.state.get");
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_AudioEncoder_constructor");
BLINK_BINDINGS_TRACE_EVENT("AudioEncoder.constructor");
...
// [Measure], [MeasureAs]
UseCounter::Count(current_execution_context, WebFeature::kWebCodecsAudioEncoder);
...
auto&& arg1_init = NativeValueTraits<AudioEncoderInit>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& return_value = AudioEncoder::Create(script_state, arg1_init, exception_state);
static_assert(bindings::IsReturnTypeCompatible<AudioEncoder, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8AudioEncoder::GetWrapperTypeInfo(), v8_receiver);
bindings::V8SetReturnValue(info, v8_wrapper);
}

void CloseOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_AudioEncoder_close");
BLINK_BINDINGS_TRACE_EVENT("AudioEncoder.close");
...
void ConfigureOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_AudioEncoder_configure");
BLINK_BINDINGS_TRACE_EVENT("AudioEncoder.configure");
...
void EncodeOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_AudioEncoder_encode");
BLINK_BINDINGS_TRACE_EVENT("AudioEncoder.encode");
...
blink_receiver->encode(arg1_data, exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
void FlushOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_AudioEncoder_flush");
BLINK_BINDINGS_TRACE_EVENT("AudioEncoder.flush");
// Promise returning function: Convert a TypeError to a reject promise.
ExceptionToRejectPromiseScope reject_promise_scope(info);

v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
if (!V8AudioEncoder::HasInstance(isolate, v8_receiver)) {
...
void ResetOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_AudioEncoder_reset");
BLINK_BINDINGS_TRACE_EVENT("AudioEncoder.reset");
...
void IsConfigSupportedStaticOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_AudioEncoder_isConfigSupported");
BLINK_BINDINGS_TRACE_EVENT("AudioEncoder.isConfigSupported");
// Promise returning function: Convert a TypeError to a reject promise.
ExceptionToRejectPromiseScope reject_promise_scope(info);
...
auto&& return_value = AudioEncoder::isConfigSupported(script_state, arg1_config, exception_state);
static_assert(bindings::IsReturnTypeCompatible<IDLPromise<AudioEncoderSupport>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
bindings::V8SetReturnValue(info, return_value);
...
using namespace v8_audio_encoder;

}  // namespace 

void V8AudioEncoder::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8AudioEncoder::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "AudioEncoder"));
...
void V8AudioEncoder::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "AudioEncoder", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "AudioEncoder", kOperationTable);
}
