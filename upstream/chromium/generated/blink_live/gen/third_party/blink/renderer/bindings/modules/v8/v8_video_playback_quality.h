...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_VIDEO_PLAYBACK_QUALITY_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_VIDEO_PLAYBACK_QUALITY_H_
...
class MODULES_EXPORT V8VideoPlaybackQuality final : public bindings::V8InterfaceBridge<V8VideoPlaybackQuality, VideoPlaybackQuality> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1196);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_VIDEO_PLAYBACK_QUALITY_H_
