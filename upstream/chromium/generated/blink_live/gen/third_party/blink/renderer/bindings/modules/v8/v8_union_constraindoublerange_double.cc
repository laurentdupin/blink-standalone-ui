...
V8UnionConstrainDoubleRangeOrDouble* V8UnionConstrainDoubleRangeOrDouble::Create(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state) {
  if (v8_value->IsNullOrUndefined()) {
  auto&& blink_value = ConstrainDoubleRange::Create(isolate);
return MakeGarbageCollected<V8UnionConstrainDoubleRangeOrDouble>(blink_value);
}
...
v8::Local<v8::Value> V8UnionConstrainDoubleRangeOrDouble::DirectToV8(ScriptState* script_state, ConstrainDoubleRange* value) {
  return ToV8Traits<ConstrainDoubleRange>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionConstrainDoubleRangeOrDouble::DirectToV8(ScriptState* script_state, double value) {
...
void V8UnionConstrainDoubleRangeOrDouble::Clear() {
