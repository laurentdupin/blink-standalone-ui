...
using Ret = bindings::OptimizedReturnProxy<V8UnionConstrainPoint2DParametersOrPoint2DSequence>;
v8::Local<v8::Value> ToV8(ScriptState* script_state) const;

static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, ConstrainPoint2DParameters* value);
static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, const HeapVector<Member<Point2D>>& value);
