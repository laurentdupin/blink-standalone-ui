...
return dictionary;
 ...
 RTCRtpSynchronizationSource::RTCRtpSynchronizationSource(v8::Isolate* isolate) : RTCRtpContributingSource(isolate) {
...
void RTCRtpSynchronizationSource::FillTemplateProperties(Vector<std::string_view>& properties) const {
