...
bool V8MediaQueryListEvent::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<MediaQueryListEvent, Event>);
...
const WrapperTypeInfo V8MediaQueryListEvent::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8MediaQueryListEvent::InstallInterfaceTemplate,
    nullptr,
    "MediaQueryListEvent",
    V8Event::GetWrapperTypeInfo(),
    V8MediaQueryListEvent::kThisTag,
    V8MediaQueryListEvent::kMaxSubclassTag,
...
const WrapperTypeInfo& MediaQueryListEvent::wrapper_type_info_ =
    V8MediaQueryListEvent::wrapper_type_info_;
...
namespace v8_media_query_list_event {
...
BLINK_BINDINGS_TRACE_EVENT("MediaQueryListEvent.media.get");
...
BLINK_BINDINGS_TRACE_EVENT("MediaQueryListEvent.matches.get");
...
BLINK_BINDINGS_TRACE_EVENT("MediaQueryListEvent.isTrusted.get");
...
BLINK_BINDINGS_TRACE_EVENT("MediaQueryListEvent.constructor");
...
decltype(NativeValueTraits<MediaQueryListEventInit>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg2_event_init_dict;
if (info[1]->IsUndefined()) {
  arg2_event_init_dict = MediaQueryListEventInit::Create();
} else {
  arg2_event_init_dict = NativeValueTraits<MediaQueryListEventInit>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
}
auto&& return_value = MediaQueryListEvent::Create(arg1_type, arg2_event_init_dict);
static_assert(bindings::IsReturnTypeCompatible<MediaQueryListEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8MediaQueryListEvent::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_media_query_list_event;

}  // namespace 

void V8MediaQueryListEvent::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8MediaQueryListEvent::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "MediaQueryListEvent"));
...
void V8MediaQueryListEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"matches", MatchesAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "MediaQueryListEvent", kAttributeTable);
}
