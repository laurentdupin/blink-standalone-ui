...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CLIPBOARD_ITEM_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CLIPBOARD_ITEM_H_
...
class MODULES_EXPORT V8ClipboardItem final : public bindings::V8InterfaceBridge<V8ClipboardItem, ClipboardItem> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1113);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class ClipboardItem;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CLIPBOARD_ITEM_H_
