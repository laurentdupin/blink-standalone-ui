...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_LAYER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_LAYER_H_
...
class MODULES_EXPORT V8XRLayer final : public bindings::V8InterfaceBridge<V8XRLayer, XRLayer> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(818);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XRLayer;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_LAYER_H_
