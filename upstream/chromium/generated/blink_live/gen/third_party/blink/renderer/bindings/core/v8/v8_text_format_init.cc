...
if (!bindings::GetDictionaryMemberFromV8Object<V8UnderlineStyle, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[2].Get(isolate), has_underline_style_, member_underline_style_, class_like_name, exception_state)) {
  return;
}
dictionary_from_v8_context.SetCurrentPropertyName("underlineThickness");
if (!bindings::GetDictionaryMemberFromV8Object<V8UnderlineThickness, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[3].Get(isolate), has_underline_thickness_, member_underline_thickness_, class_like_name, exception_state)) {
  return;
}
}
