...
static_assert(std::derived_from<HTMLOutputElement, HTMLElement>);
...
const WrapperTypeInfo& HTMLOutputElement::wrapper_type_info_ =
    V8HTMLOutputElement::wrapper_type_info_;
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLOutputElement::GetWrapperTypeInfo(), ElementType::kHTMLOutputElement);
}
...
void V8HTMLOutputElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLOutputElement", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLOutputElement", kOperationTable);
}
