...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PUSH_SUBSCRIPTION_OPTIONS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PUSH_SUBSCRIPTION_OPTIONS_H_
...
class MODULES_EXPORT V8PushSubscriptionOptions final : public bindings::V8InterfaceBridge<V8PushSubscriptionOptions, PushSubscriptionOptions> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1240);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PushSubscriptionOptions;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PUSH_SUBSCRIPTION_OPTIONS_H_
