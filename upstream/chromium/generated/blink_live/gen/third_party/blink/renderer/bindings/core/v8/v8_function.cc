...
const char* V8Function::GetHumanReadableName() const {
  return "V8Function";
}

v8::Maybe<ScriptValue> V8Function::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<ScriptValue>& arg1_arguments) {
  const char* const class_like_name = "Function";
...
const size_t argc = 0 + arg1_arguments.size();
if (argc <= 10) {
...
v8::Maybe<ScriptValue> V8Function::Construct(const HeapVector<ScriptValue>& arg1_arguments) {
  const char* const class_like_name = "Function";
...
void V8Function::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<ScriptValue>& arg1_arguments) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = Invoke(arg0_receiver, arg1_arguments);
}

base::expected<ScriptValue, ScriptValue> V8Function::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<ScriptValue>& arg1_arguments) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_arguments);
