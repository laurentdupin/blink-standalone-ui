...
bool V8PaintSize::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8PaintSize::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8PaintSize::InstallInterfaceTemplate,
    nullptr,
    "PaintSize",
    nullptr,
    V8PaintSize::kThisTag,
    V8PaintSize::kMaxSubclassTag,
...
const WrapperTypeInfo& PaintSize::wrapper_type_info_ =
    V8PaintSize::wrapper_type_info_;
...
namespace v8_paint_size {


void WidthAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_PaintSize_width_Getter");
BLINK_BINDINGS_TRACE_EVENT("PaintSize.width.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_PaintSize_height_Getter");
BLINK_BINDINGS_TRACE_EVENT("PaintSize.height.get");
...
using namespace v8_paint_size;

}  // namespace 

void V8PaintSize::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8PaintSize::GetWrapperTypeInfo();
...
void V8PaintSize::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "PaintSize", kAttributeTable);
}
