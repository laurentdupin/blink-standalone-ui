...
class CORE_EXPORT V8SVGAnimateMotionElement final : public bindings::V8InterfaceBridge<V8SVGAnimateMotionElement, SVGAnimateMotionElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(679);
