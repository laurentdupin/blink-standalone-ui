...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MEDIA_KEY_STATUS_MAP_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MEDIA_KEY_STATUS_MAP_H_
...
class MODULES_EXPORT V8MediaKeyStatusMap final : public bindings::V8InterfaceBridge<V8MediaKeyStatusMap, MediaKeyStatusMap> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1145);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class MediaKeyStatusMap;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MEDIA_KEY_STATUS_MAP_H_
