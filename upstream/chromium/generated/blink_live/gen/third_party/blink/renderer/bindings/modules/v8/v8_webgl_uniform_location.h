...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_UNIFORM_LOCATION_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_UNIFORM_LOCATION_H_
...
class MODULES_EXPORT V8WebGLUniformLocation final : public bindings::V8InterfaceBridge<V8WebGLUniformLocation, WebGLUniformLocation> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1367);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_UNIFORM_LOCATION_H_
