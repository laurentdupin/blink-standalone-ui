...
// and input files:
//   .\third_party\blink\renderer\core\html\html_attribute_names.json5
...
const QualifiedName& LookupHTMLAttributeName(const UChar* data, unsigned length) {
  ...
  case 5:
    ...
    case 'w':
      switch (data[1]) {
      case 'a':
        if (memcmp(data + 2, u"tch", 2 * 3) == 0) {
          return html_names::kWatchAttr;
        }
        break;
      case 'i':
        if (memcmp(data + 2, u"dth", 2 * 3) == 0) {
  ...
  case 6:
    ...
    case 'f':
      ...
      case 'i':
        switch (data[2]) {
        case 'e':
          if (memcmp(data + 3, u"lds", 2 * 3) == 0) {
            return html_names::kFieldsAttr;
          }
          break;
        case 'l':
          if (memcmp(data + 3, u"ter", 2 * 3) == 0) {
            return html_names::kFilterAttr;
          }
          break;
        }
        break;
    ...
    case 'm':
      switch (data[1]) {
      case 'a':
        if (memcmp(data + 2, u"rker", 2 * 4) == 0) {
          return html_names::kMarkerAttr;
        }
        break;
      case 'e':
        if (memcmp(data + 2, u"thod", 2 * 4) == 0) {
    ...
    case 'p':
      switch (data[1]) {
      case 'a':
        if (memcmp(data + 2, u"rams", 2 * 4) == 0) {
          return html_names::kParamsAttr;
        }
        break;
      case 'o':
        switch (data[2]) {
    ...
    case 'p':
      ...
      case 'r':
        ...
        case 'e':
          switch (data[3]) {
          case 'c':
            if (memcmp(data + 4, u"ise", 2 * 3) == 0) {
              return html_names::kPreciseAttr;
            }
            break;
          case 'l':
            if (memcmp(data + 4, u"oad", 2 * 3) == 0) {
  ...
  case 8:
    ...
    case 'c':
      ...
      case 'l':
        switch (data[2]) {
        case 'i':
          if (memcmp(data + 3, u"entid", 2 * 5) == 0) {
            return html_names::kClientidAttr;
          }
          break;
        case 'o':
          if (memcmp(data + 3, u"sedby", 2 * 5) == 0) {
      ...
      case 'n':
        ...
        case 's':
          ...
          case 'e':
            ...
            break;
          case 't':
            if (memcmp(data + 4, u"ream", 2 * 4) == 0) {
              return html_names::kOnstreamAttr;
            }
            break;
          case 'u':
    ...
    case 't':
      switch (data[1]) {
      case 'a':
        if (memcmp(data + 2, u"bindex", 2 * 6) == 0) {
          return html_names::kTabindexAttr;
        }
        break;
      case 'o':
        if (memcmp(data + 2, u"olname", 2 * 6) == 0) {
          return html_names::kToolnameAttr;
        }
        break;
      }
      break;
  ...
  case 9:
    ...
    case 'c':
      switch (data[1]) {
      case 'a':
        if (memcmp(data + 2, u"chehint", 2 * 7) == 0) {
          return html_names::kCachehintAttr;
        }
        break;
      case 'h':
        switch (data[2]) {
        case 'a':
          if (memcmp(data + 3, u"llenge", 2 * 6) == 0) {
            return html_names::kChallengeAttr;
          }
          break;
        case 'e':
          if (memcmp(data + 3, u"ckable", 2 * 6) == 0) {
            return html_names::kCheckableAttr;
          }
          break;
        }
        break;
      case 'o':
        if (memcmp(data + 2, u"nfigurl", 2 * 7) == 0) {
          return html_names::kConfigurlAttr;
        }
        break;
      }
      break;
    ...
    case 'i':
      ...
      break;
    case 'l':
      if (memcmp(data + 1, u"oginhint", 2 * 8) == 0) {
        return html_names::kLoginhintAttr;
      }
      break;
    case 'm':
      switch (data[1]) {
    ...
    case 'o':
      ...
      case 'n':
        ...
        case 'c':
          switch (data[3]) {
          case 'a':
            if (memcmp(data + 4, u"nplay", 2 * 5) == 0) {
              return html_names::kOncanplayAttr;
            }
            break;
          case 'o':
            if (memcmp(data + 4, u"mmand", 2 * 5) == 0) {
              return html_names::kOncommandAttr;
            }
            break;
          }
          break;
    ...
    case 's':
      switch (data[1]) {
      case 'c':
        if (memcmp(data + 2, u"rolling", 2 * 7) == 0) {
          return html_names::kScrollingAttr;
        }
        break;
      case 'i':
        if (memcmp(data + 2, u"gnature", 2 * 7) == 0) {
          return html_names::kSignatureAttr;
        }
        break;
      case 'p':
        if (memcmp(data + 2, u"ecifier", 2 * 7) == 0) {
          return html_names::kSpecifierAttr;
        }
        break;
      }
      break;
  ...
  case 10:
    switch (data[0]) {
    case 'a':
      if (memcmp(data + 1, u"utolocate", 2 * 9) == 0) {
        return html_names::kAutolocateAttr;
      }
      break;
    case 'b':
    ...
    case 'c':
      ...
      break;
    case 'd':
      if (memcmp(data + 1, u"omainhint", 2 * 9) == 0) {
        return html_names::kDomainhintAttr;
      }
      break;
    case 'f':
      switch (data[1]) {
    ...
    case 'i':
      switch (data[1]) {
      case 'm':
        if (memcmp(data + 2, u"agesizes", 2 * 8) == 0) {
          return html_names::kImagesizesAttr;
        }
        break;
      case 'n':
        if (memcmp(data + 2, u"stallurl", 2 * 8) == 0) {
          return html_names::kInstallurlAttr;
        }
        break;
      }
      break;
    case 'l':
      ...
      break;
    case 'm':
      if (memcmp(data + 1, u"anifestid", 2 * 9) == 0) {
        return html_names::kManifestidAttr;
      }
      break;
    case 'n':
      ...
      case 'n':
        ...
        case 'a':
          ...
          case 'u':
            switch (data[4]) {
            case 't':
              if (memcmp(data + 5, u"ofill", 2 * 5) == 0) {
                return html_names::kOnautofillAttr;
              }
              break;
            case 'x':
              if (memcmp(data + 5, u"click", 2 * 5) == 0) {
        ...
        case 'k':
          ...
          break;
        case 'l':
          if (memcmp(data + 3, u"ocation", 2 * 7) == 0) {
            return html_names::kOnlocationAttr;
          }
          break;
        case 'm':
  ...
  case 11:
    ...
    case 'i':
      ...
      case 'n':
        switch (data[2]) {
        case 'c':
          if (memcmp(data + 3, u"remental", 2 * 8) == 0) {
            return html_names::kIncrementalAttr;
          }
          break;
        case 't':
          if (memcmp(data + 3, u"erestfor", 2 * 8) == 0) {
            return html_names::kInterestforAttr;
          }
          break;
        }
        break;
  ...
  case 12:
    ...
    case 'a':
      switch (data[1]) {
      case 'c':
        if (memcmp(data + 2, u"curacymode", 2 * 10) == 0) {
          return html_names::kAccuracymodeAttr;
        }
        break;
      case 'u':
        if (memcmp(data + 2, u"tocomplete", 2 * 10) == 0) {
    ...
    case 'e':
      ...
      break;
    case 'h':
      if (memcmp(data + 1, u"eadingreset", 2 * 11) == 0) {
        return html_names::kHeadingresetAttr;
      }
      break;
    case 'm':
  ...
  case 13:
    ...
    case 'h':
      switch (data[1]) {
      case 'e':
        if (memcmp(data + 2, u"adingoffset", 2 * 11) == 0) {
          return html_names::kHeadingoffsetAttr;
        }
        break;
      case 'r':
        if (memcmp(data + 2, u"eftranslate", 2 * 11) == 0) {
      ...
      break;
    case 'l':
      if (memcmp(data + 1, u"ayoutsubtree", 2 * 12) == 0) {
        return html_names::kLayoutsubtreeAttr;
      }
      break;
    case 'o':
      switch (data[1]) {
  ...
  case 14:
    ...
    case 'd':
      ...
      case 'e':
        switch (data[2]) {
        case 'f':
          if (memcmp(data + 3, u"aultchecked", 2 * 11) == 0) {
            return html_names::kDefaultcheckedAttr;
          }
          break;
        case 'l':
          if (memcmp(data + 3, u"egatesfocus", 2 * 11) == 0) {
      ...
      case 'n':
              ...
              case 'o':
                ...
                case 'r':
                  ...
                  case 'e':
                    switch (data[8]) {
                    case 'f':
                      if (memcmp(data + 9, u"ilter", 2 * 5) == 0) {
                        return html_names::kOnbeforefilterAttr;
                      }
                      break;
                    case 't':
        ...
        case 'p':
          ...
          case 'o':
            ...
            break;
          case 'r':
            if (memcmp(data + 4, u"omptaction", 2 * 10) == 0) {
              return html_names::kOnpromptactionAttr;
            }
            break;
          }
          break;
        ...
        break;
      case 'v':
        if (memcmp(data + 2, u"erscrollarea", 2 * 12) == 0) {
          return html_names::kOverscrollareaAttr;
        }
        break;
      }
      break;
    ...
    case 's':
      ...
      break;
    case 't':
      if (memcmp(data + 1, u"oolautosubmit", 2 * 13) == 0) {
        return html_names::kToolautosubmitAttr;
      }
      break;
    }
    break;
  case 15:
    ...
    case 'c':
      ...
      case 'o':
        ...
        case 'n':
          ...
          case 't':
            switch (data[4]) {
            case 'a':
              if (memcmp(data + 5, u"inertiming", 2 * 10) == 0) {
                return html_names::kContainertimingAttr;
              }
              break;
            case 'e':
              if (memcmp(data + 5, u"nteditable", 2 * 10) == 0) {
      ...
      break;
    case 'f':
      if (memcmp(data + 1, u"ocusgroupstart", 2 * 14) == 0) {
        return html_names::kFocusgroupstartAttr;
      }
      break;
    case 'o':
      switch (data[1]) {
      case 'n':
        ...
        case 'p':
          switch (data[3]) {
          case 'o':
            if (memcmp(data + 4, u"intercancel", 2 * 11) == 0) {
              return html_names::kOnpointercancelAttr;
            }
            break;
          case 'r':
            if (memcmp(data + 4, u"omptdismiss", 2 * 11) == 0) {
              return html_names::kOnpromptdismissAttr;
            }
            break;
          }
          break;
    ...
    case 'p':
      ...
      break;
    case 't':
      if (memcmp(data + 1, u"ooldescription", 2 * 14) == 0) {
        return html_names::kTooldescriptionAttr;
      }
      break;
    case 'w':
  ...
  case 17:
    ...
    case 'o':
      ...
      case 'n':
        switch (data[2]) {
        case 'a':
          if (memcmp(data + 3, u"nimationcancel", 2 * 14) == 0) {
            return html_names::kOnanimationcancelAttr;
          }
          break;
        case 'c':
  ...
  case 19:
    ...
    case 'o':
      ...
      case 'n':
        ...
        break;
      case 'v':
        if (memcmp(data + 2, u"erscrollcontainer", 2 * 17) == 0) {
          return html_names::kOverscrollcontainerAttr;
        }
        break;
      }
      break;
  ...
  case 20:
    ...
    case 'o':
      ...
      break;
    case 't':
      if (memcmp(data + 1, u"oolparamdescription", 2 * 19) == 0) {
        return html_names::kToolparamdescriptionAttr;
      }
      break;
    }
    break;
  case 21:
    switch (data[0]) {
    case 'c':
      if (memcmp(data + 1, u"ustomelementregistry", 2 * 20) == 0) {
        return html_names::kCustomelementregistryAttr;
      }
      break;
    case 'd':
  ...
  case 22:
    switch (data[0]) {
    case 'c':
      if (memcmp(data + 1, u"ontainertiming-ignore", 2 * 21) == 0) {
        return html_names::kContainertimingIgnoreAttr;
      }
      break;
    case 'o':
  ...
  case 28:
    switch (data[0]) {
    case 's':
      if (memcmp(data + 1, u"hadowrootadoptedstylesheets", 2 * 27) == 0) {
        return html_names::kShadowrootadoptedstylesheetsAttr;
      }
      break;
    }
    break;
  case 31:
    switch (data[0]) {
    case 's':
      if (memcmp(data + 1, u"hadowrootcustomelementregistry", 2 * 30) == 0) {
        return html_names::kShadowrootcustomelementregistryAttr;
      }
      break;
    }
    break;
...
const QualifiedName& LookupHTMLAttributeName(const LChar* data, unsigned length) {
  ...
  case 5:
    ...
    case 'w':
      switch (data[1]) {
      case 'a':
        if (memcmp(data + 2, "tch", 3) == 0) {
          return html_names::kWatchAttr;
        }
        break;
      case 'i':
        if (memcmp(data + 2, "dth", 3) == 0) {
          return html_names::kWidthAttr;
        }
        break;
      }
  ...
  case 6:
    ...
    case 'm':
      switch (data[1]) {
      case 'a':
        if (memcmp(data + 2, "rker", 4) == 0) {
          return html_names::kMarkerAttr;
        }
        break;
      case 'e':
        if (memcmp(data + 2, "thod", 4) == 0) {
          return html_names::kMethodAttr;
        }
        break;
      }
    ...
    case 'p':
      ...
      case 'r':
        ...
        case 'e':
          switch (data[3]) {
          case 'c':
            if (memcmp(data + 4, "ise", 3) == 0) {
              return html_names::kPreciseAttr;
            }
            break;
          case 'l':
            if (memcmp(data + 4, "oad", 3) == 0) {
              return html_names::kPreloadAttr;
            }
            break;
          }
  ...
  case 8:
    ...
    case 'c':
      ...
      case 'l':
        switch (data[2]) {
        case 'i':
          if (memcmp(data + 3, "entid", 5) == 0) {
            return html_names::kClientidAttr;
          }
          break;
        case 'o':
          if (memcmp(data + 3, "sedby", 5) == 0) {
            return html_names::kClosedbyAttr;
          }
          break;
        }
    ...
    case 't':
      switch (data[1]) {
      case 'a':
        if (memcmp(data + 2, "bindex", 6) == 0) {
          return html_names::kTabindexAttr;
        }
        break;
      case 'o':
        if (memcmp(data + 2, "olname", 6) == 0) {
          return html_names::kToolnameAttr;
        }
        break;
      }
  ...
  case 9:
    ...
    case 'c':
      ...
      case 'h':
        switch (data[2]) {
        case 'a':
          if (memcmp(data + 3, "llenge", 6) == 0) {
            return html_names::kChallengeAttr;
          }
          break;
        case 'e':
          if (memcmp(data + 3, "ckable", 6) == 0) {
            return html_names::kCheckableAttr;
          }
          break;
        }
    ...
    case 'o':
      ...
      case 'n':
        ...
        case 'c':
          switch (data[3]) {
          case 'a':
            if (memcmp(data + 4, "nplay", 5) == 0) {
              return html_names::kOncanplayAttr;
            }
            break;
          case 'o':
            if (memcmp(data + 4, "mmand", 5) == 0) {
              return html_names::kOncommandAttr;
            }
            break;
          }
    ...
    case 's':
      switch (data[1]) {
      case 'c':
        if (memcmp(data + 2, "rolling", 7) == 0) {
          return html_names::kScrollingAttr;
        }
        break;
      case 'i':
        if (memcmp(data + 2, "gnature", 7) == 0) {
          return html_names::kSignatureAttr;
        }
        break;
      case 'p':
        if (memcmp(data + 2, "ecifier", 7) == 0) {
          return html_names::kSpecifierAttr;
        }
        break;
      }
  ...
  case 10:
    switch (data[0]) {
    case 'a':
      if (memcmp(data + 1, "utolocate", 9) == 0) {
        return html_names::kAutolocateAttr;
      }
      break;
    case 'b':
    ...
    case 'c':
      ...
      break;
    case 'd':
      if (memcmp(data + 1, "omainhint", 9) == 0) {
        return html_names::kDomainhintAttr;
      }
      break;
    case 'f':
    ...
    case 'i':
      switch (data[1]) {
      case 'm':
        if (memcmp(data + 2, "agesizes", 8) == 0) {
          return html_names::kImagesizesAttr;
        }
        break;
      case 'n':
        if (memcmp(data + 2, "stallurl", 8) == 0) {
          return html_names::kInstallurlAttr;
        }
        break;
      }
    ...
    case 'l':
      ...
      break;
    case 'm':
      if (memcmp(data + 1, "anifestid", 9) == 0) {
        return html_names::kManifestidAttr;
      }
      break;
    case 'n':
      ...
      case 'n':
        ...
        case 'a':
          ...
          case 'u':
            switch (data[4]) {
            case 't':
              if (memcmp(data + 5, "ofill", 5) == 0) {
                return html_names::kOnautofillAttr;
              }
              break;
            case 'x':
              if (memcmp(data + 5, "click", 5) == 0) {
                return html_names::kOnauxclickAttr;
              }
              break;
            }
  ...
  case 11:
    ...
    case 'i':
      ...
      case 'n':
        switch (data[2]) {
        case 'c':
          if (memcmp(data + 3, "remental", 8) == 0) {
            return html_names::kIncrementalAttr;
          }
          break;
        case 't':
          if (memcmp(data + 3, "erestfor", 8) == 0) {
            return html_names::kInterestforAttr;
          }
          break;
        }
  ...
  case 12:
    ...
    case 'a':
      switch (data[1]) {
      case 'c':
        if (memcmp(data + 2, "curacymode", 10) == 0) {
          return html_names::kAccuracymodeAttr;
        }
        break;
      case 'u':
        if (memcmp(data + 2, "tocomplete", 10) == 0) {
          return html_names::kAutocompleteAttr;
        }
        break;
      }
    ...
    case 'e':
      ...
      break;
    case 'h':
      if (memcmp(data + 1, "eadingreset", 11) == 0) {
        return html_names::kHeadingresetAttr;
      }
      break;
    case 'm':
  ...
  case 13:
    ...
    case 'h':
      switch (data[1]) {
      case 'e':
        if (memcmp(data + 2, "adingoffset", 11) == 0) {
          return html_names::kHeadingoffsetAttr;
        }
        break;
      case 'r':
        if (memcmp(data + 2, "eftranslate", 11) == 0) {
          return html_names::kHreftranslateAttr;
        }
        break;
      }
      break;
    case 'l':
      if (memcmp(data + 1, "ayoutsubtree", 12) == 0) {
        return html_names::kLayoutsubtreeAttr;
      }
      break;
    case 'o':
  ...
  case 14:
    ...
    case 'd':
      ...
      case 'e':
        switch (data[2]) {
        case 'f':
          if (memcmp(data + 3, "aultchecked", 11) == 0) {
            return html_names::kDefaultcheckedAttr;
          }
          break;
        case 'l':
          if (memcmp(data + 3, "egatesfocus", 11) == 0) {
            return html_names::kDelegatesfocusAttr;
          }
          break;
        }
      ...
      case 'n':
        ...
        case 'p':
          ...
          case 'o':
            ...
            break;
          case 'r':
            if (memcmp(data + 4, "omptaction", 10) == 0) {
              return html_names::kOnpromptactionAttr;
            }
            break;
          }
        ...
        break;
      case 'v':
        if (memcmp(data + 2, "erscrollarea", 12) == 0) {
          return html_names::kOverscrollareaAttr;
        }
        break;
      }
    ...
    case 's':
      ...
      break;
    case 't':
      if (memcmp(data + 1, "oolautosubmit", 13) == 0) {
        return html_names::kToolautosubmitAttr;
      }
      break;
    }
  ...
  case 15:
    ...
    case 'c':
      ...
      case 'o':
        ...
        case 'n':
          ...
          case 't':
            switch (data[4]) {
            case 'a':
              if (memcmp(data + 5, "inertiming", 10) == 0) {
                return html_names::kContainertimingAttr;
              }
              break;
            case 'e':
              if (memcmp(data + 5, "nteditable", 10) == 0) {
                return html_names::kContenteditableAttr;
              }
              break;
            }
      ...
      break;
    case 'f':
      if (memcmp(data + 1, "ocusgroupstart", 14) == 0) {
        return html_names::kFocusgroupstartAttr;
      }
      break;
    case 'o':
      ...
      case 'n':
        ...
        case 'p':
          switch (data[3]) {
          case 'o':
            if (memcmp(data + 4, "intercancel", 11) == 0) {
              return html_names::kOnpointercancelAttr;
            }
            break;
          case 'r':
            if (memcmp(data + 4, "omptdismiss", 11) == 0) {
              return html_names::kOnpromptdismissAttr;
            }
            break;
          }
    ...
    case 'p':
      ...
      break;
    case 't':
      if (memcmp(data + 1, "ooldescription", 14) == 0) {
        return html_names::kTooldescriptionAttr;
      }
      break;
    case 'w':
  ...
  case 17:
    ...
    case 'o':
      ...
      case 'n':
        switch (data[2]) {
        case 'a':
          if (memcmp(data + 3, "nimationcancel", 14) == 0) {
            return html_names::kOnanimationcancelAttr;
          }
          break;
        case 'c':
  ...
  case 19:
    ...
    case 'o':
      ...
      case 'n':
        ...
        break;
      case 'v':
        if (memcmp(data + 2, "erscrollcontainer", 17) == 0) {
          return html_names::kOverscrollcontainerAttr;
        }
        break;
      }
  ...
  case 20:
    ...
    case 'o':
      ...
      break;
    case 't':
      if (memcmp(data + 1, "oolparamdescription", 19) == 0) {
        return html_names::kToolparamdescriptionAttr;
      }
      break;
    }
  ...
  case 21:
    switch (data[0]) {
    case 'c':
      if (memcmp(data + 1, "ustomelementregistry", 20) == 0) {
        return html_names::kCustomelementregistryAttr;
      }
      break;
    case 'd':
  ...
  case 22:
    switch (data[0]) {
    case 'c':
      if (memcmp(data + 1, "ontainertiming-ignore", 21) == 0) {
        return html_names::kContainertimingIgnoreAttr;
      }
      break;
    case 'o':
  ...
  case 28:
    switch (data[0]) {
    case 's':
      if (memcmp(data + 1, "hadowrootadoptedstylesheets", 27) == 0) {
        return html_names::kShadowrootadoptedstylesheetsAttr;
      }
      break;
    }
  ...
  case 31:
    switch (data[0]) {
    case 's':
      if (memcmp(data + 1, "hadowrootcustomelementregistry", 30) == 0) {
        return html_names::kShadowrootcustomelementregistryAttr;
      }
      break;
    }
