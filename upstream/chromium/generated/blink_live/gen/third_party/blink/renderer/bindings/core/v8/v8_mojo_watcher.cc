...
bool V8MojoWatcher::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8MojoWatcher::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8MojoWatcher::InstallInterfaceTemplate,
    nullptr,
    "MojoWatcher",
    nullptr,
    V8MojoWatcher::kThisTag,
    V8MojoWatcher::kMaxSubclassTag,
...
const WrapperTypeInfo& MojoWatcher::wrapper_type_info_ =
    V8MojoWatcher::wrapper_type_info_;
...
BLINK_BINDINGS_TRACE_EVENT("MojoWatcher.cancel");
...
using namespace v8_mojo_watcher;

}  // namespace 

void V8MojoWatcher::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8MojoWatcher::GetWrapperTypeInfo();
...
void V8MojoWatcher::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "MojoWatcher", kOperationTable);
}
