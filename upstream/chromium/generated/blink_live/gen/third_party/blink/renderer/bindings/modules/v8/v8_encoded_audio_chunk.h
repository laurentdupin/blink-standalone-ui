...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ENCODED_AUDIO_CHUNK_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ENCODED_AUDIO_CHUNK_H_
...
class MODULES_EXPORT V8EncodedAudioChunk final : public bindings::V8InterfaceBridge<V8EncodedAudioChunk, EncodedAudioChunk> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1283);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class EncodedAudioChunk;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ENCODED_AUDIO_CHUNK_H_
