...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_SHADER_TEXTURE_LOD_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_SHADER_TEXTURE_LOD_H_
...
class MODULES_EXPORT V8EXTShaderTextureLOD final : public bindings::V8InterfaceBridge<V8EXTShaderTextureLOD, EXTShaderTextureLOD> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1304);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class EXTShaderTextureLOD;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_SHADER_TEXTURE_LOD_H_
