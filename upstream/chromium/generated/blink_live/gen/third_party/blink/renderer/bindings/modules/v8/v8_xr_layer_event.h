...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_LAYER_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_LAYER_EVENT_H_
...
class MODULES_EXPORT V8XRLayerEvent final : public bindings::V8InterfaceBridge<V8XRLayerEvent, XRLayerEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(491);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XRLayerEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_LAYER_EVENT_H_
