...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_BLUETOOTH_SERVICE_DATA_MAP_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_BLUETOOTH_SERVICE_DATA_MAP_H_
...
template <>
class MODULES_EXPORT SyncIterator<BluetoothServiceDataMap> final : public bindings::SyncIteratorBase {
...
explicit  SyncIterator<BluetoothServiceDataMap>(IterationSourceBase* source, Kind kind) : bindings::SyncIteratorBase(source, kind) {
...
class MODULES_EXPORT V8SyncIteratorBluetoothServiceDataMap final : public bindings::V8InterfaceBridge<V8SyncIteratorBluetoothServiceDataMap, SyncIterator<BluetoothServiceDataMap>> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1496);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SyncIterator<BluetoothServiceDataMap>;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_BLUETOOTH_SERVICE_DATA_MAP_H_
