...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CAPTURED_MOUSE_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CAPTURED_MOUSE_EVENT_H_
...
class CapturedMouseEvent;
class ExecutionContext;
struct WrapperTypeInfo;

class MODULES_EXPORT V8CapturedMouseEvent final : public bindings::V8InterfaceBridge<V8CapturedMouseEvent, CapturedMouseEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(383);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CapturedMouseEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CAPTURED_MOUSE_EVENT_H_
