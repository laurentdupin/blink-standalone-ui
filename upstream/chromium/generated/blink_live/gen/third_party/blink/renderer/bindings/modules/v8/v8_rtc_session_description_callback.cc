...
const char* V8RTCSessionDescriptionCallback::GetHumanReadableName() const {
  return "V8RTCSessionDescriptionCallback";
}

v8::Maybe<void> V8RTCSessionDescriptionCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const RTCSessionDescriptionInit* arg1_description) {
  const char* const class_like_name = "RTCSessionDescriptionCallback";
...
v8::Maybe<void> V8RTCSessionDescriptionCallback::Construct(const RTCSessionDescriptionInit* arg1_description) {
  const char* const class_like_name = "RTCSessionDescriptionCallback";
...
void V8RTCSessionDescriptionCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const RTCSessionDescriptionInit* arg1_description) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = Invoke(arg0_receiver, arg1_description);
}

base::expected<void, ScriptValue> V8RTCSessionDescriptionCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const RTCSessionDescriptionInit* arg1_description) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_description);
