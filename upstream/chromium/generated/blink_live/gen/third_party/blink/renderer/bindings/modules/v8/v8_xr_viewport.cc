...
bool V8XRViewport::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8XRViewport::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8XRViewport::InstallInterfaceTemplate,
    nullptr,
    "XRViewport",
    nullptr,
    V8XRViewport::kThisTag,
    V8XRViewport::kMaxSubclassTag,
...
const WrapperTypeInfo& XRViewport::wrapper_type_info_ =
    V8XRViewport::wrapper_type_info_;
...
BLINK_BINDINGS_TRACE_EVENT("XRViewport.x.get");
...
BLINK_BINDINGS_TRACE_EVENT("XRViewport.y.get");
...
BLINK_BINDINGS_TRACE_EVENT("XRViewport.width.get");
...
BLINK_BINDINGS_TRACE_EVENT("XRViewport.height.get");
...
using namespace v8_xr_viewport;

}  // namespace 

void V8XRViewport::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8XRViewport::GetWrapperTypeInfo();
...
void V8XRViewport::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "XRViewport", kAttributeTable);
}
