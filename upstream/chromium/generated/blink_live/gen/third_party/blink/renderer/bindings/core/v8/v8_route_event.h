...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_ROUTE_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_ROUTE_EVENT_H_
...
class CORE_EXPORT V8RouteEvent final : public bindings::V8InterfaceBridge<V8RouteEvent, RouteEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(456);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class RouteEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_ROUTE_EVENT_H_
