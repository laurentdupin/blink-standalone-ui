...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_GARBAGE_COLLECTED_SCRIPT_WRAPPABLE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_GARBAGE_COLLECTED_SCRIPT_WRAPPABLE_H_
...
class  V8GarbageCollectedScriptWrappable final : public bindings::V8InterfaceBridge<V8GarbageCollectedScriptWrappable, GarbageCollectedScriptWrappable> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1052);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class GarbageCollectedScriptWrappable;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_GARBAGE_COLLECTED_SCRIPT_WRAPPABLE_H_
