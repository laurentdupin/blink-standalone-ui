...
const WrapperTypeInfo V8USBInTransferResult::wrapper_type_info_{
    ...
    "USBInTransferResult",
    nullptr,
    V8USBInTransferResult::kThisTag,
    V8USBInTransferResult::kMaxSubclassTag,
...
USBInTransferResult* blink_receiver = V8USBInTransferResult::ToWrappableUnsafe(isolate, v8_receiver);
...
interface_function_template->SetInterfaceName(V8String(isolate, "USBInTransferResult"));
...
void V8USBInTransferResult::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "USBInTransferResult", kAttributeTable);
}
