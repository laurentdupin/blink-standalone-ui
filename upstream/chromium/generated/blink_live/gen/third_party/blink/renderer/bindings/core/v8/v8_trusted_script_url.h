...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TRUSTED_SCRIPT_URL_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TRUSTED_SCRIPT_URL_H_
...
class CORE_EXPORT V8TrustedScriptURL final : public bindings::V8InterfaceBridge<V8TrustedScriptURL, TrustedScriptURL> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1023);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class TrustedScriptURL;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TRUSTED_SCRIPT_URL_H_
