...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_USB_ISOCHRONOUS_IN_TRANSFER_PACKET_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_USB_ISOCHRONOUS_IN_TRANSFER_PACKET_H_
...
class MODULES_EXPORT V8USBIsochronousInTransferPacket final : public bindings::V8InterfaceBridge<V8USBIsochronousInTransferPacket, USBIsochronousInTransferPacket> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1416);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class USBIsochronousInTransferPacket;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_USB_ISOCHRONOUS_IN_TRANSFER_PACKET_H_
