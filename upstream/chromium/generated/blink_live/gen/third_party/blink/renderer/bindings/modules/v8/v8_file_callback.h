...
explicit  V8FileCallback(v8::Local<v8::Object> callback_object) : CallbackInterfaceBase(callback_object) {
...
[[nodiscard]] v8::Maybe<void> handleEvent(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, File* arg1_file);
...
void InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, File* arg1_file);
