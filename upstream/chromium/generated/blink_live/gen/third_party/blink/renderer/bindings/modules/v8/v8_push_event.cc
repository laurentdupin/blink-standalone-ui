...
bool V8PushEvent::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsServiceWorkerGlobalScope() && RuntimeEnabledFeatures::PushMessagingEnabled();
}

static_assert(std::derived_from<PushEvent, ExtendableEvent>);
...
const WrapperTypeInfo V8PushEvent::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8PushEvent::InstallInterfaceTemplate,
    nullptr,
    "PushEvent",
    V8ExtendableEvent::GetWrapperTypeInfo(),
    V8PushEvent::kThisTag,
    V8PushEvent::kMaxSubclassTag,
...
const WrapperTypeInfo& PushEvent::wrapper_type_info_ =
    V8PushEvent::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, PushEvent>::value,
    "PushEvent inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_push_event {
...
BLINK_BINDINGS_TRACE_EVENT("PushEvent.data.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
PushEvent* blink_receiver = V8PushEvent::ToWrappableUnsafe(isolate, v8_receiver);
auto&& return_value = blink_receiver->data();
static_assert(bindings::IsReturnTypeCompatible<IDLNullable<PushMessageData>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
BLINK_BINDINGS_TRACE_EVENT("PushEvent.isTrusted.get");
...
BLINK_BINDINGS_TRACE_EVENT("PushEvent.constructor");
...
decltype(NativeValueTraits<PushEventInit>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg2_event_init_dict;
if (info[1]->IsUndefined()) {
  arg2_event_init_dict = PushEventInit::Create();
} else {
  arg2_event_init_dict = NativeValueTraits<PushEventInit>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
}
auto&& return_value = PushEvent::Create(arg1_type, arg2_event_init_dict, exception_state);
static_assert(bindings::IsReturnTypeCompatible<PushEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8PushEvent::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_push_event;

}  // namespace 

void V8PushEvent::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8PushEvent::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "PushEvent"));
...
void V8PushEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "PushEvent", kAttributeTable);
}
