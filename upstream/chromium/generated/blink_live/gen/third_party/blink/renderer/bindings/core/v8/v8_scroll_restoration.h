...
static V8ScrollRestoration Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8ScrollRestoration> Create(const String& value);

explicit constexpr  V8ScrollRestoration(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8ScrollRestoration& lhs, V8ScrollRestoration::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8ScrollRestoration::Enum lhs, const V8ScrollRestoration& rhs) {
