...
v8::Local<v8::Value> V8UnionBooleanOrConstrainDoubleRangeOrDouble::DirectToV8(ScriptState* script_state, bool value) {
  return ToV8Traits<IDLBoolean>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionBooleanOrConstrainDoubleRangeOrDouble::DirectToV8(ScriptState* script_state, ConstrainDoubleRange* value) {
  return ToV8Traits<ConstrainDoubleRange>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionBooleanOrConstrainDoubleRangeOrDouble::DirectToV8(ScriptState* script_state, double value) {
