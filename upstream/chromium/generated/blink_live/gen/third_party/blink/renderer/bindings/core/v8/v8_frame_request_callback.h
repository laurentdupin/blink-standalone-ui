...
explicit  V8FrameRequestCallback(v8::Local<v8::Object> callback_object) : CallbackFunctionWithTaskAttributionBase(callback_object) {
...
[[nodiscard]] base::expected<void, ScriptValue> InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, double arg1_high_res_time);
