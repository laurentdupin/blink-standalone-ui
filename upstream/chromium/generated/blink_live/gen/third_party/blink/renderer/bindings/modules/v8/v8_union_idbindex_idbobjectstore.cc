...
v8::Local<v8::Value> V8UnionIDBIndexOrIDBObjectStore::DirectToV8(ScriptState* script_state, IDBIndex* value) {
  return ToV8Traits<IDBIndex>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionIDBIndexOrIDBObjectStore::DirectToV8(ScriptState* script_state, IDBObjectStore* value) {
