...
class CORE_EXPORT V8PerformanceResourceTiming final : public bindings::V8InterfaceBridge<V8PerformanceResourceTiming, PerformanceResourceTiming> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1006);
  static constexpr v8::CppHeapPointerTag kMaxSubclassTag =
      static_cast<v8::CppHeapPointerTag>(1007);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PerformanceResourceTiming;
};
