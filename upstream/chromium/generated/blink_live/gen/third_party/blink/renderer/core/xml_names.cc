...
const QualifiedNameWithHash& kLangAttr = reinterpret_cast<QualifiedNameWithHash*>(&attr_storage)[0];
const QualifiedNameWithHash& kSpaceAttr = reinterpret_cast<QualifiedNameWithHash*>(&attr_storage)[1];
...
void Init() {
  ...
  new ((void*)&kNamespaceURI) AtomicString("http://www.w3.org/XML/1998/namespace");
