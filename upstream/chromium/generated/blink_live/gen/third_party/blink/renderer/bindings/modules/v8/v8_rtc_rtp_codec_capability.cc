...
return dictionary;
 ...
 RTCRtpCodecCapability::RTCRtpCodecCapability(v8::Isolate* isolate) : RTCRtpCodec(isolate) {
...
void RTCRtpCodecCapability::FillTemplateProperties(Vector<std::string_view>& properties) const {
