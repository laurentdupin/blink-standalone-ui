...
bool V8File::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow() || execution_context->IsWorkerGlobalScope();
}

static_assert(std::derived_from<File, Blob>);
...
const WrapperTypeInfo V8File::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8File::InstallInterfaceTemplate,
    nullptr,
    "File",
...
const WrapperTypeInfo& File::wrapper_type_info_ =
    V8File::wrapper_type_info_;
...
BLINK_BINDINGS_TRACE_EVENT("File.name.get");
...
BLINK_BINDINGS_TRACE_EVENT("File.lastModified.get");
...
void LastModifiedDateAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
...
void WebkitRelativePathAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
...
BLINK_BINDINGS_TRACE_EVENT("File.constructor");
...
auto&& arg2_file_name = NativeValueTraits<IDLUSVString>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
decltype(NativeValueTraits<FilePropertyBag>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg3_options;
if (info[2]->IsUndefined()) {
  arg3_options = FilePropertyBag::Create();
} else {
  arg3_options = NativeValueTraits<FilePropertyBag>::ArgumentValue(isolate, 2, info[2], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
}
auto&& return_value = File::Create(execution_context, std::move(arg1_file_bits), arg2_file_name, arg3_options);
static_assert(bindings::IsReturnTypeCompatible<File, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8File::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_file;

}  // namespace 

void V8File::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8File::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "File"));
...
void V8File::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"lastModifiedDate", LastModifiedDateAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
{"webkitRelativePath", WebkitRelativePathAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
};
v8::Local<v8::Signature> signature = v8::Local<v8::Signature>::Cast(interface_template);
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "File", kAttributeTable);
}
