...
class MODULES_EXPORT V8IDBOpenDBRequest final : public bindings::V8InterfaceBridge<V8IDBOpenDBRequest, IDBOpenDBRequest> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(553);
