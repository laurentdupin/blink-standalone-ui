...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TRUSTED_PARSER_OPTIONS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TRUSTED_PARSER_OPTIONS_H_
...
class CORE_EXPORT V8TrustedParserOptions final : public bindings::V8InterfaceBridge<V8TrustedParserOptions, TrustedParserOptions> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1021);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class TrustedParserOptions;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TRUSTED_PARSER_OPTIONS_H_
