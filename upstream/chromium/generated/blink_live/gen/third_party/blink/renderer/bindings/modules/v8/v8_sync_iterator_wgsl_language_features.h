...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_WGSL_LANGUAGE_FEATURES_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_WGSL_LANGUAGE_FEATURES_H_
...
template <>
class MODULES_EXPORT SyncIterator<WGSLLanguageFeatures> final : public bindings::SyncIteratorBase {
...
explicit  SyncIterator<WGSLLanguageFeatures>(IterationSourceBase* source, Kind kind) : bindings::SyncIteratorBase(source, kind) {
...
class MODULES_EXPORT V8SyncIteratorWGSLLanguageFeatures final : public bindings::V8InterfaceBridge<V8SyncIteratorWGSLLanguageFeatures, SyncIterator<WGSLLanguageFeatures>> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1502);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SyncIterator<WGSLLanguageFeatures>;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_WGSL_LANGUAGE_FEATURES_H_
