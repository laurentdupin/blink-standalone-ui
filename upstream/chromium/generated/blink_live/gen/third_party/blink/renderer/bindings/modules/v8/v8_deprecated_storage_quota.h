...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DEPRECATED_STORAGE_QUOTA_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DEPRECATED_STORAGE_QUOTA_H_
...
class MODULES_EXPORT V8DeprecatedStorageQuota final : public bindings::V8InterfaceBridge<V8DeprecatedStorageQuota, DeprecatedStorageQuota> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1241);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class DeprecatedStorageQuota;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DEPRECATED_STORAGE_QUOTA_H_
