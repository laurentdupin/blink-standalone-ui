...
class MODULES_EXPORT V8BluetoothCharacteristicProperties final : public bindings::V8InterfaceBridge<V8BluetoothCharacteristicProperties, BluetoothCharacteristicProperties> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1089);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class BluetoothCharacteristicProperties;
};
