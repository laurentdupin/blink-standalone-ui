...
bool V8BluetoothManufacturerDataMap::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8BluetoothManufacturerDataMap::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8BluetoothManufacturerDataMap::InstallInterfaceTemplate,
    V8BluetoothManufacturerDataMap::InstallContextDependentProperties,
    "BluetoothManufacturerDataMap",
    nullptr,
    V8BluetoothManufacturerDataMap::kThisTag,
    V8BluetoothManufacturerDataMap::kMaxSubclassTag,
...
const WrapperTypeInfo& BluetoothManufacturerDataMap::wrapper_type_info_ =
    V8BluetoothManufacturerDataMap::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, BluetoothManufacturerDataMap>::value,
    "BluetoothManufacturerDataMap inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_bluetooth_manufacturer_data_map {
...
BLINK_BINDINGS_TRACE_EVENT("BluetoothManufacturerDataMap.size.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
BluetoothManufacturerDataMap* blink_receiver = V8BluetoothManufacturerDataMap::ToWrappableUnsafe(isolate, v8_receiver);
...
void EntriesOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_BluetoothManufacturerDataMap_entries");
BLINK_BINDINGS_TRACE_EVENT("BluetoothManufacturerDataMap.entries");
...
static_assert(bindings::IsReturnTypeCompatible<SyncIterator<BluetoothManufacturerDataMap>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
BLINK_BINDINGS_TRACE_EVENT("BluetoothManufacturerDataMap.forEach");
...
BLINK_BINDINGS_TRACE_EVENT("BluetoothManufacturerDataMap.get");
...
ScriptState* script_state = receiver_script_state;
ExceptionState exception_state(isolate);
auto&& arg1_key = NativeValueTraits<IDLUnsignedShort>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
BLINK_BINDINGS_TRACE_EVENT("BluetoothManufacturerDataMap.has");
...
BLINK_BINDINGS_TRACE_EVENT("BluetoothManufacturerDataMap.keys");
...
BLINK_BINDINGS_TRACE_EVENT("BluetoothManufacturerDataMap.values");
...
using namespace v8_bluetooth_manufacturer_data_map;

}  // namespace 

void V8BluetoothManufacturerDataMap::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8BluetoothManufacturerDataMap::GetWrapperTypeInfo();
...
void V8BluetoothManufacturerDataMap::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "BluetoothManufacturerDataMap", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "BluetoothManufacturerDataMap", kOperationTable);
}
