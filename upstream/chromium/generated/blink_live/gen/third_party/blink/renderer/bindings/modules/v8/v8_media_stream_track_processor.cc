...
bool V8MediaStreamTrackProcessor::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8MediaStreamTrackProcessor::wrapper_type_info_{
    ...
    nullptr,
    V8MediaStreamTrackProcessor::kThisTag,
    V8MediaStreamTrackProcessor::kMaxSubclassTag,
...
const WrapperTypeInfo& MediaStreamTrackProcessor::wrapper_type_info_ =
    V8MediaStreamTrackProcessor::wrapper_type_info_;
...
static_assert(bindings::IsReturnTypeCompatible<MediaStreamTrackProcessor, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
v8::Local<v8::Object> v8_receiver = info.This();
...
interface_function_template->SetInterfaceName(V8String(isolate, "MediaStreamTrackProcessor"));
...
void V8MediaStreamTrackProcessor::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "MediaStreamTrackProcessor", kAttributeTable);
}
