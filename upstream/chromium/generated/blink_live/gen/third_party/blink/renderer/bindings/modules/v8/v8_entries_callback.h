...
explicit  V8EntriesCallback(v8::Local<v8::Object> callback_object) : CallbackInterfaceBase(callback_object) {
...
[[nodiscard]] v8::Maybe<void> handleEvent(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<Entry>>& arg1_entries);
...
void InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<Entry>>& arg1_entries);
