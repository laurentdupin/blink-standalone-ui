...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WGSL_LANGUAGE_FEATURES_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WGSL_LANGUAGE_FEATURES_H_
...
class MODULES_EXPORT V8WGSLLanguageFeatures final : public bindings::V8InterfaceBridge<V8WGSLLanguageFeatures, WGSLLanguageFeatures> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1402);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class WGSLLanguageFeatures;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WGSL_LANGUAGE_FEATURES_H_
