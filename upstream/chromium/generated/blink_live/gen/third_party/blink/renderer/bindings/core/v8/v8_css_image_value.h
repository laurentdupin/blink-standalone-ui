...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_IMAGE_VALUE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_IMAGE_VALUE_H_
...
class CORE_EXPORT V8CSSImageValue final : public bindings::V8InterfaceBridge<V8CSSImageValue, CSSStyleImageValue> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(319);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSStyleImageValue;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_IMAGE_VALUE_H_
