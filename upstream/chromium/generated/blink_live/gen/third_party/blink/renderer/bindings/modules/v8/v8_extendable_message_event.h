...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXTENDABLE_MESSAGE_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXTENDABLE_MESSAGE_EVENT_H_
...
class MODULES_EXPORT V8ExtendableMessageEvent final : public bindings::V8InterfaceBridge<V8ExtendableMessageEvent, ExtendableMessageEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(404);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class ExtendableMessageEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXTENDABLE_MESSAGE_EVENT_H_
