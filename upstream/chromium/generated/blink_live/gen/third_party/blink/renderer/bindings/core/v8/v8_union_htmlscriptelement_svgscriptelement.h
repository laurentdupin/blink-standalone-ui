...
using Ret = bindings::OptimizedReturnProxy<V8UnionHTMLScriptElementOrSVGScriptElement>;
v8::Local<v8::Value> ToV8(ScriptState* script_state) const;

static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, HTMLScriptElement* value);
static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, SVGScriptElement* value);
