...
class  V8TypeConversions final : public bindings::V8InterfaceBridge<V8TypeConversions, TypeConversions> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1063);
