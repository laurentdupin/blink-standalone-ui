...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_PERSPECTIVE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_PERSPECTIVE_H_
...
class CORE_EXPORT V8CSSPerspective final : public bindings::V8InterfaceBridge<V8CSSPerspective, CSSPerspective> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(337);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSPerspective;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_PERSPECTIVE_H_
