...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PERIODIC_SYNC_MANAGER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PERIODIC_SYNC_MANAGER_H_
...
class MODULES_EXPORT V8PeriodicSyncManager final : public bindings::V8InterfaceBridge<V8PeriodicSyncManager, PeriodicSyncManager> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1087);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PeriodicSyncManager;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PERIODIC_SYNC_MANAGER_H_
