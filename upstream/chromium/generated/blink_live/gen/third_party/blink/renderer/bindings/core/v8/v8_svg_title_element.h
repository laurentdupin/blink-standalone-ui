...
class CORE_EXPORT V8SVGTitleElement final : public bindings::V8InterfaceBridge<V8SVGTitleElement, SVGTitleElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(745);
