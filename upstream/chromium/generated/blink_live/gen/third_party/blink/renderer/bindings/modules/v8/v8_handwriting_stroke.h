...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_HANDWRITING_STROKE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_HANDWRITING_STROKE_H_
...
class MODULES_EXPORT V8HandwritingStroke final : public bindings::V8InterfaceBridge<V8HandwritingStroke, HandwritingStroke> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1173);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class HandwritingStroke;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_HANDWRITING_STROKE_H_
