...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_DEDICATED_WORKER_GLOBAL_SCOPE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_DEDICATED_WORKER_GLOBAL_SCOPE_H_
...
class CORE_EXPORT V8DedicatedWorkerGlobalScope final : public bindings::V8InterfaceBridge<V8DedicatedWorkerGlobalScope, DedicatedWorkerGlobalScope> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(812);
...
static InstallContextDependentPropertiesFuncType install_context_dependent_props_func_;
  ...
  friend class DedicatedWorkerGlobalScope;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_DEDICATED_WORKER_GLOBAL_SCOPE_H_
