...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_DIFFUSE_LIGHTING_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_DIFFUSE_LIGHTING_ELEMENT_H_
...
class CORE_EXPORT V8SVGFEDiffuseLightingElement final : public bindings::V8InterfaceBridge<V8SVGFEDiffuseLightingElement, SVGFEDiffuseLightingElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(694);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGFEDiffuseLightingElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_DIFFUSE_LIGHTING_ELEMENT_H_
