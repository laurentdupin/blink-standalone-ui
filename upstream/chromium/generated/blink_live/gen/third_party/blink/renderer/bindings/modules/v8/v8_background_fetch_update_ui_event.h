...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BACKGROUND_FETCH_UPDATE_UI_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BACKGROUND_FETCH_UPDATE_UI_EVENT_H_
...
class MODULES_EXPORT V8BackgroundFetchUpdateUIEvent final : public bindings::V8InterfaceBridge<V8BackgroundFetchUpdateUIEvent, BackgroundFetchUpdateUIEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(400);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class BackgroundFetchUpdateUIEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BACKGROUND_FETCH_UPDATE_UI_EVENT_H_
