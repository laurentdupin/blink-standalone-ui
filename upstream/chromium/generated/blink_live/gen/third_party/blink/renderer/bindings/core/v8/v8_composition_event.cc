...
bool V8CompositionEvent::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<CompositionEvent, UIEvent>);
...
const WrapperTypeInfo V8CompositionEvent::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8CompositionEvent::InstallInterfaceTemplate,
    nullptr,
    "CompositionEvent",
    V8UIEvent::GetWrapperTypeInfo(),
    V8CompositionEvent::kThisTag,
    V8CompositionEvent::kMaxSubclassTag,
...
const WrapperTypeInfo& CompositionEvent::wrapper_type_info_ =
    V8CompositionEvent::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, CompositionEvent>::value,
    "CompositionEvent inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_composition_event {
...
BLINK_BINDINGS_TRACE_EVENT("CompositionEvent.data.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
CompositionEvent* blink_receiver = V8CompositionEvent::ToWrappableUnsafe(isolate, v8_receiver);
...
BLINK_BINDINGS_TRACE_EVENT("CompositionEvent.isTrusted.get");
...
BLINK_BINDINGS_TRACE_EVENT("CompositionEvent.constructor");
...
decltype(NativeValueTraits<CompositionEventInit>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg2_event_init_dict;
if (info[1]->IsUndefined()) {
  arg2_event_init_dict = CompositionEventInit::Create();
} else {
  arg2_event_init_dict = NativeValueTraits<CompositionEventInit>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
}
auto&& return_value = CompositionEvent::Create(arg1_type, arg2_event_init_dict);
static_assert(bindings::IsReturnTypeCompatible<CompositionEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8CompositionEvent::GetWrapperTypeInfo(), v8_receiver);
bindings::V8SetReturnValue(info, v8_wrapper);
}

void InitCompositionEventOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CompositionEvent_initCompositionEvent");
BLINK_BINDINGS_TRACE_EVENT("CompositionEvent.initCompositionEvent");
...
// [Measure], [MeasureAs]
UseCounter::Count(current_execution_context, WebFeature::kV8CompositionEvent_InitCompositionEvent_Method);
...
decltype(NativeValueTraits<IDLString>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg5_data;
...
blink_receiver->initCompositionEvent(arg1_type, arg2_bubbles, arg3_cancelable, arg4_view, arg5_data);
...
using namespace v8_composition_event;

}  // namespace 

void V8CompositionEvent::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8CompositionEvent::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "CompositionEvent"));
...
void V8CompositionEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "CompositionEvent", kAttributeTable);
}
...
{"initCompositionEvent", InitCompositionEventOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
};
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "CompositionEvent", kOperationTable);
}
