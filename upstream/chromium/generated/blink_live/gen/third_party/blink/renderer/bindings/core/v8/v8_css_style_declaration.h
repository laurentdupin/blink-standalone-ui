...
class CORE_EXPORT V8CSSStyleDeclaration final : public bindings::V8InterfaceBridge<V8CSSStyleDeclaration, CSSStyleDeclaration> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(309);
  static constexpr v8::CppHeapPointerTag kMaxSubclassTag =
      static_cast<v8::CppHeapPointerTag>(311);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSStyleDeclaration;
};
