...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_VARIABLE_REFERENCE_VALUE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_VARIABLE_REFERENCE_VALUE_H_
...
class CORE_EXPORT V8CSSVariableReferenceValue final : public bindings::V8InterfaceBridge<V8CSSVariableReferenceValue, CSSStyleVariableReferenceValue> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(344);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSStyleVariableReferenceValue;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_VARIABLE_REFERENCE_VALUE_H_
