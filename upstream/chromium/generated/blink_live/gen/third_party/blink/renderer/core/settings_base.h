...
class CORE_EXPORT SettingsBase {
 ...
 public:
  ...
  bool GetInspectorHighlightAds() const { return inspector_highlight_ads_; }
  LCDTextPreference GetLCDTextPreference() const { return lcd_text_preference_; }
  ...
  const String& GetAcceptLanguages() const { return accept_languages_; }
  ...
  int GetAccessibilityFontWeightAdjustment() const { return accessibility_font_weight_adjustment_; }
  ...
  int GetAccessibilityTextSizeContrastFactor() const { return accessibility_text_size_contrast_factor_; }
  ...
  bool GetAllowUnrestrictedWindowFocus() const { return allow_unrestricted_window_focus_; }
  ...
  bool GetDynamicSafeAreaInsetsEnabled() const { return dynamic_safe_area_insets_enabled_; }
  ...
  bool GetIgnorePermissionForDeviceChangedEvent() const { return ignore_permission_for_device_changed_event_; }
  ...
  bool GetImmersiveVideoPlaybackEnabled() const { return immersive_video_playback_enabled_; }
  bool GetInForcedColors() const { return in_forced_colors_; }
  bool GetInvertedColors() const { return inverted_colors_; }
  bool GetIsForcedColorsDisabled() const { return is_forced_colors_disabled_; }
  bool GetIsInitialProfile() const { return is_initial_profile_; }
  ...
  bool GetMiddleClickPasteAllowed() const { return middle_click_paste_allowed_; }
  ...
  bool GetModalContextMenu() const { return modal_context_menu_; }
  ...
  mojom::blink::OutputDeviceUpdateAbilityType GetOutputDeviceUpdateAbilityType() const { return output_device_update_ability_type_; }
  ...
  bool GetPasswordEchoEnabledPhysical() const { return password_echo_enabled_physical_; }
  bool GetPasswordEchoEnabledTouch() const { return password_echo_enabled_touch_; }
  bool GetPictureInPictureEnabled() const { return picture_in_picture_enabled_; }
  bool GetPlaceRTLScrollbarsOnLeftSideInMainFrame() const { return place_rtl_scrollbars_on_left_side_in_main_frame_; }
  ...
  mojom::blink::PreferredColorScheme GetPreferredRootScrollbarColorScheme() const { return preferred_root_scrollbar_color_scheme_; }
  ...
  std::optional<SkColor> GetRootScrollbarThemeColor() const { return root_scrollbar_theme_color_; }
  bool GetRubberBandingOnCompositorThread() const { return rubber_banding_on_compositor_thread_; }
  bool GetScaleAllFontsIfNoMetaTextScaleTag() const { return scale_all_fonts_if_no_meta_text_scale_tag_; }
  ...
  bool GetTextSizeAdjustEnabled() const { return text_size_adjust_enabled_; }
  ...
  ui::mojom::blink::WindowShowState GetWindowShowState() const { return window_show_state_; }
  ...
  void SetInspectorHighlightAds(bool inspector_highlight_ads);
  ...
  void SetAcceptLanguages(const String& accept_languages);
  ...
  void SetAllowUnrestrictedWindowFocus(bool allow_unrestricted_window_focus);
  ...
  void SetIgnorePermissionForDeviceChangedEvent(bool ignore_permission_for_device_changed_event);
  ...
  void SetImmersiveVideoPlaybackEnabled(bool immersive_video_playback_enabled);
  ...
  void SetMiddleClickPasteAllowed(bool middle_click_paste_allowed);
  ...
  void SetPasswordEchoEnabledPhysical(bool password_echo_enabled_physical);
  void SetPasswordEchoEnabledTouch(bool password_echo_enabled_touch);
  ...
  void SetRootScrollbarThemeColor(std::optional<SkColor> root_scrollbar_theme_color);
  void SetRubberBandingOnCompositorThread(bool rubber_banding_on_compositor_thread);
  void SetScaleAllFontsIfNoMetaTextScaleTag(bool scale_all_fonts_if_no_meta_text_scale_tag);
  ...
  void SetTextSizeAdjustEnabled(bool text_size_adjust_enabled);
 ...
 private:
  ...
  std::optional<SkColor> root_scrollbar_theme_color_;
  ...
  bool inspector_highlight_ads_ : 1;
  ...
  bool allow_unrestricted_window_focus_ : 1;
  ...
  bool middle_click_paste_allowed_ : 1;
  ...
  bool password_echo_enabled_physical_ : 1;
  bool password_echo_enabled_touch_ : 1;
  ...
  bool scale_all_fonts_if_no_meta_text_scale_tag_ : 1;
  ...
  bool text_size_adjust_enabled_ : 1;
