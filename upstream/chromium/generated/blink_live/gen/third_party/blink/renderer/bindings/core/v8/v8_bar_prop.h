...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_BAR_PROP_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_BAR_PROP_H_
...
class CORE_EXPORT V8BarProp final : public bindings::V8InterfaceBridge<V8BarProp, BarProp> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(853);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class BarProp;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_BAR_PROP_H_
