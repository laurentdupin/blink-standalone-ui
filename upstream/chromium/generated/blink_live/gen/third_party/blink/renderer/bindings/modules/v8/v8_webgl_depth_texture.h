...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_DEPTH_TEXTURE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_DEPTH_TEXTURE_H_
...
class MODULES_EXPORT V8WebGLDepthTexture final : public bindings::V8InterfaceBridge<V8WebGLDepthTexture, WebGLDepthTexture> {
...
class Constant final {
  ...
  public:
static constexpr uint32_t kUnsignedInt248Webgl = 0x84FA;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1339);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class WebGLDepthTexture;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_DEPTH_TEXTURE_H_
