...
class CORE_EXPORT V8SharedWorkerGlobalScope final : public bindings::V8InterfaceBridge<V8SharedWorkerGlobalScope, SharedWorkerGlobalScope> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(814);
...
static InstallContextDependentPropertiesFuncType install_context_dependent_props_func_;
  ...
  friend class SharedWorkerGlobalScope;
};
