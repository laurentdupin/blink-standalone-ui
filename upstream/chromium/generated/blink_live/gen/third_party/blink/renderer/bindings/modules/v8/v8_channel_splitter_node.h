...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CHANNEL_SPLITTER_NODE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CHANNEL_SPLITTER_NODE_H_
...
class MODULES_EXPORT V8ChannelSplitterNode final : public bindings::V8InterfaceBridge<V8ChannelSplitterNode, ChannelSplitterNode> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(513);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class ChannelSplitterNode;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CHANNEL_SPLITTER_NODE_H_
