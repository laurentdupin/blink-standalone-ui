...
static_assert(std::derived_from<MIDIMessageEvent, Event>);
...
const WrapperTypeInfo V8MIDIMessageEvent::wrapper_type_info_{
    ...
    V8MIDIMessageEvent::kThisTag,
    V8MIDIMessageEvent::kMaxSubclassTag,
...
static_assert(bindings::IsReturnTypeCompatible<IDLNullable<NotShared<DOMUint8Array>>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Value> v8_return_value = ToV8Traits<IDLNullable<NotShared<DOMUint8Array>>>::ToV8(script_state, return_value);
...
static_assert(bindings::IsReturnTypeCompatible<MIDIMessageEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
interface_function_template->SetInterfaceName(V8String(isolate, "MIDIMessageEvent"));
...
void V8MIDIMessageEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "MIDIMessageEvent", kAttributeTable);
}
