...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SCREEN_ORIENTATION_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SCREEN_ORIENTATION_H_
...
class MODULES_EXPORT V8ScreenOrientation final : public bindings::V8InterfaceBridge<V8ScreenOrientation, ScreenOrientation> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(772);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SCREEN_ORIENTATION_H_
