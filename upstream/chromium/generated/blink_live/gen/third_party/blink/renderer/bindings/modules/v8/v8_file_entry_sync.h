...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_FILE_ENTRY_SYNC_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_FILE_ENTRY_SYNC_H_
...
class MODULES_EXPORT V8FileEntrySync final : public bindings::V8InterfaceBridge<V8FileEntrySync, FileEntrySync> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1163);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class FileEntrySync;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_FILE_ENTRY_SYNC_H_
