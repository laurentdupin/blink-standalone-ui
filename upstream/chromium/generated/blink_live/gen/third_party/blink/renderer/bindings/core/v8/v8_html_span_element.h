...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_SPAN_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_SPAN_ELEMENT_H_
...
class CORE_EXPORT V8HTMLSpanElement final : public bindings::V8InterfaceBridge<V8HTMLSpanElement, HTMLSpanElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(659);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class HTMLSpanElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_SPAN_ELEMENT_H_
