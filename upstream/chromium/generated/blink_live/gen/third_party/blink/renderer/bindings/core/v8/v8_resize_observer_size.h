...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_RESIZE_OBSERVER_SIZE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_RESIZE_OBSERVER_SIZE_H_
...
class CORE_EXPORT V8ResizeObserverSize final : public bindings::V8InterfaceBridge<V8ResizeObserverSize, ResizeObserverSize> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(941);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class ResizeObserverSize;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_RESIZE_OBSERVER_SIZE_H_
