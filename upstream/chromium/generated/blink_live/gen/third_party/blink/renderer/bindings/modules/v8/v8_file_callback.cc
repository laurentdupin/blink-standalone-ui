...
const char* V8FileCallback::GetHumanReadableName() const {
  return "V8FileCallback";
}

v8::Maybe<void> V8FileCallback::handleEvent(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, File* arg1_file) {
  const char* const class_like_name = "FileCallback";
...
void V8FileCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, File* arg1_file) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = handleEvent(arg0_receiver, arg1_file);
}
