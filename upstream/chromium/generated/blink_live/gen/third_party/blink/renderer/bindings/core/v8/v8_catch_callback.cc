...
const char* V8CatchCallback::GetHumanReadableName() const {
  return "V8CatchCallback";
}

v8::Maybe<ScriptValue> V8CatchCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const ScriptValue& arg1_value) {
  const char* const class_like_name = "CatchCallback";
...
v8::Maybe<ScriptValue> V8CatchCallback::Construct(const ScriptValue& arg1_value) {
  const char* const class_like_name = "CatchCallback";
...
base::expected<ScriptValue, ScriptValue> V8CatchCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const ScriptValue& arg1_value) {
