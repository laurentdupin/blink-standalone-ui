...
bool V8TextTrackCueList::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8TextTrackCueList::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8TextTrackCueList::InstallInterfaceTemplate,
    nullptr,
    "TextTrackCueList",
    nullptr,
    V8TextTrackCueList::kThisTag,
    V8TextTrackCueList::kMaxSubclassTag,
...
const WrapperTypeInfo& TextTrackCueList::wrapper_type_info_ =
    V8TextTrackCueList::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, TextTrackCueList>::value,
    "TextTrackCueList inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

v8::Intercepted V8TextTrackCueList::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
TextTrackCueList* blink_receiver = V8TextTrackCueList::ToWrappableUnsafe(isolate, v8_receiver);
...
static_assert(bindings::IsReturnTypeCompatible<TextTrackCue, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
return v8::Intercepted::kYes;
}

v8::Intercepted V8TextTrackCueList::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TextTrackCueList_IndexedPropertySetter");
...
v8::Intercepted V8TextTrackCueList::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TextTrackCueList_IndexedPropertyDeleter");
...
v8::Intercepted V8TextTrackCueList::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TextTrackCueList_IndexedPropertyDefiner");
...
v8::Intercepted V8TextTrackCueList::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TextTrackCueList_IndexedPropertyDescriptor");
...
void V8TextTrackCueList::IndexedPropertyEnumeratorCallback(const v8::PropertyCallbackInfo<v8::Array>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TextTrackCueList_IndexedPropertyEnumerator");
...
namespace v8_text_track_cue_list {
...
BLINK_BINDINGS_TRACE_EVENT("TextTrackCueList.length.get");
...
void GetCueByIdOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TextTrackCueList_getCueById");
BLINK_BINDINGS_TRACE_EVENT("TextTrackCueList.getCueById");
...
arg1_id = NativeValueTraits<IDLString>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
}
auto&& return_value = blink_receiver->getCueById(arg1_id);
static_assert(bindings::IsReturnTypeCompatible<IDLNullable<TextTrackCue>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
}
...
using namespace v8_text_track_cue_list;

}  // namespace 

void V8TextTrackCueList::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8TextTrackCueList::GetWrapperTypeInfo();
...
instance_template->SetHandler(
    v8::IndexedPropertyHandlerConfiguration(
        ...
        nullptr,  // query
        V8TextTrackCueList::IndexedPropertyDeleterCallback,
        V8TextTrackCueList::IndexedPropertyEnumeratorCallback,
...
void V8TextTrackCueList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "TextTrackCueList", kAttributeTable);
}
...
{"getCueById", GetCueByIdOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
};
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "TextTrackCueList", kOperationTable);
}
