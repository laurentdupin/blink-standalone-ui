...
v8::Local<v8::Value> V8UnionInternalEnumOrInternalEnumSequence::DirectToV8(ScriptState* script_state, V8InternalEnum value) {
  return ToV8Traits<V8InternalEnum>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionInternalEnumOrInternalEnumSequence::DirectToV8(ScriptState* script_state, const Vector<V8InternalEnum>& value) {
  return ToV8Traits<IDLSequence<V8InternalEnum>>::ToV8(script_state, value);
}
