...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TEST_REPORT_BODY_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TEST_REPORT_BODY_H_
...
class CORE_EXPORT V8TestReportBody final : public bindings::V8InterfaceBridge<V8TestReportBody, TestReportBody> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class TestReportBody;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TEST_REPORT_BODY_H_
