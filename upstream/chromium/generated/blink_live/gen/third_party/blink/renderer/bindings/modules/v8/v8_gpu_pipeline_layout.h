...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_PIPELINE_LAYOUT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_PIPELINE_LAYOUT_H_
...
class MODULES_EXPORT V8GPUPipelineLayout final : public bindings::V8InterfaceBridge<V8GPUPipelineLayout, GPUPipelineLayout> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1388);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class GPUPipelineLayout;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_PIPELINE_LAYOUT_H_
