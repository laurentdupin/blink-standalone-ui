...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_FENCED_FRAME_CONFIG_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_FENCED_FRAME_CONFIG_H_
...
class CORE_EXPORT V8FencedFrameConfig final : public bindings::V8InterfaceBridge<V8FencedFrameConfig, FencedFrameConfig> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(899);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_FENCED_FRAME_CONFIG_H_
