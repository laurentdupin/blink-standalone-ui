...
class  V8Internals final : public bindings::V8InterfaceBridge<V8Internals, Internals> {
...
class Constant final {
  ...
  public:
static constexpr uint16_t kLayerTreeIncludesInvalidations = 2;
static constexpr uint16_t kLayerTreeIncludesDetailedInvalidations = 4;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1056);
