...
class MODULES_EXPORT V8PresentationRequest final : public bindings::V8InterfaceBridge<V8PresentationRequest, PresentationRequest> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(759);
