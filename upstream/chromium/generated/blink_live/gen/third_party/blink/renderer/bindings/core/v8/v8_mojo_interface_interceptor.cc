...
static_assert(std::derived_from<MojoInterfaceInterceptor, EventTarget>);
...
const WrapperTypeInfo& MojoInterfaceInterceptor::wrapper_type_info_ =
    V8MojoInterfaceInterceptor::wrapper_type_info_;
...
decltype(NativeValueTraits<V8MojoInterfaceInterceptorScope>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg2_scope{V8MojoInterfaceInterceptorScope::Enum::kContext};
...
static_assert(bindings::IsReturnTypeCompatible<MojoInterfaceInterceptor, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
void V8MojoInterfaceInterceptor::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"oninterfacerequest", OninterfacerequestAttributeGetCallback, OninterfacerequestAttributeSetCallback, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
};
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "MojoInterfaceInterceptor", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "MojoInterfaceInterceptor", kOperationTable);
}
