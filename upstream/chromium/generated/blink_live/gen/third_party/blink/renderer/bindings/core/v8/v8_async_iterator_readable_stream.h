...
template <>
class CORE_EXPORT AsyncIterator<ReadableStream> final : public bindings::AsyncIteratorBase {
...
explicit  AsyncIterator<ReadableStream>(IterationSourceBase* source) : bindings::AsyncIteratorBase(source) {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(256);
