...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_INPUT_DEVICE_CAPABILITIES_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_INPUT_DEVICE_CAPABILITIES_H_
...
class CORE_EXPORT V8InputDeviceCapabilities final : public bindings::V8InterfaceBridge<V8InputDeviceCapabilities, InputDeviceCapabilities> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(915);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class InputDeviceCapabilities;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_INPUT_DEVICE_CAPABILITIES_H_
