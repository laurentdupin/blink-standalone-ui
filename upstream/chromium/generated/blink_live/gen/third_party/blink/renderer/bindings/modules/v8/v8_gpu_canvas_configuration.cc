...
return dictionary;
 ...
 GPUCanvasConfiguration::GPUCanvasConfiguration() : member_tone_mapping_(CanvasToneMapping::Create()) {
  
}

 GPUCanvasConfiguration::GPUCanvasConfiguration(v8::Isolate* isolate) : member_tone_mapping_(CanvasToneMapping::Create()) {
