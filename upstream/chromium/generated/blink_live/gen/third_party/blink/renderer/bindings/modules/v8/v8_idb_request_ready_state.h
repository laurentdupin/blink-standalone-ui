...
class MODULES_EXPORT V8IDBRequestReadyState final : public bindings::EnumerationBase {
...
static V8IDBRequestReadyState Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8IDBRequestReadyState> Create(const String& value);

explicit constexpr  V8IDBRequestReadyState(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8IDBRequestReadyState& lhs, V8IDBRequestReadyState::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8IDBRequestReadyState::Enum lhs, const V8IDBRequestReadyState& rhs) {
