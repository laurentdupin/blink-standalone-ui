...
class MODULES_EXPORT V8RTCDtlsTransport final : public bindings::V8InterfaceBridge<V8RTCDtlsTransport, RTCDtlsTransport> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(763);
