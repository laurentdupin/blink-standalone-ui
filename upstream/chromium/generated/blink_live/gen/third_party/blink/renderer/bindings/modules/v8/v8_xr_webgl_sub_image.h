...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_WEBGL_SUB_IMAGE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_WEBGL_SUB_IMAGE_H_
...
class MODULES_EXPORT V8XRWebGLSubImage final : public bindings::V8InterfaceBridge<V8XRWebGLSubImage, XRWebGLSubImage> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1449);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XRWebGLSubImage;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_WEBGL_SUB_IMAGE_H_
