...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_PROVOKING_VERTEX_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_PROVOKING_VERTEX_H_
...
class MODULES_EXPORT V8WebGLProvokingVertex final : public bindings::V8InterfaceBridge<V8WebGLProvokingVertex, WebGLProvokingVertex> {
...
class Constant final {
  ...
  public:
static constexpr uint32_t kFirstVertexConventionWebgl = 0x8E4D;
static constexpr uint32_t kLastVertexConventionWebgl = 0x8E4E;
static constexpr uint32_t kProvokingVertexWebgl = 0x8E4F;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1360);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class WebGLProvokingVertex;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_PROVOKING_VERTEX_H_
