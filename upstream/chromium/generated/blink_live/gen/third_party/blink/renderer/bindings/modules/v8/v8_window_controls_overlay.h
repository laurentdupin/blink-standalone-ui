...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WINDOW_CONTROLS_OVERLAY_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WINDOW_CONTROLS_OVERLAY_H_
...
class MODULES_EXPORT V8WindowControlsOverlay final : public bindings::V8InterfaceBridge<V8WindowControlsOverlay, WindowControlsOverlay> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(807);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class WindowControlsOverlay;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WINDOW_CONTROLS_OVERLAY_H_
