...
visitor->Trace(member_create_parser_options_);
...
dictionary_from_v8_context.SetCurrentPropertyName("createParserOptions");
if (!bindings::GetDictionaryMemberFromV8Object<V8CreateParserOptionsCallback, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate), has_create_parser_options_, member_create_parser_options_, class_like_name, exception_state)) {
  return;
}
dictionary_from_v8_context.SetCurrentPropertyName("createScript");
if (!bindings::GetDictionaryMemberFromV8Object<V8CreateScriptCallback, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[2].Get(isolate), has_create_script_, member_create_script_, class_like_name, exception_state)) {
  return;
}
dictionary_from_v8_context.SetCurrentPropertyName("createScriptURL");
if (!bindings::GetDictionaryMemberFromV8Object<V8CreateURLCallback, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[3].Get(isolate), has_create_script_url_, member_create_script_url_, class_like_name, exception_state)) {
  return;
}
}
