...
class CORE_EXPORT V8HTMLMarqueeElement final : public bindings::V8InterfaceBridge<V8HTMLMarqueeElement, HTMLMarqueeElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(632);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class HTMLMarqueeElement;
};
