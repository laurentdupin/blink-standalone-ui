...
if (!v8_value->IsObject()) {
  const char* const class_like_name = "TCPServerSocketOptions";
...
return dictionary;
 ...
 TCPServerSocketOptions::TCPServerSocketOptions(v8::Isolate* isolate) {
...
void TCPServerSocketOptions::Trace(Visitor* visitor) const {
...
dictionary_from_v8_context.SetCurrentPropertyName("backlog");
constexpr bool is_optional = false;
v8::Local<v8::Context> current_context = isolate->GetCurrentContext();
const auto& v8_own_member_names = GetV8OwnMemberNames(isolate);
if (!bindings::GetDictionaryMemberFromV8Object<IDLUnsignedLongEnforceRange, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), has_backlog_, member_backlog_, class_like_name, exception_state)) {
  return;
}
...
if (!bindings::GetDictionaryMemberFromV8Object<IDLUnsignedShortEnforceRange, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[2].Get(isolate), has_local_port_, member_local_port_, class_like_name, exception_state)) {
  return;
}
}
