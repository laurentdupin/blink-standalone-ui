...
[[nodiscard]] base::expected<ScriptValue, ScriptValue> InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<ScriptValue>& arg1_args);
