...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PERFORMANCE_TIMING_CONFIDENCE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PERFORMANCE_TIMING_CONFIDENCE_H_
...
class CORE_EXPORT V8PerformanceTimingConfidence final : public bindings::V8InterfaceBridge<V8PerformanceTimingConfidence, PerformanceTimingConfidence> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1017);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PerformanceTimingConfidence;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PERFORMANCE_TIMING_CONFIDENCE_H_
