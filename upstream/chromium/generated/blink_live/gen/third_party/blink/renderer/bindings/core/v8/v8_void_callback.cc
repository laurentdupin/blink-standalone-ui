...
const char* V8VoidCallback::GetHumanReadableName() const {
  return "V8VoidCallback";
}

v8::Maybe<void> V8VoidCallback::handleEvent(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
  const char* const class_like_name = "VoidCallback";
...
void V8VoidCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = handleEvent(arg0_receiver);
}
