...
base::expected<ScriptPromise<IDLUndefined>, ScriptValue> V8UnderlyingSourceCancelCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const ScriptValue& arg1_reason) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_reason);
