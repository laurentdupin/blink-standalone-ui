...
bool V8StyleSheetList::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8StyleSheetList::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8StyleSheetList::InstallInterfaceTemplate,
    nullptr,
    "StyleSheetList",
    nullptr,
    V8StyleSheetList::kThisTag,
    V8StyleSheetList::kMaxSubclassTag,
...
const WrapperTypeInfo& StyleSheetList::wrapper_type_info_ =
    V8StyleSheetList::wrapper_type_info_;
...
v8::Intercepted V8StyleSheetList::NamedPropertyGetterCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
v8::Intercepted V8StyleSheetList::NamedPropertySetterCallback(v8::Local<v8::Name> v8_property_name, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_StyleSheetList_NamedPropertySetter");
...
v8::Intercepted V8StyleSheetList::NamedPropertyDeleterCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_StyleSheetList_NamedPropertyDeleter");
...
v8::Intercepted V8StyleSheetList::NamedPropertyDefinerCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_StyleSheetList_NamedPropertyDefiner");
...
v8::Intercepted V8StyleSheetList::NamedPropertyDescriptorCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_StyleSheetList_NamedPropertyDescriptor");
...
//  only argument value."
auto intercepted =
    V8StyleSheetList::NamedPropertyGetterCallback(v8_property_name, info);
// "Return OrdinaryGetOwnProperty(O, P)."
...
v8::Intercepted V8StyleSheetList::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
v8::Intercepted V8StyleSheetList::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_StyleSheetList_IndexedPropertySetter");
...
v8::Intercepted V8StyleSheetList::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_StyleSheetList_IndexedPropertyDeleter");
...
v8::Intercepted V8StyleSheetList::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_StyleSheetList_IndexedPropertyDefiner");
...
v8::Intercepted V8StyleSheetList::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_StyleSheetList_IndexedPropertyDescriptor");
...
BLINK_BINDINGS_TRACE_EVENT("StyleSheetList.length.get");
...
BLINK_BINDINGS_TRACE_EVENT("StyleSheetList.item");
...
// [Measure], [MeasureAs]
UseCounter::Count(current_execution_context, WebFeature::kV8StyleSheetList_Item_Method);
...
using namespace v8_style_sheet_list;

}  // namespace 

void V8StyleSheetList::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8StyleSheetList::GetWrapperTypeInfo();
...
instance_template->SetHandler(
    v8::NamedPropertyHandlerConfiguration(
        V8StyleSheetList::NamedPropertyGetterCallback,
        V8StyleSheetList::NamedPropertySetterCallback,
        nullptr,  // query
        V8StyleSheetList::NamedPropertyDeleterCallback,
        nullptr,  // enumerator
        V8StyleSheetList::NamedPropertyDefinerCallback,
        V8StyleSheetList::NamedPropertyDescriptorCallback,
        v8::Local<v8::Value>(),
...
instance_template->SetHandler(
    v8::IndexedPropertyHandlerConfiguration(
        ...
        nullptr,  // query
        V8StyleSheetList::IndexedPropertyDeleterCallback,
        V8StyleSheetList::IndexedPropertyEnumeratorCallback,
...
void V8StyleSheetList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "StyleSheetList", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "StyleSheetList", kOperationTable);
}
