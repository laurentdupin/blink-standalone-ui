...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FOREIGN_OBJECT_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FOREIGN_OBJECT_ELEMENT_H_
...
class CORE_EXPORT V8SVGForeignObjectElement final : public bindings::V8InterfaceBridge<V8SVGForeignObjectElement, SVGForeignObjectElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(717);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FOREIGN_OBJECT_ELEMENT_H_
