...
const char* V8LaunchConsumer::GetHumanReadableName() const {
  return "V8LaunchConsumer";
}

v8::Maybe<void> V8LaunchConsumer::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, LaunchParams* arg1_params) {
  const char* const class_like_name = "LaunchConsumer";
...
v8::Maybe<void> V8LaunchConsumer::Construct(LaunchParams* arg1_params) {
  const char* const class_like_name = "LaunchConsumer";
...
void V8LaunchConsumer::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, LaunchParams* arg1_params) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = Invoke(arg0_receiver, arg1_params);
}

base::expected<void, ScriptValue> V8LaunchConsumer::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, LaunchParams* arg1_params) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_params);
