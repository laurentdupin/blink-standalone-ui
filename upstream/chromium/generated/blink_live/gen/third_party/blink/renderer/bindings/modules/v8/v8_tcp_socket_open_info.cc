...
return dictionary;
 ...
 TCPSocketOpenInfo::TCPSocketOpenInfo(v8::Isolate* isolate) : SocketOpenInfo(isolate) {
...
void TCPSocketOpenInfo::FillTemplateProperties(Vector<std::string_view>& properties) const {
