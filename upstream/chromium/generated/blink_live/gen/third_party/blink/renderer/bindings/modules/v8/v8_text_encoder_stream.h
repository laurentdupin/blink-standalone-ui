...
class MODULES_EXPORT V8TextEncoderStream final : public bindings::V8InterfaceBridge<V8TextEncoderStream, TextEncoderStream> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1144);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class TextEncoderStream;
};
