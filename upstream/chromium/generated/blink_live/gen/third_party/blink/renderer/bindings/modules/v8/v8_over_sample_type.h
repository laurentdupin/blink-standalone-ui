...
static V8OverSampleType Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8OverSampleType> Create(const String& value);

explicit constexpr  V8OverSampleType(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8OverSampleType& lhs, V8OverSampleType::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8OverSampleType::Enum lhs, const V8OverSampleType& rhs) {
