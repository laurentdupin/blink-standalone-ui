...
const char* V8TestEnumCallback::GetHumanReadableName() const {
  return "V8TestEnumCallback";
}

v8::Maybe<void> V8TestEnumCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, V8InternalEnum arg1_arg) {
  const char* const class_like_name = "TestEnumCallback";
...
v8::Local<v8::Value> v8_arg1_arg;
ScriptState* script_state = CallbackRelevantScriptState();
v8_arg1_arg = ToV8Traits<V8InternalEnum>::ToV8(script_state, arg1_arg);
argv[0] = v8_arg1_arg;
...
v8::Maybe<void> V8TestEnumCallback::Construct(V8InternalEnum arg1_arg) {
  const char* const class_like_name = "TestEnumCallback";
...
void V8TestEnumCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, V8InternalEnum arg1_arg) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = Invoke(arg0_receiver, arg1_arg);
}

base::expected<void, ScriptValue> V8TestEnumCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, V8InternalEnum arg1_arg) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_arg);
