...
auto&& arg2_value = NativeValueTraits<PassAsSpan<PassAsSpanMarkerBase::Flags::kAllowShared | kPerformDetachCheckFlag, float>>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
constexpr auto kPerformDetachCheckFlag = PassAsSpanMarkerBase::Flags::kPerformDetachCheck;
auto&& arg2_value = NativeValueTraits<PassAsSpan<PassAsSpanMarkerBase::Flags::kAllowShared | kPerformDetachCheckFlag, int32_t>>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
decltype(NativeValueTraits<IDLUnsignedLong>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg3_src_offset{0};
...
constexpr auto kPerformDetachCheckFlag = PassAsSpanMarkerBase::Flags::kPerformDetachCheck;
auto&& arg2_value = NativeValueTraits<PassAsSpan<PassAsSpanMarkerBase::Flags::kAllowShared | kPerformDetachCheckFlag, uint32_t>>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
decltype(NativeValueTraits<IDLUnsignedLong>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg3_src_offset{0};
...
auto&& arg5_usage = NativeValueTraits<IDLUnsignedLong>::ArgumentValue(isolate, 4, info[4], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
blink_receiver->framebufferTexturePixelLocalStorageWEBGL(arg1_plane, arg2_texture, arg3_level, arg4_layer, arg5_usage);
...
{"PIXEL_LOCAL_INTERNAL_FORMAT_WEBGL", V8WebGLShaderPixelLocalStorage::Constant::kPixelLocalInternalFormatWebgl},
...
{"PIXEL_LOCAL_USAGE_WEBGL", V8WebGLShaderPixelLocalStorage::Constant::kPixelLocalUsageWebgl},
...
{"PIXEL_LOCAL_USAGE_ALWAYS_NONCOHERENT_BIT_WEBGL", V8WebGLShaderPixelLocalStorage::Constant::kPixelLocalUsageAlwaysNoncoherentBitWebgl},
};
