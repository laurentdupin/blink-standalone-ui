...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_STYLE_MEDIA_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_STYLE_MEDIA_H_
...
class CORE_EXPORT V8StyleMedia final : public bindings::V8InterfaceBridge<V8StyleMedia, StyleMedia> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(349);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class StyleMedia;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_STYLE_MEDIA_H_
