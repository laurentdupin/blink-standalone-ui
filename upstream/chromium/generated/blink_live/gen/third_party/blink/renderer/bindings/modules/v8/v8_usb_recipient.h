...
kDevice, kInterface, kEndpoint, kOther
};
static constexpr size_t kEnumSize = 4;

static V8USBRecipient Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8USBRecipient> Create(const String& value);

explicit constexpr  V8USBRecipient(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
