...
class MODULES_EXPORT V8MediaKeySystemAccess final : public bindings::V8InterfaceBridge<V8MediaKeySystemAccess, MediaKeySystemAccess> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1146);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class MediaKeySystemAccess;
};
