...
const char* V8CustomElementConstructor::GetHumanReadableName() const {
...
base::expected<ScriptValue, ScriptValue> V8CustomElementConstructor::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
