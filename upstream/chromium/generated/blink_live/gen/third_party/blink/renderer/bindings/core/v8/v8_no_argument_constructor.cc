...
const char* V8NoArgumentConstructor::GetHumanReadableName() const {
  return "V8NoArgumentConstructor";
}

v8::Maybe<ScriptValue> V8NoArgumentConstructor::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
  const char* const class_like_name = "NoArgumentConstructor";
...
v8::Maybe<ScriptValue> V8NoArgumentConstructor::Construct() {
  const char* const class_like_name = "NoArgumentConstructor";
...
base::expected<ScriptValue, ScriptValue> V8NoArgumentConstructor::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
