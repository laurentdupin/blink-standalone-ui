...
class CORE_EXPORT V8PerformanceTiming final : public bindings::V8InterfaceBridge<V8PerformanceTiming, PerformanceTiming> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1016);
