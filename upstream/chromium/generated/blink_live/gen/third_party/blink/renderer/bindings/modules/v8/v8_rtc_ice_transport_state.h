...
kNew, kChecking, kConnected, kCompleted, kDisconnected, kFailed, kClosed
};
...
explicit constexpr  V8RTCIceTransportState(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
