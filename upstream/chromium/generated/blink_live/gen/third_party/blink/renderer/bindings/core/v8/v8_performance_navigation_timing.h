...
class CORE_EXPORT V8PerformanceNavigationTiming final : public bindings::V8InterfaceBridge<V8PerformanceNavigationTiming, PerformanceNavigationTiming> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PerformanceNavigationTiming;
};
