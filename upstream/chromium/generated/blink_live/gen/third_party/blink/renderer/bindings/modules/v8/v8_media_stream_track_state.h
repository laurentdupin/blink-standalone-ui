...
class MODULES_EXPORT V8MediaStreamTrackState final : public bindings::EnumerationBase {
...
static V8MediaStreamTrackState Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8MediaStreamTrackState> Create(const String& value);

explicit constexpr  V8MediaStreamTrackState(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8MediaStreamTrackState& lhs, V8MediaStreamTrackState::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8MediaStreamTrackState::Enum lhs, const V8MediaStreamTrackState& rhs) {
