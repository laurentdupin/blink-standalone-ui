...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_WEBGL_LAYER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_WEBGL_LAYER_H_
...
class MODULES_EXPORT V8XRWebGLLayer final : public bindings::V8InterfaceBridge<V8XRWebGLLayer, XRWebGLLayer> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(825);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XRWebGLLayer;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_WEBGL_LAYER_H_
