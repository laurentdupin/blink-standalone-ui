...
explicit  SyncIterator<GPUSupportedFeatures>(IterationSourceBase* source, Kind kind) : bindings::SyncIteratorBase(source, kind) {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1501);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SyncIterator<GPUSupportedFeatures>;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_GPU_SUPPORTED_FEATURES_H_
