...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DOM_FILE_SYSTEM_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DOM_FILE_SYSTEM_H_
...
class MODULES_EXPORT V8DOMFileSystem final : public bindings::V8InterfaceBridge<V8DOMFileSystem, DOMFileSystem> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1156);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DOM_FILE_SYSTEM_H_
