...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TEXT_TRACK_LIST_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TEXT_TRACK_LIST_H_
...
class CORE_EXPORT V8TextTrackList final : public bindings::V8InterfaceBridge<V8TextTrackList, TextTrackList> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(797);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class TextTrackList;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TEXT_TRACK_LIST_H_
