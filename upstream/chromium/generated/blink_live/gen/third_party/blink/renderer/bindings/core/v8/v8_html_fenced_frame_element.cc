...
bool V8HTMLFencedFrameElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow() && RuntimeEnabledFeatures::FencedFramesEnabled();
}

static_assert(std::derived_from<HTMLFencedFrameElement, HTMLElement>);
...
const WrapperTypeInfo V8HTMLFencedFrameElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8HTMLFencedFrameElement::InstallInterfaceTemplate,
    nullptr,
    "HTMLFencedFrameElement",
    V8HTMLElement::GetWrapperTypeInfo(),
    V8HTMLFencedFrameElement::kThisTag,
    V8HTMLFencedFrameElement::kMaxSubclassTag,
...
const WrapperTypeInfo& HTMLFencedFrameElement::wrapper_type_info_ =
    V8HTMLFencedFrameElement::wrapper_type_info_;
...
namespace v8_html_fenced_frame_element {


void ConfigAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLFencedFrameElement_config_Getter");
...
static_assert(bindings::IsReturnTypeCompatible<IDLNullable<FencedFrameConfig>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
}

void ConfigAttributeSetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLFencedFrameElement_config_Setter");
...
blink_receiver->setConfig(arg1_value);
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLFencedFrameElement_width_Getter");
BLINK_BINDINGS_TRACE_EVENT("HTMLFencedFrameElement.width.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLFencedFrameElement_width_Setter");
BLINK_BINDINGS_TRACE_EVENT("HTMLFencedFrameElement.width.set");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLFencedFrameElement_height_Getter");
BLINK_BINDINGS_TRACE_EVENT("HTMLFencedFrameElement.height.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLFencedFrameElement_height_Setter");
BLINK_BINDINGS_TRACE_EVENT("HTMLFencedFrameElement.height.set");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLFencedFrameElement_allow_Getter");
BLINK_BINDINGS_TRACE_EVENT("HTMLFencedFrameElement.allow.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLFencedFrameElement_allow_Setter");
BLINK_BINDINGS_TRACE_EVENT("HTMLFencedFrameElement.allow.set");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLFencedFrameElement_sandbox_Getter");
BLINK_BINDINGS_TRACE_EVENT("HTMLFencedFrameElement.sandbox.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLFencedFrameElement_sandbox_Setter");
BLINK_BINDINGS_TRACE_EVENT("HTMLFencedFrameElement.sandbox.set");
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLFencedFrameElement_constructor");
BLINK_BINDINGS_TRACE_EVENT("HTMLFencedFrameElement.constructor");
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLFencedFrameElement::GetWrapperTypeInfo(), ElementType::kHTMLFencedFrameElement);
}

void CanLoadOpaqueURLStaticOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLFencedFrameElement_canLoadOpaqueURL");
BLINK_BINDINGS_TRACE_EVENT("HTMLFencedFrameElement.canLoadOpaqueURL");
...
auto&& return_value = HTMLFencedFrameElement::canLoadOpaqueURL(script_state);
...
using namespace v8_html_fenced_frame_element;

}  // namespace 

void V8HTMLFencedFrameElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8HTMLFencedFrameElement::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "HTMLFencedFrameElement"));
...
void V8HTMLFencedFrameElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLFencedFrameElement", kAttributeTable);
}
...
void V8HTMLFencedFrameElement::InstallContextIndependentProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
  using bindings::IDLMemberInstaller;
