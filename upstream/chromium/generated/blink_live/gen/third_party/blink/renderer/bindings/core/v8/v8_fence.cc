...
bool V8Fence::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8Fence::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8Fence::InstallInterfaceTemplate,
    nullptr,
    "Fence",
    nullptr,
    V8Fence::kThisTag,
    V8Fence::kMaxSubclassTag,
...
auto&& return_value = blink_receiver->getNestedConfigs(exception_state);
static_assert(bindings::IsReturnTypeCompatible<IDLSequence<FencedFrameConfig>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
void ReportEventOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Fence_reportEvent");
BLINK_BINDINGS_TRACE_EVENT("Fence.reportEvent");
...
void SetReportEventDataForAutomaticBeaconsOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Fence_setReportEventDataForAutomaticBeacons");
BLINK_BINDINGS_TRACE_EVENT("Fence.setReportEventDataForAutomaticBeacons");
...
using namespace v8_fence;

}  // namespace 

void V8Fence::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8Fence::GetWrapperTypeInfo();
...
void V8Fence::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"getNestedConfigs", GetNestedConfigsOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
{"reportEvent", ReportEventOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
{"setReportEventDataForAutomaticBeacons", SetReportEventDataForAutomaticBeaconsOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
};
v8::Local<v8::Signature> signature = v8::Local<v8::Signature>::Cast(interface_template);
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "Fence", kOperationTable);
}
