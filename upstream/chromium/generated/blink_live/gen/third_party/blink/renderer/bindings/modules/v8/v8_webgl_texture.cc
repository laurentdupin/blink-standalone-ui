...
bool V8WebGLTexture::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow() || execution_context->IsWorkerGlobalScope();
}

static_assert(std::derived_from<WebGLTexture, WebGLObject>);
...
const WrapperTypeInfo V8WebGLTexture::wrapper_type_info_{
    ...
    V8WebGLTexture::kThisTag,
    V8WebGLTexture::kMaxSubclassTag,
...
const WrapperTypeInfo& WebGLTexture::wrapper_type_info_ =
    V8WebGLTexture::wrapper_type_info_;
