...
const char Blocking[] = "Blocking";
const char InBodyParserBlocking[] = "InBodyParserBlocking";
const char NonBlocking[] = "NonBlocking";
const char NonBlockingDynamic[] = "NonBlockingDynamic";
const char PotentiallyBlocking[] = "PotentiallyBlocking";
} // namespace RenderBlockingBehaviorEnum
...
const char InsecureLocalNetwork[] = "InsecureLocalNetwork";
const char InvalidLocalNetworkAccess[] = "InvalidLocalNetworkAccess";
...
CRDTP_BEGIN_DESERIALIZER(DirectUDPSocketOptions)
    ...
    CRDTP_DESERIALIZE_FIELD_OPT("multicastAllowAddressSharing", m_multicastAllowAddressSharing),
    CRDTP_DESERIALIZE_FIELD_OPT("multicastLoopback", m_multicastLoopback),
    CRDTP_DESERIALIZE_FIELD_OPT("multicastTimeToLive", m_multicastTimeToLive),
    CRDTP_DESERIALIZE_FIELD_OPT("receiveBufferSize", m_receiveBufferSize),
...
CRDTP_BEGIN_SERIALIZER(DirectUDPSocketOptions)
    ...
    CRDTP_SERIALIZE_FIELD("sendBufferSize", m_sendBufferSize);
    CRDTP_SERIALIZE_FIELD("receiveBufferSize", m_receiveBufferSize);
    CRDTP_SERIALIZE_FIELD("multicastLoopback", m_multicastLoopback);
    CRDTP_SERIALIZE_FIELD("multicastTimeToLive", m_multicastTimeToLive);
    CRDTP_SERIALIZE_FIELD("multicastAllowAddressSharing", m_multicastAllowAddressSharing);
CRDTP_END_SERIALIZER();
...
CRDTP_BEGIN_DESERIALIZER(AdProvenance)
    CRDTP_DESERIALIZE_FIELD_OPT("adScriptAncestry", m_adScriptAncestry),
    CRDTP_DESERIALIZE_FIELD_OPT("filterlistRule", m_filterlistRule),
CRDTP_END_DESERIALIZER()

CRDTP_BEGIN_SERIALIZER(AdProvenance)
    CRDTP_SERIALIZE_FIELD("filterlistRule", m_filterlistRule);
    CRDTP_SERIALIZE_FIELD("adScriptAncestry", m_adScriptAncestry);
CRDTP_END_SERIALIZER();
...
const char Success[] = "Success";
const char KeyError[] = "KeyError";
const char SigningError[] = "SigningError";
const char TransientSigningError[] = "TransientSigningError";
const char ServerRequestedTermination[] = "ServerRequestedTermination";
const char InvalidSessionId[] = "InvalidSessionId";
const char InvalidChallenge[] = "InvalidChallenge";
const char TooManyChallenges[] = "TooManyChallenges";
const char InvalidFetcherUrl[] = "InvalidFetcherUrl";
const char InvalidRefreshUrl[] = "InvalidRefreshUrl";
const char TransientHttpError[] = "TransientHttpError";
const char ScopeOriginSameSiteMismatch[] = "ScopeOriginSameSiteMismatch";
const char RefreshUrlSameSiteMismatch[] = "RefreshUrlSameSiteMismatch";
const char MismatchedSessionId[] = "MismatchedSessionId";
const char MissingScope[] = "MissingScope";
const char NoCredentials[] = "NoCredentials";
const char SubdomainRegistrationWellKnownUnavailable[] = "SubdomainRegistrationWellKnownUnavailable";
const char SubdomainRegistrationUnauthorized[] = "SubdomainRegistrationUnauthorized";
const char SubdomainRegistrationWellKnownMalformed[] = "SubdomainRegistrationWellKnownMalformed";
const char SessionProviderWellKnownUnavailable[] = "SessionProviderWellKnownUnavailable";
const char RelyingPartyWellKnownUnavailable[] = "RelyingPartyWellKnownUnavailable";
const char FederatedKeyThumbprintMismatch[] = "FederatedKeyThumbprintMismatch";
const char InvalidFederatedSessionUrl[] = "InvalidFederatedSessionUrl";
const char InvalidFederatedKey[] = "InvalidFederatedKey";
const char TooManyRelyingOriginLabels[] = "TooManyRelyingOriginLabels";
const char BoundCookieSetForbidden[] = "BoundCookieSetForbidden";
const char NetError[] = "NetError";
const char ProxyError[] = "ProxyError";
const char EmptySessionConfig[] = "EmptySessionConfig";
const char InvalidCredentialsConfig[] = "InvalidCredentialsConfig";
const char InvalidCredentialsType[] = "InvalidCredentialsType";
const char InvalidCredentialsEmptyName[] = "InvalidCredentialsEmptyName";
const char InvalidCredentialsCookie[] = "InvalidCredentialsCookie";
const char PersistentHttpError[] = "PersistentHttpError";
const char RegistrationAttemptedChallenge[] = "RegistrationAttemptedChallenge";
const char InvalidScopeOrigin[] = "InvalidScopeOrigin";
const char ScopeOriginContainsPath[] = "ScopeOriginContainsPath";
const char RefreshInitiatorNotString[] = "RefreshInitiatorNotString";
const char RefreshInitiatorInvalidHostPattern[] = "RefreshInitiatorInvalidHostPattern";
const char InvalidScopeSpecification[] = "InvalidScopeSpecification";
const char MissingScopeSpecificationType[] = "MissingScopeSpecificationType";
const char EmptyScopeSpecificationDomain[] = "EmptyScopeSpecificationDomain";
const char EmptyScopeSpecificationPath[] = "EmptyScopeSpecificationPath";
const char InvalidScopeSpecificationType[] = "InvalidScopeSpecificationType";
const char InvalidScopeIncludeSite[] = "InvalidScopeIncludeSite";
const char MissingScopeIncludeSite[] = "MissingScopeIncludeSite";
const char FederatedNotAuthorizedByProvider[] = "FederatedNotAuthorizedByProvider";
const char FederatedNotAuthorizedByRelyingParty[] = "FederatedNotAuthorizedByRelyingParty";
const char SessionProviderWellKnownMalformed[] = "SessionProviderWellKnownMalformed";
const char SessionProviderWellKnownHasProviderOrigin[] = "SessionProviderWellKnownHasProviderOrigin";
const char RelyingPartyWellKnownMalformed[] = "RelyingPartyWellKnownMalformed";
const char RelyingPartyWellKnownHasRelyingOrigins[] = "RelyingPartyWellKnownHasRelyingOrigins";
const char InvalidFederatedSessionProviderSessionMissing[] = "InvalidFederatedSessionProviderSessionMissing";
const char InvalidFederatedSessionWrongProviderOrigin[] = "InvalidFederatedSessionWrongProviderOrigin";
const char InvalidCredentialsCookieCreationTime[] = "InvalidCredentialsCookieCreationTime";
const char InvalidCredentialsCookieName[] = "InvalidCredentialsCookieName";
const char InvalidCredentialsCookieParsing[] = "InvalidCredentialsCookieParsing";
const char InvalidCredentialsCookieUnpermittedAttribute[] = "InvalidCredentialsCookieUnpermittedAttribute";
const char InvalidCredentialsCookieInvalidDomain[] = "InvalidCredentialsCookieInvalidDomain";
const char InvalidCredentialsCookiePrefix[] = "InvalidCredentialsCookiePrefix";
const char InvalidScopeRulePath[] = "InvalidScopeRulePath";
const char InvalidScopeRuleHostPattern[] = "InvalidScopeRuleHostPattern";
const char ScopeRuleOriginScopedHostPatternMismatch[] = "ScopeRuleOriginScopedHostPatternMismatch";
const char ScopeRuleSiteScopedHostPatternMismatch[] = "ScopeRuleSiteScopedHostPatternMismatch";
const char SigningQuotaExceeded[] = "SigningQuotaExceeded";
const char InvalidConfigJson[] = "InvalidConfigJson";
const char InvalidFederatedSessionProviderFailedToRestoreKey[] = "InvalidFederatedSessionProviderFailedToRestoreKey";
const char FailedToUnwrapKey[] = "FailedToUnwrapKey";
const char SessionDeletedDuringRefresh[] = "SessionDeletedDuringRefresh";
const char CrossOriginRegistrationSiteNotIncluded[] = "CrossOriginRegistrationSiteNotIncluded";
} // namespace DeviceBoundSessionFetchResultEnum
...
const char* RefreshEventDetails::RefreshResultEnum::RefreshQuotaExceeded = "RefreshQuotaExceeded";
...
void Frontend::directUDPSocketJoinedMulticastGroup(const String& identifier, const String& IPAddress)
{
    if (!frontend_channel_)
        return;
    crdtp::ObjectSerializer serializer;
    serializer.AddField(crdtp::MakeSpan("identifier"), identifier);
    serializer.AddField(crdtp::MakeSpan("IPAddress"), IPAddress);
    frontend_channel_->SendProtocolNotification(crdtp::CreateNotification("Network.directUDPSocketJoinedMulticastGroup", serializer.Finish()));
}

void Frontend::directUDPSocketLeftMulticastGroup(const String& identifier, const String& IPAddress)
{
    if (!frontend_channel_)
        return;
    crdtp::ObjectSerializer serializer;
    serializer.AddField(crdtp::MakeSpan("identifier"), identifier);
    serializer.AddField(crdtp::MakeSpan("IPAddress"), IPAddress);
    frontend_channel_->SendProtocolNotification(crdtp::CreateNotification("Network.directUDPSocketLeftMulticastGroup", serializer.Finish()));
}
...
public:
    ...
    void setAcceptedEncodings(crdtp::Dispatchable& dispatchable);
    void clearAcceptedEncodingsOverride(crdtp::Dispatchable& dispatchable);
    void canClearBrowserCache(crdtp::Dispatchable& dispatchable);
    void canClearBrowserCookies(crdtp::Dispatchable& dispatchable);
    ...
    void overrideNetworkState(crdtp::Dispatchable& dispatchable);
    void enable(crdtp::Dispatchable& dispatchable);
    void configureDurableMessages(crdtp::Dispatchable& dispatchable);
    void getCertificate(crdtp::Dispatchable& dispatchable);
    void getResponseBody(crdtp::Dispatchable& dispatchable);
    void getRequestPostData(crdtp::Dispatchable& dispatchable);
    void replayXHR(crdtp::Dispatchable& dispatchable);
    void searchInResponseBody(crdtp::Dispatchable& dispatchable);
    void setBlockedURLs(crdtp::Dispatchable& dispatchable);
    ...
    void setAttachDebugStack(crdtp::Dispatchable& dispatchable);
    void streamResourceContent(crdtp::Dispatchable& dispatchable);
 protected:
    Backend* m_backend;
};
...
void DomainDispatcherImpl::setAcceptedEncodings(crdtp::Dispatchable& dispatchable)
{
...
void DomainDispatcherImpl::clearAcceptedEncodingsOverride(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
...
void DomainDispatcherImpl::canClearBrowserCache(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
...
void DomainDispatcherImpl::canClearBrowserCookies(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    // Declare output parameters.
    bool out_result;
...
void DomainDispatcherImpl::overrideNetworkState(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
...
void DomainDispatcherImpl::configureDurableMessages(crdtp::Dispatchable& dispatchable)
{
    ...
    std::unique_ptr<DomainDispatcher::WeakPtr> weak = weakPtr();
    DispatchResponse response = m_backend->configureDurableMessages(std::move(params.maxTotalBufferSize), std::move(params.maxResourceBufferSize));
    if (response.IsFallThrough()) {
        dispatchable.DispatchFallThrough(response.Message());
        return;
    }
...
void DomainDispatcherImpl::getCertificate(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
...
public:
    GetRequestPostDataCallbackImpl(std::unique_ptr<DomainDispatcher::WeakPtr> backendImpl, crdtp::Dispatchable& dispatchable)
        : DomainDispatcher::Callback(std::move(backendImpl), dispatchable, crdtp::SpanFrom("Network.getRequestPostData")) { }

    void sendSuccess(const String& postData, bool base64Encoded) override
    {
        crdtp::ObjectSerializer serializer;
...
void DomainDispatcherImpl::getRequestPostData(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
    ...
    m_backend->getRequestPostData(params.requestId, std::make_unique<GetRequestPostDataCallbackImpl>(weakPtr(), dispatchable));
}
...
void DomainDispatcherImpl::replayXHR(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
...
void DomainDispatcherImpl::searchInResponseBody(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
...
void DomainDispatcherImpl::setBlockedURLs(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
...
void DomainDispatcherImpl::setAttachDebugStack(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
...
void DomainDispatcherImpl::streamResourceContent(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
