...
bool V8SVGScriptElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<SVGScriptElement, SVGElement>);
...
const WrapperTypeInfo V8SVGScriptElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SVGScriptElement::InstallInterfaceTemplate,
    nullptr,
    "SVGScriptElement",
    V8SVGElement::GetWrapperTypeInfo(),
    V8SVGScriptElement::kThisTag,
    V8SVGScriptElement::kMaxSubclassTag,
...
const WrapperTypeInfo& SVGScriptElement::wrapper_type_info_ =
    V8SVGScriptElement::wrapper_type_info_;
...
namespace v8_svg_script_element {


void TypeAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SVGScriptElement_type_Getter");
BLINK_BINDINGS_TRACE_EVENT("SVGScriptElement.type.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SVGScriptElement_type_Setter");
BLINK_BINDINGS_TRACE_EVENT("SVGScriptElement.type.set");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SVGScriptElement_async_Getter");
BLINK_BINDINGS_TRACE_EVENT("SVGScriptElement.async.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
SVGScriptElement* blink_receiver = V8SVGScriptElement::ToWrappableUnsafe(isolate, v8_receiver);
auto&& return_value = blink_receiver->FastHasAttribute(svg_names::kAsyncAttr);
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SVGScriptElement_async_Setter");
BLINK_BINDINGS_TRACE_EVENT("SVGScriptElement.async.set");
...
blink_receiver->SetBooleanAttribute(svg_names::kAsyncAttr, arg1_value);
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SVGScriptElement_href_Getter");
BLINK_BINDINGS_TRACE_EVENT("SVGScriptElement.href.get");
v8::Isolate* isolate = info.GetIsolate();
...
using namespace v8_svg_script_element;

}  // namespace 

void V8SVGScriptElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SVGScriptElement::GetWrapperTypeInfo();
...
void V8SVGScriptElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGScriptElement", kAttributeTable);
}
...
void V8SVGScriptElement::InstallContextIndependentProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
  using bindings::IDLMemberInstaller;
