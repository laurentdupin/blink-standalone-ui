...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_MATH_CLAMP_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_MATH_CLAMP_H_
...
class CORE_EXPORT V8CSSMathClamp final : public bindings::V8InterfaceBridge<V8CSSMathClamp, CSSMathClamp> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(323);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSMathClamp;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_MATH_CLAMP_H_
