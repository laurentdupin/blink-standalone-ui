...
class CORE_EXPORT V8WritableStreamDefaultWriter final : public bindings::V8InterfaceBridge<V8WritableStreamDefaultWriter, WritableStreamDefaultWriter> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(961);
