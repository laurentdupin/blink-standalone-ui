...
public:
    ...
    void compositingReasons(crdtp::Dispatchable& dispatchable);
    void disable(crdtp::Dispatchable& dispatchable);
    void enable(crdtp::Dispatchable& dispatchable);
    void loadSnapshot(crdtp::Dispatchable& dispatchable);
    void makeSnapshot(crdtp::Dispatchable& dispatchable);
    void profileSnapshot(crdtp::Dispatchable& dispatchable);
    void releaseSnapshot(crdtp::Dispatchable& dispatchable);
    void replaySnapshot(crdtp::Dispatchable& dispatchable);
    void snapshotCommandLog(crdtp::Dispatchable& dispatchable);
 protected:
    Backend* m_backend;
};
...
void DomainDispatcherImpl::compositingReasons(crdtp::Dispatchable& dispatchable)
{
...
void DomainDispatcherImpl::loadSnapshot(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
...
void DomainDispatcherImpl::makeSnapshot(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
...
void DomainDispatcherImpl::profileSnapshot(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
...
void DomainDispatcherImpl::releaseSnapshot(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
...
void DomainDispatcherImpl::replaySnapshot(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
...
void DomainDispatcherImpl::snapshotCommandLog(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
