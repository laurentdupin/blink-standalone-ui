...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CANVAS_CAPTURE_MEDIA_STREAM_TRACK_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CANVAS_CAPTURE_MEDIA_STREAM_TRACK_H_
...
class MODULES_EXPORT V8CanvasCaptureMediaStreamTrack final : public bindings::V8InterfaceBridge<V8CanvasCaptureMediaStreamTrack, CanvasCaptureMediaStreamTrack> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(569);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CANVAS_CAPTURE_MEDIA_STREAM_TRACK_H_
