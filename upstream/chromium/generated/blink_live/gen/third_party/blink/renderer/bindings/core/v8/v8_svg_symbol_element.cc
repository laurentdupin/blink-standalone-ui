...
bool V8SVGSymbolElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<SVGSymbolElement, SVGGraphicsElement>);
...
const WrapperTypeInfo V8SVGSymbolElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SVGSymbolElement::InstallInterfaceTemplate,
    nullptr,
    "SVGSymbolElement",
    V8SVGGraphicsElement::GetWrapperTypeInfo(),
    V8SVGSymbolElement::kThisTag,
    V8SVGSymbolElement::kMaxSubclassTag,
...
const WrapperTypeInfo& SVGSymbolElement::wrapper_type_info_ =
    V8SVGSymbolElement::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, SVGSymbolElement>::value,
    "SVGSymbolElement inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_svg_symbol_element {
...
SVGSymbolElement* blink_receiver = V8SVGSymbolElement::ToWrappableUnsafe(isolate, v8_receiver);
...
using namespace v8_svg_symbol_element;

}  // namespace 

void V8SVGSymbolElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SVGSymbolElement::GetWrapperTypeInfo();
...
void V8SVGSymbolElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGSymbolElement", kAttributeTable);
}
