...
class MODULES_EXPORT V8ExtendableCookieChangeEvent final : public bindings::V8InterfaceBridge<V8ExtendableCookieChangeEvent, ExtendableCookieChangeEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(403);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class ExtendableCookieChangeEvent;
};
