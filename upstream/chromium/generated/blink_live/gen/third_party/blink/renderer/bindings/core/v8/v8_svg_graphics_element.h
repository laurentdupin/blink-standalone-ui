...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_GRAPHICS_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_GRAPHICS_ELEMENT_H_
...
class CORE_EXPORT V8SVGGraphicsElement final : public bindings::V8InterfaceBridge<V8SVGGraphicsElement, SVGGraphicsElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(714);
  static constexpr v8::CppHeapPointerTag kMaxSubclassTag =
      static_cast<v8::CppHeapPointerTag>(736);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGGraphicsElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_GRAPHICS_ELEMENT_H_
