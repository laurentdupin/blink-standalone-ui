...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_QUOTA_EXCEEDED_ERROR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_QUOTA_EXCEEDED_ERROR_H_
...
class CORE_EXPORT V8QuotaExceededError final : public bindings::V8InterfaceBridge<V8QuotaExceededError, QuotaExceededError> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class QuotaExceededError;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_QUOTA_EXCEEDED_ERROR_H_
