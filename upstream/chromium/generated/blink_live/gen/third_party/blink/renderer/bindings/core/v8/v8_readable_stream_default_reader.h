...
class CORE_EXPORT V8ReadableStreamDefaultReader final : public bindings::V8InterfaceBridge<V8ReadableStreamDefaultReader, ReadableStreamDefaultReader> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(954);
