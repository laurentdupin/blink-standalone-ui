...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DIGITAL_GOODS_SERVICE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DIGITAL_GOODS_SERVICE_H_
...
class MODULES_EXPORT V8DigitalGoodsService final : public bindings::V8InterfaceBridge<V8DigitalGoodsService, DigitalGoodsService> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1212);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class DigitalGoodsService;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DIGITAL_GOODS_SERVICE_H_
