...
return is_in_secure_context && execution_context->IsDedicatedWorkerGlobalScope();
}
...
const WrapperTypeInfo V8FileSystemSyncAccessHandle::wrapper_type_info_{
    ...
    nullptr,
    V8FileSystemSyncAccessHandle::kThisTag,
    V8FileSystemSyncAccessHandle::kMaxSubclassTag,
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_FileSystemSyncAccessHandle_mode_Getter");
BLINK_BINDINGS_TRACE_EVENT("FileSystemSyncAccessHandle.mode.get");
...
FileSystemSyncAccessHandle* blink_receiver = V8FileSystemSyncAccessHandle::ToWrappableUnsafe(isolate, v8_receiver);
ExceptionState exception_state(isolate);
auto&& return_value = blink_receiver->getSize(exception_state);
...
ExceptionState exception_state(isolate);
auto&& arg1_buffer = NativeValueTraits<PassAsSpan<PassAsSpanMarkerBase::Flags::kAllowShared | kPerformDetachCheckFlag, void>>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
decltype(NativeValueTraits<FileSystemReadWriteOptions>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg2_options;
...
void V8FileSystemSyncAccessHandle::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"getSize", GetSizeOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "FileSystemSyncAccessHandle", kOperationTable);
}
...
void V8FileSystemSyncAccessHandle::InstallContextIndependentProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
  using bindings::IDLMemberInstaller;
...
v8::Local<v8::Signature> signature = v8::Local<v8::Signature>::Cast(interface_template);
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "FileSystemSyncAccessHandle", kAttributeTable);
}
