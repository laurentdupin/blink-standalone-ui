...
class MODULES_EXPORT V8RTCIceComponent final : public bindings::EnumerationBase {
...
static V8RTCIceComponent Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8RTCIceComponent> Create(const String& value);

explicit constexpr  V8RTCIceComponent(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8RTCIceComponent& lhs, V8RTCIceComponent::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8RTCIceComponent::Enum lhs, const V8RTCIceComponent& rhs) {
