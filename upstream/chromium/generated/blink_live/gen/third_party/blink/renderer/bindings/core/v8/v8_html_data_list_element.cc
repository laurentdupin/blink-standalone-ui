...
bool V8HTMLDataListElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<HTMLDataListElement, HTMLElement>);
...
const WrapperTypeInfo V8HTMLDataListElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8HTMLDataListElement::InstallInterfaceTemplate,
    nullptr,
    "HTMLDataListElement",
    V8HTMLElement::GetWrapperTypeInfo(),
    V8HTMLDataListElement::kThisTag,
    V8HTMLDataListElement::kMaxSubclassTag,
...
const WrapperTypeInfo& HTMLDataListElement::wrapper_type_info_ =
    V8HTMLDataListElement::wrapper_type_info_;
...
namespace v8_html_data_list_element {
...
BLINK_BINDINGS_TRACE_EVENT("HTMLDataListElement.options.get");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLDataListElement.constructor");
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLDataListElement::GetWrapperTypeInfo(), ElementType::kHTMLDataListElement);
}


}  // namespace v8_html_data_list_element

using namespace v8_html_data_list_element;

}  // namespace 

void V8HTMLDataListElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8HTMLDataListElement::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "HTMLDataListElement"));
...
void V8HTMLDataListElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLDataListElement", kAttributeTable);
}
