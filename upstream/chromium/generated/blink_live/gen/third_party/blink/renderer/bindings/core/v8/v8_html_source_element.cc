...
static_assert(std::derived_from<HTMLSourceElement, HTMLElement>);
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLSourceElement::GetWrapperTypeInfo(), ElementType::kHTMLSourceElement);
}
...
void V8HTMLSourceElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLSourceElement", kAttributeTable);
}
