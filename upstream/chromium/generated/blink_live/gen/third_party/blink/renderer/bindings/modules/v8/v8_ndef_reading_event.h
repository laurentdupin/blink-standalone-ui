...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_NDEF_READING_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_NDEF_READING_EVENT_H_
...
class MODULES_EXPORT V8NDEFReadingEvent final : public bindings::V8InterfaceBridge<V8NDEFReadingEvent, NDEFReadingEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(432);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class NDEFReadingEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_NDEF_READING_EVENT_H_
