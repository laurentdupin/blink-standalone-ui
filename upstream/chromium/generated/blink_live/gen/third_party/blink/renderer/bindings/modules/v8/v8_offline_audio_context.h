...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OFFLINE_AUDIO_CONTEXT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OFFLINE_AUDIO_CONTEXT_H_
...
class MODULES_EXPORT V8OfflineAudioContext final : public bindings::V8InterfaceBridge<V8OfflineAudioContext, OfflineAudioContext> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(530);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OFFLINE_AUDIO_CONTEXT_H_
