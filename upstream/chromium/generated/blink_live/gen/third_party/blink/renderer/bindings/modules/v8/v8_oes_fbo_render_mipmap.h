...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_FBO_RENDER_MIPMAP_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_FBO_RENDER_MIPMAP_H_
...
class MODULES_EXPORT V8OESFboRenderMipmap final : public bindings::V8InterfaceBridge<V8OESFboRenderMipmap, OESFboRenderMipmap> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1315);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class OESFboRenderMipmap;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_FBO_RENDER_MIPMAP_H_
