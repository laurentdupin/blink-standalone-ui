...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_MATH_SUM_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_MATH_SUM_H_
...
class CORE_EXPORT V8CSSMathSum final : public bindings::V8InterfaceBridge<V8CSSMathSum, CSSMathSum> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSMathSum;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_MATH_SUM_H_
