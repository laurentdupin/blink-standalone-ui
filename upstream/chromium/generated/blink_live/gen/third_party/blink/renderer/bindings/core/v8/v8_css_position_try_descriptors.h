...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_POSITION_TRY_DESCRIPTORS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_POSITION_TRY_DESCRIPTORS_H_
...
class CORE_EXPORT V8CSSPositionTryDescriptors final : public bindings::V8InterfaceBridge<V8CSSPositionTryDescriptors, CSSPositionTryDescriptors> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSPositionTryDescriptors;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_POSITION_TRY_DESCRIPTORS_H_
