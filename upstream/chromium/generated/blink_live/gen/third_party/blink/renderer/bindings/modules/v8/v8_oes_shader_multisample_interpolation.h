...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_SHADER_MULTISAMPLE_INTERPOLATION_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_SHADER_MULTISAMPLE_INTERPOLATION_H_
...
class MODULES_EXPORT V8OESShaderMultisampleInterpolation final : public bindings::V8InterfaceBridge<V8OESShaderMultisampleInterpolation, OESShaderMultisampleInterpolation> {
...
class Constant final {
  ...
  public:
static constexpr uint32_t kMinFragmentInterpolationOffsetOes = 0x8E5B;
static constexpr uint32_t kMaxFragmentInterpolationOffsetOes = 0x8E5C;
static constexpr uint32_t kFragmentInterpolationOffsetBitsOes = 0x8E5D;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1317);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class OESShaderMultisampleInterpolation;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_SHADER_MULTISAMPLE_INTERPOLATION_H_
