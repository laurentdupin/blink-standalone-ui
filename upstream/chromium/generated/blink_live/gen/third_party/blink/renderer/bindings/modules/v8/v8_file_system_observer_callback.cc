...
const char* V8FileSystemObserverCallback::GetHumanReadableName() const {
  return "V8FileSystemObserverCallback";
}

v8::Maybe<void> V8FileSystemObserverCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<FileSystemChangeRecord>>& arg1_records, FileSystemObserver* arg2_observer) {
  const char* const class_like_name = "FileSystemObserverCallback";
...
v8::Maybe<void> V8FileSystemObserverCallback::Construct(const HeapVector<Member<FileSystemChangeRecord>>& arg1_records, FileSystemObserver* arg2_observer) {
  const char* const class_like_name = "FileSystemObserverCallback";
...
void V8FileSystemObserverCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<FileSystemChangeRecord>>& arg1_records, FileSystemObserver* arg2_observer) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = Invoke(arg0_receiver, arg1_records, arg2_observer);
}

base::expected<void, ScriptValue> V8FileSystemObserverCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<FileSystemChangeRecord>>& arg1_records, FileSystemObserver* arg2_observer) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_records, arg2_observer);
