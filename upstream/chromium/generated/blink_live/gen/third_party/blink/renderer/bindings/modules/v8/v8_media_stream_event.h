...
class MODULES_EXPORT V8MediaStreamEvent final : public bindings::V8InterfaceBridge<V8MediaStreamEvent, MediaStreamEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(428);
