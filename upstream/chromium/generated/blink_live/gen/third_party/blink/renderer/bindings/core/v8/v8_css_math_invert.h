...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_MATH_INVERT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_MATH_INVERT_H_
...
class CORE_EXPORT V8CSSMathInvert final : public bindings::V8InterfaceBridge<V8CSSMathInvert, CSSMathInvert> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(324);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSMathInvert;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_MATH_INVERT_H_
