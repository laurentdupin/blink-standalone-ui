...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SMART_CARD_CONTEXT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SMART_CARD_CONTEXT_H_
...
class MODULES_EXPORT V8SmartCardContext final : public bindings::V8InterfaceBridge<V8SmartCardContext, SmartCardContext> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1462);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SmartCardContext;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SMART_CARD_CONTEXT_H_
