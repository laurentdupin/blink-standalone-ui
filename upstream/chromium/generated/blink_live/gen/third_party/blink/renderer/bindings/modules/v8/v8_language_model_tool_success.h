...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_LANGUAGE_MODEL_TOOL_SUCCESS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_LANGUAGE_MODEL_TOOL_SUCCESS_H_
...
class MODULES_EXPORT V8LanguageModelToolSuccess final : public bindings::V8InterfaceBridge<V8LanguageModelToolSuccess, LanguageModelToolSuccess> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1072);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class LanguageModelToolSuccess;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_LANGUAGE_MODEL_TOOL_SUCCESS_H_
