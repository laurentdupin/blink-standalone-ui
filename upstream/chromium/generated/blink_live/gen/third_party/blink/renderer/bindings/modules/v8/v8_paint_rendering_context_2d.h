...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PAINT_RENDERING_CONTEXT_2D_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PAINT_RENDERING_CONTEXT_2D_H_
...
class MODULES_EXPORT V8PaintRenderingContext2D final : public bindings::V8InterfaceBridge<V8PaintRenderingContext2D, PaintRenderingContext2D> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1135);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PaintRenderingContext2D;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PAINT_RENDERING_CONTEXT_2D_H_
