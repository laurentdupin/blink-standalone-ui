...
const WrapperTypeInfo& Scheduling::wrapper_type_info_ =
    V8Scheduling::wrapper_type_info_;
...
void V8Scheduling::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
