...
bool V8SVGAnimatedTransformList::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8SVGAnimatedTransformList::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SVGAnimatedTransformList::InstallInterfaceTemplate,
    nullptr,
    "SVGAnimatedTransformList",
    nullptr,
    V8SVGAnimatedTransformList::kThisTag,
    V8SVGAnimatedTransformList::kMaxSubclassTag,
...
const WrapperTypeInfo& SVGAnimatedTransformList::wrapper_type_info_ =
    V8SVGAnimatedTransformList::wrapper_type_info_;
...
namespace v8_svg_animated_transform_list {
...
BLINK_BINDINGS_TRACE_EVENT("SVGAnimatedTransformList.baseVal.get");
v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Context> current_context = isolate->GetCurrentContext();
ScriptState* current_script_state = ScriptState::From(isolate, current_context);
ExecutionContext* current_execution_context = ToExecutionContext(current_script_state);
// [Measure], [MeasureAs]
UseCounter::Count(current_execution_context, WebFeature::kSVGAnimatedTransformListBaseVal);
...
static_assert(bindings::IsReturnTypeCompatible<SVGTransformListTearOff, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
BLINK_BINDINGS_TRACE_EVENT("SVGAnimatedTransformList.animVal.get");
...
using namespace v8_svg_animated_transform_list;

}  // namespace 

void V8SVGAnimatedTransformList::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SVGAnimatedTransformList::GetWrapperTypeInfo();
...
void V8SVGAnimatedTransformList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGAnimatedTransformList", kAttributeTable);
}
