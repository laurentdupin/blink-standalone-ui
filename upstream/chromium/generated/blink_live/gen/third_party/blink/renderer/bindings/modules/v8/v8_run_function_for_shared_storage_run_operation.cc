...
const char* V8RunFunctionForSharedStorageRunOperation::GetHumanReadableName() const {
  return "V8RunFunctionForSharedStorageRunOperation";
}

v8::Maybe<ScriptPromise<IDLAny>> V8RunFunctionForSharedStorageRunOperation::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const ScriptValue& arg1_data) {
...
base::expected<ScriptPromise<IDLAny>, ScriptValue> V8RunFunctionForSharedStorageRunOperation::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const ScriptValue& arg1_data) {
