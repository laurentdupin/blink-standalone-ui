...
base::expected<ScriptValue, ScriptValue> V8Reducer::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const ScriptValue& arg1_accumulator, const ScriptValue& arg2_current_value, uint64_t arg3_index) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_accumulator, arg2_current_value, arg3_index);
