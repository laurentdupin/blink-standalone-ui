...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_POLYGON_MODE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_POLYGON_MODE_H_
...
class MODULES_EXPORT V8WebGLPolygonMode final : public bindings::V8InterfaceBridge<V8WebGLPolygonMode, WebGLPolygonMode> {
...
class Constant final {
  ...
  public:
static constexpr uint32_t kPolygonModeWebgl = 0x0B40;
static constexpr uint32_t kPolygonOffsetLineWebgl = 0x2A02;
static constexpr uint32_t kLineWebgl = 0x1B01;
static constexpr uint32_t kFillWebgl = 0x1B02;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1359);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_POLYGON_MODE_H_
