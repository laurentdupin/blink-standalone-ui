...
class CORE_EXPORT V8SVGLinearGradientElement final : public bindings::V8InterfaceBridge<V8SVGLinearGradientElement, SVGLinearGradientElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(712);
