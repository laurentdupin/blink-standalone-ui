...
static_assert(std::derived_from<HTMLFontElement, HTMLElement>);
...
bindings::PerformAttributeSetCEReactionsReflectTypeStringLegacyNullToEmptyString(info, html_names::kColorAttr);
}
...
bindings::PerformAttributeSetCEReactionsReflectTypeString(info, html_names::kFaceAttr);
}
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLFontElement::GetWrapperTypeInfo(), ElementType::kHTMLFontElement);
}
...
void V8HTMLFontElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLFontElement", kAttributeTable);
}
