...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_UNION_ARRAYBUFFER_ARRAYBUFFERVIEW_BLOB_USVSTRING_WRITEPARAMS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_UNION_ARRAYBUFFER_ARRAYBUFFERVIEW_BLOB_USVSTRING_WRITEPARAMS_H_
...
class MODULES_EXPORT V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVStringOrWriteParams final : public bindings::UnionBase {
  
  public:
// The type of the content value of this IDL union.
enum class ContentType {
kArrayBuffer, kArrayBufferView, kBlob, kUSVString, kWriteParams
};

static V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVStringOrWriteParams* Create(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state);

explicit  V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVStringOrWriteParams(DOMArrayBuffer* value) : content_type_(ContentType::kArrayBuffer), member_array_buffer_(value) {
  DCHECK(value);
}
explicit  V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVStringOrWriteParams(NotShared<DOMArrayBufferView> value) : content_type_(ContentType::kArrayBufferView), member_array_buffer_view_(value) {
  DCHECK(value);
}
explicit  V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVStringOrWriteParams(Blob* value) : content_type_(ContentType::kBlob), member_blob_(value) {
  DCHECK(value);
}
explicit  V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVStringOrWriteParams(const String& value);
explicit  V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVStringOrWriteParams(String&& value);
explicit  V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVStringOrWriteParams(WriteParams* value) : content_type_(ContentType::kWriteParams), member_write_params_(value) {
  DCHECK(value);
}
...
bool IsWriteParams() const {
  return content_type_ == ContentType::kWriteParams;
}
WriteParams* GetAsWriteParams() const {
  DCHECK_EQ(content_type_, ContentType::kWriteParams);
return member_write_params_.Get();
}
void Set(WriteParams* value) {
  DCHECK(value);
Clear();
member_write_params_ = value;
content_type_ = ContentType::kWriteParams;
}
...
using Ret = bindings::OptimizedReturnProxy<V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVStringOrWriteParams>;
...
static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, WriteParams* value);
...
static constexpr const char* UnionNameInIDL() {
  return "(ArrayBuffer or ArrayBufferView or Blob or USVString or WriteParams)";
}
...
Member<WriteParams> member_write_params_;
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_UNION_ARRAYBUFFER_ARRAYBUFFERVIEW_BLOB_USVSTRING_WRITEPARAMS_H_
