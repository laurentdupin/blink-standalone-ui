...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NODE_LIST_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NODE_LIST_H_
...
class CORE_EXPORT V8NodeList final : public bindings::V8InterfaceBridge<V8NodeList, NodeList> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(837);
  static constexpr v8::CppHeapPointerTag kMaxSubclassTag =
      static_cast<v8::CppHeapPointerTag>(838);
...
static uint32_t IndexedPropertyIndexOfCallback(v8::Local<v8::Value> needle, uint32_t start_index, uint32_t end_index, uint32_t* out_length, const v8::PropertyCallbackInfo<void>& info);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NODE_LIST_H_
