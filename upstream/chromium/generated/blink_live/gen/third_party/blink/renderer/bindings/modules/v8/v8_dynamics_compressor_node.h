...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DYNAMICS_COMPRESSOR_NODE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DYNAMICS_COMPRESSOR_NODE_H_
...
class MODULES_EXPORT V8DynamicsCompressorNode final : public bindings::V8InterfaceBridge<V8DynamicsCompressorNode, DynamicsCompressorNode> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(516);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DYNAMICS_COMPRESSOR_NODE_H_
