...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ORIENTATION_SENSOR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ORIENTATION_SENSOR_H_
...
class MODULES_EXPORT V8OrientationSensor final : public bindings::V8InterfaceBridge<V8OrientationSensor, OrientationSensor> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(780);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ORIENTATION_SENSOR_H_
