...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_FEDERATED_CREDENTIAL_INIT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_FEDERATED_CREDENTIAL_INIT_H_
...
class MODULES_EXPORT FederatedCredentialInit : public CredentialData {
  ...
  public:
static FederatedCredentialInit* Create() {
  return MakeGarbageCollected<FederatedCredentialInit>();
}
static FederatedCredentialInit* Create(v8::Isolate* isolate) {
  return MakeGarbageCollected<FederatedCredentialInit>(isolate);
}
static FederatedCredentialInit* Create(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state);

explicit  FederatedCredentialInit();
explicit  FederatedCredentialInit(v8::Isolate* isolate);
...
const String& provider() const {
  return member_provider_;
}
void setProvider(const String& value);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_FEDERATED_CREDENTIAL_INIT_H_
