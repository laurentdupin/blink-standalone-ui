...
static_assert(std::derived_from<HTMLLabelElement, HTMLElement>);
...
const WrapperTypeInfo V8HTMLLabelElement::wrapper_type_info_{
    ...
    V8HTMLLabelElement::kThisTag,
    V8HTMLLabelElement::kMaxSubclassTag,
...
v8::Local<v8::Object> v8_receiver = info.This();
HTMLLabelElement* blink_receiver = V8HTMLLabelElement::ToWrappableUnsafe(isolate, v8_receiver);
auto&& return_value = blink_receiver->controlForBinding();
static_assert(bindings::IsReturnTypeCompatible<IDLNullable<HTMLElement>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
}
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLLabelElement::GetWrapperTypeInfo(), ElementType::kHTMLLabelElement);
}
...
interface_function_template->SetInterfaceName(V8String(isolate, "HTMLLabelElement"));
...
void V8HTMLLabelElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLLabelElement", kAttributeTable);
}
