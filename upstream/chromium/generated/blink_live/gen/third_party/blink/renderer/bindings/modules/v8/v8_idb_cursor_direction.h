...
class MODULES_EXPORT V8IDBCursorDirection final : public bindings::EnumerationBase {
  
  public:
enum class Enum : enum_int_t {
kNext, kNextunique, kPrev, kPrevunique
};
static constexpr size_t kEnumSize = 4;

static V8IDBCursorDirection Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8IDBCursorDirection> Create(const String& value);

explicit constexpr  V8IDBCursorDirection(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8IDBCursorDirection& lhs, V8IDBCursorDirection::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8IDBCursorDirection::Enum lhs, const V8IDBCursorDirection& rhs) {
