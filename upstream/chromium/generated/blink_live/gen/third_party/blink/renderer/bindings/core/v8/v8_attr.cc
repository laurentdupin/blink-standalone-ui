...
bool V8Attr::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<Attr, Node>);
...
const WrapperTypeInfo V8Attr::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8Attr::InstallInterfaceTemplate,
    nullptr,
    "Attr",
    V8Node::GetWrapperTypeInfo(),
    V8Attr::kThisTag,
    V8Attr::kMaxSubclassTag,
...
BLINK_BINDINGS_TRACE_EVENT("Attr.namespaceURI.get");
...
BLINK_BINDINGS_TRACE_EVENT("Attr.prefix.get");
...
BLINK_BINDINGS_TRACE_EVENT("Attr.localName.get");
...
BLINK_BINDINGS_TRACE_EVENT("Attr.name.get");
...
BLINK_BINDINGS_TRACE_EVENT("Attr.value.get");
...
BLINK_BINDINGS_TRACE_EVENT("Attr.value.set");
...
void OwnerElementAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Attr_ownerElement_Getter");
BLINK_BINDINGS_TRACE_EVENT("Attr.ownerElement.get");
...
void SpecifiedAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Attr_specified_Getter");
BLINK_BINDINGS_TRACE_EVENT("Attr.specified.get");
...
using namespace v8_attr;

}  // namespace 

void V8Attr::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8Attr::GetWrapperTypeInfo();
...
void V8Attr::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"ownerElement", OwnerElementAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
{"specified", SpecifiedAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
};
v8::Local<v8::Signature> signature = v8::Local<v8::Signature>::Cast(interface_template);
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "Attr", kAttributeTable);
}
