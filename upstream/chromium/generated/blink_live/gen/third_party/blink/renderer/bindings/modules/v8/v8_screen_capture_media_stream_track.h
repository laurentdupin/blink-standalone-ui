...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SCREEN_CAPTURE_MEDIA_STREAM_TRACK_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SCREEN_CAPTURE_MEDIA_STREAM_TRACK_H_
...
class ScreenCaptureMediaStreamTrack;
struct WrapperTypeInfo;

class MODULES_EXPORT V8ScreenCaptureMediaStreamTrack final : public bindings::V8InterfaceBridge<V8ScreenCaptureMediaStreamTrack, ScreenCaptureMediaStreamTrack> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(571);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class ScreenCaptureMediaStreamTrack;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SCREEN_CAPTURE_MEDIA_STREAM_TRACK_H_
