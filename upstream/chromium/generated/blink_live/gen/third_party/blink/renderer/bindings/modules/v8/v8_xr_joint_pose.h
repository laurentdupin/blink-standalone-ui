...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_JOINT_POSE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_JOINT_POSE_H_
...
class MODULES_EXPORT V8XRJointPose final : public bindings::V8InterfaceBridge<V8XRJointPose, XRJointPose> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1442);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XRJointPose;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_JOINT_POSE_H_
