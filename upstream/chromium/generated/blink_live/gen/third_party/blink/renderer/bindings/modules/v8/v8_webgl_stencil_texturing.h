...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_STENCIL_TEXTURING_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_STENCIL_TEXTURING_H_
...
class MODULES_EXPORT V8WebGLStencilTexturing final : public bindings::V8InterfaceBridge<V8WebGLStencilTexturing, WebGLStencilTexturing> {
...
class Constant final {
  ...
  public:
static constexpr uint32_t kDepthStencilTextureModeWebgl = 0x90EA;
static constexpr uint32_t kStencilIndexWebgl = 0x1901;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1366);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class WebGLStencilTexturing;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_STENCIL_TEXTURING_H_
