...
class MODULES_EXPORT V8MediaStreamTrack final : public bindings::V8InterfaceBridge<V8MediaStreamTrack, MediaStreamTrack> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(567);
