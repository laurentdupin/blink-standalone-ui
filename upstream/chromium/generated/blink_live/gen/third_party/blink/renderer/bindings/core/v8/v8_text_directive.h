...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TEXT_DIRECTIVE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TEXT_DIRECTIVE_H_
...
class CORE_EXPORT V8TextDirective final : public bindings::V8InterfaceBridge<V8TextDirective, TextDirective> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class TextDirective;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TEXT_DIRECTIVE_H_
