...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_DOM_RECT_READ_ONLY_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_DOM_RECT_READ_ONLY_H_
...
class CORE_EXPORT V8DOMRectReadOnly final : public bindings::V8InterfaceBridge<V8DOMRectReadOnly, DOMRectReadOnly> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(887);
  static constexpr v8::CppHeapPointerTag kMaxSubclassTag =
      static_cast<v8::CppHeapPointerTag>(888);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class DOMRectReadOnly;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_DOM_RECT_READ_ONLY_H_
