...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SHARED_STORAGE_DELETE_METHOD_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SHARED_STORAGE_DELETE_METHOD_H_
...
class MODULES_EXPORT V8SharedStorageDeleteMethod final : public bindings::V8InterfaceBridge<V8SharedStorageDeleteMethod, SharedStorageDeleteMethod> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1257);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SharedStorageDeleteMethod;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SHARED_STORAGE_DELETE_METHOD_H_
