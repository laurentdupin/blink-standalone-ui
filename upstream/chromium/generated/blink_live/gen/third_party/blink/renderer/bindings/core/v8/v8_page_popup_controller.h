...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PAGE_POPUP_CONTROLLER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PAGE_POPUP_CONTROLLER_H_
...
class CORE_EXPORT V8PagePopupController final : public bindings::V8InterfaceBridge<V8PagePopupController, PagePopupController> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(936);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PagePopupController;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PAGE_POPUP_CONTROLLER_H_
