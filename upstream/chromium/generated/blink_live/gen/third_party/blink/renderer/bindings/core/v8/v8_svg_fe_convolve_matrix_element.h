...
class CORE_EXPORT V8SVGFEConvolveMatrixElement final : public bindings::V8InterfaceBridge<V8SVGFEConvolveMatrixElement, SVGFEConvolveMatrixElement> {
...
class Constant final {
  ...
  public:
static constexpr uint16_t kSVGEdgemodeUnknown = 0;
static constexpr uint16_t kSVGEdgemodeDuplicate = 1;
static constexpr uint16_t kSVGEdgemodeWrap = 2;
static constexpr uint16_t kSVGEdgemodeNone = 3;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(693);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGFEConvolveMatrixElement;
};
