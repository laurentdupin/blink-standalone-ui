...
class CORE_EXPORT V8CSSTransformComponent final : public bindings::V8InterfaceBridge<V8CSSTransformComponent, CSSTransformComponent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(335);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSTransformComponent;
};
