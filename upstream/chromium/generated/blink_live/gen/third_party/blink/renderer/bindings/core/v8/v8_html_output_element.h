...
class CORE_EXPORT V8HTMLOutputElement final : public bindings::V8InterfaceBridge<V8HTMLOutputElement, HTMLOutputElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(647);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class HTMLOutputElement;
};
