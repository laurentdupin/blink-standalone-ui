...
class CORE_EXPORT V8HTMLTableRowElement final : public bindings::V8InterfaceBridge<V8HTMLTableRowElement, HTMLTableRowElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(665);
