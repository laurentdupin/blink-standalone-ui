...
class MODULES_EXPORT V8MediaStreamTrackEvent final : public bindings::V8InterfaceBridge<V8MediaStreamTrackEvent, MediaStreamTrackEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(429);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class MediaStreamTrackEvent;
};
