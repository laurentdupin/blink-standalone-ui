...
using Ret = bindings::OptimizedReturnProxy<V8UnionMediaStreamTrackAudioStatsOrMediaStreamTrackVideoStats>;
v8::Local<v8::Value> ToV8(ScriptState* script_state) const;

static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, MediaStreamTrackAudioStats* value);
static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, MediaStreamTrackVideoStats* value);
