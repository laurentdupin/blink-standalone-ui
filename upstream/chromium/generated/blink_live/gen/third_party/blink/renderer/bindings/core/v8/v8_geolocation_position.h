...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_GEOLOCATION_POSITION_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_GEOLOCATION_POSITION_H_
...
class CORE_EXPORT V8GeolocationPosition final : public bindings::V8InterfaceBridge<V8GeolocationPosition, Geoposition> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(879);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class Geoposition;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_GEOLOCATION_POSITION_H_
