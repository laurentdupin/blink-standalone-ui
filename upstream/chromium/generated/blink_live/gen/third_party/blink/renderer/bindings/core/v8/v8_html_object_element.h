...
class CORE_EXPORT V8HTMLObjectElement final : public bindings::V8InterfaceBridge<V8HTMLObjectElement, HTMLObjectElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(644);
