...
const char* V8PositionCallback::GetHumanReadableName() const {
...
v8_arg1_position = ToV8Traits<Geoposition>::ToV8(script_state, arg1_position);
...
base::expected<void, ScriptValue> V8PositionCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, Geoposition* arg1_position) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_position);
