...
bool V8CrashReportContext::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow() && RuntimeEnabledFeatures::CrashReportingStorageAPIEnabled(execution_context);
}
...
const WrapperTypeInfo V8CrashReportContext::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8CrashReportContext::InstallInterfaceTemplate,
    nullptr,
    "CrashReportContext",
    nullptr,
    V8CrashReportContext::kThisTag,
    V8CrashReportContext::kMaxSubclassTag,
...
const WrapperTypeInfo& CrashReportContext::wrapper_type_info_ =
    V8CrashReportContext::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, CrashReportContext>::value,
    "CrashReportContext inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_crash_report_context {

void DeleteOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CrashReportContext_delete");
BLINK_BINDINGS_TRACE_EVENT("CrashReportContext.delete");
...
CrashReportContext* blink_receiver = V8CrashReportContext::ToWrappableUnsafe(isolate, v8_receiver);
ExceptionState exception_state(isolate);
auto&& arg1_key = NativeValueTraits<IDLString>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
blink_receiver->deleteKey(arg1_key, exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
void InitializeOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CrashReportContext_initialize");
BLINK_BINDINGS_TRACE_EVENT("CrashReportContext.initialize");
// Promise returning function: Convert a TypeError to a reject promise.
ExceptionToRejectPromiseScope reject_promise_scope(info);

v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
if (!V8CrashReportContext::HasInstance(isolate, v8_receiver)) {
  V8ThrowException::ThrowTypeError(isolate, "Illegal invocation");
return;
}

// [Measure], [MeasureAs]
bindings::CountWebDXFeature(isolate, WebDXFeature::kDRAFT_CrashReportStorageAPIInitialize);
...
const char* const class_like_name = "CrashReportContext";
...
auto&& return_value = blink_receiver->initialize(script_state, arg1_length, exception_state);
...
void SetOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CrashReportContext_set");
BLINK_BINDINGS_TRACE_EVENT("CrashReportContext.set");
...
blink_receiver->set(arg1_key, arg2_value, exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
using namespace v8_crash_report_context;

}  // namespace 

void V8CrashReportContext::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8CrashReportContext::GetWrapperTypeInfo();
...
void V8CrashReportContext::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"initialize", InitializeOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kDoNotCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "CrashReportContext", kOperationTable);
}
