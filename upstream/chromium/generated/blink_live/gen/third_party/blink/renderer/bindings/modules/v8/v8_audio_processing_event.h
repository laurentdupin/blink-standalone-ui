...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_AUDIO_PROCESSING_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_AUDIO_PROCESSING_EVENT_H_
...
class MODULES_EXPORT V8AudioProcessingEvent final : public bindings::V8InterfaceBridge<V8AudioProcessingEvent, AudioProcessingEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(376);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class AudioProcessingEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_AUDIO_PROCESSING_EVENT_H_
