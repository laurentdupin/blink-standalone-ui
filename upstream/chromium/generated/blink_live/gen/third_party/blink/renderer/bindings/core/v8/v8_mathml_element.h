...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_MATHML_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_MATHML_ELEMENT_H_
...
class CORE_EXPORT V8MathMLElement final : public bindings::V8InterfaceBridge<V8MathMLElement, MathMLElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(675);
...
static InstallContextDependentPropertiesFuncType install_context_dependent_props_func_;
  ...
  friend class MathMLElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_MATHML_ELEMENT_H_
