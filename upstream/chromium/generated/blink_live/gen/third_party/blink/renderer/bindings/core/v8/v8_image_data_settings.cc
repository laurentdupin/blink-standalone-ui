...
if (!bindings::GetDictionaryMemberFromV8Object<V8ImageDataPixelFormat, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate), fallback_presence_var, member_pixel_format_, class_like_name, exception_state)) {
  return;
}
}
}
