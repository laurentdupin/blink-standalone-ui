...
bool V8MojoInterfaceRequestEvent::IsExposed(ExecutionContext* execution_context) {
  
return (execution_context->IsWindow() || execution_context->IsWorkerGlobalScope()) && RuntimeEnabledFeatures::MojoJSTestEnabled();
}

static_assert(std::derived_from<MojoInterfaceRequestEvent, Event>);
...
const WrapperTypeInfo V8MojoInterfaceRequestEvent::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8MojoInterfaceRequestEvent::InstallInterfaceTemplate,
    nullptr,
    "MojoInterfaceRequestEvent",
    V8Event::GetWrapperTypeInfo(),
    V8MojoInterfaceRequestEvent::kThisTag,
    V8MojoInterfaceRequestEvent::kMaxSubclassTag,
...
const WrapperTypeInfo& MojoInterfaceRequestEvent::wrapper_type_info_ =
    V8MojoInterfaceRequestEvent::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, MojoInterfaceRequestEvent>::value,
    "MojoInterfaceRequestEvent inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_mojo_interface_request_event {
...
BLINK_BINDINGS_TRACE_EVENT("MojoInterfaceRequestEvent.handle.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
MojoInterfaceRequestEvent* blink_receiver = V8MojoInterfaceRequestEvent::ToWrappableUnsafe(isolate, v8_receiver);
...
BLINK_BINDINGS_TRACE_EVENT("MojoInterfaceRequestEvent.isTrusted.get");
...
BLINK_BINDINGS_TRACE_EVENT("MojoInterfaceRequestEvent.constructor");
...
decltype(NativeValueTraits<MojoInterfaceRequestEventInit>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg2_event_init_dict;
if (info[1]->IsUndefined()) {
  arg2_event_init_dict = MojoInterfaceRequestEventInit::Create();
} else {
  arg2_event_init_dict = NativeValueTraits<MojoInterfaceRequestEventInit>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
}
auto&& return_value = MojoInterfaceRequestEvent::Create(arg1_type, arg2_event_init_dict);
static_assert(bindings::IsReturnTypeCompatible<MojoInterfaceRequestEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8MojoInterfaceRequestEvent::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_mojo_interface_request_event;

}  // namespace 

void V8MojoInterfaceRequestEvent::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8MojoInterfaceRequestEvent::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "MojoInterfaceRequestEvent"));
...
void V8MojoInterfaceRequestEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "MojoInterfaceRequestEvent", kAttributeTable);
}
