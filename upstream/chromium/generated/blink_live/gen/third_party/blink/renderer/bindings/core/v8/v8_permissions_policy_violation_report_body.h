...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PERMISSIONS_POLICY_VIOLATION_REPORT_BODY_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PERMISSIONS_POLICY_VIOLATION_REPORT_BODY_H_
...
class CORE_EXPORT V8PermissionsPolicyViolationReportBody final : public bindings::V8InterfaceBridge<V8PermissionsPolicyViolationReportBody, PermissionsPolicyViolationReportBody> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(871);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PermissionsPolicyViolationReportBody;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PERMISSIONS_POLICY_VIOLATION_REPORT_BODY_H_
