...
const char* V8NavigatorUserMediaSuccessCallback::GetHumanReadableName() const {
  return "V8NavigatorUserMediaSuccessCallback";
}
...
v8_arg1_stream = ToV8Traits<MediaStream>::ToV8(script_state, arg1_stream);
...
base::expected<void, ScriptValue> V8NavigatorUserMediaSuccessCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, MediaStream* arg1_stream) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_stream);
