...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CROP_TARGET_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CROP_TARGET_H_
...
class MODULES_EXPORT V8CropTarget final : public bindings::V8InterfaceBridge<V8CropTarget, CropTarget> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1197);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CropTarget;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CROP_TARGET_H_
