...
const char* V8CustomElementFormDisabledCallback::GetHumanReadableName() const {
  return "V8CustomElementFormDisabledCallback";
}

v8::Maybe<void> V8CustomElementFormDisabledCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, bool arg1_disabled) {
  const char* const class_like_name = "CustomElementFormDisabledCallback";
...
v8::Maybe<void> V8CustomElementFormDisabledCallback::Construct(bool arg1_disabled) {
  const char* const class_like_name = "CustomElementFormDisabledCallback";
...
void V8CustomElementFormDisabledCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, bool arg1_disabled) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = Invoke(arg0_receiver, arg1_disabled);
}

base::expected<void, ScriptValue> V8CustomElementFormDisabledCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, bool arg1_disabled) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_disabled);
