...
const char* V8BlinkAudioWorkletProcessCallback::GetHumanReadableName() const {
  return "V8BlinkAudioWorkletProcessCallback";
}

v8::Maybe<ScriptValue> V8BlinkAudioWorkletProcessCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const ScriptValue& arg1_inputs, const ScriptValue& arg2_outputs, const ScriptValue& arg3_param_values) {
...
base::expected<ScriptValue, ScriptValue> V8BlinkAudioWorkletProcessCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const ScriptValue& arg1_inputs, const ScriptValue& arg2_outputs, const ScriptValue& arg3_param_values) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_inputs, arg2_outputs, arg3_param_values);
