...
class MODULES_EXPORT V8EndOfStreamError final : public bindings::EnumerationBase {
...
static V8EndOfStreamError Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8EndOfStreamError> Create(const String& value);

explicit constexpr  V8EndOfStreamError(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8EndOfStreamError& lhs, V8EndOfStreamError::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8EndOfStreamError::Enum lhs, const V8EndOfStreamError& rhs) {
