...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_LAUNCH_QUEUE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_LAUNCH_QUEUE_H_
...
class MODULES_EXPORT V8LaunchQueue final : public bindings::V8InterfaceBridge<V8LaunchQueue, LaunchQueue> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1185);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class LaunchQueue;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_LAUNCH_QUEUE_H_
