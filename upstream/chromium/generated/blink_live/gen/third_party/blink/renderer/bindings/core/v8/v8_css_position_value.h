...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_POSITION_VALUE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_POSITION_VALUE_H_
...
class CORE_EXPORT V8CSSPositionValue final : public bindings::V8InterfaceBridge<V8CSSPositionValue, CSSPositionValue> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(332);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSPositionValue;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_POSITION_VALUE_H_
