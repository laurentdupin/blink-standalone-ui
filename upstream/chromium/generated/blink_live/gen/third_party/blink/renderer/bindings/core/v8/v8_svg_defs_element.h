...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_DEFS_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_DEFS_ELEMENT_H_
...
class CORE_EXPORT V8SVGDefsElement final : public bindings::V8InterfaceBridge<V8SVGDefsElement, SVGDefsElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(716);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGDefsElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_DEFS_ELEMENT_H_
