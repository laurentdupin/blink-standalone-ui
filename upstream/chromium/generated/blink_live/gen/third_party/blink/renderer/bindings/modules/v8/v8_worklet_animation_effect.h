...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WORKLET_ANIMATION_EFFECT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WORKLET_ANIMATION_EFFECT_H_
...
class MODULES_EXPORT V8WorkletAnimationEffect final : public bindings::V8InterfaceBridge<V8WorkletAnimationEffect, WorkletAnimationEffect> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1083);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class WorkletAnimationEffect;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WORKLET_ANIMATION_EFFECT_H_
