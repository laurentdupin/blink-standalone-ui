...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_QUAD_LAYER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_QUAD_LAYER_H_
...
class MODULES_EXPORT V8XRQuadLayer final : public bindings::V8InterfaceBridge<V8XRQuadLayer, XRQuadLayer> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XRQuadLayer;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_QUAD_LAYER_H_
