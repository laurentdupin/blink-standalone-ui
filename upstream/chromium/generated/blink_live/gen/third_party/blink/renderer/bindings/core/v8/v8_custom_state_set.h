...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CUSTOM_STATE_SET_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CUSTOM_STATE_SET_H_
...
class CORE_EXPORT V8CustomStateSet final : public bindings::V8InterfaceBridge<V8CustomStateSet, CustomStateSet> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(896);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CustomStateSet;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CUSTOM_STATE_SET_H_
