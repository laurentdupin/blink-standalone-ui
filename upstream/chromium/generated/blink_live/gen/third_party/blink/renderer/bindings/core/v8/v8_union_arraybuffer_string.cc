...
v8::Local<v8::Value> V8UnionArrayBufferOrString::DirectToV8(ScriptState* script_state, DOMArrayBuffer* value) {
  return ToV8Traits<DOMArrayBuffer>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionArrayBufferOrString::DirectToV8(ScriptState* script_state, const String& value) {
