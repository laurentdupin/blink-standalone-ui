...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TASK_ATTRIBUTION_TIMING_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TASK_ATTRIBUTION_TIMING_H_
...
class CORE_EXPORT V8TaskAttributionTiming final : public bindings::V8InterfaceBridge<V8TaskAttributionTiming, TaskAttributionTiming> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1010);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class TaskAttributionTiming;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TASK_ATTRIBUTION_TIMING_H_
