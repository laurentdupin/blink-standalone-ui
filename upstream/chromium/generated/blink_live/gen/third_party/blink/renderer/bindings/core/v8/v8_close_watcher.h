...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CLOSE_WATCHER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CLOSE_WATCHER_H_
...
class CORE_EXPORT V8CloseWatcher final : public bindings::V8InterfaceBridge<V8CloseWatcher, CloseWatcher> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(538);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CloseWatcher;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CLOSE_WATCHER_H_
