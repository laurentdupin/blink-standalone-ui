...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_TEXTURE_FLOAT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_TEXTURE_FLOAT_H_
...
class MODULES_EXPORT V8OESTextureFloat final : public bindings::V8InterfaceBridge<V8OESTextureFloat, OESTextureFloat> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1319);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_TEXTURE_FLOAT_H_
