...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_RENDERING_CONTEXT_WEBGPU_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_RENDERING_CONTEXT_WEBGPU_H_
...
class MODULES_EXPORT V8WebGLRenderingContextWebGPU final : public bindings::V8InterfaceBridge<V8WebGLRenderingContextWebGPU, WebGLRenderingContextWebGPU> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1363);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class WebGLRenderingContextWebGPU;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_RENDERING_CONTEXT_WEBGPU_H_
