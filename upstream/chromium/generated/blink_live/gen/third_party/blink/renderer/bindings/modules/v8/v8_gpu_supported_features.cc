...
bool V8GPUSupportedFeatures::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8GPUSupportedFeatures::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8GPUSupportedFeatures::InstallInterfaceTemplate,
    V8GPUSupportedFeatures::InstallContextDependentProperties,
    "GPUSupportedFeatures",
    nullptr,
    V8GPUSupportedFeatures::kThisTag,
    V8GPUSupportedFeatures::kMaxSubclassTag,
...
const WrapperTypeInfo& GPUSupportedFeatures::wrapper_type_info_ =
    V8GPUSupportedFeatures::wrapper_type_info_;
...
namespace v8_gpu_supported_features {


void SizeAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_GPUSupportedFeatures_size_Getter");
BLINK_BINDINGS_TRACE_EVENT("GPUSupportedFeatures.size.get");
...
void EntriesOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_GPUSupportedFeatures_entries");
BLINK_BINDINGS_TRACE_EVENT("GPUSupportedFeatures.entries");
...
static_assert(bindings::IsReturnTypeCompatible<SyncIterator<GPUSupportedFeatures>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
}

void ForEachOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_GPUSupportedFeatures_forEach");
BLINK_BINDINGS_TRACE_EVENT("GPUSupportedFeatures.forEach");
...
void HasOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_GPUSupportedFeatures_has");
BLINK_BINDINGS_TRACE_EVENT("GPUSupportedFeatures.has");
...
void KeysOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_GPUSupportedFeatures_keys");
BLINK_BINDINGS_TRACE_EVENT("GPUSupportedFeatures.keys");
...
void ValuesOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_GPUSupportedFeatures_values");
BLINK_BINDINGS_TRACE_EVENT("GPUSupportedFeatures.values");
...
using namespace v8_gpu_supported_features;

}  // namespace 

void V8GPUSupportedFeatures::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8GPUSupportedFeatures::GetWrapperTypeInfo();
...
void V8GPUSupportedFeatures::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "GPUSupportedFeatures", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "GPUSupportedFeatures", kOperationTable);
}
...
void V8GPUSupportedFeatures::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object, v8::Local<v8::Object> prototype_object, v8::Local<v8::Object> interface_object, v8::Local<v8::Template> interface_template, FeatureSelector feature_selector) {
  using bindings::IDLMemberInstaller;
