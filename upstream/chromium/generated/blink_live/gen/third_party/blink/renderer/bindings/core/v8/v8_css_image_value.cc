...
bool V8CSSImageValue::IsExposed(ExecutionContext* execution_context) {
...
static_assert(std::derived_from<CSSStyleImageValue, CSSStyleValue>);
...
const WrapperTypeInfo V8CSSImageValue::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8CSSImageValue::InstallInterfaceTemplate,
    nullptr,
    "CSSImageValue",
    V8CSSStyleValue::GetWrapperTypeInfo(),
    V8CSSImageValue::kThisTag,
    V8CSSImageValue::kMaxSubclassTag,
...
const WrapperTypeInfo& CSSStyleImageValue::wrapper_type_info_ =
    V8CSSImageValue::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, CSSStyleImageValue>::value,
    "CSSStyleImageValue inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_css_image_value {



}  // namespace v8_css_image_value

using namespace v8_css_image_value;

}  // namespace 

void V8CSSImageValue::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8CSSImageValue::GetWrapperTypeInfo();
