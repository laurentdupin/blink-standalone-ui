...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_PIPELINE_ERROR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_PIPELINE_ERROR_H_
...
class MODULES_EXPORT V8GPUPipelineError final : public bindings::V8InterfaceBridge<V8GPUPipelineError, GPUPipelineError> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(361);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class GPUPipelineError;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_PIPELINE_ERROR_H_
