...
#ifndef THIRD_PARTY_BLINK_RENDERER_CORE_MATHML_ELEMENT_FACTORY_H_
#define THIRD_PARTY_BLINK_RENDERER_CORE_MATHML_ELEMENT_FACTORY_H_
...
#endif  // THIRD_PARTY_BLINK_RENDERER_CORE_MATHML_ELEMENT_FACTORY_H_
