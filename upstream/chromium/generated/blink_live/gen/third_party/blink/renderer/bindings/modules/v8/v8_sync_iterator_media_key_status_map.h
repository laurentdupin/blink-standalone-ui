...
template <>
class MODULES_EXPORT SyncIterator<MediaKeyStatusMap> final : public bindings::SyncIteratorBase {
...
explicit  SyncIterator<MediaKeyStatusMap>(IterationSourceBase* source, Kind kind) : bindings::SyncIteratorBase(source, kind) {
...
class MODULES_EXPORT V8SyncIteratorMediaKeyStatusMap final : public bindings::V8InterfaceBridge<V8SyncIteratorMediaKeyStatusMap, SyncIterator<MediaKeyStatusMap>> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1497);
