...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_CERTIFICATE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_CERTIFICATE_H_
...
class MODULES_EXPORT V8RTCCertificate final : public bindings::V8InterfaceBridge<V8RTCCertificate, RTCCertificate> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1216);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class RTCCertificate;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_CERTIFICATE_H_
