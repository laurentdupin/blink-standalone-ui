...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_IDB_CURSOR_WITH_VALUE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_IDB_CURSOR_WITH_VALUE_H_
...
class MODULES_EXPORT V8IDBCursorWithValue final : public bindings::V8InterfaceBridge<V8IDBCursorWithValue, IDBCursorWithValue> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1176);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class IDBCursorWithValue;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_IDB_CURSOR_WITH_VALUE_H_
