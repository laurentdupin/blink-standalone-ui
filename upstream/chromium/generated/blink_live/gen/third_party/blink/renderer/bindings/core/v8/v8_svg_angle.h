...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_ANGLE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_ANGLE_H_
...
class CORE_EXPORT V8SVGAngle final : public bindings::V8InterfaceBridge<V8SVGAngle, SVGAngleTearOff> {
...
class Constant final {
  ...
  public:
static constexpr uint16_t kSVGAngletypeUnknown = 0;
static constexpr uint16_t kSVGAngletypeUnspecified = 1;
static constexpr uint16_t kSVGAngletypeDeg = 2;
static constexpr uint16_t kSVGAngletypeRad = 3;
static constexpr uint16_t kSVGAngletypeGrad = 4;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(962);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGAngleTearOff;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_ANGLE_H_
