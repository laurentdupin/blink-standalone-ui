...
if (!v8_value->IsObject()) {
  const char* const class_like_name = "DragEventInit";
...
return dictionary;
 ...
 DragEventInit::DragEventInit(v8::Isolate* isolate) : MouseEventInit(isolate) {
...
if (!bindings::GetDictionaryMemberFromV8Object<IDLNullable<DataTransfer>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), fallback_presence_var, member_data_transfer_, class_like_name, exception_state)) {
  return;
}
}
