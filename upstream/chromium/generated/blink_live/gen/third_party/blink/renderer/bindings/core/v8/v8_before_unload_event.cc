...
bool V8BeforeUnloadEvent::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<BeforeUnloadEvent, Event>);
...
const WrapperTypeInfo V8BeforeUnloadEvent::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8BeforeUnloadEvent::InstallInterfaceTemplate,
    nullptr,
    "BeforeUnloadEvent",
    V8Event::GetWrapperTypeInfo(),
    V8BeforeUnloadEvent::kThisTag,
    V8BeforeUnloadEvent::kMaxSubclassTag,
...
const WrapperTypeInfo& BeforeUnloadEvent::wrapper_type_info_ =
    V8BeforeUnloadEvent::wrapper_type_info_;
...
namespace v8_before_unload_event {
...
BLINK_BINDINGS_TRACE_EVENT("BeforeUnloadEvent.returnValue.get");
...
BLINK_BINDINGS_TRACE_EVENT("BeforeUnloadEvent.returnValue.set");
...
BLINK_BINDINGS_TRACE_EVENT("BeforeUnloadEvent.isTrusted.get");
...
using namespace v8_before_unload_event;

}  // namespace 

void V8BeforeUnloadEvent::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8BeforeUnloadEvent::GetWrapperTypeInfo();
...
void V8BeforeUnloadEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "BeforeUnloadEvent", kAttributeTable);
}
