...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HIGHLIGHT_REGISTRY_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HIGHLIGHT_REGISTRY_H_
...
class CORE_EXPORT V8HighlightRegistry final : public bindings::V8InterfaceBridge<V8HighlightRegistry, HighlightRegistry> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(890);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class HighlightRegistry;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HIGHLIGHT_REGISTRY_H_
