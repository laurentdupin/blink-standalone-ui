...
const char* V8BlobCallback::GetHumanReadableName() const {
...
v8_arg1_blob = ToV8Traits<IDLNullable<Blob>>::ToV8(script_state, arg1_blob);
argv[0] = v8_arg1_blob;
...
base::expected<void, ScriptValue> V8BlobCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, Blob* arg1_blob) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_blob);
