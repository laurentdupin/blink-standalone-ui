...
kSendrecv, kSendonly, kRecvonly, kInactive, kStopped
};
static constexpr size_t kEnumSize = 5;

static V8RTCRtpTransceiverDirection Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8RTCRtpTransceiverDirection> Create(const String& value);

explicit constexpr  V8RTCRtpTransceiverDirection(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
  
}
constexpr  V8RTCRtpTransceiverDirection(const V8RTCRtpTransceiverDirection&) = default;
constexpr  V8RTCRtpTransceiverDirection(V8RTCRtpTransceiverDirection&&) = default;
 ~V8RTCRtpTransceiverDirection() = default;

V8RTCRtpTransceiverDirection& operator=(const V8RTCRtpTransceiverDirection&) = default;
V8RTCRtpTransceiverDirection& operator=(V8RTCRtpTransceiverDirection&&) = default;
