...
public:
    ...
    void startViolationsReport(crdtp::Dispatchable& dispatchable);
    void stopViolationsReport(crdtp::Dispatchable& dispatchable);
 protected:
    Backend* m_backend;
};
...
void DomainDispatcherImpl::startViolationsReport(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
...
void DomainDispatcherImpl::stopViolationsReport(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
