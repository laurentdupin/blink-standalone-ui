...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_STANDARD_DERIVATIVES_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_STANDARD_DERIVATIVES_H_
...
class MODULES_EXPORT V8OESStandardDerivatives final : public bindings::V8InterfaceBridge<V8OESStandardDerivatives, OESStandardDerivatives> {
...
class Constant final {
  ...
  public:
static constexpr uint32_t kFragmentShaderDerivativeHintOes = 0x8B8B;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1318);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class OESStandardDerivatives;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_STANDARD_DERIVATIVES_H_
