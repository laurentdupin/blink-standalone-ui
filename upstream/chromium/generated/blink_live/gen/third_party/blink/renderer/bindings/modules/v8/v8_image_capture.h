...
class MODULES_EXPORT V8ImageCapture final : public bindings::V8InterfaceBridge<V8ImageCapture, ImageCapture> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1174);
