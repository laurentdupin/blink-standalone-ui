...
bool V8CSSStyleRule::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<CSSStyleRule, CSSRule>);
...
const WrapperTypeInfo V8CSSStyleRule::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8CSSStyleRule::InstallInterfaceTemplate,
    nullptr,
    "CSSStyleRule",
    V8CSSRule::GetWrapperTypeInfo(),
    V8CSSStyleRule::kThisTag,
    V8CSSStyleRule::kMaxSubclassTag,
...
const WrapperTypeInfo& CSSStyleRule::wrapper_type_info_ =
    V8CSSStyleRule::wrapper_type_info_;
...
namespace v8_css_style_rule {


void SelectorTextAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSStyleRule_selectorText_Getter");
BLINK_BINDINGS_TRACE_EVENT("CSSStyleRule.selectorText.get");
...
void SelectorTextAttributeSetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSStyleRule_selectorText_Setter");
BLINK_BINDINGS_TRACE_EVENT("CSSStyleRule.selectorText.set");
...
blink_receiver->setSelectorText(execution_context, arg1_value);
...
BLINK_BINDINGS_TRACE_EVENT("CSSStyleRule.style.get");
...
BLINK_BINDINGS_TRACE_EVENT("CSSStyleRule.style.set");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSStyleRule_cssRules_Getter");
BLINK_BINDINGS_TRACE_EVENT("CSSStyleRule.cssRules.get");
...
void DeleteRuleOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSStyleRule_deleteRule");
BLINK_BINDINGS_TRACE_EVENT("CSSStyleRule.deleteRule");
...
void InsertRuleOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSStyleRule_insertRule");
BLINK_BINDINGS_TRACE_EVENT("CSSStyleRule.insertRule");
...
using namespace v8_css_style_rule;

}  // namespace 

void V8CSSStyleRule::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8CSSStyleRule::GetWrapperTypeInfo();
...
void V8CSSStyleRule::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "CSSStyleRule", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "CSSStyleRule", kOperationTable);
}
