...
class MODULES_EXPORT GPURenderBundleDescriptor : public GPUObjectDescriptorBase {
  ...
  public:
static GPURenderBundleDescriptor* Create() {
  return MakeGarbageCollected<GPURenderBundleDescriptor>();
}
static GPURenderBundleDescriptor* Create(v8::Isolate* isolate) {
  return MakeGarbageCollected<GPURenderBundleDescriptor>(isolate);
}
static GPURenderBundleDescriptor* Create(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state);

explicit  GPURenderBundleDescriptor();
explicit  GPURenderBundleDescriptor(v8::Isolate* isolate);
