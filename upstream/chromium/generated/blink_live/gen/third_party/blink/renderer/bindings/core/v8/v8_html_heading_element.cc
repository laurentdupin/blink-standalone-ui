...
bool V8HTMLHeadingElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<HTMLHeadingElement, HTMLElement>);
...
const WrapperTypeInfo V8HTMLHeadingElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8HTMLHeadingElement::InstallInterfaceTemplate,
    nullptr,
    "HTMLHeadingElement",
    V8HTMLElement::GetWrapperTypeInfo(),
    V8HTMLHeadingElement::kThisTag,
    V8HTMLHeadingElement::kMaxSubclassTag,
...
const WrapperTypeInfo& HTMLHeadingElement::wrapper_type_info_ =
    V8HTMLHeadingElement::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, HTMLHeadingElement>::value,
    "HTMLHeadingElement inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_html_heading_element {
...
BLINK_BINDINGS_TRACE_EVENT("HTMLHeadingElement.align.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
HTMLHeadingElement* blink_receiver = V8HTMLHeadingElement::ToWrappableUnsafe(isolate, v8_receiver);
...
BLINK_BINDINGS_TRACE_EVENT("HTMLHeadingElement.align.set");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLHeadingElement.constructor");
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLHeadingElement::GetWrapperTypeInfo(), ElementType::kHTMLHeadingElement);
}


}  // namespace v8_html_heading_element

using namespace v8_html_heading_element;

}  // namespace 

void V8HTMLHeadingElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8HTMLHeadingElement::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "HTMLHeadingElement"));
...
void V8HTMLHeadingElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLHeadingElement", kAttributeTable);
}
