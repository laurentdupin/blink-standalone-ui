...
bool V8HitTestLayerRectList::IsExposed(ExecutionContext* execution_context) {
  return false;
}
...
const WrapperTypeInfo V8HitTestLayerRectList::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8HitTestLayerRectList::InstallInterfaceTemplate,
    nullptr,
    "HitTestLayerRectList",
    nullptr,
    V8HitTestLayerRectList::kThisTag,
    V8HitTestLayerRectList::kMaxSubclassTag,
...
const WrapperTypeInfo& HitTestLayerRectList::wrapper_type_info_ =
    V8HitTestLayerRectList::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, HitTestLayerRectList>::value,
    "HitTestLayerRectList inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

v8::Intercepted V8HitTestLayerRectList::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HitTestLayerRectList_IndexedPropertyGetter");
...
HitTestLayerRectList* blink_receiver = V8HitTestLayerRectList::ToWrappableUnsafe(isolate, v8_receiver);
...
static_assert(bindings::IsReturnTypeCompatible<HitTestLayerRect, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
return v8::Intercepted::kYes;
}

v8::Intercepted V8HitTestLayerRectList::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HitTestLayerRectList_IndexedPropertySetter");
...
v8::Intercepted V8HitTestLayerRectList::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HitTestLayerRectList_IndexedPropertyDeleter");
...
v8::Intercepted V8HitTestLayerRectList::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HitTestLayerRectList_IndexedPropertyDefiner");
...
v8::Intercepted V8HitTestLayerRectList::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HitTestLayerRectList_IndexedPropertyDescriptor");
...
auto intercepted =
    V8HitTestLayerRectList::IndexedPropertyGetterCallback(index, info);
...
void V8HitTestLayerRectList::IndexedPropertyEnumeratorCallback(const v8::PropertyCallbackInfo<v8::Array>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HitTestLayerRectList_IndexedPropertyEnumerator");
...
namespace v8_hit_test_layer_rect_list {


void LengthAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HitTestLayerRectList_length_Getter");
BLINK_BINDINGS_TRACE_EVENT("HitTestLayerRectList.length.get");
...
void ItemOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HitTestLayerRectList_item");
BLINK_BINDINGS_TRACE_EVENT("HitTestLayerRectList.item");
...
using namespace v8_hit_test_layer_rect_list;

}  // namespace 

void V8HitTestLayerRectList::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8HitTestLayerRectList::GetWrapperTypeInfo();
...
instance_template->SetHandler(
    v8::IndexedPropertyHandlerConfiguration(
        V8HitTestLayerRectList::IndexedPropertyGetterCallback,
        V8HitTestLayerRectList::IndexedPropertySetterCallback,
        nullptr,  // query
        V8HitTestLayerRectList::IndexedPropertyDeleterCallback,
        V8HitTestLayerRectList::IndexedPropertyEnumeratorCallback,
        V8HitTestLayerRectList::IndexedPropertyDefinerCallback,
        V8HitTestLayerRectList::IndexedPropertyDescriptorCallback,
        nullptr,  // index_of
        v8::Local<v8::Value>(),
...
void V8HitTestLayerRectList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HitTestLayerRectList", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "HitTestLayerRectList", kOperationTable);
}
