...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_VERTEX_ARRAY_OBJECT_OES_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_VERTEX_ARRAY_OBJECT_OES_H_
...
class MODULES_EXPORT V8WebGLVertexArrayObjectOES final : public bindings::V8InterfaceBridge<V8WebGLVertexArrayObjectOES, WebGLVertexArrayObjectOES> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1358);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_VERTEX_ARRAY_OBJECT_OES_H_
