...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_ELEMENT_IMAGE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_ELEMENT_IMAGE_H_
...
class CORE_EXPORT V8ElementImage final : public bindings::V8InterfaceBridge<V8ElementImage, ElementImage> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(891);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class ElementImage;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_ELEMENT_IMAGE_H_
