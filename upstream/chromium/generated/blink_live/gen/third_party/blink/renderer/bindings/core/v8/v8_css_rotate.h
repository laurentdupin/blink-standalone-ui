...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_ROTATE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_ROTATE_H_
...
class CORE_EXPORT V8CSSRotate final : public bindings::V8InterfaceBridge<V8CSSRotate, CSSRotate> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(338);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSRotate;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_ROTATE_H_
