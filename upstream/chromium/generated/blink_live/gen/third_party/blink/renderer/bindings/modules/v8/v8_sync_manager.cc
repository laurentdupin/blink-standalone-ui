...
const WrapperTypeInfo& SyncManager::wrapper_type_info_ =
    V8SyncManager::wrapper_type_info_;
...
auto&& return_value = blink_receiver->registerFunction(script_state, arg1_tag, exception_state);
...
void V8SyncManager::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "SyncManager", kOperationTable);
}
