...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_TILE_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_TILE_ELEMENT_H_
...
class CORE_EXPORT V8SVGFETileElement final : public bindings::V8InterfaceBridge<V8SVGFETileElement, SVGFETileElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(708);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGFETileElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_TILE_ELEMENT_H_
