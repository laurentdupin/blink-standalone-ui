...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_PATH_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_PATH_ELEMENT_H_
...
class CORE_EXPORT V8SVGPathElement final : public bindings::V8InterfaceBridge<V8SVGPathElement, SVGPathElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(723);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGPathElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_PATH_ELEMENT_H_
