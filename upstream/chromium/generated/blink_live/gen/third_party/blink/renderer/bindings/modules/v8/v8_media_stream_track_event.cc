...
bool V8MediaStreamTrackEvent::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<MediaStreamTrackEvent, Event>);
...
const WrapperTypeInfo V8MediaStreamTrackEvent::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8MediaStreamTrackEvent::InstallInterfaceTemplate,
    nullptr,
    "MediaStreamTrackEvent",
    V8Event::GetWrapperTypeInfo(),
    V8MediaStreamTrackEvent::kThisTag,
    V8MediaStreamTrackEvent::kMaxSubclassTag,
...
const WrapperTypeInfo& MediaStreamTrackEvent::wrapper_type_info_ =
    V8MediaStreamTrackEvent::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, MediaStreamTrackEvent>::value,
    "MediaStreamTrackEvent inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_media_stream_track_event {
...
BLINK_BINDINGS_TRACE_EVENT("MediaStreamTrackEvent.track.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
MediaStreamTrackEvent* blink_receiver = V8MediaStreamTrackEvent::ToWrappableUnsafe(isolate, v8_receiver);
...
BLINK_BINDINGS_TRACE_EVENT("MediaStreamTrackEvent.isTrusted.get");
...
BLINK_BINDINGS_TRACE_EVENT("MediaStreamTrackEvent.constructor");
...
auto&& arg2_event_init_dict = NativeValueTraits<MediaStreamTrackEventInit>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& return_value = MediaStreamTrackEvent::Create(arg1_type, arg2_event_init_dict);
static_assert(bindings::IsReturnTypeCompatible<MediaStreamTrackEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8MediaStreamTrackEvent::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_media_stream_track_event;

}  // namespace 

void V8MediaStreamTrackEvent::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8MediaStreamTrackEvent::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "MediaStreamTrackEvent"));
...
void V8MediaStreamTrackEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "MediaStreamTrackEvent", kAttributeTable);
}
