...
const WrapperTypeInfo V8ReadableByteStreamController::wrapper_type_info_{
    ...
    nullptr,
    V8ReadableByteStreamController::kThisTag,
    V8ReadableByteStreamController::kMaxSubclassTag,
...
static_assert(bindings::IsReturnTypeCompatible<IDLNullable<ReadableStreamBYOBRequest>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
void V8ReadableByteStreamController::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "ReadableByteStreamController", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "ReadableByteStreamController", kOperationTable);
}
