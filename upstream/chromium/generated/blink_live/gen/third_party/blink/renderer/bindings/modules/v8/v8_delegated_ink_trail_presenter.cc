...
const WrapperTypeInfo V8DelegatedInkTrailPresenter::wrapper_type_info_{
    ...
    nullptr,
    V8DelegatedInkTrailPresenter::kThisTag,
    V8DelegatedInkTrailPresenter::kMaxSubclassTag,
...
void V8DelegatedInkTrailPresenter::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "DelegatedInkTrailPresenter", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "DelegatedInkTrailPresenter", kOperationTable);
}
