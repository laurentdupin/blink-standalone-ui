...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CLIENTS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CLIENTS_H_
...
class MODULES_EXPORT V8Clients final : public bindings::V8InterfaceBridge<V8Clients, ServiceWorkerClients> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1247);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class ServiceWorkerClients;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CLIENTS_H_
