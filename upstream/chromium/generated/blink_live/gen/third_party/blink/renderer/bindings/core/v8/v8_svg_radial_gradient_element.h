...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_RADIAL_GRADIENT_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_RADIAL_GRADIENT_ELEMENT_H_
...
class CORE_EXPORT V8SVGRadialGradientElement final : public bindings::V8InterfaceBridge<V8SVGRadialGradientElement, SVGRadialGradientElement> {
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_RADIAL_GRADIENT_ELEMENT_H_
