...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PUSH_MESSAGE_DATA_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PUSH_MESSAGE_DATA_H_
...
class MODULES_EXPORT V8PushMessageData final : public bindings::V8InterfaceBridge<V8PushMessageData, PushMessageData> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1238);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PushMessageData;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PUSH_MESSAGE_DATA_H_
