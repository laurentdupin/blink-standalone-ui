...
if (!v8_value->IsObject()) {
  const char* const class_like_name = "PushSubscriptionChangeEventInit";
...
return dictionary;
 ...
 PushSubscriptionChangeEventInit::PushSubscriptionChangeEventInit(v8::Isolate* isolate) : ExtendableEventInit(isolate) {
...
void PushSubscriptionChangeEventInit::Trace(Visitor* visitor) const {
  visitor->Trace(member_new_subscription_);
visitor->Trace(member_old_subscription_);
...
dictionary_from_v8_context.SetCurrentPropertyName("newSubscription");
constexpr bool is_optional = false;
v8::Local<v8::Context> current_context = isolate->GetCurrentContext();
const auto& v8_own_member_names = GetV8OwnMemberNames(isolate);
if (!bindings::GetDictionaryMemberFromV8Object<PushSubscription, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), has_new_subscription_, member_new_subscription_, class_like_name, exception_state)) {
  return;
}
dictionary_from_v8_context.SetCurrentPropertyName("oldSubscription");
if (!bindings::GetDictionaryMemberFromV8Object<PushSubscription, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate), has_old_subscription_, member_old_subscription_, class_like_name, exception_state)) {
  return;
}
}
