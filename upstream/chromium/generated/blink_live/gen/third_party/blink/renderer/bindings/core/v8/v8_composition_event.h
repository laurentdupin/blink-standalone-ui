...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_COMPOSITION_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_COMPOSITION_EVENT_H_
...
class CORE_EXPORT V8CompositionEvent final : public bindings::V8InterfaceBridge<V8CompositionEvent, CompositionEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(474);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CompositionEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_COMPOSITION_EVENT_H_
