...
static_assert(std::derived_from<HTMLFormControlsCollection, HTMLCollection>);
...
const WrapperTypeInfo V8HTMLFormControlsCollection::wrapper_type_info_{
    ...
    V8HTMLFormControlsCollection::kThisTag,
    V8HTMLFormControlsCollection::kMaxSubclassTag,
...
v8::Intercepted V8HTMLFormControlsCollection::NamedPropertyGetterCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
auto&& return_value = blink_receiver->namedGetter(script_state, blink_property_name);
static_assert(bindings::IsReturnTypeCompatible<IDLNullable<V8UnionElementOrRadioNodeList>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (!return_value) {
...
//  only argument value."
v8::Local<v8::Value> v8_return_value = ToV8Traits<IDLNullable<V8UnionElementOrRadioNodeList>>::ToV8(script_state, return_value);
bindings::V8SetReturnValue(info, v8_return_value);
return v8::Intercepted::kYes;
}

v8::Intercepted V8HTMLFormControlsCollection::NamedPropertySetterCallback(v8::Local<v8::Name> v8_property_name, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
...
v8::Intercepted V8HTMLFormControlsCollection::NamedPropertyDeleterCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
...
v8::Intercepted V8HTMLFormControlsCollection::NamedPropertyDefinerCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
...
v8::Intercepted V8HTMLFormControlsCollection::NamedPropertyDescriptorCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
v8::Intercepted V8HTMLFormControlsCollection::NamedPropertyQueryCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Integer>& info) {
...
v8::Intercepted V8HTMLFormControlsCollection::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
v8::Intercepted V8HTMLFormControlsCollection::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
...
v8::Intercepted V8HTMLFormControlsCollection::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
...
v8::Intercepted V8HTMLFormControlsCollection::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
...
v8::Intercepted V8HTMLFormControlsCollection::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
auto&& return_value = blink_receiver->namedGetter(script_state, arg1_name);
static_assert(bindings::IsReturnTypeCompatible<IDLNullable<V8UnionElementOrRadioNodeList>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Value> v8_return_value = ToV8Traits<IDLNullable<V8UnionElementOrRadioNodeList>>::ToV8(script_state, return_value);
bindings::V8SetReturnValue(info, v8_return_value);
}
...
void V8HTMLFormControlsCollection::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLFormControlsCollection", kOperationTable);
}
