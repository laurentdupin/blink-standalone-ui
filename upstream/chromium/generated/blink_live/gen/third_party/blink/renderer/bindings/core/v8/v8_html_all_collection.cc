...
bool V8HTMLAllCollection::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8HTMLAllCollection::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8HTMLAllCollection::InstallInterfaceTemplate,
    nullptr,
    "HTMLAllCollection",
    nullptr,
    V8HTMLAllCollection::kThisTag,
    V8HTMLAllCollection::kMaxSubclassTag,
...
const WrapperTypeInfo& HTMLAllCollection::wrapper_type_info_ =
    V8HTMLAllCollection::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, HTMLAllCollection>::value,
    "HTMLAllCollection inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

v8::Intercepted V8HTMLAllCollection::NamedPropertyGetterCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
static_assert(bindings::IsReturnTypeCompatible<IDLNullable<V8UnionElementOrHTMLCollection>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (!return_value) {
...
v8::Intercepted V8HTMLAllCollection::NamedPropertySetterCallback(v8::Local<v8::Name> v8_property_name, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLAllCollection_NamedPropertySetter");
...
v8::Intercepted V8HTMLAllCollection::NamedPropertyDeleterCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLAllCollection_NamedPropertyDeleter");
...
v8::Intercepted V8HTMLAllCollection::NamedPropertyDefinerCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLAllCollection_NamedPropertyDefiner");
...
v8::Intercepted V8HTMLAllCollection::NamedPropertyDescriptorCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLAllCollection_NamedPropertyDescriptor");
...
//  only argument value."
auto intercepted =
    V8HTMLAllCollection::NamedPropertyGetterCallback(v8_property_name, info);
// "Return OrdinaryGetOwnProperty(O, P)."
...
v8::Intercepted V8HTMLAllCollection::NamedPropertyQueryCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Integer>& info) {
...
void V8HTMLAllCollection::NamedPropertyEnumeratorCallback(const v8::PropertyCallbackInfo<v8::Array>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLAllCollection_NamedPropertyEnumerator");
...
v8::Intercepted V8HTMLAllCollection::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
v8::Intercepted V8HTMLAllCollection::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLAllCollection_IndexedPropertySetter");
...
v8::Intercepted V8HTMLAllCollection::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLAllCollection_IndexedPropertyDeleter");
...
v8::Intercepted V8HTMLAllCollection::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLAllCollection_IndexedPropertyDefiner");
...
v8::Intercepted V8HTMLAllCollection::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLAllCollection_IndexedPropertyDescriptor");
...
void V8HTMLAllCollection::IndexedPropertyEnumeratorCallback(const v8::PropertyCallbackInfo<v8::Array>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLAllCollection_IndexedPropertyEnumerator");
...
namespace v8_html_all_collection {
...
BLINK_BINDINGS_TRACE_EVENT("HTMLAllCollection.length.get");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLAllCollection.item");
...
if (non_undefined_argument_length <= 0) {
  return_value = blink_receiver->item(isolate, exception_state);
break;
}
auto&& arg1_name_or_index = NativeValueTraits<IDLAny>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
return_value = blink_receiver->item(isolate, arg1_name_or_index, exception_state);
} while (false);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
BLINK_BINDINGS_TRACE_EVENT("HTMLAllCollection.namedItem");
...
using namespace v8_html_all_collection;

}  // namespace 

void V8HTMLAllCollection::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8HTMLAllCollection::GetWrapperTypeInfo();
...
instance_template->SetHandler(
    v8::NamedPropertyHandlerConfiguration(
        V8HTMLAllCollection::NamedPropertyGetterCallback,
        V8HTMLAllCollection::NamedPropertySetterCallback,
        V8HTMLAllCollection::NamedPropertyQueryCallback,
        V8HTMLAllCollection::NamedPropertyDeleterCallback,
        V8HTMLAllCollection::NamedPropertyEnumeratorCallback,
        V8HTMLAllCollection::NamedPropertyDefinerCallback,
        V8HTMLAllCollection::NamedPropertyDescriptorCallback,
        v8::Local<v8::Value>(),
...
instance_template->SetHandler(
    v8::IndexedPropertyHandlerConfiguration(
        ...
        nullptr,  // query
        V8HTMLAllCollection::IndexedPropertyDeleterCallback,
        V8HTMLAllCollection::IndexedPropertyEnumeratorCallback,
...
void V8HTMLAllCollection::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLAllCollection", kAttributeTable);
}
...
{"item", ItemOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLAllCollection", kOperationTable);
}
