...
k, kNoReferrer, kNoReferrerWhenDowngrade, kSameOrigin, kOrigin, kStrictOrigin, kOriginWhenCrossOrigin, kStrictOriginWhenCrossOrigin, kUnsafeUrl
};
...
explicit constexpr  V8ReferrerPolicy(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
