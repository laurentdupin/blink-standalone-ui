...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_VIEW_TRANSITION_RULE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_VIEW_TRANSITION_RULE_H_
...
class CORE_EXPORT V8CSSViewTransitionRule final : public bindings::V8InterfaceBridge<V8CSSViewTransitionRule, CSSViewTransitionRule> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSViewTransitionRule;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_VIEW_TRANSITION_RULE_H_
