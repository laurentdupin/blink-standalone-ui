...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_QUERY_SET_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_QUERY_SET_H_
...
class MODULES_EXPORT V8GPUQuerySet final : public bindings::V8InterfaceBridge<V8GPUQuerySet, GPUQuerySet> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1389);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class GPUQuerySet;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_QUERY_SET_H_
