...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_OUT_OF_MEMORY_ERROR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_OUT_OF_MEMORY_ERROR_H_
...
class MODULES_EXPORT V8GPUOutOfMemoryError final : public bindings::V8InterfaceBridge<V8GPUOutOfMemoryError, GPUOutOfMemoryError> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1384);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class GPUOutOfMemoryError;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_OUT_OF_MEMORY_ERROR_H_
