...
bool V8TextDecoderStream::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow() || execution_context->IsWorkerGlobalScope() || execution_context->IsShadowRealmGlobalScope();
}
...
const WrapperTypeInfo V8TextDecoderStream::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8TextDecoderStream::InstallInterfaceTemplate,
    nullptr,
    "TextDecoderStream",
    nullptr,
    V8TextDecoderStream::kThisTag,
    V8TextDecoderStream::kMaxSubclassTag,
...
const WrapperTypeInfo& TextDecoderStream::wrapper_type_info_ =
    V8TextDecoderStream::wrapper_type_info_;
...
namespace v8_text_decoder_stream {
...
BLINK_BINDINGS_TRACE_EVENT("TextDecoderStream.encoding.get");
...
BLINK_BINDINGS_TRACE_EVENT("TextDecoderStream.fatal.get");
...
BLINK_BINDINGS_TRACE_EVENT("TextDecoderStream.ignoreBOM.get");
...
BLINK_BINDINGS_TRACE_EVENT("TextDecoderStream.readable.get");
...
BLINK_BINDINGS_TRACE_EVENT("TextDecoderStream.writable.get");
...
BLINK_BINDINGS_TRACE_EVENT("TextDecoderStream.constructor");
...
// [Measure], [MeasureAs]
UseCounter::Count(current_execution_context, WebFeature::kTextDecoderStreamConstructor);


ScriptState* script_state = current_script_state;
decltype(NativeValueTraits<IDLString>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg1_label;
...
decltype(NativeValueTraits<TextDecoderOptions>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg2_options;
...
auto&& return_value = TextDecoderStream::Create(script_state, arg1_label, arg2_options, exception_state);
static_assert(bindings::IsReturnTypeCompatible<TextDecoderStream, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8TextDecoderStream::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_text_decoder_stream;

}  // namespace 

void V8TextDecoderStream::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8TextDecoderStream::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "TextDecoderStream"));
...
void V8TextDecoderStream::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"fatal", FatalAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
{"ignoreBOM", IgnoreBOMAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "TextDecoderStream", kAttributeTable);
}
