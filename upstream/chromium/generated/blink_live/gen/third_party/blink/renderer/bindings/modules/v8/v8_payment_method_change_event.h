...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PAYMENT_METHOD_CHANGE_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PAYMENT_METHOD_CHANGE_EVENT_H_
...
class MODULES_EXPORT V8PaymentMethodChangeEvent final : public bindings::V8InterfaceBridge<V8PaymentMethodChangeEvent, PaymentMethodChangeEvent> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PaymentMethodChangeEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PAYMENT_METHOD_CHANGE_EVENT_H_
