...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_SKEW_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_SKEW_H_
...
class CORE_EXPORT V8CSSSkew final : public bindings::V8InterfaceBridge<V8CSSSkew, CSSSkew> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(340);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSSkew;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_SKEW_H_
