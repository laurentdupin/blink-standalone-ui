...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_ERROR_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_ERROR_EVENT_H_
...
class MODULES_EXPORT V8RTCErrorEvent final : public bindings::V8InterfaceBridge<V8RTCErrorEvent, RTCErrorEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(451);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class RTCErrorEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_ERROR_EVENT_H_
