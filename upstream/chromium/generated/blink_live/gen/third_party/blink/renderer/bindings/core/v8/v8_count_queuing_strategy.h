...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_COUNT_QUEUING_STRATEGY_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_COUNT_QUEUING_STRATEGY_H_
...
class CORE_EXPORT V8CountQueuingStrategy final : public bindings::V8InterfaceBridge<V8CountQueuingStrategy, CountQueuingStrategy> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(948);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CountQueuingStrategy;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_COUNT_QUEUING_STRATEGY_H_
