...
void CSSMathRandomExposedConstructCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_LayoutWorkletGlobalScope_CSSMathRandom_ConstructorGetterCallback");
BLINK_BINDINGS_TRACE_EVENT("LayoutWorkletGlobalScope.CSSMathRandom");
