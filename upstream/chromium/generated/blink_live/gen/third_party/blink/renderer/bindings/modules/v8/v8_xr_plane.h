...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_PLANE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_PLANE_H_
...
class MODULES_EXPORT V8XRPlane final : public bindings::V8InterfaceBridge<V8XRPlane, XRPlane> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1439);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XRPlane;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_PLANE_H_
