...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_LOSE_CONTEXT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_LOSE_CONTEXT_H_
...
class MODULES_EXPORT V8WebGLLoseContext final : public bindings::V8InterfaceBridge<V8WebGLLoseContext, WebGLLoseContext> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1342);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class WebGLLoseContext;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_LOSE_CONTEXT_H_
