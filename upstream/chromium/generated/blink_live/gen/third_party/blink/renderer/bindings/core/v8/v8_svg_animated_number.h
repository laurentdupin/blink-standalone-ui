...
class CORE_EXPORT V8SVGAnimatedNumber final : public bindings::V8InterfaceBridge<V8SVGAnimatedNumber, SVGAnimatedNumber> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(969);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGAnimatedNumber;
};
