...
class  V8HitTestLayerRectList final : public bindings::V8InterfaceBridge<V8HitTestLayerRectList, HitTestLayerRectList> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1055);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class HitTestLayerRectList;
};
