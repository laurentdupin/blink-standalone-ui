...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_MARKER_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_MARKER_ELEMENT_H_
...
class CORE_EXPORT V8SVGMarkerElement final : public bindings::V8InterfaceBridge<V8SVGMarkerElement, SVGMarkerElement> {
...
class Constant final {
  ...
  public:
static constexpr uint16_t kSVGMarkerunitsUnknown = 0;
static constexpr uint16_t kSVGMarkerunitsUserspaceonuse = 1;
static constexpr uint16_t kSVGMarkerunitsStrokewidth = 2;
static constexpr uint16_t kSVGMarkerOrientUnknown = 0;
static constexpr uint16_t kSVGMarkerOrientAuto = 1;
static constexpr uint16_t kSVGMarkerOrientAngle = 2;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(738);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGMarkerElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_MARKER_ELEMENT_H_
