...
const char* V8VoidFunction::GetHumanReadableName() const {
  return "V8VoidFunction";
}

v8::Maybe<void> V8VoidFunction::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
  const char* const class_like_name = "VoidFunction";
...
v8::Maybe<void> V8VoidFunction::Construct() {
  const char* const class_like_name = "VoidFunction";
...
void V8VoidFunction::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
  v8::Isolate* isolate = GetIsolate();
...
base::expected<void, ScriptValue> V8VoidFunction::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
