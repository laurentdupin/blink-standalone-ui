...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PRESSURE_OBSERVER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PRESSURE_OBSERVER_H_
...
class MODULES_EXPORT V8PressureObserver final : public bindings::V8InterfaceBridge<V8PressureObserver, PressureObserver> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1464);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PressureObserver;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PRESSURE_OBSERVER_H_
