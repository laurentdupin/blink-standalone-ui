...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_EXTERNAL_TEXTURE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_EXTERNAL_TEXTURE_H_
...
class MODULES_EXPORT V8GPUExternalTexture final : public bindings::V8InterfaceBridge<V8GPUExternalTexture, GPUExternalTexture> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1386);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class GPUExternalTexture;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_EXTERNAL_TEXTURE_H_
