...
class MODULES_EXPORT V8BackgroundFetchEvent final : public bindings::V8InterfaceBridge<V8BackgroundFetchEvent, BackgroundFetchEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(399);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class BackgroundFetchEvent;
};
