...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TASK_SIGNAL_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TASK_SIGNAL_H_
...
class CORE_EXPORT V8TaskSignal final : public bindings::V8InterfaceBridge<V8TaskSignal, DOMTaskSignal> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class DOMTaskSignal;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TASK_SIGNAL_H_
