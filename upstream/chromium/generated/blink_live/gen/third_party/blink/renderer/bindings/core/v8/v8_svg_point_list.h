...
class CORE_EXPORT V8SVGPointList final : public bindings::V8InterfaceBridge<V8SVGPointList, SVGPointListTearOff> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(981);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGPointListTearOff;
};
