...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_INSTALL_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_INSTALL_ELEMENT_H_
...
class HTMLInstallElement;
struct WrapperTypeInfo;

class CORE_EXPORT V8HTMLInstallElement final : public bindings::V8InterfaceBridge<V8HTMLInstallElement, HTMLInstallElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(625);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class HTMLInstallElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_INSTALL_ELEMENT_H_
