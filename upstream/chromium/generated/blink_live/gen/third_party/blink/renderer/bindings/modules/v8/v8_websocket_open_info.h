...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBSOCKET_OPEN_INFO_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBSOCKET_OPEN_INFO_H_
...
class MODULES_EXPORT WebSocketOpenInfo : public bindings::DictionaryBase {
  
  public:
static WebSocketOpenInfo* Create() {
  return MakeGarbageCollected<WebSocketOpenInfo>();
}
static WebSocketOpenInfo* Create(v8::Isolate* isolate) {
  return MakeGarbageCollected<WebSocketOpenInfo>(isolate);
}
static WebSocketOpenInfo* Create(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state);

explicit  WebSocketOpenInfo();
explicit  WebSocketOpenInfo(v8::Isolate* isolate);
...
String getExtensionsOr(const String& fallback_value) const;
String getExtensionsOr(String&& fallback_value) const;
void setExtensions(const String& value);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBSOCKET_OPEN_INFO_H_
