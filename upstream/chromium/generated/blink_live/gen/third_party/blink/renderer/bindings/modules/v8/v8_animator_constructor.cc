...
const char* V8AnimatorConstructor::GetHumanReadableName() const {
  return "V8AnimatorConstructor";
}
...
base::expected<ScriptValue, ScriptValue> V8AnimatorConstructor::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const ScriptValue& arg1_options, const ScriptValue& arg2_state) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_options, arg2_state);
