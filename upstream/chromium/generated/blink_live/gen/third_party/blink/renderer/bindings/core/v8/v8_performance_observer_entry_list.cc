...
bool V8PerformanceObserverEntryList::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8PerformanceObserverEntryList::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8PerformanceObserverEntryList::InstallInterfaceTemplate,
    nullptr,
    "PerformanceObserverEntryList",
    nullptr,
    V8PerformanceObserverEntryList::kThisTag,
    V8PerformanceObserverEntryList::kMaxSubclassTag,
...
const WrapperTypeInfo& PerformanceObserverEntryList::wrapper_type_info_ =
    V8PerformanceObserverEntryList::wrapper_type_info_;
...
namespace v8_performance_observer_entry_list {
...
BLINK_BINDINGS_TRACE_EVENT("PerformanceObserverEntryList.getEntries");
...
BLINK_BINDINGS_TRACE_EVENT("PerformanceObserverEntryList.getEntriesByName");
...
BLINK_BINDINGS_TRACE_EVENT("PerformanceObserverEntryList.getEntriesByType");
...
using namespace v8_performance_observer_entry_list;

}  // namespace 

void V8PerformanceObserverEntryList::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8PerformanceObserverEntryList::GetWrapperTypeInfo();
...
void V8PerformanceObserverEntryList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "PerformanceObserverEntryList", kOperationTable);
}
