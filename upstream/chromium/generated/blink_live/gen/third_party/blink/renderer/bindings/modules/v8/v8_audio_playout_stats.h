...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_AUDIO_PLAYOUT_STATS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_AUDIO_PLAYOUT_STATS_H_
...
class MODULES_EXPORT V8AudioPlayoutStats final : public bindings::V8InterfaceBridge<V8AudioPlayoutStats, AudioPlayoutStats> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1278);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class AudioPlayoutStats;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_AUDIO_PLAYOUT_STATS_H_
