...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_GPU_SUB_IMAGE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_GPU_SUB_IMAGE_H_
...
class MODULES_EXPORT V8XRGPUSubImage final : public bindings::V8InterfaceBridge<V8XRGPUSubImage, XRGPUSubImage> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1448);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XRGPUSubImage;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_GPU_SUB_IMAGE_H_
