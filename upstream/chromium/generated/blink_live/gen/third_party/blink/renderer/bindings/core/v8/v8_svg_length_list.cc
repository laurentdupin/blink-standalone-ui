...
bool V8SVGLengthList::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8SVGLengthList::wrapper_type_info_{
    ...
    "SVGLengthList",
    nullptr,
    V8SVGLengthList::kThisTag,
    V8SVGLengthList::kMaxSubclassTag,
...
const WrapperTypeInfo& SVGLengthListTearOff::wrapper_type_info_ =
    V8SVGLengthList::wrapper_type_info_;
...
v8::Intercepted V8SVGLengthList::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
SVGLengthListTearOff* blink_receiver = V8SVGLengthList::ToWrappableUnsafe(isolate, v8_receiver);
...
v8::Intercepted V8SVGLengthList::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
...
v8::Intercepted V8SVGLengthList::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
...
v8::Intercepted V8SVGLengthList::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
...
return V8SVGLengthList::IndexedPropertySetterCallback(
    index,
...
v8::Intercepted V8SVGLengthList::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
instance_template->SetHandler(
    v8::IndexedPropertyHandlerConfiguration(
        ...
        nullptr,  // query
        V8SVGLengthList::IndexedPropertyDeleterCallback,
        V8SVGLengthList::IndexedPropertyEnumeratorCallback,
...
void V8SVGLengthList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGLengthList", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGLengthList", kOperationTable);
}
