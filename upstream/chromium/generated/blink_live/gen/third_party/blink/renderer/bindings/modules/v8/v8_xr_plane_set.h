...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_PLANE_SET_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_PLANE_SET_H_
...
class MODULES_EXPORT V8XRPlaneSet final : public bindings::V8InterfaceBridge<V8XRPlaneSet, XRPlaneSet> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1440);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XRPlaneSet;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_PLANE_SET_H_
