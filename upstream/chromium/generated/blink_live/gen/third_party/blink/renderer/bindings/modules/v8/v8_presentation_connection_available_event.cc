...
bool V8PresentationConnectionAvailableEvent::IsExposed(ExecutionContext* execution_context) {
  
const bool is_in_secure_context = execution_context->IsSecureContext();
return is_in_secure_context && execution_context->IsWindow() && RuntimeEnabledFeatures::PresentationEnabled();
}

static_assert(std::derived_from<PresentationConnectionAvailableEvent, Event>);
...
const WrapperTypeInfo V8PresentationConnectionAvailableEvent::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8PresentationConnectionAvailableEvent::InstallInterfaceTemplate,
    nullptr,
    "PresentationConnectionAvailableEvent",
    V8Event::GetWrapperTypeInfo(),
    V8PresentationConnectionAvailableEvent::kThisTag,
    V8PresentationConnectionAvailableEvent::kMaxSubclassTag,
...
const WrapperTypeInfo& PresentationConnectionAvailableEvent::wrapper_type_info_ =
    V8PresentationConnectionAvailableEvent::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, PresentationConnectionAvailableEvent>::value,
    "PresentationConnectionAvailableEvent inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_presentation_connection_available_event {
...
BLINK_BINDINGS_TRACE_EVENT("PresentationConnectionAvailableEvent.connection.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
PresentationConnectionAvailableEvent* blink_receiver = V8PresentationConnectionAvailableEvent::ToWrappableUnsafe(isolate, v8_receiver);
auto&& return_value = blink_receiver->connection();
static_assert(bindings::IsReturnTypeCompatible<PresentationConnection, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
BLINK_BINDINGS_TRACE_EVENT("PresentationConnectionAvailableEvent.isTrusted.get");
...
BLINK_BINDINGS_TRACE_EVENT("PresentationConnectionAvailableEvent.constructor");
...
auto&& arg2_event_init_dict = NativeValueTraits<PresentationConnectionAvailableEventInit>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& return_value = PresentationConnectionAvailableEvent::Create(arg1_type, arg2_event_init_dict);
static_assert(bindings::IsReturnTypeCompatible<PresentationConnectionAvailableEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8PresentationConnectionAvailableEvent::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_presentation_connection_available_event;

}  // namespace 

void V8PresentationConnectionAvailableEvent::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8PresentationConnectionAvailableEvent::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "PresentationConnectionAvailableEvent"));
...
void V8PresentationConnectionAvailableEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "PresentationConnectionAvailableEvent", kAttributeTable);
}
