...
const WrapperTypeInfo V8RestrictionTarget::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8RestrictionTarget::InstallInterfaceTemplate,
    V8RestrictionTarget::InstallContextDependentProperties,
    "RestrictionTarget",
    nullptr,
    V8RestrictionTarget::kThisTag,
    V8RestrictionTarget::kMaxSubclassTag,
...
const WrapperTypeInfo& RestrictionTarget::wrapper_type_info_ =
    V8RestrictionTarget::wrapper_type_info_;
...
namespace v8_restriction_target {

void FromElementStaticOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_RestrictionTarget_fromElement");
BLINK_BINDINGS_TRACE_EVENT("RestrictionTarget.fromElement");
...
const char* const class_like_name = "RestrictionTarget";
...
auto&& return_value = RestrictionTarget::fromElement(script_state, arg1_element, exception_state);
static_assert(bindings::IsReturnTypeCompatible<IDLPromise<RestrictionTarget>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
using namespace v8_restriction_target;

}  // namespace 

void V8RestrictionTarget::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8RestrictionTarget::GetWrapperTypeInfo();
...
void V8RestrictionTarget::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object, v8::Local<v8::Object> prototype_object, v8::Local<v8::Object> interface_object, v8::Local<v8::Template> interface_template, FeatureSelector feature_selector) {
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_object, prototype_object, interface_object, signature, "RestrictionTarget", kOperationTable);
}
