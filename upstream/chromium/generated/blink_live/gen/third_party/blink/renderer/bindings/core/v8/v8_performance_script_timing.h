...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PERFORMANCE_SCRIPT_TIMING_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PERFORMANCE_SCRIPT_TIMING_H_
...
class CORE_EXPORT V8PerformanceScriptTiming final : public bindings::V8InterfaceBridge<V8PerformanceScriptTiming, PerformanceScriptTiming> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1008);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PerformanceScriptTiming;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PERFORMANCE_SCRIPT_TIMING_H_
