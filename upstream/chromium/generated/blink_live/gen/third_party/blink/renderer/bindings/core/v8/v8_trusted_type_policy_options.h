...
class V8CreateParserOptionsCallback;
...
bool hasCreateParserOptions() const {
  return has_create_parser_options_;
}
V8CreateParserOptionsCallback* createParserOptions() const {
  DCHECK(hasCreateParserOptions());
return member_create_parser_options_.Get();
}
V8CreateParserOptionsCallback* getCreateParserOptionsOr(V8CreateParserOptionsCallback* fallback_value) const {
  if (!hasCreateParserOptions()) {
  return fallback_value;
}
return member_create_parser_options_.Get();
}
void setCreateParserOptions(V8CreateParserOptionsCallback* value) {
  member_create_parser_options_ = value;
has_create_parser_options_ = true;
DCHECK(member_create_parser_options_);
}
