...
bool V8WebGLSync::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow() || execution_context->IsWorkerGlobalScope();
}

static_assert(std::derived_from<WebGLSync, WebGLObject>);
...
const WrapperTypeInfo V8WebGLSync::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8WebGLSync::InstallInterfaceTemplate,
    nullptr,
    "WebGLSync",
    V8WebGLObject::GetWrapperTypeInfo(),
    V8WebGLSync::kThisTag,
    V8WebGLSync::kMaxSubclassTag,
...
const WrapperTypeInfo& WebGLSync::wrapper_type_info_ =
    V8WebGLSync::wrapper_type_info_;
...
namespace v8_webgl_sync {



}  // namespace v8_webgl_sync

using namespace v8_webgl_sync;

}  // namespace 

void V8WebGLSync::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8WebGLSync::GetWrapperTypeInfo();
