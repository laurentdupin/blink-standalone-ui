...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PERFORMANCE_EVENT_TIMING_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PERFORMANCE_EVENT_TIMING_H_
...
class CORE_EXPORT V8PerformanceEventTiming final : public bindings::V8InterfaceBridge<V8PerformanceEventTiming, PerformanceEventTiming> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1000);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PerformanceEventTiming;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PERFORMANCE_EVENT_TIMING_H_
