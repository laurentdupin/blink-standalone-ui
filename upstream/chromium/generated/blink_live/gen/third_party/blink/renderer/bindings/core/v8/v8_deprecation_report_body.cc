...
bool V8DeprecationReportBody::IsExposed(ExecutionContext* execution_context) {
  return false;
}

static_assert(std::derived_from<DeprecationReportBody, ReportBody>);
...
const WrapperTypeInfo V8DeprecationReportBody::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8DeprecationReportBody::InstallInterfaceTemplate,
    V8DeprecationReportBody::InstallContextDependentProperties,
    "DeprecationReportBody",
    V8ReportBody::GetWrapperTypeInfo(),
    V8DeprecationReportBody::kThisTag,
    V8DeprecationReportBody::kMaxSubclassTag,
...
const WrapperTypeInfo& DeprecationReportBody::wrapper_type_info_ =
    V8DeprecationReportBody::wrapper_type_info_;
...
namespace v8_deprecation_report_body {
...
BLINK_BINDINGS_TRACE_EVENT("DeprecationReportBody.id.get");
...
void AnticipatedRemovalAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DeprecationReportBody_anticipatedRemoval_Getter");
BLINK_BINDINGS_TRACE_EVENT("DeprecationReportBody.anticipatedRemoval.get");
...
auto&& return_value = blink_receiver->anticipatedRemoval(script_state);
...
BLINK_BINDINGS_TRACE_EVENT("DeprecationReportBody.message.get");
...
BLINK_BINDINGS_TRACE_EVENT("DeprecationReportBody.sourceFile.get");
...
BLINK_BINDINGS_TRACE_EVENT("DeprecationReportBody.lineNumber.get");
...
BLINK_BINDINGS_TRACE_EVENT("DeprecationReportBody.columnNumber.get");
...
void ToJSONOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DeprecationReportBody_toJSON");
BLINK_BINDINGS_TRACE_EVENT("DeprecationReportBody.toJSON");
...
using namespace v8_deprecation_report_body;

}  // namespace 

void V8DeprecationReportBody::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8DeprecationReportBody::GetWrapperTypeInfo();
...
void V8DeprecationReportBody::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"anticipatedRemoval", AnticipatedRemovalAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "DeprecationReportBody", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "DeprecationReportBody", kOperationTable);
}
...
void V8DeprecationReportBody::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object, v8::Local<v8::Object> prototype_object, v8::Local<v8::Object> interface_object, v8::Local<v8::Template> interface_template, FeatureSelector feature_selector) {
  using bindings::IDLMemberInstaller;
