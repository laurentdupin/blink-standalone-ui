...
bool V8TransformStreamDefaultController::IsExposed(ExecutionContext* execution_context) {
  return true;
}
...
const WrapperTypeInfo V8TransformStreamDefaultController::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8TransformStreamDefaultController::InstallInterfaceTemplate,
    nullptr,
    "TransformStreamDefaultController",
    nullptr,
    V8TransformStreamDefaultController::kThisTag,
    V8TransformStreamDefaultController::kMaxSubclassTag,
...
const WrapperTypeInfo& TransformStreamDefaultController::wrapper_type_info_ =
    V8TransformStreamDefaultController::wrapper_type_info_;
...
namespace v8_transform_stream_default_controller {
...
BLINK_BINDINGS_TRACE_EVENT("TransformStreamDefaultController.desiredSize.get");
...
BLINK_BINDINGS_TRACE_EVENT("TransformStreamDefaultController.enqueue");
...
BLINK_BINDINGS_TRACE_EVENT("TransformStreamDefaultController.error");
...
blink_receiver->error(script_state, arg1_reason);
} while (false);
...
BLINK_BINDINGS_TRACE_EVENT("TransformStreamDefaultController.terminate");
...
using namespace v8_transform_stream_default_controller;

}  // namespace 

void V8TransformStreamDefaultController::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8TransformStreamDefaultController::GetWrapperTypeInfo();
...
void V8TransformStreamDefaultController::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "TransformStreamDefaultController", kAttributeTable);
}
...
{"enqueue", EnqueueOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "TransformStreamDefaultController", kOperationTable);
}
