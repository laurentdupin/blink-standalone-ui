...
kNew, kChecking, kConnected, kCompleted, kFailed, kDisconnected, kClosed
};
...
explicit constexpr  V8RTCIceConnectionState(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
