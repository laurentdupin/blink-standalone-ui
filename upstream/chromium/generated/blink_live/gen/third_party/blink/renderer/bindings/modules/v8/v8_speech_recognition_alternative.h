...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SPEECH_RECOGNITION_ALTERNATIVE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SPEECH_RECOGNITION_ALTERNATIVE_H_
...
class MODULES_EXPORT V8SpeechRecognitionAlternative final : public bindings::V8InterfaceBridge<V8SpeechRecognitionAlternative, SpeechRecognitionAlternative> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1263);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SpeechRecognitionAlternative;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SPEECH_RECOGNITION_ALTERNATIVE_H_
