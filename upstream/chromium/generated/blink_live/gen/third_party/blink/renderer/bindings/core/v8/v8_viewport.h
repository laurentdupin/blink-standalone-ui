...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_VIEWPORT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_VIEWPORT_H_
...
class CORE_EXPORT V8Viewport final : public bindings::V8InterfaceBridge<V8Viewport, DOMViewport> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(876);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class DOMViewport;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_VIEWPORT_H_
