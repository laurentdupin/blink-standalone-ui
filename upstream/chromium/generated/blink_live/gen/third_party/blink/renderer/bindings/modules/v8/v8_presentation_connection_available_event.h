...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PRESENTATION_CONNECTION_AVAILABLE_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PRESENTATION_CONNECTION_AVAILABLE_EVENT_H_
...
class MODULES_EXPORT V8PresentationConnectionAvailableEvent final : public bindings::V8InterfaceBridge<V8PresentationConnectionAvailableEvent, PresentationConnectionAvailableEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(444);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PresentationConnectionAvailableEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PRESENTATION_CONNECTION_AVAILABLE_EVENT_H_
