...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_AUDIO_SINK_INFO_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_AUDIO_SINK_INFO_H_
...
class MODULES_EXPORT V8AudioSinkInfo final : public bindings::V8InterfaceBridge<V8AudioSinkInfo, AudioSinkInfo> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1279);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class AudioSinkInfo;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_AUDIO_SINK_INFO_H_
