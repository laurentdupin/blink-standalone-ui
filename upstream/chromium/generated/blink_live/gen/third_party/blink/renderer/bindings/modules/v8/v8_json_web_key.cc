...
String JsonWebKey::getPrivOr(const String& fallback_value) const {
  if (!hasPriv()) {
  return fallback_value;
}
return member_priv_;
...
String JsonWebKey::getPrivOr(String&& fallback_value) const {
  if (!hasPriv()) {
  return std::move(fallback_value);
}
return member_priv_;
...
void JsonWebKey::setPriv(const String& value) {
  member_priv_ = value;
has_priv_ = true;
}

void JsonWebKey::setPriv(String&& value) {
  member_priv_ = std::move(value);
has_priv_ = true;
}
...
String JsonWebKey::getPubOr(const String& fallback_value) const {
  if (!hasPub()) {
  return fallback_value;
}
return member_pub_;
...
String JsonWebKey::getPubOr(String&& fallback_value) const {
  if (!hasPub()) {
  return std::move(fallback_value);
}
return member_pub_;
...
void JsonWebKey::setPub(const String& value) {
  member_pub_ = value;
has_pub_ = true;
}

void JsonWebKey::setPub(String&& value) {
  member_pub_ = std::move(value);
has_pub_ = true;
}
...
dictionary_from_v8_context.SetCurrentPropertyName("priv");
if (!bindings::GetDictionaryMemberFromV8Object<IDLString, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[13].Get(isolate), has_priv_, member_priv_, class_like_name, exception_state)) {
  return;
}
dictionary_from_v8_context.SetCurrentPropertyName("pub");
if (!bindings::GetDictionaryMemberFromV8Object<IDLString, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[14].Get(isolate), has_pub_, member_pub_, class_like_name, exception_state)) {
  return;
}
dictionary_from_v8_context.SetCurrentPropertyName("q");
if (!bindings::GetDictionaryMemberFromV8Object<IDLString, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[15].Get(isolate), has_q_, member_q_, class_like_name, exception_state)) {
  return;
}
dictionary_from_v8_context.SetCurrentPropertyName("qi");
if (!bindings::GetDictionaryMemberFromV8Object<IDLString, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[16].Get(isolate), has_qi_, member_qi_, class_like_name, exception_state)) {
  return;
}
dictionary_from_v8_context.SetCurrentPropertyName("use");
if (!bindings::GetDictionaryMemberFromV8Object<IDLString, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[17].Get(isolate), has_use_, member_use_, class_like_name, exception_state)) {
  return;
}
dictionary_from_v8_context.SetCurrentPropertyName("x");
if (!bindings::GetDictionaryMemberFromV8Object<IDLString, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[18].Get(isolate), has_x_, member_x_, class_like_name, exception_state)) {
  return;
}
dictionary_from_v8_context.SetCurrentPropertyName("y");
if (!bindings::GetDictionaryMemberFromV8Object<IDLString, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[19].Get(isolate), has_y_, member_y_, class_like_name, exception_state)) {
  return;
}
}
