...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_TRANSFORM_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_TRANSFORM_EVENT_H_
...
class MODULES_EXPORT V8RTCTransformEvent final : public bindings::V8InterfaceBridge<V8RTCTransformEvent, RTCTransformEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(455);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class RTCTransformEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_TRANSFORM_EVENT_H_
