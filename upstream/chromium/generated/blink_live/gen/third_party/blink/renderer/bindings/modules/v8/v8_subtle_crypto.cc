...
return is_in_secure_context && (execution_context->IsWindow() || execution_context->IsWorkerGlobalScope() || execution_context->IsSharedStorageWorkletGlobalScope());
}
...
void DecapsulateBitsOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SubtleCrypto_decapsulateBits");
BLINK_BINDINGS_TRACE_EVENT("SubtleCrypto.decapsulateBits");
...
// [Measure], [MeasureAs]
UseCounter::Count(current_execution_context, WebFeature::kSubtleCryptoDecapsulateBits);
...
const char* const property_name = "decapsulateBits";
ExceptionState exception_state(isolate, ExceptionContext(exception_context_type, class_like_name, property_name));
auto&& arg1_decapsulation_algorithm = NativeValueTraits<V8UnionObjectOrString>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& arg2_decapsulation_key = NativeValueTraits<CryptoKey>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& arg3_ciphertext = NativeValueTraits<V8UnionArrayBufferOrArrayBufferView>::ArgumentValue(isolate, 2, info[2], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& return_value = blink_receiver->decapsulateBits(script_state, arg1_decapsulation_algorithm, arg2_decapsulation_key, arg3_ciphertext, exception_state);
...
void DecapsulateKeyOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SubtleCrypto_decapsulateKey");
BLINK_BINDINGS_TRACE_EVENT("SubtleCrypto.decapsulateKey");
// Promise returning function: Convert a TypeError to a reject promise.
ExceptionToRejectPromiseScope reject_promise_scope(info);
...
ExecutionContext* current_execution_context = ToExecutionContext(current_script_state);
// [Measure], [MeasureAs]
UseCounter::Count(current_execution_context, WebFeature::kSubtleCryptoDecapsulateKey);
...
const v8::ExceptionContext exception_context_type = v8::ExceptionContext::kOperation;
const char* const class_like_name = "SubtleCrypto";
const char* const property_name = "decapsulateKey";
ExceptionState exception_state(isolate, ExceptionContext(exception_context_type, class_like_name, property_name));
auto&& arg1_decapsulation_algorithm = NativeValueTraits<V8UnionObjectOrString>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
...
auto&& arg4_shared_key_algorithm = NativeValueTraits<V8UnionObjectOrString>::ArgumentValue(isolate, 3, info[3], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& arg5_extractable = NativeValueTraits<IDLBoolean>::ArgumentValue(isolate, 4, info[4], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& arg6_key_usages = NativeValueTraits<IDLSequence<IDLString>>::ArgumentValue(isolate, 5, info[5], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& return_value = blink_receiver->decapsulateKey(script_state, arg1_decapsulation_algorithm, arg2_decapsulation_key, arg3_ciphertext, arg4_shared_key_algorithm, arg5_extractable, std::move(arg6_key_usages), exception_state);
static_assert(bindings::IsReturnTypeCompatible<IDLPromise<CryptoKey>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
bindings::V8SetReturnValue(info, return_value);
...
decltype(NativeValueTraits<IDLNullable<IDLUnsignedLong>>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg3_length;
...
auto&& return_value = blink_receiver->deriveKey(script_state, arg1_algorithm, arg2_base_key, arg3_derived_key_type, arg4_extractable, std::move(arg5_key_usages), exception_state);
static_assert(bindings::IsReturnTypeCompatible<IDLPromise<IDLAny>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
void EncapsulateBitsOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SubtleCrypto_encapsulateBits");
BLINK_BINDINGS_TRACE_EVENT("SubtleCrypto.encapsulateBits");
// Promise returning function: Convert a TypeError to a reject promise.
ExceptionToRejectPromiseScope reject_promise_scope(info);
...
ExecutionContext* current_execution_context = ToExecutionContext(current_script_state);
// [Measure], [MeasureAs]
UseCounter::Count(current_execution_context, WebFeature::kSubtleCryptoEncapsulateBits);
...
const v8::ExceptionContext exception_context_type = v8::ExceptionContext::kOperation;
const char* const class_like_name = "SubtleCrypto";
const char* const property_name = "encapsulateBits";
ExceptionState exception_state(isolate, ExceptionContext(exception_context_type, class_like_name, property_name));
auto&& arg1_encapsulation_algorithm = NativeValueTraits<V8UnionObjectOrString>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& arg2_encapsulation_key = NativeValueTraits<CryptoKey>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& return_value = blink_receiver->encapsulateBits(script_state, arg1_encapsulation_algorithm, arg2_encapsulation_key, exception_state);
static_assert(bindings::IsReturnTypeCompatible<IDLPromise<EncapsulatedBits>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
bindings::V8SetReturnValue(info, return_value);
...
void EncapsulateKeyOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SubtleCrypto_encapsulateKey");
BLINK_BINDINGS_TRACE_EVENT("SubtleCrypto.encapsulateKey");
// Promise returning function: Convert a TypeError to a reject promise.
ExceptionToRejectPromiseScope reject_promise_scope(info);
...
ExecutionContext* current_execution_context = ToExecutionContext(current_script_state);
// [Measure], [MeasureAs]
UseCounter::Count(current_execution_context, WebFeature::kSubtleCryptoEncapsulateKey);
...
const v8::ExceptionContext exception_context_type = v8::ExceptionContext::kOperation;
const char* const class_like_name = "SubtleCrypto";
const char* const property_name = "encapsulateKey";
ExceptionState exception_state(isolate, ExceptionContext(exception_context_type, class_like_name, property_name));
auto&& arg1_encapsulation_algorithm = NativeValueTraits<V8UnionObjectOrString>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
...
auto&& arg3_shared_key_algorithm = NativeValueTraits<V8UnionObjectOrString>::ArgumentValue(isolate, 2, info[2], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& arg4_extractable = NativeValueTraits<IDLBoolean>::ArgumentValue(isolate, 3, info[3], exception_state);
...
auto&& return_value = blink_receiver->encapsulateKey(script_state, arg1_encapsulation_algorithm, arg2_encapsulation_key, arg3_shared_key_algorithm, arg4_extractable, std::move(arg5_key_usages), exception_state);
static_assert(bindings::IsReturnTypeCompatible<IDLPromise<EncapsulatedKey>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
bindings::V8SetReturnValue(info, return_value);
...
auto&& return_value = blink_receiver->exportKey(script_state, arg1_format, arg2_key, exception_state);
static_assert(bindings::IsReturnTypeCompatible<IDLPromise<IDLAny>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
auto&& return_value = blink_receiver->generateKey(script_state, arg1_algorithm, arg2_extractable, std::move(arg3_key_usages), exception_state);
static_assert(bindings::IsReturnTypeCompatible<IDLPromise<V8UnionCryptoKeyOrCryptoKeyPair>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
bindings::V8SetReturnValue(info, return_value);
...
auto&& return_value = blink_receiver->importKey(script_state, arg1_format, arg2_key_data, arg3_algorithm, arg4_extractable, std::move(arg5_key_usages), exception_state);
static_assert(bindings::IsReturnTypeCompatible<IDLPromise<CryptoKey>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
auto&& return_value = blink_receiver->unwrapKey(script_state, arg1_format, arg2_wrapped_key, arg3_unwrapping_key, arg4_unwrap_algorithm, arg5_unwrapped_key_algorithm, arg6_extractable, std::move(arg7_key_usages), exception_state);
static_assert(bindings::IsReturnTypeCompatible<IDLPromise<CryptoKey>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
void V8SubtleCrypto::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"deriveBits", DeriveBitsOperationCallback, 2, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kDoNotCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "SubtleCrypto", kOperationTable);
}
...
void V8SubtleCrypto::InstallContextIndependentProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
  using bindings::IDLMemberInstaller;
...
if (RuntimeEnabledFeatures::WebCryptoPQCEnabled()) {
  static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
{"decapsulateBits", DecapsulateBitsOperationCallback, 3, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kDoNotCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
{"decapsulateKey", DecapsulateKeyOperationCallback, 6, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kDoNotCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
{"encapsulateBits", EncapsulateBitsOperationCallback, 2, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kDoNotCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
{"encapsulateKey", EncapsulateKeyOperationCallback, 5, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kDoNotCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
};
v8::Local<v8::Signature> signature = v8::Local<v8::Signature>::Cast(interface_template);
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "SubtleCrypto", kOperationTable);
}
