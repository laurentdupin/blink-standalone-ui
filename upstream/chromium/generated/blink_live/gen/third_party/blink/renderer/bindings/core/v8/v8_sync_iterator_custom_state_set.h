...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SYNC_ITERATOR_CUSTOM_STATE_SET_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SYNC_ITERATOR_CUSTOM_STATE_SET_H_
...
template <>
class CORE_EXPORT SyncIterator<CustomStateSet> final : public bindings::SyncIteratorBase {
...
explicit  SyncIterator<CustomStateSet>(IterationSourceBase* source, Kind kind) : bindings::SyncIteratorBase(source, kind) {
...
class CORE_EXPORT V8SyncIteratorCustomStateSet final : public bindings::V8InterfaceBridge<V8SyncIteratorCustomStateSet, SyncIterator<CustomStateSet>> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1490);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SyncIterator<CustomStateSet>;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SYNC_ITERATOR_CUSTOM_STATE_SET_H_
