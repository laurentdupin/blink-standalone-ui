...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_ELLIPSE_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_ELLIPSE_ELEMENT_H_
...
class CORE_EXPORT V8SVGEllipseElement final : public bindings::V8InterfaceBridge<V8SVGEllipseElement, SVGEllipseElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(721);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGEllipseElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_ELLIPSE_ELEMENT_H_
