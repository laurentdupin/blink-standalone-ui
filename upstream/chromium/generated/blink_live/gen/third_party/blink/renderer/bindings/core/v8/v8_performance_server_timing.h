...
class CORE_EXPORT V8PerformanceServerTiming final : public bindings::V8InterfaceBridge<V8PerformanceServerTiming, PerformanceServerTiming> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1015);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PerformanceServerTiming;
};
