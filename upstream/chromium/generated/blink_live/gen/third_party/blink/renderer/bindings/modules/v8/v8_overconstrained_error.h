...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OVERCONSTRAINED_ERROR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OVERCONSTRAINED_ERROR_H_
...
class MODULES_EXPORT V8OverconstrainedError final : public bindings::V8InterfaceBridge<V8OverconstrainedError, OverconstrainedError> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(363);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class OverconstrainedError;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OVERCONSTRAINED_ERROR_H_
