...
static_assert(std::derived_from<CSSImportRule, CSSRule>);
...
const WrapperTypeInfo& CSSImportRule::wrapper_type_info_ =
    V8CSSImportRule::wrapper_type_info_;
...
void V8CSSImportRule::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "CSSImportRule", kAttributeTable);
}
