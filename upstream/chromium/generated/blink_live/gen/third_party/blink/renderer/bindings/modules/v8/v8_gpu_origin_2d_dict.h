...
class MODULES_EXPORT GPUOrigin2DDict : public bindings::DictionaryBase {
  
  public:
static GPUOrigin2DDict* Create() {
  return MakeGarbageCollected<GPUOrigin2DDict>();
}
static GPUOrigin2DDict* Create(v8::Isolate* isolate) {
  return MakeGarbageCollected<GPUOrigin2DDict>(isolate);
}
static GPUOrigin2DDict* Create(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state);

explicit  GPUOrigin2DDict();
explicit  GPUOrigin2DDict(v8::Isolate* isolate);
