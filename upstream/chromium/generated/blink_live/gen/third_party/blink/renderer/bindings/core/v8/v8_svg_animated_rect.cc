...
bool V8SVGAnimatedRect::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8SVGAnimatedRect::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SVGAnimatedRect::InstallInterfaceTemplate,
    nullptr,
    "SVGAnimatedRect",
    nullptr,
    V8SVGAnimatedRect::kThisTag,
    V8SVGAnimatedRect::kMaxSubclassTag,
...
const WrapperTypeInfo& SVGAnimatedRect::wrapper_type_info_ =
    V8SVGAnimatedRect::wrapper_type_info_;
...
namespace v8_svg_animated_rect {
...
BLINK_BINDINGS_TRACE_EVENT("SVGAnimatedRect.baseVal.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGAnimatedRect.animVal.get");
...
using namespace v8_svg_animated_rect;

}  // namespace 

void V8SVGAnimatedRect::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SVGAnimatedRect::GetWrapperTypeInfo();
...
void V8SVGAnimatedRect::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGAnimatedRect", kAttributeTable);
}
