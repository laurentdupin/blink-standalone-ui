...
const char* V8AudioDataOutputCallback::GetHumanReadableName() const {
  return "V8AudioDataOutputCallback";
}

v8::Maybe<void> V8AudioDataOutputCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, AudioData* arg1_output) {
  const char* const class_like_name = "AudioDataOutputCallback";
...
v8_arg1_output = ToV8Traits<AudioData>::ToV8(script_state, arg1_output);
...
v8::Maybe<void> V8AudioDataOutputCallback::Construct(AudioData* arg1_output) {
  const char* const class_like_name = "AudioDataOutputCallback";
...
void V8AudioDataOutputCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, AudioData* arg1_output) {
  v8::Isolate* isolate = GetIsolate();
...
base::expected<void, ScriptValue> V8AudioDataOutputCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, AudioData* arg1_output) {
