...
std::optional<Vector<String>> ReportingObserverOptions::getTypesOr(const std::optional<Vector<String>>& fallback_value) const {
  if (!hasTypes()) {
...
std::optional<Vector<String>> ReportingObserverOptions::getTypesOr(std::optional<Vector<String>>&& fallback_value) const {
  if (!hasTypes()) {
...
void ReportingObserverOptions::setTypes(const std::optional<Vector<String>>& value) {
  member_types_ = value;
has_types_ = true;
}

void ReportingObserverOptions::setTypes(std::optional<Vector<String>>&& value) {
...
if (!bindings::GetDictionaryMemberFromV8Object<IDLNullable<IDLSequence<IDLString>>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate), has_types_, member_types_, class_like_name, exception_state)) {
  return;
}
}
