...
bool V8CSPViolationReportBody::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<CSPViolationReportBody, ReportBody>);
...
const WrapperTypeInfo V8CSPViolationReportBody::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8CSPViolationReportBody::InstallInterfaceTemplate,
    V8CSPViolationReportBody::InstallContextDependentProperties,
    "CSPViolationReportBody",
    V8ReportBody::GetWrapperTypeInfo(),
    V8CSPViolationReportBody::kThisTag,
    V8CSPViolationReportBody::kMaxSubclassTag,
...
const WrapperTypeInfo& CSPViolationReportBody::wrapper_type_info_ =
    V8CSPViolationReportBody::wrapper_type_info_;
...
namespace v8_csp_violation_report_body {
...
BLINK_BINDINGS_TRACE_EVENT("CSPViolationReportBody.documentURL.get");
...
BLINK_BINDINGS_TRACE_EVENT("CSPViolationReportBody.referrer.get");
...
BLINK_BINDINGS_TRACE_EVENT("CSPViolationReportBody.blockedURL.get");
...
BLINK_BINDINGS_TRACE_EVENT("CSPViolationReportBody.effectiveDirective.get");
...
BLINK_BINDINGS_TRACE_EVENT("CSPViolationReportBody.originalPolicy.get");
...
BLINK_BINDINGS_TRACE_EVENT("CSPViolationReportBody.sourceFile.get");
...
BLINK_BINDINGS_TRACE_EVENT("CSPViolationReportBody.sample.get");
...
BLINK_BINDINGS_TRACE_EVENT("CSPViolationReportBody.disposition.get");
...
BLINK_BINDINGS_TRACE_EVENT("CSPViolationReportBody.statusCode.get");
...
BLINK_BINDINGS_TRACE_EVENT("CSPViolationReportBody.lineNumber.get");
...
BLINK_BINDINGS_TRACE_EVENT("CSPViolationReportBody.columnNumber.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSPViolationReportBody_urlHash_Getter");
BLINK_BINDINGS_TRACE_EVENT("CSPViolationReportBody.urlHash.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSPViolationReportBody_evalHash_Getter");
BLINK_BINDINGS_TRACE_EVENT("CSPViolationReportBody.evalHash.get");
...
void ToJSONOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSPViolationReportBody_toJSON");
BLINK_BINDINGS_TRACE_EVENT("CSPViolationReportBody.toJSON");
...
using namespace v8_csp_violation_report_body;

}  // namespace 

void V8CSPViolationReportBody::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8CSPViolationReportBody::GetWrapperTypeInfo();
...
void V8CSPViolationReportBody::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "CSPViolationReportBody", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "CSPViolationReportBody", kOperationTable);
}
...
void V8CSPViolationReportBody::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object, v8::Local<v8::Object> prototype_object, v8::Local<v8::Object> interface_object, v8::Local<v8::Template> interface_template, FeatureSelector feature_selector) {
  using bindings::IDLMemberInstaller;
...
v8::Local<v8::Signature> signature = v8::Local<v8::Signature>::Cast(interface_template);
IDLMemberInstaller::InstallAttributes(isolate, world, instance_object, prototype_object, interface_object, signature, "CSPViolationReportBody", kAttributeTable);
}
