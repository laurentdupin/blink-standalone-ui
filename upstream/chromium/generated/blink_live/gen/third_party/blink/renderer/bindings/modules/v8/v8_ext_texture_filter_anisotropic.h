...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_TEXTURE_FILTER_ANISOTROPIC_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_TEXTURE_FILTER_ANISOTROPIC_H_
...
class MODULES_EXPORT V8EXTTextureFilterAnisotropic final : public bindings::V8InterfaceBridge<V8EXTTextureFilterAnisotropic, EXTTextureFilterAnisotropic> {
...
class Constant final {
  ...
  public:
static constexpr uint32_t kTextureMaxAnisotropyExt = 0x84FE;
static constexpr uint32_t kMaxTextureMaxAnisotropyExt = 0x84FF;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1308);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class EXTTextureFilterAnisotropic;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_TEXTURE_FILTER_ANISOTROPIC_H_
