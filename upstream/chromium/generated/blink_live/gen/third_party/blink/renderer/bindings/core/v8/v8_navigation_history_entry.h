...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NAVIGATION_HISTORY_ENTRY_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NAVIGATION_HISTORY_ENTRY_H_
...
class CORE_EXPORT V8NavigationHistoryEntry final : public bindings::V8InterfaceBridge<V8NavigationHistoryEntry, NavigationHistoryEntry> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(577);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class NavigationHistoryEntry;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NAVIGATION_HISTORY_ENTRY_H_
