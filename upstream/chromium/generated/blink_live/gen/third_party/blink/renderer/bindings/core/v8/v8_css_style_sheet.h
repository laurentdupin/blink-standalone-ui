...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_STYLE_SHEET_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_STYLE_SHEET_H_
...
class CORE_EXPORT V8CSSStyleSheet final : public bindings::V8InterfaceBridge<V8CSSStyleSheet, CSSStyleSheet> {
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_STYLE_SHEET_H_
