...
if (!v8_value->IsObject()) {
  const char* const class_like_name = "ConstantSourceOptions";
...
return dictionary;
 ...
 ConstantSourceOptions::ConstantSourceOptions(v8::Isolate* isolate) {
...
void ConstantSourceOptions::Trace(Visitor* visitor) const {
...
if (!bindings::GetDictionaryMemberFromV8Object<IDLFloat, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), fallback_presence_var, member_offset_, class_like_name, exception_state)) {
  return;
}
}
