...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SYNC_ITERATOR_HEADERS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SYNC_ITERATOR_HEADERS_H_
...
template <>
class CORE_EXPORT SyncIterator<Headers> final : public bindings::SyncIteratorBase {
  DEFINE_WRAPPERTYPEINFO();

  public:
using IDLKeyType = IDLByteString;
using IDLValueType = IDLByteString;
using KeyType = String;
using ValueType = String;

explicit  SyncIterator<Headers>(IterationSourceBase* source, Kind kind) : bindings::SyncIteratorBase(source, kind) {
...
class CORE_EXPORT V8SyncIteratorHeaders final : public bindings::V8InterfaceBridge<V8SyncIteratorHeaders, SyncIterator<Headers>> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1487);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SyncIterator<Headers>;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SYNC_ITERATOR_HEADERS_H_
