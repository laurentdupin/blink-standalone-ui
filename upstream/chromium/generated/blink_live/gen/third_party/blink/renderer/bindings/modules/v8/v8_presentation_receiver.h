...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PRESENTATION_RECEIVER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PRESENTATION_RECEIVER_H_
...
class MODULES_EXPORT V8PresentationReceiver final : public bindings::V8InterfaceBridge<V8PresentationReceiver, PresentationReceiver> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1236);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PresentationReceiver;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PRESENTATION_RECEIVER_H_
