...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_ENCODED_AUDIO_FRAME_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_ENCODED_AUDIO_FRAME_H_
...
class MODULES_EXPORT V8RTCEncodedAudioFrame final : public bindings::V8InterfaceBridge<V8RTCEncodedAudioFrame, RTCEncodedAudioFrame> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1217);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class RTCEncodedAudioFrame;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_ENCODED_AUDIO_FRAME_H_
