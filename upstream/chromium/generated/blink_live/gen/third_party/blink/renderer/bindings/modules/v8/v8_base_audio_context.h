...
class MODULES_EXPORT V8BaseAudioContext final : public bindings::V8InterfaceBridge<V8BaseAudioContext, BaseAudioContext> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(528);
