...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_FUNC_G_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_FUNC_G_ELEMENT_H_
...
class CORE_EXPORT V8SVGFEFuncGElement final : public bindings::V8InterfaceBridge<V8SVGFEFuncGElement, SVGFEFuncGElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(686);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGFEFuncGElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_FUNC_G_ELEMENT_H_
