...
class MODULES_EXPORT V8FileWriterSync final : public bindings::V8InterfaceBridge<V8FileWriterSync, FileWriterSync> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1164);
