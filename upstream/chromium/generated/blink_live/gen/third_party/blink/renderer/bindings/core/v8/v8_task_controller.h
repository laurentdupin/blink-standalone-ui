...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TASK_CONTROLLER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TASK_CONTROLLER_H_
...
class DOMTaskController;
class ExecutionContext;
struct WrapperTypeInfo;

class CORE_EXPORT V8TaskController final : public bindings::V8InterfaceBridge<V8TaskController, DOMTaskController> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(354);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class DOMTaskController;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TASK_CONTROLLER_H_
