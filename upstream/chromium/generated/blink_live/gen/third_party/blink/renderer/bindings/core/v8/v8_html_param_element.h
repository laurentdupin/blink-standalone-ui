...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_PARAM_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_PARAM_ELEMENT_H_
...
class CORE_EXPORT V8HTMLParamElement final : public bindings::V8InterfaceBridge<V8HTMLParamElement, HTMLParamElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(649);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class HTMLParamElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_PARAM_ELEMENT_H_
