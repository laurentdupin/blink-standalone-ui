...
class MODULES_EXPORT V8RTCPriorityType final : public bindings::EnumerationBase {
  
  public:
enum class Enum : enum_int_t {
kVeryLow, kLow, kMedium, kHigh
};
static constexpr size_t kEnumSize = 4;

static V8RTCPriorityType Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8RTCPriorityType> Create(const String& value);

explicit constexpr  V8RTCPriorityType(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8RTCPriorityType& lhs, V8RTCPriorityType::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8RTCPriorityType::Enum lhs, const V8RTCPriorityType& rhs) {
