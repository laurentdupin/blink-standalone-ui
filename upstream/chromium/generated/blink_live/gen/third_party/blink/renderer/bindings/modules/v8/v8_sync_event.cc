...
bool V8SyncEvent::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsServiceWorkerGlobalScope();
}

static_assert(std::derived_from<SyncEvent, ExtendableEvent>);
...
const WrapperTypeInfo V8SyncEvent::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SyncEvent::InstallInterfaceTemplate,
    nullptr,
    "SyncEvent",
    V8ExtendableEvent::GetWrapperTypeInfo(),
    V8SyncEvent::kThisTag,
    V8SyncEvent::kMaxSubclassTag,
...
const WrapperTypeInfo& SyncEvent::wrapper_type_info_ =
    V8SyncEvent::wrapper_type_info_;
...
BLINK_BINDINGS_TRACE_EVENT("SyncEvent.tag.get");
...
void LastChanceAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SyncEvent_lastChance_Getter");
BLINK_BINDINGS_TRACE_EVENT("SyncEvent.lastChance.get");
...
BLINK_BINDINGS_TRACE_EVENT("SyncEvent.isTrusted.get");
...
BLINK_BINDINGS_TRACE_EVENT("SyncEvent.constructor");
...
auto&& arg2_init = NativeValueTraits<SyncEventInit>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& return_value = SyncEvent::Create(arg1_type, arg2_init);
static_assert(bindings::IsReturnTypeCompatible<SyncEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8SyncEvent::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_sync_event;

}  // namespace 

void V8SyncEvent::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SyncEvent::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "SyncEvent"));
...
void V8SyncEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"lastChance", LastChanceAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SyncEvent", kAttributeTable);
}
