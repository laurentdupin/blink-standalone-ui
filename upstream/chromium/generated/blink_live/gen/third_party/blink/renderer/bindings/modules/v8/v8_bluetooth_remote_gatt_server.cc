...
bool V8BluetoothRemoteGATTServer::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8BluetoothRemoteGATTServer::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8BluetoothRemoteGATTServer::InstallInterfaceTemplate,
    nullptr,
    "BluetoothRemoteGATTServer",
    nullptr,
    V8BluetoothRemoteGATTServer::kThisTag,
    V8BluetoothRemoteGATTServer::kMaxSubclassTag,
...
const WrapperTypeInfo& BluetoothRemoteGATTServer::wrapper_type_info_ =
    V8BluetoothRemoteGATTServer::wrapper_type_info_;
...
namespace v8_bluetooth_remote_gatt_server {
...
BLINK_BINDINGS_TRACE_EVENT("BluetoothRemoteGATTServer.device.get");
...
static_assert(bindings::IsReturnTypeCompatible<BluetoothDevice, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
BLINK_BINDINGS_TRACE_EVENT("BluetoothRemoteGATTServer.connected.get");
...
BLINK_BINDINGS_TRACE_EVENT("BluetoothRemoteGATTServer.connect");
// Promise returning function: Convert a TypeError to a reject promise.
ExceptionToRejectPromiseScope reject_promise_scope(info);

v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
if (!V8BluetoothRemoteGATTServer::HasInstance(isolate, v8_receiver)) {
...
static_assert(bindings::IsReturnTypeCompatible<IDLPromise<BluetoothRemoteGATTServer>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
BLINK_BINDINGS_TRACE_EVENT("BluetoothRemoteGATTServer.disconnect");
...
blink_receiver->disconnect(script_state, exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
void GetPrimaryServiceOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_BluetoothRemoteGATTServer_getPrimaryService");
BLINK_BINDINGS_TRACE_EVENT("BluetoothRemoteGATTServer.getPrimaryService");
// Promise returning function: Convert a TypeError to a reject promise.
ExceptionToRejectPromiseScope reject_promise_scope(info);
...
const v8::ExceptionContext exception_context_type = v8::ExceptionContext::kOperation;
const char* const class_like_name = "BluetoothRemoteGATTServer";
const char* const property_name = "getPrimaryService";
ExceptionState exception_state(isolate, ExceptionContext(exception_context_type, class_like_name, property_name));
auto&& arg1_service = NativeValueTraits<V8UnionStringOrUnsignedLong>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& return_value = blink_receiver->getPrimaryService(script_state, arg1_service, exception_state);
static_assert(bindings::IsReturnTypeCompatible<IDLPromise<BluetoothRemoteGATTService>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
bindings::V8SetReturnValue(info, return_value);
...
void GetPrimaryServicesOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_BluetoothRemoteGATTServer_getPrimaryServices");
BLINK_BINDINGS_TRACE_EVENT("BluetoothRemoteGATTServer.getPrimaryServices");
// Promise returning function: Convert a TypeError to a reject promise.
ExceptionToRejectPromiseScope reject_promise_scope(info);
...
ScriptPromise<IDLSequence<BluetoothRemoteGATTService>> return_value;
const v8::ExceptionContext exception_context_type = v8::ExceptionContext::kOperation;
const char* const class_like_name = "BluetoothRemoteGATTServer";
const char* const property_name = "getPrimaryServices";
ExceptionState exception_state(isolate, ExceptionContext(exception_context_type, class_like_name, property_name));
...
return_value = blink_receiver->getPrimaryServices(script_state, arg1_service, exception_state);
} while (false);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
using namespace v8_bluetooth_remote_gatt_server;

}  // namespace 

void V8BluetoothRemoteGATTServer::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8BluetoothRemoteGATTServer::GetWrapperTypeInfo();
...
void V8BluetoothRemoteGATTServer::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "BluetoothRemoteGATTServer", kAttributeTable);
}
...
{"connect", ConnectOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kDoNotCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
...
{"getPrimaryService", GetPrimaryServiceOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kDoNotCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
{"getPrimaryServices", GetPrimaryServicesOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kDoNotCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
};
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "BluetoothRemoteGATTServer", kOperationTable);
}
