...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BLUETOOTH_REMOTE_GATT_SERVER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BLUETOOTH_REMOTE_GATT_SERVER_H_
...
class MODULES_EXPORT V8BluetoothRemoteGATTServer final : public bindings::V8InterfaceBridge<V8BluetoothRemoteGATTServer, BluetoothRemoteGATTServer> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1093);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class BluetoothRemoteGATTServer;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BLUETOOTH_REMOTE_GATT_SERVER_H_
