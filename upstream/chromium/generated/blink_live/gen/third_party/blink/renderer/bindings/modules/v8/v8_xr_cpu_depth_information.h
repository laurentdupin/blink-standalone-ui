...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_CPU_DEPTH_INFORMATION_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_CPU_DEPTH_INFORMATION_H_
...
class MODULES_EXPORT V8XRCPUDepthInformation final : public bindings::V8InterfaceBridge<V8XRCPUDepthInformation, XRCPUDepthInformation> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1425);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XRCPUDepthInformation;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_CPU_DEPTH_INFORMATION_H_
