...
kClampToEdge, kRepeat, kMirrorRepeat
};
static constexpr size_t kEnumSize = 3;

static V8GPUAddressMode Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8GPUAddressMode> Create(const String& value);

explicit constexpr  V8GPUAddressMode(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8GPUAddressMode& lhs, V8GPUAddressMode::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8GPUAddressMode::Enum lhs, const V8GPUAddressMode& rhs) {
