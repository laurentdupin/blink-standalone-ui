...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DIGITAL_CREDENTIAL_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DIGITAL_CREDENTIAL_H_
...
class MODULES_EXPORT V8DigitalCredential final : public bindings::V8InterfaceBridge<V8DigitalCredential, DigitalCredential> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1123);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class DigitalCredential;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DIGITAL_CREDENTIAL_H_
