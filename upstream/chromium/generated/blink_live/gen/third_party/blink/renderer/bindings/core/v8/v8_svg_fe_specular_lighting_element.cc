...
bool V8SVGFESpecularLightingElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<SVGFESpecularLightingElement, SVGElement>);
...
const WrapperTypeInfo V8SVGFESpecularLightingElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SVGFESpecularLightingElement::InstallInterfaceTemplate,
    nullptr,
    "SVGFESpecularLightingElement",
    V8SVGElement::GetWrapperTypeInfo(),
    V8SVGFESpecularLightingElement::kThisTag,
    V8SVGFESpecularLightingElement::kMaxSubclassTag,
...
const WrapperTypeInfo& SVGFESpecularLightingElement::wrapper_type_info_ =
    V8SVGFESpecularLightingElement::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, SVGFESpecularLightingElement>::value,
    "SVGFESpecularLightingElement inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_svg_fe_specular_lighting_element {
...
BLINK_BINDINGS_TRACE_EVENT("SVGFESpecularLightingElement.in1.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
SVGFESpecularLightingElement* blink_receiver = V8SVGFESpecularLightingElement::ToWrappableUnsafe(isolate, v8_receiver);
...
BLINK_BINDINGS_TRACE_EVENT("SVGFESpecularLightingElement.surfaceScale.get");
...
void SpecularConstantAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SVGFESpecularLightingElement_specularConstant_Getter");
BLINK_BINDINGS_TRACE_EVENT("SVGFESpecularLightingElement.specularConstant.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
SVGFESpecularLightingElement* blink_receiver = V8SVGFESpecularLightingElement::ToWrappableUnsafe(isolate, v8_receiver);
auto&& return_value = blink_receiver->specularConstant();
static_assert(bindings::IsReturnTypeCompatible<SVGAnimatedNumber, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
}
...
BLINK_BINDINGS_TRACE_EVENT("SVGFESpecularLightingElement.specularExponent.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFESpecularLightingElement.kernelUnitLengthX.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFESpecularLightingElement.kernelUnitLengthY.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFESpecularLightingElement.x.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFESpecularLightingElement.y.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFESpecularLightingElement.width.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFESpecularLightingElement.height.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFESpecularLightingElement.result.get");
...
using namespace v8_svg_fe_specular_lighting_element;

}  // namespace 

void V8SVGFESpecularLightingElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SVGFESpecularLightingElement::GetWrapperTypeInfo();
...
void V8SVGFESpecularLightingElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"specularConstant", SpecularConstantAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
{"specularExponent", SpecularExponentAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGFESpecularLightingElement", kAttributeTable);
}
