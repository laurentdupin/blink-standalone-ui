...
bool V8WritableStream::IsExposed(ExecutionContext* execution_context) {
  return true;
}
...
const WrapperTypeInfo V8WritableStream::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8WritableStream::InstallInterfaceTemplate,
    nullptr,
    "WritableStream",
    nullptr,
    V8WritableStream::kThisTag,
    V8WritableStream::kMaxSubclassTag,
...
const WrapperTypeInfo& WritableStream::wrapper_type_info_ =
    V8WritableStream::wrapper_type_info_;
...
BLINK_BINDINGS_TRACE_EVENT("WritableStream.locked.get");
...
BLINK_BINDINGS_TRACE_EVENT("WritableStream.constructor");
...
auto&& arg1_underlying_sink = NativeValueTraits<IDLOptional<IDLAny>>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
if (non_undefined_argument_length <= 1) {
  return_value = WritableStream::Create(script_state, arg1_underlying_sink, exception_state);
break;
}
...
return_value = WritableStream::Create(script_state, arg1_underlying_sink, arg2_strategy, exception_state);
} while (false);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8WritableStream::GetWrapperTypeInfo(), v8_receiver);
...
v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
if (!V8WritableStream::HasInstance(isolate, v8_receiver)) {
...
void GetWriterOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
...
ScriptState* script_state = receiver_script_state;
ExceptionState exception_state(isolate);
auto&& return_value = blink_receiver->getWriter(script_state, exception_state);
static_assert(bindings::IsReturnTypeCompatible<WritableStreamDefaultWriter, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
using namespace v8_writable_stream;

}  // namespace 

void V8WritableStream::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8WritableStream::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "WritableStream"));
...
void V8WritableStream::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"locked", LockedAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
};
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "WritableStream", kAttributeTable);
}
...
{"getWriter", GetWriterOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
};
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "WritableStream", kOperationTable);
}
