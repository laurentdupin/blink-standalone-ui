...
class CORE_EXPORT V8WorkerGlobalScope final : public bindings::V8InterfaceBridge<V8WorkerGlobalScope, WorkerGlobalScope> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(811);
