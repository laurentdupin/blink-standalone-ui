...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HASH_CHANGE_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HASH_CHANGE_EVENT_H_
...
class CORE_EXPORT V8HashChangeEvent final : public bindings::V8InterfaceBridge<V8HashChangeEvent, HashChangeEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(420);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class HashChangeEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HASH_CHANGE_EVENT_H_
