...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_BLEND_MIN_MAX_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_BLEND_MIN_MAX_H_
...
class MODULES_EXPORT V8EXTBlendMinMax final : public bindings::V8InterfaceBridge<V8EXTBlendMinMax, EXTBlendMinMax> {
...
class Constant final {
  ...
  public:
static constexpr uint32_t kMinExt = 0x8007;
static constexpr uint32_t kMaxExt = 0x8008;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1292);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class EXTBlendMinMax;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_BLEND_MIN_MAX_H_
