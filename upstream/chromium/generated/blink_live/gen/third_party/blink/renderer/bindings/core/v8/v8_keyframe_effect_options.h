...
bool hasIterationComposite() const {
  return true;
}
V8IterationCompositeOperation iterationComposite() const {
  return member_iteration_composite_;
}
void setIterationComposite(V8IterationCompositeOperation value) {
  member_iteration_composite_ = value;
}
void setIterationComposite(V8IterationCompositeOperation::Enum value) {
  member_iteration_composite_ = V8IterationCompositeOperation(value);
}
...
V8IterationCompositeOperation member_iteration_composite_{V8IterationCompositeOperation::Enum::kReplace};
