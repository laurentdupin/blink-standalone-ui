...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PICTURE_IN_PICTURE_WINDOW_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PICTURE_IN_PICTURE_WINDOW_H_
...
class MODULES_EXPORT V8PictureInPictureWindow final : public bindings::V8InterfaceBridge<V8PictureInPictureWindow, PictureInPictureWindow> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(754);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PICTURE_IN_PICTURE_WINDOW_H_
