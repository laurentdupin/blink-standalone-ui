...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EYE_DROPPER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EYE_DROPPER_H_
...
class MODULES_EXPORT V8EyeDropper final : public bindings::V8InterfaceBridge<V8EyeDropper, EyeDropper> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1148);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class EyeDropper;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EYE_DROPPER_H_
