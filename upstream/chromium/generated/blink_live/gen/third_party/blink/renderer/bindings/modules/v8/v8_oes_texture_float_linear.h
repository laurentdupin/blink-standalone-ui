...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_TEXTURE_FLOAT_LINEAR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_TEXTURE_FLOAT_LINEAR_H_
...
class MODULES_EXPORT V8OESTextureFloatLinear final : public bindings::V8InterfaceBridge<V8OESTextureFloatLinear, OESTextureFloatLinear> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1320);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class OESTextureFloatLinear;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_TEXTURE_FLOAT_LINEAR_H_
