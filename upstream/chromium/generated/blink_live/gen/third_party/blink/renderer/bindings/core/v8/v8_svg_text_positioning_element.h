...
class CORE_EXPORT V8SVGTextPositioningElement final : public bindings::V8InterfaceBridge<V8SVGTextPositioningElement, SVGTextPositioningElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(733);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGTextPositioningElement;
};
