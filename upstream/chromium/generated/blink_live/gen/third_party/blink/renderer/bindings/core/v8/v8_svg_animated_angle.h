...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_ANIMATED_ANGLE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_ANIMATED_ANGLE_H_
...
class CORE_EXPORT V8SVGAnimatedAngle final : public bindings::V8InterfaceBridge<V8SVGAnimatedAngle, SVGAnimatedAngle> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(963);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGAnimatedAngle;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_ANIMATED_ANGLE_H_
