...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MEDIA_STREAM_TRACK_AUDIO_STATS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MEDIA_STREAM_TRACK_AUDIO_STATS_H_
...
class MODULES_EXPORT V8MediaStreamTrackAudioStats final : public bindings::V8InterfaceBridge<V8MediaStreamTrackAudioStats, MediaStreamTrackAudioStats> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1200);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class MediaStreamTrackAudioStats;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MEDIA_STREAM_TRACK_AUDIO_STATS_H_
