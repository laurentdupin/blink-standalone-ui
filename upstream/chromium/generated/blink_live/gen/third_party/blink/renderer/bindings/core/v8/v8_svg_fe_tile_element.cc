...
bool V8SVGFETileElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<SVGFETileElement, SVGElement>);
...
const WrapperTypeInfo V8SVGFETileElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SVGFETileElement::InstallInterfaceTemplate,
    nullptr,
    "SVGFETileElement",
    V8SVGElement::GetWrapperTypeInfo(),
    V8SVGFETileElement::kThisTag,
    V8SVGFETileElement::kMaxSubclassTag,
...
const WrapperTypeInfo& SVGFETileElement::wrapper_type_info_ =
    V8SVGFETileElement::wrapper_type_info_;
...
namespace v8_svg_fe_tile_element {
...
BLINK_BINDINGS_TRACE_EVENT("SVGFETileElement.in1.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFETileElement.x.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFETileElement.y.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFETileElement.width.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFETileElement.height.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFETileElement.result.get");
...
using namespace v8_svg_fe_tile_element;

}  // namespace 

void V8SVGFETileElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SVGFETileElement::GetWrapperTypeInfo();
...
void V8SVGFETileElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGFETileElement", kAttributeTable);
}
