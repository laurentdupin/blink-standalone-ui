...
using Ret = bindings::OptimizedReturnProxy<V8UnionMediaSourceHandleOrMediaStream>;
v8::Local<v8::Value> ToV8(ScriptState* script_state) const;

static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, MediaSourceHandleImpl* value);
static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, MediaStream* value);
