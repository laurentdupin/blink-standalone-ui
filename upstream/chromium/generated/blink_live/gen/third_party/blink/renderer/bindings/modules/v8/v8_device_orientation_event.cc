...
static_assert(std::derived_from<DeviceOrientationEvent, Event>);
...
const WrapperTypeInfo V8DeviceOrientationEvent::wrapper_type_info_{
    ...
    V8DeviceOrientationEvent::kThisTag,
    V8DeviceOrientationEvent::kMaxSubclassTag,
...
DeviceOrientationEvent* blink_receiver = V8DeviceOrientationEvent::ToWrappableUnsafe(isolate, v8_receiver);
...
static_assert(bindings::IsReturnTypeCompatible<DeviceOrientationEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
interface_function_template->SetInterfaceName(V8String(isolate, "DeviceOrientationEvent"));
...
void V8DeviceOrientationEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "DeviceOrientationEvent", kAttributeTable);
}
...
void V8DeviceOrientationEvent::InstallContextIndependentProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
  using bindings::IDLMemberInstaller;
...
v8::Local<v8::Signature> signature = v8::Local<v8::Signature>::Cast(interface_template);
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "DeviceOrientationEvent", kOperationTable);
}
