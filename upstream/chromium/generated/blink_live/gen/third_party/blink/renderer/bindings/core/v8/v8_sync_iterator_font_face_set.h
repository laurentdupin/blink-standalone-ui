...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SYNC_ITERATOR_FONT_FACE_SET_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SYNC_ITERATOR_FONT_FACE_SET_H_
...
template <>
class CORE_EXPORT SyncIterator<FontFaceSet> final : public bindings::SyncIteratorBase {
  DEFINE_WRAPPERTYPEINFO();

  public:
using IDLKeyType = void;
using IDLValueType = FontFace;
using KeyType = void;
using ValueType = FontFace*;

explicit  SyncIterator<FontFaceSet>(IterationSourceBase* source, Kind kind) : bindings::SyncIteratorBase(source, kind) {
...
class CORE_EXPORT V8SyncIteratorFontFaceSet final : public bindings::V8InterfaceBridge<V8SyncIteratorFontFaceSet, SyncIterator<FontFaceSet>> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1486);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SyncIterator<FontFaceSet>;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SYNC_ITERATOR_FONT_FACE_SET_H_
