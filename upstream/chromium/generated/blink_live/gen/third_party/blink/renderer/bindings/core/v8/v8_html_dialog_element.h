...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_DIALOG_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_DIALOG_ELEMENT_H_
...
class CORE_EXPORT V8HTMLDialogElement final : public bindings::V8InterfaceBridge<V8HTMLDialogElement, HTMLDialogElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(607);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class HTMLDialogElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_DIALOG_ELEMENT_H_
