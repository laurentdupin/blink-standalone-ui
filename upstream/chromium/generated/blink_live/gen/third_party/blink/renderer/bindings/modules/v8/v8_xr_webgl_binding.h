...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_WEBGL_BINDING_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_WEBGL_BINDING_H_
...
class MODULES_EXPORT V8XRWebGLBinding final : public bindings::V8InterfaceBridge<V8XRWebGLBinding, XRWebGLBinding> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1454);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XRWebGLBinding;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_WEBGL_BINDING_H_
