...
bool V8DOMRectList::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8DOMRectList::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8DOMRectList::InstallInterfaceTemplate,
    nullptr,
    "DOMRectList",
    nullptr,
    V8DOMRectList::kThisTag,
    V8DOMRectList::kMaxSubclassTag,
...
const WrapperTypeInfo& DOMRectList::wrapper_type_info_ =
    V8DOMRectList::wrapper_type_info_;
...
v8::Intercepted V8DOMRectList::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
static_assert(bindings::IsReturnTypeCompatible<IDLNullable<DOMRect>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
return v8::Intercepted::kYes;
}

v8::Intercepted V8DOMRectList::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMRectList_IndexedPropertySetter");
...
v8::Intercepted V8DOMRectList::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMRectList_IndexedPropertyDeleter");
...
v8::Intercepted V8DOMRectList::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMRectList_IndexedPropertyDefiner");
...
v8::Intercepted V8DOMRectList::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMRectList_IndexedPropertyDescriptor");
...
auto intercepted =
    V8DOMRectList::IndexedPropertyGetterCallback(index, info);
...
namespace v8_dom_rect_list {


void LengthAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMRectList_length_Getter");
BLINK_BINDINGS_TRACE_EVENT("DOMRectList.length.get");
...
void ItemOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_DOMRectList_item");
BLINK_BINDINGS_TRACE_EVENT("DOMRectList.item");
...
// [Measure], [MeasureAs]
UseCounter::Count(current_execution_context, WebFeature::kClientRectListItem);
...
using namespace v8_dom_rect_list;

}  // namespace 

void V8DOMRectList::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8DOMRectList::GetWrapperTypeInfo();
...
instance_template->SetHandler(
    v8::IndexedPropertyHandlerConfiguration(
        V8DOMRectList::IndexedPropertyGetterCallback,
        V8DOMRectList::IndexedPropertySetterCallback,
        nullptr,  // query
        V8DOMRectList::IndexedPropertyDeleterCallback,
        V8DOMRectList::IndexedPropertyEnumeratorCallback,
        V8DOMRectList::IndexedPropertyDefinerCallback,
        V8DOMRectList::IndexedPropertyDescriptorCallback,
        nullptr,  // index_of
        v8::Local<v8::Value>(),
...
void V8DOMRectList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "DOMRectList", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "DOMRectList", kOperationTable);
}
