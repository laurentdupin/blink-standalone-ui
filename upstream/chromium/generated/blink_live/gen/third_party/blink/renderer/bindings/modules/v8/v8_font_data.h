...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_FONT_DATA_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_FONT_DATA_H_
...
class MODULES_EXPORT V8FontData final : public bindings::V8InterfaceBridge<V8FontData, FontMetadata> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1166);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class FontMetadata;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_FONT_DATA_H_
