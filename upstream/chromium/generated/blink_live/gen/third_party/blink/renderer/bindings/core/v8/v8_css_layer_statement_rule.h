...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_LAYER_STATEMENT_RULE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_LAYER_STATEMENT_RULE_H_
...
class CORE_EXPORT V8CSSLayerStatementRule final : public bindings::V8InterfaceBridge<V8CSSLayerStatementRule, CSSLayerStatementRule> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(299);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSLayerStatementRule;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_LAYER_STATEMENT_RULE_H_
