...
bool V8DOMFileSystemSync::IsExposed(ExecutionContext* execution_context) {
  return false;
}
...
const WrapperTypeInfo V8DOMFileSystemSync::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8DOMFileSystemSync::InstallInterfaceTemplate,
    V8DOMFileSystemSync::InstallContextDependentProperties,
    "DOMFileSystemSync",
    nullptr,
    V8DOMFileSystemSync::kThisTag,
    V8DOMFileSystemSync::kMaxSubclassTag,
...
const WrapperTypeInfo& DOMFileSystemSync::wrapper_type_info_ =
    V8DOMFileSystemSync::wrapper_type_info_;
...
namespace v8_dom_file_system_sync {
...
BLINK_BINDINGS_TRACE_EVENT("DOMFileSystemSync.name.get");
...
BLINK_BINDINGS_TRACE_EVENT("DOMFileSystemSync.root.get");
...
using namespace v8_dom_file_system_sync;

}  // namespace 

void V8DOMFileSystemSync::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8DOMFileSystemSync::GetWrapperTypeInfo();
...
void V8DOMFileSystemSync::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "DOMFileSystemSync", kAttributeTable);
}
...
void V8DOMFileSystemSync::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object, v8::Local<v8::Object> prototype_object, v8::Local<v8::Object> interface_object, v8::Local<v8::Template> interface_template, FeatureSelector feature_selector) {
  using bindings::IDLMemberInstaller;
