...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CHANNEL_MERGER_NODE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CHANNEL_MERGER_NODE_H_
...
class MODULES_EXPORT V8ChannelMergerNode final : public bindings::V8InterfaceBridge<V8ChannelMergerNode, ChannelMergerNode> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(512);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class ChannelMergerNode;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CHANNEL_MERGER_NODE_H_
