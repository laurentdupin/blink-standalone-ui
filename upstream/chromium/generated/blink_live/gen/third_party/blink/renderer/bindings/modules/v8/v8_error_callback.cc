...
const char* V8ErrorCallback::GetHumanReadableName() const {
  return "V8ErrorCallback";
}

v8::Maybe<void> V8ErrorCallback::handleEvent(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, DOMException* arg1_error) {
  const char* const class_like_name = "ErrorCallback";
...
void V8ErrorCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, DOMException* arg1_error) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = handleEvent(arg0_receiver, arg1_error);
}
