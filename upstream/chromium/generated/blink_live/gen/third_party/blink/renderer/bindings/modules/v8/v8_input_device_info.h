...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_INPUT_DEVICE_INFO_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_INPUT_DEVICE_INFO_H_
...
class MODULES_EXPORT V8InputDeviceInfo final : public bindings::V8InterfaceBridge<V8InputDeviceInfo, InputDeviceInfo> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class InputDeviceInfo;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_INPUT_DEVICE_INFO_H_
