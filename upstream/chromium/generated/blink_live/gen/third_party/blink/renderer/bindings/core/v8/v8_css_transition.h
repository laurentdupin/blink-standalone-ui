...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_TRANSITION_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_TRANSITION_H_
...
class CORE_EXPORT V8CSSTransition final : public bindings::V8InterfaceBridge<V8CSSTransition, CSSTransition> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(500);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSTransition;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_TRANSITION_H_
