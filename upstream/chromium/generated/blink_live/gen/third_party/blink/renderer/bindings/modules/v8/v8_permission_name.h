...
kGeolocation, kNotifications, kPush, kMidi, kCamera, kMicrophone, kBackgroundFetch, kBackgroundSync, kPersistentStorage, kAmbientLightSensor, kAccelerometer, kGyroscope, kMagnetometer, kScreenWakeLock, kNfc, kDisplayCapture, kClipboardRead, kClipboardWrite, kPaymentHandler, kIdleDetection, kPeriodicBackgroundSync, kSystemWakeLock, kStorageAccess, kWindowManagement, kLocalFonts, kTopLevelStorageAccess, kCapturedSurfaceControl, kSpeakerSelection, kKeyboardLock, kPointerLock, kFullscreen, kWebAppInstallation, kLocalNetworkAccess, kLocalNetwork, kLoopbackNetwork, kGeolocationApproximate
};
static constexpr size_t kEnumSize = 36;
