...
bool V8RTCSctpTransport::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<RTCSctpTransport, EventTarget>);
...
const WrapperTypeInfo V8RTCSctpTransport::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8RTCSctpTransport::InstallInterfaceTemplate,
    nullptr,
    "RTCSctpTransport",
    V8EventTarget::GetWrapperTypeInfo(),
    V8RTCSctpTransport::kThisTag,
    V8RTCSctpTransport::kMaxSubclassTag,
...
const WrapperTypeInfo& RTCSctpTransport::wrapper_type_info_ =
    V8RTCSctpTransport::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, RTCSctpTransport>::value,
    "RTCSctpTransport inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_rtc_sctp_transport {
...
BLINK_BINDINGS_TRACE_EVENT("RTCSctpTransport.transport.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
RTCSctpTransport* blink_receiver = V8RTCSctpTransport::ToWrappableUnsafe(isolate, v8_receiver);
auto&& return_value = blink_receiver->transport();
static_assert(bindings::IsReturnTypeCompatible<RTCDtlsTransport, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
BLINK_BINDINGS_TRACE_EVENT("RTCSctpTransport.state.get");
...
static_assert(bindings::IsReturnTypeCompatible<V8RTCSctpTransportState, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, isolate, bindings::V8ReturnValue::kNonNullable);
}



void MaxMessageSizeAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_RTCSctpTransport_maxMessageSize_Getter");
BLINK_BINDINGS_TRACE_EVENT("RTCSctpTransport.maxMessageSize.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
RTCSctpTransport* blink_receiver = V8RTCSctpTransport::ToWrappableUnsafe(isolate, v8_receiver);
auto&& return_value = blink_receiver->maxMessageSize();
...
void MaxChannelsAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_RTCSctpTransport_maxChannels_Getter");
BLINK_BINDINGS_TRACE_EVENT("RTCSctpTransport.maxChannels.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
RTCSctpTransport* blink_receiver = V8RTCSctpTransport::ToWrappableUnsafe(isolate, v8_receiver);
auto&& return_value = blink_receiver->maxChannels();
...
BLINK_BINDINGS_TRACE_EVENT("RTCSctpTransport.onstatechange.get");
...
BLINK_BINDINGS_TRACE_EVENT("RTCSctpTransport.onstatechange.set");
...
using namespace v8_rtc_sctp_transport;

}  // namespace 

void V8RTCSctpTransport::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8RTCSctpTransport::GetWrapperTypeInfo();
...
void V8RTCSctpTransport::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"maxMessageSize", MaxMessageSizeAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
{"maxChannels", MaxChannelsAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "RTCSctpTransport", kAttributeTable);
}
