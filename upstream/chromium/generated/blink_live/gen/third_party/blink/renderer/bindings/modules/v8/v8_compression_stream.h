...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_COMPRESSION_STREAM_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_COMPRESSION_STREAM_H_
...
class MODULES_EXPORT V8CompressionStream final : public bindings::V8InterfaceBridge<V8CompressionStream, CompressionStream> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1114);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CompressionStream;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_COMPRESSION_STREAM_H_
