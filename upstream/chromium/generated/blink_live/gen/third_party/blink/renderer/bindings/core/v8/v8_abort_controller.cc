...
bool V8AbortController::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8AbortController::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8AbortController::InstallInterfaceTemplate,
    nullptr,
    "AbortController",
    nullptr,
    V8AbortController::kThisTag,
    V8AbortController::kMaxSubclassTag,
...
const WrapperTypeInfo& AbortController::wrapper_type_info_ =
    V8AbortController::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, AbortController>::value,
    "AbortController inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_abort_controller {
...
BLINK_BINDINGS_TRACE_EVENT("AbortController.signal.get");
...
BLINK_BINDINGS_TRACE_EVENT("AbortController.constructor");
...
static_assert(bindings::IsReturnTypeCompatible<AbortController, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
BLINK_BINDINGS_TRACE_EVENT("AbortController.abort");
...
blink_receiver->abort(script_state, arg1_reason);
} while (false);
...
using namespace v8_abort_controller;

}  // namespace 

void V8AbortController::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8AbortController::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "AbortController"));
...
void V8AbortController::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "AbortController", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "AbortController", kOperationTable);
}
