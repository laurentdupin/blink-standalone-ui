...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_VERTEX_ARRAY_OBJECT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_VERTEX_ARRAY_OBJECT_H_
...
class MODULES_EXPORT V8OESVertexArrayObject final : public bindings::V8InterfaceBridge<V8OESVertexArrayObject, OESVertexArrayObject> {
...
class Constant final {
  ...
  public:
static constexpr uint32_t kVertexArrayBindingOes = 0x85B5;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1323);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_VERTEX_ARRAY_OBJECT_H_
