...
bool V8ImageBitmap::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8ImageBitmap::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8ImageBitmap::InstallInterfaceTemplate,
    nullptr,
    "ImageBitmap",
    nullptr,
    V8ImageBitmap::kThisTag,
    V8ImageBitmap::kMaxSubclassTag,
...
const WrapperTypeInfo& ImageBitmap::wrapper_type_info_ =
    V8ImageBitmap::wrapper_type_info_;
...
BLINK_BINDINGS_TRACE_EVENT("ImageBitmap.width.get");
...
BLINK_BINDINGS_TRACE_EVENT("ImageBitmap.height.get");
...
BLINK_BINDINGS_TRACE_EVENT("ImageBitmap.close");
...
using namespace v8_image_bitmap;

}  // namespace 

void V8ImageBitmap::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8ImageBitmap::GetWrapperTypeInfo();
...
void V8ImageBitmap::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "ImageBitmap", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "ImageBitmap", kOperationTable);
}
