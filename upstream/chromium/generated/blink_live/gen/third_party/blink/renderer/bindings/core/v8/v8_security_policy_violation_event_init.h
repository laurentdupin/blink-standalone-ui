...
bool hasEvalHash() const {
  return has_eval_hash_;
}
const String& evalHash() const {
  DCHECK(hasEvalHash());
return member_eval_hash_;
}
String getEvalHashOr(const String& fallback_value) const;
String getEvalHashOr(String&& fallback_value) const;
void setEvalHash(const String& value);
void setEvalHash(String&& value);
...
bool hasUrlHash() const {
  return has_url_hash_;
}
const String& urlHash() const {
  DCHECK(hasUrlHash());
return member_url_hash_;
}
String getUrlHashOr(const String& fallback_value) const;
String getUrlHashOr(String&& fallback_value) const;
void setUrlHash(const String& value);
void setUrlHash(String&& value);
