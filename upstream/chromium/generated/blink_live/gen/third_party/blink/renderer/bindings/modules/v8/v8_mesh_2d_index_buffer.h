...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MESH_2D_INDEX_BUFFER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MESH_2D_INDEX_BUFFER_H_
...
class MODULES_EXPORT V8Mesh2DIndexBuffer final : public bindings::V8InterfaceBridge<V8Mesh2DIndexBuffer, Mesh2DIndexBuffer> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1107);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class Mesh2DIndexBuffer;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MESH_2D_INDEX_BUFFER_H_
