...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_FONT_FEATURE_VALUES_MAP_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_FONT_FEATURE_VALUES_MAP_H_
...
class CORE_EXPORT V8CSSFontFeatureValuesMap final : public bindings::V8InterfaceBridge<V8CSSFontFeatureValuesMap, CSSFontFeatureValuesMap> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(273);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSFontFeatureValuesMap;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_FONT_FEATURE_VALUES_MAP_H_
