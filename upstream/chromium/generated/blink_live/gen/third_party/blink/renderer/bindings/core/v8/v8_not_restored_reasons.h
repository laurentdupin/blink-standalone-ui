...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NOT_RESTORED_REASONS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NOT_RESTORED_REASONS_H_
...
class CORE_EXPORT V8NotRestoredReasons final : public bindings::V8InterfaceBridge<V8NotRestoredReasons, NotRestoredReasons> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(992);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class NotRestoredReasons;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NOT_RESTORED_REASONS_H_
