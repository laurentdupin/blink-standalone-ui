...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_IDENTITY_CREDENTIAL_ERROR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_IDENTITY_CREDENTIAL_ERROR_H_
...
class MODULES_EXPORT V8IdentityCredentialError final : public bindings::V8InterfaceBridge<V8IdentityCredentialError, IdentityCredentialError> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(362);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class IdentityCredentialError;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_IDENTITY_CREDENTIAL_ERROR_H_
