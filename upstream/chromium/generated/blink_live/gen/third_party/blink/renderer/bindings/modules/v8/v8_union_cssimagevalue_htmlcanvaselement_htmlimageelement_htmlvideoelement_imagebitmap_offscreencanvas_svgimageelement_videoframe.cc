...
return MakeGarbageCollected<V8UnionCSSImageValueOrHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrOffscreenCanvasOrSVGImageElementOrVideoFrame>(blink_value);
}
...
if (V8CSSImageValue::HasInstance(isolate, v8_value)) {
  auto&& blink_value = V8CSSImageValue::ToWrappableUnsafe(isolate, v8_value.As<v8::Object>());
return MakeGarbageCollected<V8UnionCSSImageValueOrHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrOffscreenCanvasOrSVGImageElementOrVideoFrame>(blink_value);
}
...
V8UnionHTMLCanvasElementOrOffscreenCanvas* V8UnionCSSImageValueOrHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrOffscreenCanvasOrSVGImageElementOrVideoFrame::GetAsV8UnionHTMLCanvasElementOrOffscreenCanvas() const {
...
void V8UnionCSSImageValueOrHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrOffscreenCanvasOrSVGImageElementOrVideoFrame::Set(const V8UnionHTMLCanvasElementOrOffscreenCanvas* value) {
...
V8UnionHTMLVideoElementOrVideoFrame* V8UnionCSSImageValueOrHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrOffscreenCanvasOrSVGImageElementOrVideoFrame::GetAsV8UnionHTMLVideoElementOrVideoFrame() const {
  switch (content_type_) {
...
void V8UnionCSSImageValueOrHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrOffscreenCanvasOrSVGImageElementOrVideoFrame::Set(const V8UnionHTMLVideoElementOrVideoFrame* value) {
  switch (value->GetContentType()) {
...
void V8UnionCSSImageValueOrHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrOffscreenCanvasOrSVGImageElementOrVideoFrame::Trace(Visitor* visitor) const {
  visitor->Trace(member_css_image_value_);
...
void V8UnionCSSImageValueOrHTMLCanvasElementOrHTMLImageElementOrHTMLVideoElementOrImageBitmapOrOffscreenCanvasOrSVGImageElementOrVideoFrame::Clear() {
  member_css_image_value_.Clear();
