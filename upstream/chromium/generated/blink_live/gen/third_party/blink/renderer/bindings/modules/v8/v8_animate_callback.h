...
[[nodiscard]] base::expected<void, ScriptValue> InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, double arg1_current_time, const V8UnionWorkletAnimationEffectOrWorkletGroupEffect* arg2_effect);
