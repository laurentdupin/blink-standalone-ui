...
class MODULES_EXPORT V8SpeechSynthesisUtterance final : public bindings::V8InterfaceBridge<V8SpeechSynthesisUtterance, SpeechSynthesisUtterance> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(793);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SpeechSynthesisUtterance;
};
