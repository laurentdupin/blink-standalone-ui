...
bool V8TextTrackList::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<TextTrackList, EventTarget>);
...
const WrapperTypeInfo V8TextTrackList::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8TextTrackList::InstallInterfaceTemplate,
    nullptr,
    "TextTrackList",
    V8EventTarget::GetWrapperTypeInfo(),
    V8TextTrackList::kThisTag,
    V8TextTrackList::kMaxSubclassTag,
...
const WrapperTypeInfo& TextTrackList::wrapper_type_info_ =
    V8TextTrackList::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, TextTrackList>::value,
    "TextTrackList inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

v8::Intercepted V8TextTrackList::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
TextTrackList* blink_receiver = V8TextTrackList::ToWrappableUnsafe(isolate, v8_receiver);
...
v8::Intercepted V8TextTrackList::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TextTrackList_IndexedPropertySetter");
...
v8::Intercepted V8TextTrackList::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TextTrackList_IndexedPropertyDeleter");
...
v8::Intercepted V8TextTrackList::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TextTrackList_IndexedPropertyDefiner");
...
v8::Intercepted V8TextTrackList::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TextTrackList_IndexedPropertyDescriptor");
...
void V8TextTrackList::IndexedPropertyEnumeratorCallback(const v8::PropertyCallbackInfo<v8::Array>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TextTrackList_IndexedPropertyEnumerator");
...
BLINK_BINDINGS_TRACE_EVENT("TextTrackList.length.get");
...
BLINK_BINDINGS_TRACE_EVENT("TextTrackList.onchange.get");
...
BLINK_BINDINGS_TRACE_EVENT("TextTrackList.onchange.set");
...
BLINK_BINDINGS_TRACE_EVENT("TextTrackList.onaddtrack.get");
...
BLINK_BINDINGS_TRACE_EVENT("TextTrackList.onaddtrack.set");
...
BLINK_BINDINGS_TRACE_EVENT("TextTrackList.onremovetrack.get");
...
BLINK_BINDINGS_TRACE_EVENT("TextTrackList.onremovetrack.set");
...
BLINK_BINDINGS_TRACE_EVENT("TextTrackList.getTrackById");
...
static_assert(bindings::IsReturnTypeCompatible<IDLNullable<TextTrack>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
}
...
using namespace v8_text_track_list;

}  // namespace 

void V8TextTrackList::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8TextTrackList::GetWrapperTypeInfo();
...
instance_template->SetHandler(
    v8::IndexedPropertyHandlerConfiguration(
        ...
        nullptr,  // query
        V8TextTrackList::IndexedPropertyDeleterCallback,
        V8TextTrackList::IndexedPropertyEnumeratorCallback,
...
void V8TextTrackList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "TextTrackList", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "TextTrackList", kOperationTable);
}
