...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_AUDIO_TRACK_LIST_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_AUDIO_TRACK_LIST_H_
...
class CORE_EXPORT V8AudioTrackList final : public bindings::V8InterfaceBridge<V8AudioTrackList, AudioTrackList> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(526);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class AudioTrackList;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_AUDIO_TRACK_LIST_H_
