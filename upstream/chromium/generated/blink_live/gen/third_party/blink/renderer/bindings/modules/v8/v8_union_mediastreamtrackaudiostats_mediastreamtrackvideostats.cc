...
v8::Local<v8::Value> V8UnionMediaStreamTrackAudioStatsOrMediaStreamTrackVideoStats::DirectToV8(ScriptState* script_state, MediaStreamTrackAudioStats* value) {
  return ToV8Traits<MediaStreamTrackAudioStats>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionMediaStreamTrackAudioStatsOrMediaStreamTrackVideoStats::DirectToV8(ScriptState* script_state, MediaStreamTrackVideoStats* value) {
  return ToV8Traits<MediaStreamTrackVideoStats>::ToV8(script_state, value);
}
