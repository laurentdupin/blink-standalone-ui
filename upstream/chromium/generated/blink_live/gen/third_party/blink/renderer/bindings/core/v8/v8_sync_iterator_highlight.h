...
using IDLValueType = AbstractRange;
using KeyType = void;
using ValueType = AbstractRange*;

explicit  SyncIterator<Highlight>(IterationSourceBase* source, Kind kind) : bindings::SyncIteratorBase(source, kind) {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1488);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SyncIterator<Highlight>;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SYNC_ITERATOR_HIGHLIGHT_H_
