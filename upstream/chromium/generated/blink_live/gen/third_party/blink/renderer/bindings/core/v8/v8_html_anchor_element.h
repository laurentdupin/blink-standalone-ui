...
class CORE_EXPORT V8HTMLAnchorElement final : public bindings::V8InterfaceBridge<V8HTMLAnchorElement, HTMLAnchorElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(595);
