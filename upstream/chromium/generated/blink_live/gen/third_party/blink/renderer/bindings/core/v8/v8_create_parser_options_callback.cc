...
const char* V8CreateParserOptionsCallback::GetHumanReadableName() const {
  return "V8CreateParserOptionsCallback";
}

v8::Maybe<ScriptValue> V8CreateParserOptionsCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const SetHTMLUnsafeOptions* arg1_input) {
  const char* const class_like_name = "CreateParserOptionsCallback";
...
v8_arg1_input = ToV8Traits<SetHTMLUnsafeOptions>::ToV8(script_state, arg1_input);
...
v8::Maybe<ScriptValue> V8CreateParserOptionsCallback::Construct(const SetHTMLUnsafeOptions* arg1_input) {
  const char* const class_like_name = "CreateParserOptionsCallback";
...
base::expected<ScriptValue, ScriptValue> V8CreateParserOptionsCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const SetHTMLUnsafeOptions* arg1_input) {
