...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_TEXT_CONTENT_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_TEXT_CONTENT_ELEMENT_H_
...
class CORE_EXPORT V8SVGTextContentElement final : public bindings::V8InterfaceBridge<V8SVGTextContentElement, SVGTextContentElement> {
...
class Constant final {
  ...
  public:
static constexpr uint16_t kLengthadjustUnknown = 0;
static constexpr uint16_t kLengthadjustSpacing = 1;
static constexpr uint16_t kLengthadjustSpacingandglyphs = 2;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(731);
  static constexpr v8::CppHeapPointerTag kMaxSubclassTag =
      static_cast<v8::CppHeapPointerTag>(735);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGTextContentElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_TEXT_CONTENT_ELEMENT_H_
