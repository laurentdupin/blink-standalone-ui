...
class MODULES_EXPORT V8GPUCompareFunction final : public bindings::EnumerationBase {
...
static V8GPUCompareFunction Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8GPUCompareFunction> Create(const String& value);

explicit constexpr  V8GPUCompareFunction(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8GPUCompareFunction& lhs, V8GPUCompareFunction::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8GPUCompareFunction::Enum lhs, const V8GPUCompareFunction& rhs) {
