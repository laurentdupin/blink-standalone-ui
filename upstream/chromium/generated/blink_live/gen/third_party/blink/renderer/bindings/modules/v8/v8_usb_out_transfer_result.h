...
class MODULES_EXPORT V8USBOutTransferResult final : public bindings::V8InterfaceBridge<V8USBOutTransferResult, USBOutTransferResult> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1420);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class USBOutTransferResult;
};
