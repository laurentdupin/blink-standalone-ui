...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_GC_OBSERVATION_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_GC_OBSERVATION_H_
...
class  V8GCObservation final : public bindings::V8InterfaceBridge<V8GCObservation, GCObservation> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1053);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class GCObservation;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_GC_OBSERVATION_H_
