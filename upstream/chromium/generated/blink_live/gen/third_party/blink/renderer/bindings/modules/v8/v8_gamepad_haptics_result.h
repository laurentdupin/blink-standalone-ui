...
kComplete, kPreempted, kInvalidParameter, kNotSupported
};
...
explicit constexpr  V8GamepadHapticsResult(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
