...
bool V8XRInputSourceEvent::IsExposed(ExecutionContext* execution_context) {
  
const bool is_in_secure_context = execution_context->IsSecureContext();
return is_in_secure_context && execution_context->IsWindow() && RuntimeEnabledFeatures::WebXREnabled();
}

static_assert(std::derived_from<XRInputSourceEvent, Event>);
...
const WrapperTypeInfo V8XRInputSourceEvent::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8XRInputSourceEvent::InstallInterfaceTemplate,
    nullptr,
    "XRInputSourceEvent",
    V8Event::GetWrapperTypeInfo(),
    V8XRInputSourceEvent::kThisTag,
    V8XRInputSourceEvent::kMaxSubclassTag,
...
const WrapperTypeInfo& XRInputSourceEvent::wrapper_type_info_ =
    V8XRInputSourceEvent::wrapper_type_info_;
...
namespace v8_xr_input_source_event {
...
BLINK_BINDINGS_TRACE_EVENT("XRInputSourceEvent.frame.get");
...
static_assert(bindings::IsReturnTypeCompatible<XRFrame, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
}



void InputSourceAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRInputSourceEvent_inputSource_Getter");
BLINK_BINDINGS_TRACE_EVENT("XRInputSourceEvent.inputSource.get");
...
BLINK_BINDINGS_TRACE_EVENT("XRInputSourceEvent.isTrusted.get");
...
BLINK_BINDINGS_TRACE_EVENT("XRInputSourceEvent.constructor");
...
auto&& arg2_event_init_dict = NativeValueTraits<XRInputSourceEventInit>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& return_value = XRInputSourceEvent::Create(arg1_type, arg2_event_init_dict);
static_assert(bindings::IsReturnTypeCompatible<XRInputSourceEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8XRInputSourceEvent::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_xr_input_source_event;

}  // namespace 

void V8XRInputSourceEvent::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8XRInputSourceEvent::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "XRInputSourceEvent"));
...
void V8XRInputSourceEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"inputSource", InputSourceAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "XRInputSourceEvent", kAttributeTable);
}
