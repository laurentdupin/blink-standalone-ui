...
kAztec, kCode128, kCode39, kCode93, kCodabar, kDataMatrix, kEan13, kEan8, kItf, kPdf417, kQrCode, kUnknown, kUpcA, kUpcE
};
...
explicit constexpr  V8BarcodeFormat(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
