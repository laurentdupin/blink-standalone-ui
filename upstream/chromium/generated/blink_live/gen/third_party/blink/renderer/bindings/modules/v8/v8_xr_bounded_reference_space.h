...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_BOUNDED_REFERENCE_SPACE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_BOUNDED_REFERENCE_SPACE_H_
...
class MODULES_EXPORT V8XRBoundedReferenceSpace final : public bindings::V8InterfaceBridge<V8XRBoundedReferenceSpace, XRBoundedReferenceSpace> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(831);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XRBoundedReferenceSpace;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_BOUNDED_REFERENCE_SPACE_H_
