...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_DATA_LIST_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_DATA_LIST_ELEMENT_H_
...
class CORE_EXPORT V8HTMLDataListElement final : public bindings::V8InterfaceBridge<V8HTMLDataListElement, HTMLDataListElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(605);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class HTMLDataListElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_DATA_LIST_ELEMENT_H_
