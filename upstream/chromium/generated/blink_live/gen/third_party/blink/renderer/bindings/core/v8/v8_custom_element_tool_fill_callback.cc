...
const char* V8CustomElementToolFillCallback::GetHumanReadableName() const {
  return "V8CustomElementToolFillCallback";
}

v8::Maybe<void> V8CustomElementToolFillCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const String& arg1_value) {
  const char* const class_like_name = "CustomElementToolFillCallback";
...
v8_arg1_value = ToV8Traits<IDLString>::ToV8(script_state, arg1_value);
...
v8::Maybe<void> V8CustomElementToolFillCallback::Construct(const String& arg1_value) {
  const char* const class_like_name = "CustomElementToolFillCallback";
...
void V8CustomElementToolFillCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const String& arg1_value) {
  v8::Isolate* isolate = GetIsolate();
...
base::expected<void, ScriptValue> V8CustomElementToolFillCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const String& arg1_value) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_value);
