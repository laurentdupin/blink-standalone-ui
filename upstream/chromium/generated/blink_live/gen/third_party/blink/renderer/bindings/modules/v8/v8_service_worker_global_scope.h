...
class MODULES_EXPORT V8ServiceWorkerGlobalScope final : public bindings::V8InterfaceBridge<V8ServiceWorkerGlobalScope, ServiceWorkerGlobalScope> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(813);
