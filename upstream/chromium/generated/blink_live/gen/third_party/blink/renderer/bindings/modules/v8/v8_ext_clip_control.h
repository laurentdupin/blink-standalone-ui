...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_CLIP_CONTROL_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_CLIP_CONTROL_H_
...
class MODULES_EXPORT V8EXTClipControl final : public bindings::V8InterfaceBridge<V8EXTClipControl, EXTClipControl> {
...
class Constant final {
  ...
  public:
static constexpr uint32_t kLowerLeftExt = 0x8CA1;
static constexpr uint32_t kUpperLeftExt = 0x8CA2;
static constexpr uint32_t kNegativeOneToOneExt = 0x935E;
static constexpr uint32_t kZeroToOneExt = 0x935F;
static constexpr uint32_t kClipOriginExt = 0x935C;
static constexpr uint32_t kClipDepthModeExt = 0x935D;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1293);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class EXTClipControl;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_CLIP_CONTROL_H_
