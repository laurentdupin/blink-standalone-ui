...
// The maximum number of shorthands a single longhand can belong to.
using MatchingShorthandsVector = Vector<StylePropertyShorthand, 6>;
...
void getMatchingShorthandsForLonghand(
    CSSPropertyID, MatchingShorthandsVector* result);

unsigned indexOfShorthandForLonghand(CSSPropertyID,
                                     const MatchingShorthandsVector&);
