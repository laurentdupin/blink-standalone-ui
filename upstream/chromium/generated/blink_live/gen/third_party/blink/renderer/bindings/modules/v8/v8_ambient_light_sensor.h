...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_AMBIENT_LIGHT_SENSOR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_AMBIENT_LIGHT_SENSOR_H_
...
class MODULES_EXPORT V8AmbientLightSensor final : public bindings::V8InterfaceBridge<V8AmbientLightSensor, AmbientLightSensor> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(777);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class AmbientLightSensor;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_AMBIENT_LIGHT_SENSOR_H_
