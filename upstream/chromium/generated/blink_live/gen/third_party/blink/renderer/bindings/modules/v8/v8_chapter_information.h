...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CHAPTER_INFORMATION_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CHAPTER_INFORMATION_H_
...
class MODULES_EXPORT V8ChapterInformation final : public bindings::V8InterfaceBridge<V8ChapterInformation, ChapterInformation> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1190);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class ChapterInformation;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CHAPTER_INFORMATION_H_
