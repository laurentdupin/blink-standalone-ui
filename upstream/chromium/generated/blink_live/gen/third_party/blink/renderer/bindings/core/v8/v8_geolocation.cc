...
if (per_context_data && per_context_data->ActivityLogger()) [[unlikely]] { per_context_data->ActivityLogger()->LogMethod(script_state, "Geolocation.getCurrentPosition", info); }
...
blink_receiver->getCurrentPositionForBindings(arg1_success_callback, arg2_error_callback, arg3_options);
...
V8PerContextData* per_context_data = script_state->PerContextData();
// [LogActivity], [LogAllWorlds]
if (per_context_data && per_context_data->ActivityLogger()) [[unlikely]] { per_context_data->ActivityLogger()->LogMethod(script_state, "Geolocation.watchPosition", info); }
...
auto&& return_value = blink_receiver->watchPositionForBindings(arg1_success_callback, arg2_error_callback, arg3_options);
...
void V8Geolocation::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "Geolocation", kOperationTable);
}
