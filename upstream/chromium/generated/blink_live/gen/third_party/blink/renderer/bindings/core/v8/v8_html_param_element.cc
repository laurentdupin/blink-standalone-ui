...
bool V8HTMLParamElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<HTMLParamElement, HTMLElement>);
...
const WrapperTypeInfo V8HTMLParamElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8HTMLParamElement::InstallInterfaceTemplate,
    nullptr,
    "HTMLParamElement",
    V8HTMLElement::GetWrapperTypeInfo(),
    V8HTMLParamElement::kThisTag,
    V8HTMLParamElement::kMaxSubclassTag,
...
const WrapperTypeInfo& HTMLParamElement::wrapper_type_info_ =
    V8HTMLParamElement::wrapper_type_info_;
...
namespace v8_html_param_element {
...
BLINK_BINDINGS_TRACE_EVENT("HTMLParamElement.name.get");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLParamElement.name.set");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLParamElement.value.get");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLParamElement.value.set");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLParamElement.type.get");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLParamElement.type.set");

bindings::PerformAttributeSetCEReactionsReflectTypeString(info, html_names::kTypeAttr);
}


void ValueTypeAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLParamElement_valueType_Getter");
BLINK_BINDINGS_TRACE_EVENT("HTMLParamElement.valueType.get");
...
void ValueTypeAttributeSetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLParamElement_valueType_Setter");
BLINK_BINDINGS_TRACE_EVENT("HTMLParamElement.valueType.set");

bindings::PerformAttributeSetCEReactionsReflectTypeString(info, html_names::kValuetypeAttr);
}

void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLParamElement_constructor");
BLINK_BINDINGS_TRACE_EVENT("HTMLParamElement.constructor");
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLParamElement::GetWrapperTypeInfo(), ElementType::kHTMLParamElement);
}


}  // namespace v8_html_param_element

using namespace v8_html_param_element;

}  // namespace 

void V8HTMLParamElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8HTMLParamElement::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "HTMLParamElement"));
...
void V8HTMLParamElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"valueType", ValueTypeAttributeGetCallback, ValueTypeAttributeSetCallback, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
};
v8::Local<v8::Signature> signature = v8::Local<v8::Signature>::Cast(interface_template);
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLParamElement", kAttributeTable);
}
