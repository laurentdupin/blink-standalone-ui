...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_FLOAT_BLEND_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_FLOAT_BLEND_H_
...
class MODULES_EXPORT V8EXTFloatBlend final : public bindings::V8InterfaceBridge<V8EXTFloatBlend, EXTFloatBlend> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1300);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class EXTFloatBlend;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_FLOAT_BLEND_H_
