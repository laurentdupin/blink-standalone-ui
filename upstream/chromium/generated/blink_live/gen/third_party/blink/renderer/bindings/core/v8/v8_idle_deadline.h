...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_IDLE_DEADLINE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_IDLE_DEADLINE_H_
...
class CORE_EXPORT V8IdleDeadline final : public bindings::V8InterfaceBridge<V8IdleDeadline, IdleDeadline> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(944);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class IdleDeadline;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_IDLE_DEADLINE_H_
