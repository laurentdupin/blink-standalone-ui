...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_PSEUDO_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_PSEUDO_ELEMENT_H_
...
class CORE_EXPORT V8CSSPseudoElement final : public bindings::V8InterfaceBridge<V8CSSPseudoElement, CSSPseudoElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(359);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSPseudoElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_PSEUDO_ELEMENT_H_
