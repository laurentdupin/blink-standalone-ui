...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TRUSTED_HTML_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TRUSTED_HTML_H_
...
class CORE_EXPORT V8TrustedHTML final : public bindings::V8InterfaceBridge<V8TrustedHTML, TrustedHTML> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1020);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class TrustedHTML;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TRUSTED_HTML_H_
