...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MEDIA_STREAM_TRACK_PROCESSOR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MEDIA_STREAM_TRACK_PROCESSOR_H_
...
class MODULES_EXPORT V8MediaStreamTrackProcessor final : public bindings::V8InterfaceBridge<V8MediaStreamTrackProcessor, MediaStreamTrackProcessor> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1097);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class MediaStreamTrackProcessor;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MEDIA_STREAM_TRACK_PROCESSOR_H_
