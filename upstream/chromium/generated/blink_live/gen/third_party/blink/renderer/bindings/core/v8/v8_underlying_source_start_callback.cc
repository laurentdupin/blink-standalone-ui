...
const char* V8UnderlyingSourceStartCallback::GetHumanReadableName() const {
  return "V8UnderlyingSourceStartCallback";
}

v8::Maybe<ScriptValue> V8UnderlyingSourceStartCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const V8UnionReadableByteStreamControllerOrReadableStreamDefaultController* arg1_controller) {
  const char* const class_like_name = "UnderlyingSourceStartCallback";
...
v8_arg1_controller = ToV8Traits<V8UnionReadableByteStreamControllerOrReadableStreamDefaultController>::ToV8(script_state, arg1_controller);
...
v8::Maybe<ScriptValue> V8UnderlyingSourceStartCallback::Construct(const V8UnionReadableByteStreamControllerOrReadableStreamDefaultController* arg1_controller) {
  const char* const class_like_name = "UnderlyingSourceStartCallback";
...
base::expected<ScriptValue, ScriptValue> V8UnderlyingSourceStartCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const V8UnionReadableByteStreamControllerOrReadableStreamDefaultController* arg1_controller) {
