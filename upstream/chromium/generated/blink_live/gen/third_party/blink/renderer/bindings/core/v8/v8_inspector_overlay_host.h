...
class CORE_EXPORT V8InspectorOverlayHost final : public bindings::V8InterfaceBridge<V8InspectorOverlayHost, InspectorOverlayHost> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(919);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class InspectorOverlayHost;
};
