...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_DOM_RECT_LIST_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_DOM_RECT_LIST_H_
...
class CORE_EXPORT V8DOMRectList final : public bindings::V8InterfaceBridge<V8DOMRectList, DOMRectList> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class DOMRectList;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_DOM_RECT_LIST_H_
