...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CRASH_REPORT_CONTEXT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CRASH_REPORT_CONTEXT_H_
...
class CORE_EXPORT V8CrashReportContext final : public bindings::V8InterfaceBridge<V8CrashReportContext, CrashReportContext> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(854);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CrashReportContext;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CRASH_REPORT_CONTEXT_H_
