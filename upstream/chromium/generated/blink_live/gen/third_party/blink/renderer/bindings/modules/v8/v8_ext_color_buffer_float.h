...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_COLOR_BUFFER_FLOAT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_COLOR_BUFFER_FLOAT_H_
...
class MODULES_EXPORT V8EXTColorBufferFloat final : public bindings::V8InterfaceBridge<V8EXTColorBufferFloat, EXTColorBufferFloat> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1294);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_COLOR_BUFFER_FLOAT_H_
