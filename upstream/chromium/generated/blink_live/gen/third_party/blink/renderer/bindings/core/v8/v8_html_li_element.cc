...
static_assert(std::derived_from<HTMLLIElement, HTMLElement>);
...
const WrapperTypeInfo V8HTMLLIElement::wrapper_type_info_{
    ...
    V8HTMLLIElement::kThisTag,
    V8HTMLLIElement::kMaxSubclassTag,
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLLIElement::GetWrapperTypeInfo(), ElementType::kHTMLLIElement);
}
...
interface_function_template->SetInterfaceName(V8String(isolate, "HTMLLIElement"));
...
void V8HTMLLIElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLLIElement", kAttributeTable);
}
