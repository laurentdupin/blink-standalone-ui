...
class MODULES_EXPORT SharedStorageSetMethodOptions : public SharedStorageModifierMethodOptions {
...
void Trace(Visitor* visitor) const override;
  ...
  protected:
static constexpr size_t kBasePropertyCount = SharedStorageModifierMethodOptions::kTotalPropertyCount;
