...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SPEECH_SYNTHESIS_ERROR_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SPEECH_SYNTHESIS_ERROR_EVENT_H_
...
class MODULES_EXPORT V8SpeechSynthesisErrorEvent final : public bindings::V8InterfaceBridge<V8SpeechSynthesisErrorEvent, SpeechSynthesisErrorEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(464);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SpeechSynthesisErrorEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SPEECH_SYNTHESIS_ERROR_EVENT_H_
