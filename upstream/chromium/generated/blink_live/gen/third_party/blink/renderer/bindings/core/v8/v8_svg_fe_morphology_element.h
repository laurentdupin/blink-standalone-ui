...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_MORPHOLOGY_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_MORPHOLOGY_ELEMENT_H_
...
class CORE_EXPORT V8SVGFEMorphologyElement final : public bindings::V8InterfaceBridge<V8SVGFEMorphologyElement, SVGFEMorphologyElement> {
...
class Constant final {
  ...
  public:
static constexpr uint16_t kSVGMorphologyOperatorUnknown = 0;
static constexpr uint16_t kSVGMorphologyOperatorErode = 1;
static constexpr uint16_t kSVGMorphologyOperatorDilate = 2;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(703);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGFEMorphologyElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_MORPHOLOGY_ELEMENT_H_
