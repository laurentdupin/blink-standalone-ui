...
static_assert(std::derived_from<HTMLStyleElement, HTMLElement>);
...
const WrapperTypeInfo& HTMLStyleElement::wrapper_type_info_ =
    V8HTMLStyleElement::wrapper_type_info_;
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLStyleElement::GetWrapperTypeInfo(), ElementType::kHTMLStyleElement);
}
...
void V8HTMLStyleElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLStyleElement", kAttributeTable);
}
