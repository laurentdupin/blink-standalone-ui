...
class CORE_EXPORT V8IntersectionObserver final : public bindings::V8InterfaceBridge<V8IntersectionObserver, IntersectionObserver> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(920);
