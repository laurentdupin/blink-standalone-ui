...
bool V8PresentationConnectionCloseEvent::IsExposed(ExecutionContext* execution_context) {
  
const bool is_in_secure_context = execution_context->IsSecureContext();
return is_in_secure_context && execution_context->IsWindow() && RuntimeEnabledFeatures::PresentationEnabled();
}

static_assert(std::derived_from<PresentationConnectionCloseEvent, Event>);
...
const WrapperTypeInfo V8PresentationConnectionCloseEvent::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8PresentationConnectionCloseEvent::InstallInterfaceTemplate,
    nullptr,
    "PresentationConnectionCloseEvent",
    V8Event::GetWrapperTypeInfo(),
    V8PresentationConnectionCloseEvent::kThisTag,
    V8PresentationConnectionCloseEvent::kMaxSubclassTag,
...
const WrapperTypeInfo& PresentationConnectionCloseEvent::wrapper_type_info_ =
    V8PresentationConnectionCloseEvent::wrapper_type_info_;
...
namespace v8_presentation_connection_close_event {
...
BLINK_BINDINGS_TRACE_EVENT("PresentationConnectionCloseEvent.reason.get");
...
static_assert(bindings::IsReturnTypeCompatible<V8PresentationConnectionCloseReason, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
BLINK_BINDINGS_TRACE_EVENT("PresentationConnectionCloseEvent.message.get");
...
BLINK_BINDINGS_TRACE_EVENT("PresentationConnectionCloseEvent.isTrusted.get");
...
BLINK_BINDINGS_TRACE_EVENT("PresentationConnectionCloseEvent.constructor");
...
auto&& arg2_event_init_dict = NativeValueTraits<PresentationConnectionCloseEventInit>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& return_value = PresentationConnectionCloseEvent::Create(arg1_type, arg2_event_init_dict);
static_assert(bindings::IsReturnTypeCompatible<PresentationConnectionCloseEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8PresentationConnectionCloseEvent::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_presentation_connection_close_event;

}  // namespace 

void V8PresentationConnectionCloseEvent::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8PresentationConnectionCloseEvent::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "PresentationConnectionCloseEvent"));
...
void V8PresentationConnectionCloseEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "PresentationConnectionCloseEvent", kAttributeTable);
}
