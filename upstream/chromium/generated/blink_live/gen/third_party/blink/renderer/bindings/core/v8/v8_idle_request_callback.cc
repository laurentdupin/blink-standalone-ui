...
const char* V8IdleRequestCallback::GetHumanReadableName() const {
  return "V8IdleRequestCallback";
}

v8::Maybe<void> V8IdleRequestCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, IdleDeadline* arg1_deadline) {
  const char* const class_like_name = "IdleRequestCallback";
...
v8::Local<v8::Value> v8_arg1_deadline;
ScriptState* script_state = CallbackRelevantScriptState();
v8_arg1_deadline = ToV8Traits<IdleDeadline>::ToV8(script_state, arg1_deadline);
argv[0] = v8_arg1_deadline;
...
v8::Maybe<void> V8IdleRequestCallback::Construct(IdleDeadline* arg1_deadline) {
  const char* const class_like_name = "IdleRequestCallback";
...
void V8IdleRequestCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, IdleDeadline* arg1_deadline) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = Invoke(arg0_receiver, arg1_deadline);
}

base::expected<void, ScriptValue> V8IdleRequestCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, IdleDeadline* arg1_deadline) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_deadline);
