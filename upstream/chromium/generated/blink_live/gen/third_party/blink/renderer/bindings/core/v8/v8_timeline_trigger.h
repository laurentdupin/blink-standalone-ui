...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TIMELINE_TRIGGER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TIMELINE_TRIGGER_H_
...
class CORE_EXPORT V8TimelineTrigger final : public bindings::V8InterfaceBridge<V8TimelineTrigger, TimelineTrigger> {
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TIMELINE_TRIGGER_H_
