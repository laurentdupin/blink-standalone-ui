...
kLicenseRequest, kLicenseRenewal, kLicenseRelease, kIndividualizationRequest
};
...
explicit constexpr  V8MediaKeyMessageType(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
