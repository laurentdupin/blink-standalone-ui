...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CANVAS_PAINT_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CANVAS_PAINT_EVENT_H_
...
class CanvasPaintEvent;
class ExecutionContext;
struct WrapperTypeInfo;

class CORE_EXPORT V8CanvasPaintEvent final : public bindings::V8InterfaceBridge<V8CanvasPaintEvent, CanvasPaintEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(382);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CanvasPaintEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CANVAS_PAINT_EVENT_H_
