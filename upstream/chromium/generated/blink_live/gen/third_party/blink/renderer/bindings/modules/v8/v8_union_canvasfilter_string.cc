...
v8::Local<v8::Value> V8UnionCanvasFilterOrString::DirectToV8(ScriptState* script_state, CanvasFilter* value) {
  return ToV8Traits<CanvasFilter>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionCanvasFilterOrString::DirectToV8(ScriptState* script_state, const String& value) {
