...
const char* V8PositionErrorCallback::GetHumanReadableName() const {
  return "V8PositionErrorCallback";
}

v8::Maybe<void> V8PositionErrorCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, GeolocationPositionError* arg1_position_error) {
  const char* const class_like_name = "PositionErrorCallback";
...
v8::Local<v8::Value> v8_arg1_position_error;
ScriptState* script_state = CallbackRelevantScriptState();
v8_arg1_position_error = ToV8Traits<GeolocationPositionError>::ToV8(script_state, arg1_position_error);
argv[0] = v8_arg1_position_error;
...
v8::Maybe<void> V8PositionErrorCallback::Construct(GeolocationPositionError* arg1_position_error) {
  const char* const class_like_name = "PositionErrorCallback";
...
void V8PositionErrorCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, GeolocationPositionError* arg1_position_error) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = Invoke(arg0_receiver, arg1_position_error);
}

base::expected<void, ScriptValue> V8PositionErrorCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, GeolocationPositionError* arg1_position_error) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_position_error);
