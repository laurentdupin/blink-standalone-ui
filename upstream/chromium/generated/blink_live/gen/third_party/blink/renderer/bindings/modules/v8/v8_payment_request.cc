...
static_assert(std::derived_from<PaymentRequest, EventTarget>);
...
static_assert(bindings::IsReturnTypeCompatible<IDLNullable<PaymentAddress>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
static_assert(bindings::IsReturnTypeCompatible<IDLNullable<V8PaymentShippingType>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, isolate, bindings::V8ReturnValue::kNullable);
}
...
static_assert(bindings::IsReturnTypeCompatible<PaymentRequest, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
void GetSecurePaymentConfirmationCapabilitiesStaticOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_PaymentRequest_getSecurePaymentConfirmationCapabilities");
BLINK_BINDINGS_TRACE_EVENT("PaymentRequest.getSecurePaymentConfirmationCapabilities");
// Promise returning function: Convert a TypeError to a reject promise.
ExceptionToRejectPromiseScope reject_promise_scope(info);
...
auto&& return_value = PaymentRequest::getSecurePaymentConfirmationCapabilities(script_state);
...
void SecurePaymentConfirmationAvailabilityStaticOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_PaymentRequest_securePaymentConfirmationAvailability");
BLINK_BINDINGS_TRACE_EVENT("PaymentRequest.securePaymentConfirmationAvailability");
// Promise returning function: Convert a TypeError to a reject promise.
ExceptionToRejectPromiseScope reject_promise_scope(info);
...
ScriptState* current_script_state = ScriptState::From(isolate, current_context);
ScriptState* script_state = current_script_state;
auto&& return_value = PaymentRequest::securePaymentConfirmationAvailability(script_state);
static_assert(bindings::IsReturnTypeCompatible<IDLPromise<V8SecurePaymentConfirmationAvailability>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value);
}
...
void V8PaymentRequest::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "PaymentRequest", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "PaymentRequest", kOperationTable);
}
...
void V8PaymentRequest::InstallContextIndependentProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
  using bindings::IDLMemberInstaller;
...
if (RuntimeEnabledFeatures::SecurePaymentConfirmationCapabilitiesEnabled()) {
  static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
{"getSecurePaymentConfirmationCapabilities", GetSecurePaymentConfirmationCapabilitiesStaticOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kInterface), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kDoNotCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kDoNotCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
};
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "PaymentRequest", kOperationTable);
}
if (RuntimeEnabledFeatures::SecurePaymentConfirmationAvailabilityAPIEnabled()) {
  static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
{"securePaymentConfirmationAvailability", SecurePaymentConfirmationAvailabilityStaticOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kInterface), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kDoNotCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kDoNotCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
};
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "PaymentRequest", kOperationTable);
}
