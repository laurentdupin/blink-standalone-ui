...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ML_LSTM_CELL_SUPPORT_LIMITS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ML_LSTM_CELL_SUPPORT_LIMITS_H_
...
class MODULES_EXPORT MLLstmCellSupportLimits : public bindings::DictionaryBase {
  
  public:
static MLLstmCellSupportLimits* Create() {
  return MakeGarbageCollected<MLLstmCellSupportLimits>();
}
static MLLstmCellSupportLimits* Create(v8::Isolate* isolate) {
  return MakeGarbageCollected<MLLstmCellSupportLimits>(isolate);
}
static MLLstmCellSupportLimits* Create(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state);

explicit  MLLstmCellSupportLimits();
explicit  MLLstmCellSupportLimits(v8::Isolate* isolate);
...
bool hasCellState() const {
  return has_cell_state_;
}
MLTensorLimits* cellState() const {
  DCHECK(hasCellState());
return member_cell_state_.Get();
}
MLTensorLimits* getCellStateOr(MLTensorLimits* fallback_value) const {
  if (!hasCellState()) {
  return fallback_value;
}
return member_cell_state_.Get();
}
void setCellState(MLTensorLimits* value) {
  member_cell_state_ = value;
has_cell_state_ = true;
DCHECK(member_cell_state_);
}
...
Member<MLTensorLimits> member_cell_state_;
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ML_LSTM_CELL_SUPPORT_LIMITS_H_
