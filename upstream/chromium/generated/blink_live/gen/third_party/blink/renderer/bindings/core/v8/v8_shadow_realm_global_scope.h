...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SHADOW_REALM_GLOBAL_SCOPE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SHADOW_REALM_GLOBAL_SCOPE_H_
...
class CORE_EXPORT V8ShadowRealmGlobalScope final : public bindings::V8InterfaceBridge<V8ShadowRealmGlobalScope, ShadowRealmGlobalScope> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(946);
...
static InstallContextIndependentPropertiesFuncType install_context_independent_props_func_;
  ...
  friend class ShadowRealmGlobalScope;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SHADOW_REALM_GLOBAL_SCOPE_H_
