...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_PEER_CONNECTION_ICE_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_PEER_CONNECTION_ICE_EVENT_H_
...
class MODULES_EXPORT V8RTCPeerConnectionIceEvent final : public bindings::V8InterfaceBridge<V8RTCPeerConnectionIceEvent, RTCPeerConnectionIceEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(453);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class RTCPeerConnectionIceEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_PEER_CONNECTION_ICE_EVENT_H_
