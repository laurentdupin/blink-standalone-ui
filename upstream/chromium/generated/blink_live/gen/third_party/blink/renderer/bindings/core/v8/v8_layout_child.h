...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_LAYOUT_CHILD_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_LAYOUT_CHILD_H_
...
class CORE_EXPORT V8LayoutChild final : public bindings::V8InterfaceBridge<V8LayoutChild, CustomLayoutChild> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(923);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CustomLayoutChild;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_LAYOUT_CHILD_H_
