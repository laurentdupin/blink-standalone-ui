...
return dictionary;
 ...
 PictureInPictureEventInit::PictureInPictureEventInit(v8::Isolate* isolate) : EventInit(isolate) {
...
void PictureInPictureEventInit::Trace(Visitor* visitor) const {
  visitor->Trace(member_picture_in_picture_window_);
...
dictionary_from_v8_context.SetCurrentPropertyName("pictureInPictureWindow");
constexpr bool is_required = true;
v8::Local<v8::Context> current_context = isolate->GetCurrentContext();
const auto& v8_own_member_names = GetV8OwnMemberNames(isolate);
bool fallback_presence_var;
if (!bindings::GetDictionaryMemberFromV8Object<PictureInPictureWindow, is_required>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), fallback_presence_var, member_picture_in_picture_window_, class_like_name, exception_state)) {
  return;
}
}
