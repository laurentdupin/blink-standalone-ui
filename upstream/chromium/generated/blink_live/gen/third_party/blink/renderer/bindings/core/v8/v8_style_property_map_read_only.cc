...
const WrapperTypeInfo V8StylePropertyMapReadOnly::wrapper_type_info_{
    ...
    nullptr,
    V8StylePropertyMapReadOnly::kThisTag,
    V8StylePropertyMapReadOnly::kMaxSubclassTag,
...
const WrapperTypeInfo& StylePropertyMapReadOnly::wrapper_type_info_ =
    V8StylePropertyMapReadOnly::wrapper_type_info_;
...
static_assert(bindings::IsReturnTypeCompatible<V8UnionCSSStyleValueOrUndefined, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
v8::Local<v8::Value> v8_return_value = ToV8Traits<V8UnionCSSStyleValueOrUndefined>::ToV8(script_state, return_value);
...
static_assert(bindings::IsReturnTypeCompatible<SyncIterator<StylePropertyMapReadOnly>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
void V8StylePropertyMapReadOnly::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "StylePropertyMapReadOnly", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "StylePropertyMapReadOnly", kOperationTable);
}
