...
class CORE_EXPORT CoreProbeSink final : public GarbageCollected<CoreProbeSink> {
 ...
 public:
  enum AgentType : unsigned {
    ...
    kInspectorWebMCPAgent = 1u << 22,
    kLCPScriptObserver = 1u << 23,
    kPerformanceMonitor = 1u << 24,
  };
  ...
  const AgentRegistry<AdTracker>& AdTrackers() const { return ad_trackers_; }
  void AddAdTracker(AdTracker* agent);
  void RemoveAdTracker(AdTracker* agent);

  bool HasAnimationFrameTimingMonitors() const { return !animation_frame_timing_monitors_.IsEmpty(); }
  const AgentRegistry<AnimationFrameTimingMonitor>& AnimationFrameTimingMonitors() const { return animation_frame_timing_monitors_; }
  ...
  const AgentRegistry<DevToolsSession>& DevToolsSessions() const { return dev_tools_sessions_; }
  ...
  const AgentRegistry<InspectorAnimationAgent>& InspectorAnimationAgents() const { return inspector_animation_agents_; }
  ...
  bool HasInspectorAuditsAgents() const { return !inspector_audits_agents_.IsEmpty(); }
  const AgentRegistry<InspectorAuditsAgent>& InspectorAuditsAgents() const { return inspector_audits_agents_; }
  ...
  const AgentRegistry<InspectorCSSAgent>& InspectorCSSAgents() const { return inspector_css_agents_; }
  ...
  const AgentRegistry<InspectorDOMAgent>& InspectorDOMAgents() const { return inspector_dom_agents_; }
  ...
  const AgentRegistry<InspectorDOMDebuggerAgent>& InspectorDOMDebuggerAgents() const { return inspector_dom_debugger_agents_; }
  ...
  const AgentRegistry<InspectorDOMSnapshotAgent>& InspectorDOMSnapshotAgents() const { return inspector_dom_snapshot_agents_; }
  ...
  const AgentRegistry<InspectorEmulationAgent>& InspectorEmulationAgents() const { return inspector_emulation_agents_; }
  ...
  bool HasInspectorEventBreakpointsAgents() const { return !inspector_event_breakpoints_agents_.IsEmpty(); }
  const AgentRegistry<InspectorEventBreakpointsAgent>& InspectorEventBreakpointsAgents() const { return inspector_event_breakpoints_agents_; }
  ...
  bool HasInspectorIssueReporters() const { return !inspector_issue_reporters_.IsEmpty(); }
  const AgentRegistry<InspectorIssueReporter>& InspectorIssueReporters() const { return inspector_issue_reporters_; }
  ...
  const AgentRegistry<InspectorLayerTreeAgent>& InspectorLayerTreeAgents() const { return inspector_layer_tree_agents_; }
  ...
  const AgentRegistry<InspectorLogAgent>& InspectorLogAgents() const { return inspector_log_agents_; }
  void AddInspectorLogAgent(InspectorLogAgent* agent);
  void RemoveInspectorLogAgent(InspectorLogAgent* agent);

  bool HasInspectorMediaAgents() const { return !inspector_media_agents_.IsEmpty(); }
  const AgentRegistry<InspectorMediaAgent>& InspectorMediaAgents() const { return inspector_media_agents_; }
  ...
  const AgentRegistry<InspectorNetworkAgent>& InspectorNetworkAgents() const { return inspector_network_agents_; }
  ...
  const AgentRegistry<InspectorPerformanceAgent>& InspectorPerformanceAgents() const { return inspector_performance_agents_; }
  ...
  bool HasInspectorPerformanceTimelineAgents() const { return !inspector_performance_timeline_agents_.IsEmpty(); }
  const AgentRegistry<InspectorPerformanceTimelineAgent>& InspectorPerformanceTimelineAgents() const { return inspector_performance_timeline_agents_; }
  ...
  bool HasInspectorPreloadAgents() const { return !inspector_preload_agents_.IsEmpty(); }
  const AgentRegistry<InspectorPreloadAgent>& InspectorPreloadAgents() const { return inspector_preload_agents_; }
  ...
  const AgentRegistry<InspectorTraceEvents>& InspectorTraceEventss() const { return inspector_trace_eventss_; }
  void AddInspectorTraceEvents(InspectorTraceEvents* agent);
  void RemoveInspectorTraceEvents(InspectorTraceEvents* agent);

  bool HasInspectorWebMCPAgents() const { return !inspector_web_mcp_agents_.IsEmpty(); }
  const AgentRegistry<InspectorWebMCPAgent>& InspectorWebMCPAgents() const { return inspector_web_mcp_agents_; }
  void AddInspectorWebMCPAgent(InspectorWebMCPAgent* agent);
  void RemoveInspectorWebMCPAgent(InspectorWebMCPAgent* agent);

  bool HasLCPScriptObservers() const { return !lcp_script_observers_.IsEmpty(); }
  const AgentRegistry<LCPScriptObserver>& LCPScriptObservers() const { return lcp_script_observers_; }
  ...
  const AgentRegistry<PerformanceMonitor>& PerformanceMonitors() const { return performance_monitors_; }
 ...
 private:
  ...
  AgentRegistry<InspectorWebMCPAgent> inspector_web_mcp_agents_;
  ...
  static unsigned s_numSinksWithInspectorWebMCPAgent;
