...
class MODULES_EXPORT V8RTCIceCandidate final : public bindings::V8InterfaceBridge<V8RTCIceCandidate, RTCIceCandidate> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1219);
