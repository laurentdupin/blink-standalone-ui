...
const char* V8LockGrantedCallback::GetHumanReadableName() const {
  return "V8LockGrantedCallback";
}

v8::Maybe<ScriptValue> V8LockGrantedCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, Lock* arg1_lock) {
  const char* const class_like_name = "LockGrantedCallback";
...
v8::Maybe<ScriptValue> V8LockGrantedCallback::Construct(Lock* arg1_lock) {
  const char* const class_like_name = "LockGrantedCallback";
...
base::expected<ScriptValue, ScriptValue> V8LockGrantedCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, Lock* arg1_lock) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_lock);
