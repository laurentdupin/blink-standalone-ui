...
bool V8SVGAnimatedEnumeration::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8SVGAnimatedEnumeration::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SVGAnimatedEnumeration::InstallInterfaceTemplate,
    nullptr,
    "SVGAnimatedEnumeration",
    nullptr,
    V8SVGAnimatedEnumeration::kThisTag,
    V8SVGAnimatedEnumeration::kMaxSubclassTag,
...
const WrapperTypeInfo& SVGAnimatedEnumerationBase::wrapper_type_info_ =
    V8SVGAnimatedEnumeration::wrapper_type_info_;
...
namespace v8_svg_animated_enumeration {
...
BLINK_BINDINGS_TRACE_EVENT("SVGAnimatedEnumeration.baseVal.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGAnimatedEnumeration.baseVal.set");
...
BLINK_BINDINGS_TRACE_EVENT("SVGAnimatedEnumeration.animVal.get");
...
using namespace v8_svg_animated_enumeration;

}  // namespace 

void V8SVGAnimatedEnumeration::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SVGAnimatedEnumeration::GetWrapperTypeInfo();
...
void V8SVGAnimatedEnumeration::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGAnimatedEnumeration", kAttributeTable);
}
