...
const char* V8RTCPeerConnectionErrorCallback::GetHumanReadableName() const {
  return "V8RTCPeerConnectionErrorCallback";
}

v8::Maybe<void> V8RTCPeerConnectionErrorCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, DOMException* arg1_error) {
  const char* const class_like_name = "RTCPeerConnectionErrorCallback";
...
v8_arg1_error = ToV8Traits<DOMException>::ToV8(script_state, arg1_error);
...
v8::Maybe<void> V8RTCPeerConnectionErrorCallback::Construct(DOMException* arg1_error) {
  const char* const class_like_name = "RTCPeerConnectionErrorCallback";
...
void V8RTCPeerConnectionErrorCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, DOMException* arg1_error) {
  v8::Isolate* isolate = GetIsolate();
...
base::expected<void, ScriptValue> V8RTCPeerConnectionErrorCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, DOMException* arg1_error) {
