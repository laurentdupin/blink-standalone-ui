...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_NUMBER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_NUMBER_H_
...
class CORE_EXPORT V8SVGNumber final : public bindings::V8InterfaceBridge<V8SVGNumber, SVGNumberTearOff> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(978);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGNumberTearOff;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_NUMBER_H_
