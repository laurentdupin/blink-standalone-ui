...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NAVIGATION_CURRENT_ENTRY_CHANGE_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NAVIGATION_CURRENT_ENTRY_CHANGE_EVENT_H_
...
class CORE_EXPORT V8NavigationCurrentEntryChangeEvent final : public bindings::V8InterfaceBridge<V8NavigationCurrentEntryChangeEvent, NavigationCurrentEntryChangeEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(434);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class NavigationCurrentEntryChangeEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NAVIGATION_CURRENT_ENTRY_CHANGE_EVENT_H_
