...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_LI_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_LI_ELEMENT_H_
...
class CORE_EXPORT V8HTMLLIElement final : public bindings::V8InterfaceBridge<V8HTMLLIElement, HTMLLIElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(626);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class HTMLLIElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_LI_ELEMENT_H_
