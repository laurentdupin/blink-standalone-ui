...
class MODULES_EXPORT V8FileWriter final : public bindings::V8InterfaceBridge<V8FileWriter, FileWriter> {
...
class Constant final {
  ...
  public:
static constexpr uint16_t kInit = 0;
static constexpr uint16_t kWriting = 1;
static constexpr uint16_t kDone = 2;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(546);
