...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PAINT_SIZE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PAINT_SIZE_H_
...
class MODULES_EXPORT V8PaintSize final : public bindings::V8InterfaceBridge<V8PaintSize, PaintSize> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1136);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PaintSize;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PAINT_SIZE_H_
