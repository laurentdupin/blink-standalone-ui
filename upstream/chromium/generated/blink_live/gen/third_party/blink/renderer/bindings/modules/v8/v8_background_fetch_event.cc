...
bool V8BackgroundFetchEvent::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsServiceWorkerGlobalScope() && RuntimeEnabledFeatures::BackgroundFetchEnabled();
}

static_assert(std::derived_from<BackgroundFetchEvent, ExtendableEvent>);
...
const WrapperTypeInfo V8BackgroundFetchEvent::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8BackgroundFetchEvent::InstallInterfaceTemplate,
    nullptr,
    "BackgroundFetchEvent",
    V8ExtendableEvent::GetWrapperTypeInfo(),
    V8BackgroundFetchEvent::kThisTag,
    V8BackgroundFetchEvent::kMaxSubclassTag,
...
const WrapperTypeInfo& BackgroundFetchEvent::wrapper_type_info_ =
    V8BackgroundFetchEvent::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, BackgroundFetchEvent>::value,
    "BackgroundFetchEvent inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_background_fetch_event {


void RegistrationAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_BackgroundFetchEvent_registration_Getter");
BLINK_BINDINGS_TRACE_EVENT("BackgroundFetchEvent.registration.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
BackgroundFetchEvent* blink_receiver = V8BackgroundFetchEvent::ToWrappableUnsafe(isolate, v8_receiver);
auto&& return_value = blink_receiver->registration();
static_assert(bindings::IsReturnTypeCompatible<BackgroundFetchRegistration, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
BLINK_BINDINGS_TRACE_EVENT("BackgroundFetchEvent.isTrusted.get");
...
BLINK_BINDINGS_TRACE_EVENT("BackgroundFetchEvent.constructor");
...
auto&& return_value = BackgroundFetchEvent::Create(arg1_type, arg2_init);
static_assert(bindings::IsReturnTypeCompatible<BackgroundFetchEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8BackgroundFetchEvent::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_background_fetch_event;

}  // namespace 

void V8BackgroundFetchEvent::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8BackgroundFetchEvent::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "BackgroundFetchEvent"));
...
void V8BackgroundFetchEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "BackgroundFetchEvent", kAttributeTable);
}
