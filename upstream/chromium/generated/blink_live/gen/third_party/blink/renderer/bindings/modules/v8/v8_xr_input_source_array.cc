...
bool V8XRInputSourceArray::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8XRInputSourceArray::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8XRInputSourceArray::InstallInterfaceTemplate,
    nullptr,
    "XRInputSourceArray",
    nullptr,
    V8XRInputSourceArray::kThisTag,
    V8XRInputSourceArray::kMaxSubclassTag,
...
const WrapperTypeInfo& XRInputSourceArray::wrapper_type_info_ =
    V8XRInputSourceArray::wrapper_type_info_;
...
v8::Intercepted V8XRInputSourceArray::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
static_assert(bindings::IsReturnTypeCompatible<XRInputSource, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
return v8::Intercepted::kYes;
}

v8::Intercepted V8XRInputSourceArray::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRInputSourceArray_IndexedPropertySetter");
...
v8::Intercepted V8XRInputSourceArray::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRInputSourceArray_IndexedPropertyDeleter");
...
v8::Intercepted V8XRInputSourceArray::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRInputSourceArray_IndexedPropertyDefiner");
...
v8::Intercepted V8XRInputSourceArray::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRInputSourceArray_IndexedPropertyDescriptor");
...
auto intercepted =
    V8XRInputSourceArray::IndexedPropertyGetterCallback(index, info);
...
namespace v8_xr_input_source_array {


void LengthAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRInputSourceArray_length_Getter");
BLINK_BINDINGS_TRACE_EVENT("XRInputSourceArray.length.get");
...
using namespace v8_xr_input_source_array;

}  // namespace 

void V8XRInputSourceArray::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8XRInputSourceArray::GetWrapperTypeInfo();
...
instance_template->SetHandler(
    v8::IndexedPropertyHandlerConfiguration(
        V8XRInputSourceArray::IndexedPropertyGetterCallback,
        V8XRInputSourceArray::IndexedPropertySetterCallback,
        nullptr,  // query
        V8XRInputSourceArray::IndexedPropertyDeleterCallback,
        V8XRInputSourceArray::IndexedPropertyEnumeratorCallback,
        V8XRInputSourceArray::IndexedPropertyDefinerCallback,
        V8XRInputSourceArray::IndexedPropertyDescriptorCallback,
        nullptr,  // index_of
        v8::Local<v8::Value>(),
...
void V8XRInputSourceArray::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "XRInputSourceArray", kAttributeTable);
}
