...
static_assert(std::derived_from<StylePropertyMap, StylePropertyMapReadOnly>);
...
const WrapperTypeInfo V8StylePropertyMap::wrapper_type_info_{
    ...
    V8StylePropertyMap::kThisTag,
    V8StylePropertyMap::kMaxSubclassTag,
...
void V8StylePropertyMap::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "StylePropertyMap", kOperationTable);
}
