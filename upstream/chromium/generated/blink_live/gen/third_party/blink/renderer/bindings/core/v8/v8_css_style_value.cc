...
bool V8CSSStyleValue::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8CSSStyleValue::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8CSSStyleValue::InstallInterfaceTemplate,
    V8CSSStyleValue::InstallContextDependentProperties,
    "CSSStyleValue",
    nullptr,
    V8CSSStyleValue::kThisTag,
    V8CSSStyleValue::kMaxSubclassTag,
...
const WrapperTypeInfo& CSSStyleValue::wrapper_type_info_ =
    V8CSSStyleValue::wrapper_type_info_;
...
BLINK_BINDINGS_TRACE_EVENT("CSSStyleValue.parse");
...
auto&& arg2_css_text = NativeValueTraits<IDLString>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& return_value = CSSStyleValue::parse(execution_context, arg1_property, arg2_css_text, exception_state);
static_assert(bindings::IsReturnTypeCompatible<CSSStyleValue, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
void ParseAllStaticOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSStyleValue_parseAll");
BLINK_BINDINGS_TRACE_EVENT("CSSStyleValue.parseAll");
...
auto&& return_value = CSSStyleValue::parseAll(execution_context, arg1_property, arg2_css_text, exception_state);
static_assert(bindings::IsReturnTypeCompatible<IDLSequence<CSSStyleValue>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
BLINK_BINDINGS_TRACE_EVENT("CSSStyleValue.toString");
...
using namespace v8_css_style_value;

}  // namespace 

void V8CSSStyleValue::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8CSSStyleValue::GetWrapperTypeInfo();
...
void V8CSSStyleValue::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "CSSStyleValue", kOperationTable);
}
...
void V8CSSStyleValue::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object, v8::Local<v8::Object> prototype_object, v8::Local<v8::Object> interface_object, v8::Local<v8::Template> interface_template, FeatureSelector feature_selector) {
  using bindings::IDLMemberInstaller;
...
{"parseAll", ParseAllStaticOperationCallback, 2, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kInterface), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kDoNotCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kDoNotCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
};
v8::Local<v8::Signature> signature = v8::Local<v8::Signature>::Cast(interface_template);
IDLMemberInstaller::InstallOperations(isolate, world, instance_object, prototype_object, interface_object, signature, "CSSStyleValue", kOperationTable);
}
