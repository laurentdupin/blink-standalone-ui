...
class MODULES_EXPORT GPUImageCopyTextureTagged : public GPUTexelCopyTextureInfo {
...
void Trace(Visitor* visitor) const override;
  ...
  protected:
static constexpr size_t kBasePropertyCount = GPUTexelCopyTextureInfo::kTotalPropertyCount;
