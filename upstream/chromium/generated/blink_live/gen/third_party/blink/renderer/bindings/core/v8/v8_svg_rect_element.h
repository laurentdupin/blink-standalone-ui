...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_RECT_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_RECT_ELEMENT_H_
...
class CORE_EXPORT V8SVGRectElement final : public bindings::V8InterfaceBridge<V8SVGRectElement, SVGRectElement> {
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_RECT_ELEMENT_H_
