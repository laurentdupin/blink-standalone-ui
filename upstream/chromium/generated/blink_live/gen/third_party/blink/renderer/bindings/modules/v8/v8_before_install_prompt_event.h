...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BEFORE_INSTALL_PROMPT_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BEFORE_INSTALL_PROMPT_EVENT_H_
...
class MODULES_EXPORT V8BeforeInstallPromptEvent final : public bindings::V8InterfaceBridge<V8BeforeInstallPromptEvent, BeforeInstallPromptEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(378);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BEFORE_INSTALL_PROMPT_EVENT_H_
