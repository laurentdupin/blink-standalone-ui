...
if (script_state->World().IsIsolatedWorld() && per_context_data && per_context_data->ActivityLogger()) [[unlikely]] { per_context_data->ActivityLogger()->LogGetter(script_state, "Document.cookie"); }
...
void OnautofillAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Document_onautofill_Getter");
BLINK_BINDINGS_TRACE_EVENT("Document.onautofill.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
Document* blink_receiver = V8Document::ToWrappableUnsafe(isolate, v8_receiver);
auto&& return_value = blink_receiver->onautofill();
static_assert(bindings::IsReturnTypeCompatible<IDLEventHandler, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, isolate, blink_receiver);
}

void OnautofillAttributeSetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Document_onautofill_Setter");
BLINK_BINDINGS_TRACE_EVENT("Document.onautofill.set");
...
v8::Local<v8::Object> v8_receiver = info.This();
Document* blink_receiver = V8Document::ToWrappableUnsafe(isolate, v8_receiver);
blink_receiver->setOnautofill(event_handler);
}
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Document_onbeforefilter_Getter");
BLINK_BINDINGS_TRACE_EVENT("Document.onbeforefilter.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Document_onbeforefilter_Setter");
BLINK_BINDINGS_TRACE_EVENT("Document.onbeforefilter.set");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Document_oncomplete_Getter");
BLINK_BINDINGS_TRACE_EVENT("Document.oncomplete.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Document_oncomplete_Setter");
BLINK_BINDINGS_TRACE_EVENT("Document.oncomplete.set");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Document_onoverscrollcancel_Getter");
BLINK_BINDINGS_TRACE_EVENT("Document.onoverscrollcancel.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Document_onoverscrollcancel_Setter");
BLINK_BINDINGS_TRACE_EVENT("Document.onoverscrollcancel.set");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Document_onoverscrollchanging_Getter");
BLINK_BINDINGS_TRACE_EVENT("Document.onoverscrollchanging.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Document_onoverscrollchanging_Setter");
BLINK_BINDINGS_TRACE_EVENT("Document.onoverscrollchanging.set");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Document_onoverscrollend_Getter");
BLINK_BINDINGS_TRACE_EVENT("Document.onoverscrollend.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Document_onoverscrollend_Setter");
BLINK_BINDINGS_TRACE_EVENT("Document.onoverscrollend.set");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Document_onoverscrollstart_Getter");
BLINK_BINDINGS_TRACE_EVENT("Document.onoverscrollstart.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Document_onoverscrollstart_Setter");
BLINK_BINDINGS_TRACE_EVENT("Document.onoverscrollstart.set");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Document_onanimationcancel_Getter");
BLINK_BINDINGS_TRACE_EVENT("Document.onanimationcancel.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Document_onanimationcancel_Setter");
BLINK_BINDINGS_TRACE_EVENT("Document.onanimationcancel.set");
...
ExecutionContext* current_execution_context = ToExecutionContext(current_script_state);
// [DeprecateAs]
Deprecation::CountDeprecation(current_execution_context, WebFeature::kTopicsAPIAll);
// [Measure], [MeasureAs]
...
ExecutionContext* current_execution_context = ToExecutionContext(current_script_state);
// [DeprecateAs]
Deprecation::CountDeprecation(current_execution_context, WebFeature::kStorageAccessAPI_requestStorageAccessFor_Method);
...
if ((feature_selector.IsAll() && RuntimeEnabledFeatures::AutofillEventEnabled(execution_context)) || feature_selector.IsAnyOf(mojom::blink::OriginTrialFeature::kAutofillEvent)) {
  
static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
{"onautofill", OnautofillAttributeGetCallback, OnautofillAttributeSetCallback, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
};
IDLMemberInstaller::InstallAttributes(isolate, world, instance_object, prototype_object, interface_object, signature, "Document", kAttributeTable);
}
...
reinterpret_cast<intptr_t>(OnanimationcancelAttributeGetCallback),
reinterpret_cast<intptr_t>(OnanimationcancelAttributeSetCallback),
