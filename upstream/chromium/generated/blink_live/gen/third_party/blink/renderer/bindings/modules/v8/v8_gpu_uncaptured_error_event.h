...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_UNCAPTURED_ERROR_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_UNCAPTURED_ERROR_EVENT_H_
...
class MODULES_EXPORT V8GPUUncapturedErrorEvent final : public bindings::V8InterfaceBridge<V8GPUUncapturedErrorEvent, GPUUncapturedErrorEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(415);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class GPUUncapturedErrorEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_UNCAPTURED_ERROR_EVENT_H_
