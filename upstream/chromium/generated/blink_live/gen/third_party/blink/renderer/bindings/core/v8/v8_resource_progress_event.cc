...
static_assert(std::derived_from<ResourceProgressEvent, ProgressEvent>);
...
const WrapperTypeInfo V8ResourceProgressEvent::wrapper_type_info_{
    ...
    V8ResourceProgressEvent::kThisTag,
    V8ResourceProgressEvent::kMaxSubclassTag,
...
void V8ResourceProgressEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "ResourceProgressEvent", kAttributeTable);
}
