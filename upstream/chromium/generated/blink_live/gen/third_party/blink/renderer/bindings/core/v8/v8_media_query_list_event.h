...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_MEDIA_QUERY_LIST_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_MEDIA_QUERY_LIST_EVENT_H_
...
class CORE_EXPORT V8MediaQueryListEvent final : public bindings::V8InterfaceBridge<V8MediaQueryListEvent, MediaQueryListEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(427);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class MediaQueryListEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_MEDIA_QUERY_LIST_EVENT_H_
