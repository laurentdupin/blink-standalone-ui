...
bool V8AudioBuffer::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8AudioBuffer::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8AudioBuffer::InstallInterfaceTemplate,
    nullptr,
    "AudioBuffer",
    nullptr,
    V8AudioBuffer::kThisTag,
    V8AudioBuffer::kMaxSubclassTag,
...
const WrapperTypeInfo& AudioBuffer::wrapper_type_info_ =
    V8AudioBuffer::wrapper_type_info_;
...
BLINK_BINDINGS_TRACE_EVENT("AudioBuffer.length.get");
...
BLINK_BINDINGS_TRACE_EVENT("AudioBuffer.duration.get");
...
BLINK_BINDINGS_TRACE_EVENT("AudioBuffer.sampleRate.get");
...
BLINK_BINDINGS_TRACE_EVENT("AudioBuffer.numberOfChannels.get");
...
BLINK_BINDINGS_TRACE_EVENT("AudioBuffer.constructor");
...
// [Measure], [MeasureAs]
UseCounter::Count(current_execution_context, WebFeature::kV8AudioBuffer_Constructor);
...
auto&& arg1_options = NativeValueTraits<AudioBufferOptions>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& return_value = AudioBuffer::Create(arg1_options, exception_state);
...
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8AudioBuffer::GetWrapperTypeInfo(), v8_receiver);
bindings::V8SetReturnValue(info, v8_wrapper);
}

void CopyFromChannelOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_AudioBuffer_copyFromChannel");
BLINK_BINDINGS_TRACE_EVENT("AudioBuffer.copyFromChannel");
...
ExecutionContext* current_execution_context = ToExecutionContext(current_script_state);
// [Measure], [MeasureAs]
UseCounter::Count(current_execution_context, WebFeature::kV8AudioBuffer_CopyFromChannel_Method);
...
auto&& arg2_channel_number = NativeValueTraits<IDLUnsignedLong>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
decltype(NativeValueTraits<IDLUnsignedLong>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg3_buffer_offset{0};
if (!info[2]->IsUndefined()) {
  arg3_buffer_offset = NativeValueTraits<IDLUnsignedLong>::ArgumentValue(isolate, 2, info[2], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
}
blink_receiver->copyFromChannel(arg1_destination, arg2_channel_number, arg3_buffer_offset, exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
void CopyToChannelOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_AudioBuffer_copyToChannel");
BLINK_BINDINGS_TRACE_EVENT("AudioBuffer.copyToChannel");
...
blink_receiver->copyToChannel(arg1_source, arg2_channel_number, arg3_buffer_offset, exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
void GetChannelDataOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_AudioBuffer_getChannelData");
BLINK_BINDINGS_TRACE_EVENT("AudioBuffer.getChannelData");
...
ExecutionContext* current_execution_context = ToExecutionContext(current_script_state);
// [Measure], [MeasureAs]
UseCounter::Count(current_execution_context, WebFeature::kV8AudioBuffer_GetChannelData_Method);
...
auto&& return_value = blink_receiver->getChannelData(arg1_channel_index, exception_state);
...
using namespace v8_audio_buffer;

}  // namespace 

void V8AudioBuffer::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8AudioBuffer::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "AudioBuffer"));
...
void V8AudioBuffer::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "AudioBuffer", kAttributeTable);
}
...
{"copyFromChannel", CopyFromChannelOperationCallback, 2, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
{"copyToChannel", CopyToChannelOperationCallback, 2, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
{"getChannelData", GetChannelDataOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
};
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "AudioBuffer", kOperationTable);
}
