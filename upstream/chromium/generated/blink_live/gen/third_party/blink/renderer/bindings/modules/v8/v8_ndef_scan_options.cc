...
if (!v8_value->IsObject()) {
  const char* const class_like_name = "NDEFScanOptions";
...
return dictionary;
 ...
 NDEFScanOptions::NDEFScanOptions() {
  
}

 NDEFScanOptions::NDEFScanOptions(v8::Isolate* isolate) {
...
void NDEFScanOptions::Trace(Visitor* visitor) const {
