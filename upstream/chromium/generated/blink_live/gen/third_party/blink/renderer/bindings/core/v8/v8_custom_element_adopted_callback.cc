...
const char* V8CustomElementAdoptedCallback::GetHumanReadableName() const {
...
base::expected<void, ScriptValue> V8CustomElementAdoptedCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, Document* arg1_old_owner, Document* arg2_new_owner) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_old_owner, arg2_new_owner);
