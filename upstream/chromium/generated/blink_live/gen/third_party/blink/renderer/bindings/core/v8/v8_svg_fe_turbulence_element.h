...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_TURBULENCE_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_TURBULENCE_ELEMENT_H_
...
class CORE_EXPORT V8SVGFETurbulenceElement final : public bindings::V8InterfaceBridge<V8SVGFETurbulenceElement, SVGFETurbulenceElement> {
...
class Constant final {
  ...
  public:
static constexpr uint16_t kSVGTurbulenceTypeUnknown = 0;
static constexpr uint16_t kSVGTurbulenceTypeFractalnoise = 1;
static constexpr uint16_t kSVGTurbulenceTypeTurbulence = 2;
static constexpr uint16_t kSVGStitchtypeUnknown = 0;
static constexpr uint16_t kSVGStitchtypeStitch = 1;
static constexpr uint16_t kSVGStitchtypeNostitch = 2;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(709);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGFETurbulenceElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_TURBULENCE_ELEMENT_H_
