...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_SRGB_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_SRGB_H_
...
class MODULES_EXPORT V8EXTsRGB final : public bindings::V8InterfaceBridge<V8EXTsRGB, EXTsRGB> {
...
class Constant final {
  ...
  public:
static constexpr uint32_t kSRGBExt = 0x8C40;
static constexpr uint32_t kSRGBAlphaExt = 0x8C42;
static constexpr uint32_t kSRGB8Alpha8Ext = 0x8C43;
static constexpr uint32_t kFramebufferAttachmentColorEncodingExt = 0x8210;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1305);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class EXTsRGB;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_SRGB_H_
