...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GRAVITY_SENSOR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GRAVITY_SENSOR_H_
...
class MODULES_EXPORT V8GravitySensor final : public bindings::V8InterfaceBridge<V8GravitySensor, GravitySensor> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(775);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class GravitySensor;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GRAVITY_SENSOR_H_
