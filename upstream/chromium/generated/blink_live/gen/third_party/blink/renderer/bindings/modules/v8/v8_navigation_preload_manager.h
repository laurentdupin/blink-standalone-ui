...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_NAVIGATION_PRELOAD_MANAGER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_NAVIGATION_PRELOAD_MANAGER_H_
...
class MODULES_EXPORT V8NavigationPreloadManager final : public bindings::V8InterfaceBridge<V8NavigationPreloadManager, NavigationPreloadManager> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1248);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class NavigationPreloadManager;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_NAVIGATION_PRELOAD_MANAGER_H_
