...
bool V8BroadcastChannel::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow() || execution_context->IsWorkerGlobalScope();
}

static_assert(std::derived_from<BroadcastChannel, EventTarget>);
...
const WrapperTypeInfo V8BroadcastChannel::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8BroadcastChannel::InstallInterfaceTemplate,
    nullptr,
    "BroadcastChannel",
    V8EventTarget::GetWrapperTypeInfo(),
    V8BroadcastChannel::kThisTag,
    V8BroadcastChannel::kMaxSubclassTag,
...
const WrapperTypeInfo& BroadcastChannel::wrapper_type_info_ =
    V8BroadcastChannel::wrapper_type_info_;
...
namespace v8_broadcast_channel {
...
BLINK_BINDINGS_TRACE_EVENT("BroadcastChannel.name.get");
...
BLINK_BINDINGS_TRACE_EVENT("BroadcastChannel.onmessage.get");
...
BLINK_BINDINGS_TRACE_EVENT("BroadcastChannel.onmessage.set");
...
BLINK_BINDINGS_TRACE_EVENT("BroadcastChannel.onmessageerror.get");
...
BLINK_BINDINGS_TRACE_EVENT("BroadcastChannel.onmessageerror.set");
...
BLINK_BINDINGS_TRACE_EVENT("BroadcastChannel.constructor");
...
auto&& return_value = BroadcastChannel::Create(execution_context, arg1_name);
static_assert(bindings::IsReturnTypeCompatible<BroadcastChannel, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8BroadcastChannel::GetWrapperTypeInfo(), v8_receiver);
...
BLINK_BINDINGS_TRACE_EVENT("BroadcastChannel.close");
...
BLINK_BINDINGS_TRACE_EVENT("BroadcastChannel.postMessage");
...
blink_receiver->postMessage(arg1_message, exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
using namespace v8_broadcast_channel;

}  // namespace 

void V8BroadcastChannel::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8BroadcastChannel::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "BroadcastChannel"));
...
void V8BroadcastChannel::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "BroadcastChannel", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "BroadcastChannel", kOperationTable);
}
