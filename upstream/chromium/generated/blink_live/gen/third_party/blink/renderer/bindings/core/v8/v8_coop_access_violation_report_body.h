...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_COOP_ACCESS_VIOLATION_REPORT_BODY_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_COOP_ACCESS_VIOLATION_REPORT_BODY_H_
...
class CoopAccessViolationReportBody;
class ExecutionContext;
struct WrapperTypeInfo;

class CORE_EXPORT V8CoopAccessViolationReportBody final : public bindings::V8InterfaceBridge<V8CoopAccessViolationReportBody, CoopAccessViolationReportBody> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(866);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CoopAccessViolationReportBody;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_COOP_ACCESS_VIOLATION_REPORT_BODY_H_
