...
class MODULES_EXPORT V8WebGLFramebuffer final : public bindings::V8InterfaceBridge<V8WebGLFramebuffer, WebGLFramebuffer> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1347);
