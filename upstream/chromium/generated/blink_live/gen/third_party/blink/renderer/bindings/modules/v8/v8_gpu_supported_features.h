...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_SUPPORTED_FEATURES_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_SUPPORTED_FEATURES_H_
...
class MODULES_EXPORT V8GPUSupportedFeatures final : public bindings::V8InterfaceBridge<V8GPUSupportedFeatures, GPUSupportedFeatures> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1398);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class GPUSupportedFeatures;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_SUPPORTED_FEATURES_H_
