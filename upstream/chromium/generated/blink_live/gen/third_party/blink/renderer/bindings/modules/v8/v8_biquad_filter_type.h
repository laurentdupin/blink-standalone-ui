...
kLowpass, kHighpass, kBandpass, kLowshelf, kHighshelf, kPeaking, kNotch, kAllpass
};
...
explicit constexpr  V8BiquadFilterType(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
