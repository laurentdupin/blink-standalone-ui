...
const char* V8ReportingObserverCallback::GetHumanReadableName() const {
  return "V8ReportingObserverCallback";
}

v8::Maybe<void> V8ReportingObserverCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<Report>>& arg1_reports, ReportingObserver* arg2_observer) {
...
void V8ReportingObserverCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<Report>>& arg1_reports, ReportingObserver* arg2_observer) {
  v8::Isolate* isolate = GetIsolate();
...
base::expected<void, ScriptValue> V8ReportingObserverCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<Report>>& arg1_reports, ReportingObserver* arg2_observer) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_reports, arg2_observer);
