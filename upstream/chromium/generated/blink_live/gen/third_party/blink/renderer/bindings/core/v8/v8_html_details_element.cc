...
bool V8HTMLDetailsElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<HTMLDetailsElement, HTMLElement>);
...
const WrapperTypeInfo V8HTMLDetailsElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8HTMLDetailsElement::InstallInterfaceTemplate,
    nullptr,
    "HTMLDetailsElement",
    V8HTMLElement::GetWrapperTypeInfo(),
    V8HTMLDetailsElement::kThisTag,
    V8HTMLDetailsElement::kMaxSubclassTag,
...
const WrapperTypeInfo& HTMLDetailsElement::wrapper_type_info_ =
    V8HTMLDetailsElement::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, HTMLDetailsElement>::value,
    "HTMLDetailsElement inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_html_details_element {


void OpenAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLDetailsElement_open_Getter");
BLINK_BINDINGS_TRACE_EVENT("HTMLDetailsElement.open.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
HTMLDetailsElement* blink_receiver = V8HTMLDetailsElement::ToWrappableUnsafe(isolate, v8_receiver);
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLDetailsElement_open_Setter");
BLINK_BINDINGS_TRACE_EVENT("HTMLDetailsElement.open.set");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLDetailsElement_name_Getter");
BLINK_BINDINGS_TRACE_EVENT("HTMLDetailsElement.name.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLDetailsElement_name_Setter");
BLINK_BINDINGS_TRACE_EVENT("HTMLDetailsElement.name.set");

bindings::PerformAttributeSetCEReactionsReflectTypeString(info, html_names::kNameAttr);
}

void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLDetailsElement_constructor");
BLINK_BINDINGS_TRACE_EVENT("HTMLDetailsElement.constructor");
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLDetailsElement::GetWrapperTypeInfo(), ElementType::kHTMLDetailsElement);
}


}  // namespace v8_html_details_element

using namespace v8_html_details_element;

}  // namespace 

void V8HTMLDetailsElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8HTMLDetailsElement::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "HTMLDetailsElement"));
...
void V8HTMLDetailsElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLDetailsElement", kAttributeTable);
}
