...
bool V8SVGFEFloodElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<SVGFEFloodElement, SVGElement>);
...
const WrapperTypeInfo V8SVGFEFloodElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SVGFEFloodElement::InstallInterfaceTemplate,
    nullptr,
    "SVGFEFloodElement",
    V8SVGElement::GetWrapperTypeInfo(),
    V8SVGFEFloodElement::kThisTag,
    V8SVGFEFloodElement::kMaxSubclassTag,
...
const WrapperTypeInfo& SVGFEFloodElement::wrapper_type_info_ =
    V8SVGFEFloodElement::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, SVGFEFloodElement>::value,
    "SVGFEFloodElement inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_svg_fe_flood_element {
...
BLINK_BINDINGS_TRACE_EVENT("SVGFEFloodElement.x.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
SVGFEFloodElement* blink_receiver = V8SVGFEFloodElement::ToWrappableUnsafe(isolate, v8_receiver);
...
BLINK_BINDINGS_TRACE_EVENT("SVGFEFloodElement.y.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFEFloodElement.width.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFEFloodElement.height.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGFEFloodElement.result.get");
...
using namespace v8_svg_fe_flood_element;

}  // namespace 

void V8SVGFEFloodElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SVGFEFloodElement::GetWrapperTypeInfo();
...
void V8SVGFEFloodElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGFEFloodElement", kAttributeTable);
}
