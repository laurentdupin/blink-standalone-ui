...
const char* V8EntryCallback::GetHumanReadableName() const {
  return "V8EntryCallback";
}

v8::Maybe<void> V8EntryCallback::handleEvent(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, Entry* arg1_entry) {
  const char* const class_like_name = "EntryCallback";
...
void V8EntryCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, Entry* arg1_entry) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = handleEvent(arg0_receiver, arg1_entry);
}
