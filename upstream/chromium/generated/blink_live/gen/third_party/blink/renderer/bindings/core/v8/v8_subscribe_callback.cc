...
const char* V8SubscribeCallback::GetHumanReadableName() const {
  return "V8SubscribeCallback";
}

v8::Maybe<void> V8SubscribeCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, Subscriber* arg1_subscriber) {
  const char* const class_like_name = "SubscribeCallback";
...
v8::Local<v8::Value> v8_arg1_subscriber;
ScriptState* script_state = CallbackRelevantScriptState();
v8_arg1_subscriber = ToV8Traits<Subscriber>::ToV8(script_state, arg1_subscriber);
argv[0] = v8_arg1_subscriber;
...
v8::Maybe<void> V8SubscribeCallback::Construct(Subscriber* arg1_subscriber) {
  const char* const class_like_name = "SubscribeCallback";
...
void V8SubscribeCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, Subscriber* arg1_subscriber) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = Invoke(arg0_receiver, arg1_subscriber);
}

base::expected<void, ScriptValue> V8SubscribeCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, Subscriber* arg1_subscriber) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_subscriber);
