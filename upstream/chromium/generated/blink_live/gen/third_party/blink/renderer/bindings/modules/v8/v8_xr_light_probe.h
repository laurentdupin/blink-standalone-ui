...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_LIGHT_PROBE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_LIGHT_PROBE_H_
...
class MODULES_EXPORT V8XRLightProbe final : public bindings::V8InterfaceBridge<V8XRLightProbe, XRLightProbe> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(826);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XRLightProbe;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_LIGHT_PROBE_H_
