...
v8::Local<v8::Value> V8UnionWorkletAnimationEffectOrWorkletGroupEffect::DirectToV8(ScriptState* script_state, WorkletAnimationEffect* value) {
  return ToV8Traits<WorkletAnimationEffect>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionWorkletAnimationEffectOrWorkletGroupEffect::DirectToV8(ScriptState* script_state, WorkletGroupEffect* value) {
  return ToV8Traits<WorkletGroupEffect>::ToV8(script_state, value);
}
