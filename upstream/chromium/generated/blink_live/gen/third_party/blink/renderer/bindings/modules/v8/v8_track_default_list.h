...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_TRACK_DEFAULT_LIST_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_TRACK_DEFAULT_LIST_H_
...
class MODULES_EXPORT V8TrackDefaultList final : public bindings::V8InterfaceBridge<V8TrackDefaultList, TrackDefaultList> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1195);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class TrackDefaultList;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_TRACK_DEFAULT_LIST_H_
