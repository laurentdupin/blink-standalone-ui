...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_OVERSCROLL_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_OVERSCROLL_EVENT_H_
...
class OverscrollEvent;
struct WrapperTypeInfo;

class CORE_EXPORT V8OverscrollEvent final : public bindings::V8InterfaceBridge<V8OverscrollEvent, OverscrollEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(436);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class OverscrollEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_OVERSCROLL_EVENT_H_
