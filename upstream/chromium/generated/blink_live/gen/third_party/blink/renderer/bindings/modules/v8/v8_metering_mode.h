...
kNone, kManual, kSingleShot, kContinuous
};
static constexpr size_t kEnumSize = 4;

static V8MeteringMode Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8MeteringMode> Create(const String& value);

explicit constexpr  V8MeteringMode(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
