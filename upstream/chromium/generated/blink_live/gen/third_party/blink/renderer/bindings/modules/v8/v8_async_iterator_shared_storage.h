...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ASYNC_ITERATOR_SHARED_STORAGE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ASYNC_ITERATOR_SHARED_STORAGE_H_
...
template <>
class MODULES_EXPORT AsyncIterator<SharedStorage> final : public bindings::AsyncIteratorBase {
...
explicit  AsyncIterator<SharedStorage>(IterationSourceBase* source) : bindings::AsyncIteratorBase(source) {
...
class MODULES_EXPORT V8AsyncIteratorSharedStorage final : public bindings::V8InterfaceBridge<V8AsyncIteratorSharedStorage, AsyncIterator<SharedStorage>> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(258);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class AsyncIterator<SharedStorage>;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ASYNC_ITERATOR_SHARED_STORAGE_H_
