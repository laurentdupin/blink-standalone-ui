...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NOT_RESTORED_REASON_DETAILS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NOT_RESTORED_REASON_DETAILS_H_
...
class CORE_EXPORT V8NotRestoredReasonDetails final : public bindings::V8InterfaceBridge<V8NotRestoredReasonDetails, NotRestoredReasonDetails> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(991);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class NotRestoredReasonDetails;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NOT_RESTORED_REASON_DETAILS_H_
