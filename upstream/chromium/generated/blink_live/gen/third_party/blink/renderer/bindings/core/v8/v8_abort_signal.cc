...
bool V8AbortSignal::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow() || execution_context->IsWorkerGlobalScope() || execution_context->IsShadowRealmGlobalScope();
}

static_assert(std::derived_from<AbortSignal, EventTarget>);
...
const WrapperTypeInfo V8AbortSignal::wrapper_type_info_{
    ...
    V8AbortSignal::InstallContextDependentProperties,
    "AbortSignal",
    V8EventTarget::GetWrapperTypeInfo(),
    V8AbortSignal::kThisTag,
    V8AbortSignal::kMaxSubclassTag,
...
const WrapperTypeInfo& AbortSignal::wrapper_type_info_ =
    V8AbortSignal::wrapper_type_info_;
...
v8::Local<v8::Object> v8_receiver = info.This();
AbortSignal* blink_receiver = V8AbortSignal::ToWrappableUnsafe(isolate, v8_receiver);
blink_receiver->throwIfAborted(isolate);
...
void AnyStaticOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_AbortSignal_any");
BLINK_BINDINGS_TRACE_EVENT("AbortSignal.any");
...
auto&& return_value = AbortSignal::any(script_state, std::move(arg1_signals));
...
void V8AbortSignal::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "AbortSignal", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "AbortSignal", kOperationTable);
}
...
void V8AbortSignal::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object, v8::Local<v8::Object> prototype_object, v8::Local<v8::Object> interface_object, v8::Local<v8::Template> interface_template, FeatureSelector feature_selector) {
  using bindings::IDLMemberInstaller;
...
v8::Local<v8::Signature> signature = v8::Local<v8::Signature>::Cast(interface_template);
IDLMemberInstaller::InstallOperations(isolate, world, instance_object, prototype_object, interface_object, signature, "AbortSignal", kOperationTable);
}
