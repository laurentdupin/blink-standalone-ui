...
bool V8SVGAnimatedNumber::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8SVGAnimatedNumber::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SVGAnimatedNumber::InstallInterfaceTemplate,
    nullptr,
    "SVGAnimatedNumber",
    nullptr,
    V8SVGAnimatedNumber::kThisTag,
    V8SVGAnimatedNumber::kMaxSubclassTag,
...
const WrapperTypeInfo& SVGAnimatedNumber::wrapper_type_info_ =
    V8SVGAnimatedNumber::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, SVGAnimatedNumber>::value,
    "SVGAnimatedNumber inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_svg_animated_number {
...
BLINK_BINDINGS_TRACE_EVENT("SVGAnimatedNumber.baseVal.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
SVGAnimatedNumber* blink_receiver = V8SVGAnimatedNumber::ToWrappableUnsafe(isolate, v8_receiver);
...
BLINK_BINDINGS_TRACE_EVENT("SVGAnimatedNumber.baseVal.set");
...
BLINK_BINDINGS_TRACE_EVENT("SVGAnimatedNumber.animVal.get");
...
using namespace v8_svg_animated_number;

}  // namespace 

void V8SVGAnimatedNumber::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SVGAnimatedNumber::GetWrapperTypeInfo();
...
void V8SVGAnimatedNumber::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGAnimatedNumber", kAttributeTable);
}
