...
bool V8SVGAnimatedInteger::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8SVGAnimatedInteger::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SVGAnimatedInteger::InstallInterfaceTemplate,
    nullptr,
    "SVGAnimatedInteger",
    nullptr,
    V8SVGAnimatedInteger::kThisTag,
    V8SVGAnimatedInteger::kMaxSubclassTag,
...
const WrapperTypeInfo& SVGAnimatedInteger::wrapper_type_info_ =
    V8SVGAnimatedInteger::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, SVGAnimatedInteger>::value,
    "SVGAnimatedInteger inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_svg_animated_integer {
...
BLINK_BINDINGS_TRACE_EVENT("SVGAnimatedInteger.baseVal.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
SVGAnimatedInteger* blink_receiver = V8SVGAnimatedInteger::ToWrappableUnsafe(isolate, v8_receiver);
...
BLINK_BINDINGS_TRACE_EVENT("SVGAnimatedInteger.baseVal.set");
...
BLINK_BINDINGS_TRACE_EVENT("SVGAnimatedInteger.animVal.get");
...
using namespace v8_svg_animated_integer;

}  // namespace 

void V8SVGAnimatedInteger::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SVGAnimatedInteger::GetWrapperTypeInfo();
...
void V8SVGAnimatedInteger::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGAnimatedInteger", kAttributeTable);
}
