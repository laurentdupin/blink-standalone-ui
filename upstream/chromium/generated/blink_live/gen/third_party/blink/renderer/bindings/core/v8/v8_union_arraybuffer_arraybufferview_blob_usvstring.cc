...
v8::Local<v8::Value> V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVString::DirectToV8(ScriptState* script_state, DOMArrayBuffer* value) {
  return ToV8Traits<DOMArrayBuffer>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVString::DirectToV8(ScriptState* script_state, NotShared<DOMArrayBufferView> value) {
  return ToV8Traits<NotShared<DOMArrayBufferView>>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVString::DirectToV8(ScriptState* script_state, Blob* value) {
  return ToV8Traits<Blob>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionArrayBufferOrArrayBufferViewOrBlobOrUSVString::DirectToV8(ScriptState* script_state, const String& value) {
