...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CANVAS_PATTERN_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CANVAS_PATTERN_H_
...
class MODULES_EXPORT V8CanvasPattern final : public bindings::V8InterfaceBridge<V8CanvasPattern, CanvasPattern> {
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CANVAS_PATTERN_H_
