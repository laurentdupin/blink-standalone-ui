...
class MODULES_EXPORT V8USBEndpointType final : public bindings::EnumerationBase {
  
  public:
enum class Enum : enum_int_t {
kBulk, kInterrupt, kIsochronous
};
static constexpr size_t kEnumSize = 3;

static V8USBEndpointType Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8USBEndpointType> Create(const String& value);

explicit constexpr  V8USBEndpointType(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8USBEndpointType& lhs, V8USBEndpointType::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8USBEndpointType::Enum lhs, const V8USBEndpointType& rhs) {
