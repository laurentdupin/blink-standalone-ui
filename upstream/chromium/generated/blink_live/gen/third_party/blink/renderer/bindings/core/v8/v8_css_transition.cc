...
static_assert(std::derived_from<CSSTransition, Animation>);
...
const WrapperTypeInfo V8CSSTransition::wrapper_type_info_{
    ...
    V8CSSTransition::kThisTag,
    V8CSSTransition::kMaxSubclassTag,
...
void V8CSSTransition::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "CSSTransition", kAttributeTable);
}
