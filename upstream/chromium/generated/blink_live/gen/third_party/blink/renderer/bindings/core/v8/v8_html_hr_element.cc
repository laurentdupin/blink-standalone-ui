...
static_assert(std::derived_from<HTMLHRElement, HTMLElement>);
...
const WrapperTypeInfo& HTMLHRElement::wrapper_type_info_ =
    V8HTMLHRElement::wrapper_type_info_;
...
bindings::PerformAttributeSetCEReactionsReflectTypeString(info, html_names::kColorAttr);
}
...
bindings::PerformAttributeSetCEReactionsReflectTypeBoolean(info, html_names::kNoshadeAttr);
}
...
bindings::PerformAttributeSetCEReactionsReflectTypeString(info, html_names::kSizeAttr);
}
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLHRElement::GetWrapperTypeInfo(), ElementType::kHTMLHRElement);
}
...
void V8HTMLHRElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLHRElement", kAttributeTable);
}
