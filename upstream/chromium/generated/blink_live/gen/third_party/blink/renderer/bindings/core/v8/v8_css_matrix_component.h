...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_MATRIX_COMPONENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_MATRIX_COMPONENT_H_
...
class CORE_EXPORT V8CSSMatrixComponent final : public bindings::V8InterfaceBridge<V8CSSMatrixComponent, CSSMatrixComponent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(336);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSMatrixComponent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_MATRIX_COMPONENT_H_
