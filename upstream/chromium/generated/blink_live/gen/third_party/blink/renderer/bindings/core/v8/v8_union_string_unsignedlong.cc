...
v8::Local<v8::Value> V8UnionStringOrUnsignedLong::DirectToV8(ScriptState* script_state, const String& value) {
  return ToV8Traits<IDLString>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionStringOrUnsignedLong::DirectToV8(ScriptState* script_state, uint32_t value) {
