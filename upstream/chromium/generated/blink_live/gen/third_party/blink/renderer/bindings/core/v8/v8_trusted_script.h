...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TRUSTED_SCRIPT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TRUSTED_SCRIPT_H_
...
class CORE_EXPORT V8TrustedScript final : public bindings::V8InterfaceBridge<V8TrustedScript, TrustedScript> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1022);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class TrustedScript;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TRUSTED_SCRIPT_H_
