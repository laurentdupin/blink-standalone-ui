...
using crdtp::span;
namespace cbor {
using crdtp::cbor::ParseCBOR;
using crdtp::cbor::EncodeBinary;
...
using crdtp::cbor::EncodeIndefiniteLengthArrayStart;
using crdtp::cbor::EncodeIndefiniteLengthMapStart;
using crdtp::cbor::EncodeInt32;
using crdtp::cbor::EncodeNull;
using crdtp::cbor::EncodeStop;
using crdtp::cbor::EncodeString8;
using crdtp::cbor::EncodeTrue;
using crdtp::cbor::EnvelopeEncoder;
}  // namespace cbor
...
using blink::protocol::Object;
using blink::protocol::Value;
using blink::protocol::String;
using blink::protocol::DictionaryValue;
using blink::protocol::FundamentalValue;
using blink::protocol::StringValue;
