...
using Ret = bindings::OptimizedReturnProxy<V8UnionIDBCursorOrIDBIndexOrIDBObjectStore>;
v8::Local<v8::Value> ToV8(ScriptState* script_state) const;

static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, IDBCursor* value);
static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, IDBIndex* value);
static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, IDBObjectStore* value);
