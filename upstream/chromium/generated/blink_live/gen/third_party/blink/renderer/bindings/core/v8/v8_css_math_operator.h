...
kSum, kProduct, kNegate, kInvert, kMin, kMax, kClamp, kRandom
};
...
explicit constexpr  V8CSSMathOperator(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
