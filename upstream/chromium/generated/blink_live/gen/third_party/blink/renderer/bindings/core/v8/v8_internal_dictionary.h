...
bool hasRecordMemberWithDefault() const {
  return true;
}
const Vector<std::pair<String, int32_t>>& recordMemberWithDefault() const {
  return member_record_member_with_default_;
}
void setRecordMemberWithDefault(const Vector<std::pair<String, int32_t>>& value);
void setRecordMemberWithDefault(Vector<std::pair<String, int32_t>>&& value);
...
Vector<std::pair<String, int32_t>> member_record_member_with_default_;
