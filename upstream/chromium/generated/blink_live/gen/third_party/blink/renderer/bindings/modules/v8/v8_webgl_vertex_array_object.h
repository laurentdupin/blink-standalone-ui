...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_VERTEX_ARRAY_OBJECT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_VERTEX_ARRAY_OBJECT_H_
...
class MODULES_EXPORT V8WebGLVertexArrayObject final : public bindings::V8InterfaceBridge<V8WebGLVertexArrayObject, WebGLVertexArrayObject> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1357);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEBGL_VERTEX_ARRAY_OBJECT_H_
