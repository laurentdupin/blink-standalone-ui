...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_STYLE_PROPERTY_MAP_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_STYLE_PROPERTY_MAP_H_
...
class CORE_EXPORT V8StylePropertyMap final : public bindings::V8InterfaceBridge<V8StylePropertyMap, StylePropertyMap> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(346);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class StylePropertyMap;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_STYLE_PROPERTY_MAP_H_
