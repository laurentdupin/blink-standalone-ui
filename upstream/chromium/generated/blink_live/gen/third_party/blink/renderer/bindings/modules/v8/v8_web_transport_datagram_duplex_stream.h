...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEB_TRANSPORT_DATAGRAM_DUPLEX_STREAM_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEB_TRANSPORT_DATAGRAM_DUPLEX_STREAM_H_
...
class MODULES_EXPORT V8WebTransportDatagramDuplexStream final : public bindings::V8InterfaceBridge<V8WebTransportDatagramDuplexStream, DatagramDuplexStream> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1408);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class DatagramDuplexStream;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WEB_TRANSPORT_DATAGRAM_DUPLEX_STREAM_H_
