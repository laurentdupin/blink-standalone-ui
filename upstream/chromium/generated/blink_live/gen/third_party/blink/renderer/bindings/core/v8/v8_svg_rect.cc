...
bool V8SVGRect::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8SVGRect::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SVGRect::InstallInterfaceTemplate,
    nullptr,
    "SVGRect",
    nullptr,
    V8SVGRect::kThisTag,
    V8SVGRect::kMaxSubclassTag,
...
BLINK_BINDINGS_TRACE_EVENT("SVGRect.x.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGRect.x.set");
...
BLINK_BINDINGS_TRACE_EVENT("SVGRect.y.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGRect.y.set");
...
BLINK_BINDINGS_TRACE_EVENT("SVGRect.width.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGRect.width.set");
...
BLINK_BINDINGS_TRACE_EVENT("SVGRect.height.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGRect.height.set");
...
using namespace v8_svg_rect;

}  // namespace 

void V8SVGRect::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SVGRect::GetWrapperTypeInfo();
...
void V8SVGRect::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGRect", kAttributeTable);
}
