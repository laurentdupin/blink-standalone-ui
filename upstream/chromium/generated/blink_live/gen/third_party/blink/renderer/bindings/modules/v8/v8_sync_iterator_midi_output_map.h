...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_MIDI_OUTPUT_MAP_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_MIDI_OUTPUT_MAP_H_
...
template <>
class MODULES_EXPORT SyncIterator<MIDIOutputMap> final : public bindings::SyncIteratorBase {
  DEFINE_WRAPPERTYPEINFO();

  public:
using IDLKeyType = IDLString;
using IDLValueType = MIDIOutput;
using KeyType = String;
using ValueType = MIDIOutput*;

explicit  SyncIterator<MIDIOutputMap>(IterationSourceBase* source, Kind kind) : bindings::SyncIteratorBase(source, kind) {
...
class MODULES_EXPORT V8SyncIteratorMIDIOutputMap final : public bindings::V8InterfaceBridge<V8SyncIteratorMIDIOutputMap, SyncIterator<MIDIOutputMap>> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1504);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SyncIterator<MIDIOutputMap>;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_MIDI_OUTPUT_MAP_H_
