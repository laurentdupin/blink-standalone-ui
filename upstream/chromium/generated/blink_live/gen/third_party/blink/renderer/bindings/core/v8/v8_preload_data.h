...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PRELOAD_DATA_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PRELOAD_DATA_H_
...
class CORE_EXPORT V8PreloadData final : public bindings::V8InterfaceBridge<V8PreloadData, PreloadData> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1018);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PreloadData;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PRELOAD_DATA_H_
