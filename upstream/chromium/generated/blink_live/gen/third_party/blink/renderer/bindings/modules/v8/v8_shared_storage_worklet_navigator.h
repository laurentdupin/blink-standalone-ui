...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SHARED_STORAGE_WORKLET_NAVIGATOR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SHARED_STORAGE_WORKLET_NAVIGATOR_H_
...
class MODULES_EXPORT V8SharedStorageWorkletNavigator final : public bindings::V8InterfaceBridge<V8SharedStorageWorkletNavigator, SharedStorageWorkletNavigator> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1260);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SharedStorageWorkletNavigator;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SHARED_STORAGE_WORKLET_NAVIGATOR_H_
