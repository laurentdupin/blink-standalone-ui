...
bool V8GamepadButton::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8GamepadButton::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8GamepadButton::InstallInterfaceTemplate,
    nullptr,
    "GamepadButton",
    nullptr,
    V8GamepadButton::kThisTag,
    V8GamepadButton::kMaxSubclassTag,
...
const WrapperTypeInfo& GamepadButton::wrapper_type_info_ =
    V8GamepadButton::wrapper_type_info_;
...
BLINK_BINDINGS_TRACE_EVENT("GamepadButton.pressed.get");
...
void TouchedAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_GamepadButton_touched_Getter");
BLINK_BINDINGS_TRACE_EVENT("GamepadButton.touched.get");
v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Context> current_context = isolate->GetCurrentContext();
ScriptState* current_script_state = ScriptState::From(isolate, current_context);
ExecutionContext* current_execution_context = ToExecutionContext(current_script_state);
// [Measure], [MeasureAs]
UseCounter::Count(current_execution_context, WebFeature::kGamepadButtonTouched);
...
BLINK_BINDINGS_TRACE_EVENT("GamepadButton.value.get");
...
using namespace v8_gamepad_button;

}  // namespace 

void V8GamepadButton::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8GamepadButton::GetWrapperTypeInfo();
...
void V8GamepadButton::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
  using bindings::IDLMemberInstaller;

{
  
static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
{"pressed", PressedAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
{"touched", TouchedAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "GamepadButton", kAttributeTable);
}
