...
bool V8CSSKeywordValue::IsExposed(ExecutionContext* execution_context) {
...
static_assert(std::derived_from<CSSKeywordValue, CSSStyleValue>);
...
const WrapperTypeInfo V8CSSKeywordValue::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8CSSKeywordValue::InstallInterfaceTemplate,
    nullptr,
    "CSSKeywordValue",
    V8CSSStyleValue::GetWrapperTypeInfo(),
    V8CSSKeywordValue::kThisTag,
    V8CSSKeywordValue::kMaxSubclassTag,
...
const WrapperTypeInfo& CSSKeywordValue::wrapper_type_info_ =
    V8CSSKeywordValue::wrapper_type_info_;
...
namespace v8_css_keyword_value {
...
BLINK_BINDINGS_TRACE_EVENT("CSSKeywordValue.value.get");
...
BLINK_BINDINGS_TRACE_EVENT("CSSKeywordValue.value.set");
...
BLINK_BINDINGS_TRACE_EVENT("CSSKeywordValue.constructor");
...
ExceptionState exception_state(isolate);
auto&& arg1_keyword = NativeValueTraits<IDLString>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& return_value = CSSKeywordValue::Create(arg1_keyword, exception_state);
static_assert(bindings::IsReturnTypeCompatible<CSSKeywordValue, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8CSSKeywordValue::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_css_keyword_value;

}  // namespace 

void V8CSSKeywordValue::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8CSSKeywordValue::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "CSSKeywordValue"));
...
void V8CSSKeywordValue::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "CSSKeywordValue", kAttributeTable);
}
