...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_AUDIO_WORKLET_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_AUDIO_WORKLET_H_
...
class MODULES_EXPORT V8AudioWorklet final : public bindings::V8InterfaceBridge<V8AudioWorklet, AudioWorklet> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1037);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class AudioWorklet;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_AUDIO_WORKLET_H_
