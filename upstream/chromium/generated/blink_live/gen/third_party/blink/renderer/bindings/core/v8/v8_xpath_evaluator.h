...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_XPATH_EVALUATOR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_XPATH_EVALUATOR_H_
...
class CORE_EXPORT V8XPathEvaluator final : public bindings::V8InterfaceBridge<V8XPathEvaluator, XPathEvaluator> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1046);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XPathEvaluator;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_XPATH_EVALUATOR_H_
