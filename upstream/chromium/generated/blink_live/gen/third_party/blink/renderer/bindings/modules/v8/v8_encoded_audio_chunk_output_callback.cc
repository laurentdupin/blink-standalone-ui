...
const char* V8EncodedAudioChunkOutputCallback::GetHumanReadableName() const {
  return "V8EncodedAudioChunkOutputCallback";
}

v8::Maybe<void> V8EncodedAudioChunkOutputCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, EncodedAudioChunk* arg1_output, const EncodedAudioChunkMetadata* arg2_metadata) {
  const char* const class_like_name = "EncodedAudioChunkOutputCallback";
...
v8::Maybe<void> V8EncodedAudioChunkOutputCallback::Construct(EncodedAudioChunk* arg1_output, const EncodedAudioChunkMetadata* arg2_metadata) {
  const char* const class_like_name = "EncodedAudioChunkOutputCallback";
...
void V8EncodedAudioChunkOutputCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, EncodedAudioChunk* arg1_output, const EncodedAudioChunkMetadata* arg2_metadata) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = Invoke(arg0_receiver, arg1_output, arg2_metadata);
}

base::expected<void, ScriptValue> V8EncodedAudioChunkOutputCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, EncodedAudioChunk* arg1_output, const EncodedAudioChunkMetadata* arg2_metadata) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_output, arg2_metadata);
