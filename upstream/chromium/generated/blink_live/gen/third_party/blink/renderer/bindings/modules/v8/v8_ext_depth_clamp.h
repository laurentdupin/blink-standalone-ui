...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_DEPTH_CLAMP_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_DEPTH_CLAMP_H_
...
class MODULES_EXPORT V8EXTDepthClamp final : public bindings::V8InterfaceBridge<V8EXTDepthClamp, EXTDepthClamp> {
...
class Constant final {
  ...
  public:
static constexpr uint32_t kDepthClampExt = 0x864F;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1297);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class EXTDepthClamp;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_DEPTH_CLAMP_H_
