...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SPELL_CHECK_CUSTOM_DICTIONARY_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SPELL_CHECK_CUSTOM_DICTIONARY_H_
...
class MODULES_EXPORT V8SpellCheckCustomDictionary final : public bindings::V8InterfaceBridge<V8SpellCheckCustomDictionary, SpellCheckCustomDictionary> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1268);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SpellCheckCustomDictionary;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SPELL_CHECK_CUSTOM_DICTIONARY_H_
