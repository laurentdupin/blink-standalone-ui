...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_POLYGON_OFFSET_CLAMP_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_POLYGON_OFFSET_CLAMP_H_
...
class MODULES_EXPORT V8EXTPolygonOffsetClamp final : public bindings::V8InterfaceBridge<V8EXTPolygonOffsetClamp, EXTPolygonOffsetClamp> {
...
class Constant final {
  ...
  public:
static constexpr uint32_t kPolygonOffsetClampExt = 0x8E1B;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1302);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class EXTPolygonOffsetClamp;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_POLYGON_OFFSET_CLAMP_H_
