...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ENCODED_VIDEO_CHUNK_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ENCODED_VIDEO_CHUNK_H_
...
class MODULES_EXPORT V8EncodedVideoChunk final : public bindings::V8InterfaceBridge<V8EncodedVideoChunk, EncodedVideoChunk> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1284);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class EncodedVideoChunk;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ENCODED_VIDEO_CHUNK_H_
