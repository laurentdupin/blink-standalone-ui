...
using Ret = bindings::OptimizedReturnProxy<V8UnionBooleanOrConstrainDoubleRangeOrDouble>;
...
static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, ConstrainDoubleRange* value);
