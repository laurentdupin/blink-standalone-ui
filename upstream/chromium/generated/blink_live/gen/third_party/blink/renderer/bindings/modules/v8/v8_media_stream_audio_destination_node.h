...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MEDIA_STREAM_AUDIO_DESTINATION_NODE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MEDIA_STREAM_AUDIO_DESTINATION_NODE_H_
...
class MODULES_EXPORT V8MediaStreamAudioDestinationNode final : public bindings::V8InterfaceBridge<V8MediaStreamAudioDestinationNode, MediaStreamAudioDestinationNode> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(520);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MEDIA_STREAM_AUDIO_DESTINATION_NODE_H_
