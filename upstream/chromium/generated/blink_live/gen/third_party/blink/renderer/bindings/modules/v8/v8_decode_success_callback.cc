...
const char* V8DecodeSuccessCallback::GetHumanReadableName() const {
  return "V8DecodeSuccessCallback";
}

v8::Maybe<void> V8DecodeSuccessCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, AudioBuffer* arg1_decoded_data) {
  const char* const class_like_name = "DecodeSuccessCallback";
...
v8::Local<v8::Value> v8_arg1_decoded_data;
ScriptState* script_state = CallbackRelevantScriptState();
v8_arg1_decoded_data = ToV8Traits<AudioBuffer>::ToV8(script_state, arg1_decoded_data);
argv[0] = v8_arg1_decoded_data;
...
v8::Maybe<void> V8DecodeSuccessCallback::Construct(AudioBuffer* arg1_decoded_data) {
  const char* const class_like_name = "DecodeSuccessCallback";
...
void V8DecodeSuccessCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, AudioBuffer* arg1_decoded_data) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = Invoke(arg0_receiver, arg1_decoded_data);
}

base::expected<void, ScriptValue> V8DecodeSuccessCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, AudioBuffer* arg1_decoded_data) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_decoded_data);
