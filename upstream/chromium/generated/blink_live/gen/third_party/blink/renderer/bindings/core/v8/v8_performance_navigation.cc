...
bool V8PerformanceNavigation::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8PerformanceNavigation::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8PerformanceNavigation::InstallInterfaceTemplate,
    nullptr,
    "PerformanceNavigation",
    nullptr,
    V8PerformanceNavigation::kThisTag,
    V8PerformanceNavigation::kMaxSubclassTag,
...
const WrapperTypeInfo& PerformanceNavigation::wrapper_type_info_ =
    V8PerformanceNavigation::wrapper_type_info_;
...
namespace v8_performance_navigation {
...
BLINK_BINDINGS_TRACE_EVENT("PerformanceNavigation.type.get");
...
BLINK_BINDINGS_TRACE_EVENT("PerformanceNavigation.redirectCount.get");
...
BLINK_BINDINGS_TRACE_EVENT("PerformanceNavigation.toJSON");
...
using namespace v8_performance_navigation;

}  // namespace 

void V8PerformanceNavigation::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8PerformanceNavigation::GetWrapperTypeInfo();
...
void V8PerformanceNavigation::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "PerformanceNavigation", kAttributeTable);
}
...
{"TYPE_NAVIGATE", V8PerformanceNavigation::Constant::kTypeNavigate},
{"TYPE_RELOAD", V8PerformanceNavigation::Constant::kTypeReload},
{"TYPE_BACK_FORWARD", V8PerformanceNavigation::Constant::kTypeBackForward},
{"TYPE_RESERVED", V8PerformanceNavigation::Constant::kTypeReserved},
};
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "PerformanceNavigation", kOperationTable);
}
