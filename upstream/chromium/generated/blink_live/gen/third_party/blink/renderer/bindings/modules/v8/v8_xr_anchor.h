...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_ANCHOR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_ANCHOR_H_
...
class MODULES_EXPORT V8XRAnchor final : public bindings::V8InterfaceBridge<V8XRAnchor, XRAnchor> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1421);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XRAnchor;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_ANCHOR_H_
