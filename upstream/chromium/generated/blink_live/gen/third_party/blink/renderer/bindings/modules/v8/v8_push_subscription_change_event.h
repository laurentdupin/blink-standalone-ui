...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PUSH_SUBSCRIPTION_CHANGE_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PUSH_SUBSCRIPTION_CHANGE_EVENT_H_
...
class MODULES_EXPORT V8PushSubscriptionChangeEvent final : public bindings::V8InterfaceBridge<V8PushSubscriptionChangeEvent, PushSubscriptionChangeEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(411);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PushSubscriptionChangeEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PUSH_SUBSCRIPTION_CHANGE_EVENT_H_
