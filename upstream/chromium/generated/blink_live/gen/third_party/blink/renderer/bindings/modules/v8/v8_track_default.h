...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_TRACK_DEFAULT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_TRACK_DEFAULT_H_
...
class MODULES_EXPORT V8TrackDefault final : public bindings::V8InterfaceBridge<V8TrackDefault, TrackDefault> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1194);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class TrackDefault;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_TRACK_DEFAULT_H_
