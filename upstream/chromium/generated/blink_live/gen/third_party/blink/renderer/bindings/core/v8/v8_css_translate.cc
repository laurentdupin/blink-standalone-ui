...
static_assert(std::derived_from<CSSTranslate, CSSTransformComponent>);
...
const WrapperTypeInfo& CSSTranslate::wrapper_type_info_ =
    V8CSSTranslate::wrapper_type_info_;
...
void V8CSSTranslate::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "CSSTranslate", kAttributeTable);
}
