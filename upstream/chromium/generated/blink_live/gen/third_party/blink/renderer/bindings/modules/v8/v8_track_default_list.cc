...
const WrapperTypeInfo& TrackDefaultList::wrapper_type_info_ =
    V8TrackDefaultList::wrapper_type_info_;
...
v8::Intercepted V8TrackDefaultList::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
...
v8::Intercepted V8TrackDefaultList::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
...
decltype(NativeValueTraits<IDLSequence<TrackDefault>>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg1_track_defaults;
...
instance_template->SetHandler(
    v8::IndexedPropertyHandlerConfiguration(
        ...
        nullptr,  // query
        V8TrackDefaultList::IndexedPropertyDeleterCallback,
        V8TrackDefaultList::IndexedPropertyEnumeratorCallback,
...
void V8TrackDefaultList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "TrackDefaultList", kAttributeTable);
}
