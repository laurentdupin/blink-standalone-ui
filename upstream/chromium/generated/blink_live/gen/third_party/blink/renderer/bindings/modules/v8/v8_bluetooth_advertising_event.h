...
class MODULES_EXPORT V8BluetoothAdvertisingEvent final : public bindings::V8InterfaceBridge<V8BluetoothAdvertisingEvent, BluetoothAdvertisingEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(381);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class BluetoothAdvertisingEvent;
};
