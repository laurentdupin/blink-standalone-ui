...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_INTRINSIC_SIZES_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_INTRINSIC_SIZES_H_
...
class CORE_EXPORT V8IntrinsicSizes final : public bindings::V8InterfaceBridge<V8IntrinsicSizes, CustomIntrinsicSizes> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(922);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CustomIntrinsicSizes;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_INTRINSIC_SIZES_H_
