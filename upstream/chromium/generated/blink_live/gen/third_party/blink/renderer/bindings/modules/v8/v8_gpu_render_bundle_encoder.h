...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_RENDER_BUNDLE_ENCODER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_RENDER_BUNDLE_ENCODER_H_
...
class MODULES_EXPORT V8GPURenderBundleEncoder final : public bindings::V8InterfaceBridge<V8GPURenderBundleEncoder, GPURenderBundleEncoder> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1392);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class GPURenderBundleEncoder;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_RENDER_BUNDLE_ENCODER_H_
