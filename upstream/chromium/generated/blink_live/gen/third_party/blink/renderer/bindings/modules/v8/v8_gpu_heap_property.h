...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_HEAP_PROPERTY_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_HEAP_PROPERTY_H_
...
class MODULES_EXPORT V8GPUHeapProperty final : public bindings::V8InterfaceBridge<V8GPUHeapProperty, GPUHeapProperty> {
...
class Constant final {
  ...
  public:
static constexpr uint32_t kDeviceLocal = 1;
static constexpr uint32_t kHostVisible = 2;
static constexpr uint32_t kHostCoherent = 4;
static constexpr uint32_t kHostUncached = 8;
static constexpr uint32_t kHostCached = 16;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1480);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class GPUHeapProperty;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_HEAP_PROPERTY_H_
