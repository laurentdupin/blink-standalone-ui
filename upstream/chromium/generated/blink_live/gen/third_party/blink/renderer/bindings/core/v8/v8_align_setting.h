...
kStart, kCenter, kEnd, kLeft, kRight
};
...
explicit constexpr  V8AlignSetting(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
