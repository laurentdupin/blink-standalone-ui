...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SHARED_STORAGE_SET_METHOD_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SHARED_STORAGE_SET_METHOD_H_
...
class MODULES_EXPORT V8SharedStorageSetMethod final : public bindings::V8InterfaceBridge<V8SharedStorageSetMethod, SharedStorageSetMethod> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SharedStorageSetMethod;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SHARED_STORAGE_SET_METHOD_H_
