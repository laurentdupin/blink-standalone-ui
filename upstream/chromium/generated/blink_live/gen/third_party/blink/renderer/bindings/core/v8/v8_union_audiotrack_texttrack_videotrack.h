...
using Ret = bindings::OptimizedReturnProxy<V8UnionAudioTrackOrTextTrackOrVideoTrack>;
v8::Local<v8::Value> ToV8(ScriptState* script_state) const;

static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, AudioTrack* value);
static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, TextTrack* value);
static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, VideoTrack* value);
