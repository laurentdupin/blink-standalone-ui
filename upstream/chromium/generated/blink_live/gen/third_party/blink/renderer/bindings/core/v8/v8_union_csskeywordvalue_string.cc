...
v8::Local<v8::Value> V8UnionCSSKeywordValueOrString::DirectToV8(ScriptState* script_state, CSSKeywordValue* value) {
  return ToV8Traits<CSSKeywordValue>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionCSSKeywordValueOrString::DirectToV8(ScriptState* script_state, const String& value) {
