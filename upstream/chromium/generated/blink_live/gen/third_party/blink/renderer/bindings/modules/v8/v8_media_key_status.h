...
kUsable, kExpired, kReleased, kOutputRestricted, kOutputDownscaled, kStatusPending, kInternalError, kUsableInFuture
};
...
explicit constexpr  V8MediaKeyStatus(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
