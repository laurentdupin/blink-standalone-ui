...
bool hasAlwaysNegotiateDataChannels() const {
  return true;
}
bool alwaysNegotiateDataChannels() const {
  return member_always_negotiate_data_channels_;
}
void setAlwaysNegotiateDataChannels(bool value) {
  member_always_negotiate_data_channels_ = value;
}
...
bool member_always_negotiate_data_channels_{false};
