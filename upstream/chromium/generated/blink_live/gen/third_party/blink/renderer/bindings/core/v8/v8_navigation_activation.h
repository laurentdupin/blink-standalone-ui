...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NAVIGATION_ACTIVATION_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NAVIGATION_ACTIVATION_H_
...
class CORE_EXPORT V8NavigationActivation final : public bindings::V8InterfaceBridge<V8NavigationActivation, NavigationActivation> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(931);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class NavigationActivation;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NAVIGATION_ACTIVATION_H_
