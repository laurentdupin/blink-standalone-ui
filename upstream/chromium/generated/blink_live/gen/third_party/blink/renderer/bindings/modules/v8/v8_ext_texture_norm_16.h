...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_TEXTURE_NORM_16_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_TEXTURE_NORM_16_H_
...
class MODULES_EXPORT V8EXTTextureNorm16 final : public bindings::V8InterfaceBridge<V8EXTTextureNorm16, EXTTextureNorm16> {
...
class Constant final {
  ...
  public:
static constexpr uint32_t kR16Ext = 0x822A;
static constexpr uint32_t kRg16Ext = 0x822C;
static constexpr uint32_t kRgb16Ext = 0x8054;
static constexpr uint32_t kRgba16Ext = 0x805B;
static constexpr uint32_t kR16SnormExt = 0x8F98;
static constexpr uint32_t kRg16SnormExt = 0x8F99;
static constexpr uint32_t kRgb16SnormExt = 0x8F9A;
static constexpr uint32_t kRgba16SnormExt = 0x8F9B;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1310);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class EXTTextureNorm16;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_TEXTURE_NORM_16_H_
