...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PERFORMANCE_LONG_TASK_TIMING_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PERFORMANCE_LONG_TASK_TIMING_H_
...
class CORE_EXPORT V8PerformanceLongTaskTiming final : public bindings::V8InterfaceBridge<V8PerformanceLongTaskTiming, PerformanceLongTaskTiming> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1002);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PerformanceLongTaskTiming;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PERFORMANCE_LONG_TASK_TIMING_H_
