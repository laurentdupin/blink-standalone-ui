...
class CORE_EXPORT V8CSSFontFeatureValuesRule final : public bindings::V8InterfaceBridge<V8CSSFontFeatureValuesRule, CSSFontFeatureValuesRule> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(280);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSFontFeatureValuesRule;
};
