...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GAMEPAD_TOUCH_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GAMEPAD_TOUCH_H_
...
class MODULES_EXPORT V8GamepadTouch final : public bindings::V8InterfaceBridge<V8GamepadTouch, GamepadTouch> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1170);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class GamepadTouch;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GAMEPAD_TOUCH_H_
