...
bool V8CanMakePaymentEvent::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsServiceWorkerGlobalScope() && RuntimeEnabledFeatures::PaymentAppEnabled();
}

static_assert(std::derived_from<CanMakePaymentEvent, ExtendableEvent>);
...
const WrapperTypeInfo V8CanMakePaymentEvent::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8CanMakePaymentEvent::InstallInterfaceTemplate,
    nullptr,
    "CanMakePaymentEvent",
    V8ExtendableEvent::GetWrapperTypeInfo(),
    V8CanMakePaymentEvent::kThisTag,
    V8CanMakePaymentEvent::kMaxSubclassTag,
...
const WrapperTypeInfo& CanMakePaymentEvent::wrapper_type_info_ =
    V8CanMakePaymentEvent::wrapper_type_info_;
...
namespace v8_can_make_payment_event {
...
BLINK_BINDINGS_TRACE_EVENT("CanMakePaymentEvent.isTrusted.get");
...
BLINK_BINDINGS_TRACE_EVENT("CanMakePaymentEvent.constructor");
...
auto&& arg2_event_init_dict = NativeValueTraits<CanMakePaymentEventInit>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& return_value = CanMakePaymentEvent::Create(arg1_type, arg2_event_init_dict);
static_assert(bindings::IsReturnTypeCompatible<CanMakePaymentEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8CanMakePaymentEvent::GetWrapperTypeInfo(), v8_receiver);
...
BLINK_BINDINGS_TRACE_EVENT("CanMakePaymentEvent.respondWith");
...
ExceptionState exception_state(isolate);
auto&& arg1_can_make_payment_response = NativeValueTraits<IDLPromise<IDLBoolean>>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
blink_receiver->respondWith(script_state, arg1_can_make_payment_response, exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
using namespace v8_can_make_payment_event;

}  // namespace 

void V8CanMakePaymentEvent::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8CanMakePaymentEvent::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "CanMakePaymentEvent"));
...
void V8CanMakePaymentEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "CanMakePaymentEvent", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "CanMakePaymentEvent", kOperationTable);
}
