...
const char* V8CustomElementFormAssociatedCallback::GetHumanReadableName() const {
  return "V8CustomElementFormAssociatedCallback";
}

v8::Maybe<void> V8CustomElementFormAssociatedCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, HTMLFormElement* arg1_form) {
  const char* const class_like_name = "CustomElementFormAssociatedCallback";
...
v8::Local<v8::Value> v8_arg1_form;
ScriptState* script_state = CallbackRelevantScriptState();
v8_arg1_form = ToV8Traits<IDLNullable<HTMLFormElement>>::ToV8(script_state, arg1_form);
argv[0] = v8_arg1_form;
...
v8::Maybe<void> V8CustomElementFormAssociatedCallback::Construct(HTMLFormElement* arg1_form) {
  const char* const class_like_name = "CustomElementFormAssociatedCallback";
...
void V8CustomElementFormAssociatedCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, HTMLFormElement* arg1_form) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = Invoke(arg0_receiver, arg1_form);
}

base::expected<void, ScriptValue> V8CustomElementFormAssociatedCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, HTMLFormElement* arg1_form) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_form);
