...
v8::Local<v8::Value> V8UnionFileOrUSVString::DirectToV8(ScriptState* script_state, File* value) {
  return ToV8Traits<File>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionFileOrUSVString::DirectToV8(ScriptState* script_state, const String& value) {
