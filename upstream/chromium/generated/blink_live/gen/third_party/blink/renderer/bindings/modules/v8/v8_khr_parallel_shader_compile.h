...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_KHR_PARALLEL_SHADER_COMPILE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_KHR_PARALLEL_SHADER_COMPILE_H_
...
class MODULES_EXPORT V8KHRParallelShaderCompile final : public bindings::V8InterfaceBridge<V8KHRParallelShaderCompile, KHRParallelShaderCompile> {
...
class Constant final {
  ...
  public:
static constexpr uint32_t kCompletionStatusKhr = 0x91B1;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1311);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class KHRParallelShaderCompile;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_KHR_PARALLEL_SHADER_COMPILE_H_
