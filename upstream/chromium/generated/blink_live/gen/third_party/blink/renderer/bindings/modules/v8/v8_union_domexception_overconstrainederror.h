...
using Ret = bindings::OptimizedReturnProxy<V8UnionDOMExceptionOrOverconstrainedError>;
v8::Local<v8::Value> ToV8(ScriptState* script_state) const;

static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, DOMException* value);
static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, OverconstrainedError* value);
