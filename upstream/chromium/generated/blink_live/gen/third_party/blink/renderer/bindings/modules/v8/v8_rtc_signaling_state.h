...
class MODULES_EXPORT V8RTCSignalingState final : public bindings::EnumerationBase {
  
  public:
enum class Enum : enum_int_t {
kStable, kHaveLocalOffer, kHaveRemoteOffer, kHaveLocalPranswer, kHaveRemotePranswer, kClosed
};
static constexpr size_t kEnumSize = 6;

static V8RTCSignalingState Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8RTCSignalingState> Create(const String& value);

explicit constexpr  V8RTCSignalingState(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8RTCSignalingState& lhs, V8RTCSignalingState::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8RTCSignalingState::Enum lhs, const V8RTCSignalingState& rhs) {
