...
const WrapperTypeInfo V8XRTransientInputHitTestSource::wrapper_type_info_{
    ...
    nullptr,
    V8XRTransientInputHitTestSource::kThisTag,
    V8XRTransientInputHitTestSource::kMaxSubclassTag,
...
void V8XRTransientInputHitTestSource::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "XRTransientInputHitTestSource", kOperationTable);
}
