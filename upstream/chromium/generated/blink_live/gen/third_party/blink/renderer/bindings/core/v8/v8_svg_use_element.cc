...
bool V8SVGUseElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<SVGUseElement, SVGGraphicsElement>);
...
const WrapperTypeInfo V8SVGUseElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SVGUseElement::InstallInterfaceTemplate,
    nullptr,
    "SVGUseElement",
    V8SVGGraphicsElement::GetWrapperTypeInfo(),
    V8SVGUseElement::kThisTag,
    V8SVGUseElement::kMaxSubclassTag,
...
const WrapperTypeInfo& SVGUseElement::wrapper_type_info_ =
    V8SVGUseElement::wrapper_type_info_;
...
namespace v8_svg_use_element {


void XAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SVGUseElement_x_Getter");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SVGUseElement_y_Getter");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SVGUseElement_width_Getter");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SVGUseElement_height_Getter");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SVGUseElement_href_Getter");
...
using namespace v8_svg_use_element;

}  // namespace 

void V8SVGUseElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SVGUseElement::GetWrapperTypeInfo();
...
void V8SVGUseElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGUseElement", kAttributeTable);
}
