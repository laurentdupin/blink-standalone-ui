...
static_assert(std::derived_from<HTMLAreaElement, HTMLElement>);
...
const WrapperTypeInfo V8HTMLAreaElement::wrapper_type_info_{
    ...
    V8HTMLAreaElement::InstallContextDependentProperties,
    "HTMLAreaElement",
...
bindings::PerformAttributeSetCEReactionsReflectTypeString(info, html_names::kCoordsAttr);
}
...
bindings::PerformAttributeSetCEReactionsReflectTypeString(info, html_names::kDownloadAttr);
}
...
bindings::PerformAttributeSetCEReactionsReflectTypeString(info, html_names::kShapeAttr);
}
...
bindings::PerformAttributeSetCEReactionsReflectTypeBoolean(info, html_names::kNohrefAttr);
}


void AttributionSrcAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLAreaElement_attributionSrc_Getter");
BLINK_BINDINGS_TRACE_EVENT("HTMLAreaElement.attributionSrc.get");
v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Context> current_context = isolate->GetCurrentContext();
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLAreaElement_attributionSrc_Setter");
BLINK_BINDINGS_TRACE_EVENT("HTMLAreaElement.attributionSrc.set");
v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Context> current_context = isolate->GetCurrentContext();
ScriptState* current_script_state = ScriptState::From(isolate, current_context);
ExecutionContext* current_execution_context = ToExecutionContext(current_script_state);
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLAreaElement_interestForElement_Getter");
BLINK_BINDINGS_TRACE_EVENT("HTMLAreaElement.interestForElement.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLAreaElement_interestForElement_Setter");
BLINK_BINDINGS_TRACE_EVENT("HTMLAreaElement.interestForElement.set");
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLAreaElement::GetWrapperTypeInfo(), ElementType::kHTMLAreaElement);
}
...
void V8HTMLAreaElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLAreaElement", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLAreaElement", kOperationTable);
}
...
void V8HTMLAreaElement::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object, v8::Local<v8::Object> prototype_object, v8::Local<v8::Object> interface_object, v8::Local<v8::Template> interface_template, FeatureSelector feature_selector) {
  using bindings::IDLMemberInstaller;
...
v8::Local<v8::Signature> signature = v8::Local<v8::Signature>::Cast(interface_template);
IDLMemberInstaller::InstallAttributes(isolate, world, instance_object, prototype_object, interface_object, signature, "HTMLAreaElement", kAttributeTable);
}
