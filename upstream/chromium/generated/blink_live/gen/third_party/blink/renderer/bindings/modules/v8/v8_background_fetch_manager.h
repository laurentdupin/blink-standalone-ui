...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BACKGROUND_FETCH_MANAGER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BACKGROUND_FETCH_MANAGER_H_
...
class MODULES_EXPORT V8BackgroundFetchManager final : public bindings::V8InterfaceBridge<V8BackgroundFetchManager, BackgroundFetchManager> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1085);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class BackgroundFetchManager;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BACKGROUND_FETCH_MANAGER_H_
