...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_ANIMATE_TRANSFORM_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_ANIMATE_TRANSFORM_ELEMENT_H_
...
class CORE_EXPORT V8SVGAnimateTransformElement final : public bindings::V8InterfaceBridge<V8SVGAnimateTransformElement, SVGAnimateTransformElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(680);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_ANIMATE_TRANSFORM_ELEMENT_H_
