...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_LOGIN_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_LOGIN_ELEMENT_H_
...
class CORE_EXPORT V8HTMLLoginElement final : public bindings::V8InterfaceBridge<V8HTMLLoginElement, HTMLLoginElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(630);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class HTMLLoginElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_LOGIN_ELEMENT_H_
