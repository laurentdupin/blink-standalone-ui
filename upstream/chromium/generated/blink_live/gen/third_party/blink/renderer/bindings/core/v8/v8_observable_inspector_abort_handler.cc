...
const char* V8ObservableInspectorAbortHandler::GetHumanReadableName() const {
...
base::expected<void, ScriptValue> V8ObservableInspectorAbortHandler::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const ScriptValue& arg1_value) {
