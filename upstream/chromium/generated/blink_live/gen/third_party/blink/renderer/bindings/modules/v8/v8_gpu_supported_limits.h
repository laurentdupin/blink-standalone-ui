...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_SUPPORTED_LIMITS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_SUPPORTED_LIMITS_H_
...
class MODULES_EXPORT V8GPUSupportedLimits final : public bindings::V8InterfaceBridge<V8GPUSupportedLimits, GPUSupportedLimits> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1399);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class GPUSupportedLimits;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_SUPPORTED_LIMITS_H_
