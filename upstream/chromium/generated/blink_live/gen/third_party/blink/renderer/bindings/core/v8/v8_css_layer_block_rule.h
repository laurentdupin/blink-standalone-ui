...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_LAYER_BLOCK_RULE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_LAYER_BLOCK_RULE_H_
...
class CORE_EXPORT V8CSSLayerBlockRule final : public bindings::V8InterfaceBridge<V8CSSLayerBlockRule, CSSLayerBlockRule> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(290);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSLayerBlockRule;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_LAYER_BLOCK_RULE_H_
