...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SCRIPT_PROCESSOR_NODE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SCRIPT_PROCESSOR_NODE_H_
...
class MODULES_EXPORT V8ScriptProcessorNode final : public bindings::V8InterfaceBridge<V8ScriptProcessorNode, ScriptProcessorNode> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(523);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SCRIPT_PROCESSOR_NODE_H_
