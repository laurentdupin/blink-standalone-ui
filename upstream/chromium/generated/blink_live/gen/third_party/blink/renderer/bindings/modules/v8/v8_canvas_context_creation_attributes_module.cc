...
return dictionary;
 ...
 CanvasContextCreationAttributesModule::CanvasContextCreationAttributesModule() : member_tone_mapping_(CanvasToneMapping::Create()) {
  
}

 CanvasContextCreationAttributesModule::CanvasContextCreationAttributesModule(v8::Isolate* isolate) : member_tone_mapping_(CanvasToneMapping::Create()) {
...
if (!bindings::GetDictionaryMemberFromV8Object<CanvasToneMapping, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[11].Get(isolate), fallback_presence_var, member_tone_mapping_, class_like_name, exception_state)) {
  return;
}
}
dictionary_from_v8_context.SetCurrentPropertyName("willReadFrequently");
if (!bindings::GetDictionaryMemberFromV8Object<V8CanvasWillReadFrequently, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[12].Get(isolate), fallback_presence_var, member_will_read_frequently_, class_like_name, exception_state)) {
  return;
}
if (RuntimeEnabledFeatures::WebXREnabled()) {
  dictionary_from_v8_context.SetCurrentPropertyName("xrCompatible");
if (!bindings::GetDictionaryMemberFromV8Object<IDLBoolean, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[13].Get(isolate), fallback_presence_var, member_xr_compatible_, class_like_name, exception_state)) {
  return;
}
}
}
