...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_MERGE_NODE_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_MERGE_NODE_ELEMENT_H_
...
class CORE_EXPORT V8SVGFEMergeNodeElement final : public bindings::V8InterfaceBridge<V8SVGFEMergeNodeElement, SVGFEMergeNodeElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(702);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGFEMergeNodeElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_MERGE_NODE_ELEMENT_H_
