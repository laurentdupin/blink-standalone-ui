...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_LENGTH_LIST_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_LENGTH_LIST_H_
...
class CORE_EXPORT V8SVGLengthList final : public bindings::V8InterfaceBridge<V8SVGLengthList, SVGLengthListTearOff> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(976);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGLengthListTearOff;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_LENGTH_LIST_H_
