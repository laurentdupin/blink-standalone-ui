...
v8::Local<v8::Value> V8UnionConstrainPoint2DParametersOrPoint2DSequence::DirectToV8(ScriptState* script_state, ConstrainPoint2DParameters* value) {
  return ToV8Traits<ConstrainPoint2DParameters>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionConstrainPoint2DParametersOrPoint2DSequence::DirectToV8(ScriptState* script_state, const HeapVector<Member<Point2D>>& value) {
  return ToV8Traits<IDLSequence<Point2D>>::ToV8(script_state, value);
}

void V8UnionConstrainPoint2DParametersOrPoint2DSequence::Trace(Visitor* visitor) const {
  visitor->Trace(member_constrain_point_2d_parameters_);
visitor->Trace(member_point_2d_sequence_);
