...
bool V8SVGForeignObjectElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<SVGForeignObjectElement, SVGGraphicsElement>);
...
const WrapperTypeInfo V8SVGForeignObjectElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SVGForeignObjectElement::InstallInterfaceTemplate,
    nullptr,
    "SVGForeignObjectElement",
    V8SVGGraphicsElement::GetWrapperTypeInfo(),
    V8SVGForeignObjectElement::kThisTag,
    V8SVGForeignObjectElement::kMaxSubclassTag,
...
const WrapperTypeInfo& SVGForeignObjectElement::wrapper_type_info_ =
    V8SVGForeignObjectElement::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, SVGForeignObjectElement>::value,
    "SVGForeignObjectElement inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_svg_foreign_object_element {
...
BLINK_BINDINGS_TRACE_EVENT("SVGForeignObjectElement.x.get");
v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Context> current_context = isolate->GetCurrentContext();
ScriptState* current_script_state = ScriptState::From(isolate, current_context);
ExecutionContext* current_execution_context = ToExecutionContext(current_script_state);
// [Measure], [MeasureAs]
UseCounter::Count(current_execution_context, WebFeature::kSVG1DOMForeignObjectElement);


v8::Local<v8::Object> v8_receiver = info.This();
SVGForeignObjectElement* blink_receiver = V8SVGForeignObjectElement::ToWrappableUnsafe(isolate, v8_receiver);
...
BLINK_BINDINGS_TRACE_EVENT("SVGForeignObjectElement.y.get");
v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Context> current_context = isolate->GetCurrentContext();
ScriptState* current_script_state = ScriptState::From(isolate, current_context);
ExecutionContext* current_execution_context = ToExecutionContext(current_script_state);
...
BLINK_BINDINGS_TRACE_EVENT("SVGForeignObjectElement.width.get");
v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Context> current_context = isolate->GetCurrentContext();
ScriptState* current_script_state = ScriptState::From(isolate, current_context);
ExecutionContext* current_execution_context = ToExecutionContext(current_script_state);
...
BLINK_BINDINGS_TRACE_EVENT("SVGForeignObjectElement.height.get");
v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Context> current_context = isolate->GetCurrentContext();
ScriptState* current_script_state = ScriptState::From(isolate, current_context);
ExecutionContext* current_execution_context = ToExecutionContext(current_script_state);
...
using namespace v8_svg_foreign_object_element;

}  // namespace 

void V8SVGForeignObjectElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SVGForeignObjectElement::GetWrapperTypeInfo();
...
void V8SVGForeignObjectElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGForeignObjectElement", kAttributeTable);
}
