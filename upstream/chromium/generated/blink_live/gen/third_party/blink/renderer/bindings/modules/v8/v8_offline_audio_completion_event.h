...
class MODULES_EXPORT V8OfflineAudioCompletionEvent final : public bindings::V8InterfaceBridge<V8OfflineAudioCompletionEvent, OfflineAudioCompletionEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(435);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class OfflineAudioCompletionEvent;
};
