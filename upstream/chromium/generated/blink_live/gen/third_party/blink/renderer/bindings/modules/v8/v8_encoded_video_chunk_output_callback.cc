...
const char* V8EncodedVideoChunkOutputCallback::GetHumanReadableName() const {
  return "V8EncodedVideoChunkOutputCallback";
}

v8::Maybe<void> V8EncodedVideoChunkOutputCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, EncodedVideoChunk* arg1_chunk, const EncodedVideoChunkMetadata* arg2_metadata) {
  const char* const class_like_name = "EncodedVideoChunkOutputCallback";
...
v8::Local<v8::Value> v8_arg1_chunk;
ScriptState* script_state = CallbackRelevantScriptState();
v8_arg1_chunk = ToV8Traits<EncodedVideoChunk>::ToV8(script_state, arg1_chunk);
argv[0] = v8_arg1_chunk;
v8::Local<v8::Value> v8_arg2_metadata;
v8_arg2_metadata = ToV8Traits<EncodedVideoChunkMetadata>::ToV8(script_state, arg2_metadata);
...
v8::Maybe<void> V8EncodedVideoChunkOutputCallback::Construct(EncodedVideoChunk* arg1_chunk, const EncodedVideoChunkMetadata* arg2_metadata) {
  const char* const class_like_name = "EncodedVideoChunkOutputCallback";
...
void V8EncodedVideoChunkOutputCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, EncodedVideoChunk* arg1_chunk, const EncodedVideoChunkMetadata* arg2_metadata) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = Invoke(arg0_receiver, arg1_chunk, arg2_metadata);
}

base::expected<void, ScriptValue> V8EncodedVideoChunkOutputCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, EncodedVideoChunk* arg1_chunk, const EncodedVideoChunkMetadata* arg2_metadata) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_chunk, arg2_metadata);
