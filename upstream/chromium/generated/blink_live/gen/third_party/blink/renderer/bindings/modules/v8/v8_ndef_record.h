...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_NDEF_RECORD_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_NDEF_RECORD_H_
...
class MODULES_EXPORT V8NDEFRecord final : public bindings::V8InterfaceBridge<V8NDEFRecord, NDEFRecord> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1210);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class NDEFRecord;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_NDEF_RECORD_H_
