...
v8::Local<v8::Value> V8UnionIDBCursorOrIDBIndexOrIDBObjectStore::DirectToV8(ScriptState* script_state, IDBCursor* value) {
  return ToV8Traits<IDBCursor>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionIDBCursorOrIDBIndexOrIDBObjectStore::DirectToV8(ScriptState* script_state, IDBIndex* value) {
  return ToV8Traits<IDBIndex>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionIDBCursorOrIDBIndexOrIDBObjectStore::DirectToV8(ScriptState* script_state, IDBObjectStore* value) {
  return ToV8Traits<IDBObjectStore>::ToV8(script_state, value);
}
