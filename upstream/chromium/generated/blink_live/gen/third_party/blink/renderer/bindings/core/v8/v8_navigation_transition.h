...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NAVIGATION_TRANSITION_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NAVIGATION_TRANSITION_H_
...
class CORE_EXPORT V8NavigationTransition final : public bindings::V8InterfaceBridge<V8NavigationTransition, NavigationTransition> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(935);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class NavigationTransition;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NAVIGATION_TRANSITION_H_
