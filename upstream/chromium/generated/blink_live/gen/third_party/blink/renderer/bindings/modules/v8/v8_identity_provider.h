...
class MODULES_EXPORT V8IdentityProvider final : public bindings::V8InterfaceBridge<V8IdentityProvider, IdentityProvider> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1130);
