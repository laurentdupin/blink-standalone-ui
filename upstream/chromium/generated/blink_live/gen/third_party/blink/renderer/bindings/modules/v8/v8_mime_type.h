...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MIME_TYPE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MIME_TYPE_H_
...
class MODULES_EXPORT V8MimeType final : public bindings::V8InterfaceBridge<V8MimeType, DOMMimeType> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1231);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class DOMMimeType;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MIME_TYPE_H_
