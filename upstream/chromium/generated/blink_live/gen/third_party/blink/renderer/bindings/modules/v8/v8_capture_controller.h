...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CAPTURE_CONTROLLER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CAPTURE_CONTROLLER_H_
...
class MODULES_EXPORT V8CaptureController final : public bindings::V8InterfaceBridge<V8CaptureController, CaptureController> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(536);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CAPTURE_CONTROLLER_H_
