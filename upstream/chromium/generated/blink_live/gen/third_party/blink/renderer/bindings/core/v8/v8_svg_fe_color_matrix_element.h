...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_COLOR_MATRIX_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_COLOR_MATRIX_ELEMENT_H_
...
class CORE_EXPORT V8SVGFEColorMatrixElement final : public bindings::V8InterfaceBridge<V8SVGFEColorMatrixElement, SVGFEColorMatrixElement> {
...
class Constant final {
  ...
  public:
static constexpr uint16_t kSVGFecolormatrixTypeUnknown = 0;
static constexpr uint16_t kSVGFecolormatrixTypeMatrix = 1;
static constexpr uint16_t kSVGFecolormatrixTypeSaturate = 2;
static constexpr uint16_t kSVGFecolormatrixTypeHuerotate = 3;
static constexpr uint16_t kSVGFecolormatrixTypeLuminancetoalpha = 4;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(690);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGFEColorMatrixElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_COLOR_MATRIX_ELEMENT_H_
