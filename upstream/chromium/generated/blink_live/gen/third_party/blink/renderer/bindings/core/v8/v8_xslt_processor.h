...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_XSLT_PROCESSOR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_XSLT_PROCESSOR_H_
...
class CORE_EXPORT V8XSLTProcessor final : public bindings::V8InterfaceBridge<V8XSLTProcessor, XSLTProcessor> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1049);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_XSLT_PROCESSOR_H_
