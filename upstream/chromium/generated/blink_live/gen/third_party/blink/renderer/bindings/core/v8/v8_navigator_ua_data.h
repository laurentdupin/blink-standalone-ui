...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NAVIGATOR_UA_DATA_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NAVIGATOR_UA_DATA_H_
...
class CORE_EXPORT V8NavigatorUAData final : public bindings::V8InterfaceBridge<V8NavigatorUAData, NavigatorUAData> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(862);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class NavigatorUAData;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NAVIGATOR_UA_DATA_H_
