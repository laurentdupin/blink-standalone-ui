...
bool V8GeolocationPositionError::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8GeolocationPositionError::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8GeolocationPositionError::InstallInterfaceTemplate,
    nullptr,
    "GeolocationPositionError",
    nullptr,
    V8GeolocationPositionError::kThisTag,
    V8GeolocationPositionError::kMaxSubclassTag,
...
const WrapperTypeInfo& GeolocationPositionError::wrapper_type_info_ =
    V8GeolocationPositionError::wrapper_type_info_;
...
namespace v8_geolocation_position_error {
...
BLINK_BINDINGS_TRACE_EVENT("GeolocationPositionError.code.get");
...
BLINK_BINDINGS_TRACE_EVENT("GeolocationPositionError.message.get");
...
using namespace v8_geolocation_position_error;

}  // namespace 

void V8GeolocationPositionError::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8GeolocationPositionError::GetWrapperTypeInfo();
...
void V8GeolocationPositionError::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "GeolocationPositionError", kAttributeTable);
}
...
{"PERMISSION_DENIED", V8GeolocationPositionError::Constant::kPermissionDenied},
{"POSITION_UNAVAILABLE", V8GeolocationPositionError::Constant::kPositionUnavailable},
{"TIMEOUT", V8GeolocationPositionError::Constant::kTimeout},
};
