...
const WrapperTypeInfo V8FetchLaterResult::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8FetchLaterResult::InstallInterfaceTemplate,
    nullptr,
    "FetchLaterResult",
    nullptr,
    V8FetchLaterResult::kThisTag,
    V8FetchLaterResult::kMaxSubclassTag,
...
const WrapperTypeInfo& FetchLaterResult::wrapper_type_info_ =
    V8FetchLaterResult::wrapper_type_info_;
...
namespace v8_fetch_later_result {


void ActivatedAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_FetchLaterResult_activated_Getter");
BLINK_BINDINGS_TRACE_EVENT("FetchLaterResult.activated.get");
v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Context> current_context = isolate->GetCurrentContext();
ScriptState* current_script_state = ScriptState::From(isolate, current_context);
ExecutionContext* current_execution_context = ToExecutionContext(current_script_state);
// [Measure], [MeasureAs]
UseCounter::Count(current_execution_context, WebFeature::kV8FetchLaterResult_Activated_AttributeGetter);
...
using namespace v8_fetch_later_result;

}  // namespace 

void V8FetchLaterResult::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8FetchLaterResult::GetWrapperTypeInfo();
...
void V8FetchLaterResult::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "FetchLaterResult", kAttributeTable);
}
