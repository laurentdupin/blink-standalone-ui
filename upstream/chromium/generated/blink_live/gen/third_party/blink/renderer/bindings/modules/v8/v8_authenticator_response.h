...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_AUTHENTICATOR_RESPONSE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_AUTHENTICATOR_RESPONSE_H_
...
class MODULES_EXPORT V8AuthenticatorResponse final : public bindings::V8InterfaceBridge<V8AuthenticatorResponse, AuthenticatorResponse> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1119);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class AuthenticatorResponse;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_AUTHENTICATOR_RESPONSE_H_
