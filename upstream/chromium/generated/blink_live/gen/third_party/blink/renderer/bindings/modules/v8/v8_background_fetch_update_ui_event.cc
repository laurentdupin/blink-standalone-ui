...
static_assert(std::derived_from<BackgroundFetchUpdateUIEvent, BackgroundFetchEvent>);
...
const WrapperTypeInfo& BackgroundFetchUpdateUIEvent::wrapper_type_info_ =
    V8BackgroundFetchUpdateUIEvent::wrapper_type_info_;
...
static_assert(bindings::IsReturnTypeCompatible<BackgroundFetchUpdateUIEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
void V8BackgroundFetchUpdateUIEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "BackgroundFetchUpdateUIEvent", kAttributeTable);
}
...
{"updateUI", UpdateUIOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kDoNotCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
};
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "BackgroundFetchUpdateUIEvent", kOperationTable);
}
