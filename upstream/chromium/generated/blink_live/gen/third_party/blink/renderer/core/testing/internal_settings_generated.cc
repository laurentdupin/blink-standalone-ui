...
InternalSettingsGenerated::InternalSettingsGenerated(Page& page)
  ...
  backup_.SetDOMPasteAllowed(
      GetSettings().GetDOMPasteAllowed());
  backup_.SetDontSendKeyEventsToJavascript(
      GetSettings().GetDontSendKeyEventsToJavascript());
  backup_.SetHighlightAds(
      GetSettings().GetHighlightAds());
  backup_.SetInspectorHighlightAds(
      GetSettings().GetInspectorHighlightAds());
  backup_.SetLCDTextPreference(
      GetSettings().GetLCDTextPreference());
  backup_.SetNetworkQuietTimeout(
      GetSettings().GetNetworkQuietTimeout());
  backup_.SetWebXRImmersiveArAllowed(
      GetSettings().GetWebXRImmersiveArAllowed());
  backup_.SetAccelerated2dCanvasMSAASampleCount(
      GetSettings().GetAccelerated2dCanvasMSAASampleCount());
  backup_.SetAcceleratedCompositingEnabled(
      GetSettings().GetAcceleratedCompositingEnabled());
  backup_.SetAcceptLanguages(
      GetSettings().GetAcceptLanguages());
  backup_.SetAccessibilityAlwaysShowFocus(
      GetSettings().GetAccessibilityAlwaysShowFocus());
  backup_.SetAccessibilityFontScaleFactor(
      GetSettings().GetAccessibilityFontScaleFactor());
  backup_.SetAccessibilityFontWeightAdjustment(
      GetSettings().GetAccessibilityFontWeightAdjustment());
  backup_.SetAccessibilityIncludeSvgGElement(
      GetSettings().GetAccessibilityIncludeSvgGElement());
  backup_.SetAccessibilityPasswordValuesEnabled(
      GetSettings().GetAccessibilityPasswordValuesEnabled());
  backup_.SetAccessibilityTextSizeContrastFactor(
      GetSettings().GetAccessibilityTextSizeContrastFactor());
  backup_.SetAllowCustomScrollbarInMainFrame(
      GetSettings().GetAllowCustomScrollbarInMainFrame());
  backup_.SetAllowFileAccessFromFileURLs(
      GetSettings().GetAllowFileAccessFromFileURLs());
  backup_.SetAllowGeolocationOnInsecureOrigins(
      GetSettings().GetAllowGeolocationOnInsecureOrigins());
  backup_.SetAllowRunningOfInsecureContent(
      GetSettings().GetAllowRunningOfInsecureContent());
  backup_.SetAllowScriptsToCloseWindows(
      GetSettings().GetAllowScriptsToCloseWindows());
  backup_.SetAllowUniversalAccessFromFileURLs(
      GetSettings().GetAllowUniversalAccessFromFileURLs());
  backup_.SetAllowUnrestrictedWindowFocus(
      GetSettings().GetAllowUnrestrictedWindowFocus());
  backup_.SetAlwaysShowContextMenuOnTouch(
      GetSettings().GetAlwaysShowContextMenuOnTouch());
  backup_.SetAntialiased2dCanvasEnabled(
      GetSettings().GetAntialiased2dCanvasEnabled());
  backup_.SetAntialiasedClips2dCanvasEnabled(
      GetSettings().GetAntialiasedClips2dCanvasEnabled());
  backup_.SetAriaModalPrunesAXTree(
      GetSettings().GetAriaModalPrunesAXTree());
  backup_.SetAutoplayPolicy(
      GetSettings().GetAutoplayPolicy());
  backup_.SetAvailableHoverTypes(
      GetSettings().GetAvailableHoverTypes());
  backup_.SetAvailablePointerTypes(
      GetSettings().GetAvailablePointerTypes());
  backup_.SetBarrelButtonForDragEnabled(
      GetSettings().GetBarrelButtonForDragEnabled());
  backup_.SetBypassCSP(
      GetSettings().GetBypassCSP());
  backup_.SetCaretBrowsingEnabled(
      GetSettings().GetCaretBrowsingEnabled());
  backup_.SetCookieEnabled(
      GetSettings().GetCookieEnabled());
  backup_.SetDefaultFixedFontSize(
      GetSettings().GetDefaultFixedFontSize());
  backup_.SetDefaultFontSize(
      GetSettings().GetDefaultFontSize());
  backup_.SetDefaultTextEncodingName(
      GetSettings().GetDefaultTextEncodingName());
  backup_.SetDefaultVideoPosterURL(
      GetSettings().GetDefaultVideoPosterURL());
  backup_.SetDisableReadingFromCanvas(
      GetSettings().GetDisableReadingFromCanvas());
  backup_.SetDisallowFetchForDocWrittenScriptsInMainFrame(
      GetSettings().GetDisallowFetchForDocWrittenScriptsInMainFrame());
  backup_.SetDisallowFetchForDocWrittenScriptsInMainFrameIfEffectively2G(
      GetSettings().GetDisallowFetchForDocWrittenScriptsInMainFrameIfEffectively2G());
  backup_.SetDisallowFetchForDocWrittenScriptsInMainFrameOnSlowConnections(
      GetSettings().GetDisallowFetchForDocWrittenScriptsInMainFrameOnSlowConnections());
  backup_.SetDisplayModeOverride(
      GetSettings().GetDisplayModeOverride());
  backup_.SetDNSPrefetchingEnabled(
      GetSettings().GetDNSPrefetchingEnabled());
  backup_.SetDoHtmlPreloadScanning(
      GetSettings().GetDoHtmlPreloadScanning());
  backup_.SetDoNotUpdateSelectionOnMutatingSelectionRange(
      GetSettings().GetDoNotUpdateSelectionOnMutatingSelectionRange());
  backup_.SetDownloadableBinaryFontsEnabled(
      GetSettings().GetDownloadableBinaryFontsEnabled());
  backup_.SetDynamicSafeAreaInsetsEnabled(
      GetSettings().GetDynamicSafeAreaInsetsEnabled());
  backup_.SetEditingBehaviorType(
      GetSettings().GetEditingBehaviorType());
  backup_.SetEmbeddedMediaExperienceEnabled(
      GetSettings().GetEmbeddedMediaExperienceEnabled());
  backup_.SetForceAndroidOverlayScrollbar(
      GetSettings().GetForceAndroidOverlayScrollbar());
  backup_.SetForceDarkModeEnabled(
      GetSettings().GetForceDarkModeEnabled());
  backup_.SetForceMainWorldInitialization(
      GetSettings().GetForceMainWorldInitialization());
  backup_.SetForceTouchEventFeatureDetectionForInspector(
      GetSettings().GetForceTouchEventFeatureDetectionForInspector());
  backup_.SetForceZeroLayoutHeight(
      GetSettings().GetForceZeroLayoutHeight());
  backup_.SetFullscreenSupported(
      GetSettings().GetFullscreenSupported());
  backup_.SetHideDownloadUI(
      GetSettings().GetHideDownloadUI());
  backup_.SetHideScrollbars(
      GetSettings().GetHideScrollbars());
  backup_.SetHyperlinkAuditingEnabled(
      GetSettings().GetHyperlinkAuditingEnabled());
  backup_.SetIgnoreMainFrameOverflowHiddenQuirk(
      GetSettings().GetIgnoreMainFrameOverflowHiddenQuirk());
  backup_.SetIgnorePermissionForDeviceChangedEvent(
      GetSettings().GetIgnorePermissionForDeviceChangedEvent());
  backup_.SetImageAnimationPolicy(
      GetSettings().GetImageAnimationPolicy());
  backup_.SetImagesEnabled(
      GetSettings().GetImagesEnabled());
  backup_.SetImmersiveModeEnabled(
      GetSettings().GetImmersiveModeEnabled());
  backup_.SetImmersiveVideoPlaybackEnabled(
      GetSettings().GetImmersiveVideoPlaybackEnabled());
  backup_.SetInForcedColors(
      GetSettings().GetInForcedColors());
  backup_.SetInvertedColors(
      GetSettings().GetInvertedColors());
  backup_.SetIsForcedColorsDisabled(
      GetSettings().GetIsForcedColorsDisabled());
  backup_.SetIsInitialProfile(
      GetSettings().GetIsInitialProfile());
  ...
  backup_.SetLocalStorageEnabled(
      GetSettings().GetLocalStorageEnabled());
  backup_.SetLogDnsPrefetchAndPreconnect(
      GetSettings().GetLogDnsPrefetchAndPreconnect());
  backup_.SetLogPreload(
      GetSettings().GetLogPreload());
  backup_.SetLowPriorityIframesThreshold(
      GetSettings().GetLowPriorityIframesThreshold());
  backup_.SetMainFrameClipsContent(
      GetSettings().GetMainFrameClipsContent());
  backup_.SetMainFrameResizesAreOrientationChanges(
      GetSettings().GetMainFrameResizesAreOrientationChanges());
  backup_.SetMaxTouchPoints(
      GetSettings().GetMaxTouchPoints());
  backup_.SetMediaControlsEnabled(
      GetSettings().GetMediaControlsEnabled());
  backup_.SetMediaTypeOverride(
      GetSettings().GetMediaTypeOverride());
  backup_.SetMiddleClickPasteAllowed(
      GetSettings().GetMiddleClickPasteAllowed());
  backup_.SetMinimumFontSize(
      GetSettings().GetMinimumFontSize());
  backup_.SetMinimumLogicalFontSize(
      GetSettings().GetMinimumLogicalFontSize());
  backup_.SetMockGestureTapHighlightsEnabled(
      GetSettings().GetMockGestureTapHighlightsEnabled());
  backup_.SetModalContextMenu(
      GetSettings().GetModalContextMenu());
  backup_.SetMultiTargetTapNotificationEnabled(
      GetSettings().GetMultiTargetTapNotificationEnabled());
  backup_.SetNavigateOnDragDrop(
      GetSettings().GetNavigateOnDragDrop());
  backup_.SetNavigationControls(
      GetSettings().GetNavigationControls());
  backup_.SetNavigatorPlatformOverride(
      GetSettings().GetNavigatorPlatformOverride());
  backup_.SetOutputDeviceUpdateAbilityType(
      GetSettings().GetOutputDeviceUpdateAbilityType());
  backup_.SetParserScriptingFlagPolicy(
      GetSettings().GetParserScriptingFlagPolicy());
  backup_.SetPasswordEchoDurationInSeconds(
      GetSettings().GetPasswordEchoDurationInSeconds());
  backup_.SetPasswordEchoEnabledPhysical(
      GetSettings().GetPasswordEchoEnabledPhysical());
  backup_.SetPasswordEchoEnabledTouch(
      GetSettings().GetPasswordEchoEnabledTouch());
  backup_.SetPictureInPictureEnabled(
      GetSettings().GetPictureInPictureEnabled());
  backup_.SetPlaceRTLScrollbarsOnLeftSideInMainFrame(
      GetSettings().GetPlaceRTLScrollbarsOnLeftSideInMainFrame());
  backup_.SetPluginsEnabled(
      GetSettings().GetPluginsEnabled());
  backup_.SetPreferHiddenVolumeControls(
      GetSettings().GetPreferHiddenVolumeControls());
  backup_.SetPreferredColorScheme(
      GetSettings().GetPreferredColorScheme());
  backup_.SetPreferredContrast(
      GetSettings().GetPreferredContrast());
  backup_.SetPreferredRootScrollbarColorScheme(
      GetSettings().GetPreferredRootScrollbarColorScheme());
  ...
  backup_.SetPresentationReceiver(
      GetSettings().GetPresentationReceiver());
  backup_.SetPresentationRequiresUserGesture(
      GetSettings().GetPresentationRequiresUserGesture());
  backup_.SetPrimaryHoverType(
      GetSettings().GetPrimaryHoverType());
  backup_.SetPrimaryPointerType(
      GetSettings().GetPrimaryPointerType());
  backup_.SetPrintingMaximumShrinkFactor(
      GetSettings().GetPrintingMaximumShrinkFactor());
  backup_.SetReportScreenSizeInPhysicalPixelsQuirk(
      GetSettings().GetReportScreenSizeInPhysicalPixelsQuirk());
  backup_.SetRequireTransientActivationAndAuthorizationForSubAppsAPI(
      GetSettings().GetRequireTransientActivationAndAuthorizationForSubAppsAPI());
  ...
  backup_.SetResizable(
      GetSettings().GetResizable());
  backup_.SetRootScrollbarThemeColor(
      GetSettings().GetRootScrollbarThemeColor());
  backup_.SetRubberBandingOnCompositorThread(
      GetSettings().GetRubberBandingOnCompositorThread());
  backup_.SetScaleAllFontsIfNoMetaTextScaleTag(
      GetSettings().GetScaleAllFontsIfNoMetaTextScaleTag());
  backup_.SetScriptEnabled(
      GetSettings().GetScriptEnabled());
  backup_.SetScrollAnimatorEnabled(
      GetSettings().GetScrollAnimatorEnabled());
  backup_.SetSelectTrailingWhitespaceEnabled(
      GetSettings().GetSelectTrailingWhitespaceEnabled());
  backup_.SetSelectionClipboardBufferAvailable(
      GetSettings().GetSelectionClipboardBufferAvailable());
  backup_.SetSelectionIncludesAltImageText(
      GetSettings().GetSelectionIncludesAltImageText());
  backup_.SetSelectionStrategy(
      GetSettings().GetSelectionStrategy());
  backup_.SetShouldClearDocumentBackground(
      GetSettings().GetShouldClearDocumentBackground());
  backup_.SetShouldPrintBackgrounds(
      GetSettings().GetShouldPrintBackgrounds());
  backup_.SetShouldProtectAgainstIpcFlooding(
      GetSettings().GetShouldProtectAgainstIpcFlooding());
  backup_.SetShouldReuseGlobalForUnownedMainFrame(
      GetSettings().GetShouldReuseGlobalForUnownedMainFrame());
  backup_.SetShowContextMenuOnMouseUp(
      GetSettings().GetShowContextMenuOnMouseUp());
  backup_.SetShrinksViewportContentToFit(
      GetSettings().GetShrinksViewportContentToFit());
  backup_.SetSmartInsertDeleteEnabled(
      GetSettings().GetSmartInsertDeleteEnabled());
  backup_.SetSmoothScrollForFindEnabled(
      GetSettings().GetSmoothScrollForFindEnabled());
  backup_.SetSpatialNavigationEnabled(
      GetSettings().GetSpatialNavigationEnabled());
  backup_.SetSpellCheckEnabledByDefault(
      GetSettings().GetSpellCheckEnabledByDefault());
  backup_.SetStrictMixedContentChecking(
      GetSettings().GetStrictMixedContentChecking());
  backup_.SetStrictMixedContentCheckingForPlugin(
      GetSettings().GetStrictMixedContentCheckingForPlugin());
  backup_.SetStrictPowerfulFeatureRestrictions(
      GetSettings().GetStrictPowerfulFeatureRestrictions());
  backup_.SetStrictlyBlockBlockableMixedContent(
      GetSettings().GetStrictlyBlockBlockableMixedContent());
  backup_.SetSupportsMultipleWindows(
      GetSettings().GetSupportsMultipleWindows());
  backup_.SetSyncXHRInDocumentsEnabled(
      GetSettings().GetSyncXHRInDocumentsEnabled());
  backup_.SetTargetBlankImpliesNoOpenerEnabledWillBeRemoved(
      GetSettings().GetTargetBlankImpliesNoOpenerEnabledWillBeRemoved());
  backup_.SetTextAreasAreResizable(
      GetSettings().GetTextAreasAreResizable());
  backup_.SetTextSizeAdjustEnabled(
      GetSettings().GetTextSizeAdjustEnabled());
  backup_.SetTextTrackBackgroundColor(
      GetSettings().GetTextTrackBackgroundColor());
  backup_.SetTextTrackFontFamily(
      GetSettings().GetTextTrackFontFamily());
  backup_.SetTextTrackFontStyle(
      GetSettings().GetTextTrackFontStyle());
  backup_.SetTextTrackFontVariant(
      GetSettings().GetTextTrackFontVariant());
  backup_.SetTextTrackKindUserPreference(
      GetSettings().GetTextTrackKindUserPreference());
  backup_.SetTextTrackMarginPercentage(
      GetSettings().GetTextTrackMarginPercentage());
  backup_.SetTextTrackTextColor(
      GetSettings().GetTextTrackTextColor());
  backup_.SetTextTrackTextShadow(
      GetSettings().GetTextTrackTextShadow());
  backup_.SetTextTrackTextSize(
      GetSettings().GetTextTrackTextSize());
  backup_.SetTextTrackWindowColor(
      GetSettings().GetTextTrackWindowColor());
  backup_.SetTextTrackWindowRadius(
      GetSettings().GetTextTrackWindowRadius());
  backup_.SetTouchDragDropEnabled(
      GetSettings().GetTouchDragDropEnabled());
  backup_.SetTouchDragEndContextMenu(
      GetSettings().GetTouchDragEndContextMenu());
  backup_.SetTouchEditingEnabled(
  ...
  backup_.SetV8CacheOptions(
      GetSettings().GetV8CacheOptions());
  backup_.SetValidationMessageTimerMagnification(
      GetSettings().GetValidationMessageTimerMagnification());
  backup_.SetViewportEnabled(
      GetSettings().GetViewportEnabled());
  backup_.SetViewportMetaEnabled(
      GetSettings().GetViewportMetaEnabled());
  backup_.SetViewportMetaMergeContentQuirk(
      GetSettings().GetViewportMetaMergeContentQuirk());
  backup_.SetViewportMetaZeroValuesQuirk(
      GetSettings().GetViewportMetaZeroValuesQuirk());
  backup_.SetViewportStyle(
      GetSettings().GetViewportStyle());
  backup_.SetWebAppScope(
      GetSettings().GetWebAppScope());
  backup_.SetWebGL1Enabled(
      GetSettings().GetWebGL1Enabled());
  backup_.SetWebGL2Enabled(
      GetSettings().GetWebGL2Enabled());
  backup_.SetWebGLErrorsToConsoleEnabled(
      GetSettings().GetWebGLErrorsToConsoleEnabled());
  backup_.SetWebSecurityEnabled(
      GetSettings().GetWebSecurityEnabled());
  backup_.SetWideViewportQuirkEnabled(
      GetSettings().GetWideViewportQuirkEnabled());
  backup_.SetWindowShowState(
      GetSettings().GetWindowShowState());
}

InternalSettingsGenerated::~InternalSettingsGenerated() {}

void InternalSettingsGenerated::ResetToConsistentState() {
  GetSettings().SetDOMPasteAllowed(
      backup_.GetDOMPasteAllowed());
  GetSettings().SetDontSendKeyEventsToJavascript(
      backup_.GetDontSendKeyEventsToJavascript());
  GetSettings().SetHighlightAds(
      backup_.GetHighlightAds());
  GetSettings().SetInspectorHighlightAds(
      backup_.GetInspectorHighlightAds());
  GetSettings().SetLCDTextPreference(
      backup_.GetLCDTextPreference());
  GetSettings().SetNetworkQuietTimeout(
      backup_.GetNetworkQuietTimeout());
  GetSettings().SetWebXRImmersiveArAllowed(
      backup_.GetWebXRImmersiveArAllowed());
  GetSettings().SetAccelerated2dCanvasMSAASampleCount(
      backup_.GetAccelerated2dCanvasMSAASampleCount());
  GetSettings().SetAcceleratedCompositingEnabled(
      backup_.GetAcceleratedCompositingEnabled());
  GetSettings().SetAcceptLanguages(
      backup_.GetAcceptLanguages());
  GetSettings().SetAccessibilityAlwaysShowFocus(
      backup_.GetAccessibilityAlwaysShowFocus());
  GetSettings().SetAccessibilityFontScaleFactor(
      backup_.GetAccessibilityFontScaleFactor());
  GetSettings().SetAccessibilityFontWeightAdjustment(
      backup_.GetAccessibilityFontWeightAdjustment());
  GetSettings().SetAccessibilityIncludeSvgGElement(
      backup_.GetAccessibilityIncludeSvgGElement());
  GetSettings().SetAccessibilityPasswordValuesEnabled(
      backup_.GetAccessibilityPasswordValuesEnabled());
  GetSettings().SetAccessibilityTextSizeContrastFactor(
      backup_.GetAccessibilityTextSizeContrastFactor());
  GetSettings().SetAllowCustomScrollbarInMainFrame(
      backup_.GetAllowCustomScrollbarInMainFrame());
  GetSettings().SetAllowFileAccessFromFileURLs(
      backup_.GetAllowFileAccessFromFileURLs());
  GetSettings().SetAllowGeolocationOnInsecureOrigins(
      backup_.GetAllowGeolocationOnInsecureOrigins());
  GetSettings().SetAllowRunningOfInsecureContent(
      backup_.GetAllowRunningOfInsecureContent());
  GetSettings().SetAllowScriptsToCloseWindows(
      backup_.GetAllowScriptsToCloseWindows());
  GetSettings().SetAllowUniversalAccessFromFileURLs(
      backup_.GetAllowUniversalAccessFromFileURLs());
  GetSettings().SetAllowUnrestrictedWindowFocus(
      backup_.GetAllowUnrestrictedWindowFocus());
  GetSettings().SetAlwaysShowContextMenuOnTouch(
      backup_.GetAlwaysShowContextMenuOnTouch());
  GetSettings().SetAntialiased2dCanvasEnabled(
      backup_.GetAntialiased2dCanvasEnabled());
  GetSettings().SetAntialiasedClips2dCanvasEnabled(
      backup_.GetAntialiasedClips2dCanvasEnabled());
  GetSettings().SetAriaModalPrunesAXTree(
      backup_.GetAriaModalPrunesAXTree());
  GetSettings().SetAutoplayPolicy(
      backup_.GetAutoplayPolicy());
  GetSettings().SetAvailableHoverTypes(
      backup_.GetAvailableHoverTypes());
  GetSettings().SetAvailablePointerTypes(
      backup_.GetAvailablePointerTypes());
  GetSettings().SetBarrelButtonForDragEnabled(
      backup_.GetBarrelButtonForDragEnabled());
  GetSettings().SetBypassCSP(
      backup_.GetBypassCSP());
  GetSettings().SetCaretBrowsingEnabled(
      backup_.GetCaretBrowsingEnabled());
  GetSettings().SetCookieEnabled(
      backup_.GetCookieEnabled());
  GetSettings().SetDefaultFixedFontSize(
      backup_.GetDefaultFixedFontSize());
  GetSettings().SetDefaultFontSize(
      backup_.GetDefaultFontSize());
  GetSettings().SetDefaultTextEncodingName(
      backup_.GetDefaultTextEncodingName());
  GetSettings().SetDefaultVideoPosterURL(
      backup_.GetDefaultVideoPosterURL());
  GetSettings().SetDisableReadingFromCanvas(
      backup_.GetDisableReadingFromCanvas());
  GetSettings().SetDisallowFetchForDocWrittenScriptsInMainFrame(
      backup_.GetDisallowFetchForDocWrittenScriptsInMainFrame());
  GetSettings().SetDisallowFetchForDocWrittenScriptsInMainFrameIfEffectively2G(
      backup_.GetDisallowFetchForDocWrittenScriptsInMainFrameIfEffectively2G());
  GetSettings().SetDisallowFetchForDocWrittenScriptsInMainFrameOnSlowConnections(
      backup_.GetDisallowFetchForDocWrittenScriptsInMainFrameOnSlowConnections());
  GetSettings().SetDisplayModeOverride(
      backup_.GetDisplayModeOverride());
  GetSettings().SetDNSPrefetchingEnabled(
      backup_.GetDNSPrefetchingEnabled());
  GetSettings().SetDoHtmlPreloadScanning(
      backup_.GetDoHtmlPreloadScanning());
  GetSettings().SetDoNotUpdateSelectionOnMutatingSelectionRange(
      backup_.GetDoNotUpdateSelectionOnMutatingSelectionRange());
  GetSettings().SetDownloadableBinaryFontsEnabled(
      backup_.GetDownloadableBinaryFontsEnabled());
  GetSettings().SetDynamicSafeAreaInsetsEnabled(
      backup_.GetDynamicSafeAreaInsetsEnabled());
  GetSettings().SetEditingBehaviorType(
      backup_.GetEditingBehaviorType());
  GetSettings().SetEmbeddedMediaExperienceEnabled(
      backup_.GetEmbeddedMediaExperienceEnabled());
  GetSettings().SetForceAndroidOverlayScrollbar(
      backup_.GetForceAndroidOverlayScrollbar());
  GetSettings().SetForceDarkModeEnabled(
      backup_.GetForceDarkModeEnabled());
  GetSettings().SetForceMainWorldInitialization(
      backup_.GetForceMainWorldInitialization());
  GetSettings().SetForceTouchEventFeatureDetectionForInspector(
      backup_.GetForceTouchEventFeatureDetectionForInspector());
  GetSettings().SetForceZeroLayoutHeight(
      backup_.GetForceZeroLayoutHeight());
  GetSettings().SetFullscreenSupported(
      backup_.GetFullscreenSupported());
  GetSettings().SetHideDownloadUI(
      backup_.GetHideDownloadUI());
  GetSettings().SetHideScrollbars(
      backup_.GetHideScrollbars());
  GetSettings().SetHyperlinkAuditingEnabled(
      backup_.GetHyperlinkAuditingEnabled());
  GetSettings().SetIgnoreMainFrameOverflowHiddenQuirk(
      backup_.GetIgnoreMainFrameOverflowHiddenQuirk());
  GetSettings().SetIgnorePermissionForDeviceChangedEvent(
      backup_.GetIgnorePermissionForDeviceChangedEvent());
  GetSettings().SetImageAnimationPolicy(
      backup_.GetImageAnimationPolicy());
  GetSettings().SetImagesEnabled(
      backup_.GetImagesEnabled());
  GetSettings().SetImmersiveModeEnabled(
      backup_.GetImmersiveModeEnabled());
  GetSettings().SetImmersiveVideoPlaybackEnabled(
      backup_.GetImmersiveVideoPlaybackEnabled());
  GetSettings().SetInForcedColors(
      backup_.GetInForcedColors());
  GetSettings().SetInvertedColors(
      backup_.GetInvertedColors());
  GetSettings().SetIsForcedColorsDisabled(
      backup_.GetIsForcedColorsDisabled());
  GetSettings().SetIsInitialProfile(
      backup_.GetIsInitialProfile());
  ...
  GetSettings().SetLoadsImagesAutomatically(
      backup_.GetLoadsImagesAutomatically());
  GetSettings().SetLocalStorageEnabled(
      backup_.GetLocalStorageEnabled());
  GetSettings().SetLogDnsPrefetchAndPreconnect(
      backup_.GetLogDnsPrefetchAndPreconnect());
  GetSettings().SetLogPreload(
      backup_.GetLogPreload());
  GetSettings().SetLowPriorityIframesThreshold(
      backup_.GetLowPriorityIframesThreshold());
  GetSettings().SetMainFrameClipsContent(
      backup_.GetMainFrameClipsContent());
  GetSettings().SetMainFrameResizesAreOrientationChanges(
      backup_.GetMainFrameResizesAreOrientationChanges());
  GetSettings().SetMaxTouchPoints(
      backup_.GetMaxTouchPoints());
  GetSettings().SetMediaControlsEnabled(
      backup_.GetMediaControlsEnabled());
  GetSettings().SetMediaTypeOverride(
      backup_.GetMediaTypeOverride());
  GetSettings().SetMiddleClickPasteAllowed(
      backup_.GetMiddleClickPasteAllowed());
  GetSettings().SetMinimumFontSize(
      backup_.GetMinimumFontSize());
  GetSettings().SetMinimumLogicalFontSize(
      backup_.GetMinimumLogicalFontSize());
  GetSettings().SetMockGestureTapHighlightsEnabled(
      backup_.GetMockGestureTapHighlightsEnabled());
  GetSettings().SetModalContextMenu(
      backup_.GetModalContextMenu());
  GetSettings().SetMultiTargetTapNotificationEnabled(
      backup_.GetMultiTargetTapNotificationEnabled());
  GetSettings().SetNavigateOnDragDrop(
      backup_.GetNavigateOnDragDrop());
  GetSettings().SetNavigationControls(
      backup_.GetNavigationControls());
  GetSettings().SetNavigatorPlatformOverride(
      backup_.GetNavigatorPlatformOverride());
  GetSettings().SetOutputDeviceUpdateAbilityType(
      backup_.GetOutputDeviceUpdateAbilityType());
  GetSettings().SetParserScriptingFlagPolicy(
      backup_.GetParserScriptingFlagPolicy());
  GetSettings().SetPasswordEchoDurationInSeconds(
      backup_.GetPasswordEchoDurationInSeconds());
  GetSettings().SetPasswordEchoEnabledPhysical(
      backup_.GetPasswordEchoEnabledPhysical());
  GetSettings().SetPasswordEchoEnabledTouch(
      backup_.GetPasswordEchoEnabledTouch());
  GetSettings().SetPictureInPictureEnabled(
      backup_.GetPictureInPictureEnabled());
  GetSettings().SetPlaceRTLScrollbarsOnLeftSideInMainFrame(
      backup_.GetPlaceRTLScrollbarsOnLeftSideInMainFrame());
  GetSettings().SetPluginsEnabled(
      backup_.GetPluginsEnabled());
  GetSettings().SetPreferHiddenVolumeControls(
      backup_.GetPreferHiddenVolumeControls());
  GetSettings().SetPreferredColorScheme(
      backup_.GetPreferredColorScheme());
  GetSettings().SetPreferredContrast(
      backup_.GetPreferredContrast());
  GetSettings().SetPreferredRootScrollbarColorScheme(
      backup_.GetPreferredRootScrollbarColorScheme());
  ...
  GetSettings().SetPrefersReducedTransparency(
      backup_.GetPrefersReducedTransparency());
  GetSettings().SetPresentationReceiver(
      backup_.GetPresentationReceiver());
  GetSettings().SetPresentationRequiresUserGesture(
      backup_.GetPresentationRequiresUserGesture());
  GetSettings().SetPrimaryHoverType(
      backup_.GetPrimaryHoverType());
  GetSettings().SetPrimaryPointerType(
      backup_.GetPrimaryPointerType());
  GetSettings().SetPrintingMaximumShrinkFactor(
      backup_.GetPrintingMaximumShrinkFactor());
  GetSettings().SetReportScreenSizeInPhysicalPixelsQuirk(
      backup_.GetReportScreenSizeInPhysicalPixelsQuirk());
  GetSettings().SetRequireTransientActivationAndAuthorizationForSubAppsAPI(
      backup_.GetRequireTransientActivationAndAuthorizationForSubAppsAPI());
  ...
  GetSettings().SetResizable(
      backup_.GetResizable());
  GetSettings().SetRootScrollbarThemeColor(
      backup_.GetRootScrollbarThemeColor());
  GetSettings().SetRubberBandingOnCompositorThread(
      backup_.GetRubberBandingOnCompositorThread());
  GetSettings().SetScaleAllFontsIfNoMetaTextScaleTag(
      backup_.GetScaleAllFontsIfNoMetaTextScaleTag());
  GetSettings().SetScriptEnabled(
      backup_.GetScriptEnabled());
  GetSettings().SetScrollAnimatorEnabled(
      backup_.GetScrollAnimatorEnabled());
  GetSettings().SetSelectTrailingWhitespaceEnabled(
      backup_.GetSelectTrailingWhitespaceEnabled());
  GetSettings().SetSelectionClipboardBufferAvailable(
      backup_.GetSelectionClipboardBufferAvailable());
  GetSettings().SetSelectionIncludesAltImageText(
      backup_.GetSelectionIncludesAltImageText());
  GetSettings().SetSelectionStrategy(
      backup_.GetSelectionStrategy());
  GetSettings().SetShouldClearDocumentBackground(
      backup_.GetShouldClearDocumentBackground());
  GetSettings().SetShouldPrintBackgrounds(
      backup_.GetShouldPrintBackgrounds());
  GetSettings().SetShouldProtectAgainstIpcFlooding(
      backup_.GetShouldProtectAgainstIpcFlooding());
  GetSettings().SetShouldReuseGlobalForUnownedMainFrame(
      backup_.GetShouldReuseGlobalForUnownedMainFrame());
  GetSettings().SetShowContextMenuOnMouseUp(
      backup_.GetShowContextMenuOnMouseUp());
  GetSettings().SetShrinksViewportContentToFit(
      backup_.GetShrinksViewportContentToFit());
  GetSettings().SetSmartInsertDeleteEnabled(
      backup_.GetSmartInsertDeleteEnabled());
  GetSettings().SetSmoothScrollForFindEnabled(
      backup_.GetSmoothScrollForFindEnabled());
  GetSettings().SetSpatialNavigationEnabled(
      backup_.GetSpatialNavigationEnabled());
  GetSettings().SetSpellCheckEnabledByDefault(
      backup_.GetSpellCheckEnabledByDefault());
  GetSettings().SetStrictMixedContentChecking(
      backup_.GetStrictMixedContentChecking());
  GetSettings().SetStrictMixedContentCheckingForPlugin(
      backup_.GetStrictMixedContentCheckingForPlugin());
  GetSettings().SetStrictPowerfulFeatureRestrictions(
      backup_.GetStrictPowerfulFeatureRestrictions());
  GetSettings().SetStrictlyBlockBlockableMixedContent(
      backup_.GetStrictlyBlockBlockableMixedContent());
  GetSettings().SetSupportsMultipleWindows(
      backup_.GetSupportsMultipleWindows());
  GetSettings().SetSyncXHRInDocumentsEnabled(
      backup_.GetSyncXHRInDocumentsEnabled());
  GetSettings().SetTargetBlankImpliesNoOpenerEnabledWillBeRemoved(
      backup_.GetTargetBlankImpliesNoOpenerEnabledWillBeRemoved());
  GetSettings().SetTextAreasAreResizable(
      backup_.GetTextAreasAreResizable());
  GetSettings().SetTextSizeAdjustEnabled(
      backup_.GetTextSizeAdjustEnabled());
  GetSettings().SetTextTrackBackgroundColor(
      backup_.GetTextTrackBackgroundColor());
  GetSettings().SetTextTrackFontFamily(
      backup_.GetTextTrackFontFamily());
  GetSettings().SetTextTrackFontStyle(
      backup_.GetTextTrackFontStyle());
  GetSettings().SetTextTrackFontVariant(
      backup_.GetTextTrackFontVariant());
  GetSettings().SetTextTrackKindUserPreference(
      backup_.GetTextTrackKindUserPreference());
  GetSettings().SetTextTrackMarginPercentage(
      backup_.GetTextTrackMarginPercentage());
  GetSettings().SetTextTrackTextColor(
      backup_.GetTextTrackTextColor());
  GetSettings().SetTextTrackTextShadow(
      backup_.GetTextTrackTextShadow());
  GetSettings().SetTextTrackTextSize(
      backup_.GetTextTrackTextSize());
  GetSettings().SetTextTrackWindowColor(
      backup_.GetTextTrackWindowColor());
  GetSettings().SetTextTrackWindowRadius(
      backup_.GetTextTrackWindowRadius());
  GetSettings().SetTouchDragDropEnabled(
      backup_.GetTouchDragDropEnabled());
  GetSettings().SetTouchDragEndContextMenu(
      backup_.GetTouchDragEndContextMenu());
  GetSettings().SetTouchEditingEnabled(
  ...
  GetSettings().SetV8CacheOptions(
      backup_.GetV8CacheOptions());
  GetSettings().SetValidationMessageTimerMagnification(
      backup_.GetValidationMessageTimerMagnification());
  GetSettings().SetViewportEnabled(
      backup_.GetViewportEnabled());
  GetSettings().SetViewportMetaEnabled(
      backup_.GetViewportMetaEnabled());
  GetSettings().SetViewportMetaMergeContentQuirk(
      backup_.GetViewportMetaMergeContentQuirk());
  GetSettings().SetViewportMetaZeroValuesQuirk(
      backup_.GetViewportMetaZeroValuesQuirk());
  GetSettings().SetViewportStyle(
      backup_.GetViewportStyle());
  GetSettings().SetWebAppScope(
      backup_.GetWebAppScope());
  GetSettings().SetWebGL1Enabled(
      backup_.GetWebGL1Enabled());
  GetSettings().SetWebGL2Enabled(
      backup_.GetWebGL2Enabled());
  GetSettings().SetWebGLErrorsToConsoleEnabled(
      backup_.GetWebGLErrorsToConsoleEnabled());
  GetSettings().SetWebSecurityEnabled(
      backup_.GetWebSecurityEnabled());
  GetSettings().SetWideViewportQuirkEnabled(
      backup_.GetWideViewportQuirkEnabled());
  GetSettings().SetWindowShowState(
      backup_.GetWindowShowState());
}
...
void InternalSettingsGenerated::setInspectorHighlightAds(
    bool InspectorHighlightAds) {
  GetSettings().SetInspectorHighlightAds(InspectorHighlightAds);
}
...
void InternalSettingsGenerated::setAcceptLanguages(
    const String& acceptLanguages) {
  GetSettings().SetAcceptLanguages(acceptLanguages);
}
...
void InternalSettingsGenerated::setAllowUnrestrictedWindowFocus(
    bool allowUnrestrictedWindowFocus) {
  GetSettings().SetAllowUnrestrictedWindowFocus(allowUnrestrictedWindowFocus);
}
...
void InternalSettingsGenerated::setDynamicSafeAreaInsetsEnabled(
...
void InternalSettingsGenerated::setIgnorePermissionForDeviceChangedEvent(
    bool ignorePermissionForDeviceChangedEvent) {
  GetSettings().SetIgnorePermissionForDeviceChangedEvent(ignorePermissionForDeviceChangedEvent);
}
...
void InternalSettingsGenerated::setImmersiveVideoPlaybackEnabled(
    bool immersiveVideoPlaybackEnabled) {
  GetSettings().SetImmersiveVideoPlaybackEnabled(immersiveVideoPlaybackEnabled);
}
...
void InternalSettingsGenerated::setIsInitialProfile(
    bool isInitialProfile) {
  GetSettings().SetIsInitialProfile(isInitialProfile);
}
...
void InternalSettingsGenerated::setMiddleClickPasteAllowed(
    bool middleClickPasteAllowed) {
  GetSettings().SetMiddleClickPasteAllowed(middleClickPasteAllowed);
}
...
void InternalSettingsGenerated::setPasswordEchoEnabledPhysical(
    bool passwordEchoEnabledPhysical) {
  GetSettings().SetPasswordEchoEnabledPhysical(passwordEchoEnabledPhysical);
}

void InternalSettingsGenerated::setPasswordEchoEnabledTouch(
    bool passwordEchoEnabledTouch) {
  GetSettings().SetPasswordEchoEnabledTouch(passwordEchoEnabledTouch);
}
...
void InternalSettingsGenerated::setScaleAllFontsIfNoMetaTextScaleTag(
    bool scaleAllFontsIfNoMetaTextScaleTag) {
  GetSettings().SetScaleAllFontsIfNoMetaTextScaleTag(scaleAllFontsIfNoMetaTextScaleTag);
}
...
void InternalSettingsGenerated::setTextSizeAdjustEnabled(
    bool textSizeAdjustEnabled) {
  GetSettings().SetTextSizeAdjustEnabled(textSizeAdjustEnabled);
}
