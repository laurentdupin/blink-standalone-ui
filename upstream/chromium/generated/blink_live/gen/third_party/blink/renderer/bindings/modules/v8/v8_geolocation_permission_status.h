...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GEOLOCATION_PERMISSION_STATUS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GEOLOCATION_PERMISSION_STATUS_H_
...
class MODULES_EXPORT V8GeolocationPermissionStatus final : public bindings::V8InterfaceBridge<V8GeolocationPermissionStatus, GeolocationPermissionStatus> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(753);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class GeolocationPermissionStatus;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GEOLOCATION_PERMISSION_STATUS_H_
