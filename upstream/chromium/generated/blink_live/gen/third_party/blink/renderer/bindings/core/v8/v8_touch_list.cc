...
bool V8TouchList::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8TouchList::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8TouchList::InstallInterfaceTemplate,
    nullptr,
    "TouchList",
    nullptr,
    V8TouchList::kThisTag,
    V8TouchList::kMaxSubclassTag,
...
const WrapperTypeInfo& TouchList::wrapper_type_info_ =
    V8TouchList::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, TouchList>::value,
    "TouchList inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

v8::Intercepted V8TouchList::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TouchList_IndexedPropertyGetter");
...
TouchList* blink_receiver = V8TouchList::ToWrappableUnsafe(isolate, v8_receiver);
...
static_assert(bindings::IsReturnTypeCompatible<IDLNullable<Touch>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
return v8::Intercepted::kYes;
}

v8::Intercepted V8TouchList::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TouchList_IndexedPropertySetter");
...
v8::Intercepted V8TouchList::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TouchList_IndexedPropertyDeleter");
...
v8::Intercepted V8TouchList::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TouchList_IndexedPropertyDefiner");
...
v8::Intercepted V8TouchList::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TouchList_IndexedPropertyDescriptor");
...
auto intercepted =
    V8TouchList::IndexedPropertyGetterCallback(index, info);
...
void V8TouchList::IndexedPropertyEnumeratorCallback(const v8::PropertyCallbackInfo<v8::Array>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TouchList_IndexedPropertyEnumerator");
...
namespace v8_touch_list {


void LengthAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TouchList_length_Getter");
BLINK_BINDINGS_TRACE_EVENT("TouchList.length.get");
...
void ItemOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TouchList_item");
BLINK_BINDINGS_TRACE_EVENT("TouchList.item");
...
using namespace v8_touch_list;

}  // namespace 

void V8TouchList::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8TouchList::GetWrapperTypeInfo();
...
instance_template->SetHandler(
    v8::IndexedPropertyHandlerConfiguration(
        V8TouchList::IndexedPropertyGetterCallback,
        V8TouchList::IndexedPropertySetterCallback,
        nullptr,  // query
        V8TouchList::IndexedPropertyDeleterCallback,
        V8TouchList::IndexedPropertyEnumeratorCallback,
        V8TouchList::IndexedPropertyDefinerCallback,
        V8TouchList::IndexedPropertyDescriptorCallback,
        nullptr,  // index_of
        v8::Local<v8::Value>(),
...
void V8TouchList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "TouchList", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "TouchList", kOperationTable);
}
