...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NAVIGATION_DEFER_PAGE_SWAP_CONTROLLER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NAVIGATION_DEFER_PAGE_SWAP_CONTROLLER_H_
...
class CORE_EXPORT V8NavigationDeferPageSwapController final : public bindings::V8InterfaceBridge<V8NavigationDeferPageSwapController, NavigationDeferPageSwapController> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(932);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class NavigationDeferPageSwapController;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NAVIGATION_DEFER_PAGE_SWAP_CONTROLLER_H_
