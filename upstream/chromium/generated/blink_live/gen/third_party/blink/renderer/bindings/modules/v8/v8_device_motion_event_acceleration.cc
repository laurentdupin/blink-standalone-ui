...
bool V8DeviceMotionEventAcceleration::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8DeviceMotionEventAcceleration::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8DeviceMotionEventAcceleration::InstallInterfaceTemplate,
    nullptr,
    "DeviceMotionEventAcceleration",
    nullptr,
    V8DeviceMotionEventAcceleration::kThisTag,
    V8DeviceMotionEventAcceleration::kMaxSubclassTag,
...
const WrapperTypeInfo& DeviceMotionEventAcceleration::wrapper_type_info_ =
    V8DeviceMotionEventAcceleration::wrapper_type_info_;
...
namespace v8_device_motion_event_acceleration {
...
BLINK_BINDINGS_TRACE_EVENT("DeviceMotionEventAcceleration.x.get");
...
BLINK_BINDINGS_TRACE_EVENT("DeviceMotionEventAcceleration.y.get");
...
BLINK_BINDINGS_TRACE_EVENT("DeviceMotionEventAcceleration.z.get");
...
using namespace v8_device_motion_event_acceleration;

}  // namespace 

void V8DeviceMotionEventAcceleration::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8DeviceMotionEventAcceleration::GetWrapperTypeInfo();
...
void V8DeviceMotionEventAcceleration::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "DeviceMotionEventAcceleration", kAttributeTable);
}
