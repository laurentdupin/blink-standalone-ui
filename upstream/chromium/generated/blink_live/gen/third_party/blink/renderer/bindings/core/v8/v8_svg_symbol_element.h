...
class CORE_EXPORT V8SVGSymbolElement final : public bindings::V8InterfaceBridge<V8SVGSymbolElement, SVGSymbolElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(730);
