...
using Ret = bindings::OptimizedReturnProxy<V8UnionClientOrMessagePortOrServiceWorker>;
v8::Local<v8::Value> ToV8(ScriptState* script_state) const;

static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, ServiceWorkerClient* value);
static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, MessagePort* value);
static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, ServiceWorker* value);
