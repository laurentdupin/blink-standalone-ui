...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SYNC_ITERATOR_EVENT_COUNTS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SYNC_ITERATOR_EVENT_COUNTS_H_
...
template <>
class CORE_EXPORT SyncIterator<EventCounts> final : public bindings::SyncIteratorBase {
  DEFINE_WRAPPERTYPEINFO();

  public:
using IDLKeyType = IDLString;
using IDLValueType = IDLUnsignedLongLong;
using KeyType = String;
using ValueType = uint64_t;

explicit  SyncIterator<EventCounts>(IterationSourceBase* source, Kind kind) : bindings::SyncIteratorBase(source, kind) {
...
class CORE_EXPORT V8SyncIteratorEventCounts final : public bindings::V8InterfaceBridge<V8SyncIteratorEventCounts, SyncIterator<EventCounts>> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1492);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SyncIterator<EventCounts>;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SYNC_ITERATOR_EVENT_COUNTS_H_
