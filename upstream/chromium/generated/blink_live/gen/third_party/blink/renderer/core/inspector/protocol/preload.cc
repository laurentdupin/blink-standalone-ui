...
const char PrerenderUntilScript[] = "PrerenderUntilScript";
} // namespace SpeculationActionEnum
...
const char FormSubmitWhenPrerendering[] = "FormSubmitWhenPrerendering";
const char CrossDocumentRestart[] = "CrossDocumentRestart";
} // namespace PrerenderFinalStatusEnum
...
const char PrefetchNotEligibleBlockedByConnectionAllowlist[] = "PrefetchNotEligibleBlockedByConnectionAllowlist";
...
const char PrefetchCancelledOnUserNavigation[] = "PrefetchCancelledOnUserNavigation";
} // namespace PrefetchStatusEnum
