...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_XML_HTTP_REQUEST_EVENT_TARGET_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_XML_HTTP_REQUEST_EVENT_TARGET_H_
...
class CORE_EXPORT V8XMLHttpRequestEventTarget final : public bindings::V8InterfaceBridge<V8XMLHttpRequestEventTarget, XMLHttpRequestEventTarget> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(815);
  static constexpr v8::CppHeapPointerTag kMaxSubclassTag =
      static_cast<v8::CppHeapPointerTag>(817);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XMLHttpRequestEventTarget;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_XML_HTTP_REQUEST_EVENT_TARGET_H_
