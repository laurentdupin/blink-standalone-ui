...
bool V8BackgroundFetchRecord::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8BackgroundFetchRecord::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8BackgroundFetchRecord::InstallInterfaceTemplate,
    nullptr,
    "BackgroundFetchRecord",
    nullptr,
    V8BackgroundFetchRecord::kThisTag,
    V8BackgroundFetchRecord::kMaxSubclassTag,
...
const WrapperTypeInfo& BackgroundFetchRecord::wrapper_type_info_ =
    V8BackgroundFetchRecord::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, BackgroundFetchRecord>::value,
    "BackgroundFetchRecord inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_background_fetch_record {
...
BLINK_BINDINGS_TRACE_EVENT("BackgroundFetchRecord.request.get");
...
void ResponseReadyAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  // Promise returning function: Convert a TypeError to a reject promise.
ExceptionToRejectPromiseScope reject_promise_scope(info);
v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
if (!V8BackgroundFetchRecord::HasInstance(isolate, v8_receiver)) {
...
BLINK_BINDINGS_TRACE_EVENT("BackgroundFetchRecord.responseReady.get");
...
using namespace v8_background_fetch_record;

}  // namespace 

void V8BackgroundFetchRecord::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8BackgroundFetchRecord::GetWrapperTypeInfo();
...
void V8BackgroundFetchRecord::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
