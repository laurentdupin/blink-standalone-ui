...
class CORE_EXPORT V8HTMLMediaElement final : public bindings::V8InterfaceBridge<V8HTMLMediaElement, HTMLMediaElement> {
...
class Constant final {
  ...
  public:
static constexpr uint16_t kNetworkEmpty = 0;
static constexpr uint16_t kNetworkIdle = 1;
static constexpr uint16_t kNetworkLoading = 2;
static constexpr uint16_t kNetworkNoSource = 3;
static constexpr uint16_t kHaveNothing = 0;
static constexpr uint16_t kHaveMetadata = 1;
static constexpr uint16_t kHaveCurrentData = 2;
static constexpr uint16_t kHaveFutureData = 3;
static constexpr uint16_t kHaveEnoughData = 4;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(633);
  static constexpr v8::CppHeapPointerTag kMaxSubclassTag =
      static_cast<v8::CppHeapPointerTag>(635);
