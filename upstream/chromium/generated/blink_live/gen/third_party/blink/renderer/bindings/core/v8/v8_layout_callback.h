...
[[nodiscard]] base::expected<ScriptValue, ScriptValue> InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<CustomLayoutChild>>& arg1_children, CustomLayoutEdges* arg2_edges, CustomLayoutConstraints* arg3_constraints, StylePropertyMapReadOnly* arg4_style_map);
