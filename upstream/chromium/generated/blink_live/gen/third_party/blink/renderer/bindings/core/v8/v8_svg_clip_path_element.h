...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_CLIP_PATH_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_CLIP_PATH_ELEMENT_H_
...
class CORE_EXPORT V8SVGClipPathElement final : public bindings::V8InterfaceBridge<V8SVGClipPathElement, SVGClipPathElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(682);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGClipPathElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_CLIP_PATH_ELEMENT_H_
