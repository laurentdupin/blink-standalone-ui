...
bool V8SVGMetadataElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<SVGMetadataElement, SVGElement>);
...
const WrapperTypeInfo V8SVGMetadataElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SVGMetadataElement::InstallInterfaceTemplate,
    nullptr,
    "SVGMetadataElement",
    V8SVGElement::GetWrapperTypeInfo(),
    V8SVGMetadataElement::kThisTag,
    V8SVGMetadataElement::kMaxSubclassTag,
...
const WrapperTypeInfo& SVGMetadataElement::wrapper_type_info_ =
    V8SVGMetadataElement::wrapper_type_info_;
...
namespace v8_svg_metadata_element {



}  // namespace v8_svg_metadata_element

using namespace v8_svg_metadata_element;

}  // namespace 

void V8SVGMetadataElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SVGMetadataElement::GetWrapperTypeInfo();
