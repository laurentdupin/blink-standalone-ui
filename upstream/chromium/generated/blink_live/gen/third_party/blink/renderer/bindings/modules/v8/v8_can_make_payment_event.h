...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CAN_MAKE_PAYMENT_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CAN_MAKE_PAYMENT_EVENT_H_
...
class MODULES_EXPORT V8CanMakePaymentEvent final : public bindings::V8InterfaceBridge<V8CanMakePaymentEvent, CanMakePaymentEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(401);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CanMakePaymentEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CAN_MAKE_PAYMENT_EVENT_H_
