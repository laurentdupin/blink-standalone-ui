...
const char* V8PressureUpdateCallback::GetHumanReadableName() const {
  return "V8PressureUpdateCallback";
}

v8::Maybe<void> V8PressureUpdateCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<PressureRecord>>& arg1_changes, PressureObserver* arg2_observer) {
  const char* const class_like_name = "PressureUpdateCallback";
...
v8::Local<v8::Value> v8_arg1_changes;
ScriptState* script_state = CallbackRelevantScriptState();
v8_arg1_changes = ToV8Traits<IDLSequence<PressureRecord>>::ToV8(script_state, arg1_changes);
argv[0] = v8_arg1_changes;
v8::Local<v8::Value> v8_arg2_observer;
v8_arg2_observer = ToV8Traits<PressureObserver>::ToV8(script_state, arg2_observer);
...
v8::Maybe<void> V8PressureUpdateCallback::Construct(const HeapVector<Member<PressureRecord>>& arg1_changes, PressureObserver* arg2_observer) {
  const char* const class_like_name = "PressureUpdateCallback";
...
void V8PressureUpdateCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<PressureRecord>>& arg1_changes, PressureObserver* arg2_observer) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = Invoke(arg0_receiver, arg1_changes, arg2_observer);
}

base::expected<void, ScriptValue> V8PressureUpdateCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<PressureRecord>>& arg1_changes, PressureObserver* arg2_observer) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_changes, arg2_observer);
