...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CREATE_MONITOR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CREATE_MONITOR_H_
...
class MODULES_EXPORT V8CreateMonitor final : public bindings::V8InterfaceBridge<V8CreateMonitor, CreateMonitor> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(540);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CreateMonitor;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CREATE_MONITOR_H_
