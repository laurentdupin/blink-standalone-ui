...
class CORE_EXPORT V8HTMLTrackElement final : public bindings::V8InterfaceBridge<V8HTMLTrackElement, HTMLTrackElement> {
...
static constexpr uint16_t kLoading = 1;
static constexpr uint16_t kLoaded = 2;
static constexpr uint16_t kError = 3;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(671);
