...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PAINT_WORKLET_GLOBAL_SCOPE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PAINT_WORKLET_GLOBAL_SCOPE_H_
...
class MODULES_EXPORT V8PaintWorkletGlobalScope final : public bindings::V8InterfaceBridge<V8PaintWorkletGlobalScope, PaintWorkletGlobalScope> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1042);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PaintWorkletGlobalScope;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PAINT_WORKLET_GLOBAL_SCOPE_H_
