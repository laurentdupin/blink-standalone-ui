...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_XR_HAND_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_XR_HAND_H_
...
template <>
class MODULES_EXPORT SyncIterator<XRHand> final : public bindings::SyncIteratorBase {
  DEFINE_WRAPPERTYPEINFO();

  public:
using IDLKeyType = V8XRHandJoint;
using IDLValueType = XRJointSpace;
using KeyType = V8XRHandJoint;
using ValueType = XRJointSpace*;

explicit  SyncIterator<XRHand>(IterationSourceBase* source, Kind kind) : bindings::SyncIteratorBase(source, kind) {
...
class MODULES_EXPORT V8SyncIteratorXRHand final : public bindings::V8InterfaceBridge<V8SyncIteratorXRHand, SyncIterator<XRHand>> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1506);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SyncIterator<XRHand>;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SYNC_ITERATOR_XR_HAND_H_
