...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_CAMERA_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_CAMERA_H_
...
class MODULES_EXPORT V8XRCamera final : public bindings::V8InterfaceBridge<V8XRCamera, XRCamera> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1423);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XRCamera;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_CAMERA_H_
