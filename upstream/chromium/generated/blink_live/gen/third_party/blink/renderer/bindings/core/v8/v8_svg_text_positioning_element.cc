...
bool V8SVGTextPositioningElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<SVGTextPositioningElement, SVGTextContentElement>);
...
const WrapperTypeInfo V8SVGTextPositioningElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SVGTextPositioningElement::InstallInterfaceTemplate,
    nullptr,
    "SVGTextPositioningElement",
    V8SVGTextContentElement::GetWrapperTypeInfo(),
    V8SVGTextPositioningElement::kThisTag,
    V8SVGTextPositioningElement::kMaxSubclassTag,
...
const WrapperTypeInfo& SVGTextPositioningElement::wrapper_type_info_ =
    V8SVGTextPositioningElement::wrapper_type_info_;
...
namespace v8_svg_text_positioning_element {
...
BLINK_BINDINGS_TRACE_EVENT("SVGTextPositioningElement.x.get");
...
static_assert(bindings::IsReturnTypeCompatible<SVGAnimatedLengthList, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
BLINK_BINDINGS_TRACE_EVENT("SVGTextPositioningElement.y.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGTextPositioningElement.dx.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGTextPositioningElement.dy.get");
...
void RotateAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SVGTextPositioningElement_rotate_Getter");
BLINK_BINDINGS_TRACE_EVENT("SVGTextPositioningElement.rotate.get");
...
using namespace v8_svg_text_positioning_element;

}  // namespace 

void V8SVGTextPositioningElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SVGTextPositioningElement::GetWrapperTypeInfo();
...
void V8SVGTextPositioningElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"rotate", RotateAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
};
v8::Local<v8::Signature> signature = v8::Local<v8::Signature>::Cast(interface_template);
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGTextPositioningElement", kAttributeTable);
}
