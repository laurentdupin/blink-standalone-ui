...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_LAYOUT_CONSTRAINTS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_LAYOUT_CONSTRAINTS_H_
...
class CORE_EXPORT V8LayoutConstraints final : public bindings::V8InterfaceBridge<V8LayoutConstraints, CustomLayoutConstraints> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(924);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CustomLayoutConstraints;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_LAYOUT_CONSTRAINTS_H_
