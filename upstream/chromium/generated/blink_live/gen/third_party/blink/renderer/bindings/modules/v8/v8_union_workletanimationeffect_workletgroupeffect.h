...
using Ret = bindings::OptimizedReturnProxy<V8UnionWorkletAnimationEffectOrWorkletGroupEffect>;
v8::Local<v8::Value> ToV8(ScriptState* script_state) const;

static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, WorkletAnimationEffect* value);
static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, WorkletGroupEffect* value);
