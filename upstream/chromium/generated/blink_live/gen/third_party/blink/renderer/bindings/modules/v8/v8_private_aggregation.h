...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PRIVATE_AGGREGATION_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PRIVATE_AGGREGATION_H_
...
class MODULES_EXPORT V8PrivateAggregation final : public bindings::V8InterfaceBridge<V8PrivateAggregation, PrivateAggregation> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1252);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PrivateAggregation;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_PRIVATE_AGGREGATION_H_
