...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_RENDER_BUNDLE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_RENDER_BUNDLE_H_
...
class MODULES_EXPORT V8GPURenderBundle final : public bindings::V8InterfaceBridge<V8GPURenderBundle, GPURenderBundle> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1391);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class GPURenderBundle;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_RENDER_BUNDLE_H_
