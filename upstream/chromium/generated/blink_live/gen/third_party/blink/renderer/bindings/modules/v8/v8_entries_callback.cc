...
const char* V8EntriesCallback::GetHumanReadableName() const {
  return "V8EntriesCallback";
}

v8::Maybe<void> V8EntriesCallback::handleEvent(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<Entry>>& arg1_entries) {
  const char* const class_like_name = "EntriesCallback";
...
void V8EntriesCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<Entry>>& arg1_entries) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = handleEvent(arg0_receiver, arg1_entries);
}
