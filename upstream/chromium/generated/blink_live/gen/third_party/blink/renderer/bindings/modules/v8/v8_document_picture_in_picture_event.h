...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DOCUMENT_PICTURE_IN_PICTURE_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DOCUMENT_PICTURE_IN_PICTURE_EVENT_H_
...
class MODULES_EXPORT V8DocumentPictureInPictureEvent final : public bindings::V8InterfaceBridge<V8DocumentPictureInPictureEvent, DocumentPictureInPictureEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(394);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class DocumentPictureInPictureEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DOCUMENT_PICTURE_IN_PICTURE_EVENT_H_
