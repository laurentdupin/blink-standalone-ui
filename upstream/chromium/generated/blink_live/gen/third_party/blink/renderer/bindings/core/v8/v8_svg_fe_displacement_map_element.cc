...
static_assert(std::derived_from<SVGFEDisplacementMapElement, SVGElement>);
...
const WrapperTypeInfo V8SVGFEDisplacementMapElement::wrapper_type_info_{
    ...
    V8SVGFEDisplacementMapElement::kThisTag,
    V8SVGFEDisplacementMapElement::kMaxSubclassTag,
...
SVGFEDisplacementMapElement* blink_receiver = V8SVGFEDisplacementMapElement::ToWrappableUnsafe(isolate, v8_receiver);
...
void V8SVGFEDisplacementMapElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGFEDisplacementMapElement", kAttributeTable);
}
...
{"SVG_CHANNEL_UNKNOWN", V8SVGFEDisplacementMapElement::Constant::kSVGChannelUnknown},
{"SVG_CHANNEL_R", V8SVGFEDisplacementMapElement::Constant::kSVGChannelR},
{"SVG_CHANNEL_G", V8SVGFEDisplacementMapElement::Constant::kSVGChannelG},
{"SVG_CHANNEL_B", V8SVGFEDisplacementMapElement::Constant::kSVGChannelB},
{"SVG_CHANNEL_A", V8SVGFEDisplacementMapElement::Constant::kSVGChannelA},
};
