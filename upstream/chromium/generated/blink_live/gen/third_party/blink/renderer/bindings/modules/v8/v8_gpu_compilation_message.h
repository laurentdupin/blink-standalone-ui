...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_COMPILATION_MESSAGE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_COMPILATION_MESSAGE_H_
...
class MODULES_EXPORT V8GPUCompilationMessage final : public bindings::V8InterfaceBridge<V8GPUCompilationMessage, GPUCompilationMessage> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1378);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class GPUCompilationMessage;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_COMPILATION_MESSAGE_H_
