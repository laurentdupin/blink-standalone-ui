...
v8::Local<v8::Value> V8UnionHTMLScriptElementOrSVGScriptElement::DirectToV8(ScriptState* script_state, HTMLScriptElement* value) {
  return ToV8Traits<HTMLScriptElement>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionHTMLScriptElementOrSVGScriptElement::DirectToV8(ScriptState* script_state, SVGScriptElement* value) {
  return ToV8Traits<SVGScriptElement>::ToV8(script_state, value);
}
