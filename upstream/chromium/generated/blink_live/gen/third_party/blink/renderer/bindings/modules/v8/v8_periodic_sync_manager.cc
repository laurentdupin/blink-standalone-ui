...
const WrapperTypeInfo V8PeriodicSyncManager::wrapper_type_info_{
    ...
    "PeriodicSyncManager",
    nullptr,
    V8PeriodicSyncManager::kThisTag,
    V8PeriodicSyncManager::kMaxSubclassTag,
...
void V8PeriodicSyncManager::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "PeriodicSyncManager", kOperationTable);
}
