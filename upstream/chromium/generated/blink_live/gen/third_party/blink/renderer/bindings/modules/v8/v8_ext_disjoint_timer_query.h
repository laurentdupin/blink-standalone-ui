...
class MODULES_EXPORT V8EXTDisjointTimerQuery final : public bindings::V8InterfaceBridge<V8EXTDisjointTimerQuery, EXTDisjointTimerQuery> {
...
static constexpr uint32_t kCurrentQueryExt = 0x8865;
static constexpr uint32_t kQueryResultExt = 0x8866;
static constexpr uint32_t kQueryResultAvailableExt = 0x8867;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1298);
