...
class MODULES_EXPORT V8GPUPowerPreference final : public bindings::EnumerationBase {
  
  public:
enum class Enum : enum_int_t {
kLowPower, kHighPerformance
};
static constexpr size_t kEnumSize = 2;

static V8GPUPowerPreference Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8GPUPowerPreference> Create(const String& value);

explicit constexpr  V8GPUPowerPreference(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8GPUPowerPreference& lhs, V8GPUPowerPreference::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8GPUPowerPreference::Enum lhs, const V8GPUPowerPreference& rhs) {
