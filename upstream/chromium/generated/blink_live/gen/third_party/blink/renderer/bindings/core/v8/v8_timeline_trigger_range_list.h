...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TIMELINE_TRIGGER_RANGE_LIST_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TIMELINE_TRIGGER_RANGE_LIST_H_
...
class CORE_EXPORT V8TimelineTriggerRangeList final : public bindings::V8InterfaceBridge<V8TimelineTriggerRangeList, TimelineTriggerRangeList> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(269);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class TimelineTriggerRangeList;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TIMELINE_TRIGGER_RANGE_LIST_H_
