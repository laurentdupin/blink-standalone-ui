...
class MODULES_EXPORT CameraDevicePermissionDescriptor : public PermissionDescriptor {
  ...
  public:
static CameraDevicePermissionDescriptor* Create() {
...
static CameraDevicePermissionDescriptor* Create(v8::Isolate* isolate) {
  return MakeGarbageCollected<CameraDevicePermissionDescriptor>(isolate);
}
static CameraDevicePermissionDescriptor* Create(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state);

explicit  CameraDevicePermissionDescriptor();
explicit  CameraDevicePermissionDescriptor(v8::Isolate* isolate);

bool hasPanTiltZoom() const {
  return true;
}
bool panTiltZoom() const {
  return member_pan_tilt_zoom_;
}
void setPanTiltZoom(bool value) {
  member_pan_tilt_zoom_ = value;
}
...
bool member_pan_tilt_zoom_{false};
