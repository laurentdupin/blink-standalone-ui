...
class CORE_EXPORT V8FormStateRestoreMode final : public bindings::EnumerationBase {
  
  public:
enum class Enum : enum_int_t {
kRestore, kAutocomplete
};
static constexpr size_t kEnumSize = 2;

static V8FormStateRestoreMode Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8FormStateRestoreMode> Create(const String& value);

explicit constexpr  V8FormStateRestoreMode(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8FormStateRestoreMode& lhs, V8FormStateRestoreMode::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8FormStateRestoreMode::Enum lhs, const V8FormStateRestoreMode& rhs) {
