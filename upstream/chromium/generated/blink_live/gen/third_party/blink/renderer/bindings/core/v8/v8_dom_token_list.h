...
class CORE_EXPORT V8DOMTokenList final : public bindings::V8InterfaceBridge<V8DOMTokenList, DOMTokenList> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(372);
