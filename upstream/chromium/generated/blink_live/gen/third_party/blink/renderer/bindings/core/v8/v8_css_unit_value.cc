...
bool V8CSSUnitValue::IsExposed(ExecutionContext* execution_context) {
...
static_assert(std::derived_from<CSSUnitValue, CSSNumericValue>);
...
const WrapperTypeInfo V8CSSUnitValue::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8CSSUnitValue::InstallInterfaceTemplate,
    nullptr,
    "CSSUnitValue",
    V8CSSNumericValue::GetWrapperTypeInfo(),
    V8CSSUnitValue::kThisTag,
    V8CSSUnitValue::kMaxSubclassTag,
...
const WrapperTypeInfo& CSSUnitValue::wrapper_type_info_ =
    V8CSSUnitValue::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, CSSUnitValue>::value,
    "CSSUnitValue inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_css_unit_value {
...
BLINK_BINDINGS_TRACE_EVENT("CSSUnitValue.value.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
CSSUnitValue* blink_receiver = V8CSSUnitValue::ToWrappableUnsafe(isolate, v8_receiver);
...
BLINK_BINDINGS_TRACE_EVENT("CSSUnitValue.value.set");
...
void UnitAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSUnitValue_unit_Getter");
BLINK_BINDINGS_TRACE_EVENT("CSSUnitValue.unit.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
CSSUnitValue* blink_receiver = V8CSSUnitValue::ToWrappableUnsafe(isolate, v8_receiver);
auto&& return_value = blink_receiver->unit();
...
BLINK_BINDINGS_TRACE_EVENT("CSSUnitValue.constructor");
...
auto&& arg2_unit = NativeValueTraits<IDLString>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& return_value = CSSUnitValue::Create(arg1_value, arg2_unit, exception_state);
static_assert(bindings::IsReturnTypeCompatible<CSSUnitValue, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8CSSUnitValue::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_css_unit_value;

}  // namespace 

void V8CSSUnitValue::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8CSSUnitValue::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "CSSUnitValue"));
...
void V8CSSUnitValue::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"unit", UnitAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
};
v8::Local<v8::Signature> signature = v8::Local<v8::Signature>::Cast(interface_template);
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "CSSUnitValue", kAttributeTable);
}
