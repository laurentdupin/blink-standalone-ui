...
public:
    ...
    void setTimeDomain(crdtp::Dispatchable& dispatchable);
    void getMetrics(crdtp::Dispatchable& dispatchable);
 protected:
    Backend* m_backend;
};
...
struct enableParams : public crdtp::DeserializableProtocolObject<enableParams> {
    std::optional<String> timeDomain;
    DECLARE_DESERIALIZATION_SUPPORT();
};

CRDTP_BEGIN_DESERIALIZER(enableParams)
    CRDTP_DESERIALIZE_FIELD_OPT("timeDomain", timeDomain),
CRDTP_END_DESERIALIZER()
...
CRDTP_BEGIN_DESERIALIZER(setTimeDomainParams)
    CRDTP_DESERIALIZE_FIELD("timeDomain", timeDomain),
CRDTP_END_DESERIALIZER()

}  // namespace

void DomainDispatcherImpl::setTimeDomain(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
    auto deserializer = crdtp::DeferredMessage::FromSpan(dispatchable.Params())->MakeDeserializer();
...
void DomainDispatcherImpl::getMetrics(crdtp::Dispatchable& dispatchable)
{
    // Prepare input parameters.
