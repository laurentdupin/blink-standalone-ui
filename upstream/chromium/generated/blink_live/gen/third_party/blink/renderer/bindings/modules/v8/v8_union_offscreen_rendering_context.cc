...
v8::Local<v8::Value> V8OffscreenRenderingContext::DirectToV8(ScriptState* script_state, GPUCanvasContext* value) {
  return ToV8Traits<GPUCanvasContext>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8OffscreenRenderingContext::DirectToV8(ScriptState* script_state, ImageBitmapRenderingContext* value) {
  return ToV8Traits<ImageBitmapRenderingContext>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8OffscreenRenderingContext::DirectToV8(ScriptState* script_state, OffscreenCanvasRenderingContext2D* value) {
  return ToV8Traits<OffscreenCanvasRenderingContext2D>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8OffscreenRenderingContext::DirectToV8(ScriptState* script_state, WebGL2RenderingContext* value) {
  return ToV8Traits<WebGL2RenderingContext>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8OffscreenRenderingContext::DirectToV8(ScriptState* script_state, WebGL2RenderingContextWebGPU* value) {
  return ToV8Traits<WebGL2RenderingContextWebGPU>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8OffscreenRenderingContext::DirectToV8(ScriptState* script_state, WebGLRenderingContext* value) {
  return ToV8Traits<WebGLRenderingContext>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8OffscreenRenderingContext::DirectToV8(ScriptState* script_state, WebGLRenderingContextWebGPU* value) {
