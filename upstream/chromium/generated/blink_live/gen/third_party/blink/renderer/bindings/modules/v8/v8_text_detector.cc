...
const WrapperTypeInfo V8TextDetector::wrapper_type_info_{
    ...
    "TextDetector",
    nullptr,
    V8TextDetector::kThisTag,
    V8TextDetector::kMaxSubclassTag,
...
static_assert(bindings::IsReturnTypeCompatible<TextDetector, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
TextDetector* blink_receiver = V8TextDetector::ToWrappableUnsafe(isolate, v8_receiver);
...
static_assert(bindings::IsReturnTypeCompatible<IDLPromise<IDLSequence<DetectedText>>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
interface_function_template->SetInterfaceName(V8String(isolate, "TextDetector"));
...
void V8TextDetector::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "TextDetector", kOperationTable);
}
