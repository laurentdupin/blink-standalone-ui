...
if (hasRpId()) {
  values[4] = ToV8Traits<IDLString>::ToV8(script_state, member_rp_id_);
...
if (!bindings::GetDictionaryMemberFromV8Object<AuthenticationExtensionsClientInputs, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[2].Get(isolate), has_extensions_, member_extensions_, class_like_name, exception_state)) {
  return;
}
...
if (!bindings::GetDictionaryMemberFromV8Object<IDLString, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[6].Get(isolate), has_user_verification_, member_user_verification_, class_like_name, exception_state)) {
  return;
}
}
