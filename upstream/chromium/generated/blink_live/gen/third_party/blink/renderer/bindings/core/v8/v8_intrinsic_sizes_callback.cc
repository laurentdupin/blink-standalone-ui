...
const char* V8IntrinsicSizesCallback::GetHumanReadableName() const {
  return "V8IntrinsicSizesCallback";
}

v8::Maybe<ScriptValue> V8IntrinsicSizesCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<CustomLayoutChild>>& arg1_children, CustomLayoutEdges* arg2_edges, StylePropertyMapReadOnly* arg3_style_map) {
...
v8::Maybe<ScriptValue> V8IntrinsicSizesCallback::Construct(const HeapVector<Member<CustomLayoutChild>>& arg1_children, CustomLayoutEdges* arg2_edges, StylePropertyMapReadOnly* arg3_style_map) {
  const char* const class_like_name = "IntrinsicSizesCallback";
...
base::expected<ScriptValue, ScriptValue> V8IntrinsicSizesCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<CustomLayoutChild>>& arg1_children, CustomLayoutEdges* arg2_edges, StylePropertyMapReadOnly* arg3_style_map) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_children, arg2_edges, arg3_style_map);
