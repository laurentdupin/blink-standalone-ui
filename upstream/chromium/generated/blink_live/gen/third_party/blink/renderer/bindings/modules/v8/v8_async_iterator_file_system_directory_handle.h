...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ASYNC_ITERATOR_FILE_SYSTEM_DIRECTORY_HANDLE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ASYNC_ITERATOR_FILE_SYSTEM_DIRECTORY_HANDLE_H_
...
template <>
class MODULES_EXPORT AsyncIterator<FileSystemDirectoryHandle> final : public bindings::AsyncIteratorBase {
  DEFINE_WRAPPERTYPEINFO();

  public:
using IDLKeyType = IDLUSVString;
using IDLValueType = FileSystemHandle;
using KeyType = String;
using ValueType = FileSystemHandle*;

explicit  AsyncIterator<FileSystemDirectoryHandle>(IterationSourceBase* source) : bindings::AsyncIteratorBase(source) {
...
class MODULES_EXPORT V8AsyncIteratorFileSystemDirectoryHandle final : public bindings::V8InterfaceBridge<V8AsyncIteratorFileSystemDirectoryHandle, AsyncIterator<FileSystemDirectoryHandle>> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(257);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class AsyncIterator<FileSystemDirectoryHandle>;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ASYNC_ITERATOR_FILE_SYSTEM_DIRECTORY_HANDLE_H_
