...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ABSOLUTE_ORIENTATION_SENSOR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ABSOLUTE_ORIENTATION_SENSOR_H_
...
class MODULES_EXPORT V8AbsoluteOrientationSensor final : public bindings::V8InterfaceBridge<V8AbsoluteOrientationSensor, AbsoluteOrientationSensor> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(781);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class AbsoluteOrientationSensor;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ABSOLUTE_ORIENTATION_SENSOR_H_
