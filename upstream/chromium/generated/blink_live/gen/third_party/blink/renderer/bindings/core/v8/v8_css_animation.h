...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_ANIMATION_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_ANIMATION_H_
...
class CORE_EXPORT V8CSSAnimation final : public bindings::V8InterfaceBridge<V8CSSAnimation, CSSAnimation> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(499);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSAnimation;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_ANIMATION_H_
