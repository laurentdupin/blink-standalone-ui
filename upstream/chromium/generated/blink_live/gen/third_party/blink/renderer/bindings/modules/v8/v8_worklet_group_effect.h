...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WORKLET_GROUP_EFFECT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WORKLET_GROUP_EFFECT_H_
...
class MODULES_EXPORT V8WorkletGroupEffect final : public bindings::V8InterfaceBridge<V8WorkletGroupEffect, WorkletGroupEffect> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1084);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class WorkletGroupEffect;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_WORKLET_GROUP_EFFECT_H_
