...
bool V8EventCounts::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8EventCounts::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8EventCounts::InstallInterfaceTemplate,
    V8EventCounts::InstallContextDependentProperties,
    "EventCounts",
    nullptr,
    V8EventCounts::kThisTag,
    V8EventCounts::kMaxSubclassTag,
...
const WrapperTypeInfo& EventCounts::wrapper_type_info_ =
    V8EventCounts::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, EventCounts>::value,
    "EventCounts inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_event_counts {


void SizeAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_EventCounts_size_Getter");
BLINK_BINDINGS_TRACE_EVENT("EventCounts.size.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
EventCounts* blink_receiver = V8EventCounts::ToWrappableUnsafe(isolate, v8_receiver);
...
void EntriesOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_EventCounts_entries");
BLINK_BINDINGS_TRACE_EVENT("EventCounts.entries");
...
static_assert(bindings::IsReturnTypeCompatible<SyncIterator<EventCounts>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
}

void ForEachOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_EventCounts_forEach");
BLINK_BINDINGS_TRACE_EVENT("EventCounts.forEach");
...
void GetOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_EventCounts_get");
BLINK_BINDINGS_TRACE_EVENT("EventCounts.get");
...
void HasOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_EventCounts_has");
BLINK_BINDINGS_TRACE_EVENT("EventCounts.has");
...
void KeysOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_EventCounts_keys");
BLINK_BINDINGS_TRACE_EVENT("EventCounts.keys");
...
void ValuesOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_EventCounts_values");
BLINK_BINDINGS_TRACE_EVENT("EventCounts.values");
...
using namespace v8_event_counts;

}  // namespace 

void V8EventCounts::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8EventCounts::GetWrapperTypeInfo();
...
void V8EventCounts::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "EventCounts", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "EventCounts", kOperationTable);
}
...
void V8EventCounts::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object, v8::Local<v8::Object> prototype_object, v8::Local<v8::Object> interface_object, v8::Local<v8::Template> interface_template, FeatureSelector feature_selector) {
  using bindings::IDLMemberInstaller;
