...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_GRADIENT_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_GRADIENT_ELEMENT_H_
...
class CORE_EXPORT V8SVGGradientElement final : public bindings::V8InterfaceBridge<V8SVGGradientElement, SVGGradientElement> {
...
class Constant final {
  ...
  public:
static constexpr uint16_t kSVGSpreadmethodUnknown = 0;
static constexpr uint16_t kSVGSpreadmethodPad = 1;
static constexpr uint16_t kSVGSpreadmethodReflect = 2;
static constexpr uint16_t kSVGSpreadmethodRepeat = 3;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(711);
  static constexpr v8::CppHeapPointerTag kMaxSubclassTag =
      static_cast<v8::CppHeapPointerTag>(713);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGGradientElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_GRADIENT_ELEMENT_H_
