...
bool V8ProgressEvent::IsExposed(ExecutionContext* execution_context) {
...
static_assert(std::derived_from<ProgressEvent, Event>);
...
const WrapperTypeInfo V8ProgressEvent::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8ProgressEvent::InstallInterfaceTemplate,
    nullptr,
    "ProgressEvent",
    V8Event::GetWrapperTypeInfo(),
    V8ProgressEvent::kThisTag,
    V8ProgressEvent::kMaxSubclassTag,
...
const WrapperTypeInfo& ProgressEvent::wrapper_type_info_ =
    V8ProgressEvent::wrapper_type_info_;
...
namespace v8_progress_event {


void LengthComputableAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_ProgressEvent_lengthComputable_Getter");
BLINK_BINDINGS_TRACE_EVENT("ProgressEvent.lengthComputable.get");
...
BLINK_BINDINGS_TRACE_EVENT("ProgressEvent.loaded.get");
...
BLINK_BINDINGS_TRACE_EVENT("ProgressEvent.total.get");
...
BLINK_BINDINGS_TRACE_EVENT("ProgressEvent.isTrusted.get");
...
BLINK_BINDINGS_TRACE_EVENT("ProgressEvent.constructor");
...
decltype(NativeValueTraits<ProgressEventInit>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg2_event_init_dict;
if (info[1]->IsUndefined()) {
  arg2_event_init_dict = ProgressEventInit::Create();
} else {
  arg2_event_init_dict = NativeValueTraits<ProgressEventInit>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
}
auto&& return_value = ProgressEvent::Create(arg1_type, arg2_event_init_dict);
static_assert(bindings::IsReturnTypeCompatible<ProgressEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8ProgressEvent::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_progress_event;

}  // namespace 

void V8ProgressEvent::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8ProgressEvent::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "ProgressEvent"));
...
void V8ProgressEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
  using bindings::IDLMemberInstaller;

{
  
static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
{"lengthComputable", LengthComputableAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "ProgressEvent", kAttributeTable);
}
