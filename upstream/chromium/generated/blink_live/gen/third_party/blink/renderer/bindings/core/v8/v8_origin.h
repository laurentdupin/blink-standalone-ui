...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_ORIGIN_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_ORIGIN_H_
...
class CORE_EXPORT V8Origin final : public bindings::V8InterfaceBridge<V8Origin, DOMOrigin> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1027);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class DOMOrigin;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_ORIGIN_H_
