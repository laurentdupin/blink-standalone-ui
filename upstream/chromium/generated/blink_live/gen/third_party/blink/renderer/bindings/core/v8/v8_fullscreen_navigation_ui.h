...
class CORE_EXPORT V8FullscreenNavigationUI final : public bindings::EnumerationBase {
...
static V8FullscreenNavigationUI Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8FullscreenNavigationUI> Create(const String& value);

explicit constexpr  V8FullscreenNavigationUI(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8FullscreenNavigationUI& lhs, V8FullscreenNavigationUI::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8FullscreenNavigationUI::Enum lhs, const V8FullscreenNavigationUI& rhs) {
