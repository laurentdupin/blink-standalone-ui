...
static_assert(std::derived_from<BrowserCaptureMediaStreamTrack, MediaStreamTrack>);
...
const WrapperTypeInfo V8BrowserCaptureMediaStreamTrack::wrapper_type_info_{
    ...
    V8BrowserCaptureMediaStreamTrack::kThisTag,
    V8BrowserCaptureMediaStreamTrack::kMaxSubclassTag,
...
const WrapperTypeInfo& BrowserCaptureMediaStreamTrack::wrapper_type_info_ =
    V8BrowserCaptureMediaStreamTrack::wrapper_type_info_;
...
void CropToOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_BrowserCaptureMediaStreamTrack_cropTo");
BLINK_BINDINGS_TRACE_EVENT("BrowserCaptureMediaStreamTrack.cropTo");
...
const char* const property_name = "cropTo";
...
auto&& return_value = blink_receiver->cropTo(script_state, arg1_crop_id, exception_state);
...
using namespace v8_browser_capture_media_stream_track;

}  // namespace 

void V8BrowserCaptureMediaStreamTrack::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8BrowserCaptureMediaStreamTrack::GetWrapperTypeInfo();
...
void V8BrowserCaptureMediaStreamTrack::InstallContextIndependentProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "BrowserCaptureMediaStreamTrack", kOperationTable);
}
