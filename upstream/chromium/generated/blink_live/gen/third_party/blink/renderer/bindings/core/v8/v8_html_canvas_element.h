...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_CANVAS_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_CANVAS_ELEMENT_H_
...
class CORE_EXPORT V8HTMLCanvasElement final : public bindings::V8InterfaceBridge<V8HTMLCanvasElement, HTMLCanvasElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(601);
...
static InstallContextDependentPropertiesFuncType install_context_dependent_props_func_;
  ...
  friend class HTMLCanvasElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_CANVAS_ELEMENT_H_
