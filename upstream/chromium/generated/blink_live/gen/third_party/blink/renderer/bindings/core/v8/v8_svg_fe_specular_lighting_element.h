...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_SPECULAR_LIGHTING_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_SPECULAR_LIGHTING_ELEMENT_H_
...
class CORE_EXPORT V8SVGFESpecularLightingElement final : public bindings::V8InterfaceBridge<V8SVGFESpecularLightingElement, SVGFESpecularLightingElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(706);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGFESpecularLightingElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_SPECULAR_LIGHTING_ELEMENT_H_
