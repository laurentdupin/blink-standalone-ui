...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_USB_ALTERNATE_INTERFACE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_USB_ALTERNATE_INTERFACE_H_
...
class MODULES_EXPORT V8USBAlternateInterface final : public bindings::V8InterfaceBridge<V8USBAlternateInterface, USBAlternateInterface> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1410);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class USBAlternateInterface;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_USB_ALTERNATE_INTERFACE_H_
