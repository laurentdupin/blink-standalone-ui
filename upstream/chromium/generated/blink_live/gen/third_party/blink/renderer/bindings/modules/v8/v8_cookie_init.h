...
const std::optional<int64_t>& maxAge() const {
  DCHECK(hasMaxAge());
return member_max_age_;
}
std::optional<int64_t> getMaxAgeOr(const std::optional<int64_t>& fallback_value) const {
  if (!hasMaxAge()) {
  return fallback_value;
}
return member_max_age_;
}
void setMaxAge(const std::optional<int64_t>& value) {
  member_max_age_ = value;
has_max_age_ = true;
}
void setMaxAge(int64_t value) {
  member_max_age_ = value;
has_max_age_ = true;
}
...
std::optional<int64_t> member_max_age_;
String member_name_;
