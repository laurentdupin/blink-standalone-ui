...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SERVICE_WORKER_REGISTRATION_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SERVICE_WORKER_REGISTRATION_H_
...
class MODULES_EXPORT V8ServiceWorkerRegistration final : public bindings::V8InterfaceBridge<V8ServiceWorkerRegistration, ServiceWorkerRegistration> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(787);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SERVICE_WORKER_REGISTRATION_H_
