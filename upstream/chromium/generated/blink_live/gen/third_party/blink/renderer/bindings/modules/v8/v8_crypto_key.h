...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CRYPTO_KEY_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CRYPTO_KEY_H_
...
class MODULES_EXPORT V8CryptoKey final : public bindings::V8InterfaceBridge<V8CryptoKey, CryptoKey> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1133);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CryptoKey;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CRYPTO_KEY_H_
