...
class CORE_EXPORT V8HTMLSelectElement final : public bindings::V8InterfaceBridge<V8HTMLSelectElement, HTMLSelectElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(655);
