...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_MEMORY_HEAP_INFO_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_MEMORY_HEAP_INFO_H_
...
class MODULES_EXPORT V8GPUMemoryHeapInfo final : public bindings::V8InterfaceBridge<V8GPUMemoryHeapInfo, GPUMemoryHeapInfo> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1387);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class GPUMemoryHeapInfo;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_MEMORY_HEAP_INFO_H_
