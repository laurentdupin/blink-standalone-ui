...
const char* V8IntersectionObserverCallback::GetHumanReadableName() const {
  return "V8IntersectionObserverCallback";
}

v8::Maybe<void> V8IntersectionObserverCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<IntersectionObserverEntry>>& arg1_entries, IntersectionObserver* arg2_observer) {
  const char* const class_like_name = "IntersectionObserverCallback";
...
v8_arg1_entries = ToV8Traits<IDLSequence<IntersectionObserverEntry>>::ToV8(script_state, arg1_entries);
argv[0] = v8_arg1_entries;
v8::Local<v8::Value> v8_arg2_observer;
v8_arg2_observer = ToV8Traits<IntersectionObserver>::ToV8(script_state, arg2_observer);
...
v8::Maybe<void> V8IntersectionObserverCallback::Construct(const HeapVector<Member<IntersectionObserverEntry>>& arg1_entries, IntersectionObserver* arg2_observer) {
  const char* const class_like_name = "IntersectionObserverCallback";
...
void V8IntersectionObserverCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<IntersectionObserverEntry>>& arg1_entries, IntersectionObserver* arg2_observer) {
  v8::Isolate* isolate = GetIsolate();
...
base::expected<void, ScriptValue> V8IntersectionObserverCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<IntersectionObserverEntry>>& arg1_entries, IntersectionObserver* arg2_observer) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_entries, arg2_observer);
