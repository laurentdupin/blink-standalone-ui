...
static_assert(std::derived_from<PaintWorkletGlobalScope, WorkletGlobalScope>);
...
void CSSMathRandomExposedConstructCallback(v8::Local<v8::Name> v8_property_name, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_PaintWorkletGlobalScope_CSSMathRandom_ConstructorGetterCallback");
BLINK_BINDINGS_TRACE_EVENT("PaintWorkletGlobalScope.CSSMathRandom");

bindings::V8SetReturnValue(info, V8CSSMathRandom::GetWrapperTypeInfo(), bindings::V8ReturnValue::kInterfaceObject);
}
...
if (RuntimeEnabledFeatures::CSSRandomFunctionTypedOMEnabled()) {
  static const IDLMemberInstaller::ExposedConstructConfig kExposedConstructTable[] = {
{"CSSMathRandom", CSSMathRandomExposedConstructCallback}, 
};
IDLMemberInstaller::InstallExposedConstructs(isolate, world, instance_template, prototype_template, interface_template, signature, kExposedConstructTable);
}
