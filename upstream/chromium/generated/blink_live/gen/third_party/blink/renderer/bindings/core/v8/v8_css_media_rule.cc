...
bool V8CSSMediaRule::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<CSSMediaRule, CSSConditionRule>);
...
const WrapperTypeInfo V8CSSMediaRule::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8CSSMediaRule::InstallInterfaceTemplate,
    nullptr,
    "CSSMediaRule",
    V8CSSConditionRule::GetWrapperTypeInfo(),
    V8CSSMediaRule::kThisTag,
    V8CSSMediaRule::kMaxSubclassTag,
...
const WrapperTypeInfo& CSSMediaRule::wrapper_type_info_ =
    V8CSSMediaRule::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, CSSMediaRule>::value,
    "CSSMediaRule inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_css_media_rule {
...
BLINK_BINDINGS_TRACE_EVENT("CSSMediaRule.media.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
CSSMediaRule* blink_receiver = V8CSSMediaRule::ToWrappableUnsafe(isolate, v8_receiver);
auto&& return_value = blink_receiver->media();
static_assert(bindings::IsReturnTypeCompatible<MediaList, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
BLINK_BINDINGS_TRACE_EVENT("CSSMediaRule.media.set");
...
using namespace v8_css_media_rule;

}  // namespace 

void V8CSSMediaRule::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8CSSMediaRule::GetWrapperTypeInfo();
...
void V8CSSMediaRule::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "CSSMediaRule", kAttributeTable);
}
