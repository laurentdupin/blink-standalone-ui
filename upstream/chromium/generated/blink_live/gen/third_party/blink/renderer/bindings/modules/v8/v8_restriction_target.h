...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RESTRICTION_TARGET_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RESTRICTION_TARGET_H_
...
class MODULES_EXPORT V8RestrictionTarget final : public bindings::V8InterfaceBridge<V8RestrictionTarget, RestrictionTarget> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1202);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class RestrictionTarget;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RESTRICTION_TARGET_H_
