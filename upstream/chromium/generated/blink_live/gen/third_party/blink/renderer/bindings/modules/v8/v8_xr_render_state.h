...
class MODULES_EXPORT V8XRRenderState final : public bindings::V8InterfaceBridge<V8XRRenderState, XRRenderState> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1445);
