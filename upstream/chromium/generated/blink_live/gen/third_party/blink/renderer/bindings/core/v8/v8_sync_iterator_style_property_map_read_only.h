...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SYNC_ITERATOR_STYLE_PROPERTY_MAP_READ_ONLY_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SYNC_ITERATOR_STYLE_PROPERTY_MAP_READ_ONLY_H_
...
template <>
class CORE_EXPORT SyncIterator<StylePropertyMapReadOnly> final : public bindings::SyncIteratorBase {
  DEFINE_WRAPPERTYPEINFO();

  public:
using IDLKeyType = IDLString;
using IDLValueType = IDLSequence<CSSStyleValue>;
using KeyType = String;
using ValueType = HeapVector<Member<CSSStyleValue>>;

explicit  SyncIterator<StylePropertyMapReadOnly>(IterationSourceBase* source, Kind kind) : bindings::SyncIteratorBase(source, kind) {
...
class CORE_EXPORT V8SyncIteratorStylePropertyMapReadOnly final : public bindings::V8InterfaceBridge<V8SyncIteratorStylePropertyMapReadOnly, SyncIterator<StylePropertyMapReadOnly>> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1485);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SyncIterator<StylePropertyMapReadOnly>;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SYNC_ITERATOR_STYLE_PROPERTY_MAP_READ_ONLY_H_
