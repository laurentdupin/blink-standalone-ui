...
class MODULES_EXPORT V8OVRMultiview2 final : public bindings::V8InterfaceBridge<V8OVRMultiview2, OVRMultiview2> {
...
class Constant final {
  ...
  public:
static constexpr uint32_t kFramebufferAttachmentTextureNumViewsOvr = 0x9630;
static constexpr uint32_t kFramebufferAttachmentTextureBaseViewIndexOvr = 0x9632;
static constexpr uint32_t kMaxViewsOvr = 0x9631;
static constexpr uint32_t kFramebufferIncompleteViewTargetsOvr = 0x9633;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1324);
