...
const char* V8TestReceiverObjectCallback::GetHumanReadableName() const {
  return "V8TestReceiverObjectCallback";
}

v8::Maybe<void> V8TestReceiverObjectCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
  const char* const class_like_name = "TestReceiverObjectCallback";
...
v8::Maybe<void> V8TestReceiverObjectCallback::Construct() {
  const char* const class_like_name = "TestReceiverObjectCallback";
...
void V8TestReceiverObjectCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
  v8::Isolate* isolate = GetIsolate();
...
base::expected<void, ScriptValue> V8TestReceiverObjectCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
