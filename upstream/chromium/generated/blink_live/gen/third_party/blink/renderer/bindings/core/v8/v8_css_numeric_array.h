...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_NUMERIC_ARRAY_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_NUMERIC_ARRAY_H_
...
class CORE_EXPORT V8CSSNumericArray final : public bindings::V8InterfaceBridge<V8CSSNumericArray, CSSNumericArray> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(317);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSNumericArray;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_NUMERIC_ARRAY_H_
