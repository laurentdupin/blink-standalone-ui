...
const char* V8WebCodecsErrorCallback::GetHumanReadableName() const {
  return "V8WebCodecsErrorCallback";
}

v8::Maybe<void> V8WebCodecsErrorCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, DOMException* arg1_error) {
  const char* const class_like_name = "WebCodecsErrorCallback";
...
v8::Maybe<void> V8WebCodecsErrorCallback::Construct(DOMException* arg1_error) {
  const char* const class_like_name = "WebCodecsErrorCallback";
...
void V8WebCodecsErrorCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, DOMException* arg1_error) {
  v8::Isolate* isolate = GetIsolate();
...
base::expected<void, ScriptValue> V8WebCodecsErrorCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, DOMException* arg1_error) {
