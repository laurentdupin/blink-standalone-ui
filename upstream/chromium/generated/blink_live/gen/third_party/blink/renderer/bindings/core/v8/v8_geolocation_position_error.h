...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_GEOLOCATION_POSITION_ERROR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_GEOLOCATION_POSITION_ERROR_H_
...
class CORE_EXPORT V8GeolocationPositionError final : public bindings::V8InterfaceBridge<V8GeolocationPositionError, GeolocationPositionError> {
...
class Constant final {
  ...
  public:
static constexpr uint16_t kPermissionDenied = 1;
static constexpr uint16_t kPositionUnavailable = 2;
static constexpr uint16_t kTimeout = 3;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(880);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class GeolocationPositionError;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_GEOLOCATION_POSITION_ERROR_H_
