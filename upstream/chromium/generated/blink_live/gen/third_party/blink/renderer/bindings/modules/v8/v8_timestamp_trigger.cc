...
bool V8TimestampTrigger::IsExposed(ExecutionContext* execution_context) {
  
return (execution_context->IsWindow() || execution_context->IsWorkerGlobalScope()) && RuntimeEnabledFeatures::NotificationTriggersEnabled(execution_context);
}
...
const WrapperTypeInfo V8TimestampTrigger::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8TimestampTrigger::InstallInterfaceTemplate,
    nullptr,
    "TimestampTrigger",
    nullptr,
    V8TimestampTrigger::kThisTag,
    V8TimestampTrigger::kMaxSubclassTag,
...
const WrapperTypeInfo& TimestampTrigger::wrapper_type_info_ =
    V8TimestampTrigger::wrapper_type_info_;
...
namespace v8_timestamp_trigger {
...
BLINK_BINDINGS_TRACE_EVENT("TimestampTrigger.timestamp.get");
...
BLINK_BINDINGS_TRACE_EVENT("TimestampTrigger.constructor");
...
auto&& arg1_timestamp = NativeValueTraits<IDLUnsignedLongLong>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& return_value = TimestampTrigger::Create(arg1_timestamp);
...
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8TimestampTrigger::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_timestamp_trigger;

}  // namespace 

void V8TimestampTrigger::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8TimestampTrigger::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "TimestampTrigger"));
...
void V8TimestampTrigger::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "TimestampTrigger", kAttributeTable);
}
