...
kAdd, kSubtract, kReverseSubtract, kMin, kMax
};
...
explicit constexpr  V8GPUBlendOperation(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
