...
V8RenderingContext* V8RenderingContext::Create(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state) {
...
return MakeGarbageCollected<V8RenderingContext>(blink_value);
}
...
if (V8CanvasRenderingContext2D::HasInstance(isolate, v8_value)) {
  auto&& blink_value = V8CanvasRenderingContext2D::ToWrappableUnsafe(isolate, v8_value.As<v8::Object>());
return MakeGarbageCollected<V8RenderingContext>(blink_value);
}
...
V8UnionWebGL2RenderingContextOrWebGLRenderingContext* V8RenderingContext::GetAsV8UnionWebGL2RenderingContextOrWebGLRenderingContext() const {
...
void V8RenderingContext::Set(const V8UnionWebGL2RenderingContextOrWebGLRenderingContext* value) {
...
v8::Local<v8::Value> V8RenderingContext::ToV8(ScriptState* script_state) const {
  switch (content_type_) {
...
v8::Local<v8::Value> V8RenderingContext::DirectToV8(ScriptState* script_state, CanvasRenderingContext2D* value) {
  return ToV8Traits<CanvasRenderingContext2D>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8RenderingContext::DirectToV8(ScriptState* script_state, GPUCanvasContext* value) {
  return ToV8Traits<GPUCanvasContext>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8RenderingContext::DirectToV8(ScriptState* script_state, ImageBitmapRenderingContext* value) {
  return ToV8Traits<ImageBitmapRenderingContext>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8RenderingContext::DirectToV8(ScriptState* script_state, WebGL2RenderingContext* value) {
  return ToV8Traits<WebGL2RenderingContext>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8RenderingContext::DirectToV8(ScriptState* script_state, WebGL2RenderingContextWebGPU* value) {
  return ToV8Traits<WebGL2RenderingContextWebGPU>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8RenderingContext::DirectToV8(ScriptState* script_state, WebGLRenderingContext* value) {
  return ToV8Traits<WebGLRenderingContext>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8RenderingContext::DirectToV8(ScriptState* script_state, WebGLRenderingContextWebGPU* value) {
  return ToV8Traits<WebGLRenderingContextWebGPU>::ToV8(script_state, value);
}

void V8RenderingContext::Trace(Visitor* visitor) const {
  visitor->Trace(member_canvas_rendering_context_2d_);
