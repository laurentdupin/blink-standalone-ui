...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_APPLY_MIXIN_RULE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_APPLY_MIXIN_RULE_H_
...
class CSSApplyMixinRule;
class ExecutionContext;
struct WrapperTypeInfo;

class CORE_EXPORT V8CSSApplyMixinRule final : public bindings::V8InterfaceBridge<V8CSSApplyMixinRule, CSSApplyMixinRule> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(275);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSApplyMixinRule;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_APPLY_MIXIN_RULE_H_
