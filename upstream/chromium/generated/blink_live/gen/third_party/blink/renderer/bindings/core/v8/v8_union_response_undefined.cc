...
v8::Local<v8::Value> V8UnionResponseOrUndefined::DirectToV8(ScriptState* script_state, Response* value) {
  return ToV8Traits<Response>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionResponseOrUndefined::DirectToV8(ScriptState* script_state, const ToV8UndefinedGenerator& value) {
