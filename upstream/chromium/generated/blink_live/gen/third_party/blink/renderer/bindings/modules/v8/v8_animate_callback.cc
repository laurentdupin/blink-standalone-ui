...
const char* V8AnimateCallback::GetHumanReadableName() const {
  return "V8AnimateCallback";
}

v8::Maybe<void> V8AnimateCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, double arg1_current_time, const V8UnionWorkletAnimationEffectOrWorkletGroupEffect* arg2_effect) {
  const char* const class_like_name = "AnimateCallback";
...
v8::Maybe<void> V8AnimateCallback::Construct(double arg1_current_time, const V8UnionWorkletAnimationEffectOrWorkletGroupEffect* arg2_effect) {
  const char* const class_like_name = "AnimateCallback";
...
void V8AnimateCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, double arg1_current_time, const V8UnionWorkletAnimationEffectOrWorkletGroupEffect* arg2_effect) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = Invoke(arg0_receiver, arg1_current_time, arg2_effect);
}

base::expected<void, ScriptValue> V8AnimateCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, double arg1_current_time, const V8UnionWorkletAnimationEffectOrWorkletGroupEffect* arg2_effect) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_current_time, arg2_effect);
