...
kOutOfMemory, kValidation, kInternal
};
static constexpr size_t kEnumSize = 3;

static V8GPUErrorFilter Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8GPUErrorFilter> Create(const String& value);

explicit constexpr  V8GPUErrorFilter(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8GPUErrorFilter& lhs, V8GPUErrorFilter::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8GPUErrorFilter::Enum lhs, const V8GPUErrorFilter& rhs) {
