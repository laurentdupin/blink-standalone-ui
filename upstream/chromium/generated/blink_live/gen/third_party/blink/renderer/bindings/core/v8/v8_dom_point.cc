...
bool V8DOMPoint::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow() || execution_context->IsWorkerGlobalScope();
}

static_assert(std::derived_from<DOMPoint, DOMPointReadOnly>);
...
const WrapperTypeInfo V8DOMPoint::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8DOMPoint::InstallInterfaceTemplate,
    nullptr,
    "DOMPoint",
    V8DOMPointReadOnly::GetWrapperTypeInfo(),
    V8DOMPoint::kThisTag,
    V8DOMPoint::kMaxSubclassTag,
...
const WrapperTypeInfo& DOMPoint::wrapper_type_info_ =
    V8DOMPoint::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, DOMPoint>::value,
    "DOMPoint inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_dom_point {
...
BLINK_BINDINGS_TRACE_EVENT("DOMPoint.x.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
DOMPoint* blink_receiver = V8DOMPoint::ToWrappableUnsafe(isolate, v8_receiver);
...
BLINK_BINDINGS_TRACE_EVENT("DOMPoint.x.set");
...
BLINK_BINDINGS_TRACE_EVENT("DOMPoint.y.get");
...
BLINK_BINDINGS_TRACE_EVENT("DOMPoint.y.set");
...
BLINK_BINDINGS_TRACE_EVENT("DOMPoint.z.get");
...
BLINK_BINDINGS_TRACE_EVENT("DOMPoint.z.set");
...
blink_receiver->setZ(arg1_value);
...
BLINK_BINDINGS_TRACE_EVENT("DOMPoint.w.get");
...
BLINK_BINDINGS_TRACE_EVENT("DOMPoint.w.set");
...
decltype(NativeValueTraits<IDLUnrestrictedDouble>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg4_w{1};
...
auto&& return_value = DOMPoint::Create(arg1_x, arg2_y, arg3_z, arg4_w);
...
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8DOMPoint::GetWrapperTypeInfo(), v8_receiver);
...
BLINK_BINDINGS_TRACE_EVENT("DOMPoint.fromPoint");
...
auto&& return_value = DOMPoint::fromPoint(arg1_other);
static_assert(bindings::IsReturnTypeCompatible<DOMPoint, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
using namespace v8_dom_point;

}  // namespace 

void V8DOMPoint::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8DOMPoint::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "DOMPoint"));
...
void V8DOMPoint::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "DOMPoint", kAttributeTable);
}
...
{"fromPoint", FromPointStaticOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kInterface), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kDoNotCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kDoNotCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
};
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "DOMPoint", kOperationTable);
}
