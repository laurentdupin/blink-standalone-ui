...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_COMPUTE_PIPELINE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_COMPUTE_PIPELINE_H_
...
class MODULES_EXPORT V8GPUComputePipeline final : public bindings::V8InterfaceBridge<V8GPUComputePipeline, GPUComputePipeline> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1380);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class GPUComputePipeline;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_COMPUTE_PIPELINE_H_
