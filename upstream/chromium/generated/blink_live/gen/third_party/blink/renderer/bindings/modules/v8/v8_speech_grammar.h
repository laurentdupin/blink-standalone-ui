...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SPEECH_GRAMMAR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SPEECH_GRAMMAR_H_
...
class MODULES_EXPORT V8SpeechGrammar final : public bindings::V8InterfaceBridge<V8SpeechGrammar, SpeechGrammar> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1261);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SpeechGrammar;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SPEECH_GRAMMAR_H_
