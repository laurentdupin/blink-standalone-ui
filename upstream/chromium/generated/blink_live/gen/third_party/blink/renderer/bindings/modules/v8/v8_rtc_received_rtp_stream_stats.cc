...
if (hasPacketsReportedAsLost()) {
  values[5] = ToV8Traits<IDLUnsignedLongLong>::ToV8(script_state, member_packets_reported_as_lost_);
DCHECK(!values[5].IsEmpty());
}
if (hasPacketsReportedAsLostButRecovered()) {
  values[6] = ToV8Traits<IDLUnsignedLongLong>::ToV8(script_state, member_packets_reported_as_lost_but_recovered_);
...
dictionary_from_v8_context.SetCurrentPropertyName("packetsReportedAsLost");
if (!bindings::GetDictionaryMemberFromV8Object<IDLUnsignedLongLong, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[5].Get(isolate), has_packets_reported_as_lost_, member_packets_reported_as_lost_, class_like_name, exception_state)) {
  return;
}
dictionary_from_v8_context.SetCurrentPropertyName("packetsReportedAsLostButRecovered");
if (!bindings::GetDictionaryMemberFromV8Object<IDLUnsignedLongLong, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[6].Get(isolate), has_packets_reported_as_lost_but_recovered_, member_packets_reported_as_lost_but_recovered_, class_like_name, exception_state)) {
  return;
}
}
