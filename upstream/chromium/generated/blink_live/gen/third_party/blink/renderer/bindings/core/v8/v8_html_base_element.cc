...
bool V8HTMLBaseElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<HTMLBaseElement, HTMLElement>);
...
const WrapperTypeInfo V8HTMLBaseElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8HTMLBaseElement::InstallInterfaceTemplate,
    nullptr,
    "HTMLBaseElement",
    V8HTMLElement::GetWrapperTypeInfo(),
    V8HTMLBaseElement::kThisTag,
    V8HTMLBaseElement::kMaxSubclassTag,
...
const WrapperTypeInfo& HTMLBaseElement::wrapper_type_info_ =
    V8HTMLBaseElement::wrapper_type_info_;
...
namespace v8_html_base_element {
...
BLINK_BINDINGS_TRACE_EVENT("HTMLBaseElement.href.get");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLBaseElement.href.set");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLBaseElement.target.get");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLBaseElement.target.set");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLBaseElement.constructor");
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLBaseElement::GetWrapperTypeInfo(), ElementType::kHTMLBaseElement);
}


}  // namespace v8_html_base_element

using namespace v8_html_base_element;

}  // namespace 

void V8HTMLBaseElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8HTMLBaseElement::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "HTMLBaseElement"));
...
void V8HTMLBaseElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLBaseElement", kAttributeTable);
}
