...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_DRAW_BUFFERS_INDEXED_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_DRAW_BUFFERS_INDEXED_H_
...
class MODULES_EXPORT V8OESDrawBuffersIndexed final : public bindings::V8InterfaceBridge<V8OESDrawBuffersIndexed, OESDrawBuffersIndexed> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1313);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OES_DRAW_BUFFERS_INDEXED_H_
