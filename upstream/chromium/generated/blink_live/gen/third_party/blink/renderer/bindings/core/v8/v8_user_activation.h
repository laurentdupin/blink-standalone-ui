...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_USER_ACTIVATION_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_USER_ACTIVATION_H_
...
class CORE_EXPORT V8UserActivation final : public bindings::V8InterfaceBridge<V8UserActivation, UserActivation> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(875);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class UserActivation;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_USER_ACTIVATION_H_
