...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BLUETOOTH_MANUFACTURER_DATA_MAP_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BLUETOOTH_MANUFACTURER_DATA_MAP_H_
...
class MODULES_EXPORT V8BluetoothManufacturerDataMap final : public bindings::V8InterfaceBridge<V8BluetoothManufacturerDataMap, BluetoothManufacturerDataMap> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1091);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class BluetoothManufacturerDataMap;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BLUETOOTH_MANUFACTURER_DATA_MAP_H_
