...
class MODULES_EXPORT V8TextDecoderStream final : public bindings::V8InterfaceBridge<V8TextDecoderStream, TextDecoderStream> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1142);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class TextDecoderStream;
};
