...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TEXT_CLUSTER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TEXT_CLUSTER_H_
...
class CORE_EXPORT V8TextCluster final : public bindings::V8InterfaceBridge<V8TextCluster, TextCluster> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(893);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class TextCluster;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TEXT_CLUSTER_H_
