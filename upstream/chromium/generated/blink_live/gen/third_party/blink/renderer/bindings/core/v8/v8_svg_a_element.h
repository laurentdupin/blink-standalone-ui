...
class CORE_EXPORT V8SVGAElement final : public bindings::V8InterfaceBridge<V8SVGAElement, SVGAElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(715);
