...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_SCOPE_RULE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_SCOPE_RULE_H_
...
class CORE_EXPORT V8CSSScopeRule final : public bindings::V8InterfaceBridge<V8CSSScopeRule, CSSScopeRule> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(294);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSScopeRule;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_SCOPE_RULE_H_
