...
class CORE_EXPORT V8HTMLFrameSetElement final : public bindings::V8InterfaceBridge<V8HTMLFrameSetElement, HTMLFrameSetElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(616);
