...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_INTERNALS_UKM_RECORDER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_INTERNALS_UKM_RECORDER_H_
...
class  V8InternalsUkmRecorder final : public bindings::V8InterfaceBridge<V8InternalsUkmRecorder, InternalsUkmRecorder> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1057);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class InternalsUkmRecorder;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_INTERNALS_UKM_RECORDER_H_
