...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_DISJOINT_TIMER_QUERY_WEBGL2_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_DISJOINT_TIMER_QUERY_WEBGL2_H_
...
class MODULES_EXPORT V8EXTDisjointTimerQueryWebGL2 final : public bindings::V8InterfaceBridge<V8EXTDisjointTimerQueryWebGL2, EXTDisjointTimerQueryWebGL2> {
...
class Constant final {
  ...
  public:
static constexpr uint32_t kQueryCounterBitsExt = 0x8864;
static constexpr uint32_t kTimeElapsedExt = 0x88BF;
static constexpr uint32_t kTimestampExt = 0x8E28;
static constexpr uint32_t kGpuDisjointExt = 0x8FBB;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1299);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_DISJOINT_TIMER_QUERY_WEBGL2_H_
