...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_SCALE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_SCALE_H_
...
class CORE_EXPORT V8CSSScale final : public bindings::V8InterfaceBridge<V8CSSScale, CSSScale> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(339);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSScale;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_SCALE_H_
