...
const char* V8Visitor::GetHumanReadableName() const {
  return "V8Visitor";
}

v8::Maybe<void> V8Visitor::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const ScriptValue& arg1_element, uint64_t arg2_index) {
  const char* const class_like_name = "Visitor";
...
v8::Maybe<void> V8Visitor::Construct(const ScriptValue& arg1_element, uint64_t arg2_index) {
  const char* const class_like_name = "Visitor";
...
void V8Visitor::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const ScriptValue& arg1_element, uint64_t arg2_index) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = Invoke(arg0_receiver, arg1_element, arg2_index);
}

base::expected<void, ScriptValue> V8Visitor::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const ScriptValue& arg1_element, uint64_t arg2_index) {
