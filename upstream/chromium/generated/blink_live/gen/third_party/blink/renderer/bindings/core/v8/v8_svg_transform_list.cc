...
const WrapperTypeInfo V8SVGTransformList::wrapper_type_info_{
    ...
    "SVGTransformList",
    nullptr,
    V8SVGTransformList::kThisTag,
    V8SVGTransformList::kMaxSubclassTag,
...
v8::Intercepted V8SVGTransformList::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
SVGTransformListTearOff* blink_receiver = V8SVGTransformList::ToWrappableUnsafe(isolate, v8_receiver);
...
v8::Intercepted V8SVGTransformList::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
...
v8::Intercepted V8SVGTransformList::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
...
v8::Intercepted V8SVGTransformList::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
...
return V8SVGTransformList::IndexedPropertySetterCallback(
    index,
...
v8::Intercepted V8SVGTransformList::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
static_assert(bindings::IsReturnTypeCompatible<IDLNullable<SVGTransformTearOff>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
bindings::V8SetReturnValue(info, return_value, blink_receiver);
...
void V8SVGTransformList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGTransformList", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGTransformList", kOperationTable);
}
