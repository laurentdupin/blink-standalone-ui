...
bool V8InspectorOverlayHost::IsExposed(ExecutionContext* execution_context) {
  return false;
}
...
const WrapperTypeInfo V8InspectorOverlayHost::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8InspectorOverlayHost::InstallInterfaceTemplate,
    V8InspectorOverlayHost::InstallContextDependentProperties,
    "InspectorOverlayHost",
    nullptr,
    V8InspectorOverlayHost::kThisTag,
    V8InspectorOverlayHost::kMaxSubclassTag,
...
const WrapperTypeInfo& InspectorOverlayHost::wrapper_type_info_ =
    V8InspectorOverlayHost::wrapper_type_info_;
...
namespace v8_inspector_overlay_host {
...
BLINK_BINDINGS_TRACE_EVENT("InspectorOverlayHost.send");
...
blink_receiver->send(arg1_command);
...
using namespace v8_inspector_overlay_host;

}  // namespace 

void V8InspectorOverlayHost::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8InspectorOverlayHost::GetWrapperTypeInfo();
...
void V8InspectorOverlayHost::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "InspectorOverlayHost", kOperationTable);
}
...
void V8InspectorOverlayHost::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object, v8::Local<v8::Object> prototype_object, v8::Local<v8::Object> interface_object, v8::Local<v8::Template> interface_template, FeatureSelector feature_selector) {
  using bindings::IDLMemberInstaller;
