...
const char* V8CreateScriptCallback::GetHumanReadableName() const {
  return "V8CreateScriptCallback";
}

v8::Maybe<String> V8CreateScriptCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const String& arg1_input, const HeapVector<ScriptValue>& arg2_args) {
  const char* const class_like_name = "CreateScriptCallback";
...
v8::Maybe<String> V8CreateScriptCallback::Construct(const String& arg1_input, const HeapVector<ScriptValue>& arg2_args) {
  const char* const class_like_name = "CreateScriptCallback";
...
base::expected<String, ScriptValue> V8CreateScriptCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const String& arg1_input, const HeapVector<ScriptValue>& arg2_args) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_input, arg2_args);
