...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_COUNTER_STYLE_RULE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_COUNTER_STYLE_RULE_H_
...
class CORE_EXPORT V8CSSCounterStyleRule final : public bindings::V8InterfaceBridge<V8CSSCounterStyleRule, CSSCounterStyleRule> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(277);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSCounterStyleRule;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_COUNTER_STYLE_RULE_H_
