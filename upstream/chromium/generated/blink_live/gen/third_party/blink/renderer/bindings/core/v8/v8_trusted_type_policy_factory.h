...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TRUSTED_TYPE_POLICY_FACTORY_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TRUSTED_TYPE_POLICY_FACTORY_H_
...
class CORE_EXPORT V8TrustedTypePolicyFactory final : public bindings::V8InterfaceBridge<V8TrustedTypePolicyFactory, TrustedTypePolicyFactory> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1025);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class TrustedTypePolicyFactory;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_TRUSTED_TYPE_POLICY_FACTORY_H_
