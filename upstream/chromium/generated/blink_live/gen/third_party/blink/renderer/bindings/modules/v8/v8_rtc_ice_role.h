...
kControlling, kControlled
};
static constexpr size_t kEnumSize = 2;

static V8RTCIceRole Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8RTCIceRole> Create(const String& value);

explicit constexpr  V8RTCIceRole(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
