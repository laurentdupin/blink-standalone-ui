...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PERFORMANCE_OBSERVER_ENTRY_LIST_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PERFORMANCE_OBSERVER_ENTRY_LIST_H_
...
class CORE_EXPORT V8PerformanceObserverEntryList final : public bindings::V8InterfaceBridge<V8PerformanceObserverEntryList, PerformanceObserverEntryList> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1014);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PerformanceObserverEntryList;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PERFORMANCE_OBSERVER_ENTRY_LIST_H_
