...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CONTENT_VISIBILITY_AUTO_STATE_CHANGE_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CONTENT_VISIBILITY_AUTO_STATE_CHANGE_EVENT_H_
...
class CORE_EXPORT V8ContentVisibilityAutoStateChangeEvent final : public bindings::V8InterfaceBridge<V8ContentVisibilityAutoStateChangeEvent, ContentVisibilityAutoStateChangeEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(389);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class ContentVisibilityAutoStateChangeEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CONTENT_VISIBILITY_AUTO_STATE_CHANGE_EVENT_H_
