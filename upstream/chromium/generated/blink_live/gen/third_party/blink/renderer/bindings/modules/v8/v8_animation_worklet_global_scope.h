...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ANIMATION_WORKLET_GLOBAL_SCOPE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ANIMATION_WORKLET_GLOBAL_SCOPE_H_
...
class MODULES_EXPORT V8AnimationWorkletGlobalScope final : public bindings::V8InterfaceBridge<V8AnimationWorkletGlobalScope, AnimationWorkletGlobalScope> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1039);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class AnimationWorkletGlobalScope;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_ANIMATION_WORKLET_GLOBAL_SCOPE_H_
