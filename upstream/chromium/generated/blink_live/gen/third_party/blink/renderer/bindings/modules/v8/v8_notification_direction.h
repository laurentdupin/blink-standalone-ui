...
class MODULES_EXPORT V8NotificationDirection final : public bindings::EnumerationBase {
...
static V8NotificationDirection Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8NotificationDirection> Create(const String& value);

explicit constexpr  V8NotificationDirection(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8NotificationDirection& lhs, V8NotificationDirection::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8NotificationDirection::Enum lhs, const V8NotificationDirection& rhs) {
