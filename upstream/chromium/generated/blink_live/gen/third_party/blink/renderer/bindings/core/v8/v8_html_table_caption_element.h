...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_TABLE_CAPTION_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_TABLE_CAPTION_ELEMENT_H_
...
class CORE_EXPORT V8HTMLTableCaptionElement final : public bindings::V8InterfaceBridge<V8HTMLTableCaptionElement, HTMLTableCaptionElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(661);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class HTMLTableCaptionElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_TABLE_CAPTION_ELEMENT_H_
