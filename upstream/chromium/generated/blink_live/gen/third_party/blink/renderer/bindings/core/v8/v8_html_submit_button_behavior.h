...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_SUBMIT_BUTTON_BEHAVIOR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_SUBMIT_BUTTON_BEHAVIOR_H_
...
class CORE_EXPORT V8HTMLSubmitButtonBehavior final : public bindings::V8InterfaceBridge<V8HTMLSubmitButtonBehavior, HTMLSubmitButtonBehavior> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(901);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class HTMLSubmitButtonBehavior;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_SUBMIT_BUTTON_BEHAVIOR_H_
