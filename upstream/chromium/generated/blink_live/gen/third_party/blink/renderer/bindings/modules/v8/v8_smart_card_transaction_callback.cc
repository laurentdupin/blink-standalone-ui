...
base::expected<ScriptPromise<IDLNullable<V8SmartCardDisposition>>, ScriptValue> V8SmartCardTransactionCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
