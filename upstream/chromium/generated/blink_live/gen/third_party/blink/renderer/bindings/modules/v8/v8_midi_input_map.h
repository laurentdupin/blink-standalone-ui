...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MIDI_INPUT_MAP_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MIDI_INPUT_MAP_H_
...
class MODULES_EXPORT V8MIDIInputMap final : public bindings::V8InterfaceBridge<V8MIDIInputMap, MIDIInputMap> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1403);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class MIDIInputMap;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MIDI_INPUT_MAP_H_
