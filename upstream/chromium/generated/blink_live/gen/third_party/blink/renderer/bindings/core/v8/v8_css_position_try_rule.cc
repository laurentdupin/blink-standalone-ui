...
bool V8CSSPositionTryRule::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<CSSPositionTryRule, CSSRule>);
...
const WrapperTypeInfo V8CSSPositionTryRule::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8CSSPositionTryRule::InstallInterfaceTemplate,
    nullptr,
    "CSSPositionTryRule",
    V8CSSRule::GetWrapperTypeInfo(),
    V8CSSPositionTryRule::kThisTag,
    V8CSSPositionTryRule::kMaxSubclassTag,
...
const WrapperTypeInfo& CSSPositionTryRule::wrapper_type_info_ =
    V8CSSPositionTryRule::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, CSSPositionTryRule>::value,
    "CSSPositionTryRule inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_css_position_try_rule {


void NameAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSPositionTryRule_name_Getter");
BLINK_BINDINGS_TRACE_EVENT("CSSPositionTryRule.name.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
CSSPositionTryRule* blink_receiver = V8CSSPositionTryRule::ToWrappableUnsafe(isolate, v8_receiver);
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSPositionTryRule_style_Getter");
BLINK_BINDINGS_TRACE_EVENT("CSSPositionTryRule.style.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSPositionTryRule_style_Setter");
BLINK_BINDINGS_TRACE_EVENT("CSSPositionTryRule.style.set");
...
using namespace v8_css_position_try_rule;

}  // namespace 

void V8CSSPositionTryRule::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8CSSPositionTryRule::GetWrapperTypeInfo();
...
void V8CSSPositionTryRule::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "CSSPositionTryRule", kAttributeTable);
}
