...
bool hasProcessingInstructions() const {
  return has_processing_instructions_;
}
const HeapVector<Member<V8UnionSanitizerProcessingInstructionOrString>>& processingInstructions() const {
  DCHECK(hasProcessingInstructions());
return member_processing_instructions_;
}
HeapVector<Member<V8UnionSanitizerProcessingInstructionOrString>> getProcessingInstructionsOr(const HeapVector<Member<V8UnionSanitizerProcessingInstructionOrString>>& fallback_value) const;
HeapVector<Member<V8UnionSanitizerProcessingInstructionOrString>> getProcessingInstructionsOr(HeapVector<Member<V8UnionSanitizerProcessingInstructionOrString>>&& fallback_value) const;
void setProcessingInstructions(const HeapVector<Member<V8UnionSanitizerProcessingInstructionOrString>>& value);
void setProcessingInstructions(HeapVector<Member<V8UnionSanitizerProcessingInstructionOrString>>&& value);
...
bool hasRemoveProcessingInstructions() const {
  return has_remove_processing_instructions_;
}
const HeapVector<Member<V8UnionSanitizerProcessingInstructionOrString>>& removeProcessingInstructions() const {
  DCHECK(hasRemoveProcessingInstructions());
return member_remove_processing_instructions_;
}
HeapVector<Member<V8UnionSanitizerProcessingInstructionOrString>> getRemoveProcessingInstructionsOr(const HeapVector<Member<V8UnionSanitizerProcessingInstructionOrString>>& fallback_value) const;
HeapVector<Member<V8UnionSanitizerProcessingInstructionOrString>> getRemoveProcessingInstructionsOr(HeapVector<Member<V8UnionSanitizerProcessingInstructionOrString>>&& fallback_value) const;
void setRemoveProcessingInstructions(const HeapVector<Member<V8UnionSanitizerProcessingInstructionOrString>>& value);
void setRemoveProcessingInstructions(HeapVector<Member<V8UnionSanitizerProcessingInstructionOrString>>&& value);
