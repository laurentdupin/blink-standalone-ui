...
using Ret = bindings::OptimizedReturnProxy<V8UnionElementOrHTMLCollection>;
...
static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, HTMLCollection* value);
