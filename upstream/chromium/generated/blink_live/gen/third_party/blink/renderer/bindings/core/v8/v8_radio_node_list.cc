...
static_assert(std::derived_from<RadioNodeList, NodeList>);
...
const WrapperTypeInfo& RadioNodeList::wrapper_type_info_ =
    V8RadioNodeList::wrapper_type_info_;
...
v8::Intercepted V8RadioNodeList::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
...
v8::Intercepted V8RadioNodeList::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
...
instance_template->SetHandler(
    v8::IndexedPropertyHandlerConfiguration(
        ...
        nullptr,  // query
        V8RadioNodeList::IndexedPropertyDeleterCallback,
        V8RadioNodeList::IndexedPropertyEnumeratorCallback,
...
void V8RadioNodeList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "RadioNodeList", kAttributeTable);
}
