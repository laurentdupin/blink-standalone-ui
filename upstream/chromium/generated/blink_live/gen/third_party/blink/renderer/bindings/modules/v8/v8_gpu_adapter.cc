...
bool V8GPUAdapter::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8GPUAdapter::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8GPUAdapter::InstallInterfaceTemplate,
    nullptr,
    "GPUAdapter",
    nullptr,
    V8GPUAdapter::kThisTag,
    V8GPUAdapter::kMaxSubclassTag,
...
const WrapperTypeInfo& GPUAdapter::wrapper_type_info_ =
    V8GPUAdapter::wrapper_type_info_;
...
namespace v8_gpu_adapter {


void FeaturesAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_GPUAdapter_features_Getter");
BLINK_BINDINGS_TRACE_EVENT("GPUAdapter.features.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_GPUAdapter_limits_Getter");
BLINK_BINDINGS_TRACE_EVENT("GPUAdapter.limits.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_GPUAdapter_info_Getter");
BLINK_BINDINGS_TRACE_EVENT("GPUAdapter.info.get");
...
BLINK_BINDINGS_TRACE_EVENT("GPUAdapter.requestDevice");
// Promise returning function: Convert a TypeError to a reject promise.
ExceptionToRejectPromiseScope reject_promise_scope(info);

v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
if (!V8GPUAdapter::HasInstance(isolate, v8_receiver)) {
...
if (info[0]->IsUndefined()) {
  arg1_descriptor = GPUDeviceDescriptor::Create();
} else {
  const v8::ExceptionContext exception_context_type = v8::ExceptionContext::kOperation;
const char* const class_like_name = "GPUAdapter";
...
arg1_descriptor = NativeValueTraits<GPUDeviceDescriptor>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
}
auto&& return_value = blink_receiver->requestDevice(script_state, arg1_descriptor);
static_assert(bindings::IsReturnTypeCompatible<IDLPromise<GPUDevice>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
using namespace v8_gpu_adapter;

}  // namespace 

void V8GPUAdapter::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8GPUAdapter::GetWrapperTypeInfo();
...
void V8GPUAdapter::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "GPUAdapter", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "GPUAdapter", kOperationTable);
}
