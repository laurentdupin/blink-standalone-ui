...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DEVICE_MOTION_EVENT_ROTATION_RATE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DEVICE_MOTION_EVENT_ROTATION_RATE_H_
...
class MODULES_EXPORT V8DeviceMotionEventRotationRate final : public bindings::V8InterfaceBridge<V8DeviceMotionEventRotationRate, DeviceMotionEventRotationRate> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1140);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class DeviceMotionEventRotationRate;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DEVICE_MOTION_EVENT_ROTATION_RATE_H_
