...
static_assert(std::derived_from<HTMLTextAreaElement, HTMLElement>);
...
const WrapperTypeInfo V8HTMLTextAreaElement::wrapper_type_info_{
    ...
    V8HTMLTextAreaElement::InstallContextDependentProperties,
    "HTMLTextAreaElement",
...
bindings::PerformAttributeSetCEReactionsReflectTypeString(info, html_names::kWrapAttr);
}
...
if (script_state->World().IsIsolatedWorld() && per_context_data && per_context_data->ActivityLogger()) [[unlikely]] { per_context_data->ActivityLogger()->LogGetter(script_state, "HTMLTextAreaElement.value"); }
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLTextAreaElement::GetWrapperTypeInfo(), ElementType::kHTMLTextAreaElement);
}
...
void CreateValueRangeOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLTextAreaElement_createValueRange");
BLINK_BINDINGS_TRACE_EVENT("HTMLTextAreaElement.createValueRange");
...
void V8HTMLTextAreaElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLTextAreaElement", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLTextAreaElement", kOperationTable);
}
...
void V8HTMLTextAreaElement::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object, v8::Local<v8::Object> prototype_object, v8::Local<v8::Object> interface_object, v8::Local<v8::Template> interface_template, FeatureSelector feature_selector) {
  using bindings::IDLMemberInstaller;
...
v8::Local<v8::Signature> signature = v8::Local<v8::Signature>::Cast(interface_template);
IDLMemberInstaller::InstallOperations(isolate, world, instance_object, prototype_object, interface_object, signature, "HTMLTextAreaElement", kOperationTable);
}
