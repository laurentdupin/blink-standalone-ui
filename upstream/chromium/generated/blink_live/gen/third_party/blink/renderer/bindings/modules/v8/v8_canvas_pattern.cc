...
bool V8CanvasPattern::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8CanvasPattern::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8CanvasPattern::InstallInterfaceTemplate,
    nullptr,
    "CanvasPattern",
    nullptr,
    V8CanvasPattern::kThisTag,
    V8CanvasPattern::kMaxSubclassTag,
...
const WrapperTypeInfo& CanvasPattern::wrapper_type_info_ =
    V8CanvasPattern::wrapper_type_info_;
...
BLINK_BINDINGS_TRACE_EVENT("CanvasPattern.setTransform");
...
if (info[0]->IsUndefined()) {
  arg1_transform = DOMMatrix2DInit::Create();
} else {
  arg1_transform = NativeValueTraits<DOMMatrix2DInit>::ArgumentValue(isolate, 0, info[0], exception_state);
...
using namespace v8_canvas_pattern;

}  // namespace 

void V8CanvasPattern::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8CanvasPattern::GetWrapperTypeInfo();
...
void V8CanvasPattern::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "CanvasPattern", kOperationTable);
}
