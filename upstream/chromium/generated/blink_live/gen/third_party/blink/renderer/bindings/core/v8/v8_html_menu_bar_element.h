...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_MENU_BAR_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_MENU_BAR_ELEMENT_H_
...
class CORE_EXPORT V8HTMLMenuBarElement final : public bindings::V8InterfaceBridge<V8HTMLMenuBarElement, HTMLMenuBarElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(636);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class HTMLMenuBarElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_HTML_MENU_BAR_ELEMENT_H_
