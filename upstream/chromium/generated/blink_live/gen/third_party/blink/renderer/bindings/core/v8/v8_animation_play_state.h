...
kIdle, kPending, kRunning, kPaused, kFinished
};
...
explicit constexpr  V8AnimationPlayState(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
