...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_RECEIVED_PACKET_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_RECEIVED_PACKET_H_
...
class RtcReceivedPacket;
struct WrapperTypeInfo;

class MODULES_EXPORT V8RtcReceivedPacket final : public bindings::V8InterfaceBridge<V8RtcReceivedPacket, RtcReceivedPacket> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1227);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class RtcReceivedPacket;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_RECEIVED_PACKET_H_
