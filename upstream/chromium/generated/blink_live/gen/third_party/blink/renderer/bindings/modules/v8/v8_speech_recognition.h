...
class MODULES_EXPORT V8SpeechRecognition final : public bindings::V8InterfaceBridge<V8SpeechRecognition, SpeechRecognition> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(791);
