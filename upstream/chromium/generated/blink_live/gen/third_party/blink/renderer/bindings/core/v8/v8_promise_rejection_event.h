...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PROMISE_REJECTION_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PROMISE_REJECTION_EVENT_H_
...
class CORE_EXPORT V8PromiseRejectionEvent final : public bindings::V8InterfaceBridge<V8PromiseRejectionEvent, PromiseRejectionEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(448);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PromiseRejectionEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PROMISE_REJECTION_EVENT_H_
