...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_REWRITER_CREATE_OPTIONS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_REWRITER_CREATE_OPTIONS_H_
...
class MODULES_EXPORT RewriterCreateOptions : public RewriterCreateCoreOptions {
  
  public:
static RewriterCreateOptions* Create() {
  return MakeGarbageCollected<RewriterCreateOptions>();
}
static RewriterCreateOptions* Create(v8::Isolate* isolate) {
  return MakeGarbageCollected<RewriterCreateOptions>(isolate);
}
static RewriterCreateOptions* Create(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state);

explicit  RewriterCreateOptions();
explicit  RewriterCreateOptions(v8::Isolate* isolate);
...
void Trace(Visitor* visitor) const override;
  ...
  protected:
static constexpr size_t kBasePropertyCount = RewriterCreateCoreOptions::kTotalPropertyCount;
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_REWRITER_CREATE_OPTIONS_H_
