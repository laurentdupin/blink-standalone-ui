...
class  V8HitTestLayerRect final : public bindings::V8InterfaceBridge<V8HitTestLayerRect, HitTestLayerRect> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1054);
