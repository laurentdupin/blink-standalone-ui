...
bool V8GPUOutOfMemoryError::IsExposed(ExecutionContext* execution_context) {
  
const bool is_in_secure_context = execution_context->IsSecureContext();
return is_in_secure_context && (execution_context->IsWindow() || execution_context->IsWorkerGlobalScope());
}

static_assert(std::derived_from<GPUOutOfMemoryError, GPUError>);
...
const WrapperTypeInfo V8GPUOutOfMemoryError::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8GPUOutOfMemoryError::InstallInterfaceTemplate,
    nullptr,
    "GPUOutOfMemoryError",
    V8GPUError::GetWrapperTypeInfo(),
    V8GPUOutOfMemoryError::kThisTag,
    V8GPUOutOfMemoryError::kMaxSubclassTag,
...
const WrapperTypeInfo& GPUOutOfMemoryError::wrapper_type_info_ =
    V8GPUOutOfMemoryError::wrapper_type_info_;
...
auto&& return_value = GPUOutOfMemoryError::Create(arg1_message);
static_assert(bindings::IsReturnTypeCompatible<GPUOutOfMemoryError, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8GPUOutOfMemoryError::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_gpu_out_of_memory_error;

}  // namespace 

void V8GPUOutOfMemoryError::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8GPUOutOfMemoryError::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "GPUOutOfMemoryError"));
