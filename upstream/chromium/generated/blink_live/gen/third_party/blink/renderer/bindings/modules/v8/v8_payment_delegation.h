...
kShippingAddress, kPayerName, kPayerPhone, kPayerEmail
};
...
explicit constexpr  V8PaymentDelegation(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
