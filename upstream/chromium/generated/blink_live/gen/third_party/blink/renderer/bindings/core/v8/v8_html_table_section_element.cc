...
bool V8HTMLTableSectionElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<HTMLTableSectionElement, HTMLElement>);
...
const WrapperTypeInfo V8HTMLTableSectionElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8HTMLTableSectionElement::InstallInterfaceTemplate,
    nullptr,
    "HTMLTableSectionElement",
    V8HTMLElement::GetWrapperTypeInfo(),
    V8HTMLTableSectionElement::kThisTag,
    V8HTMLTableSectionElement::kMaxSubclassTag,
...
const WrapperTypeInfo& HTMLTableSectionElement::wrapper_type_info_ =
    V8HTMLTableSectionElement::wrapper_type_info_;
...
namespace v8_html_table_section_element {
...
BLINK_BINDINGS_TRACE_EVENT("HTMLTableSectionElement.rows.get");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLTableSectionElement.align.get");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLTableSectionElement.align.set");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLTableSectionElement.ch.get");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLTableSectionElement.ch.set");

bindings::PerformAttributeSetCEReactionsReflectTypeString(info, html_names::kCharAttr);
}
...
BLINK_BINDINGS_TRACE_EVENT("HTMLTableSectionElement.chOff.get");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLTableSectionElement.chOff.set");

bindings::PerformAttributeSetCEReactionsReflectTypeString(info, html_names::kCharoffAttr);
}
...
BLINK_BINDINGS_TRACE_EVENT("HTMLTableSectionElement.vAlign.get");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLTableSectionElement.vAlign.set");

bindings::PerformAttributeSetCEReactionsReflectTypeString(info, html_names::kValignAttr);
}

void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLTableSectionElement_constructor");
BLINK_BINDINGS_TRACE_EVENT("HTMLTableSectionElement.constructor");
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLTableSectionElement::GetWrapperTypeInfo(), ElementType::kHTMLTableSectionElement);
}
...
static_assert(bindings::IsReturnTypeCompatible<HTMLElement, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
bindings::V8SetReturnValue(info, return_value, blink_receiver);
...
using namespace v8_html_table_section_element;

}  // namespace 

void V8HTMLTableSectionElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8HTMLTableSectionElement::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "HTMLTableSectionElement"));
...
void V8HTMLTableSectionElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLTableSectionElement", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLTableSectionElement", kOperationTable);
}
