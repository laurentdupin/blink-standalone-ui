...
class MODULES_EXPORT V8ServiceWorkerContainer final : public bindings::V8InterfaceBridge<V8ServiceWorkerContainer, ServiceWorkerContainer> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(786);
