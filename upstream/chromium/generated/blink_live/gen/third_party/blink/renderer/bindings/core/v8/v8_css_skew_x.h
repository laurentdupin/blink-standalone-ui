...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_SKEW_X_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_SKEW_X_H_
...
class CORE_EXPORT V8CSSSkewX final : public bindings::V8InterfaceBridge<V8CSSSkewX, CSSSkewX> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(341);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSSkewX;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_SKEW_X_H_
