...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BROWSER_CAPTURE_MEDIA_STREAM_TRACK_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BROWSER_CAPTURE_MEDIA_STREAM_TRACK_H_
...
class MODULES_EXPORT V8BrowserCaptureMediaStreamTrack final : public bindings::V8InterfaceBridge<V8BrowserCaptureMediaStreamTrack, BrowserCaptureMediaStreamTrack> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(568);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class BrowserCaptureMediaStreamTrack;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BROWSER_CAPTURE_MEDIA_STREAM_TRACK_H_
