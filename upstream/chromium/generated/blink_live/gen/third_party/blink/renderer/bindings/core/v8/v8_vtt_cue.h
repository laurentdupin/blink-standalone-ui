...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_VTT_CUE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_VTT_CUE_H_
...
class CORE_EXPORT V8VTTCue final : public bindings::V8InterfaceBridge<V8VTTCue, VTTCue> {
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_VTT_CUE_H_
