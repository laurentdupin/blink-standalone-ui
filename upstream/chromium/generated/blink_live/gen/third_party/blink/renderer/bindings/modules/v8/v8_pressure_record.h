...
class MODULES_EXPORT V8PressureRecord final : public bindings::V8InterfaceBridge<V8PressureRecord, PressureRecord> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1465);
