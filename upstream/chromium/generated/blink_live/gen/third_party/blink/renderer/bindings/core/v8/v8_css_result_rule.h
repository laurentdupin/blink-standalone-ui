...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_RESULT_RULE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_RESULT_RULE_H_
...
class CORE_EXPORT V8CSSResultRule final : public bindings::V8InterfaceBridge<V8CSSResultRule, CSSResultRule> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(293);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSResultRule;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_RESULT_RULE_H_
