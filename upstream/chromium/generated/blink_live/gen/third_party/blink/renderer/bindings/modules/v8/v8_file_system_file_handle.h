...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_FILE_SYSTEM_FILE_HANDLE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_FILE_SYSTEM_FILE_HANDLE_H_
...
class MODULES_EXPORT V8FileSystemFileHandle final : public bindings::V8InterfaceBridge<V8FileSystemFileHandle, FileSystemFileHandle> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class FileSystemFileHandle;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_FILE_SYSTEM_FILE_HANDLE_H_
