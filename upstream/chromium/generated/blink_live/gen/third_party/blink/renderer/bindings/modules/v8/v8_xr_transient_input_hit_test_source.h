...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_TRANSIENT_INPUT_HIT_TEST_SOURCE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_TRANSIENT_INPUT_HIT_TEST_SOURCE_H_
...
class MODULES_EXPORT V8XRTransientInputHitTestSource final : public bindings::V8InterfaceBridge<V8XRTransientInputHitTestSource, XRTransientInputHitTestSource> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1451);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_TRANSIENT_INPUT_HIT_TEST_SOURCE_H_
