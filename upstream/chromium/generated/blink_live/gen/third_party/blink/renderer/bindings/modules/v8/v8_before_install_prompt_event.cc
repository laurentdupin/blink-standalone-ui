...
static_assert(std::derived_from<BeforeInstallPromptEvent, Event>);
...
const WrapperTypeInfo& BeforeInstallPromptEvent::wrapper_type_info_ =
    V8BeforeInstallPromptEvent::wrapper_type_info_;
...
static_assert(bindings::IsReturnTypeCompatible<IDLPromise<AppBannerPromptResult>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
decltype(NativeValueTraits<BeforeInstallPromptEventInit>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg2_event_init_dict;
...
static_assert(bindings::IsReturnTypeCompatible<BeforeInstallPromptEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
void V8BeforeInstallPromptEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "BeforeInstallPromptEvent", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "BeforeInstallPromptEvent", kOperationTable);
}
