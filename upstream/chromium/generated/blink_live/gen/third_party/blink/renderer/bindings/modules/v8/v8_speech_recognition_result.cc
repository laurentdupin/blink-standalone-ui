...
bool V8SpeechRecognitionResult::IsExposed(ExecutionContext* execution_context) {
  return false;
}
...
const WrapperTypeInfo V8SpeechRecognitionResult::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SpeechRecognitionResult::InstallInterfaceTemplate,
    V8SpeechRecognitionResult::InstallContextDependentProperties,
    "SpeechRecognitionResult",
    nullptr,
    V8SpeechRecognitionResult::kThisTag,
    V8SpeechRecognitionResult::kMaxSubclassTag,
...
const WrapperTypeInfo& SpeechRecognitionResult::wrapper_type_info_ =
    V8SpeechRecognitionResult::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, SpeechRecognitionResult>::value,
    "SpeechRecognitionResult inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

v8::Intercepted V8SpeechRecognitionResult::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
SpeechRecognitionResult* blink_receiver = V8SpeechRecognitionResult::ToWrappableUnsafe(isolate, v8_receiver);
...
static_assert(bindings::IsReturnTypeCompatible<SpeechRecognitionAlternative, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
return v8::Intercepted::kYes;
}

v8::Intercepted V8SpeechRecognitionResult::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SpeechRecognitionResult_IndexedPropertySetter");
...
v8::Intercepted V8SpeechRecognitionResult::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SpeechRecognitionResult_IndexedPropertyDeleter");
...
v8::Intercepted V8SpeechRecognitionResult::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SpeechRecognitionResult_IndexedPropertyDefiner");
...
v8::Intercepted V8SpeechRecognitionResult::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SpeechRecognitionResult_IndexedPropertyDescriptor");
...
void V8SpeechRecognitionResult::IndexedPropertyEnumeratorCallback(const v8::PropertyCallbackInfo<v8::Array>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SpeechRecognitionResult_IndexedPropertyEnumerator");
...
namespace v8_speech_recognition_result {
...
BLINK_BINDINGS_TRACE_EVENT("SpeechRecognitionResult.length.get");
...
void IsFinalAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_SpeechRecognitionResult_isFinal_Getter");
BLINK_BINDINGS_TRACE_EVENT("SpeechRecognitionResult.isFinal.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
SpeechRecognitionResult* blink_receiver = V8SpeechRecognitionResult::ToWrappableUnsafe(isolate, v8_receiver);
auto&& return_value = blink_receiver->isFinal();
...
BLINK_BINDINGS_TRACE_EVENT("SpeechRecognitionResult.item");
...
using namespace v8_speech_recognition_result;

}  // namespace 

void V8SpeechRecognitionResult::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SpeechRecognitionResult::GetWrapperTypeInfo();
...
instance_template->SetHandler(
    v8::IndexedPropertyHandlerConfiguration(
        ...
        nullptr,  // query
        V8SpeechRecognitionResult::IndexedPropertyDeleterCallback,
        V8SpeechRecognitionResult::IndexedPropertyEnumeratorCallback,
...
void V8SpeechRecognitionResult::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"isFinal", IsFinalAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
};
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SpeechRecognitionResult", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "SpeechRecognitionResult", kOperationTable);
}
...
void V8SpeechRecognitionResult::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object, v8::Local<v8::Object> prototype_object, v8::Local<v8::Object> interface_object, v8::Local<v8::Template> interface_template, FeatureSelector feature_selector) {
  using bindings::IDLMemberInstaller;
