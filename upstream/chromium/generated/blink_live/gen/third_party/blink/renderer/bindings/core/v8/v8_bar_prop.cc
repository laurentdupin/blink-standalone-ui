...
bool V8BarProp::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8BarProp::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8BarProp::InstallInterfaceTemplate,
    nullptr,
    "BarProp",
    nullptr,
    V8BarProp::kThisTag,
    V8BarProp::kMaxSubclassTag,
...
BLINK_BINDINGS_TRACE_EVENT("BarProp.visible.get");
...
using namespace v8_bar_prop;

}  // namespace 

void V8BarProp::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8BarProp::GetWrapperTypeInfo();
...
void V8BarProp::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "BarProp", kAttributeTable);
}
