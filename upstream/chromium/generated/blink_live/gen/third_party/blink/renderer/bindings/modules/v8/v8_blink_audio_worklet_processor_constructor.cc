...
const char* V8BlinkAudioWorkletProcessorConstructor::GetHumanReadableName() const {
...
base::expected<ScriptValue, ScriptValue> V8BlinkAudioWorkletProcessorConstructor::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const ScriptValue& arg1_options) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_options);
