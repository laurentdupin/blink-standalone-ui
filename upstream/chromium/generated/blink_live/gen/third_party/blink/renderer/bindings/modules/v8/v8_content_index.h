...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CONTENT_INDEX_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CONTENT_INDEX_H_
...
class MODULES_EXPORT V8ContentIndex final : public bindings::V8InterfaceBridge<V8ContentIndex, ContentIndex> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1117);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class ContentIndex;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_CONTENT_INDEX_H_
