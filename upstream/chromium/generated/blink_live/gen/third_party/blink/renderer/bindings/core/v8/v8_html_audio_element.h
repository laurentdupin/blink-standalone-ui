...
class CORE_EXPORT V8HTMLAudioElement final : public bindings::V8InterfaceBridge<V8HTMLAudioElement, HTMLAudioElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(634);
