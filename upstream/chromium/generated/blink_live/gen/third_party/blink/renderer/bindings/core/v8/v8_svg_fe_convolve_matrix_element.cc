...
static_assert(std::derived_from<SVGFEConvolveMatrixElement, SVGElement>);
...
static_assert(bindings::IsReturnTypeCompatible<SVGAnimatedBoolean, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
}
...
void V8SVGFEConvolveMatrixElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGFEConvolveMatrixElement", kAttributeTable);
}
...
{"SVG_EDGEMODE_UNKNOWN", V8SVGFEConvolveMatrixElement::Constant::kSVGEdgemodeUnknown},
{"SVG_EDGEMODE_DUPLICATE", V8SVGFEConvolveMatrixElement::Constant::kSVGEdgemodeDuplicate},
{"SVG_EDGEMODE_WRAP", V8SVGFEConvolveMatrixElement::Constant::kSVGEdgemodeWrap},
{"SVG_EDGEMODE_NONE", V8SVGFEConvolveMatrixElement::Constant::kSVGEdgemodeNone},
};
