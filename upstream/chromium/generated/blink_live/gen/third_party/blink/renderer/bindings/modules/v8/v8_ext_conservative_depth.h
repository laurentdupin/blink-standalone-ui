...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_CONSERVATIVE_DEPTH_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_CONSERVATIVE_DEPTH_H_
...
class MODULES_EXPORT V8EXTConservativeDepth final : public bindings::V8InterfaceBridge<V8EXTConservativeDepth, EXTConservativeDepth> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1296);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class EXTConservativeDepth;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_CONSERVATIVE_DEPTH_H_
