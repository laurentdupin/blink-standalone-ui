...
if (RuntimeEnabledFeatures::WebAuthenticationImmediateGetEnabled()) {
  dictionary_from_v8_context.SetCurrentPropertyName("uiMode");
if (!bindings::GetDictionaryMemberFromV8Object<V8CredentialUiModeRequirement, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[8].Get(isolate), fallback_presence_var, member_ui_mode_, class_like_name, exception_state)) {
  return;
}
}
}
