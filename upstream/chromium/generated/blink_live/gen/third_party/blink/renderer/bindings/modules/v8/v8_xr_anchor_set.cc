...
bool V8XRAnchorSet::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8XRAnchorSet::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8XRAnchorSet::InstallInterfaceTemplate,
    V8XRAnchorSet::InstallContextDependentProperties,
    "XRAnchorSet",
    nullptr,
    V8XRAnchorSet::kThisTag,
    V8XRAnchorSet::kMaxSubclassTag,
...
const WrapperTypeInfo& XRAnchorSet::wrapper_type_info_ =
    V8XRAnchorSet::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, XRAnchorSet>::value,
    "XRAnchorSet inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_xr_anchor_set {


void SizeAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRAnchorSet_size_Getter");
BLINK_BINDINGS_TRACE_EVENT("XRAnchorSet.size.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
XRAnchorSet* blink_receiver = V8XRAnchorSet::ToWrappableUnsafe(isolate, v8_receiver);
...
void EntriesOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRAnchorSet_entries");
BLINK_BINDINGS_TRACE_EVENT("XRAnchorSet.entries");
...
static_assert(bindings::IsReturnTypeCompatible<SyncIterator<XRAnchorSet>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, blink_receiver);
}

void ForEachOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRAnchorSet_forEach");
BLINK_BINDINGS_TRACE_EVENT("XRAnchorSet.forEach");
...
void HasOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRAnchorSet_has");
BLINK_BINDINGS_TRACE_EVENT("XRAnchorSet.has");
...
ScriptState* script_state = receiver_script_state;
ExceptionState exception_state(isolate);
auto&& arg1_value = NativeValueTraits<XRAnchor>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
void KeysOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRAnchorSet_keys");
BLINK_BINDINGS_TRACE_EVENT("XRAnchorSet.keys");
...
void ValuesOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRAnchorSet_values");
BLINK_BINDINGS_TRACE_EVENT("XRAnchorSet.values");
...
using namespace v8_xr_anchor_set;

}  // namespace 

void V8XRAnchorSet::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8XRAnchorSet::GetWrapperTypeInfo();
...
void V8XRAnchorSet::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "XRAnchorSet", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "XRAnchorSet", kOperationTable);
}
...
void V8XRAnchorSet::InstallContextDependentProperties(v8::Local<v8::Context> context, const DOMWrapperWorld& world, v8::Local<v8::Object> instance_object, v8::Local<v8::Object> prototype_object, v8::Local<v8::Object> interface_object, v8::Local<v8::Template> interface_template, FeatureSelector feature_selector) {
  using bindings::IDLMemberInstaller;
