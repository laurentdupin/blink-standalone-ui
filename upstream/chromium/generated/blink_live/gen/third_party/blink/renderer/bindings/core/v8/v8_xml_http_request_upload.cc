...
bool V8XMLHttpRequestUpload::IsExposed(ExecutionContext* execution_context) {
...
static_assert(std::derived_from<XMLHttpRequestUpload, XMLHttpRequestEventTarget>);
...
const WrapperTypeInfo V8XMLHttpRequestUpload::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8XMLHttpRequestUpload::InstallInterfaceTemplate,
    nullptr,
    "XMLHttpRequestUpload",
    V8XMLHttpRequestEventTarget::GetWrapperTypeInfo(),
    V8XMLHttpRequestUpload::kThisTag,
    V8XMLHttpRequestUpload::kMaxSubclassTag,
...
const WrapperTypeInfo& XMLHttpRequestUpload::wrapper_type_info_ =
    V8XMLHttpRequestUpload::wrapper_type_info_;
...
namespace v8_xml_http_request_upload {



}  // namespace v8_xml_http_request_upload

using namespace v8_xml_http_request_upload;

}  // namespace 

void V8XMLHttpRequestUpload::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8XMLHttpRequestUpload::GetWrapperTypeInfo();
