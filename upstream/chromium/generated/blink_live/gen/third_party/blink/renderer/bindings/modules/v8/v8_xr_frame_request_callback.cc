...
const char* V8XRFrameRequestCallback::GetHumanReadableName() const {
  return "V8XRFrameRequestCallback";
}

v8::Maybe<void> V8XRFrameRequestCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, double arg1_time, XRFrame* arg2_frame) {
  const char* const class_like_name = "XRFrameRequestCallback";
...
v8::Maybe<void> V8XRFrameRequestCallback::Construct(double arg1_time, XRFrame* arg2_frame) {
  const char* const class_like_name = "XRFrameRequestCallback";
...
void V8XRFrameRequestCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, double arg1_time, XRFrame* arg2_frame) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = Invoke(arg0_receiver, arg1_time, arg2_frame);
}

base::expected<void, ScriptValue> V8XRFrameRequestCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, double arg1_time, XRFrame* arg2_frame) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_time, arg2_frame);
