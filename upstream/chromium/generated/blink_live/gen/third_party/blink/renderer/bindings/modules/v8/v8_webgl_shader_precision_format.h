...
class MODULES_EXPORT V8WebGLShaderPrecisionFormat final : public bindings::V8InterfaceBridge<V8WebGLShaderPrecisionFormat, WebGLShaderPrecisionFormat> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1365);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class WebGLShaderPrecisionFormat;
};
