...
class CORE_EXPORT V8Range final : public bindings::V8InterfaceBridge<V8Range, Range> {
...
class Constant final {
  ...
  public:
static constexpr uint16_t kStartToStart = 0;
static constexpr uint16_t kStartToEnd = 1;
static constexpr uint16_t kEndToEnd = 2;
static constexpr uint16_t kEndToStart = 3;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(357);
