...
bool V8AudioProcessingEvent::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<AudioProcessingEvent, Event>);
...
const WrapperTypeInfo V8AudioProcessingEvent::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8AudioProcessingEvent::InstallInterfaceTemplate,
    nullptr,
    "AudioProcessingEvent",
    V8Event::GetWrapperTypeInfo(),
    V8AudioProcessingEvent::kThisTag,
    V8AudioProcessingEvent::kMaxSubclassTag,
...
const WrapperTypeInfo& AudioProcessingEvent::wrapper_type_info_ =
    V8AudioProcessingEvent::wrapper_type_info_;
...
namespace v8_audio_processing_event {


void PlaybackTimeAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_AudioProcessingEvent_playbackTime_Getter");
BLINK_BINDINGS_TRACE_EVENT("AudioProcessingEvent.playbackTime.get");
...
void InputBufferAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_AudioProcessingEvent_inputBuffer_Getter");
BLINK_BINDINGS_TRACE_EVENT("AudioProcessingEvent.inputBuffer.get");
...
void OutputBufferAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_AudioProcessingEvent_outputBuffer_Getter");
BLINK_BINDINGS_TRACE_EVENT("AudioProcessingEvent.outputBuffer.get");
...
BLINK_BINDINGS_TRACE_EVENT("AudioProcessingEvent.isTrusted.get");
...
BLINK_BINDINGS_TRACE_EVENT("AudioProcessingEvent.constructor");
...
auto&& arg2_event_init_dict = NativeValueTraits<AudioProcessingEventInit>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& return_value = AudioProcessingEvent::Create(arg1_type, arg2_event_init_dict);
static_assert(bindings::IsReturnTypeCompatible<AudioProcessingEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8AudioProcessingEvent::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_audio_processing_event;

}  // namespace 

void V8AudioProcessingEvent::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8AudioProcessingEvent::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "AudioProcessingEvent"));
...
void V8AudioProcessingEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
  using bindings::IDLMemberInstaller;

{
  
static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
{"playbackTime", PlaybackTimeAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
{"inputBuffer", InputBufferAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
{"outputBuffer", OutputBufferAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "AudioProcessingEvent", kAttributeTable);
}
