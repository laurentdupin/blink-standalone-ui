...
static PushPermissionDescriptor* Create() {
  return MakeGarbageCollected<PushPermissionDescriptor>();
}
static PushPermissionDescriptor* Create(v8::Isolate* isolate) {
  return MakeGarbageCollected<PushPermissionDescriptor>(isolate);
}
static PushPermissionDescriptor* Create(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state);

explicit  PushPermissionDescriptor();
explicit  PushPermissionDescriptor(v8::Isolate* isolate);
