...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BLUETOOTH_REMOTE_GATT_CHARACTERISTIC_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BLUETOOTH_REMOTE_GATT_CHARACTERISTIC_H_
...
class MODULES_EXPORT V8BluetoothRemoteGATTCharacteristic final : public bindings::V8InterfaceBridge<V8BluetoothRemoteGATTCharacteristic, BluetoothRemoteGATTCharacteristic> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(534);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_BLUETOOTH_REMOTE_GATT_CHARACTERISTIC_H_
