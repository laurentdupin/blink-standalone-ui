...
struct ProtocolTypeTraits<T,
     typename std::enable_if<std::is_base_of<blink::protocol::Value, T>::value>::type> {
  static void Serialize(const blink::protocol::Value& value, std::vector<uint8_t>* bytes) {
    value.AppendSerialized(bytes);
  }
};
...
struct ProtocolTypeTraits<std::unique_ptr<blink::protocol::Value>> {
  static bool Deserialize(DeserializerState* state, std::unique_ptr<blink::protocol::Value>* value);
  static void Serialize(const std::unique_ptr<blink::protocol::Value>& value, std::vector<uint8_t>* bytes);
};

template <>
struct ProtocolTypeTraits<std::unique_ptr<blink::protocol::DictionaryValue>> {
  static bool Deserialize(DeserializerState* state, std::unique_ptr<blink::protocol::DictionaryValue>* value);
  static void Serialize(const std::unique_ptr<blink::protocol::DictionaryValue>& value, std::vector<uint8_t>* bytes);
};
...
struct ProtocolTypeTraits<std::unique_ptr<blink::protocol::Object>> {
  static bool Deserialize(DeserializerState* state, std::unique_ptr<blink::protocol::Object>* value);
  static void Serialize(const std::unique_ptr<blink::protocol::Object>& value, std::vector<uint8_t>* bytes);
};

template<>
struct ProtocolTypeTraits<blink::protocol::Object> {
  static void Serialize(const blink::protocol::Object& value, std::vector<uint8_t>* bytes) {
    value.AppendSerialized(bytes);
  }
};
