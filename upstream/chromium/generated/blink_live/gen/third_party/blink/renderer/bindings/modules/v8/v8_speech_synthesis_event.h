...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SPEECH_SYNTHESIS_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SPEECH_SYNTHESIS_EVENT_H_
...
class MODULES_EXPORT V8SpeechSynthesisEvent final : public bindings::V8InterfaceBridge<V8SpeechSynthesisEvent, SpeechSynthesisEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(463);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SpeechSynthesisEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SPEECH_SYNTHESIS_EVENT_H_
