...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_COMPOSITION_LAYER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_COMPOSITION_LAYER_H_
...
class MODULES_EXPORT V8XRCompositionLayer final : public bindings::V8InterfaceBridge<V8XRCompositionLayer, XRCompositionLayer> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(819);
  static constexpr v8::CppHeapPointerTag kMaxSubclassTag =
      static_cast<v8::CppHeapPointerTag>(824);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XRCompositionLayer;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_COMPOSITION_LAYER_H_
