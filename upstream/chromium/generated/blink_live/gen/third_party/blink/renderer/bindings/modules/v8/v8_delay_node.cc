...
static_assert(std::derived_from<DelayNode, AudioNode>);
...
const WrapperTypeInfo V8DelayNode::wrapper_type_info_{
    ...
    V8DelayNode::kThisTag,
    V8DelayNode::kMaxSubclassTag,
...
DelayNode* blink_receiver = V8DelayNode::ToWrappableUnsafe(isolate, v8_receiver);
...
static_assert(bindings::IsReturnTypeCompatible<DelayNode, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
interface_function_template->SetInterfaceName(V8String(isolate, "DelayNode"));
...
void V8DelayNode::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "DelayNode", kAttributeTable);
}
