...
bool V8HTMLTableColElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<HTMLTableColElement, HTMLElement>);
...
const WrapperTypeInfo V8HTMLTableColElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8HTMLTableColElement::InstallInterfaceTemplate,
    nullptr,
    "HTMLTableColElement",
    V8HTMLElement::GetWrapperTypeInfo(),
    V8HTMLTableColElement::kThisTag,
    V8HTMLTableColElement::kMaxSubclassTag,
...
const WrapperTypeInfo& HTMLTableColElement::wrapper_type_info_ =
    V8HTMLTableColElement::wrapper_type_info_;
...
namespace v8_html_table_col_element {


void SpanAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLTableColElement_span_Getter");
BLINK_BINDINGS_TRACE_EVENT("HTMLTableColElement.span.get");
...
void SpanAttributeSetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLTableColElement_span_Setter");
BLINK_BINDINGS_TRACE_EVENT("HTMLTableColElement.span.set");
...
blink_receiver->setSpan(arg1_value);
...
BLINK_BINDINGS_TRACE_EVENT("HTMLTableColElement.align.get");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLTableColElement.align.set");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLTableColElement.ch.get");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLTableColElement.ch.set");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLTableColElement.chOff.get");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLTableColElement.chOff.set");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLTableColElement.vAlign.get");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLTableColElement.vAlign.set");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLTableColElement.width.get");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLTableColElement.width.set");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLTableColElement.constructor");
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLTableColElement::GetWrapperTypeInfo(), ElementType::kHTMLTableColElement);
}


}  // namespace v8_html_table_col_element

using namespace v8_html_table_col_element;

}  // namespace 

void V8HTMLTableColElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8HTMLTableColElement::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "HTMLTableColElement"));
...
void V8HTMLTableColElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
  using bindings::IDLMemberInstaller;

{
  
static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
{"span", SpanAttributeGetCallback, SpanAttributeSetCallback, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLTableColElement", kAttributeTable);
}
