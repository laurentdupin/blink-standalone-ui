...
class MODULES_EXPORT V8FileSystemWritableFileStream final : public bindings::V8InterfaceBridge<V8FileSystemWritableFileStream, FileSystemWritableFileStream> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(958);
