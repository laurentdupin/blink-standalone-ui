...
using Ret = bindings::OptimizedReturnProxy<V8UnionAuctionAdOrLongLong>;
v8::Local<v8::Value> ToV8(ScriptState* script_state) const;

static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, AuctionAd* value);
static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, int64_t value);
