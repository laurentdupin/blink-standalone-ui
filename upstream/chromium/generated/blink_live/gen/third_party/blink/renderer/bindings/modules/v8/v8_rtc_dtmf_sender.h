...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_DTMF_SENDER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_DTMF_SENDER_H_
...
class MODULES_EXPORT V8RTCDTMFSender final : public bindings::V8InterfaceBridge<V8RTCDTMFSender, RTCDTMFSender> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(761);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class RTCDTMFSender;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_DTMF_SENDER_H_
