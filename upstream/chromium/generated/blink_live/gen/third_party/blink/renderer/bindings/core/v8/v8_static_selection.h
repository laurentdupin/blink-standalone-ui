...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_STATIC_SELECTION_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_STATIC_SELECTION_H_
...
class  V8StaticSelection final : public bindings::V8InterfaceBridge<V8StaticSelection, StaticSelection> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1062);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class StaticSelection;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_STATIC_SELECTION_H_
