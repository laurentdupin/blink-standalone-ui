...
bool V8VideoEncoder::IsExposed(ExecutionContext* execution_context) {
  
const bool is_in_secure_context = execution_context->IsSecureContext();
return is_in_secure_context && (execution_context->IsWindow() || execution_context->IsDedicatedWorkerGlobalScope());
}

static_assert(std::derived_from<VideoEncoder, EventTarget>);
...
const WrapperTypeInfo V8VideoEncoder::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8VideoEncoder::InstallInterfaceTemplate,
    nullptr,
    "VideoEncoder",
    V8EventTarget::GetWrapperTypeInfo(),
    V8VideoEncoder::kThisTag,
    V8VideoEncoder::kMaxSubclassTag,
...
const WrapperTypeInfo& VideoEncoder::wrapper_type_info_ =
    V8VideoEncoder::wrapper_type_info_;
...
namespace v8_video_encoder {


void EncodeQueueSizeAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_VideoEncoder_encodeQueueSize_Getter");
BLINK_BINDINGS_TRACE_EVENT("VideoEncoder.encodeQueueSize.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_VideoEncoder_ondequeue_Getter");
BLINK_BINDINGS_TRACE_EVENT("VideoEncoder.ondequeue.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_VideoEncoder_ondequeue_Setter");
BLINK_BINDINGS_TRACE_EVENT("VideoEncoder.ondequeue.set");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_VideoEncoder_state_Getter");
BLINK_BINDINGS_TRACE_EVENT("VideoEncoder.state.get");
...
static_assert(bindings::IsReturnTypeCompatible<V8CodecState, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
BLINK_BINDINGS_TRACE_EVENT("VideoEncoder.constructor");
...
// [Measure], [MeasureAs]
UseCounter::Count(current_execution_context, WebFeature::kWebCodecsVideoEncoder);
...
auto&& arg1_init = NativeValueTraits<VideoEncoderInit>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& return_value = VideoEncoder::Create(script_state, arg1_init, exception_state);
static_assert(bindings::IsReturnTypeCompatible<VideoEncoder, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8VideoEncoder::GetWrapperTypeInfo(), v8_receiver);
...
void EncodeOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
...
decltype(NativeValueTraits<VideoEncoderEncodeOptions>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg2_options;
if (info[1]->IsUndefined()) {
  arg2_options = VideoEncoderEncodeOptions::Create();
} else {
  arg2_options = NativeValueTraits<VideoEncoderEncodeOptions>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
}
blink_receiver->encode(arg1_frame, arg2_options, exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
if (!V8VideoEncoder::HasInstance(isolate, v8_receiver)) {
...
void GetAllFrameBuffersOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_VideoEncoder_getAllFrameBuffers");
BLINK_BINDINGS_TRACE_EVENT("VideoEncoder.getAllFrameBuffers");
...
VideoEncoder* blink_receiver = V8VideoEncoder::ToWrappableUnsafe(isolate, v8_receiver);
ExceptionState exception_state(isolate);
auto&& return_value = blink_receiver->getAllFrameBuffers(script_state, exception_state);
static_assert(bindings::IsReturnTypeCompatible<IDLSequence<VideoEncoderBuffer>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
v8::Local<v8::Value> v8_return_value = ToV8Traits<IDLSequence<VideoEncoderBuffer>>::ToV8(script_state, return_value);
...
void IsConfigSupportedStaticOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_VideoEncoder_isConfigSupported");
BLINK_BINDINGS_TRACE_EVENT("VideoEncoder.isConfigSupported");
// Promise returning function: Convert a TypeError to a reject promise.
ExceptionToRejectPromiseScope reject_promise_scope(info);
...
auto&& return_value = VideoEncoder::isConfigSupported(script_state, arg1_config, exception_state);
static_assert(bindings::IsReturnTypeCompatible<IDLPromise<VideoEncoderSupport>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
bindings::V8SetReturnValue(info, return_value);
...
using namespace v8_video_encoder;

}  // namespace 

void V8VideoEncoder::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8VideoEncoder::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "VideoEncoder"));
...
void V8VideoEncoder::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "VideoEncoder", kAttributeTable);
}
...
{"encode", EncodeOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "VideoEncoder", kOperationTable);
}
...
void V8VideoEncoder::InstallContextIndependentProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
  using bindings::IDLMemberInstaller;
...
if (RuntimeEnabledFeatures::WebCodecsVideoEncoderBuffersEnabled()) {
  static const IDLMemberInstaller::OperationConfig kOperationTable[] = {
{"getAllFrameBuffers", GetAllFrameBuffersOperationCallback, 0, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
};
v8::Local<v8::Signature> signature = v8::Local<v8::Signature>::Cast(interface_template);
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "VideoEncoder", kOperationTable);
}
