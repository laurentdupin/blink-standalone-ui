...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_ROUTE_RULE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_ROUTE_RULE_H_
...
class CORE_EXPORT V8CSSRouteRule final : public bindings::V8InterfaceBridge<V8CSSRouteRule, CSSRouteRule> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(305);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSRouteRule;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_ROUTE_RULE_H_
