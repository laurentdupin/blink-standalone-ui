...
bool V8XRLayer::IsExposed(ExecutionContext* execution_context) {
  
const bool is_in_secure_context = execution_context->IsSecureContext();
return is_in_secure_context && execution_context->IsWindow();
}

static_assert(std::derived_from<XRLayer, EventTarget>);
...
const WrapperTypeInfo V8XRLayer::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8XRLayer::InstallInterfaceTemplate,
    nullptr,
    "XRLayer",
    V8EventTarget::GetWrapperTypeInfo(),
    V8XRLayer::kThisTag,
    V8XRLayer::kMaxSubclassTag,
...
const WrapperTypeInfo& XRLayer::wrapper_type_info_ =
    V8XRLayer::wrapper_type_info_;
...
namespace v8_xr_layer {



}  // namespace v8_xr_layer

using namespace v8_xr_layer;

}  // namespace 

void V8XRLayer::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8XRLayer::GetWrapperTypeInfo();
