...
class MODULES_EXPORT V8InstallEvent final : public bindings::V8InterfaceBridge<V8InstallEvent, InstallEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(406);
