...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_TRANSPORT_ICE_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_TRANSPORT_ICE_EVENT_H_
...
class RtcTransportIceEvent;
struct WrapperTypeInfo;

class MODULES_EXPORT V8RtcTransportIceEvent final : public bindings::V8InterfaceBridge<V8RtcTransportIceEvent, RtcTransportIceEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(457);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class RtcTransportIceEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_TRANSPORT_ICE_EVENT_H_
