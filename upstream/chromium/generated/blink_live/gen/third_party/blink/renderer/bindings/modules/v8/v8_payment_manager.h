...
class MODULES_EXPORT V8PaymentManager final : public bindings::V8InterfaceBridge<V8PaymentManager, PaymentManager> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1215);
