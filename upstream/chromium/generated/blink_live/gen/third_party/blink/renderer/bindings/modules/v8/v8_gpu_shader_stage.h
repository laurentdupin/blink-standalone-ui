...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_SHADER_STAGE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_SHADER_STAGE_H_
...
class MODULES_EXPORT V8GPUShaderStage final : public bindings::V8InterfaceBridge<V8GPUShaderStage, GPUShaderStage> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1482);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class GPUShaderStage;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_SHADER_STAGE_H_
