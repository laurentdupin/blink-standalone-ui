...
const char* V8SchedulerPostTaskCallback::GetHumanReadableName() const {
  return "V8SchedulerPostTaskCallback";
}

v8::Maybe<ScriptValue> V8SchedulerPostTaskCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
  const char* const class_like_name = "SchedulerPostTaskCallback";
...
v8::Maybe<ScriptValue> V8SchedulerPostTaskCallback::Construct() {
  const char* const class_like_name = "SchedulerPostTaskCallback";
...
base::expected<ScriptValue, ScriptValue> V8SchedulerPostTaskCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
