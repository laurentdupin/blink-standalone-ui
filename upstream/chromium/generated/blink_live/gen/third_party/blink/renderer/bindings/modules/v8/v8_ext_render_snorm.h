...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_RENDER_SNORM_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_RENDER_SNORM_H_
...
class MODULES_EXPORT V8EXTRenderSnorm final : public bindings::V8InterfaceBridge<V8EXTRenderSnorm, EXTRenderSnorm> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1303);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class EXTRenderSnorm;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EXT_RENDER_SNORM_H_
