...
static_assert(std::derived_from<HTMLHtmlElement, HTMLElement>);
...
const WrapperTypeInfo V8HTMLHtmlElement::wrapper_type_info_{
    ...
    V8HTMLHtmlElement::kThisTag,
    V8HTMLHtmlElement::kMaxSubclassTag,
...
bindings::PerformAttributeSetCEReactionsReflectTypeString(info, html_names::kVersionAttr);
}
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLHtmlElement::GetWrapperTypeInfo(), ElementType::kHTMLHtmlElement);
}
...
interface_function_template->SetInterfaceName(V8String(isolate, "HTMLHtmlElement"));
...
void V8HTMLHtmlElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLHtmlElement", kAttributeTable);
}
