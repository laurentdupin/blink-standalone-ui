...
bool V8TrustedScriptURL::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8TrustedScriptURL::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8TrustedScriptURL::InstallInterfaceTemplate,
    nullptr,
    "TrustedScriptURL",
    nullptr,
    V8TrustedScriptURL::kThisTag,
    V8TrustedScriptURL::kMaxSubclassTag,
...
const WrapperTypeInfo& TrustedScriptURL::wrapper_type_info_ =
    V8TrustedScriptURL::wrapper_type_info_;
...
namespace v8_trusted_script_url {

void ToJSONOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TrustedScriptURL_toJSON");
BLINK_BINDINGS_TRACE_EVENT("TrustedScriptURL.toJSON");
...
void FromLiteralStaticOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_TrustedScriptURL_fromLiteral");
BLINK_BINDINGS_TRACE_EVENT("TrustedScriptURL.fromLiteral");
...
auto&& return_value = TrustedScriptURL::fromLiteral(script_state, arg1_template_literal, exception_state);
...
BLINK_BINDINGS_TRACE_EVENT("TrustedScriptURL.toString");
...
using namespace v8_trusted_script_url;

}  // namespace 

void V8TrustedScriptURL::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8TrustedScriptURL::GetWrapperTypeInfo();
...
void V8TrustedScriptURL::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "TrustedScriptURL", kOperationTable);
}
...
void V8TrustedScriptURL::InstallContextIndependentProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
  using bindings::IDLMemberInstaller;
