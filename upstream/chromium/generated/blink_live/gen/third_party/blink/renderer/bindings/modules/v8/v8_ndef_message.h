...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_NDEF_MESSAGE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_NDEF_MESSAGE_H_
...
class MODULES_EXPORT V8NDEFMessage final : public bindings::V8InterfaceBridge<V8NDEFMessage, NDEFMessage> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1209);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class NDEFMessage;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_NDEF_MESSAGE_H_
