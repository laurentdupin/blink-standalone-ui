...
const WrapperTypeInfo V8XRRigidTransform::wrapper_type_info_{
    ...
    "XRRigidTransform",
    nullptr,
    V8XRRigidTransform::kThisTag,
    V8XRRigidTransform::kMaxSubclassTag,
...
XRRigidTransform* blink_receiver = V8XRRigidTransform::ToWrappableUnsafe(isolate, v8_receiver);
...
interface_function_template->SetInterfaceName(V8String(isolate, "XRRigidTransform"));
...
void V8XRRigidTransform::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "XRRigidTransform", kAttributeTable);
}
