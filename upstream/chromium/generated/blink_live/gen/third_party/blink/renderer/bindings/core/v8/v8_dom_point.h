...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_DOM_POINT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_DOM_POINT_H_
...
class CORE_EXPORT V8DOMPoint final : public bindings::V8InterfaceBridge<V8DOMPoint, DOMPoint> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class DOMPoint;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_DOM_POINT_H_
