...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SPECULATION_DATA_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SPECULATION_DATA_H_
...
class CORE_EXPORT V8SpeculationData final : public bindings::V8InterfaceBridge<V8SpeculationData, SpeculationData> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1019);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SpeculationData;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SPECULATION_DATA_H_
