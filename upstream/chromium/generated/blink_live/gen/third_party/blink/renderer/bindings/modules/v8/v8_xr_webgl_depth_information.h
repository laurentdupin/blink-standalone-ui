...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_WEBGL_DEPTH_INFORMATION_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_WEBGL_DEPTH_INFORMATION_H_
...
class MODULES_EXPORT V8XRWebGLDepthInformation final : public bindings::V8InterfaceBridge<V8XRWebGLDepthInformation, XRWebGLDepthInformation> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1426);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XRWebGLDepthInformation;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_WEBGL_DEPTH_INFORMATION_H_
