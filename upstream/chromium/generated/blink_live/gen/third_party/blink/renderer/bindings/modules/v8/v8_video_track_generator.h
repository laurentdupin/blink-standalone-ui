...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_VIDEO_TRACK_GENERATOR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_VIDEO_TRACK_GENERATOR_H_
...
class MODULES_EXPORT V8VideoTrackGenerator final : public bindings::V8InterfaceBridge<V8VideoTrackGenerator, VideoTrackGenerator> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1098);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class VideoTrackGenerator;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_VIDEO_TRACK_GENERATOR_H_
