...
AuthenticationExtensionsPaymentOutputs* payment() const {
  DCHECK(hasPayment());
return member_payment_.Get();
}
AuthenticationExtensionsPaymentOutputs* getPaymentOr(AuthenticationExtensionsPaymentOutputs* fallback_value) const {
  if (!hasPayment()) {
  return fallback_value;
}
return member_payment_.Get();
}
void setPayment(AuthenticationExtensionsPaymentOutputs* value) {
...
Member<AuthenticationExtensionsPaymentOutputs> member_payment_;
