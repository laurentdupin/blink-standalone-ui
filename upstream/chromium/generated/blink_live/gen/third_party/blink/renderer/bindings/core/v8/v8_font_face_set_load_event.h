...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_FONT_FACE_SET_LOAD_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_FONT_FACE_SET_LOAD_EVENT_H_
...
class CORE_EXPORT V8FontFaceSetLoadEvent final : public bindings::V8InterfaceBridge<V8FontFaceSetLoadEvent, FontFaceSetLoadEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(413);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class FontFaceSetLoadEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_FONT_FACE_SET_LOAD_EVENT_H_
