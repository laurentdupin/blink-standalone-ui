...
const char* V8StorageQuotaCallback::GetHumanReadableName() const {
  return "V8StorageQuotaCallback";
}

v8::Maybe<void> V8StorageQuotaCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, uint64_t arg1_granted_quota_in_bytes) {
  const char* const class_like_name = "StorageQuotaCallback";
...
v8::Maybe<void> V8StorageQuotaCallback::Construct(uint64_t arg1_granted_quota_in_bytes) {
  const char* const class_like_name = "StorageQuotaCallback";
...
void V8StorageQuotaCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, uint64_t arg1_granted_quota_in_bytes) {
  v8::Isolate* isolate = GetIsolate();
v8::TryCatch try_catch(isolate);
try_catch.SetVerbose(true);

std::ignore = Invoke(arg0_receiver, arg1_granted_quota_in_bytes);
}

base::expected<void, ScriptValue> V8StorageQuotaCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, uint64_t arg1_granted_quota_in_bytes) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_granted_quota_in_bytes);
