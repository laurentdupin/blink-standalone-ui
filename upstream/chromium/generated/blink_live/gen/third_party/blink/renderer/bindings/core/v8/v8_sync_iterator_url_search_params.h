...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SYNC_ITERATOR_URL_SEARCH_PARAMS_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SYNC_ITERATOR_URL_SEARCH_PARAMS_H_
...
template <>
class CORE_EXPORT SyncIterator<URLSearchParams> final : public bindings::SyncIteratorBase {
  DEFINE_WRAPPERTYPEINFO();

  public:
using IDLKeyType = IDLUSVString;
using IDLValueType = IDLUSVString;
using KeyType = String;
using ValueType = String;

explicit  SyncIterator<URLSearchParams>(IterationSourceBase* source, Kind kind) : bindings::SyncIteratorBase(source, kind) {
...
class CORE_EXPORT V8SyncIteratorURLSearchParams final : public bindings::V8InterfaceBridge<V8SyncIteratorURLSearchParams, SyncIterator<URLSearchParams>> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1493);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SyncIterator<URLSearchParams>;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SYNC_ITERATOR_URL_SEARCH_PARAMS_H_
