...
if (!v8_value->IsObject()) {
  const char* const class_like_name = "PageTransitionEventInit";
...
return dictionary;
 ...
 PageTransitionEventInit::PageTransitionEventInit(v8::Isolate* isolate) : EventInit(isolate) {
...
void PageTransitionEventInit::Trace(Visitor* visitor) const {
...
if (!bindings::GetDictionaryMemberFromV8Object<IDLBoolean, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), has_persisted_, member_persisted_, class_like_name, exception_state)) {
  return;
}
}
