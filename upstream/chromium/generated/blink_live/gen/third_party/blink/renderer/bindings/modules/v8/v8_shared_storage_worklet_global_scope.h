...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SHARED_STORAGE_WORKLET_GLOBAL_SCOPE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SHARED_STORAGE_WORKLET_GLOBAL_SCOPE_H_
...
class MODULES_EXPORT V8SharedStorageWorkletGlobalScope final : public bindings::V8InterfaceBridge<V8SharedStorageWorkletGlobalScope, SharedStorageWorkletGlobalScope> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1043);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SharedStorageWorkletGlobalScope;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SHARED_STORAGE_WORKLET_GLOBAL_SCOPE_H_
