...
class CORE_EXPORT V8RequestCredentials final : public bindings::EnumerationBase {
  
  public:
enum class Enum : enum_int_t {
kOmit, kSameOrigin, kInclude
};
static constexpr size_t kEnumSize = 3;

static V8RequestCredentials Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8RequestCredentials> Create(const String& value);

explicit constexpr  V8RequestCredentials(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8RequestCredentials& lhs, V8RequestCredentials::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8RequestCredentials::Enum lhs, const V8RequestCredentials& rhs) {
