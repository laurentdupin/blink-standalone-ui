...
bool V8CSSMarginRule::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<CSSMarginRule, CSSRule>);
...
const WrapperTypeInfo V8CSSMarginRule::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8CSSMarginRule::InstallInterfaceTemplate,
    nullptr,
    "CSSMarginRule",
    V8CSSRule::GetWrapperTypeInfo(),
    V8CSSMarginRule::kThisTag,
    V8CSSMarginRule::kMaxSubclassTag,
...
const WrapperTypeInfo& CSSMarginRule::wrapper_type_info_ =
    V8CSSMarginRule::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, CSSMarginRule>::value,
    "CSSMarginRule inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_css_margin_rule {


void NameAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSMarginRule_name_Getter");
BLINK_BINDINGS_TRACE_EVENT("CSSMarginRule.name.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
CSSMarginRule* blink_receiver = V8CSSMarginRule::ToWrappableUnsafe(isolate, v8_receiver);
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSMarginRule_style_Getter");
BLINK_BINDINGS_TRACE_EVENT("CSSMarginRule.style.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_CSSMarginRule_style_Setter");
BLINK_BINDINGS_TRACE_EVENT("CSSMarginRule.style.set");
...
using namespace v8_css_margin_rule;

}  // namespace 

void V8CSSMarginRule::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8CSSMarginRule::GetWrapperTypeInfo();
...
void V8CSSMarginRule::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "CSSMarginRule", kAttributeTable);
}
