...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_DEPTH_INFORMATION_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_DEPTH_INFORMATION_H_
...
class MODULES_EXPORT V8XRDepthInformation final : public bindings::V8InterfaceBridge<V8XRDepthInformation, XRDepthInformation> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1424);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XRDepthInformation;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_DEPTH_INFORMATION_H_
