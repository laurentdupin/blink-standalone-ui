...
class CORE_EXPORT V8HTMLBaseElement final : public bindings::V8InterfaceBridge<V8HTMLBaseElement, HTMLBaseElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(598);
