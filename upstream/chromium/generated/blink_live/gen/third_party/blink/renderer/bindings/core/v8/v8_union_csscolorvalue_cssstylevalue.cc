...
v8::Local<v8::Value> V8UnionCSSColorValueOrCSSStyleValue::DirectToV8(ScriptState* script_state, CSSColorValue* value) {
  return ToV8Traits<CSSColorValue>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionCSSColorValueOrCSSStyleValue::DirectToV8(ScriptState* script_state, CSSStyleValue* value) {
