...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_VIDEO_ENCODER_BUFFER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_VIDEO_ENCODER_BUFFER_H_
...
class MODULES_EXPORT V8VideoEncoderBuffer final : public bindings::V8InterfaceBridge<V8VideoEncoderBuffer, VideoEncoderBuffer> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1289);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class VideoEncoderBuffer;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_VIDEO_ENCODER_BUFFER_H_
