...
class MODULES_EXPORT V8HdrMetadataType final : public bindings::EnumerationBase {
  
  public:
enum class Enum : enum_int_t {
kSmpteSt2086, kSmpteSt209410, kSmpteSt209440
};
static constexpr size_t kEnumSize = 3;

static V8HdrMetadataType Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8HdrMetadataType> Create(const String& value);

explicit constexpr  V8HdrMetadataType(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8HdrMetadataType& lhs, V8HdrMetadataType::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8HdrMetadataType::Enum lhs, const V8HdrMetadataType& rhs) {
