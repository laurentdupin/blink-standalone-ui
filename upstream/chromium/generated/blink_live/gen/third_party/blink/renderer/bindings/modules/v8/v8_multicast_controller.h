...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MULTICAST_CONTROLLER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MULTICAST_CONTROLLER_H_
...
class MODULES_EXPORT V8MulticastController final : public bindings::V8InterfaceBridge<V8MulticastController, MulticastController> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1458);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class MulticastController;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MULTICAST_CONTROLLER_H_
