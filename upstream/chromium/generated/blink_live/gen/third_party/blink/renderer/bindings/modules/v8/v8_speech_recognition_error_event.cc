...
bool V8SpeechRecognitionErrorEvent::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow() && RuntimeEnabledFeatures::UnprefixedSpeechRecognitionEnabled();
}

static_assert(std::derived_from<SpeechRecognitionErrorEvent, Event>);
...
const WrapperTypeInfo V8SpeechRecognitionErrorEvent::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SpeechRecognitionErrorEvent::InstallInterfaceTemplate,
    nullptr,
    "SpeechRecognitionErrorEvent",
    V8Event::GetWrapperTypeInfo(),
    V8SpeechRecognitionErrorEvent::kThisTag,
    V8SpeechRecognitionErrorEvent::kMaxSubclassTag,
...
const WrapperTypeInfo& SpeechRecognitionErrorEvent::wrapper_type_info_ =
    V8SpeechRecognitionErrorEvent::wrapper_type_info_;
...
namespace v8_speech_recognition_error_event {
...
BLINK_BINDINGS_TRACE_EVENT("SpeechRecognitionErrorEvent.error.get");
...
BLINK_BINDINGS_TRACE_EVENT("SpeechRecognitionErrorEvent.message.get");
...
BLINK_BINDINGS_TRACE_EVENT("SpeechRecognitionErrorEvent.isTrusted.get");
...
BLINK_BINDINGS_TRACE_EVENT("SpeechRecognitionErrorEvent.constructor");
...
decltype(NativeValueTraits<SpeechRecognitionErrorEventInit>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg2_event_init_dict;
if (info[1]->IsUndefined()) {
  arg2_event_init_dict = SpeechRecognitionErrorEventInit::Create();
} else {
  arg2_event_init_dict = NativeValueTraits<SpeechRecognitionErrorEventInit>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
}
auto&& return_value = SpeechRecognitionErrorEvent::Create(arg1_type, arg2_event_init_dict);
static_assert(bindings::IsReturnTypeCompatible<SpeechRecognitionErrorEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8SpeechRecognitionErrorEvent::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_speech_recognition_error_event;

}  // namespace 

void V8SpeechRecognitionErrorEvent::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SpeechRecognitionErrorEvent::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "SpeechRecognitionErrorEvent"));
...
void V8SpeechRecognitionErrorEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SpeechRecognitionErrorEvent", kAttributeTable);
}
