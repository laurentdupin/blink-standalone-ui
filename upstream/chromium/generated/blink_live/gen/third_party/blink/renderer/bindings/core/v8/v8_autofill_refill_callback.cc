...
const char* V8AutofillRefillCallback::GetHumanReadableName() const {
  return "V8AutofillRefillCallback";
}

v8::Maybe<ScriptPromise<IDLUndefined>> V8AutofillRefillCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
  const char* const class_like_name = "AutofillRefillCallback";
...
v8::Maybe<ScriptPromise<IDLUndefined>> V8AutofillRefillCallback::Construct() {
  const char* const class_like_name = "AutofillRefillCallback";
...
base::expected<ScriptPromise<IDLUndefined>, ScriptValue> V8AutofillRefillCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
