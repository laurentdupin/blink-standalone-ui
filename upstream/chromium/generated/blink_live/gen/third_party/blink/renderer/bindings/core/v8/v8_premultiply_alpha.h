...
kNone, kPremultiply, kDefault
};
static constexpr size_t kEnumSize = 3;

static V8PremultiplyAlpha Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8PremultiplyAlpha> Create(const String& value);

explicit constexpr  V8PremultiplyAlpha(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8PremultiplyAlpha& lhs, V8PremultiplyAlpha::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8PremultiplyAlpha::Enum lhs, const V8PremultiplyAlpha& rhs) {
