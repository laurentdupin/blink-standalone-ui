...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MEDIA_ELEMENT_AUDIO_SOURCE_NODE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MEDIA_ELEMENT_AUDIO_SOURCE_NODE_H_
...
class MODULES_EXPORT V8MediaElementAudioSourceNode final : public bindings::V8InterfaceBridge<V8MediaElementAudioSourceNode, MediaElementAudioSourceNode> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(519);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_MEDIA_ELEMENT_AUDIO_SOURCE_NODE_H_
