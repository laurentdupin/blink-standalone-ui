...
using Ret = bindings::OptimizedReturnProxy<V8UnionInternalEnumOrInternalEnumSequence>;
v8::Local<v8::Value> ToV8(ScriptState* script_state) const;

static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, V8InternalEnum value);
static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, const Vector<V8InternalEnum>& value);
