...
bool V8AudioBufferSourceNode::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<AudioBufferSourceNode, AudioScheduledSourceNode>);
...
const WrapperTypeInfo V8AudioBufferSourceNode::wrapper_type_info_{
    ...
    V8AudioBufferSourceNode::kThisTag,
    V8AudioBufferSourceNode::kMaxSubclassTag,
...
const WrapperTypeInfo& AudioBufferSourceNode::wrapper_type_info_ =
    V8AudioBufferSourceNode::wrapper_type_info_;
...
static_assert(bindings::IsReturnTypeCompatible<IDLNullable<AudioBuffer>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
...
decltype(NativeValueTraits<AudioBufferSourceOptions>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg2_options;
...
interface_function_template->SetInterfaceName(V8String(isolate, "AudioBufferSourceNode"));
...
void V8AudioBufferSourceNode::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"loopStart", LoopStartAttributeGetCallback, LoopStartAttributeSetCallback, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
{"loopEnd", LoopEndAttributeGetCallback, LoopEndAttributeSetCallback, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
};
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "AudioBufferSourceNode", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "AudioBufferSourceNode", kOperationTable);
}
