...
class CORE_EXPORT V8CSSNumericValue final : public bindings::V8InterfaceBridge<V8CSSNumericValue, CSSNumericValue> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(321);
