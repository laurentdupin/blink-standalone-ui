...
const char* V8StorageErrorCallback::GetHumanReadableName() const {
  return "V8StorageErrorCallback";
}

v8::Maybe<void> V8StorageErrorCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, DOMError* arg1_error) {
  const char* const class_like_name = "StorageErrorCallback";
...
v8_arg1_error = ToV8Traits<DOMError>::ToV8(script_state, arg1_error);
...
v8::Maybe<void> V8StorageErrorCallback::Construct(DOMError* arg1_error) {
  const char* const class_like_name = "StorageErrorCallback";
...
void V8StorageErrorCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, DOMError* arg1_error) {
  v8::Isolate* isolate = GetIsolate();
...
base::expected<void, ScriptValue> V8StorageErrorCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, DOMError* arg1_error) {
