...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_CUSTOM_MEDIA_RULE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_CUSTOM_MEDIA_RULE_H_
...
class CORE_EXPORT V8CSSCustomMediaRule final : public bindings::V8InterfaceBridge<V8CSSCustomMediaRule, CSSCustomMediaRule> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(278);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSCustomMediaRule;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_CUSTOM_MEDIA_RULE_H_
