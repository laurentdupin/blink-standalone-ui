...
bool V8HTMLOptGroupElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<HTMLOptGroupElement, HTMLElement>);
...
const WrapperTypeInfo V8HTMLOptGroupElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8HTMLOptGroupElement::InstallInterfaceTemplate,
    nullptr,
    "HTMLOptGroupElement",
    V8HTMLElement::GetWrapperTypeInfo(),
    V8HTMLOptGroupElement::kThisTag,
    V8HTMLOptGroupElement::kMaxSubclassTag,
...
const WrapperTypeInfo& HTMLOptGroupElement::wrapper_type_info_ =
    V8HTMLOptGroupElement::wrapper_type_info_;
...
namespace v8_html_opt_group_element {


void DisabledAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLOptGroupElement_disabled_Getter");
BLINK_BINDINGS_TRACE_EVENT("HTMLOptGroupElement.disabled.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLOptGroupElement_disabled_Setter");
BLINK_BINDINGS_TRACE_EVENT("HTMLOptGroupElement.disabled.set");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLOptGroupElement_label_Getter");
BLINK_BINDINGS_TRACE_EVENT("HTMLOptGroupElement.label.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLOptGroupElement_label_Setter");
BLINK_BINDINGS_TRACE_EVENT("HTMLOptGroupElement.label.set");

bindings::PerformAttributeSetCEReactionsReflectTypeString(info, html_names::kLabelAttr);
}

void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_HTMLOptGroupElement_constructor");
BLINK_BINDINGS_TRACE_EVENT("HTMLOptGroupElement.constructor");
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLOptGroupElement::GetWrapperTypeInfo(), ElementType::kHTMLOptGroupElement);
}


}  // namespace v8_html_opt_group_element

using namespace v8_html_opt_group_element;

}  // namespace 

void V8HTMLOptGroupElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8HTMLOptGroupElement::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "HTMLOptGroupElement"));
...
void V8HTMLOptGroupElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLOptGroupElement", kAttributeTable);
}
