...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_MATH_MAX_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_MATH_MAX_H_
...
class CORE_EXPORT V8CSSMathMax final : public bindings::V8InterfaceBridge<V8CSSMathMax, CSSMathMax> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(325);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSMathMax;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_MATH_MAX_H_
