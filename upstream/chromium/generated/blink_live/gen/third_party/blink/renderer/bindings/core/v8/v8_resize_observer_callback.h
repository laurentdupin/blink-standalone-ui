...
[[nodiscard]] base::expected<void, ScriptValue> InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const HeapVector<Member<ResizeObserverEntry>>& arg1_entries, ResizeObserver* arg2_observer);
