...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SYNC_ITERATOR_CSS_FONT_FEATURE_VALUES_MAP_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SYNC_ITERATOR_CSS_FONT_FEATURE_VALUES_MAP_H_
...
template <>
class CORE_EXPORT SyncIterator<CSSFontFeatureValuesMap> final : public bindings::SyncIteratorBase {
  DEFINE_WRAPPERTYPEINFO();

  public:
using IDLKeyType = IDLString;
using IDLValueType = IDLSequence<IDLUnsignedLong>;
using KeyType = String;
using ValueType = Vector<uint32_t>;

explicit  SyncIterator<CSSFontFeatureValuesMap>(IterationSourceBase* source, Kind kind) : bindings::SyncIteratorBase(source, kind) {
...
class CORE_EXPORT V8SyncIteratorCSSFontFeatureValuesMap final : public bindings::V8InterfaceBridge<V8SyncIteratorCSSFontFeatureValuesMap, SyncIterator<CSSFontFeatureValuesMap>> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1484);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SyncIterator<CSSFontFeatureValuesMap>;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SYNC_ITERATOR_CSS_FONT_FEATURE_VALUES_MAP_H_
