...
static V8GPUIndexFormat Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8GPUIndexFormat> Create(const String& value);

explicit constexpr  V8GPUIndexFormat(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8GPUIndexFormat& lhs, V8GPUIndexFormat::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8GPUIndexFormat::Enum lhs, const V8GPUIndexFormat& rhs) {
