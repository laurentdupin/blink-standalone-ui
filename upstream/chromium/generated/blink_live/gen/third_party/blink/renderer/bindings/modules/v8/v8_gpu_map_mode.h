...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_MAP_MODE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_MAP_MODE_H_
...
class MODULES_EXPORT V8GPUMapMode final : public bindings::V8InterfaceBridge<V8GPUMapMode, GPUMapMode> {
...
class Constant final {
  ...
  public:
static constexpr uint32_t kRead = 0x0001;
static constexpr uint32_t kWrite = 0x0002;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1481);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class GPUMapMode;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_MAP_MODE_H_
