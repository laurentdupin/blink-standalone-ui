...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EVENT_SOURCE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EVENT_SOURCE_H_
...
class MODULES_EXPORT V8EventSource final : public bindings::V8InterfaceBridge<V8EventSource, EventSource> {
...
class Constant final {
  ...
  public:
static constexpr uint16_t kConnecting = 0;
static constexpr uint16_t kOpen = 1;
static constexpr uint16_t kClosed = 2;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(544);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_EVENT_SOURCE_H_
