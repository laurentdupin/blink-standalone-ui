...
return dictionary;
 ...
 BluetoothManufacturerDataFilterInit::BluetoothManufacturerDataFilterInit(v8::Isolate* isolate) : BluetoothDataFilterInit(isolate) {
...
void BluetoothManufacturerDataFilterInit::FillTemplateProperties(Vector<std::string_view>& properties) const {
...
if (!bindings::GetDictionaryMemberFromV8Object<IDLUnsignedShortEnforceRange, is_required>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), fallback_presence_var, member_company_identifier_, class_like_name, exception_state)) {
  return;
}
}
