...
class CORE_EXPORT V8XMLHttpRequest final : public bindings::V8InterfaceBridge<V8XMLHttpRequest, XMLHttpRequest> {
...
class Constant final {
  ...
  public:
static constexpr uint16_t kUnsent = 0;
static constexpr uint16_t kOpened = 1;
static constexpr uint16_t kHeadersReceived = 2;
static constexpr uint16_t kLoading = 3;
static constexpr uint16_t kDone = 4;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(816);
