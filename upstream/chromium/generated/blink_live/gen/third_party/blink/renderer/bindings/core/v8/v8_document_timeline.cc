...
static_assert(std::derived_from<DocumentTimeline, AnimationTimeline>);
...
const WrapperTypeInfo V8DocumentTimeline::wrapper_type_info_{
    ...
    V8DocumentTimeline::kThisTag,
    V8DocumentTimeline::kMaxSubclassTag,
...
interface_function_template->SetInterfaceName(V8String(isolate, "DocumentTimeline"));
