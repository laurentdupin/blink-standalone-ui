...
v8::Local<v8::Value> V8UnionConstrainLongRangeOrLong::DirectToV8(ScriptState* script_state, ConstrainLongRange* value) {
  return ToV8Traits<ConstrainLongRange>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionConstrainLongRangeOrLong::DirectToV8(ScriptState* script_state, int32_t value) {
  return ToV8Traits<IDLLong>::ToV8(script_state, value);
}

void V8UnionConstrainLongRangeOrLong::Trace(Visitor* visitor) const {
  visitor->Trace(member_constrain_long_range_);
