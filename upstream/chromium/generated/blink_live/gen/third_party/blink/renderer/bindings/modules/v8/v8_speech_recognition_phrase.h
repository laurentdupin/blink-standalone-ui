...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SPEECH_RECOGNITION_PHRASE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SPEECH_RECOGNITION_PHRASE_H_
...
class MODULES_EXPORT V8SpeechRecognitionPhrase final : public bindings::V8InterfaceBridge<V8SpeechRecognitionPhrase, SpeechRecognitionPhrase> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1264);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SpeechRecognitionPhrase;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SPEECH_RECOGNITION_PHRASE_H_
