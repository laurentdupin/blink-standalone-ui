...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_USB_IN_TRANSFER_RESULT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_USB_IN_TRANSFER_RESULT_H_
...
class MODULES_EXPORT V8USBInTransferResult final : public bindings::V8InterfaceBridge<V8USBInTransferResult, USBInTransferResult> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1414);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class USBInTransferResult;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_USB_IN_TRANSFER_RESULT_H_
