...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SPEECH_SYNTHESIS_VOICE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SPEECH_SYNTHESIS_VOICE_H_
...
class MODULES_EXPORT V8SpeechSynthesisVoice final : public bindings::V8InterfaceBridge<V8SpeechSynthesisVoice, SpeechSynthesisVoice> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1267);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SpeechSynthesisVoice;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_SPEECH_SYNTHESIS_VOICE_H_
