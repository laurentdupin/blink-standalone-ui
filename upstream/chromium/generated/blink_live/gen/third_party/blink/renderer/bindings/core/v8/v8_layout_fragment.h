...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_LAYOUT_FRAGMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_LAYOUT_FRAGMENT_H_
...
class CORE_EXPORT V8LayoutFragment final : public bindings::V8InterfaceBridge<V8LayoutFragment, CustomLayoutFragment> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(926);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CustomLayoutFragment;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_LAYOUT_FRAGMENT_H_
