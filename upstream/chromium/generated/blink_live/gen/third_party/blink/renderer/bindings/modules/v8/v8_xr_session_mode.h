...
kInline, kImmersiveVr, kImmersiveAr
};
static constexpr size_t kEnumSize = 3;

static V8XRSessionMode Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8XRSessionMode> Create(const String& value);

explicit constexpr  V8XRSessionMode(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
