...
v8::Local<v8::Value> V8UnionStringOrTrustedScript::DirectToV8(ScriptState* script_state, const String& value) {
  return ToV8Traits<IDLString>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionStringOrTrustedScript::DirectToV8(ScriptState* script_state, TrustedScript* value) {
