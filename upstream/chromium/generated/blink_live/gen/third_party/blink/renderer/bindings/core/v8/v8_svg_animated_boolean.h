...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_ANIMATED_BOOLEAN_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_ANIMATED_BOOLEAN_H_
...
class CORE_EXPORT V8SVGAnimatedBoolean final : public bindings::V8InterfaceBridge<V8SVGAnimatedBoolean, SVGAnimatedBoolean> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(964);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGAnimatedBoolean;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_ANIMATED_BOOLEAN_H_
