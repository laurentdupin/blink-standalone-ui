...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GAMEPAD_HAPTIC_ACTUATOR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GAMEPAD_HAPTIC_ACTUATOR_H_
...
class MODULES_EXPORT V8GamepadHapticActuator final : public bindings::V8InterfaceBridge<V8GamepadHapticActuator, GamepadHapticActuator> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1169);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class GamepadHapticActuator;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GAMEPAD_HAPTIC_ACTUATOR_H_
