...
static_assert(std::derived_from<HTMLTableCellElement, HTMLElement>);
...
bindings::PerformAttributeSetCEReactionsReflectTypeString(info, html_names::kHeadersAttr);
}
...
bindings::PerformAttributeSetCEReactionsReflectTypeString(info, html_names::kAxisAttr);
}
...
bindings::PerformAttributeSetCEReactionsReflectTypeBoolean(info, html_names::kNowrapAttr);
}
...
bindings::PerformAttributeSetCEReactionsReflectTypeString(info, html_names::kAbbrAttr);
}
...
bindings::PerformAttributeSetCEReactionsReflectTypeString(info, html_names::kScopeAttr);
}
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLTableCellElement::GetWrapperTypeInfo(), ElementType::kHTMLTableCellElement);
}
...
void V8HTMLTableCellElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLTableCellElement", kAttributeTable);
}
