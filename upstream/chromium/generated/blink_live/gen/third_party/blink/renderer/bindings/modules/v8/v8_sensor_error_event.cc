...
bool V8SensorErrorEvent::IsExposed(ExecutionContext* execution_context) {
  
const bool is_in_secure_context = execution_context->IsSecureContext();
return is_in_secure_context && execution_context->IsWindow();
}

static_assert(std::derived_from<SensorErrorEvent, Event>);
...
const WrapperTypeInfo V8SensorErrorEvent::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SensorErrorEvent::InstallInterfaceTemplate,
    nullptr,
    "SensorErrorEvent",
    V8Event::GetWrapperTypeInfo(),
    V8SensorErrorEvent::kThisTag,
    V8SensorErrorEvent::kMaxSubclassTag,
...
const WrapperTypeInfo& SensorErrorEvent::wrapper_type_info_ =
    V8SensorErrorEvent::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, SensorErrorEvent>::value,
    "SensorErrorEvent inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_sensor_error_event {
...
BLINK_BINDINGS_TRACE_EVENT("SensorErrorEvent.error.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
SensorErrorEvent* blink_receiver = V8SensorErrorEvent::ToWrappableUnsafe(isolate, v8_receiver);
...
BLINK_BINDINGS_TRACE_EVENT("SensorErrorEvent.isTrusted.get");
...
BLINK_BINDINGS_TRACE_EVENT("SensorErrorEvent.constructor");
...
auto&& arg2_event_init_dict = NativeValueTraits<SensorErrorEventInit>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& return_value = SensorErrorEvent::Create(arg1_type, arg2_event_init_dict);
static_assert(bindings::IsReturnTypeCompatible<SensorErrorEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8SensorErrorEvent::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_sensor_error_event;

}  // namespace 

void V8SensorErrorEvent::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SensorErrorEvent::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "SensorErrorEvent"));
...
void V8SensorErrorEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SensorErrorEvent", kAttributeTable);
}
