...
kNone, kForwards, kBackwards, kBoth, kAuto
};
...
explicit constexpr  V8FillMode(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
