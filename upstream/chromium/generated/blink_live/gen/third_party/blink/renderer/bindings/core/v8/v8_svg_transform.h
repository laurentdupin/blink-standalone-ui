...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_TRANSFORM_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_TRANSFORM_H_
...
class CORE_EXPORT V8SVGTransform final : public bindings::V8InterfaceBridge<V8SVGTransform, SVGTransformTearOff> {
...
class Constant final {
  ...
  public:
static constexpr uint16_t kSVGTransformUnknown = 0;
static constexpr uint16_t kSVGTransformMatrix = 1;
static constexpr uint16_t kSVGTransformTranslate = 2;
static constexpr uint16_t kSVGTransformScale = 3;
static constexpr uint16_t kSVGTransformRotate = 4;
static constexpr uint16_t kSVGTransformSkewx = 5;
static constexpr uint16_t kSVGTransformSkewy = 6;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(985);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGTransformTearOff;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_TRANSFORM_H_
