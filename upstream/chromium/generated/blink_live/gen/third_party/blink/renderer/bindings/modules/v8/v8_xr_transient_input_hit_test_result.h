...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_TRANSIENT_INPUT_HIT_TEST_RESULT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_TRANSIENT_INPUT_HIT_TEST_RESULT_H_
...
class MODULES_EXPORT V8XRTransientInputHitTestResult final : public bindings::V8InterfaceBridge<V8XRTransientInputHitTestResult, XRTransientInputHitTestResult> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1450);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XRTransientInputHitTestResult;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_TRANSIENT_INPUT_HIT_TEST_RESULT_H_
