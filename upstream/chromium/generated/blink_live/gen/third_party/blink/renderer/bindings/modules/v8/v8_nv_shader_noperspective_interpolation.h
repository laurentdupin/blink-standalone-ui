...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1312);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class NVShaderNoperspectiveInterpolation;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_NV_SHADER_NOPERSPECTIVE_INTERPOLATION_H_
