...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_PROJECTION_LAYER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_PROJECTION_LAYER_H_
...
class MODULES_EXPORT V8XRProjectionLayer final : public bindings::V8InterfaceBridge<V8XRProjectionLayer, XRProjectionLayer> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(823);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XRProjectionLayer;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_PROJECTION_LAYER_H_
