...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_FILE_SYSTEM_SYNC_ACCESS_HANDLE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_FILE_SYSTEM_SYNC_ACCESS_HANDLE_H_
...
class MODULES_EXPORT V8FileSystemSyncAccessHandle final : public bindings::V8InterfaceBridge<V8FileSystemSyncAccessHandle, FileSystemSyncAccessHandle> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1153);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class FileSystemSyncAccessHandle;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_FILE_SYSTEM_SYNC_ACCESS_HANDLE_H_
