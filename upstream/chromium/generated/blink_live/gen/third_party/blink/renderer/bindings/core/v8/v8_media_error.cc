...
bool V8MediaError::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8MediaError::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8MediaError::InstallInterfaceTemplate,
    nullptr,
    "MediaError",
    nullptr,
    V8MediaError::kThisTag,
    V8MediaError::kMaxSubclassTag,
...
const WrapperTypeInfo& MediaError::wrapper_type_info_ =
    V8MediaError::wrapper_type_info_;

// non-[ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, MediaError>::value,
    "MediaError inherits from ActiveScriptWrappable<> without "
    "[ActiveScriptWrappable] extended attribute.");

namespace  {

namespace v8_media_error {
...
BLINK_BINDINGS_TRACE_EVENT("MediaError.code.get");


v8::Isolate* isolate = info.GetIsolate();
v8::Local<v8::Object> v8_receiver = info.This();
MediaError* blink_receiver = V8MediaError::ToWrappableUnsafe(isolate, v8_receiver);
...
BLINK_BINDINGS_TRACE_EVENT("MediaError.message.get");
...
using namespace v8_media_error;

}  // namespace 

void V8MediaError::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8MediaError::GetWrapperTypeInfo();
...
void V8MediaError::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "MediaError", kAttributeTable);
}
...
{"MEDIA_ERR_ABORTED", V8MediaError::Constant::kMediaErrAborted},
{"MEDIA_ERR_NETWORK", V8MediaError::Constant::kMediaErrNetwork},
{"MEDIA_ERR_DECODE", V8MediaError::Constant::kMediaErrDecode},
{"MEDIA_ERR_SRC_NOT_SUPPORTED", V8MediaError::Constant::kMediaErrSrcNotSupported},
};
