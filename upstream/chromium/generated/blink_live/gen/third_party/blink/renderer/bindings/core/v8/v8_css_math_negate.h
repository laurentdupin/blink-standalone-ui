...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_MATH_NEGATE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_MATH_NEGATE_H_
...
class CORE_EXPORT V8CSSMathNegate final : public bindings::V8InterfaceBridge<V8CSSMathNegate, CSSMathNegate> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(327);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSMathNegate;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_MATH_NEGATE_H_
