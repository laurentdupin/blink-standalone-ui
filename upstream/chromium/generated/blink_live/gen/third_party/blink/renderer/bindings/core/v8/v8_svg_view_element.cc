...
static_assert(std::derived_from<SVGViewElement, SVGElement>);
...
const WrapperTypeInfo V8SVGViewElement::wrapper_type_info_{
    ...
    V8SVGViewElement::kThisTag,
    V8SVGViewElement::kMaxSubclassTag,
...
void V8SVGViewElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGViewElement", kAttributeTable);
}
