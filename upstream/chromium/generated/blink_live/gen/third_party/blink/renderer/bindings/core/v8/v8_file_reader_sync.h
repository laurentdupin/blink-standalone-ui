...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_FILE_READER_SYNC_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_FILE_READER_SYNC_H_
...
class CORE_EXPORT V8FileReaderSync final : public bindings::V8InterfaceBridge<V8FileReaderSync, FileReaderSync> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(851);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class FileReaderSync;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_FILE_READER_SYNC_H_
