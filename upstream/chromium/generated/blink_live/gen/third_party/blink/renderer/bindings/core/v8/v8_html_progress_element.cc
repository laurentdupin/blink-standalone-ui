...
bool V8HTMLProgressElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<HTMLProgressElement, HTMLElement>);
...
const WrapperTypeInfo V8HTMLProgressElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8HTMLProgressElement::InstallInterfaceTemplate,
    nullptr,
    "HTMLProgressElement",
    V8HTMLElement::GetWrapperTypeInfo(),
    V8HTMLProgressElement::kThisTag,
    V8HTMLProgressElement::kMaxSubclassTag,
...
const WrapperTypeInfo& HTMLProgressElement::wrapper_type_info_ =
    V8HTMLProgressElement::wrapper_type_info_;
...
namespace v8_html_progress_element {
...
BLINK_BINDINGS_TRACE_EVENT("HTMLProgressElement.value.get");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLProgressElement.value.set");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLProgressElement.max.get");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLProgressElement.max.set");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLProgressElement.position.get");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLProgressElement.labels.get");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLProgressElement.constructor");
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLProgressElement::GetWrapperTypeInfo(), ElementType::kHTMLProgressElement);
}


}  // namespace v8_html_progress_element

using namespace v8_html_progress_element;

}  // namespace 

void V8HTMLProgressElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8HTMLProgressElement::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "HTMLProgressElement"));
...
void V8HTMLProgressElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLProgressElement", kAttributeTable);
}
