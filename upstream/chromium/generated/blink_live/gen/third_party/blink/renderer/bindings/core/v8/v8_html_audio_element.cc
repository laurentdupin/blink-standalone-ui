...
bool V8HTMLAudioElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<HTMLAudioElement, HTMLMediaElement>);
...
const WrapperTypeInfo V8HTMLAudioElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8HTMLAudioElement::InstallInterfaceTemplate,
    nullptr,
    "HTMLAudioElement",
    V8HTMLMediaElement::GetWrapperTypeInfo(),
    V8HTMLAudioElement::kThisTag,
    V8HTMLAudioElement::kMaxSubclassTag,
...
const WrapperTypeInfo& HTMLAudioElement::wrapper_type_info_ =
    V8HTMLAudioElement::wrapper_type_info_;
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLAudioElement::GetWrapperTypeInfo(), ElementType::kHTMLAudioElement);
}


}  // namespace v8_html_audio_element

using namespace v8_html_audio_element;

}  // namespace 

void V8HTMLAudioElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8HTMLAudioElement::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "HTMLAudioElement"));
