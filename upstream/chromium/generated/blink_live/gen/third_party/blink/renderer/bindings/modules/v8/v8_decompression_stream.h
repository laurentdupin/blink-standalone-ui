...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DECOMPRESSION_STREAM_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DECOMPRESSION_STREAM_H_
...
class MODULES_EXPORT V8DecompressionStream final : public bindings::V8InterfaceBridge<V8DecompressionStream, DecompressionStream> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1115);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class DecompressionStream;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_DECOMPRESSION_STREAM_H_
