...
bool hasAccuracyMode() const {
  return true;
}
V8AccuracyMode accuracyMode() const {
  return member_accuracy_mode_;
}
void setAccuracyMode(V8AccuracyMode value) {
  member_accuracy_mode_ = value;
}
void setAccuracyMode(V8AccuracyMode::Enum value) {
  member_accuracy_mode_ = V8AccuracyMode(value);
}
...
V8AccuracyMode member_accuracy_mode_{V8AccuracyMode::Enum::kPrecise};
