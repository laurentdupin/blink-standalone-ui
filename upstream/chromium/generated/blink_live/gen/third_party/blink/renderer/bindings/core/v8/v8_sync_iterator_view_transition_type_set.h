...
template <>
class CORE_EXPORT SyncIterator<ViewTransitionTypeSet> final : public bindings::SyncIteratorBase {
...
explicit  SyncIterator<ViewTransitionTypeSet>(IterationSourceBase* source, Kind kind) : bindings::SyncIteratorBase(source, kind) {
...
class CORE_EXPORT V8SyncIteratorViewTransitionTypeSet final : public bindings::V8InterfaceBridge<V8SyncIteratorViewTransitionTypeSet, SyncIterator<ViewTransitionTypeSet>> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1494);
