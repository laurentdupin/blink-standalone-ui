...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_NAVIGATOR_LOGIN_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_NAVIGATOR_LOGIN_H_
...
class MODULES_EXPORT V8NavigatorLogin final : public bindings::V8InterfaceBridge<V8NavigatorLogin, NavigatorLogin> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1131);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class NavigatorLogin;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_NAVIGATOR_LOGIN_H_
