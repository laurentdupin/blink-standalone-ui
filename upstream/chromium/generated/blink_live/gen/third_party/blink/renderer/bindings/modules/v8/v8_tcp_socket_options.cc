...
return dictionary;
 ...
 TCPSocketOptions::TCPSocketOptions(v8::Isolate* isolate) : SocketOptions(isolate) {
...
if (!bindings::GetDictionaryMemberFromV8Object<IDLUnsignedLongEnforceRange, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[1].Get(isolate), has_keep_alive_delay_, member_keep_alive_delay_, class_like_name, exception_state)) {
  return;
}
dictionary_from_v8_context.SetCurrentPropertyName("noDelay");
bool fallback_presence_var;
if (!bindings::GetDictionaryMemberFromV8Object<IDLBoolean, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[2].Get(isolate), fallback_presence_var, member_no_delay_, class_like_name, exception_state)) {
  return;
}
}
