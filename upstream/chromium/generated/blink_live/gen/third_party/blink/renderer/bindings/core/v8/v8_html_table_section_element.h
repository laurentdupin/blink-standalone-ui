...
class CORE_EXPORT V8HTMLTableSectionElement final : public bindings::V8InterfaceBridge<V8HTMLTableSectionElement, HTMLTableSectionElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(666);
