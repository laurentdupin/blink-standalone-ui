...
const String& priv() const {
  DCHECK(hasPriv());
return member_priv_;
}
String getPrivOr(const String& fallback_value) const;
String getPrivOr(String&& fallback_value) const;
void setPriv(const String& value);
void setPriv(String&& value);

bool hasPub() const {
  return has_pub_;
}
const String& pub() const {
  DCHECK(hasPub());
return member_pub_;
}
String getPubOr(const String& fallback_value) const;
String getPubOr(String&& fallback_value) const;
void setPub(const String& value);
