...
bool V8HTMLDocument::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<HTMLDocument, Document>);
...
const WrapperTypeInfo V8HTMLDocument::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8HTMLDocument::InstallInterfaceTemplate,
    nullptr,
    "HTMLDocument",
    V8Document::GetWrapperTypeInfo(),
    V8HTMLDocument::kThisTag,
    V8HTMLDocument::kMaxSubclassTag,
...
const WrapperTypeInfo& HTMLDocument::wrapper_type_info_ =
    V8HTMLDocument::wrapper_type_info_;
...
BLINK_BINDINGS_TRACE_EVENT("HTMLDocument.location.get");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLDocument.location.set");
...
using namespace v8_html_document;

}  // namespace 

void V8HTMLDocument::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8HTMLDocument::GetWrapperTypeInfo();
...
void V8HTMLDocument::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLDocument", kAttributeTable);
}
...
reinterpret_cast<intptr_t>(V8HTMLDocument::GetWrapperTypeInfo()),
...
void InstallPropsOfV8HTMLDocument(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
