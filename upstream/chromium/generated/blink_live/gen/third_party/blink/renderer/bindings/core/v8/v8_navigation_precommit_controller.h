...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NAVIGATION_PRECOMMIT_CONTROLLER_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NAVIGATION_PRECOMMIT_CONTROLLER_H_
...
class CORE_EXPORT V8NavigationPrecommitController final : public bindings::V8InterfaceBridge<V8NavigationPrecommitController, NavigationPrecommitController> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(934);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class NavigationPrecommitController;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_NAVIGATION_PRECOMMIT_CONTROLLER_H_
