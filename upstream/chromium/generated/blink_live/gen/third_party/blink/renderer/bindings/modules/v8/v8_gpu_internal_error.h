...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_INTERNAL_ERROR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_INTERNAL_ERROR_H_
...
class MODULES_EXPORT V8GPUInternalError final : public bindings::V8InterfaceBridge<V8GPUInternalError, GPUInternalError> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1383);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class GPUInternalError;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_GPU_INTERNAL_ERROR_H_
