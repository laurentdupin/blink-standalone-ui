...
class MODULES_EXPORT V8CanvasRenderingContext2D final : public bindings::V8InterfaceBridge<V8CanvasRenderingContext2D, CanvasRenderingContext2D> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1106);
