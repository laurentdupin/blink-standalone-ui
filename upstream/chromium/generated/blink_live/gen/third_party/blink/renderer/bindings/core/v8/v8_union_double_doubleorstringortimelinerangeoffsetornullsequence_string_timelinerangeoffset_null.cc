...
v8::Local<v8::Value> V8UnionDoubleOrDoubleOrStringOrTimelineRangeOffsetOrNullSequenceOrStringOrTimelineRangeOffsetOrNull::DirectToV8(ScriptState* script_state, double value) {
  return ToV8Traits<IDLDouble>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionDoubleOrDoubleOrStringOrTimelineRangeOffsetOrNullSequenceOrStringOrTimelineRangeOffsetOrNull::DirectToV8(ScriptState* script_state, const HeapVector<Member<V8UnionDoubleOrStringOrTimelineRangeOffset>>& value) {
  return ToV8Traits<IDLSequence<IDLNullable<V8UnionDoubleOrStringOrTimelineRangeOffset>>>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionDoubleOrDoubleOrStringOrTimelineRangeOffsetOrNullSequenceOrStringOrTimelineRangeOffsetOrNull::DirectToV8(ScriptState* script_state, const String& value) {
  return ToV8Traits<IDLString>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionDoubleOrDoubleOrStringOrTimelineRangeOffsetOrNullSequenceOrStringOrTimelineRangeOffsetOrNull::DirectToV8(ScriptState* script_state, TimelineRangeOffset* value) {
  return ToV8Traits<TimelineRangeOffset>::ToV8(script_state, value);
}
