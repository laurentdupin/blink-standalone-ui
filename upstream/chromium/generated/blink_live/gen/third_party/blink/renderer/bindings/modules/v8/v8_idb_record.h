...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_IDB_RECORD_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_IDB_RECORD_H_
...
class MODULES_EXPORT V8IDBRecord final : public bindings::V8InterfaceBridge<V8IDBRecord, IDBRecord> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1181);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class IDBRecord;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_IDB_RECORD_H_
