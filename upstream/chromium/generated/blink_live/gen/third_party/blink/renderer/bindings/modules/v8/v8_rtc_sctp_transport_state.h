...
class MODULES_EXPORT V8RTCSctpTransportState final : public bindings::EnumerationBase {
  
  public:
enum class Enum : enum_int_t {
kConnecting, kConnected, kClosed
};
static constexpr size_t kEnumSize = 3;

static V8RTCSctpTransportState Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8RTCSctpTransportState> Create(const String& value);

explicit constexpr  V8RTCSctpTransportState(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8RTCSctpTransportState& lhs, V8RTCSctpTransportState::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8RTCSctpTransportState::Enum lhs, const V8RTCSctpTransportState& rhs) {
