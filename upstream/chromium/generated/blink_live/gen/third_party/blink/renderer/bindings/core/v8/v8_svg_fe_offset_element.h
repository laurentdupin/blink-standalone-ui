...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_OFFSET_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_OFFSET_ELEMENT_H_
...
class CORE_EXPORT V8SVGFEOffsetElement final : public bindings::V8InterfaceBridge<V8SVGFEOffsetElement, SVGFEOffsetElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(704);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGFEOffsetElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_OFFSET_ELEMENT_H_
