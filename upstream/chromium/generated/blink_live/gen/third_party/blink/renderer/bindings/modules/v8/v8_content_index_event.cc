...
bool V8ContentIndexEvent::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsServiceWorkerGlobalScope() && RuntimeEnabledFeatures::ContentIndexEnabled();
}

static_assert(std::derived_from<ContentIndexEvent, ExtendableEvent>);
...
const WrapperTypeInfo V8ContentIndexEvent::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8ContentIndexEvent::InstallInterfaceTemplate,
    nullptr,
    "ContentIndexEvent",
    V8ExtendableEvent::GetWrapperTypeInfo(),
    V8ContentIndexEvent::kThisTag,
    V8ContentIndexEvent::kMaxSubclassTag,
...
const WrapperTypeInfo& ContentIndexEvent::wrapper_type_info_ =
    V8ContentIndexEvent::wrapper_type_info_;
...
namespace v8_content_index_event {


void IdAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_ContentIndexEvent_id_Getter");
BLINK_BINDINGS_TRACE_EVENT("ContentIndexEvent.id.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_ContentIndexEvent_isTrusted_Getter");
BLINK_BINDINGS_TRACE_EVENT("ContentIndexEvent.isTrusted.get");
...
void ConstructorCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_ContentIndexEvent_constructor");
BLINK_BINDINGS_TRACE_EVENT("ContentIndexEvent.constructor");
...
auto&& arg2_init = NativeValueTraits<ContentIndexEventInit>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& return_value = ContentIndexEvent::Create(arg1_type, arg2_init);
static_assert(bindings::IsReturnTypeCompatible<ContentIndexEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8ContentIndexEvent::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_content_index_event;

}  // namespace 

void V8ContentIndexEvent::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8ContentIndexEvent::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "ContentIndexEvent"));
...
void V8ContentIndexEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "ContentIndexEvent", kAttributeTable);
}
