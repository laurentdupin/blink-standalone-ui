...
bool V8XRInputSourcesChangeEvent::IsExposed(ExecutionContext* execution_context) {
  
const bool is_in_secure_context = execution_context->IsSecureContext();
return is_in_secure_context && execution_context->IsWindow() && RuntimeEnabledFeatures::WebXREnabled();
}

static_assert(std::derived_from<XRInputSourcesChangeEvent, Event>);
...
const WrapperTypeInfo V8XRInputSourcesChangeEvent::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8XRInputSourcesChangeEvent::InstallInterfaceTemplate,
    nullptr,
    "XRInputSourcesChangeEvent",
    V8Event::GetWrapperTypeInfo(),
    V8XRInputSourcesChangeEvent::kThisTag,
    V8XRInputSourcesChangeEvent::kMaxSubclassTag,
...
const WrapperTypeInfo& XRInputSourcesChangeEvent::wrapper_type_info_ =
    V8XRInputSourcesChangeEvent::wrapper_type_info_;
...
namespace v8_xr_input_sources_change_event {
...
BLINK_BINDINGS_TRACE_EVENT("XRInputSourcesChangeEvent.session.get");
...
void AddedAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRInputSourcesChangeEvent_added_Getter");
BLINK_BINDINGS_TRACE_EVENT("XRInputSourcesChangeEvent.added.get");
...
static_assert(bindings::IsReturnTypeCompatible<IDLArray<XRInputSource>, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Value> v8_return_value = ToV8Traits<IDLArray<XRInputSource>>::ToV8(script_state, return_value);
bindings::V8SetReturnValue(info, v8_return_value);
}



void RemovedAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_XRInputSourcesChangeEvent_removed_Getter");
BLINK_BINDINGS_TRACE_EVENT("XRInputSourcesChangeEvent.removed.get");
...
BLINK_BINDINGS_TRACE_EVENT("XRInputSourcesChangeEvent.isTrusted.get");
...
BLINK_BINDINGS_TRACE_EVENT("XRInputSourcesChangeEvent.constructor");
...
auto&& arg2_event_init_dict = NativeValueTraits<XRInputSourcesChangeEventInit>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
auto&& return_value = XRInputSourcesChangeEvent::Create(arg1_type, arg2_event_init_dict);
static_assert(bindings::IsReturnTypeCompatible<XRInputSourcesChangeEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8XRInputSourcesChangeEvent::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_xr_input_sources_change_event;

}  // namespace 

void V8XRInputSourcesChangeEvent::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8XRInputSourcesChangeEvent::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "XRInputSourcesChangeEvent"));
...
void V8XRInputSourcesChangeEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"added", AddedAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
{"removed", RemovedAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "XRInputSourcesChangeEvent", kAttributeTable);
}
