...
class CORE_EXPORT V8MojoHandle final : public bindings::V8InterfaceBridge<V8MojoHandle, MojoHandle> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(929);
