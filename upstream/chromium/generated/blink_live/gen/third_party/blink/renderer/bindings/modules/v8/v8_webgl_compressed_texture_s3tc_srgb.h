...
class MODULES_EXPORT V8WebGLCompressedTextureS3TCsRGB final : public bindings::V8InterfaceBridge<V8WebGLCompressedTextureS3TCsRGB, WebGLCompressedTextureS3TCsRGB> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1336);
