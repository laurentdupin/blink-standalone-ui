...
class CORE_EXPORT V8TextMetrics final : public bindings::V8InterfaceBridge<V8TextMetrics, TextMetrics> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(894);
