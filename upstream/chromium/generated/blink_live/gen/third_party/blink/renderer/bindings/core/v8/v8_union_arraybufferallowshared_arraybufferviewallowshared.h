...
using Ret = bindings::OptimizedReturnProxy<V8UnionArrayBufferAllowSharedOrArrayBufferViewAllowShared>;
v8::Local<v8::Value> ToV8(ScriptState* script_state) const;

static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, DOMArrayBufferBase* value);
static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, MaybeShared<DOMArrayBufferView> value);
