...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_RTP_SCRIPT_TRANSFORM_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_RTP_SCRIPT_TRANSFORM_H_
...
class MODULES_EXPORT V8RTCRtpScriptTransform final : public bindings::V8InterfaceBridge<V8RTCRtpScriptTransform, RTCRtpScriptTransform> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1221);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class RTCRtpScriptTransform;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_RTP_SCRIPT_TRANSFORM_H_
