...
bool V8Credential::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8Credential::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8Credential::InstallInterfaceTemplate,
    nullptr,
    "Credential",
    nullptr,
    V8Credential::kThisTag,
    V8Credential::kMaxSubclassTag,
...
const WrapperTypeInfo& Credential::wrapper_type_info_ =
    V8Credential::wrapper_type_info_;
...
BLINK_BINDINGS_TRACE_EVENT("Credential.id.get");
...
BLINK_BINDINGS_TRACE_EVENT("Credential.type.get");
...
void IsConditionalMediationAvailableStaticOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_Credential_isConditionalMediationAvailable");
BLINK_BINDINGS_TRACE_EVENT("Credential.isConditionalMediationAvailable");
...
auto&& return_value = Credential::isConditionalMediationAvailable(script_state);
...
using namespace v8_credential;

}  // namespace 

void V8Credential::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8Credential::GetWrapperTypeInfo();
...
void V8Credential::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "Credential", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "Credential", kOperationTable);
}
