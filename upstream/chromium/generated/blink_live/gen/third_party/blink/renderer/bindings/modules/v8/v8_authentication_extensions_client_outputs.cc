...
visitor->Trace(member_get_cred_blob_);
...
void AuthenticationExtensionsClientOutputs::FillTemplateProperties(Vector<std::string_view>& properties) const {
...
if (hasPayment()) {
  values[6] = ToV8Traits<AuthenticationExtensionsPaymentOutputs>::ToV8(script_state, member_payment_.Get());
DCHECK(!values[6].IsEmpty());
}
if (hasPrf()) {
  values[7] = ToV8Traits<AuthenticationExtensionsPRFOutputs>::ToV8(script_state, member_prf_.Get());
DCHECK(!values[7].IsEmpty());
}
if (RuntimeEnabledFeatures::WebAuthenticationSupplementalPubKeysEnabled()) {
  if (hasSupplementalPubKeys()) {
  values[8] = ToV8Traits<AuthenticationExtensionsSupplementalPubKeysOutputs>::ToV8(script_state, member_supplemental_pub_keys_.Get());
DCHECK(!values[8].IsEmpty());
}
}
if (hasUvm()) {
  values[9] = ToV8Traits<IDLSequence<IDLSequence<IDLUnsignedLong>>>::ToV8(script_state, member_uvm_);
...
if (!bindings::GetDictionaryMemberFromV8Object<DOMArrayBuffer, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[3].Get(isolate), has_get_cred_blob_, member_get_cred_blob_, class_like_name, exception_state)) {
  return;
}
...
if (!bindings::GetDictionaryMemberFromV8Object<AuthenticationExtensionsLargeBlobOutputs, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[5].Get(isolate), has_large_blob_, member_large_blob_, class_like_name, exception_state)) {
  return;
}
dictionary_from_v8_context.SetCurrentPropertyName("payment");
if (!bindings::GetDictionaryMemberFromV8Object<AuthenticationExtensionsPaymentOutputs, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[6].Get(isolate), has_payment_, member_payment_, class_like_name, exception_state)) {
  return;
}
dictionary_from_v8_context.SetCurrentPropertyName("prf");
if (!bindings::GetDictionaryMemberFromV8Object<AuthenticationExtensionsPRFOutputs, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[7].Get(isolate), has_prf_, member_prf_, class_like_name, exception_state)) {
  return;
}
if (RuntimeEnabledFeatures::WebAuthenticationSupplementalPubKeysEnabled()) {
  dictionary_from_v8_context.SetCurrentPropertyName("supplementalPubKeys");
if (!bindings::GetDictionaryMemberFromV8Object<AuthenticationExtensionsSupplementalPubKeysOutputs, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[8].Get(isolate), has_supplemental_pub_keys_, member_supplemental_pub_keys_, class_like_name, exception_state)) {
  return;
}
}
dictionary_from_v8_context.SetCurrentPropertyName("uvm");
if (!bindings::GetDictionaryMemberFromV8Object<IDLSequence<IDLSequence<IDLUnsignedLong>>, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[9].Get(isolate), has_uvm_, member_uvm_, class_like_name, exception_state)) {
  return;
}
}
