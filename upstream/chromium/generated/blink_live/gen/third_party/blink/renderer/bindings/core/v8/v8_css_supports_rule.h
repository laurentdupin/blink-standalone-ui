...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_SUPPORTS_RULE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_SUPPORTS_RULE_H_
...
class CORE_EXPORT V8CSSSupportsRule final : public bindings::V8InterfaceBridge<V8CSSSupportsRule, CSSSupportsRule> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSSupportsRule;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_SUPPORTS_RULE_H_
