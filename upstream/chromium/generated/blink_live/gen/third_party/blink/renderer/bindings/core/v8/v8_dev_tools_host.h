...
class CORE_EXPORT V8DevToolsHost final : public bindings::V8InterfaceBridge<V8DevToolsHost, DevToolsHost> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(918);
