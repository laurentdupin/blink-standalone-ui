...
bool V8SVGNumber::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8SVGNumber::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8SVGNumber::InstallInterfaceTemplate,
    nullptr,
    "SVGNumber",
    nullptr,
    V8SVGNumber::kThisTag,
    V8SVGNumber::kMaxSubclassTag,
...
const WrapperTypeInfo& SVGNumberTearOff::wrapper_type_info_ =
    V8SVGNumber::wrapper_type_info_;
...
BLINK_BINDINGS_TRACE_EVENT("SVGNumber.value.get");
...
BLINK_BINDINGS_TRACE_EVENT("SVGNumber.value.set");
...
using namespace v8_svg_number;

}  // namespace 

void V8SVGNumber::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8SVGNumber::GetWrapperTypeInfo();
...
void V8SVGNumber::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGNumber", kAttributeTable);
}
