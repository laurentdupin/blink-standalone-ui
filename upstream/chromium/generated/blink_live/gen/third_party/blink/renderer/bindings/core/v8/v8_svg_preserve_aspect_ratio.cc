...
const WrapperTypeInfo V8SVGPreserveAspectRatio::wrapper_type_info_{
    ...
    nullptr,
    V8SVGPreserveAspectRatio::kThisTag,
    V8SVGPreserveAspectRatio::kMaxSubclassTag,
...
void V8SVGPreserveAspectRatio::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "SVGPreserveAspectRatio", kAttributeTable);
}
