...
using Ret = bindings::OptimizedReturnProxy<V8UnionReadableByteStreamControllerOrReadableStreamDefaultController>;
v8::Local<v8::Value> ToV8(ScriptState* script_state) const;

static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, ReadableByteStreamController* value);
static v8::Local<v8::Value> DirectToV8(ScriptState* script_state, ReadableStreamDefaultController* value);
