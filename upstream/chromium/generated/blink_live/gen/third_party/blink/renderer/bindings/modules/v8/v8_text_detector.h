...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_TEXT_DETECTOR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_TEXT_DETECTOR_H_
...
class MODULES_EXPORT V8TextDetector final : public bindings::V8InterfaceBridge<V8TextDetector, TextDetector> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1251);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class TextDetector;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_TEXT_DETECTOR_H_
