...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_STORAGE_ACCESS_HANDLE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_STORAGE_ACCESS_HANDLE_H_
...
class MODULES_EXPORT V8StorageAccessHandle final : public bindings::V8InterfaceBridge<V8StorageAccessHandle, StorageAccessHandle> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1270);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class StorageAccessHandle;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_STORAGE_ACCESS_HANDLE_H_
