...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_VIEW_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_VIEW_ELEMENT_H_
...
class CORE_EXPORT V8SVGViewElement final : public bindings::V8InterfaceBridge<V8SVGViewElement, SVGViewElement> {
...
class Constant final {
  ...
  public:
static constexpr uint16_t kSVGZoomandpanUnknown = 0;
static constexpr uint16_t kSVGZoomandpanDisable = 1;
static constexpr uint16_t kSVGZoomandpanMagnify = 2;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(746);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGViewElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_VIEW_ELEMENT_H_
