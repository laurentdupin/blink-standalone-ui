...
bool V8CompressionStream::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8CompressionStream::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8CompressionStream::InstallInterfaceTemplate,
    nullptr,
    "CompressionStream",
    nullptr,
    V8CompressionStream::kThisTag,
    V8CompressionStream::kMaxSubclassTag,
...
const WrapperTypeInfo& CompressionStream::wrapper_type_info_ =
    V8CompressionStream::wrapper_type_info_;
...
namespace v8_compression_stream {
...
BLINK_BINDINGS_TRACE_EVENT("CompressionStream.readable.get");
...
BLINK_BINDINGS_TRACE_EVENT("CompressionStream.writable.get");
...
BLINK_BINDINGS_TRACE_EVENT("CompressionStream.constructor");
...
// [Measure], [MeasureAs]
UseCounter::Count(current_execution_context, WebFeature::kCompressionStreamConstructor);
...
auto&& return_value = CompressionStream::Create(script_state, arg1_format, exception_state);
static_assert(bindings::IsReturnTypeCompatible<CompressionStream, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
if (exception_state.HadException()) [[unlikely]] {
  return;
}
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8CompressionStream::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_compression_stream;

}  // namespace 

void V8CompressionStream::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8CompressionStream::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "CompressionStream"));
...
void V8CompressionStream::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "CompressionStream", kAttributeTable);
}
