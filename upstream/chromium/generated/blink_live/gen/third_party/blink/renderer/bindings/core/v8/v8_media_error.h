...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_MEDIA_ERROR_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_MEDIA_ERROR_H_
...
class CORE_EXPORT V8MediaError final : public bindings::V8InterfaceBridge<V8MediaError, MediaError> {
...
class Constant final {
  ...
  public:
static constexpr uint16_t kMediaErrAborted = 1;
static constexpr uint16_t kMediaErrNetwork = 2;
static constexpr uint16_t kMediaErrDecode = 3;
static constexpr uint16_t kMediaErrSrcNotSupported = 4;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(908);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class MediaError;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_MEDIA_ERROR_H_
