...
const WrapperTypeInfo& XPathEvaluator::wrapper_type_info_ =
    V8XPathEvaluator::wrapper_type_info_;
...
auto&& return_value = blink_receiver->evaluate(execution_context, arg1_expression, arg2_context_node, arg3_resolver, arg4_type, arg5_in_result, exception_state);
...
void V8XPathEvaluator::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "XPathEvaluator", kOperationTable);
}
