...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_IMAGE_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_IMAGE_ELEMENT_H_
...
class CORE_EXPORT V8SVGFEImageElement final : public bindings::V8InterfaceBridge<V8SVGFEImageElement, SVGFEImageElement> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(700);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGFEImageElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_IMAGE_ELEMENT_H_
