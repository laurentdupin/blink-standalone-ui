...
bool V8MediaList::IsExposed(ExecutionContext* execution_context) {
...
const WrapperTypeInfo V8MediaList::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8MediaList::InstallInterfaceTemplate,
    nullptr,
    "MediaList",
    nullptr,
    V8MediaList::kThisTag,
    V8MediaList::kMaxSubclassTag,
...
const WrapperTypeInfo& MediaList::wrapper_type_info_ =
    V8MediaList::wrapper_type_info_;
...
v8::Intercepted V8MediaList::IndexedPropertyGetterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
...
v8::Intercepted V8MediaList::IndexedPropertySetterCallback(uint32_t index, v8::Local<v8::Value> v8_property_value, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaList_IndexedPropertySetter");
...
v8::Intercepted V8MediaList::IndexedPropertyDeleterCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaList_IndexedPropertyDeleter");
...
v8::Intercepted V8MediaList::IndexedPropertyDefinerCallback(uint32_t index, const v8::PropertyDescriptor& v8_property_desc, const v8::PropertyCallbackInfo<v8::Boolean>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaList_IndexedPropertyDefiner");
...
v8::Intercepted V8MediaList::IndexedPropertyDescriptorCallback(uint32_t index, const v8::PropertyCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaList_IndexedPropertyDescriptor");
...
BLINK_BINDINGS_TRACE_EVENT("MediaList.length.get");
...
void MediaTextAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaList_mediaText_Getter");
BLINK_BINDINGS_TRACE_EVENT("MediaList.mediaText.get");
...
void MediaTextAttributeSetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaList_mediaText_Setter");
BLINK_BINDINGS_TRACE_EVENT("MediaList.mediaText.set");
...
blink_receiver->setMediaText(execution_context, arg1_value);

}

void AppendMediumOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaList_appendMedium");
BLINK_BINDINGS_TRACE_EVENT("MediaList.appendMedium");
...
if (info[0]->IsString()) [[likely]] {
  ...
  ExceptionState exception_state(isolate);
arg1_medium = NativeValueTraits<IDLString>::ArgumentValue(isolate, 0, info[0], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
}
blink_receiver->appendMedium(execution_context, arg1_medium);

}

void DeleteMediumOperationCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_MediaList_deleteMedium");
BLINK_BINDINGS_TRACE_EVENT("MediaList.deleteMedium");
...
blink_receiver->deleteMedium(execution_context, arg1_medium, exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
...
BLINK_BINDINGS_TRACE_EVENT("MediaList.item");
...
using namespace v8_media_list;

}  // namespace 

void V8MediaList::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8MediaList::GetWrapperTypeInfo();
...
instance_template->SetHandler(
    v8::IndexedPropertyHandlerConfiguration(
        ...
        nullptr,  // query
        V8MediaList::IndexedPropertyDeleterCallback,
        V8MediaList::IndexedPropertyEnumeratorCallback,
...
void V8MediaList::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
{"mediaText", MediaTextAttributeGetCallback, MediaTextAttributeSetCallback, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
};
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "MediaList", kAttributeTable);
}
...
{"appendMedium", AppendMediumOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
{"deleteMedium", DeleteMediumOperationCallback, 1, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasSideEffect)}, 
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "MediaList", kOperationTable);
}
