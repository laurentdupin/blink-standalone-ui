...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SELECTOR_DIRECTIVE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SELECTOR_DIRECTIVE_H_
...
class CORE_EXPORT V8SelectorDirective final : public bindings::V8InterfaceBridge<V8SelectorDirective, SelectorDirective> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(856);
  static constexpr v8::CppHeapPointerTag kMaxSubclassTag =
      static_cast<v8::CppHeapPointerTag>(857);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SelectorDirective;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SELECTOR_DIRECTIVE_H_
