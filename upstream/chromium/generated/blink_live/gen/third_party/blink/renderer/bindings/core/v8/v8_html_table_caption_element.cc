...
bool V8HTMLTableCaptionElement::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow();
}

static_assert(std::derived_from<HTMLTableCaptionElement, HTMLElement>);
...
const WrapperTypeInfo V8HTMLTableCaptionElement::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8HTMLTableCaptionElement::InstallInterfaceTemplate,
    nullptr,
    "HTMLTableCaptionElement",
    V8HTMLElement::GetWrapperTypeInfo(),
    V8HTMLTableCaptionElement::kThisTag,
    V8HTMLTableCaptionElement::kMaxSubclassTag,
...
const WrapperTypeInfo& HTMLTableCaptionElement::wrapper_type_info_ =
    V8HTMLTableCaptionElement::wrapper_type_info_;
...
namespace v8_html_table_caption_element {
...
BLINK_BINDINGS_TRACE_EVENT("HTMLTableCaptionElement.align.get");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLTableCaptionElement.align.set");
...
BLINK_BINDINGS_TRACE_EVENT("HTMLTableCaptionElement.constructor");
...
// [HTMLConstructor]
V8HTMLConstructor::HtmlConstructor(info, *V8HTMLTableCaptionElement::GetWrapperTypeInfo(), ElementType::kHTMLTableCaptionElement);
}


}  // namespace v8_html_table_caption_element

using namespace v8_html_table_caption_element;

}  // namespace 

void V8HTMLTableCaptionElement::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8HTMLTableCaptionElement::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "HTMLTableCaptionElement"));
...
void V8HTMLTableCaptionElement::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "HTMLTableCaptionElement", kAttributeTable);
}
