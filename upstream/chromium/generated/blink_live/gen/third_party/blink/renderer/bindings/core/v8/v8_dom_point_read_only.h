...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_DOM_POINT_READ_ONLY_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_DOM_POINT_READ_ONLY_H_
...
class CORE_EXPORT V8DOMPointReadOnly final : public bindings::V8InterfaceBridge<V8DOMPointReadOnly, DOMPointReadOnly> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(883);
  static constexpr v8::CppHeapPointerTag kMaxSubclassTag =
      static_cast<v8::CppHeapPointerTag>(884);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class DOMPointReadOnly;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_DOM_POINT_READ_ONLY_H_
