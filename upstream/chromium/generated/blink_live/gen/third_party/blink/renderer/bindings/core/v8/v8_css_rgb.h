...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_RGB_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_RGB_H_
...
class CORE_EXPORT V8CSSRGB final : public bindings::V8InterfaceBridge<V8CSSRGB, CSSRGB> {
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_RGB_H_
