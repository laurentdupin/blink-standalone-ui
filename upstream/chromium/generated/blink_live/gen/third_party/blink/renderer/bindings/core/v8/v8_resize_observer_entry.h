...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_RESIZE_OBSERVER_ENTRY_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_RESIZE_OBSERVER_ENTRY_H_
...
class CORE_EXPORT V8ResizeObserverEntry final : public bindings::V8InterfaceBridge<V8ResizeObserverEntry, ResizeObserverEntry> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(940);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class ResizeObserverEntry;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_RESIZE_OBSERVER_ENTRY_H_
