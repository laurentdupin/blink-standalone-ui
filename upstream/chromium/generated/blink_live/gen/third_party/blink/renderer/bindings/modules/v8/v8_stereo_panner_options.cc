...
if (!v8_value->IsObject()) {
  const char* const class_like_name = "StereoPannerOptions";
...
return dictionary;
 ...
 StereoPannerOptions::StereoPannerOptions(v8::Isolate* isolate) : AudioNodeOptions(isolate) {
...
void StereoPannerOptions::Trace(Visitor* visitor) const {
...
if (!bindings::GetDictionaryMemberFromV8Object<IDLFloat, is_optional>(isolate, current_context, v8_dictionary, v8_own_member_names[0].Get(isolate), fallback_presence_var, member_pan_, class_like_name, exception_state)) {
  return;
}
}
