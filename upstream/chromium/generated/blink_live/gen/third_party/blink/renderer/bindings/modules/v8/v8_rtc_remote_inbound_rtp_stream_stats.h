...
bool hasPacketsWithBleachedEct1Marking() const {
  return has_packets_with_bleached_ect_1_marking_;
}
uint64_t packetsWithBleachedEct1Marking() const {
  DCHECK(hasPacketsWithBleachedEct1Marking());
return member_packets_with_bleached_ect_1_marking_;
}
uint64_t getPacketsWithBleachedEct1MarkingOr(uint64_t fallback_value) const {
  if (!hasPacketsWithBleachedEct1Marking()) {
  return fallback_value;
}
return member_packets_with_bleached_ect_1_marking_;
}
void setPacketsWithBleachedEct1Marking(uint64_t value) {
  member_packets_with_bleached_ect_1_marking_ = value;
has_packets_with_bleached_ect_1_marking_ = true;
}
...
bool has_packets_with_bleached_ect_1_marking_ = false;
...
uint64_t member_packets_with_bleached_ect_1_marking_;
