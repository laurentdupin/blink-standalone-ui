...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_MOJO_INTERFACE_REQUEST_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_MOJO_INTERFACE_REQUEST_EVENT_H_
...
class MojoInterfaceRequestEvent;
struct WrapperTypeInfo;

class CORE_EXPORT V8MojoInterfaceRequestEvent final : public bindings::V8InterfaceBridge<V8MojoInterfaceRequestEvent, MojoInterfaceRequestEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(431);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class MojoInterfaceRequestEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_MOJO_INTERFACE_REQUEST_EVENT_H_
