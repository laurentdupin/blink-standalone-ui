...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_VIRTUAL_KEYBOARD_GEOMETRY_CHANGE_EVENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_VIRTUAL_KEYBOARD_GEOMETRY_CHANGE_EVENT_H_
...
class VirtualKeyboardGeometryChangeEvent;
struct WrapperTypeInfo;

class MODULES_EXPORT V8VirtualKeyboardGeometryChangeEvent final : public bindings::V8InterfaceBridge<V8VirtualKeyboardGeometryChangeEvent, VirtualKeyboardGeometryChangeEvent> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(485);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class VirtualKeyboardGeometryChangeEvent;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_VIRTUAL_KEYBOARD_GEOMETRY_CHANGE_EVENT_H_
