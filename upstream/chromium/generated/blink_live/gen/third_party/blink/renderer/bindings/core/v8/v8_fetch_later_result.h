...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_FETCH_LATER_RESULT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_FETCH_LATER_RESULT_H_
...
class CORE_EXPORT V8FetchLaterResult final : public bindings::V8InterfaceBridge<V8FetchLaterResult, FetchLaterResult> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(844);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class FetchLaterResult;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_FETCH_LATER_RESULT_H_
