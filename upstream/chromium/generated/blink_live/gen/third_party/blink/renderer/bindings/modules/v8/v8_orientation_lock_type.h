...
class MODULES_EXPORT V8OrientationLockType final : public bindings::EnumerationBase {
  
  public:
enum class Enum : enum_int_t {
kAny, kNatural, kLandscape, kPortrait, kPortraitPrimary, kPortraitSecondary, kLandscapePrimary, kLandscapeSecondary
};
static constexpr size_t kEnumSize = 8;

static V8OrientationLockType Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8OrientationLockType> Create(const String& value);

explicit constexpr  V8OrientationLockType(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8OrientationLockType& lhs, V8OrientationLockType::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8OrientationLockType::Enum lhs, const V8OrientationLockType& rhs) {
