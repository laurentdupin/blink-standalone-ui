...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_VIEW_TRANSITION_TYPE_SET_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_VIEW_TRANSITION_TYPE_SET_H_
...
class CORE_EXPORT V8ViewTransitionTypeSet final : public bindings::V8InterfaceBridge<V8ViewTransitionTypeSet, ViewTransitionTypeSet> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1032);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class ViewTransitionTypeSet;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_VIEW_TRANSITION_TYPE_SET_H_
