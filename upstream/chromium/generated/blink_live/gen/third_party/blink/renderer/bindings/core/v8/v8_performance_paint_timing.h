...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PERFORMANCE_PAINT_TIMING_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PERFORMANCE_PAINT_TIMING_H_
...
class CORE_EXPORT V8PerformancePaintTiming final : public bindings::V8InterfaceBridge<V8PerformancePaintTiming, PerformancePaintTiming> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1005);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PerformancePaintTiming;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PERFORMANCE_PAINT_TIMING_H_
