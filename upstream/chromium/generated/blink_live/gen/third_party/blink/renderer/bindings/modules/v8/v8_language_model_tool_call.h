...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_LANGUAGE_MODEL_TOOL_CALL_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_LANGUAGE_MODEL_TOOL_CALL_H_
...
class MODULES_EXPORT V8LanguageModelToolCall final : public bindings::V8InterfaceBridge<V8LanguageModelToolCall, LanguageModelToolCall> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1071);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class LanguageModelToolCall;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_LANGUAGE_MODEL_TOOL_CALL_H_
