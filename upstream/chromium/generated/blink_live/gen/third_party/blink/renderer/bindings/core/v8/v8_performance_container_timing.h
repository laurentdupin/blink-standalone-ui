...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PERFORMANCE_CONTAINER_TIMING_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PERFORMANCE_CONTAINER_TIMING_H_
...
class CORE_EXPORT V8PerformanceContainerTiming final : public bindings::V8InterfaceBridge<V8PerformanceContainerTiming, PerformanceContainerTiming> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(998);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class PerformanceContainerTiming;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_PERFORMANCE_CONTAINER_TIMING_H_
