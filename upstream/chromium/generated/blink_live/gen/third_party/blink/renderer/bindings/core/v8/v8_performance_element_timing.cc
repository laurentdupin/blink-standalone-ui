...
static_assert(std::derived_from<PerformanceElementTiming, PerformanceEntry>);
...
const WrapperTypeInfo& PerformanceElementTiming::wrapper_type_info_ =
    V8PerformanceElementTiming::wrapper_type_info_;
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_PerformanceElementTiming_paintTime_Getter");
BLINK_BINDINGS_TRACE_EVENT("PerformanceElementTiming.paintTime.get");
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_PerformanceElementTiming_presentationTime_Getter");
BLINK_BINDINGS_TRACE_EVENT("PerformanceElementTiming.presentationTime.get");
...
void V8PerformanceElementTiming::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "PerformanceElementTiming", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "PerformanceElementTiming", kOperationTable);
}
...
void V8PerformanceElementTiming::InstallContextIndependentProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
  using bindings::IDLMemberInstaller;
