...
class CORE_EXPORT V8ColorSpaceConversion final : public bindings::EnumerationBase {
...
static V8ColorSpaceConversion Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8ColorSpaceConversion> Create(const String& value);

explicit constexpr  V8ColorSpaceConversion(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8ColorSpaceConversion& lhs, V8ColorSpaceConversion::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8ColorSpaceConversion::Enum lhs, const V8ColorSpaceConversion& rhs) {
