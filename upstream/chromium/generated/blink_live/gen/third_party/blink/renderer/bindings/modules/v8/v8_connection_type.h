...
kCellular, kBluetooth, kEthernet, kWifi, kWimax, kOther, kNone, kUnknown
};
static constexpr size_t kEnumSize = 8;

static V8ConnectionType Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8ConnectionType> Create(const String& value);

explicit constexpr  V8ConnectionType(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8ConnectionType& lhs, V8ConnectionType::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8ConnectionType::Enum lhs, const V8ConnectionType& rhs) {
