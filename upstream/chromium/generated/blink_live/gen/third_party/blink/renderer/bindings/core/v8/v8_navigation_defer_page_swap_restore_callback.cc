...
const char* V8NavigationDeferPageSwapRestoreCallback::GetHumanReadableName() const {
  return "V8NavigationDeferPageSwapRestoreCallback";
}

v8::Maybe<void> V8NavigationDeferPageSwapRestoreCallback::Invoke(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
  const char* const class_like_name = "NavigationDeferPageSwapRestoreCallback";
...
v8::Maybe<void> V8NavigationDeferPageSwapRestoreCallback::Construct() {
  const char* const class_like_name = "NavigationDeferPageSwapRestoreCallback";
...
void V8NavigationDeferPageSwapRestoreCallback::InvokeAndReportException(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
  v8::Isolate* isolate = GetIsolate();
...
base::expected<void, ScriptValue> V8NavigationDeferPageSwapRestoreCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver) {
