...
class MODULES_EXPORT V8ChannelCountMode final : public bindings::EnumerationBase {
  
  public:
enum class Enum : enum_int_t {
kMax, kClampedMax, kExplicit
};
static constexpr size_t kEnumSize = 3;

static V8ChannelCountMode Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8ChannelCountMode> Create(const String& value);

explicit constexpr  V8ChannelCountMode(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8ChannelCountMode& lhs, V8ChannelCountMode::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8ChannelCountMode::Enum lhs, const V8ChannelCountMode& rhs) {
