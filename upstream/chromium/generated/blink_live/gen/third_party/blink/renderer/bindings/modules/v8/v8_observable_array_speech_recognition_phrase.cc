...
// static
const WrapperTypeInfo V8ObservableArraySpeechRecognitionPhrase::wrapper_type_info_body_{
    {gin::kEmbedderBlink},
    V8ObservableArraySpeechRecognitionPhrase::InstallObservableArrayBackingListTemplate,
    nullptr,
...
// static
const WrapperTypeInfo& V8ObservableArraySpeechRecognitionPhrase::wrapper_type_info_ =
    V8ObservableArraySpeechRecognitionPhrase::wrapper_type_info_body_;


template class bindings::ObservableArrayExoticObjectHandler<V8ObservableArraySpeechRecognitionPhrase, SpeechRecognitionPhrase>;

class V8ObservableArraySpeechRecognitionPhrase::Handler final : public bindings::ObservableArrayExoticObjectHandler<V8ObservableArraySpeechRecognitionPhrase, SpeechRecognitionPhrase> {
 ...
 V8ObservableArraySpeechRecognitionPhrase::V8ObservableArraySpeechRecognitionPhrase(GarbageCollectedMixin* platform_object, SetAlgorithmCallback set_algorithm_callback, DeleteAlgorithmCallback delete_algorithm_callback) : BaseClass(platform_object), set_algorithm_callback_(set_algorithm_callback), delete_algorithm_callback_(delete_algorithm_callback) {
  
}

void V8ObservableArraySpeechRecognitionPhrase::PerformAttributeSet(ScriptState* script_state, v8::Local<v8::Value> v8_value) {
  Handler::PerformAttributeSet(script_state, *this, v8_value);
}

v8::Local<v8::FunctionTemplate> V8ObservableArraySpeechRecognitionPhrase::GetProxyHandlerFunctionTemplate(ScriptState* script_state) {
...
void V8ObservableArraySpeechRecognitionPhrase::Trace(Visitor* visitor) const {
  BaseClass::Trace(visitor);
}

void V8ObservableArraySpeechRecognitionPhrase::InstallObservableArrayBackingListTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> backing_list_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8ObservableArraySpeechRecognitionPhrase::GetStaticWrapperTypeInfo();
