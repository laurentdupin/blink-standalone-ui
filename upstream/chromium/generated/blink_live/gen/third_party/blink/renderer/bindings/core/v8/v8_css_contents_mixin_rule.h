...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_CONTENTS_MIXIN_RULE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_CONTENTS_MIXIN_RULE_H_
...
class CSSContentsMixinRule;
class ExecutionContext;
struct WrapperTypeInfo;

class CORE_EXPORT V8CSSContentsMixinRule final : public bindings::V8InterfaceBridge<V8CSSContentsMixinRule, CSSContentsMixinRule> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(276);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class CSSContentsMixinRule;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_CSS_CONTENTS_MIXIN_RULE_H_
