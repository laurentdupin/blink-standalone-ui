...
class CORE_EXPORT V8StylePropertyMapReadOnly final : public bindings::V8InterfaceBridge<V8StylePropertyMapReadOnly, StylePropertyMapReadOnly> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(345);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class StylePropertyMapReadOnly;
};
