...
class MODULES_EXPORT V8RTCDtlsTransportState final : public bindings::EnumerationBase {
  
  public:
enum class Enum : enum_int_t {
kNew, kConnecting, kConnected, kClosed, kFailed
};
static constexpr size_t kEnumSize = 5;

static V8RTCDtlsTransportState Create(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exception_state);
static std::optional<V8RTCDtlsTransportState> Create(const String& value);

explicit constexpr  V8RTCDtlsTransportState(Enum value) : bindings::EnumerationBase(static_cast<enum_int_t>(value), string_table_[static_cast<enum_int_t>(value)]) {
...
inline bool operator==(const V8RTCDtlsTransportState& lhs, V8RTCDtlsTransportState::Enum rhs) {
  return lhs.AsEnum() == rhs;
}

inline bool operator==(V8RTCDtlsTransportState::Enum lhs, const V8RTCDtlsTransportState& rhs) {
