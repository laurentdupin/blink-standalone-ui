...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_ANCHOR_SET_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_ANCHOR_SET_H_
...
class MODULES_EXPORT V8XRAnchorSet final : public bindings::V8InterfaceBridge<V8XRAnchorSet, XRAnchorSet> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1422);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class XRAnchorSet;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_XR_ANCHOR_SET_H_
