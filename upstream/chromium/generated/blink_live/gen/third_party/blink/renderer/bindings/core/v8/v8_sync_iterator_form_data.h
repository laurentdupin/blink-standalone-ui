...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SYNC_ITERATOR_FORM_DATA_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SYNC_ITERATOR_FORM_DATA_H_
...
template <>
class CORE_EXPORT SyncIterator<FormData> final : public bindings::SyncIteratorBase {
  DEFINE_WRAPPERTYPEINFO();

  public:
using IDLKeyType = IDLUSVString;
using IDLValueType = V8UnionFileOrUSVString;
using KeyType = String;
using ValueType = V8UnionFileOrUSVString*;

explicit  SyncIterator<FormData>(IterationSourceBase* source, Kind kind) : bindings::SyncIteratorBase(source, kind) {
...
class CORE_EXPORT V8SyncIteratorFormData final : public bindings::V8InterfaceBridge<V8SyncIteratorFormData, SyncIterator<FormData>> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1491);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SyncIterator<FormData>;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SYNC_ITERATOR_FORM_DATA_H_
