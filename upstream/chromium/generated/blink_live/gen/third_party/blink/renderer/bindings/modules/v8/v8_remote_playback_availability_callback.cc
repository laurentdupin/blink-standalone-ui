...
const char* V8RemotePlaybackAvailabilityCallback::GetHumanReadableName() const {
...
base::expected<void, ScriptValue> V8RemotePlaybackAvailabilityCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, bool arg1_available) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_available);
