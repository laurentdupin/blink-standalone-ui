...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_TRANSPORT_ICE_CANDIDATE_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_TRANSPORT_ICE_CANDIDATE_H_
...
class RtcTransportIceCandidate;
struct WrapperTypeInfo;

class MODULES_EXPORT V8RtcTransportIceCandidate final : public bindings::V8InterfaceBridge<V8RtcTransportIceCandidate, RtcTransportIceCandidate> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1229);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class RtcTransportIceCandidate;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_RTC_TRANSPORT_ICE_CANDIDATE_H_
