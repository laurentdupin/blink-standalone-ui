...
const char* V8Predicate::GetHumanReadableName() const {
  return "V8Predicate";
}
...
base::expected<bool, ScriptValue> V8Predicate::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const ScriptValue& arg1_value, uint64_t arg2_index) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_value, arg2_index);
