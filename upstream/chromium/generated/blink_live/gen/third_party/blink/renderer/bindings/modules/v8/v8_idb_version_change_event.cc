...
bool V8IDBVersionChangeEvent::IsExposed(ExecutionContext* execution_context) {
  
return execution_context->IsWindow() || execution_context->IsWorkerGlobalScope();
}

static_assert(std::derived_from<IDBVersionChangeEvent, Event>);
...
const WrapperTypeInfo V8IDBVersionChangeEvent::wrapper_type_info_{
    {gin::kEmbedderBlink},
    V8IDBVersionChangeEvent::InstallInterfaceTemplate,
    nullptr,
    "IDBVersionChangeEvent",
    V8Event::GetWrapperTypeInfo(),
    V8IDBVersionChangeEvent::kThisTag,
    V8IDBVersionChangeEvent::kMaxSubclassTag,
...
const WrapperTypeInfo& IDBVersionChangeEvent::wrapper_type_info_ =
    V8IDBVersionChangeEvent::wrapper_type_info_;
...
namespace v8_idb_version_change_event {


void OldVersionAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_IDBVersionChangeEvent_oldVersion_Getter");
BLINK_BINDINGS_TRACE_EVENT("IDBVersionChangeEvent.oldVersion.get");
...
void NewVersionAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_IDBVersionChangeEvent_newVersion_Getter");
BLINK_BINDINGS_TRACE_EVENT("IDBVersionChangeEvent.newVersion.get");
...
void DataLossAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_IDBVersionChangeEvent_dataLoss_Getter");
BLINK_BINDINGS_TRACE_EVENT("IDBVersionChangeEvent.dataLoss.get");
...
static_assert(bindings::IsReturnTypeCompatible<V8IDBDataLossAmount, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, isolate, bindings::V8ReturnValue::kNonNullable);
}



void DataLossMessageAttributeGetCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
  
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_IDBVersionChangeEvent_dataLossMessage_Getter");
BLINK_BINDINGS_TRACE_EVENT("IDBVersionChangeEvent.dataLossMessage.get");
...
BLINK_BINDINGS_TRACE_EVENT("IDBVersionChangeEvent.isTrusted.get");
...
BLINK_BINDINGS_TRACE_EVENT("IDBVersionChangeEvent.constructor");
...
decltype(NativeValueTraits<IDBVersionChangeEventInit>::NativeValue(std::declval<v8::Isolate*>(), std::declval<v8::Local<v8::Value>>(), std::declval<ExceptionState&>())) arg2_event_init_dict;
if (info[1]->IsUndefined()) {
  arg2_event_init_dict = IDBVersionChangeEventInit::Create();
} else {
  arg2_event_init_dict = NativeValueTraits<IDBVersionChangeEventInit>::ArgumentValue(isolate, 1, info[1], exception_state);
if (exception_state.HadException()) [[unlikely]] {
  return;
}
}
auto&& return_value = IDBVersionChangeEvent::Create(arg1_type, arg2_event_init_dict);
static_assert(bindings::IsReturnTypeCompatible<IDBVersionChangeEvent, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
v8::Local<v8::Object> v8_wrapper = return_value->AssociateWithWrapper(isolate, V8IDBVersionChangeEvent::GetWrapperTypeInfo(), v8_receiver);
...
using namespace v8_idb_version_change_event;

}  // namespace 

void V8IDBVersionChangeEvent::InstallInterfaceTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Template> interface_template) {
  const WrapperTypeInfo* const wrapper_type_info = V8IDBVersionChangeEvent::GetWrapperTypeInfo();
...
interface_function_template->SetInterfaceName(V8String(isolate, "IDBVersionChangeEvent"));
...
void V8IDBVersionChangeEvent::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
  using bindings::IDLMemberInstaller;

{
  
static const IDLMemberInstaller::AttributeConfig kAttributeTable[] = {
{"oldVersion", OldVersionAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
{"newVersion", NewVersionAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
{"dataLoss", DataLossAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
{"dataLossMessage", DataLossMessageAttributeGetCallback, nullptr, unsigned(v8::None), unsigned(IDLMemberInstaller::FlagLocation::kPrototype), unsigned(IDLMemberInstaller::FlagWorld::kAllWorlds), unsigned(IDLMemberInstaller::FlagReceiverCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(IDLMemberInstaller::FlagCrossOriginCheck::kCheck), unsigned(v8::SideEffectType::kHasNoSideEffect), unsigned(V8PrivateProperty::CachedAccessor::kNone)},
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "IDBVersionChangeEvent", kAttributeTable);
}
