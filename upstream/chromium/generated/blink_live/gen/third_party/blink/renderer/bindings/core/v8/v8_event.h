...
class CORE_EXPORT V8Event final : public bindings::V8InterfaceBridge<V8Event, Event> {
...
static constexpr uint16_t kCapturingPhase = 1;
static constexpr uint16_t kAtTarget = 2;
static constexpr uint16_t kBubblingPhase = 3;
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(373);
