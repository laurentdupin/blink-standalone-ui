...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OFFSCREEN_CANVAS_RENDERING_CONTEXT_2D_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OFFSCREEN_CANVAS_RENDERING_CONTEXT_2D_H_
...
class MODULES_EXPORT V8OffscreenCanvasRenderingContext2D final : public bindings::V8InterfaceBridge<V8OffscreenCanvasRenderingContext2D, OffscreenCanvasRenderingContext2D> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1112);
...
#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_OFFSCREEN_CANVAS_RENDERING_CONTEXT_2D_H_
