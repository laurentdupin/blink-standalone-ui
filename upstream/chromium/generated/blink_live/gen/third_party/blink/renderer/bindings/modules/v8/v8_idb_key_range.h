...
class MODULES_EXPORT V8IDBKeyRange final : public bindings::V8InterfaceBridge<V8IDBKeyRange, IDBKeyRange> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1179);
