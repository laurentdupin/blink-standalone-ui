...
return (execution_context->IsWindow() && RuntimeEnabledFeatures::StableBlinkFeaturesEnabled()) || (execution_context->IsDedicatedWorkerGlobalScope() && RuntimeEnabledFeatures::TransferableRTCDataChannelEnabled());
}

static_assert(std::derived_from<RTCDataChannel, EventTarget>);
...
const WrapperTypeInfo V8RTCDataChannel::wrapper_type_info_{
    ...
    V8RTCDataChannel::kThisTag,
    V8RTCDataChannel::kMaxSubclassTag,
...
static_assert(bindings::IsReturnTypeCompatible<V8RTCDataChannelState, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, isolate, bindings::V8ReturnValue::kNonNullable);
}
...
RUNTIME_CALL_TIMER_SCOPE_DISABLED_BY_DEFAULT(info.GetIsolate(), "Blink_RTCDataChannel_priority_Getter");
BLINK_BINDINGS_TRACE_EVENT("RTCDataChannel.priority.get");
...
static_assert(bindings::IsReturnTypeCompatible<V8RTCPriorityType, std::remove_cvref_t<decltype(return_value)>>, "Return type from native call is incompatible to the type specified in IDL");
bindings::V8SetReturnValue(info, return_value, isolate, bindings::V8ReturnValue::kNonNullable);
}
...
void V8RTCDataChannel::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallAttributes(isolate, world, instance_template, prototype_template, interface_template, signature, "RTCDataChannel", kAttributeTable);
}
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "RTCDataChannel", kOperationTable);
}
...
void V8RTCDataChannel::InstallContextIndependentProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
  using bindings::IDLMemberInstaller;
