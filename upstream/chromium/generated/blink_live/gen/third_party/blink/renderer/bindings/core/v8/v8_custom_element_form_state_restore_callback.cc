...
const char* V8CustomElementFormStateRestoreCallback::GetHumanReadableName() const {
...
base::expected<void, ScriptValue> V8CustomElementFormStateRestoreCallback::InvokeAndCatch(bindings::V8ValueOrScriptWrappableAdapter arg0_receiver, const V8UnionFileOrFormDataOrUSVString* arg1_value, V8FormStateRestoreMode arg2_mode) {
  v8::TryCatch try_catch(GetIsolate());

auto result = Invoke(arg0_receiver, arg1_value, arg2_mode);
