...
class  V8InternalSettingsGenerated final : public bindings::V8InterfaceBridge<V8InternalSettingsGenerated, InternalSettingsGenerated> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1067);
  static constexpr v8::CppHeapPointerTag kMaxSubclassTag =
      static_cast<v8::CppHeapPointerTag>(1068);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class InternalSettingsGenerated;
};
