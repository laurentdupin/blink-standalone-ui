...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_USB_ISOCHRONOUS_IN_TRANSFER_RESULT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_USB_ISOCHRONOUS_IN_TRANSFER_RESULT_H_
...
class MODULES_EXPORT V8USBIsochronousInTransferResult final : public bindings::V8InterfaceBridge<V8USBIsochronousInTransferResult, USBIsochronousInTransferResult> {
...
static constexpr const WrapperTypeInfo* GetWrapperTypeInfo() {
  ...
  static constexpr v8::CppHeapPointerTag kThisTag =
      static_cast<v8::CppHeapPointerTag>(1417);
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class USBIsochronousInTransferResult;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_MODULES_V8_V8_USB_ISOCHRONOUS_IN_TRANSFER_RESULT_H_
