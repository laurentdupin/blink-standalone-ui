...
class MODULES_EXPORT RTCRtpCodecCapability : public RTCRtpCodec {
...
static RTCRtpCodecCapability* Create(v8::Isolate* isolate) {
  return MakeGarbageCollected<RTCRtpCodecCapability>(isolate);
}
static RTCRtpCodecCapability* Create(v8::Isolate* isolate, v8::Local<v8::Value> v8_value, ExceptionState& exception_state);

explicit  RTCRtpCodecCapability();
explicit  RTCRtpCodecCapability(v8::Isolate* isolate);
