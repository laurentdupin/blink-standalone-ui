...
#ifndef THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_FUNC_R_ELEMENT_H_
#define THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_FUNC_R_ELEMENT_H_
...
class CORE_EXPORT V8SVGFEFuncRElement final : public bindings::V8InterfaceBridge<V8SVGFEFuncRElement, SVGFEFuncRElement> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class SVGFEFuncRElement;
};


}  // namespace blink

#endif  // THIRD_PARTY_BLINK_RENDERER_BINDINGS_CORE_V8_V8_SVG_FE_FUNC_R_ELEMENT_H_
