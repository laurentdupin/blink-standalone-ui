...
class CORE_EXPORT V8HTMLOptionsCollection final : public bindings::V8InterfaceBridge<V8HTMLOptionsCollection, HTMLOptionsCollection> {
...
static const WrapperTypeInfo wrapper_type_info_;
  ...
  friend class HTMLOptionsCollection;
};
