...
v8::Local<v8::Value> V8UnionHTMLCanvasElementOrOffscreenCanvas::DirectToV8(ScriptState* script_state, HTMLCanvasElement* value) {
  return ToV8Traits<HTMLCanvasElement>::ToV8(script_state, value);
}
v8::Local<v8::Value> V8UnionHTMLCanvasElementOrOffscreenCanvas::DirectToV8(ScriptState* script_state, OffscreenCanvas* value) {
