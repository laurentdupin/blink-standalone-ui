...
static_assert(std::derived_from<MIDIOutput, MIDIPort>);
...
const WrapperTypeInfo& MIDIOutput::wrapper_type_info_ =
    V8MIDIOutput::wrapper_type_info_;
...
void V8MIDIOutput::InstallUnconditionalProperties(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::ObjectTemplate> instance_template, v8::Local<v8::ObjectTemplate> prototype_template, v8::Local<v8::Template> interface_template) {
...
IDLMemberInstaller::InstallOperations(isolate, world, instance_template, prototype_template, interface_template, signature, "MIDIOutput", kOperationTable);
}
