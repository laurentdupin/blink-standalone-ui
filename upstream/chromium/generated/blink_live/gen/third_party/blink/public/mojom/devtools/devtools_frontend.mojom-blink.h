...
class DevToolsFrontend
 ...
 public:
  ...
  static constexpr const char* Name_ = "blink.mojom.DevToolsFrontend";
...
// with not having this data in traces there.
  ...
  virtual void SetupDevToolsFrontend(const ::blink::String& api_script, ::mojo::PendingAssociatedRemote<DevToolsFrontendHost> host) = 0;

  virtual void SetupDevToolsExtensionAPI(const ::blink::String& extension_api) = 0;
};
...
class DevToolsFrontendHost
 ...
 public:
  using IPCStableHashFunction = uint32_t(*)();
  static constexpr const char* Name_ = "blink.mojom.DevToolsFrontendHost";
  static IPCStableHashFunction MessageToMethodInfo_(mojo::Message& message);
  static const char* MessageToMethodName_(mojo::Message& message);
  static constexpr uint32_t Version_ = 0;
...
// with not having this data in traces there.
  ...
  virtual void DispatchEmbedderMessage(::base::DictValue message) = 0;
};
...
class  DevToolsFrontendProxy
 ...
 public:
  ...
  void SetupDevToolsFrontend(const ::blink::String& api_script, ::mojo::PendingAssociatedRemote<DevToolsFrontendHost> host) final;
  
  void SetupDevToolsExtensionAPI(const ::blink::String& extension_api) final;
...
class  DevToolsFrontendHostProxy
 ...
 public:
  ...
  void DispatchEmbedderMessage(::base::DictValue message) final;

 private:
  mojo::MessageReceiverWithResponder* receiver_;
};
class  DevToolsFrontendStubDispatch {
 public:
...
class  DevToolsFrontendHostStubDispatch {
 public:
...
class  DevToolsFrontendRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class  DevToolsFrontendHostRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
