// third_party/blink/public/mojom/use_counter/metrics/css_property_id.mojom-data-view.h is auto generated by mojom_bindings_generator.py, do not edit
...
#ifndef THIRD_PARTY_BLINK_PUBLIC_MOJOM_USE_COUNTER_METRICS_CSS_PROPERTY_ID_MOJOM_DATA_VIEW_H_
#define THIRD_PARTY_BLINK_PUBLIC_MOJOM_USE_COUNTER_METRICS_CSS_PROPERTY_ID_MOJOM_DATA_VIEW_H_
...
enum class CSSSampleId : int32_t {
  ...
  kColumnRuleInsetCapStart = 891,
  
  kColumnRuleInsetCapEnd = 892,
  
  kColumnRuleInsetJunctionStart = 893,
  
  kColumnRuleInsetJunctionEnd = 894,
  
  kRowRuleInsetCapStart = 895,
  
  kRowRuleInsetCapEnd = 896,
  
  kRowRuleInsetJunctionStart = 897,
  
  kRowRuleInsetJunctionEnd = 898,
  ...
  kColumnRuleInsetCap = 910,
  
  kRowRuleInsetCap = 911,
  
  kColumnRuleInsetJunction = 912,
  
  kRowRuleInsetJunction = 913,
  
  kRuleInsetCap = 914,
  
  kRuleInsetJunction = 915,
  ...
  kViewTransitionScope = 925,
  
  kRuleVisibilityItems = 926,
  ...
  kTimelineTriggerActivationRangeStart = 930,
  
  kTimelineTriggerActivationRangeEnd = 931,
  
  kTimelineTriggerActivationRange = 932,
  
  kRuleOverlap = 933,
  
  kColumnRuleInsetStart = 934,
  
  kColumnRuleInsetEnd = 935,
  
  kRowRuleInsetStart = 936,
  
  kRowRuleInsetEnd = 937,
  ...
  kHangingPunctuation = 941,
  
  kFlexLineCount = 942,
  
  kTextDecorationSkipSpaces = 943,
  kMinValue = 0,
  kMaxValue = 943,
};

COMPONENT_EXPORT(WEB_FEATURE_MOJO_BINDINGS_MOJOM_SHARED) std::ostream& operator<<(std::ostream& os, CSSSampleId value);
inline bool IsKnownEnumValue(CSSSampleId value) {
  return internal::CSSSampleId_Data::IsKnownValue(
      static_cast<int32_t>(value));
}

// Returns true if the enum has an infallible conversion from the mojom enum.
consteval bool HasInfallibleConversion(CSSSampleId) {
  return true;
}
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_MOJOM_USE_COUNTER_METRICS_CSS_PROPERTY_ID_MOJOM_DATA_VIEW_H_