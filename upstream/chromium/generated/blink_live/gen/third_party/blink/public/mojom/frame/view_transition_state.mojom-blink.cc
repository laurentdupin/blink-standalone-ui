...
ViewTransitionState::ViewTransitionState(
    ::blink::Vector<ViewTransitionElementPtr> elements_in,
    ::blink::mojom::blink::ViewTransitionTokenPtr transition_token_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<ViewTransitionElementPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::mojom::blink::ViewTransitionTokenPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
