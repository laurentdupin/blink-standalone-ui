...
class  BlobInterceptorForTesting : public Blob {
  ...
  void Load(::mojo::PendingReceiver<::network::mojom::blink::URLLoader> loader, const ::blink::String& request_method, ::network::mojom::blink::HttpRequestHeadersPtr headers, ::mojo::PendingRemote<::network::mojom::blink::URLLoaderClient> client) override;
