...
RendererPreferences::RendererPreferences()
    : can_accept_load_drops(true),
      ...
      hinting(::gfx::mojom::Hinting::kMedium),
      use_autohinter(false),
      use_bitmaps(false),
      subpixel_rendering(::gfx::mojom::SubpixelRendering::kNone),
...
RendererPreferences::RendererPreferences(
    ...
    ::gfx::mojom::Hinting hinting_in,
    bool use_autohinter_in,
    bool use_bitmaps_in,
    ::gfx::mojom::SubpixelRendering subpixel_rendering_in,
    bool use_subpixel_positioning_in,
    float text_contrast_in,
    float text_gamma_in,
    ...
    std::vector<::blink::mojom::WebRtcIpHandlingUrlEntryPtr> webrtc_ip_handling_urls_in,
    ...
    ::blink::mojom::UserAgentOverridePtr user_agent_override_in,
    ...
    const ::std::u16string& caption_font_family_name_in,
    int32_t caption_font_height_in,
    const ::std::u16string& small_caption_font_family_name_in,
    int32_t small_caption_font_height_in,
    const ::std::u16string& menu_font_family_name_in,
    int32_t menu_font_height_in,
    const ::std::u16string& status_font_family_name_in,
    int32_t status_font_height_in,
    const ::std::u16string& message_font_family_name_in,
    int32_t message_font_height_in,
...
void RendererPreferences::WriteIntoTrace(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::gfx::mojom::Hinting>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::gfx::mojom::SubpixelRendering>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "text_contrast"), this->text_contrast,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type float>"
#else
      "<value>"
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<::blink::mojom::WebRtcIpHandlingUrlEntryPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::mojom::UserAgentOverridePtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "caption_font_family_name"), this->caption_font_family_name,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "caption_font_height"), this->caption_font_height,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "small_caption_font_family_name"), this->small_caption_font_family_name,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type const ::std::u16string&>"
#else
      "<value>"
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "small_caption_font_height"), this->small_caption_font_height,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type int32_t>"
#else
      "<value>"
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "menu_font_family_name"), this->menu_font_family_name,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type const ::std::u16string&>"
#else
      "<value>"
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "menu_font_height"), this->menu_font_height,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type int32_t>"
#else
      "<value>"
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "status_font_family_name"), this->status_font_family_name,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type const ::std::u16string&>"
#else
      "<value>"
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "status_font_height"), this->status_font_height,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type int32_t>"
#else
      "<value>"
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "message_font_family_name"), this->message_font_family_name,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type const ::std::u16string&>"
#else
      "<value>"
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "message_font_height"), this->message_font_height,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type int32_t>"
#else
      "<value>"
