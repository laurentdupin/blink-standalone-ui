...
class  PolicyContainerHostInterceptorForTesting : public PolicyContainerHost {
  ...
  void AddContentSecurityPolicies(::blink::Vector<::network::mojom::blink::ContentSecurityPolicyPtr> content_security_policies) override;
};
class  PolicyContainerHostAsyncWaiter {
 public:
