// third_party/blink/public/mojom/choosers/popup_menu.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef THIRD_PARTY_BLINK_PUBLIC_MOJOM_CHOOSERS_POPUP_MENU_MOJOM_BLINK_H_
#define THIRD_PARTY_BLINK_PUBLIC_MOJOM_CHOOSERS_POPUP_MENU_MOJOM_BLINK_H_
...
#include "third_party/blink/public/mojom/choosers/popup_menu.mojom-blink-forward.h"  // IWYU pragma: export
...
class BLINK_PLATFORM_EXPORT PopupMenuClient
    : public PopupMenuClientInterfaceBase {
 public:
  using IPCStableHashFunction = uint32_t(*)();
  static constexpr const char* Name_ = "blink.mojom.PopupMenuClient";
...
// with not having this data in traces there.
  ...
  virtual void DidAcceptIndices(const ::blink::Vector<int32_t>& indices) = 0;
...
class BLINK_PLATFORM_EXPORT PopupMenuClientProxy
 ...
 public:
  ...
  void DidAcceptIndices(const ::blink::Vector<int32_t>& indices) final;
...
class BLINK_PLATFORM_EXPORT PopupMenuClientStubDispatch {
 public:
...
class BLINK_PLATFORM_EXPORT PopupMenuClientRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
class BLINK_PLATFORM_EXPORT MenuItem {
 public:
  template <typename T>
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        MenuItem::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        MenuItem::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::blink::MenuItem::DataView,
                                         ::blink::mojom::blink::MenuItemPtr> {
  static bool IsNull(const ::blink::mojom::blink::MenuItemPtr& input) { return !input; }
  static void SetToNull(::blink::mojom::blink::MenuItemPtr* output) { output->reset(); }

  static const decltype(::blink::mojom::blink::MenuItem::label)& label(
      const ::blink::mojom::blink::MenuItemPtr& input) {
    return input->label;
  }

  static const decltype(::blink::mojom::blink::MenuItem::tool_tip)& tool_tip(
      const ::blink::mojom::blink::MenuItemPtr& input) {
    return input->tool_tip;
  }

  static decltype(::blink::mojom::blink::MenuItem::type) type(
      const ::blink::mojom::blink::MenuItemPtr& input) {
    return input->type;
  }

  static decltype(::blink::mojom::blink::MenuItem::action) action(
      const ::blink::mojom::blink::MenuItemPtr& input) {
    return input->action;
  }

  static decltype(::blink::mojom::blink::MenuItem::text_direction) text_direction(
      const ::blink::mojom::blink::MenuItemPtr& input) {
    return input->text_direction;
  }

  static decltype(::blink::mojom::blink::MenuItem::has_text_direction_override) has_text_direction_override(
      const ::blink::mojom::blink::MenuItemPtr& input) {
    return input->has_text_direction_override;
  }

  static decltype(::blink::mojom::blink::MenuItem::enabled) enabled(
      const ::blink::mojom::blink::MenuItemPtr& input) {
    return input->enabled;
  }

  static decltype(::blink::mojom::blink::MenuItem::checked) checked(
      const ::blink::mojom::blink::MenuItemPtr& input) {
    return input->checked;
  }

  static bool Read(::blink::mojom::blink::MenuItem::DataView input, ::blink::mojom::blink::MenuItemPtr* output);
};

}  // namespace mojo

#endif  // THIRD_PARTY_BLINK_PUBLIC_MOJOM_CHOOSERS_POPUP_MENU_MOJOM_BLINK_H_