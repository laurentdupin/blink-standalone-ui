...
class  PrefetchedSignedExchangeInfo {
 public:
  ...
  PrefetchedSignedExchangeInfo(
      ...
      SHA256HashValuePtr header_integrity,
...
template <>
struct  StructTraits<::blink::mojom::blink::SHA256HashValue::DataView,
...
template <>
struct  StructTraits<::blink::mojom::blink::PrefetchedSignedExchangeInfo::DataView,
