...
UserAgentBrandVersion::UserAgentBrandVersion(
    const ::blink::String& brand_in,
    const ::blink::String& version_in)
...
UserAgentMetadata::UserAgentMetadata(
    ::blink::Vector<UserAgentBrandVersionPtr> brand_version_list_in,
    ::blink::Vector<UserAgentBrandVersionPtr> brand_full_version_list_in,
    const ::blink::String& full_version_in,
    const ::blink::String& platform_in,
    const ::blink::String& platform_version_in,
    const ::blink::String& architecture_in,
    const ::blink::String& model_in,
    bool mobile_in,
    const ::blink::String& bitness_in,
    bool wow64_in,
    ::blink::Vector<::blink::String> form_factors_in)
...
void UserAgentMetadata::WriteIntoTrace(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<UserAgentBrandVersionPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "form_factors"), this->form_factors,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
UserAgentOverride::UserAgentOverride(
    const ::blink::String& ua_string_override_in,
