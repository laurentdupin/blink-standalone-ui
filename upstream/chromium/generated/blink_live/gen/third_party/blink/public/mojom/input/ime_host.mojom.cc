// third_party/blink/public/mojom/input/ime_host.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "third_party/blink/public/mojom/input/ime_host.mojom-test-utils.h"
...
TextAppearanceInfo::TextAppearanceInfo(
    ::skia::mojom::SkColorPtr text_color_in)
    : text_color(std::move(text_color_in)) {}

TextAppearanceInfo::~TextAppearanceInfo() = default;
size_t TextAppearanceInfo::Hash(size_t seed) const {
...
InputCursorAnchorInfo::InputCursorAnchorInfo(
    std::vector<::gfx::Rect> character_bounds_in,
    EditorBoundsInfoPtr editor_bounds_info_in,
    TextAppearanceInfoPtr text_appearance_info_in,
    std::vector<::gfx::Rect> visible_line_bounds_in,
    const std::optional<::gfx::Rect>& insertion_marker_in,
    bool requested_in)
    : character_bounds(std::move(character_bounds_in)),
      ...
      insertion_marker(std::move(insertion_marker_in)),
...
void InputCursorAnchorInfo::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "insertion_marker"), this->insertion_marker,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
void ImeRenderWidgetHostProxy::UpdateCursorAnchorInfo(
  ...
  mojo::Message message(
      std::to_underlying(messages::ImeRenderWidgetHost::kUpdateCursorAnchorInfo), kFlags, estimated_payload_size);
...
bool ImeRenderWidgetHostRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::ImeRenderWidgetHost::Name_,
...
// static
bool StructTraits<::blink::mojom::EditorBoundsInfo::DataView, ::blink::mojom::EditorBoundsInfoPtr>::Read(
    ::blink::mojom::EditorBoundsInfo::DataView input,
    ::blink::mojom::EditorBoundsInfoPtr* output) {
  bool success = true;
  ::blink::mojom::EditorBoundsInfoPtr result(::blink::mojom::EditorBoundsInfo::New());
...
// static
bool StructTraits<::blink::mojom::TextAppearanceInfo::DataView, ::blink::mojom::TextAppearanceInfoPtr>::Read(
    ::blink::mojom::TextAppearanceInfo::DataView input,
    ::blink::mojom::TextAppearanceInfoPtr* output) {
  bool success = true;
  ::blink::mojom::TextAppearanceInfoPtr result(::blink::mojom::TextAppearanceInfo::New());
...
// static
bool StructTraits<::blink::mojom::InputCursorAnchorInfo::DataView, ::blink::mojom::InputCursorAnchorInfoPtr>::Read(
    ::blink::mojom::InputCursorAnchorInfo::DataView input,
    ::blink::mojom::InputCursorAnchorInfoPtr* output) {
  bool success = true;
  ::blink::mojom::InputCursorAnchorInfoPtr result(::blink::mojom::InputCursorAnchorInfo::New());
      ...
      if (success && !input.ReadVisibleLineBounds(&result->visible_line_bounds))
        success = false;
      if (success && !input.ReadInsertionMarker(&result->insertion_marker))
        success = false;
      if (success)
