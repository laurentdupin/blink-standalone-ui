...
class  CloneableMessage {
 public:
  ...
  CloneableMessage(
      ::mojo_base::mojom::BigBufferPtr encoded_message,
      std::vector<::blink::mojom::SerializedBlobPtr> blobs,
      ::url::mojom::OriginPtr sender_origin,
      ...
      ::mojo_base::mojom::UnguessableTokenPtr sender_agent_cluster_id,
...
template <>
struct  StructTraits<::blink::mojom::CloneableMessage::DataView,
