...
void FencedFrameOwnerHostProxy::Navigate(
    const ::blink::KURL& in_url, ::base::TimeTicks in_navigation_start_time, ::mojo_base::mojom::blink::String16Ptr in_embedder_shared_storage_context) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  mojo::Message message(
      std::to_underlying(messages::FencedFrameOwnerHost::kNavigate), kFlags, estimated_payload_size);
...
void FencedFrameOwnerHostProxy::DidChangeFramePolicy(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FencedFrameOwnerHost::kDidChangeFramePolicy), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool FencedFrameOwnerHostStubDispatch::Accept(
  ...
  switch (static_cast<messages::FencedFrameOwnerHost>(message->header()->name)) {
    case messages::FencedFrameOwnerHost::kNavigate: {
      ...
      ::mojo_base::mojom::blink::String16Ptr p_embedder_shared_storage_context{};
...
bool FencedFrameOwnerHostRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::blink::FencedFrameOwnerHost::Name_,
...
void FencedFrameOwnerHostInterceptorForTesting::Navigate(const ::blink::KURL& url, ::base::TimeTicks navigation_start_time, ::mojo_base::mojom::blink::String16Ptr embedder_shared_storage_context) {
