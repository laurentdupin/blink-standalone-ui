...
class  FrameWidgetInterceptorForTesting : public FrameWidget {
  ...
  void DragTargetDragEnter(::blink::mojom::DragDataPtr drag_data, const ::gfx::PointF& point_in_viewport, const ::gfx::PointF& screen_point, ::blink::mojom::AllowedDragOperationsPtr operations_allowed, uint32_t key_modifiers, DragTargetDragEnterCallback callback) override;
  void DragTargetDragOver(const ::gfx::PointF& point_in_viewport, const ::gfx::PointF& screen_point, ::blink::mojom::AllowedDragOperationsPtr operations_allowed, uint32_t key_modifiers, DragTargetDragOverCallback callback) override;
  ...
  void SetTextDirection(::mojo_base::mojom::TextDirection direction) override;
  void SetActive(bool active) override;
  void SetInheritedEffectiveTouchActionForSubFrame(::cc::mojom::TouchActionPtr touch_action) override;
  ...
  void EnableDeviceEmulation(::blink::mojom::DeviceEmulationParamsPtr parameters, DeviceEmulationCacheBehavior cache_behavior) override;
  void DisableDeviceEmulation() override;
  void BindWidgetCompositor(::mojo::PendingReceiver<::blink::mojom::WidgetCompositor> host) override;
  void SetViewportIntersection(::blink::mojom::ViewportIntersectionStatePtr intersection_state, ::blink::mojom::VisualPropertiesPtr visual_properties) override;
