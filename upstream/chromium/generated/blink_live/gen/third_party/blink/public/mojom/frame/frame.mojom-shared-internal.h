...
class SubframeResourceLengths_Data;
...
static_assert(sizeof(LegacyTechEventCodeLocation_Data) == 32,
              "Bad sizeof(LegacyTechEventCodeLocation_Data)");
// Used by LegacyTechEventCodeLocation::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView>
struct LegacyTechEventCodeLocation_UnserializedMessageContext
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  LegacyTechEventCodeLocation_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag
    LegacyTechEventCodeLocation_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
class  SubframeResourceLengths_Data {
 public:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
  ...
  mojo::internal::StructHeader header_;
  mojo::internal::Pointer<::mojo_base::mojom::internal::ByteSize_Data> encoded_data_length;
  mojo::internal::Pointer<::mojo_base::mojom::internal::ByteSize_Data> encoded_body_length;
  mojo::internal::Pointer<::mojo_base::mojom::internal::ByteSize_Data> decoded_body_length;

 private:
  friend class mojo::internal::MessageFragment<SubframeResourceLengths_Data>;

  SubframeResourceLengths_Data();
  ~SubframeResourceLengths_Data() = delete;
};
static_assert(sizeof(SubframeResourceLengths_Data) == 32,
              "Bad sizeof(SubframeResourceLengths_Data)");
// Used by SubframeResourceLengths::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView>
struct SubframeResourceLengths_UnserializedMessageContext
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  SubframeResourceLengths_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
      , user_data_(std::move(input)) {}
  ~SubframeResourceLengths_UnserializedMessageContext() override = default;
 ...
 private:
  // mojo::internal::UnserializedMessageContext:
  void Serialize(mojo::Message& message) override {
    mojo::internal::MessageFragment<SubframeResourceLengths_Data> fragment(message);
    mojo::internal::Serialize<DataView>(user_data_, fragment);
  }
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag
    SubframeResourceLengths_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
