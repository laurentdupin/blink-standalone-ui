...
WheelData::WheelData(
    ...
    ::blink::mojom::RailsMode rails_mode_in)
...
size_t WheelData::Hash(size_t seed) const {
  ...
  seed = mojo::internal::Hash(seed, this->rails_mode);
  return seed;
}
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::mojom::RailsMode>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
size_t TapDownData::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->tap_down_count);
  return seed;
}
...
Event::Event(
    ...
    const ::ui::EventLatencyMetadata& event_latency_metadata_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type const ::ui::EventLatencyMetadata&>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
TouchActionOptional::TouchActionOptional(
    const ::cc::TouchAction& touch_action_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type const ::cc::TouchAction&>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
void WidgetInputHandlerHostProxy::SetTouchActionFromMain(
    const ::cc::TouchAction& in_touch_action) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  mojo::Message message(
      std::to_underlying(messages::WidgetInputHandlerHost::kSetTouchActionFromMain), kFlags, estimated_payload_size);
  ...
  MOJO_INTERNAL_CHECK_SERIALIZATION(
    ...
    !(params->touch_action.is_null()),
    mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
    "null touch_action in WidgetInputHandlerHost.SetTouchActionFromMain request");
...
void WidgetInputHandlerHostProxy::SetPanAction(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::WidgetInputHandlerHost::kSetPanAction), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void WidgetInputHandlerHostProxy::DidOverscroll(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::WidgetInputHandlerHost::kDidOverscroll), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void WidgetInputHandlerHostProxy::DidStartScrollingViewport(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::WidgetInputHandlerHost::kDidStartScrollingViewport), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void WidgetInputHandlerHostProxy::ImeCancelComposition(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::WidgetInputHandlerHost::kImeCancelComposition), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void WidgetInputHandlerHostProxy::ImeCompositionRangeChanged(
    const ::gfx::Range& in_range, const std::optional<std::vector<::gfx::Rect>>& in_character_bounds) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::WidgetInputHandlerHost::kImeCompositionRangeChanged), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void WidgetInputHandlerHostProxy::SetMouseCapture(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::WidgetInputHandlerHost::kSetMouseCapture), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void WidgetInputHandlerHostProxy::SetAutoscrollSelectionActiveInMainFrame(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::WidgetInputHandlerHost::kSetAutoscrollSelectionActiveInMainFrame), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void WidgetInputHandlerHostProxy::RequestMouseLock(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::WidgetInputHandlerHost::kRequestMouseLock), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool WidgetInputHandlerHostRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::WidgetInputHandlerHost::Name_,
...
FrameWidgetInputHandler::IPCStableHashFunction FrameWidgetInputHandler::MessageToMethodInfo_(mojo::Message& message) {
  ...
  switch (static_cast<messages::FrameWidgetInputHandler>(message.name())) {
    ...
    case messages::FrameWidgetInputHandler::kPasteFromImageBytes: {
      return &FrameWidgetInputHandler::PasteFromImageBytes_Sym::IPCStableHash;
    }
...
const char* FrameWidgetInputHandler::MessageToMethodName_(mojo::Message& message) {
  ...
  if (!is_response) {
    switch (static_cast<messages::FrameWidgetInputHandler>(message.name())) {
      ...
      case messages::FrameWidgetInputHandler::kPasteFromImageBytes:
            return "Receive blink::mojom::FrameWidgetInputHandler::PasteFromImageBytes";
      case messages::FrameWidgetInputHandler::kDelete:
    ...
    switch (static_cast<messages::FrameWidgetInputHandler>(message.name())) {
      ...
      case messages::FrameWidgetInputHandler::kPasteFromImageBytes:
            return "Receive reply blink::mojom::FrameWidgetInputHandler::PasteFromImageBytes";
      case messages::FrameWidgetInputHandler::kDelete:
...
uint32_t FrameWidgetInputHandler::PasteFromImageBytes_Sym::IPCStableHash() {
  // This method's address is used for identifying the mojo method name after
  // symbolization. So each IPCStableHash should have a unique address.
  // We cannot use NO_CODE_FOLDING() here - it relies on the uniqueness of
  // __LINE__ value, which is not unique across different mojo modules.
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x2d72c704;  // IPCStableHash for blink::mojom::FrameWidgetInputHandler::PasteFromImageBytes
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void FrameWidgetInputHandlerProxy::AddImeTextSpansToExistingText(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kAddImeTextSpansToExistingText), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::ClearImeTextSpansByType(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kClearImeTextSpansByType), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::SetCompositionFromExistingText(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kSetCompositionFromExistingText), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::ExtendSelectionAndDelete(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kExtendSelectionAndDelete), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::ExtendSelectionAndReplace(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kExtendSelectionAndReplace), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::DeleteSurroundingText(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kDeleteSurroundingText), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::DeleteSurroundingTextInCodePoints(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kDeleteSurroundingTextInCodePoints), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::SetEditableSelectionOffsets(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kSetEditableSelectionOffsets), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::HandleStylusWritingGestureAction(
    ::blink::mojom::StylusWritingGestureDataPtr in_gesture_data, HandleStylusWritingGestureActionCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kHandleStylusWritingGestureAction), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::ExecuteEditCommand(
    const std::string& in_command, const ::blink::String& in_value) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kExecuteEditCommand), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::Undo(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kUndo), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::Redo(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kRedo), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::Cut(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kCut), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::Copy(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kCopy), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::CopyToFindPboard(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kCopyToFindPboard), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::CenterSelection(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kCenterSelection), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::Paste(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kPaste), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::PasteAndMatchStyle(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kPasteAndMatchStyle), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::PasteFromImageBytes(
    ::mojo_base::BigBuffer in_image_bytes, const std::string& in_media_format) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "Send blink::mojom::FrameWidgetInputHandler::PasteFromImageBytes", "input_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("image_bytes"), in_image_bytes,
                        "<value of type ::mojo_base::BigBuffer>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("media_format"), in_media_format,
                        "<value of type const std::string&>");
   });
#endif
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kPasteFromImageBytes), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
      ::blink::mojom::internal::FrameWidgetInputHandler_PasteFromImageBytes_Params_Data> params(
          message);
  params.Allocate();
  mojo::internal::MessageFragment<decltype(params->image_bytes)>
      image_bytes_fragment(params.message());
  image_bytes_fragment.Claim(&params->image_bytes);
  
  mojo::internal::Serialize<::mojo_base::mojom::BigBufferDataView>(
    in_image_bytes,
    image_bytes_fragment,
    true);

  
  MOJO_INTERNAL_CHECK_SERIALIZATION(
    mojo::internal::SendValidation::kDefault,
    !(params->image_bytes.is_null()),
    mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
    "null image_bytes in FrameWidgetInputHandler.PasteFromImageBytes request");
  mojo::internal::MessageFragment<
      typename decltype(params->media_format)::BaseType> media_format_fragment(
          params.message());
  
  mojo::internal::Serialize<mojo::StringDataView>(
    in_media_format,
    media_format_fragment);

  params->media_format.Set(
      media_format_fragment.is_null() ? nullptr : media_format_fragment.data());

  
  MOJO_INTERNAL_CHECK_SERIALIZATION(
    mojo::internal::SendValidation::kDefault,
    !(params->media_format.is_null()),
    mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
    "null media_format in FrameWidgetInputHandler.PasteFromImageBytes request");

#if defined(ENABLE_IPC_FUZZER)
  message.set_interface_name(FrameWidgetInputHandler::Name_);
  message.set_method_name("PasteFromImageBytes");
#endif
  // This return value may be ignored as false implies the Connector has
  // encountered an error, which will be visible through other means.
  ::mojo::internal::SendMojoMessage(*receiver_, message);
...
void FrameWidgetInputHandlerProxy::Delete(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kDelete), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::SelectAll(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kSelectAll), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::CollapseSelection(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kCollapseSelection), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::Replace(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kReplace), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::ReplaceMisspelling(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kReplaceMisspelling), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::SelectRange(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kSelectRange), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::AdjustSelectionByCharacterOffset(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kAdjustSelectionByCharacterOffset), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::SelectAroundCaret(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kSelectAroundCaret), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::MoveRangeSelectionExtent(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kMoveRangeSelectionExtent), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::ScrollFocusedEditableNodeIntoView(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kScrollFocusedEditableNodeIntoView), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::WaitForPageScaleAnimationForTesting(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kWaitForPageScaleAnimationForTesting), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FrameWidgetInputHandlerProxy::MoveCaret(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FrameWidgetInputHandler::kMoveCaret), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
class FrameWidgetInputHandler_HandleStylusWritingGestureAction_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::blink::mojom::HandwritingGestureResult in_result);
};
...
void FrameWidgetInputHandler_HandleStylusWritingGestureAction_ProxyToResponder::Run(
  ...
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("result"), in_result,
                        "<value of type ::blink::mojom::HandwritingGestureResult>");
   });
#endif
...
bool FrameWidgetInputHandler_WaitForPageScaleAnimationForTesting_ForwardToCallback::Accept(
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        FrameWidgetInputHandler::Name_, 29, true);
    return false;
  }
  if (!callback_.is_null()) {
    std::move(callback_).Run();
...
bool FrameWidgetInputHandlerStubDispatch::Accept(
  ...
  switch (static_cast<messages::FrameWidgetInputHandler>(message->header()->name)) {
    ...
    case messages::FrameWidgetInputHandler::kPasteFromImageBytes: {
      DCHECK(message->is_serialized());
      internal::FrameWidgetInputHandler_PasteFromImageBytes_Params_Data* params =
          reinterpret_cast<internal::FrameWidgetInputHandler_PasteFromImageBytes_Params_Data*>(
              message->mutable_payload());
      

      // Validation for FrameWidgetInputHandler.18
      bool success = true;
      ::mojo_base::BigBuffer p_image_bytes{};
      std::string p_media_format{};
      FrameWidgetInputHandler_PasteFromImageBytes_ParamsDataView input_data_view(params, message);
      
      if (success && !input_data_view.ReadImageBytes(&p_image_bytes))
        success = false;
      if (success && !input_data_view.ReadMediaFormat(&p_media_format))
        success = false;
      if (!success) {
        ReportValidationErrorForMessage(
            message,
      ...
      // A null |impl| means no implementation was bound.
      DCHECK(impl);
      impl->PasteFromImageBytes(        
        std::move(p_image_bytes), 
        std::move(p_media_format));
      return true;
    }
    case messages::FrameWidgetInputHandler::kDelete: {
      DCHECK(message->is_serialized());
...
static const mojo::internal::GenericValidationInfo kFrameWidgetInputHandlerValidationInfo[] = {
    ...
    { &internal::FrameWidgetInputHandler_PasteAndMatchStyle_Params_Data::Validate,
     nullptr /* no response */},
    { &internal::FrameWidgetInputHandler_PasteFromImageBytes_Params_Data::Validate,
     nullptr /* no response */},
...
bool FrameWidgetInputHandlerRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::FrameWidgetInputHandler::Name_,
...
WidgetInputHandler::IPCStableHashFunction WidgetInputHandler::MessageToMethodInfo_(mojo::Message& message) {
  ...
  switch (static_cast<messages::WidgetInputHandler>(message.name())) {
    ...
    case messages::WidgetInputHandler::kPingMainThread: {
      return &WidgetInputHandler::PingMainThread_Sym::IPCStableHash;
    }
...
const char* WidgetInputHandler::MessageToMethodName_(mojo::Message& message) {
  ...
  if (!is_response) {
    switch (static_cast<messages::WidgetInputHandler>(message.name())) {
      ...
      case messages::WidgetInputHandler::kPingMainThread:
            return "Receive blink::mojom::WidgetInputHandler::PingMainThread";
      case messages::WidgetInputHandler::kGetFrameWidgetInputHandler:
    ...
    switch (static_cast<messages::WidgetInputHandler>(message.name())) {
      ...
      case messages::WidgetInputHandler::kPingMainThread:
            return "Receive reply blink::mojom::WidgetInputHandler::PingMainThread";
      case messages::WidgetInputHandler::kGetFrameWidgetInputHandler:
...
uint32_t WidgetInputHandler::PingMainThread_Sym::IPCStableHash() {
  // This method's address is used for identifying the mojo method name after
  // symbolization. So each IPCStableHash should have a unique address.
  // We cannot use NO_CODE_FOLDING() here - it relies on the uniqueness of
  // __LINE__ value, which is not unique across different mojo modules.
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xbe9784b1;  // IPCStableHash for blink::mojom::WidgetInputHandler::PingMainThread
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
class WidgetInputHandler_PingMainThread_ForwardToCallback
    : public mojo::MessageReceiver {
 public:
  WidgetInputHandler_PingMainThread_ForwardToCallback(
      WidgetInputHandler::PingMainThreadCallback callback
      ) : callback_(std::move(callback)) {
  }

  WidgetInputHandler_PingMainThread_ForwardToCallback(const WidgetInputHandler_PingMainThread_ForwardToCallback&) = delete;
  WidgetInputHandler_PingMainThread_ForwardToCallback& operator=(const WidgetInputHandler_PingMainThread_ForwardToCallback&) = delete;

  bool Accept(mojo::Message* message) override;
 private:
  WidgetInputHandler::PingMainThreadCallback callback_;
};
...
void WidgetInputHandlerProxy::SetFocus(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::WidgetInputHandler::kSetFocus), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void WidgetInputHandlerProxy::MouseCaptureLost(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::WidgetInputHandler::kMouseCaptureLost), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void WidgetInputHandlerProxy::SetEditCommandsForNextKeyEvent(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::WidgetInputHandler::kSetEditCommandsForNextKeyEvent), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void WidgetInputHandlerProxy::CursorVisibilityChanged(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::WidgetInputHandler::kCursorVisibilityChanged), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void WidgetInputHandlerProxy::ImeSetComposition(
    const ::blink::String& in_text, const std::vector<::ui::ImeTextSpan>& in_ime_text_spans, const ::gfx::Range& in_range, int32_t in_start, int32_t in_end, ImeState in_ime_state, ImeSetCompositionCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("end"), in_end,
                        "<value of type int32_t>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("ime_state"), in_ime_state,
                        "<value of type ImeState>");
   });
#endif
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::WidgetInputHandler::kImeSetComposition), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
  ...
  mojo::internal::Serialize<::blink::mojom::ImeState>(
    in_ime_state,
    &params->ime_state);
...
void WidgetInputHandlerProxy::ImeCommitText(
    const ::blink::String& in_text, const std::vector<::ui::ImeTextSpan>& in_ime_text_spans, const ::gfx::Range& in_range, int32_t in_relative_cursor_position, ImeCommitTextCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::WidgetInputHandler::kImeCommitText), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void WidgetInputHandlerProxy::ImeFinishComposingText(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::WidgetInputHandler::kImeFinishComposingText), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void WidgetInputHandlerProxy::RequestTextInputStateUpdate(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::WidgetInputHandler::kRequestTextInputStateUpdate), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void WidgetInputHandlerProxy::RequestCompositionUpdates(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::WidgetInputHandler::kRequestCompositionUpdates), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void WidgetInputHandlerProxy::DispatchEvent(
    EventPtr in_event, EventPtr in_original_event_for_gesture, DispatchEventCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::WidgetInputHandler::kDispatchEvent), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void WidgetInputHandlerProxy::DispatchNonBlockingEvent(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::WidgetInputHandler::kDispatchNonBlockingEvent), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void WidgetInputHandlerProxy::WaitForInputProcessed(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::WidgetInputHandler::kWaitForInputProcessed), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void WidgetInputHandlerProxy::PingMainThread(
    PingMainThreadCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "Send blink::mojom::WidgetInputHandler::PingMainThread");
#endif
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::WidgetInputHandler::kPingMainThread), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
      ::blink::mojom::internal::WidgetInputHandler_PingMainThread_Params_Data> params(
          message);
  params.Allocate();

#if defined(ENABLE_IPC_FUZZER)
  message.set_interface_name(WidgetInputHandler::Name_);
  message.set_method_name("PingMainThread");
#endif
  std::unique_ptr<mojo::MessageReceiver> responder(
      new WidgetInputHandler_PingMainThread_ForwardToCallback(
          std::move(callback)));
  ::mojo::internal::SendMojoMessage(*receiver_, message, std::move(responder));
}
...
void WidgetInputHandlerProxy::GetFrameWidgetInputHandler(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::WidgetInputHandler::kGetFrameWidgetInputHandler), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void WidgetInputHandlerProxy::UpdateBrowserControlsState(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::WidgetInputHandler::kUpdateBrowserControlsState), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
class WidgetInputHandler_PingMainThread_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 public:
  static WidgetInputHandler::PingMainThreadCallback CreateCallback(
      ::mojo::Message& message,
      std::unique_ptr<mojo::MessageReceiverWithStatus> responder) {
    std::unique_ptr<WidgetInputHandler_PingMainThread_ProxyToResponder> proxy(
        new WidgetInputHandler_PingMainThread_ProxyToResponder(
            message, std::move(responder)));
    return base::BindOnce(&WidgetInputHandler_PingMainThread_ProxyToResponder::Run,
                          std::move(proxy));
  }

  ~WidgetInputHandler_PingMainThread_ProxyToResponder() {
#if DCHECK_IS_ON()
    if (responder_) {
      // If we're being destroyed without being run, we want to ensure the
      // binding endpoint has been closed. This checks for that asynchronously.
 ...
 private:
  ...
  static void OnIsConnectedComplete(bool connected) {
    DCHECK(!connected)
        << "WidgetInputHandler::PingMainThreadCallback was destroyed without "
        << "first either being run or its corresponding binding being closed. "
        << "It is an error to drop response callbacks which still correspond "
        << "to an open interface pipe.";
  }
...
bool WidgetInputHandler_PingMainThread_ForwardToCallback::Accept(
    mojo::Message* message) {
  DCHECK(message->is_serialized());
  internal::WidgetInputHandler_PingMainThread_ResponseParams_Data* params =
      reinterpret_cast<
          internal::WidgetInputHandler_PingMainThread_ResponseParams_Data*>(
              message->mutable_payload());
  

  // Validation for WidgetInputHandler.12
  bool success = true;
  WidgetInputHandler_PingMainThread_ResponseParamsDataView input_data_view(params, message);
...
void WidgetInputHandler_PingMainThread_ProxyToResponder::Run(
    ) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "Send reply blink::mojom::WidgetInputHandler::PingMainThread");
#endif
  ...
  mojo::Message message(
      std::to_underlying(messages::WidgetInputHandler::kPingMainThread), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
      ::blink::mojom::internal::WidgetInputHandler_PingMainThread_ResponseParams_Data> params(
          message);
  params.Allocate();
...
bool WidgetInputHandlerStubDispatch::Accept(
  ...
  switch (static_cast<messages::WidgetInputHandler>(message->header()->name)) {
    ...
    case messages::WidgetInputHandler::kUpdateBrowserControlsState: {
      ...
      // Validation for WidgetInputHandler.14
      bool success = true;
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            WidgetInputHandler::Name_, 14, false);
        return false;
      }
      // A null |impl| means no implementation was bound.
      DCHECK(impl);
...
bool WidgetInputHandlerStubDispatch::AcceptWithResponder(
  ...
  switch (static_cast<messages::WidgetInputHandler>(message->header()->name)) {
    ...
    case messages::WidgetInputHandler::kImeSetComposition: {
      ...
      if (success)
        p_end = input_data_view.end();
      if (success && !input_data_view.ReadImeState(&p_ime_state))
        success = false;
      if (!success) {
        ReportValidationErrorForMessage(
            message,
      ...
      impl->ImeSetComposition(        
        ...
        std::move(p_start), 
        std::move(p_end), 
        std::move(p_ime_state), std::move(callback));
      return true;
    }
    case messages::WidgetInputHandler::kImeCommitText: {
    ...
    case messages::WidgetInputHandler::kDispatchEvent: {
      ...
      bool success = true;
      EventPtr p_event{};
      EventPtr p_original_event_for_gesture{};
    ...
    case messages::WidgetInputHandler::kPingMainThread: {
      internal::WidgetInputHandler_PingMainThread_Params_Data* params =
          reinterpret_cast<
              internal::WidgetInputHandler_PingMainThread_Params_Data*>(
                  message->mutable_payload());
      

      // Validation for WidgetInputHandler.12
      bool success = true;
      WidgetInputHandler_PingMainThread_ParamsDataView input_data_view(params, message);
      ...
      auto callback =
          WidgetInputHandler_PingMainThread_ProxyToResponder::CreateCallback(
              *message, std::move(responder));
      // A null |impl| means no implementation was bound.
      DCHECK(impl);
      impl->PingMainThread(std::move(callback));
      return true;
    }
    case messages::WidgetInputHandler::kGetFrameWidgetInputHandler: {
      break;
...
static const mojo::internal::GenericValidationInfo kWidgetInputHandlerValidationInfo[] = {
    ...
    { &internal::WidgetInputHandler_PingMainThread_Params_Data::Validate,
     &internal::WidgetInputHandler_PingMainThread_ResponseParams_Data::Validate},
...
bool WidgetInputHandlerRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::WidgetInputHandler::Name_,
...
bool StructTraits<::blink::mojom::WheelData::DataView, ::blink::mojom::WheelDataPtr>::Read(
  ...
  ::blink::mojom::WheelDataPtr result(::blink::mojom::WheelData::New());
      ...
      if (success && !input.ReadRailsMode(&result->rails_mode))
        success = false;
  *output = std::move(result);
  return success;
}
...
// static
bool StructTraits<::blink::mojom::TapDownData::DataView, ::blink::mojom::TapDownDataPtr>::Read(
    ::blink::mojom::TapDownData::DataView input,
    ::blink::mojom::TapDownDataPtr* output) {
  bool success = true;
  ::blink::mojom::TapDownDataPtr result(::blink::mojom::TapDownData::New());
...
void WidgetInputHandlerHostInterceptorForTesting::SetTouchActionFromMain(const ::cc::TouchAction& touch_action) {
...
void WidgetInputHandlerHostInterceptorForTesting::ImeCompositionRangeChanged(const ::gfx::Range& range, const std::optional<std::vector<::gfx::Rect>>& character_bounds) {
...
void FrameWidgetInputHandlerInterceptorForTesting::HandleStylusWritingGestureAction(::blink::mojom::StylusWritingGestureDataPtr gesture_data, HandleStylusWritingGestureActionCallback callback) {
  GetForwardingInterface()->HandleStylusWritingGestureAction(
    std::move(gesture_data)
    , std::move(callback));
}
void FrameWidgetInputHandlerInterceptorForTesting::ExecuteEditCommand(const std::string& command, const ::blink::String& value) {
...
void FrameWidgetInputHandlerInterceptorForTesting::PasteFromImageBytes(::mojo_base::BigBuffer image_bytes, const std::string& media_format) {
  GetForwardingInterface()->PasteFromImageBytes(
    std::move(image_bytes)
    , 
    std::move(media_format)
    );
}
...
void FrameWidgetInputHandlerAsyncWaiter::HandleStylusWritingGestureAction(
  ...
  proxy_->HandleStylusWritingGestureAction(
      ...
      base::BindOnce(
          [](base::RunLoop* loop,
             ::blink::mojom::HandwritingGestureResult* out_result
,
             ::blink::mojom::HandwritingGestureResult result) {*out_result = std::move(result);
            loop->Quit();
          },
          &loop,
          out_result));
...
::blink::mojom::HandwritingGestureResult FrameWidgetInputHandlerAsyncWaiter::HandleStylusWritingGestureAction(
    ::blink::mojom::StylusWritingGestureDataPtr gesture_data) {
  ::blink::mojom::HandwritingGestureResult async_wait_result;
...
void WidgetInputHandlerInterceptorForTesting::ImeSetComposition(const ::blink::String& text, const std::vector<::ui::ImeTextSpan>& ime_text_spans, const ::gfx::Range& range, int32_t start, int32_t end, ImeState ime_state, ImeSetCompositionCallback callback) {
...
void WidgetInputHandlerInterceptorForTesting::ImeCommitText(const ::blink::String& text, const std::vector<::ui::ImeTextSpan>& ime_text_spans, const ::gfx::Range& range, int32_t relative_cursor_position, ImeCommitTextCallback callback) {
...
void WidgetInputHandlerInterceptorForTesting::DispatchEvent(EventPtr event, EventPtr original_event_for_gesture, DispatchEventCallback callback) {
...
void WidgetInputHandlerInterceptorForTesting::DispatchNonBlockingEvent(EventPtr event) {
...
void WidgetInputHandlerInterceptorForTesting::PingMainThread(PingMainThreadCallback callback) {
  GetForwardingInterface()->PingMainThread(std::move(callback));
}
...
void WidgetInputHandlerAsyncWaiter::PingMainThread(
    ) {
  base::RunLoop loop;
  proxy_->PingMainThread(
      base::BindOnce(
          [](base::RunLoop* loop) {
            loop->Quit();
          },
