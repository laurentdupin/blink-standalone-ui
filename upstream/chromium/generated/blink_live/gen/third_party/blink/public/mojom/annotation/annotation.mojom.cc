// third_party/blink/public/mojom/annotation/annotation.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "third_party/blink/public/mojom/annotation/annotation.mojom-import-headers.h"
...
SelectorCreationResult::SelectorCreationResult(
    ...
    const std::string& serialized_selector_in,
...
void Selector::set_serialized_selector(const std::string& serialized_selector) {
  if (tag_ == Tag::kSerializedSelector) {
    data_.serialized_selector = std::move(serialized_selector);
  } else {
    DestroyActive();
    tag_ = Tag::kSerializedSelector;
    new (&data_.serialized_selector) std::string(
...
size_t Selector::Hash(size_t seed) const {
  ...
  switch (tag_) {
    ...
    case Tag::kSerializedSelector:
      return mojo::internal::Hash(seed, data_.serialized_selector);
    case Tag::kNodeId:
      return mojo::internal::Hash(seed, data_.node_id);
    default:
      NOTREACHED();
  }
}
...
void AnnotationAgentProxy::ScrollIntoView(
  ...
  mojo::Message message(
      std::to_underlying(messages::AnnotationAgent::kScrollIntoView), kFlags, estimated_payload_size);
...
bool AnnotationAgentRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::AnnotationAgent::Name_,
...
void AnnotationAgentHostProxy::DidFinishAttachment(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::AnnotationAgentHost::kDidFinishAttachment), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool AnnotationAgentHostRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::AnnotationAgentHost::Name_,
...
void AnnotationAgentContainerProxy::CreateAgent(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::AnnotationAgentContainer::kCreateAgent), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void AnnotationAgentContainerProxy::CreateAgentFromSelection(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::AnnotationAgentContainer::kCreateAgentFromSelection), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void AnnotationAgentContainerProxy::RemoveAgentsOfType(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::AnnotationAgentContainer::kRemoveAgentsOfType), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
class AnnotationAgentContainer_CreateAgentFromSelection_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      SelectorCreationResultPtr in_result, ::blink::mojom::LinkGenerationError in_error, ::blink::mojom::LinkGenerationReadyStatus in_ready_status);
};
...
bool AnnotationAgentContainer_CreateAgentFromSelection_ForwardToCallback::Accept(
  ...
  ::blink::mojom::LinkGenerationError p_error{};
  ::blink::mojom::LinkGenerationReadyStatus p_ready_status{};
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("error"), in_error,
                        "<value of type ::blink::mojom::LinkGenerationError>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("ready_status"), in_ready_status,
                        "<value of type ::blink::mojom::LinkGenerationReadyStatus>");
   });
#endif
...
// static
bool StructTraits<::blink::mojom::SelectorCreationResult::DataView, ::blink::mojom::SelectorCreationResultPtr>::Read(
    ::blink::mojom::SelectorCreationResult::DataView input,
    ::blink::mojom::SelectorCreationResultPtr* output) {
  bool success = true;
  ::blink::mojom::SelectorCreationResultPtr result(::blink::mojom::SelectorCreationResult::New());
...
// static
bool UnionTraits<::blink::mojom::Selector::DataView, ::blink::mojom::SelectorPtr>::Read(
    ::blink::mojom::Selector::DataView input,
    ::blink::mojom::SelectorPtr* output) {
  using UnionType = ::blink::mojom::Selector;
  using Tag = UnionType::Tag;

  switch (input.tag()) {
    case Tag::kSerializedSelector: {
      std::string result_serialized_selector{};
...
,
             ::blink::mojom::LinkGenerationError* out_error
,
             ::blink::mojom::LinkGenerationReadyStatus* out_ready_status
,
             SelectorCreationResultPtr result,
             ::blink::mojom::LinkGenerationError error,
             ::blink::mojom::LinkGenerationReadyStatus ready_status) {*out_result = std::move(result);*out_error = std::move(error);*out_ready_status = std::move(ready_status);
            loop->Quit();
          },
          &loop,
          out_result,
