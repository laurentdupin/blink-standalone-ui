...
#include "third_party/blink/public/mojom/frame/frame_policy.mojom-forward.h"  // IWYU pragma: export
#include "services/network/public/mojom/web_sandbox_flags.mojom-forward.h"
#include "third_party/blink/public/mojom/frame/deferred_fetch_policy.mojom-forward.h"
...
class  FramePolicy {
 public:
  ...
  FramePolicy(
      ...
      std::vector<::network::mojom::ParsedPermissionsPolicyDeclarationPtr> container_policy,
      base::flat_map<::blink::mojom::DocumentPolicyFeature, ::blink::mojom::PolicyValuePtr> required_document_policy,
      ::blink::mojom::DeferredFetchPolicy deferred_fetch_policy);
...
FramePolicy& operator=(const FramePolicy&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        FramePolicy::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
template <>
struct  StructTraits<::blink::mojom::FramePolicy::DataView,
  ...
  static decltype(::blink::mojom::FramePolicy::deferred_fetch_policy) deferred_fetch_policy(
      const ::blink::mojom::FramePolicyPtr& input) {
