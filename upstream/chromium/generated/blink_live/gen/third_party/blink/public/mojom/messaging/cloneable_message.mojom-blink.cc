...
CloneableMessage::CloneableMessage(
    ::mojo_base::mojom::blink::BigBufferPtr encoded_message_in,
    ::blink::Vector<::blink::mojom::blink::SerializedBlobPtr> blobs_in,
    ::url::mojom::blink::OriginPtr sender_origin_in,
    ...
    ::mojo_base::mojom::blink::UnguessableTokenPtr sender_agent_cluster_id_in,
    bool locked_to_sender_agent_cluster_in,
    ::blink::Vector<::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessTransferToken>> file_system_access_tokens_in)
...
void CloneableMessage::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "blobs"), this->blobs,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<::blink::mojom::blink::SerializedBlobPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "sender_agent_cluster_id"), this->sender_agent_cluster_id,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::mojo_base::mojom::blink::UnguessableTokenPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "locked_to_sender_agent_cluster"), this->locked_to_sender_agent_cluster,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type bool>"
#else
      "<value>"
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessTransferToken>>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
