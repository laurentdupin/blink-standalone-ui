...
AffectedRequest::AffectedRequest(
    const ::blink::String& request_id_in,
...
AffectedFrame::AffectedFrame(
    const ::blink::String& frame_id_in)
...
AffectedLocation::AffectedLocation(
    const ::blink::String& script_id_in,
    const ::blink::String& url_in,
    uint32_t line_in,
    uint32_t column_in)
...
AttributionReportingIssueDetails::AttributionReportingIssueDetails(
    ...
    AffectedRequestPtr request_in,
    const ::blink::String& invalid_parameter_in)
...
void AttributionReportingIssueDetails::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "invalid_parameter"), this->invalid_parameter,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type const ::blink::String&>"
#else
      "<value>"
...
MixedContentIssueDetails::MixedContentIssueDetails(
    ...
    const ::blink::String& insecure_url_in,
    const ::blink::String& main_resource_url_in,
    AffectedRequestPtr request_in,
    AffectedFramePtr frame_in)
...
ContentSecurityPolicyIssueDetails::ContentSecurityPolicyIssueDetails(
    ...
    const ::blink::String& violated_directive_in,
...
CookieIssueDetails::CookieIssueDetails(
    ...
    ::blink::Vector<CookieExclusionReason> exclusion_reason_in,
    ::blink::Vector<CookieWarningReason> warning_reason_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type const ::blink::Vector<CookieExclusionReason>&>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type const ::blink::Vector<CookieWarningReason>&>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
PerformanceIssueDetails::PerformanceIssueDetails(
    PerformanceIssueType performance_issue_type_in,
    AffectedLocationPtr affected_location_in)
    : performance_issue_type(std::move(performance_issue_type_in)),
      affected_location(std::move(affected_location_in)) {}

PerformanceIssueDetails::~PerformanceIssueDetails() = default;

void PerformanceIssueDetails::WriteIntoTrace(
    perfetto::TracedValue traced_context) const {
  [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "performance_issue_type"), this->performance_issue_type,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type PerformanceIssueType>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
bool PerformanceIssueDetails::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  return Data_::Validate(data, validation_context);
}
...
EmailVerificationRequestIssueDetails::EmailVerificationRequestIssueDetails(
    ::blink::mojom::blink::EmailVerificationRequestResult status_in)
    : status(std::move(status_in)) {}

EmailVerificationRequestIssueDetails::~EmailVerificationRequestIssueDetails() = default;
size_t EmailVerificationRequestIssueDetails::Hash(size_t seed) const {
  seed = mojo::internal::WTFHash(seed, this->status);
  return seed;
}

void EmailVerificationRequestIssueDetails::WriteIntoTrace(
    perfetto::TracedValue traced_context) const {
  [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "status"), this->status,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::mojom::blink::EmailVerificationRequestResult>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
bool EmailVerificationRequestIssueDetails::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  return Data_::Validate(data, validation_context);
}
...
BounceTrackingIssueDetails::BounceTrackingIssueDetails(
    ::blink::Vector<::blink::String> tracking_sites_in)
...
void BounceTrackingIssueDetails::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "tracking_sites"), this->tracking_sites,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
PartitioningBlobURLIssueDetails::PartitioningBlobURLIssueDetails()
    : url(),
      partitioning_blob_url_info() {}

PartitioningBlobURLIssueDetails::PartitioningBlobURLIssueDetails(
    const ::blink::KURL& url_in,
    PartitioningBlobURLInfo partitioning_blob_url_info_in)
    : url(std::move(url_in)),
      partitioning_blob_url_info(std::move(partitioning_blob_url_info_in)) {}

PartitioningBlobURLIssueDetails::~PartitioningBlobURLIssueDetails() = default;

void PartitioningBlobURLIssueDetails::WriteIntoTrace(
    perfetto::TracedValue traced_context) const {
  [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "partitioning_blob_url_info"), this->partitioning_blob_url_info,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type PartitioningBlobURLInfo>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
bool PartitioningBlobURLIssueDetails::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  return Data_::Validate(data, validation_context);
}
...
CookieDeprecationMetadataIssueDetails::CookieDeprecationMetadataIssueDetails(
    ::blink::Vector<::blink::String> allowed_sites_in,
...
void CookieDeprecationMetadataIssueDetails::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "allowed_sites"), this->allowed_sites,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type const ::blink::Vector<::blink::String>&>"
#else
      "<value>"
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "opt_out_percentage"), this->opt_out_percentage,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type uint32_t>"
#else
      "<value>"
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "is_opt_out_top_level"), this->is_opt_out_top_level,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type bool>"
#else
      "<value>"
...
GenericIssueDetails::GenericIssueDetails(
    ...
    const ::blink::String& frame_id_in,
    int32_t violating_node_id_in,
    const ::blink::String& violating_node_attribute_in)
...
void GenericIssueDetails::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "violating_node_attribute"), this->violating_node_attribute,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type const ::blink::String&>"
#else
      "<value>"
...
UserReidentificationIssueDetails::UserReidentificationIssueDetails(
    UserReidentificationIssueType type_in,
    AffectedRequestPtr request_in,
    AffectedLocationPtr sourceCodeLocation_in)
    : type(std::move(type_in)),
      request(std::move(request_in)),
      sourceCodeLocation(std::move(sourceCodeLocation_in)) {}

UserReidentificationIssueDetails::~UserReidentificationIssueDetails() = default;

void UserReidentificationIssueDetails::WriteIntoTrace(
    perfetto::TracedValue traced_context) const {
  [[maybe_unused]] auto dict = std::move(traced_context).WriteDictionary();
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "type"), this->type,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type UserReidentificationIssueType>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "sourceCodeLocation"), this->sourceCodeLocation,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type AffectedLocationPtr>"
#else
      "<value>"
...
bool UserReidentificationIssueDetails::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  return Data_::Validate(data, validation_context);
}
InspectorIssueDetails::InspectorIssueDetails()
    : cookie_issue_details(),
      ...
      email_verification_request_details(),
      issue_id() {}
...
InspectorIssueDetails::InspectorIssueDetails(
    ...
    PartitioningBlobURLIssueDetailsPtr partitioning_blob_url_issue_details_in,
    ...
    UserReidentificationIssueDetailsPtr user_reidentification_issue_details_in,
    PerformanceIssueDetailsPtr performance_issue_details_in,
    EmailVerificationRequestIssueDetailsPtr email_verification_request_details_in,
    ...
    : cookie_issue_details(std::move(cookie_issue_details_in)),
      ...
      partitioning_blob_url_issue_details(std::move(partitioning_blob_url_issue_details_in)),
      ...
      user_reidentification_issue_details(std::move(user_reidentification_issue_details_in)),
      performance_issue_details(std::move(performance_issue_details_in)),
      email_verification_request_details(std::move(email_verification_request_details_in)),
...
void InspectorIssueDetails::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "attribution_reporting_issue_details"), this->attribution_reporting_issue_details,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "bounce_tracking_issue_details"), this->bounce_tracking_issue_details,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "partitioning_blob_url_issue_details"), this->partitioning_blob_url_issue_details,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type PartitioningBlobURLIssueDetailsPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "cookie_deprecation_metadata_issue_details"), this->cookie_deprecation_metadata_issue_details,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "deprecation_issue_details"), this->deprecation_issue_details,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "federated_auth_user_info_request_details"), this->federated_auth_user_info_request_details,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "user_reidentification_issue_details"), this->user_reidentification_issue_details,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type UserReidentificationIssueDetailsPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "performance_issue_details"), this->performance_issue_details,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type PerformanceIssueDetailsPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "email_verification_request_details"), this->email_verification_request_details,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type EmailVerificationRequestIssueDetailsPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
bool StructTraits<::blink::mojom::blink::AttributionReportingIssueDetails::DataView, ::blink::mojom::blink::AttributionReportingIssueDetailsPtr>::Read(
    ::blink::mojom::blink::AttributionReportingIssueDetails::DataView input,
    ::blink::mojom::blink::AttributionReportingIssueDetailsPtr* output) {
  bool success = true;
...
// static
bool StructTraits<::blink::mojom::blink::PerformanceIssueDetails::DataView, ::blink::mojom::blink::PerformanceIssueDetailsPtr>::Read(
    ::blink::mojom::blink::PerformanceIssueDetails::DataView input,
    ::blink::mojom::blink::PerformanceIssueDetailsPtr* output) {
  bool success = true;
  ::blink::mojom::blink::PerformanceIssueDetailsPtr result(::blink::mojom::blink::PerformanceIssueDetails::New());
  
      if (success && !input.ReadPerformanceIssueType(&result->performance_issue_type))
        success = false;
      if (success && !input.ReadAffectedLocation(&result->affected_location))
        success = false;
  *output = std::move(result);
...
// static
bool StructTraits<::blink::mojom::blink::FederatedAuthUserInfoRequestIssueDetails::DataView, ::blink::mojom::blink::FederatedAuthUserInfoRequestIssueDetailsPtr>::Read(
    ::blink::mojom::blink::FederatedAuthUserInfoRequestIssueDetails::DataView input,
...
// static
bool StructTraits<::blink::mojom::blink::EmailVerificationRequestIssueDetails::DataView, ::blink::mojom::blink::EmailVerificationRequestIssueDetailsPtr>::Read(
    ::blink::mojom::blink::EmailVerificationRequestIssueDetails::DataView input,
    ::blink::mojom::blink::EmailVerificationRequestIssueDetailsPtr* output) {
  bool success = true;
  ::blink::mojom::blink::EmailVerificationRequestIssueDetailsPtr result(::blink::mojom::blink::EmailVerificationRequestIssueDetails::New());
...
bool StructTraits<::blink::mojom::blink::BounceTrackingIssueDetails::DataView, ::blink::mojom::blink::BounceTrackingIssueDetailsPtr>::Read(
    ::blink::mojom::blink::BounceTrackingIssueDetails::DataView input,
    ::blink::mojom::blink::BounceTrackingIssueDetailsPtr* output) {
  bool success = true;
...
// static
bool StructTraits<::blink::mojom::blink::PartitioningBlobURLIssueDetails::DataView, ::blink::mojom::blink::PartitioningBlobURLIssueDetailsPtr>::Read(
    ::blink::mojom::blink::PartitioningBlobURLIssueDetails::DataView input,
    ::blink::mojom::blink::PartitioningBlobURLIssueDetailsPtr* output) {
  bool success = true;
  ::blink::mojom::blink::PartitioningBlobURLIssueDetailsPtr result(::blink::mojom::blink::PartitioningBlobURLIssueDetails::New());
  
      if (success && !input.ReadUrl(&result->url))
        success = false;
      if (success && !input.ReadPartitioningBlobUrlInfo(&result->partitioning_blob_url_info))
        success = false;
  *output = std::move(result);
  return success;
}
...
// static
bool StructTraits<::blink::mojom::blink::CookieDeprecationMetadataIssueDetails::DataView, ::blink::mojom::blink::CookieDeprecationMetadataIssueDetailsPtr>::Read(
    ::blink::mojom::blink::CookieDeprecationMetadataIssueDetails::DataView input,
...
bool StructTraits<::blink::mojom::blink::DeprecationIssueDetails::DataView, ::blink::mojom::blink::DeprecationIssueDetailsPtr>::Read(
    ::blink::mojom::blink::DeprecationIssueDetails::DataView input,
    ::blink::mojom::blink::DeprecationIssueDetailsPtr* output) {
  bool success = true;
...
// static
bool StructTraits<::blink::mojom::blink::UserReidentificationIssueDetails::DataView, ::blink::mojom::blink::UserReidentificationIssueDetailsPtr>::Read(
    ::blink::mojom::blink::UserReidentificationIssueDetails::DataView input,
    ::blink::mojom::blink::UserReidentificationIssueDetailsPtr* output) {
  bool success = true;
  ::blink::mojom::blink::UserReidentificationIssueDetailsPtr result(::blink::mojom::blink::UserReidentificationIssueDetails::New());
  
      if (success && !input.ReadType(&result->type))
        success = false;
      if (success && !input.ReadRequest(&result->request))
        success = false;
      if (success && !input.ReadSourceCodeLocation(&result->sourceCodeLocation))
        success = false;
  *output = std::move(result);
  return success;
}
...
bool StructTraits<::blink::mojom::blink::InspectorIssueDetails::DataView, ::blink::mojom::blink::InspectorIssueDetailsPtr>::Read(
  ...
  ::blink::mojom::blink::InspectorIssueDetailsPtr result(::blink::mojom::blink::InspectorIssueDetails::New());
      ...
      if (success && !input.ReadBounceTrackingIssueDetails(&result->bounce_tracking_issue_details))
        success = false;
      if (success && !input.ReadPartitioningBlobUrlIssueDetails(&result->partitioning_blob_url_issue_details))
        success = false;
      ...
      if (success && !input.ReadFederatedAuthUserInfoRequestDetails(&result->federated_auth_user_info_request_details))
        success = false;
      if (success && !input.ReadUserReidentificationIssueDetails(&result->user_reidentification_issue_details))
        success = false;
      if (success && !input.ReadPerformanceIssueDetails(&result->performance_issue_details))
        success = false;
      if (success && !input.ReadEmailVerificationRequestDetails(&result->email_verification_request_details))
        success = false;
