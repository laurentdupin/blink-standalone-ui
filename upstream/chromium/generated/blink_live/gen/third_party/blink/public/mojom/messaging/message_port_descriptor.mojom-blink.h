...
class  MessagePortDescriptor {
 public:
  ...
  MessagePortDescriptor(
      ...
      ::mojo_base::mojom::blink::UnguessableTokenPtr id,
...
template <>
struct  StructTraits<::blink::mojom::blink::MessagePortDescriptor::DataView,
                                         ::blink::mojom::blink::MessagePortDescriptorPtr> {
  static bool IsNull(const ::blink::mojom::blink::MessagePortDescriptorPtr& input) { return !input; }
  static void SetToNull(::blink::mojom::blink::MessagePortDescriptorPtr* output) { output->reset(); }

  static  decltype(::blink::mojom::blink::MessagePortDescriptor::pipe_handle)& pipe_handle(
       ::blink::mojom::blink::MessagePortDescriptorPtr& input) {
    return input->pipe_handle;
  }

  static const decltype(::blink::mojom::blink::MessagePortDescriptor::id)& id(
      const ::blink::mojom::blink::MessagePortDescriptorPtr& input) {
    return input->id;
  }

  static decltype(::blink::mojom::blink::MessagePortDescriptor::sequence_number) sequence_number(
      const ::blink::mojom::blink::MessagePortDescriptorPtr& input) {
