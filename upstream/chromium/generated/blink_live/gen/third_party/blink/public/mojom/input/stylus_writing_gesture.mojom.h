// third_party/blink/public/mojom/input/stylus_writing_gesture.mojom.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef THIRD_PARTY_BLINK_PUBLIC_MOJOM_INPUT_STYLUS_WRITING_GESTURE_MOJOM_H_
#define THIRD_PARTY_BLINK_PUBLIC_MOJOM_INPUT_STYLUS_WRITING_GESTURE_MOJOM_H_
...
#include "third_party/blink/public/mojom/input/stylus_writing_gesture.mojom-forward.h"  // IWYU pragma: export
 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        StylusWritingGestureData::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        StylusWritingGestureData::DataView, std::vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::blink::mojom::StylusWritingGestureData::DataView,
                                         ::blink::mojom::StylusWritingGestureDataPtr> {
  static bool IsNull(const ::blink::mojom::StylusWritingGestureDataPtr& input) { return !input; }
  static void SetToNull(::blink::mojom::StylusWritingGestureDataPtr* output) { output->reset(); }

  static decltype(::blink::mojom::StylusWritingGestureData::action) action(
      const ::blink::mojom::StylusWritingGestureDataPtr& input) {
    return input->action;
  }

  static decltype(::blink::mojom::StylusWritingGestureData::granularity) granularity(
      const ::blink::mojom::StylusWritingGestureDataPtr& input) {
    return input->granularity;
  }

  static const decltype(::blink::mojom::StylusWritingGestureData::start_rect)& start_rect(
      const ::blink::mojom::StylusWritingGestureDataPtr& input) {
    return input->start_rect;
  }

  static const decltype(::blink::mojom::StylusWritingGestureData::end_rect)& end_rect(
      const ::blink::mojom::StylusWritingGestureDataPtr& input) {
    return input->end_rect;
  }

  static const decltype(::blink::mojom::StylusWritingGestureData::text_alternative)& text_alternative(
      const ::blink::mojom::StylusWritingGestureDataPtr& input) {
    return input->text_alternative;
  }

  static const decltype(::blink::mojom::StylusWritingGestureData::text_to_insert)& text_to_insert(
      const ::blink::mojom::StylusWritingGestureDataPtr& input) {
    return input->text_to_insert;
  }

  static decltype(::blink::mojom::StylusWritingGestureData::is_preview) is_preview(
      const ::blink::mojom::StylusWritingGestureDataPtr& input) {
    return input->is_preview;
  }

  static bool Read(::blink::mojom::StylusWritingGestureData::DataView input, ::blink::mojom::StylusWritingGestureDataPtr* output);
};

}  // namespace mojo

#endif  // THIRD_PARTY_BLINK_PUBLIC_MOJOM_INPUT_STYLUS_WRITING_GESTURE_MOJOM_H_