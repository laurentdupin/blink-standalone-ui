...
CommitNavigationParams::CommitNavigationParams()
    : origin_to_commit(),
      ...
      load_with_storage_access(::network::mojom::StorageAccessApiStatus::kNone),
...
CommitNavigationParams::CommitNavigationParams(
    ...
    ::blink::mojom::StorageKeyPtr storage_key_in,
    ...
    std::vector<::network::mojom::URLRequestRedirectInfoPtr> redirect_infos_in,
    ...
    ::blink::mojom::TaskAttributionIdPtr soft_navigation_heuristics_task_id_in,
    const base::flat_map<::blink::mojom::RuntimeFeature, bool>& modified_runtime_features_in,
    ::blink::mojom::FencedFramePropertiesPtr fenced_frame_properties_in,
    ::blink::mojom::BackForwardCacheNotRestoredReasonsPtr not_restored_reasons_in,
    ::network::mojom::StorageAccessApiStatus load_with_storage_access_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::mojom::StorageKeyPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<::network::mojom::URLRequestRedirectInfoPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::mojom::FencedFramePropertiesPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
