...
namespace internal {
class  BackForwardCacheControllerHost_EvictFromBackForwardCache_Params_Data {
 public:
...
class  BackForwardCacheControllerHost_DidChangeBackForwardCacheDisablingFeatures_Params_Data {
 public:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
...
class BackForwardCacheControllerHost_DidChangeBackForwardCacheDisablingFeatures_ParamsDataView {
 public:
  ...
  [[nodiscard]] bool ReadDetails(UserType* output) {
    ...
    return mojo::internal::Deserialize<mojo::ArrayDataView<::blink::mojom::BlockingDetailsDataView>>(
        pointer, output, message_);
  }
 private:
...
inline void BackForwardCacheControllerHost_EvictFromBackForwardCache_ParamsDataView::GetSourceDataView(
    ::blink::mojom::ScriptSourceLocationDataView* output) {
  auto pointer = data_->source.Get();
