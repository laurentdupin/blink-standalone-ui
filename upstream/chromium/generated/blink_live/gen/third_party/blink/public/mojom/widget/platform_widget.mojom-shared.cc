...
// static
bool InitialFrameSinkParams_Data::Validate(
    const void* data,
  ...
  [[maybe_unused]] const InitialFrameSinkParams_Data* object =
      static_cast<const InitialFrameSinkParams_Data*>(data);

  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->initial_frame_sink, 1, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateHandleOrInterface(object->initial_frame_sink,
                                                 validation_context)) {
    return false;
  }

  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->initial_frame_sink_client, 2, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateHandleOrInterface(object->initial_frame_sink_client,
                                                 validation_context)) {
    return false;
  }

  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->initial_viz_rir_client, 3, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateHandleOrInterface(object->initial_viz_rir_client,
                                                 validation_context)) {
    return false;
  }
...
InitialFrameSinkParams_Data::InitialFrameSinkParams_Data()
...
bool WidgetHost_CreateFrameSink_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->render_input_router_client, 3, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateHandleOrInterface(object->render_input_router_client,
                                                 validation_context)) {
    return false;
  }
...
// static
bool Widget_RequestSuccessfulPresentationTimeForNextFrame_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
...
// static
bool Widget_CancelSuccessfulPresentationTimeRequest_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
...
// static
bool Widget_SetupBrowserRenderInputRouterConnections_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const Widget_SetupBrowserRenderInputRouterConnections_Params_Data* object =
      static_cast<const Widget_SetupBrowserRenderInputRouterConnections_Params_Data*>(data);

  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->browser_client, 1, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateHandleOrInterface(object->browser_client,
                                                 validation_context)) {
    return false;
  }
...
Widget_SetupBrowserRenderInputRouterConnections_Params_Data::Widget_SetupBrowserRenderInputRouterConnections_Params_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool RenderInputRouterClient_GetWidgetInputHandler_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
...
// static
bool RenderInputRouterClient_ShowContextMenu_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
...
// static
bool RenderInputRouterClient_BindInputTargetClient_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
