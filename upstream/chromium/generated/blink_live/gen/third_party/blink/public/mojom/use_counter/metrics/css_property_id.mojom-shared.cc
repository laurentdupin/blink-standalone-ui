...
NOINLINE static const char* CSSSampleIdToStringHelper(CSSSampleId value) {
  ...
  switch(value) {
    case CSSSampleId::kInvalid:
      return "{kInvalid, kInternalAlignContentBlock, kInternalAlignSelfBlock, kInternalEmptyLineHeight, kInternalVisitedBackgroundColor, kInternalVisitedBorderBlockEndColor, kInternalVisitedBorderBlockStartColor, kInternalVisitedBorderBottomColor, kInternalVisitedBorderInlineEndColor, kInternalVisitedBorderInlineStartColor, kInternalVisitedBorderLeftColor, kInternalVisitedBorderRightColor, kInternalVisitedBorderTopColor, kInternalVisitedCaretColor, kInternalVisitedColor, kInternalVisitedColumnRuleColor, kInternalVisitedFill, kInternalVisitedOutlineColor, kInternalVisitedStroke, kInternalVisitedTextDecorationColor, kInternalVisitedTextEmphasisColor, kInternalVisitedTextFillColor, kInternalVisitedTextStrokeColor, kInternalFontSizeDelta, kInternalForcedBackgroundColor, kInternalForcedBorderColor, kInternalForcedColor, kInternalForcedOutlineColor, kInternalForcedVisitedColor, kInternalOverflowBlock, kInternalOverflowInline, kInternalOverscrollArea, kInternalOverscrollPosition}";
    ...
    case CSSSampleId::kAliasWebkitPrintColorAdjust:
      return "kAliasWebkitPrintColorAdjust";
    ...
    case CSSSampleId::kScrollInitialTarget:
    ...
    case CSSSampleId::kFlowTolerance:
      return "kFlowTolerance";
    case CSSSampleId::kCaretAnimation:
      return "kCaretAnimation";
    case CSSSampleId::kInteractivity:
      return "kInteractivity";
    case CSSSampleId::kGridLanesDirection:
      return "kGridLanesDirection";
    case CSSSampleId::kResult:
      return "kResult";
    case CSSSampleId::kInterestDelayStart:
      return "kInterestDelayStart";
    case CSSSampleId::kInterestDelayEnd:
      return "kInterestDelayEnd";
    case CSSSampleId::kAnimationTriggerRange:
      return "kAnimationTriggerRange";
    case CSSSampleId::kAnimationTriggerExitRange:
      return "kAnimationTriggerExitRange";
    case CSSSampleId::kInterestDelay:
      return "kInterestDelay";
    case CSSSampleId::kAnimationTrigger:
      return "kAnimationTrigger";
    case CSSSampleId::kColumnRuleBreak:
      return "kColumnRuleBreak";
    case CSSSampleId::kRowRuleBreak:
      return "kRowRuleBreak";
    case CSSSampleId::kCornerBottomLeftShape:
      return "kCornerBottomLeftShape";
    case CSSSampleId::kCornerBottomRightShape:
      return "kCornerBottomRightShape";
    case CSSSampleId::kCornerTopLeftShape:
      return "kCornerTopLeftShape";
    case CSSSampleId::kCornerTopRightShape:
      return "kCornerTopRightShape";
    case CSSSampleId::kCornerStartStartShape:
      return "kCornerStartStartShape";
    case CSSSampleId::kCornerStartEndShape:
      return "kCornerStartEndShape";
    case CSSSampleId::kCornerEndStartShape:
      return "kCornerEndStartShape";
    case CSSSampleId::kCornerEndEndShape:
      return "kCornerEndEndShape";
    case CSSSampleId::kReadingOrder:
      return "kReadingOrder";
    case CSSSampleId::kColumnRuleInset:
      return "kColumnRuleInset";
    case CSSSampleId::kRowRuleInset:
      return "kRowRuleInset";
    case CSSSampleId::kCornerShape:
      return "kCornerShape";
    case CSSSampleId::kScrollTargetGroup:
      return "kScrollTargetGroup";
    case CSSSampleId::kRowRuleStyle:
      return "kRowRuleStyle";
    case CSSSampleId::kRowRuleWidth:
      return "kRowRuleWidth";
    case CSSSampleId::kRowRuleColor:
      return "kRowRuleColor";
    case CSSSampleId::kPrintColorAdjust:
      return "kPrintColorAdjust";
    case CSSSampleId::kColumnHeight:
      return "kColumnHeight";
    case CSSSampleId::kColumnWrap:
      return "kColumnWrap";
    case CSSSampleId::kRuleColor:
      return "kRuleColor";
    case CSSSampleId::kRuleWidth:
      return "kRuleWidth";
    case CSSSampleId::kRuleStyle:
      return "kRuleStyle";
    case CSSSampleId::kCaretShape:
      return "kCaretShape";
    case CSSSampleId::kRowRule:
      return "kRowRule";
    case CSSSampleId::kRule:
      return "kRule";
    case CSSSampleId::kCornerTopShape:
      return "kCornerTopShape";
    case CSSSampleId::kCornerRightShape:
      return "kCornerRightShape";
    case CSSSampleId::kCornerBottomShape:
      return "kCornerBottomShape";
    case CSSSampleId::kCornerLeftShape:
      return "kCornerLeftShape";
    case CSSSampleId::kCornerBlockStartShape:
      return "kCornerBlockStartShape";
    case CSSSampleId::kCornerBlockEndShape:
      return "kCornerBlockEndShape";
    case CSSSampleId::kCornerInlineStartShape:
      return "kCornerInlineStartShape";
    case CSSSampleId::kCornerInlineEndShape:
      return "kCornerInlineEndShape";
    case CSSSampleId::kCorners:
      return "kCorners";
    case CSSSampleId::kBorderShape:
      return "kBorderShape";
    case CSSSampleId::kTimelineTriggerName:
      return "kTimelineTriggerName";
    case CSSSampleId::kTimelineTriggerBehavior:
      return "kTimelineTriggerBehavior";
    case CSSSampleId::kTimelineTriggerSource:
      return "kTimelineTriggerSource";
    case CSSSampleId::kTimelineTrigger:
      return "kTimelineTrigger";
    case CSSSampleId::kGridLanes:
      return "kGridLanes";
    case CSSSampleId::kContinue:
      return "kContinue";
    case CSSSampleId::kMaxLines:
      return "kMaxLines";
    case CSSSampleId::kBlockEllipsis:
      return "kBlockEllipsis";
    case CSSSampleId::kOverscrollArea:
      return "kOverscrollArea";
    case CSSSampleId::kOverscrollPosition:
      return "kOverscrollPosition";
    case CSSSampleId::kFontLanguageOverride:
      return "kFontLanguageOverride";
    case CSSSampleId::kRubyOverhang:
      return "kRubyOverhang";
    case CSSSampleId::kRuleBreak:
      return "kRuleBreak";
    case CSSSampleId::kRuleInset:
      return "kRuleInset";
    case CSSSampleId::kColumnRuleVisibilityItems:
      return "kColumnRuleVisibilityItems";
    case CSSSampleId::kRowRuleVisibilityItems:
      return "kRowRuleVisibilityItems";
    case CSSSampleId::kColumnRuleInsetCapStart:
      return "kColumnRuleInsetCapStart";
    case CSSSampleId::kColumnRuleInsetCapEnd:
      return "kColumnRuleInsetCapEnd";
    case CSSSampleId::kColumnRuleInsetJunctionStart:
      return "kColumnRuleInsetJunctionStart";
    case CSSSampleId::kColumnRuleInsetJunctionEnd:
      return "kColumnRuleInsetJunctionEnd";
    case CSSSampleId::kRowRuleInsetCapStart:
      return "kRowRuleInsetCapStart";
    case CSSSampleId::kRowRuleInsetCapEnd:
      return "kRowRuleInsetCapEnd";
    case CSSSampleId::kRowRuleInsetJunctionStart:
      return "kRowRuleInsetJunctionStart";
    case CSSSampleId::kRowRuleInsetJunctionEnd:
      return "kRowRuleInsetJunctionEnd";
    case CSSSampleId::kTriggerScope:
      return "kTriggerScope";
    case CSSSampleId::kProtocol:
      return "kProtocol";
    case CSSSampleId::kHostname:
      return "kHostname";
    case CSSSampleId::kPort:
      return "kPort";
    case CSSSampleId::kPathname:
      return "kPathname";
    case CSSSampleId::kSearch:
      return "kSearch";
    case CSSSampleId::kHash:
      return "kHash";
    case CSSSampleId::kBaseUrl:
      return "kBaseUrl";
    case CSSSampleId::kPattern:
      return "kPattern";
    case CSSSampleId::kColumnRuleInsetCap:
      return "kColumnRuleInsetCap";
    case CSSSampleId::kRowRuleInsetCap:
      return "kRowRuleInsetCap";
    case CSSSampleId::kColumnRuleInsetJunction:
      return "kColumnRuleInsetJunction";
    case CSSSampleId::kRowRuleInsetJunction:
      return "kRowRuleInsetJunction";
    case CSSSampleId::kRuleInsetCap:
      return "kRuleInsetCap";
    case CSSSampleId::kRuleInsetJunction:
      return "kRuleInsetJunction";
    case CSSSampleId::kPageMarginSafety:
      return "kPageMarginSafety";
    case CSSSampleId::kTimelineTriggerActiveRangeStart:
      return "kTimelineTriggerActiveRangeStart";
    case CSSSampleId::kTimelineTriggerActiveRangeEnd:
      return "kTimelineTriggerActiveRangeEnd";
    case CSSSampleId::kTimelineTriggerActiveRange:
      return "kTimelineTriggerActiveRange";
    case CSSSampleId::kGridLanesPack:
      return "kGridLanesPack";
    case CSSSampleId::kTextFit:
      return "kTextFit";
    case CSSSampleId::kViewTransitionScope:
      return "kViewTransitionScope";
    case CSSSampleId::kRuleVisibilityItems:
      return "kRuleVisibilityItems";
    case CSSSampleId::kFrameSizing:
      return "kFrameSizing";
    case CSSSampleId::kImageAnimation:
      return "kImageAnimation";
    case CSSSampleId::kMarginTrim:
      return "kMarginTrim";
    case CSSSampleId::kTimelineTriggerActivationRangeStart:
      return "kTimelineTriggerActivationRangeStart";
    case CSSSampleId::kTimelineTriggerActivationRangeEnd:
      return "kTimelineTriggerActivationRangeEnd";
    case CSSSampleId::kTimelineTriggerActivationRange:
      return "kTimelineTriggerActivationRange";
    case CSSSampleId::kRuleOverlap:
      return "kRuleOverlap";
    case CSSSampleId::kColumnRuleInsetStart:
      return "kColumnRuleInsetStart";
    case CSSSampleId::kColumnRuleInsetEnd:
      return "kColumnRuleInsetEnd";
    case CSSSampleId::kRowRuleInsetStart:
      return "kRowRuleInsetStart";
    case CSSSampleId::kRowRuleInsetEnd:
      return "kRowRuleInsetEnd";
    case CSSSampleId::kRuleInsetStart:
      return "kRuleInsetStart";
    case CSSSampleId::kRuleInsetEnd:
      return "kRuleInsetEnd";
    case CSSSampleId::kPathLength:
      return "kPathLength";
    case CSSSampleId::kHangingPunctuation:
      return "kHangingPunctuation";
    case CSSSampleId::kFlexLineCount:
      return "kFlexLineCount";
    case CSSSampleId::kTextDecorationSkipSpaces:
      return "kTextDecorationSkipSpaces";
    default:
      return nullptr;
  }
}
