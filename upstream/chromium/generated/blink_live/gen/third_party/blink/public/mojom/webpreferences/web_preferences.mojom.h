// third_party/blink/public/mojom/webpreferences/web_preferences.mojom.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef THIRD_PARTY_BLINK_PUBLIC_MOJOM_WEBPREFERENCES_WEB_PREFERENCES_MOJOM_H_
#define THIRD_PARTY_BLINK_PUBLIC_MOJOM_WEBPREFERENCES_WEB_PREFERENCES_MOJOM_H_
...
#include "third_party/blink/public/mojom/webpreferences/web_preferences.mojom-forward.h"  // IWYU pragma: export
...
class  WebPreferences {
 public:
  ...
  WebPreferences(
      base::flat_map<std::string, ::mojo_base::mojom::String16Ptr> standard_font_family_map,
      base::flat_map<std::string, ::mojo_base::mojom::String16Ptr> fixed_font_family_map,
      base::flat_map<std::string, ::mojo_base::mojom::String16Ptr> serif_font_family_map,
      base::flat_map<std::string, ::mojo_base::mojom::String16Ptr> sans_serif_font_family_map,
      base::flat_map<std::string, ::mojo_base::mojom::String16Ptr> cursive_font_family_map,
      base::flat_map<std::string, ::mojo_base::mojom::String16Ptr> fantasy_font_family_map,
      base::flat_map<std::string, ::mojo_base::mojom::String16Ptr> math_font_family_map,
      ...
      const std::string& text_track_background_color,
      const std::string& text_track_text_color,
      const std::string& text_track_text_size,
      const std::string& text_track_text_shadow,
      const std::string& text_track_font_family,
      const std::string& text_track_font_style,
      const std::string& text_track_font_variant,
      const std::string& text_track_window_color,
      const std::string& text_track_window_radius,
      ...
      ::url::mojom::UrlPtr web_app_scope,
      ...
      ::skia::mojom::SkColorPtr root_scrollbar_theme_color,
      ...
      ::mojo_base::mojom::TimeDeltaPtr duplicate_nav_threshold,
...
template <>
struct  StructTraits<::blink::mojom::WebPreferences::DataView,
                                         ::blink::mojom::WebPreferencesPtr> {
  static bool IsNull(const ::blink::mojom::WebPreferencesPtr& input) { return !input; }
  static void SetToNull(::blink::mojom::WebPreferencesPtr* output) { output->reset(); }

  static const decltype(::blink::mojom::WebPreferences::standard_font_family_map)& standard_font_family_map(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->standard_font_family_map;
  }

  static const decltype(::blink::mojom::WebPreferences::fixed_font_family_map)& fixed_font_family_map(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->fixed_font_family_map;
  }

  static const decltype(::blink::mojom::WebPreferences::serif_font_family_map)& serif_font_family_map(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->serif_font_family_map;
  }

  static const decltype(::blink::mojom::WebPreferences::sans_serif_font_family_map)& sans_serif_font_family_map(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->sans_serif_font_family_map;
  }

  static const decltype(::blink::mojom::WebPreferences::cursive_font_family_map)& cursive_font_family_map(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->cursive_font_family_map;
  }

  static const decltype(::blink::mojom::WebPreferences::fantasy_font_family_map)& fantasy_font_family_map(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->fantasy_font_family_map;
  }

  static const decltype(::blink::mojom::WebPreferences::math_font_family_map)& math_font_family_map(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->math_font_family_map;
  }

  static decltype(::blink::mojom::WebPreferences::default_font_size) default_font_size(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->default_font_size;
  }

  static decltype(::blink::mojom::WebPreferences::default_fixed_font_size) default_fixed_font_size(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->default_fixed_font_size;
  }

  static decltype(::blink::mojom::WebPreferences::minimum_font_size) minimum_font_size(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->minimum_font_size;
  }

  static decltype(::blink::mojom::WebPreferences::minimum_logical_font_size) minimum_logical_font_size(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->minimum_logical_font_size;
  }

  static const decltype(::blink::mojom::WebPreferences::default_encoding)& default_encoding(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->default_encoding;
  }

  static decltype(::blink::mojom::WebPreferences::context_menu_on_mouse_up) context_menu_on_mouse_up(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->context_menu_on_mouse_up;
  }

  static decltype(::blink::mojom::WebPreferences::javascript_enabled) javascript_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->javascript_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::web_security_enabled) web_security_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->web_security_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::loads_images_automatically) loads_images_automatically(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->loads_images_automatically;
  }

  static decltype(::blink::mojom::WebPreferences::images_enabled) images_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->images_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::plugins_enabled) plugins_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->plugins_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::dom_paste_enabled) dom_paste_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->dom_paste_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::shrinks_standalone_images_to_fit) shrinks_standalone_images_to_fit(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->shrinks_standalone_images_to_fit;
  }

  static decltype(::blink::mojom::WebPreferences::text_areas_are_resizable) text_areas_are_resizable(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->text_areas_are_resizable;
  }

  static decltype(::blink::mojom::WebPreferences::allow_scripts_to_close_windows) allow_scripts_to_close_windows(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->allow_scripts_to_close_windows;
  }

  static decltype(::blink::mojom::WebPreferences::allow_unrestricted_window_focus) allow_unrestricted_window_focus(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->allow_unrestricted_window_focus;
  }

  static decltype(::blink::mojom::WebPreferences::remote_fonts_enabled) remote_fonts_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->remote_fonts_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::javascript_can_access_clipboard) javascript_can_access_clipboard(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->javascript_can_access_clipboard;
  }

  static decltype(::blink::mojom::WebPreferences::dns_prefetching_enabled) dns_prefetching_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->dns_prefetching_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::data_saver_enabled) data_saver_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->data_saver_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::battery_saver_enabled) battery_saver_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->battery_saver_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::preloading_disabled) preloading_disabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->preloading_disabled;
  }

  static decltype(::blink::mojom::WebPreferences::local_storage_enabled) local_storage_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->local_storage_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::tabs_to_links) tabs_to_links(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->tabs_to_links;
  }

  static decltype(::blink::mojom::WebPreferences::disable_ipc_flooding_protection) disable_ipc_flooding_protection(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->disable_ipc_flooding_protection;
  }

  static decltype(::blink::mojom::WebPreferences::hyperlink_auditing_enabled) hyperlink_auditing_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->hyperlink_auditing_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::allow_universal_access_from_file_urls) allow_universal_access_from_file_urls(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->allow_universal_access_from_file_urls;
  }

  static decltype(::blink::mojom::WebPreferences::allow_file_access_from_file_urls) allow_file_access_from_file_urls(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->allow_file_access_from_file_urls;
  }

  static decltype(::blink::mojom::WebPreferences::webgl1_enabled) webgl1_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->webgl1_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::webgl2_enabled) webgl2_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->webgl2_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::privileged_webgl_extensions_enabled) privileged_webgl_extensions_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->privileged_webgl_extensions_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::webgl_errors_to_console_enabled) webgl_errors_to_console_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->webgl_errors_to_console_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::hide_scrollbars) hide_scrollbars(
      const ::blink::mojom::WebPreferencesPtr& input) {
  ...
  static decltype(::blink::mojom::WebPreferences::canvas_2d_layers_enabled) canvas_2d_layers_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->canvas_2d_layers_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::antialiased_2d_canvas_disabled) antialiased_2d_canvas_disabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->antialiased_2d_canvas_disabled;
  }

  static decltype(::blink::mojom::WebPreferences::antialiased_clips_2d_canvas_enabled) antialiased_clips_2d_canvas_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->antialiased_clips_2d_canvas_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::accelerated_filters_enabled) accelerated_filters_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->accelerated_filters_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::deferred_filters_enabled) deferred_filters_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->deferred_filters_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::container_culling_enabled) container_culling_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->container_culling_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::allow_running_insecure_content) allow_running_insecure_content(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->allow_running_insecure_content;
  }

  static decltype(::blink::mojom::WebPreferences::disable_reading_from_canvas) disable_reading_from_canvas(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->disable_reading_from_canvas;
  }

  static decltype(::blink::mojom::WebPreferences::strict_mixed_content_checking) strict_mixed_content_checking(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->strict_mixed_content_checking;
  }

  static decltype(::blink::mojom::WebPreferences::allow_geolocation_on_insecure_origins) allow_geolocation_on_insecure_origins(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->allow_geolocation_on_insecure_origins;
  }

  static decltype(::blink::mojom::WebPreferences::strictly_block_blockable_mixed_content) strictly_block_blockable_mixed_content(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->strictly_block_blockable_mixed_content;
  }

  static decltype(::blink::mojom::WebPreferences::block_mixed_plugin_content) block_mixed_plugin_content(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->block_mixed_plugin_content;
  }

  static decltype(::blink::mojom::WebPreferences::highlight_ads) highlight_ads(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->highlight_ads;
  }

  static decltype(::blink::mojom::WebPreferences::password_echo_enabled_physical) password_echo_enabled_physical(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->password_echo_enabled_physical;
  }

  static decltype(::blink::mojom::WebPreferences::password_echo_enabled_touch) password_echo_enabled_touch(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->password_echo_enabled_touch;
  }

  static decltype(::blink::mojom::WebPreferences::should_clear_document_background) should_clear_document_background(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->should_clear_document_background;
  }

  static decltype(::blink::mojom::WebPreferences::enable_scroll_animator) enable_scroll_animator(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->enable_scroll_animator;
  }

  static decltype(::blink::mojom::WebPreferences::prefers_reduced_motion) prefers_reduced_motion(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->prefers_reduced_motion;
  }

  static decltype(::blink::mojom::WebPreferences::prefers_reduced_transparency) prefers_reduced_transparency(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->prefers_reduced_transparency;
  }

  static decltype(::blink::mojom::WebPreferences::inverted_colors) inverted_colors(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->inverted_colors;
  }

  static decltype(::blink::mojom::WebPreferences::touch_event_feature_detection_enabled) touch_event_feature_detection_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->touch_event_feature_detection_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::pointer_events_max_touch_points) pointer_events_max_touch_points(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->pointer_events_max_touch_points;
  }

  static decltype(::blink::mojom::WebPreferences::available_pointer_types) available_pointer_types(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->available_pointer_types;
  }

  static decltype(::blink::mojom::WebPreferences::primary_pointer_type) primary_pointer_type(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->primary_pointer_type;
  }

  static decltype(::blink::mojom::WebPreferences::output_device_update_ability_type) output_device_update_ability_type(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->output_device_update_ability_type;
  }

  static decltype(::blink::mojom::WebPreferences::available_hover_types) available_hover_types(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->available_hover_types;
  }

  static decltype(::blink::mojom::WebPreferences::primary_hover_type) primary_hover_type(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->primary_hover_type;
  }

  static decltype(::blink::mojom::WebPreferences::dont_send_key_events_to_javascript) dont_send_key_events_to_javascript(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->dont_send_key_events_to_javascript;
  }

  static decltype(::blink::mojom::WebPreferences::barrel_button_for_drag_enabled) barrel_button_for_drag_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->barrel_button_for_drag_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::sync_xhr_in_documents_enabled) sync_xhr_in_documents_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->sync_xhr_in_documents_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::target_blank_implies_no_opener_enabled_will_be_removed) target_blank_implies_no_opener_enabled_will_be_removed(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->target_blank_implies_no_opener_enabled_will_be_removed;
  }

  static decltype(::blink::mojom::WebPreferences::ignore_permission_for_device_changed_event) ignore_permission_for_device_changed_event(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->ignore_permission_for_device_changed_event;
  }

  static decltype(::blink::mojom::WebPreferences::number_of_cpu_cores) number_of_cpu_cores(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->number_of_cpu_cores;
  }

  static decltype(::blink::mojom::WebPreferences::editing_behavior) editing_behavior(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->editing_behavior;
  }

  static decltype(::blink::mojom::WebPreferences::supports_multiple_windows) supports_multiple_windows(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->supports_multiple_windows;
  }

  static decltype(::blink::mojom::WebPreferences::viewport_enabled) viewport_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->viewport_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::viewport_meta_enabled) viewport_meta_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->viewport_meta_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::auto_zoom_focused_editable_to_legible_scale) auto_zoom_focused_editable_to_legible_scale(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->auto_zoom_focused_editable_to_legible_scale;
  }

  static decltype(::blink::mojom::WebPreferences::shrinks_viewport_contents_to_fit) shrinks_viewport_contents_to_fit(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->shrinks_viewport_contents_to_fit;
  }

  static decltype(::blink::mojom::WebPreferences::viewport_style) viewport_style(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->viewport_style;
  }

  static decltype(::blink::mojom::WebPreferences::smooth_scroll_for_find_enabled) smooth_scroll_for_find_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->smooth_scroll_for_find_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::main_frame_resizes_are_orientation_changes) main_frame_resizes_are_orientation_changes(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->main_frame_resizes_are_orientation_changes;
  }

  static decltype(::blink::mojom::WebPreferences::initialize_at_minimum_page_scale) initialize_at_minimum_page_scale(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->initialize_at_minimum_page_scale;
  }

  static decltype(::blink::mojom::WebPreferences::smart_insert_delete_enabled) smart_insert_delete_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->smart_insert_delete_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::spatial_navigation_enabled) spatial_navigation_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->spatial_navigation_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::v8_cache_options) v8_cache_options(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->v8_cache_options;
  }

  static decltype(::blink::mojom::WebPreferences::record_whole_document) record_whole_document(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->record_whole_document;
  }

  static decltype(::blink::mojom::WebPreferences::stylus_handwriting_enabled) stylus_handwriting_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->stylus_handwriting_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::cookie_enabled) cookie_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->cookie_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::accelerated_video_decode_enabled) accelerated_video_decode_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->accelerated_video_decode_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::animation_policy) animation_policy(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->animation_policy;
  }

  static decltype(::blink::mojom::WebPreferences::user_gesture_required_for_presentation) user_gesture_required_for_presentation(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->user_gesture_required_for_presentation;
  }

  static decltype(::blink::mojom::WebPreferences::text_tracks_enabled) text_tracks_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->text_tracks_enabled;
  }

  static const decltype(::blink::mojom::WebPreferences::text_track_background_color)& text_track_background_color(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->text_track_background_color;
  }

  static const decltype(::blink::mojom::WebPreferences::text_track_text_color)& text_track_text_color(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->text_track_text_color;
  }

  static const decltype(::blink::mojom::WebPreferences::text_track_text_size)& text_track_text_size(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->text_track_text_size;
  }

  static const decltype(::blink::mojom::WebPreferences::text_track_text_shadow)& text_track_text_shadow(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->text_track_text_shadow;
  }

  static const decltype(::blink::mojom::WebPreferences::text_track_font_family)& text_track_font_family(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->text_track_font_family;
  }

  static const decltype(::blink::mojom::WebPreferences::text_track_font_style)& text_track_font_style(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->text_track_font_style;
  }

  static const decltype(::blink::mojom::WebPreferences::text_track_font_variant)& text_track_font_variant(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->text_track_font_variant;
  }

  static const decltype(::blink::mojom::WebPreferences::text_track_window_color)& text_track_window_color(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->text_track_window_color;
  }

  static const decltype(::blink::mojom::WebPreferences::text_track_window_radius)& text_track_window_radius(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->text_track_window_radius;
  }

  static decltype(::blink::mojom::WebPreferences::text_track_margin_percentage) text_track_margin_percentage(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->text_track_margin_percentage;
  }

  static decltype(::blink::mojom::WebPreferences::immersive_mode_enabled) immersive_mode_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->immersive_mode_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::immersive_video_playback_enabled) immersive_video_playback_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->immersive_video_playback_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::double_tap_to_zoom_enabled) double_tap_to_zoom_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->double_tap_to_zoom_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::fullscreen_supported) fullscreen_supported(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->fullscreen_supported;
  }

  static decltype(::blink::mojom::WebPreferences::text_size_adjust_enabled) text_size_adjust_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->text_size_adjust_enabled;
  }

  static const decltype(::blink::mojom::WebPreferences::web_app_scope)& web_app_scope(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->web_app_scope;
  }

  static decltype(::blink::mojom::WebPreferences::is_initial_profile) is_initial_profile(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->is_initial_profile;
  }

  static decltype(::blink::mojom::WebPreferences::force_dark_mode_enabled) force_dark_mode_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->force_dark_mode_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::default_minimum_page_scale_factor) default_minimum_page_scale_factor(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->default_minimum_page_scale_factor;
  }

  static decltype(::blink::mojom::WebPreferences::default_maximum_page_scale_factor) default_maximum_page_scale_factor(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->default_maximum_page_scale_factor;
  }

  static decltype(::blink::mojom::WebPreferences::hide_download_ui) hide_download_ui(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->hide_download_ui;
  }

  static decltype(::blink::mojom::WebPreferences::presentation_receiver) presentation_receiver(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->presentation_receiver;
  }

  static decltype(::blink::mojom::WebPreferences::media_controls_enabled) media_controls_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->media_controls_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::do_not_update_selection_on_mutating_selection_range) do_not_update_selection_on_mutating_selection_range(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->do_not_update_selection_on_mutating_selection_range;
  }

  static decltype(::blink::mojom::WebPreferences::autoplay_policy) autoplay_policy(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->autoplay_policy;
  }

  static decltype(::blink::mojom::WebPreferences::require_transient_activation_for_get_display_media) require_transient_activation_for_get_display_media(
      const ::blink::mojom::WebPreferencesPtr& input) {
  ...
  static decltype(::blink::mojom::WebPreferences::in_forced_colors) in_forced_colors(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->in_forced_colors;
  }

  static decltype(::blink::mojom::WebPreferences::is_forced_colors_disabled) is_forced_colors_disabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->is_forced_colors_disabled;
  }

  static const decltype(::blink::mojom::WebPreferences::root_scrollbar_theme_color)& root_scrollbar_theme_color(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->root_scrollbar_theme_color;
  }

  static decltype(::blink::mojom::WebPreferences::preferred_root_scrollbar_color_scheme) preferred_root_scrollbar_color_scheme(
      const ::blink::mojom::WebPreferencesPtr& input) {
  ...
  static decltype(::blink::mojom::WebPreferences::preferred_contrast) preferred_contrast(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->preferred_contrast;
  }

  static decltype(::blink::mojom::WebPreferences::low_priority_iframes_threshold) low_priority_iframes_threshold(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->low_priority_iframes_threshold;
  }

  static decltype(::blink::mojom::WebPreferences::picture_in_picture_enabled) picture_in_picture_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->picture_in_picture_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::translate_service_available) translate_service_available(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->translate_service_available;
  }

  static decltype(::blink::mojom::WebPreferences::network_quality_estimator_web_holdback) network_quality_estimator_web_holdback(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->network_quality_estimator_web_holdback;
  }

  static decltype(::blink::mojom::WebPreferences::lazy_load_enabled) lazy_load_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->lazy_load_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::allow_mixed_content_upgrades) allow_mixed_content_upgrades(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->allow_mixed_content_upgrades;
  }

  static decltype(::blink::mojom::WebPreferences::always_show_focus) always_show_focus(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->always_show_focus;
  }

  static decltype(::blink::mojom::WebPreferences::touch_drag_drop_enabled) touch_drag_drop_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->touch_drag_drop_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::touch_dragend_context_menu) touch_dragend_context_menu(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->touch_dragend_context_menu;
  }

  static decltype(::blink::mojom::WebPreferences::webxr_immersive_ar_allowed) webxr_immersive_ar_allowed(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->webxr_immersive_ar_allowed;
  }

  static decltype(::blink::mojom::WebPreferences::renderer_wide_named_frame_lookup) renderer_wide_named_frame_lookup(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->renderer_wide_named_frame_lookup;
  }

  static decltype(::blink::mojom::WebPreferences::strict_mime_type_check_for_worker_scripts_enabled) strict_mime_type_check_for_worker_scripts_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->strict_mime_type_check_for_worker_scripts_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::modal_context_menu) modal_context_menu(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->modal_context_menu;
  }

  static decltype(::blink::mojom::WebPreferences::payment_request_enabled) payment_request_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->payment_request_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::ai_ot_apis_enabled) ai_ot_apis_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->ai_ot_apis_enabled;
  }

  static decltype(::blink::mojom::WebPreferences::ignore_duplicate_nav_enabled) ignore_duplicate_nav_enabled(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->ignore_duplicate_nav_enabled;
  }

  static const decltype(::blink::mojom::WebPreferences::duplicate_nav_threshold)& duplicate_nav_threshold(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->duplicate_nav_threshold;
  }

  static decltype(::blink::mojom::WebPreferences::is_indigo_onboarding) is_indigo_onboarding(
      const ::blink::mojom::WebPreferencesPtr& input) {
    return input->is_indigo_onboarding;
  }

  static bool Read(::blink::mojom::WebPreferences::DataView input, ::blink::mojom::WebPreferencesPtr* output);
};

}  // namespace mojo

#endif  // THIRD_PARTY_BLINK_PUBLIC_MOJOM_WEBPREFERENCES_WEB_PREFERENCES_MOJOM_H_