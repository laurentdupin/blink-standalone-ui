...
NOINLINE static const char* PermissionNameToStringHelper(PermissionName value) {
  ...
  switch(value) {
    ...
    case PermissionName::GEOLOCATION_APPROXIMATE:
      return "GEOLOCATION_APPROXIMATE";
    default:
      return nullptr;
  }
}
...
// static
bool EmbeddedPermissionControlDescriptorExtension_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context,
    bool inlined) {
  if (!data) {
  ...
  const EmbeddedPermissionControlDescriptorExtension_Data* object = static_cast<const EmbeddedPermissionControlDescriptorExtension_Data*>(data);
  ...
  switch (object->tag) {
    ...
    case EmbeddedPermissionControlDescriptorExtension_Tag::kGeolocation: {

      if (!mojo::internal::ValidatePointerNonNullable(
              object->data.f_geolocation, 1, validation_context)) {
        return false;
      }
      if (!mojo::internal::ValidateStruct(object->data.f_geolocation, validation_context))
        return false;
      return true;
    }
    case EmbeddedPermissionControlDescriptorExtension_Tag::kInstall: {

      if (!mojo::internal::ValidatePointerNonNullable(
              object->data.f_install, 2, validation_context)) {
        return false;
      }
      if (!mojo::internal::ValidateStruct(object->data.f_install, validation_context))
        return false;
      return true;
    }
    case EmbeddedPermissionControlDescriptorExtension_Tag::kUserMedia: {

      if (!mojo::internal::ValidatePointerNonNullable(
              object->data.f_user_media, 3, validation_context)) {
        return false;
      }
      if (!mojo::internal::ValidateStruct(object->data.f_user_media, validation_context))
        return false;
      return true;
    }
    default: {
      ...
      ReportValidationError(
          validation_context,
          mojo::internal::VALIDATION_ERROR_UNKNOWN_UNION_TAG,
          "unknown tag in EmbeddedPermissionControlDescriptorExtension");
      return false;
    }
  }
}
...
// static
bool GeolocationEmbeddedPermissionRequestDescriptor_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const GeolocationEmbeddedPermissionRequestDescriptor_Data* object =
      static_cast<const GeolocationEmbeddedPermissionRequestDescriptor_Data*>(data);

  return true;
}

GeolocationEmbeddedPermissionRequestDescriptor_Data::GeolocationEmbeddedPermissionRequestDescriptor_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool InstallEmbeddedPermissionRequestDescriptor_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const InstallEmbeddedPermissionRequestDescriptor_Data* object =
      static_cast<const InstallEmbeddedPermissionRequestDescriptor_Data*>(data);

  return true;
}

InstallEmbeddedPermissionRequestDescriptor_Data::InstallEmbeddedPermissionRequestDescriptor_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool UserMediaEmbeddedPermissionRequestDescriptor_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const UserMediaEmbeddedPermissionRequestDescriptor_Data* object =
      static_cast<const UserMediaEmbeddedPermissionRequestDescriptor_Data*>(data);

  return true;
}

UserMediaEmbeddedPermissionRequestDescriptor_Data::UserMediaEmbeddedPermissionRequestDescriptor_Data()
    : header_({sizeof(*this), 0}) {}
...
bool EmbeddedPermissionRequestDescriptor_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->element_position, 1, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidateInlinedUnionNonNullable(
          object->detail, 2, validation_context)) {
    return false;
  }
...
bool PermissionService_AddPermissionObserver_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->last_known_status, 2, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateStruct(object->last_known_status, validation_context))
    return false;
