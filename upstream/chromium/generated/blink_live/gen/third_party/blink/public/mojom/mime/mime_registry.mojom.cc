// third_party/blink/public/mojom/mime/mime_registry.mojom.cc is auto generated by mojom_bindings_generator.py, do not edit
...
bool MimeRegistryProxy::GetMimeTypeFromExtension(
  ...
  mojo::Message message(
      std::to_underlying(messages::MimeRegistry::kGetMimeTypeFromExtension), kFlags, estimated_payload_size);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_END1(
    "mojom", "Call blink::mojom::MimeRegistry::GetMimeTypeFromExtension (sync)", "sync_response_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
...
bool MimeRegistryRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::MimeRegistry::Name_,
...
std::string MimeRegistryAsyncWaiter::GetMimeTypeFromExtension(
