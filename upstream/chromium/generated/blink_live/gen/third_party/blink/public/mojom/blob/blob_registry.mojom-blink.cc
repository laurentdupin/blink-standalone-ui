...
bool ProgressClientRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::blink::ProgressClient::Name_,
...
# endif // !BUILDFLAG(IS_FUCHSIA)
bool BlobRegistry::Register(::mojo::PendingReceiver<::blink::mojom::blink::Blob> blob, const ::blink::String& uuid, const ::blink::String& content_type, const ::blink::String& content_disposition, ::blink::Vector<::blink::mojom::blink::DataElementPtr> elements) {
  NOTREACHED();
}
...
bool BlobRegistryProxy::Register(
    ::mojo::PendingReceiver<::blink::mojom::blink::Blob> param_blob, const ::blink::String& param_uuid, const ::blink::String& param_content_type, const ::blink::String& param_content_disposition, ::blink::Vector<::blink::mojom::blink::DataElementPtr> param_elements) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_BEGIN1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("elements"), param_elements,
                        "<value of type ::blink::Vector<::blink::mojom::blink::DataElementPtr>>");
   });
#else
...
void BlobRegistryProxy::Register(
    ::mojo::PendingReceiver<::blink::mojom::blink::Blob> in_blob, const ::blink::String& in_uuid, const ::blink::String& in_content_type, const ::blink::String& in_content_disposition, ::blink::Vector<::blink::mojom::blink::DataElementPtr> in_elements, RegisterCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void BlobRegistryProxy::RegisterFromStream(
    const ::blink::String& in_content_type, const ::blink::String& in_content_disposition, uint64_t in_length_hint, ::mojo::ScopedDataPipeConsumerHandle in_data, ::mojo::PendingAssociatedRemote<ProgressClient> in_progress_client, RegisterFromStreamCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
class BlobRegistry_RegisterFromStream_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      ::blink::mojom::blink::SerializedBlobPtr in_blob);
};
...
bool BlobRegistry_RegisterFromStream_ForwardToCallback::Accept(
  ...
  bool success = true;
  ::blink::mojom::blink::SerializedBlobPtr p_blob{};
...
void BlobRegistry_RegisterFromStream_ProxyToResponder::Run(
  ...
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("blob"), in_blob,
                        "<value of type ::blink::mojom::blink::SerializedBlobPtr>");
   });
#endif
...
bool BlobRegistryStubDispatch::AcceptWithResponder(
  ...
  switch (static_cast<messages::BlobRegistry>(message->header()->name)) {
    case messages::BlobRegistry::kRegister: {
      ...
      ::blink::String p_uuid{};
      ::blink::String p_content_type{};
      ::blink::String p_content_disposition{};
      ::blink::Vector<::blink::mojom::blink::DataElementPtr> p_elements{};
...
bool BlobRegistryRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::blink::BlobRegistry::Name_,
...
void BlobRegistryInterceptorForTesting::Register(::mojo::PendingReceiver<::blink::mojom::blink::Blob> blob, const ::blink::String& uuid, const ::blink::String& content_type, const ::blink::String& content_disposition, ::blink::Vector<::blink::mojom::blink::DataElementPtr> elements, RegisterCallback callback) {
...
void BlobRegistryInterceptorForTesting::RegisterFromStream(const ::blink::String& content_type, const ::blink::String& content_disposition, uint64_t length_hint, ::mojo::ScopedDataPipeConsumerHandle data, ::mojo::PendingAssociatedRemote<ProgressClient> progress_client, RegisterFromStreamCallback callback) {
...
void BlobRegistryAsyncWaiter::RegisterFromStream(
  ...
  proxy_->RegisterFromStream(
      ...
      base::BindOnce(
          [](base::RunLoop* loop,
             ::blink::mojom::blink::SerializedBlobPtr* out_blob
,
             ::blink::mojom::blink::SerializedBlobPtr blob) {*out_blob = std::move(blob);
            loop->Quit();
          },
          &loop,
          out_blob));
...
::blink::mojom::blink::SerializedBlobPtr BlobRegistryAsyncWaiter::RegisterFromStream(
    const ::blink::String& content_type, const ::blink::String& content_disposition, uint64_t length_hint, ::mojo::ScopedDataPipeConsumerHandle data, ::mojo::PendingAssociatedRemote<ProgressClient> progress_client) {
  ::blink::mojom::blink::SerializedBlobPtr async_wait_result;
