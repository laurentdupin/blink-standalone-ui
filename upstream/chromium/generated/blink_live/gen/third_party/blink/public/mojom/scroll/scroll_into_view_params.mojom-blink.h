...
class BLINK_PLATFORM_EXPORT ScrollAlignment {
 public:
  template <typename T>
...
class BLINK_PLATFORM_EXPORT FocusedEditableParams {
 public:
  template <typename T>
...
class BLINK_PLATFORM_EXPORT ScrollIntoViewParams {
 public:
  template <typename T>
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::blink::ScrollAlignment::DataView,
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::blink::FocusedEditableParams::DataView,
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::blink::ScrollIntoViewParams::DataView,
