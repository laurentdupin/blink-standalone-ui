...
using ScriptToEvaluateOnNewDocumentPtr = mojo::InlinedStructPtr<ScriptToEvaluateOnNewDocument>;

class BrowserOriginatingSessionState;
using BrowserOriginatingSessionStatePtr = mojo::StructPtr<BrowserOriginatingSessionState>;

class RendererOriginatingSessionState;
using RendererOriginatingSessionStatePtr = mojo::StructPtr<RendererOriginatingSessionState>;
