...
void DevToolsFrontendProxy::SetupDevToolsFrontend(
  ...
  mojo::Message message(
      std::to_underlying(messages::DevToolsFrontend::kSetupDevToolsFrontend), kFlags, estimated_payload_size);
...
void DevToolsFrontendProxy::SetupDevToolsExtensionAPI(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DevToolsFrontend::kSetupDevToolsExtensionAPI), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool DevToolsFrontendRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::DevToolsFrontend::Name_,
...
void DevToolsFrontendHostProxy::DispatchEmbedderMessage(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DevToolsFrontendHost::kDispatchEmbedderMessage), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool DevToolsFrontendHostRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::DevToolsFrontendHost::Name_,
...
void DevToolsFrontendHostInterceptorForTesting::DispatchEmbedderMessage(::base::DictValue message) {
