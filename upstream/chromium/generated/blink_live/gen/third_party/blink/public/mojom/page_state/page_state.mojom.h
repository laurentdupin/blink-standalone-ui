...
class  DEPRECATED_FileSystemFile {
 public:
  ...
  DEPRECATED_FileSystemFile(
      ::url::mojom::UrlPtr filesystem_url,
      uint64_t offset,
      uint64_t length,
      ::mojo_base::mojom::TimePtr modification_time);
...
class  File {
 public:
  ...
  File(
      ::mojo_base::mojom::String16Ptr path,
      uint64_t offset,
      uint64_t length,
      ::mojo_base::mojom::TimePtr modification_time);
...
class  HttpBody {
 public:
  ...
  HttpBody(
      ::mojo_base::mojom::String16Ptr http_content_type,
...
class  ViewState {
 public:
  ...
  ViewState(
      ::gfx::mojom::PointFPtr visual_viewport_scroll_offset,
      ::gfx::mojom::PointPtr scroll_offset,
  ...
  ViewState(
      ...
      ::gfx::mojom::PointPtr scroll_offset,
      double page_scale_factor,
      ::mojo_base::mojom::String16Ptr scroll_anchor_selector,
      ::gfx::mojom::PointFPtr scroll_anchor_offset,
...
class  FrameState {
 public:
  ...
  FrameState(
      ::mojo_base::mojom::String16Ptr url_string,
      ::mojo_base::mojom::String16Ptr referrer,
      ::mojo_base::mojom::String16Ptr target,
      ::mojo_base::mojom::String16Ptr state_object,
      std::vector<::mojo_base::mojom::String16Ptr> document_state,
  ...
  FrameState(
      ...
      std::vector<FrameStatePtr> children,
      const std::optional<std::string>& initiator_origin,
      ::mojo_base::mojom::String16Ptr navigation_api_key,
      ::mojo_base::mojom::String16Ptr navigation_api_id);
  ...
  FrameState(
      ...
      ::mojo_base::mojom::String16Ptr navigation_api_key,
      ::mojo_base::mojom::String16Ptr navigation_api_id,
      ::mojo_base::mojom::String16Ptr navigation_api_state);
  ...
  FrameState(
      ...
      ::mojo_base::mojom::String16Ptr navigation_api_state,
      bool protect_url_in_navigation_api,
      ::mojo_base::mojom::String16Ptr initiator_base_url_string);
...
class  PageState {
 public:
  ...
  PageState(
      std::vector<::mojo_base::mojom::String16Ptr> referenced_files,
      FrameStatePtr top);
...
template <>
struct  StructTraits<::blink::mojom::DEPRECATED_FileSystemFile::DataView,
...
template <>
struct  StructTraits<::blink::mojom::File::DataView,
                                         ::blink::mojom::FilePtr> {
...
template <>
struct  StructTraits<::blink::mojom::RequestBody::DataView,
...
template <>
struct  StructTraits<::blink::mojom::HttpBody::DataView,
...
template <>
struct  StructTraits<::blink::mojom::ViewState::DataView,
...
template <>
struct  StructTraits<::blink::mojom::FrameState::DataView,
...
template <>
struct  StructTraits<::blink::mojom::PageState::DataView,
...
template <>
struct  UnionTraits<::blink::mojom::Element::DataView,
