...
BlockingDetails::BlockingDetails(
    ::blink::mojom::blink::WebSchedulerTrackedFeature feature_in,
    ::blink::mojom::blink::ScriptSourceLocationPtr source_in)
...
void BlockingDetails::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      ...
      "<value of type ::blink::mojom::blink::WebSchedulerTrackedFeature>"
#else
      "<value>"
...
void BackForwardCacheControllerHostProxy::EvictFromBackForwardCache(
  ...
  mojo::Message message(
      std::to_underlying(messages::BackForwardCacheControllerHost::kEvictFromBackForwardCache), kFlags, estimated_payload_size);
...
void BackForwardCacheControllerHostProxy::DidChangeBackForwardCacheDisablingFeatures(
    ::blink::Vector<BlockingDetailsPtr> in_details) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("details"), in_details,
                        "<value of type ::blink::Vector<BlockingDetailsPtr>>");
   });
#endif
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::BackForwardCacheControllerHost::kDidChangeBackForwardCacheDisablingFeatures), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool BackForwardCacheControllerHostStubDispatch::Accept(
  ...
  switch (static_cast<messages::BackForwardCacheControllerHost>(message->header()->name)) {
    ...
    case messages::BackForwardCacheControllerHost::kDidChangeBackForwardCacheDisablingFeatures: {
      ...
      bool success = true;
      ::blink::Vector<BlockingDetailsPtr> p_details{};
...
bool BackForwardCacheControllerHostRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::blink::BackForwardCacheControllerHost::Name_,
...
bool StructTraits<::blink::mojom::blink::BlockingDetails::DataView, ::blink::mojom::blink::BlockingDetailsPtr>::Read(
    ::blink::mojom::blink::BlockingDetails::DataView input,
    ::blink::mojom::blink::BlockingDetailsPtr* output) {
  bool success = true;
...
void BackForwardCacheControllerHostInterceptorForTesting::EvictFromBackForwardCache(::blink::mojom::blink::RendererEvictionReason reason, ::blink::mojom::blink::ScriptSourceLocationPtr source) {
...
void BackForwardCacheControllerHostInterceptorForTesting::DidChangeBackForwardCacheDisablingFeatures(::blink::Vector<BlockingDetailsPtr> details) {
