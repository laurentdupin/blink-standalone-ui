// third_party/blink/public/mojom/data_transfer/data_transfer.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef THIRD_PARTY_BLINK_PUBLIC_MOJOM_DATA_TRANSFER_DATA_TRANSFER_MOJOM_BLINK_H_
#define THIRD_PARTY_BLINK_PUBLIC_MOJOM_DATA_TRANSFER_DATA_TRANSFER_MOJOM_BLINK_H_
...
#include "third_party/blink/public/mojom/data_transfer/data_transfer.mojom-blink-forward.h"  // IWYU pragma: export
...
class BLINK_PLATFORM_EXPORT DataTransferFile {
 public:
  template <typename T>
  ...
  DataTransferFile(
      ...
      ::mojo_base::mojom::blink::FilePathPtr display_name,
      ::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessDataTransferToken> file_system_access_token);
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::blink::DataTransferFile::DataView,
                                         ::blink::mojom::blink::DataTransferFilePtr> {
  static bool IsNull(const ::blink::mojom::blink::DataTransferFilePtr& input) { return !input; }
  static void SetToNull(::blink::mojom::blink::DataTransferFilePtr* output) { output->reset(); }

  static const decltype(::blink::mojom::blink::DataTransferFile::path)& path(
      const ::blink::mojom::blink::DataTransferFilePtr& input) {
    return input->path;
  }

  static const decltype(::blink::mojom::blink::DataTransferFile::display_name)& display_name(
      const ::blink::mojom::blink::DataTransferFilePtr& input) {
    return input->display_name;
  }

  static  decltype(::blink::mojom::blink::DataTransferFile::file_system_access_token)& file_system_access_token(
       ::blink::mojom::blink::DataTransferFilePtr& input) {
    return input->file_system_access_token;
  }

  static bool Read(::blink::mojom::blink::DataTransferFile::DataView input, ::blink::mojom::blink::DataTransferFilePtr* output);
};

}  // namespace mojo

#endif  // THIRD_PARTY_BLINK_PUBLIC_MOJOM_DATA_TRANSFER_DATA_TRANSFER_MOJOM_BLINK_H_