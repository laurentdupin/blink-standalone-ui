// third_party/blink/public/mojom/messaging/message_port_descriptor.mojom-shared.cc is auto generated by mojom_bindings_generator.py, do not edit
...
bool MessagePortDescriptor_Data::Validate(
  ...
  [[maybe_unused]] const MessagePortDescriptor_Data* object =
      static_cast<const MessagePortDescriptor_Data*>(data);

  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->pipe_handle, 1, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateHandleOrInterface(object->pipe_handle,
                                                 validation_context)) {
    return false;
  }
