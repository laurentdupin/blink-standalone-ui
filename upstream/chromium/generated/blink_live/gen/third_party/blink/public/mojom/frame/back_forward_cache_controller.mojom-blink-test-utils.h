...
class  BackForwardCacheControllerHostInterceptorForTesting : public BackForwardCacheControllerHost {
  ...
  void DidChangeBackForwardCacheDisablingFeatures(::blink::Vector<BlockingDetailsPtr> details) override;
};
class  BackForwardCacheControllerHostAsyncWaiter {
 public:
