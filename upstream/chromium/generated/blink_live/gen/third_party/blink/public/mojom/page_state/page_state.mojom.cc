...
DEPRECATED_FileSystemFile::DEPRECATED_FileSystemFile(
    ::url::mojom::UrlPtr filesystem_url_in,
    uint64_t offset_in,
    uint64_t length_in,
    ::mojo_base::mojom::TimePtr modification_time_in)
...
size_t DEPRECATED_FileSystemFile::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->filesystem_url);
  seed = mojo::internal::Hash(seed, this->offset);
  seed = mojo::internal::Hash(seed, this->length);
  seed = mojo::internal::Hash(seed, this->modification_time);
  return seed;
}
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::mojo_base::mojom::TimePtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
File::File(
    ::mojo_base::mojom::String16Ptr path_in,
    uint64_t offset_in,
    uint64_t length_in,
    ::mojo_base::mojom::TimePtr modification_time_in)
...
HttpBody::HttpBody(
    ::mojo_base::mojom::String16Ptr http_content_type_in,
...
ViewState::ViewState(
    ::gfx::mojom::PointFPtr visual_viewport_scroll_offset_in,
    ::gfx::mojom::PointPtr scroll_offset_in,
...
ViewState::ViewState(
    ...
    ::gfx::mojom::PointPtr scroll_offset_in,
    double page_scale_factor_in,
    ::mojo_base::mojom::String16Ptr scroll_anchor_selector_in,
    ::gfx::mojom::PointFPtr scroll_anchor_offset_in,
...
FrameState::FrameState(
    ::mojo_base::mojom::String16Ptr url_string_in,
    ::mojo_base::mojom::String16Ptr referrer_in,
    ::mojo_base::mojom::String16Ptr target_in,
    ::mojo_base::mojom::String16Ptr state_object_in,
    std::vector<::mojo_base::mojom::String16Ptr> document_state_in,
...
FrameState::FrameState(
    ...
    std::vector<FrameStatePtr> children_in,
    const std::optional<std::string>& initiator_origin_in,
    ::mojo_base::mojom::String16Ptr navigation_api_key_in,
    ::mojo_base::mojom::String16Ptr navigation_api_id_in)
    : url_string(std::move(url_string_in)),
      referrer(std::move(referrer_in)),
      target(std::move(target_in)),
      state_object(std::move(state_object_in)),
...
FrameState::FrameState(
    ...
    ::mojo_base::mojom::String16Ptr navigation_api_key_in,
    ::mojo_base::mojom::String16Ptr navigation_api_id_in,
    ::mojo_base::mojom::String16Ptr navigation_api_state_in)
    : url_string(std::move(url_string_in)),
      referrer(std::move(referrer_in)),
      target(std::move(target_in)),
      state_object(std::move(state_object_in)),
...
FrameState::FrameState(
    ...
    ::mojo_base::mojom::String16Ptr navigation_api_state_in,
    bool protect_url_in_navigation_api_in,
    ::mojo_base::mojom::String16Ptr initiator_base_url_string_in)
    : url_string(std::move(url_string_in)),
      referrer(std::move(referrer_in)),
      target(std::move(target_in)),
      state_object(std::move(state_object_in)),
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<::mojo_base::mojom::String16Ptr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
PageState::PageState(
    std::vector<::mojo_base::mojom::String16Ptr> referenced_files_in,
...
void Element::set_blob_uuid(const std::string& blob_uuid) {
  if (tag_ == Tag::kBlobUuid) {
    ...
    DestroyActive();
    tag_ = Tag::kBlobUuid;
    new (&data_.blob_uuid) std::string(
        std::move(blob_uuid));
  }
}
