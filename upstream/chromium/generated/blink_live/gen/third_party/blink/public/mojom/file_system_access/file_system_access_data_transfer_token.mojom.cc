...
void FileSystemAccessDataTransferTokenProxy::GetInternalId(
  ...
  mojo::Message message(
      std::to_underlying(messages::FileSystemAccessDataTransferToken::kGetInternalId), kFlags, estimated_payload_size);
...
void FileSystemAccessDataTransferTokenProxy::Clone(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FileSystemAccessDataTransferToken::kClone), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool FileSystemAccessDataTransferTokenRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::FileSystemAccessDataTransferToken::Name_,
