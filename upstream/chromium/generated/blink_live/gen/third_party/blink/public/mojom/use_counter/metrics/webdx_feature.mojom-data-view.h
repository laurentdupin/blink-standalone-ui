// third_party/blink/public/mojom/use_counter/metrics/webdx_feature.mojom-data-view.h is auto generated by mojom_bindings_generator.py, do not edit
...
#ifndef THIRD_PARTY_BLINK_PUBLIC_MOJOM_USE_COUNTER_METRICS_WEBDX_FEATURE_MOJOM_DATA_VIEW_H_
#define THIRD_PARTY_BLINK_PUBLIC_MOJOM_USE_COUNTER_METRICS_WEBDX_FEATURE_MOJOM_DATA_VIEW_H_
...
enum class WebDXFeature : int32_t {
  ...
  kCanvas_2dColorManagement = 203,
  
  kCanvas_2dDesynchronized = 204,
  
  kCanvas_2dWillreadfrequently = 205,
...
inline bool IsKnownEnumValue(WebDXFeature value) {
  return internal::WebDXFeature_Data::IsKnownValue(
      static_cast<int32_t>(value));
}

// Returns true if the enum has an infallible conversion from the mojom enum.
consteval bool HasInfallibleConversion(WebDXFeature) {
  return true;
}
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_MOJOM_USE_COUNTER_METRICS_WEBDX_FEATURE_MOJOM_DATA_VIEW_H_