...
class BLINK_PLATFORM_EXPORT RendererPreferences {
 public:
  template <typename T>
  ...
  RendererPreferences(
      ...
      ::blink::Vector<::blink::mojom::blink::WebRtcIpHandlingUrlEntryPtr> webrtc_ip_handling_urls,
      ...
      const ::blink::String& caption_font_family_name,
      int32_t caption_font_height,
      const ::blink::String& small_caption_font_family_name,
      int32_t small_caption_font_height,
      const ::blink::String& menu_font_family_name,
      int32_t menu_font_height,
      const ::blink::String& status_font_family_name,
      int32_t status_font_height,
      const ::blink::String& message_font_family_name,
...
RendererPreferences& operator=(const RendererPreferences&) = delete;
  ...
  ::blink::String caption_font_family_name;
  
  int32_t caption_font_height;
  
  ::blink::String small_caption_font_family_name;
  
  int32_t small_caption_font_height;
  
  ::blink::String menu_font_family_name;
  
  int32_t menu_font_height;
  
  ::blink::String status_font_family_name;
  
  int32_t status_font_height;
  
  ::blink::String message_font_family_name;
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::blink::RendererPreferences::DataView,
  ...
  static decltype(::blink::mojom::blink::RendererPreferences::text_contrast) text_contrast(
      const ::blink::mojom::blink::RendererPreferencesPtr& input) {
    return input->text_contrast;
  }

  static decltype(::blink::mojom::blink::RendererPreferences::text_gamma) text_gamma(
      const ::blink::mojom::blink::RendererPreferencesPtr& input) {
  ...
  static decltype(::blink::mojom::blink::RendererPreferences::menu_font_height) menu_font_height(
      const ::blink::mojom::blink::RendererPreferencesPtr& input) {
