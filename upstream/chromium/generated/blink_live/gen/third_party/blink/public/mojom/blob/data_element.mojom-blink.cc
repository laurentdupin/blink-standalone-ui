...
DataElementBytes::DataElementBytes(
    uint64_t length_in,
    std::optional<::blink::Vector<uint8_t>> embedded_data_in,
...
void BytesProviderProxy::RequestAsReply(
  ...
  mojo::Message message(
      std::to_underlying(messages::BytesProvider::kRequestAsReply), kFlags, estimated_payload_size);
...
void BytesProviderProxy::RequestAsStream(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::BytesProvider::kRequestAsStream), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void BytesProviderProxy::RequestAsFile(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::BytesProvider::kRequestAsFile), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool BytesProviderRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::blink::BytesProvider::Name_,
  ...
  proxy_->RequestAsReply(
      base::BindOnce(
          [](base::RunLoop* loop,
             ::blink::Vector<uint8_t>* out_data
,
             const ::blink::Vector<uint8_t>& data) {*out_data = std::move(data);
            loop->Quit();
          },
          &loop,
          out_data));
...
::blink::Vector<uint8_t> BytesProviderAsyncWaiter::RequestAsReply(
    ) {
