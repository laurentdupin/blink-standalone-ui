...
bool RendererPreferences_Data::Validate(
  ...
  if (!::blink::mojom::internal::WebRtcIpHandlingPolicy_Data
        ::Validate(object->webrtc_ip_handling_policy, validation_context))
    return false;

  if (!mojo::internal::ValidatePointerNonNullable(
          object->webrtc_ip_handling_urls, 23, validation_context)) {
    return false;
  }
  constexpr const mojo::internal::ContainerValidateParams& webrtc_ip_handling_urls_validate_params =
      mojo::internal::GetArrayValidator<0, false, nullptr>();
  if (!mojo::internal::ValidateContainer(object->webrtc_ip_handling_urls, validation_context,
                                         &webrtc_ip_handling_urls_validate_params)) {
    return false;
  }

  if (!mojo::internal::ValidatePointerNonNullable(
          object->webrtc_local_ips_allowed_urls, 28, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->user_agent_override, 29, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->accept_languages, 30, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->caption_font_family_name, 34, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->small_caption_font_family_name, 36, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->menu_font_family_name, 38, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->status_font_family_name, 40, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->message_font_family_name, 42, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->explicitly_allowed_network_ports, 44, validation_context)) {
    return false;
  }
