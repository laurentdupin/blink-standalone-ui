...
RedirectInfo::RedirectInfo(
    ::url::mojom::OriginPtr origin_of_new_url_in,
...
ResourceLoadInfo::ResourceLoadInfo(
    ...
    ::url::mojom::UrlPtr final_url_in,
    ::url::mojom::UrlPtr referrer_in,
    ::url::mojom::UrlPtr original_url_in,
    const std::string& method_in,
    ::network::mojom::RequestDestination request_destination_in,
    ::network::mojom::RequestPriority request_priority_in,
    const std::string& mime_type_in,
    bool was_cached_in,
    CommonNetworkInfoPtr network_info_in,
    int32_t net_error_in,
    ::network::mojom::ProxyChainPtr proxy_chain_in,
    ::network::mojom::LoadTimingInfoPtr load_timing_info_in,
    ::mojo_base::mojom::ByteCountPtr raw_body_bytes_in,
    ::mojo_base::mojom::ByteCountPtr total_received_bytes_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::network::mojom::ProxyChainPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::mojo_base::mojom::ByteCountPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
bool StructTraits<::blink::mojom::ResourceLoadInfo::DataView, ::blink::mojom::ResourceLoadInfoPtr>::Read(
  ...
  ::blink::mojom::ResourceLoadInfoPtr result(::blink::mojom::ResourceLoadInfo::New());
      ...
      if (success && !input.ReadLoadTimingInfo(&result->load_timing_info))
        success = false;
      if (success && !input.ReadRawBodyBytes(&result->raw_body_bytes))
        success = false;
      if (success && !input.ReadTotalReceivedBytes(&result->total_received_bytes))
        success = false;
