...
// static
bool TextFragmentReceiver_RequestSelectorForViewportCenter_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const TextFragmentReceiver_RequestSelectorForViewportCenter_Params_Data* object =
      static_cast<const TextFragmentReceiver_RequestSelectorForViewportCenter_Params_Data*>(data);

  return true;
}

TextFragmentReceiver_RequestSelectorForViewportCenter_Params_Data::TextFragmentReceiver_RequestSelectorForViewportCenter_Params_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool TextFragmentReceiver_RequestSelectorForViewportCenter_ResponseParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const TextFragmentReceiver_RequestSelectorForViewportCenter_ResponseParams_Data* object =
      static_cast<const TextFragmentReceiver_RequestSelectorForViewportCenter_ResponseParams_Data*>(data);
...
TextFragmentReceiver_RequestSelectorForViewportCenter_ResponseParams_Data::TextFragmentReceiver_RequestSelectorForViewportCenter_ResponseParams_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool TextFragmentReceiver_RequestSelectorForSelection_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const TextFragmentReceiver_RequestSelectorForSelection_Params_Data* object =
      static_cast<const TextFragmentReceiver_RequestSelectorForSelection_Params_Data*>(data);

  return true;
}

TextFragmentReceiver_RequestSelectorForSelection_Params_Data::TextFragmentReceiver_RequestSelectorForSelection_Params_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool TextFragmentReceiver_RequestSelectorForSelection_ResponseParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const TextFragmentReceiver_RequestSelectorForSelection_ResponseParams_Data* object =
      static_cast<const TextFragmentReceiver_RequestSelectorForSelection_ResponseParams_Data*>(data);
...
TextFragmentReceiver_RequestSelectorForSelection_ResponseParams_Data::TextFragmentReceiver_RequestSelectorForSelection_ResponseParams_Data()
    : header_({sizeof(*this), 0}) {}
