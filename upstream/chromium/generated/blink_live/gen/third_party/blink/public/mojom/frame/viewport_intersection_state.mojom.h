...
template <>
struct  StructTraits<::blink::mojom::ViewportIntersectionState::DataView,
  ...
  static decltype(::blink::mojom::ViewportIntersectionState::is_hidden_for_media_playback) is_hidden_for_media_playback(
      const ::blink::mojom::ViewportIntersectionStatePtr& input) {
