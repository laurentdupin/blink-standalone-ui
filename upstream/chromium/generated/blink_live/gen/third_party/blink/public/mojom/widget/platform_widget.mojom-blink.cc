...
InitialFrameSinkParams::InitialFrameSinkParams(
    ::mojo::PendingRemote<::viz::mojom::blink::CompositorFrameSink> initial_frame_sink_in,
    ::mojo::PendingReceiver<::viz::mojom::blink::CompositorFrameSinkClient> initial_frame_sink_client_in,
...
void InitialFrameSinkParams::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      ...
      "<value of type ::mojo::PendingRemote<::viz::mojom::blink::CompositorFrameSink>>"
#else
      "<value>"
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::mojo::PendingReceiver<::viz::mojom::blink::CompositorFrameSinkClient>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
void WidgetHostProxy::SetCursor(
    ::ui::mojom::blink::CursorPtr in_cursor) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("cursor"), in_cursor,
                        "<value of type ::ui::mojom::blink::CursorPtr>");
   });
#endif
...
void WidgetHostProxy::UpdateTooltipUnderCursor(
    ::mojo_base::mojom::blink::String16Ptr in_tooltip_text, ::mojo_base::mojom::blink::TextDirection in_text_direction_hint) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("tooltip_text"), in_tooltip_text,
                        "<value of type ::mojo_base::mojom::blink::String16Ptr>");
      perfetto::WriteIntoTracedValueWithFallback(
...
void WidgetHostProxy::UpdateTooltipFromKeyboard(
    ::mojo_base::mojom::blink::String16Ptr in_tooltip_text, ::mojo_base::mojom::blink::TextDirection in_text_direction_hint, const ::gfx::Rect& in_bounds) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void WidgetHostProxy::SelectionBoundsChanged(
    const ::gfx::Rect& in_anchor_rect, ::mojo_base::mojom::blink::TextDirection in_anchor_dir, const ::gfx::Rect& in_focus_rect, ::mojo_base::mojom::blink::TextDirection in_focus_dir, const ::gfx::Rect& in_bounding_box_rect, bool in_is_anchor_first) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool WidgetHostStubDispatch::Accept(
  ...
  switch (static_cast<messages::WidgetHost>(message->header()->name)) {
    case messages::WidgetHost::kSetCursor: {
      ...
      bool success = true;
      ::ui::mojom::blink::CursorPtr p_cursor{};
    ...
    case messages::WidgetHost::kUpdateTooltipUnderCursor: {
      ...
      bool success = true;
      ::mojo_base::mojom::blink::String16Ptr p_tooltip_text{};
      ::mojo_base::mojom::blink::TextDirection p_text_direction_hint{};
    ...
    case messages::WidgetHost::kSelectionBoundsChanged: {
      ...
      ::mojo_base::mojom::blink::TextDirection p_anchor_dir{};
      ::gfx::Rect p_focus_rect{};
      ::mojo_base::mojom::blink::TextDirection p_focus_dir{};
...
void WidgetProxy::UpdateVisualProperties(
    ::blink::mojom::blink::VisualPropertiesPtr in_visual_properties) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
// static
bool StructTraits<::blink::mojom::blink::InitialFrameSinkParams::DataView, ::blink::mojom::blink::InitialFrameSinkParamsPtr>::Read(
    ::blink::mojom::blink::InitialFrameSinkParams::DataView input,
    ::blink::mojom::blink::InitialFrameSinkParamsPtr* output) {
  bool success = true;
  ::blink::mojom::blink::InitialFrameSinkParamsPtr result(::blink::mojom::blink::InitialFrameSinkParams::New());
...
void WidgetHostInterceptorForTesting::SetCursor(::ui::mojom::blink::CursorPtr cursor) {
  GetForwardingInterface()->SetCursor(
    std::move(cursor)
    );
}
void WidgetHostInterceptorForTesting::UpdateTooltipUnderCursor(::mojo_base::mojom::blink::String16Ptr tooltip_text, ::mojo_base::mojom::blink::TextDirection text_direction_hint) {
...
void WidgetHostInterceptorForTesting::UpdateTooltipFromKeyboard(::mojo_base::mojom::blink::String16Ptr tooltip_text, ::mojo_base::mojom::blink::TextDirection text_direction_hint, const ::gfx::Rect& bounds) {
...
void WidgetHostInterceptorForTesting::SelectionBoundsChanged(const ::gfx::Rect& anchor_rect, ::mojo_base::mojom::blink::TextDirection anchor_dir, const ::gfx::Rect& focus_rect, ::mojo_base::mojom::blink::TextDirection focus_dir, const ::gfx::Rect& bounding_box_rect, bool is_anchor_first) {
...
void WidgetInterceptorForTesting::UpdateVisualProperties(::blink::mojom::blink::VisualPropertiesPtr visual_properties) {
