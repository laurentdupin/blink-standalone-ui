...
StylusWritingGestureData::StylusWritingGestureData(
    ...
    const ::blink::String& text_alternative_in,
    const ::blink::String& text_to_insert_in,
    bool is_preview_in)
...
bool StructTraits<::blink::mojom::blink::StylusWritingGestureData::DataView, ::blink::mojom::blink::StylusWritingGestureDataPtr>::Read(
    ::blink::mojom::blink::StylusWritingGestureData::DataView input,
    ::blink::mojom::blink::StylusWritingGestureDataPtr* output) {
  bool success = true;
