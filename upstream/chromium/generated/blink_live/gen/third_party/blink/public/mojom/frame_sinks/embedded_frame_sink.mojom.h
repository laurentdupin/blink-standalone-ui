...
#include "third_party/blink/public/mojom/frame_sinks/embedded_frame_sink.mojom-import-headers.h"  // IWYU pragma: export
...
class SurfaceEmbedder
 ...
 public:
  ...
  static constexpr const char* Name_ = "blink.mojom.SurfaceEmbedder";
...
class EmbeddedFrameSinkClient
 ...
 public:
  using IPCStableHashFunction = uint32_t(*)();
  static constexpr const char* Name_ = "blink.mojom.EmbeddedFrameSinkClient";
  static IPCStableHashFunction MessageToMethodInfo_(mojo::Message& message);
  static const char* MessageToMethodName_(mojo::Message& message);
  static constexpr uint32_t Version_ = 0;
  static constexpr bool PassesAssociatedKinds_ = false;
...
class EmbeddedFrameSinkProvider
 ...
 public:
  using IPCStableHashFunction = uint32_t(*)();
  static constexpr const char* Name_ = "blink.mojom.EmbeddedFrameSinkProvider";
  static IPCStableHashFunction MessageToMethodInfo_(mojo::Message& message);
  static const char* MessageToMethodName_(mojo::Message& message);
  static constexpr uint32_t Version_ = 0;
  static constexpr bool PassesAssociatedKinds_ = false;
  ...
  enum MethodMinVersions : uint32_t {
    ...
    kSetParentFrameSinkIdMinVersion = 0,
...
// with not having this data in traces there.
  ...
  struct SetParentFrameSinkId_Sym {
    NOINLINE static uint32_t IPCStableHash();
  };
  ...
  virtual void SetParentFrameSinkId(const ::viz::FrameSinkId& frame_sink_id, const ::viz::FrameSinkId& parent_frame_sink_id) = 0;
...
class  EmbeddedFrameSinkProviderProxy
 ...
 public:
  ...
  void SetParentFrameSinkId(const ::viz::FrameSinkId& frame_sink_id, const ::viz::FrameSinkId& parent_frame_sink_id) final;
...
class  SurfaceEmbedderStubDispatch {
 public:
...
class  EmbeddedFrameSinkClientStubDispatch {
 public:
...
class  EmbeddedFrameSinkProviderStubDispatch {
 public:
...
class  SurfaceEmbedderRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class  EmbeddedFrameSinkClientRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class  EmbeddedFrameSinkProviderRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
