...
#include "third_party/blink/public/mojom/forms/form_control_type.mojom-data-view.h"  // IWYU pragma: export
...
struct Serializer<::blink::mojom::FormControlType, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::blink::mojom::FormControlType>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::blink::mojom::FormControlType, UserType> ||
                        HasInfallibleConversion(::blink::mojom::FormControlType()),
                    "::blink::mojom::FormControlType does not have an infallible conversion, "
...
template <>
struct  TraceFormatTraits<::blink::mojom::FormControlType> {
