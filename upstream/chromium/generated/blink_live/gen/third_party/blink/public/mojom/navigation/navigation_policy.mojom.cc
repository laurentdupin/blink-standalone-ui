...
size_t NavigationDownloadTypes::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->view_source);
  seed = mojo::internal::Hash(seed, this->interstitial);
  seed = mojo::internal::Hash(seed, this->opener_cross_origin);
  seed = mojo::internal::Hash(seed, this->ad_frame_no_gesture);
  seed = mojo::internal::Hash(seed, this->ad_frame);
  seed = mojo::internal::Hash(seed, this->sandbox);
  seed = mojo::internal::Hash(seed, this->no_gesture);
  return seed;
}
...
size_t NavigationDownloadPolicy::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->observed_types);
  seed = mojo::internal::Hash(seed, this->disallowed_types);
  return seed;
}
