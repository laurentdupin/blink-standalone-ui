...
enum class FrameWidgetInputHandler : uint32_t {
  ...
  kPasteFromImageBytes = 18,
  kDelete = 19,
  kSelectAll = 20,
  kCollapseSelection = 21,
  kReplace = 22,
  kReplaceMisspelling = 23,
  kSelectRange = 24,
  kAdjustSelectionByCharacterOffset = 25,
  kSelectAroundCaret = 26,
  kMoveRangeSelectionExtent = 27,
  kScrollFocusedEditableNodeIntoView = 28,
  kWaitForPageScaleAnimationForTesting = 29,
  kMoveCaret = 30,
};
enum class WidgetInputHandler : uint32_t {
  ...
  kPingMainThread = 12,
  kGetFrameWidgetInputHandler = 13,
  kUpdateBrowserControlsState = 14,
};
