...
class BLINK_PLATFORM_EXPORT SynchronousCompositorInterceptorForTesting : public SynchronousCompositor {
  ...
  void SetSharedMemory(::mojo_base::mojom::blink::WritableSharedMemoryRegionPtr shm_region, SetSharedMemoryCallback callback) override;
  ...
  void ReclaimResources(uint32_t layer_tree_frame_sink_id, ::blink::Vector<::viz::ReturnedResource> resources) override;
  ...
  void BeginFrame(const ::viz::BeginFrameArgs& args, const ::blink::HashMap<uint32_t, ::viz::FrameTimingDetails>& timing_details) override;
  void SetBeginFrameSourcePaused(bool paused) override;
};
class BLINK_PLATFORM_EXPORT SynchronousCompositorAsyncWaiter {
 public:
...
class BLINK_PLATFORM_EXPORT SynchronousCompositorHostInterceptorForTesting : public SynchronousCompositorHost {
  ...
  void SetThreads(const ::blink::Vector<::viz::Thread>& threads) override;
};
class BLINK_PLATFORM_EXPORT SynchronousCompositorHostAsyncWaiter {
 public:
...
class BLINK_PLATFORM_EXPORT SynchronousCompositorControlHostInterceptorForTesting : public SynchronousCompositorControlHost {
...
class BLINK_PLATFORM_EXPORT SynchronousCompositorControlHostAsyncWaiter {
 public:
