...
void KeepAliveHandleFactoryProxy::IssueKeepAliveHandle(
    ::mojo::PendingReceiver<::blink::mojom::KeepAliveHandle> in_keep_alive_handle) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("keep_alive_handle"), in_keep_alive_handle,
                        "<value of type ::mojo::PendingReceiver<::blink::mojom::KeepAliveHandle>>");
   });
#endif
...
bool KeepAliveHandleFactoryRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::KeepAliveHandleFactory::Name_,
