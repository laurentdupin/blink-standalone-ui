...
class  TransferableMessage {
 public:
  ...
  TransferableMessage(
      ::blink::mojom::CloneableMessagePtr message,
      std::vector<::blink::mojom::MessagePortDescriptorPtr> ports,
      std::vector<::blink::mojom::MessagePortDescriptorPtr> stream_channels,
      ...
      ::blink::mojom::TaskAttributionIdPtr task_state_id);
...
template <>
struct  StructTraits<::blink::mojom::TransferableMessage::DataView,
  ...
  static decltype(::blink::mojom::TransferableMessage::delegated_capability) delegated_capability(
      const ::blink::mojom::TransferableMessagePtr& input) {
    return input->delegated_capability;
  }

  static const decltype(::blink::mojom::TransferableMessage::task_state_id)& task_state_id(
      const ::blink::mojom::TransferableMessagePtr& input) {
