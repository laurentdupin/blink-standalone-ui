...
bool ReportBodyElement_Data::Validate(
  ...
  [[maybe_unused]] const ReportBodyElement_Data* object =
      static_cast<const ReportBodyElement_Data*>(data);
...
bool ReportBody_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const ReportBody_Data* object =
      static_cast<const ReportBody_Data*>(data);
...
bool Report_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const Report_Data* object =
      static_cast<const Report_Data*>(data);
...
bool ReportingObserver_Notify_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const ReportingObserver_Notify_Params_Data* object =
      static_cast<const ReportingObserver_Notify_Params_Data*>(data);
