// third_party/blink/public/mojom/frame/back_forward_cache_controller.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef THIRD_PARTY_BLINK_PUBLIC_MOJOM_FRAME_BACK_FORWARD_CACHE_CONTROLLER_MOJOM_BLINK_H_
#define THIRD_PARTY_BLINK_PUBLIC_MOJOM_FRAME_BACK_FORWARD_CACHE_CONTROLLER_MOJOM_BLINK_H_
...
#include "third_party/blink/public/mojom/frame/back_forward_cache_controller.mojom-blink-forward.h"  // IWYU pragma: export
...
// with not having this data in traces there.
  ...
  virtual void EvictFromBackForwardCache(::blink::mojom::blink::RendererEvictionReason reason, ::blink::mojom::blink::ScriptSourceLocationPtr source) = 0;

  virtual void DidChangeBackForwardCacheDisablingFeatures(::blink::Vector<BlockingDetailsPtr> details) = 0;
};
...
class  BackForwardCacheControllerHostProxy
 ...
 public:
  ...
  void EvictFromBackForwardCache(::blink::mojom::blink::RendererEvictionReason reason, ::blink::mojom::blink::ScriptSourceLocationPtr source) final;
  
  void DidChangeBackForwardCacheDisablingFeatures(::blink::Vector<BlockingDetailsPtr> details) final;

 private:
  mojo::MessageReceiverWithResponder* receiver_;
};
class  BackForwardCacheControllerHostStubDispatch {
 public:
...
class  BackForwardCacheControllerHostRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
class  BlockingDetails {
 public:
  ...
  BlockingDetails(
      ::blink::mojom::blink::WebSchedulerTrackedFeature feature,
...
BlockingDetails& operator=(const BlockingDetails&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        BlockingDetails::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        BlockingDetails::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::blink::mojom::blink::BlockingDetails::DataView,
                                         ::blink::mojom::blink::BlockingDetailsPtr> {
  static bool IsNull(const ::blink::mojom::blink::BlockingDetailsPtr& input) { return !input; }
  static void SetToNull(::blink::mojom::blink::BlockingDetailsPtr* output) { output->reset(); }

  static decltype(::blink::mojom::blink::BlockingDetails::feature) feature(
      const ::blink::mojom::blink::BlockingDetailsPtr& input) {
    return input->feature;
  }

  static const decltype(::blink::mojom::blink::BlockingDetails::source)& source(
      const ::blink::mojom::blink::BlockingDetailsPtr& input) {
    return input->source;
  }

  static bool Read(::blink::mojom::blink::BlockingDetails::DataView input, ::blink::mojom::blink::BlockingDetailsPtr* output);
};

}  // namespace mojo

#endif  // THIRD_PARTY_BLINK_PUBLIC_MOJOM_FRAME_BACK_FORWARD_CACHE_CONTROLLER_MOJOM_BLINK_H_