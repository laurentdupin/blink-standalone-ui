...
#include "third_party/blink/public/mojom/frame/intrinsic_sizing_info.mojom-blink-forward.h"  // IWYU pragma: export
 ...
 public:
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        IntrinsicSizingInfo::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        IntrinsicSizingInfo::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
bool IntrinsicSizingInfo::Equals(const T& other_struct) const {
  ...
  if (!mojo::Equals(this->has_height, other_struct.has_height))
    return false;
  if (!mojo::Equals(this->is_cleared, other_struct.is_cleared))
    return false;
  return true;
}
...
bool operator<(const T& lhs, const T& rhs) {
  ...
  if (rhs.has_height < lhs.has_height)
    return false;
  if (lhs.is_cleared < rhs.is_cleared)
    return true;
  if (rhs.is_cleared < lhs.is_cleared)
    return false;
  return false;
}
...
template <>
struct  StructTraits<::blink::mojom::blink::IntrinsicSizingInfo::DataView,
  ...
  static decltype(::blink::mojom::blink::IntrinsicSizingInfo::is_cleared) is_cleared(
      const ::blink::mojom::blink::IntrinsicSizingInfoPtr& input) {
    return input->is_cleared;
  }
