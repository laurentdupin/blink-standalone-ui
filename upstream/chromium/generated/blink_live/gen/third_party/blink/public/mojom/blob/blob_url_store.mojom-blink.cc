...
void BlobURLStoreProxy::ResolveAsBlobURLToken(
    const ::blink::KURL& in_url, ::mojo::PendingReceiver<BlobURLToken> in_token, bool in_is_top_level_navigation) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool BlobURLStoreRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::blink::BlobURLStore::Name_,
...
bool BlobURLTokenRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::blink::BlobURLToken::Name_,
...
void BlobURLStoreInterceptorForTesting::Register(::mojo::PendingRemote<::blink::mojom::blink::Blob> blob, const ::blink::KURL& url, RegisterCallback callback) {
...
void BlobURLStoreInterceptorForTesting::ResolveAsURLLoaderFactory(const ::blink::KURL& url, ::mojo::PendingReceiver<::network::mojom::blink::URLLoaderFactory> factory) {
...
void BlobURLStoreInterceptorForTesting::ResolveAsBlobURLToken(const ::blink::KURL& url, ::mojo::PendingReceiver<BlobURLToken> token, bool is_top_level_navigation) {
