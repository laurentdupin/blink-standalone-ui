...
bool GpuDataManagerProxy::Are3DAPIsBlockedForUrl(
    const ::blink::KURL& param_url, bool* out_param_blocked) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_BEGIN1(
  ...
  mojo::Message message(
      std::to_underlying(messages::GpuDataManager::kAre3DAPIsBlockedForUrl), kFlags, estimated_payload_size);
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_END1(
    "mojom", "Call blink::mojom::GpuDataManager::Are3DAPIsBlockedForUrl (sync)", "sync_response_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
...
void GpuDataManagerProxy::Are3DAPIsBlockedForUrl(
    const ::blink::KURL& in_url, Are3DAPIsBlockedForUrlCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool GpuDataManagerRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::blink::GpuDataManager::Name_,
...
void GpuDataManagerAsyncWaiter::Are3DAPIsBlockedForUrl(
    const ::blink::KURL& url, bool* out_blocked) {
  base::RunLoop loop;
