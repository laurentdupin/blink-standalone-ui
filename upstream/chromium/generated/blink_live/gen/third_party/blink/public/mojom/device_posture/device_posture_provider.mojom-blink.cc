...
void DevicePostureProviderProxy::AddListenerAndGetCurrentPosture(
  ...
  mojo::Message message(
      std::to_underlying(messages::DevicePostureProvider::kAddListenerAndGetCurrentPosture), kFlags, estimated_payload_size);
...
bool DevicePostureProviderRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::blink::DevicePostureProvider::Name_,
...
void DevicePostureClientProxy::OnPostureChanged(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::DevicePostureClient::kOnPostureChanged), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool DevicePostureClientRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::blink::DevicePostureClient::Name_,
