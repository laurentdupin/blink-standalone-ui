...
class BLINK_PLATFORM_EXPORT OpenGraphMetadata {
 public:
  template <typename T>
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        OpenGraphMetadata::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        OpenGraphMetadata::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::blink::OpenGraphMetadata::DataView,
                                         ::blink::mojom::blink::OpenGraphMetadataPtr> {
  static bool IsNull(const ::blink::mojom::blink::OpenGraphMetadataPtr& input) { return !input; }
  static void SetToNull(::blink::mojom::blink::OpenGraphMetadataPtr* output) { output->reset(); }

  static const decltype(::blink::mojom::blink::OpenGraphMetadata::image)& image(
      const ::blink::mojom::blink::OpenGraphMetadataPtr& input) {
    return input->image;
  }
