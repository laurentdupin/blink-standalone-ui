// third_party/blink/public/mojom/manifest/display_mode.mojom-shared.h is auto generated by mojom_bindings_generator.py, do not edit
...
#include "third_party/blink/public/mojom/manifest/display_mode.mojom-data-view.h"  // IWYU pragma: export
...
struct Serializer<::blink::mojom::DisplayMode, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::blink::mojom::DisplayMode>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::blink::mojom::DisplayMode, UserType> ||
                        HasInfallibleConversion(::blink::mojom::DisplayMode()),
                    "::blink::mojom::DisplayMode does not have an infallible conversion, "
...
template <>
struct  TraceFormatTraits<::blink::mojom::DisplayMode> {
 static void WriteIntoTrace(perfetto::TracedValue context, ::blink::mojom::DisplayMode value);
};
