...
class  ViewportIntersectionState {
 public:
  ...
  ViewportIntersectionState(
      ...
      bool is_hidden_for_media_playback);
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ViewportIntersectionState::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        ViewportIntersectionState::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
ViewportIntersectionStatePtr ViewportIntersectionState::Clone() const {
  return New(
      ...
      mojo::Clone(is_hidden_for_media_playback)
  );
}
...
bool ViewportIntersectionState::Equals(const T& other_struct) const {
  ...
  if (!mojo::Equals(this->main_frame_transform, other_struct.main_frame_transform))
    return false;
  if (!mojo::Equals(this->is_hidden_for_media_playback, other_struct.is_hidden_for_media_playback))
    return false;
  return true;
}
...
bool operator<(const T& lhs, const T& rhs) {
  ...
  if (rhs.main_frame_transform < lhs.main_frame_transform)
    return false;
  if (lhs.is_hidden_for_media_playback < rhs.is_hidden_for_media_playback)
    return true;
  if (rhs.is_hidden_for_media_playback < lhs.is_hidden_for_media_playback)
    return false;
  return false;
}
...
template <>
struct  StructTraits<::blink::mojom::blink::ViewportIntersectionState::DataView,
  ...
  static decltype(::blink::mojom::blink::ViewportIntersectionState::is_hidden_for_media_playback) is_hidden_for_media_playback(
      const ::blink::mojom::blink::ViewportIntersectionStatePtr& input) {
    return input->is_hidden_for_media_playback;
  }
