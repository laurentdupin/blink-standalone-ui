...
CloneableMessage::CloneableMessage(
    ::mojo_base::mojom::BigBufferPtr encoded_message_in,
    std::vector<::blink::mojom::SerializedBlobPtr> blobs_in,
    ::url::mojom::OriginPtr sender_origin_in,
    ...
    ::mojo_base::mojom::UnguessableTokenPtr sender_agent_cluster_id_in,
    bool locked_to_sender_agent_cluster_in,
    std::vector<::mojo::PendingRemote<::blink::mojom::FileSystemAccessTransferToken>> file_system_access_tokens_in)
