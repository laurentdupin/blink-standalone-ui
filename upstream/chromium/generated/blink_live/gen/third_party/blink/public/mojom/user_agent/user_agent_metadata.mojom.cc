...
size_t UserAgentBrandVersion::Hash(size_t seed) const {
  seed = mojo::internal::Hash(seed, this->brand);
...
UserAgentMetadata::UserAgentMetadata(
    std::vector<UserAgentBrandVersionPtr> brand_version_list_in,
    std::vector<UserAgentBrandVersionPtr> brand_full_version_list_in,
    ...
    bool wow64_in,
    std::vector<std::string> form_factors_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<UserAgentBrandVersionPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
