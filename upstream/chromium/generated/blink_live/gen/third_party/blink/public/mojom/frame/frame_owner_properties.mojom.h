 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        FrameOwnerProperties::DataView, std::vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        FrameOwnerProperties::DataView, std::vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::blink::mojom::FrameOwnerProperties::DataView,
                                         ::blink::mojom::FrameOwnerPropertiesPtr> {
  static bool IsNull(const ::blink::mojom::FrameOwnerPropertiesPtr& input) { return !input; }
  static void SetToNull(::blink::mojom::FrameOwnerPropertiesPtr* output) { output->reset(); }

  static const decltype(::blink::mojom::FrameOwnerProperties::name)& name(
      const ::blink::mojom::FrameOwnerPropertiesPtr& input) {
    return input->name;
  }

  static decltype(::blink::mojom::FrameOwnerProperties::scrollbar_mode) scrollbar_mode(
      const ::blink::mojom::FrameOwnerPropertiesPtr& input) {
    return input->scrollbar_mode;
  }

  static decltype(::blink::mojom::FrameOwnerProperties::margin_width) margin_width(
      const ::blink::mojom::FrameOwnerPropertiesPtr& input) {
    return input->margin_width;
  }

  static decltype(::blink::mojom::FrameOwnerProperties::margin_height) margin_height(
      const ::blink::mojom::FrameOwnerPropertiesPtr& input) {
    return input->margin_height;
  }

  static decltype(::blink::mojom::FrameOwnerProperties::allow_fullscreen) allow_fullscreen(
      const ::blink::mojom::FrameOwnerPropertiesPtr& input) {
    return input->allow_fullscreen;
  }

  static decltype(::blink::mojom::FrameOwnerProperties::allow_payment_request) allow_payment_request(
      const ::blink::mojom::FrameOwnerPropertiesPtr& input) {
    return input->allow_payment_request;
  }

  static decltype(::blink::mojom::FrameOwnerProperties::is_display_none) is_display_none(
      const ::blink::mojom::FrameOwnerPropertiesPtr& input) {
    return input->is_display_none;
  }

  static decltype(::blink::mojom::FrameOwnerProperties::color_scheme) color_scheme(
      const ::blink::mojom::FrameOwnerPropertiesPtr& input) {
    return input->color_scheme;
  }

  static decltype(::blink::mojom::FrameOwnerProperties::preferred_color_scheme) preferred_color_scheme(
      const ::blink::mojom::FrameOwnerPropertiesPtr& input) {
