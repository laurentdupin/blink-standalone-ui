...
#include "third_party/blink/public/mojom/input/pointer_lock_context.mojom-blink-test-utils.h"
...
void PointerLockContextProxy::RequestMouseLockChange(
  ...
  mojo::Message message(
      std::to_underlying(messages::PointerLockContext::kRequestMouseLockChange), kFlags, estimated_payload_size);
...
bool PointerLockContextRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::blink::PointerLockContext::Name_,
...
void PointerLockContextAsyncWaiter::RequestMouseLockChange(
    bool unadjusted_movement, ::blink::mojom::blink::PointerLockResult* out_result) {
  base::RunLoop loop;
...
,
             ::blink::mojom::blink::PointerLockResult result) {*out_result = std::move(result);
            loop->Quit();
          },
          &loop,
          out_result));
...
::blink::mojom::blink::PointerLockResult PointerLockContextAsyncWaiter::RequestMouseLockChange(
    bool unadjusted_movement) {
  ::blink::mojom::blink::PointerLockResult async_wait_result;
