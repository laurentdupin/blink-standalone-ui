...
FramePolicy::FramePolicy(
    ...
    std::vector<::network::mojom::ParsedPermissionsPolicyDeclarationPtr> container_policy_in,
    base::flat_map<::blink::mojom::DocumentPolicyFeature, ::blink::mojom::PolicyValuePtr> required_document_policy_in,
    ::blink::mojom::DeferredFetchPolicy deferred_fetch_policy_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::vector<::network::mojom::ParsedPermissionsPolicyDeclarationPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type base::flat_map<::blink::mojom::DocumentPolicyFeature, ::blink::mojom::PolicyValuePtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::mojom::DeferredFetchPolicy>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
