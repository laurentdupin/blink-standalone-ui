// third_party/blink/public/mojom/messaging/cloneable_message.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef THIRD_PARTY_BLINK_PUBLIC_MOJOM_MESSAGING_CLONEABLE_MESSAGE_MOJOM_BLINK_H_
#define THIRD_PARTY_BLINK_PUBLIC_MOJOM_MESSAGING_CLONEABLE_MESSAGE_MOJOM_BLINK_H_
...
#include "third_party/blink/public/mojom/messaging/cloneable_message.mojom-blink-forward.h"  // IWYU pragma: export
...
class  CloneableMessage {
 public:
  ...
  CloneableMessage(
      ::mojo_base::mojom::blink::BigBufferPtr encoded_message,
      ::blink::Vector<::blink::mojom::blink::SerializedBlobPtr> blobs,
      ::url::mojom::blink::OriginPtr sender_origin,
      ...
      ::mojo_base::mojom::blink::UnguessableTokenPtr sender_agent_cluster_id,
      bool locked_to_sender_agent_cluster,
      ::blink::Vector<::mojo::PendingRemote<::blink::mojom::blink::FileSystemAccessTransferToken>> file_system_access_tokens);
...
struct  StructTraits<::blink::mojom::blink::CloneableMessage::DataView,
  ...
  static const decltype(::blink::mojom::blink::CloneableMessage::sender_origin)& sender_origin(
  ...
  static decltype(::blink::mojom::blink::CloneableMessage::stack_trace_should_pause) stack_trace_should_pause(
      const ::blink::mojom::blink::CloneableMessagePtr& input) {
    return input->stack_trace_should_pause;
  }

  static const decltype(::blink::mojom::blink::CloneableMessage::sender_agent_cluster_id)& sender_agent_cluster_id(
      const ::blink::mojom::blink::CloneableMessagePtr& input) {
    return input->sender_agent_cluster_id;
  }

  static decltype(::blink::mojom::blink::CloneableMessage::locked_to_sender_agent_cluster) locked_to_sender_agent_cluster(
      const ::blink::mojom::blink::CloneableMessagePtr& input) {
    return input->locked_to_sender_agent_cluster;
  }

  static  decltype(::blink::mojom::blink::CloneableMessage::file_system_access_tokens)& file_system_access_tokens(
       ::blink::mojom::blink::CloneableMessagePtr& input) {
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_MOJOM_MESSAGING_CLONEABLE_MESSAGE_MOJOM_BLINK_H_