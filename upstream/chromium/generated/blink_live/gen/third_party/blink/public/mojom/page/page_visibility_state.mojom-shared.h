// third_party/blink/public/mojom/page/page_visibility_state.mojom-shared.h is auto generated by mojom_bindings_generator.py, do not edit
...
#include "third_party/blink/public/mojom/page/page_visibility_state.mojom-data-view.h"  // IWYU pragma: export
...
struct Serializer<::blink::mojom::PageVisibilityState, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::blink::mojom::PageVisibilityState>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::blink::mojom::PageVisibilityState, UserType> ||
                        HasInfallibleConversion(::blink::mojom::PageVisibilityState()),
                    "::blink::mojom::PageVisibilityState does not have an infallible conversion, "
...
template <>
struct  TraceFormatTraits<::blink::mojom::PageVisibilityState> {
 static void WriteIntoTrace(perfetto::TracedValue context, ::blink::mojom::PageVisibilityState value);
};
