...
#include "third_party/blink/public/mojom/lcp_critical_path_predictor/lcp_critical_path_predictor.mojom-data-view.h"  // IWYU pragma: export
...
struct Serializer<::blink::mojom::LcpElementDataView, MaybeConstUserType> {
  ...
  static bool Deserialize(::blink::mojom::internal::LcpElement_Data* input,
                          UserType* output,
                          Message* message) {
    if (!input)
      return CallSetToNullIfExists<Traits>(output);

    ::blink::mojom::LcpElementDataView data_view(input, message);
...
inline void LcpElementDataView::GetLocatorDataView(
...
inline void LCPCriticalPathPredictorNavigationTimeHintDataView::GetLcpElementLocatorsAllDataView(
    mojo::ArrayDataView<::mojo_base::mojom::ByteStringDataView>* output) {
