// third_party/blink/public/mojom/permissions_policy/policy_value.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef THIRD_PARTY_BLINK_PUBLIC_MOJOM_PERMISSIONS_POLICY_POLICY_VALUE_MOJOM_BLINK_H_
#define THIRD_PARTY_BLINK_PUBLIC_MOJOM_PERMISSIONS_POLICY_POLICY_VALUE_MOJOM_BLINK_H_
...
#include "third_party/blink/public/mojom/permissions_policy/policy_value.mojom-blink-forward.h"  // IWYU pragma: export
...
class BLINK_PLATFORM_EXPORT PolicyValue {
 public:
...
template <>
struct BLINK_PLATFORM_EXPORT UnionTraits<::blink::mojom::blink::PolicyValue::DataView,
  ...
  static ::blink::mojom::blink::PolicyValue::Tag GetTag(const ::blink::mojom::blink::PolicyValuePtr& input) {
    return input->which();
  }

  static  bool bool_value(const ::blink::mojom::blink::PolicyValuePtr& input) {
    return input->get_bool_value();
  }

  static  double dec_double_value(const ::blink::mojom::blink::PolicyValuePtr& input) {
    return input->get_dec_double_value();
  }

  static  int32_t enum_value(const ::blink::mojom::blink::PolicyValuePtr& input) {
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_MOJOM_PERMISSIONS_POLICY_POLICY_VALUE_MOJOM_BLINK_H_