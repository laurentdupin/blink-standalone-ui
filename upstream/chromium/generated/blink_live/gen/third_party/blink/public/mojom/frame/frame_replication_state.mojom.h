...
class  FrameReplicationState {
 public:
  ...
  FrameReplicationState(
      ...
      std::vector<::network::mojom::ParsedPermissionsPolicyDeclarationPtr> permissions_policy_header,
      ::network::mojom::WebSandboxFlags active_sandbox_flags,
      ::blink::mojom::FramePolicyPtr frame_policy,
...
FrameReplicationState& operator=(const FrameReplicationState&) = delete;
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        FrameReplicationState::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
template <>
struct  StructTraits<::blink::mojom::FrameReplicationState::DataView,
