...
class  FileSystemAccessDataTransferTokenStubDispatch {
 public:
...
class  FileSystemAccessDataTransferTokenRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class  FileSystemAccessDataTransferTokenResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
