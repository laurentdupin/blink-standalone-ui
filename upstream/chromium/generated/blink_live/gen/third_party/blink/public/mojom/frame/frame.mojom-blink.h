...
#include "third_party/blink/public/mojom/frame/frame.mojom-blink-import-headers.h"  // IWYU pragma: export
...
#include "skia/public/mojom/skcolor4f.mojom-blink-forward.h"
...
#include "third_party/blink/public/mojom/messaging/task_attribution_id.mojom-blink-forward.h"
...
// with not having this data in traces there.
  ...
  virtual void GetCompositorFrameSink(::mojo::PendingReceiver<::viz::mojom::blink::CompositorFrameSink> sink, ::mojo::PendingRemote<::viz::mojom::blink::CompositorFrameSinkClient> client) = 0;
...
// with not having this data in traces there.
  ...
  virtual void GoToEntryAtOffset(int32_t offset, bool has_user_gesture, ::base::TimeTicks actual_navigation_start, ::blink::mojom::blink::TaskAttributionIdPtr soft_navigation_heuristics_task_id) = 0;

  virtual void NavigateToNavigationApiKey(const ::blink::String& key, bool has_user_gesture, ::base::TimeTicks actual_navigation_start, ::blink::mojom::blink::TaskAttributionIdPtr soft_navigation_heuristics_task_id) = 0;

  virtual void NavigateEventHandlerPresenceChanged(bool present) = 0;

  virtual void UpdateTitle(const ::blink::String& title) = 0;
  ...
  virtual void ShowContextMenu(::mojo::PendingAssociatedRemote<::blink::mojom::blink::ContextMenuClient> client, ::blink::mojom::blink::UntrustworthyContextMenuParamsPtr params) = 0;
  ...
  virtual void SendFencedFrameReportingBeacon(const ::blink::String& event_data, const ::blink::String& event_type, const ::blink::Vector<::blink::mojom::blink::ReportingDestination>& destinations, bool cross_origin_exposed) = 0;
  ...
  virtual void SetFencedFrameAutomaticBeaconReportEventData(::blink::mojom::blink::AutomaticBeaconType event_type, const ::blink::String& event_data, const ::blink::Vector<::blink::mojom::blink::ReportingDestination>& destinations, bool once, bool cross_origin_exposed) = 0;
  ...
  virtual void StartDragging(::blink::mojom::blink::DragDataPtr drag_data, ::blink::mojom::blink::AllowedDragOperationsPtr operations_allowed, const ::SkBitmap& image, const ::gfx::Vector2d& cursor_offset_in_dip, const ::gfx::Rect& drag_obj_rect_in_dip, ::blink::mojom::blink::DragEventSourceInfoPtr event_info) = 0;
  ...
  using InitializeCrashReportContextCallback = base::OnceCallback<void(::mojo_base::mojom::blink::UnsafeSharedMemoryRegionPtr)>;
  using InitializeCrashReportContextMojoCallback = base::OnceCallback<void(::mojo_base::mojom::blink::UnsafeSharedMemoryRegionPtr)>;
...
// with not having this data in traces there.
  ...
  virtual void JavaScriptMethodExecuteRequest(const ::blink::String& object_name, const ::blink::String& method_name, ::base::ListValue arguments, bool wants_result, JavaScriptMethodExecuteRequestCallback callback) = 0;
  ...
  virtual void InvokeScriptToolForInspector(const ::base::UnguessableToken& invocation_id, const ::blink::String& tool_name, const ::blink::String& input_arguments, InvokeScriptToolForInspectorCallback callback) = 0;
  ...
  virtual void AddResourceTimingEntryForFailedSubframeNavigation(const ::blink::FrameToken& subframe_token, const ::blink::KURL& initial_url, ::base::TimeTicks start_time, ::base::TimeTicks redirect_time, ::base::TimeTicks request_start, ::base::TimeTicks response_start, ::base::TimeTicks completion_time, uint32_t response_code, const ::blink::String& mime_type, ::network::mojom::blink::LoadTimingInfoPtr load_timing_info, ::net::HttpConnectionInfo connection_info, const ::blink::String& alpn_negotiated_protocol, bool is_secure_transport, bool is_validated, const ::blink::String& normalized_server_timing, SubframeResourceLengthsPtr resource_lengths) = 0;
...
// with not having this data in traces there.
  ...
  virtual void DidChangeThemeColor(::skia::mojom::blink::SkColorPtr theme_color) = 0;

  virtual void DidChangeBackgroundColor(::skia::mojom::blink::SkColor4fPtr background_color, bool color_adjust) = 0;
...
class  UnboundedSurfaceHostProxy
 ...
 public:
  ...
  void GetCompositorFrameSink(::mojo::PendingReceiver<::viz::mojom::blink::CompositorFrameSink> sink, ::mojo::PendingRemote<::viz::mojom::blink::CompositorFrameSinkClient> client) final;
...
class  LocalFrameHostProxy
 ...
 public:
  ...
  void GoToEntryAtOffset(int32_t offset, bool has_user_gesture, ::base::TimeTicks actual_navigation_start, ::blink::mojom::blink::TaskAttributionIdPtr soft_navigation_heuristics_task_id) final;
  
  void NavigateToNavigationApiKey(const ::blink::String& key, bool has_user_gesture, ::base::TimeTicks actual_navigation_start, ::blink::mojom::blink::TaskAttributionIdPtr soft_navigation_heuristics_task_id) final;
  
  void NavigateEventHandlerPresenceChanged(bool present) final;
  
  void UpdateTitle(const ::blink::String& title) final;
  ...
  void ShowContextMenu(::mojo::PendingAssociatedRemote<::blink::mojom::blink::ContextMenuClient> client, ::blink::mojom::blink::UntrustworthyContextMenuParamsPtr params) final;
  ...
  void SendFencedFrameReportingBeacon(const ::blink::String& event_data, const ::blink::String& event_type, const ::blink::Vector<::blink::mojom::blink::ReportingDestination>& destinations, bool cross_origin_exposed) final;
  ...
  void SetFencedFrameAutomaticBeaconReportEventData(::blink::mojom::blink::AutomaticBeaconType event_type, const ::blink::String& event_data, const ::blink::Vector<::blink::mojom::blink::ReportingDestination>& destinations, bool once, bool cross_origin_exposed) final;
  ...
  void StartDragging(::blink::mojom::blink::DragDataPtr drag_data, ::blink::mojom::blink::AllowedDragOperationsPtr operations_allowed, const ::SkBitmap& image, const ::gfx::Vector2d& cursor_offset_in_dip, const ::gfx::Rect& drag_obj_rect_in_dip, ::blink::mojom::blink::DragEventSourceInfoPtr event_info) final;
...
class  LocalFrameProxy
 ...
 public:
  ...
  void JavaScriptMethodExecuteRequest(const ::blink::String& object_name, const ::blink::String& method_name, ::base::ListValue arguments, bool wants_result, JavaScriptMethodExecuteRequestCallback callback) final;
  ...
  void InvokeScriptToolForInspector(const ::base::UnguessableToken& invocation_id, const ::blink::String& tool_name, const ::blink::String& input_arguments, InvokeScriptToolForInspectorCallback callback) final;
...
class  LocalMainFrameHostProxy
 ...
 public:
  ...
  void DidChangeThemeColor(::skia::mojom::blink::SkColorPtr theme_color) final;
  
  void DidChangeBackgroundColor(::skia::mojom::blink::SkColor4fPtr background_color, bool color_adjust) final;
...
class  SubframeResourceLengths {
 public:
  ...
  SubframeResourceLengths(
      ::mojo_base::mojom::blink::ByteSizePtr encoded_data_length,
      ::mojo_base::mojom::blink::ByteSizePtr encoded_body_length,
      ::mojo_base::mojom::blink::ByteSizePtr decoded_body_length);
...
SubframeResourceLengths& operator=(const SubframeResourceLengths&) = delete;
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SubframeResourceLengths::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        SubframeResourceLengths::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::blink::mojom::blink::SavableSubframe::DataView,
...
template <>
struct  StructTraits<::blink::mojom::blink::GetSavableResourceLinksReply::DataView,
...
template <>
struct  StructTraits<::blink::mojom::blink::FindInPageResultAXParams::DataView,
...
template <>
struct  StructTraits<::blink::mojom::blink::DownloadURLParams::DataView,
...
template <>
struct  StructTraits<::blink::mojom::blink::IframeAttributes::DataView,
...
template <>
struct  StructTraits<::blink::mojom::blink::LegacyTechEventCodeLocation::DataView,
...
template <>
struct  StructTraits<::blink::mojom::blink::SubframeResourceLengths::DataView,
                                         ::blink::mojom::blink::SubframeResourceLengthsPtr> {
  static bool IsNull(const ::blink::mojom::blink::SubframeResourceLengthsPtr& input) { return !input; }
  static void SetToNull(::blink::mojom::blink::SubframeResourceLengthsPtr* output) { output->reset(); }

  static const decltype(::blink::mojom::blink::SubframeResourceLengths::encoded_data_length)& encoded_data_length(
      const ::blink::mojom::blink::SubframeResourceLengthsPtr& input) {
    return input->encoded_data_length;
  }

  static const decltype(::blink::mojom::blink::SubframeResourceLengths::encoded_body_length)& encoded_body_length(
      const ::blink::mojom::blink::SubframeResourceLengthsPtr& input) {
    return input->encoded_body_length;
  }

  static const decltype(::blink::mojom::blink::SubframeResourceLengths::decoded_body_length)& decoded_body_length(
      const ::blink::mojom::blink::SubframeResourceLengthsPtr& input) {
    return input->decoded_body_length;
  }

  static bool Read(::blink::mojom::blink::SubframeResourceLengths::DataView input, ::blink::mojom::blink::SubframeResourceLengthsPtr* output);
};
