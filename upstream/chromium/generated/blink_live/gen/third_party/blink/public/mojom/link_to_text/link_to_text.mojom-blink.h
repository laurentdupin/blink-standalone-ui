...
class BLINK_PLATFORM_EXPORT TextFragmentReceiver
...
// with not having this data in traces there.
  ...
  using RequestSelectorCallback = base::OnceCallback<void(const ::blink::String&, LinkGenerationError, LinkGenerationReadyStatus)>;
  using RequestSelectorMojoCallback = base::OnceCallback<void(const ::blink::String&, LinkGenerationError, LinkGenerationReadyStatus)>;

  virtual void RequestSelector(RequestSelectorCallback callback) = 0;

  virtual void RemoveFragments() = 0;

  using ExtractTextFragmentsMatchesCallback = base::OnceCallback<void(const ::blink::Vector<::blink::String>&)>;
  using ExtractTextFragmentsMatchesMojoCallback = base::OnceCallback<void(const ::blink::Vector<::blink::String>&)>;

  virtual void ExtractTextFragmentsMatches(ExtractTextFragmentsMatchesCallback callback) = 0;

  using GetExistingSelectorsCallback = base::OnceCallback<void(const ::blink::Vector<::blink::String>&)>;
  using GetExistingSelectorsMojoCallback = base::OnceCallback<void(const ::blink::Vector<::blink::String>&)>;

  virtual void GetExistingSelectors(GetExistingSelectorsCallback callback) = 0;

  using RequestSelectorForViewportCenterCallback = base::OnceCallback<void(const ::blink::String&, LinkGenerationError, LinkGenerationReadyStatus)>;
  using RequestSelectorForViewportCenterMojoCallback = base::OnceCallback<void(const ::blink::String&, LinkGenerationError, LinkGenerationReadyStatus)>;

  virtual void RequestSelectorForViewportCenter(RequestSelectorForViewportCenterCallback callback) = 0;

  using RequestSelectorForSelectionCallback = base::OnceCallback<void(const ::blink::String&, LinkGenerationError, LinkGenerationReadyStatus)>;
  using RequestSelectorForSelectionMojoCallback = base::OnceCallback<void(const ::blink::String&, LinkGenerationError, LinkGenerationReadyStatus)>;
...
class BLINK_PLATFORM_EXPORT TextFragmentReceiverProxy
...
class BLINK_PLATFORM_EXPORT TextFragmentReceiverStubDispatch {
 public:
...
class BLINK_PLATFORM_EXPORT TextFragmentReceiverRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class BLINK_PLATFORM_EXPORT TextFragmentReceiverResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
