...
# endif // !BUILDFLAG(IS_FUCHSIA)
bool FileBackedBlobFactory::RegisterBlobSync(::mojo::PendingReceiver<::blink::mojom::blink::Blob> blob, const ::blink::String& uuid, const ::blink::String& content_type, ::blink::mojom::blink::DataElementFilePtr file) {
  NOTREACHED();
}
...
void FileBackedBlobFactoryProxy::RegisterBlob(
    ::mojo::PendingReceiver<::blink::mojom::blink::Blob> in_blob, const ::blink::String& in_uuid, const ::blink::String& in_content_type, ::blink::mojom::blink::DataElementFilePtr in_file) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  mojo::Message message(
      std::to_underlying(messages::FileBackedBlobFactory::kRegisterBlob), kFlags, estimated_payload_size);
...
bool FileBackedBlobFactoryProxy::RegisterBlobSync(
    ::mojo::PendingReceiver<::blink::mojom::blink::Blob> param_blob, const ::blink::String& param_uuid, const ::blink::String& param_content_type, ::blink::mojom::blink::DataElementFilePtr param_file) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_BEGIN1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FileBackedBlobFactory::kRegisterBlobSync), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_END0("mojom", "Call blink::mojom::FileBackedBlobFactory::RegisterBlobSync (sync)");
#endif
  return result;
}

void FileBackedBlobFactoryProxy::RegisterBlobSync(
    ::mojo::PendingReceiver<::blink::mojom::blink::Blob> in_blob, const ::blink::String& in_uuid, const ::blink::String& in_content_type, ::blink::mojom::blink::DataElementFilePtr in_file, RegisterBlobSyncCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool FileBackedBlobFactoryRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::blink::FileBackedBlobFactory::Name_,
...
void FileBackedBlobFactoryInterceptorForTesting::RegisterBlob(::mojo::PendingReceiver<::blink::mojom::blink::Blob> blob, const ::blink::String& uuid, const ::blink::String& content_type, ::blink::mojom::blink::DataElementFilePtr file) {
...
void FileBackedBlobFactoryInterceptorForTesting::RegisterBlobSync(::mojo::PendingReceiver<::blink::mojom::blink::Blob> blob, const ::blink::String& uuid, const ::blink::String& content_type, ::blink::mojom::blink::DataElementFilePtr file, RegisterBlobSyncCallback callback) {
