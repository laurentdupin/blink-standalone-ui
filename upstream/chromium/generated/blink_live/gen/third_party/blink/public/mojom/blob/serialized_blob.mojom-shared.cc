// third_party/blink/public/mojom/blob/serialized_blob.mojom-shared.cc is auto generated by mojom_bindings_generator.py, do not edit
...
// static
bool SerializedBlob_Data::Validate(
    const void* data,
  ...
  [[maybe_unused]] const SerializedBlob_Data* object =
      static_cast<const SerializedBlob_Data*>(data);
  ...
  if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
          object->blob, 4, validation_context)) {
    return false;
  }
...
SerializedBlob_Data::SerializedBlob_Data()
