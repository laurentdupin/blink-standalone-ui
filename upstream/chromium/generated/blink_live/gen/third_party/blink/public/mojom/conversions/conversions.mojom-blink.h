...
class BLINK_PLATFORM_EXPORT AttributionHost
...
class BLINK_PLATFORM_EXPORT AttributionHostProxy
...
class BLINK_PLATFORM_EXPORT AttributionHostStubDispatch {
 public:
...
class BLINK_PLATFORM_EXPORT AttributionHostRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
class BLINK_PLATFORM_EXPORT Impression {
 public:
  template <typename T>
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::blink::Impression::DataView,
