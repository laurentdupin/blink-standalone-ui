...
namespace internal {
class  FileBackedBlobFactory_RegisterBlob_Params_Data {
 public:
...
class  FileBackedBlobFactory_RegisterBlobSync_Params_Data {
 public:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
...
class  FileBackedBlobFactory_RegisterBlobSync_ResponseParams_Data {
 public:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
