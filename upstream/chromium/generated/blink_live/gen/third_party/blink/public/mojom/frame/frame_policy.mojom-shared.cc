...
// static
bool FramePolicy_Data::Validate(
    const void* data,
  ...
  [[maybe_unused]] const FramePolicy_Data* object =
      static_cast<const FramePolicy_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->container_policy, 2, validation_context)) {
    return false;
  }
  constexpr const mojo::internal::ContainerValidateParams& container_policy_validate_params =
      mojo::internal::GetArrayValidator<0, false, nullptr>();
  if (!mojo::internal::ValidateContainer(object->container_policy, validation_context,
                                         &container_policy_validate_params)) {
    return false;
  }

  if (!mojo::internal::ValidatePointerNonNullable(
          object->required_document_policy, 3, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidateContainer(object->required_document_policy, validation_context,
                                         &required_document_policy_validate_params)) {
    return false;
  }


  if (!::blink::mojom::internal::DeferredFetchPolicy_Data
        ::Validate(object->deferred_fetch_policy, validation_context))
    return false;
