...
class BLINK_PLATFORM_EXPORT ImeRenderWidgetHost
...
class BLINK_PLATFORM_EXPORT ImeRenderWidgetHostProxy
...
class BLINK_PLATFORM_EXPORT ImeRenderWidgetHostStubDispatch {
 public:
...
class BLINK_PLATFORM_EXPORT ImeRenderWidgetHostRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
class BLINK_PLATFORM_EXPORT EditorBoundsInfo {
 public:
  template <typename T>
...
class BLINK_PLATFORM_EXPORT TextAppearanceInfo {
 public:
  template <typename T>
  ...
  explicit TextAppearanceInfo(
      ::skia::mojom::blink::SkColorPtr text_color);
...
class BLINK_PLATFORM_EXPORT InputCursorAnchorInfo {
 public:
  template <typename T>
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::blink::EditorBoundsInfo::DataView,
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::blink::TextAppearanceInfo::DataView,
...
template <>
struct BLINK_PLATFORM_EXPORT StructTraits<::blink::mojom::blink::InputCursorAnchorInfo::DataView,
