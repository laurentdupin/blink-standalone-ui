...
ColorProviderColorMaps::ColorProviderColorMaps(
    base::flat_map<::color::mojom::RendererColorId, ::skia::mojom::SkColorPtr> light_colors_map_in,
    base::flat_map<::color::mojom::RendererColorId, ::skia::mojom::SkColorPtr> dark_colors_map_in,
    base::flat_map<::color::mojom::RendererColorId, ::skia::mojom::SkColorPtr> forced_colors_map_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type base::flat_map<::color::mojom::RendererColorId, ::skia::mojom::SkColorPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
PageBroadcast::IPCStableHashFunction PageBroadcast::MessageToMethodInfo_(mojo::Message& message) {
  ...
  switch (static_cast<messages::PageBroadcast>(message.name())) {
    ...
    case messages::PageBroadcast::kUpgradePrerenderUntilScriptToFullPrerender: {
      return &PageBroadcast::UpgradePrerenderUntilScriptToFullPrerender_Sym::IPCStableHash;
    }
...
const char* PageBroadcast::MessageToMethodName_(mojo::Message& message) {
  ...
  if (!is_response) {
    switch (static_cast<messages::PageBroadcast>(message.name())) {
      ...
      case messages::PageBroadcast::kUpgradePrerenderUntilScriptToFullPrerender:
            return "Receive blink::mojom::PageBroadcast::UpgradePrerenderUntilScriptToFullPrerender";
      case messages::PageBroadcast::kUpdateWebPreferences:
    ...
    switch (static_cast<messages::PageBroadcast>(message.name())) {
      ...
      case messages::PageBroadcast::kUpgradePrerenderUntilScriptToFullPrerender:
            return "Receive reply blink::mojom::PageBroadcast::UpgradePrerenderUntilScriptToFullPrerender";
      case messages::PageBroadcast::kUpdateWebPreferences:
...
uint32_t PageBroadcast::UpgradePrerenderUntilScriptToFullPrerender_Sym::IPCStableHash() {
  // This method's address is used for identifying the mojo method name after
  // symbolization. So each IPCStableHash should have a unique address.
  // We cannot use NO_CODE_FOLDING() here - it relies on the uniqueness of
  // __LINE__ value, which is not unique across different mojo modules.
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x0dc90a8f;  // IPCStableHash for blink::mojom::PageBroadcast::UpgradePrerenderUntilScriptToFullPrerender
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void PageBroadcastProxy::SetPageLifecycleState(
  ...
  mojo::Message message(
      std::to_underlying(messages::PageBroadcast::kSetPageLifecycleState), kFlags, estimated_payload_size);
...
void PageBroadcastProxy::AudioStateChanged(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::PageBroadcast::kAudioStateChanged), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void PageBroadcastProxy::ActivatePrerenderedPage(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::PageBroadcast::kActivatePrerenderedPage), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void PageBroadcastProxy::UpgradePrerenderUntilScriptToFullPrerender(
    ) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "Send blink::mojom::PageBroadcast::UpgradePrerenderUntilScriptToFullPrerender");
#endif
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::PageBroadcast::kUpgradePrerenderUntilScriptToFullPrerender), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
      ::blink::mojom::internal::PageBroadcast_UpgradePrerenderUntilScriptToFullPrerender_Params_Data> params(
          message);
  params.Allocate();

#if defined(ENABLE_IPC_FUZZER)
  message.set_interface_name(PageBroadcast::Name_);
  message.set_method_name("UpgradePrerenderUntilScriptToFullPrerender");
#endif
  // This return value may be ignored as false implies the Connector has
  // encountered an error, which will be visible through other means.
  ::mojo::internal::SendMojoMessage(*receiver_, message);
...
void PageBroadcastProxy::UpdateWebPreferences(
    ::blink::mojom::WebPreferencesPtr in_preferences) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("preferences"), in_preferences,
                        "<value of type ::blink::mojom::WebPreferencesPtr>");
   });
#endif
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::PageBroadcast::kUpdateWebPreferences), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void PageBroadcastProxy::UpdateRendererPreferences(
    ::blink::mojom::RendererPreferencesPtr in_preferences) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("preferences"), in_preferences,
                        "<value of type ::blink::mojom::RendererPreferencesPtr>");
   });
#endif
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::PageBroadcast::kUpdateRendererPreferences), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void PageBroadcastProxy::SetHistoryIndexAndLength(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::PageBroadcast::kSetHistoryIndexAndLength), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void PageBroadcastProxy::SetPageBaseBackgroundColor(
    ::skia::mojom::SkColorPtr in_color) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::PageBroadcast::kSetPageBaseBackgroundColor), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void PageBroadcastProxy::CreateRemoteMainFrame(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::PageBroadcast::kCreateRemoteMainFrame), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void PageBroadcastProxy::UpdatePageBrowsingContextGroup(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::PageBroadcast::kUpdatePageBrowsingContextGroup), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void PageBroadcastProxy::SetPageAttributionSupport(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::PageBroadcast::kSetPageAttributionSupport), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void PageBroadcastProxy::UpdateColorProviders(
    ColorProviderColorMapsPtr in_color_provider_colors) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("color_provider_colors"), in_color_provider_colors,
                        "<value of type ColorProviderColorMapsPtr>");
   });
#endif
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::PageBroadcast::kUpdateColorProviders), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void PageBroadcastProxy::SetSupportsDraggableRegions(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::PageBroadcast::kSetSupportsDraggableRegions), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool PageBroadcastStubDispatch::Accept(
  ...
  switch (static_cast<messages::PageBroadcast>(message->header()->name)) {
    ...
    case messages::PageBroadcast::kUpgradePrerenderUntilScriptToFullPrerender: {
      DCHECK(message->is_serialized());
      internal::PageBroadcast_UpgradePrerenderUntilScriptToFullPrerender_Params_Data* params =
          reinterpret_cast<internal::PageBroadcast_UpgradePrerenderUntilScriptToFullPrerender_Params_Data*>(
              message->mutable_payload());
      

      // Validation for PageBroadcast.3
      bool success = true;
      PageBroadcast_UpgradePrerenderUntilScriptToFullPrerender_ParamsDataView input_data_view(params, message);
      ...
      // A null |impl| means no implementation was bound.
      DCHECK(impl);
      impl->UpgradePrerenderUntilScriptToFullPrerender(        );
      return true;
    }
    case messages::PageBroadcast::kUpdateWebPreferences: {
      DCHECK(message->is_serialized());
      ...
      bool success = true;
      ::blink::mojom::WebPreferencesPtr p_preferences{};
    ...
    case messages::PageBroadcast::kUpdateRendererPreferences: {
      ...
      bool success = true;
      ::blink::mojom::RendererPreferencesPtr p_preferences{};
    ...
    case messages::PageBroadcast::kUpdateColorProviders: {
      ...
      bool success = true;
      ColorProviderColorMapsPtr p_color_provider_colors{};
    ...
    case messages::PageBroadcast::kSetSupportsDraggableRegions: {
      ...
      // Validation for PageBroadcast.12
      bool success = true;
...
static const mojo::internal::GenericValidationInfo kPageBroadcastValidationInfo[] = {
    ...
    { &internal::PageBroadcast_UpgradePrerenderUntilScriptToFullPrerender_Params_Data::Validate,
     nullptr /* no response */},
...
bool PageBroadcastRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::PageBroadcast::Name_,
...
void PageBroadcastInterceptorForTesting::UpgradePrerenderUntilScriptToFullPrerender() {
  GetForwardingInterface()->UpgradePrerenderUntilScriptToFullPrerender();
}
void PageBroadcastInterceptorForTesting::UpdateWebPreferences(::blink::mojom::WebPreferencesPtr preferences) {
  GetForwardingInterface()->UpdateWebPreferences(
    std::move(preferences)
    );
}
void PageBroadcastInterceptorForTesting::UpdateRendererPreferences(::blink::mojom::RendererPreferencesPtr preferences) {
...
void PageBroadcastInterceptorForTesting::SetPageBaseBackgroundColor(::skia::mojom::SkColorPtr color) {
...
void PageBroadcastInterceptorForTesting::UpdateColorProviders(ColorProviderColorMapsPtr color_provider_colors) {
