...
void FencedFrameOwnerHostProxy::Navigate(
    const ::GURL& in_url, ::base::TimeTicks in_navigation_start_time, ::mojo_base::mojom::String16Ptr in_embedder_shared_storage_context) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool FencedFrameOwnerHostStubDispatch::Accept(
  ...
  switch (static_cast<messages::FencedFrameOwnerHost>(message->header()->name)) {
    case messages::FencedFrameOwnerHost::kNavigate: {
      ...
      ::mojo_base::mojom::String16Ptr p_embedder_shared_storage_context{};
...
void FencedFrameOwnerHostInterceptorForTesting::Navigate(const ::GURL& url, ::base::TimeTicks navigation_start_time, ::mojo_base::mojom::String16Ptr embedder_shared_storage_context) {
