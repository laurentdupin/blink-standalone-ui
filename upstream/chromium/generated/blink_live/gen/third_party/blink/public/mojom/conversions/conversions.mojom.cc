...
#include "third_party/blink/public/mojom/conversions/conversions.mojom-test-utils.h"
...
void AttributionHostProxy::RegisterDataHost(
    ::mojo::PendingReceiver<::attribution_reporting::mojom::DataHost> in_data_host, ::attribution_reporting::mojom::RegistrationEligibility in_registration_eligibility, bool in_is_for_background_requests, const std::vector<::url::Origin>& in_reporting_origins) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("data_host"), in_data_host,
                        "<value of type ::mojo::PendingReceiver<::attribution_reporting::mojom::DataHost>>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("registration_eligibility"), in_registration_eligibility,
                        "<value of type ::attribution_reporting::mojom::RegistrationEligibility>");
      perfetto::WriteIntoTracedValueWithFallback(
  ...
  mojo::Message message(
      std::to_underlying(messages::AttributionHost::kRegisterDataHost), kFlags, estimated_payload_size);
...
void AttributionHostProxy::RegisterNavigationDataHost(
    ::mojo::PendingReceiver<::attribution_reporting::mojom::DataHost> in_data_host, const ::blink::AttributionSrcToken& in_attribution_src_token) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::AttributionHost::kRegisterNavigationDataHost), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void AttributionHostProxy::NotifyNavigationWithBackgroundRegistrationsWillStart(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::AttributionHost::kNotifyNavigationWithBackgroundRegistrationsWillStart), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool AttributionHostRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::AttributionHost::Name_,
...
void AttributionHostInterceptorForTesting::RegisterDataHost(::mojo::PendingReceiver<::attribution_reporting::mojom::DataHost> data_host, ::attribution_reporting::mojom::RegistrationEligibility registration_eligibility, bool is_for_background_requests, const std::vector<::url::Origin>& reporting_origins) {
...
void AttributionHostInterceptorForTesting::RegisterNavigationDataHost(::mojo::PendingReceiver<::attribution_reporting::mojom::DataHost> data_host, const ::blink::AttributionSrcToken& attribution_src_token) {
