...
class  ResourceLoadInfo_Data {
 public:
  ...
  uint8_t did_use_server_http_auth : 1;
  uint8_t pad9_[3];
  int32_t net_error;
  mojo::internal::Pointer<internal::CommonNetworkInfo_Data> network_info;
  ...
  mojo::internal::Pointer<::mojo_base::mojom::internal::ByteCount_Data> raw_body_bytes;
  mojo::internal::Pointer<::mojo_base::mojom::internal::ByteCount_Data> total_received_bytes;
...
static_assert(sizeof(ResourceLoadInfo_Data) == 128,
