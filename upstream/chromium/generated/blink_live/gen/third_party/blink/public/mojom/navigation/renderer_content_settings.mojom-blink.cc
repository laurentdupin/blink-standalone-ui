// third_party/blink/public/mojom/navigation/renderer_content_settings.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "third_party/blink/public/mojom/navigation/renderer_content_settings.mojom-blink-test-utils.h"
...
size_t RendererContentSettings::Hash(size_t seed) const {
  seed = mojo::internal::WTFHash(seed, this->allow_script);
  seed = mojo::internal::WTFHash(seed, this->allow_image);
  seed = mojo::internal::WTFHash(seed, this->allow_popup);
  seed = mojo::internal::WTFHash(seed, this->allow_mixed_content);
  seed = mojo::internal::WTFHash(seed, this->allow_controlled_frame);
  return seed;
}
...
// static
bool StructTraits<::blink::mojom::blink::RendererContentSettings::DataView, ::blink::mojom::blink::RendererContentSettingsPtr>::Read(
    ::blink::mojom::blink::RendererContentSettings::DataView input,
    ::blink::mojom::blink::RendererContentSettingsPtr* output) {
  bool success = true;
  ::blink::mojom::blink::RendererContentSettingsPtr result(::blink::mojom::blink::RendererContentSettings::New());
