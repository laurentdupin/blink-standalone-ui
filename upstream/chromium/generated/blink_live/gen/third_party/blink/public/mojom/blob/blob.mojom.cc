...
void BlobProxy::Load(
    ::mojo::PendingReceiver<::network::mojom::URLLoader> in_loader, const std::string& in_request_method, ::network::mojom::HttpRequestHeadersPtr in_headers, ::mojo::PendingRemote<::network::mojom::URLLoaderClient> in_client) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool BlobStubDispatch::Accept(
  ...
  switch (static_cast<messages::Blob>(message->header()->name)) {
    ...
    case messages::Blob::kLoad: {
      ...
      ::network::mojom::HttpRequestHeadersPtr p_headers{};
...
void BlobInterceptorForTesting::Load(::mojo::PendingReceiver<::network::mojom::URLLoader> loader, const std::string& request_method, ::network::mojom::HttpRequestHeadersPtr headers, ::mojo::PendingRemote<::network::mojom::URLLoaderClient> client) {
