...
class  FileSystemAccessDataTransferTokenInterceptorForTesting : public FileSystemAccessDataTransferToken {
...
class  FileSystemAccessDataTransferTokenAsyncWaiter {
 public:
