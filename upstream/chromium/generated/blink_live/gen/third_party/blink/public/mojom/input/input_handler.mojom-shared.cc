...
NOINLINE static const char* ImeStateToStringHelper(ImeState value) {
  // Defined in a helper function to ensure that Clang generates a lookup table.
  switch(value) {
    case ImeState::kNone:
      return "kNone";
    case ImeState::kTextSuggestionSelected:
      return "kTextSuggestionSelected";
    default:
      return nullptr;
  }
}

std::string ImeStateToString(ImeState value) {
  const char *str = ImeStateToStringHelper(value);
  if (!str) {
    return base::StringPrintf("Unknown ImeState value: %i", static_cast<int32_t>(value));
  }
  return str;
}

std::ostream& operator<<(std::ostream& os, ImeState value) {
  return os << ImeStateToString(value);
}
...
bool WheelData_Data::Validate(
  ...
  if (!::blink::mojom::internal::RailsMode_Data
        ::Validate(object->rails_mode, validation_context))
    return false;
...
// static
bool FrameWidgetInputHandler_PasteFromImageBytes_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const FrameWidgetInputHandler_PasteFromImageBytes_Params_Data* object =
      static_cast<const FrameWidgetInputHandler_PasteFromImageBytes_Params_Data*>(data);

  if (!mojo::internal::ValidateInlinedUnionNonNullable(
          object->image_bytes, 1, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateInlinedUnion(object->image_bytes, validation_context))
    return false;

  if (!mojo::internal::ValidatePointerNonNullable(
          object->media_format, 2, validation_context)) {
    return false;
  }
  constexpr const mojo::internal::ContainerValidateParams& media_format_validate_params =
      mojo::internal::GetArrayValidator<0, false, nullptr>();
  if (!mojo::internal::ValidateContainer(object->media_format, validation_context,
                                         &media_format_validate_params)) {
    return false;
  }
...
FrameWidgetInputHandler_PasteFromImageBytes_Params_Data::FrameWidgetInputHandler_PasteFromImageBytes_Params_Data()
    : header_({sizeof(*this), 0}) {}
...
bool WidgetInputHandler_ImeSetComposition_Params_Data::Validate(
  ...
  if (!::blink::mojom::internal::ImeState_Data
        ::Validate(object->ime_state, validation_context))
    return false;
...
bool WidgetInputHandler_DispatchEvent_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidateStruct(object->original_event_for_gesture, validation_context))
    return false;
...
// static
bool WidgetInputHandler_PingMainThread_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const WidgetInputHandler_PingMainThread_Params_Data* object =
      static_cast<const WidgetInputHandler_PingMainThread_Params_Data*>(data);

  return true;
}

WidgetInputHandler_PingMainThread_Params_Data::WidgetInputHandler_PingMainThread_Params_Data()
    : header_({sizeof(*this), 0}) {}


// static
bool WidgetInputHandler_PingMainThread_ResponseParams_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const WidgetInputHandler_PingMainThread_ResponseParams_Data* object =
      static_cast<const WidgetInputHandler_PingMainThread_ResponseParams_Data*>(data);

  return true;
}

WidgetInputHandler_PingMainThread_ResponseParams_Data::WidgetInputHandler_PingMainThread_ResponseParams_Data()
    : header_({sizeof(*this), 0}) {}
...
// static
void TraceFormatTraits<::blink::mojom::ImeState>::WriteIntoTrace(
   perfetto::TracedValue context, ::blink::mojom::ImeState value) {
  return std::move(context).WriteString(::blink::mojom::ImeStateToString(value));
}
