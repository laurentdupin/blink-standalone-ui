...
RendererPreferences::RendererPreferences(
    ...
    ::blink::mojom::blink::WebRtcIpHandlingPolicy webrtc_ip_handling_policy_in,
    ::blink::Vector<::blink::mojom::blink::WebRtcIpHandlingUrlEntryPtr> webrtc_ip_handling_urls_in,
    std::optional<bool> webrtc_post_quantum_key_agreement_in,
    uint16_t webrtc_udp_min_port_in,
    uint16_t webrtc_udp_max_port_in,
    ::blink::Vector<::blink::String> webrtc_local_ips_allowed_urls_in,
    ::blink::mojom::blink::UserAgentOverridePtr user_agent_override_in,
    const ::blink::String& accept_languages_in,
    bool send_subresource_notification_in,
    bool plugin_fullscreen_allowed_in,
    bool caret_browsing_enabled_in,
    const ::blink::String& caption_font_family_name_in,
    int32_t caption_font_height_in,
    const ::blink::String& small_caption_font_family_name_in,
    int32_t small_caption_font_height_in,
    const ::blink::String& menu_font_family_name_in,
    int32_t menu_font_height_in,
    const ::blink::String& status_font_family_name_in,
    int32_t status_font_height_in,
    const ::blink::String& message_font_family_name_in,
    int32_t message_font_height_in,
    ::blink::Vector<uint16_t> explicitly_allowed_network_ports_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<::blink::mojom::blink::WebRtcIpHandlingUrlEntryPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
