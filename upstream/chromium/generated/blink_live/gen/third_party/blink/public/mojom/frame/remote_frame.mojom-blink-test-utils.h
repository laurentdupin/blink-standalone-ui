...
class  NavigationStateKeepAliveHandleInterceptorForTesting : public NavigationStateKeepAliveHandle {
  virtual NavigationStateKeepAliveHandle* GetForwardingInterface() = 0;
};
class  NavigationStateKeepAliveHandleAsyncWaiter {
 public:
...
class  RemoteFrameHostInterceptorForTesting : public RemoteFrameHost {
  virtual RemoteFrameHost* GetForwardingInterface() = 0;
  void SetInheritedEffectiveTouchAction(::cc::mojom::blink::TouchActionPtr touch_action) override;
  ...
  void RouteMessageEvent(const std::optional<::blink::LocalFrameToken>& source_frame_token, const ::scoped_refptr<const ::blink::SecurityOrigin>& source_origin, const ::scoped_refptr<const ::blink::SecurityOrigin>& target_origin, ::blink::BlinkTransferableMessage message) override;
  void PrintCrossProcessSubframe(const ::gfx::Rect& frame_content_rect, int32_t document_cookie) override;
  void Detach() override;
  void UpdateViewportIntersection(::blink::mojom::blink::ViewportIntersectionStatePtr intersection_state, ::blink::mojom::blink::FrameVisualPropertiesPtr visual_properties) override;
  void SynchronizeVisualProperties(::blink::mojom::blink::FrameVisualPropertiesPtr properties) override;
  void OpenURL(OpenURLParamsPtr params) override;
};
class  RemoteFrameHostAsyncWaiter {
 public:
...
class  RemoteFrameInterceptorForTesting : public RemoteFrame {
  ...
  void SetReplicatedName(const ::blink::String& name, const ::blink::String& unique_name) override;
  ...
  void UpdateUserActivationState(::blink::mojom::blink::UserActivationUpdateType state_update_type, ::blink::mojom::blink::UserActivationNotificationType notification_type) override;
  ...
  void DidSetFramePolicyHeaders(::network::mojom::blink::WebSandboxFlags sandbox_flags, const ::blink::Vector<::network::ParsedPermissionsPolicyDeclaration>& parsed_permissions_policy) override;
  ...
  void CreateRemoteChildren(::blink::Vector<CreateRemoteChildParamsPtr> params, const std::optional<::base::UnguessableToken>& navigation_metrics_token) override;
};
class  RemoteFrameAsyncWaiter {
 public:
...
class  RemoteMainFrameInterceptorForTesting : public RemoteMainFrame {
  virtual RemoteMainFrame* GetForwardingInterface() = 0;
};
class  RemoteMainFrameAsyncWaiter {
 public:
...
class  RemoteMainFrameHostInterceptorForTesting : public RemoteMainFrameHost {
...
class  RemoteMainFrameHostAsyncWaiter {
 public:
