...
// with not having this data in traces there.
  ...
  using RequestMouseLockChangeMojoCallback = base::OnceCallback<void(::blink::mojom::PointerLockResult)>;
...
class  PointerLockContextStubDispatch {
 public:
...
class  PointerLockContextRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class  PointerLockContextResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
