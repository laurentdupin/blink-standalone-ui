...
bool ViewportIntersectionState_Data::Validate(
  ...
  [[maybe_unused]] const ViewportIntersectionState_Data* object =
      static_cast<const ViewportIntersectionState_Data*>(data);
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->outermost_main_frame_size, 5, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->outermost_main_frame_scroll_position, 6, validation_context)) {
    return false;
  }
