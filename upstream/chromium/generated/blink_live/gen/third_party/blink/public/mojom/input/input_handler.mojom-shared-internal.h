...
static_assert(sizeof(PointerData_Data) == 88,
...
static_assert(sizeof(ScrollData_Data) == 32,
...
static_assert(sizeof(TapDownData_Data) == 16,
              "Bad sizeof(TapDownData_Data)");
...
struct TapDownData_UnserializedMessageContext
 ...
 public:
  ...
  TapDownData_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
...
static_assert(sizeof(GestureData_Data) == 112,
...
static_assert(sizeof(Event_Data) == 72,
...
static_assert(sizeof(DidOverscrollParams_Data) == 56,
              "Bad sizeof(DidOverscrollParams_Data)");
...
struct DidOverscrollParams_UnserializedMessageContext
 ...
 public:
  ...
  DidOverscrollParams_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
...
static_assert(sizeof(EditCommand_Data) == 24,
              "Bad sizeof(EditCommand_Data)");
...
struct EditCommand_UnserializedMessageContext
 ...
 public:
  ...
  EditCommand_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
...
static_assert(sizeof(SelectAroundCaretResult_Data) == 24,
              "Bad sizeof(SelectAroundCaretResult_Data)");
...
struct SelectAroundCaretResult_UnserializedMessageContext
 ...
 public:
  ...
  SelectAroundCaretResult_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
