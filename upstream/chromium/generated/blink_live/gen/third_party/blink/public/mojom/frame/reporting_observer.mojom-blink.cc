...
ReportBody::ReportBody(
    ::blink::Vector<ReportBodyElementPtr> body_in)
...
void ReportBody::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "body"), this->body,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<ReportBodyElementPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
void ReportingObserverProxy::Notify(
  ...
  mojo::Message message(
      std::to_underlying(messages::ReportingObserver::kNotify), kFlags, estimated_payload_size);
...
bool ReportingObserverRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::blink::ReportingObserver::Name_,
