...
class IsolatedAppPermissionPolicyEntry_Data;
...
class  BeginNavigationParams_Data {
 public:
  ...
  mojo::internal::Pointer<::mojo_base::mojom::internal::TimeTicks_Data> before_unload_dialog_opened;
  mojo::internal::Pointer<::mojo_base::mojom::internal::TimeTicks_Data> before_unload_dialog_closed;
  mojo::internal::Pointer<::mojo_base::mojom::internal::UnguessableToken_Data> script_tool_invocation_id;
...
static_assert(sizeof(BeginNavigationParams_Data) == 136,
...
class  CommonNavigationParams_Data {
 public:
  ...
  uint8_t has_possibly_filtered_user_gesture : 1;
...
static_assert(sizeof(CommonNavigationParams_Data) == 144,
...
static_assert(sizeof(NavigationTiming_Data) == 40,
...
class  IsolatedAppPermissionPolicyEntry_Data {
 public:
  ...
  mojo::internal::StructHeader header_;
  mojo::internal::Pointer<mojo::internal::String_Data> feature;
  mojo::internal::Pointer<mojo::internal::Array_Data<mojo::internal::Pointer<mojo::internal::String_Data>>> allowed_origins;

 private:
  friend class mojo::internal::MessageFragment<IsolatedAppPermissionPolicyEntry_Data>;

  IsolatedAppPermissionPolicyEntry_Data();
  ~IsolatedAppPermissionPolicyEntry_Data() = delete;
};
static_assert(sizeof(IsolatedAppPermissionPolicyEntry_Data) == 24,
              "Bad sizeof(IsolatedAppPermissionPolicyEntry_Data)");
// Used by IsolatedAppPermissionPolicyEntry::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView>
struct IsolatedAppPermissionPolicyEntry_UnserializedMessageContext
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  IsolatedAppPermissionPolicyEntry_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
      , user_data_(std::move(input)) {}
  ~IsolatedAppPermissionPolicyEntry_UnserializedMessageContext() override = default;
 ...
 private:
  // mojo::internal::UnserializedMessageContext:
  void Serialize(mojo::Message& message) override {
    mojo::internal::MessageFragment<IsolatedAppPermissionPolicyEntry_Data> fragment(message);
    mojo::internal::Serialize<DataView>(user_data_, fragment);
  }
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag
    IsolatedAppPermissionPolicyEntry_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
class  CommitNavigationParams_Data {
 public:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
  ...
  uint8_t should_skip_screenshot : 1;
  uint8_t force_new_document_sequence_number : 1;
  uint8_t is_initial_webui : 1;
  uint8_t pad17_[2];
  ...
  ::blink::mojom::internal::AgentClusterKey_Data agent_cluster_key;
  ...
  mojo::internal::Pointer<mojo::internal::Array_Data<mojo::internal::Pointer<::network::mojom::internal::LinkHeader_Data>>> early_hints_preloaded_resources;
  ...
  mojo::internal::Pointer<::blink::mojom::internal::LocalFrameToken_Data> commit_target_frame_token;
  mojo::internal::Pointer<mojo::internal::Array_Data<mojo::internal::Pointer<internal::IsolatedAppPermissionPolicyEntry_Data>>> isolated_app_policy;
  mojo::internal::Pointer<mojo::internal::String_Data> internal_scroll_to_text_fragment;
...
static_assert(sizeof(CommitNavigationParams_Data) == 368,
...
static_assert(sizeof(PageSwapEventParams_Data) == 32,
              "Bad sizeof(PageSwapEventParams_Data)");
...
struct PageSwapEventParams_UnserializedMessageContext
 ...
 public:
  ...
  PageSwapEventParams_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
