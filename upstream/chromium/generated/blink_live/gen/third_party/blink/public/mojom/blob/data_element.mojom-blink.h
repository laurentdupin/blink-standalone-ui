// third_party/blink/public/mojom/blob/data_element.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit
...
#include "third_party/blink/public/mojom/blob/data_element.mojom-blink-forward.h"  // IWYU pragma: export
...
// with not having this data in traces there.
  ...
  using RequestAsReplyCallback = base::OnceCallback<void(const ::blink::Vector<uint8_t>&)>;
  using RequestAsReplyMojoCallback = base::OnceCallback<void(const ::blink::Vector<uint8_t>&)>;
...
class  BytesProviderStubDispatch {
 public:
...
class  BytesProviderRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class  BytesProviderResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
class  DataElementBytes {
 public:
  ...
  DataElementBytes(
      uint64_t length,
      std::optional<::blink::Vector<uint8_t>> embedded_data,
...
template <>
struct  StructTraits<::blink::mojom::blink::DataElementBytes::DataView,
...
template <>
struct  StructTraits<::blink::mojom::blink::DataElementFile::DataView,
...
template <>
struct  StructTraits<::blink::mojom::blink::DataElementBlob::DataView,
...
template <>
struct  UnionTraits<::blink::mojom::blink::DataElement::DataView,
