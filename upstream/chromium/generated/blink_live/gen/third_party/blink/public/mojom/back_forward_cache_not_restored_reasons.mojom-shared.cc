...
// static
bool SameOriginBfcacheNotRestoredDetails_Data::Validate(
    const void* data,
  ...
  [[maybe_unused]] const SameOriginBfcacheNotRestoredDetails_Data* object =
      static_cast<const SameOriginBfcacheNotRestoredDetails_Data*>(data);
