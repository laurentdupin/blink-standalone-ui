...
class BlobURLStore
 ...
 public:
  ...
  enum MethodMinVersions : uint32_t {
    ...
    kResolveAsBlobURLTokenMinVersion = 0,
  };
...
// with not having this data in traces there.
  ...
  struct ResolveAsBlobURLToken_Sym {
    NOINLINE static uint32_t IPCStableHash();
  };
  ...
  virtual bool Register(::mojo::PendingRemote<::blink::mojom::Blob> blob, const ::GURL& url);
  using RegisterCallback = base::OnceCallback<void()>;
  using RegisterMojoCallback = base::OnceCallback<void()>;

  virtual void Register(::mojo::PendingRemote<::blink::mojom::Blob> blob, const ::GURL& url, RegisterCallback callback) = 0;

  virtual void Revoke(const ::GURL& url) = 0;

  virtual void ResolveAsURLLoaderFactory(const ::GURL& url, ::mojo::PendingReceiver<::network::mojom::URLLoaderFactory> factory) = 0;

  virtual void ResolveAsBlobURLToken(const ::GURL& url, ::mojo::PendingReceiver<BlobURLToken> token, bool is_top_level_navigation) = 0;
};
...
// with not having this data in traces there.
  ...
  using GetTokenMojoCallback = base::OnceCallback<void(const ::base::UnguessableToken&)>;
...
class  BlobURLStoreProxy
 ...
 public:
  ...
  bool Register(::mojo::PendingRemote<::blink::mojom::Blob> blob, const ::GURL& url) final;
  
  void Register(::mojo::PendingRemote<::blink::mojom::Blob> blob, const ::GURL& url, RegisterCallback callback) final;
  
  void Revoke(const ::GURL& url) final;
  
  void ResolveAsURLLoaderFactory(const ::GURL& url, ::mojo::PendingReceiver<::network::mojom::URLLoaderFactory> factory) final;
  
  void ResolveAsBlobURLToken(const ::GURL& url, ::mojo::PendingReceiver<BlobURLToken> token, bool is_top_level_navigation) final;
...
class  BlobURLStoreStubDispatch {
 public:
...
class  BlobURLTokenStubDispatch {
 public:
...
class  BlobURLStoreRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class  BlobURLTokenRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class  BlobURLStoreResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class  BlobURLTokenResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
