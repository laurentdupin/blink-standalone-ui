...
// with not having this data in traces there.
  ...
  virtual void Navigate(const ::GURL& url, ::base::TimeTicks navigation_start_time, ::mojo_base::mojom::String16Ptr embedder_shared_storage_context) = 0;
...
class  FencedFrameOwnerHostProxy
 ...
 public:
  ...
  void Navigate(const ::GURL& url, ::base::TimeTicks navigation_start_time, ::mojo_base::mojom::String16Ptr embedder_shared_storage_context) final;
