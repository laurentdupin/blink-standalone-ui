...
static_assert(sizeof(Accelerator_Data) == 16,
              "Bad sizeof(Accelerator_Data)");
// Used by Accelerator::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView>
struct Accelerator_UnserializedMessageContext
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  Accelerator_UnserializedMessageContext(
...
const mojo::internal::UnserializedMessageContext::Tag
    Accelerator_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
class  FormRendererId_Data {
 public:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
...
class  CustomContextMenuItem_Data {
 public:
  ...
  int32_t type;
  int32_t action;
  mojo::internal::Pointer<::mojo_base::mojom::internal::String16_Data> feature_name;
...
static_assert(sizeof(CustomContextMenuItem_Data) == 72,
...
class  UntrustworthyContextMenuParams_Data {
 public:
  ...
  uint8_t annotation_type_$flag : 1;
  uint8_t opened_from_interest_for : 1;
  ...
  int32_t annotation_type_$value;
...
static_assert(sizeof(UntrustworthyContextMenuParams_Data) == 208,
