...
bool TransferableMessage_Data::Validate(
  ...
  [[maybe_unused]] const TransferableMessage_Data* object =
      static_cast<const TransferableMessage_Data*>(data);
  ...
  if (!mojo::internal::ValidateStruct(object->task_state_id, validation_context))
    return false;
