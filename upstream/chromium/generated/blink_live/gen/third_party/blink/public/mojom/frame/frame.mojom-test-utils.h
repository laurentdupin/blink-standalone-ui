...
class  UnboundedSurfaceHostInterceptorForTesting : public UnboundedSurfaceHost {
  ...
  void GetCompositorFrameSink(::mojo::PendingReceiver<::viz::mojom::CompositorFrameSink> sink, ::mojo::PendingRemote<::viz::mojom::CompositorFrameSinkClient> client) override;
...
class  LocalFrameHostInterceptorForTesting : public LocalFrameHost {
  ...
  void GoToEntryAtOffset(int32_t offset, bool has_user_gesture, ::base::TimeTicks actual_navigation_start, ::blink::mojom::TaskAttributionIdPtr soft_navigation_heuristics_task_id) override;
  void NavigateToNavigationApiKey(const std::string& key, bool has_user_gesture, ::base::TimeTicks actual_navigation_start, ::blink::mojom::TaskAttributionIdPtr soft_navigation_heuristics_task_id) override;
  ...
  void ShowContextMenu(::mojo::PendingAssociatedRemote<::blink::mojom::ContextMenuClient> client, ::blink::mojom::UntrustworthyContextMenuParamsPtr params) override;
  ...
  void SendFencedFrameReportingBeacon(const std::string& event_data, const std::string& event_type, const std::vector<::blink::mojom::ReportingDestination>& destinations, bool cross_origin_exposed) override;
  ...
  void SetFencedFrameAutomaticBeaconReportEventData(::blink::mojom::AutomaticBeaconType event_type, const std::string& event_data, const std::vector<::blink::mojom::ReportingDestination>& destinations, bool once, bool cross_origin_exposed) override;
  ...
  void StartDragging(::blink::mojom::DragDataPtr drag_data, ::blink::mojom::AllowedDragOperationsPtr operations_allowed, const ::SkBitmap& image, const ::gfx::Vector2d& cursor_offset_in_dip, const ::gfx::Rect& drag_obj_rect_in_dip, ::blink::mojom::DragEventSourceInfoPtr event_info) override;
...
class  LocalFrameHostAsyncWaiter {
 public:
  ...
  void InitializeCrashReportContext(
      uint64_t length, ::mojo_base::mojom::UnsafeSharedMemoryRegionPtr* out_region);
  ::mojo_base::mojom::UnsafeSharedMemoryRegionPtr InitializeCrashReportContext(uint64_t length);
...
class  LocalFrameInterceptorForTesting : public LocalFrame {
  ...
  void PostMessageEvent(const std::optional<::blink::RemoteFrameToken>& source_frame_token, const std::optional<::url::Origin>& source_origin, const std::optional<::url::Origin>& target_origin, ::blink::TransferableMessage message) override;
  void JavaScriptMethodExecuteRequest(const ::std::u16string& object_name, const ::std::u16string& method_name, ::base::ListValue arguments, bool wants_result, JavaScriptMethodExecuteRequestCallback callback) override;
  ...
  void InvokeScriptToolForInspector(const ::base::UnguessableToken& invocation_id, const std::string& tool_name, const std::string& input_arguments, InvokeScriptToolForInspectorCallback callback) override;
...
class  LocalFrameAsyncWaiter {
 public:
  ...
  void JavaScriptMethodExecuteRequest(
      const ::std::u16string& object_name, const ::std::u16string& method_name, ::base::ListValue arguments, bool wants_result, ::base::Value* out_result);
  ::base::Value JavaScriptMethodExecuteRequest(const ::std::u16string& object_name, const ::std::u16string& method_name, ::base::ListValue arguments, bool wants_result);
  ...
  void InvokeScriptToolForInspector(
      const ::base::UnguessableToken& invocation_id, const std::string& tool_name, const std::string& input_arguments, bool* out_success);
  bool InvokeScriptToolForInspector(const ::base::UnguessableToken& invocation_id, const std::string& tool_name, const std::string& input_arguments);
...
class  LocalMainFrameHostInterceptorForTesting : public LocalMainFrameHost {
  ...
  void DidChangeThemeColor(::skia::mojom::SkColorPtr theme_color) override;
  void DidChangeBackgroundColor(::skia::mojom::SkColor4fPtr background_color, bool color_adjust) override;
