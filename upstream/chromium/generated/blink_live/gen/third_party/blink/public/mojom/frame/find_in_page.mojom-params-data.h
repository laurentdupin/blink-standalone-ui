...
namespace internal {
class  FindInPage_Find_Params_Data {
 public:
...
class  FindInPage_StopFinding_Params_Data {
 public:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
...
class  FindInPage_ClearActiveFindMatch_Params_Data {
 public:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
...
class  FindInPage_SetClient_Params_Data {
 public:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
...
class  FindInPageClient_SetNumberOfMatches_Params_Data {
 public:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
...
class  FindInPageClient_SetActiveMatch_Params_Data {
 public:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
...
class FindInPage_Find_ParamsDataView {
 public:
  ...
  [[nodiscard]] bool ReadSearchText(UserType* output) {
 ...
 public:
  ...
  StopFindAction action() const {
    return ::mojo::internal::ToKnownEnumValueHelper(
          static_cast<::blink::mojom::StopFindAction>(data_->action));
  }
 private:
...
class FindInPage_SetClient_ParamsDataView {
 public:
  ...
  UserType TakeClient() {
    UserType result;
    bool ret =
        mojo::internal::Deserialize<mojo::InterfacePtrDataView<::blink::mojom::FindInPageClientInterfaceBase>>(
...
class FindInPageClient_SetNumberOfMatches_ParamsDataView {
 public:
  ...
  FindMatchUpdateType update_type() const {
    return ::mojo::internal::ToKnownEnumValueHelper(
          static_cast<::blink::mojom::FindMatchUpdateType>(data_->update_type));
  }
 private:
...
class FindInPageClient_SetActiveMatch_ParamsDataView {
 public:
  ...
  template <typename UserType>
  [[nodiscard]] bool ReadActiveMatchRect(UserType* output) {
