// third_party/blink/public/mojom/page/draggable_region.mojom.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef THIRD_PARTY_BLINK_PUBLIC_MOJOM_PAGE_DRAGGABLE_REGION_MOJOM_H_
#define THIRD_PARTY_BLINK_PUBLIC_MOJOM_PAGE_DRAGGABLE_REGION_MOJOM_H_
...
#include "third_party/blink/public/mojom/page/draggable_region.mojom-forward.h"  // IWYU pragma: export
 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        DraggableRegion::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
template <>
struct  StructTraits<::blink::mojom::DraggableRegion::DataView,
                                         ::blink::mojom::DraggableRegionPtr> {
  static bool IsNull(const ::blink::mojom::DraggableRegionPtr& input) { return !input; }
  static void SetToNull(::blink::mojom::DraggableRegionPtr* output) { output->reset(); }

  static const decltype(::blink::mojom::DraggableRegion::bounds)& bounds(
      const ::blink::mojom::DraggableRegionPtr& input) {
    return input->bounds;
  }

  static decltype(::blink::mojom::DraggableRegion::draggable) draggable(
      const ::blink::mojom::DraggableRegionPtr& input) {
    return input->draggable;
  }

  static bool Read(::blink::mojom::DraggableRegion::DataView input, ::blink::mojom::DraggableRegionPtr* output);
};

}  // namespace mojo

#endif  // THIRD_PARTY_BLINK_PUBLIC_MOJOM_PAGE_DRAGGABLE_REGION_MOJOM_H_