...
bool ResourceLoadInfo_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->proxy_chain, 12, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->raw_body_bytes, 14, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateStruct(object->raw_body_bytes, validation_context))
    return false;

  if (!mojo::internal::ValidatePointerNonNullable(
          object->total_received_bytes, 15, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateStruct(object->total_received_bytes, validation_context))
    return false;
