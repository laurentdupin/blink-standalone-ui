...
PolicyContainerPolicies::PolicyContainerPolicies(
    ...
    ::blink::Vector<::network::mojom::blink::ContentSecurityPolicyPtr> content_security_policies_in,
...
void PolicyContainerHostProxy::SetReferrerPolicy(
  ...
  mojo::Message message(
      std::to_underlying(messages::PolicyContainerHost::kSetReferrerPolicy), kFlags, estimated_payload_size);
...
void PolicyContainerHostProxy::AddContentSecurityPolicies(
    ::blink::Vector<::network::mojom::blink::ContentSecurityPolicyPtr> in_content_security_policies) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::PolicyContainerHost::kAddContentSecurityPolicies), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool PolicyContainerHostStubDispatch::Accept(
  ...
  switch (static_cast<messages::PolicyContainerHost>(message->header()->name)) {
    ...
    case messages::PolicyContainerHost::kAddContentSecurityPolicies: {
      ...
      bool success = true;
      ::blink::Vector<::network::mojom::blink::ContentSecurityPolicyPtr> p_content_security_policies{};
...
bool PolicyContainerHostRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::blink::PolicyContainerHost::Name_,
...
void PolicyContainerHostInterceptorForTesting::AddContentSecurityPolicies(::blink::Vector<::network::mojom::blink::ContentSecurityPolicyPtr> content_security_policies) {
