...
using UnboundedSurfaceHostInterfaceBase = UnboundedSurfaceHostInterfaceBase;
using UnboundedSurfaceClientInterfaceBase = UnboundedSurfaceClientInterfaceBase;
...
constexpr uint64_t kMaxCrashReportContextSize = 65536ULL;
...
using SubframeResourceLengthsPtr = mojo::StructPtr<SubframeResourceLengths>;
