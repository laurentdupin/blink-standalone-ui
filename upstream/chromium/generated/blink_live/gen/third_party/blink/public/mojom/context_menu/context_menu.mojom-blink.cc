...
size_t Accelerator::Hash(size_t seed) const {
  ...
  seed = mojo::internal::WTFHash(seed, this->modifiers);
  return seed;
}
...
CustomContextMenuItem::CustomContextMenuItem(
    ...
    const ::blink::String& icon_in,
    const ::blink::String& tool_tip_in,
    CustomContextMenuItemType type_in,
    int32_t action_in,
    const ::blink::String& feature_name_in,
    ...
    ::blink::Vector<CustomContextMenuItemPtr> submenu_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<CustomContextMenuItemPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
UntrustworthyContextMenuParams::UntrustworthyContextMenuParams(
    ...
    const ::blink::String& link_text_in,
    ...
    const ::blink::String& selection_text_in,
    const ::blink::String& title_text_in,
    const ::blink::String& alt_text_in,
    const ::blink::String& suggested_filename_in,
    const ::blink::String& misspelled_word_in,
    ::blink::Vector<::blink::String> dictionary_suggestions_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type std::optional<::blink::mojom::blink::AnnotationType>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
void ContextMenuClientProxy::ContextMenuClosed(
    const ::blink::KURL& in_link_followed, const std::optional<::blink::Impression>& in_impression) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool ContextMenuClientStubDispatch::Accept(
  ...
  switch (static_cast<messages::ContextMenuClient>(message->header()->name)) {
    ...
    case messages::ContextMenuClient::kContextMenuClosed: {
      ...
      std::optional<::blink::Impression> p_impression{};
...
bool ContextMenuClientRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::blink::ContextMenuClient::Name_,
...
// static
bool StructTraits<::blink::mojom::blink::Accelerator::DataView, ::blink::mojom::blink::AcceleratorPtr>::Read(
    ::blink::mojom::blink::Accelerator::DataView input,
    ::blink::mojom::blink::AcceleratorPtr* output) {
  bool success = true;
  ::blink::mojom::blink::AcceleratorPtr result(::blink::mojom::blink::Accelerator::New());
...
// static
bool StructTraits<::blink::mojom::blink::FormRendererId::DataView, ::blink::mojom::blink::FormRendererIdPtr>::Read(
    ::blink::mojom::blink::FormRendererId::DataView input,
    ::blink::mojom::blink::FormRendererIdPtr* output) {
  bool success = true;
  ::blink::mojom::blink::FormRendererIdPtr result(::blink::mojom::blink::FormRendererId::New());
...
void ContextMenuClientInterceptorForTesting::ContextMenuClosed(const ::blink::KURL& link_followed, const std::optional<::blink::Impression>& impression) {
