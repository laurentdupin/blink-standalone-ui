...
class BLINK_PLATFORM_EXPORT DevicePostureClient
...
class BLINK_PLATFORM_EXPORT DevicePostureClientProxy
...
class BLINK_PLATFORM_EXPORT DevicePostureClientStubDispatch {
 public:
...
class BLINK_PLATFORM_EXPORT DevicePostureClientRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
