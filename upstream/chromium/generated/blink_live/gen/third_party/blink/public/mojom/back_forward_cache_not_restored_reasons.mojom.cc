...
bool StructTraits<::blink::mojom::SameOriginBfcacheNotRestoredDetails::DataView, ::blink::mojom::SameOriginBfcacheNotRestoredDetailsPtr>::Read(
    ::blink::mojom::SameOriginBfcacheNotRestoredDetails::DataView input,
    ::blink::mojom::SameOriginBfcacheNotRestoredDetailsPtr* output) {
  bool success = true;
...
bool StructTraits<::blink::mojom::BackForwardCacheNotRestoredReasons::DataView, ::blink::mojom::BackForwardCacheNotRestoredReasonsPtr>::Read(
    ::blink::mojom::BackForwardCacheNotRestoredReasons::DataView input,
    ::blink::mojom::BackForwardCacheNotRestoredReasonsPtr* output) {
  bool success = true;
