...
#include "ui/base/cursor/mojom/cursor.mojom-forward.h"
...
// with not having this data in traces there.
  ...
  virtual void SetCursor(::ui::mojom::CursorPtr cursor) = 0;

  virtual void UpdateTooltipUnderCursor(::mojo_base::mojom::String16Ptr tooltip_text, ::mojo_base::mojom::TextDirection text_direction_hint) = 0;

  virtual void UpdateTooltipFromKeyboard(::mojo_base::mojom::String16Ptr tooltip_text, ::mojo_base::mojom::TextDirection text_direction_hint, const ::gfx::Rect& bounds) = 0;

  virtual void ClearKeyboardTriggeredTooltip() = 0;

  virtual void TextInputStateChanged(::ui::mojom::TextInputStatePtr state) = 0;

  virtual void SelectionBoundsChanged(const ::gfx::Rect& anchor_rect, ::mojo_base::mojom::TextDirection anchor_dir, const ::gfx::Rect& focus_rect, ::mojo_base::mojom::TextDirection focus_dir, const ::gfx::Rect& bounding_box_rect, bool is_anchor_first) = 0;
...
// with not having this data in traces there.
  ...
  virtual void UpdateVisualProperties(::blink::mojom::VisualPropertiesPtr visual_properties) = 0;
...
class  WidgetHostProxy
 ...
 public:
  ...
  void SetCursor(::ui::mojom::CursorPtr cursor) final;
  
  void UpdateTooltipUnderCursor(::mojo_base::mojom::String16Ptr tooltip_text, ::mojo_base::mojom::TextDirection text_direction_hint) final;
  
  void UpdateTooltipFromKeyboard(::mojo_base::mojom::String16Ptr tooltip_text, ::mojo_base::mojom::TextDirection text_direction_hint, const ::gfx::Rect& bounds) final;
  
  void ClearKeyboardTriggeredTooltip() final;
  
  void TextInputStateChanged(::ui::mojom::TextInputStatePtr state) final;
  
  void SelectionBoundsChanged(const ::gfx::Rect& anchor_rect, ::mojo_base::mojom::TextDirection anchor_dir, const ::gfx::Rect& focus_rect, ::mojo_base::mojom::TextDirection focus_dir, const ::gfx::Rect& bounding_box_rect, bool is_anchor_first) final;
...
class  WidgetProxy
 ...
 public:
  ...
  void UpdateVisualProperties(::blink::mojom::VisualPropertiesPtr visual_properties) final;
...
class  InitialFrameSinkParams {
 public:
  ...
  InitialFrameSinkParams(
      ...
      ::mojo::PendingReceiver<::viz::mojom::CompositorFrameSinkClient> initial_frame_sink_client,
...
template <>
struct  StructTraits<::blink::mojom::InitialFrameSinkParams::DataView,
                                         ::blink::mojom::InitialFrameSinkParamsPtr> {
  static bool IsNull(const ::blink::mojom::InitialFrameSinkParamsPtr& input) { return !input; }
  static void SetToNull(::blink::mojom::InitialFrameSinkParamsPtr* output) { output->reset(); }

  static  decltype(::blink::mojom::InitialFrameSinkParams::initial_frame_sink)& initial_frame_sink(
       ::blink::mojom::InitialFrameSinkParamsPtr& input) {
    return input->initial_frame_sink;
  }

  static  decltype(::blink::mojom::InitialFrameSinkParams::initial_frame_sink_client)& initial_frame_sink_client(
       ::blink::mojom::InitialFrameSinkParamsPtr& input) {
    return input->initial_frame_sink_client;
  }

  static  decltype(::blink::mojom::InitialFrameSinkParams::initial_viz_rir_client)& initial_viz_rir_client(
       ::blink::mojom::InitialFrameSinkParamsPtr& input) {
    return input->initial_viz_rir_client;
  }

  static bool Read(::blink::mojom::InitialFrameSinkParams::DataView input, ::blink::mojom::InitialFrameSinkParamsPtr* output);
};
