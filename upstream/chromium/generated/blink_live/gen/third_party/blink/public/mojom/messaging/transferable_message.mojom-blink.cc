...
TransferableMessage::TransferableMessage(
    ::blink::mojom::blink::CloneableMessagePtr message_in,
    ::blink::Vector<::blink::mojom::blink::MessagePortDescriptorPtr> ports_in,
    ::blink::Vector<::blink::mojom::blink::MessagePortDescriptorPtr> stream_channels_in,
    ::blink::Vector<::blink::mojom::blink::SerializedArrayBufferContentsPtr> array_buffer_contents_array_in,
    ::blink::Vector<::blink::mojom::blink::SerializedStaticBitmapImagePtr> image_bitmap_contents_array_in,
    ...
    ::blink::mojom::blink::TaskAttributionIdPtr task_state_id_in)
...
void TransferableMessage::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      ...
      "<value of type ::blink::mojom::blink::CloneableMessagePtr>"
#else
      "<value>"
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "ports"), this->ports,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<::blink::mojom::blink::MessagePortDescriptorPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<::blink::mojom::blink::SerializedArrayBufferContentsPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<::blink::mojom::blink::SerializedStaticBitmapImagePtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
