...
StorageKey::StorageKey(
    ...
    ::network::mojom::blink::SchemefulSitePtr top_level_site_in,
    const std::optional<::base::UnguessableToken>& nonce_in,
    ::blink::mojom::blink::AncestorChainBit ancestor_chain_bit_in,
    ::network::mojom::blink::SchemefulSitePtr top_level_site_if_third_party_enabled_in,
...
bool StructTraits<::blink::mojom::blink::StorageKey::DataView, ::blink::mojom::blink::StorageKeyPtr>::Read(
    ::blink::mojom::blink::StorageKey::DataView input,
    ::blink::mojom::blink::StorageKeyPtr* output) {
  bool success = true;
