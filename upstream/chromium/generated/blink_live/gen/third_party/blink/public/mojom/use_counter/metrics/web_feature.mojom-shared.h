// third_party/blink/public/mojom/use_counter/metrics/web_feature.mojom-shared.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2016 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef THIRD_PARTY_BLINK_PUBLIC_MOJOM_USE_COUNTER_METRICS_WEB_FEATURE_MOJOM_SHARED_H_
#define THIRD_PARTY_BLINK_PUBLIC_MOJOM_USE_COUNTER_METRICS_WEB_FEATURE_MOJOM_SHARED_H_
...
struct Serializer<::blink::mojom::WebFeature, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::blink::mojom::WebFeature>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::blink::mojom::WebFeature, UserType> ||
                        HasInfallibleConversion(::blink::mojom::WebFeature()),
                    "::blink::mojom::WebFeature does not have an infallible conversion, "
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_MOJOM_USE_COUNTER_METRICS_WEB_FEATURE_MOJOM_SHARED_H_