...
void SurfaceEmbedderProxy::SetLocalSurfaceId(
  ...
  mojo::Message message(
      std::to_underlying(messages::SurfaceEmbedder::kSetLocalSurfaceId), kFlags, estimated_payload_size);
...
void SurfaceEmbedderProxy::OnOpacityChanged(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::SurfaceEmbedder::kOnOpacityChanged), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool SurfaceEmbedderRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::blink::SurfaceEmbedder::Name_,
...
void EmbeddedFrameSinkClientProxy::BindSurfaceEmbedder(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::EmbeddedFrameSinkClient::kBindSurfaceEmbedder), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool EmbeddedFrameSinkClientRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::blink::EmbeddedFrameSinkClient::Name_,
...
EmbeddedFrameSinkProvider::IPCStableHashFunction EmbeddedFrameSinkProvider::MessageToMethodInfo_(mojo::Message& message) {
  ...
  switch (static_cast<messages::EmbeddedFrameSinkProvider>(message.name())) {
    ...
    case messages::EmbeddedFrameSinkProvider::kSetParentFrameSinkId: {
      return &EmbeddedFrameSinkProvider::SetParentFrameSinkId_Sym::IPCStableHash;
    }
...
const char* EmbeddedFrameSinkProvider::MessageToMethodName_(mojo::Message& message) {
  ...
  if (!is_response) {
    switch (static_cast<messages::EmbeddedFrameSinkProvider>(message.name())) {
      ...
      case messages::EmbeddedFrameSinkProvider::kSetParentFrameSinkId:
            return "Receive blink::mojom::EmbeddedFrameSinkProvider::SetParentFrameSinkId";
      case messages::EmbeddedFrameSinkProvider::kRegisterEmbeddedFrameSinkBundle:
    ...
    switch (static_cast<messages::EmbeddedFrameSinkProvider>(message.name())) {
      ...
      case messages::EmbeddedFrameSinkProvider::kSetParentFrameSinkId:
            return "Receive reply blink::mojom::EmbeddedFrameSinkProvider::SetParentFrameSinkId";
      case messages::EmbeddedFrameSinkProvider::kRegisterEmbeddedFrameSinkBundle:
...
uint32_t EmbeddedFrameSinkProvider::SetParentFrameSinkId_Sym::IPCStableHash() {
  // This method's address is used for identifying the mojo method name after
  // symbolization. So each IPCStableHash should have a unique address.
  // We cannot use NO_CODE_FOLDING() here - it relies on the uniqueness of
  // __LINE__ value, which is not unique across different mojo modules.
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x10d396dd;  // IPCStableHash for blink::mojom::EmbeddedFrameSinkProvider::SetParentFrameSinkId
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
void EmbeddedFrameSinkProviderProxy::RegisterEmbeddedFrameSink(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::EmbeddedFrameSinkProvider::kRegisterEmbeddedFrameSink), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void EmbeddedFrameSinkProviderProxy::SetParentFrameSinkId(
    const ::viz::FrameSinkId& in_frame_sink_id, const ::viz::FrameSinkId& in_parent_frame_sink_id) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "Send blink::mojom::EmbeddedFrameSinkProvider::SetParentFrameSinkId", "input_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("frame_sink_id"), in_frame_sink_id,
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::EmbeddedFrameSinkProvider::kSetParentFrameSinkId), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
      ::blink::mojom::internal::EmbeddedFrameSinkProvider_SetParentFrameSinkId_Params_Data> params(
          message);
  params.Allocate();
  mojo::internal::MessageFragment<
      typename decltype(params->frame_sink_id)::BaseType> frame_sink_id_fragment(
  ...
  MOJO_INTERNAL_CHECK_SERIALIZATION(
    ...
    !(params->frame_sink_id.is_null()),
    mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
    "null frame_sink_id in EmbeddedFrameSinkProvider.SetParentFrameSinkId request");
  mojo::internal::MessageFragment<
      typename decltype(params->parent_frame_sink_id)::BaseType> parent_frame_sink_id_fragment(
          params.message());
  ...
  MOJO_INTERNAL_CHECK_SERIALIZATION(
    ...
    !(params->parent_frame_sink_id.is_null()),
    mojo::internal::VALIDATION_ERROR_UNEXPECTED_NULL_POINTER,
    "null parent_frame_sink_id in EmbeddedFrameSinkProvider.SetParentFrameSinkId request");

#if defined(ENABLE_IPC_FUZZER)
  message.set_interface_name(EmbeddedFrameSinkProvider::Name_);
  message.set_method_name("SetParentFrameSinkId");
#endif
  // This return value may be ignored as false implies the Connector has
  // encountered an error, which will be visible through other means.
  ::mojo::internal::SendMojoMessage(*receiver_, message);
...
void EmbeddedFrameSinkProviderProxy::RegisterEmbeddedFrameSinkBundle(
    const ::viz::FrameSinkBundleId& in_bundle_id, ::mojo::PendingReceiver<::viz::mojom::blink::FrameSinkBundle> in_receiver, ::mojo::PendingRemote<::viz::mojom::blink::FrameSinkBundleClient> in_client) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("receiver"), in_receiver,
                        "<value of type ::mojo::PendingReceiver<::viz::mojom::blink::FrameSinkBundle>>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("client"), in_client,
                        "<value of type ::mojo::PendingRemote<::viz::mojom::blink::FrameSinkBundleClient>>");
   });
#endif
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::EmbeddedFrameSinkProvider::kRegisterEmbeddedFrameSinkBundle), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void EmbeddedFrameSinkProviderProxy::CreateCompositorFrameSink(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::EmbeddedFrameSinkProvider::kCreateCompositorFrameSink), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void EmbeddedFrameSinkProviderProxy::CreateBundledCompositorFrameSink(
    const ::viz::FrameSinkId& in_frame_sink_id, const ::viz::FrameSinkBundleId& in_bundle_id, ::mojo::PendingRemote<::viz::mojom::blink::CompositorFrameSinkClient> in_client, ::mojo::PendingReceiver<::viz::mojom::blink::CompositorFrameSink> in_sink) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::EmbeddedFrameSinkProvider::kCreateBundledCompositorFrameSink), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void EmbeddedFrameSinkProviderProxy::CreateSimpleCompositorFrameSink(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::EmbeddedFrameSinkProvider::kCreateSimpleCompositorFrameSink), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void EmbeddedFrameSinkProviderProxy::ConnectToEmbedder(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::EmbeddedFrameSinkProvider::kConnectToEmbedder), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void EmbeddedFrameSinkProviderProxy::RegisterFrameSinkHierarchy(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::EmbeddedFrameSinkProvider::kRegisterFrameSinkHierarchy), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void EmbeddedFrameSinkProviderProxy::UnregisterFrameSinkHierarchy(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::EmbeddedFrameSinkProvider::kUnregisterFrameSinkHierarchy), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool EmbeddedFrameSinkProviderStubDispatch::Accept(
  ...
  switch (static_cast<messages::EmbeddedFrameSinkProvider>(message->header()->name)) {
    ...
    case messages::EmbeddedFrameSinkProvider::kSetParentFrameSinkId: {
      DCHECK(message->is_serialized());
      internal::EmbeddedFrameSinkProvider_SetParentFrameSinkId_Params_Data* params =
          reinterpret_cast<internal::EmbeddedFrameSinkProvider_SetParentFrameSinkId_Params_Data*>(
              message->mutable_payload());
      ...
      ::viz::FrameSinkId p_frame_sink_id{};
      ::viz::FrameSinkId p_parent_frame_sink_id{};
      EmbeddedFrameSinkProvider_SetParentFrameSinkId_ParamsDataView input_data_view(params, message);
    ...
    case messages::EmbeddedFrameSinkProvider::kRegisterEmbeddedFrameSinkBundle: {
      ...
      ::mojo::PendingRemote<::viz::mojom::blink::FrameSinkBundleClient> p_client{};
    ...
    case messages::EmbeddedFrameSinkProvider::kUnregisterFrameSinkHierarchy: {
      ...
      // Validation for EmbeddedFrameSinkProvider.8
      bool success = true;
      ::viz::FrameSinkId p_frame_sink_id{};
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            EmbeddedFrameSinkProvider::Name_, 8, false);
        return false;
      }
      // A null |impl| means no implementation was bound.
      DCHECK(impl);
...
static const mojo::internal::GenericValidationInfo kEmbeddedFrameSinkProviderValidationInfo[] = {
    { &internal::EmbeddedFrameSinkProvider_RegisterEmbeddedFrameSink_Params_Data::Validate,
     nullptr /* no response */},
    { &internal::EmbeddedFrameSinkProvider_SetParentFrameSinkId_Params_Data::Validate,
     nullptr /* no response */},
...
bool EmbeddedFrameSinkProviderRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::blink::EmbeddedFrameSinkProvider::Name_,
...
void EmbeddedFrameSinkProviderInterceptorForTesting::SetParentFrameSinkId(const ::viz::FrameSinkId& frame_sink_id, const ::viz::FrameSinkId& parent_frame_sink_id) {
  GetForwardingInterface()->SetParentFrameSinkId(
    std::move(frame_sink_id)
    , 
    std::move(parent_frame_sink_id)
    );
}
void EmbeddedFrameSinkProviderInterceptorForTesting::RegisterEmbeddedFrameSinkBundle(const ::viz::FrameSinkBundleId& bundle_id, ::mojo::PendingReceiver<::viz::mojom::blink::FrameSinkBundle> receiver, ::mojo::PendingRemote<::viz::mojom::blink::FrameSinkBundleClient> client) {
...
void EmbeddedFrameSinkProviderInterceptorForTesting::CreateBundledCompositorFrameSink(const ::viz::FrameSinkId& frame_sink_id, const ::viz::FrameSinkBundleId& bundle_id, ::mojo::PendingRemote<::viz::mojom::blink::CompositorFrameSinkClient> client, ::mojo::PendingReceiver<::viz::mojom::blink::CompositorFrameSink> sink) {
