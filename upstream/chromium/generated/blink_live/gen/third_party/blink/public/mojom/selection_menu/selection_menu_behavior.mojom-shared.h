// third_party/blink/public/mojom/selection_menu/selection_menu_behavior.mojom-shared.h is auto generated by mojom_bindings_generator.py, do not edit
...
#include "third_party/blink/public/mojom/selection_menu/selection_menu_behavior.mojom-data-view.h"  // IWYU pragma: export
...
struct Serializer<::blink::mojom::SelectionMenuBehavior, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::blink::mojom::SelectionMenuBehavior>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::blink::mojom::SelectionMenuBehavior, UserType> ||
                        HasInfallibleConversion(::blink::mojom::SelectionMenuBehavior()),
                    "::blink::mojom::SelectionMenuBehavior does not have an infallible conversion, "
...
template <>
struct  TraceFormatTraits<::blink::mojom::SelectionMenuBehavior> {
 static void WriteIntoTrace(perfetto::TracedValue context, ::blink::mojom::SelectionMenuBehavior value);
};
