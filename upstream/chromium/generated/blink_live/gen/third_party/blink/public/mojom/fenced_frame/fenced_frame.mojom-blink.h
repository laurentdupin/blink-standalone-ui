...
// with not having this data in traces there.
  ...
  virtual void Navigate(const ::blink::KURL& url, ::base::TimeTicks navigation_start_time, ::mojo_base::mojom::blink::String16Ptr embedder_shared_storage_context) = 0;
...
class  FencedFrameOwnerHostProxy
 ...
 public:
  ...
  void Navigate(const ::blink::KURL& url, ::base::TimeTicks navigation_start_time, ::mojo_base::mojom::blink::String16Ptr embedder_shared_storage_context) final;
...
class  FencedFrameOwnerHostStubDispatch {
 public:
...
class  FencedFrameOwnerHostRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
