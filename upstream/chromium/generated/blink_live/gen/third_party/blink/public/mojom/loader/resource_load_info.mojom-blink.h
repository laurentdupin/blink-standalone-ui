...
class  RedirectInfo {
 public:
  ...
  RedirectInfo(
      ::url::mojom::blink::OriginPtr origin_of_new_url,
...
class  ResourceLoadInfo {
 public:
  ...
  ResourceLoadInfo(
      int64_t request_id,
      ::url::mojom::blink::UrlPtr final_url,
      ::url::mojom::blink::UrlPtr referrer,
      ::url::mojom::blink::UrlPtr original_url,
      const ::blink::String& method,
      ::network::mojom::blink::RequestDestination request_destination,
      ::network::mojom::blink::RequestPriority request_priority,
      ...
      ::mojo_base::mojom::blink::ByteCountPtr raw_body_bytes,
      ::mojo_base::mojom::blink::ByteCountPtr total_received_bytes,
...
template <>
struct  StructTraits<::blink::mojom::blink::CommonNetworkInfo::DataView,
...
template <>
struct  StructTraits<::blink::mojom::blink::RedirectInfo::DataView,
...
template <>
struct  StructTraits<::blink::mojom::blink::ResourceLoadInfo::DataView,
