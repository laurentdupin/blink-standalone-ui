...
bool DevToolsAgent_AttachDevToolsSession_Params_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->script_to_evaluate_on_load, 5, validation_context)) {
    return false;
  }
  constexpr const mojo::internal::ContainerValidateParams& script_to_evaluate_on_load_validate_params =
      mojo::internal::GetArrayValidator<0, false, nullptr>();
  if (!mojo::internal::ValidateContainer(object->script_to_evaluate_on_load, validation_context,
                                         &script_to_evaluate_on_load_validate_params)) {
    return false;
  }

  if (!mojo::internal::ValidatePointerNonNullable(
          object->session_id, 8, validation_context)) {
    return false;
  }
