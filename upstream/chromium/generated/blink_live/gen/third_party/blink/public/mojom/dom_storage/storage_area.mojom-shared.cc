...
// static
bool StorageAreaSource_Data::Validate(
    const void* data,
  ...
  [[maybe_unused]] const StorageAreaSource_Data* object =
      static_cast<const StorageAreaSource_Data*>(data);

  if (!mojo::internal::ValidatePointerNonNullable(
          object->page_url, 1, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->storage_area_id, 2, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateStruct(object->storage_area_id, validation_context))
    return false;

  return true;
}

StorageAreaSource_Data::StorageAreaSource_Data()
