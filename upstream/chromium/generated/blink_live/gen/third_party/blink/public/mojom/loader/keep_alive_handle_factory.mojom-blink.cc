// third_party/blink/public/mojom/loader/keep_alive_handle_factory.mojom-blink.cc is auto generated by mojom_bindings_generator.py, do not edit
...
#include "third_party/blink/public/mojom/loader/keep_alive_handle_factory.mojom-blink-test-utils.h"
...
uint32_t KeepAliveHandleFactory::IssueKeepAliveHandle_Sym::IPCStableHash() {
  ...
  static constexpr uint32_t kHash = 0x77248fa0;  // IPCStableHash for blink::mojom::KeepAliveHandleFactory::IssueKeepAliveHandle
...
void KeepAliveHandleFactoryProxy::IssueKeepAliveHandle(
    ::mojo::PendingReceiver<::blink::mojom::blink::KeepAliveHandle> in_keep_alive_handle) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  mojo::Message message(
      std::to_underlying(messages::KeepAliveHandleFactory::kIssueKeepAliveHandle), kFlags, estimated_payload_size);
  ...
  mojo::internal::Serialize<mojo::InterfaceRequestDataView<::blink::mojom::KeepAliveHandleInterfaceBase>>(
    in_keep_alive_handle,
    &params->keep_alive_handle,
    &params.message());
...
bool KeepAliveHandleFactoryRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::blink::KeepAliveHandleFactory::Name_,
    kKeepAliveHandleFactoryValidationInfo);
}
...
void KeepAliveHandleFactoryInterceptorForTesting::IssueKeepAliveHandle(::mojo::PendingReceiver<::blink::mojom::blink::KeepAliveHandle> keep_alive_handle) {
  GetForwardingInterface()->IssueKeepAliveHandle(
