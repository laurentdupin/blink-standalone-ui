...
void StorageAreaObserverProxy::KeyChanged(
    const std::vector<uint8_t>& in_key, const std::vector<uint8_t>& in_new_value, const std::optional<std::vector<uint8_t>>& in_old_value, StorageAreaSourcePtr in_source) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void StorageAreaObserverProxy::KeyChangeFailed(
    const std::vector<uint8_t>& in_key, StorageAreaSourcePtr in_source) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void StorageAreaObserverProxy::KeyDeleted(
    const std::vector<uint8_t>& in_key, const std::optional<std::vector<uint8_t>>& in_old_value, StorageAreaSourcePtr in_source) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool StorageAreaObserverRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::StorageAreaObserver::Name_,
...
void StorageAreaProxy::Put(
    const std::vector<uint8_t>& in_key, const std::vector<uint8_t>& in_value, const std::optional<std::vector<uint8_t>>& in_client_old_value, StorageAreaSourcePtr in_source, PutCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void StorageAreaProxy::Delete(
    const std::vector<uint8_t>& in_key, const std::optional<std::vector<uint8_t>>& in_client_old_value, StorageAreaSourcePtr in_source, DeleteCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
// static
bool StructTraits<::blink::mojom::StorageAreaSource::DataView, ::blink::mojom::StorageAreaSourcePtr>::Read(
    ::blink::mojom::StorageAreaSource::DataView input,
    ::blink::mojom::StorageAreaSourcePtr* output) {
  bool success = true;
  ::blink::mojom::StorageAreaSourcePtr result(::blink::mojom::StorageAreaSource::New());
...
void StorageAreaObserverInterceptorForTesting::KeyChanged(const std::vector<uint8_t>& key, const std::vector<uint8_t>& new_value, const std::optional<std::vector<uint8_t>>& old_value, StorageAreaSourcePtr source) {
...
void StorageAreaObserverInterceptorForTesting::KeyChangeFailed(const std::vector<uint8_t>& key, StorageAreaSourcePtr source) {
...
void StorageAreaObserverInterceptorForTesting::KeyDeleted(const std::vector<uint8_t>& key, const std::optional<std::vector<uint8_t>>& old_value, StorageAreaSourcePtr source) {
...
void StorageAreaInterceptorForTesting::Put(const std::vector<uint8_t>& key, const std::vector<uint8_t>& value, const std::optional<std::vector<uint8_t>>& client_old_value, StorageAreaSourcePtr source, PutCallback callback) {
...
void StorageAreaInterceptorForTesting::Delete(const std::vector<uint8_t>& key, const std::optional<std::vector<uint8_t>>& client_old_value, StorageAreaSourcePtr source, DeleteCallback callback) {
...
void StorageAreaAsyncWaiter::Put(
    const std::vector<uint8_t>& key, const std::vector<uint8_t>& value, const std::optional<std::vector<uint8_t>>& client_old_value, StorageAreaSourcePtr source, bool* out_success) {
  base::RunLoop loop;
  proxy_->Put(
      std::move(key),
      std::move(value),
...
bool StorageAreaAsyncWaiter::Put(
    const std::vector<uint8_t>& key, const std::vector<uint8_t>& value, const std::optional<std::vector<uint8_t>>& client_old_value, StorageAreaSourcePtr source) {
...
void StorageAreaAsyncWaiter::Delete(
    const std::vector<uint8_t>& key, const std::optional<std::vector<uint8_t>>& client_old_value, StorageAreaSourcePtr source) {
  base::RunLoop loop;
  proxy_->Delete(
      std::move(key),
      std::move(client_old_value),
