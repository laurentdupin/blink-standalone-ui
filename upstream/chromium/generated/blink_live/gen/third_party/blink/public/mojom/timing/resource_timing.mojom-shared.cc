...
bool ResourceTimingInfo_Data::Validate(
  ...
  constexpr const mojo::internal::ContainerValidateParams& connection_info_validate_params =
      mojo::internal::GetArrayValidator<0, false, nullptr>();
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->server_timing, 15, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->content_type, 18, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->content_encoding, 19, validation_context)) {
    return false;
  }
  constexpr const mojo::internal::ContainerValidateParams& content_encoding_validate_params =
      mojo::internal::GetArrayValidator<0, false, nullptr>();
  if (!mojo::internal::ValidateContainer(object->content_encoding, validation_context,
                                         &content_encoding_validate_params)) {
    return false;
  }

  if (!mojo::internal::ValidatePointerNonNullable(
          object->initiator_url, 20, validation_context)) {
    return false;
  }
