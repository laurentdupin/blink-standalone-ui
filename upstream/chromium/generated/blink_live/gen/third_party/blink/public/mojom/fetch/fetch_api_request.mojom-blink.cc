...
FetchAPIRequest::FetchAPIRequest(
    ...
    FetchAPIRequestHeadersPtr headers_in,
    ::blink::mojom::blink::SerializedBlobPtr blob_in,
    FetchAPIRequestBodyPtr body_in,
...
void FetchAPIRequest::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "headers"), this->headers,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type FetchAPIRequestHeadersPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "body"), this->body,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type FetchAPIRequestBodyPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
