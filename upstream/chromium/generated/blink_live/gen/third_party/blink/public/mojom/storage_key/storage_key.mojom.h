...
class  StorageKey {
 public:
  ...
  StorageKey(
      ...
      ::network::mojom::SchemefulSitePtr top_level_site,
      const std::optional<::base::UnguessableToken>& nonce,
      ::blink::mojom::AncestorChainBit ancestor_chain_bit,
      ::network::mojom::SchemefulSitePtr top_level_site_if_third_party_enabled,
...
template <>
struct  StructTraits<::blink::mojom::StorageKey::DataView,
