...
DEPRECATED_FileSystemFile::DEPRECATED_FileSystemFile(
    ::url::mojom::blink::UrlPtr filesystem_url_in,
    uint64_t offset_in,
    uint64_t length_in,
    ::mojo_base::mojom::blink::TimePtr modification_time_in)
...
size_t DEPRECATED_FileSystemFile::Hash(size_t seed) const {
  seed = mojo::internal::WTFHash(seed, this->filesystem_url);
  seed = mojo::internal::WTFHash(seed, this->offset);
  seed = mojo::internal::WTFHash(seed, this->length);
  seed = mojo::internal::WTFHash(seed, this->modification_time);
  return seed;
}
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::mojo_base::mojom::blink::TimePtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
File::File(
    ::mojo_base::mojom::blink::String16Ptr path_in,
    uint64_t offset_in,
    uint64_t length_in,
    ::mojo_base::mojom::blink::TimePtr modification_time_in)
...
RequestBody::RequestBody(
    ::blink::Vector<ElementPtr> elements_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<ElementPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
HttpBody::HttpBody(
    ::mojo_base::mojom::blink::String16Ptr http_content_type_in,
...
ViewState::ViewState(
    ::gfx::mojom::blink::PointFPtr visual_viewport_scroll_offset_in,
    ::gfx::mojom::blink::PointPtr scroll_offset_in,
...
ViewState::ViewState(
    ...
    ::gfx::mojom::blink::PointPtr scroll_offset_in,
    double page_scale_factor_in,
    ::mojo_base::mojom::blink::String16Ptr scroll_anchor_selector_in,
    ::gfx::mojom::blink::PointFPtr scroll_anchor_offset_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::gfx::mojom::blink::PointPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
FrameState::FrameState(
    ::mojo_base::mojom::blink::String16Ptr url_string_in,
    ::mojo_base::mojom::blink::String16Ptr referrer_in,
    ::mojo_base::mojom::blink::String16Ptr target_in,
    ::mojo_base::mojom::blink::String16Ptr state_object_in,
    ::blink::Vector<::mojo_base::mojom::blink::String16Ptr> document_state_in,
    ...
    ::blink::Vector<FrameStatePtr> children_in)
...
FrameState::FrameState(
    ...
    HttpBodyPtr http_body_in,
    ::blink::Vector<FrameStatePtr> children_in,
    const ::blink::String& initiator_origin_in)
    : url_string(std::move(url_string_in)),
      referrer(std::move(referrer_in)),
      target(std::move(target_in)),
      state_object(std::move(state_object_in)),
...
FrameState::FrameState(
    ...
    ::blink::Vector<FrameStatePtr> children_in,
    const ::blink::String& initiator_origin_in,
    ::mojo_base::mojom::blink::String16Ptr navigation_api_key_in,
    ::mojo_base::mojom::blink::String16Ptr navigation_api_id_in)
    : url_string(std::move(url_string_in)),
      referrer(std::move(referrer_in)),
      target(std::move(target_in)),
      state_object(std::move(state_object_in)),
...
FrameState::FrameState(
    ...
    ::mojo_base::mojom::blink::String16Ptr navigation_api_key_in,
    ::mojo_base::mojom::blink::String16Ptr navigation_api_id_in,
    ::mojo_base::mojom::blink::String16Ptr navigation_api_state_in)
    : url_string(std::move(url_string_in)),
      referrer(std::move(referrer_in)),
      target(std::move(target_in)),
      state_object(std::move(state_object_in)),
...
FrameState::FrameState(
    ...
    ::mojo_base::mojom::blink::String16Ptr navigation_api_state_in,
    bool protect_url_in_navigation_api_in,
    ::mojo_base::mojom::blink::String16Ptr initiator_base_url_string_in)
    : url_string(std::move(url_string_in)),
      referrer(std::move(referrer_in)),
      target(std::move(target_in)),
      state_object(std::move(state_object_in)),
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<::mojo_base::mojom::blink::String16Ptr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<FrameStatePtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
PageState::PageState(
    ::blink::Vector<::mojo_base::mojom::blink::String16Ptr> referenced_files_in,
...
Element::NewBlobUuid(
  ...
  return ElementPtr(
      std::in_place,
      std::in_place_index<static_cast<size_t>(Tag::kBlobUuid)>,
      std::move(value));
}
...
ElementPtr
Element::NewDeprecatedFileSystemFile(
    DEPRECATED_FileSystemFilePtr value) {
  return ElementPtr(
      std::in_place,
      std::in_place_index<static_cast<size_t>(Tag::kDeprecatedFileSystemFile)>,
      std::move(value));
}
...
Element::Element(
    ...
    const ::blink::String& value)
    : tag_(Tag::kBlobUuid),
      data_(std::in_place_index<static_cast<size_t>(Tag::kBlobUuid)>,
            std::move(value)) {}
...
Element::Element(
    ...
    : tag_(Tag::kDeprecatedFileSystemFile),
      data_(std::in_place_index<static_cast<size_t>(Tag::kDeprecatedFileSystemFile)>,
            std::move(value)) {}
Element::~Element() {
  DestroyActive();
}

void Element::set_blob_uuid(const ::blink::String& blob_uuid) {
  if (tag_ == Tag::kBlobUuid) {
    data_.blob_uuid = std::move(blob_uuid);
  } else {
    DestroyActive();
    tag_ = Tag::kBlobUuid;
    new (&data_.blob_uuid) ::blink::String(
        std::move(blob_uuid));
  }
}

void Element::set_bytes(::blink::Vector<uint8_t> bytes) {
  if (tag_ == Tag::kBytes) {
...
void Element::set_DEPRECATED_file_system_file(DEPRECATED_FileSystemFilePtr DEPRECATED_file_system_file) {
  if (tag_ == Tag::kDeprecatedFileSystemFile) {
    ...
    DestroyActive();
    tag_ = Tag::kDeprecatedFileSystemFile;
    new (&data_.DEPRECATED_file_system_file) DEPRECATED_FileSystemFilePtr(
        std::move(DEPRECATED_file_system_file));
  }
}


Element::Union_::Union_(
    std::in_place_index_t<static_cast<size_t>(Tag::kBlobUuid)>,
    const ::blink::String& value)
    : blob_uuid(std::move(value)) {}
...
Element::Union_::Union_(
    std::in_place_index_t<static_cast<size_t>(Tag::kDeprecatedFileSystemFile)>,
    DEPRECATED_FileSystemFilePtr value)
    : DEPRECATED_file_system_file(std::move(value)) {}

void Element::DestroyActive() {
  switch (tag_) {

    case Tag::kBlobUuid:
      std::destroy_at(&data_.blob_uuid);
      break;
    case Tag::kBytes:
    ...
    case Tag::kDeprecatedFileSystemFile:
      std::destroy_at(&data_.DEPRECATED_file_system_file);
      break;
  }
}
