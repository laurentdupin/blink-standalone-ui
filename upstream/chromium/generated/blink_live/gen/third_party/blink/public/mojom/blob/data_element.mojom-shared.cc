...
bool DataElement_Data::Validate(
  ...
  switch (object->tag) {
    ...
    case DataElement_Tag::kBlob: {

      if (!mojo::internal::ValidatePointerNonNullable(
              object->data.f_blob, 3, validation_context)) {
        return false;
      }
...
bool DataElementBlob_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const DataElementBlob_Data* object =
      static_cast<const DataElementBlob_Data*>(data);
...
bool BytesProvider_RequestAsReply_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const BytesProvider_RequestAsReply_Params_Data* object =
      static_cast<const BytesProvider_RequestAsReply_Params_Data*>(data);
...
bool BytesProvider_RequestAsReply_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const BytesProvider_RequestAsReply_ResponseParams_Data* object =
      static_cast<const BytesProvider_RequestAsReply_ResponseParams_Data*>(data);
...
bool BytesProvider_RequestAsStream_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const BytesProvider_RequestAsStream_Params_Data* object =
      static_cast<const BytesProvider_RequestAsStream_Params_Data*>(data);
...
bool BytesProvider_RequestAsFile_Params_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const BytesProvider_RequestAsFile_Params_Data* object =
      static_cast<const BytesProvider_RequestAsFile_Params_Data*>(data);
...
bool BytesProvider_RequestAsFile_ResponseParams_Data::Validate(
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const BytesProvider_RequestAsFile_ResponseParams_Data* object =
      static_cast<const BytesProvider_RequestAsFile_ResponseParams_Data*>(data);
