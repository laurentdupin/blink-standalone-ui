...
class AnnotationAgentContainer_CreateAgentFromSelection_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      SelectorCreationResultPtr in_result, ::blink::mojom::blink::LinkGenerationError in_error, ::blink::mojom::blink::LinkGenerationReadyStatus in_ready_status);
};
...
bool AnnotationAgentContainer_CreateAgentFromSelection_ForwardToCallback::Accept(
  ...
  ::blink::mojom::blink::LinkGenerationError p_error{};
  ::blink::mojom::blink::LinkGenerationReadyStatus p_ready_status{};
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("error"), in_error,
                        "<value of type ::blink::mojom::blink::LinkGenerationError>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("ready_status"), in_ready_status,
                        "<value of type ::blink::mojom::blink::LinkGenerationReadyStatus>");
   });
#endif
...
,
             ::blink::mojom::blink::LinkGenerationError* out_error
,
             ::blink::mojom::blink::LinkGenerationReadyStatus* out_ready_status
,
             SelectorCreationResultPtr result,
             ::blink::mojom::blink::LinkGenerationError error,
             ::blink::mojom::blink::LinkGenerationReadyStatus ready_status) {*out_result = std::move(result);*out_error = std::move(error);*out_ready_status = std::move(ready_status);
            loop->Quit();
          },
          &loop,
          out_result,
