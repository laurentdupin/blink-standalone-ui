...
RedirectInfo::RedirectInfo(
    ::url::mojom::blink::OriginPtr origin_of_new_url_in,
...
ResourceLoadInfo::ResourceLoadInfo(
    ...
    ::url::mojom::blink::UrlPtr final_url_in,
    ::url::mojom::blink::UrlPtr referrer_in,
    ::url::mojom::blink::UrlPtr original_url_in,
    const ::blink::String& method_in,
    ::network::mojom::blink::RequestDestination request_destination_in,
    ::network::mojom::blink::RequestPriority request_priority_in,
    ...
    ::mojo_base::mojom::blink::ByteCountPtr raw_body_bytes_in,
    ::mojo_base::mojom::blink::ByteCountPtr total_received_bytes_in,
    ::blink::Vector<RedirectInfoPtr> redirect_info_chain_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::mojo_base::mojom::blink::ByteCountPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<RedirectInfoPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
