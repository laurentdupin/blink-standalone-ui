...
#include "third_party/blink/public/mojom/frame/frame_visual_properties.mojom-blink-test-utils.h"
...
FrameVisualProperties::FrameVisualProperties(
    ...
    ::viz::mojom::blink::LocalSurfaceIdPtr local_surface_id_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::viz::mojom::blink::LocalSurfaceIdPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
