...
// with not having this data in traces there.
  ...
  virtual void Load(::mojo::PendingReceiver<::network::mojom::blink::URLLoader> loader, const ::blink::String& request_method, ::network::mojom::blink::HttpRequestHeadersPtr headers, ::mojo::PendingRemote<::network::mojom::blink::URLLoaderClient> client) = 0;
...
class  BlobProxy
 ...
 public:
  ...
  void Load(::mojo::PendingReceiver<::network::mojom::blink::URLLoader> loader, const ::blink::String& request_method, ::network::mojom::blink::HttpRequestHeadersPtr headers, ::mojo::PendingRemote<::network::mojom::blink::URLLoaderClient> client) final;
