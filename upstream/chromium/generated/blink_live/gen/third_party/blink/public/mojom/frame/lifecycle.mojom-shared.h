// third_party/blink/public/mojom/frame/lifecycle.mojom-shared.h is auto generated by mojom_bindings_generator.py, do not edit
...
#include "third_party/blink/public/mojom/frame/lifecycle.mojom-data-view.h"  // IWYU pragma: export
...
struct Serializer<::blink::mojom::FrameVisibility, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::blink::mojom::FrameVisibility>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::blink::mojom::FrameVisibility, UserType> ||
                        HasInfallibleConversion(::blink::mojom::FrameVisibility()),
                    "::blink::mojom::FrameVisibility does not have an infallible conversion, "
...
struct Serializer<::blink::mojom::FrameLifecycleState, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::blink::mojom::FrameLifecycleState>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::blink::mojom::FrameLifecycleState, UserType> ||
                        HasInfallibleConversion(::blink::mojom::FrameLifecycleState()),
                    "::blink::mojom::FrameLifecycleState does not have an infallible conversion, "
                    "use an optional return type.");
      *output = Traits::FromMojom(known_value);
      return true;
    } else {
...
template <>
struct  TraceFormatTraits<::blink::mojom::FrameVisibility> {
 static void WriteIntoTrace(perfetto::TracedValue context, ::blink::mojom::FrameVisibility value);
};
...
template <>
struct  TraceFormatTraits<::blink::mojom::FrameLifecycleState> {
 static void WriteIntoTrace(perfetto::TracedValue context, ::blink::mojom::FrameLifecycleState value);
};
