 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        IntrinsicSizingInfo::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
template <>
struct  StructTraits<::blink::mojom::IntrinsicSizingInfo::DataView,
  ...
  static decltype(::blink::mojom::IntrinsicSizingInfo::is_cleared) is_cleared(
      const ::blink::mojom::IntrinsicSizingInfoPtr& input) {
