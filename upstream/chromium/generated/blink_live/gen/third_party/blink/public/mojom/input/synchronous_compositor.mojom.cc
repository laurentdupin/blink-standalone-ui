...
bool SynchronousCompositor::SetSharedMemory(::mojo_base::mojom::WritableSharedMemoryRegionPtr shm_region, bool* out_success, SyncCompositorCommonRendererParamsPtr* out_result) {
  NOTREACHED();
}
...
bool SynchronousCompositorProxy::SetSharedMemory(
    ::mojo_base::mojom::WritableSharedMemoryRegionPtr param_shm_region, bool* out_param_success, SyncCompositorCommonRendererParamsPtr* out_param_result) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_BEGIN1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("shm_region"), param_shm_region,
                        "<value of type ::mojo_base::mojom::WritableSharedMemoryRegionPtr>");
   });
#else
...
void SynchronousCompositorProxy::SetSharedMemory(
    ::mojo_base::mojom::WritableSharedMemoryRegionPtr in_shm_region, SetSharedMemoryCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool SynchronousCompositorStubDispatch::AcceptWithResponder(
  ...
  switch (static_cast<messages::SynchronousCompositor>(message->header()->name)) {
    ...
    case messages::SynchronousCompositor::kSetSharedMemory: {
      ...
      // Validation for SynchronousCompositor.2
      bool success = true;
      ::mojo_base::mojom::WritableSharedMemoryRegionPtr p_shm_region{};
...
bool SynchronousCompositorRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::SynchronousCompositor::Name_,
...
void SynchronousCompositorHostProxy::SetThreads(
    const std::vector<::viz::Thread>& in_threads) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool SynchronousCompositorHostRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::SynchronousCompositorHost::Name_,
...
bool SynchronousCompositorControlHostRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::SynchronousCompositorControlHost::Name_,
...
void SynchronousCompositorInterceptorForTesting::SetSharedMemory(::mojo_base::mojom::WritableSharedMemoryRegionPtr shm_region, SetSharedMemoryCallback callback) {
...
void SynchronousCompositorHostInterceptorForTesting::SetThreads(const std::vector<::viz::Thread>& threads) {
