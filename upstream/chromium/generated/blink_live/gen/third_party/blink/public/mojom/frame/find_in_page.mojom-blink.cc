...
void FindInPageProxy::Find(
    int32_t in_request_id, const ::blink::String& in_search_text, FindOptionsPtr in_options) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  mojo::Message message(
      std::to_underlying(messages::FindInPage::kFind), kFlags, estimated_payload_size);
...
void FindInPageProxy::StopFinding(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FindInPage::kStopFinding), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FindInPageProxy::ClearActiveFindMatch(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FindInPage::kClearActiveFindMatch), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FindInPageProxy::SetClient(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FindInPage::kSetClient), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool FindInPageRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::blink::FindInPage::Name_,
...
void FindInPageClientProxy::SetNumberOfMatches(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FindInPageClient::kSetNumberOfMatches), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void FindInPageClientProxy::SetActiveMatch(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::FindInPageClient::kSetActiveMatch), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool FindInPageClientRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::blink::FindInPageClient::Name_,
...
void FindInPageInterceptorForTesting::Find(int32_t request_id, const ::blink::String& search_text, FindOptionsPtr options) {
