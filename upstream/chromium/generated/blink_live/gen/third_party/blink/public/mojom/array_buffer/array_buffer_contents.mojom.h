...
class  SerializedArrayBufferContents {
 public:
  ...
  SerializedArrayBufferContents(
      ::mojo_base::mojom::BigBufferPtr contents,
...
template <>
struct  StructTraits<::blink::mojom::SerializedArrayBufferContents::DataView,
  ...
  static decltype(::blink::mojom::SerializedArrayBufferContents::javascript_resize_limit) javascript_resize_limit(
