// third_party/blink/public/mojom/gpu/gpu.mojom-blink.h is auto generated by mojom_bindings_generator.py, do not edit

// Copyright 2013 The Chromium Authors
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef THIRD_PARTY_BLINK_PUBLIC_MOJOM_GPU_GPU_MOJOM_BLINK_H_
#define THIRD_PARTY_BLINK_PUBLIC_MOJOM_GPU_GPU_MOJOM_BLINK_H_
...
#include "third_party/blink/public/mojom/gpu/gpu.mojom-blink-forward.h"  // IWYU pragma: export
...
class PLATFORM_EXPORT GpuDataManager
...
// with not having this data in traces there.
  ...
  virtual bool Are3DAPIsBlockedForUrl(const ::blink::KURL& url, bool* out_blocked);
  ...
  virtual void Are3DAPIsBlockedForUrl(const ::blink::KURL& url, Are3DAPIsBlockedForUrlCallback callback) = 0;
};



class PLATFORM_EXPORT GpuDataManagerProxy
 ...
 public:
  ...
  bool Are3DAPIsBlockedForUrl(const ::blink::KURL& url, bool* out_blocked) final;
  
  void Are3DAPIsBlockedForUrl(const ::blink::KURL& url, Are3DAPIsBlockedForUrlCallback callback) final;

 private:
  mojo::MessageReceiverWithResponder* receiver_;
};
class PLATFORM_EXPORT GpuDataManagerStubDispatch {
 public:
...
class PLATFORM_EXPORT GpuDataManagerRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class PLATFORM_EXPORT GpuDataManagerResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_MOJOM_GPU_GPU_MOJOM_BLINK_H_