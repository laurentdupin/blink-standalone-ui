...
class  FindInPageInterceptorForTesting : public FindInPage {
  virtual FindInPage* GetForwardingInterface() = 0;
  void Find(int32_t request_id, const ::blink::String& search_text, FindOptionsPtr options) override;
...
class  FindInPageClientInterceptorForTesting : public FindInPageClient {
...
class  FindInPageClientAsyncWaiter {
 public:
