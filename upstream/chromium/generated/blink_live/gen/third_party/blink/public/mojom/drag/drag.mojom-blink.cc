...
size_t AllowedDragOperations::Hash(size_t seed) const {
  seed = mojo::internal::WTFHash(seed, this->allow_copy);
  seed = mojo::internal::WTFHash(seed, this->allow_link);
  seed = mojo::internal::WTFHash(seed, this->allow_move);
  return seed;
}
...
DragItemBinary::DragItemBinary(
    ...
    ::mojo_base::mojom::blink::FilePathPtr filename_extension_in,
...
DragItemFileSystemFile::DragItemFileSystemFile(
    ...
    ::blink::mojom::blink::SerializedBlobPtr serialized_blob_in)
    : url(std::move(url_in)),
