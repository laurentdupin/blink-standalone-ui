...
class  RemoteFrameHostInterceptorForTesting : public RemoteFrameHost {
  ...
  void SetInheritedEffectiveTouchAction(::cc::mojom::TouchActionPtr touch_action) override;
  ...
  void RouteMessageEvent(const std::optional<::blink::LocalFrameToken>& source_frame_token, const ::url::Origin& source_origin, const std::optional<::url::Origin>& target_origin, ::blink::TransferableMessage message) override;
  void PrintCrossProcessSubframe(const ::gfx::Rect& frame_content_rect, int32_t document_cookie) override;
  void Detach() override;
  void UpdateViewportIntersection(::blink::mojom::ViewportIntersectionStatePtr intersection_state, ::blink::mojom::FrameVisualPropertiesPtr visual_properties) override;
  void SynchronizeVisualProperties(::blink::mojom::FrameVisualPropertiesPtr properties) override;
...
class  RemoteFrameInterceptorForTesting : public RemoteFrame {
  ...
  void DidSetFramePolicyHeaders(::network::mojom::WebSandboxFlags sandbox_flags, const std::vector<::network::ParsedPermissionsPolicyDeclaration>& parsed_permissions_policy) override;
  ...
  void CreateRemoteChildren(std::vector<CreateRemoteChildParamsPtr> params, const std::optional<::base::UnguessableToken>& navigation_metrics_token) override;
};
