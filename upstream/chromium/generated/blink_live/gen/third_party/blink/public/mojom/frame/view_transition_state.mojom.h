...
class  ViewTransitionElement {
 public:
  ...
  ViewTransitionElement(
      ...
      ::viz::mojom::ViewTransitionElementResourceIdPtr snapshot_id,
      int32_t paint_order,
...
class  ViewTransitionState {
 public:
  ...
  ViewTransitionState(
      std::vector<ViewTransitionElementPtr> elements,
      ::blink::mojom::ViewTransitionTokenPtr transition_token,
      const ::gfx::Size& snapshot_root_size_at_capture,
      float device_pixel_ratio,
      uint32_t next_element_resource_id,
      ::viz::mojom::ViewTransitionElementResourceIdPtr subframe_snapshot_id,
...
template <>
struct  StructTraits<::blink::mojom::ViewTransitionElementLayeredBoxProperties::DataView,
...
template <>
struct  StructTraits<::blink::mojom::ViewTransitionElement::DataView,
...
template <>
struct  StructTraits<::blink::mojom::ViewTransitionState::DataView,
  ...
  static decltype(::blink::mojom::ViewTransitionState::delay_layer_tree_view_deletion) delay_layer_tree_view_deletion(
      const ::blink::mojom::ViewTransitionStatePtr& input) {
