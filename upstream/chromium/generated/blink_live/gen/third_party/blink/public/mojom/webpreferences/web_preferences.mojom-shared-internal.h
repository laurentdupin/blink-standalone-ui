...
class  WebPreferences_Data {
 public:
  ...
  uint8_t allow_unrestricted_window_focus : 1;
  ...
  uint8_t battery_saver_enabled : 1;
  uint8_t preloading_disabled : 1;
  ...
  uint8_t highlight_ads : 1;
  uint8_t password_echo_enabled_physical : 1;
  uint8_t password_echo_enabled_touch : 1;
  ...
  uint8_t ignore_permission_for_device_changed_event : 1;
  ...
  uint8_t immersive_video_playback_enabled : 1;
  uint8_t double_tap_to_zoom_enabled : 1;
  uint8_t fullscreen_supported : 1;
  uint8_t text_size_adjust_enabled : 1;
  uint8_t is_initial_profile : 1;
  ...
  uint8_t touch_dragend_context_menu : 1;
  ...
  mojo::internal::Pointer<::skia::mojom::internal::SkColor_Data> root_scrollbar_theme_color;
  ...
  uint8_t payment_request_enabled : 1;
  uint8_t ai_ot_apis_enabled : 1;
  uint8_t ignore_duplicate_nav_enabled : 1;
  uint8_t is_indigo_onboarding : 1;
  uint8_t pad144_[3];
  mojo::internal::Pointer<::mojo_base::mojom::internal::TimeDelta_Data> duplicate_nav_threshold;
