...
MenuItem::MenuItem()
    : label(),
      ...
      action(0U),
      text_direction(::mojo_base::mojom::TextDirection::LEFT_TO_RIGHT),
...
MenuItem::MenuItem(
    ...
    const std::optional<std::string>& tool_tip_in,
    MenuItem::Type type_in,
    uint32_t action_in,
    ::mojo_base::mojom::TextDirection text_direction_in,
...
bool PopupMenuClientRequestValidator::Accept(mojo::Message* message) {
  return mojo::internal::ValidateRequestGenericPacked(
    message,
    ::blink::mojom::PopupMenuClient::Name_,
