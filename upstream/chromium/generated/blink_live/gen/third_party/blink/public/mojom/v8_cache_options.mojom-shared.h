...
#include "third_party/blink/public/mojom/v8_cache_options.mojom-data-view.h"  // IWYU pragma: export
...
struct Serializer<::blink::mojom::V8CacheOptions, MaybeConstUserType> {
  ...
  static bool Deserialize(int32_t input, UserType* output) {
    auto known_value = ::mojo::internal::ToKnownEnumValueHelper(
        static_cast<::blink::mojom::V8CacheOptions>(input));
    if constexpr (requires {
                    {
                      Traits::FromMojom(known_value)
                    } -> std::same_as<UserType>;
                  }) {
      static_assert(std::same_as<::blink::mojom::V8CacheOptions, UserType> ||
                        HasInfallibleConversion(::blink::mojom::V8CacheOptions()),
                    "::blink::mojom::V8CacheOptions does not have an infallible conversion, "
...
template <>
struct  TraceFormatTraits<::blink::mojom::V8CacheOptions> {
