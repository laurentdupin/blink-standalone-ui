...
// with not having this data in traces there.
  ...
  virtual void Register(::mojo::PendingRemote<::blink::mojom::blink::Blob> blob, const ::blink::KURL& url, RegisterCallback callback) = 0;

  virtual void Revoke(const ::blink::KURL& url) = 0;

  virtual void ResolveAsURLLoaderFactory(const ::blink::KURL& url, ::mojo::PendingReceiver<::network::mojom::blink::URLLoaderFactory> factory) = 0;

  virtual void ResolveAsBlobURLToken(const ::blink::KURL& url, ::mojo::PendingReceiver<BlobURLToken> token, bool is_top_level_navigation) = 0;
};
...
class  BlobURLStoreProxy
 ...
 public:
  ...
  bool Register(::mojo::PendingRemote<::blink::mojom::blink::Blob> blob, const ::blink::KURL& url) final;
  
  void Register(::mojo::PendingRemote<::blink::mojom::blink::Blob> blob, const ::blink::KURL& url, RegisterCallback callback) final;
  
  void Revoke(const ::blink::KURL& url) final;
  
  void ResolveAsURLLoaderFactory(const ::blink::KURL& url, ::mojo::PendingReceiver<::network::mojom::blink::URLLoaderFactory> factory) final;
  
  void ResolveAsBlobURLToken(const ::blink::KURL& url, ::mojo::PendingReceiver<BlobURLToken> token, bool is_top_level_navigation) final;
