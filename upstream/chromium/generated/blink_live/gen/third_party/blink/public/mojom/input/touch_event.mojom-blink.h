...
#include "third_party/blink/public/mojom/input/touch_event.mojom-blink-forward.h"  // IWYU pragma: export
 ...
 public:
  ...
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        TouchEventConsumers::DataView, ::blink::Vector<uint8_t>, send_validation>(input);
  }

  template <typename UserType>
  static ::blink::Vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        TouchEventConsumers::DataView, ::blink::Vector<uint8_t>>(input);
  }
...
template <>
struct  StructTraits<::blink::mojom::blink::TouchEventConsumers::DataView,
