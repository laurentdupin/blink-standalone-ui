...
// with not having this data in traces there.
  ...
  virtual void Load(::mojo::PendingReceiver<::network::mojom::URLLoader> loader, const std::string& request_method, ::network::mojom::HttpRequestHeadersPtr headers, ::mojo::PendingRemote<::network::mojom::URLLoaderClient> client) = 0;
  ...
  using GetInternalUUIDMojoCallback = base::OnceCallback<void(const std::string&)>;
...
class  BlobProxy
 ...
 public:
  ...
  void Load(::mojo::PendingReceiver<::network::mojom::URLLoader> loader, const std::string& request_method, ::network::mojom::HttpRequestHeadersPtr headers, ::mojo::PendingRemote<::network::mojom::URLLoaderClient> client) final;
...
class  BlobReaderClientStubDispatch {
 public:
...
class  BlobReaderClientRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class  BlobRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
class  BlobResponseValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
