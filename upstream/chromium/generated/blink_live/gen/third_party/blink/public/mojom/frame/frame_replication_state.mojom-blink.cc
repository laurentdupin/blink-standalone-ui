...
FrameReplicationState::FrameReplicationState(
    ...
    const ::blink::String& unique_name_in,
    ::blink::Vector<::network::mojom::blink::ParsedPermissionsPolicyDeclarationPtr> permissions_policy_header_in,
    ::network::mojom::blink::WebSandboxFlags active_sandbox_flags_in,
    ::blink::mojom::blink::FramePolicyPtr frame_policy_in,
    ::blink::mojom::blink::InsecureRequestPolicy insecure_request_policy_in,
    ::blink::Vector<uint32_t> insecure_navigations_set_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::mojom::blink::FramePolicyPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
bool StructTraits<::blink::mojom::blink::FrameReplicationState::DataView, ::blink::mojom::blink::FrameReplicationStatePtr>::Read(
    ::blink::mojom::blink::FrameReplicationState::DataView input,
    ::blink::mojom::blink::FrameReplicationStatePtr* output) {
  bool success = true;
