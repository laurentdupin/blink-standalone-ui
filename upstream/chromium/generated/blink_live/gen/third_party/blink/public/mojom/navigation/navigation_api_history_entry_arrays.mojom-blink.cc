...
NavigationApiHistoryEntryArrays::NavigationApiHistoryEntryArrays(
    ::blink::Vector<NavigationApiHistoryEntryPtr> back_entries_in,
    ::blink::Vector<NavigationApiHistoryEntryPtr> forward_entries_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::Vector<NavigationApiHistoryEntryPtr>>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
