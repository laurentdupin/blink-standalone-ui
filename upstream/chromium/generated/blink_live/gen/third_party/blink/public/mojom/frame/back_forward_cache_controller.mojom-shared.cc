...
// static
bool BlockingDetails_Data::Validate(
    const void* data,
  ...
  [[maybe_unused]] const BlockingDetails_Data* object =
      static_cast<const BlockingDetails_Data*>(data);


  if (!::blink::mojom::internal::WebSchedulerTrackedFeature_Data
...
BackForwardCacheControllerHost_DidChangeBackForwardCacheDisablingFeatures_Params_Data::BackForwardCacheControllerHost_DidChangeBackForwardCacheDisablingFeatures_Params_Data()
    : header_({sizeof(*this), 0}) {}
