...
static_assert(sizeof(CreateRemoteChildParams_Data) == 80,
              "Bad sizeof(CreateRemoteChildParams_Data)");
// Used by CreateRemoteChildParams::WrapAsMessage to lazily serialize the struct.
template <typename UserType, typename DataView>
struct CreateRemoteChildParams_UnserializedMessageContext
    : public mojo::internal::UnserializedMessageContext {
 public:
  static const mojo::internal::UnserializedMessageContext::Tag kMessageTag;

  CreateRemoteChildParams_UnserializedMessageContext(
    uint32_t message_name,
    uint32_t message_flags,
    UserType input)
      : mojo::internal::UnserializedMessageContext(&kMessageTag, message_name, message_flags)
...
template <typename UserType, typename DataView>
const mojo::internal::UnserializedMessageContext::Tag
    CreateRemoteChildParams_UnserializedMessageContext<UserType, DataView>::kMessageTag = {};
class  OpenURLParams_Data {
 public:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
...
static_assert(sizeof(OpenURLParams_Data) == 136,
