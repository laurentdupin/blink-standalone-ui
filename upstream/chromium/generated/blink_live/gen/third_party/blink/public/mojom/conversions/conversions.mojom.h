...
#include "third_party/blink/public/mojom/conversions/conversions.mojom-forward.h"  // IWYU pragma: export
...
// with not having this data in traces there.
  ...
  virtual void RegisterDataHost(::mojo::PendingReceiver<::attribution_reporting::mojom::DataHost> data_host, ::attribution_reporting::mojom::RegistrationEligibility registration_eligibility, bool is_for_background_requests, const std::vector<::url::Origin>& reporting_origins) = 0;

  virtual void RegisterNavigationDataHost(::mojo::PendingReceiver<::attribution_reporting::mojom::DataHost> data_host, const ::blink::AttributionSrcToken& attribution_src_token) = 0;
...
class  AttributionHostProxy
 ...
 public:
  ...
  void RegisterDataHost(::mojo::PendingReceiver<::attribution_reporting::mojom::DataHost> data_host, ::attribution_reporting::mojom::RegistrationEligibility registration_eligibility, bool is_for_background_requests, const std::vector<::url::Origin>& reporting_origins) final;
  
  void RegisterNavigationDataHost(::mojo::PendingReceiver<::attribution_reporting::mojom::DataHost> data_host, const ::blink::AttributionSrcToken& attribution_src_token) final;
...
class  AttributionHostStubDispatch {
 public:
...
class  AttributionHostRequestValidator : public mojo::MessageReceiver {
 public:
  bool Accept(mojo::Message* message) override;
};
 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        Impression::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
template <>
struct  StructTraits<::blink::mojom::Impression::DataView,
  ...
  static decltype(::blink::mojom::Impression::is_empty_attribution_src_tag) is_empty_attribution_src_tag(
      const ::blink::mojom::ImpressionPtr& input) {
