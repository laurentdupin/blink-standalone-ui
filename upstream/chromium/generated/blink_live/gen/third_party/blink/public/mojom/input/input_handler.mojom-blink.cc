...
WheelData::WheelData(
    ...
    ::blink::mojom::blink::RailsMode rails_mode_in)
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::mojom::blink::RailsMode>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
...
void FrameWidgetInputHandlerProxy::ExtendSelectionAndReplace(
    uint32_t in_before, uint32_t in_after, const ::std::u16string& in_replacement_text) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void FrameWidgetInputHandlerProxy::ExecuteEditCommand(
    const ::blink::String& in_command, const std::optional<::std::u16string>& in_value) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void FrameWidgetInputHandlerProxy::PasteFromImageBytes(
    ::mojo_base::BigBuffer in_image_bytes, const ::blink::String& in_media_format) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
bool FrameWidgetInputHandlerStubDispatch::Accept(
  ...
  switch (static_cast<messages::FrameWidgetInputHandler>(message->header()->name)) {
    ...
    case messages::FrameWidgetInputHandler::kExtendSelectionAndReplace: {
      ...
      uint32_t p_before{};
      uint32_t p_after{};
      ::std::u16string p_replacement_text{};
...
void WidgetInputHandlerProxy::ImeSetComposition(
    const ::std::u16string& in_text, const ::blink::Vector<::ui::ImeTextSpan>& in_ime_text_spans, const ::gfx::Range& in_range, int32_t in_start, int32_t in_end, ImeState in_ime_state, ImeSetCompositionCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void WidgetInputHandlerProxy::ImeCommitText(
    const ::std::u16string& in_text, const ::blink::Vector<::ui::ImeTextSpan>& in_ime_text_spans, const ::gfx::Range& in_range, int32_t in_relative_cursor_position, ImeCommitTextCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
...
void FrameWidgetInputHandlerInterceptorForTesting::ExtendSelectionAndReplace(uint32_t before, uint32_t after, const ::std::u16string& replacement_text) {
...
void FrameWidgetInputHandlerInterceptorForTesting::ExecuteEditCommand(const ::blink::String& command, const std::optional<::std::u16string>& value) {
...
void FrameWidgetInputHandlerInterceptorForTesting::PasteFromImageBytes(::mojo_base::BigBuffer image_bytes, const ::blink::String& media_format) {
...
void WidgetInputHandlerInterceptorForTesting::ImeSetComposition(const ::std::u16string& text, const ::blink::Vector<::ui::ImeTextSpan>& ime_text_spans, const ::gfx::Range& range, int32_t start, int32_t end, ImeState ime_state, ImeSetCompositionCallback callback) {
...
void WidgetInputHandlerInterceptorForTesting::ImeCommitText(const ::std::u16string& text, const ::blink::Vector<::ui::ImeTextSpan>& ime_text_spans, const ::gfx::Range& range, int32_t relative_cursor_position, ImeCommitTextCallback callback) {
