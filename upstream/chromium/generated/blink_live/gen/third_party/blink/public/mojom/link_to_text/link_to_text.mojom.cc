...
TextFragmentReceiver::IPCStableHashFunction TextFragmentReceiver::MessageToMethodInfo_(mojo::Message& message) {
  ...
  switch (static_cast<messages::TextFragmentReceiver>(message.name())) {
    ...
    case messages::TextFragmentReceiver::kRequestSelectorForViewportCenter: {
      return &TextFragmentReceiver::RequestSelectorForViewportCenter_Sym::IPCStableHash;
    }
    case messages::TextFragmentReceiver::kRequestSelectorForSelection: {
      return &TextFragmentReceiver::RequestSelectorForSelection_Sym::IPCStableHash;
    }
...
const char* TextFragmentReceiver::MessageToMethodName_(mojo::Message& message) {
  ...
  if (!is_response) {
    switch (static_cast<messages::TextFragmentReceiver>(message.name())) {
      ...
      case messages::TextFragmentReceiver::kRequestSelectorForViewportCenter:
            return "Receive blink::mojom::TextFragmentReceiver::RequestSelectorForViewportCenter";
      case messages::TextFragmentReceiver::kRequestSelectorForSelection:
            return "Receive blink::mojom::TextFragmentReceiver::RequestSelectorForSelection";
      case messages::TextFragmentReceiver::kExtractFirstFragmentRect:
    ...
    switch (static_cast<messages::TextFragmentReceiver>(message.name())) {
      ...
      case messages::TextFragmentReceiver::kRequestSelectorForViewportCenter:
            return "Receive reply blink::mojom::TextFragmentReceiver::RequestSelectorForViewportCenter";
      case messages::TextFragmentReceiver::kRequestSelectorForSelection:
            return "Receive reply blink::mojom::TextFragmentReceiver::RequestSelectorForSelection";
      case messages::TextFragmentReceiver::kExtractFirstFragmentRect:
...
uint32_t TextFragmentReceiver::RequestSelectorForViewportCenter_Sym::IPCStableHash() {
  // This method's address is used for identifying the mojo method name after
  // symbolization. So each IPCStableHash should have a unique address.
  // We cannot use NO_CODE_FOLDING() here - it relies on the uniqueness of
  // __LINE__ value, which is not unique across different mojo modules.
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0x789502ac;  // IPCStableHash for blink::mojom::TextFragmentReceiver::RequestSelectorForViewportCenter
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
uint32_t TextFragmentReceiver::RequestSelectorForSelection_Sym::IPCStableHash() {
  // This method's address is used for identifying the mojo method name after
  // symbolization. So each IPCStableHash should have a unique address.
  // We cannot use NO_CODE_FOLDING() here - it relies on the uniqueness of
  // __LINE__ value, which is not unique across different mojo modules.
  // The code below is very similar to NO_CODE_FOLDING, but it uses a unique
  // hash instead of __LINE__.
  static constexpr uint32_t kHash = 0xea7c8113;  // IPCStableHash for blink::mojom::TextFragmentReceiver::RequestSelectorForSelection
  const uint32_t hash = kHash;
  base::debug::Alias(&hash);
  return hash;
}
...
class TextFragmentReceiver_RequestSelectorForViewportCenter_ForwardToCallback
    : public mojo::MessageReceiver {
 public:
  TextFragmentReceiver_RequestSelectorForViewportCenter_ForwardToCallback(
      TextFragmentReceiver::RequestSelectorForViewportCenterCallback callback
      ) : callback_(std::move(callback)) {
  }

  TextFragmentReceiver_RequestSelectorForViewportCenter_ForwardToCallback(const TextFragmentReceiver_RequestSelectorForViewportCenter_ForwardToCallback&) = delete;
  TextFragmentReceiver_RequestSelectorForViewportCenter_ForwardToCallback& operator=(const TextFragmentReceiver_RequestSelectorForViewportCenter_ForwardToCallback&) = delete;

  bool Accept(mojo::Message* message) override;
 private:
  TextFragmentReceiver::RequestSelectorForViewportCenterCallback callback_;
};

class TextFragmentReceiver_RequestSelectorForSelection_ForwardToCallback
    : public mojo::MessageReceiver {
 public:
  TextFragmentReceiver_RequestSelectorForSelection_ForwardToCallback(
      TextFragmentReceiver::RequestSelectorForSelectionCallback callback
      ) : callback_(std::move(callback)) {
  }

  TextFragmentReceiver_RequestSelectorForSelection_ForwardToCallback(const TextFragmentReceiver_RequestSelectorForSelection_ForwardToCallback&) = delete;
  TextFragmentReceiver_RequestSelectorForSelection_ForwardToCallback& operator=(const TextFragmentReceiver_RequestSelectorForSelection_ForwardToCallback&) = delete;

  bool Accept(mojo::Message* message) override;
 private:
  TextFragmentReceiver::RequestSelectorForSelectionCallback callback_;
};
...
void TextFragmentReceiverProxy::Cancel(
  ...
  mojo::Message message(
      std::to_underlying(messages::TextFragmentReceiver::kCancel), kFlags, estimated_payload_size);
...
void TextFragmentReceiverProxy::RequestSelector(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::TextFragmentReceiver::kRequestSelector), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void TextFragmentReceiverProxy::RemoveFragments(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::TextFragmentReceiver::kRemoveFragments), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void TextFragmentReceiverProxy::ExtractTextFragmentsMatches(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::TextFragmentReceiver::kExtractTextFragmentsMatches), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void TextFragmentReceiverProxy::GetExistingSelectors(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::TextFragmentReceiver::kGetExistingSelectors), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void TextFragmentReceiverProxy::RequestSelectorForViewportCenter(
    RequestSelectorForViewportCenterCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "Send blink::mojom::TextFragmentReceiver::RequestSelectorForViewportCenter");
#endif
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::TextFragmentReceiver::kRequestSelectorForViewportCenter), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
      ::blink::mojom::internal::TextFragmentReceiver_RequestSelectorForViewportCenter_Params_Data> params(
          message);
  params.Allocate();

#if defined(ENABLE_IPC_FUZZER)
  message.set_interface_name(TextFragmentReceiver::Name_);
  message.set_method_name("RequestSelectorForViewportCenter");
#endif
  std::unique_ptr<mojo::MessageReceiver> responder(
      new TextFragmentReceiver_RequestSelectorForViewportCenter_ForwardToCallback(
          std::move(callback)));
  ::mojo::internal::SendMojoMessage(*receiver_, message, std::move(responder));
}

void TextFragmentReceiverProxy::RequestSelectorForSelection(
    RequestSelectorForSelectionCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "Send blink::mojom::TextFragmentReceiver::RequestSelectorForSelection");
#endif
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::TextFragmentReceiver::kRequestSelectorForSelection), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
      ::blink::mojom::internal::TextFragmentReceiver_RequestSelectorForSelection_Params_Data> params(
          message);
  params.Allocate();

#if defined(ENABLE_IPC_FUZZER)
  message.set_interface_name(TextFragmentReceiver::Name_);
  message.set_method_name("RequestSelectorForSelection");
#endif
  std::unique_ptr<mojo::MessageReceiver> responder(
      new TextFragmentReceiver_RequestSelectorForSelection_ForwardToCallback(
          std::move(callback)));
  ::mojo::internal::SendMojoMessage(*receiver_, message, std::move(responder));
}
...
void TextFragmentReceiverProxy::ExtractFirstFragmentRect(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::TextFragmentReceiver::kExtractFirstFragmentRect), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
class TextFragmentReceiver_RequestSelector_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 ...
 private:
  ...
  void Run(
      const std::string& in_selector, LinkGenerationError in_error, LinkGenerationReadyStatus in_ready_status);
};
...
bool TextFragmentReceiver_RequestSelector_ForwardToCallback::Accept(
  ...
  LinkGenerationError p_error{};
  LinkGenerationReadyStatus p_ready_status{};
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("error"), in_error,
                        "<value of type LinkGenerationError>");
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("ready_status"), in_ready_status,
                        "<value of type LinkGenerationReadyStatus>");
   });
#endif
...
class TextFragmentReceiver_RequestSelectorForViewportCenter_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 public:
  static TextFragmentReceiver::RequestSelectorForViewportCenterCallback CreateCallback(
      ::mojo::Message& message,
      std::unique_ptr<mojo::MessageReceiverWithStatus> responder) {
    std::unique_ptr<TextFragmentReceiver_RequestSelectorForViewportCenter_ProxyToResponder> proxy(
        new TextFragmentReceiver_RequestSelectorForViewportCenter_ProxyToResponder(
            message, std::move(responder)));
    return base::BindOnce(&TextFragmentReceiver_RequestSelectorForViewportCenter_ProxyToResponder::Run,
                          std::move(proxy));
  }

  ~TextFragmentReceiver_RequestSelectorForViewportCenter_ProxyToResponder() {
#if DCHECK_IS_ON()
    if (responder_) {
      // If we're being destroyed without being run, we want to ensure the
      // binding endpoint has been closed. This checks for that asynchronously.
 ...
 private:
  ...
  static void OnIsConnectedComplete(bool connected) {
    DCHECK(!connected)
        << "TextFragmentReceiver::RequestSelectorForViewportCenterCallback was destroyed without "
        << "first either being run or its corresponding binding being closed. "
        << "It is an error to drop response callbacks which still correspond "
        << "to an open interface pipe.";
  }
...
bool TextFragmentReceiver_RequestSelectorForViewportCenter_ForwardToCallback::Accept(
    mojo::Message* message) {
  DCHECK(message->is_serialized());
  internal::TextFragmentReceiver_RequestSelectorForViewportCenter_ResponseParams_Data* params =
      reinterpret_cast<
          internal::TextFragmentReceiver_RequestSelectorForViewportCenter_ResponseParams_Data*>(
              message->mutable_payload());
  ...
  LinkGenerationError p_error{};
  LinkGenerationReadyStatus p_ready_status{};
  TextFragmentReceiver_RequestSelectorForViewportCenter_ResponseParamsDataView input_data_view(params, message);
...
void TextFragmentReceiver_RequestSelectorForViewportCenter_ProxyToResponder::Run(
    const std::string& in_selector, LinkGenerationError in_error, LinkGenerationReadyStatus in_ready_status) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "Send reply blink::mojom::TextFragmentReceiver::RequestSelectorForViewportCenter", "async_response_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("selector"), in_selector,
  ...
  mojo::Message message(
      std::to_underlying(messages::TextFragmentReceiver::kRequestSelectorForViewportCenter), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
      ::blink::mojom::internal::TextFragmentReceiver_RequestSelectorForViewportCenter_ResponseParams_Data> params(
          message);
  params.Allocate();
  mojo::internal::MessageFragment<
      typename decltype(params->selector)::BaseType> selector_fragment(
...
class TextFragmentReceiver_RequestSelectorForSelection_ProxyToResponder : public ::mojo::internal::ProxyToResponder {
 public:
  static TextFragmentReceiver::RequestSelectorForSelectionCallback CreateCallback(
      ::mojo::Message& message,
      std::unique_ptr<mojo::MessageReceiverWithStatus> responder) {
    std::unique_ptr<TextFragmentReceiver_RequestSelectorForSelection_ProxyToResponder> proxy(
        new TextFragmentReceiver_RequestSelectorForSelection_ProxyToResponder(
            message, std::move(responder)));
    return base::BindOnce(&TextFragmentReceiver_RequestSelectorForSelection_ProxyToResponder::Run,
                          std::move(proxy));
  }

  ~TextFragmentReceiver_RequestSelectorForSelection_ProxyToResponder() {
#if DCHECK_IS_ON()
    if (responder_) {
      // If we're being destroyed without being run, we want to ensure the
      // binding endpoint has been closed. This checks for that asynchronously.
 ...
 private:
  ...
  static void OnIsConnectedComplete(bool connected) {
    DCHECK(!connected)
        << "TextFragmentReceiver::RequestSelectorForSelectionCallback was destroyed without "
        << "first either being run or its corresponding binding being closed. "
        << "It is an error to drop response callbacks which still correspond "
        << "to an open interface pipe.";
  }
...
bool TextFragmentReceiver_RequestSelectorForSelection_ForwardToCallback::Accept(
    mojo::Message* message) {
  DCHECK(message->is_serialized());
  internal::TextFragmentReceiver_RequestSelectorForSelection_ResponseParams_Data* params =
      reinterpret_cast<
          internal::TextFragmentReceiver_RequestSelectorForSelection_ResponseParams_Data*>(
              message->mutable_payload());
  

  // Validation for TextFragmentReceiver.6
  bool success = true;
  std::string p_selector{};
  LinkGenerationError p_error{};
  LinkGenerationReadyStatus p_ready_status{};
  TextFragmentReceiver_RequestSelectorForSelection_ResponseParamsDataView input_data_view(params, message);
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        TextFragmentReceiver::Name_, 6, true);
    return false;
  }
  if (!callback_.is_null()) {
    std::move(callback_).Run(
...
void TextFragmentReceiver_RequestSelectorForSelection_ProxyToResponder::Run(
    const std::string& in_selector, LinkGenerationError in_error, LinkGenerationReadyStatus in_ready_status) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    "mojom", "Send reply blink::mojom::TextFragmentReceiver::RequestSelectorForSelection", "async_response_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("selector"), in_selector,
  ...
  mojo::Message message(
      std::to_underlying(messages::TextFragmentReceiver::kRequestSelectorForSelection), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
      ::blink::mojom::internal::TextFragmentReceiver_RequestSelectorForSelection_ResponseParams_Data> params(
          message);
  params.Allocate();
  mojo::internal::MessageFragment<
      typename decltype(params->selector)::BaseType> selector_fragment(
...
bool TextFragmentReceiver_ExtractFirstFragmentRect_ForwardToCallback::Accept(
  ...
  // Validation for TextFragmentReceiver.7
  bool success = true;
  ::gfx::Rect p_bounds{};
  ...
  if (!success) {
    ReportValidationErrorForMessage(
        message,
        mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
        TextFragmentReceiver::Name_, 7, true);
    return false;
  }
  if (!callback_.is_null()) {
    std::move(callback_).Run(
...
bool TextFragmentReceiverStubDispatch::AcceptWithResponder(
  ...
  switch (static_cast<messages::TextFragmentReceiver>(message->header()->name)) {
    ...
    case messages::TextFragmentReceiver::kRequestSelectorForViewportCenter: {
      internal::TextFragmentReceiver_RequestSelectorForViewportCenter_Params_Data* params =
          reinterpret_cast<
              internal::TextFragmentReceiver_RequestSelectorForViewportCenter_Params_Data*>(
                  message->mutable_payload());
      

      // Validation for TextFragmentReceiver.5
      bool success = true;
      TextFragmentReceiver_RequestSelectorForViewportCenter_ParamsDataView input_data_view(params, message);
      ...
      auto callback =
          TextFragmentReceiver_RequestSelectorForViewportCenter_ProxyToResponder::CreateCallback(
              *message, std::move(responder));
      // A null |impl| means no implementation was bound.
      DCHECK(impl);
      impl->RequestSelectorForViewportCenter(std::move(callback));
      return true;
    }
    case messages::TextFragmentReceiver::kRequestSelectorForSelection: {
      internal::TextFragmentReceiver_RequestSelectorForSelection_Params_Data* params =
          reinterpret_cast<
              internal::TextFragmentReceiver_RequestSelectorForSelection_Params_Data*>(
                  message->mutable_payload());
      

      // Validation for TextFragmentReceiver.6
      bool success = true;
      TextFragmentReceiver_RequestSelectorForSelection_ParamsDataView input_data_view(params, message);
      
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            TextFragmentReceiver::Name_, 6, false);
        return false;
      }
      auto callback =
          TextFragmentReceiver_RequestSelectorForSelection_ProxyToResponder::CreateCallback(
              *message, std::move(responder));
      // A null |impl| means no implementation was bound.
      DCHECK(impl);
      impl->RequestSelectorForSelection(std::move(callback));
      return true;
    }
    case messages::TextFragmentReceiver::kExtractFirstFragmentRect: {
      ...
      if (!success) {
        ReportValidationErrorForMessage(
            message,
            mojo::internal::VALIDATION_ERROR_DESERIALIZATION_FAILED,
            TextFragmentReceiver::Name_, 7, false);
        return false;
      }
      auto callback =
...
static const mojo::internal::GenericValidationInfo kTextFragmentReceiverValidationInfo[] = {
    ...
    { &internal::TextFragmentReceiver_RequestSelectorForViewportCenter_Params_Data::Validate,
     &internal::TextFragmentReceiver_RequestSelectorForViewportCenter_ResponseParams_Data::Validate},
    { &internal::TextFragmentReceiver_RequestSelectorForSelection_Params_Data::Validate,
     &internal::TextFragmentReceiver_RequestSelectorForSelection_ResponseParams_Data::Validate},
...
void TextFragmentReceiverInterceptorForTesting::RequestSelectorForViewportCenter(RequestSelectorForViewportCenterCallback callback) {
  GetForwardingInterface()->RequestSelectorForViewportCenter(std::move(callback));
}
void TextFragmentReceiverInterceptorForTesting::RequestSelectorForSelection(RequestSelectorForSelectionCallback callback) {
  GetForwardingInterface()->RequestSelectorForSelection(std::move(callback));
}
...
,
             LinkGenerationError* out_error
,
             LinkGenerationReadyStatus* out_ready_status
,
             const std::string& selector,
             LinkGenerationError error,
             LinkGenerationReadyStatus ready_status) {*out_selector = std::move(selector);*out_error = std::move(error);*out_ready_status = std::move(ready_status);
            loop->Quit();
          },
          &loop,
          out_selector,
  ...
  proxy_->ExtractTextFragmentsMatches(
      base::BindOnce(
          [](base::RunLoop* loop,
             std::vector<std::string>* out_text
,
             const std::vector<std::string>& text) {*out_text = std::move(text);
            loop->Quit();
          },
          &loop,
          out_text));
  ...
  proxy_->GetExistingSelectors(
      base::BindOnce(
          [](base::RunLoop* loop,
             std::vector<std::string>* out_selectors
,
             const std::vector<std::string>& selectors) {*out_selectors = std::move(selectors);
            loop->Quit();
          },
          &loop,
          out_selectors));
...
void TextFragmentReceiverAsyncWaiter::RequestSelectorForViewportCenter(
    std::string* out_selector, LinkGenerationError* out_error, LinkGenerationReadyStatus* out_ready_status) {
  base::RunLoop loop;
  proxy_->RequestSelectorForViewportCenter(
      base::BindOnce(
          [](base::RunLoop* loop,
             std::string* out_selector
,
...
void TextFragmentReceiverAsyncWaiter::RequestSelectorForSelection(
    std::string* out_selector, LinkGenerationError* out_error, LinkGenerationReadyStatus* out_ready_status) {
  base::RunLoop loop;
  proxy_->RequestSelectorForSelection(
      base::BindOnce(
          [](base::RunLoop* loop,
             std::string* out_selector
,
