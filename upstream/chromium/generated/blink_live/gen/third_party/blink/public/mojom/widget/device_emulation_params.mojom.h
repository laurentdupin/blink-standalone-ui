...
#include "third_party/blink/public/mojom/widget/device_emulation_params.mojom-forward.h"  // IWYU pragma: export
 ...
 public:
  ...
  static std::vector<uint8_t> Serialize(UserType* input) {
    return mojo::internal::SerializeImpl<
        DeviceEmulationParams::DataView, std::vector<uint8_t>, send_validation>(input);
  }
...
template <>
struct  StructTraits<::blink::mojom::DeviceEmulationParams::DataView,
  ...
  static const decltype(::blink::mojom::DeviceEmulationParams::viewport_segments)& viewport_segments(
      const ::blink::mojom::DeviceEmulationParamsPtr& input) {
  ...
  static decltype(::blink::mojom::DeviceEmulationParams::force_android_overlay_scrollbar) force_android_overlay_scrollbar(
      const ::blink::mojom::DeviceEmulationParamsPtr& input) {
