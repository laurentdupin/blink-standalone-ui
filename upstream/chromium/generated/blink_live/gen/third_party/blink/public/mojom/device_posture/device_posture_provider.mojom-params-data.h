...
static_assert(sizeof(DevicePostureClient_OnPostureChanged_Params_Data) == 16,
              "Bad sizeof(DevicePostureClient_OnPostureChanged_Params_Data)");
...
class DevicePostureProvider_AddListenerAndGetCurrentPosture_ParamsDataView {
 public:
  ...
  UserType TakeClient() {
    UserType result;
    bool ret =
        mojo::internal::Deserialize<mojo::InterfacePtrDataView<::blink::mojom::DevicePostureClientInterfaceBase>>(
 ...
 public:
  ...
  DevicePostureType posture() const {
    return ::mojo::internal::ToKnownEnumValueHelper(
          static_cast<::blink::mojom::DevicePostureType>(data_->posture));
  }
 private:
...
class DevicePostureClient_OnPostureChanged_ParamsDataView {
 public:
  ...
  DevicePostureClient_OnPostureChanged_ParamsDataView(
      internal::DevicePostureClient_OnPostureChanged_Params_Data* data,
      mojo::Message* message)
      : data_(data) {}
