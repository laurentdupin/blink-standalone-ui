...
bool OpenURLParams_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->actual_navigation_start, 4, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->extra_headers, 7, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->href_translate, 16, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->download_policy, 18, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->source_location, 19, validation_context)) {
    return false;
  }
