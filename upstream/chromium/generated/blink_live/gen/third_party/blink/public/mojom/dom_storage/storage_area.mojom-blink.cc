...
StorageAreaSource::StorageAreaSource()
    : page_url(),
      storage_area_id() {}

StorageAreaSource::StorageAreaSource(
    const ::blink::KURL& page_url_in,
    const ::base::Token& storage_area_id_in)
    : page_url(std::move(page_url_in)),
      storage_area_id(std::move(storage_area_id_in)) {}

StorageAreaSource::~StorageAreaSource() = default;

void StorageAreaSource::WriteIntoTrace(
  ...
  perfetto::WriteIntoTracedValueWithFallback(
    dict.AddItem(
      "storage_area_id"), this->storage_area_id,
#if BUILDFLAG(MOJO_TRACE_ENABLED)
...
bool StorageAreaSource::Validate(
    const void* data,
...
void StorageAreaObserverProxy::KeyChanged(
    const ::blink::Vector<uint8_t>& in_key, const ::blink::Vector<uint8_t>& in_new_value, const std::optional<::blink::Vector<uint8_t>>& in_old_value, StorageAreaSourcePtr in_source) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
    ...
    [&](perfetto::TracedValue context){
      ...
      perfetto::WriteIntoTracedValueWithFallback(
           dict.AddItem("source"), in_source,
                        "<value of type StorageAreaSourcePtr>");
   });
#endif
  ...
  mojo::Message message(
      std::to_underlying(messages::StorageAreaObserver::kKeyChanged), kFlags, estimated_payload_size);
  ...
  mojo::internal::Serialize<::blink::mojom::StorageAreaSourceDataView>(
    in_source,
    source_fragment);
...
void StorageAreaObserverProxy::KeyChangeFailed(
    const ::blink::Vector<uint8_t>& in_key, StorageAreaSourcePtr in_source) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::StorageAreaObserver::kKeyChangeFailed), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void StorageAreaObserverProxy::KeyDeleted(
    const ::blink::Vector<uint8_t>& in_key, const std::optional<::blink::Vector<uint8_t>>& in_old_value, StorageAreaSourcePtr in_source) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::StorageAreaObserver::kKeyDeleted), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void StorageAreaObserverProxy::AllDeleted(
    bool in_was_nonempty, StorageAreaSourcePtr in_source) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::StorageAreaObserver::kAllDeleted), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void StorageAreaObserverProxy::ShouldSendOldValueOnMutations(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::StorageAreaObserver::kShouldSendOldValueOnMutations), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void StorageAreaProxy::AddObserver(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::StorageArea::kAddObserver), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void StorageAreaProxy::Put(
    const ::blink::Vector<uint8_t>& in_key, const ::blink::Vector<uint8_t>& in_value, const std::optional<::blink::Vector<uint8_t>>& in_client_old_value, StorageAreaSourcePtr in_source, PutCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::StorageArea::kPut), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void StorageAreaProxy::Delete(
    const ::blink::Vector<uint8_t>& in_key, const std::optional<::blink::Vector<uint8_t>>& in_client_old_value, StorageAreaSourcePtr in_source, DeleteCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::StorageArea::kDelete), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
void StorageAreaProxy::DeleteAll(
    StorageAreaSourcePtr in_source, ::mojo::PendingRemote<StorageAreaObserver> in_new_observer, DeleteAllCallback callback) {
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT1(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::StorageArea::kDeleteAll), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
bool StorageAreaProxy::GetAll(
  ...
  const size_t estimated_payload_size =
    0;
  mojo::Message message(
      std::to_underlying(messages::StorageArea::kGetAll), kFlags, estimated_payload_size);
  mojo::internal::MessageFragment<
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT_END1(
    "mojom", "Call blink::mojom::StorageArea::GetAll (sync)", "sync_response_parameters",
    [&](perfetto::TracedValue context){
      auto dict = std::move(context).WriteDictionary();
      perfetto::WriteIntoTracedValueWithFallback(
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "Send reply blink::mojom::StorageArea::Delete");
#endif
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
  TRACE_EVENT0("mojom", "Send reply blink::mojom::StorageArea::DeleteAll");
#endif
...
// static
bool StructTraits<::blink::mojom::blink::StorageAreaSource::DataView, ::blink::mojom::blink::StorageAreaSourcePtr>::Read(
    ::blink::mojom::blink::StorageAreaSource::DataView input,
    ::blink::mojom::blink::StorageAreaSourcePtr* output) {
  bool success = true;
  ::blink::mojom::blink::StorageAreaSourcePtr result(::blink::mojom::blink::StorageAreaSource::New());
  
      if (success && !input.ReadPageUrl(&result->page_url))
        success = false;
      if (success && !input.ReadStorageAreaId(&result->storage_area_id))
        success = false;
...
void StorageAreaObserverInterceptorForTesting::KeyChanged(const ::blink::Vector<uint8_t>& key, const ::blink::Vector<uint8_t>& new_value, const std::optional<::blink::Vector<uint8_t>>& old_value, StorageAreaSourcePtr source) {
...
void StorageAreaObserverInterceptorForTesting::KeyChangeFailed(const ::blink::Vector<uint8_t>& key, StorageAreaSourcePtr source) {
...
void StorageAreaObserverInterceptorForTesting::KeyDeleted(const ::blink::Vector<uint8_t>& key, const std::optional<::blink::Vector<uint8_t>>& old_value, StorageAreaSourcePtr source) {
...
void StorageAreaObserverInterceptorForTesting::AllDeleted(bool was_nonempty, StorageAreaSourcePtr source) {
...
void StorageAreaInterceptorForTesting::Put(const ::blink::Vector<uint8_t>& key, const ::blink::Vector<uint8_t>& value, const std::optional<::blink::Vector<uint8_t>>& client_old_value, StorageAreaSourcePtr source, PutCallback callback) {
...
void StorageAreaInterceptorForTesting::Delete(const ::blink::Vector<uint8_t>& key, const std::optional<::blink::Vector<uint8_t>>& client_old_value, StorageAreaSourcePtr source, DeleteCallback callback) {
...
void StorageAreaInterceptorForTesting::DeleteAll(StorageAreaSourcePtr source, ::mojo::PendingRemote<StorageAreaObserver> new_observer, DeleteAllCallback callback) {
...
bool StorageAreaAsyncWaiter::Put(
    const ::blink::Vector<uint8_t>& key, const ::blink::Vector<uint8_t>& value, const std::optional<::blink::Vector<uint8_t>>& client_old_value, StorageAreaSourcePtr source) {
