...
class  SerializedArrayBufferContents {
 public:
  ...
  SerializedArrayBufferContents(
      ::mojo_base::mojom::blink::BigBufferPtr contents,
      std::optional<uint64_t> javascript_resize_limit);
...
SerializedArrayBufferContentsPtr SerializedArrayBufferContents::Clone() const {
  return New(
      mojo::Clone(contents),
      mojo::Clone(javascript_resize_limit)
  );
}
...
bool SerializedArrayBufferContents::Equals(const T& other_struct) const {
  if (!mojo::Equals(this->contents, other_struct.contents))
    return false;
  if (!mojo::Equals(this->javascript_resize_limit, other_struct.javascript_resize_limit))
    return false;
  return true;
}
...
bool operator<(const T& lhs, const T& rhs) {
  ...
  if (rhs.contents < lhs.contents)
    return false;
  if (lhs.javascript_resize_limit < rhs.javascript_resize_limit)
    return true;
  if (rhs.javascript_resize_limit < lhs.javascript_resize_limit)
    return false;
  return false;
}
...
template <>
struct  StructTraits<::blink::mojom::blink::SerializedArrayBufferContents::DataView,
  ...
  static decltype(::blink::mojom::blink::SerializedArrayBufferContents::javascript_resize_limit) javascript_resize_limit(
      const ::blink::mojom::blink::SerializedArrayBufferContentsPtr& input) {
    return input->javascript_resize_limit;
  }
