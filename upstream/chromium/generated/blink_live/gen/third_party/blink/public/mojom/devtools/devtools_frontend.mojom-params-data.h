...
namespace internal {
class  DevToolsFrontend_SetupDevToolsFrontend_Params_Data {
 public:
...
class  DevToolsFrontend_SetupDevToolsExtensionAPI_Params_Data {
 public:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
...
class  DevToolsFrontendHost_DispatchEmbedderMessage_Params_Data {
 public:
  static bool Validate(const void* data,
                       mojo::internal::ValidationContext* validation_context);
