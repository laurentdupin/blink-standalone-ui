...
FrameReplicationState::FrameReplicationState(
    ...
    std::vector<::network::mojom::ParsedPermissionsPolicyDeclarationPtr> permissions_policy_header_in,
    ::network::mojom::WebSandboxFlags active_sandbox_flags_in,
    ::blink::mojom::FramePolicyPtr frame_policy_in,
...
#if BUILDFLAG(MOJO_TRACE_ENABLED)
      "<value of type ::blink::mojom::FramePolicyPtr>"
#else
      "<value>"
#endif  // BUILDFLAG(MOJO_TRACE_ENABLED)
    );
