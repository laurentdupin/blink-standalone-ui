...
bool BeginNavigationParams_Data::Validate(
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->before_unload_dialog_opened, 18, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateStruct(object->before_unload_dialog_opened, validation_context))
    return false;

  if (!mojo::internal::ValidatePointerNonNullable(
          object->before_unload_dialog_closed, 19, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateStruct(object->before_unload_dialog_closed, validation_context))
    return false;

  if (!mojo::internal::ValidateStruct(object->script_tool_invocation_id, validation_context))
    return false;
...
// static
bool IsolatedAppPermissionPolicyEntry_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const IsolatedAppPermissionPolicyEntry_Data* object =
      static_cast<const IsolatedAppPermissionPolicyEntry_Data*>(data);

  if (!mojo::internal::ValidatePointerNonNullable(
          object->feature, 1, validation_context)) {
    return false;
  }
  constexpr const mojo::internal::ContainerValidateParams& feature_validate_params =
      mojo::internal::GetArrayValidator<0, false, nullptr>();
  if (!mojo::internal::ValidateContainer(object->feature, validation_context,
                                         &feature_validate_params)) {
    return false;
  }
...
IsolatedAppPermissionPolicyEntry_Data::IsolatedAppPermissionPolicyEntry_Data()
    : header_({sizeof(*this), 0}) {}
...
bool CommitNavigationParams_Data::Validate(
  ...
  if (!mojo::internal::ValidateInlinedUnionNonNullable(
          object->agent_cluster_key, 30, validation_context)) {
    return false;
  }
  if (!mojo::internal::ValidateInlinedUnion(object->agent_cluster_key, validation_context))
    return false;

  if (!mojo::internal::ValidatePointerNonNullable(
          object->enabled_client_hints, 31, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->navigation_api_history_entry_arrays, 36, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->early_hints_preloaded_resources, 37, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->commit_sent, 38, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->srcdoc_value, 39, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->reduced_accept_language, 42, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->modified_runtime_features, 46, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->content_settings, 52, validation_context)) {
    return false;
  }
  ...
  if (!mojo::internal::ValidatePointerNonNullable(
          object->navigation_metrics_token, 59, validation_context)) {
    return false;
  }
  ...
  constexpr const mojo::internal::ContainerValidateParams& isolated_app_policy_validate_params =
      mojo::internal::GetArrayValidator<0, false, nullptr>();
  if (!mojo::internal::ValidateContainer(object->isolated_app_policy, validation_context,
                                         &isolated_app_policy_validate_params)) {
    return false;
  }

  constexpr const mojo::internal::ContainerValidateParams& internal_scroll_to_text_fragment_validate_params =
      mojo::internal::GetArrayValidator<0, false, nullptr>();
  if (!mojo::internal::ValidateContainer(object->internal_scroll_to_text_fragment, validation_context,
                                         &internal_scroll_to_text_fragment_validate_params)) {
    return false;
  }
...
// static
bool NavigationResumeDeferredCommitListener_ResumeDeferredCommit_Params_Data::Validate(
    const void* data,
    mojo::internal::ValidationContext* validation_context) {
  if (!data)
    return true;
  ...
  // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
  // the message comes from an older version.
  [[maybe_unused]] const NavigationResumeDeferredCommitListener_ResumeDeferredCommit_Params_Data* object =
      static_cast<const NavigationResumeDeferredCommitListener_ResumeDeferredCommit_Params_Data*>(data);

  return true;
}

NavigationResumeDeferredCommitListener_ResumeDeferredCommit_Params_Data::NavigationResumeDeferredCommitListener_ResumeDeferredCommit_Params_Data()
    : header_({sizeof(*this), 0}) {}
