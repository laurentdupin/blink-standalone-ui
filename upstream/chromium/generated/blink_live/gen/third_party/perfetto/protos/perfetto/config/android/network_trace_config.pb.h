...
extern const ::google::protobuf::internal::ClassDataLite<41> NetworkPacketTraceConfig_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
class NetworkPacketTraceConfig final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.NetworkPacketTraceConfig) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR NetworkPacketTraceConfig(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(NetworkPacketTraceConfig* PROTOBUF_NONNULL other) {
  ...
  NetworkPacketTraceConfig* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<NetworkPacketTraceConfig>(arena);
  }
