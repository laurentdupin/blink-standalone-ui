...
class I2cReplyFtraceEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/7> {
 public:
  ...
  bool has_len() const { return at<5>().valid(); }
  uint32_t len() const { return at<5>().as_uint32(); }
  bool has_buf() const { return at<7>().valid(); }
  ::protozero::ConstBytes buf() const { return at<7>().as_bytes(); }
};
...
class I2cReplyFtraceEvent : public ::protozero::Message {
 public:
  ...
  void set_buf(const uint8_t* data, size_t size) {
    AppendBytes(FieldMetadata_Buf::kFieldId, data, size);
  }
  void set_buf(::protozero::ConstBytes bytes) {
    AppendBytes(FieldMetadata_Buf::kFieldId, bytes.data, bytes.size);
  }
...
class I2cWriteFtraceEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/7> {
 public:
