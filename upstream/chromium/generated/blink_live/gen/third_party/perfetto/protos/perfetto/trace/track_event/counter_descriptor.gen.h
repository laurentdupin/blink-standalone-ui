...
class PERFETTO_EXPORT_COMPONENT CounterDescriptor : public ::protozero::CppMessageObj {
 public:
  ...
  bool has_y_axis_share_key() const { return _has_field_[7]; }
  const std::string& y_axis_share_key() const { return y_axis_share_key_; }
  void set_y_axis_share_key(const std::string& value) { y_axis_share_key_ = value; _has_field_.set(7); }
