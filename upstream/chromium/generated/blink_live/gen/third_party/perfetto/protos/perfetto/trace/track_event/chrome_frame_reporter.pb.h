...
extern const ::google::protobuf::internal::ClassDataLite<36> ChromeFrameReporter_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
inline bool ChromeFrameReporter_State_IsValid(int value) {
...
inline bool ChromeFrameReporter_FrameDropReason_IsValid(int value) {
  return 0 <= value && value <= 3;
}
...
inline bool ChromeFrameReporter_ScrollState_IsValid(int value) {
...
inline bool ChromeFrameReporter_FrameType_IsValid(int value) {
...
class ChromeFrameReporter final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.ChromeFrameReporter) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR ChromeFrameReporter(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(ChromeFrameReporter* PROTOBUF_NONNULL other) {
  ...
  ChromeFrameReporter* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<ChromeFrameReporter>(arena);
  }
 ...
 public:
  ...
  static inline bool FrameDropReason_Parse(
  ...
  const ::google::protobuf::RepeatedPtrField<::std::string>& high_latency_contribution_stage() const;
  ::google::protobuf::RepeatedPtrField<::std::string>* PROTOBUF_NONNULL mutable_high_latency_contribution_stage();
  ...
  bool has_surface_frame_trace_id() const;
  void clear_surface_frame_trace_id() ;
  ::int64_t surface_frame_trace_id() const;
  ...
  bool has_display_trace_id() const;
  void clear_display_trace_id() ;
  ::int64_t display_trace_id() const;
