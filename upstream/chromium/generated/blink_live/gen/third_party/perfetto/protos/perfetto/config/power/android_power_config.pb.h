...
extern const ::google::protobuf::internal::ClassDataLite<35> AndroidPowerConfig_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
inline bool AndroidPowerConfig_BatteryCounters_IsValid(int value) {
...
class AndroidPowerConfig final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.AndroidPowerConfig) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR AndroidPowerConfig(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(AndroidPowerConfig* PROTOBUF_NONNULL other) {
  ...
  AndroidPowerConfig* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<AndroidPowerConfig>(arena);
  }
 ...
 public:
  ...
  static inline bool BatteryCounters_Parse(
  ...
  ::google::protobuf::RepeatedField<int>* PROTOBUF_NONNULL mutable_battery_counters();
