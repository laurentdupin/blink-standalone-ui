...
extern const ::google::protobuf::internal::ClassDataLite<40> ChromeProcessDescriptor_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
class ChromeProcessDescriptor final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.ChromeProcessDescriptor) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR ChromeProcessDescriptor(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(ChromeProcessDescriptor* PROTOBUF_NONNULL other) {
  ...
  ChromeProcessDescriptor* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<ChromeProcessDescriptor>(arena);
  }
