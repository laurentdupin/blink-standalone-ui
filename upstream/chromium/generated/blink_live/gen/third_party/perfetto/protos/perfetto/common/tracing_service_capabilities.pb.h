...
extern const ::google::protobuf::internal::ClassDataLite<43> TracingServiceCapabilities_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
class TracingServiceCapabilities final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.TracingServiceCapabilities) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR TracingServiceCapabilities(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(TracingServiceCapabilities* PROTOBUF_NONNULL other) {
  ...
  TracingServiceCapabilities* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<TracingServiceCapabilities>(arena);
  }
 ...
 public:
  ...
  const ::google::protobuf::RepeatedField<int>& observable_events() const;
  ::google::protobuf::RepeatedField<int>* PROTOBUF_NONNULL mutable_observable_events();
...
inline void TracingServiceCapabilities::add_observable_events(::perfetto::protos::ObservableEvents_Type value) {
                                          ...
                                          assert(::google::protobuf::internal::ValidateEnum(
                                              value, ::perfetto::protos::ObservableEvents_Type_internal_data_));
                                          ::google::protobuf::internal::TSanWrite(&_impl_);
  _internal_mutable_observable_events()->Add(value);
