...
class PERFETTO_EXPORT_COMPONENT ProcessStatsConfig : public ::protozero::CppMessageObj {
 public:
  ...
  bool has_record_process_dmabuf_rss() const { return _has_field_[13]; }
  bool record_process_dmabuf_rss() const { return record_process_dmabuf_rss_; }
  void set_record_process_dmabuf_rss(bool value) { record_process_dmabuf_rss_ = value; _has_field_.set(13); }
