...
class CommitDataRequest_ChunksToMove_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/5> {
 public:
  ...
  bool has_chunk_incomplete() const { return at<5>().valid(); }
  bool chunk_incomplete() const { return at<5>().as_bool(); }
};
...
class CommitDataRequest_ChunksToMove : public ::protozero::Message {
 public:
  ...
  using FieldMetadata_ChunkIncomplete =
    ::protozero::proto_utils::FieldMetadata<
      5,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kBool,
  ...
  static constexpr FieldMetadata_ChunkIncomplete kChunkIncomplete{};
  void set_chunk_incomplete(bool value) {
    static constexpr uint32_t field_id = FieldMetadata_ChunkIncomplete::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kBool>
