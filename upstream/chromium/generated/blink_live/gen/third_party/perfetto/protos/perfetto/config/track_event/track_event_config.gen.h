...
class PERFETTO_EXPORT_COMPONENT TrackEventConfig : public ::protozero::CppMessageObj {
 public:
  ...
  bool has_thread_time_subsampling_ns() const { return _has_field_[10]; }
  uint64_t thread_time_subsampling_ns() const { return thread_time_subsampling_ns_; }
  void set_thread_time_subsampling_ns(uint64_t value) { thread_time_subsampling_ns_ = value; _has_field_.set(10); }
