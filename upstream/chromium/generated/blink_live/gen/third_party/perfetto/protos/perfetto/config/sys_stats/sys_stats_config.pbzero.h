...
class SysStatsConfig_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/15> {
 public:
  ...
  bool has_slab_period_ms() const { return at<15>().valid(); }
  uint32_t slab_period_ms() const { return at<15>().as_uint32(); }
};
...
class SysStatsConfig : public ::protozero::Message {
 public:
  ...
  using FieldMetadata_SlabPeriodMs =
    ::protozero::proto_utils::FieldMetadata<
      15,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kUint32,
  ...
  static constexpr FieldMetadata_SlabPeriodMs kSlabPeriodMs{};
  void set_slab_period_ms(uint32_t value) {
    static constexpr uint32_t field_id = FieldMetadata_SlabPeriodMs::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kUint32>
