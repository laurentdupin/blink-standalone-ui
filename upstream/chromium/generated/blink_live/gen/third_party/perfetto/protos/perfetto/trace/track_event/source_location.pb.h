...
extern const ::google::protobuf::internal::ClassDataLite<31> SourceLocation_class_data_;
...
extern const ::google::protobuf::internal::ClassDataLite<43> UnsymbolizedSourceLocation_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
class UnsymbolizedSourceLocation final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.UnsymbolizedSourceLocation) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR UnsymbolizedSourceLocation(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(UnsymbolizedSourceLocation* PROTOBUF_NONNULL other) {
  ...
  UnsymbolizedSourceLocation* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<UnsymbolizedSourceLocation>(arena);
  }
...
class SourceLocation final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.SourceLocation) */ {
 public:
  ...
  PROTOBUF_NOINLINE void Swap(SourceLocation* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
  ...
  SourceLocation* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<SourceLocation>(arena);
  }
