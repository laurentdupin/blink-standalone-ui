...
class PERFETTO_EXPORT_COMPONENT PerfEvents_RawEvent : public ::protozero::CppMessageObj {
 public:
  ...
  bool has_pmu_name() const { return _has_field_[5]; }
  const std::string& pmu_name() const { return pmu_name_; }
  void set_pmu_name(const std::string& value) { pmu_name_ = value; _has_field_.set(5); }
