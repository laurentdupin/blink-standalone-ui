...
extern const ::google::protobuf::internal::ClassDataLite<27> LogMessage_class_data_;
class LogMessageBody;
struct LogMessageBodyDefaultTypeInternal;
extern LogMessageBodyDefaultTypeInternal _LogMessageBody_default_instance_;
extern const ::google::protobuf::internal::ClassDataLite<31> LogMessageBody_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
inline bool LogMessage_Priority_IsValid(int value) {
...
class LogMessageBody final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.LogMessageBody) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR LogMessageBody(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(LogMessageBody* PROTOBUF_NONNULL other) {
  ...
  LogMessageBody* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<LogMessageBody>(arena);
  }
...
class LogMessage final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.LogMessage) */ {
 public:
  ...
  PROTOBUF_NOINLINE void Swap(LogMessage* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
  ...
  LogMessage* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<LogMessage>(arena);
  }
