...
extern const ::google::protobuf::internal::ClassDataLite<27> TestConfig_class_data_;
...
extern const ::google::protobuf::internal::ClassDataLite<39> TestConfig_DummyFields_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
class TestConfig_DummyFields final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.TestConfig.DummyFields) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR TestConfig_DummyFields(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(TestConfig_DummyFields* PROTOBUF_NONNULL other) {
  ...
  TestConfig_DummyFields* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<TestConfig_DummyFields>(arena);
  }
...
class TestConfig final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.TestConfig) */ {
 public:
  ...
  PROTOBUF_NOINLINE void Swap(TestConfig* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
  ...
  TestConfig* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<TestConfig>(arena);
  }
...
inline ::perfetto::protos::TestConfig_DummyFields* PROTOBUF_NONNULL TestConfig::_internal_mutable_dummy_fields() {
  ...
  if (_impl_.dummy_fields_ == nullptr) {
    auto* p = ::google::protobuf::MessageLite::DefaultConstruct<::perfetto::protos::TestConfig_DummyFields>(GetArena());
