...
extern const ::google::protobuf::internal::ClassDataLite<32> ChromeLegacyIpc_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
inline bool ChromeLegacyIpc_MessageClass_IsValid(int value) {
...
class ChromeLegacyIpc final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.ChromeLegacyIpc) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR ChromeLegacyIpc(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(ChromeLegacyIpc* PROTOBUF_NONNULL other) {
  ...
  ChromeLegacyIpc* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<ChromeLegacyIpc>(arena);
  }
 ...
 public:
  ...
  static inline bool MessageClass_Parse(
