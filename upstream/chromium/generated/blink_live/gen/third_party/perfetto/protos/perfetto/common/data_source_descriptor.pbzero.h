...
class DataSourceDescriptor_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/10> {
 public:
  ...
  bool has_protovm_program() const { return at<10>().valid(); }
  ::protozero::ConstBytes protovm_program() const { return at<10>().as_bytes(); }
...
class DataSourceDescriptor : public ::protozero::Message {
 public:
  ...
  using FieldMetadata_ProtovmProgram =
    ::protozero::proto_utils::FieldMetadata<
      10,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
  ...
  static constexpr FieldMetadata_ProtovmProgram kProtovmProgram{};
  template <typename T = VmProgram> T* set_protovm_program() {
