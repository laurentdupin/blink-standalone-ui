...
class SchedGroupTrackerFtraceEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/4> {
 public:
  SchedGroupTrackerFtraceEvent_Decoder(const uint8_t* data, size_t len) : TypedProtoDecoder(data, len) {}
  explicit SchedGroupTrackerFtraceEvent_Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
  explicit SchedGroupTrackerFtraceEvent_Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
  ...
  ::protozero::ConstChars group() const { return at<3>().as_string(); }
  bool has_group_num() const { return at<4>().valid(); }
  int32_t group_num() const { return at<4>().as_int32(); }
};

class SchedGroupTrackerFtraceEvent : public ::protozero::Message {
 public:
  using Decoder = SchedGroupTrackerFtraceEvent_Decoder;
  enum : int32_t {
    kCommFieldNumber = 1,
    kPidFieldNumber = 2,
    kGroupFieldNumber = 3,
    kGroupNumFieldNumber = 4,
  };
  static constexpr const char* GetName() { return ".perfetto.protos.SchedGroupTrackerFtraceEvent"; }
  ...
  void set_group(const char* data, size_t size) {
    AppendBytes(FieldMetadata_Group::kFieldId, data, size);
  }
  void set_group(::protozero::ConstChars chars) {
    AppendBytes(FieldMetadata_Group::kFieldId, chars.data, chars.size);
  }
  ...
  static constexpr FieldMetadata_GroupNum kGroupNum{};
  void set_group_num(int32_t value) {
    static constexpr uint32_t field_id = FieldMetadata_GroupNum::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kInt32>
