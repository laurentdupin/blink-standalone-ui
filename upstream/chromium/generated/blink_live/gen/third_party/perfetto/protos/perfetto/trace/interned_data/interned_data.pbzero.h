...
class AndroidJobName_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/2> {
 public:
  AndroidJobName_Decoder(const uint8_t* data, size_t len) : TypedProtoDecoder(data, len) {}
  explicit AndroidJobName_Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
  explicit AndroidJobName_Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
...
class AndroidJobName : public ::protozero::Message {
 public:
  using Decoder = AndroidJobName_Decoder;
  enum : int32_t {
    kIidFieldNumber = 1,
    kNameFieldNumber = 2,
  };
  static constexpr const char* GetName() { return ".perfetto.protos.AndroidJobName"; }
...
class InternedData_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/47> {
 public:
  ...
  bool has_android_job_name() const { return at<44>().valid(); }
  ::protozero::RepeatedFieldIterator<::protozero::ConstBytes> android_job_name() const { return GetRepeated<::protozero::ConstBytes>(44); }
...
class InternedData : public ::protozero::Message {
 public:
  ...
  using FieldMetadata_AndroidJobName =
    ::protozero::proto_utils::FieldMetadata<
      44,
      ::protozero::proto_utils::RepetitionType::kRepeatedNotPacked,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
  ...
  static constexpr FieldMetadata_AndroidJobName kAndroidJobName{};
  template <typename T = AndroidJobName> T* add_android_job_name() {
