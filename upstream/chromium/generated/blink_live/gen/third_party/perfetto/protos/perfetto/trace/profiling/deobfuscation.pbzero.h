...
class ObfuscatedMember_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/6> {
 public:
  ...
  bool has_deobfuscated_name() const { return at<2>().valid(); }
  ::protozero::ConstChars deobfuscated_name() const { return at<2>().as_string(); }
  bool has_obfuscated_line_start() const { return at<3>().valid(); }
  uint32_t obfuscated_line_start() const { return at<3>().as_uint32(); }
  bool has_obfuscated_line_end() const { return at<4>().valid(); }
  uint32_t obfuscated_line_end() const { return at<4>().as_uint32(); }
  bool has_source_line_start() const { return at<5>().valid(); }
  uint32_t source_line_start() const { return at<5>().as_uint32(); }
  bool has_source_line_end() const { return at<6>().valid(); }
  uint32_t source_line_end() const { return at<6>().as_uint32(); }
};
...
class ObfuscatedMember : public ::protozero::Message {
 public:
  ...
  using FieldMetadata_ObfuscatedLineStart =
    ::protozero::proto_utils::FieldMetadata<
      3,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
  ...
  static constexpr FieldMetadata_ObfuscatedLineStart kObfuscatedLineStart{};
  void set_obfuscated_line_start(uint32_t value) {
    static constexpr uint32_t field_id = FieldMetadata_ObfuscatedLineStart::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kUint32>
  ...
  using FieldMetadata_ObfuscatedLineEnd =
    ::protozero::proto_utils::FieldMetadata<
      4,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kUint32,
  ...
  static constexpr FieldMetadata_ObfuscatedLineEnd kObfuscatedLineEnd{};
  void set_obfuscated_line_end(uint32_t value) {
    static constexpr uint32_t field_id = FieldMetadata_ObfuscatedLineEnd::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kUint32>
  ...
  using FieldMetadata_SourceLineStart =
    ::protozero::proto_utils::FieldMetadata<
      5,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kUint32,
  ...
  static constexpr FieldMetadata_SourceLineStart kSourceLineStart{};
  void set_source_line_start(uint32_t value) {
    static constexpr uint32_t field_id = FieldMetadata_SourceLineStart::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kUint32>
  ...
  using FieldMetadata_SourceLineEnd =
    ::protozero::proto_utils::FieldMetadata<
      6,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kUint32,
  ...
  static constexpr FieldMetadata_SourceLineEnd kSourceLineEnd{};
  void set_source_line_end(uint32_t value) {
    static constexpr uint32_t field_id = FieldMetadata_SourceLineEnd::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kUint32>
