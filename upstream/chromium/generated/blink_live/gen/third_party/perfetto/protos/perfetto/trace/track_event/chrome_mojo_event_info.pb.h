...
extern const ::google::protobuf::internal::ClassDataLite<36> ChromeMojoEventInfo_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
class ChromeMojoEventInfo final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.ChromeMojoEventInfo) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR ChromeMojoEventInfo(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(ChromeMojoEventInfo* PROTOBUF_NONNULL other) {
  ...
  ChromeMojoEventInfo* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<ChromeMojoEventInfo>(arena);
  }
