...
class StackWalkEtwEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/2> {
 public:
  StackWalkEtwEvent_Decoder(const uint8_t* data, size_t len) : TypedProtoDecoder(data, len) {}
  explicit StackWalkEtwEvent_Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
  explicit StackWalkEtwEvent_Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
  bool has_trigger() const { return at<1>().valid(); }
  ::protozero::ConstChars trigger() const { return at<1>().as_string(); }
  bool has_callstack_iid() const { return at<2>().valid(); }
  uint64_t callstack_iid() const { return at<2>().as_uint64(); }
};

class StackWalkEtwEvent : public ::protozero::Message {
 public:
  using Decoder = StackWalkEtwEvent_Decoder;
  enum : int32_t {
    kTriggerFieldNumber = 1,
    kCallstackIidFieldNumber = 2,
  };
  static constexpr const char* GetName() { return ".perfetto.protos.StackWalkEtwEvent"; }
  ...
  void set_trigger(const char* data, size_t size) {
    AppendBytes(FieldMetadata_Trigger::kFieldId, data, size);
  }
  void set_trigger(::protozero::ConstChars chars) {
    AppendBytes(FieldMetadata_Trigger::kFieldId, chars.data, chars.size);
  }
  void set_trigger(std::string value) {
    static constexpr uint32_t field_id = FieldMetadata_Trigger::kFieldId;
...
class FileIoSimpleOpEtwEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/5> {
 public:
...
class FileIoReadWriteEtwEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/8> {
 public:
  ...
  bool has_opcode() const { return at<8>().valid(); }
  uint32_t opcode() const { return at<8>().as_uint32(); }
};
...
class FileIoInfoEtwEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/7> {
 public:
  ...
  bool has_opcode() const { return at<7>().valid(); }
  uint32_t opcode() const { return at<7>().as_uint32(); }
};
...
class FileIoDirEnumEtwEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/9> {
 public:
  ...
  bool has_opcode() const { return at<9>().valid(); }
  uint32_t opcode() const { return at<9>().as_uint32(); }
};
