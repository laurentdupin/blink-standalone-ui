...
extern const ::google::protobuf::internal::ClassDataLite<40> ChromeBenchmarkMetadata_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
class ChromeBenchmarkMetadata final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.ChromeBenchmarkMetadata) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR ChromeBenchmarkMetadata(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(ChromeBenchmarkMetadata* PROTOBUF_NONNULL other) {
  ...
  ChromeBenchmarkMetadata* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<ChromeBenchmarkMetadata>(arena);
  }
 ...
 public:
  ...
  const ::google::protobuf::RepeatedPtrField<::std::string>& story_tags() const;
  ::google::protobuf::RepeatedPtrField<::std::string>* PROTOBUF_NONNULL mutable_story_tags();
