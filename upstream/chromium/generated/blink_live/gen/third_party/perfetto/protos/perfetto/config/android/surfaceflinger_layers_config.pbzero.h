...
constexpr SurfaceFlingerLayersConfig_Mode SurfaceFlingerLayersConfig_Mode_MAX = SurfaceFlingerLayersConfig_Mode::MODE_PROTOVM;
...
const char* SurfaceFlingerLayersConfig_Mode_Name(::perfetto::protos::pbzero::SurfaceFlingerLayersConfig_Mode value) {
  ...
  case ::perfetto::protos::pbzero::SurfaceFlingerLayersConfig_Mode::MODE_PROTOVM:
    return "MODE_PROTOVM";
  }
...
class SurfaceFlingerLayersConfig : public ::protozero::Message {
 public:
  ...
  static inline const Mode MODE_PROTOVM = Mode::MODE_PROTOVM;
