...
class PERFETTO_EXPORT_COMPONENT FtraceConfig : public ::protozero::CppMessageObj {
 public:
  ...
  bool has_atrace_userspace_only() const { return _has_field_[34]; }
  bool atrace_userspace_only() const { return atrace_userspace_only_; }
  void set_atrace_userspace_only(bool value) { atrace_userspace_only_ = value; _has_field_.set(34); }
  ...
  bool has_function_graph_max_depth() const { return _has_field_[33]; }
  uint32_t function_graph_max_depth() const { return function_graph_max_depth_; }
  void set_function_graph_max_depth(uint32_t value) { function_graph_max_depth_ = value; _has_field_.set(33); }
  ...
  const std::vector<uint32_t>& tids_to_trace() const { return tids_to_trace_; }
  std::vector<uint32_t>* mutable_tids_to_trace() { return &tids_to_trace_; }
  int tids_to_trace_size() const { return static_cast<int>(tids_to_trace_.size()); }
  void clear_tids_to_trace() { tids_to_trace_.clear(); }
  void add_tids_to_trace(uint32_t value) { tids_to_trace_.emplace_back(value); }
  uint32_t* add_tids_to_trace() { tids_to_trace_.emplace_back(); return &tids_to_trace_.back(); }

  const std::vector<FtraceConfig_TracefsOption>& tracefs_options() const { return tracefs_options_; }
  std::vector<FtraceConfig_TracefsOption>* mutable_tracefs_options() { return &tracefs_options_; }
  int tracefs_options_size() const;
  void clear_tracefs_options();
  FtraceConfig_TracefsOption* add_tracefs_options();

  bool has_tracing_cpumask() const { return _has_field_[37]; }
  const std::string& tracing_cpumask() const { return tracing_cpumask_; }
  void set_tracing_cpumask(const std::string& value) { tracing_cpumask_ = value; _has_field_.set(37); }
 ...
 private:
  ...
  std::vector<uint32_t> tids_to_trace_;
  std::vector<FtraceConfig_TracefsOption> tracefs_options_;
  std::string tracing_cpumask_{};
...
class PERFETTO_EXPORT_COMPONENT FtraceConfig_TracefsOption : public ::protozero::CppMessageObj {
 public:
  using State = FtraceConfig_TracefsOption_State;
  static constexpr auto STATE_UNKNOWN = FtraceConfig_TracefsOption_State_STATE_UNKNOWN;
  static constexpr auto STATE_ENABLED = FtraceConfig_TracefsOption_State_STATE_ENABLED;
  static constexpr auto STATE_DISABLED = FtraceConfig_TracefsOption_State_STATE_DISABLED;
  static constexpr auto State_MIN = FtraceConfig_TracefsOption_State_STATE_UNKNOWN;
  static constexpr auto State_MAX = FtraceConfig_TracefsOption_State_STATE_DISABLED;
  enum FieldNumbers {
    kNameFieldNumber = 1,
    kStateFieldNumber = 2,
  };
  ...
  ~FtraceConfig_TracefsOption() override;
  FtraceConfig_TracefsOption(FtraceConfig_TracefsOption&&) noexcept;
  FtraceConfig_TracefsOption& operator=(FtraceConfig_TracefsOption&&);
  FtraceConfig_TracefsOption(const FtraceConfig_TracefsOption&);
  FtraceConfig_TracefsOption& operator=(const FtraceConfig_TracefsOption&);
  bool operator==(const FtraceConfig_TracefsOption&) const;
  bool operator!=(const FtraceConfig_TracefsOption& other) const { return !(*this == other); }
  ...
  FtraceConfig_TracefsOption_State state() const { return state_; }
  void set_state(FtraceConfig_TracefsOption_State value) { state_ = value; _has_field_.set(2); }

 private:
  std::string name_{};
  FtraceConfig_TracefsOption_State state_{};
