...
extern const ::google::protobuf::internal::ClassDataLite<33> ThreadDescriptor_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
inline bool ThreadDescriptor_ChromeThreadType_IsValid(int value) {
...
const ::std::string& ThreadDescriptor_ChromeThreadType_Name(T value) {
  ...
  return ThreadDescriptor_ChromeThreadType_Name(static_cast<ThreadDescriptor_ChromeThreadType>(value));
}
...
class ThreadDescriptor final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.ThreadDescriptor) */ {
 public:
  ...
  PROTOBUF_NOINLINE void Swap(ThreadDescriptor* PROTOBUF_NONNULL other) {
  ...
  ThreadDescriptor* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<ThreadDescriptor>(arena);
  }
 ...
 public:
  ...
  static inline bool ChromeThreadType_Parse(
