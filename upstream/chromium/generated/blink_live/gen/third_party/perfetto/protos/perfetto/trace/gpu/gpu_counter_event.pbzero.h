...
class InternedGpuCounterDescriptor_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/3> {
 public:
  InternedGpuCounterDescriptor_Decoder(const uint8_t* data, size_t len) : TypedProtoDecoder(data, len) {}
  explicit InternedGpuCounterDescriptor_Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
  explicit InternedGpuCounterDescriptor_Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
  bool has_iid() const { return at<1>().valid(); }
  uint64_t iid() const { return at<1>().as_uint64(); }
  bool has_counter_descriptor() const { return at<2>().valid(); }
  ::protozero::ConstBytes counter_descriptor() const { return at<2>().as_bytes(); }
  bool has_gpu_id() const { return at<3>().valid(); }
  int32_t gpu_id() const { return at<3>().as_int32(); }
};

class InternedGpuCounterDescriptor : public ::protozero::Message {
 public:
  using Decoder = InternedGpuCounterDescriptor_Decoder;
  enum : int32_t {
    kIidFieldNumber = 1,
    kCounterDescriptorFieldNumber = 2,
    kGpuIdFieldNumber = 3,
  };
  static constexpr const char* GetName() { return ".perfetto.protos.InternedGpuCounterDescriptor"; }
...
class GpuCounterEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/4> {
 public:
  ...
  bool has_counter_descriptor_iid() const { return at<4>().valid(); }
  uint64_t counter_descriptor_iid() const { return at<4>().as_uint64(); }
...
class GpuCounterEvent : public ::protozero::Message {
 public:
  ...
  using FieldMetadata_CounterDescriptorIid =
    ::protozero::proto_utils::FieldMetadata<
      4,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kUint64,
  ...
  static constexpr FieldMetadata_CounterDescriptorIid kCounterDescriptorIid{};
  void set_counter_descriptor_iid(uint64_t value) {
    static constexpr uint32_t field_id = FieldMetadata_CounterDescriptorIid::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kUint64>
