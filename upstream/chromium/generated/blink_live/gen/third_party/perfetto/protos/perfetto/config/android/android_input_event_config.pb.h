...
extern const ::google::protobuf::internal::ClassDataLite<40> AndroidInputEventConfig_class_data_;
...
extern const ::google::protobuf::internal::ClassDataLite<50> AndroidInputEventConfig_TraceRule_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
inline bool AndroidInputEventConfig_TraceMode_IsValid(int value) {
...
template <typename T>
const ::std::string& AndroidInputEventConfig_TraceMode_Name(T value) {
...
inline bool AndroidInputEventConfig_TraceLevel_IsValid(int value) {
...
template <typename T>
const ::std::string& AndroidInputEventConfig_TraceLevel_Name(T value) {
...
class AndroidInputEventConfig_TraceRule final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.AndroidInputEventConfig.TraceRule) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR AndroidInputEventConfig_TraceRule(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(AndroidInputEventConfig_TraceRule* PROTOBUF_NONNULL other) {
  ...
  AndroidInputEventConfig_TraceRule* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<AndroidInputEventConfig_TraceRule>(arena);
  }
 ...
 public:
  ...
  const ::google::protobuf::RepeatedPtrField<::std::string>& match_all_packages() const;
  ::google::protobuf::RepeatedPtrField<::std::string>* PROTOBUF_NONNULL mutable_match_all_packages();
  ...
  const ::google::protobuf::RepeatedPtrField<::std::string>& match_any_packages() const;
  ::google::protobuf::RepeatedPtrField<::std::string>* PROTOBUF_NONNULL mutable_match_any_packages();
...
class AndroidInputEventConfig final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.AndroidInputEventConfig) */ {
 public:
  ...
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR AndroidInputEventConfig(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(AndroidInputEventConfig* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
  ...
  AndroidInputEventConfig* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<AndroidInputEventConfig>(arena);
  }
 ...
 public:
  ...
  template <typename T>
  static inline const ::std::string& TraceMode_Name(T value) {
    return AndroidInputEventConfig_TraceMode_Name(value);
  }
  static inline bool TraceMode_Parse(
  ...
  static inline bool TraceLevel_Parse(
  ...
  public:
  void clear_rules() ;
  ::perfetto::protos::AndroidInputEventConfig_TraceRule* PROTOBUF_NONNULL mutable_rules(int index);
  ::google::protobuf::RepeatedPtrField<::perfetto::protos::AndroidInputEventConfig_TraceRule>* PROTOBUF_NONNULL mutable_rules();
  ...
  const ::google::protobuf::RepeatedPtrField<::perfetto::protos::AndroidInputEventConfig_TraceRule>& rules() const;
