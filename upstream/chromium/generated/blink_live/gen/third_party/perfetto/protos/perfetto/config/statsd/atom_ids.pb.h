...
#ifndef protos_2fperfetto_2fconfig_2fstatsd_2fatom_5fids_2eproto_2epb_2eh
#define protos_2fperfetto_2fconfig_2fstatsd_2fatom_5fids_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_protos_2fperfetto_2fconfig_2fstatsd_2fatom_5fids_2eproto
...
struct TableStruct_protos_2fperfetto_2fconfig_2fstatsd_2fatom_5fids_2eproto {
  static const ::uint32_t offsets[];
};
namespace perfetto {
namespace protos {
enum AtomId : int;
extern const uint32_t AtomId_internal_data_[];
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
template <>
internal::EnumTraitsT<::perfetto::protos::AtomId_internal_data_>
    internal::EnumTraitsImpl::value<::perfetto::protos::AtomId>;
}  // namespace protobuf
}  // namespace google
...
extern const uint32_t AtomId_internal_data_[];
inline constexpr AtomId AtomId_MIN =
    static_cast<AtomId>(0);
inline constexpr AtomId AtomId_MAX =
    static_cast<AtomId>(99999);
inline bool AtomId_IsValid(int value) {
  return ::google::protobuf::internal::ValidateEnum(value, AtomId_internal_data_);
}
inline constexpr int AtomId_ARRAYSIZE = 99999 + 1;
const ::std::string& AtomId_Name(AtomId value);
template <typename T>
const ::std::string& AtomId_Name(T value) {
  static_assert(::std::is_same<T, AtomId>::value ||
                    ::std::is_integral<T>::value,
                "Incorrect type passed to AtomId_Name().");
  return AtomId_Name(static_cast<AtomId>(value));
}
bool AtomId_Parse(
    ::absl::string_view name, AtomId* PROTOBUF_NONNULL value);
...
template <>
struct is_proto_enum<::perfetto::protos::AtomId> : std::true_type {};
...
#endif  // protos_2fperfetto_2fconfig_2fstatsd_2fatom_5fids_2eproto_2epb_2eh
