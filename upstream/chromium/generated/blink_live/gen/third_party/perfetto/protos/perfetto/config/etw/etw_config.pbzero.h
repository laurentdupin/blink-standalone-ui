...
class EtwConfig_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/5> {
 public:
  ...
  bool has_stack_sampling_events() const { return at<5>().valid(); }
  ::protozero::RepeatedFieldIterator<::protozero::ConstChars> stack_sampling_events() const { return GetRepeated<::protozero::ConstChars>(5); }
};
...
class EtwConfig : public ::protozero::Message {
 public:
  ...
  using FieldMetadata_StackSamplingEvents =
    ::protozero::proto_utils::FieldMetadata<
      5,
      ::protozero::proto_utils::RepetitionType::kRepeatedNotPacked,
      ::protozero::proto_utils::ProtoSchemaType::kString,
  ...
  static constexpr FieldMetadata_StackSamplingEvents kStackSamplingEvents{};
  void add_stack_sampling_events(const char* data, size_t size) {
    AppendBytes(FieldMetadata_StackSamplingEvents::kFieldId, data, size);
  }
  void add_stack_sampling_events(::protozero::ConstChars chars) {
    AppendBytes(FieldMetadata_StackSamplingEvents::kFieldId, chars.data, chars.size);
  }
  void add_stack_sampling_events(std::string value) {
    static constexpr uint32_t field_id = FieldMetadata_StackSamplingEvents::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kString>
