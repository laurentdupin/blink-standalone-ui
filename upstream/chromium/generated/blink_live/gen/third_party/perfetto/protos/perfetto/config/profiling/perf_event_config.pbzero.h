...
class PerfEventConfig_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/22> {
 public:
  ...
  bool has_ignore_open_failure() const { return at<21>().valid(); }
  bool ignore_open_failure() const { return at<21>().as_bool(); }
  bool has_cpuid() const { return at<22>().valid(); }
  ::protozero::RepeatedFieldIterator<::protozero::ConstChars> cpuid() const { return GetRepeated<::protozero::ConstChars>(22); }
...
class PerfEventConfig : public ::protozero::Message {
 public:
  ...
  using FieldMetadata_IgnoreOpenFailure =
    ::protozero::proto_utils::FieldMetadata<
      21,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
  ...
  static constexpr FieldMetadata_IgnoreOpenFailure kIgnoreOpenFailure{};
  void set_ignore_open_failure(bool value) {
    static constexpr uint32_t field_id = FieldMetadata_IgnoreOpenFailure::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kBool>
  ...
  void add_cpuid(const char* data, size_t size) {
    AppendBytes(FieldMetadata_Cpuid::kFieldId, data, size);
  }
  void add_cpuid(::protozero::ConstChars chars) {
    AppendBytes(FieldMetadata_Cpuid::kFieldId, chars.data, chars.size);
  }
  void add_cpuid(std::string value) {
