...
namespace perfetto_pbzero_enum_FtraceConfig_TracefsOption {
enum State : int32_t;
}  // namespace perfetto_pbzero_enum_FtraceConfig_TracefsOption
using FtraceConfig_TracefsOption_State = perfetto_pbzero_enum_FtraceConfig_TracefsOption::State;
} // Namespace pbzero.
} // Namespace protos.
} // Namespace perfetto.
...
constexpr FtraceConfig_TracefsOption_State FtraceConfig_TracefsOption_State_MIN = FtraceConfig_TracefsOption_State::STATE_UNKNOWN;
constexpr FtraceConfig_TracefsOption_State FtraceConfig_TracefsOption_State_MAX = FtraceConfig_TracefsOption_State::STATE_DISABLED;


PERFETTO_PROTOZERO_CONSTEXPR14_OR_INLINE
const char* FtraceConfig_TracefsOption_State_Name(::perfetto::protos::pbzero::FtraceConfig_TracefsOption_State value) {
  switch (value) {
  case ::perfetto::protos::pbzero::FtraceConfig_TracefsOption_State::STATE_UNKNOWN:
    return "STATE_UNKNOWN";

  case ::perfetto::protos::pbzero::FtraceConfig_TracefsOption_State::STATE_ENABLED:
    return "STATE_ENABLED";

  case ::perfetto::protos::pbzero::FtraceConfig_TracefsOption_State::STATE_DISABLED:
...
class FtraceConfig_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/37> {
 public:
  ...
  bool has_tracefs_options() const { return at<36>().valid(); }
  ::protozero::RepeatedFieldIterator<::protozero::ConstBytes> tracefs_options() const { return GetRepeated<::protozero::ConstBytes>(36); }
  bool has_tracing_cpumask() const { return at<37>().valid(); }
  ::protozero::ConstChars tracing_cpumask() const { return at<37>().as_string(); }
...
class FtraceConfig : public ::protozero::Message {
 public:
  ...
  using TracefsOption = ::perfetto::protos::pbzero::FtraceConfig_TracefsOption;
  ...
  using FieldMetadata_TracefsOptions =
    ::protozero::proto_utils::FieldMetadata<
      36,
      ::protozero::proto_utils::RepetitionType::kRepeatedNotPacked,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
  ...
  static constexpr FieldMetadata_TracefsOptions kTracefsOptions{};
  template <typename T = FtraceConfig_TracefsOption> T* add_tracefs_options() {
    return BeginNestedMessage<T>(36);
  }


  using FieldMetadata_TracingCpumask =
    ::protozero::proto_utils::FieldMetadata<
      37,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kString,
  ...
  static constexpr FieldMetadata_TracingCpumask kTracingCpumask{};
  void set_tracing_cpumask(const char* data, size_t size) {
    AppendBytes(FieldMetadata_TracingCpumask::kFieldId, data, size);
  }
  void set_tracing_cpumask(::protozero::ConstChars chars) {
    AppendBytes(FieldMetadata_TracingCpumask::kFieldId, chars.data, chars.size);
  }
  void set_tracing_cpumask(std::string value) {
    static constexpr uint32_t field_id = FieldMetadata_TracingCpumask::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kString>
...
class FtraceConfig_TracefsOption_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/2> {
 public:
  ...
  explicit FtraceConfig_TracefsOption_Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
...
class FtraceConfig_TracefsOption : public ::protozero::Message {
 public:
  using Decoder = FtraceConfig_TracefsOption_Decoder;
  enum : int32_t {
    kNameFieldNumber = 1,
    kStateFieldNumber = 2,
  };
  static constexpr const char* GetName() { return ".perfetto.protos.FtraceConfig.TracefsOption"; }


  using State = ::perfetto::protos::pbzero::FtraceConfig_TracefsOption_State;
  static inline const char* State_Name(State value) {
    return ::perfetto::protos::pbzero::FtraceConfig_TracefsOption_State_Name(value);
  }
  static inline const State STATE_UNKNOWN = State::STATE_UNKNOWN;
  static inline const State STATE_ENABLED = State::STATE_ENABLED;
  ...
  using FieldMetadata_State =
    ::protozero::proto_utils::FieldMetadata<
      ...
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kEnum,
      FtraceConfig_TracefsOption_State,
      FtraceConfig_TracefsOption>;

  static constexpr FieldMetadata_State kState{};
  void set_state(FtraceConfig_TracefsOption_State value) {
