...
class PERFETTO_EXPORT_COMPONENT TraceConfig : public ::protozero::CppMessageObj {
 public:
  ...
  static constexpr auto WRITE_FLUSH_UNSPECIFIED = TraceConfig_WriteFlushMode_WRITE_FLUSH_UNSPECIFIED;
  static constexpr auto WRITE_FLUSH_AUTO = TraceConfig_WriteFlushMode_WRITE_FLUSH_AUTO;
  static constexpr auto WRITE_FLUSH_DISABLED = TraceConfig_WriteFlushMode_WRITE_FLUSH_DISABLED;
  static constexpr auto WRITE_FLUSH_ENABLED = TraceConfig_WriteFlushMode_WRITE_FLUSH_ENABLED;
  static constexpr auto WriteFlushMode_MIN = TraceConfig_WriteFlushMode_WRITE_FLUSH_UNSPECIFIED;
  static constexpr auto WriteFlushMode_MAX = TraceConfig_WriteFlushMode_WRITE_FLUSH_ENABLED;
  using FFlushMode = TraceConfig_FFlushMode;
  static constexpr auto FFLUSH_UNSPECIFIED = TraceConfig_FFlushMode_FFLUSH_UNSPECIFIED;
  static constexpr auto FFLUSH_DISABLED = TraceConfig_FFlushMode_FFLUSH_DISABLED;
  static constexpr auto FFLUSH_ENABLED = TraceConfig_FFlushMode_FFLUSH_ENABLED;
  static constexpr auto FFlushMode_MIN = TraceConfig_FFlushMode_FFLUSH_UNSPECIFIED;
  static constexpr auto FFlushMode_MAX = TraceConfig_FFlushMode_FFLUSH_ENABLED;
  enum FieldNumbers {
  ...
  bool has_priority_boost() const { return _has_field_[40]; }
  const PriorityBoostConfig& priority_boost() const { return *priority_boost_; }
  PriorityBoostConfig* mutable_priority_boost() { _has_field_.set(40); return priority_boost_.get(); }

  bool has_exclusive_prio() const { return _has_field_[41]; }
  ...
  bool has_write_flush_mode() const { return _has_field_[44]; }
  TraceConfig_WriteFlushMode write_flush_mode() const { return write_flush_mode_; }
  void set_write_flush_mode(TraceConfig_WriteFlushMode value) { write_flush_mode_ = value; _has_field_.set(44); }

  bool has_fflush_post_write() const { return _has_field_[45]; }
  TraceConfig_FFlushMode fflush_post_write() const { return fflush_post_write_; }
  void set_fflush_post_write(TraceConfig_FFlushMode value) { fflush_post_write_ = value; _has_field_.set(45); }

  bool has_trace_all_machines() const { return _has_field_[43]; }
...
class PERFETTO_EXPORT_COMPONENT TraceConfig_TraceFilter : public ::protozero::CppMessageObj {
 public:
  ...
  bool has_bytecode_overlay_v54() const { return _has_field_[4]; }
  const std::string& bytecode_overlay_v54() const { return bytecode_overlay_v54_; }
  void set_bytecode_overlay_v54(const std::string& value) { bytecode_overlay_v54_ = value; _has_field_.set(4); }
  void set_bytecode_overlay_v54(const void* p, size_t s) { bytecode_overlay_v54_.assign(reinterpret_cast<const char*>(p), s); _has_field_.set(4); }

  bool has_string_filter_chain_v54() const { return _has_field_[5]; }
  const TraceConfig_TraceFilter_StringFilterChain& string_filter_chain_v54() const { return *string_filter_chain_v54_; }
  TraceConfig_TraceFilter_StringFilterChain* mutable_string_filter_chain_v54() { _has_field_.set(5); return string_filter_chain_v54_.get(); }

 private:
  std::string bytecode_{};
  std::string bytecode_v2_{};
  ::protozero::CopyablePtr<TraceConfig_TraceFilter_StringFilterChain> string_filter_chain_;
  std::string bytecode_overlay_v54_{};
  ::protozero::CopyablePtr<TraceConfig_TraceFilter_StringFilterChain> string_filter_chain_v54_;
...
class PERFETTO_EXPORT_COMPONENT TraceConfig_TraceFilter_StringFilterRule : public ::protozero::CppMessageObj {
 public:
  ...
  const std::vector<SemanticType>& semantic_type() const { return semantic_type_; }
  std::vector<SemanticType>* mutable_semantic_type() { return &semantic_type_; }
  int semantic_type_size() const { return static_cast<int>(semantic_type_.size()); }
  void clear_semantic_type() { semantic_type_.clear(); }
  void add_semantic_type(SemanticType value) { semantic_type_.emplace_back(value); }
  SemanticType* add_semantic_type() { semantic_type_.emplace_back(); return &semantic_type_.back(); }
 ...
 private:
  ...
  std::string name_{};
  std::vector<SemanticType> semantic_type_;
...
class PERFETTO_EXPORT_COMPONENT TraceConfig_BuiltinDataSource : public ::protozero::CppMessageObj {
 public:
  ...
  bool has_disable_extension_descriptors() const { return _has_field_[9]; }
...
class PERFETTO_EXPORT_COMPONENT TraceConfig_DataSource : public ::protozero::CppMessageObj {
 public:
  ...
  const std::vector<std::string>& machine_name_filter() const { return machine_name_filter_; }
  std::vector<std::string>* mutable_machine_name_filter() { return &machine_name_filter_; }
  int machine_name_filter_size() const { return static_cast<int>(machine_name_filter_.size()); }
  void clear_machine_name_filter() { machine_name_filter_.clear(); }
  void add_machine_name_filter(std::string value) { machine_name_filter_.emplace_back(value); }
  std::string* add_machine_name_filter() { machine_name_filter_.emplace_back(); return &machine_name_filter_.back(); }
 ...
 private:
  ...
  std::vector<std::string> machine_name_filter_;
...
class PERFETTO_EXPORT_COMPONENT TraceConfig_BufferConfig : public ::protozero::CppMessageObj {
 public:
  ...
  bool has_experimental_mode() const { return _has_field_[8]; }
  TraceConfig_BufferConfig_ExperimentalMode experimental_mode() const { return experimental_mode_; }
  void set_experimental_mode(TraceConfig_BufferConfig_ExperimentalMode value) { experimental_mode_ = value; _has_field_.set(8); }
 ...
 private:
  ...
  std::string name_{};
  TraceConfig_BufferConfig_ExperimentalMode experimental_mode_{};
