...
extern const ::google::protobuf::internal::ClassDataLite<34> ProcessDescriptor_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
inline bool ProcessDescriptor_ChromeProcessType_IsValid(int value) {
...
class ProcessDescriptor final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.ProcessDescriptor) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR ProcessDescriptor(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(ProcessDescriptor* PROTOBUF_NONNULL other) {
  ...
  ProcessDescriptor* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<ProcessDescriptor>(arena);
  }
 ...
 public:
  ...
  static inline bool ChromeProcessType_Parse(
  ...
  ::google::protobuf::RepeatedPtrField<::std::string>* PROTOBUF_NONNULL mutable_cmdline();
  ...
  const ::google::protobuf::RepeatedPtrField<::std::string>& process_labels() const;
  ::google::protobuf::RepeatedPtrField<::std::string>* PROTOBUF_NONNULL mutable_process_labels();
