...
extern const ::google::protobuf::internal::ClassDataLite<31> SysStatsConfig_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
inline bool SysStatsConfig_StatCounters_IsValid(int value) {
...
class SysStatsConfig final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.SysStatsConfig) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR SysStatsConfig(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(SysStatsConfig* PROTOBUF_NONNULL other) {
  ...
  SysStatsConfig* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<SysStatsConfig>(arena);
  }
 ...
 public:
  ...
  static inline bool StatCounters_Parse(
  ...
  ::google::protobuf::RepeatedField<int>* PROTOBUF_NONNULL mutable_meminfo_counters();
  ...
  ::google::protobuf::RepeatedField<int>* PROTOBUF_NONNULL mutable_vmstat_counters();
  ...
  ::google::protobuf::RepeatedField<int>* PROTOBUF_NONNULL mutable_stat_counters();
  ...
  bool has_slab_period_ms() const;
  void clear_slab_period_ms() ;
  ::uint32_t slab_period_ms() const;
  void set_slab_period_ms(::uint32_t value);

  private:
  ::uint32_t _internal_slab_period_ms() const;
  void _internal_set_slab_period_ms(::uint32_t value);
...
// optional uint32 slab_period_ms = 15;
inline bool SysStatsConfig::has_slab_period_ms() const {
  bool value = CheckHasBit(_impl_._has_bits_[0], 0x00004000U);
  return value;
}
inline void SysStatsConfig::clear_slab_period_ms() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.slab_period_ms_ = 0u;
  ClearHasBit(_impl_._has_bits_[0],
                  0x00004000U);
}
inline ::uint32_t SysStatsConfig::slab_period_ms() const {
  // @@protoc_insertion_point(field_get:perfetto.protos.SysStatsConfig.slab_period_ms)
  return _internal_slab_period_ms();
}
inline void SysStatsConfig::set_slab_period_ms(::uint32_t value) {
  _internal_set_slab_period_ms(value);
  SetHasBit(_impl_._has_bits_[0], 0x00004000U);
  // @@protoc_insertion_point(field_set:perfetto.protos.SysStatsConfig.slab_period_ms)
}
inline ::uint32_t SysStatsConfig::_internal_slab_period_ms() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.slab_period_ms_;
}
inline void SysStatsConfig::_internal_set_slab_period_ms(::uint32_t value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.slab_period_ms_ = value;
}
