...
namespace perfetto_pbzero_enum_TraceConfig {
enum FFlushMode : int32_t;
}  // namespace perfetto_pbzero_enum_TraceConfig
using TraceConfig_FFlushMode = perfetto_pbzero_enum_TraceConfig::FFlushMode;
namespace perfetto_pbzero_enum_TraceConfig {
...
namespace perfetto_pbzero_enum_TraceConfig {
enum WriteFlushMode : int32_t;
}  // namespace perfetto_pbzero_enum_TraceConfig
using TraceConfig_WriteFlushMode = perfetto_pbzero_enum_TraceConfig::WriteFlushMode;
} // Namespace pbzero.
} // Namespace protos.
} // Namespace perfetto.
...
constexpr TraceConfig_WriteFlushMode TraceConfig_WriteFlushMode_MIN = TraceConfig_WriteFlushMode::WRITE_FLUSH_UNSPECIFIED;
constexpr TraceConfig_WriteFlushMode TraceConfig_WriteFlushMode_MAX = TraceConfig_WriteFlushMode::WRITE_FLUSH_ENABLED;


PERFETTO_PROTOZERO_CONSTEXPR14_OR_INLINE
const char* TraceConfig_WriteFlushMode_Name(::perfetto::protos::pbzero::TraceConfig_WriteFlushMode value) {
  switch (value) {
  case ::perfetto::protos::pbzero::TraceConfig_WriteFlushMode::WRITE_FLUSH_UNSPECIFIED:
    return "WRITE_FLUSH_UNSPECIFIED";

  case ::perfetto::protos::pbzero::TraceConfig_WriteFlushMode::WRITE_FLUSH_AUTO:
    return "WRITE_FLUSH_AUTO";

  case ::perfetto::protos::pbzero::TraceConfig_WriteFlushMode::WRITE_FLUSH_DISABLED:
    return "WRITE_FLUSH_DISABLED";

  case ::perfetto::protos::pbzero::TraceConfig_WriteFlushMode::WRITE_FLUSH_ENABLED:
    return "WRITE_FLUSH_ENABLED";
  }
  return "PBZERO_UNKNOWN_ENUM_VALUE";
}
...
constexpr TraceConfig_FFlushMode TraceConfig_FFlushMode_MIN = TraceConfig_FFlushMode::FFLUSH_UNSPECIFIED;
constexpr TraceConfig_FFlushMode TraceConfig_FFlushMode_MAX = TraceConfig_FFlushMode::FFLUSH_ENABLED;


PERFETTO_PROTOZERO_CONSTEXPR14_OR_INLINE
const char* TraceConfig_FFlushMode_Name(::perfetto::protos::pbzero::TraceConfig_FFlushMode value) {
  switch (value) {
  case ::perfetto::protos::pbzero::TraceConfig_FFlushMode::FFLUSH_UNSPECIFIED:
    return "FFLUSH_UNSPECIFIED";

  case ::perfetto::protos::pbzero::TraceConfig_FFlushMode::FFLUSH_DISABLED:
    return "FFLUSH_DISABLED";

  case ::perfetto::protos::pbzero::TraceConfig_FFlushMode::FFLUSH_ENABLED:
    return "FFLUSH_ENABLED";
  }
  return "PBZERO_UNKNOWN_ENUM_VALUE";
}
...
PERFETTO_PROTOZERO_CONSTEXPR14_OR_INLINE
const char* TraceConfig_BufferConfig_ExperimentalMode_Name(::perfetto::protos::pbzero::TraceConfig_BufferConfig_ExperimentalMode value) {
  switch (value) {
  case ::perfetto::protos::pbzero::TraceConfig_BufferConfig_ExperimentalMode::MODE_UNSPECIFIED:
...
class TraceConfig_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/46> {
 public:
  ...
  bool has_write_flush_mode() const { return at<44>().valid(); }
  int32_t write_flush_mode() const { return at<44>().as_int32(); }
  bool has_fflush_post_write() const { return at<45>().valid(); }
...
class TraceConfig : public ::protozero::Message {
 public:
  ...
  using WriteFlushMode = ::perfetto::protos::pbzero::TraceConfig_WriteFlushMode;
  static inline const char* WriteFlushMode_Name(WriteFlushMode value) {
    return ::perfetto::protos::pbzero::TraceConfig_WriteFlushMode_Name(value);
  }

  using FFlushMode = ::perfetto::protos::pbzero::TraceConfig_FFlushMode;
  static inline const char* FFlushMode_Name(FFlushMode value) {
    return ::perfetto::protos::pbzero::TraceConfig_FFlushMode_Name(value);
  }
  ...
  static inline const WriteFlushMode WRITE_FLUSH_UNSPECIFIED = WriteFlushMode::WRITE_FLUSH_UNSPECIFIED;
  static inline const WriteFlushMode WRITE_FLUSH_AUTO = WriteFlushMode::WRITE_FLUSH_AUTO;
  static inline const WriteFlushMode WRITE_FLUSH_DISABLED = WriteFlushMode::WRITE_FLUSH_DISABLED;
  static inline const WriteFlushMode WRITE_FLUSH_ENABLED = WriteFlushMode::WRITE_FLUSH_ENABLED;
  static inline const FFlushMode FFLUSH_UNSPECIFIED = FFlushMode::FFLUSH_UNSPECIFIED;
  static inline const FFlushMode FFLUSH_DISABLED = FFlushMode::FFLUSH_DISABLED;
  static inline const FFlushMode FFLUSH_ENABLED = FFlushMode::FFLUSH_ENABLED;
  ...
  using FieldMetadata_WriteFlushMode =
    ::protozero::proto_utils::FieldMetadata<
      44,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kEnum,
      TraceConfig_WriteFlushMode,
      TraceConfig>;

  static constexpr FieldMetadata_WriteFlushMode kWriteFlushMode{};
  void set_write_flush_mode(TraceConfig_WriteFlushMode value) {
    static constexpr uint32_t field_id = FieldMetadata_WriteFlushMode::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kEnum>
  ...
  using FieldMetadata_FflushPostWrite =
    ::protozero::proto_utils::FieldMetadata<
      45,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kEnum,
      TraceConfig_FFlushMode,
      TraceConfig>;

  static constexpr FieldMetadata_FflushPostWrite kFflushPostWrite{};
  void set_fflush_post_write(TraceConfig_FFlushMode value) {
    static constexpr uint32_t field_id = FieldMetadata_FflushPostWrite::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kEnum>
  ...
  using FieldMetadata_TraceAllMachines =
    ::protozero::proto_utils::FieldMetadata<
      43,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kBool,
  ...
  static constexpr FieldMetadata_TraceAllMachines kTraceAllMachines{};
  void set_trace_all_machines(bool value) {
    static constexpr uint32_t field_id = FieldMetadata_TraceAllMachines::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kBool>
...
class TraceConfig_TraceFilter_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/5> {
 public:
  ...
  bool has_bytecode_overlay_v54() const { return at<4>().valid(); }
  ::protozero::ConstBytes bytecode_overlay_v54() const { return at<4>().as_bytes(); }
  bool has_string_filter_chain_v54() const { return at<5>().valid(); }
  ::protozero::ConstBytes string_filter_chain_v54() const { return at<5>().as_bytes(); }
};
...
class TraceConfig_TraceFilter : public ::protozero::Message {
 public:
  ...
  using FieldMetadata_BytecodeOverlayV54 =
    ::protozero::proto_utils::FieldMetadata<
      4,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kBytes,
  ...
  static constexpr FieldMetadata_BytecodeOverlayV54 kBytecodeOverlayV54{};
  void set_bytecode_overlay_v54(const uint8_t* data, size_t size) {
    AppendBytes(FieldMetadata_BytecodeOverlayV54::kFieldId, data, size);
  }
  void set_bytecode_overlay_v54(::protozero::ConstBytes bytes) {
    AppendBytes(FieldMetadata_BytecodeOverlayV54::kFieldId, bytes.data, bytes.size);
  }
  void set_bytecode_overlay_v54(std::string value) {
    static constexpr uint32_t field_id = FieldMetadata_BytecodeOverlayV54::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kBytes>
  ...
  using FieldMetadata_StringFilterChainV54 =
    ::protozero::proto_utils::FieldMetadata<
      5,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
  ...
  static constexpr FieldMetadata_StringFilterChainV54 kStringFilterChainV54{};
  template <typename T = TraceConfig_TraceFilter_StringFilterChain> T* set_string_filter_chain_v54() {
...
class TraceConfig_TraceFilter_StringFilterRule_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/5> {
 public:
  ...
  bool has_semantic_type() const { return at<5>().valid(); }
  ::protozero::RepeatedFieldIterator<int32_t> semantic_type() const { return GetRepeated<int32_t>(5); }
};
...
class TraceConfig_TraceFilter_StringFilterRule : public ::protozero::Message {
 public:
  ...
  using FieldMetadata_SemanticType =
    ::protozero::proto_utils::FieldMetadata<
      5,
      ::protozero::proto_utils::RepetitionType::kRepeatedNotPacked,
      ::protozero::proto_utils::ProtoSchemaType::kEnum,
  ...
  static constexpr FieldMetadata_SemanticType kSemanticType{};
  void add_semantic_type(SemanticType value) {
    static constexpr uint32_t field_id = FieldMetadata_SemanticType::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kEnum>
...
class TraceConfig_BuiltinDataSource : public ::protozero::Message {
 public:
  ...
  using FieldMetadata_DisableExtensionDescriptors =
    ::protozero::proto_utils::FieldMetadata<
      9,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kBool,
...
class TraceConfig_BufferConfig_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/8> {
 public:
  ...
  bool has_experimental_mode() const { return at<8>().valid(); }
  int32_t experimental_mode() const { return at<8>().as_int32(); }
};
...
class TraceConfig_BufferConfig : public ::protozero::Message {
 public:
  ...
  using ExperimentalMode = ::perfetto::protos::pbzero::TraceConfig_BufferConfig_ExperimentalMode;
  static inline const char* ExperimentalMode_Name(ExperimentalMode value) {
    return ::perfetto::protos::pbzero::TraceConfig_BufferConfig_ExperimentalMode_Name(value);
  }
  ...
  using FieldMetadata_ExperimentalMode =
    ::protozero::proto_utils::FieldMetadata<
      8,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kEnum,
      TraceConfig_BufferConfig_ExperimentalMode,
      TraceConfig_BufferConfig>;

  static constexpr FieldMetadata_ExperimentalMode kExperimentalMode{};
  void set_experimental_mode(TraceConfig_BufferConfig_ExperimentalMode value) {
    static constexpr uint32_t field_id = FieldMetadata_ExperimentalMode::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kEnum>
