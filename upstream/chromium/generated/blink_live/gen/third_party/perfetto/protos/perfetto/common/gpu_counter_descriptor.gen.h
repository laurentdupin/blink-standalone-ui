...
class PERFETTO_EXPORT_COMPONENT GpuCounterDescriptor : public ::protozero::CppMessageObj {
 public:
  ...
  const std::vector<GpuCounterDescriptor_GpuCounterGroupSpec>& counter_groups() const { return counter_groups_; }
  std::vector<GpuCounterDescriptor_GpuCounterGroupSpec>* mutable_counter_groups() { return &counter_groups_; }
  int counter_groups_size() const;
  void clear_counter_groups();
  GpuCounterDescriptor_GpuCounterGroupSpec* add_counter_groups();
  ...
  bool has_supports_counter_names() const { return _has_field_[7]; }
  bool supports_counter_names() const { return supports_counter_names_; }
  void set_supports_counter_names(bool value) { supports_counter_names_ = value; _has_field_.set(7); }

  bool has_supports_counter_name_globs() const { return _has_field_[8]; }
  bool supports_counter_name_globs() const { return supports_counter_name_globs_; }
  void set_supports_counter_name_globs(bool value) { supports_counter_name_globs_ = value; _has_field_.set(8); }

 private:
  std::vector<GpuCounterDescriptor_GpuCounterSpec> specs_;
  std::vector<GpuCounterDescriptor_GpuCounterBlock> blocks_;
  std::vector<GpuCounterDescriptor_GpuCounterGroupSpec> counter_groups_;
...
class PERFETTO_EXPORT_COMPONENT GpuCounterDescriptor_GpuCounterGroupSpec : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
  ...
  ~GpuCounterDescriptor_GpuCounterGroupSpec() override;
  GpuCounterDescriptor_GpuCounterGroupSpec(GpuCounterDescriptor_GpuCounterGroupSpec&&) noexcept;
  GpuCounterDescriptor_GpuCounterGroupSpec& operator=(GpuCounterDescriptor_GpuCounterGroupSpec&&);
  GpuCounterDescriptor_GpuCounterGroupSpec(const GpuCounterDescriptor_GpuCounterGroupSpec&);
  GpuCounterDescriptor_GpuCounterGroupSpec& operator=(const GpuCounterDescriptor_GpuCounterGroupSpec&);
  bool operator==(const GpuCounterDescriptor_GpuCounterGroupSpec&) const;
  bool operator!=(const GpuCounterDescriptor_GpuCounterGroupSpec& other) const { return !(*this == other); }
  ...
  bool has_group_id() const { return _has_field_[1]; }
  uint32_t group_id() const { return group_id_; }
  void set_group_id(uint32_t value) { group_id_ = value; _has_field_.set(1); }
