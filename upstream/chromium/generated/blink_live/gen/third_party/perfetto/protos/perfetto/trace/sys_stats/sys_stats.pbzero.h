...
class SysStats_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/18> {
 public:
  ...
  bool has_slab_info() const { return at<18>().valid(); }
  ::protozero::RepeatedFieldIterator<::protozero::ConstBytes> slab_info() const { return GetRepeated<::protozero::ConstBytes>(18); }
};
...
class SysStats : public ::protozero::Message {
 public:
  ...
  using SlabInfo = ::perfetto::protos::pbzero::SysStats_SlabInfo;
  ...
  static constexpr FieldMetadata_SlabInfo kSlabInfo{};
  template <typename T = SysStats_SlabInfo> T* add_slab_info() {
    return BeginNestedMessage<T>(18);
  }

};

class SysStats_SlabInfo_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/3> {
 public:
  SysStats_SlabInfo_Decoder(const uint8_t* data, size_t len) : TypedProtoDecoder(data, len) {}
  explicit SysStats_SlabInfo_Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
  explicit SysStats_SlabInfo_Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
  bool has_name() const { return at<1>().valid(); }
  ::protozero::ConstChars name() const { return at<1>().as_string(); }
  bool has_pages_per_slab() const { return at<2>().valid(); }
  uint32_t pages_per_slab() const { return at<2>().as_uint32(); }
  bool has_num_slabs() const { return at<3>().valid(); }
  uint32_t num_slabs() const { return at<3>().as_uint32(); }
};

class SysStats_SlabInfo : public ::protozero::Message {
 public:
  using Decoder = SysStats_SlabInfo_Decoder;
  enum : int32_t {
    kNameFieldNumber = 1,
    kPagesPerSlabFieldNumber = 2,
    kNumSlabsFieldNumber = 3,
  };
  static constexpr const char* GetName() { return ".perfetto.protos.SysStats.SlabInfo"; }
  ...
  using FieldMetadata_PagesPerSlab =
    ::protozero::proto_utils::FieldMetadata<
      2,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kUint32,
  ...
  static constexpr FieldMetadata_PagesPerSlab kPagesPerSlab{};
  void set_pages_per_slab(uint32_t value) {
    static constexpr uint32_t field_id = FieldMetadata_PagesPerSlab::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kUint32>
  ...
  static constexpr FieldMetadata_NumSlabs kNumSlabs{};
  void set_num_slabs(uint32_t value) {
    static constexpr uint32_t field_id = FieldMetadata_NumSlabs::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kUint32>
