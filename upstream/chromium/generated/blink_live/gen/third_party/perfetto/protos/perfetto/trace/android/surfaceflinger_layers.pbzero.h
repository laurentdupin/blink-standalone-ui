...
class LayerProto_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/69> {
 public:
  ...
  bool has_reported_radii() const { return at<68>().valid(); }
  ::protozero::ConstBytes reported_radii() const { return at<68>().as_bytes(); }
  bool has_disable_client_drawn_radii() const { return at<69>().valid(); }
  bool disable_client_drawn_radii() const { return at<69>().as_bool(); }
};
...
class LayerProto : public ::protozero::Message {
 public:
  ...
  using FieldMetadata_ReportedRadii =
    ::protozero::proto_utils::FieldMetadata<
      68,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
  ...
  static constexpr FieldMetadata_ReportedRadii kReportedRadii{};
  template <typename T = CornerRadiiProto> T* set_reported_radii() {
    return BeginNestedMessage<T>(68);
  }


  using FieldMetadata_DisableClientDrawnRadii =
    ::protozero::proto_utils::FieldMetadata<
      69,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kBool,
  ...
  static constexpr FieldMetadata_DisableClientDrawnRadii kDisableClientDrawnRadii{};
  void set_disable_client_drawn_radii(bool value) {
    static constexpr uint32_t field_id = FieldMetadata_DisableClientDrawnRadii::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kBool>
...
class LayersPatchProto_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/10> {
 public:
  LayersPatchProto_Decoder(const uint8_t* data, size_t len) : TypedProtoDecoder(data, len) {}
  explicit LayersPatchProto_Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
  explicit LayersPatchProto_Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
  bool has_layers() const { return at<1>().valid(); }
  ::protozero::RepeatedFieldIterator<::protozero::ConstBytes> layers() const { return GetRepeated<::protozero::ConstBytes>(1); }
  ...
  bool has_deleted_layer_ids() const { return at<3>().valid(); }
  ::protozero::RepeatedFieldIterator<int32_t> deleted_layer_ids() const { return GetRepeated<int32_t>(3); }
  bool has_deleted_display_ids() const { return at<4>().valid(); }
  ::protozero::RepeatedFieldIterator<uint64_t> deleted_display_ids() const { return GetRepeated<uint64_t>(4); }
  bool has_elapsed_realtime_nanos() const { return at<5>().valid(); }
  int64_t elapsed_realtime_nanos() const { return at<5>().as_int64(); }
  bool has_where() const { return at<6>().valid(); }
  ::protozero::ConstChars where() const { return at<6>().as_string(); }
  bool has_hwc_blob() const { return at<7>().valid(); }
  ::protozero::ConstChars hwc_blob() const { return at<7>().as_string(); }
  bool has_excludes_composition_state() const { return at<8>().valid(); }
  bool excludes_composition_state() const { return at<8>().as_bool(); }
  bool has_missed_entries() const { return at<9>().valid(); }
  uint32_t missed_entries() const { return at<9>().as_uint32(); }
  bool has_vsync_id() const { return at<10>().valid(); }
  int64_t vsync_id() const { return at<10>().as_int64(); }
};

class LayersPatchProto : public ::protozero::Message {
 public:
  using Decoder = LayersPatchProto_Decoder;
  enum : int32_t {
    kLayersFieldNumber = 1,
  ...
  static constexpr const char* GetName() { return ".perfetto.protos.LayersPatchProto"; }
  ...
  using FieldMetadata_DeletedLayerIds =
    ::protozero::proto_utils::FieldMetadata<
      3,
      ::protozero::proto_utils::RepetitionType::kRepeatedNotPacked,
      ::protozero::proto_utils::ProtoSchemaType::kInt32,
  ...
  static constexpr FieldMetadata_DeletedLayerIds kDeletedLayerIds{};
  void add_deleted_layer_ids(int32_t value) {
    static constexpr uint32_t field_id = FieldMetadata_DeletedLayerIds::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kInt32>
  ...
  using FieldMetadata_DeletedDisplayIds =
    ::protozero::proto_utils::FieldMetadata<
      4,
      ::protozero::proto_utils::RepetitionType::kRepeatedNotPacked,
      ::protozero::proto_utils::ProtoSchemaType::kUint64,
  ...
  static constexpr FieldMetadata_DeletedDisplayIds kDeletedDisplayIds{};
  void add_deleted_display_ids(uint64_t value) {
    static constexpr uint32_t field_id = FieldMetadata_DeletedDisplayIds::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kUint64>
