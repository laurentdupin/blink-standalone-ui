...
extern const ::google::protobuf::internal::ClassDataLite<33> StressTestConfig_class_data_;
...
extern const ::google::protobuf::internal::ClassDataLite<46> StressTestConfig_WriterTiming_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
class StressTestConfig_WriterTiming final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.StressTestConfig.WriterTiming) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR StressTestConfig_WriterTiming(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(StressTestConfig_WriterTiming* PROTOBUF_NONNULL other) {
  ...
  StressTestConfig_WriterTiming* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<StressTestConfig_WriterTiming>(arena);
  }
...
class StressTestConfig final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.StressTestConfig) */ {
 public:
  ...
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR StressTestConfig(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(StressTestConfig* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
  ...
  StressTestConfig* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<StressTestConfig>(arena);
  }
...
inline ::perfetto::protos::StressTestConfig_WriterTiming* PROTOBUF_NONNULL StressTestConfig::_internal_mutable_steady_state_timings() {
  ...
  if (_impl_.steady_state_timings_ == nullptr) {
    auto* p = ::google::protobuf::MessageLite::DefaultConstruct<::perfetto::protos::StressTestConfig_WriterTiming>(GetArena());
