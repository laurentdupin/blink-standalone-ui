...
extern const ::google::protobuf::internal::ClassDataLite<32> JavaHprofConfig_class_data_;
...
extern const ::google::protobuf::internal::ClassDataLite<53> JavaHprofConfig_ContinuousDumpConfig_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
class JavaHprofConfig_ContinuousDumpConfig final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.JavaHprofConfig.ContinuousDumpConfig) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR JavaHprofConfig_ContinuousDumpConfig(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(JavaHprofConfig_ContinuousDumpConfig* PROTOBUF_NONNULL other) {
  ...
  JavaHprofConfig_ContinuousDumpConfig* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<JavaHprofConfig_ContinuousDumpConfig>(arena);
  }
...
class JavaHprofConfig final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.JavaHprofConfig) */ {
 public:
  ...
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR JavaHprofConfig(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(JavaHprofConfig* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
  ...
  JavaHprofConfig* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<JavaHprofConfig>(arena);
  }
 ...
 public:
  ...
  const ::google::protobuf::RepeatedPtrField<::std::string>& ignored_types() const;
  ::google::protobuf::RepeatedPtrField<::std::string>* PROTOBUF_NONNULL mutable_ignored_types();
...
inline ::perfetto::protos::JavaHprofConfig_ContinuousDumpConfig* PROTOBUF_NONNULL JavaHprofConfig::_internal_mutable_continuous_dump_config() {
  ...
  if (_impl_.continuous_dump_config_ == nullptr) {
    auto* p = ::google::protobuf::MessageLite::DefaultConstruct<::perfetto::protos::JavaHprofConfig_ContinuousDumpConfig>(GetArena());
