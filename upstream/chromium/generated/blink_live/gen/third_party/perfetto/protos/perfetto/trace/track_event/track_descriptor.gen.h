...
class PERFETTO_EXPORT_COMPONENT TrackDescriptor : public ::protozero::CppMessageObj {
 public:
  ...
  static constexpr auto SIBLING_MERGE_BEHAVIOR_UNSPECIFIED = TrackDescriptor_SiblingMergeBehavior_SIBLING_MERGE_BEHAVIOR_UNSPECIFIED;
  static constexpr auto SIBLING_MERGE_BEHAVIOR_BY_TRACK_NAME = TrackDescriptor_SiblingMergeBehavior_SIBLING_MERGE_BEHAVIOR_BY_TRACK_NAME;
  static constexpr auto SIBLING_MERGE_BEHAVIOR_NONE = TrackDescriptor_SiblingMergeBehavior_SIBLING_MERGE_BEHAVIOR_NONE;
  static constexpr auto SIBLING_MERGE_BEHAVIOR_BY_SIBLING_MERGE_KEY = TrackDescriptor_SiblingMergeBehavior_SIBLING_MERGE_BEHAVIOR_BY_SIBLING_MERGE_KEY;
  static constexpr auto SiblingMergeBehavior_MIN = TrackDescriptor_SiblingMergeBehavior_SIBLING_MERGE_BEHAVIOR_UNSPECIFIED;
  static constexpr auto SiblingMergeBehavior_MAX = TrackDescriptor_SiblingMergeBehavior_SIBLING_MERGE_BEHAVIOR_BY_SIBLING_MERGE_KEY;
  enum FieldNumbers {
    kUuidFieldNumber = 1,
  ...
  bool has_description() const { return _has_field_[14]; }
  const std::string& description() const { return description_; }
  void set_description(const std::string& value) { description_ = value; _has_field_.set(14); }
  ...
  bool has_sibling_merge_behavior() const { return _has_field_[15]; }
  TrackDescriptor_SiblingMergeBehavior sibling_merge_behavior() const { return sibling_merge_behavior_; }
  void set_sibling_merge_behavior(TrackDescriptor_SiblingMergeBehavior value) { sibling_merge_behavior_ = value; _has_field_.set(15); }

  bool has_sibling_merge_key() const { return _has_field_[16]; }
  const std::string& sibling_merge_key() const { return sibling_merge_key_; }
  void set_sibling_merge_key(const std::string& value) { sibling_merge_key_ = value; _has_field_.set(16); }

  bool has_sibling_merge_key_int() const { return _has_field_[17]; }
  uint64_t sibling_merge_key_int() const { return sibling_merge_key_int_; }
  void set_sibling_merge_key_int(uint64_t value) { sibling_merge_key_int_ = value; _has_field_.set(17); }
 ...
 private:
  ...
  TrackDescriptor_SiblingMergeBehavior sibling_merge_behavior_{};
  std::string sibling_merge_key_{};
