...
extern const ::google::protobuf::internal::ClassDataLite<33> AndroidLogConfig_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
class AndroidLogConfig final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.AndroidLogConfig) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR AndroidLogConfig(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(AndroidLogConfig* PROTOBUF_NONNULL other) {
  ...
  AndroidLogConfig* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<AndroidLogConfig>(arena);
  }
 ...
 public:
  ...
  ::google::protobuf::RepeatedField<int>* PROTOBUF_NONNULL mutable_log_ids();
  ...
  ::google::protobuf::RepeatedPtrField<::std::string>* PROTOBUF_NONNULL mutable_filter_tags();
  ...
  bool has_preserve_log_buffer() const;
  void clear_preserve_log_buffer() ;
  bool preserve_log_buffer() const;
