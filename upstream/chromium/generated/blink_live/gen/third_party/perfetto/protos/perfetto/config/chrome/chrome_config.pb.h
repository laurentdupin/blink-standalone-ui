...
extern const ::google::protobuf::internal::ClassDataLite<29> ChromeConfig_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
inline bool ChromeConfig_ClientPriority_IsValid(int value) {
...
class ChromeConfig final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.ChromeConfig) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR ChromeConfig(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(ChromeConfig* PROTOBUF_NONNULL other) {
  ...
  ChromeConfig* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<ChromeConfig>(arena);
  }
 ...
 public:
  ...
  static inline bool ClientPriority_Parse(
  ...
  bool has_event_package_name_filter_enabled() const;
