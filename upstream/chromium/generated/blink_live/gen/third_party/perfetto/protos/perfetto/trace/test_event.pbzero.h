...
class TestEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/7> {
 public:
  ...
  bool has_protovm_patch() const { return at<6>().valid(); }
  ::protozero::ConstBytes protovm_patch() const { return at<6>().as_bytes(); }
  bool has_protovm_incremental_state() const { return at<7>().valid(); }
  ::protozero::ConstBytes protovm_incremental_state() const { return at<7>().as_bytes(); }
};
...
class TestEvent : public ::protozero::Message {
 public:
  ...
  using ProtoVmPatch = ::perfetto::protos::pbzero::TestEvent_ProtoVmPatch;
  using ProtoVmIncrementalState = ::perfetto::protos::pbzero::TestEvent_ProtoVmIncrementalState;
  ...
  using FieldMetadata_ProtovmPatch =
    ::protozero::proto_utils::FieldMetadata<
      6,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
  ...
  static constexpr FieldMetadata_ProtovmPatch kProtovmPatch{};
  template <typename T = TestEvent_ProtoVmPatch> T* set_protovm_patch() {
    return BeginNestedMessage<T>(6);
  }


  using FieldMetadata_ProtovmIncrementalState =
    ::protozero::proto_utils::FieldMetadata<
      7,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
  ...
  static constexpr FieldMetadata_ProtovmIncrementalState kProtovmIncrementalState{};
  template <typename T = TestEvent_ProtoVmIncrementalState> T* set_protovm_incremental_state() {
    return BeginNestedMessage<T>(7);
  }

};

class TestEvent_ProtoVmIncrementalState_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/2> {
 public:
  TestEvent_ProtoVmIncrementalState_Decoder(const uint8_t* data, size_t len) : TypedProtoDecoder(data, len) {}
  explicit TestEvent_ProtoVmIncrementalState_Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
  explicit TestEvent_ProtoVmIncrementalState_Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
  bool has_string_merged() const { return at<1>().valid(); }
  ::protozero::ConstChars string_merged() const { return at<1>().as_string(); }
  bool has_int_merged() const { return at<2>().valid(); }
  int32_t int_merged() const { return at<2>().as_int32(); }
};

class TestEvent_ProtoVmIncrementalState : public ::protozero::Message {
 public:
  using Decoder = TestEvent_ProtoVmIncrementalState_Decoder;
  enum : int32_t {
    kStringMergedFieldNumber = 1,
    kIntMergedFieldNumber = 2,
  };
  static constexpr const char* GetName() { return ".perfetto.protos.TestEvent.ProtoVmIncrementalState"; }


  using FieldMetadata_StringMerged =
    ::protozero::proto_utils::FieldMetadata<
      1,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kString,
  ...
  static constexpr FieldMetadata_StringMerged kStringMerged{};
  void set_string_merged(const char* data, size_t size) {
    AppendBytes(FieldMetadata_StringMerged::kFieldId, data, size);
  }
  void set_string_merged(::protozero::ConstChars chars) {
    AppendBytes(FieldMetadata_StringMerged::kFieldId, chars.data, chars.size);
  }
  void set_string_merged(std::string value) {
    static constexpr uint32_t field_id = FieldMetadata_StringMerged::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kString>
  ...
  static constexpr FieldMetadata_IntMerged kIntMerged{};
  void set_int_merged(int32_t value) {
    static constexpr uint32_t field_id = FieldMetadata_IntMerged::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kInt32>
...
class TestEvent_ProtoVmPatch_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/2> {
 public:
  TestEvent_ProtoVmPatch_Decoder(const uint8_t* data, size_t len) : TypedProtoDecoder(data, len) {}
  explicit TestEvent_ProtoVmPatch_Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
  explicit TestEvent_ProtoVmPatch_Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
  bool has_string_to_merge() const { return at<1>().valid(); }
  ::protozero::ConstChars string_to_merge() const { return at<1>().as_string(); }
  bool has_int_to_merge() const { return at<2>().valid(); }
  int32_t int_to_merge() const { return at<2>().as_int32(); }
};

class TestEvent_ProtoVmPatch : public ::protozero::Message {
 public:
  using Decoder = TestEvent_ProtoVmPatch_Decoder;
  enum : int32_t {
    kStringToMergeFieldNumber = 1,
    kIntToMergeFieldNumber = 2,
  };
  static constexpr const char* GetName() { return ".perfetto.protos.TestEvent.ProtoVmPatch"; }


  using FieldMetadata_StringToMerge =
    ::protozero::proto_utils::FieldMetadata<
      1,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kString,
  ...
  static constexpr FieldMetadata_StringToMerge kStringToMerge{};
  void set_string_to_merge(const char* data, size_t size) {
    AppendBytes(FieldMetadata_StringToMerge::kFieldId, data, size);
  }
  void set_string_to_merge(::protozero::ConstChars chars) {
    AppendBytes(FieldMetadata_StringToMerge::kFieldId, chars.data, chars.size);
  }
  void set_string_to_merge(std::string value) {
    static constexpr uint32_t field_id = FieldMetadata_StringToMerge::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kString>
  ...
  using FieldMetadata_IntToMerge =
    ::protozero::proto_utils::FieldMetadata<
      2,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kInt32,
  ...
  static constexpr FieldMetadata_IntToMerge kIntToMerge{};
  void set_int_to_merge(int32_t value) {
    static constexpr uint32_t field_id = FieldMetadata_IntToMerge::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kInt32>
