...
extern const ::google::protobuf::internal::ClassDataLite<34> ChromeLatencyInfo_class_data_;
...
extern const ::google::protobuf::internal::ClassDataLite<48> ChromeLatencyInfo_ComponentInfo_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
inline bool ChromeLatencyInfo_Step_IsValid(int value) {
...
inline bool ChromeLatencyInfo_LatencyComponentType_IsValid(int value) {
...
inline bool ChromeLatencyInfo_InputType_IsValid(int value) {
...
template <typename T>
const ::std::string& ChromeLatencyInfo_InputType_Name(T value) {
...
class ChromeLatencyInfo_ComponentInfo final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.ChromeLatencyInfo.ComponentInfo) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR ChromeLatencyInfo_ComponentInfo(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(ChromeLatencyInfo_ComponentInfo* PROTOBUF_NONNULL other) {
  ...
  ChromeLatencyInfo_ComponentInfo* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<ChromeLatencyInfo_ComponentInfo>(arena);
  }
...
class ChromeLatencyInfo final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.ChromeLatencyInfo) */ {
 public:
  ...
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR ChromeLatencyInfo(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(ChromeLatencyInfo* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
  ...
  ChromeLatencyInfo* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<ChromeLatencyInfo>(arena);
  }
 ...
 public:
  ...
  static inline bool LatencyComponentType_Parse(
  ...
  ::perfetto::protos::ChromeLatencyInfo_ComponentInfo* PROTOBUF_NONNULL mutable_component_info(int index);
  ::google::protobuf::RepeatedPtrField<::perfetto::protos::ChromeLatencyInfo_ComponentInfo>* PROTOBUF_NONNULL mutable_component_info();
  ...
  const ::google::protobuf::RepeatedPtrField<::perfetto::protos::ChromeLatencyInfo_ComponentInfo>& component_info() const;
