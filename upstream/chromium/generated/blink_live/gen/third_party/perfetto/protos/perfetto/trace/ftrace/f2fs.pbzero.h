...
class F2fsLockElapsedTimeFtraceEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/13> {
 public:
  F2fsLockElapsedTimeFtraceEvent_Decoder(const uint8_t* data, size_t len) : TypedProtoDecoder(data, len) {}
  explicit F2fsLockElapsedTimeFtraceEvent_Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
  explicit F2fsLockElapsedTimeFtraceEvent_Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
  ...
  bool has_ioprio_class() const { return at<5>().valid(); }
  int32_t ioprio_class() const { return at<5>().as_int32(); }
  bool has_ioprio_data() const { return at<6>().valid(); }
  int32_t ioprio_data() const { return at<6>().as_int32(); }
  bool has_lock_name() const { return at<7>().valid(); }
  uint32_t lock_name() const { return at<7>().as_uint32(); }
  bool has_is_write() const { return at<8>().valid(); }
  uint32_t is_write() const { return at<8>().as_uint32(); }
  bool has_total_time() const { return at<9>().valid(); }
  uint64_t total_time() const { return at<9>().as_uint64(); }
  bool has_running_time() const { return at<10>().valid(); }
  uint64_t running_time() const { return at<10>().as_uint64(); }
  bool has_runnable_time() const { return at<11>().valid(); }
  uint64_t runnable_time() const { return at<11>().as_uint64(); }
  bool has_io_sleep_time() const { return at<12>().valid(); }
  uint64_t io_sleep_time() const { return at<12>().as_uint64(); }
  bool has_other_time() const { return at<13>().valid(); }
  uint64_t other_time() const { return at<13>().as_uint64(); }
};

class F2fsLockElapsedTimeFtraceEvent : public ::protozero::Message {
 public:
  using Decoder = F2fsLockElapsedTimeFtraceEvent_Decoder;
  enum : int32_t {
    kDevFieldNumber = 1,
    kCommFieldNumber = 2,
    kPidFieldNumber = 3,
    kPrioFieldNumber = 4,
    kIoprioClassFieldNumber = 5,
    kIoprioDataFieldNumber = 6,
    kLockNameFieldNumber = 7,
    kIsWriteFieldNumber = 8,
    kTotalTimeFieldNumber = 9,
    kRunningTimeFieldNumber = 10,
    kRunnableTimeFieldNumber = 11,
    kIoSleepTimeFieldNumber = 12,
    kOtherTimeFieldNumber = 13,
  };
  static constexpr const char* GetName() { return ".perfetto.protos.F2fsLockElapsedTimeFtraceEvent"; }
  ...
  using FieldMetadata_IoprioClass =
    ::protozero::proto_utils::FieldMetadata<
      5,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kInt32,
  ...
  static constexpr FieldMetadata_IoprioClass kIoprioClass{};
  void set_ioprio_class(int32_t value) {
    static constexpr uint32_t field_id = FieldMetadata_IoprioClass::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kInt32>
  ...
  using FieldMetadata_IoprioData =
    ::protozero::proto_utils::FieldMetadata<
      6,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kInt32,
  ...
  static constexpr FieldMetadata_IoprioData kIoprioData{};
  void set_ioprio_data(int32_t value) {
    static constexpr uint32_t field_id = FieldMetadata_IoprioData::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kInt32>
  ...
  static constexpr FieldMetadata_LockName kLockName{};
  void set_lock_name(uint32_t value) {
    static constexpr uint32_t field_id = FieldMetadata_LockName::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kUint32>
  ...
  using FieldMetadata_RunningTime =
    ::protozero::proto_utils::FieldMetadata<
      10,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kUint64,
  ...
  static constexpr FieldMetadata_RunningTime kRunningTime{};
  void set_running_time(uint64_t value) {
    static constexpr uint32_t field_id = FieldMetadata_RunningTime::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kUint64>
  ...
  using FieldMetadata_RunnableTime =
    ::protozero::proto_utils::FieldMetadata<
      11,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kUint64,
  ...
  static constexpr FieldMetadata_RunnableTime kRunnableTime{};
  void set_runnable_time(uint64_t value) {
    static constexpr uint32_t field_id = FieldMetadata_RunnableTime::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kUint64>
  ...
  using FieldMetadata_IoSleepTime =
    ::protozero::proto_utils::FieldMetadata<
      12,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kUint64,
  ...
  static constexpr FieldMetadata_IoSleepTime kIoSleepTime{};
  void set_io_sleep_time(uint64_t value) {
    static constexpr uint32_t field_id = FieldMetadata_IoSleepTime::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kUint64>
  ...
  static constexpr FieldMetadata_OtherTime kOtherTime{};
  void set_other_time(uint64_t value) {
    static constexpr uint32_t field_id = FieldMetadata_OtherTime::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kUint64>
...
class F2fsWriteCheckpointFtraceEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/5> {
 public:
  ...
  bool has_phase() const { return at<5>().valid(); }
  uint32_t phase() const { return at<5>().as_uint32(); }
};
