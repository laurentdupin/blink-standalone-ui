...
extern const ::google::protobuf::internal::ClassDataLite<24> Trigger_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
class Trigger final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.Trigger) */ {
 public:
  ...
  PROTOBUF_NOINLINE void Swap(Trigger* PROTOBUF_NONNULL other) {
  ...
  Trigger* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<Trigger>(arena);
  }
