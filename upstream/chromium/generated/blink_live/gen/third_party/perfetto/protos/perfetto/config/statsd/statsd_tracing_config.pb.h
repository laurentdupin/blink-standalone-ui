...
extern const ::google::protobuf::internal::ClassDataLite<37> StatsdPullAtomConfig_class_data_;
...
extern const ::google::protobuf::internal::ClassDataLite<36> StatsdTracingConfig_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
class StatsdPullAtomConfig final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.StatsdPullAtomConfig) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR StatsdPullAtomConfig(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(StatsdPullAtomConfig* PROTOBUF_NONNULL other) {
  ...
  StatsdPullAtomConfig* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<StatsdPullAtomConfig>(arena);
  }
 ...
 public:
  ...
  const ::google::protobuf::RepeatedField<int>& pull_atom_id() const;
  ::google::protobuf::RepeatedField<int>* PROTOBUF_NONNULL mutable_pull_atom_id();
  ...
  const ::google::protobuf::RepeatedField<::int32_t>& raw_pull_atom_id() const;
  ...
  ::google::protobuf::RepeatedPtrField<::std::string>* PROTOBUF_NONNULL mutable_packages();
...
class StatsdTracingConfig final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.StatsdTracingConfig) */ {
 public:
  ...
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR StatsdTracingConfig(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(StatsdTracingConfig* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
  ...
  StatsdTracingConfig* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<StatsdTracingConfig>(arena);
  }
 ...
 public:
  ...
  const ::google::protobuf::RepeatedField<int>& push_atom_id() const;
  ::google::protobuf::RepeatedField<int>* PROTOBUF_NONNULL mutable_push_atom_id();
  ...
  const ::google::protobuf::RepeatedField<::int32_t>& raw_push_atom_id() const;
  ...
  ::perfetto::protos::StatsdPullAtomConfig* PROTOBUF_NONNULL mutable_pull_config(int index);
  ::google::protobuf::RepeatedPtrField<::perfetto::protos::StatsdPullAtomConfig>* PROTOBUF_NONNULL mutable_pull_config();
  ...
  const ::google::protobuf::RepeatedPtrField<::perfetto::protos::StatsdPullAtomConfig>& pull_config() const;
