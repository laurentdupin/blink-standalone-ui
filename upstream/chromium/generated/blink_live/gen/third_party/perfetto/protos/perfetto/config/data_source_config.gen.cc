...
void DataSourceConfig::Serialize(::protozero::Message* msg) const {
  ...
  // Field 138: user_list_config
  if (_has_field_[138]) {
    msg->AppendString(138, user_list_config_);
  }

  // Field 139: inputmethod_config
  if (_has_field_[139]) {
