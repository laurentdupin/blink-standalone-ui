...
class AndroidLogConfig_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/5> {
 public:
  ...
  bool has_preserve_log_buffer() const { return at<5>().valid(); }
  bool preserve_log_buffer() const { return at<5>().as_bool(); }
};
...
class AndroidLogConfig : public ::protozero::Message {
 public:
  ...
  using FieldMetadata_PreserveLogBuffer =
    ::protozero::proto_utils::FieldMetadata<
      5,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
  ...
  static constexpr FieldMetadata_PreserveLogBuffer kPreserveLogBuffer{};
  void set_preserve_log_buffer(bool value) {
    static constexpr uint32_t field_id = FieldMetadata_PreserveLogBuffer::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kBool>
