...
extern const ::google::protobuf::internal::ClassDataLite<35> ProcessStatsConfig_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
inline bool ProcessStatsConfig_Quirks_IsValid(int value) {
...
class ProcessStatsConfig final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.ProcessStatsConfig) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR ProcessStatsConfig(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(ProcessStatsConfig* PROTOBUF_NONNULL other) {
  ...
  ProcessStatsConfig* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<ProcessStatsConfig>(arena);
  }
 ...
 public:
  ...
  static constexpr Quirks DISABLE_INITIAL_DUMP = ProcessStatsConfig_Quirks_DISABLE_INITIAL_DUMP;
  ...
  static inline bool Quirks_Parse(
  ...
  ::google::protobuf::RepeatedField<int>* PROTOBUF_NONNULL mutable_quirks();
  ...
  bool has_record_process_dmabuf_rss() const;
  void clear_record_process_dmabuf_rss() ;
  bool record_process_dmabuf_rss() const;
