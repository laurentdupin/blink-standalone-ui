...
class TrackEventConfig_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/10> {
 public:
  ...
  bool has_thread_time_subsampling_ns() const { return at<10>().valid(); }
  uint64_t thread_time_subsampling_ns() const { return at<10>().as_uint64(); }
...
class TrackEventConfig : public ::protozero::Message {
 public:
  ...
  using FieldMetadata_ThreadTimeSubsamplingNs =
    ::protozero::proto_utils::FieldMetadata<
      10,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kUint64,
  ...
  static constexpr FieldMetadata_ThreadTimeSubsamplingNs kThreadTimeSubsamplingNs{};
  void set_thread_time_subsampling_ns(uint64_t value) {
    static constexpr uint32_t field_id = FieldMetadata_ThreadTimeSubsamplingNs::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kUint64>
