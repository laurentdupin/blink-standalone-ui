...
PROTOBUF_CONSTEXPR RectProto::RectProto(::_pbi::ConstantInitialized)
    ...
    : ::google::protobuf::MessageLite(RectProto_class_data_.base()),
...
struct RectProtoDefaultTypeInternal {
  PROTOBUF_CONSTEXPR RectProtoDefaultTypeInternal() : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 RectProtoDefaultTypeInternal _RectProto_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
class RectProto::_Internal {
 public:
  using HasBits =
      decltype(::std::declval<RectProto>()._impl_._has_bits_);
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::MessageLite(arena, RectProto_class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
...
constexpr auto RectProto::InternalNewImpl_() {
  return ::google::protobuf::internal::MessageCreator::ZeroInit(sizeof(RectProto),
                                            alignof(RectProto));
}
constexpr auto RectProto::InternalGenerateClassData_() {
  return ::google::protobuf::internal::ClassDataLite<26>{
      {
          &_RectProto_default_instance_._instance,
          &_table_.header,
      ...
      "perfetto.protos.RectProto",
  };
}

PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataLite<26> RectProto_class_data_ =
    RectProto::InternalGenerateClassData_();
...
RectProto::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::perfetto::protos::RectProto>(),  // to_prefetch
    ...
    {::_pbi::TcParser::FastV32S1,
     {16, 1, 0,
      PROTOBUF_FIELD_OFFSET(RectProto, _impl_.top_)}},
    // optional int32 right = 3;
    {::_pbi::TcParser::FastV32S1,
     {24, 2, 0,
      PROTOBUF_FIELD_OFFSET(RectProto, _impl_.right_)}},
  }}, {{
    65535, 65535
  }}, {{
    // optional int32 left = 1;
    {PROTOBUF_FIELD_OFFSET(RectProto, _impl_.left_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // optional int32 top = 2;
    {PROTOBUF_FIELD_OFFSET(RectProto, _impl_.top_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // optional int32 right = 3;
    {PROTOBUF_FIELD_OFFSET(RectProto, _impl_.right_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
    // optional int32 bottom = 4;
    {PROTOBUF_FIELD_OFFSET(RectProto, _impl_.bottom_), _Internal::kHasBitsOffset + 3, 0, (0 | ::_fl::kFcOptional | ::_fl::kInt32)},
  }},
  // no aux_entries
  {{
  }},
