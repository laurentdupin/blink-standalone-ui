...
#ifndef protos_2fperfetto_2fconfig_2fgpu_2fvulkan_5fmemory_5fconfig_2eproto_2epb_2eh
#define protos_2fperfetto_2fconfig_2fgpu_2fvulkan_5fmemory_5fconfig_2eproto_2epb_2eh
...
extern const ::google::protobuf::internal::ClassDataLite<35> VulkanMemoryConfig_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
class VulkanMemoryConfig final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.VulkanMemoryConfig) */ {
 public:
  inline VulkanMemoryConfig() : VulkanMemoryConfig(nullptr) {}
  ~VulkanMemoryConfig() PROTOBUF_FINAL;

#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(VulkanMemoryConfig* PROTOBUF_NONNULL msg, ::std::destroying_delete_t) {
    SharedDtor(*msg);
    ::google::protobuf::internal::SizedDelete(msg, sizeof(VulkanMemoryConfig));
  }
#endif

  template <typename = void>
  explicit PROTOBUF_CONSTEXPR VulkanMemoryConfig(::google::protobuf::internal::ConstantInitialized);

  inline VulkanMemoryConfig(const VulkanMemoryConfig& from) : VulkanMemoryConfig(nullptr, from) {}
  inline VulkanMemoryConfig(VulkanMemoryConfig&& from) noexcept
      : VulkanMemoryConfig(nullptr, ::std::move(from)) {}
  ...
  friend void swap(VulkanMemoryConfig& a, VulkanMemoryConfig& b) { a.Swap(&b); }
  PROTOBUF_NOINLINE void Swap(VulkanMemoryConfig* PROTOBUF_NONNULL other) {
  ...
  void UnsafeArenaSwap(VulkanMemoryConfig* PROTOBUF_NONNULL other) {
    if (other == this) return;
  ...
  VulkanMemoryConfig* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<VulkanMemoryConfig>(arena);
  }
  void CopyFrom(const VulkanMemoryConfig& from);
  void MergeFrom(const VulkanMemoryConfig& from) { VulkanMemoryConfig::MergeImpl(*this, from); }
  ...
  void InternalSwap(VulkanMemoryConfig* PROTOBUF_NONNULL other);
 private:
  template <typename T>
  friend ::absl::string_view(::google::protobuf::internal::GetAnyMessageName)();
  static ::absl::string_view FullMessageName() { return "perfetto.protos.VulkanMemoryConfig"; }

  explicit VulkanMemoryConfig(::google::protobuf::Arena* PROTOBUF_NULLABLE arena);
  VulkanMemoryConfig(::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const VulkanMemoryConfig& from);
  VulkanMemoryConfig(
      ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, VulkanMemoryConfig&& from) noexcept
      : VulkanMemoryConfig(arena) {
    *this = ::std::move(from);
  }
 ...
 private:
  ...
  struct Impl_ {
    ...
    inline explicit Impl_(
        ...
        const VulkanMemoryConfig& from_msg);
...
#endif  // protos_2fperfetto_2fconfig_2fgpu_2fvulkan_5fmemory_5fconfig_2eproto_2epb_2eh
