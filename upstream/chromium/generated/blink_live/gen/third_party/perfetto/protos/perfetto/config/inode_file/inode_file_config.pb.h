...
extern const ::google::protobuf::internal::ClassDataLite<32> InodeFileConfig_class_data_;
...
extern const ::google::protobuf::internal::ClassDataLite<55> InodeFileConfig_MountPointMappingEntry_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
class InodeFileConfig_MountPointMappingEntry final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.InodeFileConfig.MountPointMappingEntry) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR InodeFileConfig_MountPointMappingEntry(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(InodeFileConfig_MountPointMappingEntry* PROTOBUF_NONNULL other) {
  ...
  InodeFileConfig_MountPointMappingEntry* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<InodeFileConfig_MountPointMappingEntry>(arena);
  }
 ...
 public:
  ...
  ::google::protobuf::RepeatedPtrField<::std::string>* PROTOBUF_NONNULL mutable_scan_roots();
...
class InodeFileConfig final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.InodeFileConfig) */ {
 public:
  ...
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR InodeFileConfig(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(InodeFileConfig* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
  ...
  InodeFileConfig* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<InodeFileConfig>(arena);
  }
 ...
 public:
  ...
  ::google::protobuf::RepeatedPtrField<::std::string>* PROTOBUF_NONNULL mutable_scan_mount_points();
  ...
  ::perfetto::protos::InodeFileConfig_MountPointMappingEntry* PROTOBUF_NONNULL mutable_mount_point_mapping(int index);
  ::google::protobuf::RepeatedPtrField<::perfetto::protos::InodeFileConfig_MountPointMappingEntry>* PROTOBUF_NONNULL mutable_mount_point_mapping();
  ...
  const ::google::protobuf::RepeatedPtrField<::perfetto::protos::InodeFileConfig_MountPointMappingEntry>& mount_point_mapping() const;
