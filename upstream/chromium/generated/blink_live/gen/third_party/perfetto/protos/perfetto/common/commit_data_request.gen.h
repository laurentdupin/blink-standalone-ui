...
class PERFETTO_EXPORT_COMPONENT CommitDataRequest_ChunksToMove : public ::protozero::CppMessageObj {
 public:
  ...
  bool has_chunk_incomplete() const { return _has_field_[5]; }
  bool chunk_incomplete() const { return chunk_incomplete_; }
  void set_chunk_incomplete(bool value) { chunk_incomplete_ = value; _has_field_.set(5); }
