...
class TracePacket_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/900> {
 public:
  ...
  bool has_generic_gpu_frequency_event() const { return at<129>().valid(); }
  ::protozero::ConstBytes generic_gpu_frequency_event() const { return at<129>().as_bytes(); }
  ...
  bool has_trace_provenance() const { return at<124>().valid(); }
  ::protozero::ConstBytes trace_provenance() const { return at<124>().as_bytes(); }
  bool has_protovms() const { return at<125>().valid(); }
  ::protozero::ConstBytes protovms() const { return at<125>().as_bytes(); }
  bool has_trace_attributes() const { return at<126>().valid(); }
  ::protozero::ConstBytes trace_attributes() const { return at<126>().as_bytes(); }
  bool has_android_aflags() const { return at<127>().valid(); }
  ::protozero::ConstBytes android_aflags() const { return at<127>().as_bytes(); }
  bool has_gpu_info() const { return at<128>().valid(); }
  ::protozero::ConstBytes gpu_info() const { return at<128>().as_bytes(); }
  ...
  bool has_user_list() const { return at<123>().valid(); }
  ::protozero::ConstBytes user_list() const { return at<123>().as_bytes(); }
...
class TracePacket : public ::protozero::Message {
 public:
  ...
  using ProtoVms = ::perfetto::protos::pbzero::TracePacket_ProtoVms;
  ...
  using FieldMetadata_GenericGpuFrequencyEvent =
    ::protozero::proto_utils::FieldMetadata<
      129,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
  ...
  static constexpr FieldMetadata_GenericGpuFrequencyEvent kGenericGpuFrequencyEvent{};
  template <typename T = GenericGpuFrequencyEvent> T* set_generic_gpu_frequency_event() {
  ...
  using FieldMetadata_TraceProvenance =
    ::protozero::proto_utils::FieldMetadata<
      124,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
  ...
  static constexpr FieldMetadata_TraceProvenance kTraceProvenance{};
  template <typename T = TraceProvenance> T* set_trace_provenance() {
    return BeginNestedMessage<T>(124);
  }


  using FieldMetadata_Protovms =
    ::protozero::proto_utils::FieldMetadata<
      125,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
  ...
  static constexpr FieldMetadata_Protovms kProtovms{};
  template <typename T = TracePacket_ProtoVms> T* set_protovms() {
  ...
  using FieldMetadata_AndroidAflags =
    ::protozero::proto_utils::FieldMetadata<
      127,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
  ...
  static constexpr FieldMetadata_AndroidAflags kAndroidAflags{};
  template <typename T = AndroidAflags> T* set_android_aflags() {
    return BeginNestedMessage<T>(127);
  }


  using FieldMetadata_GpuInfo =
    ::protozero::proto_utils::FieldMetadata<
      128,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
  ...
  static constexpr FieldMetadata_GpuInfo kGpuInfo{};
  template <typename T = GpuInfo> T* set_gpu_info() {
  ...
  static constexpr FieldMetadata_UserList kUserList{};
  template <typename T = AndroidUserList> T* set_user_list() {
...
class TracePacket_ProtoVms_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/1> {
 public:
  TracePacket_ProtoVms_Decoder(const uint8_t* data, size_t len) : TypedProtoDecoder(data, len) {}
  explicit TracePacket_ProtoVms_Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
  explicit TracePacket_ProtoVms_Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
...
class TracePacket_ProtoVms : public ::protozero::Message {
 public:
  using Decoder = TracePacket_ProtoVms_Decoder;
  enum : int32_t {
    kInstanceFieldNumber = 1,
  };
  static constexpr const char* GetName() { return ".perfetto.protos.TracePacket.ProtoVms"; }

  using Instance = ::perfetto::protos::pbzero::TracePacket_ProtoVms_Instance;
  ...
  template <typename T = TracePacket_ProtoVms_Instance> T* add_instance() {
    return BeginNestedMessage<T>(1);
  }

};

class TracePacket_ProtoVms_Instance_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/4> {
 public:
  TracePacket_ProtoVms_Instance_Decoder(const uint8_t* data, size_t len) : TypedProtoDecoder(data, len) {}
  explicit TracePacket_ProtoVms_Instance_Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
  explicit TracePacket_ProtoVms_Instance_Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
  bool has_program() const { return at<1>().valid(); }
  ::protozero::ConstBytes program() const { return at<1>().as_bytes(); }
  bool has_state() const { return at<2>().valid(); }
  ::protozero::ConstBytes state() const { return at<2>().as_bytes(); }
  bool has_memory_limit_kb() const { return at<3>().valid(); }
  uint32_t memory_limit_kb() const { return at<3>().as_uint32(); }
  bool has_producer_id() const { return at<4>().valid(); }
  ::protozero::RepeatedFieldIterator<int32_t> producer_id() const { return GetRepeated<int32_t>(4); }
};

class TracePacket_ProtoVms_Instance : public ::protozero::Message {
 public:
  using Decoder = TracePacket_ProtoVms_Instance_Decoder;
  enum : int32_t {
  ...
  static constexpr const char* GetName() { return ".perfetto.protos.TracePacket.ProtoVms.Instance"; }


  using FieldMetadata_Program =
    ::protozero::proto_utils::FieldMetadata<
      1,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
  ...
  static constexpr FieldMetadata_Program kProgram{};
  template <typename T = VmProgram> T* set_program() {
    return BeginNestedMessage<T>(1);
  }
  ...
  template <typename T = TracePacket> T* set_state() {
    return BeginNestedMessage<T>(2);
  }
