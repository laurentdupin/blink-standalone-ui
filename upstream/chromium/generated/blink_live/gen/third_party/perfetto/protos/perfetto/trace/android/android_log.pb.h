...
extern const ::google::protobuf::internal::ClassDataLite<33> AndroidLogPacket_class_data_;
...
extern const ::google::protobuf::internal::ClassDataLite<42> AndroidLogPacket_LogEvent_class_data_;
...
extern const ::google::protobuf::internal::ClassDataLite<46> AndroidLogPacket_LogEvent_Arg_class_data_;
...
extern const ::google::protobuf::internal::ClassDataLite<39> AndroidLogPacket_Stats_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
class AndroidLogPacket_Stats final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.AndroidLogPacket.Stats) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR AndroidLogPacket_Stats(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(AndroidLogPacket_Stats* PROTOBUF_NONNULL other) {
  ...
  AndroidLogPacket_Stats* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<AndroidLogPacket_Stats>(arena);
  }
...
class AndroidLogPacket_LogEvent_Arg final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.AndroidLogPacket.LogEvent.Arg) */ {
 public:
  ...
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR AndroidLogPacket_LogEvent_Arg(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(AndroidLogPacket_LogEvent_Arg* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
  ...
  AndroidLogPacket_LogEvent_Arg* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<AndroidLogPacket_LogEvent_Arg>(arena);
  }
...
class AndroidLogPacket_LogEvent final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.AndroidLogPacket.LogEvent) */ {
 public:
  ...
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR AndroidLogPacket_LogEvent(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(AndroidLogPacket_LogEvent* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
  ...
  AndroidLogPacket_LogEvent* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<AndroidLogPacket_LogEvent>(arena);
  }
 ...
 public:
  ...
  public:
  void clear_args() ;
  ::perfetto::protos::AndroidLogPacket_LogEvent_Arg* PROTOBUF_NONNULL mutable_args(int index);
  ::google::protobuf::RepeatedPtrField<::perfetto::protos::AndroidLogPacket_LogEvent_Arg>* PROTOBUF_NONNULL mutable_args();
  ...
  const ::google::protobuf::RepeatedPtrField<::perfetto::protos::AndroidLogPacket_LogEvent_Arg>& args() const;
...
class AndroidLogPacket final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.AndroidLogPacket) */ {
 public:
  ...
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR AndroidLogPacket(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(AndroidLogPacket* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
  ...
  AndroidLogPacket* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<AndroidLogPacket>(arena);
  }
 ...
 public:
  ...
  public:
  void clear_events() ;
  ::perfetto::protos::AndroidLogPacket_LogEvent* PROTOBUF_NONNULL mutable_events(int index);
  ::google::protobuf::RepeatedPtrField<::perfetto::protos::AndroidLogPacket_LogEvent>* PROTOBUF_NONNULL mutable_events();
  ...
  const ::google::protobuf::RepeatedPtrField<::perfetto::protos::AndroidLogPacket_LogEvent>& events() const;
...
inline ::perfetto::protos::AndroidLogPacket_Stats* PROTOBUF_NONNULL AndroidLogPacket::_internal_mutable_stats() {
  ...
  if (_impl_.stats_ == nullptr) {
    auto* p = ::google::protobuf::MessageLite::DefaultConstruct<::perfetto::protos::AndroidLogPacket_Stats>(GetArena());
