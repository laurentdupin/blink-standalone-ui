...
class DataSourceConfig_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/150> {
 public:
  ...
  bool has_target_buffer_name() const { return at<11>().valid(); }
  ::protozero::ConstChars target_buffer_name() const { return at<11>().as_string(); }
  ...
  bool has_protovm_config() const { return at<12>().valid(); }
  ::protozero::ConstBytes protovm_config() const { return at<12>().as_bytes(); }
  ...
  bool has_user_list_config() const { return at<138>().valid(); }
  ::protozero::ConstBytes user_list_config() const { return at<138>().as_bytes(); }
  bool has_inputmethod_config() const { return at<139>().valid(); }
  ::protozero::ConstBytes inputmethod_config() const { return at<139>().as_bytes(); }
  bool has_android_aflags_config() const { return at<140>().valid(); }
  ::protozero::ConstBytes android_aflags_config() const { return at<140>().as_bytes(); }
  bool has_qnx_config() const { return at<150>().valid(); }
  ::protozero::ConstBytes qnx_config() const { return at<150>().as_bytes(); }
...
class DataSourceConfig : public ::protozero::Message {
 public:
  ...
  using FieldMetadata_TargetBufferName =
    ::protozero::proto_utils::FieldMetadata<
      11,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kString,
  ...
  static constexpr FieldMetadata_TargetBufferName kTargetBufferName{};
  void set_target_buffer_name(const char* data, size_t size) {
    AppendBytes(FieldMetadata_TargetBufferName::kFieldId, data, size);
  }
  void set_target_buffer_name(::protozero::ConstChars chars) {
    AppendBytes(FieldMetadata_TargetBufferName::kFieldId, chars.data, chars.size);
  }
  void set_target_buffer_name(std::string value) {
    static constexpr uint32_t field_id = FieldMetadata_TargetBufferName::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kString>
  ...
  using FieldMetadata_ProtovmConfig =
    ::protozero::proto_utils::FieldMetadata<
      12,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
  ...
  static constexpr FieldMetadata_ProtovmConfig kProtovmConfig{};
  template <typename T = ProtoVmConfig> T* set_protovm_config() {
  ...
  using FieldMetadata_UserListConfig =
    ::protozero::proto_utils::FieldMetadata<
      138,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
  ...
  static constexpr FieldMetadata_UserListConfig kUserListConfig{};
  template <typename T = AndroidUserListConfig> T* set_user_list_config() {
    return BeginNestedMessage<T>(138);
  }

  void set_user_list_config_raw(const std::string& raw) {
    return AppendBytes(138, raw.data(), raw.size());
  }


  using FieldMetadata_InputmethodConfig =
    ::protozero::proto_utils::FieldMetadata<
      139,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
  ...
  static constexpr FieldMetadata_InputmethodConfig kInputmethodConfig{};
  template <typename T = InputMethodConfig> T* set_inputmethod_config() {
    return BeginNestedMessage<T>(139);
  }

  void set_inputmethod_config_raw(const std::string& raw) {
    return AppendBytes(139, raw.data(), raw.size());
  }


  using FieldMetadata_AndroidAflagsConfig =
    ::protozero::proto_utils::FieldMetadata<
      140,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
  ...
  static constexpr FieldMetadata_AndroidAflagsConfig kAndroidAflagsConfig{};
  template <typename T = AndroidAflagsConfig> T* set_android_aflags_config() {
    return BeginNestedMessage<T>(140);
  }

  void set_android_aflags_config_raw(const std::string& raw) {
    return AppendBytes(140, raw.data(), raw.size());
  }


  using FieldMetadata_QnxConfig =
    ::protozero::proto_utils::FieldMetadata<
      150,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
  ...
  static constexpr FieldMetadata_QnxConfig kQnxConfig{};
  template <typename T = QnxConfig> T* set_qnx_config() {
    return BeginNestedMessage<T>(150);
  }

  void set_qnx_config_raw(const std::string& raw) {
    return AppendBytes(150, raw.data(), raw.size());
  }
