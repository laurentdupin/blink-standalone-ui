...
extern const ::google::protobuf::internal::ClassDataLite<32> DebugAnnotation_class_data_;
...
extern const ::google::protobuf::internal::ClassDataLite<36> DebugAnnotationName_class_data_;
...
extern const ::google::protobuf::internal::ClassDataLite<45> DebugAnnotationValueTypeName_class_data_;
...
extern const ::google::protobuf::internal::ClassDataLite<44> DebugAnnotation_NestedValue_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
inline bool DebugAnnotation_NestedValue_NestedType_IsValid(int value) {
...
class DebugAnnotationValueTypeName final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.DebugAnnotationValueTypeName) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR DebugAnnotationValueTypeName(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(DebugAnnotationValueTypeName* PROTOBUF_NONNULL other) {
  ...
  DebugAnnotationValueTypeName* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<DebugAnnotationValueTypeName>(arena);
  }
...
class DebugAnnotationName final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.DebugAnnotationName) */ {
 public:
  ...
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR DebugAnnotationName(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(DebugAnnotationName* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
  ...
  DebugAnnotationName* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<DebugAnnotationName>(arena);
  }
...
class DebugAnnotation_NestedValue final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.DebugAnnotation.NestedValue) */ {
 public:
  ...
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR DebugAnnotation_NestedValue(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(DebugAnnotation_NestedValue* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
  ...
  DebugAnnotation_NestedValue* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<DebugAnnotation_NestedValue>(arena);
  }
 ...
 public:
  ...
  ::perfetto::protos::DebugAnnotation_NestedValue* PROTOBUF_NONNULL mutable_dict_values(int index);
  ::google::protobuf::RepeatedPtrField<::perfetto::protos::DebugAnnotation_NestedValue>* PROTOBUF_NONNULL mutable_dict_values();
  ...
  const ::google::protobuf::RepeatedPtrField<::perfetto::protos::DebugAnnotation_NestedValue>& dict_values() const;
  ...
  ::perfetto::protos::DebugAnnotation_NestedValue* PROTOBUF_NONNULL mutable_array_values(int index);
  ::google::protobuf::RepeatedPtrField<::perfetto::protos::DebugAnnotation_NestedValue>* PROTOBUF_NONNULL mutable_array_values();
  ...
  const ::google::protobuf::RepeatedPtrField<::perfetto::protos::DebugAnnotation_NestedValue>& array_values() const;
...
class DebugAnnotation final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.DebugAnnotation) */ {
 public:
  ...
  PROTOBUF_NOINLINE void Swap(DebugAnnotation* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
  ...
  DebugAnnotation* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<DebugAnnotation>(arena);
  }
 ...
 public:
  ...
  ::perfetto::protos::DebugAnnotation* PROTOBUF_NONNULL mutable_dict_entries(int index);
  ::google::protobuf::RepeatedPtrField<::perfetto::protos::DebugAnnotation>* PROTOBUF_NONNULL mutable_dict_entries();
  ...
  const ::google::protobuf::RepeatedPtrField<::perfetto::protos::DebugAnnotation>& dict_entries() const;
  ...
  public:
  void clear_array_values() ;
  ::perfetto::protos::DebugAnnotation* PROTOBUF_NONNULL mutable_array_values(int index);
  ::google::protobuf::RepeatedPtrField<::perfetto::protos::DebugAnnotation>* PROTOBUF_NONNULL mutable_array_values();
  ...
  const ::google::protobuf::RepeatedPtrField<::perfetto::protos::DebugAnnotation>& array_values() const;
...
inline ::perfetto::protos::DebugAnnotation_NestedValue* PROTOBUF_NONNULL DebugAnnotation::_internal_mutable_nested_value() {
  if (value_case() != kNestedValue) {
    ...
    _impl_.value_.nested_value_ = 
        ::google::protobuf::MessageLite::DefaultConstruct<::perfetto::protos::DebugAnnotation_NestedValue>(GetArena());
  }
