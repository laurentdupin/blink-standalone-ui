...
class DpuDispFrameStartMissingFtraceEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/4> {
 public:
  DpuDispFrameStartMissingFtraceEvent_Decoder(const uint8_t* data, size_t len) : TypedProtoDecoder(data, len) {}
  explicit DpuDispFrameStartMissingFtraceEvent_Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
  explicit DpuDispFrameStartMissingFtraceEvent_Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
  ...
  uint32_t output_id() const { return at<2>().as_uint32(); }
  bool has_frames_pending() const { return at<3>().valid(); }
  int32_t frames_pending() const { return at<3>().as_int32(); }
  bool has_te_count() const { return at<4>().valid(); }
  int32_t te_count() const { return at<4>().as_int32(); }
};

class DpuDispFrameStartMissingFtraceEvent : public ::protozero::Message {
 public:
  using Decoder = DpuDispFrameStartMissingFtraceEvent_Decoder;
  enum : int32_t {
    kDisplayIdFieldNumber = 1,
    kOutputIdFieldNumber = 2,
    kFramesPendingFieldNumber = 3,
    kTeCountFieldNumber = 4,
  };
  static constexpr const char* GetName() { return ".perfetto.protos.DpuDispFrameStartMissingFtraceEvent"; }
  ...
  void set_output_id(uint32_t value) {
  ...
  static constexpr FieldMetadata_TeCount kTeCount{};
  void set_te_count(int32_t value) {
    static constexpr uint32_t field_id = FieldMetadata_TeCount::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kInt32>
...
class DpuDispFrameDoneMissingFtraceEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/4> {
 public:
  DpuDispFrameDoneMissingFtraceEvent_Decoder(const uint8_t* data, size_t len) : TypedProtoDecoder(data, len) {}
  explicit DpuDispFrameDoneMissingFtraceEvent_Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
  explicit DpuDispFrameDoneMissingFtraceEvent_Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
  bool has_display_id() const { return at<1>().valid(); }
  int32_t display_id() const { return at<1>().as_int32(); }
  bool has_output_id() const { return at<2>().valid(); }
  uint32_t output_id() const { return at<2>().as_uint32(); }
...
class DpuDispFrameDoneMissingFtraceEvent : public ::protozero::Message {
 public:
  using Decoder = DpuDispFrameDoneMissingFtraceEvent_Decoder;
  enum : int32_t {
    kDisplayIdFieldNumber = 1,
    kOutputIdFieldNumber = 2,
    kFramesPendingFieldNumber = 3,
  ...
  static constexpr const char* GetName() { return ".perfetto.protos.DpuDispFrameDoneMissingFtraceEvent"; }
...
class DpuDispFrameStartTimeoutFtraceEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/4> {
 public:
  DpuDispFrameStartTimeoutFtraceEvent_Decoder(const uint8_t* data, size_t len) : TypedProtoDecoder(data, len) {}
  explicit DpuDispFrameStartTimeoutFtraceEvent_Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
  explicit DpuDispFrameStartTimeoutFtraceEvent_Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
  bool has_display_id() const { return at<1>().valid(); }
  int32_t display_id() const { return at<1>().as_int32(); }
  bool has_output_id() const { return at<2>().valid(); }
  uint32_t output_id() const { return at<2>().as_uint32(); }
...
class DpuDispFrameStartTimeoutFtraceEvent : public ::protozero::Message {
 public:
  using Decoder = DpuDispFrameStartTimeoutFtraceEvent_Decoder;
  enum : int32_t {
    kDisplayIdFieldNumber = 1,
    kOutputIdFieldNumber = 2,
    kFramesPendingFieldNumber = 3,
  ...
  static constexpr const char* GetName() { return ".perfetto.protos.DpuDispFrameStartTimeoutFtraceEvent"; }
...
class DpuDispFrameDoneTimeoutFtraceEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/5> {
 public:
  DpuDispFrameDoneTimeoutFtraceEvent_Decoder(const uint8_t* data, size_t len) : TypedProtoDecoder(data, len) {}
  explicit DpuDispFrameDoneTimeoutFtraceEvent_Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
  explicit DpuDispFrameDoneTimeoutFtraceEvent_Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
  bool has_display_id() const { return at<1>().valid(); }
  int32_t display_id() const { return at<1>().as_int32(); }
  bool has_output_id() const { return at<2>().valid(); }
  uint32_t output_id() const { return at<2>().as_uint32(); }
  ...
  bool has_te_count() const { return at<4>().valid(); }
  int32_t te_count() const { return at<4>().as_int32(); }
  bool has_during_disable() const { return at<5>().valid(); }
  uint32_t during_disable() const { return at<5>().as_uint32(); }
};

class DpuDispFrameDoneTimeoutFtraceEvent : public ::protozero::Message {
 public:
  using Decoder = DpuDispFrameDoneTimeoutFtraceEvent_Decoder;
  enum : int32_t {
    kDisplayIdFieldNumber = 1,
    kOutputIdFieldNumber = 2,
    kFramesPendingFieldNumber = 3,
    kTeCountFieldNumber = 4,
    kDuringDisableFieldNumber = 5,
  };
  static constexpr const char* GetName() { return ".perfetto.protos.DpuDispFrameDoneTimeoutFtraceEvent"; }
  ...
  using FieldMetadata_DuringDisable =
    ::protozero::proto_utils::FieldMetadata<
      5,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kUint32,
  ...
  static constexpr FieldMetadata_DuringDisable kDuringDisable{};
  void set_during_disable(uint32_t value) {
    static constexpr uint32_t field_id = FieldMetadata_DuringDisable::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kUint32>
...
class DpuDsiTxFtraceEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/5> {
 public:
  ...
  bool has_tx_buf() const { return at<5>().valid(); }
  ::protozero::ConstBytes tx_buf() const { return at<5>().as_bytes(); }
};
...
class DpuDsiRxFtraceEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/3> {
 public:
