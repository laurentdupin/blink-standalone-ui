...
class SystemInfo_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/16> {
 public:
  ...
  bool has_system_ram_bytes() const { return at<16>().valid(); }
  uint64_t system_ram_bytes() const { return at<16>().as_uint64(); }
};
...
class SystemInfo : public ::protozero::Message {
 public:
  ...
  using FieldMetadata_SystemRamBytes =
    ::protozero::proto_utils::FieldMetadata<
      16,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kUint64,
  ...
  static constexpr FieldMetadata_SystemRamBytes kSystemRamBytes{};
  void set_system_ram_bytes(uint64_t value) {
    static constexpr uint32_t field_id = FieldMetadata_SystemRamBytes::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kUint64>
