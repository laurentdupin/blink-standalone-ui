...
class V8JsCode_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/11> {
 public:
  ...
  bool has_source_positions() const { return at<9>().valid(); }
  ::protozero::ConstBytes source_positions() const { return at<9>().as_bytes(); }
  bool has_bytecode_positions() const { return at<10>().valid(); }
  ::protozero::ConstBytes bytecode_positions() const { return at<10>().as_bytes(); }
  bool has_inlined_bytecode_positions() const { return at<11>().valid(); }
  ::protozero::ConstBytes inlined_bytecode_positions() const { return at<11>().as_bytes(); }
};
...
class V8JsCode : public ::protozero::Message {
 public:
  ...
  using FieldMetadata_SourcePositions =
    ::protozero::proto_utils::FieldMetadata<
      9,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kBytes,
  ...
  static constexpr FieldMetadata_SourcePositions kSourcePositions{};
  void set_source_positions(const uint8_t* data, size_t size) {
    AppendBytes(FieldMetadata_SourcePositions::kFieldId, data, size);
  }
  void set_source_positions(::protozero::ConstBytes bytes) {
    AppendBytes(FieldMetadata_SourcePositions::kFieldId, bytes.data, bytes.size);
  }
  void set_source_positions(std::string value) {
    static constexpr uint32_t field_id = FieldMetadata_SourcePositions::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kBytes>
  ...
  using FieldMetadata_BytecodePositions =
    ::protozero::proto_utils::FieldMetadata<
      10,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kBytes,
  ...
  static constexpr FieldMetadata_BytecodePositions kBytecodePositions{};
  void set_bytecode_positions(const uint8_t* data, size_t size) {
    AppendBytes(FieldMetadata_BytecodePositions::kFieldId, data, size);
  }
  void set_bytecode_positions(::protozero::ConstBytes bytes) {
    AppendBytes(FieldMetadata_BytecodePositions::kFieldId, bytes.data, bytes.size);
  }
  void set_bytecode_positions(std::string value) {
    static constexpr uint32_t field_id = FieldMetadata_BytecodePositions::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kBytes>
  ...
  using FieldMetadata_InlinedBytecodePositions =
    ::protozero::proto_utils::FieldMetadata<
      11,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kBytes,
  ...
  static constexpr FieldMetadata_InlinedBytecodePositions kInlinedBytecodePositions{};
  void set_inlined_bytecode_positions(const uint8_t* data, size_t size) {
    AppendBytes(FieldMetadata_InlinedBytecodePositions::kFieldId, data, size);
  }
  void set_inlined_bytecode_positions(::protozero::ConstBytes bytes) {
    AppendBytes(FieldMetadata_InlinedBytecodePositions::kFieldId, bytes.data, bytes.size);
  }
  void set_inlined_bytecode_positions(std::string value) {
    static constexpr uint32_t field_id = FieldMetadata_InlinedBytecodePositions::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kBytes>
