...
class PerfEvents_RawEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/5> {
 public:
  ...
  bool has_pmu_name() const { return at<5>().valid(); }
  ::protozero::ConstChars pmu_name() const { return at<5>().as_string(); }
};
...
class PerfEvents_RawEvent : public ::protozero::Message {
 public:
  ...
  static constexpr FieldMetadata_PmuName kPmuName{};
  void set_pmu_name(const char* data, size_t size) {
    AppendBytes(FieldMetadata_PmuName::kFieldId, data, size);
  }
  void set_pmu_name(::protozero::ConstChars chars) {
    AppendBytes(FieldMetadata_PmuName::kFieldId, chars.data, chars.size);
  }
  void set_pmu_name(std::string value) {
    static constexpr uint32_t field_id = FieldMetadata_PmuName::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kString>
