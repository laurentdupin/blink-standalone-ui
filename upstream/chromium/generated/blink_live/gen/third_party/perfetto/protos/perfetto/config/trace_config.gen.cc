...
#include "protos/perfetto/config/android/android_aflags_config.gen.h"
  ...
  for (auto field = dec.ReadField(); field.valid(); field = dec.ReadField()) {
    ...
    switch (field.id()) {
      ...
      case 3 /* string_filter_chain */:
        ...
        break;
      case 4 /* bytecode_overlay_v54 */:
        field.get(&bytecode_overlay_v54_);
        break;
      case 5 /* string_filter_chain_v54 */:
