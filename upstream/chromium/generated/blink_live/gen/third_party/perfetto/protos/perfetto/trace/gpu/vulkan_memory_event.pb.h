...
extern const ::google::protobuf::internal::ClassDataLite<34> VulkanMemoryEvent_class_data_;
...
extern const ::google::protobuf::internal::ClassDataLite<44> VulkanMemoryEventAnnotation_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
inline bool VulkanMemoryEvent_Source_IsValid(int value) {
...
inline bool VulkanMemoryEvent_Operation_IsValid(int value) {
  return 0 <= value && value <= 5;
}
...
inline bool VulkanMemoryEvent_AllocationScope_IsValid(int value) {
  return 0 <= value && value <= 5;
}
...
class VulkanMemoryEventAnnotation final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.VulkanMemoryEventAnnotation) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR VulkanMemoryEventAnnotation(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(VulkanMemoryEventAnnotation* PROTOBUF_NONNULL other) {
  ...
  VulkanMemoryEventAnnotation* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<VulkanMemoryEventAnnotation>(arena);
  }
...
class VulkanMemoryEvent final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.VulkanMemoryEvent) */ {
 public:
  ...
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR VulkanMemoryEvent(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(VulkanMemoryEvent* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
  ...
  VulkanMemoryEvent* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<VulkanMemoryEvent>(arena);
  }
 ...
 public:
  ...
  static inline bool AllocationScope_Parse(
  ...
  ::perfetto::protos::VulkanMemoryEventAnnotation* PROTOBUF_NONNULL mutable_annotations(int index);
  ::google::protobuf::RepeatedPtrField<::perfetto::protos::VulkanMemoryEventAnnotation>* PROTOBUF_NONNULL mutable_annotations();
  ...
  const ::google::protobuf::RepeatedPtrField<::perfetto::protos::VulkanMemoryEventAnnotation>& annotations() const;
