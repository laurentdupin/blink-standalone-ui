...
class PERFETTO_EXPORT_COMPONENT AndroidLogConfig : public ::protozero::CppMessageObj {
 public:
  ...
  bool has_preserve_log_buffer() const { return _has_field_[5]; }
  bool preserve_log_buffer() const { return preserve_log_buffer_; }
  void set_preserve_log_buffer(bool value) { preserve_log_buffer_ = value; _has_field_.set(5); }
