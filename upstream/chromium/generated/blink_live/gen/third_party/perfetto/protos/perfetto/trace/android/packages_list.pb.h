...
extern const ::google::protobuf::internal::ClassDataLite<29> PackagesList_class_data_;
...
extern const ::google::protobuf::internal::ClassDataLite<41> PackagesList_PackageInfo_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
class PackagesList_PackageInfo final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.PackagesList.PackageInfo) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR PackagesList_PackageInfo(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(PackagesList_PackageInfo* PROTOBUF_NONNULL other) {
  ...
  PackagesList_PackageInfo* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<PackagesList_PackageInfo>(arena);
  }
...
class PackagesList final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.PackagesList) */ {
 public:
  ...
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR PackagesList(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(PackagesList* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
  ...
  PackagesList* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<PackagesList>(arena);
  }
 ...
 public:
  ...
  public:
  void clear_packages() ;
  ::perfetto::protos::PackagesList_PackageInfo* PROTOBUF_NONNULL mutable_packages(int index);
  ::google::protobuf::RepeatedPtrField<::perfetto::protos::PackagesList_PackageInfo>* PROTOBUF_NONNULL mutable_packages();
  ...
  const ::google::protobuf::RepeatedPtrField<::perfetto::protos::PackagesList_PackageInfo>& packages() const;
