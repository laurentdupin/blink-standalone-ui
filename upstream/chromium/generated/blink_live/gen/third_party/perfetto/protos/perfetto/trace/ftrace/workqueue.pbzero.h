...
class WorkqueueQueueWorkFtraceEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/6> {
 public:
  ...
  int32_t req_cpu() const { return at<4>().as_int32(); }
  bool has_cpu() const { return at<5>().valid(); }
  int32_t cpu() const { return at<5>().as_int32(); }
  bool has_workqueue() const { return at<6>().valid(); }
  ::protozero::ConstChars workqueue() const { return at<6>().as_string(); }
};
...
class WorkqueueQueueWorkFtraceEvent : public ::protozero::Message {
 public:
  ...
  void set_workqueue(const char* data, size_t size) {
    AppendBytes(FieldMetadata_Workqueue::kFieldId, data, size);
  }
  void set_workqueue(::protozero::ConstChars chars) {
    AppendBytes(FieldMetadata_Workqueue::kFieldId, chars.data, chars.size);
  }
  void set_workqueue(std::string value) {
...
class WorkqueueActivateWorkFtraceEvent_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/2> {
 public:
