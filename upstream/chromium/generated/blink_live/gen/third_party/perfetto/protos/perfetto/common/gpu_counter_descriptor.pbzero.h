...
class GpuCounterDescriptor_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/8> {
 public:
  ...
  bool has_counter_groups() const { return at<6>().valid(); }
  ::protozero::RepeatedFieldIterator<::protozero::ConstBytes> counter_groups() const { return GetRepeated<::protozero::ConstBytes>(6); }
  ...
  bool has_supports_counter_names() const { return at<7>().valid(); }
  bool supports_counter_names() const { return at<7>().as_bool(); }
  bool has_supports_counter_name_globs() const { return at<8>().valid(); }
  bool supports_counter_name_globs() const { return at<8>().as_bool(); }
};
...
class GpuCounterDescriptor : public ::protozero::Message {
 public:
  ...
  using GpuCounterGroupSpec = ::perfetto::protos::pbzero::GpuCounterDescriptor_GpuCounterGroupSpec;
  ...
  using FieldMetadata_CounterGroups =
    ::protozero::proto_utils::FieldMetadata<
      6,
      ::protozero::proto_utils::RepetitionType::kRepeatedNotPacked,
      ::protozero::proto_utils::ProtoSchemaType::kMessage,
  ...
  static constexpr FieldMetadata_CounterGroups kCounterGroups{};
  template <typename T = GpuCounterDescriptor_GpuCounterGroupSpec> T* add_counter_groups() {
  ...
  using FieldMetadata_SupportsCounterNames =
    ::protozero::proto_utils::FieldMetadata<
      7,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kBool,
  ...
  static constexpr FieldMetadata_SupportsCounterNames kSupportsCounterNames{};
  void set_supports_counter_names(bool value) {
    static constexpr uint32_t field_id = FieldMetadata_SupportsCounterNames::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kBool>
  ...
  using FieldMetadata_SupportsCounterNameGlobs =
    ::protozero::proto_utils::FieldMetadata<
      8,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kBool,
  ...
  static constexpr FieldMetadata_SupportsCounterNameGlobs kSupportsCounterNameGlobs{};
  void set_supports_counter_name_globs(bool value) {
    static constexpr uint32_t field_id = FieldMetadata_SupportsCounterNameGlobs::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kBool>
...
class GpuCounterDescriptor_GpuCounterGroupSpec_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/4> {
 public:
  GpuCounterDescriptor_GpuCounterGroupSpec_Decoder(const uint8_t* data, size_t len) : TypedProtoDecoder(data, len) {}
  explicit GpuCounterDescriptor_GpuCounterGroupSpec_Decoder(const std::string& raw) : TypedProtoDecoder(reinterpret_cast<const uint8_t*>(raw.data()), raw.size()) {}
  explicit GpuCounterDescriptor_GpuCounterGroupSpec_Decoder(const ::protozero::ConstBytes& raw) : TypedProtoDecoder(raw.data, raw.size) {}
  bool has_group_id() const { return at<1>().valid(); }
  uint32_t group_id() const { return at<1>().as_uint32(); }
  ...
  bool has_counter_ids() const { return at<4>().valid(); }
  ::protozero::RepeatedFieldIterator<uint32_t> counter_ids() const { return GetRepeated<uint32_t>(4); }
};

class GpuCounterDescriptor_GpuCounterGroupSpec : public ::protozero::Message {
 public:
  using Decoder = GpuCounterDescriptor_GpuCounterGroupSpec_Decoder;
  enum : int32_t {
  ...
  static constexpr const char* GetName() { return ".perfetto.protos.GpuCounterDescriptor.GpuCounterGroupSpec"; }
