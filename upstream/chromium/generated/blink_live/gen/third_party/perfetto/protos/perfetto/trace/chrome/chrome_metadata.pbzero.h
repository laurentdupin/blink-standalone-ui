...
class ChromeMetadataPacket_Decoder : public ::protozero::TypedProtoDecoder</*MAX_FIELD_ID=*/8> {
 public:
  ...
  bool has_app_package_name() const { return at<5>().valid(); }
  ::protozero::ConstChars app_package_name() const { return at<5>().as_string(); }
  bool has_app_version() const { return at<6>().valid(); }
  ::protozero::ConstChars app_version() const { return at<6>().as_string(); }
  bool has_channel() const { return at<7>().valid(); }
  uint32_t channel() const { return at<7>().as_uint32(); }
  bool has_os_name() const { return at<8>().valid(); }
  ::protozero::ConstChars os_name() const { return at<8>().as_string(); }
};
...
class ChromeMetadataPacket : public ::protozero::Message {
 public:
  ...
  using FieldMetadata_AppPackageName =
    ::protozero::proto_utils::FieldMetadata<
      5,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kString,
  ...
  static constexpr FieldMetadata_AppPackageName kAppPackageName{};
  void set_app_package_name(const char* data, size_t size) {
    AppendBytes(FieldMetadata_AppPackageName::kFieldId, data, size);
  }
  void set_app_package_name(::protozero::ConstChars chars) {
    AppendBytes(FieldMetadata_AppPackageName::kFieldId, chars.data, chars.size);
  }
  void set_app_package_name(std::string value) {
    static constexpr uint32_t field_id = FieldMetadata_AppPackageName::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kString>
  ...
  using FieldMetadata_AppVersion =
    ::protozero::proto_utils::FieldMetadata<
      6,
      ::protozero::proto_utils::RepetitionType::kNotRepeated,
      ::protozero::proto_utils::ProtoSchemaType::kString,
  ...
  static constexpr FieldMetadata_AppVersion kAppVersion{};
  void set_app_version(const char* data, size_t size) {
    AppendBytes(FieldMetadata_AppVersion::kFieldId, data, size);
  }
  void set_app_version(::protozero::ConstChars chars) {
    AppendBytes(FieldMetadata_AppVersion::kFieldId, chars.data, chars.size);
  }
  void set_app_version(std::string value) {
    static constexpr uint32_t field_id = FieldMetadata_AppVersion::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kString>
  ...
  static constexpr FieldMetadata_OsName kOsName{};
  void set_os_name(const char* data, size_t size) {
    AppendBytes(FieldMetadata_OsName::kFieldId, data, size);
  }
  void set_os_name(::protozero::ConstChars chars) {
    AppendBytes(FieldMetadata_OsName::kFieldId, chars.data, chars.size);
  }
  void set_os_name(std::string value) {
    static constexpr uint32_t field_id = FieldMetadata_OsName::kFieldId;
    // Call the appropriate protozero::Message::Append(field_id, ...)
    // method based on the type of the field.
    ::protozero::internal::FieldWriter<
      ::protozero::proto_utils::ProtoSchemaType::kString>
