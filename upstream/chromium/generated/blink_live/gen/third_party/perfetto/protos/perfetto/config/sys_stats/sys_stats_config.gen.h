...
class PERFETTO_EXPORT_COMPONENT SysStatsConfig : public ::protozero::CppMessageObj {
 public:
  ...
  bool has_slab_period_ms() const { return _has_field_[15]; }
  uint32_t slab_period_ms() const { return slab_period_ms_; }
  void set_slab_period_ms(uint32_t value) { slab_period_ms_ = value; _has_field_.set(15); }
