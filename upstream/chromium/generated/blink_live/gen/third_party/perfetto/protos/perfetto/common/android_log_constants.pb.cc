...
static const ::google::protobuf::internal::EnumEntry AndroidLogId_entries[] = {
...
const ::std::string& AndroidLogId_Name(AndroidLogId value) {
  static const bool kDummy = ::google::protobuf::internal::InitializeEnumStrings(
      AndroidLogId_entries, AndroidLogId_entries_by_number, 8,
      AndroidLogId_strings);
  (void)kDummy;

  int idx = ::google::protobuf::internal::LookUpEnumName(AndroidLogId_entries,
                                  AndroidLogId_entries_by_number,
                                  8, value);
  return idx == -1 ? ::google::protobuf::internal::GetEmptyString() : AndroidLogId_strings[idx].get();
}

bool AndroidLogId_Parse(::absl::string_view name, AndroidLogId* PROTOBUF_NONNULL value) {
  int int_value;
...
static const ::google::protobuf::internal::EnumEntry AndroidLogPriority_entries[] = {
...
const ::std::string& AndroidLogPriority_Name(AndroidLogPriority value) {
  static const bool kDummy = ::google::protobuf::internal::InitializeEnumStrings(
      AndroidLogPriority_entries, AndroidLogPriority_entries_by_number, 8,
      AndroidLogPriority_strings);
  (void)kDummy;

  int idx = ::google::protobuf::internal::LookUpEnumName(AndroidLogPriority_entries,
                                  AndroidLogPriority_entries_by_number,
                                  8, value);
  return idx == -1 ? ::google::protobuf::internal::GetEmptyString() : AndroidLogPriority_strings[idx].get();
}

bool AndroidLogPriority_Parse(::absl::string_view name, AndroidLogPriority* PROTOBUF_NONNULL value) {
  int int_value;
  bool success = ::google::protobuf::internal::LookUpEnumValue(
