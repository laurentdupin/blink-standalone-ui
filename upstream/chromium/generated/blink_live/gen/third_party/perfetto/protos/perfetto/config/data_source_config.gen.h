...
class PERFETTO_EXPORT_COMPONENT DataSourceConfig : public ::protozero::CppMessageObj {
 public:
  ...
  static constexpr auto BUFFER_EXHAUSTED_UNSPECIFIED = DataSourceConfig_BufferExhaustedPolicy_BUFFER_EXHAUSTED_UNSPECIFIED;
  static constexpr auto BUFFER_EXHAUSTED_DROP = DataSourceConfig_BufferExhaustedPolicy_BUFFER_EXHAUSTED_DROP;
  static constexpr auto BUFFER_EXHAUSTED_STALL_THEN_ABORT = DataSourceConfig_BufferExhaustedPolicy_BUFFER_EXHAUSTED_STALL_THEN_ABORT;
  static constexpr auto BUFFER_EXHAUSTED_STALL_THEN_DROP = DataSourceConfig_BufferExhaustedPolicy_BUFFER_EXHAUSTED_STALL_THEN_DROP;
  static constexpr auto BufferExhaustedPolicy_MIN = DataSourceConfig_BufferExhaustedPolicy_BUFFER_EXHAUSTED_UNSPECIFIED;
  static constexpr auto BufferExhaustedPolicy_MAX = DataSourceConfig_BufferExhaustedPolicy_BUFFER_EXHAUSTED_STALL_THEN_DROP;
  enum FieldNumbers {
    kNameFieldNumber = 1,
  ...
  bool has_target_buffer_name() const { return _has_field_[11]; }
  const std::string& target_buffer_name() const { return target_buffer_name_; }
  void set_target_buffer_name(const std::string& value) { target_buffer_name_ = value; _has_field_.set(11); }
  ...
  bool has_buffer_exhausted_policy() const { return _has_field_[9]; }
  DataSourceConfig_BufferExhaustedPolicy buffer_exhausted_policy() const { return buffer_exhausted_policy_; }
  void set_buffer_exhausted_policy(DataSourceConfig_BufferExhaustedPolicy value) { buffer_exhausted_policy_ = value; _has_field_.set(9); }

  bool has_priority_boost() const { return _has_field_[10]; }
  const PriorityBoostConfig& priority_boost() const { return *priority_boost_; }
  PriorityBoostConfig* mutable_priority_boost() { _has_field_.set(10); return priority_boost_.get(); }

  bool has_protovm_config() const { return _has_field_[12]; }
  const ProtoVmConfig& protovm_config() const { return *protovm_config_; }
  ProtoVmConfig* mutable_protovm_config() { _has_field_.set(12); return protovm_config_.get(); }
  ...
  const std::string& frozen_ftrace_config_raw() const { return frozen_ftrace_config_; }
  void set_frozen_ftrace_config_raw(const std::string& raw) { frozen_ftrace_config_ = raw; _has_field_.set(136); }
  ...
  const std::string& cpu_per_uid_config_raw() const { return cpu_per_uid_config_; }
  void set_cpu_per_uid_config_raw(const std::string& raw) { cpu_per_uid_config_ = raw; _has_field_.set(137); }

  const std::string& user_list_config_raw() const { return user_list_config_; }
  void set_user_list_config_raw(const std::string& raw) { user_list_config_ = raw; _has_field_.set(138); }

  const std::string& inputmethod_config_raw() const { return inputmethod_config_; }
  void set_inputmethod_config_raw(const std::string& raw) { inputmethod_config_ = raw; _has_field_.set(139); }

  const std::string& android_aflags_config_raw() const { return android_aflags_config_; }
  void set_android_aflags_config_raw(const std::string& raw) { android_aflags_config_ = raw; _has_field_.set(140); }

  const std::string& qnx_config_raw() const { return qnx_config_; }
  void set_qnx_config_raw(const std::string& raw) { qnx_config_ = raw; _has_field_.set(150); }
 ...
 private:
  ...
  std::string target_buffer_name_{};
  ...
  DataSourceConfig_BufferExhaustedPolicy buffer_exhausted_policy_{};
  ::protozero::CopyablePtr<PriorityBoostConfig> priority_boost_;
  ::protozero::CopyablePtr<ProtoVmConfig> protovm_config_;
  ...
  std::string frozen_ftrace_config_;  // [lazy=true]
  ...
  std::string cpu_per_uid_config_;  // [lazy=true]
  std::string user_list_config_;  // [lazy=true]
  std::string inputmethod_config_;  // [lazy=true]
  std::string android_aflags_config_;  // [lazy=true]
  std::string qnx_config_;  // [lazy=true]
