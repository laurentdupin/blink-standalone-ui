...
class PERFETTO_EXPORT_COMPONENT SystemInfo : public ::protozero::CppMessageObj {
 public:
  ...
  bool has_system_ram_bytes() const { return _has_field_[16]; }
  uint64_t system_ram_bytes() const { return system_ram_bytes_; }
  void set_system_ram_bytes(uint64_t value) { system_ram_bytes_ = value; _has_field_.set(16); }
