...
extern const ::google::protobuf::internal::ClassDataLite<27> SmapsEntry_class_data_;
class SmapsPacket;
struct SmapsPacketDefaultTypeInternal;
extern SmapsPacketDefaultTypeInternal _SmapsPacket_default_instance_;
extern const ::google::protobuf::internal::ClassDataLite<28> SmapsPacket_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
class SmapsEntry final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.SmapsEntry) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR SmapsEntry(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(SmapsEntry* PROTOBUF_NONNULL other) {
  ...
  SmapsEntry* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<SmapsEntry>(arena);
  }
...
class SmapsPacket final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.SmapsPacket) */ {
 public:
  ...
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR SmapsPacket(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(SmapsPacket* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
  ...
  SmapsPacket* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<SmapsPacket>(arena);
  }
 ...
 public:
  ...
  public:
  void clear_entries() ;
  ::perfetto::protos::SmapsEntry* PROTOBUF_NONNULL mutable_entries(int index);
  ::google::protobuf::RepeatedPtrField<::perfetto::protos::SmapsEntry>* PROTOBUF_NONNULL mutable_entries();
  ...
  const ::google::protobuf::RepeatedPtrField<::perfetto::protos::SmapsEntry>& entries() const;
