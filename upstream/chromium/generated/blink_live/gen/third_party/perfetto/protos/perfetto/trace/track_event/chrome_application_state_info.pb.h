...
extern const ::google::protobuf::internal::ClassDataLite<43> ChromeApplicationStateInfo_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
inline bool ChromeApplicationStateInfo_ChromeApplicationState_IsValid(int value) {
...
class ChromeApplicationStateInfo final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.ChromeApplicationStateInfo) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR ChromeApplicationStateInfo(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(ChromeApplicationStateInfo* PROTOBUF_NONNULL other) {
  ...
  ChromeApplicationStateInfo* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<ChromeApplicationStateInfo>(arena);
  }
 ...
 public:
  ...
  static inline bool ChromeApplicationState_Parse(
