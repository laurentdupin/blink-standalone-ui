...
extern const ::google::protobuf::internal::ClassDataLite<35> GraphicsFrameEvent_class_data_;
...
extern const ::google::protobuf::internal::ClassDataLite<47> GraphicsFrameEvent_BufferEvent_class_data_;
}  // namespace protos
}  // namespace perfetto
namespace google {
namespace protobuf {
...
inline bool GraphicsFrameEvent_BufferEventType_IsValid(int value) {
...
class GraphicsFrameEvent_BufferEvent final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.GraphicsFrameEvent.BufferEvent) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR GraphicsFrameEvent_BufferEvent(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(GraphicsFrameEvent_BufferEvent* PROTOBUF_NONNULL other) {
  ...
  GraphicsFrameEvent_BufferEvent* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<GraphicsFrameEvent_BufferEvent>(arena);
  }
...
class GraphicsFrameEvent final : public ::google::protobuf::MessageLite
/* @@protoc_insertion_point(class_definition:perfetto.protos.GraphicsFrameEvent) */ {
 public:
  ...
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR GraphicsFrameEvent(::google::protobuf::internal::ConstantInitialized);
  ...
  PROTOBUF_NOINLINE void Swap(GraphicsFrameEvent* PROTOBUF_NONNULL other) {
    if (other == this) return;
    if (::google::protobuf::internal::CanUseInternalSwap(GetArena(), other->GetArena())) {
      InternalSwap(other);
    } else {
  ...
  GraphicsFrameEvent* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
    return ::google::protobuf::MessageLite::DefaultConstruct<GraphicsFrameEvent>(arena);
  }
 ...
 public:
  ...
  static inline bool BufferEventType_Parse(
...
inline ::perfetto::protos::GraphicsFrameEvent_BufferEvent* PROTOBUF_NONNULL GraphicsFrameEvent::_internal_mutable_buffer_event() {
  ...
  if (_impl_.buffer_event_ == nullptr) {
    auto* p = ::google::protobuf::MessageLite::DefaultConstruct<::perfetto::protos::GraphicsFrameEvent_BufferEvent>(GetArena());
