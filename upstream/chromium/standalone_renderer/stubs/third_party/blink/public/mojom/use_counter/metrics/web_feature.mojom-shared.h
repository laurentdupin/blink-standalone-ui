#ifndef STANDALONE_RENDERER_STUBS_THIRD_PARTY_BLINK_PUBLIC_MOJOM_USE_COUNTER_METRICS_WEB_FEATURE_MOJOM_SHARED_H_
#define STANDALONE_RENDERER_STUBS_THIRD_PARTY_BLINK_PUBLIC_MOJOM_USE_COUNTER_METRICS_WEB_FEATURE_MOJOM_SHARED_H_
...
enum class WebFeature : int32_t {
  ...
  kReflection = 55,
  kOBSOLETE_PrefixedStorageInfo = 57,
  ...
  kOBSOLETE_CaseInsensitiveAttrSelectorMatch = 244,
  ...
  kOBSOLETE_PrefixedWindowURL = 283,
  ...
  kOBSOLETE_HTMLImportsAsyncAttribute = 463,
  kXMLHttpRequestSynchronous = 465,
  kCSSSelectorPseudoUnresolved = 466,
  kOBSOLETE_CSSSelectorPseudoShadow = 467,
  kOBSOLETE_CSSSelectorPseudoContent = 468,
  kCSSSelectorPseudoHost = 469,
  kCSSSelectorPseudoHostContext = 470,
  kOBSOLETE_CSSDeepCombinator = 471,
  kUseAsm = 473,
  kDOMWindowOpen = 475,
  ...
  kOBSOLETE_LegacyProtocolEmbeddedAsSubresource = 531,
  ...
  kClientHintsDPR_DEPRECATED = 835,
  kClientHintsResourceWidth_DEPRECATED = 836,
  kClientHintsViewportWidth_DEPRECATED = 837,
  ...
  kOBSOLETE_ExternalAddSearchProvider = 981,
  kOBSOLETE_ExternalIsSearchProviderInstalled = 982,
  ...
  kOBSOLETE_V8IntlV8Parse = 1134,
  kOBSOLETE_V8IntlPattern = 1135,
  kOBSOLETE_V8IntlResolved = 1136,
  kOBSOLETE_V8PromiseChain = 1137,
  kOBSOLETE_V8PromiseAccept = 1138,
  kOBSOLETE_V8PromiseDefer = 1139,
  kEventComposed = 1140,
  ...
  kOBSOLETE_MediaStreamConstraintsFromDictionary = 1151,
  ...
  kOBSOLETE_MixedShadowRootV0AndV1 = 1309,
  ...
  kPersistentStoragePersist = 1369,
  kPersistentStoragePersisted = 1370,
  kPersistentStorageEstimate = 1371,
  kOBSOLETE_CSSDeepCombinatorAndShadow = 1375,
  ...
  kOBSOLETE_V8ArrayProtectorDirtied = 1390,
  kV8ArraySpeciesModified = 1391,
  kV8ArrayPrototypeConstructorModified = 1392,
  kOBSOLETE_V8ArrayInstanceProtoModified = 1393,
  kV8ArrayInstanceConstructorModified = 1394,
  kOBSOLETE_V8LegacyFunctionDeclaration = 1395,
  kOBSOLETE_V8RegExpPrototypeSourceGetter = 1396,
  kOBSOLETE_V8RegExpPrototypeOldFlagGetter = 1397,
  ...
  kOBSOLETE_DocumentPointerLockElementInV0Shadow = 1423,
  ...
  kOBSOLETE_SendBeaconWithNonSimpleContentType = 1485,
  ...
  kOBSOLETE_OffscreenCanvasCommitWebGL = 1661,
  kRTCConfigurationIceTransportPolicy = 1662,
  kRTCConfigurationIceTransports = 1664,
  kOBSOLETE_DocumentFullscreenElementInV0Shadow = 1665,
  ...
  kOBSOLETE_HTMLTableCellElementColspanGreaterThan1000 = 1784,
  kOBSOLETE_HTMLTableCellElementColspanGreaterThan8190 = 1785,
  ...
  kOBSOLETE_HTMLTableElementPresentationAttributeBackground = 1869,
  ...
  kOBSOLETE_HTMLContentElement = 1896,
  kOBSOLETE_HTMLShadowElement = 1897,
  ...
  kOBSOLETE_ElementNameDOMInvalidHTMLParserValid = 1968,
  kOBSOLETE_ElementNameDOMValidHTMLParserInvalid = 1969,
  ...
  kOBSOLETE_ShapeDetection_BarcodeDetectorConstructor = 1991,
  kOBSOLETE_ShapeDetection_FaceDetectorConstructor = 1992,
  ...
  kClientHintsDeviceMemory_DEPRECATED = 2017,
  kCSSRegisterProperty = 2018,
  kRelativeOrientationSensorConstructor = 2019,
  kOBSOLETE_kSmoothScrollJSInterventionActivated = 2020,
  ...
  kOBSOLETE_V8ConstructorNonUndefinedPrimitiveReturn = 2054,
  ...
  kOBSOLETE_V8LabeledExpressionStatement = 2119,
  ...
  kOBSOLETE_DeepCombinatorInStaticProfile = 2163,
  kOBSOLETE_PseudoShadowInStaticProfile = 2164,
  ...
  kOBSOLETE_WindowEventInV0ShadowTree = 2244,
  ...
  kOBSOLETE_NegativeBackgroundSize = 2402,
  kOBSOLETE_NegativeMaskSize = 2403,
  kClientHintsRtt_DEPRECATED = 2404,
  kClientHintsDownlink_DEPRECATED = 2405,
  kClientHintsEct_DEPRECATED = 2406,
  ...
  kOBSOLETE_V8ArrayPrototypeSortJSArrayModifiedPrototype = 2437,
  ...
  kOBSOLETE_MediaStreamDestinationOnOfflineContext = 2476,
  kOBSOLETE_MediaStreamSourceOnOfflineContext = 2477,
  ...
  kOBSOLETE_ShapeDetectionAPI = 2522,
  ...
  kOBSOLETE_StringToLocaleUpperCase = 2602,
  ...
  kOBSOLETE_V8OptimizedFunctionWithOneShotBytecode = 2612,
  ...
  kOBSOLETE_DefaultInCustomIdent = 2628,
  kHTMLAnchorElementHrefTranslateAttribute = 2629,
  kWebKitUserModifyEffective = 2630,
  kPlainTextEditingEffective = 2631,
  kOBSOLETE_LegacyTLSVersionInMainFrameResource = 2634,
  kOBSOLETE_LegacyTLSVersionInSubresource = 2635,
  kOBSOLETE_LegacyTLSVersionInSubframeMainResource = 2636,
  ...
  kTrustedTypesDefaultPolicyCreated = 2724,
  ...
  kOBSOLETE_V8RTCQuicTransport_Constructor = 2740,
  kOBSOLETE_V8RTCQuicTransport_Transport_AttributeGetter = 2741,
  kOBSOLETE_V8RTCQuicTransport_State_AttributeGetter = 2742,
  kOBSOLETE_V8RTCQuicTransport_GetKey_Method = 2743,
  kOBSOLETE_V8RTCQuicTransport_GetStats_Method = 2744,
  kOBSOLETE_V8RTCQuicTransport_Connect_Method = 2745,
  kOBSOLETE_V8RTCQuicTransport_Listen_Method = 2746,
  kOBSOLETE_V8RTCQuicTransport_Stop_Method = 2747,
  kOBSOLETE_V8RTCQuicTransport_CreateStream_Method = 2748,
  ...
  kOBSOLETE_V8RTCQuicStream_Transport_AttributeGetter = 2758,
  kOBSOLETE_V8RTCQuicStream_State_AttributeGetter = 2759,
  kOBSOLETE_V8RTCQuicStream_ReadBufferedAmount_AttributeGetter = 2760,
  kOBSOLETE_V8RTCQuicStream_MaxReadBufferedAmount_AttributeGetter = 2761,
  kOBSOLETE_V8RTCQuicStream_WriteBufferedAmount_AttributeGetter = 2762,
  kOBSOLETE_V8RTCQuicStream_MaxWriteBufferedAmount_AttributeGetter = 2763,
  kOBSOLETE_V8RTCQuicStream_ReadInto_Method = 2764,
  kOBSOLETE_V8RTCQuicStream_Write_Method = 2765,
  kOBSOLETE_V8RTCQuicStream_Reset_Method = 2766,
  kOBSOLETE_V8RTCQuicStream_WaitForWriteBufferedAmountBelow_Method = 2767,
  kOBSOLETE_V8RTCQuicStream_WaitForReadable_Method = 2768,
  ...
  kOBSOLETE_U2FCryptotokenRegister = 2812,
  kOBSOLETE_U2FCryptotokenSign = 2813,
  ...
  kOBSOLETE_V8RTCQuicTransport_MaxDatagramLength_AttributeGetter = 2867,
  kOBSOLETE_V8RTCQuicTransport_ReadyToSendDatagram_Method = 2868,
  kOBSOLETE_V8RTCQuicTransport_SendDatagram_Method = 2869,
  kOBSOLETE_V8RTCQuicTransport_ReceiveDatagrams_Method = 2870,
  ...
  kPaymentRequestInitialized = 2894,
  kPaymentRequestShow = 2895,
  kPaymentRequestShippingAddressChange = 2896,
  kPaymentRequestShippingOptionChange = 2897,
  kPaymentRequestPaymentMethodChange = 2898,
  kV8Animation_UpdatePlaybackRate_Method = 2899,
  kTwoValuedOverflow = 2900,
  kTextFragmentAnchor = 2901,
  kTextFragmentAnchorMatchFound = 2902,
  ...
  kUnsizedMediaPolicy = 2918,
  kScrollByPrecisionTouchPad = 2919,
  kPinchZoom = 2920,
  kFeaturePolicyCommaSeparatedDeclarations = 2922,
  kFeaturePolicySemicolonSeparatedDeclarations = 2923,
  kV8CallSiteAPIGetFunctionSloppyCall = 2924,
  ...
  kLazyLoadFrameLoadingAttributeLazy = 2933,
  ...
  kLinkPrefetchLoadEvent = 2956,
  kLinkPrefetchErrorEvent = 2957,
  kFontSizeWebkitXxxLarge = 2958,
  kV8Database_ChangeVersion_Method = 2959,
  kV8Database_Transaction_Method = 2960,
  ...
  kContentIndexDelete = 2984,
  kContentIndexGet = 2985,
  kV8SpeechGrammar_Constructor = 2986,
  kV8SpeechGrammarList_AddFromString_Method = 2987,
  kV8SpeechGrammarList_Constructor = 2988,
  kV8SpeechGrammarList_Item_Method = 2989,
  ...
  kXMLHttpRequestSynchronousInWorker = 3003,
  kPerformanceObserverBufferedFlag = 3004,
  kWakeLockAcquireScreenLock = 3005,
  kWakeLockAcquireSystemLock = 3006,
  kThirdPartyServiceWorker = 3007,
  kJSSelfProfiling = 3008,
  kHTMLFrameSetElement = 3009,
  kFetchRedirectError = 3012,
  kFetchRedirectManual = 3013,
  kFetchCacheReload = 3014,
  kV8Window_ChooseFileSystemEntries_Method = 3015,
  kV8FileSystemDirectoryHandle_GetSystemDirectory_Method = 3016,
  ...
  kOBSOLETE_FragmentHasTildeAmpersandTilde = 3039,
  kOBSOLETE_FragmentHasColonTildeColon = 3040,
  kOBSOLETE_FragmentHasTildeAtTilde = 3041,
  kOBSOLETE_FragmentHasAmpersandDelimiterQuestion = 3042,
  ...
  kHasMarkerPseudoElement = 3066,
  kWindowMove = 3067,
  kWindowResize = 3068,
  kMovedOrResizedPopup = 3069,
  kMovedOrResizedPopup2sAfterCreation = 3070,
  kDOMWindowOpenPositioningFeatures = 3071,
  kMouseEventScreenX = 3072,
  kMouseEventScreenY = 3073,
  kCredentialManagerIsUserVerifyingPlatformAuthenticatorAvailable = 3074,
  kObsoleteWebrtcTlsVersion = 3075,
  kUpgradeInsecureRequestsUpgradedRequestBlockable = 3076,
  kUpgradeInsecureRequestsUpgradedRequestOptionallyBlockable = 3077,
  kUpgradeInsecureRequestsUpgradedRequestWebsocket = 3078,
  kUpgradeInsecureRequestsUpgradedRequestForm = 3079,
  kUpgradeInsecureRequestsUpgradedRequestUnknown = 3080,
  ...
  kV8VideoPlaybackQuality_CorruptedVideoFrames_AttributeGetter = 3117,
  ...
  kOBSOLETE_WebNfcAPI = 3127,
  kHostCandidateAttributeGetter = 3128,
  kCSPWithReasonableObjectRestrictions = 3129,
  kCSPWithReasonableBaseRestrictions = 3130,
  kCSPWithReasonableScriptRestrictions = 3131,
  kCSPWithReasonableRestrictions = 3132,
  kCSPROWithReasonableObjectRestrictions = 3133,
  kCSPROWithReasonableBaseRestrictions = 3134,
  kCSPROWithReasonableScriptRestrictions = 3135,
  ...
  kV8Animation_CommitStyles_Method = 3150,
  ...
  kLargeStickyAd = 3155,
  kCSSComparisonFunctions = 3157,
  kOBSOLETE_FeaturePolicyProposalWouldChangeBehaviour = 3158,
  ...
  kXRDOMOverlay = 3168,
  kOBSOLETE_CssStyleSheetReplaceWithImport = 3169,
  kCryptoAlgorithmEd25519 = 3170,
  kCryptoAlgorithmX25519 = 3171,
  kDisplayNames = 3172,
  ...
  kOBSOLETE_V8RTCRtpSender_CreateEncodedAudioStreams_Method = 3180,
  kOBSOLETE_V8RTCRtpSender_CreateEncodedVideoStreams_Method = 3181,
  kOBSOLETE_V8RTCRtpReceiver_CreateEncodedAudioStreams_Method = 3182,
  kOBSOLETE_V8RTCRtpReceiver_CreateEncodedVideoStreams_Method = 3183,
  kQuicTransport = 3184,
  ...
  kClientHintsUAFullVersion = 3189,
  kOBSOLETE_SchedulerCurrentTaskSignal = 3190,
  kThirdPartyFileSystem = 3191,
  kThirdPartyIndexedDb = 3192,
  ...
  kDocumentPolicyIframePolicyAttribute = 3228,
  kDocumentPolicyCausedPageUnload = 3229,
  kRequiredDocumentPolicy = 3230,
  kPerformanceObserverEntryTypesAndBuffered = 3231,
  kPerformanceObserverTypeError = 3232,
  ...
  kXRFrameCreateAnchor = 3250,
  kXRHitTestResultCreateAnchor = 3251,
  kCSSKeywordRevert = 3252,
  kOverlayPopupAd = 3253,
  kEventTimingFirstInputExplicitlyRequested = 3254,
  kCustomScrollbarPercentThickness = 3255,
  kCustomScrollbarPartPercentLength = 3256,
  kV8InvalidatedArrayBufferDetachingProtector = 3257,
  kV8InvalidatedArrayConstructorProtector = 3258,
  kV8InvalidatedArrayIteratorLookupChainProtector = 3259,
  kV8InvalidatedArraySpeciesLookupChainProtector = 3260,
  kV8InvalidatedIsConcatSpreadableLookupChainProtector = 3261,
  kV8InvalidatedMapIteratorLookupChainProtector = 3262,
  kV8InvalidatedNoElementsProtector = 3263,
  kV8InvalidatedPromiseHookProtector = 3264,
  kV8InvalidatedPromiseResolveLookupChainProtector = 3265,
  kV8InvalidatedPromiseSpeciesLookupChainProtector = 3266,
  kV8InvalidatedPromiseThenLookupChainProtector = 3267,
  kV8InvalidatedRegExpSpeciesLookupChainProtector = 3268,
  kV8InvalidatedSetIteratorLookupChainProtector = 3269,
  kV8InvalidatedStringIteratorLookupChainProtector = 3270,
  kV8InvalidatedStringLengthOverflowLookupChainProtector = 3271,
  kV8InvalidatedTypedArraySpeciesLookupChainProtector = 3272,
  kClientHintsUAPlatformVersion = 3273,
  kIFrameCSPAttribute = 3274,
  kNavigatorCookieEnabled = 3275,
  kTrustTokenFetch = 3276,
  kTrustTokenXhr = 3277,
  kTrustTokenIframe = 3278,
  ...
  kOriginAgentClusterHeader = 3286,
  kV8WasmSimdOpcodes = 3287,
  kGridRowGapPercent = 3288,
  kGridRowGapPercentIndefinite = 3289,
  kFlexRowGapPercent = 3290,
  ...
  kWebBluetoothRemoteCharacteristicWriteValueWithResponse = 3305,
  ...
  kOBSOLETE_V8WasmBulkMemory = 3320,
  kV8WasmRefTypes = 3321,
  kOBSOLETE_V8WasmMultiValue = 3322,
  ...
  kOBSOLETE_MainFrameCSPViaOriginPolicy = 3361,
  kHtmlClipboardApiRead = 3362,
  kHtmlClipboardApiWrite = 3363,
  kOBSOLETE_CSSSystemColorComputeToSelf = 3364,
  kAttributionReportingAPIAll = 3365,
  kOBSOLETE_ImpressionRegistration = 3366,
  kOBSOLETE_ConversionRegistration = 3367,
  ...
  kOBSOLETE_UserDataFieldFilled_PredictedTypeMatch = 3379,
  kOBSOLETE_EmailFieldFilled_PredictedTypeMatch = 3380,
  kOBSOLETE_PhoneFieldFilled_PredictedTypeMatch = 3381,
  kOBSOLETE_EmailFieldFilled_PatternMatch = 3382,
  kOBSOLETE_LastLetterSpacingAffectsRendering = 3383,
  kV8FontData_GetTables_Method = 3384,
  kV8FontData_Blob_Method = 3385,
  kOBSOLETE_V8FontManager_Query_Method = 3386,
  kAudioContextBaseLatency = 3387,
  kV8Window_GetScreenDetails_Method = 3388,
  ...
  kOBSOLETE_GPUAdapter_Name = 3405,
  ...
  kV8AuthenticatorAttestationResponse_GetTransports_Method = 3455,
  ...
  kWebCodecs = 3464,
  kCredentialManagerCrossOriginPublicKeyGetRequest = 3465,
  kCSSContainStrictWithoutContentVisibility = 3466,
  kCSSContainAllWithoutContentVisibility = 3467,
  kTimerInstallFromBeforeUnload = 3468,
  kTimerInstallFromUnload = 3469,
  kOBSOLETE_ElementAttachInternalsBeforeConstructor = 3470,
  ...
  kIdentifiabilityStudyReserved3480 = 3480,
  kV8Navigator_JavaEnabled_Method = 3481,
  kIdentifiabilityStudyReserved3482 = 3482,
  kIdentifiabilityStudyReserved3483 = 3483,
  kIdentifiabilityStudyReserved3484 = 3484,
  kIdentifiabilityStudyReserved3485 = 3485,
  kIdentifiabilityStudyReserved3486 = 3486,
  kIdentifiabilityStudyReserved3487 = 3487,
  kIdentifiabilityStudyReserved3488 = 3488,
  kIdentifiabilityStudyReserved3489 = 3489,
  kIdentifiabilityStudyReserved3490 = 3490,
  kIdentifiabilityStudyReserved3491 = 3491,
  kIdentifiabilityStudyReserved3492 = 3492,
  kIdentifiabilityStudyReserved3493 = 3493,
  kIdentifiabilityStudyReserved3494 = 3494,
  kIdentifiabilityStudyReserved3495 = 3495,
  ...
  kIdentifiabilityStudyReserved3514 = 3514,
  kIdentifiabilityStudyReserved3515 = 3515,
  kIdentifiabilityStudyReserved3516 = 3516,
  kIdentifiabilityStudyReserved3517 = 3517,
  kIdentifiabilityStudyReserved3518 = 3518,
  kIdentifiabilityStudyReserved3519 = 3519,
  kIdentifiabilityStudyReserved3520 = 3520,
  kIdentifiabilityStudyReserved3521 = 3521,
  kIdentifiabilityStudyReserved3522 = 3522,
  kIdentifiabilityStudyReserved3523 = 3523,
  kIdentifiabilityStudyReserved3524 = 3524,
  kIdentifiabilityStudyReserved3525 = 3525,
  kIdentifiabilityStudyReserved3526 = 3526,
  kIdentifiabilityStudyReserved3527 = 3527,
  kIdentifiabilityStudyReserved3528 = 3528,
  kIdentifiabilityStudyReserved3529 = 3529,
  kIdentifiabilityStudyReserved3530 = 3530,
  kIdentifiabilityStudyReserved3531 = 3531,
  kIdentifiabilityStudyReserved3532 = 3532,
  kIdentifiabilityStudyReserved3533 = 3533,
  kIdentifiabilityStudyReserved3534 = 3534,
  kIdentifiabilityStudyReserved3535 = 3535,
  kIdentifiabilityStudyReserved3536 = 3536,
  kIdentifiabilityStudyReserved3537 = 3537,
  kIdentifiabilityStudyReserved3538 = 3538,
  kIdentifiabilityStudyReserved3539 = 3539,
  kIdentifiabilityStudyReserved3540 = 3540,
  kV8WheelEvent_DeltaMode_AttributeGetter = 3541,
  kV8Touch_Force_AttributeGetter = 3542,
  kWebGLRenderingContextMakeXRCompatible = 3543,
  kV8WebGLCompressedTextureASTC_GetSupportedProfiles_Method = 3544,
  kHTMLCanvasGetContext = 3545,
  ...
  kWebGL2RenderingContextGetInternalFormatParameter = 3571,
  kIdentifiabilityStudyReserved3572 = 3572,
  kIdentifiabilityStudyReserved3573 = 3573,
  kIdentifiabilityStudyReserved3574 = 3574,
  ...
  kIdentifiabilityMediaDevicesEnumerateDevices = 3582,
  kIdentifiabilityStudyReserved3583 = 3583,
  kIdentifiabilityStudyReserved3584 = 3584,
  kIdentifiabilityStudyReserved3585 = 3585,
  kIdentifiabilityStudyReserved3586 = 3586,
  kIdentifiabilityStudyReserved3587 = 3587,
  kIdentifiabilityStudyReserved3588 = 3588,
  kIdentifiabilityStudyReserved3589 = 3589,
  kIdentifiabilityStudyReserved3590 = 3590,
  kIdentifiabilityStudyReserved3591 = 3591,
  kIdentifiabilityStudyReserved3592 = 3592,
  kIdentifiabilityStudyReserved3593 = 3593,
  kIdentifiabilityStudyReserved3594 = 3594,
  kIdentifiabilityStudyReserved3595 = 3595,
  kIdentifiabilityStudyReserved3596 = 3596,
  kIdentifiabilityStudyReserved3597 = 3597,
  kIdentifiabilityStudyReserved3598 = 3598,
  kIdentifiabilityStudyReserved3599 = 3599,
  kIdentifiabilityStudyReserved3600 = 3600,
  kIdentifiabilityStudyReserved3601 = 3601,
  kIdentifiabilityStudyReserved3602 = 3602,
  kIdentifiabilityStudyReserved3603 = 3603,
  kIdentifiabilityStudyReserved3604 = 3604,
  kIdentifiabilityStudyReserved3605 = 3605,
  kIdentifiabilityStudyReserved3606 = 3606,
  ...
  kIdentifiabilityStudyReserved3614 = 3614,
  kIdentifiabilityStudyReserved3615 = 3615,
  kIdentifiabilityStudyReserved3616 = 3616,
  kIdentifiabilityStudyReserved3617 = 3617,
  kIdentifiabilityStudyReserved3618 = 3618,
  kIdentifiabilityStudyReserved3619 = 3619,
  kIdentifiabilityStudyReserved3620 = 3620,
  kIdentifiabilityStudyReserved3621 = 3621,
  kIdentifiabilityStudyReserved3622 = 3622,
  kIdentifiabilityStudyReserved3623 = 3623,
  kIdentifiabilityStudyReserved3624 = 3624,
  kIdentifiabilityStudyReserved3625 = 3625,
  kIdentifiabilityStudyReserved3626 = 3626,
  kIdentifiabilityStudyReserved3627 = 3627,
  kIdentifiabilityStudyReserved3628 = 3628,
  kIdentifiabilityStudyReserved3629 = 3629,
  kIdentifiabilityStudyReserved3630 = 3630,
  kIdentifiabilityStudyReserved3631 = 3631,
  kIdentifiabilityStudyReserved3632 = 3632,
  kIdentifiabilityStudyReserved3633 = 3633,
  kIdentifiabilityStudyReserved3634 = 3634,
  kIdentifiabilityStudyReserved3635 = 3635,
  kIdentifiabilityStudyReserved3636 = 3636,
  kIdentifiabilityStudyReserved3637 = 3637,
  kIdentifiabilityStudyReserved3638 = 3638,
  kIdentifiabilityStudyReserved3639 = 3639,
  kIdentifiabilityStudyReserved3640 = 3640,
  kIdentifiabilityStudyReserved3641 = 3641,
  kIdentifiabilityStudyReserved3642 = 3642,
  kIdentifiabilityStudyReserved3643 = 3643,
  kIdentifiabilityStudyReserved3644 = 3644,
  kIdentifiabilityStudyReserved3645 = 3645,
  kIdentifiabilityStudyReserved3646 = 3646,
  kIdentifiabilityStudyReserved3647 = 3647,
  kIdentifiabilityStudyReserved3648 = 3648,
  kIdentifiabilityStudyReserved3649 = 3649,
  kIdentifiabilityStudyReserved3650 = 3650,
  kIdentifiabilityStudyReserved3651 = 3651,
  kIdentifiabilityStudyReserved3652 = 3652,
  kIdentifiabilityStudyReserved3653 = 3653,
  kIdentifiabilityStudyReserved3654 = 3654,
  kIdentifiabilityStudyReserved3655 = 3655,
  kIdentifiabilityStudyReserved3656 = 3656,
  kIdentifiabilityStudyReserved3657 = 3657,
  kIdentifiabilityStudyReserved3658 = 3658,
  kIdentifiabilityStudyReserved3659 = 3659,
  kIdentifiabilityStudyReserved3660 = 3660,
  kIdentifiabilityStudyReserved3661 = 3661,
  kIdentifiabilityStudyReserved3662 = 3662,
  kIdentifiabilityStudyReserved3663 = 3663,
  kIdentifiabilityStudyReserved3664 = 3664,
  kIdentifiabilityStudyReserved3665 = 3665,
  kIdentifiabilityStudyReserved3666 = 3666,
  kIdentifiabilityStudyReserved3667 = 3667,
  kIdentifiabilityStudyReserved3668 = 3668,
  kIdentifiabilityStudyReserved3669 = 3669,
  kIdentifiabilityStudyReserved3670 = 3670,
  kIdentifiabilityStudyReserved3671 = 3671,
  kIdentifiabilityStudyReserved3672 = 3672,
  kIdentifiabilityStudyReserved3673 = 3673,
  kIdentifiabilityStudyReserved3674 = 3674,
  kIdentifiabilityStudyReserved3675 = 3675,
  kIdentifiabilityStudyReserved3676 = 3676,
  kIdentifiabilityStudyReserved3677 = 3677,
  kIdentifiabilityStudyReserved3678 = 3678,
  ...
  kOBSOLETE_AddressSpaceLocalEmbeddedInPublicNonSecureContext = 3691,
  kOBSOLETE_AddressSpaceLocalEmbeddedInUnknownSecureContext = 3692,
  kOBSOLETE_AddressSpaceLocalEmbeddedInUnknownNonSecureContext = 3693,
  kOBSOLETE_AddressSpacePrivateEmbeddedInPublicSecureContext = 3694,
  kOBSOLETE_AddressSpacePrivateEmbeddedInPublicNonSecureContext = 3695,
  kOBSOLETE_AddressSpacePrivateEmbeddedInUnknownSecureContext = 3696,
  kOBSOLETE_AddressSpacePrivateEmbeddedInUnknownNonSecureContext = 3697,
  ...
  kOBSOLETE_PopoverAttribute = 3781,
  ...
  kCreateJSONModuleScript = 3804,
  kCreateCSSModuleScript = 3805,
  kInsertHTMLCommandOnInput = 3806,
  kInsertHTMLCommandOnTextarea = 3807,
  ...
  kSanitizerAPIFromDocument = 3820,
  kSanitizerAPIFromFragment = 3821,
  kOBSOLETE_StorageFoundationOpen = 3822,
  kOBSOLETE_StorageFoundationRead = 3823,
  kOBSOLETE_StorageFoundationReadSync = 3824,
  kOBSOLETE_StorageFoundationWrite = 3825,
  kOBSOLETE_StorageFoundationWriteSync = 3826,
  kOBSOLETE_StorageFoundationFlush = 3827,
  kOBSOLETE_StorageFoundationFlushSync = 3828,
  kUnrestrictedSharedArrayBuffer = 3829,
  kFeaturePolicyJSAPIAllowsFeatureIFrame = 3830,
  kFeaturePolicyJSAPIAllowsFeatureDocument = 3831,
  kFeaturePolicyJSAPIAllowsFeatureOriginIFrame = 3832,
  kFeaturePolicyJSAPIAllowsFeatureOriginDocument = 3833,
  kFeaturePolicyJSAPIAllowedFeaturesIFrame = 3834,
  kFeaturePolicyJSAPIAllowedFeaturesDocument = 3835,
  kFeaturePolicyJSAPIFeaturesIFrame = 3836,
  kFeaturePolicyJSAPIFeaturesDocument = 3837,
  kFeaturePolicyJSAPIGetAllowlistIFrame = 3838,
  kFeaturePolicyJSAPIGetAllowlistDocument = 3839,
  kOBSOLETE_V8Screens_Onchange_AttributeGetter = 3840,
  kOBSOLETE_V8Screens_Onchange_AttributeSetter = 3841,
  kV8ScreenDetailed_Left_AttributeGetter = 3842,
  kV8ScreenDetailed_Top_AttributeGetter = 3843,
  kV8ScreenDetailed_IsPrimary_AttributeGetter = 3844,
  kV8ScreenDetailed_IsInternal_AttributeGetter = 3845,
  kV8ScreenDetailed_DevicePixelRatio_AttributeGetter = 3846,
  kV8ScreenDetailed_Id_AttributeGetter = 3847,
  ...
  kV8Navigator_JoinAdInterestGroup_Method = 3855,
  kV8Navigator_LeaveAdInterestGroup_Method = 3856,
  kV8Navigator_RunAdAuction_Method = 3857,
  kXHRJSONEncodingDetection = 3858,
  kWorkerControlledByServiceWorkerOutOfScope = 3859,
  kXRPlaneDetection = 3860,
  kXRFrameDetectedPlanes = 3861,
  kXRImageTracking = 3862,
  kXRSessionGetTrackedImageScores = 3863,
  kXRFrameGetImageTrackingResults = 3864,
  kOBSOLETE_OpenWebDatabaseThirdPartyContext = 3865,
  kPointerId = 3866,
  kTransform3dScene = 3867,
  kPrefersColorSchemeMediaFeature = 3868,
  kPrefersContrastMediaFeature = 3869,
  kForcedColorsMediaFeature = 3870,
  ...
  kOBSOLETE_NewCanvas2DAPI = 3886,
  kOBSOLETE_ServiceWorkerSubresourceFilterBypassedRequest = 3887,
  kWebGPURequestAdapter = 3888,
  ...
  kOBSOLETE_HandwritingRecognitionQuerySupport = 3893,
  ...
  kPressureObserver_Constructor = 3899,
  kPressureObserver_Observe = 3900,
  kOBSOLETE_ComputePressureObserver_Stop = 3901,
  ...
  kV8ScreenDetails_Onscreenschange_AttributeGetter = 3905,
  kV8ScreenDetails_Onscreenschange_AttributeSetter = 3906,
  kV8ScreenDetails_Oncurrentscreenchange_AttributeGetter = 3907,
  kV8ScreenDetails_Oncurrentscreenchange_AttributeSetter = 3908,
  ...
  kOBSOLETE_kARIATouchpassthroughAttribute = 3918,
  kARIAVirtualcontentAttribute = 3919,
  kOBSOLETE_kAccessibilityTouchPassthroughSet = 3920,
  kTextFragmentBlockedByForceLoadAtTop = 3921,
  kOBSOLETE_UrnDocumentAccessedCookies = 3922,
  kFontFaceAscentOverride = 3923,
  ...
  kOBSOLETE_ClientHintsUAReduced = 3968,
  ...
  kClientHintsViewportHeight = 3976,
  kV8NavigatorManagedData_GetDirectoryId_Method = 3977,
  kV8NavigatorManagedData_GetHostname_Method = 3978,
  kV8NavigatorManagedData_GetSerialNumber_Method = 3979,
  kV8NavigatorManagedData_GetAnnotatedAssetId_Method = 3980,
  kV8NavigatorManagedData_GetAnnotatedLocation_Method = 3981,
  kOBSOLETE_UserDataFieldFilledPreviously = 3982,
  kTableCollapsedBorderDifferentToVisual = 3983,
  kHighlightAPIRegisterHighlight = 3984,
  kOBSOLETE_ReadOrWriteWebDatabaseThirdPartyContext = 3985,
  kOBSOLETE_FontSelectorCSSFontFamilyWebKitPrefixPictograph = 3986,
  kOBSOLETE_FontSelectorCSSFontFamilyWebKitPrefixStandard = 3987,
  kFontSelectorCSSFontFamilyWebKitPrefixBody = 3988,
  kFontBuilderCSSFontFamilyWebKitPrefixBody = 3989,
  kCapabilityDelegationOfPaymentRequest = 3990,
  kCredentialManagerGetLegacyFederatedCredential = 3992,
  kCredentialManagerGetPasswordCredential = 3993,
  kCredentialManagerStoreFederatedCredential = 3994,
  kCredentialManagerStorePasswordCredential = 3995,
  kCredentialManagerCreateFederatedCredential = 3996,
  kCredentialManagerCreatePasswordCredential = 3997,
  kCanvasRenderingContext2DRoundRect = 3998,
  kNewLayoutOverflowDifferentBlockWithNonEmptyInflowBounds = 3999,
  kCanvasRenderingContext2DReset = 4000,
  kCanvasRenderingContext2DLetterSpacing = 4001,
  kCanvasRenderingContext2DWordSpacing = 4002,
  kCanvasRenderingContext2DFontVariantCaps = 4003,
  kCanvasRenderingContext2DFontKerning = 4004,
  kCanvasRenderingContext2DFontStretch = 4005,
  kCanvasRenderingContext2DTextRendering = 4006,
  ...
  kV8FileSystemSyncAccessHandle_Read_Method = 4014,
  kV8FileSystemSyncAccessHandle_Write_Method = 4015,
  kV8FileSystemSyncAccessHandle_Close_Method = 4016,
  kV8FileSystemSyncAccessHandle_Flush_Method = 4017,
  kV8FileSystemSyncAccessHandle_GetSize_Method = 4018,
  kV8FileSystemSyncAccessHandle_Truncate_Method = 4019,
  kV8SharedArrayBufferConstructedInExtensionWithoutIsolation = 4020,
  kMediaSourceExtensionsForWebCodecs = 4021,
  kPaymentRequestResponse = 4023,
  kPaymentRequestComplete = 4024,
  kHTMLCanvasElement_2D = 4025,
  kHTMLCanvasElement_WebGL = 4026,
  kHTMLCanvasElement_WebGL2 = 4027,
  kHTMLCanvasElement_BitmapRenderer = 4028,
  kHTMLCanvasElement_WebGPU = 4029,
  kOffscreenCanvas_2D = 4030,
  kOffscreenCanvas_WebGL = 4031,
  kOffscreenCanvas_WebGL2 = 4032,
  kOffscreenCanvas_BitmapRenderer = 4033,
  kOffscreenCanvas_WebGPU = 4034,
  kCanvasRenderingContext2DHasOverdraw = 4035,
  kDigitalGoodsConsume = 4036,
  kDigitalGoodsListPurchaseHistory = 4037,
  kWebShareContainingFiles = 4038,
  ...
  kCSSTransitionBlockedByAnimation = 4066,
  kWebAppManifestHasComments = 4067,
  kAutoExpandedDetailsForFindInPage = 4068,
  kAutoExpandedDetailsForScrollToTextFragment = 4069,
  kOBSOLETE_WebCodecsVideoFrameDefaultTimestamp = 4070,
  kWebCodecsVideoFrameFromImage = 4071,
  kWebCodecsVideoFrameFromBuffer = 4072,
  kOBSOLETE_OpenWebDatabaseInsecureContext = 4073,
  ...
  kOBSOLETE_ClientHintsMetaNameAcceptCH = 4081,
  kOBSOLETE_CSSMatchMediaUnknown = 4082,
  kOBSOLETE_CSSMediaListUnknown = 4083,
  kOBSOLETE_CSSOMMediaConditionUnknown = 4084,
  kDocumentDomainSettingWithoutOriginAgentClusterHeader = 4085,
  kCrossOriginEmbedderPolicyCredentiallessReportOnly = 4086,
  kCrossOriginEmbedderPolicyRequireCorpReportOnly = 4087,
  kCoopAndCoepIsolatedReportOnly = 4088,
  ...
  kWindowProxyCrossOriginAccessBlur = 4115,
  kWindowProxyCrossOriginAccessClose = 4116,
  kWindowProxyCrossOriginAccessClosed = 4117,
  kWindowProxyCrossOriginAccessFocus = 4118,
  kWindowProxyCrossOriginAccessFrames = 4119,
  kWindowProxyCrossOriginAccessIndexedGetter = 4120,
  kWindowProxyCrossOriginAccessLength = 4121,
  kWindowProxyCrossOriginAccessLocation = 4122,
  kWindowProxyCrossOriginAccessNamedGetter = 4123,
  kWindowProxyCrossOriginAccessOpener = 4124,
  kWindowProxyCrossOriginAccessParent = 4125,
  kWindowProxyCrossOriginAccessPostMessage = 4126,
  kWindowProxyCrossOriginAccessSelf = 4127,
  kWindowProxyCrossOriginAccessTop = 4128,
  kWindowProxyCrossOriginAccessWindow = 4129,
  kWindowProxyCrossOriginAccessFromOtherPageBlur = 4130,
  kWindowProxyCrossOriginAccessFromOtherPageClose = 4131,
  kWindowProxyCrossOriginAccessFromOtherPageClosed = 4132,
  kWindowProxyCrossOriginAccessFromOtherPageFocus = 4133,
  kWindowProxyCrossOriginAccessFromOtherPageFrames = 4134,
  kWindowProxyCrossOriginAccessFromOtherPageIndexedGetter = 4135,
  kWindowProxyCrossOriginAccessFromOtherPageLength = 4136,
  kWindowProxyCrossOriginAccessFromOtherPageLocation = 4137,
  kWindowProxyCrossOriginAccessFromOtherPageNamedGetter = 4138,
  kWindowProxyCrossOriginAccessFromOtherPageOpener = 4139,
  kWindowProxyCrossOriginAccessFromOtherPageParent = 4140,
  kWindowProxyCrossOriginAccessFromOtherPagePostMessage = 4141,
  kWindowProxyCrossOriginAccessFromOtherPageSelf = 4142,
  ...
  kOBSOLETE_ClientHintsPartitionedCookies = 4160,
  ...
  kCSSAtRuleFontPaletteValues = 4164,
  kCSSAtRuleContainer = 4165,
  kFedCm = 4166,
  kFetchEventSourceLastEventIdCorsUnSafe = 4167,
  kWrongBaselineOfMultiLineButtonWithNonSpace = 4168,
  ...
  kBlockingAttributeRenderToken = 4183,
  kPressureObserver_Unobserve = 4184,
  kPressureObserver_Disconnect = 4185,
  kPressureObserver_TakeRecords = 4186,
  kPrivacySandboxAdsAPIs = 4187,
  kFledge = 4188,
  kElementShowPopover = 4189,
  kElementHidePopover = 4190,
  kOBSOLETE_ValidPopoverAttribute = 4191,
  kDeprecationExample = 4192,
  kRTCLocalSdpModificationOpusStereo = 4193,
  ...
  kOBSOLETE_LegacyConstraintGoogIPv6 = 4207,
  ...
  kV8PaymentInstruments_Delete_Method = 4231,
  kV8PaymentInstruments_Get_Method = 4232,
  ...
  kFlexboxNewAbsPos = 4237,
  kScriptSchedulingType_Defer = 4238,
  kScriptSchedulingType_ParserBlocking = 4239,
  kScriptSchedulingType_ParserBlockingInline = 4240,
  ...
  kOBSOLETE_AnyPopoverAttribute = 4258,
  ...
  kSharedStorageAPI_SharedStorage_DOMReference = 4263,
  kSharedStorageAPI_AddModule_Method = 4264,
  kSharedStorageAPI_Set_Method = 4265,
  kSharedStorageAPI_Append_Method = 4266,
  kSharedStorageAPI_Delete_Method = 4267,
  kSharedStorageAPI_Clear_Method = 4268,
  ...
  kOBSOLETE_PrivateNetworkAccessPermissionPrompt = 4293,
  ...
  kOBSOLETE_kNavigateEventRestoreScroll = 4304,
  kSendBeaconWithArrayBuffer = 4305,
  kSendBeaconWithArrayBufferView = 4306,
  kSendBeaconWithBlob = 4307,
  ...
  kStorageAccessAPI_requestStorageAccessFor_Method = 4332,
  ...
  kInteractiveWidgetResizesContent = 4367,
  kInteractiveWidgetResizesVisual = 4368,
  kSerivceWorkerFallbackMainResource = 4369,
  kOBSOLETE_GetDisplayMediaWithoutUserActivation = 4370,
  kBackForwardCacheNotRestoredReasons = 4371,
  kCSSNesting = 4372,
  kSandboxIneffectiveAllowOriginAllowScript = 4373,
  kDocumentOpenDifferentWindow = 4374,
  kDocumentOpenMutateSandbox = 4375,
  ...
  kCSSValueAppearanceMediaSliderRendered = 4388,
  kCSSValueAppearanceMediaSliderThumbRendered = 4389,
  kCSSValueAppearanceMediaVolumeSliderRendered = 4390,
  kCSSValueAppearanceMediaVolumeSliderThumbRendered = 4391,
  kV8PerformanceResourceTiming_DeliveryType_AttributeGetter = 4392,
  kDocumentLoaderDeliveryTypeNavigationalPrefetch = 4393,
  kSpeculationRulesHeader = 4394,
  kSpeculationRulesDocumentRules = 4395,
  kFedCmIframe = 4396,
  kV8DocumentPictureInPicture_RequestWindow_Method = 4397,
  ...
  kOBSOLETE_DialogCloseWatcherCancelSkipped = 4422,
  kOBSOLETE_DialogCloseWatcherCancelSkippedAndDefaultPrevented = 4423,
  kOBSOLETE_DialogCloseWatcherCloseSignalClosedMultiple = 4424,
  kNoVarySearch = 4425,
  kFedCmUserInfo = 4426,
  ...
  kOBSOLETE_DisableThirdPartySessionStoragePartitioningAfterGeneralPartitioning,
  ...
  kOBSOLETE_WebGPUWebCodecs = 4481,
  ...
  kAttributionFencedFrameReportingBeacon = 4496,
  kIframeBrowsingTopicsAttribute = 4497,
  kSpeculationRulesSelectorMatches = 4498,
  kSpeculationRulesExplicitEagerness = 4499,
  kSpeculationRulesEagernessConservative = 4500,
  kSpeculationRulesEagernessModerate = 4501,
  kSpeculationRulesEagernessImmediate = 4502,
  ...
  kV8StorageBucket_Persist_Method = 4508,
  kV8StorageBucket_Persisted_Method = 4509,
  kV8StorageBucket_Estimate_Method = 4510,
  kV8StorageBucket_Durability_Method = 4511,
  kV8StorageBucket_SetExpires_Method = 4512,
  kV8StorageBucket_Expires_Method = 4513,
  kV8StorageBucket_IndexedDB_AttributeGetter = 4514,
  kV8StorageBucket_Locks_AttributeGetter = 4515,
  kV8StorageBucket_Caches_AttributeGetter = 4516,
  kV8StorageBucket_GetDirectory_Method = 4517,
  ...
  kGamepadTouchEvents = 4536,
  kGamepadTouchTouchId = 4537,
  kGamepadTouchSurfaceId = 4538,
  kGamepadTouchPosition = 4539,
  kGamepadTouchSurfaceDimension = 4540,
  kSandboxViaFencedFrame = 4541,
  kVisibilityStateObserver = 4542,
  kV8CompileHintsMagicAll = 4543,
  kOBSOLETE_TextWrapBalance = 4544,
  ...
  kCSSStyleContainerQuery = 4550,
  kCSSValueAppearanceMediaSlider = 4551,
  kCSSValueAppearanceMediaSliderthumb = 4552,
  kCSSValueAppearanceMediaVolumeSlider = 4553,
  kCSSValueAppearanceMediaVolumeSliderthumb = 4554,
  kCSSValueAppearanceSliderHorizontal = 4555,
  ...
  kOBSOLETE_ServiceWorkerBypassFetchHandlerForAllWithRaceNetworkRequestByOriginTrial,
  kOBSOLETE_EventTimingPaintedPresentationPromiseResolvedWithEarlierPromiseUnresolved,
  ...
  kOBSOLETE_GetCoalescedEventsInInsecureContext = 4598,
  kCSPEESameOriginBlanketEnforcement = 4599,
  kSharedDictionaryUsed = 4601,
  kSharedDictionaryUsedForNavigation = 4602,
  kSharedDictionaryUsedForMainFrameNavigation = 4603,
  kSharedDictionaryUsedForSubFrameNavigation = 4604,
  kSharedDictionaryUsedForSubresource = 4605,
  kPriceChangeConfirmation = 4606,
  ...
  kGetAllScreensMedia = 4630,
  kInputEventToRecentlyMovedIframeMistakenlyDiscarded = 4631,
  kCSSRelativeColor = 4632,
  kXPathMissingVariableParsed = 4633,
  kXPathMissingVariableEvaluated = 4634,
  kClientHintsPrefersReducedTransparency = 4635,
  kElementCapture = 4636,
  kSharedStorageAPI_Fetch_Attribute = 4637,
  kSharedStorageAPI_Image_Attribute = 4638,
  kSharedStorageAPI_Iframe_Attribute = 4639,
  kVirtualKeyboardShow = 4640,
  kVirtualKeyboardHide = 4641,
  kVirtualKeyboardOverlayPolicy = 4642,
  kScrollSnapNestedSnapAreas = 4643,
  kScrollSnapCoveringSnapArea = 4644,
  ...
  kPrivateAggregationApiEnableDebugMode = 4656,
  ...
  kOutOfFlowJustifySelfNoInsets = 4665,
  kOutOfFlowJustifySelfSingleInset = 4666,
  kOutOfFlowJustifySelfBothInsets = 4667,
  ...
  kObservableConstructor = 4672,
  kTextWrapBalance = 4673,
  ...
  kHTMLDetailsElementNameAttributeClosesOther = 4679,
  kCSSSubgridLayout = 4680,
  kV8TemporalObject = 4681,
  kChromeCSIUnknown = 4682,
  kChromeCSIOnloadT = 4683,
  kChromeCSIPageT = 4684,
  kChromeCSIStartE = 4685,
  kChromeCSITran = 4686,
  kParseHTMLUnsafe = 4687,
  kSetHTMLUnsafe = 4688,
  ...
  kOBSOLETE_MouseDragOnCancelledMouseMove = 4754,
  ...
  kWebAppTitle = 4884,
  kOBSOLETE_DOMSubtreeModifiedEventFired = 4885,
  kOBSOLETE_DOMNodeInsertedEventFired = 4886,
  kOBSOLETE_DOMNodeRemovedEventFired = 4887,
  kOBSOLETE_DOMNodeRemovedFromDocumentEventFired = 4888,
  kOBSOLETE_DOMNodeInsertedIntoDocumentEventFired = 4889,
  kOBSOLETE_DOMCharacterDataModifiedEventFired = 4890,
  ...
  kOBSOLETE_SkippedPreloadScanning = 4929,
  ...
  kOBSOLETE_SimplifyLoadingTransparentPlaceholderImage = 4941,
  ...
  kOBSOLETE_InsideListMarkerPositionQuirk = 5000,
  ...
  kOBSOLETE_V8MLContext_Compute_Method = 5024,
  ...
  kOBSOLETE_V8GPUSupportedLimits_MaxInterStageShaderComponents_AttributeGetter,
  ...
  kOBSOLETE_HttpParsersParseDateFromUTCStringDifferent = 5128,
  kOBSOLETE_HttpParsersParseDateFromStringDifferent = 5129,
  ...
  kOBSOLETE_ControlledFrameElement = 5205,
  ...
  kOBSOLETE_VarFallbackValidation = 5231,
  ...
  kCheckMarkPseudoElement = 5467,
  kBeforePseudoElement = 5468,
  kAfterPseudoElement = 5469,
  kPickerIconPseudoElement = 5470,
  kMarkerPseudoElement = 5471,
  kBackdropPseudoElement = 5472,
  kSelectionPseudoElement = 5473,
  kSearchTextPseudoElement = 5474,
  kTargetTextPseudoElement = 5475,
  ...
  kMLCreateContextGPUDevice = 5480,
  kDisallowedSelectChild = 5481,
  kDisallowedOptGroupChild = 5482,
  kNonPhrasingContentOptionChild = 5483,
  kInteractiveContentOptionChild = 5484,
  kInteractiveContentLegendChild = 5485,
  kPrivateAggregationApiErrorReporting = 5486,
  kLanguageModel_Prompt_Input_Image = 5487,
  kLanguageModel_Prompt_Input_Audio = 5488,
  kHttp3 = 5489,
  kCanvasReadbackNoise = 5490,
  kCanvasReadbackNoiseMatchesHeuristics = 5491,
  kSVGImage = 5492,
  kDeviceBoundSessionRequestInScope = 5493,
  kDeviceBoundSessionRequestDeferral = 5494,
  kRoleAttributeMenu = 5495,
  kRoleAttributeMenubar = 5496,
  kRoleAttributeMenuitem = 5497,
  kRoleAttributeMenuitemcheckbox = 5498,
  kRoleAttributeMenuitemradio = 5499,
  kRoleAttributeButton = 5500,
  kRoleAttributeCell = 5501,
  kRoleAttributeCheckbox = 5502,
  kRoleAttributeColumnheader = 5503,
  kRoleAttributeCombobox = 5504,
  kRoleAttributeDialog = 5505,
  kRoleAttributeGrid = 5506,
  kRoleAttributeGridcell = 5507,
  kRoleAttributeHeading = 5508,
  kRoleAttributeImg = 5509,
  kRoleAttributeInput = 5510,
  kRoleAttributeLink = 5511,
  kRoleAttributeList = 5512,
  kRoleAttributeListbox = 5513,
  kRoleAttributeListitem = 5514,
  kRoleAttributeMain = 5515,
  kRoleAttributeMarquee = 5516,
  kRoleAttributeMath = 5517,
  kRoleAttributeMeter = 5518,
  kRoleAttributeNavigation = 5519,
  kRoleAttributeOption = 5520,
  kRoleAttributeProgressbar = 5521,
  kRoleAttributeRadio = 5522,
  kRoleAttributeRadiogroup = 5523,
  kRoleAttributeRange = 5524,
  kRoleAttributeRow = 5525,
  kRoleAttributeRowgroup = 5526,
  kRoleAttributeRowheader = 5527,
  kRoleAttributeScrollbar = 5528,
  kRoleAttributeSearch = 5529,
  kRoleAttributeSearchbox = 5530,
  kRoleAttributeSelect = 5531,
  kRoleAttributeSeparator = 5532,
  kRoleAttributeSlider = 5533,
  kRoleAttributeSpinbutton = 5534,
  kRoleAttributeSwitch = 5535,
  kRoleAttributeTab = 5536,
  kRoleAttributeTable = 5537,
  kRoleAttributeTablist = 5538,
  kRoleAttributeTabpanel = 5539,
  kRoleAttributeTextbox = 5540,
  kRoleAttributeToolbar = 5541,
  kRoleAttributeTooltip = 5542,
  kRoleAttributeTree = 5543,
  kRoleAttributeTreegrid = 5544,
  kRoleAttributeTreeitem = 5545,
  ...
  kCSSCustomMedia = 5600,
  kHTMLCanvasElementLowLatency_2D = 5601,
  ...
  kClipboardPlatformPermissionDenied = 5606,
  kValidPopoverAttribute = 5607,
  kCanvasFallbackContent = 5608,
  kCanvasFallbackElementContent = 5609,
  kAutofillMaybeSyntheticSelect = 5610,
  kAutofillSyntheticSelect = 5611,
  kFetchRetry = 5612,
  kMessageEventDataBeforeSameOrigin = 5613,
  kMessageEventDataBeforeSameSiteOrigin = 5614,
  kMessageEventDataBeforeCrossSiteOrigin = 5615,
  kMessageEventDataBeforeOpaqueOrigin = 5616,
  ...
  kPointerRawUpdateEventsInInsecureContext = 5663,
  kReportToHeader = 5664,
  kReportingEndpointsHeader = 5665,
  kOverscrollBehaviorWithOverflowHidden = 5666,
  kWebCodecsAv1EncodingWithQP = 5667,
  kExternalSVGDocumentResources = 5668,
  ...
  kImageElementTimingNotImageOrVideoNode = 5776,
  kXSLPIInSVGImage = 5777,
  kXSLPIInSVGStandaloneDoc = 5778,
  kAudioContextAsyncStateTransitions = 5779,
  ...
  kMaxValue = kPreventSvgFilterPaint,
};
...
#endif  // STANDALONE_RENDERER_STUBS_THIRD_PARTY_BLINK_PUBLIC_MOJOM_USE_COUNTER_METRICS_WEB_FEATURE_MOJOM_SHARED_H_
