...
constexpr FeatureState kSuppressMemoryListenersDefaultState =
...
BASE_FEATURE(kSuppressMemoryListeners, kSuppressMemoryListenersDefaultState);

#if BUILDFLAG(IS_MAC) || BUILDFLAG(IS_WIN)
constexpr const char* kSuppressMemoryListenersMaskDefaultValue =
...
BASE_FEATURE_PARAM(std::string,
                   ...
                   kSuppressMemoryListenersMaskDefaultValue);
}  // namespace
