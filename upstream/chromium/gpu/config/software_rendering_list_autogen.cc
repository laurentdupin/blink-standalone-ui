...
const std::array<GpuControlList::Entry, 41>& GetSoftwareRenderingListEntries() {
...
static const std::array<GpuControlList::Entry, 41> kSoftwareRenderingListEntries = {{
{
4,  // id
...
{
166,  // id
"8.17.10.* AMD drivers are buggy Please update your graphics driver via this link: https://www.amd.com/en/support/apu/amd-series-processors/amd-a8-series-apu-for-laptops/a8-5550m-radeon-hd-8550g",
...
{
184,  // id
"Disable Graphite on very old Intel drivers",
base::span(kFeatureListForSoftwareEntry184),  // features
base::span<const char* const>(),  // DisabledExtensions
base::span<const char* const>(),  // DisabledWebGLExtensions
base::span(kCrBugsForSoftwareEntry184),  // CrBugs
{
GpuControlList::kOsWin,  // os_type
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // os_version
0x8086,  // vendor_id
...
GpuControlList::kMultiGpuCategoryNone,  // multi_gpu_category
GpuControlList::kMultiGpuStyleNone,  // multi_gpu_style
&kDriverInfoForSoftwareEntry184,  // driver info
nullptr,  // GL strings
nullptr,  // machine model info
nullptr,  // Intel conditions
nullptr,  // more conditions
...
{
187,  // id
"Disable Graphite on very old Intel GPU generations due to crashiness",
base::span(kFeatureListForSoftwareEntry187),  // features
base::span<const char* const>(),  // DisabledExtensions
base::span<const char* const>(),  // DisabledWebGLExtensions
base::span(kCrBugsForSoftwareEntry187),  // CrBugs
{
GpuControlList::kOsWin,  // os_type
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // os_version
0x8086,  // vendor_id
...
nullptr,  // GL strings
nullptr,  // machine model info
&kIntelConditionsForEntry187_1043157500,  // Intel conditions
nullptr,  // more conditions
},
base::span<const GpuControlList::Conditions>(),  // exceptions
},
{
188,  // id
"Disable Graphite on D3D11 feature level below 12.0 due to crashiness",
base::span(kFeatureListForSoftwareEntry188),  // features
base::span<const char* const>(),  // DisabledExtensions
base::span<const char* const>(),  // DisabledWebGLExtensions
base::span(kCrBugsForSoftwareEntry188),  // CrBugs
{
GpuControlList::kOsWin,  // os_type
{GpuControlList::kUnknown, GpuControlList::kVersionStyleNumerical, GpuControlList::kVersionSchemaCommon, nullptr, nullptr},  // os_version
0x00,  // vendor_id
...
nullptr,  // machine model info
nullptr,  // Intel conditions
&kMoreForEntry188_1043157500,  // more data
},
base::span<const GpuControlList::Conditions>(),  // exceptions
},
}};
