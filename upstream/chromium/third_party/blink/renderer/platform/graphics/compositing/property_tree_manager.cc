...
static cc::RenderSurfaceReason RenderSurfaceReasonForEffect(
  ...
  // The standalone generated RuntimeEnabledFeatures surface does not yet carry
  // UnboundedElement. Keep this optional compositor branch disabled until the
  // generated feature set is aligned.
  DCHECK(!effect.RequiresCompositingForUnboundedElement());
#else
