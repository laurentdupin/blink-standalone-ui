...
namespace {
void TraceStandaloneFrameStage(const char* stage) {
}
}  // namespace
...
Frame::Frame(FrameClient* client,
  ...
  TraceStandaloneFrameStage("Frame ctor body");
  InstanceCounters::IncrementCounter(InstanceCounters::kFrameCounter);
  TraceStandaloneFrameStage("after increment counter");
  ...
  TraceStandaloneFrameStage("after insert check");
}
