...
void LocalFrameView::PerformLayout() {
#if defined(HTML_CSS_RENDERER_STANDALONE)
  TraceStandaloneLocalFrameViewStage("PerformLayout begin");
#endif
  ScriptForbiddenScope forbid_script;
#if defined(HTML_CSS_RENDERER_STANDALONE)
  TraceStandaloneLocalFrameViewStage("PerformLayout after forbid_script");
#endif

  has_pending_layout_ = false;
#if defined(HTML_CSS_RENDERER_STANDALONE)
  TraceStandaloneLocalFrameViewStage("PerformLayout after pending flag");
#endif

  base::AutoReset<bool> change_scheduling_enabled(&layout_scheduling_enabled_,
                                                  false);
#if defined(HTML_CSS_RENDERER_STANDALONE)
  TraceStandaloneLocalFrameViewStage("PerformLayout after scheduling reset");
#endif
  ...
  if (GetLayoutView()->NeedsLayout()) {
    ...
    TraceStandaloneLocalFrameViewStage(
        "PerformLayout before ClearLayoutSubtreeRootsAndMarkContainingBlocks");
#endif
    ClearLayoutSubtreeRootsAndMarkContainingBlocks();
#if defined(HTML_CSS_RENDERER_STANDALONE)
    TraceStandaloneLocalFrameViewStage(
        "PerformLayout after ClearLayoutSubtreeRootsAndMarkContainingBlocks");
#endif
  }
#if defined(HTML_CSS_RENDERER_STANDALONE)
  TraceStandaloneLocalFrameViewStage("PerformLayout before ClearHitTestCache");
#endif
  GetLayoutView()->ClearHitTestCache();
#if defined(HTML_CSS_RENDERER_STANDALONE)
  TraceStandaloneLocalFrameViewStage("PerformLayout after ClearHitTestCache");
#endif

  const bool in_subtree_layout = IsSubtreeLayout();
#if defined(HTML_CSS_RENDERER_STANDALONE)
  TraceStandaloneLocalFrameViewStage("PerformLayout after IsSubtreeLayout");
#endif

  Document* document = GetFrame().GetDocument();
#if defined(HTML_CSS_RENDERER_STANDALONE)
  TraceStandaloneLocalFrameViewStage("PerformLayout after document");
#endif
  if (!in_subtree_layout) {
#if defined(HTML_CSS_RENDERER_STANDALONE)
    TraceStandaloneLocalFrameViewStage("PerformLayout before full root setup");
#endif
    ClearLayoutSubtreeRootsAndMarkContainingBlocks();
#if defined(HTML_CSS_RENDERER_STANDALONE)
    TraceStandaloneLocalFrameViewStage(
        "PerformLayout after full ClearLayoutSubtreeRootsAndMarkContainingBlocks");
#endif
    Node* body = document->body();
#if defined(HTML_CSS_RENDERER_STANDALONE)
    TraceStandaloneLocalFrameViewStage("PerformLayout after body lookup");
#endif
#if !defined(HTML_CSS_RENDERER_STANDALONE)
...
#if defined(HTML_CSS_RENDERER_STANDALONE)
  TraceStandaloneLocalFrameViewStage("PerformLayout after root setup");
#endif
...
#if defined(HTML_CSS_RENDERER_STANDALONE)
  TraceStandaloneLocalFrameViewStage("PerformLayout after old size");
#endif
...
#if defined(HTML_CSS_RENDERER_STANDALONE)
  TraceStandaloneLocalFrameViewStage("PerformLayout after contents height");
#endif
#if !defined(HTML_CSS_RENDERER_STANDALONE)
  TRACE_EVENT_BEGIN1(
...
#if defined(HTML_CSS_RENDERER_STANDALONE)
  TraceStandaloneLocalFrameViewStage("PerformLayout after lifecycle");
#endif
...
#if defined(HTML_CSS_RENDERER_STANDALONE)
      TraceStandaloneLocalFrameViewStage("PerformLayout before LayoutRoot");
#endif
      GetLayoutView()->LayoutRoot();
#if defined(HTML_CSS_RENDERER_STANDALONE)
      TraceStandaloneLocalFrameViewStage("PerformLayout after LayoutRoot");
#endif
    }
  }
...
#if defined(HTML_CSS_RENDERER_STANDALONE)
  TraceStandaloneLocalFrameViewStage("PerformLayout after lifecycle after-layout");
#endif
...
#if defined(HTML_CSS_RENDERER_STANDALONE)
  TraceStandaloneLocalFrameViewStage("UpdateLayout standalone before perform");
  PerformLayout();
  TraceStandaloneLocalFrameViewStage("UpdateLayout standalone after perform");
  Lifecycle().AdvanceTo(DocumentLifecycle::kLayoutClean);
  TraceStandaloneLocalFrameViewStage("UpdateLayout standalone done");
  return;
#endif
...
bool LocalFrameView::UpdateAllLifecyclePhases(DocumentUpdateReason reason) {
  TraceStandaloneLocalFrameViewStage("UpdateAllLifecyclePhases begin");
#if !defined(HTML_CSS_RENDERER_STANDALONE)
  AllowThrottlingScope allow_throttling(*this);
#endif
  TraceStandaloneLocalFrameViewStage("UpdateAllLifecyclePhases after throttling scope");
  bool updated =
#if defined(HTML_CSS_RENDERER_STANDALONE)
      UpdateLifecyclePhases(DocumentLifecycle::kPaintClean, reason);
#else
      GetFrame().LocalFrameRoot().View()->UpdateLifecyclePhases(
          DocumentLifecycle::kPaintClean, reason);
#endif
  TraceStandaloneLocalFrameViewStage("UpdateAllLifecyclePhases after UpdateLifecyclePhases");
...
bool LocalFrameView::UpdateAllLifecyclePhasesForTest() {
  TraceStandaloneLocalFrameViewStage("UpdateAllLifecyclePhasesForTest begin");
  bool result = UpdateAllLifecyclePhases(DocumentUpdateReason::kTest);
  TraceStandaloneLocalFrameViewStage("UpdateAllLifecyclePhasesForTest before post steps");
#if !defined(HTML_CSS_RENDERER_STANDALONE)
  RunPostLifecycleSteps();
#else
  TraceStandaloneLocalFrameViewStage(
      "UpdateAllLifecyclePhasesForTest skipping browser post steps");
#endif
  TraceStandaloneLocalFrameViewStage("UpdateAllLifecyclePhasesForTest done");
  return result;
}
...
bool LocalFrameView::UpdateLifecyclePhases(
    ...
    DocumentUpdateReason reason) {
  TraceStandaloneLocalFrameViewStage("UpdateLifecyclePhases begin");
...
#endif
  TraceStandaloneLocalFrameViewStage("UpdateLifecyclePhases after reentrance checks");
  ...
  DCHECK(target_state == DocumentLifecycle::kLayoutClean ||
         ...
         target_state == DocumentLifecycle::kPaintClean);
#endif
  TraceStandaloneLocalFrameViewStage("UpdateLifecyclePhases after DCHECKs");
  ...
  if (!frame_->GetDocument()->IsActive())
    return false;
#endif
  TraceStandaloneLocalFrameViewStage("UpdateLifecyclePhases after active check");
...
#endif
  TraceStandaloneLocalFrameViewStage("UpdateLifecyclePhases before PrepareRecursive");

#if !defined(HTML_CSS_RENDERER_STANDALONE)
  PrepareForLifecycleUpdateRecursive();
#endif
  TraceStandaloneLocalFrameViewStage("UpdateLifecyclePhases after PrepareRecursive");
...
#if defined(HTML_CSS_RENDERER_STANDALONE)
  // The standalone probe drives a single local frame directly and bypasses the
  // recursive root-frame lifecycle guard above. Avoid touching the root-view
  // reentrance sentinel until the standalone Frame/View ownership model is
  // complete; the actual lifecycle target is still passed explicitly below.
  TraceStandaloneLocalFrameViewStage("UpdateLifecyclePhases skipping target state");
#else
  base::AutoReset<DocumentLifecycle::LifecycleState> target_state_scope(
      &target_state_, target_state);
#endif
  TraceStandaloneLocalFrameViewStage("UpdateLifecyclePhases after target scope");

#if !defined(HTML_CSS_RENDERER_STANDALONE)
  lifecycle_data_.start_time = base::TimeTicks::Now();
  ++lifecycle_data_.count;
#else
  TraceStandaloneLocalFrameViewStage("UpdateLifecyclePhases skipping lifecycle data");
#endif
  ...
  TraceStandaloneLocalFrameViewStage("UpdateLifecyclePhases before force debug");
  ...
  TraceStandaloneLocalFrameViewStage("UpdateLifecyclePhases before internal");
  UpdateLifecyclePhasesInternal(target_state, reason);
  TraceStandaloneLocalFrameViewStage("UpdateLifecyclePhases after internal");

  if (target_state == DocumentLifecycle::kPaintClean) {
#if defined(HTML_CSS_RENDERER_STANDALONE)
    TraceStandaloneLocalFrameViewStage(
        "UpdateLifecyclePhases skipping browser lifecycle-finished observers");
#else
...
void LocalFrameView::UpdateLifecyclePhasesInternal(
  ...
  TraceStandaloneLocalFrameViewStage("UpdateLifecyclePhasesInternal before collect views");
#if defined(HTML_CSS_RENDERER_STANDALONE)
  unthrottled_frame_views.push_back(this);
#else
  ForAllNonThrottledLocalFrameViews(
...
#endif
  TraceStandaloneLocalFrameViewStage("UpdateLifecyclePhasesInternal after collect views");

  while (true) {
    TraceStandaloneLocalFrameViewStage("UpdateLifecyclePhasesInternal loop begin");
#if !defined(HTML_CSS_RENDERER_STANDALONE)
...
#endif
    TraceStandaloneLocalFrameViewStage(
        "UpdateLifecyclePhasesInternal before style/layout");
    bool run_more_lifecycle_phases =
        RunStyleAndLayoutLifecyclePhases(target_state);
    TraceStandaloneLocalFrameViewStage(
        "UpdateLifecyclePhasesInternal after style/layout");
    ...
    if (should_run_post_layout_snapshot_client_steps) {
      should_run_post_layout_snapshot_client_steps = false;
      TraceStandaloneLocalFrameViewStage(
          "UpdateLifecyclePhasesInternal before snapshot post-layout");
      bool needs_to_repeat_lifecycle =
          RunSnapshotPostLayoutStateSteps(target_state, reason);
      TraceStandaloneLocalFrameViewStage(
          "UpdateLifecyclePhasesInternal after snapshot post-layout");
    ...
    TraceStandaloneLocalFrameViewStage(
        "UpdateLifecyclePhasesInternal before layout view check");
    if (!GetLayoutView()) {
      return;
    }
    TraceStandaloneLocalFrameViewStage(
        "UpdateLifecyclePhasesInternal after layout view check");
...
#endif
      TraceStandaloneLocalFrameViewStage(
          "UpdateLifecyclePhasesInternal before compositing inputs");
      run_more_lifecycle_phases =
          RunCompositingInputsLifecyclePhase(target_state);
      TraceStandaloneLocalFrameViewStage(
          "UpdateLifecyclePhasesInternal after compositing inputs");
      if (!run_more_lifecycle_phases)
        return;

      TraceStandaloneLocalFrameViewStage(
          "UpdateLifecyclePhasesInternal before prepaint");
      run_more_lifecycle_phases = RunPrePaintLifecyclePhase(target_state);
      TraceStandaloneLocalFrameViewStage(
          "UpdateLifecyclePhasesInternal after prepaint");
    }
...
#if defined(HTML_CSS_RENDERER_STANDALONE)
    needs_to_repeat_lifecycle = false;
#else
...
#else
  TraceStandaloneLocalFrameViewStage(
      "UpdateLifecyclePhasesInternal skipping browser post-prepaint steps");
#endif

  DCHECK_EQ(target_state, DocumentLifecycle::kPaintClean);
  TraceStandaloneLocalFrameViewStage(
      "UpdateLifecyclePhasesInternal before paint");
  RunPaintLifecyclePhase(PaintBenchmarkMode::kNormal);
  TraceStandaloneLocalFrameViewStage(
      "UpdateLifecyclePhasesInternal after paint");
...
bool LocalFrameView::RunStyleAndLayoutLifecyclePhases(
    DocumentLifecycle::LifecycleState target_state) {
  TraceStandaloneLocalFrameViewStage("RunStyleAndLayout begin");
#if !defined(HTML_CSS_RENDERER_STANDALONE)
  TRACE_EVENT0("blink,benchmark",
               "LocalFrameView::RunStyleAndLayoutLifecyclePhases");
#endif
  TraceStandaloneLocalFrameViewStage("RunStyleAndLayout before update");
  UpdateStyleAndLayoutIfNeededRecursive();
  TraceStandaloneLocalFrameViewStage("RunStyleAndLayout after update");
  DCHECK(ShouldThrottleRendering() ||
...
#if defined(HTML_CSS_RENDERER_STANDALONE)
  TraceStandaloneLocalFrameViewStage(
      "RunStyleAndLayout standalone skipping browser post-layout steps");
  return true;
#endif
...
bool LocalFrameView::RunCompositingInputsLifecyclePhase(
    DocumentLifecycle::LifecycleState target_state) {
#if defined(HTML_CSS_RENDERER_STANDALONE)
  TraceStandaloneLocalFrameViewStage("RunCompositingInputs begin standalone");
  Lifecycle().AdvanceTo(DocumentLifecycle::kInCompositingInputsUpdate);
  TraceStandaloneLocalFrameViewStage("RunCompositingInputs after lifecycle");
  if (GetLayoutView() && GetLayoutView()->Layer()) {
    TraceStandaloneLocalFrameViewStage(
        "RunCompositingInputs skipping selection");
    TraceStandaloneLocalFrameViewStage("RunCompositingInputs before flags");
    GetLayoutView()->Layer()->UpdateDescendantDependentFlags();
    TraceStandaloneLocalFrameViewStage("RunCompositingInputs after flags");
  }
  TraceStandaloneLocalFrameViewStage("RunCompositingInputs before clean");
  Lifecycle().AdvanceTo(DocumentLifecycle::kCompositingInputsClean);
  TraceStandaloneLocalFrameViewStage("RunCompositingInputs done standalone");
...
bool LocalFrameView::RunPrePaintLifecyclePhase(
    DocumentLifecycle::LifecycleState target_state) {
#if defined(HTML_CSS_RENDERER_STANDALONE)
  TraceStandaloneLocalFrameViewStage("RunPrePaint begin standalone");
  Lifecycle().AdvanceTo(DocumentLifecycle::kInPrePaint);
  if (GetLayoutView()) {
    PrePaintTreeWalk().WalkTree(*this);
  }
  Lifecycle().AdvanceTo(DocumentLifecycle::kPrePaintClean);
  TraceStandaloneLocalFrameViewStage("RunPrePaint done standalone");
...
void LocalFrameView::PaintTree(
    ...
    std::optional<PaintController>& paint_controller) {
#if defined(HTML_CSS_RENDERER_STANDALONE)
  TraceStandaloneLocalFrameViewStage("PaintTree begin");
#else
  ...
  auto* layout_view = GetLayoutView();
  DCHECK(layout_view);
  TraceStandaloneLocalFrameViewStage("PaintTree after layout view");

  CullRectUpdater(*layout_view->Layer()).Update();
  TraceStandaloneLocalFrameViewStage("PaintTree after cull rect");

#if defined(HTML_CSS_RENDERER_STANDALONE)
  bool debug_info_newly_enabled = false;
#else
  bool debug_info_newly_enabled =
      UpdatePaintDebugInfoEnabled() && PaintDebugInfoEnabled();
#endif
  TraceStandaloneLocalFrameViewStage("PaintTree after debug flag");

  paint_frame_count_++;
#if defined(HTML_CSS_RENDERER_STANDALONE)
  MarkFirstEligibleToPaint();
...
#endif
  TraceStandaloneLocalFrameViewStage("PaintTree after frame view paint setup");
  ...
  if (benchmark_mode >= PaintBenchmarkMode::kForcePaint ||
    ...
    TraceStandaloneLocalFrameViewStage("PaintTree after persistent data");
    paint_controller.emplace(PaintDebugInfoEnabled(),
                             paint_controller_persistent_data_.Get(),
                             benchmark_mode);
    TraceStandaloneLocalFrameViewStage("PaintTree after controller");
    GraphicsContext graphics_context(*paint_controller);
    TraceStandaloneLocalFrameViewStage("PaintTree after graphics context");
...
#endif
      TraceStandaloneLocalFrameViewStage("PaintTree before PaintFrame");
      PaintFrame(graphics_context);
      TraceStandaloneLocalFrameViewStage("PaintTree after PaintFrame");
  ...
  TraceStandaloneLocalFrameViewStage(
      "PaintTree standalone skipping repaint flag cleanup");
#else
  ForAllNonThrottledLocalFrameViews(
...
#endif
  TraceStandaloneLocalFrameViewStage("PaintTree done");
}
...
void LocalFrameView::UpdateStyleAndLayoutIfNeededRecursive() {
  TraceStandaloneLocalFrameViewStage("UpdateStyleAndLayoutIfNeededRecursive begin");
#if !defined(HTML_CSS_RENDERER_STANDALONE)
...
#else
  TraceStandaloneLocalFrameViewStage(
      "UpdateStyleAndLayoutIfNeededRecursive skipping active check");
#endif

  TraceStandaloneLocalFrameViewStage(
      "UpdateStyleAndLayoutIfNeededRecursive before update");
  UpdateStyleAndLayout();
  TraceStandaloneLocalFrameViewStage(
      "UpdateStyleAndLayoutIfNeededRecursive after update");
...
#endif
  TraceStandaloneLocalFrameViewStage(
      "UpdateStyleAndLayoutIfNeededRecursive after plugin checks");
...
#if defined(HTML_CSS_RENDERER_STANDALONE)
  TraceStandaloneLocalFrameViewStage(
      "UpdateStyleAndLayoutIfNeededRecursive before lifecycle clean");
#endif
  if (Lifecycle().GetState() < DocumentLifecycle::kLayoutClean)
    Lifecycle().AdvanceTo(DocumentLifecycle::kLayoutClean);
...
#endif
  TraceStandaloneLocalFrameViewStage("UpdateStyleAndLayoutIfNeededRecursive done");
}

void LocalFrameView::UpdateStyleAndLayout() {
  TraceStandaloneLocalFrameViewStage("UpdateStyleAndLayout begin");
#if DCHECK_IS_ON() && !defined(HTML_CSS_RENDERER_STANDALONE)
...
#endif
  TraceStandaloneLocalFrameViewStage("UpdateStyleAndLayout after entry guards");
  ...
  bool did_layout = false;
  {
    ...
    ScriptForbiddenScope::AllowUserAgentScript allow_script;
#endif
    TraceStandaloneLocalFrameViewStage("UpdateStyleAndLayout before internal");
    did_layout = UpdateStyleAndLayoutInternal();
    TraceStandaloneLocalFrameViewStage("UpdateStyleAndLayout after internal");
  }
  ...
  UpdateGeometriesIfNeeded();
#endif
  TraceStandaloneLocalFrameViewStage("UpdateStyleAndLayout done");
}

bool LocalFrameView::UpdateStyleAndLayoutInternal() {
  TraceStandaloneLocalFrameViewStage("UpdateStyleAndLayoutInternal begin");
#if !defined(HTML_CSS_RENDERER_STANDALONE)
  ...
  do {
...
#endif
      TraceStandaloneLocalFrameViewStage(
          "UpdateStyleAndLayoutInternal after document tree update");
    ...
    TraceStandaloneLocalFrameViewStage(
        "UpdateStyleAndLayoutInternal before background fixed");
    UpdateCanCompositeBackgroundAttachmentFixed();
    TraceStandaloneLocalFrameViewStage(
        "UpdateStyleAndLayoutInternal after background fixed");
...
#endif
      TraceStandaloneLocalFrameViewStage(
          "UpdateStyleAndLayoutInternal before layout");
      UpdateLayout();
      TraceStandaloneLocalFrameViewStage(
          "UpdateStyleAndLayoutInternal after layout");
      layout_updated = true;
    }
#if defined(HTML_CSS_RENDERER_STANDALONE)
  } while (false);
