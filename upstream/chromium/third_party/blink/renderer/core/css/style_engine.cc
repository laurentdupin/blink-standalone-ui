...
#if defined(HTML_CSS_RENDERER_STANDALONE)
      Element& standalone_recalc_root = style_recalc_root_.RootElement();
      StyleRecalcContext standalone_recalc_context =
          StyleRecalcContext::FromAncestors(standalone_recalc_root);
      RecalcStyle({}, standalone_recalc_context);
#else
      RecalcStyle();
#endif
#if defined(HTML_CSS_RENDERER_STANDALONE)
