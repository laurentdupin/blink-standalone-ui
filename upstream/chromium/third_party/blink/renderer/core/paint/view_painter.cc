...
#endif
#if defined(HTML_CSS_RENDERER_STANDALONE)
  bool paints_hit_test_data = false;
#else
...
#if defined(HTML_CSS_RENDERER_STANDALONE)
  bool paints_element_tracking_id_or_region_capture_data = false;
#else
...
#endif
#if defined(HTML_CSS_RENDERER_STANDALONE)
  bool paints_scroll_hit_test = false;
#else
