...
class StandaloneDirectLayerTreeFrameSink final : public cc::LayerTreeFrameSink {
 public:
  StandaloneDirectLayerTreeFrameSink(
      ...
      : cc::LayerTreeFrameSink(std::move(compositor_context_provider),
        ...
        frame_sink_support_(frame_sink_manager,
                            frame_sink_id,
                            &viz_client_,
  ...
  bool BindToClient(cc::LayerTreeFrameSinkClient* client) override {
    ...
    frame_sink_support_.BindToClient(client, compositor_task_runner_.get());
    return true;
  }
  ...
  void ReclaimDroppedCompositorFrameResources(
    ...
    frame_sink_support_.ReclaimResources(std::move(returned_resources));
  }
  ...
  void DidNotProduceFrame(const viz::BeginFrameAck& ack,
    ...
    frame_sink_support_.DidNotProduceFrame(ack);
  }

  void NotifyNewLocalSurfaceIdExpectedWhilePaused() override {
    frame_sink_support_.NotifyNewLocalSurfaceIdExpectedWhilePaused();
  }
  ...
  html_css_renderer::ExternalGpuTargetCopyResult RenderExternalVkImageToTarget(
    ...
    if (!offscreen_skia_dependency_) {
      return MakeAsyncExternalGpuTargetCopyResult(
          html_css_renderer::ExternalGpuTargetCopyStatus::kFailed,
          "gpu_external_vkimage_render_copy: failed "
    ...
    if (!prepare_result.empty()) {
      return MakeAsyncExternalGpuTargetCopyResult(
          html_css_renderer::ExternalGpuTargetCopyStatus::kFailed,
          "gpu_external_vkimage_render_copy: failed failure=" + prepare_result,
          output_size);
    }
  ...
  BeginRenderExternalVkImageToTargetAsync(
    ...
    if (!offscreen_skia_dependency_) {
      return MakeAsyncExternalGpuTargetCopyResult(
          html_css_renderer::ExternalGpuTargetCopyStatus::kFailed,
          "gpu_external_vkimage_render_copy_async: failed "
          "failure=offscreen Vulkan Skia dependency is not available",
          output_size);
    }
    scoped_refptr<gpu::ClientSharedImage> blit_target;
    ...
    if (!prepare_result.empty()) {
      return MakeAsyncExternalGpuTargetCopyResult(
          html_css_renderer::ExternalGpuTargetCopyStatus::kFailed,
          "gpu_external_vkimage_render_copy_async: failed failure=" +
              prepare_result,
          output_size);
    }
    if (!blit_target || blit_target->mailbox().IsZero()) {
  ...
  html_css_renderer::ExternalGpuTargetCopyResult RenderExternalD3D12ToTarget(
    ...
    if (!offscreen_skia_dependency_) {
      return MakeAsyncExternalGpuTargetCopyResult(
          html_css_renderer::ExternalGpuTargetCopyStatus::kFailed,
          "gpu_external_d3d12_render_copy: failed "
    ...
    if (!prepare_result.empty()) {
      return MakeAsyncExternalGpuTargetCopyResult(
          prepare_result.find(
              ...
              : html_css_renderer::ExternalGpuTargetCopyStatus::kFailed,
          "gpu_external_d3d12_render_copy: failed failure=" + prepare_result,
          output_size);
    }
    if (!blit_target || blit_target->mailbox().IsZero()) {
      offscreen_skia_dependency_
  ...
  BeginRenderExternalD3D12ToTargetAsync(void* d3d12_resource,
    ...
    if (!offscreen_skia_dependency_) {
      return MakeAsyncExternalGpuTargetCopyResult(
          html_css_renderer::ExternalGpuTargetCopyStatus::kFailed,
          "gpu_external_d3d12_render_copy_async: failed "
          "failure=offscreen D3D12 Skia dependency is not available",
          output_size);
    }
    scoped_refptr<gpu::ClientSharedImage> blit_target;
    ...
    if (!prepare_result.empty()) {
      return MakeAsyncExternalGpuTargetCopyResult(
          html_css_renderer::ExternalGpuTargetCopyStatus::kFailed,
          "gpu_external_d3d12_render_copy_async: failed failure=" +
              prepare_result,
          output_size);
    }
    if (!blit_target || blit_target->mailbox().IsZero()) {
      ...
      return MakeAsyncExternalGpuTargetCopyResult(
          html_css_renderer::ExternalGpuTargetCopyStatus::kFailed,
          "gpu_external_d3d12_render_copy_async: failed failure=external "
          "D3D12 target SharedImage is unavailable",
          output_size);
    }
  ...
  bool NeedsActivatedRootSurfaceForExternalTarget() const {
    return frame_sink_support_.NeedsActivatedRootSurface(local_surface_id_);
  }
 ...
 private:
  ...
  StandaloneRootFrameSinkSupportController frame_sink_support_;
