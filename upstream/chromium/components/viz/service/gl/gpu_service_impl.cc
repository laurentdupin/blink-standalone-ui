...
mojom::ContextLostReason ToVizContextLostReason(
    gpu::error::ContextLostReason reason) {
  switch (reason) {
    case gpu::error::kGuilty:
      return mojom::ContextLostReason::GUILTY;
    case gpu::error::kInnocent:
      return mojom::ContextLostReason::INNOCENT;
    case gpu::error::kUnknown:
      return mojom::ContextLostReason::UNKNOWN;
    case gpu::error::kOutOfMemory:
      return mojom::ContextLostReason::OUT_OF_MEMORY;
    case gpu::error::kMakeCurrentFailed:
      return mojom::ContextLostReason::MAKE_CURRENT_FAILED;
    case gpu::error::kGpuChannelLost:
      return mojom::ContextLostReason::GPU_CHANNEL_LOST;
    case gpu::error::kInvalidGpuMessage:
      return mojom::ContextLostReason::INVALID_GPU_MESSAGE;
  }
  return mojom::ContextLostReason::UNKNOWN;
}
...
void GpuServiceImpl::InitializeWithHost(
  ...
  // created.
#if defined(HTML_CSS_RENDERER_STANDALONE)
  gpu_info_.shared_image_d3d = false;
  gpu_host_->DidUpdateGPUInfo(gpu_info_);
#else
...
void GpuServiceImpl::DidLoseContext(gpu::error::ContextLostReason reason,
  ...
  gpu_host_->DidLoseContext(ToVizContextLostReason(reason), active_url);
}
