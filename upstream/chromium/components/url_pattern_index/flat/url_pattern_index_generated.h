...
inline const char *EnumNameOptionFlag(OptionFlag e) {
  if (::flatbuffers::IsOutRange(e, OptionFlag_IS_ALLOWLIST, OptionFlag_IS_MATCH_CASE)) return "";
...
inline const char *EnumNameRequestMethod(RequestMethod e) {
  switch (e) {
    ...
    case RequestMethod_OTHER_HTTP: return "OTHER_HTTP";
...
inline bool VerifyUrlPatternIndexBuffer(
  ...
  return verifier.template VerifyBuffer<url_pattern_index::flat::UrlPatternIndex>(nullptr);
}

template <bool B = false>
inline bool VerifySizePrefixedUrlPatternIndexBuffer(
    ::flatbuffers::VerifierTemplate<B> &verifier) {
  return verifier.template VerifySizePrefixedBuffer<url_pattern_index::flat::UrlPatternIndex>(nullptr);
}
