...
def main() -> None:
    ...
    for path in sorted(args.input_dir.rglob(args.glob)):
        ...
        rows.append({
            ...
            "thresholded_changed_percent_union_content_bbox": data.get("thresholded_changed_percent_union_content_bbox", data.get("changed_percent_union_content_bbox", 0)),
            ...
            "visual_match_under_threshold": data.get("visual_match_under_threshold", False),
            "exact_pixel_identical": data.get("exact_pixel_identical", False),
